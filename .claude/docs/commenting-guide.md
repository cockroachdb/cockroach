# CockroachDB Commenting Guide

Detailed writing principles and examples for Go and protobuf comments,
distilled from well-documented packages across the codebase (concurrency,
admission control, optimizer, rangefeed, jobs, storage, execinfra).
