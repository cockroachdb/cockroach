...
- Missing release note annotation entirely
- Using invalid category names
- Including internal information in release notes
- Vague descriptions that don't explain impact to users
- Wrong category for backward-incompatible changes
- Ending subject line with period
- Not explaining the "why" behind changes

## Pull Request Guidelines
- **PRs should be created on the rafiss fork**, not on cockroachdb/cockroach directly
