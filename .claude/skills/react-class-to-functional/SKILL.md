...
- Bound methods / arrow class methods → `useCallback` (if passed as prop or in dep arrays) or plain functions
...
- [ ] Run build system (not just tests) to catch declaration file issues