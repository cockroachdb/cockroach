...
/*
Package client and its KV API has been deprecated. Please use a
postgres-compatible SQL driver (e.g. github.com/lib/pq). For more details,
see http://www.cockroachlabs.com/blog/sql-in-cockroachdb-mapping-table-data-to-key-value-storage/.
