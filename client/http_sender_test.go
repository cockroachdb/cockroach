...
var (
	...
	testPutReq  = &proto.PutRequest{KVRequestHeader: proto.KVRequestHeader{Timestamp: testTS, Key: testKey}}
	testPutResp = &proto.PutResponse{KVResponseHeader: proto.KVResponseHeader{Timestamp: testTS}}
)
