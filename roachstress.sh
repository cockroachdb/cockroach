...
time caffeinate -- ./roachtest.$sha run "${TEST}" --port 8080 --debug --count 800 --cpu-quota 1600 --roachprod roachprod.${sha} --workload workload.${sha} --cockroach ./cockroach.$sha --artifacts artifacts.$sha
