...
type GetUIDataResponse struct {
	...
	KeyValues map[string]*GetUIDataResponse_Value `protobuf:"bytes,1,rep,name=key_values,json=keyValues" json:"key_values,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
}
...
var fileDescriptorAdmin = []byte{
	...
	,
}
