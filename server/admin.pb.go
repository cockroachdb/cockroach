...
const (
	// CLIENT instructs the server to refuse new SQL clients and terminate
	// existing clients in a graceful manner.
...
type DrainRequest struct {
	// This is actually a DrainMode, but grpc-gateway does not support proxying
	// enum fields (yet: https://github.com/gengo/grpc-gateway/issues/5) and it
	// fails in pretty dramatic ways (panics the server).
	Modes []int32 `protobuf:"varint,1,rep,name=modes" json:"modes,omitempty"`
}
...
type AdminClient interface {
	...
	// Example URLs:
	// - /_admin/v1/drain
	// - /_admin/v1/drain?modes=1
	// - /_admin/v1/drain?modes=1&modes=2
...
func _Admin_Drain_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error) (interface{}, error) {
	in := new(DrainRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	out, err := srv.(AdminServer).Drain(ctx, in)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var fileDescriptorAdmin = []byte{
	...
	,
}
