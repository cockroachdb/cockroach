...
func (*RaftDebugRequest) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{15} }

type RaftDebugResponse struct {
	Ranges []*RaftRangeStatus `protobuf:"bytes,1,rep,name=ranges" json:"ranges,omitempty"`
}
...
func (*RaftDebugResponse) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{16} }
...
type RaftRangeStatus struct {
	...
	Errors  []*RaftRangeError                                `protobuf:"bytes,2,rep,name=errors" json:"errors,omitempty"`
	Nodes   []*RaftRangeNode                                 `protobuf:"bytes,3,rep,name=nodes" json:"nodes,omitempty"`
}
...
var fileDescriptorStatus = []byte{
	...
	,
}
