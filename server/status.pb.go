...
func (*LogFilesListRequest) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{10} }
...
func (*LogFileRequest) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{11} }
...
func (*StacksRequest) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{12} }
...
func (*MetricsRequest) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{13} }
...
var fileDescriptorStatus = []byte{
	...
	,
}
