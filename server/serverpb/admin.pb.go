...
func (m *ConstraintsRequest) Reset()                    { *m = ConstraintsRequest{} }
func (m *ConstraintsRequest) String() string            { return proto.CompactTextString(m) }
func (*ConstraintsRequest) ProtoMessage()               {}
func (*ConstraintsRequest) Descriptor() ([]byte, []int) { return fileDescriptorAdmin, []int{24} }
...
func (*Candidate) Descriptor() ([]byte, []int) { return fileDescriptorAdmin, []int{25} }

type ConstraintsResponse struct {
	Stores     []cockroach_roachpb.StoreDescriptor `protobuf:"bytes,1,rep,name=stores" json:"stores"`
	Candidates []Candidate                         `protobuf:"bytes,2,rep,name=candidates" json:"candidates"`
}

func (m *ConstraintsResponse) Reset()                    { *m = ConstraintsResponse{} }
func (m *ConstraintsResponse) String() string            { return proto.CompactTextString(m) }
func (*ConstraintsResponse) ProtoMessage()               {}
func (*ConstraintsResponse) Descriptor() ([]byte, []int) { return fileDescriptorAdmin, []int{26} }
...
func init() {
	...
	proto.RegisterType((*ConstraintsRequest)(nil), "cockroach.server.serverpb.ConstraintsRequest")
	proto.RegisterType((*Candidate)(nil), "cockroach.server.serverpb.Candidate")
	proto.RegisterType((*ConstraintsResponse)(nil), "cockroach.server.serverpb.ConstraintsResponse")
...
type AdminClient interface {
	...
	// Constraints computes the candidate stores for the given set of constraints.
...
func (c *adminClient) Constraints(ctx context.Context, in *ConstraintsRequest, opts ...grpc.CallOption) (*ConstraintsResponse, error) {
	out := new(ConstraintsResponse)
	err := grpc.Invoke(ctx, "/cockroach.server.serverpb.Admin/Constraints", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Admin_Constraints_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ConstraintsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdminServer).Constraints(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cockroach.server.serverpb.Admin/Constraints",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServer).Constraints(ctx, req.(*ConstraintsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Admin_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Admin_Constraints_Handler,
		},
	},
...
func (m *ConstraintsRequest) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *ConstraintsRequest) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.Constraints) > 0 {
		data[i] = 0xa
		i++
		i = encodeVarintAdmin(data, i, uint64(len(m.Constraints)))
...
func (m *Candidate) MarshalTo(data []byte) (int, error) {
	...
	if m.Score != 0 {
		data[i] = 0x11
		i++
		i = encodeFixed64Admin(data, i, uint64(math.Float64bits(float64(m.Score))))
	}
	return i, nil
}

func (m *ConstraintsResponse) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *ConstraintsResponse) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ConstraintsRequest) Size() (n int) {
	var l int
	_ = l
	l = len(m.Constraints)
	if l > 0 {
...
func (m *ConstraintsResponse) Size() (n int) {
	var l int
	_ = l
	if len(m.Stores) > 0 {
...
func (m *ConstraintsRequest) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ConstraintsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ConstraintsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ConstraintsResponse) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ConstraintsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ConstraintsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Stores = append(m.Stores, cockroach_roachpb.StoreDescriptor{})
...
var fileDescriptorAdmin = []byte{
	...
	,
}
