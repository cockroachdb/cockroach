...
/*
	...
	It has these top-level messages:
		...
		ServerWarning
		ServerWarningsRequest
		ServerWarningsResponse
		DetailsRequest
		DetailsResponse
		NodesRequest
		NodesResponse
...
// ServerWarning represents a warning that the user should be notified about.
type ServerWarning struct {
	Server  string `protobuf:"bytes,1,opt,name=server,proto3" json:"server,omitempty"`
	Message string `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
}

func (m *ServerWarning) Reset()                    { *m = ServerWarning{} }
func (m *ServerWarning) String() string            { return proto.CompactTextString(m) }
func (*ServerWarning) ProtoMessage()               {}
func (*ServerWarning) Descriptor() ([]byte, []int) { return fileDescriptorAdmin, []int{24} }

// ServerWarningsRequest requests all server warnings.
type ServerWarningsRequest struct {
}

func (m *ServerWarningsRequest) Reset()                    { *m = ServerWarningsRequest{} }
func (m *ServerWarningsRequest) String() string            { return proto.CompactTextString(m) }
func (*ServerWarningsRequest) ProtoMessage()               {}
func (*ServerWarningsRequest) Descriptor() ([]byte, []int) { return fileDescriptorAdmin, []int{25} }

// ServerWarningsResponse returns all server warnings.
type ServerWarningsResponse struct {
	Warnings []ServerWarning `protobuf:"bytes,1,rep,name=warnings" json:"warnings"`
}

func (m *ServerWarningsResponse) Reset()                    { *m = ServerWarningsResponse{} }
func (m *ServerWarningsResponse) String() string            { return proto.CompactTextString(m) }
func (*ServerWarningsResponse) ProtoMessage()               {}
func (*ServerWarningsResponse) Descriptor() ([]byte, []int) { return fileDescriptorAdmin, []int{26} }
...
func init() {
	...
	proto.RegisterType((*ServerWarning)(nil), "cockroach.server.serverpb.ServerWarning")
	proto.RegisterType((*ServerWarningsRequest)(nil), "cockroach.server.serverpb.ServerWarningsRequest")
	proto.RegisterType((*ServerWarningsResponse)(nil), "cockroach.server.serverpb.ServerWarningsResponse")
...
type AdminClient interface {
	...
	// ServerWarnings returns any warnings that need to be shown to the user.
	ServerWarnings(ctx context.Context, in *ServerWarningsRequest, opts ...grpc.CallOption) (*ServerWarningsResponse, error)
}
...
func (c *adminClient) ServerWarnings(ctx context.Context, in *ServerWarningsRequest, opts ...grpc.CallOption) (*ServerWarningsResponse, error) {
	out := new(ServerWarningsResponse)
	err := grpc.Invoke(ctx, "/cockroach.server.serverpb.Admin/ServerWarnings", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AdminServer interface {
	...
	// ServerWarnings returns any warnings that need to be shown to the user.
	ServerWarnings(context.Context, *ServerWarningsRequest) (*ServerWarningsResponse, error)
}
...
func _Admin_ServerWarnings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ServerWarningsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdminServer).ServerWarnings(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cockroach.server.serverpb.Admin/ServerWarnings",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServer).ServerWarnings(ctx, req.(*ServerWarningsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Admin_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ServerWarnings",
			Handler:    _Admin_ServerWarnings_Handler,
		},
	},
...
func (m *ServerWarning) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *ServerWarning) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.Server) > 0 {
		data[i] = 0xa
		i++
		i = encodeVarintAdmin(data, i, uint64(len(m.Server)))
...
func (m *ServerWarningsRequest) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *ServerWarningsRequest) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ServerWarningsResponse) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *ServerWarningsResponse) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ServerWarning) Size() (n int) {
	var l int
	_ = l
	l = len(m.Server)
	if l > 0 {
...
func (m *ServerWarningsRequest) Size() (n int) {
	var l int
	_ = l
	return n
}

func (m *ServerWarningsResponse) Size() (n int) {
	var l int
	_ = l
	if len(m.Warnings) > 0 {
...
func (m *ServerWarning) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ServerWarning: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ServerWarning: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ServerWarningsRequest) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ServerWarningsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ServerWarningsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *ServerWarningsResponse) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ServerWarningsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ServerWarningsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Warnings = append(m.Warnings, ServerWarning{})
...
var fileDescriptorAdmin = []byte{
	...
	,
}
