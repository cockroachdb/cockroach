...
const (
	...
	ZoneConfigurationLevel_CLUSTER ZoneConfigurationLevel = 0
	// DATABASE indicates that this object uses a database-level Zone Configuration.
	ZoneConfigurationLevel_DATABASE ZoneConfigurationLevel = 1
	// TABLE indicates that this object uses a table-level Zone Configuration.
	ZoneConfigurationLevel_TABLE ZoneConfigurationLevel = 2
)
...
type TableDetailsResponse struct {
	...
	ZoneConfig *cockroach_config.ZoneConfig `protobuf:"bytes,6,opt,name=zone_config,json=zoneConfig" json:"zone_config,omitempty"`
...
func (c *adminClient) Drain(ctx context.Context, in *DrainRequest, opts ...grpc.CallOption) (*DrainResponse, error) {
	...
	err := grpc.Invoke(ctx, "/cockroach.server.serverpb.Admin/Drain", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminClient) ClusterFreeze(ctx context.Context, in *ClusterFreezeRequest, opts ...grpc.CallOption) (Admin_ClusterFreezeClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Admin_serviceDesc.Streams[0], c.cc, "/cockroach.server.serverpb.Admin/ClusterFreeze", opts...)
	if err != nil {
		return nil, err
	}
...
func _Admin_Drain_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cockroach.server.serverpb.Admin/Drain",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (m *TableDetailsResponse) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			if m.ZoneConfig == nil {
				m.ZoneConfig = &cockroach_config.ZoneConfig{}
			}
...
var fileDescriptorAdmin = []byte{
	...
	,
}
