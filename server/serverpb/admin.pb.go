...
type TableStatsResponse struct {
	...
	// replica_count is the number of active replicas which were found during
	// this query.
	ReplicaCount int64 `protobuf:"varint,2,opt,name=replica_count,json=replicaCount,proto3" json:"replica_count,omitempty"`
	// node_count is the number of nodes which should contain data for this table.
	NodeCount int64 `protobuf:"varint,3,opt,name=node_count,json=nodeCount,proto3" json:"node_count,omitempty"`
	// mvcc_stats is the summation of MVCCStats for all replicas of this table
	// across the cluster.
	MvccStats cockroach_storage_engine_enginepb.MVCCStats `protobuf:"bytes,4,opt,name=mvcc_stats,json=mvccStats" json:"mvcc_stats"`
	...
	MissingNodes []string `protobuf:"bytes,5,rep,name=missing_nodes,json=missingNodes" json:"missing_nodes,omitempty"`
}
...
func (m *TableStatsResponse) MarshalTo(data []byte) (int, error) {
	...
	data[i] = 0x22
	i++
	i = encodeVarintAdmin(data, i, uint64(m.MvccStats.Size()))
	n2, err := m.MvccStats.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n2
	if len(m.MissingNodes) > 0 {
		for _, s := range m.MissingNodes {
			data[i] = 0x2a
			i++
			l = len(s)
			for l >= 1<<7 {
...
func (m *TableStatsResponse) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			m.MissingNodes = append(m.MissingNodes, string(data[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipAdmin(data[iNdEx:])
...
var fileDescriptorAdmin = []byte{
	...
	,
}
