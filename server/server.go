...
func (s *Server) Start() error {
	...
	// write a status summary immediately; this helps the UI remain responsive
	// when new nodes are added.
	if err := s.node.writeSummaries(); err != nil {
		log.Warningf("error writing initial node summary: %s", err)
	}
