...
func (b *Batch) logRequest(arg roachpb.Request, level int) {
	...
	switch req := arg.(type) {
	case *roachpb.GetRequest:
		log.InfofDepth(b.Context, level, "Get %s", req.Key)
	case *roachpb.PutRequest:
		log.InfofDepth(b.Context, level, "Put %s -> %s", req.Key, req.Value.PrettyPrint())
	case *roachpb.ConditionalPutRequest:
		log.InfofDepth(b.Context, level, "CPut %s -> %s", req.Key, req.Value.PrettyPrint())
	case *roachpb.InitPutRequest:
		log.InfofDepth(b.Context, level, "InitPut %s -> %s", req.Key, req.Value.PrettyPrint())
	case *roachpb.IncrementRequest:
		log.InfofDepth(b.Context, level, "Increment %s by %v", req.Key, req.Increment)
	case *roachpb.ScanRequest:
		log.InfofDepth(b.Context, level, "Scan from %s to %s", req.Key, req.EndKey)
	case *roachpb.ReverseScanRequest:
		log.InfofDepth(b.Context, level, "Reverse scan from %s to %s", req.Key, req.EndKey)
	case *roachpb.DeleteRequest:
		log.InfofDepth(b.Context, level, "Del %s", req.Key)
	case *roachpb.DeleteRangeRequest:
		log.InfofDepth(b.Context, level, "DelRange %s", req.Key)
	case *roachpb.BeginTransactionRequest:
		log.InfofDepth(b.Context, level, "BeginTransaction %s", req.Key)
	case *roachpb.EndTransactionRequest:
		log.InfofDepth(b.Context, level, "EndTransaction %s", req.Key)
	case *roachpb.AdminMergeRequest:
		log.InfofDepth(b.Context, level, "AdminMerge from %s to %s", req.Key, req.EndKey)
	case *roachpb.AdminSplitRequest:
		log.InfofDepth(b.Context, level, "AdminSplit %s at %s", req.Key, req.SplitKey)
	case *roachpb.AdminTransferLeaseRequest:
		log.InfofDepth(b.Context, level, "AdminTransferLease %s to %s", req.Key, req.Target)
	case *roachpb.HeartbeatTxnRequest:
	...
	case *roachpb.RangeLookupRequest:
		log.InfofDepth(b.Context, level, "RangeLook at %s", req.Key)
	case *roachpb.ResolveIntentRequest:
		log.InfofDepth(b.Context, level, "ResolveIntent at %s for txn %s", req.Span, req.IntentTxn)
	case *roachpb.ResolveIntentRangeRequest:
		log.InfofDepth(b.Context, level, "ResolveIntentRange at %s for txn %s", req.Span, req.IntentTxn)
	case *roachpb.MergeRequest:
		log.InfofDepth(b.Context, level, "Merge at %s -> %s", req.Key, req.Value.PrettyPrint())
	case *roachpb.TruncateLogRequest:
		log.InfofDepth(b.Context, level, "TruncateLog at %s for range %v", req.Index, req.RangeID)
	case *roachpb.RequestLeaseRequest:
		log.InfofDepth(b.Context, level, "RequestLease at %s for lease %s", req.Key, req.Lease)
	case *roachpb.CheckConsistencyRequest:
		log.InfofDepth(b.Context, level, "CheckConsistency from %s to %s", req.Key, req.EndKey)
	case *roachpb.ChangeFrozenRequest:
		log.InfofDepth(b.Context, level, "ChangeFrozen from %s to %s", req.Key, req.EndKey)
	default:
