...
type Result struct {
	...
	// ResumeKey is the the start key to be used on the next operation in a
	...
	// a new start key and over a shorter span of keys. Exception: ResumeKey
	// is the updated end key for the ReverseScan operation.
