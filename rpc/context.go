...
// connection backoff.
func (ctx *Context) NewBackOff() backoff.BackOff {
	...
	//
	// TODO(peter): Add comment about disruption from setting MaxInterval beyond
	// the Raft election timeout.
