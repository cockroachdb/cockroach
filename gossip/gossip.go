...
type Gossip struct {
	...
	*server                           // Embedded gossip RPC server
	...
	systemConfigSet      bool // Whether the system config has been set
...
// CheckSystemConfig returns whether the system config has been set.
func (g *Gossip) CheckSystemConfig() bool {
	return g.systemConfigSet
}
