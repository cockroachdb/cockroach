...
// 10 simulation cycles. It's really difficult to determine the right
// number for cycles because different things can happen during a
// single cycle, depending on how much CPU time is
