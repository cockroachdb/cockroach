...
go_repository(
    ...
    # NB: repository as of commit b1667ff58f71
    urls = [
...
http_archive(
    ...
    urls = [
        "https://storage.googleapis.com/public-bazel-artifacts/build/cmake-3.19.6.tar.gz",
    ],
)
http_archive(
    name = "gnumake_src",
    ...
    urls = [
        "https://storage.googleapis.com/public-bazel-artifacts/build/make-4.3.tar.gz",
    ],
)
# NB: We don't use Ninja for anything. We're just including it here so we don't
# incidentally pull it from Github.
http_archive(
    ...
    urls = [
        "https://storage.googleapis.com/public-bazel-artifacts/build/ninja-1.10.2.tar.gz",
    ],
)
