...
go_download_sdk(
    name = "go_sdk",
    sdks = {
        "darwin_amd64": ("go1.21.1.darwin-amd64.tar.gz", "8e9c0c15083b29ddbe6698a69f8ec567ac690058eea25bd429e171b31b200c55"),
        "darwin_arm64": ("go1.21.1.darwin-arm64.tar.gz", "3fecd40f7bb7f1e8242e29a13fd0808b0d3de71d9706cfdbbf513ed3f157b7e7"),
        "freebsd_amd64": ("go1.21.1.freebsd-amd64.tar.gz", "2571f10f6047e04d87c1f5986a05e5e8f7b511faf98803ef12b66d563845d2a1"),
        "linux_amd64": ("go1.21.1.linux-amd64.tar.gz", "b04f523963cb5f8bcf297f3d24c6bd2134f32bf05be173509387b1f5e6e5ec21"),
        "linux_arm64": ("go1.21.1.linux-arm64.tar.gz", "626a591e469fe48f84bd603c2d021997949841e2f9cd07524075f9db7acf5cab"),
        "windows_amd64": ("go1.21.1.windows-amd64.tar.gz", "24024540aecba13265bfe0ac158ec459a1d0b6e9bad1c47d808a2462a1033516"),
    },
    urls = ["https://storage.googleapis.com/public-bazel-artifacts/go/20231009-181726/{}"],
    version = "1.21.1",
)
...
go_download_sdk(
    name = "go_sdk_fips",
    sdks = {
        "linux_amd64": ("go1.21.1fips.linux-amd64.tar.gz", "96926e3a55fc9631b31bf799f19442b8564ecfea753402560e5bfaa4a7e37808"),
    },
    urls = ["https://storage.googleapis.com/public-bazel-artifacts/go/20231009-181726/{}"],
    version = "1.21.1fips",
)
