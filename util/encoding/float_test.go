...
func TestEncodeFloat(t *testing.T) {
	testCases := []struct {
		...
		{math.NaN(), []byte{0x53}},
		{math.Inf(-1), []byte{0x54}},
		{-math.MaxFloat64, []byte{0x55, 0x64, 0xfc, 0x60, 0x66, 0x44, 0xe4, 0x9e, 0x82, 0xc0, 0x8d, 0x0}},
		{-1e308, []byte{0x55, 0x64, 0xfd, 0x0}},
		{-10000.0, []byte{0x5d, 0xfd, 0x0}},
		{-9999.0, []byte{0x5e, 0x38, 0x39, 0x00}},
		{-100.0, []byte{0x5e, 0xfd, 0x00}},
		{-99.0, []byte{0x5f, 0x39, 0x00}},
		{-1.0, []byte{0x5f, 0xfd, 0x0}},
		{-0.00123, []byte{0x61, 0x1, 0xe6, 0xc3, 0x0}},
		{-1e-307, []byte{0x61, 0x99, 0xeb, 0x0}},
		{-math.SmallestNonzeroFloat64, []byte{0x61, 0xa1, 0xf5, 0x0}},
		{0, []byte{0x62}},
		{math.SmallestNonzeroFloat64, []byte{0x63, 0x5e, 0xa, 0x0}},
		{1e-307, []byte{0x63, 0x66, 0x14, 0x0}},
		{0.00123, []byte{0x63, 0xfe, 0x19, 0x3c, 0x0}},
		{0.0123, []byte{0x64, 0x03, 0x2e, 0x0}},
		{0.123, []byte{0x64, 0x19, 0x3c, 0x0}},
		{1.0, []byte{0x65, 0x02, 0x0}},
		{10.0, []byte{0x65, 0x14, 0x0}},
		{12.345, []byte{0x65, 0x19, 0x45, 0x64, 0x0}},
		{99.0, []byte{0x65, 0xc6, 0x0}},
		{99.0001, []byte{0x65, 0xc7, 0x01, 0x02, 0x0}},
		{99.01, []byte{0x65, 0xc7, 0x02, 0x0}},
		{100.0, []byte{0x66, 0x02, 0x0}},
		{100.01, []byte{0x66, 0x03, 0x01, 0x02, 0x0}},
		{100.1, []byte{0x66, 0x03, 0x01, 0x14, 0x0}},
		{1234, []byte{0x66, 0x19, 0x44, 0x0}},
		{1234.5, []byte{0x66, 0x19, 0x45, 0x64, 0x0}},
		{9999, []byte{0x66, 0xc7, 0xc6, 0x0}},
		{9999.000001, []byte{0x66, 0xc7, 0xc7, 0x01, 0x01, 0x02, 0x0}},
		{9999.000009, []byte{0x66, 0xc7, 0xc7, 0x01, 0x01, 0x12, 0x0}},
		{9999.00001, []byte{0x66, 0xc7, 0xc7, 0x01, 0x01, 0x14, 0x0}},
		{9999.00009, []byte{0x66, 0xc7, 0xc7, 0x01, 0x01, 0xb4, 0x0}},
		{9999.000099, []byte{0x66, 0xc7, 0xc7, 0x01, 0x01, 0xc6, 0x0}},
		{9999.0001, []byte{0x66, 0xc7, 0xc7, 0x01, 0x02, 0x0}},
		{9999.001, []byte{0x66, 0xc7, 0xc7, 0x01, 0x14, 0x0}},
		{9999.01, []byte{0x66, 0xc7, 0xc7, 0x02, 0x0}},
		{9999.1, []byte{0x66, 0xc7, 0xc7, 0x14, 0x0}},
		{10000, []byte{0x67, 0x02, 0x0}},
		{10001, []byte{0x67, 0x03, 0x01, 0x02, 0x0}},
		{12345, []byte{0x67, 0x03, 0x2f, 0x5a, 0x0}},
		{123450, []byte{0x67, 0x19, 0x45, 0x64, 0x0}},
		{1e308, []byte{0x6f, 0x9b, 0x2, 0x0}},
		{math.MaxFloat64, []byte{0x6f, 0x9b, 0x3, 0x9f, 0x99, 0xbb, 0x1b, 0x61, 0x7d, 0x3f, 0x72, 0x0}},
		{math.Inf(1), []byte{0x70}},
	}
