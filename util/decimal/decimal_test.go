...
func TestCbrt(t *testing.T) {
	tests := []decimalOneArgTestCase{
		{"-567", "-8.276772529143362008397373325076"},
		{"-1", "-1.0"},
		{"-0.001", "-0.1"},
		{".00000001", "0.002154434690031883721759293567"},
		{".001234567898217312", "0.107276598202120561170376298872"},
		{".001", "0.1"},
		{".123", "0.497318983326859041565008338286"},
		{"0", "0"},
		{"1", "1"},
		{"2", "1.259921049894873164767210607278"},
		{"1000", "10.0"},
		{"1234567898765432112.2763812", "1072765.982179966856906447702463743971"},
	}
	testDecimalSingleArgFunc(t, Cbrt, 30, tests)
}
