...
// protocol. It should be called by a server after it has completed
// its initialization (including but not necessarily limited to
// binding ports) and is ready to receive traffic.
func Ready() error {
...
func Exec(cmd *exec.Cmd) error {
	...
	// TODO(bdarnell): this can leak goroutines, but we don't really
	// care because we always exit after calling this function.
