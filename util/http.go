...
// PostJSON uses the supplied client to perform a POST to the URL specified by the parameters and
// unmarshals the result into the supplied interface. This function assumes that the body
// is also JSON.
