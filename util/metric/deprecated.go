...
// newDeprecatedWindowedHistogram creates a new windowed HDRHistogram with the
// given parameters. Data is kept in the active window for approximately the
// given duration. See the documentation for hdrhistogram.WindowedHistogram for
// details.
func newDeprecatedWindowedHistogram(
