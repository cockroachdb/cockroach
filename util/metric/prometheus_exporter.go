...
//  pe.AddRegistry(nodeRegistry)
//  pe.AddRegistry(storeOneRegistry)
//  ...
//  pe.AddRegistry(storeNRegistry)
//  pe.Export(w)
type PrometheusExporter struct {
	families map[string]*prometheusgo.MetricFamily
}

// NewPrometheusExporter returns an initialized prometheus exporter.
...
// AddRegistry takes a registry and adds all metrics to the metric family map.
// It creates a new family if needed.
func (pm *PrometheusExporter) AddRegistry(registry *Registry) {
