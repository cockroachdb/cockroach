...
// or all of the new range's interval. Because the RangeGroup builds
// as more ranges are added, insertion order of the ranges is critical.
...
// added to the list, and false if it does increase the range, in which
// case it wont. If the range is added, the function will also attempt
...
// added to the tree, and false if it does increase the range, in which
// case it wont. If the range is added, the function will also attempt
...
// keyspace, or share an inclusive boundary.
