...
// IsSQLRetryError returns true if the error returned from cockroachDB's
// database/sql.DB is retryable. This is true for errors that show a
// connection issue or an issue with the node itself. This can occur when a
// node is restarting or is unstable in some other way.
