...
export interface roachpbBuilder {
	...
	ReplicaIdentifier: roachpb.ReplicaIdentifierBuilder;
...
declare module cockroach.roachpb {
	...
	export interface ReplicaIdentifier {
...
getReplica?() : ReplicaDescriptor;
	...
	export interface ReplicaIdentifierMessage extends ReplicaIdentifier {
	toArrayBuffer(): ArrayBuffer;
	encode(): ByteBuffer;
	encodeJSON(): string;
	toBase64(): string;
...
export interface ReplicaIdentifierBuilder {
	new(data?: ReplicaIdentifier): ReplicaIdentifierMessage;
	decode(buffer: ArrayBuffer) : ReplicaIdentifierMessage;
	decode(buffer: ByteBuffer) : ReplicaIdentifierMessage;
	decode64(buffer: string) : ReplicaIdentifierMessage;
...
getReplicas?() : ReplicaIdentifier[];
		setReplicas?(replicas : ReplicaIdentifier[]): void;
