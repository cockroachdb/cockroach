...
export let databaseDetailsReducerObj = new CachedDataReducer<DatabaseDetailsRequest, DatabaseDetailsResponseMessage>(api.getDatabaseDetails, "databaseDetails", databaseRequestToID);
...
export let tableDetailsReducerObj = new CachedDataReducer<TableDetailsRequest, TableDetailsResponseMessage>(api.getTableDetails, "tableDetails", tableRequestToID);
