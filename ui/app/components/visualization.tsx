...
interface VisualizationProps {
  ...
  subtitle?: string;
  tooltip?: string;
  // If warning or warningTitle exist, they are appended to the tooltip and the icon is changed to the warning icon.
  warningTitle?: string;
  warning?: string;
  // If stale is true, the visualization is faded and the icon is changed to a warning icon.
  stale?: boolean;
}
