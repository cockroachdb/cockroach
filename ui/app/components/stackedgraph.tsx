...
export class StackedAreaGraph extends React.Component<StackedAreaGraphProps, {}> {
  ...
  componentDidMount() {
    this.initChart();
    this.drawChart();
    // TODO (maxlang): Make this event listener more backwards compatible. (Note
    // the vendor prefixes here: https://developer.mozilla.org/en-US/docs/Web/API/Page_Visibility_API)
