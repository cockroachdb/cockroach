...
type TSQuery = cockroach.ts.QueryMessage;
 ...
 */
function queryFromProps(props: SelectorProps): TSQuery {
    return new protos.cockroach.ts.Query({
       ...
       * TimeSeriesQueryAggregator above. TSQuery expects values in terms of the
  ...
  private queriesSelector = createSelector(
    ...
    (children) => {
      ...
      while (remainingChildren.length > 0) {
        let child = remainingChildren.splice(0, 1)[0] as React.ReactElement<any>;
...
function timeSpanMatch(request: TSRequest, timeSpan: Long[]): boolean {
