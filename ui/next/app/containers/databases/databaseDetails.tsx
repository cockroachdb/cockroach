...
import { AdminUIStore } from "../../interfaces/store";
...
function getDatabaseDetails(state: AdminUIStore, props: DatabaseMainProps): DatabaseDetailsResponseMessage {
  return state.databaseInfo.tableDetails[props && props.params && props.params.database_name].data;
}

// Base selectors to extract data from redux state.
let tables = (state: any, props: any): string[] => getDatabaseDetails(state, props).table_names || [];
let grants = (state: any, props: any): Grant[] => getDatabaseDetails(state, props).grants || [];
  ...
  (dispatch: Dispatch, ownProps: any) => {
    return {
      ...
      refreshDatabaseDetails: function () {
        // create a new function that applies the appropriate database name to the refreshDatabaseDetails function
