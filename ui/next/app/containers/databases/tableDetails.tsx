...
function getTableDetails(state: AdminUIStore, props: TableMainProps): TableDetailsResponseMessage {
  return props && props.params && props.params.database_name &&
    props && props.params && props.params.table_name &&
    state.databaseInfo.tableDetails[generateTableID(props.params.database_name, props.params.table_name)].data;
}

// Base selectors to extract data from redux state.
let columns = (state: any, props: any): Column[] => getTableDetails(state, props).getColumns() || [];
let indexes = (state: any, props: any): Index[] => getTableDetails(state, props).getIndexes() || [];
let grants = (state: any, props: any): Grant[] => getTableDetails(state, props).getGrants() || [];
  ...
  (dispatch: Dispatch, ownProps: any) => {
    return {
      ...
      refreshTableDetails: function () {
        // create a new function that applies the appropriate database and table name to the refreshTableDetails function
