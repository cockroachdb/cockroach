...
type DatabasesRespone = cockroach.server.DatabasesResponse;
...
describe("rest api", function() {
  describe("databases request", function () {
    ...
    it("correctly requests info about all databases", function () {
      ...
      return getDatabaseList().then(function (result: DatabasesRespone) {
    ...
    it("correctly times out", function (done) {
      ...
      getDatabaseList().then(function (result: DatabasesRespone) {
