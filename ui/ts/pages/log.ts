  ...
  export module Log {
    ...
    export module Page {
      ...
      function reroute(): void {
        // TODO: This needs to change the URL without refreshing/redrawing the page,
        // because currently the inputs lose focus when it happens.
        m.route(entries.getURL(), entries.getParams(), true);
      }

      // We need to debounce the reroute, because it takes focus away from the inputs so otherwise you can't type
