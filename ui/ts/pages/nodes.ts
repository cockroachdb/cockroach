          ...
          if (allStats) {
            return m(".primary-stats", [
                ...
                },
                {
                  ...
                  visualizationArguments: {
                    format: ".0s",
                    data: {value: allStats["ranges.leader"]},
                  },
                },
                {
                  title: "Available",
                  visualizationArguments: {
                    format: "3%",
                    data: {value: allStats["ranges.available"] / allStats["ranges.leader"]},
                  },
                },
                {
                  ...
                  visualizationArguments: {
                    format: "3%",
                    data: {value: allStats["ranges.replicated"] / allStats["ranges.leader"]},
                  },
                },
