  ...
  export module Graph {
    ...
    export module Page {
      ...
      class Controller implements _mithril.MithrilController {
        ...
        // Define selectors.
        private successCount: Metrics.Select.Selector = Metrics.Select.Avg("cr.node.exec.num.success.1")
          .title("Successful calls");
        private errorCount: Metrics.Select.Selector = Metrics.Select.Avg("cr.node.exec.num.error.1")
          .title("Error calls");
        private successRate: Metrics.Select.Selector = Metrics.Select.AvgRate("cr.node.exec.num.success.1")
          .title("Successful call rate");
        private errorRate: Metrics.Select.Selector = Metrics.Select.AvgRate("cr.node.exec.num.error.1")
