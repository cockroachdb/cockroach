...
$(UI_JS): $(GO_PROTOS) $(COREOS_RAFT_PROTOS) $(UI_ROOT)/yarn.installed
	...
	cd $(UI_ROOT) && yarn run pbjs -t static-module -w es6 --strict-long --keep-case --path $(ORG_ROOT) --path $(GOGO_PROTOBUF_PATH) --path $(COREOS_PATH) --path $(GRPC_GATEWAY_GOOGLEAPIS_PATH) $(GW_PROTOS) >> $@

$(UI_TS): $(UI_JS)
	# Add comment recognized by reviewable.
	echo '// GENERATED FILE DO NOT EDIT' > $@
	cd $(UI_ROOT) && yarn run pbts $(UI_JS) >> $@
