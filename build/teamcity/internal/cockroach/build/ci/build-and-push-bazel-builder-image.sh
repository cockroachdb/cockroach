...
docker buildx build --platform linux/amd64,linux/arm64,linux/s390x -o "type=image,push=true,name=$gar_repository:$TAG,name=$gar_repository:latest-do-not-use" build/bazelbuilder
