...
# Set up environment variables for bazel support docker
teamcity_alternates="/home/agent/system/git"
export BAZEL_SUPPORT_EXTRA_DOCKER_ARGS="--volume ${teamcity_alternates}:${teamcity_alternates}:ro"
