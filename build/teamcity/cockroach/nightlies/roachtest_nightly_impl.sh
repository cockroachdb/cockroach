...
# incompatible with the selective-tests flag. If both are set, select-probability
# will be used regardless of what selective-tests is. If it isn't overriden in the
