...
bazel build //pkg/cmd/cockroach //pkg/compose/compare/compare:compare_test //c-deps:libgeos //build/bazelutil:test_force_build_cdeps --config=ci --config=crosslinux --config=test -c opt
