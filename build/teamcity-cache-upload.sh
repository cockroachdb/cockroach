...
mv work/.go/src/github.com/cockroachdb/cockroach $TMPDIR/
rm -rf work/.go
mkdir -p work/.go/src/github.com/cockroachdb
mv $TMPDIR/cockroach work/.go/src/github.com/cockroachdb/
