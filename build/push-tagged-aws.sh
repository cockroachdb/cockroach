...
# make_and_deploy_tarball takes the path to the binary inside the repo and the
# tarball base name.
# eg: make_and_deploy_tarball cockroach-darwin-10.9-amd64 cockroach.darwin-amd64
