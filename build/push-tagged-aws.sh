...
# Tar up and push linux binaries. One tagged, one called "latest".
...
# Tar up and push macOS binaries. One tagged, one called "latest". The local
# binary name is generated by build-osx.sh.
...
# Tar up and push Windows binaries. One tagged, one called "latest". The local
# binary name is generated by build-osx.sh.
