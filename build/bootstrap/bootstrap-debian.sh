...
# Install ARM64 support for docker.
sudo docker run --rm --privileged docker/binfmt:a7996909642ee92942dcd6cff44b9b95f08dad64
sudo docker rmi docker/binfmt:a7996909642ee92942dcd6cff44b9b95f08dad64
...
# Docker daemon needs this to properly fetch some binaries.
echo "net.ipv4.ip_forward=1" > /etc/sysctl.d/99-docker-enable-ipv4_forward.conf
