...
do
    ...
    then
        echo "File $BAZEL_BIN/docs/generated/http/$FILE does not exist as a generated artifact; it is checked in at `docs/generated/http`, but is not being built. Is docs/generated/http/BUILD.bazel up-to-date?"
        FAILED=1
    fi
done
...
do
    ...
    then
        echo "File $BAZEL_BIN/docs/generated/sql/$FILE does not exist as a generated artifact; it is checked in at `docs/generated/sql`, but is not being built. Is docs/generated/sql/BUILD.bazel up-to-date?"
        FAILED=1
    fi
done
...
do
    ...
    then
        echo "File $BAZEL_BIN/docs/generated/sql/bnf/$FILE does not exist as a generated artifact; it is checked in at `docs/generated/sql/bnf`, but is not being built. Is docs/generated/sql/bnf/BUILD.bazel up-to-date?"
        FAILED=1
    fi
done
