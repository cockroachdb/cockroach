...
_bazel/bin/pkg/cmd/bazci/extract-test-results/extract-test-results_/extract-test-results -eventsfile $1 -servername mesolite -cert /home/agent/engflow.crt -key /home/agent/engflow.key > test-results.json
