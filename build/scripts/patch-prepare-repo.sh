...
echo "Running gazelle update ${@:3} --go_prefix=\"$IMPORT_PATH\" --repo_root=."
go run github.com/bazelbuild/bazel-gazelle/cmd/gazelle@v0.37.0 update ${@:3} --go_prefix="$IMPORT_PATH" --repo_root=.
