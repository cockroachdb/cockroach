...
pkg/sql/opt/memo/check_expr.go://go:build crdb_test
pkg/sql/opt/memo/check_expr_skip.go://go:build !crdb_test
pkg/sql/opt/memo/filters_expr_mutate_checker.go://go:build crdb_test
pkg/sql/opt/memo/filters_expr_mutate_checker_skip.go://go:build !crdb_test
pkg/sql/opt/props/verify.go://go:build crdb_test
pkg/util/a_crdb_test_bazel.go://go:build bazel
pkg/util/crdb_test_off.go://go:build !crdb_test || crdb_test_off
pkg/util/crdb_test_on.go://go:build crdb_test && !crdb_test_off
"
...
git grep '//go:build' pkg | grep crdb_test | while read LINE; do
    ...
    echo 'See pkg/sql/opt/memo/BUILD.bazel for an example.'
