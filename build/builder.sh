...
vols="${vols} --volume=${gocache}/pkg/docker_amd64_release:/go/pkg/linux_amd64_release"
vols="${vols} --volume=${gocache}/pkg/docker_amd64_msan:/go/pkg/linux_amd64_msan"
vols="${vols} --volume=${gocache}/pkg/docker_amd64_musl_msan:/go/pkg/linux_amd64_musl_msan"
vols="${vols} --volume=${gocache}/pkg/docker_amd64_release_msan:/go/pkg/linux_amd64_release_msan"
vols="${vols} --volume=${gocache}/pkg/docker_amd64_race:/go/pkg/linux_amd64_race"
vols="${vols} --volume=${gocache}/pkg/docker_amd64_musl_race:/go/pkg/linux_amd64_musl_race"
vols="${vols} --volume=${gocache}/pkg/docker_amd64_release_race:/go/pkg/linux_amd64_release_race"
...
vols="${vols} --volume=${gocache}/pkg/docker_amd64_release:/usr/local/go/pkg/linux_amd64_release"
vols="${vols} --volume=${gocache}/pkg/docker_amd64_msan:/usr/local/go/pkg/linux_amd64_msan"
vols="${vols} --volume=${gocache}/pkg/docker_amd64_musl_msan:/usr/local/go/pkg/linux_amd64_musl_msan"
vols="${vols} --volume=${gocache}/pkg/docker_amd64_release_msan:/usr/local/go/pkg/linux_amd64_release_msan"
vols="${vols} --volume=${gocache}/pkg/docker_amd64_race:/usr/local/go/pkg/linux_amd64_race"
vols="${vols} --volume=${gocache}/pkg/docker_amd64_musl_race:/usr/local/go/pkg/linux_amd64_musl_race"
vols="${vols} --volume=${gocache}/pkg/docker_amd64_release_race:/usr/local/go/pkg/linux_amd64_release_race"
