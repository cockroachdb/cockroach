...
# cache is only collected from container (shard) 0. We workaround this
# limitation by copying the build output from shards 1 and 2 over to
# shard 0. On shard 0 we wait for this remote data to be copied.
