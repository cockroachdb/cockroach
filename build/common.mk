...
# already run in CI.
override ROCKSDB_ASSERTIONS_TAG := $(if $(RACE_TAG),_assert)

# Tags that apply to every C/C++ dependency.
override STANDARD_C_DEP_TAGS := $(MSAN_TAG)
...
JEMALLOC_DIR := $(BUILD_DIR)/jemalloc$(STANDARD_C_DEP_TAGS)
PROTOBUF_DIR := $(BUILD_DIR)/protobuf$(STANDARD_C_DEP_TAGS)
ROCKSDB_DIR  := $(BUILD_DIR)/rocksdb$(STANDARD_C_DEP_TAGS)$(STDMALLOC_TAG)$(ROCKSDB_ASSERTION_TAG)
SNAPPY_DIR   := $(BUILD_DIR)/snappy$(STANDARD_C_DEP_TAGS)
