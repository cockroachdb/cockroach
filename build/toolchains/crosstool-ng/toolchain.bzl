def _impl(rctx):
    if rctx.attr.host == "x86_64":
        url = "https://storage.googleapis.com/public-bazel-artifacts/toolchains/crosstool-ng/{}/20240711-195209/{}.tar.gz".format(rctx.attr.host, rctx.attr.target)
    elif rctx.attr.host == "aarch64":
        url = "https://storage.googleapis.com/public-bazel-artifacts/toolchains/crosstool-ng/{}/20240711-192530/{}.tar.gz".format(rctx.attr.host, rctx.attr.target)
