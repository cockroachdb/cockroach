def _impl(rctx):
    if rctx.attr.host == "x86_64":
        url = "https://storage.googleapis.com/public-bazel-artifacts/toolchains/crosstool-ng/{}/20260416-234436/{}.tar.gz".format(rctx.attr.host, rctx.attr.target)
    elif rctx.attr.host == "aarch64":
        url = "https://storage.googleapis.com/public-bazel-artifacts/toolchains/crosstool-ng/{}/20260416-225204/{}.tar.gz".format(rctx.attr.host, rctx.attr.target)
