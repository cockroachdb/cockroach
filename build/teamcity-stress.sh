...
if [ $exit_status -ne 0 ]; then
  build/builder.sh env GITHUB_API_TOKEN="$GITHUB_API_TOKEN" BUILD_VCS_NUMBER="$BUILD_VCS_NUMBER" TC_BUILD_ID="$TC_BUILD_ID" TC_SERVER_URL="$TC_SERVER_URL" PKG="$PKG" github-post < artifacts/stress.log
fi;
