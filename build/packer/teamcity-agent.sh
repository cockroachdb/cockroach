...
EOF
# Some images come with apt autoupgrade job running at start.
echo "Waiting for the lock to allow the apt daily cronjob to finish..."
apt-get -o DPkg::Lock::Timeout=300 update --yes
