...
// Aborted.
// 4) If the Begin were to execute now, it'd discover the Aborted txn and return a retryable TxnAbortedError. But it doesn't execute now; it's still delayed somehow.
