...
func (s *TenantServer) RegisterDRPCService(d drpc.Mux) error {
	return tspb.DRPCRegisterTimeSeries(d, s.AsDRPCServer())
}

// RegisterGateway starts the gateway (i.e. reverse proxy) that proxies HTTP requests
// to the appropriate gRPC endpoints.
func (t *TenantServer) RegisterGateway(
...
func (s *Server) AsDRPCServer() tspb.DRPCTimeSeriesServer {
	return &drpcServer{Server: s}
}
...
func (t *TenantServer) AsDRPCServer() tspb.DRPCTimeSeriesServer {
	return &drpcTenantServer{TenantServer: t}
}
