...
var TimeseriesStorageEnabled = settings.TenantWritable.RegisterBoolSetting(
...
var Resolution10sStorageTTL = settings.TenantWritable.RegisterDurationSetting(
...
// deletion.
var Resolution30mStorageTTL = settings.TenantWritable.RegisterDurationSetting(
