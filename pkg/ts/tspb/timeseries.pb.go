...
func (*DumpRequest) Descriptor() ([]byte, []int) { return fileDescriptorTimeseries, []int{5} }
...
type TimeSeriesClient interface {
	...
	// Dump returns a stream of all of the raw TimeSeriesData. No
	// downsampling, interpolation or other processing is performed.
...
func (c *timeSeriesClient) Dump(ctx context.Context, in *DumpRequest, opts ...grpc.CallOption) (TimeSeries_DumpClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_TimeSeries_serviceDesc.Streams[0], c.cc, "/cockroach.ts.tspb.TimeSeries/Dump", opts...)
	if err != nil {
		return nil, err
	}
...
var fileDescriptorTimeseries = []byte{
	...
	,
}
