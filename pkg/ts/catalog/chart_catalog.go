	...
	},
	{
		...
		Charts: []chartDescription{
			...
			},
			{
				...
				Metrics: []string{
					"internal.rpc.batches",
				},
			},
			{
				Title: "Batch Requests Received",
				Metrics: []string{
					"internal.batch.rpc.addsstable.recv",
					"internal.batch.rpc.adminchangereplicas.recv",
					"internal.batch.rpc.adminmerge.recv",
					"internal.batch.rpc.adminrelocaterange.recv",
					"internal.batch.rpc.adminscatter.recv",
					"internal.batch.rpc.adminsplit.recv",
					"internal.batch.rpc.admintransferlease.recv",
					"internal.batch.rpc.adminunsplit.recv",
					"internal.batch.rpc.adminverifyprotectedtimestamp.recv",
					"internal.batch.rpc.barrier.recv",
					"internal.batch.rpc.checkconsistency.recv",
					"internal.batch.rpc.clearrange.recv",
					"internal.batch.rpc.computechecksum.recv",
					"internal.batch.rpc.conditionalput.recv",
					"internal.batch.rpc.delete.recv",
					"internal.batch.rpc.deleterange.recv",
					"internal.batch.rpc.endtxn.recv",
					"internal.batch.rpc.export.recv",
					"internal.batch.rpc.gc.recv",
					"internal.batch.rpc.get.recv",
					"internal.batch.rpc.heartbeattxn.recv",
					"internal.batch.rpc.import.recv",
					"internal.batch.rpc.increment.recv",
					"internal.batch.rpc.initput.recv",
					"internal.batch.rpc.leaseinfo.recv",
					"internal.batch.rpc.merge.recv",
					"internal.batch.rpc.migrate.recv",
					"internal.batch.rpc.pushtxn.recv",
					"internal.batch.rpc.put.recv",
					"internal.batch.rpc.queryintent.recv",
					"internal.batch.rpc.queryresolvedtimestamp.recv",
					"internal.batch.rpc.querytxn.recv",
					"internal.batch.rpc.rangestats.recv",
					"internal.batch.rpc.recomputestats.recv",
					"internal.batch.rpc.recovertxn.recv",
					"internal.batch.rpc.refresh.recv",
					"internal.batch.rpc.refreshrange.recv",
					"internal.batch.rpc.requestlease.recv",
					"internal.batch.rpc.resolveintent.recv",
					"internal.batch.rpc.resolveintentrange.recv",
					"internal.batch.rpc.reversescan.recv",
					"internal.batch.rpc.revertrange.recv",
					"internal.batch.rpc.scan.recv",
					"internal.batch.rpc.scaninterleavedintents.recv",
					"internal.batch.rpc.subsume.recv",
					"internal.batch.rpc.transferlease.recv",
					"internal.batch.rpc.truncatelog.recv",
					"internal.batch.rpc.writebatch.recv",
				},
			},
			{
				Title: "Requests",
