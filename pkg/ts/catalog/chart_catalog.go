		...
		Charts: []chartDescription{
			{
				...
				Metrics: []string{
					...
					"admission.admitted.kv-stores.100",
					...
					"admission.errored.kv-stores.100",
					"admission.errored.kv.0",
					"admission.errored.kv.100",
					"admission.errored.sql-kv-response.0",
					"admission.errored.sql-kv-response.100",
					"admission.requested.kv-stores.0",
					"admission.requested.kv-stores.100",
					"admission.requested.kv.0",
					"admission.requested.kv.100",
					"admission.requested.sql-kv-response.0",
					"admission.requested.sql-kv-response.100",
					"admission.admitted.elastic-cpu.-30",
					"admission.admitted.sql-leaf-start.0",
					"admission.admitted.sql-leaf-start.100",
					"admission.admitted.sql-root-start.0",
					"admission.admitted.sql-root-start.100",
					"admission.admitted.sql-sql-response.0",
					"admission.admitted.sql-sql-response.100",
					"admission.errored.elastic-cpu.-30",
					"admission.errored.sql-leaf-start.0",
					"admission.errored.sql-leaf-start.100",
					"admission.errored.sql-root-start.0",
					"admission.errored.sql-root-start.100",
					"admission.errored.sql-sql-response.0",
					"admission.errored.sql-sql-response.100",
					"admission.requested.elastic-cpu.-30",
					"admission.requested.sql-leaf-start.0",
					"admission.requested.sql-leaf-start.100",
					"admission.requested.sql-root-start.0",
					"admission.requested.sql-root-start.100",
					"admission.requested.sql-sql-response.0",
					"admission.requested.sql-sql-response.100",
				},
			},
			{
				...
				Metrics: []string{
					...
					"admission.wait_queue_length.kv-stores.100",
					"admission.wait_queue_length.kv.0",
					"admission.wait_queue_length.kv.100",
					"admission.wait_queue_length.sql-kv-response.0",
					"admission.wait_queue_length.sql-kv-response.100",
					"admission.wait_queue_length.elastic-cpu.-30",
					"admission.wait_queue_length.sql-leaf-start.0",
					"admission.wait_queue_length.sql-leaf-start.100",
					"admission.wait_queue_length.sql-root-start.0",
					"admission.wait_queue_length.sql-root-start.100",
					"admission.wait_queue_length.sql-sql-response.0",
					"admission.wait_queue_length.sql-sql-response.100",
					"admission.wait_queue_length.elastic-cpu.-30",
					"admission.wait_queue_length.sql-leaf-start.0",
					"admission.wait_queue_length.sql-leaf-start.100",
					"admission.wait_queue_length.sql-root-start.0",
			...
			},
			{
				...
				Metrics: []string{
					...
					"admission.wait_sum.kv-stores.100",
					"admission.wait_sum.kv.0",
					"admission.wait_sum.kv.100",
					"admission.wait_sum.sql-kv-response.0",
					"admission.wait_sum.sql-kv-response.100",
					"admission.wait_sum.elastic-cpu.-30",
					"admission.wait_sum.sql-leaf-start.0",
					"admission.wait_sum.sql-leaf-start.100",
					"admission.wait_sum.sql-root-start.0",
					"admission.wait_sum.sql-root-start.100",
					"admission.wait_sum.sql-sql-response.0",
					"admission.wait_sum.sql-sql-response.100",
				},
			},
			{
				...
				Metrics: []string{
					...
					"admission.wait_durations.kv-stores.0",
					"admission.wait_durations.kv-stores.100",
					"admission.wait_durations.kv.0",
					"admission.wait_durations.kv.100",
					"admission.wait_durations.sql-kv-response.0",
					"admission.wait_durations.sql-kv-response.100",
					"admission.wait_durations.elastic-cpu.-30",
					"admission.wait_durations.sql-leaf-start.0",
					"admission.wait_durations.sql-leaf-start.100",
					"admission.wait_durations.sql-root-start.0",
					"admission.wait_durations.sql-root-start.100",
					"admission.wait_durations.sql-sql-response.0",
					"admission.wait_durations.sql-sql-response.100",
				},
			},
			{
				Title: "Granter",
