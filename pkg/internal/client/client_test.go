...
func TestReadOnlyTxnObeysDeadline(t *testing.T) {
	...
	if err := txn.Exec(context.TODO(), client.TxnExecOptions{AutoRetry: false, AutoCommit: true}, func(ctx context.Context, txn *client.Txn, _ *client.TxnExecOptions) error {
