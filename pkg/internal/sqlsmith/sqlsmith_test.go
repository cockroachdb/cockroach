...
// context.
//
// This test is meant to catch these types of regression in sqlsmith or
// rand-tables. It creates 5 random tables, and performs up to 100 inserts. The
// test fails if not a single row was inserted.
//
