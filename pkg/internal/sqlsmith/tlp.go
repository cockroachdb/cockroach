...
// are supported are MAX(), MIN(), SUM() and COUNT(). AVG() is also a valid TLP
// aggregation, and the SUM/COUNT implementations can be extended to be
...
// corresponding MIN version of the queries. For the COUNT/SUM version, we
