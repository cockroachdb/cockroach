...
// Logic Partitioning (TLP). TLP is a method for logically testing DBMS's which
...
// tested. It is possible to implement forms of TLP to test aggregations, GROUP
// BY, HAVING, and JOINs. See
