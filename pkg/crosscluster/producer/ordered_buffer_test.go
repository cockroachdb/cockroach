...
// adds all events to the buffer, then incrementally flushes at successive resolved
// timestamps and reads back events to verify correctness at each checkpoint.
