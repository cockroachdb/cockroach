...
func alterTenantRestartReplication(
	...
	streamAddress := crosscluster.SourceClusterUri(srcUri)
	...
	client, err := streamclient.NewStreamClient(ctx, crosscluster.SourceClusterUri(srcUri), p.ExecCfg().InternalDB)
	if err != nil {
