...
import (
	...
	"github.com/cockroachdb/cockroach/pkg/crosscluster/externalcatalog/externalpb"
...
func IngestExternalCatalog(
	...
	// TODO: consider pulling the DescTxn outside of this function.
	return sql.DescsTxn(ctx, execCfg, func(
		...
		tablesToWrite := make([]catalog.TableDescriptor, 0)
