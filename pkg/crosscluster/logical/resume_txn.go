...
//
// endTime is an inclusive upper bound: txns with timestamp <= endTime are
// applied, txns with timestamp > endTime are not. On the initial attempt it is
// hlc.MaxTimestamp (unbounded).
//
