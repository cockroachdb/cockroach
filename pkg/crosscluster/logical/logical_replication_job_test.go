...
func TestUserPrivileges(t *testing.T) {
	...
	t.Run("replication-src", func(t *testing.T) {
		dbA.ExpectErr(t, "user testuser3 does not have REPLICATION system privilege", createStmt, dbBURL2.String())
		...
		dbB.Exec(t, fmt.Sprintf("REVOKE SYSTEM REPLICATION FROM %s", username.TestUser+"3"))
	})
