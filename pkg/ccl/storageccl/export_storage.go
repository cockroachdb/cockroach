...
func MakeExportStorage(
	...
	case roachpb.ExportStorageProvider_Workload:
		if !settings.Version.IsMinSupported(cluster.VersionExportStorageWorkload) {
			return nil, errors.Errorf(
				"experimental-workload requires all nodes to be upgraded to %s",
				cluster.VersionByKey(cluster.VersionExportStorageWorkload))
		}
