...
const (
	keyFile128 string = "111111111111111111111111111111111234567890123456"
	keyFile192 string = "22222222222222222222222222222222123456789012345678901234"
	keyFile256 string = "3333333333333333333333333333333312345678901234567890123456789012"
	key128     string = "1234567890123456"
	key192     string = "123456789012345678901234"
	key256     string = "12345678901234567890123456789012"

	// Hex of the binary value of the first KeyIDLength of key files
	keyId128 string = "3131313131313131313131313131313131313131313131313131313131313131"
	keyId192 string = "3232323232323232323232323232323232323232323232323232323232323232"
	keyId256 string = "3333333333333333333333333333333333333333333333333333333333333333"
)

func TestStoreKeyManager_LoadErrors(t *testing.T) {
...
func TestStoreKeyManager(t *testing.T) {
	...
	kmTimeNow = func() time.Time { return time.Unix(5, 0) }
		...
		func(d *datadriven.TestData) string {
			...
			case "init":
				...
				if len(data) > 2 {
					...
					writeToFile(t, memFS, memFS.PathJoin(data[0], keyRegistryFilename), bytes)
				}
				return ""
			case "load":
