...
func (EncryptionType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_key_registry_7797fb5798d9fb20, []int{0}
}
...
func (*KeyInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_key_registry_7797fb5798d9fb20, []int{1}
}
...
func (*SecretKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_key_registry_7797fb5798d9fb20, []int{2}
}
...
func (*EncryptionSettings) Descriptor() ([]byte, []int) {
	return fileDescriptor_key_registry_7797fb5798d9fb20, []int{3}
}
...
func init() {
	proto.RegisterFile("ccl/storageccl/engineccl/enginepbccl/key_registry.proto", fileDescriptor_key_registry_7797fb5798d9fb20)
}

var fileDescriptor_key_registry_7797fb5798d9fb20 = []byte{
