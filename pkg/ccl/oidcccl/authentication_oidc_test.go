...
func TestOIDCBadRequestIfDisabled(t *testing.T) {
	...
	resp, err := client.Get(s.AdminURL() + "/v1/oidc/login")
	if err != nil {
			...
			fakeDiscoveryDocument := `
{
 ...
 "grant_types_supported": [
  ...
  "urn:ietf:params:oauth:grant-type:jwt-bearer"
	...
	sqlDB.Exec(t, `SET CLUSTER SETTING server.oidc_authentication.redirect_url = "https://cockroachlabs.com/"`)
	...
	const expectedRedirectURL = "https://cockroachlabs.com/v1/oidc/callback"
