...
var OIDCRedirectURL = func() *settings.StringSetting {
	s := settings.RegisterValidatedStringSetting(
		...
		"sets OIDC redirect URL (base HTTP URL, likely your load balancer, "+
			"CRDB will automatically append `/v1/oidc/callback` to the value) (this feature is experimental)",
