...
// ErrIfNotEnterpriseEnabled returns a non-nil error if the requested enterprise
// feature is not enabled, including information or a link explaining how to
// enable it.
func ErrIfNotEnterpriseEnabled(feature string) error {
	...
	return errors.Errorf(
		"Use of %s requires an enterprise license. "+
			"See %s details on how to enable enterprise features.",
		feature,
		link,
	)
}
