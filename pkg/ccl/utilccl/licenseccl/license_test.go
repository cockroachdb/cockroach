...
func TestExpiredLicenseLanguage(t *testing.T) {
	...
	expected := "Use of RESTORE requires an enterprise license. Your enterprise trial license " +
		"expired on January 1, 1970. If you're interested in getting a new license, please contact " +
