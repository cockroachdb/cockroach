...
// SkipTenantWatcher indicates that the directory cache should not run the
// tenant watcher.
func SkipTenantWatcher() func(opts *dirOptions) {
	return func(opts *dirOptions) {
		opts.skipTenantWatcher = true
	}
}
...
func NewDirectoryCache(
	...
	if !dir.options.skipTenantWatcher {
