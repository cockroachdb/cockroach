...
//
// This also does not support transferring messages with a large state (> 1 MiB).
// This may occur if a user sets their cluster settings to large values. We can
...
//
// TODO(jaylim-crl): Address the 1 MiB limitation above. We plan to move this
// into the database for SHOW TRANSFER STATE to return a SQL error, which makes
// this a recoverable connection if the state is too large.
