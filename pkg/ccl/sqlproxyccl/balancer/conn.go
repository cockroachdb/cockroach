...
// Conn represents a connection handle, with tracker-related metadata, which
// will be set by the balancer.
//
// TODO(jaylim-crl): Add connection-related metadata here (e.g. last transfer
// time).
type Conn struct {
	ConnectionHandle
}
