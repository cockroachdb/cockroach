...
type Balancer struct {
	...
	TestingKnobs struct {
		SelectTenantPod func(rand float32, pods []*tenant.Pod) *tenant.Pod
	}
}
...
func (b *Balancer) SelectTenantPod(pods []*tenant.Pod) (*tenant.Pod, error) {
	selectFn := selectTenantPod
	if b.TestingKnobs.SelectTenantPod != nil {
		selectFn = b.TestingKnobs.SelectTenantPod
	}
	pod := selectFn(b.randFloat32(), pods)
	if pod == nil {
