...
//
// Licensed as a CockroachDB Enterprise cle under the Cockroach Community
// License (the "License"); you may not use this cle except in compliance with
...
func NewFrontendConn(src net.Conn) *FrontendConn {
	return &FrontendConn{
		Conn:        src,
		interceptor: newPgInterceptor(src, defaultBufferSize),
	}
}
