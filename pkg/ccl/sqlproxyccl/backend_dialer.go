...
var BackendDial = func(
	...
	defer closeIfCancelled(ctx, conn)()
...
// closeIfCancelled will close the connection if the context is cancelled
// before the cleanup function is called.
func closeIfCancelled(ctx context.Context, conn net.Conn) (cleanup func()) {
