...
// but this is not guaranteed. The caller should still attempt to cleanup the
// connections.
//
...
// Ideally, the forwarder should be closed whenever one calls Close explicitly,
// or when any of its main goroutines has terminated, whichever happens first.
//
