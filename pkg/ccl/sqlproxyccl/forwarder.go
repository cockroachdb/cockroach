...
// errForwarderStarted will be returned when Run is called more than once to
// denote that the forwarder has already been started.
var errForwarderStarted = errors.New("forwarder has already been started")
