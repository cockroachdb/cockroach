...
func (s mockNodeStore) GetNodeDescriptor(id roachpb.NodeID) (*roachpb.NodeDescriptor, error) {
	...
	return nil, errors.Errorf("unable to look up descriptor for node ID %d", int32(id))
}

func (s mockNodeStore) GetNodeDescriptorByStoreID(id roachpb.StoreID) (*roachpb.NodeDescriptor, error) {
	return nil, errors.Errorf("unable to look up descriptor for store ID %d", int32(id))
}
