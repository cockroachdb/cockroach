...
`); err != nil {
	...
	secondaryIndexKey, err := rowenc.EncodeSecondaryIndex(
		...
		colIDtoRowIndex, values, rowenc.VectorIndexEncodingHelper{}, true, /* includeEmpty */
	)
	if err != nil {
		t.Fatalf("unexpected error %s", err)
	}
...
`); err != nil {
	...
	secondaryIndexDelKey, err := rowenc.EncodeSecondaryIndex(
		context.Background(), codec, tableDesc, secondaryIndex,
		colIDtoRowIndex, oldValues, rowenc.VectorIndexEncodingHelper{}, true, /* includeEmpty */
	)
	if err != nil {
		t.Fatalf("unexpected error: %s", err)
	}
...
`); err != nil {
	...
	secondaryIndexKey, err := rowenc.EncodeSecondaryIndex(
		context.Background(), codec, tableDesc, secondaryIndex,
		colIDtoRowIndex, valuesConstrained, rowenc.VectorIndexEncodingHelper{}, true, /* includeEmpty */
	)
	if err != nil {
		t.Fatalf("unexpected error: %s", err)
	}
	...
	secondaryIndexKey, err = rowenc.EncodeSecondaryIndex(
		...
		rowenc.VectorIndexEncodingHelper{}, true, /* includeEmpty */
	)
	if err != nil {
		t.Fatalf("unexpected error: %s", err)
	}
