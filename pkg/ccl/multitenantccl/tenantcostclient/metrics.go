...
var (
	...
	metaTotalExternalIOEgressBytes = metric.Metadata{
		Name:        "tenant.cost_client.external_io_egress_bytes",
	...
	metaTotalCrossRegionNetworkRU = metric.Metadata{
		Name:        "tenant.cost_client.cross_region_network_ru",
