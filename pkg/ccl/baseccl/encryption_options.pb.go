...
func (EncryptionKeySource) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_encryption_options_da37372b1cf064db, []int{0}
}
...
func (*EncryptionOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_encryption_options_da37372b1cf064db, []int{1}
}
...
func init() {
	proto.RegisterFile("ccl/baseccl/encryption_options.proto", fileDescriptor_encryption_options_da37372b1cf064db)
}

var fileDescriptor_encryption_options_da37372b1cf064db = []byte{
