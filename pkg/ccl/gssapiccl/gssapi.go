...
func authGSS(
	...
	if u, err := username.MakeSQLUsernameFromUserInput(gssUser, username.UsernameValidation); err != nil {
		return nil, err
	} else {
...
func stripRealm(u username.SQLUsername) (username.SQLUsername, error) {
	...
	return username.MakeSQLUsernameFromUserInput(norm, username.UsernameValidation)
}
