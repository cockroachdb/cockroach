...
func TestBackupRollbacks_ccl_alter_table_alter_primary_key_rbr(t *testing.T) {
	defer leaktest.AfterTest(t)()
	defer log.Scope(t).Close(t)
...
func TestBackupRollbacksMixedVersion_ccl_alter_table_alter_primary_key_rbr(t *testing.T) {
	defer leaktest.AfterTest(t)()
	defer log.Scope(t).Close(t)
	const path = "pkg/ccl/schemachangerccl/testdata/end_to_end/alter_table_alter_primary_key_rbr"
	sctest.BackupRollbacksMixedVersion(t, path, MultiRegionTestClusterFactory{})
...
func TestBackupSuccess_ccl_alter_table_alter_primary_key_rbr(t *testing.T) {
	defer leaktest.AfterTest(t)()
	defer log.Scope(t).Close(t)
	const path = "pkg/ccl/schemachangerccl/testdata/end_to_end/alter_table_alter_primary_key_rbr"
	sctest.BackupSuccess(t, path, MultiRegionTestClusterFactory{})
...
func TestBackupSuccessMixedVersion_ccl_alter_table_alter_primary_key_rbr(t *testing.T) {
	defer leaktest.AfterTest(t)()
	defer log.Scope(t).Close(t)
	const path = "pkg/ccl/schemachangerccl/testdata/end_to_end/alter_table_alter_primary_key_rbr"
	sctest.BackupSuccessMixedVersion(t, path, MultiRegionTestClusterFactory{})
