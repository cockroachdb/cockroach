...
func TestBackup_base_alter_table_add_check_not_valid(t *testing.T) {
	defer leaktest.AfterTest(t)()
	defer log.Scope(t).Close(t)
	sctest.Backup(t, "pkg/sql/schemachanger/testdata/end_to_end/alter_table_add_check_not_valid", newCluster)
}
...
func TestBackup_base_alter_table_add_foreign_key_not_valid(t *testing.T) {
	defer leaktest.AfterTest(t)()
	defer log.Scope(t).Close(t)
	sctest.Backup(t, "pkg/sql/schemachanger/testdata/end_to_end/alter_table_add_foreign_key_not_valid", newCluster)
}
...
func TestBackup_base_alter_table_add_unique_without_index_not_valid(t *testing.T) {
	defer leaktest.AfterTest(t)()
	defer log.Scope(t).Close(t)
	sctest.Backup(t, "pkg/sql/schemachanger/testdata/end_to_end/alter_table_add_unique_without_index_not_valid", newCluster)
}
