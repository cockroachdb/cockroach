...
func TestBackupMixedVersionElements_base_create_database(t *testing.T) {
	defer leaktest.AfterTest(t)()
	defer log.Scope(t).Close(t)
	sctest.BackupMixedVersionElements(t, "pkg/sql/schemachanger/testdata/end_to_end/create_database", sctest.SingleNodeMixedCluster)
}
func TestBackupMixedVersionElements_base_create_database_drop_database_separate_statements(t *testing.T) {
	defer leaktest.AfterTest(t)()
	defer log.Scope(t).Close(t)
	sctest.BackupMixedVersionElements(t, "pkg/sql/schemachanger/testdata/end_to_end/create_database_drop_database_separate_statements", sctest.SingleNodeMixedCluster)
}
...
func TestBackupMixedVersionElements_base_create_index_create_database_separate_statements(t *testing.T) {
	defer leaktest.AfterTest(t)()
	defer log.Scope(t).Close(t)
	sctest.BackupMixedVersionElements(t, "pkg/sql/schemachanger/testdata/end_to_end/create_index_create_database_separate_statements", sctest.SingleNodeMixedCluster)
}
...
func TestBackupMixedVersionElements_base_create_sequence(t *testing.T) {
	defer leaktest.AfterTest(t)()
	defer log.Scope(t).Close(t)
	sctest.BackupMixedVersionElements(t, "pkg/sql/schemachanger/testdata/end_to_end/create_sequence", sctest.SingleNodeMixedCluster)
}
