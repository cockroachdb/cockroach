...
func validateTableDependenciesForOptions(
	...
	opts *tree.RestoreOptions) error {
...
func remapSchemas(
	...
	descriptorRewrites jobspb.DescRewriteMap) (bool, error) {
...
func getDescriptorByID(
	...
	tablesByID map[descpb.ID]*tabledesc.Mutable,
	typesByID map[descpb.ID]*typedesc.Mutable,
	functionsByID map[descpb.ID]*funcdesc.Mutable) catalog.Descriptor {
...
func allocateIDs(
	...
	// Outputs
	descriptorRewrites jobspb.DescRewriteMap) error {
...
func allocateDescriptorRewrites(
	...
	if descriptorCoverage == tree.AllDescriptors || descriptorCoverage == tree.SystemUsers {
		...
		if err := remapSystemTables(schemasByID, tablesByID, typesByID, tempSysDBID, descriptorRewrites); err != nil {
			return nil, err
		}
	}
