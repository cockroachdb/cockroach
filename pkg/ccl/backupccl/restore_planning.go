...
func allocateDescriptorRewrites(
	...
	intoDB string,
) (bulkccl.DescRewriteMap, error) {
	descriptorRewrites := make(bulkccl.DescRewriteMap)
...
func doRestorePlan(
	...
	if err := bulkccl.RewriteTableDescs(tables, descriptorRewrites, intoDB); err != nil {
		return err
	}
	if err := bulkccl.RewriteDatabaseDescs(databases, descriptorRewrites); err != nil {
		return err
	}
	if err := bulkccl.RewriteSchemaDescs(schemas, descriptorRewrites); err != nil {
		return err
	}
	if err := bulkccl.RewriteTypeDescs(types, descriptorRewrites); err != nil {
		return err
	}
