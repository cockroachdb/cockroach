...
func doRestorePlan(
	...
	if restoreStmt.Options.Detached {
		...
		collectRestoreTelemetry(ctx, jobID, restoreDetails, kms, intoDB, newDBName, subdir, restoreStmt,
	...
	collectRestoreTelemetry(ctx, sj.ID(), restoreDetails, kms, intoDB, newDBName, subdir, restoreStmt,
		descsByTablePattern, restoreDBs, debugPauseOn)
...
func collectRestoreTelemetry(
	...
	logRestoreTelemetry(ctx, jobID, details, kms, intoDB, newDBName, subdir, restoreStmt.AsOf, restoreStmt.Options,
		descsByTablePattern, restoreDBs, debugPauseOn)
}
