...
func showBackupPlanHook(
	...
	fn := func(ctx context.Context, _ []sql.PlanNode, resultsCh chan<- tree.Datums) error {
		...
		// A user that calls BACKUP TO <incremental_dir> on an encrypted incremental
		...
		showEncErr := `HINT: If you are running SHOW BACKUP exclusively on an incremental backup, 
