...
type backupShower struct {
	header colinfo.ResultColumns // header defines the columns of the table printed as output of
	// the show command.
	fn func([]BackupManifest) ([]tree.Datums, error) // fn is the specific implementation of the
	// shower that can either be a default, ranges, files, or JSON shower.
}
