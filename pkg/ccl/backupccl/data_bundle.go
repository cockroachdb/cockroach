...
// dataBundle specifies the data that is to be restored in a restoration flow.
...
type dataBundle interface {
	...
	// restored in either this dataBundle, or one that was previously restored.
...
// mainDataBundle is a data bundle that actually affects the highwater mark in
// the job's progress. We should only restore 1 of these.
type mainDataBundle struct {
	restoreDataBundle
}

// mainDataBundle implements dataBundle.
var _ dataBundle = &mainDataBundle{}

// isMainBundle implements dataBundle.
func (*mainDataBundle) isMainBundle() bool { return true }
...
// restoreDataBundle implements dataBundle.
var _ dataBundle = &restoreDataBundle{}

// getRekeys implements dataBundle.
func (b *restoreDataBundle) getRekeys() []roachpb.ImportRequest_TableRekey {
	return b.rekeys
}

// getPKIDs implements dataBundle.
func (b *restoreDataBundle) getPKIDs() map[uint64]bool {
	return b.pkIDs
}

// getSpans implements dataBundle.
func (b *restoreDataBundle) getSpans() []roachpb.Span {
	return b.spans
}

// getSystemTables implements dataBundle.
func (b *restoreDataBundle) getSystemTables() []catalog.TableDescriptor {
	return b.systemTables
}

// addTenant implements dataBundle.
...
// isEmpty implements dataBundle.
func (b *restoreDataBundle) isEmpty() bool {
	return len(b.spans) == 0
}

// isMainBundle implements dataBundle.
func (restoreDataBundle) isMainBundle() bool { return false }
