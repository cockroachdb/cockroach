...
const (
	...
	BackupSentinelWriteFile = "BACKUP-SENTINEL-PREPARE"
)
...
// createCheckpoint creates a checkpoint file if it does not exist.
...
func verifyWriteableDestination(
	...
	if err := exportStore.WriteFile(ctx, BackupSentinelWriteFile, bytes.NewReader([]byte{0xFF})); err != nil {
