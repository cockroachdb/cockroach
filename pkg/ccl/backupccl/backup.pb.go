...
func (MVCCFilter) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_backup_e538e902208acaf7, []int{0}
}
...
type BackupDescriptor struct {
	...
	GeodistributedBackupID github_com_cockroachdb_cockroach_pkg_util_uuid.UUID `protobuf:"bytes,18,opt,name=geodistributed_backup_id,json=geodistributedBackupId,proto3,customtype=github.com/cockroachdb/cockroach/pkg/util/uuid.UUID" json:"geodistributed_backup_id"`
	PartialDescFilenames   []string                                            `protobuf:"bytes,19,rep,name=partial_desc_filenames,json=partialDescFilenames,proto3" json:"partial_desc_filenames,omitempty"`
...
func (*BackupDescriptor_File) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_e538e902208acaf7, []int{0, 0}
}
...
func (*BackupDescriptor_DescriptorRevision) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_e538e902208acaf7, []int{0, 1}
}
...
type GeodistributedPartialBackupDescriptor struct {
	...
	GeodistributedBackupID github_com_cockroachdb_cockroach_pkg_util_uuid.UUID `protobuf:"bytes,3,opt,name=geodistributed_backup_id,json=geodistributedBackupId,proto3,customtype=github.com/cockroachdb/cockroach/pkg/util/uuid.UUID" json:"geodistributed_backup_id"`
}

func (m *GeodistributedPartialBackupDescriptor) Reset()         { *m = GeodistributedPartialBackupDescriptor{} }
func (m *GeodistributedPartialBackupDescriptor) String() string { return proto.CompactTextString(m) }
func (*GeodistributedPartialBackupDescriptor) ProtoMessage()    {}
func (*GeodistributedPartialBackupDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_e538e902208acaf7, []int{1}
}
func (m *GeodistributedPartialBackupDescriptor) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GeodistributedPartialBackupDescriptor) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalTo(b)
	if err != nil {
		return nil, err
...
func (dst *GeodistributedPartialBackupDescriptor) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GeodistributedPartialBackupDescriptor.Merge(dst, src)
}
func (m *GeodistributedPartialBackupDescriptor) XXX_Size() int {
	return m.Size()
}
func (m *GeodistributedPartialBackupDescriptor) XXX_DiscardUnknown() {
	xxx_messageInfo_GeodistributedPartialBackupDescriptor.DiscardUnknown(m)
}

var xxx_messageInfo_GeodistributedPartialBackupDescriptor proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*GeodistributedPartialBackupDescriptor)(nil), "cockroach.ccl.backupccl.GeodistributedPartialBackupDescriptor")
...
func (m *BackupDescriptor) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x1
	i++
	i = encodeVarintBackup(dAtA, i, uint64(m.GeodistributedBackupID.Size()))
	n10, err := m.GeodistributedBackupID.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n10
	if len(m.PartialDescFilenames) > 0 {
		for _, s := range m.PartialDescFilenames {
			dAtA[i] = 0x9a
			i++
			dAtA[i] = 0x1
			i++
...
func (m *GeodistributedPartialBackupDescriptor) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *GeodistributedPartialBackupDescriptor) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	i++
	i = encodeVarintBackup(dAtA, i, uint64(m.GeodistributedBackupID.Size()))
	n17, err := m.GeodistributedBackupID.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n17
...
func (m *BackupDescriptor) Size() (n int) {
	...
	n += 2 + l + sovBackup(uint64(l))
	l = m.GeodistributedBackupID.Size()
	n += 2 + l + sovBackup(uint64(l))
	if len(m.PartialDescFilenames) > 0 {
		for _, s := range m.PartialDescFilenames {
			l = len(s)
...
func (m *GeodistributedPartialBackupDescriptor) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *BackupDescriptor) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 18:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field GeodistributedBackupID", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.GeodistributedBackupID.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 19:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PartialDescFilenames", wireType)
			}
			...
			m.PartialDescFilenames = append(m.PartialDescFilenames, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 20:
			if wireType != 2 {
...
func (m *GeodistributedPartialBackupDescriptor) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GeodistributedPartialBackupDescriptor: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GeodistributedPartialBackupDescriptor: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func init() { proto.RegisterFile("ccl/backupccl/backup.proto", fileDescriptor_backup_e538e902208acaf7) }

var fileDescriptor_backup_e538e902208acaf7 = []byte{
	...
	,
}
