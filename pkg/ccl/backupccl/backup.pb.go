...
func (MVCCFilter) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_backup_3df77e708348bad1, []int{0}
}
...
func (ScheduledBackupExecutionArgs_BackupType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_backup_3df77e708348bad1, []int{4, 0}
}
...
func (*BackupManifest) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_3df77e708348bad1, []int{1}
}
...
func (*BackupManifest_File) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_3df77e708348bad1, []int{1, 0}
}
...
func (*BackupManifest_DescriptorRevision) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_3df77e708348bad1, []int{1, 1}
}
...
func (*BackupManifest_Progress) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_3df77e708348bad1, []int{1, 2}
}
...
func (*BackupManifest_Tenant) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_3df77e708348bad1, []int{1, 3}
}
...
func (*BackupPartitionDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_3df77e708348bad1, []int{2}
}
...
func (*StatsTable) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_3df77e708348bad1, []int{3}
}
...
func (*ScheduledBackupExecutionArgs) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_3df77e708348bad1, []int{4}
}
...
func (*RestoreProgress) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_3df77e708348bad1, []int{5}
}
...
func (m *BackupManifest_Tenant) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x12
	i++
	i = encodeVarintBackup(dAtA, i, uint64(m.Info.Size()))
...
func init() { proto.RegisterFile("ccl/backupccl/backup.proto", fileDescriptor_backup_3df77e708348bad1) }

var fileDescriptor_backup_3df77e708348bad1 = []byte{
	// 1551 bytes of a gzipped FileDescriptorProto
	,
}
