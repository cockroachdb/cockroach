...
type ScheduledBackupExecutionArgs struct {
	...
	// If the schedule is one of the two schedules that were created when setting
	// up a schedule with both full and incremental backups, then
	// DependentScheduleID will be set to the schedule ID of the other "dependent"
	// schedule.
