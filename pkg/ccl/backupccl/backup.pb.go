...
func (MVCCFilter) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_backup_c023ff36e805e7da, []int{0}
}
...
func (EncryptionInfo_Scheme) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_backup_c023ff36e805e7da, []int{3, 0}
}
...
type BackupManifest struct {
	...
	StatsFiles                   []string                                                             `protobuf:"bytes,23,rep,name=statsFiles,proto3" json:"statsFiles,omitempty"`
...
func (*BackupManifest) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_c023ff36e805e7da, []int{1}
}
...
func (*BackupManifest_File) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_c023ff36e805e7da, []int{1, 0}
}
...
func (*BackupManifest_DescriptorRevision) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_c023ff36e805e7da, []int{1, 1}
}
...
func (*BackupPartitionDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_c023ff36e805e7da, []int{2}
}
...
func (*EncryptionInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_c023ff36e805e7da, []int{3}
}
...
// StatsTables contains an array of sql.stats.TableStatisticProto object.
type StatsTable struct {
	Statistics []*stats.TableStatisticProto `protobuf:"bytes,2,rep,name=statistics,proto3" json:"statistics,omitempty"`
}
...
func (*StatsTable) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_c023ff36e805e7da, []int{4}
}
...
func (m *BackupManifest) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.StatsFiles) > 0 {
		for _, s := range m.StatsFiles {
			dAtA[i] = 0xba
			i++
			dAtA[i] = 0x1
			i++
...
func (m *BackupManifest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 23:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field StatsFiles", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.StatsFiles = append(m.StatsFiles, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipBackup(dAtA[iNdEx:])
...
func init() { proto.RegisterFile("ccl/backupccl/backup.proto", fileDescriptor_backup_c023ff36e805e7da) }

var fileDescriptor_backup_c023ff36e805e7da = []byte{
	// 1266 bytes of a gzipped FileDescriptorProto
	,
}
