...
func (MVCCFilter) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_backup_b369a1a0dd1a82de, []int{0}
}
...
func (*BackupDescriptor_File) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_b369a1a0dd1a82de, []int{0, 0}
}
...
func (*BackupDescriptor_DescriptorRevision) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_b369a1a0dd1a82de, []int{0, 1}
}
...
func (*BackupPartitionDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_b369a1a0dd1a82de, []int{1}
}
...
func (m *BackupDescriptor) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 21:
			...
			m.Statistics = append(m.Statistics, &stats.TableStatistic{})
...
func init() { proto.RegisterFile("ccl/backupccl/backup.proto", fileDescriptor_backup_b369a1a0dd1a82de) }

var fileDescriptor_backup_b369a1a0dd1a82de = []byte{
	...
	,
}
