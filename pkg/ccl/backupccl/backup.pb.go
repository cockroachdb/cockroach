...
func (MVCCFilter) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_backup_f994a7d7b021842a, []int{0}
}
...
type BackupDescriptor struct {
	...
	TableCoverage                int32                                               `protobuf:"varint,22,opt,name=table_coverage,json=tableCoverage,proto3" json:"table_coverage,omitempty"`
}
...
func (*BackupDescriptor_File) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_f994a7d7b021842a, []int{0, 0}
}
...
func (*BackupDescriptor_DescriptorRevision) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_f994a7d7b021842a, []int{0, 1}
}
...
func (*BackupPartitionDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_f994a7d7b021842a, []int{1}
}
...
func (m *BackupDescriptor) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TableCoverage != 0 {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintBackup(dAtA, i, uint64(m.TableCoverage))
	}
	return i, nil
}
...
func (m *BackupDescriptor) Size() (n int) {
	...
	if m.TableCoverage != 0 {
		n += 2 + sovBackup(uint64(m.TableCoverage))
	}
	return n
}
...
func init() { proto.RegisterFile("ccl/backupccl/backup.proto", fileDescriptor_backup_f994a7d7b021842a) }

var fileDescriptor_backup_f994a7d7b021842a = []byte{
	...
	,
}
