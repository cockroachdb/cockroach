...
func (MVCCFilter) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_backup_410ca4cbd48caf03, []int{0}
}
...
type BackupDescriptor struct {
	...
	Descriptors       []catpb.Descriptor                    `protobuf:"bytes,5,rep,name=descriptors,proto3" json:"descriptors"`
	// databases in descriptors that have all tables also in descriptors.
	CompleteDbs   []github_com_cockroachdb_cockroach_pkg_sql_catpb.ID `protobuf:"varint,14,rep,packed,name=complete_dbs,json=completeDbs,proto3,casttype=github.com/cockroachdb/cockroach/pkg/sql/catpb.ID" json:"complete_dbs,omitempty"`
...
func (*BackupDescriptor_File) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_410ca4cbd48caf03, []int{0, 0}
}
...
type BackupDescriptor_DescriptorRevision struct {
	...
	Desc                 *catpb.Descriptor                                 `protobuf:"bytes,3,opt,name=desc,proto3" json:"desc,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                                          `json:"-"`
	XXX_sizecache        int32                                             `json:"-"`
}
...
func (*BackupDescriptor_DescriptorRevision) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_410ca4cbd48caf03, []int{0, 1}
}
...
func (m *BackupDescriptor) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			m.Descriptors = append(m.Descriptors, catpb.Descriptor{})
		...
		case 14:
			if wireType == 0 {
				...
				if elementCount != 0 && len(m.CompleteDbs) == 0 {
					m.CompleteDbs = make([]github_com_cockroachdb_cockroach_pkg_sql_catpb.ID, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v github_com_cockroachdb_cockroach_pkg_sql_catpb.ID
					for shift := uint(0); ; shift += 7 {
...
func init() { proto.RegisterFile("ccl/backupccl/backup.proto", fileDescriptor_backup_410ca4cbd48caf03) }

var fileDescriptor_backup_410ca4cbd48caf03 = []byte{
	...
	,
}
