...
func (MVCCFilter) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_backup_67b67a1faf750bd0, []int{0}
}
...
func (*BackupDescriptor_File) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_67b67a1faf750bd0, []int{0, 0}
}
...
func (*BackupDescriptor_DescriptorRevision) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_67b67a1faf750bd0, []int{0, 1}
}
...
type BackupDescriptor_Statistics struct {
	TableStatistics []*stats.TableStatistic `protobuf:"bytes,1,rep,name=table_statistics,json=tableStatistics,proto3" json:"table_statistics,omitempty"`
}
...
func (*BackupDescriptor_Statistics) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_67b67a1faf750bd0, []int{0, 2}
}
...
func (*BackupPartitionDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_67b67a1faf750bd0, []int{1}
}
...
func init() { proto.RegisterFile("ccl/backupccl/backup.proto", fileDescriptor_backup_67b67a1faf750bd0) }

var fileDescriptor_backup_67b67a1faf750bd0 = []byte{
	...
	,
}
