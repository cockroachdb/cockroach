...
type BackupManifest_Progress struct {
	...
	// Partial indicates the progress made in Files represets only part of an
	// assigned span but did not complete exporting it. This is used to decide
	// not to update % of spans completed.
...
type BackupPlanningTraceEvent struct {
...
func (m *BackupPlanningTraceEvent) Reset()         { *m = BackupPlanningTraceEvent{} }
func (m *BackupPlanningTraceEvent) String() string { return proto.CompactTextString(m) }
func (*BackupPlanningTraceEvent) ProtoMessage()    {}
func (*BackupPlanningTraceEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_0a83e09f0e5986cc, []int{6}
}
func (m *BackupPlanningTraceEvent) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BackupPlanningTraceEvent) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *BackupPlanningTraceEvent) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BackupPlanningTraceEvent.Merge(m, src)
}
func (m *BackupPlanningTraceEvent) XXX_Size() int {
	return m.Size()
}
func (m *BackupPlanningTraceEvent) XXX_DiscardUnknown() {
	xxx_messageInfo_BackupPlanningTraceEvent.DiscardUnknown(m)
}

var xxx_messageInfo_BackupPlanningTraceEvent proto.InternalMessageInfo
...
type BackupExportTraceEvent struct {
	ExportRequest  *BackupExportTraceEvent_Request  `protobuf:"bytes,1,opt,name=export_request,json=exportRequest,proto3" json:"export_request,omitempty"`
	ExportResponse *BackupExportTraceEvent_Response `protobuf:"bytes,2,opt,name=export_response,json=exportResponse,proto3" json:"export_response,omitempty"`
}

func (m *BackupExportTraceEvent) Reset()         { *m = BackupExportTraceEvent{} }
func (m *BackupExportTraceEvent) String() string { return proto.CompactTextString(m) }
func (*BackupExportTraceEvent) ProtoMessage()    {}
func (*BackupExportTraceEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_0a83e09f0e5986cc, []int{8}
}
func (m *BackupExportTraceEvent) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BackupExportTraceEvent) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *BackupExportTraceEvent) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BackupExportTraceEvent.Merge(m, src)
}
func (m *BackupExportTraceEvent) XXX_Size() int {
	return m.Size()
}
func (m *BackupExportTraceEvent) XXX_DiscardUnknown() {
	xxx_messageInfo_BackupExportTraceEvent.DiscardUnknown(m)
}

var xxx_messageInfo_BackupExportTraceEvent proto.InternalMessageInfo

type BackupExportTraceEvent_Request struct {
	...
	ReqSentTime    hlc.Timestamp `protobuf:"bytes,4,opt,name=req_sent_time,json=reqSentTime,proto3" json:"req_sent_time"`
...
func (m *BackupExportTraceEvent_Request) Reset()         { *m = BackupExportTraceEvent_Request{} }
func (m *BackupExportTraceEvent_Request) String() string { return proto.CompactTextString(m) }
func (*BackupExportTraceEvent_Request) ProtoMessage()    {}
func (*BackupExportTraceEvent_Request) Descriptor() ([]byte, []int) {
	return fileDescriptor_0a83e09f0e5986cc, []int{8, 0}
}
func (m *BackupExportTraceEvent_Request) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BackupExportTraceEvent_Request) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *BackupExportTraceEvent_Request) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BackupExportTraceEvent_Request.Merge(m, src)
}
func (m *BackupExportTraceEvent_Request) XXX_Size() int {
	return m.Size()
}
func (m *BackupExportTraceEvent_Request) XXX_DiscardUnknown() {
	xxx_messageInfo_BackupExportTraceEvent_Request.DiscardUnknown(m)
}

var xxx_messageInfo_BackupExportTraceEvent_Request proto.InternalMessageInfo

type BackupExportTraceEvent_Response struct {
	RespReceivedTime hlc.Timestamp `protobuf:"bytes,1,opt,name=resp_received_time,json=respReceivedTime,proto3" json:"resp_received_time"`
...
func (m *BackupExportTraceEvent_Response) Reset()         { *m = BackupExportTraceEvent_Response{} }
func (m *BackupExportTraceEvent_Response) String() string { return proto.CompactTextString(m) }
func (*BackupExportTraceEvent_Response) ProtoMessage()    {}
func (*BackupExportTraceEvent_Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_0a83e09f0e5986cc, []int{8, 1}
}
func (m *BackupExportTraceEvent_Response) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BackupExportTraceEvent_Response) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *BackupExportTraceEvent_Response) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BackupExportTraceEvent_Response.Merge(m, src)
}
func (m *BackupExportTraceEvent_Response) XXX_Size() int {
	return m.Size()
}
func (m *BackupExportTraceEvent_Response) XXX_DiscardUnknown() {
	xxx_messageInfo_BackupExportTraceEvent_Response.DiscardUnknown(m)
}

var xxx_messageInfo_BackupExportTraceEvent_Response proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*BackupPlanningTraceEvent)(nil), "cockroach.ccl.backupccl.BackupPlanningTraceEvent")
	proto.RegisterMapType((map[int32]int64)(nil), "cockroach.ccl.backupccl.BackupPlanningTraceEvent.NodeToNumSpansEntry")
	proto.RegisterType((*BackupProgressTraceEvent)(nil), "cockroach.ccl.backupccl.BackupProgressTraceEvent")
	proto.RegisterType((*BackupExportTraceEvent)(nil), "cockroach.ccl.backupccl.BackupExportTraceEvent")
	proto.RegisterType((*BackupExportTraceEvent_Request)(nil), "cockroach.ccl.backupccl.BackupExportTraceEvent.Request")
	proto.RegisterType((*BackupExportTraceEvent_Response)(nil), "cockroach.ccl.backupccl.BackupExportTraceEvent.Response")
}
...
var fileDescriptor_0a83e09f0e5986cc = []byte{
	...
	,
}
...
func (m *BackupPlanningTraceEvent) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *BackupPlanningTraceEvent) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BackupPlanningTraceEvent) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *BackupExportTraceEvent) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *BackupExportTraceEvent) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BackupExportTraceEvent) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.ExportResponse != nil {
		{
			size, err := m.ExportResponse.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.ExportRequest != nil {
		{
			size, err := m.ExportRequest.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *BackupExportTraceEvent_Request) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *BackupExportTraceEvent_Request) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BackupExportTraceEvent_Request) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	{
		size, err := m.ReqSentTime.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *BackupExportTraceEvent_Response) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *BackupExportTraceEvent_Response) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BackupExportTraceEvent_Response) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	{
		size, err := m.RespReceivedTime.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *BackupPlanningTraceEvent) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *BackupExportTraceEvent) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.ExportRequest != nil {
		l = m.ExportRequest.Size()
		n += 1 + l + sovBackup(uint64(l))
	}
	if m.ExportResponse != nil {
		l = m.ExportResponse.Size()
		n += 1 + l + sovBackup(uint64(l))
	}
	return n
}

func (m *BackupExportTraceEvent_Request) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *BackupExportTraceEvent_Response) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	l = m.RespReceivedTime.Size()
	n += 1 + l + sovBackup(uint64(l))
	if m.NumFiles != 0 {
...
func (m *BackupPlanningTraceEvent) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BackupPlanningTraceEvent: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BackupPlanningTraceEvent: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *BackupExportTraceEvent) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BackupExportTraceEvent: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BackupExportTraceEvent: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExportRequest", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ExportRequest == nil {
				m.ExportRequest = &BackupExportTraceEvent_Request{}
			}
			if err := m.ExportRequest.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExportResponse", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ExportResponse == nil {
				m.ExportResponse = &BackupExportTraceEvent_Response{}
			}
			if err := m.ExportResponse.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *BackupExportTraceEvent_Request) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 4:
			...
			if err := m.ReqSentTime.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
...
func (m *BackupExportTraceEvent_Response) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RespReceivedTime", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.RespReceivedTime.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
