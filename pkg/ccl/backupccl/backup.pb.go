...
func (MVCCFilter) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_backup_168e8dbeb631756d, []int{0}
}
...
func (EncryptionInfo_Scheme) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_backup_168e8dbeb631756d, []int{3, 0}
}
...
type BackupManifest struct {
	...
	Stmts                        []string                                                             `protobuf:"bytes,23,rep,name=stmts,proto3" json:"stmts,omitempty"`
}
...
func (*BackupManifest) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_168e8dbeb631756d, []int{1}
}
...
func (*BackupManifest_File) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_168e8dbeb631756d, []int{1, 0}
}
...
func (*BackupManifest_DescriptorRevision) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_168e8dbeb631756d, []int{1, 1}
}
...
func (*BackupPartitionDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_168e8dbeb631756d, []int{2}
}
...
func (*EncryptionInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_backup_168e8dbeb631756d, []int{3}
}
...
func (m *BackupManifest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 23:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Stmts", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Stmts = append(m.Stmts, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipBackup(dAtA[iNdEx:])
...
func init() { proto.RegisterFile("ccl/backupccl/backup.proto", fileDescriptor_backup_168e8dbeb631756d) }

var fileDescriptor_backup_168e8dbeb631756d = []byte{
	// 1251 bytes of a gzipped FileDescriptorProto
	,
}
