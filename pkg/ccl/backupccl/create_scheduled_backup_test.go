	...
	testCases := []struct {
	...
	}{
		{
			...
			expectedSchedules: []expectedSchedule{
				{
					nameRe:     "BACKUP .+",
					backupStmt: "BACKUP INTO 'nodelocal://0/backup?AWS_SECRET_ACCESS_KEY=neverappears' WITH OPTIONS (detached)",
					shownStmt:  "BACKUP INTO 'nodelocal://0/backup?AWS_SECRET_ACCESS_KEY=redacted' WITH OPTIONS (detached)",
					period:     time.Hour,
				},
			},
		},
		{
			...
			expectedSchedules: []expectedSchedule{
				{
					nameRe:     "my-backup",
					backupStmt: "BACKUP INTO 'nodelocal://0/backup' WITH OPTIONS (detached)",
					period:     time.Hour,
				},
			},
		},
		...
		},
		{
			...
			expectedSchedules: []expectedSchedule{
				{
					nameRe:                        "BACKUP .*",
					backupStmt:                    "BACKUP INTO LATEST IN 'nodelocal://0/backup' WITH OPTIONS (detached)",
					period:                        time.Hour,
					paused:                        true,
		...
		},
		{
			...
			expectedSchedules: []expectedSchedule{
				{
					nameRe:     "BACKUP .+",
					backupStmt: "BACKUP INTO 'nodelocal://0/backup' WITH OPTIONS (revision_history = true, detached)",
					period:     time.Hour,
				},
			},
		},
		{
			...
			expectedSchedules: []expectedSchedule{
				{
					nameRe:                        "BACKUP .*",
					backupStmt:                    "BACKUP INTO LATEST IN 'nodelocal://0/backup' WITH OPTIONS (detached, incremental_location = 'nodelocal://1/incremental')",
					period:                        time.Hour,
					paused:                        true,
					chainProtectedTimestampRecord: true,
				},
		...
		WITH revision_history RECURRING '@hourly'`,
			expectedSchedules: []expectedSchedule{
				...
				},
				{
					nameRe: "BACKUP .+",
					backupStmt: "BACKUP TABLE system.public.jobs, " +
						"system.public.scheduled_jobs INTO 'nodelocal://0/backup' WITH OPTIONS (revision_history = true, detached)",
					period:                        24 * time.Hour,
					runsNow:                       true,
					chainProtectedTimestampRecord: true,
				},
		...
		WITH revision_history RECURRING '@hourly'`,
			expectedSchedules: []expectedSchedule{
				{
					nameRe:                        "BACKUP .*",
					backupStmt:                    "BACKUP DATABASE system INTO LATEST IN 'nodelocal://0/backup' WITH OPTIONS (revision_history = true, detached)",
					period:                        time.Hour,
					paused:                        true,
					chainProtectedTimestampRecord: true,
				},
				{
					nameRe:                        "BACKUP .+",
					backupStmt:                    "BACKUP DATABASE system INTO 'nodelocal://0/backup' WITH OPTIONS (revision_history = true, detached)",
					period:                        24 * time.Hour,
					runsNow:                       true,
					chainProtectedTimestampRecord: true,
				},
		...
		WITH revision_history RECURRING '@hourly'`,
			expectedSchedules: []expectedSchedule{
				{
					nameRe:                        "BACKUP .*",
					backupStmt:                    "BACKUP TABLE system.public.* INTO LATEST IN 'nodelocal://0/backup' WITH OPTIONS (revision_history = true, detached)",
					period:                        time.Hour,
					paused:                        true,
					chainProtectedTimestampRecord: true,
				},
				{
					nameRe:                        "BACKUP .+",
					backupStmt:                    "BACKUP TABLE system.public.* INTO 'nodelocal://0/backup' WITH OPTIONS (revision_history = true, detached)",
					period:                        24 * time.Hour,
					runsNow:                       true,
					chainProtectedTimestampRecord: true,
				},
			...
			expectedSchedules: []expectedSchedule{
				{
					...
					backupStmt:                    "BACKUP INTO LATEST IN 'nodelocal://0/backup' WITH OPTIONS (revision_history = true, detached)",
					period:                        time.Hour,
					paused:                        true,
					chainProtectedTimestampRecord: true,
				},
			...
			expectedSchedules: []expectedSchedule{
				{
					nameRe: "BACKUP .*",
					backupStmt: "BACKUP TABLE system.public.jobs, " +
						"system.public.scheduled_jobs INTO 'nodelocal://0/backup' WITH OPTIONS (" +
