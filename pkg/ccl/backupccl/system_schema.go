...
type systemBackupConfiguration struct {
	...
	//
	// TODO: Do we need to pass in the system table name here?
...
// defaultRestoreFunc is how system table data is restored. This can be
// overwritten with the system table's
// systemBackupConfiguration.customRestoreFunc.
func defaultRestoreFunc(
	ctx context.Context,
