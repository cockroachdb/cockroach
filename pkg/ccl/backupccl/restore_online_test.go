...
func TestOnlineRestoreBasic(t *testing.T) {
	...
	sqlDB.CheckQueryResults(t, jobutils.GetExternalBytesQuery, [][]string{{"0"}})
}
...
func TestOnlineRestoreTenant(t *testing.T) {
	...
	dbAbove.CheckQueryResults(t, jobutils.GetExternalBytesQuery, [][]string{{"0"}})
	dbBelow.CheckQueryResults(t, jobutils.GetExternalBytesQuery, [][]string{{"0"}})
}
