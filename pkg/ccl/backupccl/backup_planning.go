...
func getReintroducedSpans(
	...
	var induceIntroducedSpansBug bool
	if knobs := execCfg.BackupRestoreTestingKnobs; knobs != nil {
		induceIntroducedSpansBug = knobs.SkipDescriptorChangeIntroduction
	}

	if induceIntroducedSpansBug {
		// Skip adding offline descriptors from descriptor changes to induce an
		// introduced spans bug for testing.
	} else {
