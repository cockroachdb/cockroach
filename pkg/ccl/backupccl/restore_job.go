...
func remapRelevantStatistics(
	tableStatistics []*stats.TableStatisticProto, tableRewrites TableRewriteMap,
) []*stats.TableStatisticProto {
...
func (r *restoreResumer) Resume(
	...
	r.latestStats = remapRelevantStatistics(backupStats, details.TableRewrites)
