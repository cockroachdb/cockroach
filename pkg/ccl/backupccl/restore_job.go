...
func createImportingDescriptors(
	...
	if details.DescriptorCoverage == tree.AllDescriptors {
		// Retrieve the ID that was pre-allocated for the temporary system database
		// descriptor. This was the last ID generated by the restore planner, and
		// therefore is the greatest.
		// TODO(postamar): Store the ID in the job details instead? This is brittle.
