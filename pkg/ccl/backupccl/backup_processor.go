			...
			for {
				...
				case span := <-todo:
					...
					admissionHeader := roachpb.AdmissionHeader{
						...
						//
						// TODO(bulkio): the priority should vary based on whether this is
						// actually foreground or background traffic. Background exports
						// should get LowPri, unless they are being retried and need to be
						// completed in a timely manner for compliance with RPO and data
						// retention policies.
