...
// writeInProcessor controls whether we write the SST files of the backup
// from the SQL processor (rather than from the KV layer). Tenant backups always
// write the file at the processor level.
//
...
var writeInProcessor = settings.RegisterBoolSetting(
