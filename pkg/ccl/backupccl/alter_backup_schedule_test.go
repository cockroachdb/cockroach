...
`)
	...
	require.Equal(t, []string{
		"BACKUP TABLE mydb.public.t1 INTO LATEST IN 'nodelocal://0/backup/alter-schedule' WITH OPTIONS (detached)",
		"BACKUP TABLE mydb.public.t1 INTO 'nodelocal://0/backup/alter-schedule' WITH OPTIONS (detached)",
	},
		backupStmts)
