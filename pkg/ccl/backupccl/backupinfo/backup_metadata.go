...
const (
	...
	// SlimManifestFileInfoPath is the name of the SST file containing the
	// BackupManifest_Files of the backup. This file is always written in
	// conjunction with the `SLIM_BACKUP_MANIFEST`.
	SlimManifestFileInfoPath = "slim_manifest_fileinfo.sst"
...
// WriteBackupManifestFilesSST is responsible for constructing and writing the
// filePathInfo to dest. This file contains the `BackupManifest_Files` of the
// backup.
func WriteBackupManifestFilesSST(
	ctx context.Context,
