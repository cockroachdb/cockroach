...
func writeManifestToMetadata(ctx context.Context, sst storage.SSTWriter, m *backuppb.BackupManifest) error {
	info := *m
...
func writeDescsToMetadata(ctx context.Context, sst storage.SSTWriter, m *backuppb.BackupManifest) error {
...
func writeNamesToMetadata(ctx context.Context, sst storage.SSTWriter, m *backuppb.BackupManifest) error {
...
func writeSpansToMetadata(ctx context.Context, sst storage.SSTWriter, m *backuppb.BackupManifest) error {
...
func writeTenantsToMetadata(ctx context.Context, sst storage.SSTWriter, m *backuppb.BackupManifest) error {
...
func (dri *DescriptorRevisionIterator) Next(revision *backuppb.BackupManifest_DescriptorRevision) bool {
	wrapper := resultWrapper{}
...
func unmarshalWrapper(wrapper *resultWrapper, rev *backuppb.BackupManifest_DescriptorRevision) error {
