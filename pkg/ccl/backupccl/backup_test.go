...
func TestBackupRestoreSingleUserfile(t *testing.T) {
	...
	//sqlDB.Exec(t, `BACKUP DATABASE foo TO 'userfile:///a'`)
	//sqlDB.Exec(t, `CREATE DATABASE baz`)
	//sqlDB.Exec(t, `USE baz`)
	//sqlDB.Exec(t, `DROP DATABASE foo CASCADE`)
	//sqlDB.Exec(t, `RESTORE DATABASE foo FROM 'userfile:///a'`)
