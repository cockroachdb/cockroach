...
func TestBackupInLocality(t *testing.T) {
	...
	args := base.TestClusterArgs{ServerArgsPerNode: map[int]base.TestServerArgs{
		0: base.TestServerArgs{Locality: localityFromStr(t, "region=east,dc=1,az=1")},
		1: base.TestServerArgs{Locality: localityFromStr(t, "region=east,dc=2,az=2")},
		2: base.TestServerArgs{Locality: localityFromStr(t, "region=west,dc=1,az=1")},
	}}
