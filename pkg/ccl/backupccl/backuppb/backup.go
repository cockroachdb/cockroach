...
var _ tracing.TracingAggregatorEvent = &ExportStats{}
...
func (e *ExportStats) Identity() tracing.TracingAggregatorEvent {
	return &ExportStats{
...
func (e *ExportStats) Combine(other tracing.TracingAggregatorEvent) {
