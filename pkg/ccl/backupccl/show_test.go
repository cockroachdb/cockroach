...
// TestShowBackupTenantView ensures that SHOW BACKUP on a tenant backup returns
// the same results to the tenant as to the system tenant.
...
func TestShowBackupTenantView(t *testing.T) {
	...
	//row counts should look the same
