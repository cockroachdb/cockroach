...
`)
		...
		// Show the original owner before BACKUP
		showOwner := LocalFoo + "/show_owner"
		sqlDB.Exec(t, `
ALTER DATABASE mi5 OWNER TO agent_bond;
ALTER SCHEMA locator OWNER TO agent_bond;
ALTER TYPE locator.continent OWNER TO agent_bond;
ALTER TABLE locator.agent_locations OWNER TO agent_bond;
ALTER TABLE top_secret OWNER TO agent_bond;
`)
