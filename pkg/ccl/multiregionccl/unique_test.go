...
// crdb_internal.revalidate_unique_constraints can find unique constraint
// violations.
...
`)
	...
	t.Run("validate_unique_without_index", func(t *testing.T) {
		...
		r.Exec(t, `SELECT crdb_internal.revalidate_unique_constraints()`)
		r.Exec(t, `SELECT crdb_internal.revalidate_unique_constraints('t')`)
		r.Exec(t, `SELECT crdb_internal.revalidate_unique_constraints('u')`)
		r.Exec(t, `SELECT crdb_internal.revalidate_unique_constraints('v')`)
		...
		r.ExpectErr(t, `failed to validate unique constraint`,
			`SELECT crdb_internal.revalidate_unique_constraints()`)
		r.ExpectErr(t, `failed to validate unique constraint`,
			`SELECT crdb_internal.revalidate_unique_constraints('t')`)
		r.ExpectErr(t, `failed to validate unique constraint`,
	...
	t.Run("validate_implicitly_partitioned_primary_index", func(t *testing.T) {
		...
		r.ExpectErr(t, `failed to validate unique constraint`,
			`SELECT crdb_internal.revalidate_unique_constraints()`)
		r.ExpectErr(t, `failed to validate unique constraint`,
			`SELECT crdb_internal.revalidate_unique_constraints('u')`)
		r.ExpectErr(t, `failed to validate unique constraint`,
