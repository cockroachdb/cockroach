...
func TestSettingPrimaryRegionAmidstDrop(t *testing.T) {
	...
	_, sqlDB, cleanup := multiregionccl.CreateTestMultiRegionCluster(t, 2 /* numServers */, knobs)
	defer cleanup()
...
func TestDroppingPrimaryRegionAsyncJobFailure(t *testing.T) {
	...
	_, sqlDB, cleanup := multiregionccl.CreateTestMultiRegionCluster(t, 1 /* numServers */, knobs)
	defer cleanup()
...
func TestRollbackDuringAddDropRegionAsyncJobFailure(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			// Setup
			_, sqlDB, cleanup := multiregionccl.CreateTestMultiRegionCluster(t, numServers, knobs)
			defer cleanup()
