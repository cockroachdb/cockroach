...
func GetStorage(ctx context.Context, cfg FixtureConfig) (cloud.ExternalStorage, error) {
	...
	s, err := cloud.ExternalStorageFromURI(ctx, cfg.ObjectPathToURI(), base.ExternalIODirConfig{}, clustersettings.MakeClusterSettings(), nil, username.SQLUsername{}, nil, nil, nil, nil)
	if err != nil {
