...
func LoadCSV(
	...
	createTable, err := readCreateTableFromStore(ctx, table, nil /* cluster.Settings */)
	if err != nil {
		return 0, 0, 0, err
	}
...
func readCreateTableFromStore(ctx context.Context, filename string, settings *cluster.Settings) (*parser.CreateTable, error) {
