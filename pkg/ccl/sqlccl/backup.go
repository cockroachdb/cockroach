...
// ProgressReportingInterval is the interval at which the system.jobs table is
// updated with the latest progress information for a backup or restore.
var ProgressReportingInterval = time.Second
