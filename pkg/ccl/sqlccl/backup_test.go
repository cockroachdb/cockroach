...
func TestBackupRestoreInterleaved(t *testing.T) {
	...
	for i := 0; i < numAccounts; i++ {
		_ = sqlDB.Exec(`INSERT INTO i0 VALUES ($1, 1), ($2, 2)`, i, i)
		_ = sqlDB.Exec(`INSERT INTO i0_0 VALUES ($1, 1, 1), ($2, 2, 2), ($3, 3, 3)`, i, i, i)
		_ = sqlDB.Exec(`INSERT INTO i1 VALUES ($1, 1), ($2, 2), ($3, 3), ($4, 4)`, i, i, i, i)
	}
