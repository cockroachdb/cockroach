...
func loadBackupDescs(ctx context.Context, uris []string, settings *cluster.Settings) ([]BackupDescriptor, error) {
...
func restoreResumeHook(typ jobs.Type, settings *cluster.Settings) func(ctx context.Context, job *jobs.Job) error {
