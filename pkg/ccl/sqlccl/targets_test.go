...
func TestDescriptorsMatchingTargets(t *testing.T) {
	...
	tests := []struct {
		...
		{"", "TABLE *", nil, nil, `wildcard "\*" matches no valid database`},
		{"", "TABLE *, system.public.foo", nil, nil, `wildcard "\*" matches no valid database`},
		{"noexist", "TABLE *", nil, nil, `wildcard "\*" matches no valid database`},
		...
		{"", "TABLE noexist.*", nil, nil, `wildcard "noexist\.\*" matches no valid database`},
