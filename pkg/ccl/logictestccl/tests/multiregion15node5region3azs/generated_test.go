...
package testmultiregion15node5region3azs
...
func TestCCLLogic_multiregion15node5region3azs_superregions(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
	runCCLLogicTest(t, "super_regions")
}

func TestCCLLogic_multiregion15node5region3azs_superregionsbackup(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestCCLLogic_multiregion15node5region3azs_superregionsclustersettings(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
