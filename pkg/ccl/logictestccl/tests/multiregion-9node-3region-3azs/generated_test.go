...
func TestCCLLogic_multi_region_alter_table_regional_by_row(t *testing.T) {
	defer leaktest.AfterTest(t)()
...
func TestCCLLogic_regional_by_row_cascade(t *testing.T) {
	defer leaktest.AfterTest(t)()
	runCCLLogicTest(t, "regional_by_row_cascade")
}

func TestCCLLogic_regional_by_row_foreign_key(t *testing.T) {
	defer leaktest.AfterTest(t)()
...
func TestCCLLogic_regional_by_row_index(t *testing.T) {
	defer leaktest.AfterTest(t)()
	runCCLLogicTest(t, "regional_by_row_index")
}

func TestCCLLogic_regional_by_row_insert_fast_path(t *testing.T) {
	defer leaktest.AfterTest(t)()
...
func TestCCLLogic_tmp(t *testing.T) {
	defer leaktest.AfterTest(t)()
	runCCLLogicTest(t, "_tmp")
}
...
func TestCCLLogic_regional_by_row_safe_updates(t *testing.T) {
	defer leaktest.AfterTest(t)()
