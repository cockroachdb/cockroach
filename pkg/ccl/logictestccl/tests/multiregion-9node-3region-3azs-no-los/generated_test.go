...
package testmultiregion_9node_3region_3azs_no_los
...
func TestCCLLogic_alter_table_locality(t *testing.T) {
	defer leaktest.AfterTest(t)()
...
func TestCCLLogic_multi_region_backup(t *testing.T) {
	defer leaktest.AfterTest(t)()
...
func TestCCLLogic_multi_region_query_behavior(t *testing.T) {
	defer leaktest.AfterTest(t)()
...
func TestCCLLogic_regional_by_row_hash_sharded_index(t *testing.T) {
	defer leaktest.AfterTest(t)()
