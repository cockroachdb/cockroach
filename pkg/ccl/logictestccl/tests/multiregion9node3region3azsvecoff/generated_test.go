...
package testmultiregion9node3region3azsvecoff
...
func TestCCLLogic_multiregion9node3region3azsvecoff_globalplacementrestricted(
	t *testing.T,
) {
...
func TestCCLLogic_multiregion9node3region3azsvecoff_multiregionimportexport(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestCCLLogic_multiregion9node3region3azsvecoff_placement(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestCCLLogic_multiregion9node3region3azsvecoff_regionalbyrow(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestCCLLogic_multiregion9node3region3azsvecoff_regionalbyrowplacementrestricted(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestCCLLogic_multiregion9node3region3azsvecoff_regionalbyrowrenamecolumn(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestCCLLogic_multiregion9node3region3azsvecoff_regionalbytableplacementrestricted(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
