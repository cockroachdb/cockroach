...
func TestCCLLogic_5node_distsqlpartitioning(
	t *testing.T,
) {
...
func TestCCLLogic_5node_dropindex(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestCCLLogic_5node_partitioninghashshardedindex(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestCCLLogic_5node_partitioninghashshardedindexqueryplan(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
