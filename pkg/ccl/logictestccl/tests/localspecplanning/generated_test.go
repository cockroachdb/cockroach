...
func TestCCLLogic_localspecplanning_newschemachanger(
	t *testing.T,
) {
...
func TestCCLLogic_localspecplanning_partitioningenum(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestCCLLogic_localspecplanning_schemachangeintxn(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
