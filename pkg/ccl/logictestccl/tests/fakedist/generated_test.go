...
func TestCCLLogic_fakedist_newschemachanger(
	t *testing.T,
) {
...
func TestCCLLogic_fakedist_partitioningconstrainedscans(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestCCLLogic_fakedist_partitioningenum(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestCCLLogic_fakedist_schemachangeintxn(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
