...
import (
	...
	bench "github.com/cockroachdb/cockroach/pkg/bench/rttanalysis"
)
...
ALTER TABLE test41 SET LOCALITY REGIONAL BY ROW IN "us-east1";
ALTER TABLE test42 SET LOCALITY REGIONAL BY ROW IN "us-east1";
`,
			Stmt:  `ALTER DATABASE test DROP REGION "us-east2"`,
			Reset: "DROP DATABASE test",
		},
