...
var reg = rttanalysis.NewRegistry(rttanalysis.MakeClusterConstructor(func(
	tb testing.TB, knobs base.TestingKnobs,
) (_ *gosql.DB, cleanup func()) {
	cluster, _, cleanup := multiregionccltestutils.TestingCreateMultiRegionCluster(tb, 4, knobs)
	return cluster.ServerConn(0), func() {
