...
func multipleTableFixtures(n int) string {
	...
	b.WriteString(`BEGIN; CREATE DATABASE test PRIMARY REGION "us-east1" REGIONS "us-east1", "us-east2", "us-east3"; COMMIT;
USE test;`)
	for i := 0; i < n; i++ {
...
func init() {
	reg.Register("BenchmarkORMQueries", []rttanalysis.RoundTripBenchTestCase{
		{
