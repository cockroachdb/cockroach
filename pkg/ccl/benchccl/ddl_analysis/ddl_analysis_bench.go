...
import (
	...
	ddlbench "github.com/cockroachdb/cockroach/pkg/bench/ddl_analysis"
...
func RunRoundTripBenchmarkMultiRegion(b *testing.B, tests []ddlbench.RoundTripBenchTestCase) {
	...
	for _, tc := range tests {
		b.Run(tc.Name, func(b *testing.B) {
			...
			ddlbench.ExecuteRoundTripTest(b, sqlConn, &stmtToKvBatchRequests, tc)
		})
	}
}
