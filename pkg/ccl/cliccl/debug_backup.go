...
func externalStorageFromURIFactory(
	...
	return cloud.ExternalStorageFromURI(ctx, uri, base.ExternalIODirConfig{}, defaultSettings, newBlobFactory, user, nil, nil, nil, nil, opts...)
}
...
func makeIters(
	...
	for i, file := range files {
		...
		dirStorage[i], err = cloud.MakeExternalStorage(ctx, file.Dir, base.ExternalIODirConfig{}, clusterSettings, newBlobFactory, nil, nil, nil, nil)
		if err != nil {
