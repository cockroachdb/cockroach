...
// newSchemaForRow constructs avro schema for the EventRow.
...
func primaryIndexToAvroSchema(
	row cdcevent.EventRow, sqlName string, namespace string,
) (*avroDataRecord, error) {
...
func tableToAvroSchema(
	row cdcevent.EventRow, nameSuffix string, namespace string,
) (*avroDataRecord, error) {
	var sqlName string
...
func (r *avroDataRecord) textualFromRow(row cdcevent.EventRow) ([]byte, error) {
...
func (r *avroEnvelopeRecord) BinaryFromRow(
	buf []byte, meta avroMetadata, beforeRow, afterRow cdcevent.EventRow,
) ([]byte, error) {
	native := map[string]interface{}{}
...
func (r *avroDataRecord) refreshTypeMetadata(row cdcevent.EventRow) error {
