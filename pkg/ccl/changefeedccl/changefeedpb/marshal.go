...
// URI fields.
func (m ScheduledExportExecutionArgs) MarshalJSONPB(x *jsonpb.Marshaler) ([]byte, error) {
	stmt, err := parser.ParseOne(m.ExportStatement)
	if err != nil {
		return nil, err
	}
	...
	m.ExportStatement = export.String()
