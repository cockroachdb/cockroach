...
type webhookSink struct {
	...
	// parallelism workers are created and control with
	// workerGroup, running with workerCtx.
	// each worker gets its own events channel.
	workerCtx   context.Context
	workerGroup ctxgroup.Group
	exitWorkers func() // Signaled  to shutdown all workers.
