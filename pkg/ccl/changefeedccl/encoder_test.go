	...
	for _, o := range opts {
		...
		t.Run(name, func(t *testing.T) {
			...
			case changefeedbase.OptFormatAvro, changefeedbase.DeprecatedOptFormatAvro:
				...
				defer reg.Close()
				o.ConfluentSchemaRegistry = reg.URL()
...
func TestAvroEncoderWithTLS(t *testing.T) {
	...
	t.Run("format=avro,envelope=key_only", func(t *testing.T) {
		...
		opts.ConfluentSchemaRegistry = regURL.String()
		...
		opts.ConfluentSchemaRegistry = noCertReg.URL()
		...
		opts.ConfluentSchemaRegistry = wrongCertReg.URL()
