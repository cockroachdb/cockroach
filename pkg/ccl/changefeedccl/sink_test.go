...
func getBoundAccountWithBudget(budget int64) (account *mon.BoundAccount, stopMonitor func()) {
	...
	acc := mm.MakeBoundAccount()
	return &acc, func() { mm.Stop(context.Background()) }
}
