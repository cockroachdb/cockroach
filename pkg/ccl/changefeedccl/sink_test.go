...
func topic(name string) *tableDescriptorTopic {
	...
	return &tableDescriptorTopic{EventSource: &testEventSourceDescriptor{desc: tableDesc}, spec: spec}
}
...
func (testEncoder) EncodeKey(context.Context, cdcevent.EventRow) ([]byte, error) {
	panic(`unimplemented`)
}
func (testEncoder) EncodeValue(
	context.Context, eventContext, cdcevent.EventRow, cdcevent.EventRow,
) ([]byte, error) {
	panic(`unimplemented`)
}
...
func TestSQLSink(t *testing.T) {
	...
	overrideTopic := func(name string) *tableDescriptorTopic {
		...
		return &tableDescriptorTopic{EventSource: &testEventSourceDescriptor{desc: td}, spec: spec}
	}
