...
func TestSQLSink(t *testing.T) {
	...
	targets := []jobspb.ChangefeedTargetSpecification{
		jobspb.ChangefeedTargetSpecification{TableID: fooTopic.GetID(), StatementTimeName: `foo`},
		jobspb.ChangefeedTargetSpecification{TableID: barTopic.GetID(), StatementTimeName: `bar`},
	}
