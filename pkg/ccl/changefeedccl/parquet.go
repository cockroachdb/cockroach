...
const parquetOptUpdatedColName = metaSentinel + changefeedbase.OptUpdatedTimestamps
...
func appendMetadataColsToSchema(
	...
	if encodingOpts.UpdatedTimestamps {
		columnNames = append(columnNames, parquetOptUpdatedColName)
		columnTypes = append(columnTypes, types.String)
	}
...
func addParquetTestMetadata(
	...
	if encodingOpts.UpdatedTimestamps {
		valuesInOrder = append(valuesInOrder, parquetOptUpdatedColName)
		valueCols[parquetOptUpdatedColName] = idx
		idx += 1
	}
