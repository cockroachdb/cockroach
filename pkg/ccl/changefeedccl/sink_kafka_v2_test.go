...
func newKafkaSinkV2Fx(t *testing.T, opts ...fxOpt) *kafkaSinkV2Fx {
	...
	var err error
	fx.sink, err = newKafkaSinkClientV2(ctx, fx.additionalKOpts, fx.batchConfig, "no addrs", settings, &TestingKnobs{KafkaSinkClientV2Knobs: knobs}, nilMetricsRecorderBuilder, nil)
