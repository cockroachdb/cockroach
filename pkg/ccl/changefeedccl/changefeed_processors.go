...
type jobState struct {
	...
	// TODO take these fields out of here
...
func newJobState(
	...
	return &jobState{
		...
		lastFrontierPersistence: ts.Now(),
	}
}
...
// frontierPersisted indicates whether the frontier was persisted during this checkpoint.
...
func (cf *changeFrontier) maybeCheckpointJob(
	...
	if persistFrontier {
		log.Dev.Infof(ctx, "ANDY DEBUG: about to persist frontier")
		...
		log.Dev.Infof(ctx, "ANDY DEBUG: persisted frontier, avg duration: %v", cf.js.frontierPersistenceDuration)
	}
...
func (cf *changeFrontier) checkpointSpanFrontier(ctx context.Context) (bool, error) {
	...
	log.Dev.Infof(ctx, "ANDY DEBUG: persisted span frontier")
	return true, nil
}
