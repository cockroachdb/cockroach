...
type jobState struct {
	...
	job *jobs.Job
	// progress is set for only core/sinkless changefeeds.
	progress *coreChangefeedProgress
...
func (cf *changeFrontier) Start(ctx context.Context) {
	...
	if cf.spec.JobID != 0 {
		...
		cf.js = newJobState(nil, cf.EvalCtx.ChangefeedState.(*coreChangefeedProgress), cf.flowCtx.Cfg.Settings, cf.metrics, timeutil.DefaultTimeSource{})
	}
...
func (cf *changeFrontier) checkpointJobProgress(
	...
	if cf.js.job != nil {
		...
		cf.js.progress.SetHighwater(&frontier)
		cf.js.progress.SetCheckpoint(checkpoint.Spans, checkpoint.Timestamp)
		// TODO(jayshrivastava): add protected timestamp management.
	}
