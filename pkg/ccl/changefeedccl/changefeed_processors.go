...
func (cf *changeFrontier) noteAggregatorProgress(ctx context.Context, d rowenc.EncDatum) error {
	...
	err := cf.forwardFrontier(ctx, resolvedSpans.ResolvedSpans)
	if err != nil {
		return err
	}
...
func (cf *changeFrontier) forwardFrontier(ctx context.Context, spans []jobspb.ResolvedSpan) error {
