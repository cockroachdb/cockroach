...
const (
	...
	// TODO: not sure what else to do here. we can make it more dynamic .. but i
	// don't really think we need to. for reference, other systems will just
	// stringify json fields, which frankly makes more sense.
