...
func (e *jsonEncoder) EncodeKey(_ context.Context, row cdcevent.EventRow) ([]byte, error) {
...
func (e *jsonEncoder) encodeKeyRaw(row cdcevent.EventRow) ([]interface{}, error) {
...
func rowAsGoNative(row cdcevent.EventRow) (map[string]interface{}, error) {
