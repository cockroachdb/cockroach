...
func getEncoder(
	...
	sourceOpts enrichedEnvelopeSourceProviderOpts,
) (Encoder, error) {
	switch opts.Format {
	case changefeedbase.OptFormatJSON:
		return makeJSONEncoder(ctx, jsonEncoderOptions{EncodingOptions: opts, encodeForQuery: encodeForQuery}, sourceOpts)
