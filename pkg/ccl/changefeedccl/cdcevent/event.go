...
func (r Row) CopyInto(row *tree.DTuple) error {
	tupleTypes := row.ResolvedType().InternalType.TupleContents
...
func (r Row) DebugString() string {
	...
	sb.WriteString(fmt.Sprintf("Row%s{", r.Metadata))
	first := true
