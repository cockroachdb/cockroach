...
// RowFetcherTraceKVs enables pretty KV generation in the row fetcher so KVs will
// be logged.
var traceKVs = settings.RegisterBoolSetting(
	settings.TenantWritable,
	"changefeed.cdcevent.trace_kv",
	"enables pretty KV generation in the row fetcher so KVs will "+
		"be logged",
	false,
)
