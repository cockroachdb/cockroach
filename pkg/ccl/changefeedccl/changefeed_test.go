...
func TestDatabaseLevelChangefeedBasics(t *testing.T) {
	...
	testFn := func(t *testing.T, s TestServer, f cdctest.TestFeedFactory) {
		...
		expectErrCreatingFeed(t, f, `CREATE CHANGEFEED FOR DATABASE d`, "database-level changefeed is not implemented")
...
func TestDatabaseLevelChangefeedDiff(t *testing.T) {
	...
	testFn := func(t *testing.T, s TestServer, f cdctest.TestFeedFactory) {
		...
		sqlDB.Exec(t, `INSERT INTO foo2 VALUES (0, 'initial')`)
		sqlDB.Exec(t, `UPSERT INTO foo2 VALUES (0, 'updated')`)
		expectErrCreatingFeed(t, f, `CREATE CHANGEFEED FOR DATABASE d WITH diff`, `database-level changefeed is not implemented`)
...
func TestMissingDatabaseErr(t *testing.T) {
	defer leaktest.AfterTest(t)()
	defer log.Scope(t).Close(t)
	//TODO: update this when db-level changefeed is supported
	cdcTest(t, func(t *testing.T, s TestServer, f cdctest.TestFeedFactory) {
