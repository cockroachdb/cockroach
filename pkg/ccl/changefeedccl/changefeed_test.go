...
func TestChangefeedIdleness(t *testing.T) {
	...
	cdcTest(t, func(t *testing.T, s TestServer, f cdctest.TestFeedFactory) {
		...
		// Changefeed should run after the insert, but start the check before it
		// because the changefeed may become idle again before the next
		// opportunity to check occurs.
