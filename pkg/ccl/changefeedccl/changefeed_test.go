...
func TestChangefeedErrors(t *testing.T) {
	...
	sqlDB.ExpectErr(
		t, `client has run out of available brokers`,
		`CREATE CHANGEFEED FOR foo INTO 'kafka://nope/?tls_enabled=true&tls_skip_verify=true'`,
	)
	...
	sqlDB.ExpectErr(
		...
		`CREATE CHANGEFEED FOR foo INTO $1`, `kafka://nope/?tls_enabled=true&tls_skip_verify=foo`,
	)
	sqlDB.ExpectErr(
