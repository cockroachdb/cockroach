...
func TestShowChangefeedJobsShowsHighWaterTimestamp(t *testing.T) {
	...
	testFn := func(t *testing.T, s TestServer, f cdctest.TestFeedFactory) {
		...
		testutils.SucceedsSoon(t, func() error {
			stmt := "SELECT high_water_timestamp, readable_high_water_timestamp from [SHOW CHANGEFEED JOBS]"
		...
		require.Equal(t, roundedHighWaterTimestamp, readableHighWater.Time)
	}
