...
func (b *blockingBuffer) Get(ctx context.Context) (ev Event, r Resource, err error) {
	for {
		...
		if got != nil {
			...
			r = allocatedResource{alloc: got.alloc, qp: b.qp, metrics: b.metrics}
...
func (b *blockingBuffer) Add(ctx context.Context, e Event) error {
	ensureOpened := func(acquireLock bool) error {
		...
		if b.mu.closed {
			logcrash.ReportOrPanic(ctx, b.sv, "add called after close")
			return errors.AssertionFailedf("add called after close")
		}
...
func (b *blockingBuffer) Close(ctx context.Context) error {
	...
	if alloc > 0 {
		allocatedResource{qp: b.qp, alloc: alloc, metrics: b.metrics}.Release()
	}
...
func (a allocatedResource) Release() {
	a.qp.Update(func(r quotapool.Resource) (shouldNotify bool) {
		...
		a.metrics.BufferEntriesMemReleased.Inc(a.alloc)
		a.metrics.BufferEntriesReleased.Inc(1)
		return true
	})
}
