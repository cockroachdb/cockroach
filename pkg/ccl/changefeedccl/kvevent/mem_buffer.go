...
// NewMemBuffer constructs a new in-memory buffer. The buffer will track the
// memory usage of events it contains using the BoundAccount and will fail if it
// cannot allocate more memory. The thing is sort of insane in that it provides
// no backpressure on production of data.
