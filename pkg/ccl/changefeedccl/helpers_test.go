...
// createChangefeedCheckDuplicateNotices is used for checking duplicate changefeed notices when creating changefeeds.
// If multiple notices returned, it checks all to see that the expected notice is present
// exactly once.
func createChangefeedCheckDuplicateNotices(
	t *testing.T,
