...
func stripTsFromPayloads(envelopeType changefeedbase.EnvelopeType, payloads []cdctest.TestFeedMessage) ([]string, error) {
	var actual []string
...
func assertPayloadsBase(
	t testing.TB, f cdctest.TestFeed, expected []string, stripTs bool, perKeyOrdered bool, envelopeType changefeedbase.EnvelopeType,
) {
	t.Helper()
...
func assertPayloadsBaseErr(
	ctx context.Context, f cdctest.TestFeed, expected []string, stripTs bool, perKeyOrdered bool, envelopeType changefeedbase.EnvelopeType,
) error {
...
func assertPayloadsEnvelopeStripTs(t testing.TB, f cdctest.TestFeed, envelopeType changefeedbase.EnvelopeType, expected []string) {
	t.Helper()
