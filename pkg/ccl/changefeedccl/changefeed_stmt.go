...
func matchDescriptorToTablePattern(p sql.PlanHookState, descs []catalog.Descriptor, t tree.TablePattern) (catalog.TableDescriptor, error) {
	...
	for _, desc := range descs {
		...
		if ok && tbl.GetName() == pattern.String() {
			return tbl, nil
		}
	}
