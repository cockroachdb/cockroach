...
const (
	...
	SinkParamSASLKerberosServiceName = `sasl_kerberos_service_name`
	SinkParamSASLKerberosRealm       = `sasl_kerberos_realm`
	SinkParamSASLKerberosKeytabPath  = `sasl_kerberos_keytab_path`
	SinkParamSASLKerberosPrincipal   = `sasl_kerberos_principal`
	SinkParamSASLKerberosConfig      = `sasl_kerberos_config`
