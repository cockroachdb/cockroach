...
const (
	...
	OptHTTPAuthHeader           = `http_auth_header`
	OptHTTPClientTimeout        = `http_client_timeout`
...
var ChangefeedOptionExpectValues = map[string]sql.KVStringOptValidate{
	...
	OptHTTPAuthHeader:           sql.KVStringOptRequireValue,
	OptHTTPClientTimeout:        sql.KVStringOptRequireValue,
}
