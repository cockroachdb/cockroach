...
const (
	...
	OptJSONValueNullAsObject              = `json_value_null_as_object`
...
var ChangefeedOptionExpectValues = map[string]OptionPermittedValues{
	...
	OptJSONValueNullAsObject:              flagOption,
}
...
var CommonOptions = makeStringSet(OptCursor, OptEndTime, OptEnvelope,
	...
	OptIgnoreDisableChangefeedReplication, OptJSONValueNullAsObject,
)
...
func (s StatementOptions) GetEncodingOptions() (EncodingOptions, error) {
	...
	_, o.JSONValueNullAsObject = s.m[OptJSONValueNullAsObject]
