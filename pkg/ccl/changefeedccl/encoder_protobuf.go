...
type protobufEncoder struct {
	...
	keyInValue         bool                        // if key is in the value field - bare?
...
func newProtobufEncoder(
	...
	return &protobufEncoder{
		...
		beforeField:        opts.Diff, // not in bare?
...
func (e *protobufEncoder) EncodeValue(
	...
	default:
		return nil, errors.Errorf("envelope format not supported yet:  %s", e.envelopeType)
	}
}
...
func datumToProtoValue(d tree.Datum) *changefeedpb.Value {
	if d == tree.DNull {
		// how to handle null value better?
