...
// staticNodePartition assigns static partitions to the nodes.
func staticNodePartition(
	ctx context.Context,
...
func partitionSpans(
	...
	if usingStaticPartition(details) {
		spanPartitions, err = staticNodePartition(ctx, details.StaticPartition, dsp, locFilter)
	} else {
