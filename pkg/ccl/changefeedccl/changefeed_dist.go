...
var disableCheckpointFieldsInvariantCheck = envutil.EnvOrDefaultBool(
	"COCKROACH_CHANGEFEED_TESTING_DISABLE_CHECKPOINT_FIELDS_INVARIANT_CHECK", false)
...
func startDistChangefeed(
	...
	if legacyCheckpoint != nil && spanLevelCheckpoint != nil {
		...
		if buildutil.CrdbTestBuild && !disableCheckpointFieldsInvariantCheck {
			return errors.AssertionFailedf("both legacy and current checkpoint set on " +
