...
func buildDefaultKafkaConfig(u sinkURL) (kafkaDialConfig, error) {
	...
	case sarama.SASLTypeSCRAMSHA256, sarama.SASLTypeSCRAMSHA512, sarama.SASLTypeOAuth, sarama.SASLTypePlaintext, changefeedbase.SASLTypeAwsIAMRole:
	default:
		return kafkaDialConfig{}, errors.Errorf(`param %s must be one of %s, %s, %s, %s or %s`,
			changefeedbase.SinkParamSASLMechanism,
			sarama.SASLTypeSCRAMSHA256, sarama.SASLTypeSCRAMSHA512, sarama.SASLTypeOAuth, sarama.SASLTypePlaintext, changefeedbase.SASLTypeAwsIAMRole)
	}
	...
	case changefeedbase.SASLTypeAwsIAMRole:
...
func buildKafkaConfig(
	...
	if dialConfig.saslEnabled {
		...
		if dialConfig.saslMechanism == changefeedbase.SASLTypeAwsIAMRole {
