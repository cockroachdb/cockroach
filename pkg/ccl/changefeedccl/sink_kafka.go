...
const saramaMetricThrottleMS saramaMetricName = "throttle-time-in-ms"
...
func addMetricSpy(metricName saramaMetricName, config *sarama.Config, onUpdate func(int64)) {
...
func addOnThrottleCallback(s *kafkaSink, config *sarama.Config) {
	addMetricSpy(saramaMetricThrottleMS, config, func(t int64) {
