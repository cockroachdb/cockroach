...
var (
	...
	metaChangefeedResolvedMessages = metric.Metadata{
		Name:        "changefeed.resolved_messages",
		Help:        "Resolved messages emitted by all feeds",
		Measurement: "Messages",
		Unit:        metric.Unit_COUNT,
	}
...
func MakeMetrics(histogramWindow time.Duration) metric.Struct {
	m := &Metrics{
		...
		ResolvedMessages:  metric.NewCounter(metaChangefeedResolvedMessages),
