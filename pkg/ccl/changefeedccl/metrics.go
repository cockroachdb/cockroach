...
var (
	metaChangefeedForwardedResolvedMessages = metric.InitMetadata(metric.Metadata{
	...
	metaChangefeedErrorRetries = metric.InitMetadata(metric.Metadata{
	...
	metaChangefeedFailures = metric.InitMetadata(metric.Metadata{
	...
	metaEventQueueTime = metric.InitMetadata(metric.Metadata{
	...
	metaChangefeedCheckpointHistNanos = metric.InitMetadata(metric.Metadata{
	...
	metaChangefeedFrontierUpdates = metric.InitMetadata(metric.Metadata{
	...
	metaChangefeedEventConsumerFlushNanos = metric.InitMetadata(metric.Metadata{
	...
	metaChangefeedEventConsumerConsumeNanos = metric.InitMetadata(metric.Metadata{
	...
	metaChangefeedEventConsumerInFlightEvents = metric.InitMetadata(metric.Metadata{
	...
	metaChangefeedTableBytes = metric.InitMetadata(metric.Metadata{
	...
	metaChangefeedUsageErrorCount = metric.InitMetadata(metric.Metadata{
	...
	metaChangefeedUsageQueryDuration = metric.InitMetadata(metric.Metadata{
	...
	metaNetworkBytesIn = metric.InitMetadata(metric.Metadata{
	...
	metaNetworkBytesOut = metric.InitMetadata(metric.Metadata{
...
func newAggregateMetrics(histogramWindow time.Duration, lookup *cidr.Lookup) *AggMetrics {
	metaChangefeedEmittedMessages := metric.InitMetadata(metric.Metadata{
	...
	metaChangefeedEmittedBatchSizes := metric.InitMetadata(metric.Metadata{
	...
	metaChangefeedFilteredMessages := metric.InitMetadata(metric.Metadata{
	...
	metaChangefeedEmittedBytes := metric.InitMetadata(metric.Metadata{
	...
	metaChangefeedFlushedBytes := metric.InitMetadata(metric.Metadata{
	...
	metaChangefeedFlushes := metric.InitMetadata(metric.Metadata{
	...
	metaSizeBasedFlushes := metric.InitMetadata(metric.Metadata{
	...
	metaChangefeedBatchHistNanos := metric.InitMetadata(metric.Metadata{
	...
	metaChangefeedFlushHistNanos := metric.InitMetadata(metric.Metadata{
	...
	metaCommitLatency := metric.InitMetadata(metric.Metadata{
	...
	metaAdmitLatency := metric.InitMetadata(metric.Metadata{
	...
	metaChangefeedBackfillCount := metric.InitMetadata(metric.Metadata{
	...
	metaChangefeedBackfillPendingRanges := metric.InitMetadata(metric.Metadata{
	...
	metaChangefeedRunning := metric.InitMetadata(metric.Metadata{
	...
	metaMessageSize := metric.InitMetadata(metric.Metadata{
	...
	metaBatchReductionCount := metric.InitMetadata(metric.Metadata{
	...
	metaInternalRetryMessageCount := metric.InitMetadata(metric.Metadata{
	...
	metaSchemaRegistryRetriesCount := metric.InitMetadata(metric.Metadata{
	...
	metaSchemaRegistryRegistrations := metric.InitMetadata(metric.Metadata{
	...
	metaChangefeedParallelIOQueueNanos := metric.InitMetadata(metric.Metadata{
	...
	metaChangefeedParallelIOPendingRows := metric.InitMetadata(metric.Metadata{
	...
	metaChangefeedParallelIOResultQueueNanos := metric.InitMetadata(metric.Metadata{
	...
	metaChangefeedParallelIOInFlightKeys := metric.InitMetadata(metric.Metadata{
	...
	metaChangefeedParallelIOWorkers := metric.InitMetadata(metric.Metadata{
	...
	metaChangefeedSinkIOInflight := metric.InitMetadata(metric.Metadata{
	...
	metaChangefeedSinkBackpressureNanos := metric.InitMetadata(metric.Metadata{
	...
	metaAggregatorProgress := metric.InitMetadata(metric.Metadata{
	...
	metaCheckpointProgress := metric.InitMetadata(metric.Metadata{
	...
	metaLaggingRanges := metric.InitMetadata(metric.Metadata{
	...
	metaTotalRanges := metric.InitMetadata(metric.Metadata{
	...
	metaCloudstorageBufferedBytes := metric.InitMetadata(metric.Metadata{
	...
	metaChangefeedKafkaThrottlingNanos := metric.InitMetadata(metric.Metadata{
	...
	metaSinkErrors := metric.InitMetadata(metric.Metadata{
	...
	// for now.
	metaChangefeedMaxBehindNanos := metric.InitMetadata(metric.Metadata{
	...
	metaChangefeedSpanProgressSkew := metric.InitMetadata(metric.Metadata{
	...
	metaChangefeedTableProgressSkew := metric.InitMetadata(metric.Metadata{
