...
const enableSLIMetricsEnvVar = "COCKROACH_EXPERIMENTAL_ENABLE_PER_CHANGEFEED_METRICS"

var enableSLIMetrics = envutil.EnvOrDefaultBool(enableSLIMetricsEnvVar, false)
...
func (a *AggMetrics) getOrCreateScope(scope string) (*sliMetrics, error) {
	...
	if scope != defaultSLIScope && !enableSLIMetrics {
