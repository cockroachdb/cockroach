...
var (
	...
	// TODO(ssd): emit_hist_nanos and flush_hist_nanos duplicate
	// information in emit_nanos, emitted_messages, and
	// flush_nanos, flushes. While all of those could be
	// reconstructed from information in the histogram, I've kept
	// the older metrics to avoid breaking historical timeseries
	// data.
