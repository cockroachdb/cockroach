...
func (cm *ClusterMetrics) SetCheckpointLag(jobID jobspb.JobID, scope string, frontierNanos int64) {
	cm.CheckpointLag.UpdateStartTime(checkpointLagLabels(jobID, scope), frontierNanos)
}
...
func (cm *ClusterMetrics) DeleteJob(jobID jobspb.JobID, scope string) {
	cm.CheckpointLag.Delete(checkpointLagLabels(jobID, scope))
}

func checkpointLagLabels(jobID jobspb.JobID, scope string) map[string]string {
