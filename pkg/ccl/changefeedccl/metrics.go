...
func (m *JobScopedBillingMetrics) DeregisterJobMetrics(jobID catpb.JobID) {
	m.m.Lock()
	defer m.m.Unlock()
...
type Metrics struct {
	...
	BillingMetrics                 *JobScopedBillingMetrics
...
func MakeMetrics(histogramWindow time.Duration) metric.Struct {
	m := &Metrics{
		...
		BillingMetrics:    newJobScopedBillingMetrics(histogramWindow),
