...
// keeping track of aggregate metrics for all changefeeds.
const defaultSLIScope = "aggregate"
...
// sliMetrics is a structure holding all SLI related metrics aggregated into AggMetrics.
