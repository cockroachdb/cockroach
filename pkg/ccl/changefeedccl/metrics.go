...
var (
	...
	metaChangefeedReplanMetrics = metric.Metadata{
		Name:        "changefeed.replan_metrics",
...
func MakeMetrics(histogramWindow time.Duration) metric.Struct {
	m := &Metrics{
		...
		ReplanMetrics:   metric.NewCounter(metaChangefeedReplanMetrics),
	}
