...
var stateTransitions = fsm.Pattern{
	stateRunning{FeedPaused: fsm.Any, TxnOpen: fsm.Any,
		CanAddColumn: fsm.Any, CanRemoveColumn: fsm.Any}: {
		eventFinished{}: {
			Next:   stateDone{},
	...
	stateRunning{FeedPaused: fsm.False, TxnOpen: fsm.False,
		...
		eventOpenTxn{}: {
			Next: stateRunning{FeedPaused: fsm.False, TxnOpen: fsm.True,
				CanAddColumn: fsm.Var("x"), CanRemoveColumn: fsm.Var("y")},
	...
	stateRunning{FeedPaused: fsm.False, TxnOpen: fsm.True,
		CanAddColumn: fsm.Var("x"), CanRemoveColumn: fsm.Var("y")}: {
		eventCommit{}: {
			Next: stateRunning{FeedPaused: fsm.False, TxnOpen: fsm.False,
				CanAddColumn: fsm.Var("x"), CanRemoveColumn: fsm.Var("y")},
