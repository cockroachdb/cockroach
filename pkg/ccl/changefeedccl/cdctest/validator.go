...
func (vt IntegrityValidationType) StartWorkload(
	ctx context.Context, t test.Test, db *gosql.DB, monGo func(func(context.Context) error),
) (wait func()) {
	switch vt {
	case IntegrityValidationNone:
		return func() {}
...
func (vt IntegrityValidationType) startEachKeySequentialWorkload(
	ctx context.Context, t test.Test, db *gosql.DB, monGo func(func(context.Context) error),
) (wait func()) {
...
func (c *eachKeySequentialIntegrityValidator) NoteResolved(
	partition string, resolved hlc.Timestamp,
) error {
	return c.inner.NoteResolved(partition, resolved)
}

func (c *eachKeySequentialIntegrityValidator) NoteRow(
	partition string, key string, value string, updated hlc.Timestamp,
) error {
	type val struct {
		After struct {
			ID int `json:"id"`
