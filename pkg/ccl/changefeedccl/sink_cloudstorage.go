...
type cloudStorageSinkFile struct {
	// This is the least resolved timestamp being tracked by `sf`
	// as of the time of creation of the `cloudStorageSinkFile` object.
	// cloudStorageSink uses these timestamps to order its output files
	// such that CDC's external ordering guarantees are preserved.
