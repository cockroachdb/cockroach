...
func New(
	...
	m := &schemaFeed{
		...
		allowOfflineDescriptor: allowOfflineDescriptor,
...
func (tf *schemaFeed) validateDescriptor(
	...
	case catalog.TableDescriptor:
		if err := changefeedvalidators.ValidateTable(tf.targets, desc, tf.tolerances, tf.allowOfflineDescriptor); err != nil {
			return err
		}
