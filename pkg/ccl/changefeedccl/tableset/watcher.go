...
// Pop()) was last called (or the initialTS) and the given timestamp.
// [inclusive, exclusive).
// It's a convenience wrapper around Pop().
...
// timestamp) and the given timestamp [inclusive, exclusive).
// Users of this package will usually call `Pop` instead, but this is exposed for testing.
