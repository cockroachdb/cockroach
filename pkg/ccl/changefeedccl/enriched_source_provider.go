...
func addNonFixedField(
	nonFixedJSONFields *[]string, nonFixedDataIdx map[string]int, fieldName string,
) {
...
func newEnrichedSourceProvider(
	...
	addNonFixedField(&nonFixedJSONFields, nonFixedDataIdx, fieldNameDatabaseName)
	addNonFixedField(&nonFixedJSONFields, nonFixedDataIdx, fieldNameSchemaName)
	addNonFixedField(&nonFixedJSONFields, nonFixedDataIdx, fieldNameTableName)
	addNonFixedField(&nonFixedJSONFields, nonFixedDataIdx, fieldNamePrimaryKeys)

	if opts.MVCCTimestamps {
		addNonFixedField(&nonFixedJSONFields, nonFixedDataIdx, fieldNameMVCCTimestamp)
	}
