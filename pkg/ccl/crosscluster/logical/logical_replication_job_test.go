...
func TestMultipleSourcesIntoSingleDest(t *testing.T) {
	...
	WaitUntilReplicatedTime(t, now, runners[2], jobIDs[2])
	runners[0].CheckQueryResults(t, "SELECT * from tab", expectedRowsS1)
	runners[1].CheckQueryResults(t, "SELECT * from tab", expectedRowsDest)
	runners[2].CheckQueryResults(t, "SELECT * from tab", expectedRowsDest)
}
