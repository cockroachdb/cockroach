...
var (
	implicitTxnOverrides = sessiondata.InternalExecutorOverride{
		...
		// origin ID 1 to each batch request header sent by the internal executor.
		// This metadata will be plumbed to the MVCCValueHeader of each written kv,
		// and will be used by source side rangefeeds to filter these replicated
		// events, preventing data looping.
		//
