...
type Client interface {
	...
	// StartAndPlanEphemeralSpanConfigsStream creates a stream for the span configs
	...
	// source cluster.
	StartAndPlanEphemeralSpanConfigsStream(ctx context.Context, tenant roachpb.TenantName) (streampb.StreamID, Topology, error)
