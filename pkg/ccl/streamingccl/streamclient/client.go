...
type getNewClientDialer func(ctx context.Context, address streamingccl.StreamAddress) (Dialer, error)

func getFirstClientDialer(
	ctx context.Context, streamAddresses []string, newClient getNewClientDialer,
) (Dialer, error) {
