...
// results.
//
//   - job as=<source-system | source-tenant | destination-system | destination-tenant> args
//
// Takes some action on the job. Some arguments:
//
//   - wait-for-state=<succeeded|paused|failed|cancelled>: wait for
