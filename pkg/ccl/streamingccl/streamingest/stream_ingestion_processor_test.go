...
func (m *mockStreamClient) Create(ctx context.Context, target roachpb.TenantID) (streamclient.StreamID, error) {
	panic("unimplemented")
}

// Heartbeat implements the Client interface.
func (m *mockStreamClient) Heartbeat(ctx context.Context, ID streamclient.StreamID, _ hlc.Timestamp) error {
	panic("unimplemented")
}
...
func (m *mockStreamClient) Plan(
	ctx context.Context,
	_ streamclient.StreamID,
) (streamclient.Topology, error) {
	panic("unimplemented mock method")
}

// ConsumePartition implements the Client interface.
func (m *mockStreamClient) Subscribe(ctx context.Context,
...
func (m *errorStreamClient) Subscribe(ctx context.Context,
	stream streamclient.StreamID,
	spec streamclient.SubscriptionToken,
	checkpoint hlc.Timestamp,
) (chan streamingccl.Event, chan error, error) {
...
func getStreamIngestionProcessor(
	...
	for i, pa := range partitions {
		...
		spec.PartitionAddresses[i] = pa.SrcAddr.String()
