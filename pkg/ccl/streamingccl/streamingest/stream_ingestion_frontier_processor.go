...
// frontierEntriesInfoKey is the info key at which the stream ingestion frontier
// periodically dumps its state.
const frontierEntriesInfoKey = "~replication-frontier-entries.binpb"
