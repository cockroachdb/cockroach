...
func getReplicationStatsAndStatus(
	...
	if err != nil {
		return nil, jobspb.StreamIngestionProgress_REPLICATION_ERROR.String(), err
	}
	details, ok := job.Details().(jobspb.StreamIngestionDetails)
	if !ok {
		return nil, jobspb.StreamIngestionProgress_REPLICATION_ERROR.String(),
	...
	if job.Status() == jobs.StatusPaused {
		return stats, jobspb.StreamIngestionProgress_REPLICATION_PAUSED.String(), nil
	}
	if stats == nil || stats.IngestionProgress == nil {
		return stats, jobspb.StreamIngestionProgress_INITIALIZING_REPLICATION.String(), nil
	}
...
func activateTenant(ctx context.Context, execCtx interface{}, newTenantID roachpb.TenantID) error {
	...
	return execCfg.InternalDB.Txn(ctx, func(
		...
		info, err := sql.GetTenantRecordByID(ctx, txn, newTenantID)
		if err != nil {
			return err
		}
...
func (s *streamIngestionResumer) OnFailOrCancel(
	...
	return execCfg.InternalDB.Txn(ctx, func(
		...
		tenInfo, err := sql.GetTenantRecordByID(ctx, txn, details.DestinationTenantID)
		if err != nil {
