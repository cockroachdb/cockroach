...
// GetStreamIngestionStatsAndStatus implements streaming.StreamIngestManager interface.
...
func (r *streamIngestManagerImpl) RevertTenantToTimestamp(
	...
	if err := execCfg.InternalDB.Txn(ctx, func(ctx context.Context, txn isql.Txn) error {
		tenantRecord, err := sql.GetTenantRecordByName(ctx, r.evalCtx.Settings, r.txn, tenantName)
		if err != nil {
			return err
		}
		...
		return sql.UpdateTenantRecord(ctx, r.evalCtx.Settings, r.txn, tenantRecord)
	}); err != nil {
		return err
	}
	defer ptsCleanup()
