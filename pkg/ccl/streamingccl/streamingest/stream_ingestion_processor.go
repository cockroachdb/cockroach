...
// Start is launches a set of goroutines that read from the spans
...
func (sip *streamIngestionProcessor) close() {
	...
	// members for the worker group. The mergedSubscription close
	// above should result in exit signals being sent to all
	// relevant goroutines.
