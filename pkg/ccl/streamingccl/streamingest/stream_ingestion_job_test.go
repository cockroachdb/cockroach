...
`)
	...
	hDest, cleanupDest := streamingtest.NewReplicationHelper(t, base.TestServerArgs{}, roachpb.TenantID{InternalValue: 20})
	defer cleanupDest()
...
`)
	...
	testutils.SucceedsSoon(t, func() error {
		...
		fmt.Printf("highwater: %s cutover: %s\n", highwater, cutoverTime)
