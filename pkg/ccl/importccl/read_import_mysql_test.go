...
const expectedParentID = 53
const expectedParentSchemaID = 54
...
func readMysqlCreateFrom(
	...
	publicSchemaPrivileges := descpb.NewBasePrivilegeDescriptor(security.RootUserName())
