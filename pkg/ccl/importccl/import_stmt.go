...
func (r *importResumer) publishTables(ctx context.Context) error {
	details := r.job.Details().(jobspb.ImportDetails)
	...
	for i := range details.Tables {
		r.execCfg.StatsRefresher.NotifyMutation(details.Tables[i].Desc.ID, math.MaxInt32 /* rowsAffected */)
	}
