...
func (r fkResolver) LookupObject(ctx context.Context, dbName, scName, obName string) (found bool, objMeta tree.NameResolutionResult, err error) {
	tbl, ok := r[obName]
	if ok {
		return true, tbl, nil
	}
...
func (r fkResolver) LookupSchema(ctx context.Context, dbName, scName string) (found bool, scMeta tree.SchemaMeta, err error) {
