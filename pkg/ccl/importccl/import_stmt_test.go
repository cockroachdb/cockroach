...
// BenchmarkNodelocalImport-16    	       1	12140353261 ns/op	   4.65 MB/s
// BenchmarkNodelocalImport-16    	       1	11848951147 ns/op	   4.77 MB/s
// BenchmarkNodelocalImport-16    	       1	11906942926 ns/op	   4.74 MB/s
// BenchmarkNodelocalImport-16    	       1	11057788435 ns/op	   5.11 MB/s
// BenchmarkNodelocalImport-16    	       1	13932378269 ns/op	   4.06 MB/s
// BenchmarkNodelocalImport-16    	       1	12743663460 ns/op	   4.43 MB/s
// BenchmarkNodelocalImport-16    	       1	11725146403 ns/op	   4.82 MB/s
// BenchmarkNodelocalImport-16    	       1	11835203946 ns/op	   4.77 MB/s
// BenchmarkNodelocalImport-16    	       1	11972780913 ns/op	   4.72 MB/s
// BenchmarkNodelocalImport-16    	       1	11980221596 ns/op	   4.72 MB/s
func BenchmarkNodelocalImport(b *testing.B) {
	...
	// So numRows gives us ~50 MiB of generated CSV content.
	numRows := 2 * 1024 * 1024
	...
	// Assert that the generated content is > 50 Mib but < 55 Mib. If not, the
	// csvGenerator semantics have changed and the number of rows might need to be
	// tweaked.
...
// goarch: amd64
// pkg: github.com/cockroachdb/cockroach/pkg/ccl/importccl
// BenchmarkUserfileImport-16    	       1	15346918388 ns/op	   3.68 MB/s
// BenchmarkUserfileImport-16    	       1	11813260432 ns/op	   4.78 MB/s
// BenchmarkUserfileImport-16    	       1	12681948749 ns/op	   4.45 MB/s
// BenchmarkUserfileImport-16    	       1	13885448712 ns/op	   4.07 MB/s
// BenchmarkUserfileImport-16    	       1	13920615604 ns/op	   4.06 MB/s
// BenchmarkUserfileImport-16    	       1	13887126528 ns/op	   4.07 MB/s
// BenchmarkUserfileImport-16    	       1	11374035033 ns/op	   4.97 MB/s
// BenchmarkUserfileImport-16    	       1	12223213010 ns/op	   4.62 MB/s
// BenchmarkUserfileImport-16    	       1	11900816989 ns/op	   4.75 MB/s
// BenchmarkUserfileImport-16    	       1	11932175764 ns/op	   4.73 MB/s
func BenchmarkUserfileImport(b *testing.B) {
	...
	// Every row (int, string) generated by the CSVGenerator is ~25 bytes. So
	// numRows gives us ~50 MiB of generated CSV content.
	numRows := 2 * 1024 * 1024
	csvGen := newCsvGenerator(0, numRows, &intGenerator{}, &strGenerator{})
	defer csvGen.Close()
	...
	userfileStorage, err := tc.Server(0).ExecutorConfig().(sql.ExecutorConfig).DistSQLSrv.
		ExternalStorageFromURI(ctx, "userfile://defaultdb.public.root/test/data", security.RootUser)
	require.NoError(b, err)
	...
	sqlDB.Exec(b,
		fmt.Sprintf(
			`IMPORT TABLE t (a INT8 PRIMARY KEY, b STRING, INDEX (b), INDEX (a, b))
			CSV DATA ('%s')`,
			"userfile://defaultdb.public.root/test/data",
		))
}
