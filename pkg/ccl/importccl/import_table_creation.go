...
func MakeSimpleTableDescriptor(
	...
	if create.IfNotExists {
		return nil, unimplemented.NewWithIssuef(42846, "unsupported IF NOT EXISTS")
	}
	if create.Interleave != nil {
		return nil, unimplemented.NewWithIssuef(42846, "interleaved not supported")
	}
	if create.AsSource != nil {
		return nil, unimplemented.NewWithIssuef(42846, "CREATE AS not supported")
	}
	...
	for i := range create.Defs {
		...
		case *tree.ColumnTableDef:
			if def.Computed.Expr != nil {
				return nil, unimplemented.NewWithIssuef(42846, "computed columns not supported: %s", tree.AsString(def))
			}
		...
		case *tree.ForeignKeyConstraintTableDef:
			if !fks.allowed {
				return nil, unimplemented.NewWithIssuef(42846, "this IMPORT format does not support foreign keys")
			}
			if fks.skip {
				continue
			}
