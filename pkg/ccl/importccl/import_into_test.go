...
func TestProtectedTimestampsDuringImportInto(t *testing.T) {
	...
	/*	// Cancel the job and ensure that the cancellation succeeded. Prior to
		// protected timestamps this call would return an error due to a failure
		// to revert a range due to the GC threshold.
