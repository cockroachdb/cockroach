...
func getEverythingMysqlDumpTestdata(t *testing.T) string {
	...
	if rewriteMysqlTestData {
		genEverythingMysqlTestdata(t, func() { mysqldump(t, dest, "everything") }, func() {})
	}
	return dest
}
...
// calls the passed `load` func to populate it before calling the passed `dump`
// func to generate testdata from it and returns a cleanup func.
func genMysqlTestdata(t *testing.T, name, schema string, load func(*gosql.DB), dump func()) func() {
