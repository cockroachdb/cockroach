...
func (lu *mockLDAPUtil) LDAPSConn(ctx context.Context, conf ldapAuthenticatorConf) error {
	if strings.Contains(conf.ldapServer, "invalid") {
		return errors.Newf(ldapsFailureMessage + ": invalid ldap server provided")
	} else if strings.Contains(conf.ldapPort, "invalid") {
...
func (lu *mockLDAPUtil) Bind(ctx context.Context, username string, password string) error {
	if strings.Contains(username, "invalid") {
		return errors.Newf(bindFailureMessage + ": invalid username provided")
	} else if strings.Contains(password, "invalid") {
...
func TestLDAPAuthentication(t *testing.T) {
	...
	testCases := []struct {
		...
		{testName: "proper hba conf and root user cred",
			user: "root", pwd: "bar", ldapAuthSuccess: false, expectedErr: "LDAP authentication: invalid identity", expectedErrDetails: "cannot use LDAP auth to login to a reserved user root"},
		{testName: "proper hba conf and node user cred",
			user: "node", pwd: "bar", ldapAuthSuccess: false, expectedErr: "LDAP authentication: invalid identity", expectedErrDetails: "cannot use LDAP auth to login to a reserved user node"},
		{testName: "invalid ldap option",
			hbaConfLDAPOpts: map[string]string{"invalidOpt": "invalidVal"}, user: "foo", pwd: "bar", ldapAuthSuccess: false, expectedErr: "LDAP authentication: unable to fetch hba conf options",
		...
		{testName: "empty server",
			hbaConfLDAPOpts: map[string]string{"ldapserver": "empty"}, user: "foo", pwd: "bar", ldapAuthSuccess: false, expectedErr: "LDAP authentication: unable to validate authenticator options",
		...
		{testName: "invalid server",
			hbaConfLDAPOpts: map[string]string{"ldapserver": "invalid"}, user: "foo", pwd: "bar", ldapAuthSuccess: false, expectedErr: "LDAP authentication: unable to establish LDAP connection",
			expectedDetailedErrMsg: "error when trying to create LDAP connection: LDAPs connection failed: invalid ldap server provided"},
		{testName: "empty port",
			hbaConfLDAPOpts: map[string]string{"ldapport": "empty"}, user: "foo", pwd: "bar", ldapAuthSuccess: false, expectedErr: "LDAP authentication: unable to validate authenticator options",
		...
		{testName: "invalid port",
			hbaConfLDAPOpts: map[string]string{"ldapport": "invalid"}, user: "foo", pwd: "bar", ldapAuthSuccess: false, expectedErr: "LDAP authentication: unable to establish LDAP connection",
		...
		{testName: "empty base dn",
			hbaConfLDAPOpts: map[string]string{"ldapbasedn": "empty"}, user: "foo", pwd: "bar", ldapAuthSuccess: false, expectedErr: "LDAP authentication: unable to validate authenticator options",
		...
		{testName: "invalid base dn",
			hbaConfLDAPOpts: map[string]string{"ldapbasedn": "invalid"}, user: "foo", pwd: "bar", ldapAuthSuccess: false, expectedErr: "LDAP authentication: unable to find LDAP user distinguished name",
			expectedErrDetails: "cannot find provided user foo on LDAP server", expectedDetailedErrMsg: "error when searching for user in LDAP server: LDAP search failed: invalid base DN \"invalid\" provided"},
		{testName: "empty bind dn",
			hbaConfLDAPOpts: map[string]string{"ldapbinddn": "empty"}, user: "foo", pwd: "bar", ldapAuthSuccess: false, expectedErr: "LDAP authentication: unable to validate authenticator options",
		...
		{testName: "invalid bind dn",
			hbaConfLDAPOpts: map[string]string{"ldapbinddn": "invalid"}, user: "foo", pwd: "bar", ldapAuthSuccess: false, expectedErr: "LDAP authentication: unable to find LDAP user distinguished name",
			expectedErrDetails: "cannot find provided user foo on LDAP server", expectedDetailedErrMsg: "error when searching for user in LDAP server: LDAP search failed: LDAP bind failed: invalid username provided"},
		{testName: "empty bind pwd",
			hbaConfLDAPOpts: map[string]string{"ldapbindpasswd": "empty"}, user: "foo", pwd: "bar", ldapAuthSuccess: false, expectedErr: "LDAP authentication: unable to validate authenticator options",
		...
		{testName: "invalid bind pwd",
			hbaConfLDAPOpts: map[string]string{"ldapbindpasswd": "invalid"}, user: "foo", pwd: "bar", ldapAuthSuccess: false, expectedErr: "LDAP authentication: unable to find LDAP user distinguished name",
			expectedErrDetails: "cannot find provided user foo on LDAP server", expectedDetailedErrMsg: "error when searching for user in LDAP server: LDAP search failed: LDAP bind failed: invalid password provided"},
		{testName: "empty search attribute",
			hbaConfLDAPOpts: map[string]string{"ldapsearchattribute": "empty"}, user: "foo", pwd: "bar", ldapAuthSuccess: false, expectedErr: "LDAP authentication: unable to validate authenticator options",
		...
		{testName: "invalid search attribute",
			hbaConfLDAPOpts: map[string]string{"ldapsearchattribute": "invalid"}, user: "foo", pwd: "bar", ldapAuthSuccess: false, expectedErr: "LDAP authentication: unable to find LDAP user distinguished name",
			expectedErrDetails: "cannot find provided user foo on LDAP server", expectedDetailedErrMsg: "error when searching for user in LDAP server: LDAP search failed: invalid search attribute \"invalid\" provided"},
		{testName: "empty search filter",
			hbaConfLDAPOpts: map[string]string{"ldapsearchfilter": "empty"}, user: "foo", pwd: "bar", ldapAuthSuccess: false, expectedErr: "LDAP authentication: unable to validate authenticator options",
		...
		{testName: "invalid search filter",
			hbaConfLDAPOpts: map[string]string{"ldapsearchfilter": "invalid"}, user: "foo", pwd: "bar", ldapAuthSuccess: false, expectedErr: "LDAP authentication: unable to find LDAP user distinguished name",
			expectedErrDetails: "cannot find provided user foo on LDAP server", expectedDetailedErrMsg: "error when searching for user in LDAP server: LDAP search failed: invalid search filter \"invalid\" provided"},
		{testName: "invalid ldap user",
			user: "invalid", pwd: "bar", ldapAuthSuccess: false, expectedErr: "LDAP authentication: unable to find LDAP user distinguished name",
			expectedErrDetails: "cannot find provided user invalid on LDAP server", expectedDetailedErrMsg: "error when searching for user in LDAP server: LDAP search failed: invalid search value \"invalid\" provided"},
		{testName: "no such ldap user",
			...
			expectedErrDetails: "cannot find provided user  on LDAP server", expectedDetailedErrMsg: "error when searching for user in LDAP server: LDAP search failed: user \"\" does not exist"},
		{testName: "too many matching ldap users",
			...
			expectedErrDetails: "cannot find provided user foo,foo2,foo3 on LDAP server", expectedDetailedErrMsg: "error when searching for user in LDAP server: LDAP search failed: too many matching entries returned for user \"foo,foo2,foo3\""},
		{testName: "invalid ldap password",
			user: "foo", pwd: "invalid", ldapAuthSuccess: false, expectedErr: "LDAP authentication: unable to bind as LDAP user",
			expectedErrDetails: "credentials invalid for LDAP server user foo", expectedDetailedErrMsg: "error when biding as user foo with DN(foo) in LDAP server: LDAP bind failed: invalid password provided"},
	}
