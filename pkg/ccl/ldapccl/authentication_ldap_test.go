...
func TestLDAPAuthentication(t *testing.T) {
	...
	testCases := []struct {
		...
		{testName: "empty search attribute",
			...
			expectedErr:            "LDAP authentication: unable to validate authManager authN options",
			expectedDetailedErrMsg: "error validating authN hba conf options for LDAP: ldap authentication params in HBA conf missing search attribute"},
		...
		{testName: "empty search filter",
			...
			expectedErr:            "LDAP authentication: unable to validate authManager authN options",
			expectedDetailedErrMsg: "error validating authN hba conf options for LDAP: ldap authentication params in HBA conf missing search filter"},
