...
//line wkt.y:200
		{
			wktVAL.geom = geom.NewPointFlat(wktlex.(*wktLex).getCurLayout(), wktDollar[2].coordList)
		}
	case 10:
		wktDollar = wktS[wktpt-2 : wktpt+1]
//line wkt.y:204
		{
			wktVAL.geom = geom.NewPointEmpty(wktlex.(*wktLex).getCurLayout())
		}
	case 11:
		wktDollar = wktS[wktpt-2 : wktpt+1]
//line wkt.y:208
...
//line wkt.y:250
		{
			wktVAL.geom = geom.NewLineStringFlat(wktlex.(*wktLex).getCurLayout(), wktDollar[2].coordList)
		}
	case 19:
		wktDollar = wktS[wktpt-2 : wktpt+1]
//line wkt.y:254
		{
			wktVAL.geom = geom.NewLineString(wktlex.(*wktLex).getCurLayout())
		}
	case 20:
		wktDollar = wktS[wktpt-2 : wktpt+1]
//line wkt.y:258
...
//line wkt.y:300
		{
			wktVAL.geom = geom.NewPolygonFlat(wktlex.(*wktLex).getCurLayout(), wktDollar[2].flatRepr.flatCoords, wktDollar[2].flatRepr.ends)
		}
	case 28:
		wktDollar = wktS[wktpt-2 : wktpt+1]
//line wkt.y:304
		{
			wktVAL.geom = geom.NewPolygon(wktlex.(*wktLex).getCurLayout())
		}
	case 29:
		wktDollar = wktS[wktpt-2 : wktpt+1]
//line wkt.y:308
...
//line wkt.y:350
		{
			wktVAL.geom = geom.NewMultiPointFlat(
				wktlex.(*wktLex).getCurLayout(), wktDollar[2].flatRepr.flatCoords, geom.NewMultiPointFlatOptionWithEnds(wktDollar[2].flatRepr.ends),
			)
		}
	case 37:
		wktDollar = wktS[wktpt-2 : wktpt+1]
...
//line wkt.y:362
		{
			wktVAL.geom = geom.NewMultiPoint(wktlex.(*wktLex).getCurLayout())
		}
	case 39:
		wktDollar = wktS[wktpt-2 : wktpt+1]
//line wkt.y:366
...
//line wkt.y:404
		{
			wktVAL.geom = geom.NewMultiLineStringFlat(wktlex.(*wktLex).getCurLayout(), wktDollar[2].flatRepr.flatCoords, wktDollar[2].flatRepr.ends)
		}
	case 45:
		wktDollar = wktS[wktpt-2 : wktpt+1]
//line wkt.y:408
...
//line wkt.y:412
		{
			wktVAL.geom = geom.NewMultiLineString(wktlex.(*wktLex).getCurLayout())
		}
	case 47:
		wktDollar = wktS[wktpt-2 : wktpt+1]
//line wkt.y:416
...
//line wkt.y:454
		{
			wktVAL.geom = geom.NewMultiPolygonFlat(wktlex.(*wktLex).getCurLayout(), wktDollar[2].multiPolyFlatRepr.flatCoords, wktDollar[2].multiPolyFlatRepr.endss)
		}
	case 53:
		wktDollar = wktS[wktpt-2 : wktpt+1]
//line wkt.y:458
...
//line wkt.y:462
		{
			wktVAL.geom = geom.NewMultiPolygon(wktlex.(*wktLex).getCurLayout())
		}
	case 55:
		wktDollar = wktS[wktpt-2 : wktpt+1]
//line wkt.y:466
...
//line wkt.y:745
		{
			if !isValidPolygonRing(wktlex, wktDollar[1].coordList, wktlex.(*wktLex).getCurLayout().Stride()) {
				return 1
			}
			wktVAL.flatRepr = makeGeomFlatCoordsRepr(wktDollar[1].coordList)
		}
...
//line wkt.y:754
		{
			if !isValidLineString(wktlex, wktDollar[1].coordList, wktlex.(*wktLex).getCurLayout().Stride()) {
				return 1
			}
		}
	case 116:
