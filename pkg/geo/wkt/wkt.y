...
%type <pair> empty_point empty_line_pair
...
%type <pair> two_coords_line_pair three_coords_line_pair four_coords_line_pair
%type <pair> two_coords_line_allowing_empty three_coords_line_allowing_empty four_coords_line_allowing_empty
%type <pair> three_coords_line_list four_coords_line_list
%type <pair> two_coords_line_list_allowing_empty_lines
%type <pair> three_coords_line_list_allowing_empty_lines
%type <pair> four_coords_line_list_allowing_empty_lines
...
three_coords_line_list:
	three_coords_line_list ',' three_coords_line_pair
	{
		$$ = appendGeomPairs($1, $3)
	}
|	three_coords_line_pair

four_coords_line_list:
	four_coords_line_list ',' four_coords_line_pair
	{
		$$ = appendGeomPairs($1, $3)
	}
|	four_coords_line_pair
