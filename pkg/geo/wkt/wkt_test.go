...
GEOMETRYCOLLECTION Z ()
		...
		},
		{
			...
			expectedErrStr: `syntax error: mixed dimensionality, parsed layout is XYM but encountered layout of XY, XYZ, or XYZM at pos 36
GEOMETRYCOLLECTION(POINT M (0 0 0), LINESTRING(0 0, 1 1))
                                    ^
HINT: XYM layout must use the M variant of the geometry type`,
		},
		{
			desc:  "2D+M geometrycollection with 3 coords point missing M type",
			input: "GEOMETRYCOLLECTION M (POINT(0 0 0))",
			expectedErrStr: `syntax error: mixed dimensionality, parsed layout is XYM but encountered layout of XY, XYZ, or XYZM at pos 27
...
HINT: XYM layout must use the M variant of the geometry type`,
		},
		{
			...
			expectedErrStr: `syntax error: mixed dimensionality, parsed layout is XYM but encountered layout of XY, XYZ, or XYZM at pos 32
...
HINT: XYM layout must use the M variant of the geometry type`,
		},
		{
			...
			expectedErrStr: `syntax error: mixed dimensionality, parsed layout is XYM but encountered layout of XY, XYZ, or XYZM at pos 29
...
HINT: XYM layout must use the M variant of the geometry type`,
		},
		{
			...
			expectedErrStr: `syntax error: mixed dimensionality, parsed layout is XYM but encountered layout of XY, XYZ, or XYZM at pos 37
...
HINT: XYM layout must use the M variant of the geometry type`,
		},
		{
			...
			expectedErrStr: `syntax error: mixed dimensionality, parsed layout is XYM but encountered layout of XY, XYZ, or XYZM at pos 34
...
GEOMETRYCOLLECTION(LINESTRING EMPTY, POINT(0 0 0))
		...
		},
		{
			...
			expectedErrStr: `syntax error: mixed dimensionality, parsed layout is XYM but encountered layout of XY, XYZ, or XYZM at pos 48
...
HINT: XYM layout must use the M variant of the geometry type`,
		},
		{
			...
			expectedErrStr: `syntax error: mixed dimensionality, parsed layout is XYM but encountered layout of XY, XYZ, or XYZM at pos 60
...
HINT: XYM layout must use the M variant of the geometry type`,
		},
		{
			...
			expectedErrStr: `syntax error: mixed dimensionality, parsed layout is XYM but encountered layout of XY, XYZ, or XYZM at pos 59
