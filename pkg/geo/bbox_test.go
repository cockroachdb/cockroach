...
func TestBoundingBoxFromGeomT(t *testing.T) {
	testCases := []struct {
		...
		{geopb.SpatialObjectType_GeographyType, testGeomLineString, &geopb.BoundingBox{LoX: 0.017453292519943295, LoY: 0.017453292519943295, HiX: 0.03490658503988659, HiY: 0.03490658503988659}},
		{geopb.SpatialObjectType_GeographyType, geom.NewLineStringFlat(geom.XY, []float64{-15, -20, -30, -40}), &geopb.BoundingBox{LoX: -0.5235987755982988, LoY: -0.6981317007977318, HiX: -0.2617993877991494, HiY: -0.3490658503988659}},
		{geopb.SpatialObjectType_GeographyType, testGeomPolygon, &geopb.BoundingBox{LoX: 0.017453292519943295, LoY: 0.017453292519943295, HiX: 0.03490658503988659, HiY: 0.03490658503988659}},
		...
		{geopb.SpatialObjectType_GeographyType, testGeomMultiLineString, &geopb.BoundingBox{LoX: 0.017453292519943295, LoY: 0.017453292519943295, HiX: 0.06981317007977318, HiY: 0.06981317007977318}},
		{geopb.SpatialObjectType_GeographyType, testGeomMultiPolygon, &geopb.BoundingBox{LoX: 0.017453292519943295, LoY: 0.017453292519943295, HiX: 0.06981317007977318, HiY: 0.06981317007977318}},
		...
		{geopb.SpatialObjectType_GeographyType, emptyGeomPointInGeometryCollection, &geopb.BoundingBox{LoX: 0.017453292519943295, LoY: 0.017453292519943295, HiX: 0.03490658503988659, HiY: 0.03490658503988659}},
