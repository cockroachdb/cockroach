...
func TestLineCrossingDirection(t *testing.T) {
	testCases := []struct {
		...
		{
			desc:     "line1: 2 points, line2: 4 points, line2 first vertex left side, mid segment collinear, 4th vertex right side of line1",
			line1:    geom.NewLineStringFlat(geom.XY, []float64{0, -100, 0, 100}),
			line2:    geom.NewLineStringFlat(geom.XY, []float64{-50, 0, 0, 0, 0, 50, 50, 50}),
			expected: LineCrossRight,
		},
		{
			desc:     "line1: 2 points, line2: 4 points, line2 first vertex right side, mid segment collinear, 4th vertex left side of line1",
			line1:    geom.NewLineStringFlat(geom.XY, []float64{0, -100, 0, 100}),
			line2:    geom.NewLineStringFlat(geom.XY, []float64{50, 0, 0, 0, 0, 50, -50, 50}),
			expected: LineCrossLeft,
		},
		...
		{
			desc:     "line1: 4 points, line2: 4 points, middle segment overlap each other, remaining point diffrent, first and last vertex of line2 on left side of line1",
		...
		{
			desc:     "line1: 4 points, line2: 4 points, middle segment overlap each other, remaining point diffrent, first and last vertex of line2 on right side of line1",
			line1:    geom.NewLineStringFlat(geom.XY, []float64{-50, -50, 0, -50, 0, 50, -50, 50}),
			line2:    geom.NewLineStringFlat(geom.XY, []float64{50, -50, 0, -50, 0, 50, 50, 50}),
			expected: LineNoCross,
		},
		...
		{
			desc:     "line1: 4 points, line2: 3 points, total crosses: 2, line2 2nd vertex same as line1 2nd vertex and line2 4th vertex same as line1 3rd vertex, first crossing seg of line2 directed toward left",
			line1:    geom.NewLineStringFlat(geom.XY, []float64{0, 0, 0, 100, 0, 200, 0, 300}),
			line2:    geom.NewLineStringFlat(geom.XY, []float64{50, 50, -50, 150, 50, 250}),
			expected: LineMulticrossToSameFirstLeft,
		},
		{
			desc:     "line1: 4 points, line2: 3 points, total crosses: 2, line2 2nd vertex same as line1 2nd vertex and line2 4th vertex same as line1 3rd vertex, first crossing seg of line2 directed toward right",
			line1:    geom.NewLineStringFlat(geom.XY, []float64{0, 0, 0, 100, 0, 200, 0, 300}),
			line2:    geom.NewLineStringFlat(geom.XY, []float64{-50, 50, 50, 150, -50, 250}),
			expected: LineMulticrossToSameFirstRight,
		},
