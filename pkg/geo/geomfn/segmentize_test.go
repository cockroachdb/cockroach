...
func TestSegmentize(t *testing.T) {
	...
	t.Run("Error when segments to make is infinite", func(t *testing.T) {
		...
		require.EqualError(t, err, "attempting to segmentize into too many coordinates; need +Inf points between [-5.7579905902166e+09 -4.519452260862033e+09 2.8048587926955757e+09] and [-3.495930342911956e+09 -3.913707431095213e+09 9.956876080738373e+09], max 65336")
	})
}
