...
// geomGeodistCrosser implements geodist.Crosser.
type geomGeodistCrosser struct {
...
var _ geodist.Crosser = (*geomGeodistCrosser)(nil)

// ChainCrossing implements geodist.Crosser.
func (c *geomGeodistCrosser) ChainCrossing(p geodist.Point) bool {
...
// NewCrosser implements geodist.DistanceCalculator.
func (c *geomDistanceCalculator) NewCrosser(
	edge geodist.Edge, startPoint geodist.Point,
) geodist.Crosser {
	return &geomGeodistCrosser{
...
func (c *geomDistanceCalculator) PointInLinearRing(
	...
	for edgeIdx := 0; edgeIdx < polygon.NumEdges(); edgeIdx++ {
		...
		if side == pointSideOn && c.inBoundingCross(p, eV0, eV1) {
			return true
		}
