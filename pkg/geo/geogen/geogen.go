...
func RandomGeomT(
	...
	case geopb.ShapeType_MultiPoint:
		...
		// 10% chance to generate an empty multipoint.
		num := rng.Intn(10)
		for i := 0; i < num; i++ {
	...
	case geopb.ShapeType_MultiLineString:
		...
		// 10% chance to generate an empty multilinestring.
		num := rng.Intn(10)
		for i := 0; i < num; i++ {
	...
	case geopb.ShapeType_MultiPolygon:
		...
		// 10% chance to generate an empty multipolygon.
		num := rng.Intn(10)
		for i := 0; i < num; i++ {
	...
	case geopb.ShapeType_GeometryCollection:
		...
		// 10% chance to generate an empty geometrycollection.
		num := rng.Intn(10)
		for i := 0; i < num; i++ {
			var shape geom.T
			needShape := true
