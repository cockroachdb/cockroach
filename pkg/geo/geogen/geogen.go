...
func RandomValidLinearRingCoords(
	...
	// Use descending order of angle to get a CCW loop.
...
func RandomPolygon(
	...
	// * Generate a random set of polygons, see which ones they with fully cover and use that.
