...
// geographyMinDistanceUpdater finds the minimum distance using spheroid calculations.
...
func newGeographyMinDistanceUpdater(
	...
	stopAfterLEChordAngle := s1.ChordAngleFromAngle(s1.Angle(stopAfterLE / spheroid.SphereRadius))
