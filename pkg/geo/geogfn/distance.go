...
// s2GeodistCrosser implements geodist.Crosser.
type s2GeodistCrosser struct {
	*s2.EdgeCrosser
}

var _ geodist.Crosser = (*s2GeodistCrosser)(nil)

// ChainCrossing implements geodist.Crosser.
func (c *s2GeodistCrosser) ChainCrossing(p geodist.Point) bool {
...
func (c *spheroidDistanceCalculator) NewCrosser(
	edge geodist.Edge, startPoint geodist.Point,
) geodist.Crosser {
	return &s2GeodistCrosser{
