...
// The way PostGIS evaluates the distance between spheroid regions is the done
// by compututing the min of the pair-wise distance between the cross-product of
// the regions in A and the regions in B, where the pair-wise distance is computed as:
// * Compute the two closest points between the pairs of regions using the sphere
//   for calculations.
