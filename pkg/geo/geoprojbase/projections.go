...
var Projections = map[geopb.SRID]ProjInfo{
	2163: {
		...
		Spheroid:  spheroid1,
		Bounds: &Bounds{
			MinX: 3.695915214255973e+06,
			MaxX: -1.8345989415964175e+06,
			MinY: -2.5386543131344765e+06,
			MaxY: 4.802459331068178e+06,
		},
	},
	3031: {
		SRID:      3031,
		...
		Bounds: &Bounds{
			MinX: 0,
			MaxX: 4.081911918066544e-10,
			MinY: 0,
			MaxY: -3.333134027630277e+06,
		},
	},
	3035: {
		SRID:      3035,
		...
		Bounds: &Bounds{
			...
			MaxX: 4.708830298494868e+06,
			MinY: 1.5275411102207187e+06,
			MaxY: 6.8558539324565e+06,
		},
	},
	3395: {
		SRID:      3395,
		...
		Spheroid:  spheroid2,
		Bounds: &Bounds{
			MinX: -2.0037508342789244e+07,
			MaxX: 2.0037508342789244e+07,
			MinY: -1.5496570739723722e+07,
			MaxY: 1.876465623138057e+07,
		},
	},
	3408: {
		SRID:      3408,
		...
		Spheroid:  spheroid4,
		Bounds: &Bounds{
			MinX: -1.1034406944514297e-09,
			MaxX: 0,
			MinY: 9.010277046571208e+06,
			MaxY: 0,
		},
	},
	3409: {
		...
		Spheroid:  spheroid4,
		Bounds: &Bounds{
			MinX: -9.555311520569142e-26,
			MaxX: 1.1034406944514301e-09,
			MinY: -7.802503976837993e-10,
			MaxY: -9.01027704657121e+06,
		},
	},
	3571: {
		SRID:      3571,
	...
	3572: {
		...
		Spheroid:  spheroid2,
		Bounds: &Bounds{
			MinX: -2.444667401477438e+06,
			MaxX: 0,
			MinY: -4.234288146966307e+06,
			MaxY: 0,
		},
	},
	3573: {
	...
	3574: {
		...
		Spheroid:  spheroid2,
		Bounds: &Bounds{
			MinX: -3.142803830948573e+06,
			MaxX: 0,
			MinY: 3.7454477563518067e+06,
			MaxY: 0,
		},
	},
	3575: {
		...
		Spheroid:  spheroid2,
		Bounds: &Bounds{
			MinX: 849024.078536614,
			MaxX: 0,
			MinY: 4.81505482102238e+06,
			MaxY: 0,
		},
	},
	3576: {
		...
		Spheroid:  spheroid2,
		Bounds: &Bounds{
			MinX: 4.889334802954878e+06,
			MaxX: 0,
			MinY: -2.9938541081992227e-10,
			MaxY: 0,
		},
	},
	3785: {
		...
		Bounds: &Bounds{
			MinX: -2.0037508342789244e+07,
			MaxX: 2.0037508342789244e+07,
			MinY: -2.00489661040146e+07,
			MaxY: 2.004896610401459e+07,
		},
	},
	3857: {
		SRID:      3857,
	...
	3973: {
		...
		Spheroid:  spheroid2,
		Bounds: &Bounds{
			MinX: -1.1034024505272343e-09,
			MaxX: 0,
			MinY: 9.009964761231286e+06,
			MaxY: 0,
		},
	},
	3974: {
		...
		Spheroid:  spheroid2,
		Bounds: &Bounds{
			MinX: -2.327848989240319e-17,
			MaxX: 1.1034024505272343e-09,
			MinY: -0.19008329510688782,
			MaxY: -9.009964761231286e+06,
		},
	},
	3995: {
		SRID:      3995,
		...
		Spheroid:  spheroid2,
		Bounds: &Bounds{
			MinX: -4.081911918066544e-10,
			MaxX: 0,
			MinY: 3.333134027630277e+06,
			MaxY: 0,
		},
	},
	4004: {
	...
	5633: {
		...
		Bounds: &Bounds{
			...
			MaxX: 2.515870100495171e+06,
			MinY: 1.985362012397218e+06,
			MaxY: 2.491358555272759e+06,
		},
	},
	5635: {
		SRID:      5635,
		...
		Spheroid:  spheroid3,
		Bounds: &Bounds{
			MinX: 1.090443139749668e+06,
			MaxX: 2.2844161025193995e+06,
			MinY: 852680.5303986734,
			MaxY: 1.3694024327681197e+06,
		},
	},
	5636: {
		SRID:      5636,
		...
		Spheroid:  spheroid3,
		Bounds: &Bounds{
			MinX: 5.762516981165621e+06,
			MaxX: 7.032165858062416e+06,
			MinY: 1.4101831575229971e+06,
			MaxY: 2.908779050274115e+06,
		},
	},
	5638: {
		SRID:      5638,
		...
		Spheroid:  spheroid3,
		Bounds: &Bounds{
			MinX: 2.1800270871075992e+06,
			MaxX: 3.714401461962507e+06,
			MinY: 4.739806760715886e+06,
			MaxY: 5.23094047948676e+06,
		},
	},
	6931: {
		SRID:      6931,
	...
	26918: {
		...
		Bounds: &Bounds{
			...
			MaxX: 534994.655061707,
			MinY: 3.131872261800517e+06,
			MaxY: 9.329005182354301e+06,
		},
	},
	32601: {
		SRID:      32601,
		...
		Bounds: &Bounds{
			...
			MaxX: 534994.6550611365,
			MinY: 0,
			MaxY: 9.329005182447437e+06,
		},
	},
	32602: {
		SRID:      32602,
	...
	32701: {
		...
		Spheroid:  spheroid2,
		Bounds: &Bounds{
			MinX: 441867.78486720106,
			MaxX: 833978.5569194623,
			MinY: 1.1169150440516956e+06,
			MaxY: 1e+07,
		},
	},
	32702: {
	...
	32721: {
		...
		Spheroid:  spheroid2,
		Bounds: &Bounds{
			MinX: 441867.7848672013,
			MaxX: 833978.5569194623,
			MinY: 1.1169150440516975e+06,
			MaxY: 1e+07,
		},
	},
	32722: {
