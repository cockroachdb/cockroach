...
func (Shape) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_geopb_de0709dfb788056c, []int{0}
}
...
func init() { proto.RegisterFile("geo/geopb/geopb.proto", fileDescriptor_geopb_de0709dfb788056c) }

var fileDescriptor_geopb_de0709dfb788056c = []byte{
