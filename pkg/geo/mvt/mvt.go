...
func (b *MVTBuilder) Build() ([]byte, error) {
	...
	for i, feature := range b.features {
		var geomType VectorTileGeomType
		switch feature.GeomType {
		case GeomTypePoint:
			geomType = VectorTileGeomType_POINT
		case GeomTypeLineString:
			geomType = VectorTileGeomType_LINESTRING
		case GeomTypePolygon:
			geomType = VectorTileGeomType_POLYGON
		default:
			geomType = VectorTileGeomType_UNKNOWN
		}
