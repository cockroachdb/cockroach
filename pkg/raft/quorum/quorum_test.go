...
// TestComputeQSE ensures that the QSE (quorum supported expiration) is
...
func TestComputeQSE(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		require.Equal(t, tc.expQSE, m.ComputeQSE(tc.support))
	}
}
...
func TestComputeQSEJointConfig(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		require.Equal(t, tc.expQSE, j.ComputeQSE(tc.support))
	}
}
