...
//
// Implementation note: this interface will need to be implemented by an
// intermediary concrete type which translates replica IDs to store IDs and
// interacts with the real Store Liveness fabric.
