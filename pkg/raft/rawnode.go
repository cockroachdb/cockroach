...
//
// If the proposal is submitted, it can still be lost or not committed. It is
// the user's job to retry the proposal in this case.
...
//
// Successful snapshot sends should be reported with SnapshotFinish. It is less
// crucial to do this, because a successful snapshot is also reported via a
// MsgAppResp message stepped into this leader.
