...
// but there is no peer found in raft.progressTracker for that node.
...
func (rn *RawNode) Step(m pb.Message) error {
	...
	if IsResponseMsg(m.Type) && !IsLocalMsgTarget(m.From) && rn.raft.progressTracker.Progress()[m.From] == nil {
