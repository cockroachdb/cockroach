...
func (rn *RawNode) NextMsgApp(to uint64, lo, hi uint64, maxSize uint64) (pb.Message, error) {
...
func (rn *RawNode) GetProgress(peer uint64) tracker.Progress {
...
func (rn *RawNode) StableIndex() uint64 {
	return rn.raft.raftLog.stable.index
}
