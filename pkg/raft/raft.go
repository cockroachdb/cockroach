...
type raft struct {
	...
	// electionElapsed is tracked by both leaders and followers. For followers,
	// it is the number of ticks since they last received a valid message from the
	// from the current leader or if the leader is fortified when ticked. For
	// leaders, it is the number of ticks since the last time it performed a
	// checkQuorum.
	//
