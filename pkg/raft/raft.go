...
func (r *raft) setVote(vote pb.PeerID) {
	assertTrue(r.Vote == None || r.Vote == vote, "cannot change vote")
	r.Vote = vote
}
...
func (r *raft) setLead(lead pb.PeerID) {
	assertTrue(r.lead == None || r.lead == lead, "cannot change lead")
	r.lead = lead
}
...
func (r *raft) setLeadEpoch(leadEpoch pb.Epoch) {
	assertTrue(leadEpoch == 0 || r.lead != None, "leader must be set")
