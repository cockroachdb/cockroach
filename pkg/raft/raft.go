...
// by the code are exposed (e.g. Intn64).
type lockedRand struct {
	mu sync.Mutex
}

func (r *lockedRand) Intn64(n int64) int64 {
	r.mu.Lock()
...
func (r *raft) resetRandomizedElectionTimeout() {
	r.randomizedElectionTimeout = r.electionTimeout + globalRand.Intn64(r.electionTimeout)
}
