...
// from 0 to lastEntryID(), plus a commit logMark. All leader logs / snapshots
// at terms >= snapshot.term are consistent with this snapshot, i.e. all entries
// up to the lastEntryID() match.
