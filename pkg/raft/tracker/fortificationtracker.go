...
type FortificationTracker struct {
	...
	// steppingDown is set to true when the leader is stepping down. This is used
	// to prevent the leader from stepping down and regressing the
	// LeadSupportUntil promise. The leader with steppingDown set to true stops
	// advancing the LeadSupportUntil.
	steppingDown bool
}
...
// IntendToStepDown marks the leader as intending to step down. The leader will
// stop advancing the LeadSupportedUntil.
func (ft *FortificationTracker) IntendToStepDown() {
