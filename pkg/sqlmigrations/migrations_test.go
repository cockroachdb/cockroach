...
func makeIsolatedMigrationTest(
	...
	fmt.Println(backwardCompatibleMigrations)
...
func (mt *isolatedMigrationTest) runMigration(ctx context.Context, t testing.TB) {
	t.Helper()
	if err := mt.migration.workFn(ctx, runner{
		db:          mt.kvDB,
