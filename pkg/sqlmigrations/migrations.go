...
var backwardCompatibleMigrations = []migrationDescriptor{
	...
	{
		// Introduced in v2.1.
		// All changes to system.lease in v2.1 must go in here.
		// TODO(vivek): Bake into v2.2.
		name:   "add epoch to system.lease",
		workFn: changeTableDescriptorLeaseTable,
	},
}
...
// changeTableDescriptorLeaseTable upgrades the system.lease table.
func changeTableDescriptorLeaseTable(ctx context.Context, r runner) error {
