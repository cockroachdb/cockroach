...
func SetBeforeChange(ctx context.Context, sv *settings.Values, cb func(context.Context, ClusterVersion)) {
...
type Handle interface {
	...
	// returns true from this method, it means that you're guaranteed that all
...
type handleImpl struct {
	...
	// Override versions for use in tests to allow callers to specify versions
	// other than the baked in binary and minimum supported versions.
...
func MakeVersionHandleWithOverride(
	...
	return &handleImpl{
		...
		binaryMinSupportedVersionOverride: binaryMinSupportedVersion,
	}
}
...
func (v *handleImpl) BinaryVersion() roachpb.Version {
	if v.binaryVersionOverride != (roachpb.Version{}) {
		return v.binaryVersionOverride
	}
	return binaryVersion
}

func (v *handleImpl) BinaryMinSupportedVersion() roachpb.Version {
	if v.binaryMinSupportedVersionOverride != (roachpb.Version{}) {
		return v.binaryMinSupportedVersionOverride
	}
	return binaryMinSupportedVersion
}
