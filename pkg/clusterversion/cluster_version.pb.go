...
func (*ClusterVersion) Descriptor() ([]byte, []int) {
	return fileDescriptor_cluster_version_cf5cbcb86d49ee86, []int{0}
}
...
func init() {
	proto.RegisterFile("clusterversion/cluster_version.proto", fileDescriptor_cluster_version_cf5cbcb86d49ee86)
}

var fileDescriptor_cluster_version_cf5cbcb86d49ee86 = []byte{
