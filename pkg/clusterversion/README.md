...
**When**: When we are ready to release the final .0 version. (TODO: or RC1?)
...
- [ ] Update `pkg/build/version.txt` to the beta version (e.g. `24.1.0-beta.1`)
- [ ] Regenerate docs (`./dev gen docs`)
- [ ] Regenerate expected test data results as needed
...
are not backported to the release branch.
