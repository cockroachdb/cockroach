...
const (
	...
	// TODO_Delete_V24_1 is CockroachDB v24.1. It's used for all v24.1.x patch releases.
	TODO_Delete_V24_1

	// TODO_Delete_V24_2 is CockroachDB v24.2. It's used for all v24.2.x patch releases.
	TODO_Delete_V24_2

	// TODO_Delete_V24_3 is CockroachDB v24.3. It's used for all v24.3.x patch releases.
	TODO_Delete_V24_3

	// TODO_Delete_V25_1 is CockroachDB v25.1. It's used for all v25.1.x patch releases.
	TODO_Delete_V25_1
...
var versionTable = [numKeys]roachpb.Version{
	...
	TODO_Delete_V24_1: {Major: 24, Minor: 1, Internal: 0},
	TODO_Delete_V24_2: {Major: 24, Minor: 2, Internal: 0},
	TODO_Delete_V24_3: {Major: 24, Minor: 3, Internal: 0},
	TODO_Delete_V25_1: {Major: 25, Minor: 1, Internal: 0},
