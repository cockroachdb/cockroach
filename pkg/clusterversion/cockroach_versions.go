...
const (
	...
	// V24_3_TenantExcludeDataFromBackup is the migration to add the
	// `exclude_data_from_backup` on certain system tables to mirror the
	// behaviour on the system tenant.
