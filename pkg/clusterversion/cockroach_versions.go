...
// version key, e.g. to TODO_Delete_V23_2 on the release-23.2 branch once it is minted.
...
//   - if the key corresponds to a final version (e.g. TODO_Delete_V23_2), the result has the
//     same major/minor;
