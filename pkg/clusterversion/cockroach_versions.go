...
const (
	...
	// V26_2_AddInspectRowCountCheck introduces an INSPECT check that counts the
	// number of rows in a table. It is used as a validator after IMPORT.
	V26_2_AddInspectRowCountCheck
...
var versionTable = [numKeys]roachpb.Version{
	...
	V26_2_AddInspectRowCountCheck: {Major: 26, Minor: 1, Internal: 6},
