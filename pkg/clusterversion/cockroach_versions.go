...
const (
	...
	// empty topic_name params in changefeed sink URIs. The migration strips
	// existing empty topic_name params so they don't break on resume.
...
var versionTable = [numKeys]roachpb.Version{
	...
	V26_2_ChangefeedsRejectEmptyTopicName: {Major: 26, Minor: 1, Internal: 10},
