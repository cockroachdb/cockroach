...
func _() {
	...
	_ = x[SystemExternalConnectionsTable-66]
}

const _Key_name = "V21_2Start22__1Start22_"

var _Key_index = [...]uint16{0, 5, 14, 36, 54, 76, 113, 152, 166, 207, 233, 252, 286, 298, 329, 353, 374, 402, 432, 460, 481, 494, 513, 547, 585, 619, 651, 687, 719, 755, 797, 837, 869, 888, 912, 933, 964, 982, 1023, 1053, 1064, 1095, 1118, 1151, 1175, 1199, 1221, 1234, 1246, 1272, 1286, 1307, 1325, 1330, 1339, 1354, 1388, 1422, 1444, 1464, 1483, 1516, 1535, 1555, 1576, 1611, 1645, 1675}
