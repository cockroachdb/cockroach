...
func _() {
	...
	_ = x[SystemExternalConnectionsTable-64]
}

const _Key_name = "V21_2Start22__1Start22_"

var _Key_index = [...]uint16{0, 5, 14, 36, 73, 112, 126, 167, 193, 212, 246, 258, 289, 313, 334, 362, 392, 420, 441, 454, 473, 507, 545, 579, 611, 647, 679, 715, 757, 797, 829, 848, 872, 893, 924, 942, 983, 1013, 1024, 1055, 1078, 1111, 1135, 1159, 1181, 1194, 1206, 1232, 1246, 1267, 1285, 1290, 1299, 1314, 1348, 1382, 1404, 1424, 1443, 1476, 1495, 1515, 1536, 1571, 1605, 1635}
