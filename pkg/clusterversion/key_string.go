...
func _() {
	...
	_ = x[V21_1-44]
	_ = x[Start21_2-45]
	_ = x[PGNotificationsTable-46]
}

const _Key_name = "NamespaceTableWithSchemasStart20__2Start21__1Start21_2PGNotificationsTable"

var _Key_index = [...]uint16{0, 25, 34, 48, 53, 68, 90, 124, 145, 163, 180, 200, 217, 231, 295, 312, 321, 346, 366, 378, 383, 392, 420, 449, 471, 481, 496, 542, 592, 608, 629, 667, 709, 725, 761, 778, 804, 823, 852, 889, 923, 956, 974, 991, 1025, 1030, 1039, 1059}
