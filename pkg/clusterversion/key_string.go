...
func _() {
	...
	_ = x[DeleteRequestReturnKey-55]
}

const _Key_name = "V21_2Start22__1Start22_"

var _Key_index = [...]uint16{0, 5, 14, 48, 76, 106, 134, 155, 174, 208, 246, 280, 312, 348, 380, 416, 458, 498, 517, 541, 572, 590, 620, 631, 662, 686, 710, 732, 744, 770, 784, 805, 823, 828, 837, 852, 892, 926, 960, 982, 1002, 1021, 1054, 1073, 1093, 1114, 1149, 1183, 1213, 1266, 1280, 1301, 1313, 1329, 1360, 1394, 1416}
