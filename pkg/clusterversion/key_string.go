...
func _() {
	...
	_ = x[AddSSTableTombstones-63]
	_ = x[AlterSystemSQLInstancesAddLocality-64]
}

const _Key_name = "V21_2Start22__1Start22_2LocalTimestampsEnsurePebbleFormatVersionRangeKeysEnablePebbleFormatVersionRangeKeysTrigramInvertedIndexesRemoveGrantPrivilegeMVCCRangeTombstonesUpgradeSequenceToBeReferencedByIDSampledStmtDiagReqsAddSSTableTombstonesAlterSystemSQLInstancesAddLocality"
