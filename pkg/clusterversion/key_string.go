...
func _() {
	...
	_ = x[V23_1Start-40]
	_ = x[TenantNames-41]
	_ = x[UserDefinedCompositeTypes-42]
}

const _Key_name = "invalidVersionKeyV22_1Start22__2V23_1StartTenantNamesUserDefinedCompositeTypes"

var _Key_index = [...]uint16{0, 17, 22, 31, 46, 86, 120, 154, 176, 196, 215, 248, 267, 287, 308, 343, 377, 407, 460, 474, 495, 526, 559, 590, 624, 646, 675, 702, 733, 766, 784, 808, 836, 855, 875, 921, 931, 950, 968, 989, 1027, 1032, 1042, 1053, 1078}
