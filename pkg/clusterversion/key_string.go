...
func _() {
	...
	_ = x[NamespaceTableWithSchemasMigration-37]
}

const _Key_name = "NamespaceTableWithSchemasStart20__2Start21_"

var _Key_index = [...]uint16{0, 25, 34, 48, 53, 68, 90, 124, 145, 163, 180, 200, 217, 231, 295, 312, 321, 346, 366, 378, 383, 392, 420, 449, 471, 481, 496, 542, 592, 608, 629, 667, 709, 725, 761, 778, 804, 823, 857}
