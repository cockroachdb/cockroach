...
See [failures/m2_failures.md](failures/m2_failures.md) for common errors,
the testserver config boundary (what belongs in M.2 vs M.3), and the
optional skipif verification process.
