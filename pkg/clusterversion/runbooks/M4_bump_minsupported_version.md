...
See [failures/m4_failures.md](failures/m4_failures.md) for all errors including
the nightly build failure, empty LogicTest directives, duplicate statement errors,
and the pebble format version rebase gotcha.
