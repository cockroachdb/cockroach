...
func listTemplateString(listName string) string {
	return fmt.Sprintf(`# Generated by genbzl
...
var targets = []*target{
	newTarget(
		...
		listTemplateString("PROTOBUF_SRCS")),
	newTarget(
		"gomock.bzl",
		newQuery(`labels("out", kind("_gomock_prog_exec rule",  //pkg/...:*))`),
		listTemplateString("GOMOCK_SRCS")),
	newTarget(
		"stringer.bzl",
