...
GOMOCK_SRCS = [
    ...
    "//pkg/cmd/tef/planners/mock:mock_plan_executor_generated.go",
    "//pkg/cmd/tef/planners/mock:mock_planner_generated.go",
    "//pkg/cmd/tef/planners/mock:mock_planner_manager_generated.go",
    "//pkg/cmd/tef/planners/mock:mock_registry_generated.go",
    "//pkg/cmd/tef/planners/mock:mock_shared_plan_service_generated.go",
