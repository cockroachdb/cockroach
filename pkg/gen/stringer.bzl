...
STRINGER_SRCS = [
    ...
    "//pkg/multitenant/tenantcapabilities/tenantcapabilitiespb:boolcapabilityname_string.go",
    "//pkg/multitenant/tenantcapabilities/tenantcapabilitiespb:int32rangecapabilityname_string.go",
