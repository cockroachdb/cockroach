...
PROTOBUF_SRCS = [
    ...
    "//pkg/crosscluster/logical/txnpb:txnpb_go_proto",
    ...
    "//pkg/kv/kvserver/allocator/mmaprototype/mmasnappb:mmasnappb_go_proto",
    ...
    "//pkg/resourcegroup/rgpb:rgpb_go_proto",
    ...
    "//pkg/sqlproxy/tenant:tenant_go_proto",
