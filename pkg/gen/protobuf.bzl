...
PROTOBUF_SRCS = [
    ...
    "//pkg/ccl/streamingccl/streamclient:streamclient_go_proto",
    "//pkg/ccl/streamingccl/streamingest:streamingest_go_proto",
    "//pkg/ccl/streamingccl/streamproducer:streamproducer_go_proto",
