...
// SupportedBuild contains metadata about a supported build.
type SupportedBuild struct {
	BuildType string
	Suffix    string
}

// SupportedBuilds contains the supported builds.
var SupportedBuilds = []SupportedBuild{
...
func MakeRelease(b SupportedBuild, pkgDir string, opts ...MakeReleaseOption) error {
