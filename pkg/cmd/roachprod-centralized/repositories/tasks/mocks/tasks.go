...
func (_m *ITasksRepository) CreateTask(_a0 context.Context, _a1 *logger.Logger, _a2 tasks.ITask) error {
...
func (_m *ITasksRepository) GetMostRecentCompletedTaskOfType(_a0 context.Context, _a1 *logger.Logger, _a2 string) (tasks.ITask, error) {
	ret := _m.Called(_a0, _a1, _a2)
...
func (_m *ITasksRepository) GetStatistics(_a0 context.Context, _a1 *logger.Logger) (repositoriestasks.Statistics, error) {
...
func (_m *ITasksRepository) GetTask(_a0 context.Context, _a1 *logger.Logger, _a2 uuid.UUID) (tasks.ITask, error) {
	ret := _m.Called(_a0, _a1, _a2)
...
func (_m *ITasksRepository) GetTasks(_a0 context.Context, _a1 *logger.Logger, _a2 types.FilterSet) ([]tasks.ITask, int, error) {
	ret := _m.Called(_a0, _a1, _a2)
...
func (_m *ITasksRepository) GetTasksForProcessing(_a0 context.Context, _a1 *logger.Logger, _a2 chan<- tasks.ITask, _a3 string) error {
...
func (_m *ITasksRepository) PurgeTasks(_a0 context.Context, _a1 *logger.Logger, _a2 time.Duration, _a3 tasks.TaskState) (int, error) {
	ret := _m.Called(_a0, _a1, _a2, _a3)
...
func (_m *ITasksRepository) UpdateError(_a0 context.Context, _a1 *logger.Logger, _a2 uuid.UUID, _a3 string) error {
	ret := _m.Called(_a0, _a1, _a2, _a3)
...
func (_m *ITasksRepository) UpdateState(_a0 context.Context, _a1 *logger.Logger, _a2 uuid.UUID, _a3 tasks.TaskState) error {
	ret := _m.Called(_a0, _a1, _a2, _a3)
