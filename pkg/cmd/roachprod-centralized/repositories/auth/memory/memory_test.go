...
func TestMemoryRepository_GroupCRUD(t *testing.T) {
	...
	// Create
	err := repo.CreateGroup(ctx, l, group)
	require.NoError(t, err)
...
func TestMemoryRepository_GroupMembers(t *testing.T) {
	...
	err = repo.PatchGroupMembers(ctx, l, groupID, []rauth.GroupMemberOperation{
...
func TestMemoryRepository_GetStatistics(t *testing.T) {
	...
	require.NoError(t, repo.CreateGroup(ctx, l, group1))
	require.NoError(t, repo.CreateGroup(ctx, l, group2))
