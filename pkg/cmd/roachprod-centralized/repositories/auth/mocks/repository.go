...
// CreateGroup provides a mock function with given fields: _a0, _a1, _a2
func (_m *IAuthRepository) CreateGroup(
...
// GetUserGroups provides a mock function with given fields: _a0, _a1, _a2
func (_m *IAuthRepository) GetUserGroups(
	_a0 context.Context, _a1 *logger.Logger, _a2 uuid.UUID,
) ([]*auth.Group, error) {
	ret := _m.Called(_a0, _a1, _a2)
...
// PatchGroupMembers provides a mock function with given fields: _a0, _a1, _a2, _a3
func (_m *IAuthRepository) PatchGroupMembers(
	_a0 context.Context,
	_a1 *logger.Logger,
	_a2 uuid.UUID,
	...
	if len(ret) == 0 {
		panic("no return value specified for PatchGroupMembers")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *logger.Logger, uuid.UUID, []repositoriesauth.GroupMemberOperation) error); ok {
		r0 = rf(_a0, _a1, _a2, _a3)
	} else {
		r0 = ret.Error(0)
	}
