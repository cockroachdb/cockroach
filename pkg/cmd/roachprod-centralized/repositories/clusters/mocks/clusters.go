...
func (_m *IClustersRepository) AcquireSyncLockWithHealthCheck(ctx context.Context, l *logger.Logger, instanceID string, healthTimeout time.Duration) (bool, error) {
...
func (_m *IClustersRepository) ClearPendingOperations(ctx context.Context, l *logger.Logger) (int64, error) {
	ret := _m.Called(ctx, l)
...
func (_m *IClustersRepository) ClearPendingOperationsBefore(ctx context.Context, l *logger.Logger, timestamp time.Time) (int64, error) {
...
func (_m *IClustersRepository) ConditionalEnqueueOperation(ctx context.Context, l *logger.Logger, operation clusters.OperationData, healthTimeout time.Duration) (bool, error) {
...
func (_m *IClustersRepository) DeleteCluster(ctx context.Context, l *logger.Logger, cluster types.Cluster) error {
...
func (_m *IClustersRepository) GetCluster(ctx context.Context, l *logger.Logger, name string) (types.Cluster, error) {
...
func (_m *IClustersRepository) GetClusters(ctx context.Context, l *logger.Logger, filters filterstypes.FilterSet) (types.Clusters, error) {
...
func (_m *IClustersRepository) GetPendingOperationsWithTimestamp(ctx context.Context, l *logger.Logger) ([]clusters.OperationData, time.Time, error) {
	ret := _m.Called(ctx, l)
...
func (_m *IClustersRepository) StoreCluster(ctx context.Context, l *logger.Logger, cluster types.Cluster) error {
	ret := _m.Called(ctx, l, cluster)
...
func (_m *IClustersRepository) StoreClusters(ctx context.Context, l *logger.Logger, _a2 types.Clusters) error {
...
func (_m *IClustersRepository) StoreClustersAndReleaseSyncLock(ctx context.Context, l *logger.Logger, _a2 types.Clusters, instanceID string) error {
