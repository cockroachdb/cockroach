...
func (_m *IService) CreateTask(_a0 context.Context, _a1 *logger.Logger, _a2 tasks.ITask) (tasks.ITask, error) {
...
func (_m *IService) CreateTaskIfNotAlreadyPlanned(_a0 context.Context, _a1 *logger.Logger, _a2 tasks.ITask) (tasks.ITask, error) {
	ret := _m.Called(_a0, _a1, _a2)
...
func (_m *IService) CreateTaskIfNotRecentlyScheduled(_a0 context.Context, _a1 *logger.Logger, _a2 tasks.ITask, _a3 time.Duration) (tasks.ITask, error) {
...
func (_m *IService) GetMostRecentCompletedTaskOfType(_a0 context.Context, _a1 *logger.Logger, _a2 string) (tasks.ITask, error) {
	ret := _m.Called(_a0, _a1, _a2)
...
func (_m *IService) GetTask(_a0 context.Context, _a1 *logger.Logger, _a2 types.InputGetTaskDTO) (tasks.ITask, error) {
	ret := _m.Called(_a0, _a1, _a2)
...
func (_m *IService) GetTasks(_a0 context.Context, _a1 *logger.Logger, _a2 types.InputGetAllTasksDTO) ([]tasks.ITask, int, error) {
	ret := _m.Called(_a0, _a1, _a2)
	...
	var r1 int
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, *logger.Logger, types.InputGetAllTasksDTO) ([]tasks.ITask, int, error)); ok {
		return rf(_a0, _a1, _a2)
	}
	...
	if rf, ok := ret.Get(1).(func(context.Context, *logger.Logger, types.InputGetAllTasksDTO) int); ok {
		r1 = rf(_a0, _a1, _a2)
	} else {
		r1 = ret.Get(1).(int)
	}

	if rf, ok := ret.Get(2).(func(context.Context, *logger.Logger, types.InputGetAllTasksDTO) error); ok {
		r2 = rf(_a0, _a1, _a2)
	} else {
		r2 = ret.Error(2)
	}
...
func (_m *IService) WaitForTaskCompletion(_a0 context.Context, _a1 *logger.Logger, _a2 uuid.UUID, _a3 time.Duration) error {
	ret := _m.Called(_a0, _a1, _a2, _a3)
