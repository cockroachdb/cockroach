...
// GetUserByOktaID retrieves a user by Okta ID (admin/SCIM operation).
func (s *Service) GetUserByOktaID(
	ctx context.Context, l *logger.Logger, principal *pkgauth.Principal, oktaID string,
) (*auth.User, error) {
	return s.repo.GetUserByOktaID(ctx, l, oktaID)
}
