...
func (_m *IService) ListServiceAccountTokens(_a0 context.Context, _a1 *logger.Logger, _a2 *auth.Principal, _a3 uuid.UUID, _a4 types.InputListServiceAccountTokensDTO) ([]*modelsauth.ApiToken, int, error) {
	ret := _m.Called(_a0, _a1, _a2, _a3, _a4)
