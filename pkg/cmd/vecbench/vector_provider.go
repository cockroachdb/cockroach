...
type VectorProvider interface {
	...
	// PrepareSearch allows the provider to perform expensive up-front steps in
	// preparation for many calls to Search. It returns provider-specific state
	// that will be passed to Search.
	PrepareSearch(ctx context.Context, maxResults int, beamSize int) (SearchState, error)
