...
func getAssigneeEmail(packageName, testName string) string {
	// Search the source code for the email address of the last committer to touch
	// the first line of the source code that contains testName.
