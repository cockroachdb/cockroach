...
var specs = []stmtSpec{
	...
	},
	{
		name:   "import_csv",
		stmt:   "import_stmt",
		inline: []string{"uris", "opt_with_options"},
		exclude: []*regexp.Regexp{
	...
	},
	{
		...
		inline: []string{"insert_column_list", "uris", "opt_with_options", "kv_option_list"},
		replace: map[string]string{
			"table_option":       "table_name",
	...
	},
	{
		...
		replace: map[string]string{
			"'BACKUPS' 'IN' opt_uris":                     "'BACKUPS' 'IN' collectionURI",
			"'BACKUP' uri 'IN' opt_uris":                  "'BACKUP' subdirectory 'IN' collectionURI",
			"'BACKUP' collectionURI_path 'IN' opt_uris":   "'BACKUP' subdirectory 'IN' collectionURI",
			"'BACKUP' 'SCHEMAS' uri":                      "'BACKUP' 'SCHEMAS' collectionURI_path",
			"'BACKUP' 'SCHEMAS' 'FROM' uri 'IN' opt_uris": "'BACKUP' 'SCHEMAS' 'FROM' subdirectory 'IN' collectionURI",
			"'BACKUP' uri":                                "'BACKUP' collectionURI_path",
			"'BACKUP' 'CONNECTION' uri":                   "'BACKUP' 'CONNECTION' collectionURI",
		},
