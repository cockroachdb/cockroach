...
func TestCategorizeGoTests(t *testing.T) {
	...
	tmpDir, err := os.MkdirTemp("", "testpyramid-test")
	if err != nil {
		t.Fatal(err)
	}
...
func TestRoachtestPatternMatching(t *testing.T) {
	tmpDir, err := os.MkdirTemp("", "testpyramid-roachtest")
	if err != nil {
		t.Fatal(err)
	}
	defer os.RemoveAll(tmpDir)
...
func TestCypressPatternMatching(t *testing.T) {
	tmpDir, err := os.MkdirTemp("", "testpyramid-cypress")
	if err != nil {
		t.Fatal(err)
	}
	defer os.RemoveAll(tmpDir)
...
func TestFrontendTestPatternMatching(t *testing.T) {
	tmpDir, err := os.MkdirTemp("", "testpyramid-frontend")
	if err != nil {
		t.Fatal(err)
	}
	defer os.RemoveAll(tmpDir)
...
func TestCSVOutput(t *testing.T) {
	tmpDir, err := os.MkdirTemp("", "testpyramid-csv")
	if err != nil {
		t.Fatal(err)
	}
	defer os.RemoveAll(tmpDir)
