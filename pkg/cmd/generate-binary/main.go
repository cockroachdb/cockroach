...
//
// TODO(xiaochen): use a docker image with an earlier version of postgres to align
// the data format with cockroachdb. (The format of floats generated by the given
// image differs from cockroachdb's.)
//
