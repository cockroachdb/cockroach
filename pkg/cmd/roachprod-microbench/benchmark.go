...
func executeBenchmarks(binaries, packages []string) error {
	...
	// Add shutdown commands to the end of the command list. This is to prevent
	// resources from being wasted when only a few benchmarks are left running.
	for i := 0; i < numNodes; i++ {
		commands = append(commands, []cluster.RemoteCommand{
