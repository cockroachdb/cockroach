...
var (
	...
	flagInferPackages = flags.Bool("infer-packages", false, "deduce package list from report logs in the working dir rather than the test binaries archive")
