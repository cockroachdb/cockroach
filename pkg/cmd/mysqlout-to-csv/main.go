...
var lineSep = flag.String("lines-terminated-by", "\n", "line separator character")
var fieldsSep = flag.String("fields-terminated-by", "\t", "field separator character")
var encloseChar = flag.String("fields-enclosed-by", "", "field enclosing character")
var escapeChar = flag.String("fields-escaped-by", "\\", "escape character")

var chunkCSVRows = flag.Int("chunk-rows", 0, "chunk csv into N rows per file (0 no chunking)")

var progressFreq = flag.Int("progress", 1000, "number of rows per progress update (0 for no updates)")

var bufSizeKb = flag.Int("buf-size-kb", 1024, "buffer size")
