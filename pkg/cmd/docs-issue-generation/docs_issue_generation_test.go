...
func TestGetIssues(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			pullCommit: []ghPullCommit{
				{
					CRDBSha: "4dd8da9609adb3acce6795cea93b67ccacfc0270",
					CRDBCommitMsg: ghPullCommitMsg{
						Message: "util/log: move the crdb-v1 test code to a separate file\n\nRelease note: None",
					},
				},
				{
					CRDBSha: "cae4e525511a7d87f3f5ce74f02a6cf6edab4f3d",
					CRDBCommitMsg: ghPullCommitMsg{
				...
				{
					CRDBSha: "3be8458eda90aa922fa2a22ad7d6531c57aa12e1",
					CRDBCommitMsg: ghPullCommitMsg{
				...
				{
					CRDBSha: "934c7da83035fb78108daa23fa9cb8925d7b6d10",
					CRDBCommitMsg: ghPullCommitMsg{
				...
				{
					CRDBSha: "fb249c7140b634a53dca2967c946bc78ba927e1a",
					CRDBCommitMsg: ghPullCommitMsg{
		...
		},
		{
			...
			pullCommit: []ghPullCommit{
				{
					CRDBSha: "1d7811d5d14f9c7e106c3ec92de9c66192f19604",
					CRDBCommitMsg: ghPullCommitMsg{
		...
		},
		{
			...
			pullCommit: []ghPullCommit{
				{
					CRDBSha: "5ec9343b0e0a00bfd4603e55ca6533e2b77db2f9",
					CRDBCommitMsg: ghPullCommitMsg{
			...
			issues: []docsIssue{
				{
					crdbSha:    "5ec9343b0e0a00bfd4603e55ca6533e2b77db2f9",
					issueTitle: "PR #79069 - sql: ignore non-existent columns when injecting stats",
					issueBody:  "Related PR: https://github.com/cockroachdb/cockroach/pull/79069\nCommit: https://github.com/cockroachdb/cockroach/commit/5ec9343b0e0a00bfd4603e55ca6533e2b77db2f9\n\n---\n\nRelease note (sql change): `ALTER TABLE ... INJECT STATISTICS ...` will\nnow docsIssue notices when the given statistics JSON includes non-existent\ncolumns, rather than resulting in an error. Any statistics in the JSON\nfor existing columns will be injected successfully.",
				},
			},
		},
		{
			...
			pullCommit: []ghPullCommit{
				{
					CRDBSha: "88be04bd64283b1d77000a3f88588e603465e81b",
					CRDBCommitMsg: ghPullCommitMsg{
			...
			issues: []docsIssue{
				{
					crdbSha:    "88be04bd64283b1d77000a3f88588e603465e81b",
					issueTitle: "PR #79361 - changefeedccl: remove the default values from SHOW",
					issueBody:  "Related PR: https://github.com/cockroachdb/cockroach/pull/79361\nCommit: https://github.com/cockroachdb/cockroach/commit/88be04bd64283b1d77000a3f88588e603465e81b\n\n---\n\nRelease note (enterprise change): Remove the default\nvalues from the SHOW CHANGEFEED JOB output",
				},
			},
		},
	}
