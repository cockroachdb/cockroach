...
Release note (sql change): Import now checks readability...`,
	...
	for _, tc := range testCases {
		defer testutils.TestingHook(&getValidEpicRef, func(issueKey string) (bool, string, error) {
			...
			epicMap["CRDB-491"] = struct {
				IsEpic  bool
				EpicKey string
			}{IsEpic: true, EpicKey: "CRDB-491"}
			epicMap["CRDB-9234"] = struct {
				IsEpic  bool
				EpicKey string
			}{IsEpic: false, EpicKey: ""}
			epicMap["CRDB-235"] = struct {
				IsEpic  bool
				EpicKey string
			}{IsEpic: true, EpicKey: "CRDB-235"}
			epicMap["DOC-6883"] = struct {
				IsEpic  bool
				EpicKey string
			}{IsEpic: true, EpicKey: "DOC-6883"}
			epicMap["DEVINF-392"] = struct {
				IsEpic  bool
				EpicKey string
			}{IsEpic: false, EpicKey: ""}
			epicMap["https://cockroachlabs.atlassian.net/browse/CRDB-28708"] = struct {
				IsEpic  bool
				EpicKey string
			}{IsEpic: false, EpicKey: "CRDB-18955"}
			return epicMap[issueKey].IsEpic, epicMap[issueKey].EpicKey, nil
		})()
		t.Run(tc.message, func(t *testing.T) {
