...
func tagKeyPair(region string, keyPair ec2types.KeyPairInfo, IAMUserName string, creationTimestamp time.Time) (string, error) {
...
// Tags keypairs created by roachprod with IAMUserName and CreatedAt if untagged.
// Deletes keypairs created by previous users/employees and deletes TeamCity keypairs after 10 days.
