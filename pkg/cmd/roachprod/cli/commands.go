...
`,
	...
	cr.initCreateCmdFlags(createCmd)
...
`,
	...
	cr.initDestroyCmdFlags(destroyCmd)
...
`,
	...
	cr.initMonitorCmdFlags(monitorCmd)
...
`,
	...
	cr.initStartInstanceCmdFlags(startInstanceCmd)
...
`,
	...
	cr.initStageURLCmdFlags(stageURLCmd)
	return stageURLCmd
}
...
`,
	...
	cr.initAdminurlCmdFlags(adminurlCmd)
...
func (cr *commandRegistry) buildGrafanaStartCmd() *cobra.Command {
	...
	cr.initGrafanaStartCmdFlags(grafanaStartCmd)
...
`, roachprodutil.ServiceAccountJson, roachprodutil.ServiceAccountAudience),
	...
	cr.initGrafanaAnnotationCmdFlags(grafanaAnnotationCmd)
...
func (cr *commandRegistry) buildUpdateCmd() *cobra.Command {
	...
	cr.initUpdateCmdFlags(updateCmd)
	return updateCmd
}
...
func (cr *commandRegistry) buildFluentBitStartCmd() *cobra.Command {
	...
	cr.initFluentBitStartCmdFlags(fluentBitStartCmd)
...
func (cr *commandRegistry) buildOpentelemetryStartCmd() *cobra.Command {
	...
	cr.initOpentelemetryStartCmdFlags(opentelemetryStartCmd)
