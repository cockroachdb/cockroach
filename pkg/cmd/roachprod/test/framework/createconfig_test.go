...
// TestJoinZones verifies the zone joining helper.
func TestJoinZones(t *testing.T) {
	tests := []struct {
		name  string
		zones []string
		want  string
		...
		name:  "multiple zones",
		zones: []string{"us-east1-b", "us-west1-b", "europe-west2-b"},
		want:  "us-east1-b,us-west1-b,europe-west2-b",
	}, {
		name:  "empty",
		zones: []string{},
		want:  "",
