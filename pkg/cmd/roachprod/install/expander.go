...
// attributes like pgurl, pgport, uiport with the corresponding values.
...
// by nodeSpec. The returned bool is always err == nil and is part of the return
// signature to ease use in other expanderFuncs.
