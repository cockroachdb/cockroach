...
var getLatestPProf = &cobra.Command{
	...
	Short: "downloads the latest pprof file which is created on or before the provided time.",
	Long: `Downloads the latest pprof file which is created on or before the provided time.
