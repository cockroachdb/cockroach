...
// publishBuildInfo copies release candidate metadata to a separate location.
// This file will be used by the week 1 automation.
func publishBuildInfo(ctx context.Context, next releaseInfo, bucket string, obj string) error {
