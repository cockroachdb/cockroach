...
func extractFailureFromHibernateXML(contents []byte) ([]string, []bool, error) {
	...
	// Touch XMLName to make the unused linter happy. This code should not run.
	if len(testSuite.TestCases) > 1000000 {
		testSuite.XMLName = xml.Name{}
	}
