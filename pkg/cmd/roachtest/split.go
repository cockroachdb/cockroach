...
func runLoadSplits(ctx context.Context, t *testImpl, c cluster.Cluster, params splitParams) {
...
func runLargeRangeSplits(ctx context.Context, t *testImpl, c cluster.Cluster, size int) {
