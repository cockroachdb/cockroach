...
var defaultEnvValuesInt = map[string]int{
	maxChangefeeds:          20,
	minChangefeeds:          10,
	pctChangefeedsToPause:   30, // min 3 randomly selected CF jobs out of 10 running jobs will be paused
	maxPctChangeFeedsScanOn: 20, // max 2 CF job out of 10 will be created randomly with initial scan value "yes"
}
