...
func (s installFixturesStep) DisableConcurrency() bool {
	return false
}
...
func (s startStep) DisableConcurrency() bool {
	return true
}
...
func (s startSharedProcessVirtualClusterStep) DisableConcurrency() bool {
	return true
}
...
func (s startSeparateProcessVirtualClusterStep) DisableConcurrency() bool {
	return true
}
...
func (s restartVirtualClusterStep) DisableConcurrency() bool {
	return true
}
...
func (s waitForStableClusterVersionStep) DisableConcurrency() bool {
	return false
}
...
func (s preserveDowngradeOptionStep) DisableConcurrency() bool {
	return false
}
...
func (s restartWithNewBinaryStep) DisableConcurrency() bool {
	return true
}
...
func (s allowUpgradeStep) DisableConcurrency() bool {
	return false
}
...
func (s waitStep) DisableConcurrency() bool {
	return false
}
...
func (s runHookStep) DisableConcurrency() bool {
	return false
}

func (s runHookStep) RunInParallel() bool { return true }
...
func (s setClusterSettingStep) DisableConcurrency() bool {
	return false
}
...
func (s setClusterVersionStep) DisableConcurrency() bool {
	return false
}
...
func (s resetClusterSettingStep) DisableConcurrency() bool {
	return false
}
...
func (s deleteAllTenantsVersionOverrideStep) DisableConcurrency() bool {
	return false
}
...
func (s disableRateLimitersStep) DisableConcurrency() bool {
	return false
}
...
func (s panicNodeStep) Description() string {
	return fmt.Sprintf("run panic node on node %d", s.targetNode[0])
}
...
func (s panicNodeStep) Run(ctx context.Context, l *logger.Logger, rng *rand.Rand, h *Helper) error {
	...
	customStartOpts := []option.StartStopOption{option.SkipInit, option.WithInitTarget(s.initTarget)}
...
func (s panicNodeStep) DisableConcurrency() bool {
	return true
}
