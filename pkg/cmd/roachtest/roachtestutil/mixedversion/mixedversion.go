...
var (
	...
	// releases in a single upgrade). Note that support is currently
	// experimental and requires an environment variable.
	minSupportedSkipVersionUpgrade = clusterupgrade.MustParseVersion("v23.1.0")
...
func (t *Test) choosePreviousReleases() ([]*clusterupgrade.Version, error) {
	...
	// supported, this function will return both the immeidate
