...
// clone copies the caller Context returning the copy.
...
// tiven version. This should be called once every node is already
// running the given version, and the cluster version has finished
// reaching the logical version corresponding to that release.
