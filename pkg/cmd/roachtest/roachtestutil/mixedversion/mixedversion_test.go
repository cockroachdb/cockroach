...
func Test_choosePreviousReleases(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			arch:               vm.ArchAMD64,
			predecessorHistory: []string{"v22.1.3", "v22.2.10", "v23.1.3"},
			expectedReleases:   []string{"v22.1.3", "v22.2.10", "v23.1.3"},
		},
		{
			name:               "supported predecessor history is unmodified for ARM architectures",
			arch:               vm.ArchARM64,
			predecessorHistory: []string{"v22.2.0", "v23.1.10", "v23.2.3"}, // all supported
			expectedReleases:   []string{"v22.2.0", "v23.1.10", "v23.2.3"},
		},
		{
			name:               "predecessor history is filtered for ARM architectures",
			arch:               vm.ArchARM64,
			predecessorHistory: []string{"v21.2.12", "v22.1.10", "v22.2.3", "v23.1.0"},
			expectedReleases:   []string{"v22.2.3", "v23.1.0"},
		},
	}
