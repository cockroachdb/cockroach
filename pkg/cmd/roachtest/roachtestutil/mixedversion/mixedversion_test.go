...
func Test_assertValidTest(t *testing.T) {
	...
	require.Error(t, fatalErr)
	require.Equal(t,
		"mixedversion.NewTest: invalid test options: minimum supported version (v24.1.0) should be older than current version (v23.1.2)",
		fatalErr.Error(),
	)
	...
	require.Error(t, fatalErr)
	require.Equal(t,
		"mixedversion.NewTest: invalid test options: minimum supported version (v23.1.8) should be older than current version (v23.1.2)",
		fatalErr.Error(),
	)
