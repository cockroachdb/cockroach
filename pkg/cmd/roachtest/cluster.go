...
type clusterImpl struct {
	...
	preStartVirtualClusterHooks []install.ClusterHook
...
func (c *clusterImpl) RegisterClusterHook(hookName string, hookType option.ClusterHookType, fn func(context.Context) error) {
	switch hookType {
	...
	case option.PreStartVirtualClusterHook:
		c.preStartVirtualClusterHooks = append(c.preStartVirtualClusterHooks, install.ClusterHook{Name: hookName, Fn: fn})
	default:
