...
const (
	validate       attachOpt = true
	skipValidation attachOpt = false
)

// attachToExistingCluster creates a cluster object based on machines that have
// already been already allocated by roachprod. It optionally validates that
// those machine match the spec.
...
func (c *cluster) validate(ctx context.Context, nodes []nodeSpec, l *logger) error {
	...
	// TODO(andrei): This doesn't seem like it belongs in this "validation"
	// function and that it should be subject to testingSkipValidation.
