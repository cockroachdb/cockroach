...
type testImpl struct {
	...
	mu struct {
		...
		// parameters if there is a failure. They will alternatively be logged in the test itself
		// if github posting is disabled.
...
// AddParam adds a parameter to the test. This parameter will be logged either in
// the github issue if one is created or in the test logger. This is useful if a test
