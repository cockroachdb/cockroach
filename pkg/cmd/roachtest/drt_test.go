...
func TestTPCCChaosEventProcessor(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			mockPromQueries: []expectPromQuery{
				// Restart region1.
				{q: makeMetric(metricA, "success", portRegion1), t: firstShutdownComplete.Add(prometheus.DefaultScrapeInterval), retVal: 100},
				{q: makeMetric(metricA, "success", portRegion1), t: firstPreStartup, retVal: 100},
				{q: makeMetric(metricA, "error", portRegion1), t: firstShutdownComplete.Add(prometheus.DefaultScrapeInterval), retVal: 10},
				{q: makeMetric(metricA, "error", portRegion1), t: firstPreStartup, retVal: 1000},

				{q: makeMetric(metricA, "success", portRegion2), t: firstShutdownComplete.Add(prometheus.DefaultScrapeInterval), retVal: 100},
				{q: makeMetric(metricA, "success", portRegion2), t: firstPreStartup, retVal: 1000},
				{q: makeMetric(metricA, "error", portRegion2), t: firstShutdownComplete.Add(prometheus.DefaultScrapeInterval), retVal: 0},
				{q: makeMetric(metricA, "error", portRegion2), t: firstPreStartup, retVal: 0},

				{q: makeMetric(metricB, "success", portRegion1), t: firstShutdownComplete.Add(prometheus.DefaultScrapeInterval), retVal: 100},
				{q: makeMetric(metricB, "success", portRegion1), t: firstPreStartup, retVal: 100},
				{q: makeMetric(metricB, "error", portRegion1), t: firstShutdownComplete.Add(prometheus.DefaultScrapeInterval), retVal: 10},
				{q: makeMetric(metricB, "error", portRegion1), t: firstPreStartup, retVal: 1000},

				{q: makeMetric(metricB, "success", portRegion2), t: firstShutdownComplete.Add(prometheus.DefaultScrapeInterval), retVal: 100},
				{q: makeMetric(metricB, "success", portRegion2), t: firstPreStartup, retVal: 1000},
				{q: makeMetric(metricB, "error", portRegion2), t: firstShutdownComplete.Add(prometheus.DefaultScrapeInterval), retVal: 0},
				{q: makeMetric(metricB, "error", portRegion2), t: firstPreStartup, retVal: 0},

				// Shutdown region2.
				{q: makeMetric(metricA, "success", portRegion1), t: firstStartupComplete.Add(prometheus.DefaultScrapeInterval), retVal: 100},
				{q: makeMetric(metricA, "success", portRegion1), t: secondPreShutdown, retVal: 1000},
				{q: makeMetric(metricA, "error", portRegion1), t: firstStartupComplete.Add(prometheus.DefaultScrapeInterval), retVal: 1000},
				{q: makeMetric(metricA, "error", portRegion1), t: secondPreShutdown, retVal: 1000},

				{q: makeMetric(metricA, "success", portRegion2), t: firstStartupComplete.Add(prometheus.DefaultScrapeInterval), retVal: 100},
				{q: makeMetric(metricA, "success", portRegion2), t: secondPreShutdown, retVal: 1000},
				{q: makeMetric(metricA, "error", portRegion2), t: firstStartupComplete.Add(prometheus.DefaultScrapeInterval), retVal: 1000},
				{q: makeMetric(metricA, "error", portRegion2), t: secondPreShutdown, retVal: 1000},

				{q: makeMetric(metricB, "success", portRegion1), t: firstStartupComplete.Add(prometheus.DefaultScrapeInterval), retVal: 100},
				{q: makeMetric(metricB, "success", portRegion1), t: secondPreShutdown, retVal: 1000},
				{q: makeMetric(metricB, "error", portRegion1), t: firstStartupComplete.Add(prometheus.DefaultScrapeInterval), retVal: 1000},
				{q: makeMetric(metricB, "error", portRegion1), t: secondPreShutdown, retVal: 1000},

				{q: makeMetric(metricB, "success", portRegion2), t: firstStartupComplete.Add(prometheus.DefaultScrapeInterval), retVal: 100},
				{q: makeMetric(metricB, "success", portRegion2), t: secondPreShutdown, retVal: 1000},
				{q: makeMetric(metricB, "error", portRegion2), t: firstStartupComplete.Add(prometheus.DefaultScrapeInterval), retVal: 1000},
				{q: makeMetric(metricB, "error", portRegion2), t: secondPreShutdown, retVal: 1000},

				// Restart region2.
				{q: makeMetric(metricA, "success", portRegion1), t: secondShutdownComplete.Add(prometheus.DefaultScrapeInterval), retVal: 1000},
				{q: makeMetric(metricA, "success", portRegion1), t: secondPreStartup, retVal: 10000},
				{q: makeMetric(metricA, "error", portRegion1), t: secondShutdownComplete.Add(prometheus.DefaultScrapeInterval), retVal: 1000},
				{q: makeMetric(metricA, "error", portRegion1), t: secondPreStartup, retVal: 1000},

				{q: makeMetric(metricA, "success", portRegion2), t: secondShutdownComplete.Add(prometheus.DefaultScrapeInterval), retVal: 1000},
				{q: makeMetric(metricA, "success", portRegion2), t: secondPreStartup, retVal: 1000},
				{q: makeMetric(metricA, "error", portRegion2), t: secondShutdownComplete.Add(prometheus.DefaultScrapeInterval), retVal: 1000},
				{q: makeMetric(metricA, "error", portRegion2), t: secondPreStartup, retVal: 10000},

				{q: makeMetric(metricB, "success", portRegion1), t: secondShutdownComplete.Add(prometheus.DefaultScrapeInterval), retVal: 1000},
				{q: makeMetric(metricB, "success", portRegion1), t: secondPreStartup, retVal: 10000},
				{q: makeMetric(metricB, "error", portRegion1), t: secondShutdownComplete.Add(prometheus.DefaultScrapeInterval), retVal: 1000},
				{q: makeMetric(metricB, "error", portRegion1), t: secondPreStartup, retVal: 1000},

				{q: makeMetric(metricB, "success", portRegion2), t: secondShutdownComplete.Add(prometheus.DefaultScrapeInterval), retVal: 1000},
				{q: makeMetric(metricB, "success", portRegion2), t: secondPreStartup, retVal: 1000},
				{q: makeMetric(metricB, "error", portRegion2), t: secondShutdownComplete.Add(prometheus.DefaultScrapeInterval), retVal: 1000},
		...
		},
		{
			...
			mockPromQueries: []expectPromQuery{
				...
				{q: makeMetric(metricB, "success", portRegion2), t: firstPreStartup, retVal: 1000},
				{q: makeMetric(metricB, "error", portRegion2), t: firstShutdownComplete.Add(prometheus.DefaultScrapeInterval), retVal: 0},
				{q: makeMetric(metricB, "error", portRegion2), t: firstPreStartup, retVal: 1000}, // should have been had errors during shutdown.
			},
			workloadInstances: []workloadInstance{
				{
					nodes:          region1,
