...
func registerLedger(r *registry) {
	...
	r.Add(testSpec{
		...
		Run: func(ctx context.Context, t *test, c *cluster) {
			// TODO DURING REVIEW: How should we handle the round-robin
			// allocation of zones during cluster creation? This is how
			// it has to be handled now in each test, which isn't ideal.
			// As more and more roachtest become multi-zone, we're going
			// to face this annoyance more acutely.
