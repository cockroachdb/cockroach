...
`,
	...
	if err := rootCmd.Execute(); err != nil {
		code := 1
		if errors.Is(err, errInvariantViolationDetected) {
			code = ExitCodeInvariantViolationDetected
