...
`,
	...
	for _, cmd := range []*cobra.Command{runCmd, benchCmd} {
		...
		cmd.Flags().StringVar(
			...
			"the machine type to use (see https://aws.amazon.com/ec2/instance-types/, https://cloud.google.com/compute/docs/machine-types or https://docs.microsoft.com/en-us/azure/virtual-machines/windows/sizes)")
		cmd.Flags().IntVar(
