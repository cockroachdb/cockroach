...
func runMutationStatement(conn *sql.DB, smither *sqlsmith.Smither, logStmt func(string)) {
...
// not equal, an error is returned. See GenerateTLP for more information on
// TLP and the generated queries.
func runTLPQuery(conn *sql.DB, smither *sqlsmith.Smither, logStmt func(string)) error {
