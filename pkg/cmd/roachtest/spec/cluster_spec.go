...
func getGCEOpts(
	machineType string, zones []string, volumeSize, localSSDCount int, localSSD bool,
) gce.ProviderOpts {
...
func (s *ClusterSpec) RoachprodOpts(
	...
	case GCE:
		providerOpts = getGCEOpts(machineType, zones, s.VolumeSize, s.SSDs, createVMOpts.SSDOpts.UseLocalSSD)
	case Azure:
