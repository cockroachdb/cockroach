...
func TestCreatePostRequest(t *testing.T) {
	testCases := []struct {
		...
		{true, false, false, false, other, true,
		...
		{true, false, false, true, clusterCreation, true,
			prefixAll(map[string]string{
				"cloud":     "gce",
				"encrypted": "false",
				"fs":        "ext4",
		...
		{false, true, false, false, ssh, true,
			prefixAll(map[string]string{
				"cloud": "gce",
				"ssd":   "0",
				"cpu":   "4",
		...
		{true, false, true, false, other, false, nil},
	}
