...
func runMultiTenantUpgrade(ctx context.Context, t *test, c *cluster, v version.Version) {
	...
	errCh := startTenantServer(ctx, c, predecessorBinary, kvAddrs, "--log-dir=logs/mt")
	...
	errCh = startTenantServer(ctx, c, currentBinary, kvAddrs, "--log='file-defaults: {dir: logs/mt}'")
...
func startTenantServer(
	tenantCtx context.Context, c *cluster, binary string, kvAddrs []string, logFlags string,
) chan error {
