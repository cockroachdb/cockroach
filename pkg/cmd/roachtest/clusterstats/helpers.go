...
// prometheus scraper for all CockroachDB nodes. This function returns the
// created PrometheusConfig if prometheus is initialized, as well as a cleanup
// function which should be called in a defer statement.
