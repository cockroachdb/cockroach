...
type StatCollector interface {
	...
	// timeseries database. It should be called once at the end of a run.
	Cleanup()
}
...
func newClusterStatsCollector(
	...
	// Put the prometheus binary on the last node in the cluster. the remainder
	// nodes will be added as scrape targets.
	// TODO(kvoli): This should perhaps be moved to the prometheus file,
	// instead of here.
