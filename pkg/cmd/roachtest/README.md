...
For the most up-to-date guidance, open up a [recent `roachtest`
failure](https://github.com/cockroachdb/cockroach/issues?q=is%3Aopen+is%3Aissue+label%3AO-roachtest)
and peruse the instructions therein.
