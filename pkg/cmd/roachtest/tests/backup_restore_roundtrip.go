...
func backupRestoreRoundTrip(
	...
	m.Go(func(ctx context.Context) error {
		testUtils, d, runBackgroundWorkload, dbs, _, err := setupClusterForBackupRestore(
			ctx, t, c, m, testRNG,
...
// a function to run the background workload, and the databases and tables the
// workload/restore will work on.
func setupClusterForBackupRestore(
	...
	*BackupRestoreTestDriver,
	...
	return testUtils, d, runBackgroundWorkload, dbs, tables, nil
}
