...
func runMultiTenantUpgrade(ctx context.Context, t test.Test, c cluster.Cluster, v version.Version) {
	...
	const tenantNode = 2
	tenant11 := CreateTenantNode(ctx, t, c, kvAddrs, tenant11ID, tenantNode, tenant11HTTPPort, tenant11SQLPort)
	...
	tenant12 := CreateTenantNode(ctx, t, c, kvAddrs, tenant12ID, tenantNode, tenant12HTTPPort, tenant12SQLPort)
	...
	tenant13 := CreateTenantNode(ctx, t, c, kvAddrs, tenant13ID, tenantNode, tenant13HTTPPort, tenant13SQLPort)
	...
	tenant14 := CreateTenantNode(ctx, t, c, kvAddrs, tenant14ID, tenantNode, tenant14HTTPPort, tenant14SQLPort)
