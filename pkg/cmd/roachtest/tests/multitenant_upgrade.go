...
//   - Host{Binary: Prev, Cluster: Prev}: Run create_tenant(11).
//   - Tenant11a{Binary: Prev, Cluster: Prev}: Start tenant pod 11a and 11b, and verify that they work.
//   - Host{Binary: Prev, Cluster: Prev}: Set preserve downgrade option.
//   - Host{Binary: Prev, Cluster: Prev}: Run create_tenant(12).
