...
func runDecommissionDrains(ctx context.Context, t test.Test, c cluster.Cluster) {
	...
	require.NoError(t, err)
	err = cli.MatchCSV(o, expDecommissioned)
	require.NoError(t, err)
}
