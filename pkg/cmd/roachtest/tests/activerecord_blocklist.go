...
var activeRecordIgnoreList = blocklist{
	...
	`AsyncBelongsToAssociationsTest#test_async_load_belongs_to`:                                                                                             "flaky",
	`AsyncHasManyAssociationsTest#test_async_load_has_many`:                                                                                                 "flaky",
	`AsyncHasOneAssociationsTest#test_async_load_has_one`:                                                                                                   "flaky",
	...
	`FinderTest#test_select_values`: "flaky",
	...
	`TestAutosaveAssociationOnAHasAndBelongsToManyAssociation#test_should_allow_to_bypass_validations_on_the_associated_models_on_update`:                                                 "flaky",
	...
	`TestAutosaveAssociationOnAHasAndBelongsToManyAssociationWithAcceptsNestedAttributes#test_should_allow_to_bypass_validations_on_the_associated_models_on_update`:                      "flaky",
	`TestAutosaveAssociationOnAHasAndBelongsToManyAssociationWithAcceptsNestedAttributes#test_should_not_save_and_return_false_if_a_callback_cancelled_saving_in_either_create_or_update`: "flaky",
	`TestAutosaveAssociationOnAHasAndBelongsToManyAssociationWithAcceptsNestedAttributes#test_should_not_update_children_when_parent_creation_with_no_reason`:                             "flaky",
	`TestAutosaveAssociationOnAHasAndBelongsToManyAssociationWithAcceptsNestedAttributes#test_should_update_children_when_autosave_is_true_and_parent_is_new_but_child_is_not`:            "flaky",
