...
var activeRecordBlocklist = blocklist{
	"ActiveRecord::CockroachDB::Migration::PGChangeSchemaTest#test_change_string_to_date":                                               "experimental feature - https://github.com/cockroachdb/cockroach/issues/49329",
	"ActiveRecord::CockroachDB::Migration::PGChangeSchemaTest#test_change_type_with_array":                                              "experimental feature - https://github.com/cockroachdb/cockroach/issues/49329",
	"ActiveRecord::CockroachDB::Migration::PGChangeSchemaTest#test_change_type_with_symbol":                                             "experimental feature - https://github.com/cockroachdb/cockroach/issues/49329",
	"ActiveRecord::CockroachDB::Migration::PGChangeSchemaTest#test_change_type_with_symbol_using_datetime":                              "experimental feature - https://github.com/cockroachdb/cockroach/issues/49329",
	"ActiveRecord::CockroachDB::Migration::PGChangeSchemaTest#test_change_type_with_symbol_using_datetime_with_timestamptz_as_default":  "experimental feature - https://github.com/cockroachdb/cockroach/issues/49329",
	"ActiveRecord::CockroachDB::Migration::PGChangeSchemaTest#test_change_type_with_symbol_using_timestamp_with_timestamptz_as_default": "experimental feature - https://github.com/cockroachdb/cockroach/issues/49329",
	"ActiveRecord::CockroachDB::Migration::PGChangeSchemaTest#test_change_type_with_symbol_with_timestamptz_as_default":                 "experimental feature - https://github.com/cockroachdb/cockroach/issues/49329",
	"ActiveRecord::CockroachDB::Migration::PGChangeSchemaTest#test_change_type_with_symbol_with_timestamptz":                            "experimental feature - https://github.com/cockroachdb/cockroach/issues/49329",
	"PostgresqlRangeTest#test_timezone_array_awareness_tsrange":                                                                         "not yet implemented - https://github.com/cockroachdb/cockroach/issues/27791",
	"PostgresqlRangeTest#test_timezone_array_awareness_tzrange":                                                                         "not yet implemented  - https://github.com/cockroachdb/cockroach/issues/27791",
...
var activeRecordIgnoreList = blocklist{
	...
	"LengthValidationTest#test_validates_size_of_association_using_within":                                                                                     "flaky - sometimes complains that relation does not exist",
	"PostgresqlInfinityTest#test_where_clause_with_infinite_range_on_a_datetime_column":                                                                        "flaky - sometimes complains that relation does not exist",
	"PostgresqlIntervalTest#test_interval_type":                                                                                                                "flaky",
	"RelationTest#test_finding_last_with_arel_order":                                                                                                           "flaky - sometimes complains that relation does not exist",
	"RelationTest#test_joins_with_select_custom_attribute":                                                                                                     "flaky - sometimes complains that relation does not exist",
	"RelationTest#test_order_triggers_eager_loading_when_ordering_using_hash_syntax":                                                                           "flaky - sometimes complains that relation does not exist",
	"RelationTest#test_select_takes_a_variable_list_of_args":                                                                                                   "flaky - sometimes complains that relation does not exist",
	"RelationTest#test_size_with_limit":                                                                                                                        "flaky - sometimes complains that relation does not exist",
	"RelationTest#test_to_yaml":                                                                                                                                "flaky - sometimes complains that relation does not exist",
	"ReservedWordTest#test_calculations_work_with_reserved_words":                                                                                              "flaky - sometimes complains that relation does not exist",
	...
	"TouchTest#test_create_turned_off":                                                                                                                         "flaky - sometimes complains that relation does not exist",
	"TouchTest#test_update":                                                                                                                                    "flaky - sometimes complains that relation does not exist",
	...
	"UniquenessValidationTest#test_validate_case_insensitive_uniqueness_with_special_sql_like_chars":                                                           "flaky - sometimes complains that relation does not exist",
}
