...
// cdcFeatureFlags describes varouis cdc feature flags.
// zero value featureFlags uses metamorphic settings for features.
...
func (cfc *changefeedCreator) Create() (int, error) {
	...
	cfc.logger.Printf("Using mux_rangefeed to %t", cfc.useMux)
