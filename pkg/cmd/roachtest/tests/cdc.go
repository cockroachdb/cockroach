...
func (tw *tpccMultiDBWorkload) init(ctx context.Context, c cluster.Cluster, dbListFile string) error {
	dbName := "defaultdb"
	dbList := []string{}
...
func (tw *tpccMultiDBWorkload) run(ctx context.Context, c cluster.Cluster, dbListFile string) error {
