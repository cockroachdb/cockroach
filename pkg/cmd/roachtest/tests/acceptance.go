	...
	testCases := map[registry.Owner][]struct {
		...
		registry.OwnerKV: {
			...
			},
			{
				...
				fn: func(ctx context.Context, t test.Test, c cluster.Cluster) {
					// TODO(rail): pass the version in cli
					// TODO(rail): make this test exit 0 so we can proceed with automation
					// Run this test to create a new fixture for this test. This
