...
func runRegisterValidateGrantOption(
	...
	u := newVersionUpgradeTest(c,
		...
		execSQLAsUser("CREATE TABLE t2();", "foo", "", 1),                       // t2 has descriptor version GrantOptionVersion.
		execSQLAsUser("CREATE TABLE t3();", "foo", "", 2),                       // t3 has descriptor version Version21_2.
