...
var pgjdbcBlockList = blocklist{
	...
	`org.postgresql.test.xa.XADataSourceTest.closeBeforeCommit()`:                                                                                                   "98911",
	...
	`org.postgresql.test.xa.XADataSourceTest.endThenJoin()`:                                                                                                         "98911",
	...
	`org.postgresql.test.xa.XADataSourceTest.networkIssueOnOnePhaseCommit()`:                                                                                        "98911",
	`org.postgresql.test.xa.XADataSourceTest.networkIssueOnRollback()`:                                                                                              "98911",
	`org.postgresql.test.xa.XADataSourceTest.onePhase()`:                                                                                                            "98911",
	`org.postgresql.test.xa.XADataSourceTest.onePhaseCommitOfPrepared()`:                                                                                            "98911",
	`org.postgresql.test.xa.XADataSourceTest.onePhaseCommitUnknownXid()`:                                                                                            "98911",
	`org.postgresql.test.xa.XADataSourceTest.onePhaseCommittingCommittedXid()`:                                                                                      "98911",
	`org.postgresql.test.xa.XADataSourceTest.prepareUnknownXid()`:                                                                                                   "98911",
	...
	`org.postgresql.test.xa.XADataSourceTest.restoreOfAutoCommit()`:                                                                                                 "98911",
	`org.postgresql.test.xa.XADataSourceTest.restoreOfAutoCommitEndThenJoin()`:                                                                                      "98911",
	...
	`org.postgresql.test.xa.XADataSourceTest.rollbackWithoutPrepare()`:                                                                                              "98911",
	`org.postgresql.test.xa.XADataSourceTest.twoPhaseCommit()`:                                                                                                      "unknown",
	`org.postgresql.test.xa.XADataSourceTest.wrapperEquals()`:                                                                                                       "98911",
}
