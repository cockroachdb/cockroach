...
// run multiple samples and report metrics for CPU imbalance, write I/O imbalance,
...
//
// The test runs multiple samples (default: 5) and selects the median run to reduce
// variance. Standard deviation metrics (std_*) indicate consistency across runs,
// and are indicative of worst/best case outcomes.
