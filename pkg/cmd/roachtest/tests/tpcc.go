...
func registerTPCC(r registry.Registry) {
	...
	registerTPCCBenchSpec(
		r, tpccBenchSpec{
			...
			LoadWarehousesGCE:   7500,
			LoadWarehousesAWS:   7500,
			LoadWarehousesAzure: 7500,
			LoadWarehousesIBM:   7500,
			EstimatedMaxGCE:     6500,
			EstimatedMaxAWS:     6500,
			EstimatedMaxAzure:   6500,
			EstimatedMaxIBM:     6500,
