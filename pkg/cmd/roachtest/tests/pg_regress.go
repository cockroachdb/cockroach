...
func runPGRegress(ctx context.Context, t test.Test, c cluster.Cluster) {
	...
	if expected != actual {
		...
		t.L().Printf("If the diff is expected, copy regression.diffs from the test artifacts to pkg/cmd/roachtest/testdata/regresion.diffs")
	} else {
