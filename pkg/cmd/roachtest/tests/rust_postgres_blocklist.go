...
var rustPostgresIgnoreList22_1 = blocklist{
	...
	"test.transaction_drop":                    "unknown",
	"test.transaction_drop_immediate_rollback": "unknown",
	"test.transaction_rollback":                "unknown",
	...
	"types.test_bpchar_params":                 "unknown",
	...
	"types.test_slice_wrong_type":              "unknown",
}
