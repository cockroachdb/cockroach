...
var rustPostgresIgnoreList22_1 = blocklist{
	...
	"test.explicit_close":                      "unknown",
	"test.query_prepared":                      "unknown",
	"test.query_unprepared":                    "unknown",
	"test.require_channel_binding_err":         "unknown",
	"types.inet":                               "unknown",
	"types.system_time":                        "unknown",
	"types.test_bool_params":                   "unknown",
	"types.test_borrowed_bytea":                "unknown",
	"types.test_borrowed_text":                 "unknown",
	"types.test_bytea_params":                  "unknown",
	"types.test_f32_nan_param":                 "unknown",
	"types.test_f32_params":                    "unknown",
	"types.test_f64_nan_param":                 "unknown",
	"types.test_f64_params":                    "unknown",
	"types.test_i64_params":                    "unknown",
	"types.test_name_params":                   "unknown",
	"types.test_oid_params":                    "unknown",
	"types.test_text_params":                   "unknown",
	"types.test_varchar_params":                "unknown",
}
