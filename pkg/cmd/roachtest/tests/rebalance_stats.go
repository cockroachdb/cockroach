...
func distributionAggregate(query string, vals map[string][]float64) (string, []float64) {
	...
	return fmt.Sprintf("cv(%s)", query), scale(applyToSeries(timeseries, coefficientOfVariation), 100)
}
