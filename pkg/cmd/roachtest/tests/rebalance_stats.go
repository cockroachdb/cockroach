...
var (
	...
	rqpsStat = clusterstats.ClusterStat{LabelName: "store", Query: "rebalancing_requestspersecond"}
	...
	rangeCountStat      = clusterstats.ClusterStat{LabelName: "store", Query: "ranges"}
