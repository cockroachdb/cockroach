...
func getMetrics(
	...
	return getMetricsWithSamplePeriod(adminURL, start, end, defaultSampleNanos, tsQueries)
}

func getMetricsWithSamplePeriod(
	adminURL string, start, end time.Time, sampleNanos int64, tsQueries []tsQuery,
) (tspb.TimeSeriesQueryResponse, error) {
