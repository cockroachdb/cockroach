...
func runFailoverChaos(ctx context.Context, t test.Test, c cluster.Cluster, readOnly bool) {
	...
	require.NoError(
		t, roachtestutil.WaitForReplication(ctx, t, t.L(), conn, 5 /* replicationFactor */, roachtestutil.AtLeastReplicationFactor),
	)
...
func runFailoverPartialLeaseLeader(ctx context.Context, t test.Test, c cluster.Cluster) {
	...
	require.NoError(t, roachtestutil.WaitForReplication(ctx, t, t.L(), conn, 3, roachtestutil.ExactlyReplicationFactor))
