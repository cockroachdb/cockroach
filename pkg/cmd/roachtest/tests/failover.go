...
func (f *failureModeCrash) Recover(ctx context.Context, t test.Test, c cluster.Cluster, nodeID int) {
...
func (f *failureModeBlackhole) Fail(ctx context.Context, t test.Test, c cluster.Cluster, nodeID int) {
...
func (f *failureModeBlackhole) Recover(ctx context.Context, t test.Test, c cluster.Cluster, nodeID int) {
...
func (f *failureModeBlackholeRecv) Fail(ctx context.Context, t test.Test, c cluster.Cluster, nodeID int) {
	c.Run(ctx, c.Node(nodeID), `sudo iptables -A INPUT -p tcp --dport 26257 -j DROP`)
}

func (f *failureModeBlackholeRecv) Recover(ctx context.Context, t test.Test, c cluster.Cluster, nodeID int) {
	c.Run(ctx, c.Node(nodeID), `sudo iptables -F`)
}
...
func (f *failureModeBlackholeSend) Fail(ctx context.Context, t test.Test, c cluster.Cluster, nodeID int) {
	c.Run(ctx, c.Node(nodeID), `sudo iptables -A OUTPUT -p tcp --dport 26257 -j DROP`)
}

func (f *failureModeBlackholeSend) Recover(ctx context.Context, t test.Test, c cluster.Cluster, nodeID int) {
	c.Run(ctx, c.Node(nodeID), `sudo iptables -F`)
}
...
func relocateRanges(
	t test.Test, ctx context.Context, conn *sql.DB, predicate string, from, to []int,
) {
