...
func runFailoverChaos(ctx context.Context, t test.Test, c cluster.Cluster, readOnly bool) {
	...
	c.Start(ctx, t.L(), startOps(), settings, c.Range(1, 9))
...
func runFailoverPartialLeaseGateway(ctx context.Context, t test.Test, c cluster.Cluster) {
	...
	c.Start(ctx, t.L(), startOps(), settings, c.Range(1, 7))
...
func runFailoverPartialLeaseLeader(ctx context.Context, t test.Test, c cluster.Cluster) {
	...
	c.Start(ctx, t.L(), startOps(), settings, c.Range(1, 3))
	...
	c.Start(ctx, t.L(), startOps(), settings, c.Range(4, 6))
...
func runFailoverNonSystem(
	...
	c.Start(ctx, t.L(), startOps(), settings, c.Range(1, 6))
...
func runFailoverLiveness(
	...
	c.Start(ctx, t.L(), startOps(), settings, c.Range(1, 4))
...
func (f *crashFailer) Recover(ctx context.Context, nodeID int) {
	f.c.Start(ctx, f.t.L(), restartOps(), f.startSettings, f.c.Node(nodeID))
}
...
func startOps() option.StartOpts {
	startOpts := option.DefaultStartOpts()
	startOpts.RoachprodOpts.ScheduleBackups = false
	return startOpts
}

func restartOps() option.StartOpts {
	startOpts := option.DefaultStartOpts()
	startOpts.RoachprodOpts.ScheduleBackups = false
