...
type uniqueIndexWorkload struct {
	rows       int
	dataSize   int
...
func (w uniqueIndexWorkload) sourceInitCmd(tenantName string, nodes option.NodeListOption) string {
...
func (w uniqueIndexWorkload) sourceRunCmd(tenantName string, nodes option.NodeListOption) string {
...
func (w uniqueIndexWorkload) runDriver(
	workloadCtx context.Context, c cluster.Cluster, t test.Test, setup *c2cSetup,
) error {
