...
func TestRestoreRegisteredNames(t *testing.T) {
	...
	expectedRestoreTests := []string{
		...
		"restore/pause/tpcc-5k-350GiB/aws/nodes=4/cpus=8",
		"restore/tpcc-10-700MiB/gce/inc-count=4/nodes=4/cpus=8",
		"restore/tpcc-300k-20TiB/aws/inc-count=400/nodes=15/cpus=16",
		"restore/tpcc-300k-20TiB/aws/nodes=15/cpus=16",
		"restore/tpcc-300k-20TiB/gce/inc-count=400/nodes=15/cpus=16",
		"restore/tpcc-30k-2TiB/aws/inc-count=48/nodes=4/cpus=8",
		"restore/tpcc-30k-2TiB/aws/nodes=4/cpus=16",
		"restore/tpcc-30k-2TiB/aws/nodes=4/cpus=8",
		"restore/tpcc-30k-2TiB/aws/nodes=8/cpus=8",
		"restore/tpcc-30k-2TiB/aws/nodes=9/cpus=8/zones=us-east-2b,us-west-2b,eu-west-1b",
		"restore/tpcc-30k-2TiB/gce/nodes=4/cpus=8",
		"restore/tpcc-30k-2TiB/gce/nodes=4/cpus=8/lowmem",
	}
