...
func registerKV(r registry.Registry) {
	type kvOptions struct {
		...
		batchSize int
		blockSize int
		splits    int // 0 implies no splits
	...
	for _, opts := range []kvOptions{
		...
		{nodes: 3, cpus: 8, readPercent: 0, splits: 1000 /* non-zero splits */},
		{nodes: 3, cpus: 8, readPercent: 95, splits: 1000 /* non-zero splits */},
		...
		{nodes: 3, cpus: 32, readPercent: 0, splits: 1000 /* non-zero splits */},
		{nodes: 3, cpus: 32, readPercent: 95, splits: 1000 /* non-zero splits */},
