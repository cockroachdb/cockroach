...
func preloadDataStep(target int) versionStep {
	return func(ctx context.Context, t test.Test, u *versionUpgradeTest) {
		...
		c.Run(ctx, option.OnNodes(c.Node(target)),
...
func partialDecommissionStep(target, from int, binaryVersion *clusterupgrade.Version) versionStep {
	return func(ctx context.Context, t test.Test, u *versionUpgradeTest) {
		c := u.c
		c.Run(ctx, option.OnNodes(c.Node(from)), clusterupgrade.CockroachPathForVersion(t, binaryVersion), "node", "decommission",
...
func recommissionAllStep(from int, binaryVersion *clusterupgrade.Version) versionStep {
	return func(ctx context.Context, t test.Test, u *versionUpgradeTest) {
		c := u.c
		c.Run(ctx, option.OnNodes(c.Node(from)), clusterupgrade.CockroachPathForVersion(t, binaryVersion), "node", "recommission",
