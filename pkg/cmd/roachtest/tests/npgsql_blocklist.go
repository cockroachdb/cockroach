...
var npgsqlBlocklist = blocklist{
	...
	`Npgsql.Tests.BugTests.Chunked_char_array_write_buffer_encoding_space`:                                                                        "unknown",
	`Npgsql.Tests.BugTests.Chunked_string_write_buffer_encoding_space`:                                                                            "unknown",
	...
	`Npgsql.Tests.ConnectionTests(NonMultiplexing).ManyOpenClose`:                                                                                 "unknown",
	...
	`Npgsql.Tests.CopyTests(Multiplexing).Cancel_binary_import`:                                                                                   "unknown",
	...
	`Npgsql.Tests.CopyTests(Multiplexing).Cancel_text_export_when_not_consumed_and_then_Dispose`:                                                  "unknown",
	...
	`Npgsql.Tests.CopyTests(Multiplexing).Import_bytea`:                                                                                           "unknown",
	`Npgsql.Tests.CopyTests(Multiplexing).Import_cannot_write_after_commit`:                                                                       "unknown",
	`Npgsql.Tests.CopyTests(Multiplexing).Import_commit_in_middle_of_row`:                                                                         "unknown",
	`Npgsql.Tests.CopyTests(Multiplexing).Import_large_value_raw`:                                                                                 "97181",
	`Npgsql.Tests.CopyTests(Multiplexing).Import_numeric`:                                                                                         "unknown",
	...
	`Npgsql.Tests.CopyTests(Multiplexing).Wrong_table_definition_binary_export`:                                                                   "unknown",
	...
	`Npgsql.Tests.CopyTests(NonMultiplexing).Cancel_text_export_when_not_consumed_and_then_Dispose`:                                               "unknown",
	...
	`Npgsql.Tests.CopyTests(NonMultiplexing).Text_import_empty`:                                                                                   "unknown",
	...
	`Npgsql.Tests.TransactionTests(Multiplexing).Isolation_levels(ReadCommitted,"read committed")`:                                                "unknown",
	...
	`Npgsql.Tests.TransactionTests(Multiplexing).Isolation_levels(Unspecified,"read committed")`:                                                  "unknown",
	`Npgsql.Tests.TransactionTests(NonMultiplexing).Empty_Dispose`:                                                                                "unknown",
	`Npgsql.Tests.TransactionTests(NonMultiplexing).Isolation_levels(ReadCommitted,"read committed")`:                                             "unknown",
	...
	`Npgsql.Tests.TransactionTests(NonMultiplexing).Isolation_levels(Unspecified,"read committed")`:                                               "unknown",
	...
	`Npgsql.Tests.Types.InternalTypeTests(Multiplexing).NpgsqlLogSequenceNumber`:                                                                  "unknown",
	...
	`Npgsql.Tests.Types.InternalTypeTests(NonMultiplexing).NpgsqlLogSequenceNumber`:                                                               "unknown",
	...
	`Npgsql.Tests.Types.NetworkTypeTests(Multiplexing).IPAddress_Any`:                                                                             "unknown",
	`Npgsql.Tests.Types.NetworkTypeTests(Multiplexing).Inet_v4_as_IPAddress`:                                                                      "unknown",
	`Npgsql.Tests.Types.NetworkTypeTests(Multiplexing).Inet_v6_as_IPAddress`:                                                                      "unknown",
	...
	`Npgsql.Tests.Types.NetworkTypeTests(NonMultiplexing).IPAddress_Any`:                                                                          "unknown",
	`Npgsql.Tests.Types.NetworkTypeTests(NonMultiplexing).Inet_v4_as_IPAddress`:                                                                   "unknown",
	`Npgsql.Tests.Types.NetworkTypeTests(NonMultiplexing).Inet_v6_as_IPAddress`:                                                                   "unknown",
