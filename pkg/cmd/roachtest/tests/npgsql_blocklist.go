...
var npgsqlBlocklist = blocklist{
	...
	`Npgsql.Tests.CopyTests(Multiplexing).Import_exception_does_not_commit`:                                                                       "unknown",
	...
	`Npgsql.Tests.CopyTests(Multiplexing).Write_null_values`:                                                                                      "unknown",
	`Npgsql.Tests.CopyTests(Multiplexing).Wrong_table_definition_binary_import`:                                                                   "unknown",
	...
	`Npgsql.Tests.CopyTests(NonMultiplexing).Import_numeric`:                                                                                      "unknown",
