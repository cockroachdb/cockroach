...
// migrated to the new mixed-version testing framework.
func disableJobAdoptionStep(
	ctx context.Context, t test.Test, c cluster.Cluster, nodeIDs option.NodeListOption,
) error {
	...
	if _, err := c.RunWithDetails(ctx, t.L(), nodeIDs, "export COCKROACH_JOB_ADOPTIONS_PER_PERIOD=0"); err != nil {
		return err
	}
	return nil
}
