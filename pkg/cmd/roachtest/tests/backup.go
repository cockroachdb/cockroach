...
// `declarative_schema_changer/job-compatibility-mixed-version`. Delete
// this duplicated code once both tests have been migrated to the new
// mixed-version testing framework.
