...
var libPQBlacklists = blacklistsForVersion{
	{"v19.2", "libPQBlacklist19_2", libPQBlackList19_2, "", nil},
}
...
var libPQBlackList19_2 = blacklist{
	...
	"pq.TestFormatTsBackend":   "unknown",
	"pq.TestInfinityTimestamp": "41564",
	"pq.TestIssue186":          "41558",
	// TestIssue196 checks that float4 and float8 precision is maintained. The
	// failure doesn't seem to be reproducible through the shell.
	"pq.TestIssue196":              "unknown",
	...
	// TestRowsColumnTypes fails due to SELECT 1 evaluating to an INT4 in
	// postgres but an INT8 in cockroach.
	"pq.TestRowsColumnTypes":       "unknown",
