...
func GetChildWFID(childWorkflowID, taskName, planeName, planVariant string) string {
	return strings.Join([]string{childWorkflowID, taskName, planeName, planVariant}, ".")
}
