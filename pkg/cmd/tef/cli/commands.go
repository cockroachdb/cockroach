...
// Package cli provides command-line interface functionality for the Task
// Execution Framework (TEF). It handles CLI command generation and registration
// for plan-specific operations such as starting workers and executing plans.
