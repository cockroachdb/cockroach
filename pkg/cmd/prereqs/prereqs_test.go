...
var expectedFooSpecialTarget = `# Code generated by prereqs. DO NOT EDIT!

whatevah: vendor/foo.com/foo/foo.go vendor/foo.com/foo
...
func TestPrereqs(t *testing.T) {
	...
	testutils.RunTrueAndFalse(t, "symlink", func(t *testing.T, symlink bool) {
		...
		for _, tc := range []struct {
			...
			{path: "example.com/a", target: "bin/a", exp: expectedA},
			{path: "./b", target: "bin/b", exp: expectedB},
			{path: "./a/../b", target: "bin/b", exp: expectedB},
			{path: "example.com/a/../b", target: "bin/b", exp: expectedB},
			{path: "example.com/b", target: "bin/b", exp: expectedB},
			{path: "foo.com/foo", target: "bin/foo", exp: expectedFoo},
			{path: "foo.com/foo", target: "whatevah", exp: expectedFooSpecialTarget},
			{path: "./vendor/foo.com/foo", target: "bin/foo", exp: expectedFoo},
			{path: "example.com/vendor/foo.com/foo", target: "bin/foo", exp: expectedFoo},
			{path: "example.com/specialchars", target: "bin/specialchars", exp: expectedSpecialChars},
			{path: "example.com/test", target: "bin/test", exp: expectedTestNoDeps},
			{path: "example.com/test", target: "bin/test", exp: expectedTestWithDeps, includeTest: true},
		} {
			t.Run(tc.path, func(t *testing.T) {
				var buf bytes.Buffer
				if err := runW(&buf, tc.path, tc.target, tc.includeTest); err != nil {
					t.Fatal(err)
				}
