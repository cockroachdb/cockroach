...
var (
	flagAddress = flag.String("addr", "localhost:5432", "Postgres server address")
	flagUser    = flag.String("user", "postgres", "Postgres user")
	flagSchema  = flag.String("catalog", "pg_catalog", "Catalog or namespace, default: pg_catalog")
	flagRDBMS   = flag.String("rdbms", sql.Postgres, "Determines which rdbms it will connect, default: postgres")
