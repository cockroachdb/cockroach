...
// value without the checksum (as the checksum includes the key too).
//
// Callers should check the version clusterversion.CPutInline to make sure this
// is supported, and must wrap the context using CtxForCPutInline(ctx) to enable
// the call.
