...
type SSTBatcher struct {
	...
	// writeAtNow is passed to the writeAtBatchTs argument to db.AddSStable.
	writeAtNow bool
...
func (b *SSTBatcher) doFlush(ctx context.Context, reason int, nextKey roachpb.Key) error {
	...
	files, err := AddSSTable(ctx, b.db, start, end, b.sstFile.Data(), b.disallowShadowingBelow, b.ms, b.settings, b.batchTS, b.writeAtNow)
	if err != nil {
		return err
	}
