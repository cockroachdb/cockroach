...
type proberTxn interface {
	...
	// source at the time of this commit is not bypassing admission control, but
	// will once ROOT KV is subjected to admission control (see
	// pkg/kv/kvserver/store.go:AdmitKVWork).
