...
// ScanDirection determines the semantics of RangeIterator.Next().
// It also defines how RangeIterator.NeedAnother() relates to the a span: which
// end of key span is inclusive and which isn't.
...
func (ri *RangeIterator) Seek(
	ctx context.Context, key roachpb.RKey, scanDir ScanDirection,
) {
