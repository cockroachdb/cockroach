...
func TestBatchRequestString(t *testing.T) {
	...
	txn := roachpb.MakeTransaction("test", nil /* baseKey */, isolation.Serializable, roachpb.NormalUserPriority, hlc.Timestamp{} /* now */, 0 /* maxOffsetNs */, 99 /* coordinatorNodeID */, 0, false)
