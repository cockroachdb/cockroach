...
func flagForIsWrite(d lock.Durability) flag {
...
func (gr *GetRequest) flags() flag {
	...
	maybeWrite := flagForIsWrite(gr.KeyLockingDurability)
...
func (sr *ScanRequest) flags() flag {
	...
	maybeWrite := flagForIsWrite(sr.KeyLockingDurability)
...
func (rsr *ReverseScanRequest) flags() flag {
	...
	maybeWrite := flagForIsWrite(rsr.KeyLockingDurability)
