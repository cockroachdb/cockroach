...
func (ec *txnExistenceCache) populateMetaLocked(meta *roachpb.TxnCoordMeta) {
	// txnExistenceCache is all best effort. No need to persist information.
}

// augmentMetaLocked implements the txnReqInterceptor interface.
func (ec *txnExistenceCache) augmentMetaLocked(meta roachpb.TxnCoordMeta) {}
...
func (ec *txnExistenceCache) closeLocked() {}
