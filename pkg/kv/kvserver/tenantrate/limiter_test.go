...
// The argument is a yaml  init allows the test to configure the rate and burst
// limits. serialization of LimitConfigs. It returns the time as of
// initialization (00:00:00.000). For example:
//
//  init
...
// await. The set of outstanding requests is serialized as an list of
// [<id>@<tenant>, ...]
//
...
// argument as a regular expression over the values. The metrics are printed
// lexicographically.
//
// For example:
//
