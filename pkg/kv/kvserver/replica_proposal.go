...
type ProposalData struct {
	...
	// createdAtTs is the moment in time at which this command was *first* proposed.
	// Similar to createdAtTicks but is in wall time rather than raft ticks.
...
func (proposal *ProposalData) finishApplication(ctx context.Context, pr proposalResult) {
	proposal.ec.done(ctx, proposal.Request, pr.Reply, pr.Err, proposal.createdAtTs)
