...
type StoreTestingKnobs struct {
	...
	// AllocatorCheckRangeInterceptor intercepts calls to `Store.AllocatorCheckRange()`
	// and can be used to inject errors for testing. If non-nil, this error is returned
	// instead of calling the actual AllocatorCheckRange logic.
	AllocatorCheckRangeInterceptor error
