...
type StoreTestingKnobs struct {
	...
	// VoterAddSkipLearnerRollback causes voter addition to skip the learner
	// rollback that happens when promotion to a voter fails.
	...
	// ReplicaSkipLearnerSnapshot causes snapshots to never be sent to learners or
