...
func (sl *StoreList) makeStoreList(descriptors []roachpb.StoreDescriptor) StoreList {
	return makeStoreListInternal(descriptors, sl.storeCountByNode)
}
...
func (sl StoreList) filter(constraints []zonepb.ConstraintsConjunction) StoreList {
	...
	return sl.makeStoreList(filteredDescs)
}
...
func (sp *StorePool) makeStoreList(descriptors []roachpb.StoreDescriptor) StoreList {
	return makeStoreListInternal(descriptors, sp.getStoreCountByNode())
}
...
func (sp *StorePool) getStoreListFromIDsRLocked(
	...
	return makeStoreListInternal(storeDescriptors, sp.getStoreCountByNodeRLocked()), aliveStoreCount, throttled
}
