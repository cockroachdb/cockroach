...
func (m NodeStatus) String() string {
	...
	case NodeStatusUnknown:
		return "Unknown"
	default:
		err := "unknown status, expected one of [Dead,Unavailable,Live,Unknown]"
		panic(err)
	}
}
...
func (m NodeMembershipStatus) String() string {
	switch m {
	case NodeMembershipStatusActive:
		return "Active"
	case NodeMembershipStatusDecommissioning:
		return "Decommissioning"
	case NodeMembershipStatusDecommissioned:
		return "Decommissioned"
	case NodeMembershipStatusDraining:
		return "Draining"
	case NodeMembershipStatusUnknown:
		return "Unknown"
	default:
		err := "unknown membership status, expected one of [Active,Decommissioning,Decommissioned,Draining,Unknown]"
		panic(err)
	}
}
