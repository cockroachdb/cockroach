...
func (sr *StoreRebalancer) deprecatedChooseRangeToRebalance(
	...
	for {
		...
		*hottestRanges = (*hottestRanges)[1:]
		...
		targetVoterRepls, targetNonVoterRepls := sr.deprecatedGetRebalanceCandidatesBasedOnQPS(
...
// deprecatedGetRebalanceCandidatesBasedOnQPS returns a list of rebalance targets
...
// operated on.
func (sr *StoreRebalancer) deprecatedGetRebalanceCandidatesBasedOnQPS(
	ctx context.Context,
	rebalanceCtx deprecatedRebalanceContext,
