...
func TestLatchStringAndSafeformat(t *testing.T) {
	...
	require.EqualValues(t, `00011{-\x00}@0.000000010,0[Get ["a"]]`, la.String())
	require.EqualValues(t, `‹00011{-\x00}›@0.000000010,0[Get [‹"a"›]]`, redact.Sprint(la))
	require.EqualValues(t, `‹×›@0.000000010,0[Get [‹×›]]`, redact.Sprint(la).Redact())
}
