...
// Initialize span ptr when latch's span points to nil.
// This is pair with nilT struct's New, Key, EndKey,
// SetKey, SetEndKey methods
// to avoid null ptr panics.
