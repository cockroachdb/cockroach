...
type Metrics struct {
	...
	LocalWriteCount  int64
	GlobalReadCount  int64
	GlobalWriteCount int64
}
...
func (m *Manager) Metrics() Metrics {
	...
	defer m.mu.Unlock()
	var metrics Metrics
	metrics.GlobalReadCount, metrics.GlobalWriteCount = m.scopes[spanset.SpanGlobal].metricsLocked()
	metrics.LocalReadCount, metrics.LocalWriteCount = m.scopes[spanset.SpanLocal].metricsLocked()
	return metrics
}
