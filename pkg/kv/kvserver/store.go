...
// acquireReplicaForTruncator implements storeForTruncator.
func (s *Store) acquireReplicaForTruncator(rangeID roachpb.RangeID) (replicaForTruncator, error) {
...
// releaseReplicaForTruncator implements storeForTruncator.
func (s *Store) releaseReplicaForTruncator(r replicaForTruncator) {
	replica := r.(*Replica)
