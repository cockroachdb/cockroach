...
func (s *Store) AllocatorCheckRange(
	...
	if injectErr := s.cfg.TestingKnobs.AllocatorCheckRangeInterceptor(); injectErr != nil {
		return allocatorimpl.AllocatorNoop, roachpb.ReplicationTarget{}, tracingpb.Recording{}, injectErr
	}
