...
const (
	...
	// -leaseholder QPS on the store that removes the lease.
	//
	...
	// attribution.  The implemented approach composes well in comparison to
	// the process cpu approach. The sum of impact over available actions is
	// equal to the store value being balanced, similar to
