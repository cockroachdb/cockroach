...
type propBuf struct {
	...
	assignedLAI roachpb.LeaseAppliedIndex
	...
	testing struct {
		...
		leaseIndexFilter func(*ProposalData) roachpb.LeaseAppliedIndex
...
) (roachpb.LeaseAppliedIndex, hlc.Timestamp, error) {
...
func (b *propBuf) forwardAssignedLAILocked(v roachpb.LeaseAppliedIndex) {
	if b.assignedLAI < v {
		b.assignedLAI = v
	}
}
...
func (b *propBuf) OnLeaseChangeLocked(
	leaseOwned bool, appliedClosedTS hlc.Timestamp, appliedLAI roachpb.LeaseAppliedIndex,
) {
	if leaseOwned {
...
func (rp *replicaProposer) leaseAppliedIndex() roachpb.LeaseAppliedIndex {
