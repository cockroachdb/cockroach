...
// called concurrently with flushing.
func (b *propBuf) setTestingKnobs(allowLeaseProposalsWhenNotLeader bool) {
	b.testing.allowLeaseProposalWhenNotLeader = allowLeaseProposalsWhenNotLeader
}
