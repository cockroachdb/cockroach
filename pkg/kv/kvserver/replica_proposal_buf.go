...
// doneIfNotMovedLocked is like doneLocked, but it tolerates being called on a
// token that Done* was already called on. In particular, this is used when
// wanting to untrack a proposal that might, in fact, be a reproposal.
