...
type storeForTruncator interface {
	...
	// protecting raft-state is acquired before returning. This method also
	// ensures that the returned replica will not be destroyed until after
	// releaseReplicaForTruncator is called.
