...
type pendingTruncation struct {
	...
	expectedFirstIndex roachpb.RaftIndex
...
func (pt *pendingTruncation) firstIndexAfterTrunc() roachpb.RaftIndex {
...
type replicaForTruncator interface {
	...
	setTruncatedStateAndSideEffects(
		_ context.Context, _ *roachpb.RaftTruncatedState, expectedFirstIndexPreTruncation roachpb.RaftIndex,
	...
	sideloadedBytesIfTruncatedFromTo(
		_ context.Context, from, to roachpb.RaftIndex) (freed int64, _ error)
...
func (t *raftLogTruncator) addPendingTruncation(
	...
	raftExpectedFirstIndex roachpb.RaftIndex,
	raftLogDelta int64,
) {
