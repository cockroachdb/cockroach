...
func (rq *replicateQueue) processOneChange(
	...
	if !dryRun {
		...
		if err == nil {
			...
			// decommissioning, then annotate the error to avoid reprocessing
			// due to a snapshot error. This is only appended to operations
			// which have been planned successfully.
