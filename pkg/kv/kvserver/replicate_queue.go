...
// leaseTransferGoal dictates whether a call to TransferLeaseTarget should
// improve locality of access, convergence of lease counts or convergence of
// QPS.
type leaseTransferGoal int

const (
	followTheWorkload leaseTransferGoal = iota
	leaseCountConvergence
	qpsConvergence
)

type transferLeaseOptions struct {
	goal                     leaseTransferGoal
