...
type Entry struct {
	...
	ConfChangeContext *kvserverrt.ConfChangeContext // only set for config change
...
func (e *Entry) load() error {
	...
	if ccTarget != nil {
		...
		e.ConfChangeContext = &kvserverrt.ConfChangeContext{}
