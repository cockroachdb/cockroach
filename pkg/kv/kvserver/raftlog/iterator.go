...
func NewIterator(
	ctx context.Context, rangeID roachpb.RangeID, eng Reader, opts IterOptions) (*Iterator, error) {
...
func Visit(
	ctx context.Context, eng Reader, rangeID roachpb.RangeID, lo, hi kvpb.RaftIndex,
