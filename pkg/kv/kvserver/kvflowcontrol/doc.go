...
//       epochs"? What are we to do below-raft, when deciding where to return
//       flow tokens back to, since it's all for the same <tenant,priority>?
//       Maybe we need to pass down whether the work was admitted at the sender
//       with LIFO/FIFO, and return flow tokens in {LIFO,FIFO} order across all
//       nodes that issued {LIFO,FIFO} work?
//
// ---
//
