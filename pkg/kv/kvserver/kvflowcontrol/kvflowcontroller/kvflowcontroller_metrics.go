...
var (
	...
	flowTokensAvailable = metric.Metadata{
		...
		Help:        "Flow tokens available for %s work, across all replication streams",
		Measurement: "Bytes",
	...
	flowTokensDeducted = metric.Metadata{
		...
		Help:        "Flow tokens deducted by %s work, across all replication streams",
		Measurement: "Bytes",
		Unit:        metric.Unit_BYTES,
	}
	...
	flowTokensReturned = metric.Metadata{
		...
		Help:        "Flow tokens returned by %s work, across all replication streams",
		Measurement: "Bytes",
		Unit:        metric.Unit_BYTES,
	}
	...
	totalStreamCount = metric.Metadata{
		...
		Help:        "Total number of replication streams for %s work",
		Measurement: "Count",
		Unit:        metric.Unit_COUNT,
	}
	...
	blockedStreamCount = metric.Metadata{
		...
		Help:        "Number of replication streams with no flow tokens available for %s work",
		Measurement: "Count",
		Unit:        metric.Unit_COUNT,
	}
)
...
type metrics struct {
	...
	WaitDuration        [admissionpb.NumWorkClasses]*metric.Histogram
...
func newMetrics(c *Controller) *metrics {
	...
	for _, wc := range []admissionpb.WorkClass{
		...
		m.WaitDuration[wc] = metric.NewHistogram(
			annotateMetricTemplateWithWorkClass(wc, waitDuration),
