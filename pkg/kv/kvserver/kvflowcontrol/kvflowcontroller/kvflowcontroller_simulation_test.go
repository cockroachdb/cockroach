...
//     deducted (-ve 'adjust'), they go through Admit() followed by
//     DeductTokens(). If they're being returned (+ve 'adjust'), they simply
//     go through ReturnTokens(). The optional 'deduction-delay' parameter
//     controls the number of ticks between each request being granted admission
//     and it deducting the corresponding flow tokens.
//
