...
type lowPriOverrideState struct {
	...
	//
	// A read at index i causes a prefix of indices <= i to be discarded.
	intervals []interval
...
// sideChannelForPLowPriOverride is called on follower replicas, and specifies
...
// admittedIncreased returns true iff next has advanced from prev.
