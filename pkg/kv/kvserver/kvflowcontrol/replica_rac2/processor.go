...
//
// TODO(pav-kv): see what is the story with Replica.mu, and whether we need to
// group some fields based on Replica.mu lock status.
type processorImpl struct {
	...
	// raftNode gives access to the underlying raft.RawNode.
	raftNode RaftNode
