...
// though is not needed, and is mentioned in the method name purely from an
...
type RaftInterface interface {
	...
	// holding raftMu, which will not use RaftInterface, (b) call the following method
	// with the LogSlice, and the callee will make the MsgApp and behave as if it
	// was sent (i.e., update Next). Since are not holding Replica.mu, the callee
	// will need to acquire Replica.mu.
