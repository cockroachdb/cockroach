...
type rangeController struct {
	...
	// sendStreamStats populated holding raftMu and is returned to the caller of
	// SendStreamStats. Concurrent r/w is safe because the type is backed by
	// syncutil.Map.
	sendStreamStats RangeSendStreamStats
}
