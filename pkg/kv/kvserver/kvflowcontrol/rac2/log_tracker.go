...
// Admitted returns the currently observed admitted log state. The admitted
// indices are capped at the stable log index.
...
// skip removes a suffix of the ordered log marks slice, with all marks <= until
// removed from it.
