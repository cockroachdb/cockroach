...
func TestMergeQueueSeesNonVoters(t *testing.T) {
	...
	type test struct {
		name                                                   string
		leftNonVoters, rightNonVoters, leftVoters, rightVoters []int
	}

	// NB: The setup code for the "relocate-range" subtest places a single voter
	// replica on (n1,s1) for both left and right range.
	tests := []test{
		{
