...
type decommissioningNudgerEnqueueContextKey struct{}

var isDecommissioningNudgerEnqueueContextKey = decommissioningNudgerEnqueueContextKey{}
...
func (bq *baseQueue) isDecommissioningNudgerEnqueue(
	...
	return bq.name == "replicate" &&
		priority == allocatorimpl.AllocatorReplaceDecommissioningVoter.Priority() && ctx.Value(isDecommissioningNudgerEnqueueContextKey) == true
}
