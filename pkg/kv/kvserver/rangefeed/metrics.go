...
var (
	...
	metaRangeFeedOutputLoopNanosUnbufferedReg = metric.Metadata{
		Name: "kv.rangefeed.output_loop_nanos_unbuffered_reg",
	...
	metaRangefeedLifetimeNanos = metric.Metadata{
		...
		Help:        "Duration of Rangefeed between its successful registration and disconnection",
		Measurement: "Nanoseconds",
		Unit:        metric.Unit_NANOSECONDS,
	}
)
...
func NewMetrics() *Metrics {
	return &Metrics{
		...
		RangefeedOutputLoopNanosForUnbufferedReg:    metric.NewCounter(metaRangeFeedOutputLoopNanosUnbufferedReg),
