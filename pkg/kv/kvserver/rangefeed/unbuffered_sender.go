...
//			             │ Store.Rangefeed │         SendUnbuffered    DisconnectStream ─────► UnbufferedSender.run
//					         └───────┬─────────┘               ▲               ▲                               ▲
//			 		                 │                         │               │                               │
//			 		        ┌────────▼──────────┐              │               │                               │
//			 		        │ Replica.Rangefeed │              │               │                               │
...
// - For error events, DisconnectStream is non-blocking and ensures
// 1) stream context is canceled
// 2) exactly one error is sent back to the client on behalf of the stream
// 3) metrics updates.
// It makes sure DisconnectStream is non-blocking by delegating the
...
// DisconnectStream 1. Sends a mux rangefeed completion error to the
