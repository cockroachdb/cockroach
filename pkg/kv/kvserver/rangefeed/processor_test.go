...
func TestProcessorBasic(t *testing.T) {
	...
	r1OK, r1Filter, r1Done := p.Register(
	...
	r2OK, r1And2Filter, r2Done := p.Register(
...
func TestNilProcessor(t *testing.T) {
	...
	require.Panics(t, func() { p.Register(roachpb.RSpan{}, hlc.Timestamp{}, nil, false, nil) })
}
