...
// DisableRangefeedTxnPushBarrier is an escape hatch to disable the txn push
// barrier command in case it causes unexpected problems. This can result
// in violations of the rangefeed checkpoint guarantee, emitting premature
// checkpoints before all writes below it have been emitted.
