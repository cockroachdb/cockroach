...
func (r *Replica) LastAssignedLeaseIndex() roachpb.LeaseAppliedIndex {
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func (b *propBuf) LastAssignedLeaseIndexRLocked() roachpb.LeaseAppliedIndex {
...
func (r *Replica) GetCachedLastTerm() roachpb.RaftTerm {
	r.mu.RLock()
	defer r.mu.RUnlock()
