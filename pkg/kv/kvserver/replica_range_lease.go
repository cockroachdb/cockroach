...
//
// For non-expired leases, the lease's start timestamp is checked against the
// minProposedTimestamp. This timestamp indicates the oldest timestamp that a
// lease can have as its start time and still be used by the node. It is set
