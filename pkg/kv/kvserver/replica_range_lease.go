...
func (r *Replica) leaseSettings() leases.Settings {
	return leases.Settings{
		...
		ExpToEpochEquiv:                           r.store.ClusterSettings().Version.IsActive(context.Background(), clusterversion.V24_1Start),
