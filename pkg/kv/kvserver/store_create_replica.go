...
// (RaftReplicaID, RangeTombstone) state of can't all be done atomically, but
// this method effectively makes them appear atomically done under the returned
...
//   - The Replica does not see itself being destroyed in Replica.destroyStatus
