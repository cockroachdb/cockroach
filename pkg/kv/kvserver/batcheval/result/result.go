...
type LocalResult struct {
	...
	RepopulateSubsumeResponse bool
...
func (lResult *LocalResult) IsZero() bool {
	...
	return lResult.Reply == nil &&
		...
		!lResult.RepopulateSubsumeResponse &&
...
func (lResult *LocalResult) String() string {
	...
	return fmt.Sprintf("LocalResult (reply: %v, "+
		...
		lResult.PopulateBarrierResponse, lResult.RepopulateSubsumeResponse,
...
func (lResult *LocalResult) DetachRepopulateSubsumeResponse() bool {
	...
	r := lResult.RepopulateSubsumeResponse
	lResult.RepopulateSubsumeResponse = false
	return r
}
...
func (p *Result) MergeAndDestroy(q Result) error {
	...
	if !p.Local.RepopulateSubsumeResponse {
		p.Local.RepopulateSubsumeResponse = q.Local.RepopulateSubsumeResponse
	} else {
		// RepopulateSubsumeResponse is only valid for a single Barrier response.
		return errors.AssertionFailedf("multiple RepopulateSubsumeResponse results")
	}
	q.Local.RepopulateSubsumeResponse = false
