...
// ThrottleScanInterleavedIntents is called prior to request evaluation and
// latch acquisition, and could optionally slow down this ScanInterleavedIntents
// request if more than scanInterleavedIntentsPerStore of them are already
// running on the specified store.
func ThrottleScanInterleavedIntents(
	ctx context.Context, store roachpb.StoreID,
