...
func init() {
	// TODO(review): We want DefaultDeclareKeys here because we don't want to have
	// to wait out a long running transaction. But, we need a way to verify that
	// the latches are enough to provide the isolation we need here. I'm hoping
	// KVNemesis might be able to help here.
