...
// the stats computations are commutative.
//
// This can also be used to compute the merge contribution, which is the inverse
// of the fragmentation, because the range keys will already be merged in Pebble
// when this is called.
