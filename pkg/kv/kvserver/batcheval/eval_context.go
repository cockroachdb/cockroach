...
type EvalContext interface {
	...
	//
	// NOTE: This map will be nil on all replicas except the raft leader.
	GetProgress() map[uint64]tracker.Progress
...
func (m *mockEvalCtxImpl) GetProgress() map[uint64]tracker.Progress {
	return nil
}
