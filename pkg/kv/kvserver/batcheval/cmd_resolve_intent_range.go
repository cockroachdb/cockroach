...
func ResolveIntentRange(
	...
	numKeys, numBytes, resumeSpan, err := storage.MVCCResolveWriteIntentRangeWithByteSizePagination(
		ctx, readWriter, ms, update, h.MaxSpanRequestKeys, h.TargetBytes, h.AllowEmpty)
	if err != nil {
