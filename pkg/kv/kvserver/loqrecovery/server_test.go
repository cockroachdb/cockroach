...
func TestProbeRangeHealth(t *testing.T) {
	...
	for _, d := range []struct {
		...
		},
		{
			...
			result:    loqrecoverypb.RangeHealth_LossOfQuorum,
		},
		{
		...
		},
		{
			...
			deadNodes: nodeSet(3, 4, 5),
			result:    loqrecoverypb.RangeHealth_WaitingForMeta,
		},
		{
		...
		t.Run(d.name, func(t *testing.T) {
			...
			rangeInfo := func(rID roachpb.RangeID, nID roachpb.NodeID) (serverpb.RangeInfo, error) {
