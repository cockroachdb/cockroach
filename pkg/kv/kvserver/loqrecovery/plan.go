...
type PlanningReport struct {
	...
	// MissingNodes is a map of missing nodes and their corresponding stores.
	MissingNodes map[roachpb.NodeID][]roachpb.StoreID
...
func PlanReplicas(
	...
	report.MissingNodes = deadNodes.asMapOfSlices()
