...
// sql execution errors correctly and doesn't request deletion of failed records. It also
// performs basic sanity check that inserted records have correct range id and reason for
// update and a timestamp.
func TestPublishRangeLogEvents(t *testing.T) {
	...
	for _, td := range []struct {
		...
		{"success", 7, 1021, 1, nil, true},
		{"sql error", 7, 1021, 1, errors.New("stray sql error occurred"), false},
		{"wrong row count", 7, 1021, 0, nil, false},
	} {
