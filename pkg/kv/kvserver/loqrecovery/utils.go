...
// It is also kept as a part of error and not CLI package to allow datadriven
// tests to reuse this functionality without getting dependence on CLI.
func (e KeyspaceCoverageError) GetReport() string {
