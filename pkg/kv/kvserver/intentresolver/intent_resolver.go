...
) (_ *roachpb.Transaction, ambiguousAbort bool, _ *roachpb.Error) {
...
func (ir *IntentResolver) MaybePushTransactions(
	...
	skipIfInFlight bool,
) (_ map[uuid.UUID]*roachpb.Transaction, anyAmbiguousAbort bool, _ *roachpb.Error) {
	...
	for _, resp := range br.Responses {
		resp := resp.GetInner().(*roachpb.PushTxnResponse)
		txn := &resp.PusheeTxn
