...
var (
	...
	metaIntentResolverAsyncThrottled = metric.InitMetadata(metric.Metadata{
	...
	metaFinalizedTxnCleanupFailed = metric.InitMetadata(metric.Metadata{
	...
	metaIntentCleanupFailed = metric.InitMetadata(metric.Metadata{
