...
func TestIntentResolutionUnavailableRange(t *testing.T) {
	...
	testingAsyncIntentResolution := func(asyncIntentResolution func() error) error {
		go func() {
			...
			blockAsyncIntentResolution.Unlock() //lint:ignore SA2001 only used to block async intent resolution until a later time
			...
			Knobs: base.TestingKnobs{
				Store: &kvserver.StoreTestingKnobs{
					IntentResolverKnobs: kvserverbase.IntentResolverTestingKnobs{
						...
						TestingAsyncIntentResolution:        testingAsyncIntentResolution,
					},
				},
			},
		}
