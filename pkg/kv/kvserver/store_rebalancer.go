...
func (sr *StoreRebalancer) applyLeaseRebalance(
	...
	if err := candidateReplica.Repl().allocatorToken.Acquire(ctx,
		"store-rebalancer", nil /* onFail */); err != nil {
...
func (sr *StoreRebalancer) applyRangeRebalance(
	...
	if err := candidateReplica.Repl().allocatorToken.Acquire(
    ctx, "store-rebalancer", nil /* onFail */); err != nil {
