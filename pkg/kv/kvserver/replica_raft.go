...
var (
	...
	raftLogTruncationClearRangeThreshold = roachpb.RaftIndex(util.ConstantWithMetamorphicTestRange(
...
func (r *Replica) propose(
	...
	defer func(prev roachpb.LeaseAppliedIndex) {
		if pErr != nil {
...
func (r *Replica) maybeCoalesceHeartbeat(
	...
	beat := kvserverpb.RaftHeartbeat{
		...
		Term:                              roachpb.RaftTerm(msg.Term),
		Commit:                            roachpb.RaftIndex(msg.Commit),
		Quiesce:                           quiesce,
...
) (_ []snapTruncationInfo, minSnapIndex roachpb.RaftIndex) {
