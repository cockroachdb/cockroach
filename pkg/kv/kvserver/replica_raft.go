...
func (r *Replica) deliverLocalRaftMsgsRaftMuLockedReplicaMuLocked(
	...
	for i, m := range localMsgs {
		...
		// NB: we can reset messages in the r.localMsgs.recycled slice without holding the
		// localMsgs mutex because we're holding raftMu and
