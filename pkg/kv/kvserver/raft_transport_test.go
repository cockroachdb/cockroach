...
func (rttc *raftTransportTestContext) AddNode(nodeID roachpb.NodeID) *kvserver.RaftTransport {
	transport, addr := rttc.AddNodeWithoutGossip(
		...
		kvserver.NoopRaftTransportConnectedStores{},
		kvserver.NoopRaftTransportConnectedNodes{},
		nil,
	)
...
func (rttc *raftTransportTestContext) AddNodeWithoutGossip(
	...
	connectedStores kvserver.RaftTransportConnectedStores,
	connectedNodes kvserver.RaftTransportConnectedNodes,
