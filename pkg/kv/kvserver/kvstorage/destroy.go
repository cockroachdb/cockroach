...
// DestroyReplicaWrites is the plan for splitting DestroyReplica into
// cross-engine writes.
//
...
//     2.2. Write RangeTombstone with next ReplicaID/LogID.
...
func DestroyReplica(
	...
	_ = DestroyReplicaWrites // 2.1 + 2.2
