...
//
// INVARIANTS:
//   - A replica exists iff 0 < ReplicaID < MergedTombstoneReplicaID.
...
//
// NB: if NextReplicaID == MergedTombstoneReplicaID, the RangeID has no replica,
// and will never have one again. This means that the range is known to have
// been merged with its LHS neighbour.
//
