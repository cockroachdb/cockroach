...
func (r *Replica) MaybeGossipNodeLivenessRaftMuLocked(
	...
	br, result, pErr :=
		evaluateBatch(ctx, kvserverbase.CmdIDKey(""), rw, rec, nil, &ba, nil, uncertainty.Interval{}, true /* readOnly */)
	if pErr != nil {
...
func (r *Replica) loadSystemConfig(ctx context.Context) (*config.SystemConfigEntries, error) {
	...
	br, result, pErr := evaluateBatch(
		ctx, kvserverbase.CmdIDKey(""), rw, rec, nil, &ba, nil, uncertainty.Interval{}, true, /* readOnly */
	)
	if pErr != nil {
