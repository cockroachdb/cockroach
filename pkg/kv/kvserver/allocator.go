...
var enableLoadBasedLeaseRebalancing = settings.TenantWritable.RegisterBoolSetting(
...
var leaseRebalancingAggressiveness = settings.TenantWritable.RegisterFloatSetting(
