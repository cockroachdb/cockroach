...
type replicaAppBatch struct {
	appBatchNoMethods
	// h is currently always a *replicaAppBatchHandler. In the future, in the
	// context of standalone log application, this will be a *appBatchHandler.
	h appHandler
	r *Replica // TODO(sep-raft-log): move to replicaAppBatchHandler.
