...
func TestNewNodeVitality(liveness Liveness, health VitalityStatus) NodeVitality {
	return NodeVitality{
		draining:   liveness.Draining,
		membership: liveness.Membership,
		health:     health,
		Liveness:   liveness,
	}
}
...
func TestCreate(ids ...roachpb.NodeID) TestNodeVitality {
	m := TestNodeVitality{}
	for _, id := range ids {
