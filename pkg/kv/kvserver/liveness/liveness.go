...
const (
	...
	// TestTimeUntilNodeDeadOff is the test value for TimeUntilStoreDead that
...
// ScanNodeVitalityFromCache returns a map of nodeID to boolean liveness status of
// each node from the cache. This excludes nodes that were decommissioned.
