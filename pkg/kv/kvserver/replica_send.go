...
func (r *Replica) SendWithWriteBytes(
	...
	clearWorkState := ash.SetWorkState(ba.Header.WorkloadId, ash.WORK_CPU, "ReplicaSend")
...
func (r *Replica) maybeCommitWaitBeforeCommitTrigger(
	...
	clearWorkState := ash.SetWorkState(ba.Header.WorkloadId, ash.WORK_OTHER, "CommitWaitSleep")
	defer clearWorkState()
