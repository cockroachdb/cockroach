...
// unavailable. Next, it updates the meta2 range descriptor entry and uses
// UnsafeHealRange to resuscitate the range. Finally, it checks that the
// range is available again.
