...
type AllocationOp interface {
	// trackSideEffects tracks the side effects that have been generated in
	// creating this operation. This is used for updating context specific
	// metrics.
	trackSideEffects()
...
// creating this operation. This is used for updating context specific
// metrics.
func (o AllocationTransferLeaseOp) trackSideEffects() {
...
// creating this operation. This is used for updating context specific
// metrics.
func (o AllocationChangeReplicasOp) trackSideEffects() {
	if o.sideEffects != nil {
		o.sideEffects()
	}
}
...
func (o AllocationFinalizeAtomicReplicationOp) trackSideEffects()                          {}
...
func (o AllocationNoop) trackSideEffects()                          {}
