...
func readAmpCheck(
	...
	// Fail the check when the enforcement level is not set to storeHealthLog.
...
func rebalanceToReadAmpCheck(
	...
	// Fail the check when the enforcement level is storeHealthRebalanceOnly or above.
	return options.enforcementLevel < storeHealthRebalanceOnly
}
