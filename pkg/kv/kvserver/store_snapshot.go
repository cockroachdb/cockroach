...
// SendEmptySnapshot creates an OutgoingSnapshot for the input RangeDescriptor
// and seeds it with an empty range. Then, it calls initAndSendSnapshot to
// send this snapshot to the replica specified in the input.
