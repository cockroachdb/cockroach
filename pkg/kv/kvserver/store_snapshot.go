...
// descriptor and seeds it with an empty range. Then, it calls
// initAndSendSnapshot to send this snapshot to the replica specified
// in the input.
func SendEmptySnapshot(
	...
	outgoingSnap, err := snapshot(
		...
		snapUUID,
		sl,
		// TODO (thesamhuang): We may want a separate SnapshotRequest type
