...
var rebalanceSnapshotRate = settings.SystemOnly.RegisterByteSizeSetting(
...
var recoverySnapshotRate = settings.SystemOnly.RegisterByteSizeSetting(
...
var snapshotSenderBatchSize = settings.TenantWritable.RegisterByteSizeSetting(
...
var snapshotSSTWriteSyncRate = settings.TenantWritable.RegisterByteSizeSetting(
