...
/*
Package raftstorebench provides a simulated workload that loosely mimicks the
storage patterns of the Raft log and state machine on a single store. It
...
1. Appending entries to the Raft log, and
...
- Separate or combined storage engines for Raft log and state machine
