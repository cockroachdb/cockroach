...
type ReplicaState struct {
	...
	// not be served.
	GCThreshold *github_com_cockroachdb_cockroach_pkg_storage_enginepb.TxnTimestamp `protobuf:"bytes,6,opt,name=gc_threshold,json=gcThreshold,proto3,casttype=github.com/cockroachdb/cockroach/pkg/storage/enginepb.TxnTimestamp" json:"gc_threshold,omitempty"`
...
func (*ReplicaState) Descriptor() ([]byte, []int) {
	return fileDescriptor_state_3b902eacbbe4c5ca, []int{0}
}
...
type RangeInfo struct {
	...
	ActiveClosedTimestamp github_com_cockroachdb_cockroach_pkg_storage_enginepb.TxnTimestamp `protobuf:"bytes,12,opt,name=active_closed_timestamp,json=activeClosedTimestamp,proto3,casttype=github.com/cockroachdb/cockroach/pkg/storage/enginepb.TxnTimestamp" json:"active_closed_timestamp"`
...
func (*RangeInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_state_3b902eacbbe4c5ca, []int{1}
}
...
func (*RangeInfo_CTEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_state_3b902eacbbe4c5ca, []int{1, 0}
}
...
func (*LatchManagerInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_state_3b902eacbbe4c5ca, []int{2}
}
...
func (m *ReplicaState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			if m.GCThreshold == nil {
				m.GCThreshold = &github_com_cockroachdb_cockroach_pkg_storage_enginepb.TxnTimestamp{}
			}
...
var fileDescriptor_state_3b902eacbbe4c5ca = []byte{
	...
	,
}
