...
const (
	...
	// them. Note that the PROSCRIBED state is only visible to the
...
func (LeaseState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_lease_status_fa72e7aabe2b248c, []int{0}
}
...
func init() {
	proto.RegisterFile("kv/kvserver/kvserverpb/lease_status.proto", fileDescriptor_lease_status_fa72e7aabe2b248c)
}

var fileDescriptor_lease_status_fa72e7aabe2b248c = []byte{
