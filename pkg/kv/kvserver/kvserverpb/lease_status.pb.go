...
func (LeaseState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_lease_status_b4d76c1161c5d4b2, []int{0}
}
...
// the liveness if the lease is epoch-based.
...
func init() {
	proto.RegisterFile("kv/kvserver/kvserverpb/lease_status.proto", fileDescriptor_lease_status_b4d76c1161c5d4b2)
}

var fileDescriptor_lease_status_b4d76c1161c5d4b2 = []byte{
