...
func (LeaseState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_lease_status_49d92324e2fc2c47, []int{0}
}
...
func init() {
	proto.RegisterFile("kv/kvserver/kvserverpb/lease_status.proto", fileDescriptor_lease_status_49d92324e2fc2c47)
}

var fileDescriptor_lease_status_49d92324e2fc2c47 = []byte{
