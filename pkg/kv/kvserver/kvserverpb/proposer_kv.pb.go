...
func (*Split) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_4a677825a2ae70ec, []int{0}
}
...
func (*Merge) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_4a677825a2ae70ec, []int{1}
}
...
func (*ChangeReplicas) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_4a677825a2ae70ec, []int{2}
}
...
func (*ComputeChecksum) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_4a677825a2ae70ec, []int{3}
}
...
func (*Compaction) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_4a677825a2ae70ec, []int{4}
}
...
func (*SuggestedCompaction) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_4a677825a2ae70ec, []int{5}
}
...
type ReplicatedEvalResult struct {
	...
	// Copy of the request's write timestamp. Used to verify the validity of the
	// command against the GC threshold.
...
func (*ReplicatedEvalResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_4a677825a2ae70ec, []int{6}
}
...
func (*ReplicatedEvalResult_AddSSTable) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_4a677825a2ae70ec, []int{6, 0}
}
...
func (*WriteBatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_4a677825a2ae70ec, []int{7}
}
...
func (*LogicalOpLog) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_4a677825a2ae70ec, []int{8}
}
...
func (*RaftCommand) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_4a677825a2ae70ec, []int{9}
}
...
func (*RaftCommandFooter) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_4a677825a2ae70ec, []int{10}
}
...
func (*ClosedTimestampFooter) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_4a677825a2ae70ec, []int{11}
}
...
func init() {
	proto.RegisterFile("kv/kvserver/kvserverpb/proposer_kv.proto", fileDescriptor_proposer_kv_4a677825a2ae70ec)
}

var fileDescriptor_proposer_kv_4a677825a2ae70ec = []byte{
	...
	,
}
