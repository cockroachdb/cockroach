...
func (*Split) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_971b36276577105a, []int{0}
}
...
func (*Merge) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_971b36276577105a, []int{1}
}
...
func (*ChangeReplicas) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_971b36276577105a, []int{2}
}
...
func (*ComputeChecksum) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_971b36276577105a, []int{3}
}
...
func (*Compaction) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_971b36276577105a, []int{4}
}
...
func (*SuggestedCompaction) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_971b36276577105a, []int{5}
}
...
type ReplicatedEvalResult struct {
	...
	// The timestamp at which this command is writing. This is only set by
	// isIntentWrite requests (for example, it is not set by a lone EndTxn request
	// which doesn't write new values and thus can operate below the closed
	// timestamp). The field is used to verify the validity of the command against
	// the GC threshold and to update the followers' clocks.
	WriteTimestamp hlc.Timestamp `protobuf:"bytes,8,opt,name=write_timestamp,json=writeTimestamp,proto3" json:"write_timestamp"`
	// clock_signal can be set by the proposer in order to propagate a clock
	// reading to the followers. This field is generally only populated when
	// write_timestamp is not populated; when write_timestamp is populated, that's
	// considered a good enough clock signal.
	ClockSignal hlc.Timestamp `protobuf:"bytes,23,opt,name=clock_signal,json=clockSignal,proto3" json:"clock_signal"`
...
func (*ReplicatedEvalResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_971b36276577105a, []int{6}
}
...
func (*ReplicatedEvalResult_AddSSTable) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_971b36276577105a, []int{6, 0}
}
...
func (*WriteBatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_971b36276577105a, []int{7}
}
...
func (*LogicalOpLog) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_971b36276577105a, []int{8}
}
...
func (*RaftCommand) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_971b36276577105a, []int{9}
}
...
func (*MaxLeaseFooter) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_971b36276577105a, []int{10}
}
...
func (*ClosedTimestampFooter) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_971b36276577105a, []int{11}
}
...
func (m *ReplicatedEvalResult) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x1
	i++
	i = encodeVarintProposerKv(dAtA, i, uint64(m.ClockSignal.Size()))
	n18, err := m.ClockSignal.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n18
...
func (m *RaftCommand) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DeprecatedProposerLease != nil {
		...
		n19, err := m.DeprecatedProposerLease.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n19
	...
	n20, err := m.ReplicatedEvalResult.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n20
	if m.WriteBatch != nil {
		...
		n21, err := m.WriteBatch.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n21
	...
	if m.LogicalOpLog != nil {
		...
		n22, err := m.LogicalOpLog.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n22
...
func (m *ClosedTimestampFooter) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintProposerKv(dAtA, i, uint64(m.ClosedTimestamp.Size()))
	n24, err := m.ClosedTimestamp.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n24
...
func (m *ReplicatedEvalResult) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 23:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ClockSignal", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.ClockSignal.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func init() {
	proto.RegisterFile("kv/kvserver/kvserverpb/proposer_kv.proto", fileDescriptor_proposer_kv_971b36276577105a)
}

var fileDescriptor_proposer_kv_971b36276577105a = []byte{
	// 1535 bytes of a gzipped FileDescriptorProto
	,
}
