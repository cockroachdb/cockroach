...
type EvalResultFlags int32

const (
	EvalResultFlags_Empty EvalResultFlags = 0
	...
	EvalResultFlags_LeaseRequest EvalResultFlags = 1
	// IntentWrite indicates that this command writes MVCC keys and results in
	// intents (unless done outside of a txn or the command corresponds to a 1PC
	// batch). See ba.IsIntentWrite().
	EvalResultFlags_IntentWrite EvalResultFlags = 2
)

var EvalResultFlags_name = map[int32]string{
	0: "Empty",
	1: "LeaseRequest",
	2: "IntentWrite",
}
var EvalResultFlags_value = map[string]int32{
	"Empty":        0,
	"LeaseRequest": 1,
	"IntentWrite":  2,
}

func (x EvalResultFlags) String() string {
	return proto.EnumName(EvalResultFlags_name, int32(x))
}
func (EvalResultFlags) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_75631ded8fe17bb6, []int{0}
}
...
func (*Merge) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_75631ded8fe17bb6, []int{1}
}
...
func (*ChangeReplicas) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_75631ded8fe17bb6, []int{2}
}
...
func (*ComputeChecksum) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_75631ded8fe17bb6, []int{3}
}
...
func (*Compaction) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_75631ded8fe17bb6, []int{4}
}
...
func (*SuggestedCompaction) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_75631ded8fe17bb6, []int{5}
}
...
type ReplicatedEvalResult struct {
	...
	// The timestamp at which this command is writing. This is well defined by
	// IntentWrite requests, for which the field is used to verify the validity of
...
func (*ReplicatedEvalResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_75631ded8fe17bb6, []int{6}
}
...
func (*ReplicatedEvalResult_AddSSTable) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_75631ded8fe17bb6, []int{6, 0}
}
...
func (*WriteBatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_75631ded8fe17bb6, []int{7}
}
...
func (*LogicalOpLog) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_75631ded8fe17bb6, []int{8}
}
...
func (*RaftCommand) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_75631ded8fe17bb6, []int{9}
}
...
func (*MaxLeaseFooter) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_75631ded8fe17bb6, []int{10}
}
...
func (*ClosedTimestampFooter) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_75631ded8fe17bb6, []int{11}
}
...
func init() {
	...
	proto.RegisterEnum("cockroach.kv.kvserver.storagepb.EvalResultFlags", EvalResultFlags_name, EvalResultFlags_value)
}
...
func init() {
	proto.RegisterFile("kv/kvserver/kvserverpb/proposer_kv.proto", fileDescriptor_proposer_kv_75631ded8fe17bb6)
}

var fileDescriptor_proposer_kv_75631ded8fe17bb6 = []byte{
	...
	,
}
