...
func (*Split) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_8ad072a2f3dc105d, []int{0}
}
...
func (*Merge) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_8ad072a2f3dc105d, []int{1}
}
...
func (*ChangeReplicas) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_8ad072a2f3dc105d, []int{2}
}
...
func (*ComputeChecksum) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_8ad072a2f3dc105d, []int{3}
}
...
func (*Compaction) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_8ad072a2f3dc105d, []int{4}
}
...
func (*SuggestedCompaction) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_8ad072a2f3dc105d, []int{5}
}
...
type ReplicatedEvalResult struct {
	...
	// threshold).
	Timestamp github_com_cockroachdb_cockroach_pkg_storage_enginepb.TxnTimestamp `protobuf:"bytes,8,opt,name=timestamp,proto3,casttype=github.com/cockroachdb/cockroach/pkg/storage/enginepb.TxnTimestamp" json:"timestamp"`
...
func (*ReplicatedEvalResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_8ad072a2f3dc105d, []int{6}
}
...
func (*ReplicatedEvalResult_AddSSTable) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_8ad072a2f3dc105d, []int{6, 0}
}
...
func (*WriteBatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_8ad072a2f3dc105d, []int{7}
}
...
func (*LogicalOpLog) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_8ad072a2f3dc105d, []int{8}
}
...
func (*RaftCommand) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_8ad072a2f3dc105d, []int{9}
}
...
func (*RaftCommandFooter) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_8ad072a2f3dc105d, []int{10}
}
...
func init() {
	proto.RegisterFile("kv/kvserver/kvserverpb/proposer_kv.proto", fileDescriptor_proposer_kv_8ad072a2f3dc105d)
}

var fileDescriptor_proposer_kv_8ad072a2f3dc105d = []byte{
	...
	,
}
