...
type ReplicatedEvalResult struct {
	...
	// disconnect_rangefeed, if set, will disconnect range feeds with the
	// given retry error.
	//
	// FIXME(erikgrinaker): This field should really take a
	// RangeFeedRetryError.Reason, but errors.proto uses proto2 while this file
	// uses proto3, and proto2 enums cannot be referenced from proto3.
	//
	// This field is added in 22.1, and must only be used for behavior that is
	// guarded by a 22.1 version gate.
	DisconnectRangeFeed *roachpb.RangeFeedRetryError `protobuf:"bytes,23,opt,name=disconnect_rangefeed,json=disconnectRangefeed,proto3" json:"disconnect_rangefeed,omitempty"`
}
...
var fileDescriptor_19df0b186dd19269 = []byte{
	...
	,
}
...
func (m *ReplicatedEvalResult) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.DisconnectRangeFeed != nil {
		{
			size, err := m.DisconnectRangeFeed.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ReplicatedEvalResult) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 23:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DisconnectRangeFeed", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.DisconnectRangeFeed == nil {
				m.DisconnectRangeFeed = &roachpb.RangeFeedRetryError{}
			}
			if err := m.DisconnectRangeFeed.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
