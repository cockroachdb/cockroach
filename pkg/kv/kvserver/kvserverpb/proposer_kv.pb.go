...
func (*Split) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_9347681d47310ebf, []int{0}
}
...
func (*Merge) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_9347681d47310ebf, []int{1}
}
...
func (*ChangeReplicas) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_9347681d47310ebf, []int{2}
}
...
func (*ComputeChecksum) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_9347681d47310ebf, []int{3}
}
...
func (*Compaction) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_9347681d47310ebf, []int{4}
}
...
func (*SuggestedCompaction) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_9347681d47310ebf, []int{5}
}
...
func (*ReplicatedEvalResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_9347681d47310ebf, []int{6}
}
...
func (*ReplicatedEvalResult_AddSSTable) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_9347681d47310ebf, []int{6, 0}
}
...
func (*WriteBatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_9347681d47310ebf, []int{7}
}
...
func (*LogicalOpLog) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_9347681d47310ebf, []int{8}
}
...
func (*RaftCommand) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_9347681d47310ebf, []int{9}
}
...
func (*RaftCommandFooter) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_9347681d47310ebf, []int{10}
}
...
func (*ClosedTimestampFooter) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_9347681d47310ebf, []int{11}
}
...
func init() {
	proto.RegisterFile("kv/kvserver/kvserverpb/proposer_kv.proto", fileDescriptor_proposer_kv_9347681d47310ebf)
}

var fileDescriptor_proposer_kv_9347681d47310ebf = []byte{
