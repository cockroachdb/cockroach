...
// ReplicatedEvalResultFlags represent the bits in ReplicatedEvalResult.flags.
type ReplicatedEvalResultFlags int32

const (
	ReplicatedEvalResultFlags_Empty ReplicatedEvalResultFlags = 0
	// LeaseRequest indicates that the command corresponds to a RequestLease
	// request. Note that lease transfers don't have this flag.
	ReplicatedEvalResultFlags_LeaseRequest ReplicatedEvalResultFlags = 1
	// NonMVCC indicates that this command does not writes MVCC keys and it does
	...
	// that an EndTxn by itself sets this flag - it doesn't write any *new*
	// intents and so it can evaluate below the closed timestamp.
	ReplicatedEvalResultFlags_NonMVCC ReplicatedEvalResultFlags = 2
)

var ReplicatedEvalResultFlags_name = map[int32]string{
	0: "Empty",
	1: "LeaseRequest",
	2: "NonMVCC",
}

var ReplicatedEvalResultFlags_value = map[string]int32{
	"Empty":        0,
	"LeaseRequest": 1,
	"NonMVCC":      2,
}

func (x ReplicatedEvalResultFlags) String() string {
	return proto.EnumName(ReplicatedEvalResultFlags_name, int32(x))
}

func (ReplicatedEvalResultFlags) EnumDescriptor() ([]byte, []int) {
...
type ReplicatedEvalResult struct {
	...
	// the bits is given by ReplicatedEvalResultFlags.
	Flags int64 `protobuf:"varint,6,opt,name=flags,proto3" json:"flags,omitempty"`
	// The timestamp at which this command is writing. This is well defined for
	// requests with the NonMVCC flag *not set*, for which the field is used to
	// verify the validity of the command against the GC threshold. For all other
	// commands, the timestamp is to be interpreted simply as a clock signal from
	// the proposer - the field is used to bump the followers' clocks.
...
func init() {
	proto.RegisterEnum("cockroach.kv.kvserver.storagepb.ReplicatedEvalResultFlags", ReplicatedEvalResultFlags_name, ReplicatedEvalResultFlags_value)
...
var fileDescriptor_19df0b186dd19269 = []byte{
	...
	,
}
...
func (m *ReplicatedEvalResult) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x42
	if m.Flags != 0 {
		i = encodeVarintProposerKv(dAtA, i, uint64(m.Flags))
		i--
		dAtA[i] = 0x30
	}
	if m.Merge != nil {
...
func (m *ReplicatedEvalResult) Size() (n int) {
	...
	if m.Flags != 0 {
		n += 1 + sovProposerKv(uint64(m.Flags))
	}
