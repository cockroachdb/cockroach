...
func (MembershipStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_1bfd2d04a48289ea, []int{0}
}
...
func (NodeLivenessStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_1bfd2d04a48289ea, []int{1}
}
...
type Liveness struct {
	...
	// representation.
	Membership MembershipStatus `protobuf:"varint,5,opt,name=membership,proto3,enum=cockroach.kv.kvserver.storagepb.MembershipStatus" json:"membership,omitempty"`
}
...
func init() {
	proto.RegisterEnum("cockroach.kv.kvserver.storagepb.MembershipStatus", MembershipStatus_name, MembershipStatus_value)
...
func init() {
	proto.RegisterFile("kv/kvserver/kvserverpb/liveness.proto", fileDescriptor_1bfd2d04a48289ea)
}

var fileDescriptor_1bfd2d04a48289ea = []byte{
	...
	,
}
