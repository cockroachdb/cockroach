...
func (rq *raftSnapshotQueue) processRaftSnapshot(
	...
	err := repl.sendSnapshotToDelegate(ctx, repDesc, snapType, kvserverpb.SnapshotRequest_RECOVERY, kvserverpb.SnapshotRequest_RAFT_SNAPSHOT_QUEUE, raftSnapshotPriority)
