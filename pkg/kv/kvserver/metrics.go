...
var (
	...
	// TODO DURING REVIEW: what do we call this?
	// - storage.write-stalls to match the previous two metrics that were added in 92bc49c
	// - rocksdb.write-stalls to match all other metrics in this grouping
	// - pebble.write-stalls to transition new Pebble metrics to a better naming scheme
	// - something else?
	metaRdbWriteStalls = metric.Metadata{
		Name:        "rocksdb.write-stalls",
