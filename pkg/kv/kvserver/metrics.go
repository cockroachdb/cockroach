...
var (
	...
	metaRangeSnapShotCrossZoneSentBytes = metric.Metadata{
		...
		region tier key is not configured. This count increases for each snapshot
	...
	metaRangeSnapShotCrossZoneRcvdBytes = metric.Metadata{
		...
		region tiers are not configured in any nodes, this count may also include
		snapshot data received between zones in different regions. Ensuring
