...
`,
	...
	metaReplicaCircuitBreakerCumTripped = metric.Metadata{
		Name:        "kv.replica_circuit_breaker.num_trip_events",
...
type StoreMetrics struct {
	...
	*TenantsStorageMetrics
	...
	ReplicaCircuitBreakerCumTripped *metric.Gauge
}
...
func newStoreMetrics(histogramWindow time.Duration) *StoreMetrics {
	...
	sm := &StoreMetrics{
		...
		ReplicaCircuitBreakerCumTripped: metric.NewGauge(metaReplicaCircuitBreakerCumTripped),
	}
