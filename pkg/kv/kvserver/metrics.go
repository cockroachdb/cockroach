...
`,
	...
	metaRaftRcvdDeFortifyLeaderResp = metric.Metadata{
		Name:        "raft.rcvd.defortifyleaderresp",
		Help:        "Number of MsgDeFortifyLeaderResp messages received by this store",
		Measurement: "Messages",
		Unit:        metric.Unit_COUNT,
	}
...
func newStoreMetrics(histogramWindow time.Duration) *StoreMetrics {
	...
	sm := &StoreMetrics{
		...
		RaftRcvdMessages: [maxRaftMsgType + 1]*metric.Counter{
			...
			raftpb.MsgDeFortifyLeaderResp: metric.NewCounter(metaRaftRcvdDeFortifyLeaderResp),
		},
