...
Note that the measurement does not include the duration for replicating the evaluated command.`,
	...
	metaValueSeparationBytesReferenced = metric.Metadata{
		...
		Help:        "The size of storage engine value bytes that are stored separately in blob files and referenced by a live sstable.",
		Measurement: "Bytes",
		Unit:        metric.Unit_BYTES,
	}
	metaValueSeparationBytesUnreferenced = metric.Metadata{
		Name:        "storage.value_separation.value_bytes.unreferenced",
		Help:        "The size of storage engine value bytes that are stored separately in blob files and not referenced by any live sstable. These bytes are garbage that could be reclaimed by a compaction.",
		Measurement: "Bytes",
		Unit:        metric.Unit_BYTES,
	}
	...
	metaValueSeparationBlobFileSize = metric.Metadata{
		...
		Help:        "The size of the physical blob files that are used to store separated values within the storage engine.",
		Measurement: "Bytes",
		Unit:        metric.Unit_BYTES,
	}
