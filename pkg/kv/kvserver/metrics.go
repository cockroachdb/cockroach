...
`,
	...
	metaSecondaryCacheCount = metric.Metadata{
		Name:        "storage.shared-storage.cache.count",
		Help:        "The count of cache blocks in the cache (not sstable blocks)",
		Measurement: "Cache items",
		Unit:        metric.Unit_COUNT,
	}
	metaSecondaryCacheTotalReads = metric.Metadata{
		Name:        "storage.shared-storage.cache.reads-total",
		Help:        "The number of reads from the cache",
		Measurement: "Num reads",
		Unit:        metric.Unit_COUNT,
	}
	metaSecondaryCacheMultiShardReads = metric.Metadata{
		Name:        "storage.shared-storage.cache.reads-multi-shard",
		Help:        "The number of reads that require reading data from 2+ shards",
		Measurement: "Num reads",
		Unit:        metric.Unit_COUNT,
	}
	metaSecondaryCacheMultiBlockReads = metric.Metadata{
		Name:        "storage.shared-storage.cache.reads-multi-block",
		Help:        "The number of reads that require reading data from 2+ cache blocks",
		Measurement: "Num reads",
		Unit:        metric.Unit_COUNT,
	}
	metaSecondaryCacheReadsWithFullHit = metric.Metadata{
		Name:        "storage.shared-storage.cache.reads-full-hit",
		Help:        "The number of reads where all data returned was read from the cache",
		Measurement: "Num reads",
		Unit:        metric.Unit_COUNT,
	}
	metaSecondaryCacheReadsWithPartialHit = metric.Metadata{
		Name:        "storage.shared-storage.cache.reads-partial-hit",
		Help:        "The number of reads where some data returned was read from the cache",
		Measurement: "Num reads",
		Unit:        metric.Unit_COUNT,
	}
	metaSecondaryCacheReadsWithNoHit = metric.Metadata{
		Name:        "storage.shared-storage.cache.reads-no-hit",
		Help:        "The number of reads where no data returned was read from the cache",
		Measurement: "Num reads",
		Unit:        metric.Unit_COUNT,
	}
	metaSecondaryCacheEvictions = metric.Metadata{
		Name:        "storage.shared-storage.cache.evictions",
		Help:        "The number of times a cache block was evicted from the cache",
		Measurement: "Num evictions",
		Unit:        metric.Unit_COUNT,
	}
	metaSecondaryCacheWriteBackFailures = metric.Metadata{
		Name:        "storage.shared-storage.cache.write-back-failures",
		Help:        "The number of times writing a cache block to the cache failed",
