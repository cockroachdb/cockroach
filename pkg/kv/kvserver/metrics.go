...
`,
	...
	metaConcurrencyAverageLockHoldDurationNanos = metric.Metadata{
		...
		Help:        "Average length of time a lock is actively held in lock tables. Does not include replicated locks (intents) that are not held in memory",
		Measurement: "Nanoseconds",
		Unit:        metric.Unit_NANOSECONDS,
	}
	metaConcurrencyMaxLockHoldDurationNanos = metric.Metadata{
		Name:        "kv.concurrency.max_lock_hold_duration_nanos",
		Help:        "Maximum length of time any lock is actively held in lock tables. Does not include replicated locks (intents) that are not held in memory",
		Measurement: "Nanoseconds",
		Unit:        metric.Unit_NANOSECONDS,
	}
	...
	metaConcurrencyAverageLockWaitDurationNanos = metric.Metadata{
		...
		Help:        "Average length of time a request actively waits in a lock wait-queue",
		Measurement: "Nanoseconds",
		Unit:        metric.Unit_NANOSECONDS,
	}
	metaConcurrencyMaxLockWaitDurationNanos = metric.Metadata{
		Name:        "kv.concurrency.max_lock_wait_duration_nanos",
		Help:        "Maximum length of time spent actively waiting in a lock wait-queue",
		Measurement: "Nanoseconds",
		Unit:        metric.Unit_NANOSECONDS,
	}
