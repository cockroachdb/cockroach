...
Write amplification is measured as the ratio of bytes written to disk over the life of a store
relative to bytes present in sstables at the current point. This metric is a running average
