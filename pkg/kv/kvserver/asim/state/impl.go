...
type state struct {
	...
	// TODO(tbg): rename liveness -> vitality in the field name
	// and type below.
...
func (s *state) AddStore(nodeID NodeID) (Store, bool) {
	...
	// Register the store with the liveness tracker.
...
// NodeLiveness returns the aggregated liveness for a node.
