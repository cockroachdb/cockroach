...
// unavailable: set liveness expiration to be just recently expired. This needs
// to be within now - timeUntilNodeDead <= expirationWallTime < now so that the
// status is not dead nor alive.
