...
// TransferLeaseOp conatins the inforation for a transfer lease operation.
...
func NewTransferLeaseOp(
	tick time.Time, rangeID roachpb.RangeID, source, target roachpb.StoreID, rangeQPS float64,
) *TransferLeaseOp {
