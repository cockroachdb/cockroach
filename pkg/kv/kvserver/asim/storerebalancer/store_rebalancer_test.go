...
func TestStoreRebalancer(t *testing.T) {
	...
	leaseRangesInfo := state.RangesInfo{
		{StartKey: 100, Replicas: []state.StoreID{1, 2, 3}, Leaseholder: 1},
		{StartKey: 200, Replicas: []state.StoreID{1, 3, 4}, Leaseholder: 1},
		{StartKey: 300, Replicas: []state.StoreID{1, 4, 5}, Leaseholder: 1},
		{StartKey: 400, Replicas: []state.StoreID{1, 5, 6}, Leaseholder: 1},
		{StartKey: 500, Replicas: []state.StoreID{1, 6, 2}, Leaseholder: 1},
		{StartKey: 600, Replicas: []state.StoreID{1, 2, 3}, Leaseholder: 1},
	}
	...
	rangeRangesinfo := state.RangesInfo{
		{StartKey: 100, Replicas: []state.StoreID{1, 2, 3}, Leaseholder: 1},
		{StartKey: 200, Replicas: []state.StoreID{1, 2, 3}, Leaseholder: 1},
		{StartKey: 300, Replicas: []state.StoreID{1, 2, 3}, Leaseholder: 1},
		{StartKey: 400, Replicas: []state.StoreID{1, 2, 3}, Leaseholder: 1},
		{StartKey: 500, Replicas: []state.StoreID{1, 2, 3}, Leaseholder: 2},
		{StartKey: 600, Replicas: []state.StoreID{1, 2, 3}, Leaseholder: 3},
	}
