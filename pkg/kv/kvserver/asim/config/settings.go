...
const (
	...
	defaulltReplcateQueueEnabled   = true
	defaultSpltQueueEnabled        = true
...
// DefaultSimulationSettings returns a set of default control settings for
// simulation.
...
func DefaultSimulationClusterSettings() *SimulationClusterSettings {
	return &SimulationClusterSettings{
		...
		ReplicateQueueEnabled:   defaulltReplcateQueueEnabled,
		SplitQueueEnabled:       defaultSpltQueueEnabled,
	}
}
