...
func Example_tickEmptyState() {
	...
	start := state.TestingStartTime()
	s := state.LoadConfig(state.ComplexConfig)
	m := metrics.NewMetricsTracker(metrics.NewClusterMetricsTracker(os.Stdout))
...
func TestTickEmptyState(t *testing.T) {
	...
	m := metrics.NewMetricsTracker(metrics.NewClusterMetricsTracker(&buf))
...
func Example_multipleWriters() {
	...
	start := state.TestingStartTime()
	s := state.LoadConfig(state.ComplexConfig)
	m := metrics.NewMetricsTracker(metrics.NewClusterMetricsTracker(os.Stdout, os.Stdout))
...
func Example_workload() {
	...
	rwg[0] = workload.TestCreateWorkloadGenerator(settings.Start, 10*500, 10000)
	m := metrics.NewMetricsTracker(metrics.NewClusterMetricsTracker(os.Stdout))
...
func Example_storeMetricsWorkload() {
	ctx := context.Background()
	settings := config.DefaultSimulationSettings()
	settings.Duration = 30 * time.Second
	settings.Interval = 10 * time.Second
	rwg := make([]workload.Generator, 1)
	rwg[0] = workload.TestCreateWorkloadGenerator(settings.Start, 10*1000, 10000)
	m := metrics.NewMetricsTracker(metrics.NewStoreMetricsTracker(os.Stdout))

	s := state.LoadConfig(state.SingleRegionConfig)
	sim := asim.NewSimulator(rwg, s, settings, m)
	sim.RunSim(ctx)
	// Output:
	// tick,store,c_write,c_write_b,c_read,c_read_b,c_qps,c_ranges,c_leases
	// 2022-03-21 11:00:10 +0000 UTC,15,1,0,0,0,0,0.000000,0,0
	// 2022-03-21 11:00:10 +0000 UTC,8,1,0,0,0,0,0.000000,0,0
	// 2022-03-21 11:00:10 +0000 UTC,10,1,0,0,0,0,0.000000,0,0
	// 2022-03-21 11:00:10 +0000 UTC,4,1,0,0,0,0,0.000000,0,0
	// 2022-03-21 11:00:10 +0000 UTC,6,1,0,0,0,0,0.000000,0,0
	// 2022-03-21 11:00:10 +0000 UTC,3,1,2500,476753,0,0,0.000000,1,0
	// 2022-03-21 11:00:10 +0000 UTC,1,1,2500,476753,47500,9113574,0.000000,1,1
	// 2022-03-21 11:00:10 +0000 UTC,5,1,0,0,0,0,0.000000,0,0
	// 2022-03-21 11:00:10 +0000 UTC,2,1,2500,476753,0,0,0.000000,1,0
	// 2022-03-21 11:00:10 +0000 UTC,12,1,0,0,0,0,0.000000,0,0
	// 2022-03-21 11:00:10 +0000 UTC,9,1,0,0,0,0,0.000000,0,0
	// 2022-03-21 11:00:10 +0000 UTC,7,1,0,0,0,0,0.000000,0,0
	// 2022-03-21 11:00:10 +0000 UTC,13,1,0,0,0,0,0.000000,0,0
	// 2022-03-21 11:00:10 +0000 UTC,11,1,0,0,0,0,0.000000,0,0
	// 2022-03-21 11:00:10 +0000 UTC,14,1,0,0,0,0,0.000000,0,0
	// 2022-03-21 11:00:20 +0000 UTC,12,1,0,0,0,0,0.000000,0,0
	// 2022-03-21 11:00:20 +0000 UTC,6,1,0,0,0,0,0.000000,0,0
	// 2022-03-21 11:00:20 +0000 UTC,3,1,5000,953380,0,0,0.000000,1,0
	// 2022-03-21 11:00:20 +0000 UTC,7,1,0,0,0,0,0.000000,0,0
	// 2022-03-21 11:00:20 +0000 UTC,15,1,0,0,0,0,0.000000,0,0
	// 2022-03-21 11:00:20 +0000 UTC,10,1,0,0,0,0,0.000000,0,0
	// 2022-03-21 11:00:20 +0000 UTC,1,1,5000,953380,95000,18230385,333.333333,1,1
	// 2022-03-21 11:00:20 +0000 UTC,4,1,0,0,0,0,0.000000,0,0
	// 2022-03-21 11:00:20 +0000 UTC,5,1,0,0,0,0,0.000000,0,0
	// 2022-03-21 11:00:20 +0000 UTC,11,1,0,0,0,0,0.000000,0,0
	// 2022-03-21 11:00:20 +0000 UTC,14,1,0,0,0,0,0.000000,0,0
	// 2022-03-21 11:00:20 +0000 UTC,2,1,5000,953380,0,0,0.000000,1,0
	// 2022-03-21 11:00:20 +0000 UTC,9,1,0,0,0,0,0.000000,0,0
	// 2022-03-21 11:00:20 +0000 UTC,13,1,0,0,0,0,0.000000,0,0
	// 2022-03-21 11:00:20 +0000 UTC,8,1,0,0,0,0,0.000000,0,0
	// 2022-03-21 11:00:30 +0000 UTC,11,1,0,0,0,0,0.000000,0,0
	// 2022-03-21 11:00:30 +0000 UTC,14,1,0,0,0,0,0.000000,0,0
	// 2022-03-21 11:00:30 +0000 UTC,5,1,0,0,0,0,0.000000,0,0
	// 2022-03-21 11:00:30 +0000 UTC,9,1,0,0,0,0,0.000000,0,0
	// 2022-03-21 11:00:30 +0000 UTC,10,1,0,0,0,0,0.000000,0,0
	// 2022-03-21 11:00:30 +0000 UTC,8,1,0,0,0,0,0.000000,0,0
	// 2022-03-21 11:00:30 +0000 UTC,12,1,0,0,0,0,0.000000,0,0
	// 2022-03-21 11:00:30 +0000 UTC,4,1,0,0,0,0,0.000000,0,0
	// 2022-03-21 11:00:30 +0000 UTC,3,1,7500,1433699,0,0,0.000000,1,0
	// 2022-03-21 11:00:30 +0000 UTC,13,1,0,0,0,0,0.000000,0,0
	// 2022-03-21 11:00:30 +0000 UTC,15,1,0,0,0,0,0.000000,0,0
	// 2022-03-21 11:00:30 +0000 UTC,1,1,7500,1433699,142500,27362846,483.870968,1,1
	// 2022-03-21 11:00:30 +0000 UTC,6,1,0,0,0,0,0.000000,0,0
	// 2022-03-21 11:00:30 +0000 UTC,7,1,0,0,0,0,0.000000,0,0
	// 2022-03-21 11:00:30 +0000 UTC,2,1,7500,1433699,0,0,0.000000,1,0
}
...
func TestWorkloadMetrics(t *testing.T) {
	...
	s := state.NewTestStateEvenDistribution(7, 1, 3, 100000)
	rwg := make([]workload.Generator, 1)
	rwg[0] = workload.TestCreateWorkloadGenerator(settings.Start, 30000, 100000)
	m := metrics.NewMetricsTracker(metrics.NewClusterMetricsTracker(os.Stdout))
...
func TestPlotMetrics(t *testing.T) {
	ctx := context.Background()
	keyspan := 10000
	...
	for _, tc := range testCases {
		t.Run(tc.desc, func(t *testing.T) {
			...
			m := metrics.NewMetricsTracker(metrics.NewRatedStoreMetricListener(metrics.NewTimeSeriesMetricListener(&collected, tc.stores)))
			sim := asim.NewSimulator(rwg, s, settings, m)
			sim.RunSim(ctx)
