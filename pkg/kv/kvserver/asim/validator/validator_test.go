...
func TestValidator(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			constraint: "num_replicas=2 num_voters=2 " +
				"constraints={'+zone=US_West_1':2}",
			expectedSuccess:     true,
			expectedErrorMsgStr: "",
		},
		{
			description: "promoting partial nonvoters to voters",
		...
		},
		{
			...
			constraint: "num_replicas=2 " +
				"constraints={'+zone=US_West_1':2,'+region=US_West':2}",
			expectedSuccess:     true,
			expectedErrorMsgStr: "",
		},
		{
		...
		},
		{
			...
			constraint: "num_replicas=10 num_voters=28 " +
				"constraints={'+region=US_East':16,'+region=US_West':2,'+region=EU':10}",
			expectedSuccess:     false,
		...
		},
		{
			...
			constraint: "num_replicas=28 num_voters=10 " +
				"voter_constraints={'+region=US_East':16,'+region=US_West':2,'+region=EU':10}",
			expectedSuccess:     false,
			expectedErrorMsgStr: "failed to satisfy constraints for cluster",
		},
