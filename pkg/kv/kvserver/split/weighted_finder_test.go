...
type LargestRandSource struct{}

func (r LargestRandSource) Float64() float64 {
	return 1
}

func (r LargestRandSource) Intn(int) int {
	return 0
}
...
func TestSplitWeightedFinderRecorder(t *testing.T) {
	...
	testCases := []struct {
		...
		// Test recording a key query before the reservoir is full.
		{basicSpan, basicWeight, LargestRandSource{}, 0, basicReservoir, expectedBasicReservoir},
		// Test recording a key query after the reservoir is full with replacement.
		{replacementSpan, replacementWeight, ZeroRandSource{}, splitKeySampleSize + 1, replacementReservoir, expectedReplacementReservoir},
		// Test recording a key query after the reservoir is full without replacement.
		{fullSpan, fullWeight, LargestRandSource{}, splitKeySampleSize + 1, fullReservoir, expectedFullReservoir},
		// Test recording a spanning query.
		{spanningSpan, spanningWeight, LargestRandSource{}, splitKeySampleSize + 1, spanningReservoir, expectedSpanningReservoir},
	}
