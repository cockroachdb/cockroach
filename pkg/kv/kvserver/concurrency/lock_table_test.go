...
func TestLockStateSafeFormat(t *testing.T) {
	...
	l.holder.unreplicatedInfo.strengths[unreplicatedLockHolderStrengthToIndexMap[lock.Exclusive]] = 1
	l.holder.unreplicatedInfo.strengths[unreplicatedLockHolderStrengthToIndexMap[lock.Shared]] = 3
