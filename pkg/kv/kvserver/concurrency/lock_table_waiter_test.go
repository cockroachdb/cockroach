...
// Clock is part of the lockTable interface.
func (lt *mockLockTable) Clock() timeutil.TimeSource {
	if clock := lt.lockTableImpl.Clock(); clock != nil {
		return clock
	}
	return timeutil.DefaultTimeSource{}
}
