...
// performed[*]. Any non-locking readers above this timestamp should block on
// this lock. Note that this timestamp may be different from the transaction's
// provisional commit timestamp; however, non-locking readers cannot proceed
// until the intent has been moved to a higher timestamp.
//
