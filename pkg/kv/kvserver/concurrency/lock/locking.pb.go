...
func (Strength) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_locking_4fbbb41fbbd18e10, []int{0}
}
...
func (Durability) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_locking_4fbbb41fbbd18e10, []int{1}
}
...
func (WaitPolicy) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_locking_4fbbb41fbbd18e10, []int{2}
}
...
func init() {
	proto.RegisterFile("kv/kvserver/concurrency/lock/locking.proto", fileDescriptor_locking_4fbbb41fbbd18e10)
}

var fileDescriptor_locking_4fbbb41fbbd18e10 = []byte{
