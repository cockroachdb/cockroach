...
type LockTableMetrics struct {
	...
	LocksHeld int64
	// The aggregate nanoseconds locks have been actively held in the lock table.
	...
	// The aggregate nanoseconds spent in wait-queues across all locks.
	...
	TopKLocksByHoldDuration [3]LockMetrics

	// The top-k locks by longest waiting reader or writer in the wait-queue,
	// ordered in descending order.
	TopKLocksByWaitDuration [3]LockMetrics
}
...
type LockMetrics struct {
	...
	Held bool
	// The number of nanoseconds this lock has been held in the lock table
