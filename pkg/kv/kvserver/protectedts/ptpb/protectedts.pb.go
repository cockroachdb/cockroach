...
func (ProtectionMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_protectedts_e4a0069de36f267a, []int{0}
}
...
type Record struct {
	...
	Timestamp github_com_cockroachdb_cockroach_pkg_storage_enginepb.TxnTimestamp `protobuf:"bytes,2,opt,name=timestamp,proto3,casttype=github.com/cockroachdb/cockroach/pkg/storage/enginepb.TxnTimestamp" json:"timestamp"`
...
func (*Record) Descriptor() ([]byte, []int) {
	return fileDescriptor_protectedts_e4a0069de36f267a, []int{1}
}
...
func (*State) Descriptor() ([]byte, []int) {
	return fileDescriptor_protectedts_e4a0069de36f267a, []int{2}
}
...
func init() {
	proto.RegisterFile("kv/kvserver/protectedts/ptpb/protectedts.proto", fileDescriptor_protectedts_e4a0069de36f267a)
}

var fileDescriptor_protectedts_e4a0069de36f267a = []byte{
	// 588 bytes of a gzipped FileDescriptorProto
	,
}
