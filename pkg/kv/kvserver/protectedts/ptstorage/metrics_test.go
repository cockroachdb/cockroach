...
// TestStorageMetricsProtect verifies that Protect operations update metrics correctly.
...
// TestStorageMetricsRelease verifies that Release operations update metrics correctly.
...
// TestStorageMetricsGetRecord verifies that GetRecord operations update metrics correctly.
