...
func (ie *wrappedInternalExecutor) SetExtraTxnState(exTxnState *sqlutil.ExtraTxnStateArgs) {
	panic("not implemented")
}

func (ie *wrappedInternalExecutor) SetSessionData(sessionData *sessiondata.SessionData) {
	panic("not implemented")
}
