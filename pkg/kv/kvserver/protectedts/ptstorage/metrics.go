...
// Metrics holds metrics for the protected timestamp storage subsystem.
type Metrics struct {
	...
	MarkVerifiedSuccess    *metric.Counter
	MarkVerifiedFailed     *metric.Counter
}
...
func makeMetrics() Metrics {
	return Metrics{
		...
		MarkVerifiedSuccess:    metric.NewCounter(metaMarkVerifiedSuccess),
		MarkVerifiedFailed:     metric.NewCounter(metaMarkVerifiedFailed),
	}
}
...
var (
	...
	metaMarkVerifiedSuccess = metric.Metadata{
		Name:        "kv.protectedts.mark_verified.success",
		Help:        "number of successful MarkVerified operations",
		Measurement: "Operations",
		Unit:        metric.Unit_COUNT,
		MetricType:  io_prometheus_client.MetricType_COUNTER,
	}
	metaMarkVerifiedFailed = metric.Metadata{
		Name:        "kv.protectedts.mark_verified.failed",
		Help:        "number of failed MarkVerified operations (ErrNotExists or execution errors)",
		Measurement: "Operations",
		Unit:        metric.Unit_COUNT,
		MetricType:  io_prometheus_client.MetricType_COUNTER,
	}
