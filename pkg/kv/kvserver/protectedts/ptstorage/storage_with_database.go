...
func (s *storageWithDatabase) GetRecords(ctx context.Context, ids []uuid.UUID) (rs []ptpb.Record, err error) {
...
func (s *storageWithDatabase) UpdateTimestamps(ctx context.Context, recordsToUpdate map[uuid.UUID]hlc.Timestamp) error {
	return s.db.Txn(ctx, func(ctx context.Context, txn isql.Txn) error {
