...
func (p *storage) UpdateTimestamps(ctx context.Context, recordsToUpdate map[uuid.UUID]hlc.Timestamp) error {
...
func (p *storage) updateTimestampsBatched(ctx context.Context, recordsToUpdate map[uuid.UUID]hlc.Timestamp) error {
