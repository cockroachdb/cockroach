...
func TestConvertReplicaChangeToMMA(t *testing.T) {
	...
	datadriven.RunTest(t, datapathutils.TestDataPath(t, "convert_replica_change_to_mma"),
		func(t *testing.T, d *datadriven.TestData) string {
			...
			case "convert-replica-changes":
				...
				if expectPanic {
					require.Panics(t,
						func() { convertReplicaChangeToMMA(&desc, rangeUsageInfo, changes, leaseholderStoreID) })
					...
					return mmaChanges.StringForTesting()
				}
