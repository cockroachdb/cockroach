...
// refreshes policies on every leaseholder of nodes. These policies are
// refreshed regardless of whether auto-tuning is enabled.
...
// serve global reads would be assigned with policies based on observed latency
