...
// LeadForGlobalReadsAutoTuneInterval controls how frequently the system adjusts closed
// timestamp policies for ranges based on network latency measurements. When enabled,
// ranges are assigned policies based on observed latency between their leaseholder and furthest follower.
// This dynamic adjustment helps optimize closed timestamp lead times. If no latency
// data is available, falls back to default lead times. Note that the
