...
func TestNetworkRTTAndPolicyCalculations(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			expectedRTT:    50 * time.Millisecond, // midpoint of 40-60ms bucket
		},
		{
		...
		},
		{
			...
			expectedRTT:    90 * time.Millisecond, // midpoint of 80-100ms bucket
		},
		{
			name:           "exactly 100ms",
		...
		},
		{
			...
			expectedRTT:    130 * time.Millisecond, // midpoint of 120-140ms bucket
		},
		{
			name:           "exactly 140ms",
		...
		},
		{
			...
			expectedRTT:    170 * time.Millisecond, // midpoint of 160-180ms bucket
		},
		{
			name:           "exactly 180ms",
		...
		},
		{
			...
			expectedRTT:    210 * time.Millisecond, // midpoint of 200-220ms bucket
		},
		{
			name:           "exactly 220ms",
		...
		},
		{
			...
			expectedRTT:    250 * time.Millisecond, // midpoint of 240-260ms bucket
		},
		{
			name:           "exactly 260ms",
