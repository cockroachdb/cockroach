...
var laiZero = enginepb.LeaseSequence(0)

const lai100 = enginepb.LeaseSequence(100)
const lai101 = enginepb.LeaseSequence(101)
const lai102 = enginepb.LeaseSequence(102)
const lai103 = enginepb.LeaseSequence(103)
