...
func TestLockAgeThresholdSetting(t *testing.T) {
	...
	makeTxn := func() roachpb.Transaction {
		return roachpb.MakeTransaction("txn", key, isolation.Serializable, roachpb.NormalUserPriority, intentHlc, 1000, 0, 0, false)
	}
...
func TestIntentCleanupBatching(t *testing.T) {
	...
	for i, prefix := range txnPrefixes {
		...
		txn := roachpb.MakeTransaction("txn", key, isolation.Serializable, roachpb.NormalUserPriority, intentHlc, 1000, 0, 0, false)
