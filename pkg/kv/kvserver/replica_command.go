...
func splitTxnAttempt(
	...
	supoortsGCHints := store.ClusterSettings().Version.IsActive(ctx, clusterversion.GCHintInReplicaState)
...
func (r *Replica) AdminMerge(
	...
	runMergeTxn := func(txn *kv.Txn) error {
		...
		supoortsGCHints := r.ClusterSettings().Version.IsActive(ctx, clusterversion.GCHintInReplicaState)
