...
func (r *Replica) lockLearnerSnapshot(
	...
	for _, addition := range additions {
		...
		_, cleanup := r.addSnapshotLogTruncationConstraint(ctx, lockUUID, kvserverpb.SnapshotRequest_INITIAL, addition.StoreID)
...
func (r *Replica) sendSnapshotUsingDelegate(
	...
	appliedIndex, cleanup := r.addSnapshotLogTruncationConstraint(ctx, snapUUID, snapType, recipient.StoreID)
