...
// We then step through RHS's non-collocated voters & try to move them to stores
// that already have a voter for LHS. If this is not possible for all the
...
func GetTargetsToCollocateRHSForMerge(
	leftRepls, rightRepls roachpb.ReplicaSet,
