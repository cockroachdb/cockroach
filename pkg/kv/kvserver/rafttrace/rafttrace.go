...
// seenMsgAppResp returns true on the first MsgAppResp for this peer.
...
// seenMsgStorageAppendResp returns true on the first MsgStorageAppendResp.
...
func (r *RaftTracer) tryStore(tv *traceValue) *traceValue {
