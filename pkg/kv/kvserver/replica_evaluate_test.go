	...
	tcs := []testCase{
		...
		},
		{
			...
			check: func(t *testing.T, r resp) {
				...
				verifyResumeSpans(t, r, "c-c\x00", "a-a\x00")
				verifyAcquiredLocks(t, r, acquiredLocks{})
			},
		},
		{
		...
		},
		{
			...
			check: func(t *testing.T, r resp) {
				...
				verifyResumeSpans(t, r, "b-b\x00", "a-a\x00")
				verifyAcquiredLocks(t, r, acquiredLocks{})
			},
		},
		{
		...
		{
			// Per-scan limit allows both ScanRequests and ReverseScanRequests.
			name: "scans and reverse scans with MaxPerScanRequestKeys=1",
			setup: func(t *testing.T, d *data) {
				writeABCDEF(t, d)
				d.ba.Add(scanArgsString("a", "c"))
				d.ba.Add(revScanArgsString("c", "e"))
			...
			check: func(t *testing.T, r resp) {
				verifyReadResult(t, r, []string{"a"}, []string{"d"})
				verifyResumeSpans(t, r, "b-c", "c-c\x00")
				verifyAcquiredLocks(t, r, acquiredLocks{})
			},
		},
		//
