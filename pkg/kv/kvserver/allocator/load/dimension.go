...
const (
	...
	nDimensions int = int(Queries) + 1
)

// DimensionMeta has methods to gather metadata information such as the name of
// a dimension and format values appropriate to that dimension.
type DimensionMeta interface {
