...
func snapshotStore(s *storeState, cs *clusterState) *mmasnappb.StoreSnapshot {
	return &mmasnappb.StoreSnapshot{
		...
		LocalityTiers:              snapshotLocalityTiers(s.localityTiers, cs),
		OverloadStartTime:          s.overloadStartTime,
		OverloadEndTime:            s.overloadEndTime,
	}
}
...
func snapshotRange(r *rangeState) *mmasnappb.RangeSnapshot {
	...
	return &mmasnappb.RangeSnapshot{
		...
		LastFailedChange:                   r.lastFailedChange,
		DiversityIncreaseLastFailedAttempt: r.diversityIncreaseLastFailedAttempt,
	}
}
...
func snapshotLocalityTiers(lt localityTiers, cs *clusterState) mmasnappb.LocalityTiers {
	return mmasnappb.LocalityTiers{
		Tiers: []string(cs.localityTierInterner.unintern(lt)),
		Str:   lt.str,
	}
}
