...
func NewOverrideStorePool(
	storePool *StorePool, nl NodeLivenessFunc,
) *OverrideStorePool {
...
func (o *OverrideStorePool) IsStoreReadyForRoutineReplicaTransfer(ctx context.Context, targetStoreID roachpb.StoreID) bool {
...
func (o *OverrideStorePool) DecommissioningReplicas(repls []roachpb.ReplicaDescriptor) []roachpb.ReplicaDescriptor {
...
func (o *OverrideStorePool) GetStoreList(filter StoreFilter) (StoreList, int, ThrottledStoreReasons) {
	o.sp.DetailsMu.Lock()
...
func (o *OverrideStorePool) GetStoreListFromIDs(storeIDs roachpb.StoreIDSlice, filter StoreFilter) (StoreList, int, ThrottledStoreReasons) {
	o.sp.DetailsMu.Lock()
	defer o.sp.DetailsMu.Unlock()
	return o.sp.getStoreListFromIDsLocked(storeIDs, o.overrideNodeLivenessFn, filter)
}
...
func (o *OverrideStorePool) LiveAndDeadReplicas(repls []roachpb.ReplicaDescriptor, includeSuspectAndDrainingStores bool) (liveReplicas, deadReplicas []roachpb.ReplicaDescriptor) {
...
func (o *OverrideStorePool) GetLocalitiesByNode(replicas []roachpb.ReplicaDescriptor) map[roachpb.NodeID]roachpb.Locality {
	return o.sp.GetLocalitiesByNode(replicas)
}

// GetLocalitiesByStore implements the AllocatorStorePool interface.
func (o *OverrideStorePool) GetLocalitiesByStore(replicas []roachpb.ReplicaDescriptor) map[roachpb.StoreID]roachpb.Locality {
...
func (o *OverrideStorePool) GetStoreDescriptor(storeID roachpb.StoreID) (roachpb.StoreDescriptor, bool) {
	return o.sp.GetStoreDescriptor(storeID)
}

// GossipNodeIDAddress implements the AllocatorStorePool interface.
func (o *OverrideStorePool) GossipNodeIDAddress(nodeID roachpb.NodeID) (*util.UnresolvedAddr, error) {
	return o.sp.GossipNodeIDAddress(nodeID)
}

// UpdateLocalStoreAfterRebalance implements the AllocatorStorePool interface.
func (o *OverrideStorePool) UpdateLocalStoreAfterRebalance(storeID roachpb.StoreID, rangeUsageInfo allocator.RangeUsageInfo, changeType roachpb.ReplicaChangeType) {
	o.sp.UpdateLocalStoreAfterRebalance(storeID, rangeUsageInfo, changeType)
}

// UpdateLocalStoresAfterLeaseTransfer implements the AllocatorStorePool interface.
func (o *OverrideStorePool) UpdateLocalStoresAfterLeaseTransfer(from roachpb.StoreID, to roachpb.StoreID, rangeQPS float64) {
	o.sp.UpdateLocalStoresAfterLeaseTransfer(from, to, rangeQPS)
}
