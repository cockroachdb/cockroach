...
//     asserts and calls through to appBatchConcrete.
//
// In the future, replicaAppBatch will be interacting with the surrounding running
// *Replica only via the appHandler interface, and so it will be possible to use it
// for standalone log application.
...
// CheckForcedErr is part of a concrete implementation of appHandler. It simply
// passes through to kvserverbase.CheckForcedErr.
...
// AssertCheckedCommand is part of a concrete implementation of appHandler. It checks
// that the raft log index is set and equals the previously applied entry plus one.
