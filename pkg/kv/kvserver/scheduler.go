...
// priorityWorkers is the number of goroutines reserved for the priority shard.
// This shard is used for the liveness and meta ranges, so it will see little
// actual work, but we assign 2 to avoid a blocked range affecting the others.
const priorityWorkers = 2
