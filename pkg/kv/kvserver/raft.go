...
// extractSingleID extracts the command ID from the entry, if possible. The two
// returned bools are whether the id is valid, and the whether the entry is
// traced.
func extractSingleID(e raftpb.Entry) (kvserverbase.CmdIDKey, bool, bool) {
