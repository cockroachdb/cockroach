...
// GetLocalityProximity returns the locality comparison type between this replica and its peers.
// The comparison type indicates the relative locality distance between replicas, with the
// following hierarchy (most distant to closest):
