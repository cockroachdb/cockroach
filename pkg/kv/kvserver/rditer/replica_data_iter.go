...
// creates a different iterator for each replicated key range. This is to
// because MVCCIterator only allows changing the upper-bound of an existing
// iterator, and not both upper and lower bound.
