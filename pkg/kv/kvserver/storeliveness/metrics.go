...
var (
	metaSendQueueSize = metric.InitMetadata(metric.Metadata{
	...
	metaSendQueueBytes = metric.InitMetadata(metric.Metadata{
	...
	metaSendQueueIdle = metric.InitMetadata(metric.Metadata{
	...
	metaMessagesSendDropped = metric.InitMetadata(metric.Metadata{
	...
	metaMessagesReceiveDropped = metric.InitMetadata(metric.Metadata{
	...
	metaMessageHandleSuccesses = metric.InitMetadata(metric.Metadata{
	...
	metaMessageHandleFailures = metric.InitMetadata(metric.Metadata{
	...
	metaSupportWithdrawSuccesses = metric.InitMetadata(metric.Metadata{
	...
	metaSupportWithdrawFailures = metric.InitMetadata(metric.Metadata{
	...
	metaSupportFromStores = metric.InitMetadata(metric.Metadata{
	...
	metaSupportForStores = metric.InitMetadata(metric.Metadata{
	...
	metaReceiveQueueSize = metric.InitMetadata(metric.Metadata{
	...
	metaReceiveQueueBytes = metric.InitMetadata(metric.Metadata{
	...
	metaBatchesReceived = metric.InitMetadata(metric.Metadata{
		Name:        "storeliveness.transport.batches-received",
		Help:        "Number of message batches received by the Store Liveness Transport",
		Measurement: "Batches",
		Unit:        metric.Unit_COUNT,
	})
	metaHeartbeatPersistDuration = metric.InitMetadata(metric.Metadata{
	...
	metaMessageHandlePersistDuration = metric.InitMetadata(metric.Metadata{
	...
	metaSupportWithdrawPersistDuration = metric.InitMetadata(metric.Metadata{
