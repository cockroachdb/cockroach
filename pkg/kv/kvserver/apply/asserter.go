...
//     index across all replica (i.e. no double-applies or replays).
//
...
func (r *rangeAsserter) apply(
	...
	// INVARIANT: the replica must apply all commands, sequentially.
...
func (r *rangeAsserter) applySnapshot(
	...
	// INVARIANT: a snapshot must not regress the replica's applied index.
