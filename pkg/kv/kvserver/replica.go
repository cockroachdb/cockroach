...
// requests.
func (r *Replica) MeasureReqCPUNanos() func() {
	return r.measureNanosRunning(func(dur float64) {
...
// raft work.
func (r *Replica) MeasureRaftCPUNanos() func() {
	return r.measureNanosRunning(func(dur float64) {
...
func (r *Replica) measureNanosRunning(f func(float64)) func() {
	start := grunning.Time()
	return func() {
		end := grunning.Time()
