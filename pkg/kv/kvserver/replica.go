...
func (r *Replica) getTruncatedStateLocked() roachpb.RaftTruncatedState {
...
func (r *Replica) setTruncationDeltaAndTrustedLocked(deltaBytes int64, isDeltaTrusted bool) {
...
func (r *Replica) setTruncatedStateAndSideEffects(
	...
	_, expectedFirstIndexAccurate := r.handleTruncatedStateResult(
