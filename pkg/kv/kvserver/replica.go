...
func (r *Replica) maybeEnqueueProblemRange(
	...
	log.KvDistribution.Infof(ctx, "Decommissioning nudger enqueuing replica %s with priority %d", r.Desc(), allocatorimpl.AllocatorReplaceDecommissioningVoter.Priority())
