...
// HasExternalBytes returns the number of external bytes in ther
// underlying store. External bytes are bytes in a
// pebble.ExternalFile. Such files can be added by AddSSTable.
