...
type Replica struct {
	...
	// kv.closed_timestamp.policy_refresh_interval by PolicyRefresher. It is
	// used in closedTimestampPolicyRLocked.
...
func (r *Replica) closedTimestampPolicyRLocked() ctpb.RangeClosedTimestampPolicy {
	// TODO(#143648): try to remove the need for this key comparison under RLock.
