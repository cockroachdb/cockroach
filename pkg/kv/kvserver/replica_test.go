...
// TestValidateIsStateEngineSpan verifies that the function
// validateIsStateEngineSpan correctly detects spans that accesses non state
// engine keys.
...
// TestValidateIsRaftEngineSpan verifies that the function
// validateIsRaftEngineSpan() correctly checks for overlaps with non state
// engine keys.
