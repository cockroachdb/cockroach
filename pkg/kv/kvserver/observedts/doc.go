...
// timestamp of any other transaction that committed causally before the
// new transaction.
var _ = roachpb.Transaction{}.MaxTimestamp
...
var _ = roachpb.ReadWithinUncertaintyIntervalError{}
...
// that node.
var _ = (&roachpb.Transaction{}).ObservedTimestamps
