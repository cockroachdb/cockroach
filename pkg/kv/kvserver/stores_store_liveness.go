...
func (sfsl *StoresForStoreLiveness) InspectAllSupportFrom() ([]slpb.InspectSupportFromStatesPerStore, error) {
	stores := (*Stores)(sfsl)
...
func (sfsl *StoresForStoreLiveness) InspectAllSupportFor() ([]slpb.InspectSupportForStatesPerStore, error) {
	stores := (*Stores)(sfsl)
