...
func setupCircuitBreakerReplicaBench(
	...
	var sFn func() kvserver.CancelStorage
	switch cs {
	case "mutexmap":
		sFn = func() kvserver.CancelStorage { return &kvserver.MapCancelStorage{} }
	case "syncmap":
		sFn = func() kvserver.CancelStorage { return &kvserver.SyncMapCancelStorage{} }
	default:
