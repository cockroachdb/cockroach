...
// source: kv/kvserver/storagepb/state.proto
...
func (*ReplicaState) Descriptor() ([]byte, []int) {
	return fileDescriptor_state_35e438a62df2e3db, []int{0}
}
...
func (*RangeInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_state_35e438a62df2e3db, []int{1}
}
...
func (*RangeInfo_CTEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_state_35e438a62df2e3db, []int{1, 0}
}
...
func (*LatchManagerInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_state_35e438a62df2e3db, []int{2}
}
...
func init() {
	proto.RegisterFile("kv/kvserver/storagepb/state.proto", fileDescriptor_state_35e438a62df2e3db)
}

var fileDescriptor_state_35e438a62df2e3db = []byte{
	...
	,
}
