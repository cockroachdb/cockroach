...
func TestDB_GetForUpdate(t *testing.T) {
	...
	testutils.RunTrueAndFalse(t, "durability-guaranteed", func(t *testing.T, durabilityGuaranteed bool) {
		...
		if durabilityGuaranteed {
			result, err = db.GetForUpdate(context.Background(), "aa", kvpb.GuaranteedDurability)
		} else {
			result, err = db.GetForUpdate(context.Background(), "aa", kvpb.BestEffort)
		}
		if err != nil {
			t.Fatal(err)
		}
...
func TestDB_GetForShare(t *testing.T) {
	...
	testutils.RunTrueAndFalse(t, "durability-guaranteed", func(t *testing.T, durabilityGuaranteed bool) {
		...
		var err error
		if durabilityGuaranteed {
			result, err = db.GetForShare(context.Background(), "aa", kvpb.GuaranteedDurability)
		} else {
			result, err = db.GetForShare(context.Background(), "aa", kvpb.BestEffort)
		}
		if err != nil {
			t.Fatal(err)
		}
