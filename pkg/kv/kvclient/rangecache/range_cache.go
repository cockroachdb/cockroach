...
// entry is older than a certain duration and if so, evict it. To prevent
// eagerly evicting entries that are recently known to be healthy, we update
// their age when a request is successfully sent. This function implements the
// latter part of the functionality.
