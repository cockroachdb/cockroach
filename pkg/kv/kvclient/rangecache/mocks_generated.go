...
func (m *MockRangeDescriptorDB) RangeLookup(ctx context.Context, key roachpb.RKey, useReverseScan bool) ([]roachpb.RangeDescriptor, []roachpb.RangeDescriptor, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RangeLookup", ctx, key, useReverseScan)
	ret0, _ := ret[0].([]roachpb.RangeDescriptor)
...
func (mr *MockRangeDescriptorDBMockRecorder) RangeLookup(ctx, key, useReverseScan interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RangeLookup", reflect.TypeOf((*MockRangeDescriptorDB)(nil).RangeLookup), ctx, key, useReverseScan)
}
