...
const (
	// The default scaling factor for the number of streams per vCPU.  The value
	// for this setting is chosen arbitrarily as 1/4th of the default value for
	// the DefaultSenderStreamsPerVCPU.
