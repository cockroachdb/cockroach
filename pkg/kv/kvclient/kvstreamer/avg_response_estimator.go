...
func (e *avgResponseEstimator) getAvgResponseSize() int64 {
	if e.actual.totalNumResponses == 0 {
	...
	return e.actual.totalSize / e.actual.totalNumResponses
}
...
func (e *avgResponseEstimator) update(actualResponsesSize int64, numResponses int64) {
	e.actual.totalSize += actualResponsesSize
	e.actual.totalNumResponses += numResponses
}
