...
var pipelinedWritesEnabled = settings.TenantWritable.RegisterBoolSetting(
	"kv.transaction.write_pipelining_enabled",
	"if enabled, transactional writes are pipelined through Raft consensus",
	true,
)
var pipelinedWritesMaxBatchSize = settings.TenantWritable.RegisterIntSetting(
...
var trackedWritesMaxSize = settings.TenantWritable.RegisterIntSetting(
...
// kv.transaction.max_intents_bytes.
var rejectTxnOverTrackedWritesBudget = settings.TenantWritable.RegisterBoolSetting(
