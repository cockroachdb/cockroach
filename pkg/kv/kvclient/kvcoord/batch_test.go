...
func TestBatchPrevNext(t *testing.T) {
	...
	for _, test := range testCases {
		t.Run("", func(t *testing.T) {
			...
			require.NoError(t, ascHelper.Init(
				Ascending, ba.Requests, mustPreserveOrder, canReorderRequestsSlice,
			))
			require.NoError(t, descHelper.Init(
				Descending, ba.Requests, mustPreserveOrder, canReorderRequestsSlice,
			))
