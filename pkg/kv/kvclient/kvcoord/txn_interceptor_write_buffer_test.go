...
func BenchmarkTxnWriteBuffer(b *testing.B) {
	...
	// Map from kvSize to a slice of keys where ith element corresponds to the
	// key with 'i' parameter. The function assumes that for a given kvSize
	// it'll be called with increasing values of 'i'.
