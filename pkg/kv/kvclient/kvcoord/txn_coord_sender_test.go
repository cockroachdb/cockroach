...
func checkTxnMetrics(
	...
	testutils.SucceedsSoon(t, func() error {
		return checkTxnMetricsOnce(metrics, name, commits, commits1PC, commitReadOnly, aborts, restarts)
	})
}
...
func TestTxnCommit(t *testing.T) {
	...
	checkTxnMetrics(t, metrics, "commit txn", 2 /* commits */, 0 /* commits1PC */, 1, 0, 0)
}
