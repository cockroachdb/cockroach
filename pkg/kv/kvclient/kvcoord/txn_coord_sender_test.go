		...
		},
		{
			...
			run: func(
				...
				}()
				{
					...
					pErr := kvpb.NewError(kvpb.NewRefreshFailedError(
...
// TestTxnTypeCompatibleWithBatchRequest tests if a transaction and a batch
