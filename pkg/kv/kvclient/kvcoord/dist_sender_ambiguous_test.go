...
// prior to sending the request and after receiving the response from the
// underlying transport. If either function returns an non-nil override
// response, that response will be returned to the caller immediately
// (e.g. if returned from beforeSend, the request will not be sent).
