...
// isExclusivelyWriteLocked returns true if we know we hold a lock of sufficient
// strength to exclude other writers.
func (bw *bufferedWrite) isExclusivelyWriteLocked() bool {
	if bw.lki == nil {
		return false
	}
	return bw.lki.heldGE(lock.Shared)
}
