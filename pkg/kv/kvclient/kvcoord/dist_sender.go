...
func (ds *DistSender) sendToReplicas(
	...
	for first := true; ; first = false {
		...
		// disable the ability for the server to forward the read timestamp. This
		// protects against moving the timestamp when we are retrying a successful
		// write operation (after an ambiguous error) for which the intent has
