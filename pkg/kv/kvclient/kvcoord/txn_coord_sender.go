...
func (tc *TxnCoordSender) SetOmitInRangefeeds(omitInRangefeeds bool) {
	tc.mu.Lock()
	defer tc.mu.Unlock()

	if tc.mu.txn.OmitInRangefeeds == omitInRangefeeds {
		return
	}
	...
	tc.mu.txn.OmitInRangefeeds = omitInRangefeeds
}
