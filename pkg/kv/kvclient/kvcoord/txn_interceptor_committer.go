...
func (*txnCommitter) createSavepointLocked(context.Context, *savepoint) error { return nil }
...
func (*txnCommitter) rollbackToSavepointLocked(context.Context, savepoint) error { return nil }
