...
func (ds *DistSender) RangeFeedSpans(
	...
	if cfg.disableMuxRangeFeed {
		return legacyRangeFeed(ctx, cfg, spans, ds, rr, eventCh)
	}
	return muxRangeFeed(ctx, cfg, spans, ds, rr, eventCh)
}
...
func (r *rangeFeedRegistry) newActiveRangeFeed(
	span roachpb.Span,
	startAfter hlc.Timestamp,
	metrics *DistSenderRangeFeedMetrics,
) *activeRangeFeed {
