...
// Tests that the range feed handles transport error appropriately; in
// particular, that when encountering decommissioned nodes it will refresh its
// range descriptor and retry, but if this node is decommissioned it will bail
// out. Regression test for:
