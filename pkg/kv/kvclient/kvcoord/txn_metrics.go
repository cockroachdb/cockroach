...
type TxnMetrics struct {
	...
	TxnsRejectedByLockCountLimit        *metric.Counter
...
var (
	...
	metaTxnsRejectedByLockCountLimit = metric.Metadata{
...
func MakeTxnMetrics(histogramWindow time.Duration) TxnMetrics {
	return TxnMetrics{
		...
		TxnsRejectedByLockCountLimit:        metric.NewCounter(metaTxnsRejectedByLockCountLimit),
