...
func TestImmutableBatchArgs(t *testing.T) {
	...
	txn := roachpb.MakeTransaction("test", nil, isolation.Serializable, roachpb.NormalUserPriority, clock.Now(), clock.MaxOffset().Nanoseconds(), int32(ds.nodeIDGetter()), 0, false)
...
func TestMultiRangeGapReverse(t *testing.T) {
	...
	txn := roachpb.MakeTransaction("foo", nil, isolation.Serializable, 1.0, clock.Now(), 0, 1, 0, false)
...
func TestParallelCommitsDetectIntentMissingCause(t *testing.T) {
	...
	key := roachpb.Key("a")
	txn := roachpb.MakeTransaction("test", key, isolation.Serializable, roachpb.NormalUserPriority, clock.Now(), clock.MaxOffset().Nanoseconds(), 1, 0, false)
...
func TestMultipleErrorsMerged(t *testing.T) {
	...
	txn := roachpb.MakeTransaction("test", nil, isolation.Serializable, roachpb.NormalUserPriority, clock.Now(), clock.MaxOffset().Nanoseconds(), 1, 0, false)
