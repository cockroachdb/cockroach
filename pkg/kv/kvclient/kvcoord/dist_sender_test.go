...
func TestDistSenderBatchMetrics(t *testing.T) {
	...
	metricsNames := []string{
		...
		"distsender.batch_requests.cross_region",
		"distsender.batch_responses.cross_region",
		"distsender.batch_requests.cross_zone",
		"distsender.batch_responses.cross_zone"}
	...
	for _, tc := range []struct {
		...
		t.Run("SameRegionSameZone", func(t *testing.T) {
			...
			crossRegionRequest := metrics["distsender.batch_requests.cross_region"]
			crossRegionResponse := metrics["distsender.batch_responses.cross_region"]
			crossZoneRequest := metrics["distsender.batch_requests.cross_zone"]
			crossZoneResponse := metrics["distsender.batch_responses.cross_zone"]
