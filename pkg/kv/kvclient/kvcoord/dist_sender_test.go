...
func TestMultipleErrorsMerged(t *testing.T) {
	...
	// to the merged error.
	writeTimestamp1 := txn.WriteTimestamp.Add(100, 0)
	writeTimestamp2 := txn.WriteTimestamp.Add(200, 0)
	...
	for i, tc := range testCases {
		t.Run(strconv.Itoa(i), func(t *testing.T) {
			...
			testutils.RunTrueAndFalse(t, "reverse", func(t *testing.T, reverse bool) {
				...
				if tc.err1 != nil {
					expWriteTimestamp = writeTimestamp1
				}
				if tc.err2 != nil {
					expWriteTimestamp = writeTimestamp2
				}
