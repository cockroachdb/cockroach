...
// OnMetadata is called when a RangefeedMetadat event is passed to the eventCh.
...
// WithOnMetadata sets up a callback that's involked when a partial rangefeed is
// spawned.
