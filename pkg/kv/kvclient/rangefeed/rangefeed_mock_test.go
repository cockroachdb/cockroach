...
func (m *mockClient) Scan(
	...
	return m.scan(ctx, spans, asOf, rowFn, parallelism)
}
	...
	t.Run("scan retries", func(t *testing.T) {
		...
		mc := mockClient{
			scan: func(ctx context.Context, spans []roachpb.Span, asOf hlc.Timestamp,
				rowFn func(value roachpb.KeyValue), parallelism func() int) error {
	...
	t.Run("changefeed retries", func(t *testing.T) {
		...
		mc := mockClient{
			scan: func(
				...
				rowFn func(value roachpb.KeyValue), parallelism func() int,
			) error {
