	...
	args := base.TestClusterArgs{
		...
		ServerArgsPerNode: func() map[int]base.TestServerArgs {
			...
			for i := 0; i < cfg.numNodes; i++ {
				...
				//
				// We need to stay away within 80% of the max offset, so we our offset
				// to 70% of configured MaxOffset. Since MaxOffset is relatively small,
				// this doesn't give us much wiggle room.
				//
