...
func TestValidate(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			kvs: kvs(kv(`a`, 1, `v1`)),
			expected: []string{
				`committed deleteRange missing write: [dr]"a":missing-><nil>`,
			},
		},
		{
		...
		},
		{
			...
			kvs: kvs(kv(`a`, 1, `v1`)),
			expected: []string{
				`committed txn missing write: [dr]"a":missing-><nil>`,
			},
		},
		{
		...
		},
		{
			...
			expected: []string{
				`committed txn missing write: ` +
					`[dr]"a":0.000000004,0-><nil> [dr]"b":missing-><nil>`,
			},
		},
		{
			...
			expected: []string{
				`committed txn missing write: [dr]"a":0.000000004,0-><nil> [dr]"b":missing-><nil>`,
		...
		},
		{
			...
			expected: []string{
				`committed txn non-atomic timestamps: ` +
					`[dr]"a":0.000000002,0-><nil> [w]"b":0.000000003,0->v2`,
			},
		},
		{
		...
		},
		{
			...
			expected: []string{
				`committed txn missing write: ` +
					`[w]"b":missing->v2 [dr]"a":0.000000002,0-><nil> [dr]"b":missing-><nil>`,
			},
		},
		{
			...
			expected: []string{
				`key "d" outside delete range bounds {a-c}: ` +
					`[dr]"a":0.000000003,0-><nil> [dr]"d":missing-><nil>`,
			},
		},
		{
			...
			expected: []string{
				`key "d" outside delete range bounds {a-c}: ` +
					`[dr]"a":0.000000003,0-><nil> [dr]"d":0.000000003,0-><nil>`,
			},
		},
	}
