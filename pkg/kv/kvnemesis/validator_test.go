...
func TestValidate(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			expected: []string{
				`committed scan non-atomic timestamps: ` +
					`[s]{a-c}:[0.000000002,0,0,0)->["a":v1, "a2":v3, "b":v2]`,
			},
		},
		{
			...
			expected: []string{
				`committed scan non-atomic timestamps: ` +
					`[s]{a-c}:[0.000000002,0,0.000000001,0)->["b":v2]`,
			},
		},
		{
			...
			expected: []string{
				`scan result not ordered correctly: ` +
					`[s]{a-c}:[0.000000002,0,<max>)->["b":v2, "a":v1]`,
			},
		},
		{
			...
			expected: []string{
				`key "c" outside scan bounds: ` +
					`[s]{a-c}:[0.000000001,0,0,0)->["a":v1, "c":v3]`,
			},
		},
		{
		...
		},
		{
			...
			expected: []string{
				`committed batch non-atomic timestamps: ` +
					`[s]{a-c}:[<min>,0.000000001,0)->[] [s]{b-d}:[<min>,0,0)->["b":v1] [s]{c-e}:[<min>,0,0)->["c":v2]`,
			},
		},
		{
			...
			expected: []string{
				`committed batch non-atomic timestamps: ` +
					`[s]{a-c}:[<min>,0,0)->["b":v1] [s]{b-d}:[<min>,0,0)->["b":v1] [s]{c-e}:[<min>,<max>)->[]`,
			},
		},
		{
		...
		},
		{
			...
			expected: []string{
				`committed txn non-atomic timestamps: ` +
					`[s]{a-c}:[0.000000002,0,0.000000002,0)->["a":v1, "b":v3] [s]{b-d}:[0.000000002,0,0.000000003,0)->["b":v3]`,
			},
		},
		{
		...
		},
		{
			...
			expected: []string{
				`committed txn non-atomic timestamps: ` +
					`[s]{a-c}:[0.000000001,0,0.000000001,0)->["a":v1] [s]{b-d}:[<min>,0.000000001,0)->[]`,
			},
		},
		{
		...
		},
		{
			...
			expected: []string{
				`committed txn non-atomic timestamps: ` +
					`[s]{a-c}:[0.000000001,0,0.000000002,0)->["a":v1] [w]"b":0.000000002,0->v3`,
			},
		},
		{
		...
		},
		{
			...
			expected: []string{
				`committed txn non-atomic timestamps: ` +
					`[s]{a-c}:[<min>,0,0)->["a":v1] [w]"a":0.000000001,0->v1 [s]{a-c}:[0.000000001,0,<max>)->["a":v1]`,
			},
		},
		{
			...
			expected: []string{
				`committed txn non-atomic timestamps: ` +
					`[s]{a-c}:[<min>,<max>)->[] [w]"a":0.000000001,0->v1 [s]{a-c}:[<min>,0.000000001,0)->[]`,
			},
		},
		{
