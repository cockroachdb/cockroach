...
func NewTxnWithAdmissionControl(
	...
	kvTxn := roachpb.MakeTransaction("unnamed", nil /* baseKey */, isolation.Serializable, roachpb.NormalUserPriority, now.ToTimestamp(), db.clock.MaxOffset().Nanoseconds(), int32(db.ctx.NodeID.SQLInstanceID()), priority, false)
