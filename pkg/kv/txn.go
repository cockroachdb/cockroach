...
// originating within KV and that is at the root of the tree of requests. Do not
// use this for executing transactions originating in SQL. This distinction only
// causes this transaction to undergo admission control. See
// AdmissionHeader_Source for more details.
