...
func (l *legacyTransportAdapter) SendNextTimeout(defaultTimeout time.Duration) (time.Duration, bool) {
	if l.IsExhausted() {
		return 0, false
	}
...
func (t *slowLeaseHolderTransport) SendNextTimeout(defaultTimeout time.Duration) (time.Duration, bool) {
	if t.IsExhausted() {
		return 0, false
	}
	return defaultTimeout, true
