...
func NewManager(store Store, rng *roachpb.RangeDescriptor) Manager {
	...
	m := new(managerImpl)
	*m = managerImpl{
		// TODO(nvanbenschoten): move pkg/kv/storage/spanlatch to a new
		// pkg/kv/storage/concurrency/latch package. Make it implement the
		...
		// TODO(nvanbenschoten): move pkg/kv/storage/txnwait to a new
		// pkg/kv/storage/concurrency/txnwait package.
