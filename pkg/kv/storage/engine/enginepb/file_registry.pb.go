...
func (RegistryVersion) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_file_registry_9f6fa44a881cfc33, []int{0}
}
...
func (EnvType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_file_registry_9f6fa44a881cfc33, []int{1}
}
...
type FileRegistry struct {
	...
	Version RegistryVersion `protobuf:"varint,1,opt,name=version,proto3,enum=cockroach.kv.storage.engine.enginepb.RegistryVersion" json:"version,omitempty"`
...
type FileEntry struct {
	...
	EnvType EnvType `protobuf:"varint,1,opt,name=env_type,json=envType,proto3,enum=cockroach.kv.storage.engine.enginepb.EnvType" json:"env_type,omitempty"`
...
func init() {
	proto.RegisterType((*FileRegistry)(nil), "cockroach.kv.storage.engine.enginepb.FileRegistry")
	proto.RegisterMapType((map[string]*FileEntry)(nil), "cockroach.kv.storage.engine.enginepb.FileRegistry.FilesEntry")
	proto.RegisterType((*FileEntry)(nil), "cockroach.kv.storage.engine.enginepb.FileEntry")
	proto.RegisterEnum("cockroach.kv.storage.engine.enginepb.RegistryVersion", RegistryVersion_name, RegistryVersion_value)
	proto.RegisterEnum("cockroach.kv.storage.engine.enginepb.EnvType", EnvType_name, EnvType_value)
}
...
func init() {
	proto.RegisterFile("kv/storage/engine/enginepb/file_registry.proto", fileDescriptor_file_registry_9f6fa44a881cfc33)
}

var fileDescriptor_file_registry_9f6fa44a881cfc33 = []byte{
	// 381 bytes of a gzipped FileDescriptorProto
	,
}
