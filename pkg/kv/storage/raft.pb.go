...
func (SnapshotRequest_Priority) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_raft_3f516773f38e6de2, []int{5, 0}
}
...
func (SnapshotRequest_Strategy) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_raft_3f516773f38e6de2, []int{5, 1}
}
...
func (SnapshotRequest_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_raft_3f516773f38e6de2, []int{5, 2}
}
...
func (SnapshotResponse_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_raft_3f516773f38e6de2, []int{6, 0}
}
...
func (*RaftHeartbeat) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_3f516773f38e6de2, []int{0}
}
...
func (*RaftMessageRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_3f516773f38e6de2, []int{1}
}
...
func (*RaftMessageRequestBatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_3f516773f38e6de2, []int{2}
}
...
func (*RaftMessageResponseUnion) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_3f516773f38e6de2, []int{3}
}
...
func (*RaftMessageResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_3f516773f38e6de2, []int{4}
}
...
func (*SnapshotRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_3f516773f38e6de2, []int{5}
}
...
type SnapshotRequest_Header struct {
	...
	Priority SnapshotRequest_Priority `protobuf:"varint,6,opt,name=priority,enum=cockroach.kv.storage.SnapshotRequest_Priority" json:"priority"`
	// The strategy of the snapshot.
	Strategy SnapshotRequest_Strategy `protobuf:"varint,7,opt,name=strategy,enum=cockroach.kv.storage.SnapshotRequest_Strategy" json:"strategy"`
	// The type of the snapshot.
	Type SnapshotRequest_Type `protobuf:"varint,9,opt,name=type,enum=cockroach.kv.storage.SnapshotRequest_Type" json:"type"`
...
type SnapshotResponse struct {
	Status  SnapshotResponse_Status `protobuf:"varint,1,opt,name=status,enum=cockroach.kv.storage.SnapshotResponse_Status" json:"status"`
...
func (*SnapshotResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_3f516773f38e6de2, []int{6}
}
...
func (*ConfChangeContext) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_3f516773f38e6de2, []int{7}
}
...
func init() {
	proto.RegisterType((*RaftHeartbeat)(nil), "cockroach.kv.storage.RaftHeartbeat")
	proto.RegisterType((*RaftMessageRequest)(nil), "cockroach.kv.storage.RaftMessageRequest")
	proto.RegisterType((*RaftMessageRequestBatch)(nil), "cockroach.kv.storage.RaftMessageRequestBatch")
	proto.RegisterType((*RaftMessageResponseUnion)(nil), "cockroach.kv.storage.RaftMessageResponseUnion")
	proto.RegisterType((*RaftMessageResponse)(nil), "cockroach.kv.storage.RaftMessageResponse")
	proto.RegisterType((*SnapshotRequest)(nil), "cockroach.kv.storage.SnapshotRequest")
	proto.RegisterType((*SnapshotRequest_Header)(nil), "cockroach.kv.storage.SnapshotRequest.Header")
	proto.RegisterType((*SnapshotResponse)(nil), "cockroach.kv.storage.SnapshotResponse")
	proto.RegisterType((*ConfChangeContext)(nil), "cockroach.kv.storage.ConfChangeContext")
	proto.RegisterEnum("cockroach.kv.storage.SnapshotRequest_Priority", SnapshotRequest_Priority_name, SnapshotRequest_Priority_value)
	proto.RegisterEnum("cockroach.kv.storage.SnapshotRequest_Strategy", SnapshotRequest_Strategy_name, SnapshotRequest_Strategy_value)
	proto.RegisterEnum("cockroach.kv.storage.SnapshotRequest_Type", SnapshotRequest_Type_name, SnapshotRequest_Type_value)
	proto.RegisterEnum("cockroach.kv.storage.SnapshotResponse_Status", SnapshotResponse_Status_name, SnapshotResponse_Status_value)
}
...
func (c *multiRaftClient) RaftMessageBatch(ctx context.Context, opts ...grpc.CallOption) (MultiRaft_RaftMessageBatchClient, error) {
	stream, err := c.cc.NewStream(ctx, &_MultiRaft_serviceDesc.Streams[0], "/cockroach.kv.storage.MultiRaft/RaftMessageBatch", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *multiRaftClient) RaftSnapshot(ctx context.Context, opts ...grpc.CallOption) (MultiRaft_RaftSnapshotClient, error) {
	stream, err := c.cc.NewStream(ctx, &_MultiRaft_serviceDesc.Streams[1], "/cockroach.kv.storage.MultiRaft/RaftSnapshot", opts...)
	if err != nil {
		return nil, err
	}
...
var _MultiRaft_serviceDesc = grpc.ServiceDesc{
	ServiceName: "cockroach.kv.storage.MultiRaft",
	...
	Metadata: "kv/storage/raft.proto",
}
...
func init() { proto.RegisterFile("kv/storage/raft.proto", fileDescriptor_raft_3f516773f38e6de2) }

var fileDescriptor_raft_3f516773f38e6de2 = []byte{
	...
	,
}
