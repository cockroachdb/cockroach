...
// source: kv/storage/storagepb/state.proto
...
import fmt "fmt"
import math "math"
import enginepb "github.com/cockroachdb/cockroach/pkg/kv/storage/engine/enginepb"
...
func (*ReplicaState) Descriptor() ([]byte, []int) {
	return fileDescriptor_state_532640d3266f7add, []int{0}
}
...
type RangeInfo struct {
	...
	// raft_log_size may be inaccurate, see kv.storage.Replica.mu.raftLogSizeTrusted.
...
func (*RangeInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_state_532640d3266f7add, []int{1}
}
...
func (*RangeInfo_CTEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_state_532640d3266f7add, []int{1, 0}
}
...
func (*LatchManagerInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_state_532640d3266f7add, []int{2}
}
...
func init() {
	proto.RegisterType((*ReplicaState)(nil), "cockroach.kv.storage.storagepb.ReplicaState")
	proto.RegisterType((*RangeInfo)(nil), "cockroach.kv.storage.storagepb.RangeInfo")
	proto.RegisterType((*RangeInfo_CTEntry)(nil), "cockroach.kv.storage.storagepb.RangeInfo.CTEntry")
	proto.RegisterType((*LatchManagerInfo)(nil), "cockroach.kv.storage.storagepb.LatchManagerInfo")
}
...
func init() {
	proto.RegisterFile("kv/storage/storagepb/state.proto", fileDescriptor_state_532640d3266f7add)
}

var fileDescriptor_state_532640d3266f7add = []byte{
	// 996 bytes of a gzipped FileDescriptorProto
	,
}
