...
// source: kv/storage/closedts/ctpb/entry.proto
...
func (*Entry) Descriptor() ([]byte, []int) {
	return fileDescriptor_entry_c789d232c3842cdf, []int{0}
}
...
func (*Reaction) Descriptor() ([]byte, []int) {
	return fileDescriptor_entry_c789d232c3842cdf, []int{1}
}
...
func init() {
	proto.RegisterType((*Entry)(nil), "cockroach.kv.storage.ctupdate.Entry")
	proto.RegisterMapType((map[github_com_cockroachdb_cockroach_pkg_roachpb.RangeID]LAI)(nil), "cockroach.kv.storage.ctupdate.Entry.MlaiEntry")
	proto.RegisterType((*Reaction)(nil), "cockroach.kv.storage.ctupdate.Reaction")
}
...
func (c *closedTimestampClient) Get(ctx context.Context, opts ...grpc.CallOption) (ClosedTimestamp_GetClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ClosedTimestamp_serviceDesc.Streams[0], "/cockroach.kv.storage.ctupdate.ClosedTimestamp/Get", opts...)
	if err != nil {
		return nil, err
	}
...
var _ClosedTimestamp_serviceDesc = grpc.ServiceDesc{
	ServiceName: "cockroach.kv.storage.ctupdate.ClosedTimestamp",
	...
	Metadata: "kv/storage/closedts/ctpb/entry.proto",
}
...
func init() {
	proto.RegisterFile("kv/storage/closedts/ctpb/entry.proto", fileDescriptor_entry_c789d232c3842cdf)
}

var fileDescriptor_entry_c789d232c3842cdf = []byte{
	// 470 bytes of a gzipped FileDescriptorProto
	,
}
