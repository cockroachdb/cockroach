...
var (
	...
	metaDistSenderTotals = metric.Metadata{Name: "distsender.totals"}
	// metaDistSenderLocals identify the total local rpc sends of DistSender.
	metaDistSenderLocals = metric.Metadata{Name: "distsender.locals"}
	// metaDistSenderRetries identify the total retry times DistSender.
	metaDistSenderRetries = metric.Metadata{Name: "distsender.retries"}
	// metaDistSenderNotLeaseHolderErrs identify total NotLeaseHolderErrs of DistSender.
	metaDistSenderNotLeaseHolderErrs = metric.Metadata{Name: "distsender.notLeaseHolderErrs"}
)
