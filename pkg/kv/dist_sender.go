...
//
// With parallel sending, the first write in a transaction may not
// arrive before writes to other ranges. This is relevant in the case
// of a BeginTransaction request. Intents written to other ranges
// before the transaction record is created will cause the transaction
// to abort early.
