...
func (ds *DistSender) handlePerReplicaError(
	...
	case *roachpb.NotLeaseHolderError:
		if tErr.LeaseHolder != nil {
			...
			if err := transport.MoveToFront(leaseHolder); err != nil {
				log.Warningf(ds.Ctx, "unable to move leaseholder %+v to front of transport", leaseHolder)
			}
		}
		return true
	}
