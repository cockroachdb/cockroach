...
func NewDistSender(cfg DistSenderConfig, g *gossip.Gossip) *DistSender {
	...
	if ds.settings == nil {
		ds.settings = cluster.MakeTestingClusterSettings()
	}
	...
	ds.rangeCache = NewRangeDescriptorCache(rdb, ds.settings.RangeDescriptorCacheSize.Get)
	ds.leaseHolderCache = NewLeaseHolderCache(ds.settings.RangeDescriptorCacheSize.Get)
