...
func (CopysetStrategy) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_copysets_a2126159ebe54c32, []int{0}
}
...
func (*Copysets) Descriptor() ([]byte, []int) {
	return fileDescriptor_copysets_a2126159ebe54c32, []int{1}
}
...
func (*Copyset) Descriptor() ([]byte, []int) {
	return fileDescriptor_copysets_a2126159ebe54c32, []int{2}
}
...
func init() {
	proto.RegisterFile("storage/copysets/copysets.proto", fileDescriptor_copysets_a2126159ebe54c32)
}

var fileDescriptor_copysets_a2126159ebe54c32 = []byte{
	// 471 bytes of a gzipped FileDescriptorProto
	,
}
