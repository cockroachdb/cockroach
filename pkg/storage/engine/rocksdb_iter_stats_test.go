...
// Only time bounded iterators return an SST count.
//
// TODO(tschottdorf): consider letting them all do it.
// stats := iter.Stats()
// if a, e := stats.TimeBoundedNumSSTs, 10*test.sstCount; a != e {
// 	t.Errorf("touched %d SSTs, expected %d", a, e)
// }
