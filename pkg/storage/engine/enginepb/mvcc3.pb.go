...
type MVCCStatsDelta struct {
	...
	MaxWriteTimestamp cockroach_util_hlc.Timestamp `protobuf:"bytes,15,opt,name=max_write_timestamp,json=maxWriteTimestamp" json:"max_write_timestamp"`
}
...
func (this *MVCCStatsDelta) Equal(that interface{}) bool {
	...
	if !this.MaxWriteTimestamp.Equal(&that1.MaxWriteTimestamp) {
		return false
	}
	return true
}
...
func (m *MVCCStatsDelta) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x7a
	i++
	i = encodeVarintMvcc3(dAtA, i, uint64(m.MaxWriteTimestamp.Size()))
	n3, err := m.MaxWriteTimestamp.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n3
...
func (m *MVCCPersistentStats) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintMvcc3(dAtA, i, uint64(m.MaxWriteTimestamp.Size()))
	n4, err := m.MaxWriteTimestamp.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n4
...
func (m *RangeAppliedState) MarshalTo(dAtA []byte) (int, error) {
	...
	n5, err := m.RangeStats.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n5
...
func (m *MVCCStatsDelta) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 15:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxWriteTimestamp", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.MaxWriteTimestamp.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorMvcc3 = []byte{
	...
	,
}
