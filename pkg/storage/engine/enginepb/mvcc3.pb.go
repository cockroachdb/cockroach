...
type TxnMeta struct {
	...
	IgnoredSeqNums []TxnMeta_IgnoredSeqNumRange `protobuf:"bytes,10,rep,name=ignored_seqnums,json=ignoredSeqnums,proto3" json:"ignored_seqnums"`
}

func (m *TxnMeta) Reset()      { *m = TxnMeta{} }
func (*TxnMeta) ProtoMessage() {}
func (*TxnMeta) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_103dcb9366b9e490, []int{0}
}
...
type TxnMeta_IgnoredSeqNumRange struct {
...
func (m *TxnMeta_IgnoredSeqNumRange) Reset()         { *m = TxnMeta_IgnoredSeqNumRange{} }
func (m *TxnMeta_IgnoredSeqNumRange) String() string { return proto.CompactTextString(m) }
func (*TxnMeta_IgnoredSeqNumRange) ProtoMessage()    {}
func (*TxnMeta_IgnoredSeqNumRange) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_103dcb9366b9e490, []int{0, 0}
}
func (m *TxnMeta_IgnoredSeqNumRange) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TxnMeta_IgnoredSeqNumRange) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalTo(b)
	if err != nil {
		return nil, err
...
func (dst *TxnMeta_IgnoredSeqNumRange) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TxnMeta_IgnoredSeqNumRange.Merge(dst, src)
}
func (m *TxnMeta_IgnoredSeqNumRange) XXX_Size() int {
	return m.Size()
}
func (m *TxnMeta_IgnoredSeqNumRange) XXX_DiscardUnknown() {
	xxx_messageInfo_TxnMeta_IgnoredSeqNumRange.DiscardUnknown(m)
}

var xxx_messageInfo_TxnMeta_IgnoredSeqNumRange proto.InternalMessageInfo
...
func (*MVCCStatsDelta) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_103dcb9366b9e490, []int{1}
}
...
func (*MVCCPersistentStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_103dcb9366b9e490, []int{2}
}
...
func (*RangeAppliedState) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_103dcb9366b9e490, []int{3}
}
...
func (*MVCCWriteValueOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_103dcb9366b9e490, []int{4}
}
...
func (*MVCCWriteIntentOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_103dcb9366b9e490, []int{5}
}
...
func (*MVCCUpdateIntentOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_103dcb9366b9e490, []int{6}
}
...
func (*MVCCCommitIntentOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_103dcb9366b9e490, []int{7}
}
...
func (*MVCCAbortIntentOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_103dcb9366b9e490, []int{8}
}
...
func (*MVCCAbortTxnOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_103dcb9366b9e490, []int{9}
}
...
func (*MVCCLogicalOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_103dcb9366b9e490, []int{10}
}
...
func init() {
	...
	proto.RegisterType((*TxnMeta_IgnoredSeqNumRange)(nil), "cockroach.storage.engine.enginepb.TxnMeta.IgnoredSeqNumRange")
...
func (this *TxnMeta_IgnoredSeqNumRange) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*TxnMeta_IgnoredSeqNumRange)
	if !ok {
		that2, ok := that.(TxnMeta_IgnoredSeqNumRange)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *TxnMeta) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.IgnoredSeqNums) > 0 {
		for _, msg := range m.IgnoredSeqNums {
			dAtA[i] = 0x52
			i++
			i = encodeVarintMvcc3(dAtA, i, uint64(msg.Size()))
...
func (m *TxnMeta_IgnoredSeqNumRange) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *TxnMeta_IgnoredSeqNumRange) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func NewPopulatedTxnMeta(r randyMvcc3, easy bool) *TxnMeta {
	...
	if r.Intn(10) != 0 {
		v5 := r.Intn(5)
		this.IgnoredSeqNums = make([]TxnMeta_IgnoredSeqNumRange, v5)
		for i := 0; i < v5; i++ {
			v6 := NewPopulatedTxnMeta_IgnoredSeqNumRange(r, easy)
			this.IgnoredSeqNums[i] = *v6
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedTxnMeta_IgnoredSeqNumRange(r randyMvcc3, easy bool) *TxnMeta_IgnoredSeqNumRange {
	this := &TxnMeta_IgnoredSeqNumRange{}
...
func NewPopulatedRangeAppliedState(r randyMvcc3, easy bool) *RangeAppliedState {
	...
	v7 := NewPopulatedMVCCPersistentStats(r, easy)
	this.RangeStats = *v7
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func randFieldMvcc3(dAtA []byte, r randyMvcc3, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateMvcc3(dAtA, uint64(v9))
	case 1:
		dAtA = encodeVarintPopulateMvcc3(dAtA, uint64(key))
...
func (m *TxnMeta_IgnoredSeqNumRange) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TxnMeta) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			...
			m.IgnoredSeqNums = append(m.IgnoredSeqNums, TxnMeta_IgnoredSeqNumRange{})
...
func (m *TxnMeta_IgnoredSeqNumRange) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func init() {
	proto.RegisterFile("storage/engine/enginepb/mvcc3.proto", fileDescriptor_mvcc3_103dcb9366b9e490)
}

var fileDescriptor_mvcc3_103dcb9366b9e490 = []byte{
	...
	,
}
