...
func (*TxnMeta) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_82038e39582a0602, []int{0}
}
...
func (*IgnoredSeqNumRange) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_82038e39582a0602, []int{1}
}
...
func (*MVCCStatsDelta) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_82038e39582a0602, []int{2}
}
...
func (*MVCCPersistentStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_82038e39582a0602, []int{3}
}
...
func (*RangeAppliedState) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_82038e39582a0602, []int{4}
}
...
func (*MVCCWriteValueOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_82038e39582a0602, []int{5}
}
...
func (*MVCCWriteIntentOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_82038e39582a0602, []int{6}
}
...
func (*MVCCUpdateIntentOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_82038e39582a0602, []int{7}
}
...
func (*MVCCCommitIntentOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_82038e39582a0602, []int{8}
}
...
func (*MVCCAbortIntentOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_82038e39582a0602, []int{9}
}
...
func (*MVCCAbortTxnOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_82038e39582a0602, []int{10}
}
...
func (*MVCCLogicalOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_82038e39582a0602, []int{11}
}
...
func init() {
	proto.RegisterFile("storage/engine/enginepb/mvcc3.proto", fileDescriptor_mvcc3_82038e39582a0602)
}

var fileDescriptor_mvcc3_82038e39582a0602 = []byte{
