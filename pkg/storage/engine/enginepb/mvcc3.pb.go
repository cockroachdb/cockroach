...
func (*TxnMeta) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_139bddd2b63ba132, []int{0}
}
...
func (*MVCCStatsDelta) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_139bddd2b63ba132, []int{1}
}
...
func (*MVCCPersistentStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_139bddd2b63ba132, []int{2}
}
...
func (*RangeAppliedState) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_139bddd2b63ba132, []int{3}
}
...
func (*MVCCWriteValueOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_139bddd2b63ba132, []int{4}
}
...
func (*MVCCWriteIntentOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_139bddd2b63ba132, []int{5}
}
...
func (*MVCCUpdateIntentOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_139bddd2b63ba132, []int{6}
}
...
func (*MVCCCommitIntentOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_139bddd2b63ba132, []int{7}
}
...
// intance, a committed transaction will abort any intents it decided not to
...
func (*MVCCAbortIntentOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_139bddd2b63ba132, []int{8}
}
...
func (*MVCCAbortTxnOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_139bddd2b63ba132, []int{9}
}
...
func (*MVCCLogicalOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_139bddd2b63ba132, []int{10}
}
...
func init() {
	proto.RegisterFile("storage/engine/enginepb/mvcc3.proto", fileDescriptor_mvcc3_139bddd2b63ba132)
}

var fileDescriptor_mvcc3_139bddd2b63ba132 = []byte{
