...
type Entry struct {
	...
	// the IntentHistory. IntentHistory.GetValue(seq) returns the value
...
func (*Entry) Descriptor() ([]byte, []int) { return fileDescriptorMvcc, []int{0} }

// IntentHistory stores the history of sequences and values for a given key
// to be used within a transaction. Making it possible for a transaction to be
// more idempotent
type IntentHistory struct {
	// History of intent entries of ordered by Sequence.
	// This stores all the writes on the key from this transaction.
	History []Entry `protobuf:"bytes,1,rep,name=history" json:"history"`
}

func (m *IntentHistory) Reset()                    { *m = IntentHistory{} }
func (m *IntentHistory) String() string            { return proto.CompactTextString(m) }
func (*IntentHistory) ProtoMessage()               {}
func (*IntentHistory) Descriptor() ([]byte, []int) { return fileDescriptorMvcc, []int{1} }
...
type MVCCMetadata struct {
	...
	// History stores the IntentHistory of the transaction. It stores
	// all they values the txn wrote for the key along with each values
	// corresponding Sequence. Calling History.GetLatest() must return the
	// current RawBytes for transactional writes. Calling History.GetValue(seq)
	// returns the value at a given sequence.
	// History will be empty for non-transactional requests.
	History IntentHistory `protobuf:"bytes,8,opt,name=history" json:"history"`
...
func (*MVCCMetadata) Descriptor() ([]byte, []int) { return fileDescriptorMvcc, []int{2} }
...
func (*MVCCStats) Descriptor() ([]byte, []int) { return fileDescriptorMvcc, []int{3} }

func init() {
	proto.RegisterType((*Entry)(nil), "cockroach.storage.engine.enginepb.Entry")
	proto.RegisterType((*IntentHistory)(nil), "cockroach.storage.engine.enginepb.IntentHistory")
...
func (m *IntentHistory) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *IntentHistory) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *MVCCMetadata) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x42
	i++
	i = encodeVarintMvcc(dAtA, i, uint64(m.History.Size()))
	n4, err := m.History.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n4
...
func NewPopulatedEntry(r randyMvcc, easy bool) *Entry {
	this := &Entry{}
...
func NewPopulatedIntentHistory(r randyMvcc, easy bool) *IntentHistory {
	this := &IntentHistory{}
	if r.Intn(10) != 0 {
		v2 := r.Intn(5)
		this.History = make([]Entry, v2)
		for i := 0; i < v2; i++ {
			v3 := NewPopulatedEntry(r, easy)
			this.History[i] = *v3
		}
	}
	if !easy && r.Intn(10) != 0 {
...
func NewPopulatedMVCCMetadata(r randyMvcc, easy bool) *MVCCMetadata {
	...
	v4 := cockroach_util_hlc1.NewPopulatedLegacyTimestamp(r, easy)
	this.Timestamp = *v4
	...
	v6 := NewPopulatedIntentHistory(r, easy)
	this.History = *v6
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func (m *IntentHistory) Size() (n int) {
	var l int
	_ = l
	if len(m.History) > 0 {
...
func (m *IntentHistory) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: IntentHistory: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: IntentHistory: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorMvcc = []byte{
	...
	,
}
