...
// Entry stores a value at a given key, its sequence and whether it is a deletion
...
type MVCCMetadata struct {
	...
	IntentHistory []Entry `protobuf:"bytes,8,rep,name=intent_history,json=intentHistory" json:"intent_history"`
...
func NewPopulatedMVCCMetadata(r randyMvcc, easy bool) *MVCCMetadata {
	...
	v2 := cockroach_util_hlc1.NewPopulatedLegacyTimestamp(r, easy)
	this.Timestamp = *v2
	this.Deleted = bool(bool(r.Intn(2) == 0))
	...
	if r.Intn(10) != 0 {
		v4 := r.Intn(5)
		this.IntentHistory = make([]Entry, v4)
		for i := 0; i < v4; i++ {
			v5 := NewPopulatedEntry(r, easy)
			this.IntentHistory[i] = *v5
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func (m *MVCCMetadata) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			...
			m.IntentHistory = append(m.IntentHistory, Entry{})
...
var fileDescriptorMvcc = []byte{
	...
	,
}
