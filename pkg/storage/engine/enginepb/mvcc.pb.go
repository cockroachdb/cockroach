...
type MVCCStats struct {
	...
	// max_write_timestamp is the timestamp of the most recent write
	// on this key. When a txn commits, the timestamp is updated here.
...
func (m *MVCCStats) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x7a
	i++
	i = encodeVarintMvcc(dAtA, i, uint64(m.MaxWriteTimestamp.Size()))
...
var fileDescriptorMvcc = []byte{
	...
	,
}
