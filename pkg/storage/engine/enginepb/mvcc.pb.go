...
func (*LegacyTimestamp) Descriptor() ([]byte, []int) { return fileDescriptorMvcc, []int{1} }
...
type MVCCMetadata struct {
	...
	Timestamp LegacyTimestamp `protobuf:"bytes,2,opt,name=timestamp" json:"timestamp"`
	...
	MergeTimestamp *LegacyTimestamp `protobuf:"bytes,7,opt,name=merge_timestamp,json=mergeTimestamp" json:"merge_timestamp,omitempty"`
}
...
func init() {
	...
	proto.RegisterType((*LegacyTimestamp)(nil), "cockroach.storage.engine.enginepb.LegacyTimestamp")
...
func (m *LegacyTimestamp) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x8
	i++
	i = encodeVarintMvcc(dAtA, i, uint64(m.WallTime))
	dAtA[i] = 0x10
	i++
	i = encodeVarintMvcc(dAtA, i, uint64(m.Logical))
	return i, nil
}
...
func NewPopulatedLegacyTimestamp(r randyMvcc, easy bool) *LegacyTimestamp {
...
func NewPopulatedMVCCMetadata(r randyMvcc, easy bool) *MVCCMetadata {
	...
	v4 := NewPopulatedLegacyTimestamp(r, easy)
	this.Timestamp = *v4
	...
	if r.Intn(10) != 0 {
		this.MergeTimestamp = NewPopulatedLegacyTimestamp(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func (m *LegacyTimestamp) Size() (n int) {
	var l int
	_ = l
	n += 1 + sovMvcc(uint64(m.WallTime))
	n += 1 + sovMvcc(uint64(m.Logical))
	return n
}
...
func (m *MVCCMetadata) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			if m.MergeTimestamp == nil {
				m.MergeTimestamp = &LegacyTimestamp{}
			}
...
var fileDescriptorMvcc = []byte{
	...
	,
}
