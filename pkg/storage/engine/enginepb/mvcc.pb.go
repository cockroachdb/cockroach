...
func (*MVCCMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc_deedc7468a372855, []int{0}
}
...
func (*MVCCMetadata_SequencedIntent) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc_deedc7468a372855, []int{0, 0}
}
...
func (*MVCCStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc_deedc7468a372855, []int{1}
}
...
func init() {
	proto.RegisterFile("storage/engine/enginepb/mvcc.proto", fileDescriptor_mvcc_deedc7468a372855)
}

var fileDescriptor_mvcc_deedc7468a372855 = []byte{
