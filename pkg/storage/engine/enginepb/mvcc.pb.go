...
type MVCCMetadata struct {
	...
	LeasingIntent  *bool                `protobuf:"varint,9,opt,name=leasing_intent,json=leasingIntent" json:"leasing_intent,omitempty"`
}

func (m *MVCCMetadata) Reset()      { *m = MVCCMetadata{} }
func (*MVCCMetadata) ProtoMessage() {}
func (*MVCCMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc_bd5aa0c056a72ad0, []int{0}
}
...
func (*MVCCMetadata_SequencedIntent) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc_bd5aa0c056a72ad0, []int{0, 0}
}
...
func (*MVCCStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc_bd5aa0c056a72ad0, []int{1}
}
...
func (this *MVCCMetadata) Equal(that interface{}) bool {
	...
	if this.LeasingIntent != nil && that1.LeasingIntent != nil {
		if *this.LeasingIntent != *that1.LeasingIntent {
			return false
		}
	} else if this.LeasingIntent != nil {
		return false
	} else if that1.LeasingIntent != nil {
		return false
	}
	return true
}
...
func init() {
	proto.RegisterFile("storage/engine/enginepb/mvcc.proto", fileDescriptor_mvcc_bd5aa0c056a72ad0)
}

var fileDescriptor_mvcc_bd5aa0c056a72ad0 = []byte{
	// 682 bytes of a gzipped FileDescriptorProto
	,
}
