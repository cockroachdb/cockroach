...
func TestFormatMVCCMetadata(t *testing.T) {
	...
	const expStr = `{id=d7aa0f5e key="a" pri=0.00000000 epo=1 ts=0.000000000,1 min=0.000000000,1 seq=0}` +
	...
	const expV = `{id=d7aa0f5e key="a" pri=0.00000000 epo=1 ts=0.000000000,1 min=0.000000000,1 seq=0}` +
