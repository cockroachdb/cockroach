...
// NewMap implements the MapProvidingEngine interface.
func (r *RocksDB) NewMap() diskmap.SortedDiskMap {
	return NewRocksDBMap(r)
}

// NewMultiMap implements the MapProvidingEngine interface.
func (r *RocksDB) NewMultiMap() diskmap.SortedDiskMap {
