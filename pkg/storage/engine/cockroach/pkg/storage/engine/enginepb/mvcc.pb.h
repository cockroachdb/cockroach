...
class TxnMeta : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:cockroach.storage.engine.enginepb.TxnMeta) */ {
 public:
  ...
  static const TxnMeta* internal_default_instance();
  ...
  void UnsafeMergeFrom(const TxnMeta& from);
  private:
...
extern ::google::protobuf::internal::ExplicitlyConstructed<TxnMeta> TxnMeta_default_instance_;
...
class MVCCMetadata : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:cockroach.storage.engine.enginepb.MVCCMetadata) */ {
 public:
  ...
  static const MVCCMetadata* internal_default_instance();
  ...
  void UnsafeMergeFrom(const MVCCMetadata& from);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _arena_ptr_;
  }
...
extern ::google::protobuf::internal::ExplicitlyConstructed<MVCCMetadata> MVCCMetadata_default_instance_;
...
class MVCCStats : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:cockroach.storage.engine.enginepb.MVCCStats) */ {
 public:
  ...
  static const MVCCStats* internal_default_instance();
  ...
  void UnsafeMergeFrom(const MVCCStats& from);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _arena_ptr_;
  }
...
extern ::google::protobuf::internal::ExplicitlyConstructed<MVCCStats> MVCCStats_default_instance_;
