...
struct DBEngine {
  ...
  virtual DBIterator* NewIter(const rocksdb::ReadOptions&) = 0;
...
struct DBImpl : public DBEngine {
  ...
  virtual DBIterator* NewIter(const rocksdb::ReadOptions&);
...
DBIterator* DBImpl::NewIter(const rocksdb::ReadOptions& read_opts) {
  DBIterator* iter = new DBIterator;
  iter->rep.reset(rep->NewIterator(read_opts));
  return iter;
}

DBIterator* DBBatch::NewIter(const rocksdb::ReadOptions& read_opts) {
  DBIterator* iter = new DBIterator;
...
DBIterator* DBWriteOnlyBatch::NewIter(const rocksdb::ReadOptions& read_opts) {
  return NULL;
}

DBIterator* DBSnapshot::NewIter(const rocksdb::ReadOptions& read_opts) {
  DBIterator* iter = new DBIterator;
  iter->rep.reset(rep->NewIterator(read_opts));
  return iter;
}
