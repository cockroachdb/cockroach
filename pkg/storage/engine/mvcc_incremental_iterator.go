...
// TODO(pbardea): Add validation here and in C++ implementation to validate
//  that the timestamp hints are not more restrictive than incremental
//  iterator (startTime, endTime] interval.
