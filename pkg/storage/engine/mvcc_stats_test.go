...
func assertEq(t *testing.T, readWriter ReadWriter, debug string, ms, expMS *enginepb.MVCCStats) {
	t.Helper()
	...
	it := readWriter.NewIterator(IterOptions{UpperBound: roachpb.KeyMax})
	defer it.Close()
