...
func mvccPutInternal(
	...
	if ok {
		...
		if meta.Txn != nil {
			...
			// The one notable exception is when there are no past committed values, and all past writes
			// by this transaction have been rolled back, either due to transaction
