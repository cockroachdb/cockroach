...
func CheckForKeyCollisions(existingIter Iterator, sstIter Iterator) (enginepb.MVCCStats, error) {
	switch existingIter.(type) {
	case *rocksDBIterator:
		return checkForKeyCollisionsRocksDB(existingIter, sstIter)
	default:
		return checkForKeyCollisionsGo(existingIter, sstIter)
	}
}

// checkForKeyCollisionsGo is a Go port of DBCheckForKeyCollisions.
func checkForKeyCollisionsGo(existingIter Iterator, sstIter Iterator) (enginepb.MVCCStats, error) {
