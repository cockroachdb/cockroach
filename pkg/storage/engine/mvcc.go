...
// existing value that is different from the supplied value, or if the supplied
// value has a non-zero MVCC timestamp that is not exactly equal to that of the
// existing value.
func MVCCInitPut(
	ctx context.Context,
	engine ReadWriter,
