...
class Attributes : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:cockroach.roachpb.Attributes) */ {
 ...
 private:
  ...
  #else
  friend void  protobuf_AddDesc_cockroach_2fpkg_2froachpb_2fmetadata_2eproto();
  #endif
...
class StoreCapacity : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:cockroach.roachpb.StoreCapacity) */ {
 public:
  ...
  bool has_lease_holder_count() const;
  void clear_lease_holder_count();
  static const int kLeaseHolderCountFieldNumber = 4;
  ::google::protobuf::int32 lease_holder_count() const;
  void set_lease_holder_count(::google::protobuf::int32 value);
 ...
 private:
  ...
  inline void set_has_lease_holder_count();
  inline void clear_has_lease_holder_count();
  ...
  ::google::protobuf::int32 lease_holder_count_;
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void  protobuf_AddDesc_cockroach_2fpkg_2froachpb_2fmetadata_2eproto_impl();
  #else
  friend void  protobuf_AddDesc_cockroach_2fpkg_2froachpb_2fmetadata_2eproto();
...
class Locality : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:cockroach.roachpb.Locality) */ {
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static Locality* default_instance_;
};
// -------------------------------------------------------------------
...
// optional int32 lease_holder_count = 4;
inline bool StoreCapacity::has_lease_holder_count() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void StoreCapacity::set_has_lease_holder_count() {
  _has_bits_[0] |= 0x00000008u;
}
inline void StoreCapacity::clear_has_lease_holder_count() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void StoreCapacity::clear_lease_holder_count() {
  lease_holder_count_ = 0;
  clear_has_lease_holder_count();
}
inline ::google::protobuf::int32 StoreCapacity::lease_holder_count() const {
  // @@protoc_insertion_point(field_get:cockroach.roachpb.StoreCapacity.lease_holder_count)
  return lease_holder_count_;
}
inline void StoreCapacity::set_lease_holder_count(::google::protobuf::int32 value) {
