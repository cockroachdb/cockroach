...
class Span : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:cockroach.roachpb.Span) */ {
 ...
 private:
  ...
  #else
  friend void  protobuf_AddDesc_cockroach_2fpkg_2froachpb_2fdata_2eproto();
  #endif
...
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  return proposed_ts_ != NULL ? *proposed_ts_ : *default_instance().proposed_ts_;
#else
  return proposed_ts_ != NULL ? *proposed_ts_ : *default_instance_->proposed_ts_;
#endif
}
