...
void protobuf_AssignDesc_cockroach_2fpkg_2froachpb_2finternal_2eproto();
...
class InternalTimeSeriesData : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:cockroach.roachpb.InternalTimeSeriesData) */ {
 public:
  ...
  static const InternalTimeSeriesData* internal_default_instance();
  ...
  void UnsafeMergeFrom(const InternalTimeSeriesData& from);
  private:
 ...
 private:
  ...
  friend void  protobuf_AddDesc_cockroach_2fpkg_2froachpb_2finternal_2eproto_impl();
  friend void protobuf_AssignDesc_cockroach_2fpkg_2froachpb_2finternal_2eproto();
  friend void protobuf_ShutdownFile_cockroach_2fpkg_2froachpb_2finternal_2eproto();

  void InitAsDefaultInstance();
};
extern ::google::protobuf::internal::ExplicitlyConstructed<InternalTimeSeriesData> InternalTimeSeriesData_default_instance_;
...
class InternalTimeSeriesSample : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:cockroach.roachpb.InternalTimeSeriesSample) */ {
 public:
  ...
  static const InternalTimeSeriesSample* internal_default_instance();
  ...
  void UnsafeMergeFrom(const InternalTimeSeriesSample& from);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _arena_ptr_;
  }
...
extern ::google::protobuf::internal::ExplicitlyConstructed<InternalTimeSeriesSample> InternalTimeSeriesSample_default_instance_;
