...
func (t *Tracker) Close(
	...
	// greater than or equal to the current epoch, proceed with closing out the
	// current timestamp, deferring the decision regarding whether to return the
	// updated state based on epoch until after updating the data.
