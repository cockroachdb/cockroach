...
import (
	...
	"github.com/cockroachdb/cockroach/pkg/storage/closedts/provider/testutils"
...
func TestProviderSubscribeNotify(t *testing.T) {
	...
	require.Equal(t, 2*numEntries, len(snap[2])) // 2 * numEntries for n2
}
