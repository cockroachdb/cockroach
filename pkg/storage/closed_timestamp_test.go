...
func TestClosedTimestampCanServe(t *testing.T) {
	...
	if _, err := db0.Exec(`
SET CLUSTER SETTING server.closed_timestamp.target_duration = '300ms';
SET CLUSTER SETTING server.closed_timestamp.close_fraction = 0.01/0.3;
SET CLUSTER SETTING server.closed_timestamp.follower_reads_enabled = true;
