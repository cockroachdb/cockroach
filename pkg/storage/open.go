...
func makeExternalWALDir(
	...
	externalDir storagepb.EncryptedPath,
	defaultFS vfs.FS,
...
func WALFailover(
	...
	if len(storeEnvs) == 1 {
		switch walCfg.Mode {
		case storagepb.WALFailoverMode_WALFailoverDefault, storagepb.WALFailoverMode_WALFailoverAmongStores:
			return noopConfigOption
		case storagepb.WALFailoverMode_WALFailoverDisabled:
			...
			return noopConfigOption
		case storagepb.WALFailoverMode_WALFailoverExplicitPath:
	...
	switch walCfg.Mode {
	case storagepb.WALFailoverMode_WALFailoverDefault:
	...
	case storagepb.WALFailoverMode_WALFailoverAmongStores:
		// Fallthrough
	default:
		panic("unreachable")
	}
	...
	return func(cfg *engineConfig) error {
		...
		if walCfg.Mode == storagepb.WALFailoverMode_WALFailoverAmongStores {
