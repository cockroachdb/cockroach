...
func (p *pendingLeaseRequest) requestLeaseAsync(
	...
	// cancellation of all contexts onto this new one, only cancelling it
	// if all coalesced requests timeout/cancel. p.cancel (defined below)
	// is the cancel function that must be called; calling just cancel is
	// insufficient.
