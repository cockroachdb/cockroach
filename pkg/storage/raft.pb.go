...
type RaftMessageRequest struct {
	...
	// max_safe_sequence is incremented on successive coalesced
	// heartbeats. If a received heartbeat's max_safe_sequence is not in
	// order, then the quiesced range map attributed to the sender is
	// cleared to prevent using the max safe timestamp provied here with
	// a range which might have unquiesced during a missed heartbeat.
	MaxSafeSequence int64 `protobuf:"varint,8,opt,name=max_safe_sequence,json=maxSafeSequence" json:"max_safe_sequence"`
	...
	// safe_index specified with the heartbeat.
	MaxSafe cockroach_util_hlc.Timestamp `protobuf:"bytes,9,opt,name=max_safe,json=maxSafe" json:"max_safe"`
	...
	// learned from the sender must be discarded.
	...
	// safe indexes can no longer be used in conjunction with the
	// max_safe timestamp because the range is no longer guaranteed to
...
func (m *RaftMessageRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x40
	i++
	i = encodeVarintRaft(dAtA, i, uint64(m.MaxSafeSequence))
	dAtA[i] = 0x4a
	i++
...
func (m *RaftMessageRequest) Size() (n int) {
	...
	n += 1 + sovRaft(uint64(m.MaxSafeSequence))
	l = m.MaxSafe.Size()
	n += 1 + l + sovRaft(uint64(l))
...
func (m *RaftMessageRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxSafeSequence", wireType)
			}
			m.MaxSafeSequence = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxSafeSequence |= (int64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorRaft = []byte{
	...
	,
}
