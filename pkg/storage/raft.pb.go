...
type ClosedTSInfo struct {
	...
	// If quiesced is true, then future closed timestamps reported by
	// the origin store can be trusted at the last known MLAI.
	Quiesced bool `protobuf:"varint,3,opt,name=quiesced" json:"quiesced"`
}
...
func (m *ClosedTSInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Quiesced", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorRaft = []byte{
	...
	,
}
