...
type RaftHeartbeat struct {
	...
	// served by any replica before the max_safe timestamp so long
...
type RaftMessageRequest struct {
	...
	// max_safe is the timestamp before which follower replicas being
	// heartbeat can serve reads as long as they've committed up to the
	// safe_index specified with the heartbeat. Heartbeats only.
	...
	// changes between heartbeats, all prior knowledge of safe indexes
	// learned from the sender must be discarded. Heartbeats only.
	...
	// The set includes ranges which have forwarded commands
	// (leaseholder-not-leader), ranges with new leases, and ranges with
	// removed replicas. Heartbeats only.
