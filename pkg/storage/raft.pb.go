...
func (SnapshotRequest_Priority) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_raft_cf43e1b8f9b6f376, []int{5, 0}
}
...
const (
	...
	// range from the sender to the receiver. These KV pairs are then
	// combined into a large RocksDB WriteBatch that is atomically
	// applied.
	SnapshotRequest_KV_BATCH SnapshotRequest_Strategy = 0
	// SST snapshots stream SSTs for all keys in a range from the sender to the
	// receiver. Separate SSTs will be created for the replicated range-id
	// local keys, range local keys, and user keys.
...
func (SnapshotRequest_Strategy) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_raft_cf43e1b8f9b6f376, []int{5, 1}
}
...
func (SnapshotRequest_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_raft_cf43e1b8f9b6f376, []int{5, 2}
}
...
func (SnapshotResponse_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_raft_cf43e1b8f9b6f376, []int{6, 0}
}
...
func (*RaftHeartbeat) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_cf43e1b8f9b6f376, []int{0}
}
...
func (*RaftMessageRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_cf43e1b8f9b6f376, []int{1}
}
...
func (*RaftMessageRequestBatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_cf43e1b8f9b6f376, []int{2}
}
...
func (*RaftMessageResponseUnion) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_cf43e1b8f9b6f376, []int{3}
}
...
func (*RaftMessageResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_cf43e1b8f9b6f376, []int{4}
}
...
func (*SnapshotRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_cf43e1b8f9b6f376, []int{5}
}
...
func (*SnapshotResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_cf43e1b8f9b6f376, []int{6}
}
...
func (*ConfChangeContext) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_cf43e1b8f9b6f376, []int{7}
}
...
func init() { proto.RegisterFile("storage/raft.proto", fileDescriptor_raft_cf43e1b8f9b6f376) }

var fileDescriptor_raft_cf43e1b8f9b6f376 = []byte{
	// 1278 bytes of a gzipped FileDescriptorProto
	,
}
