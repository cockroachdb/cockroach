...
func (SnapshotRequest_Strategy) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorRaft, []int{6, 1}
}
...
func (SnapshotResponse_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorRaft, []int{7, 0}
}
...
// ClosedTSInfo contains information necessary to determine whether
// reads can be serviced by follower replicas based on their current
// lease applied index and whether or not they're in a quiescent
// state.
type ClosedTSInfo struct {
	RangeID github_com_cockroachdb_cockroach_pkg_roachpb.RangeID `protobuf:"varint,1,opt,name=range_id,json=rangeId,casttype=github.com/cockroachdb/cockroach/pkg/roachpb.RangeID" json:"range_id"`
	// The minimum lease applied index (MLAI) at which the range can
	// serve reads for timestamps at or before the closed timestamp.
	MinLeaseAppliedIndex uint64 `protobuf:"varint,2,opt,name=min_lease_applied_index,json=minLeaseAppliedIndex" json:"min_lease_applied_index"`
	// If quiescing is true, then future closed timestamps reported by
	// the origin store can be trusted at the last known MLAI.
	Quiescing bool `protobuf:"varint,3,opt,name=quiescing" json:"quiescing"`
}

func (m *ClosedTSInfo) Reset()                    { *m = ClosedTSInfo{} }
func (m *ClosedTSInfo) String() string            { return proto.CompactTextString(m) }
func (*ClosedTSInfo) ProtoMessage()               {}
func (*ClosedTSInfo) Descriptor() ([]byte, []int) { return fileDescriptorRaft, []int{1} }
...
type RaftMessageRequest struct {
	...
	// ranges is a set of ranges with minimum lease applied index (MLAI)
	// and whether or not the range is quiescent according to the origin
	// store (the putative leaseholder).
	Ranges []ClosedTSInfo `protobuf:"bytes,11,rep,name=ranges" json:"ranges"`
}
...
func (*RaftMessageResponseUnion) Descriptor() ([]byte, []int) { return fileDescriptorRaft, []int{4} }
...
func (*RaftMessageResponse) Descriptor() ([]byte, []int) { return fileDescriptorRaft, []int{5} }
...
func (*SnapshotRequest) Descriptor() ([]byte, []int) { return fileDescriptorRaft, []int{6} }
...
func (*SnapshotRequest_Header) Descriptor() ([]byte, []int) { return fileDescriptorRaft, []int{6, 0} }
...
func (*SnapshotResponse) Descriptor() ([]byte, []int) { return fileDescriptorRaft, []int{7} }
...
func (*ConfChangeContext) Descriptor() ([]byte, []int) { return fileDescriptorRaft, []int{8} }

func init() {
	proto.RegisterType((*RaftHeartbeat)(nil), "cockroach.storage.RaftHeartbeat")
	proto.RegisterType((*ClosedTSInfo)(nil), "cockroach.storage.ClosedTSInfo")
...
func (m *ClosedTSInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ClosedTSInfo) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	dAtA[i] = 0x10
	i++
	i = encodeVarintRaft(dAtA, i, uint64(m.MinLeaseAppliedIndex))
	dAtA[i] = 0x18
	i++
	if m.Quiescing {
		dAtA[i] = 1
...
func (m *ClosedTSInfo) Size() (n int) {
	var l int
	_ = l
	n += 1 + sovRaft(uint64(m.RangeID))
	n += 1 + sovRaft(uint64(m.MinLeaseAppliedIndex))
	n += 2
	return n
}
...
func (m *ClosedTSInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ClosedTSInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ClosedTSInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MinLeaseAppliedIndex", wireType)
			}
			m.MinLeaseAppliedIndex = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowRaft
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MinLeaseAppliedIndex |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Quiescing", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *RaftMessageRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			...
			m.Ranges = append(m.Ranges, ClosedTSInfo{})
...
var fileDescriptorRaft = []byte{
	...
	,
}
