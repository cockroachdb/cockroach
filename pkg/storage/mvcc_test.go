...
func TestMVCCGetNoMoreOldVersion(t *testing.T) {
	...
	if err := MVCCPut(ctx, engine, nil, testKey1, hlc.Timestamp{WallTime: 3}, hlc.ClockTimestamp{}, value1, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
	if err := MVCCPut(ctx, engine, nil, testKey2, hlc.Timestamp{WallTime: 1}, hlc.ClockTimestamp{}, value2, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
...
func TestMVCCGetWithValueHeader(t *testing.T) {
	...
	if err := MVCCPut(ctx, engine, nil, testKey1, hlc.Timestamp{WallTime: 1, Logical: 1}, hlc.ClockTimestamp{WallTime: 1}, value1, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
	...
	_, err = MVCCDelete(ctx, engine, nil, testKey1, hlc.Timestamp{WallTime: 3}, hlc.ClockTimestamp{WallTime: 2, Logical: 1}, NoLogicalReplication, nil)
	if err != nil {
		t.Fatal(err)
	}
...
func TestMVCCWriteWithOlderTimestampAfterDeletionOfNonexistentKey(t *testing.T) {
	...
	_, err := MVCCDelete(context.Background(), engine, nil, testKey1, hlc.Timestamp{WallTime: 3}, hlc.ClockTimestamp{}, NoLogicalReplication, nil)
	require.NoError(t, err)

	err = MVCCPut(context.Background(), engine, nil, testKey1, hlc.Timestamp{WallTime: 1}, hlc.ClockTimestamp{}, value1, NoLogicalReplication, nil)
...
func TestMVCCInlineWithTxn(t *testing.T) {
	...
	// Put an inline value.
	if err := MVCCPut(ctx, engine, nil, testKey1, hlc.Timestamp{}, hlc.ClockTimestamp{}, value1, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
	...
	err = MVCCPut(ctx, engine, nil, testKey2, hlc.Timestamp{}, hlc.ClockTimestamp{}, value2, NoLogicalReplication, txn2)
...
func TestMVCCDeleteMissingKey(t *testing.T) {
	...
	if _, err := MVCCDelete(ctx, engine, nil, testKey1, hlc.Timestamp{WallTime: 1}, hlc.ClockTimestamp{}, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
...
func TestMVCCGetAndDeleteInTxn(t *testing.T) {
	...
	txn.Sequence++
	if err := MVCCPut(ctx, engine, nil, testKey1, txn.ReadTimestamp, hlc.ClockTimestamp{}, value1, NoLogicalReplication, txn); err != nil {
		t.Fatal(err)
	}
	...
	if _, err := MVCCDelete(ctx, engine, nil, testKey1, txn.ReadTimestamp, hlc.ClockTimestamp{}, NoLogicalReplication, txn); err != nil {
		t.Fatal(err)
	}
...
func TestMVCCGetWriteIntentError(t *testing.T) {
	...
	if err := MVCCPut(ctx, engine, nil, testKey1, txn1.ReadTimestamp, hlc.ClockTimestamp{}, value1, NoLogicalReplication, txn1); err != nil {
		t.Fatal(err)
	}
...
func TestMVCCScanWriteIntentError(t *testing.T) {
	...
	for i, kv := range fixtureKVs {
		...
		if err := MVCCPut(ctx, engine, nil, kv.Key, kv.Value.Timestamp, hlc.ClockTimestamp{}, v, NoLogicalReplication, txnMap[i]); err != nil {
			t.Fatal(err)
		}
	}
...
func TestMVCCGetInconsistent(t *testing.T) {
	...
	if err := MVCCPut(ctx, engine, nil, testKey1, hlc.Timestamp{WallTime: 1}, hlc.ClockTimestamp{}, value1, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
	txn1ts := makeTxn(*txn1, hlc.Timestamp{WallTime: 2})
	if err := MVCCPut(ctx, engine, nil, testKey1, txn1ts.ReadTimestamp, hlc.ClockTimestamp{}, value2, NoLogicalReplication, txn1ts); err != nil {
		t.Fatal(err)
	}
	...
	if err := MVCCPut(ctx, engine, nil, testKey2, txn2.ReadTimestamp, hlc.ClockTimestamp{}, value1, NoLogicalReplication, txn2); err != nil {
		t.Fatal(err)
	}
...
func TestMVCCGetProtoInconsistent(t *testing.T) {
	...
	// Put two values to key 1, the latest with a txn.
	if err := MVCCPut(ctx, engine, nil, testKey1, hlc.Timestamp{WallTime: 1}, hlc.ClockTimestamp{}, v1, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
	txn1ts := makeTxn(*txn1, hlc.Timestamp{WallTime: 2})
	if err := MVCCPut(ctx, engine, nil, testKey1, txn1ts.ReadTimestamp, hlc.ClockTimestamp{}, v2, NoLogicalReplication, txn1ts); err != nil {
		t.Fatal(err)
	}
	...
	{
		// Write a single intent for key 2 and verify get returns empty.
		if err := MVCCPut(ctx, engine, nil, testKey2, txn2.ReadTimestamp, hlc.ClockTimestamp{}, v1, NoLogicalReplication, txn2); err != nil {
			t.Fatal(err)
		}
		val := roachpb.Value{}
...

	{
		...
		// write intent.
		if err := MVCCPut(ctx, engine, nil, testKey3, hlc.Timestamp{WallTime: 1}, hlc.ClockTimestamp{}, value3, NoLogicalReplication, nil); err != nil {
			t.Fatal(err)
		}
		if err := MVCCPut(ctx, engine, nil, testKey3, txn1ts.ReadTimestamp, hlc.ClockTimestamp{}, v2, NoLogicalReplication, txn1ts); err != nil {
			t.Fatal(err)
		}
		val := roachpb.Value{}
...
func TestMVCCInvalidateIterator(t *testing.T) {
	...
	for _, which := range []string{"get", "scan", "findSplitKey", "computeStats"} {
		t.Run(which, func(t *testing.T) {
			...
			key := roachpb.Key("a")
			if err := MVCCPut(ctx, engine, nil, key, ts1, hlc.ClockTimestamp{}, value1, NoLogicalReplication, nil); err != nil {
				t.Fatal(err)
			}
...
func mvccScanTest(ctx context.Context, t *testing.T, engine Engine) {
	...
	if err := MVCCPut(ctx, engine, nil, testKey1, hlc.Timestamp{WallTime: 2}, hlc.ClockTimestamp{}, value4, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
	if err := MVCCPut(ctx, engine, nil, testKey2, hlc.Timestamp{WallTime: 1}, hlc.ClockTimestamp{}, value2, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
	if err := MVCCPut(ctx, engine, nil, testKey2, hlc.Timestamp{WallTime: 3}, hlc.ClockTimestamp{}, value3, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
	if err := MVCCPut(ctx, engine, nil, testKey3, hlc.Timestamp{WallTime: 1}, hlc.ClockTimestamp{}, value3, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
	if err := MVCCPut(ctx, engine, nil, testKey3, hlc.Timestamp{WallTime: 4}, hlc.ClockTimestamp{}, value2, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
	if err := MVCCPut(ctx, engine, nil, testKey4, hlc.Timestamp{WallTime: 1}, hlc.ClockTimestamp{}, value4, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
	if err := MVCCPut(ctx, engine, nil, testKey4, hlc.Timestamp{WallTime: 5}, hlc.ClockTimestamp{}, value1, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
...
func TestMVCCScanMaxNum(t *testing.T) {
	...
	if err := MVCCPut(ctx, engine, nil, testKey6, hlc.Timestamp{WallTime: 1}, hlc.ClockTimestamp{}, value4, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
...
func TestMVCCScanWithKeyPrefix(t *testing.T) {
	...
	if err := MVCCPut(ctx, engine, nil, roachpb.Key("/a"), hlc.Timestamp{WallTime: 1}, hlc.ClockTimestamp{}, value1, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
	if err := MVCCPut(ctx, engine, nil, roachpb.Key("/a"), hlc.Timestamp{WallTime: 2}, hlc.ClockTimestamp{}, value2, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
	if err := MVCCPut(ctx, engine, nil, roachpb.Key("/aa"), hlc.Timestamp{WallTime: 2}, hlc.ClockTimestamp{}, value2, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
	if err := MVCCPut(ctx, engine, nil, roachpb.Key("/aa"), hlc.Timestamp{WallTime: 3}, hlc.ClockTimestamp{}, value3, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
	if err := MVCCPut(ctx, engine, nil, roachpb.Key("/b"), hlc.Timestamp{WallTime: 1}, hlc.ClockTimestamp{}, value3, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
...
func TestMVCCScanInTxn(t *testing.T) {
	...
	txn := makeTxn(*txn1, hlc.Timestamp{WallTime: 1})
	if err := MVCCPut(ctx, engine, nil, testKey3, txn.ReadTimestamp, hlc.ClockTimestamp{}, value3, NoLogicalReplication, txn); err != nil {
		t.Fatal(err)
	}
	if err := MVCCPut(ctx, engine, nil, testKey4, hlc.Timestamp{WallTime: 1}, hlc.ClockTimestamp{}, value4, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
...
func TestMVCCScanInconsistent(t *testing.T) {
	...
	if err := MVCCPut(ctx, engine, nil, testKey1, ts1, hlc.ClockTimestamp{}, value1, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
	txn1ts2 := makeTxn(*txn1, ts2)
	if err := MVCCPut(ctx, engine, nil, testKey1, txn1ts2.ReadTimestamp, hlc.ClockTimestamp{}, value2, NoLogicalReplication, txn1ts2); err != nil {
		t.Fatal(err)
	}
	if err := MVCCPut(ctx, engine, nil, testKey2, ts3, hlc.ClockTimestamp{}, value1, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
	if err := MVCCPut(ctx, engine, nil, testKey2, ts4, hlc.ClockTimestamp{}, value2, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
	txn2ts5 := makeTxn(*txn2, ts5)
	if err := MVCCPut(ctx, engine, nil, testKey3, txn2ts5.ReadTimestamp, hlc.ClockTimestamp{}, value3, NoLogicalReplication, txn2ts5); err != nil {
		t.Fatal(err)
	}
	if err := MVCCPut(ctx, engine, nil, testKey4, ts6, hlc.ClockTimestamp{}, value4, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
...
func TestMVCCDeleteRange(t *testing.T) {
	...
	if err := MVCCPut(ctx, engine, nil, testKey5, hlc.Timestamp{WallTime: 1}, hlc.ClockTimestamp{}, value5, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
	if err := MVCCPut(ctx, engine, nil, testKey6, hlc.Timestamp{WallTime: 1}, hlc.ClockTimestamp{}, value6, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
...
func TestMVCCDeleteRangeFailed(t *testing.T) {
	...
	txn.Sequence++
	if err := MVCCPut(ctx, engine, nil, testKey2, txn.ReadTimestamp, hlc.ClockTimestamp{}, value2, NoLogicalReplication, txn); err != nil {
		t.Fatal(err)
	}
	txn.Sequence++
	if err := MVCCPut(ctx, engine, nil, testKey3, txn.ReadTimestamp, hlc.ClockTimestamp{}, value3, NoLogicalReplication, txn); err != nil {
...
func TestMVCCDeleteRangeConcurrentTxn(t *testing.T) {
	...
	if err := MVCCPut(ctx, engine, nil, testKey2, txn1ts.ReadTimestamp, hlc.ClockTimestamp{}, value2, NoLogicalReplication, txn1ts); err != nil {
		t.Fatal(err)
	}
	if err := MVCCPut(ctx, engine, nil, testKey3, txn2ts.ReadTimestamp, hlc.ClockTimestamp{}, value3, NoLogicalReplication, txn2ts); err != nil {
		t.Fatal(err)
	}
	if err := MVCCPut(ctx, engine, nil, testKey4, hlc.Timestamp{WallTime: 1}, hlc.ClockTimestamp{}, value4, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
...
func TestMVCCUncommittedDeleteRangeVisible(t *testing.T) {
	...
	if _, err := MVCCDelete(ctx, engine, nil, testKey2, hlc.Timestamp{WallTime: 2, Logical: 1}, hlc.ClockTimestamp{}, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
...
func TestMVCCDeleteRangeOldTimestamp(t *testing.T) {
	...
	engine := NewDefaultInMemForTesting()
	defer engine.Close()
	err := MVCCPut(ctx, engine, nil, testKey1, hlc.Timestamp{WallTime: 1}, hlc.ClockTimestamp{}, value1, NoLogicalReplication, nil)
	if err != nil {
		t.Fatal(err)
	}
	err = MVCCPut(ctx, engine, nil, testKey2, hlc.Timestamp{WallTime: 3}, hlc.ClockTimestamp{}, value2, NoLogicalReplication, nil)
	if err != nil {
		t.Fatal(err)
	}
	_, err = MVCCDelete(ctx, engine, nil, testKey2, hlc.Timestamp{WallTime: 5}, hlc.ClockTimestamp{}, NoLogicalReplication, nil)
	if err != nil {
		t.Fatal(err)
	}
...
func TestMVCCDeleteRangeInline(t *testing.T) {
	...
	for i, kv := range []struct {
		...
		if err := MVCCPut(ctx, engine, nil, kv.key, hlc.Timestamp{Logical: 0}, hlc.ClockTimestamp{}, kv.value, NoLogicalReplication, nil); err != nil {
			t.Fatalf("%d: %+v", i, err)
		}
	}
...
func TestMVCCClearTimeRange(t *testing.T) {
	...
	defer eng.Close()
	require.NoError(t, MVCCPut(ctx, eng, nil, testKey2, ts1, hlc.ClockTimestamp{}, value1, NoLogicalReplication, nil))
	require.NoError(t, MVCCPut(ctx, eng, nil, testKey2, ts2, hlc.ClockTimestamp{}, value2, NoLogicalReplication, nil))
	require.NoError(t, MVCCPut(ctx, eng, nil, testKey5, ts2, hlc.ClockTimestamp{}, value2, NoLogicalReplication, nil))
	require.NoError(t, MVCCPut(ctx, eng, nil, testKey1, ts3, hlc.ClockTimestamp{}, value3, NoLogicalReplication, nil))
	require.NoError(t, MVCCPut(ctx, eng, nil, testKey5, ts4, hlc.ClockTimestamp{}, value4, NoLogicalReplication, nil))
	require.NoError(t, MVCCPut(ctx, eng, nil, testKey2, ts4, hlc.ClockTimestamp{}, value4, NoLogicalReplication, nil))
	...
	addIntent := func(t *testing.T, rw ReadWriter) {
		require.NoError(t, MVCCPut(ctx, rw, nil, testKey3, ts3, hlc.ClockTimestamp{}, value3, NoLogicalReplication, &txn))
	}
...
func TestMVCCClearTimeRangeOnRandomData(t *testing.T) {
	...
	for i := 0; i < numKVs-swathSize; i++ {
		...
		if rand.Float64() > 0.8 {
			_, err := MVCCDelete(ctx, e, &ms, key, hlc.Timestamp{WallTime: ts}, hlc.ClockTimestamp{}, NoLogicalReplication, nil)
			require.NoError(t, err)
		} else {
			v := roachpb.MakeValueFromString(fmt.Sprintf("v-%d", i))
			require.NoError(t, MVCCPut(ctx, e, &ms, key, hlc.Timestamp{WallTime: ts}, hlc.ClockTimestamp{}, v, NoLogicalReplication, nil))
		}
	}
	...
	for i := swathStart; i < swathEnd; i++ {
		...
		v := roachpb.MakeValueFromString(fmt.Sprintf("v-%d", i))
		require.NoError(t, MVCCPut(ctx, e, &ms, key, hlc.Timestamp{WallTime: int64(swathTime)}, hlc.ClockTimestamp{}, v, NoLogicalReplication, nil))
	}
	...
	for i := keyRange; i < keyRange+200; i++ {
		key := roachpb.Key(fmt.Sprintf("%05d", i))
		v := roachpb.MakeValueFromString(fmt.Sprintf("v-%d", i))
		require.NoError(t, MVCCPut(ctx, e, &ms, key, hlc.Timestamp{WallTime: int64(randTimeRange + 1)}, hlc.ClockTimestamp{}, v, NoLogicalReplication, nil))
	}
...
func TestMVCCInitPut(t *testing.T) {
	...
	err := MVCCInitPut(ctx, engine, nil, testKey1, hlc.Timestamp{Logical: 1}, hlc.ClockTimestamp{}, value1, false, NoLogicalReplication, nil)
	if err != nil {
		t.Fatal(err)
	}

	// A repeat of the command will still succeed
	err = MVCCInitPut(ctx, engine, nil, testKey1, hlc.Timestamp{Logical: 2}, hlc.ClockTimestamp{}, value1, false, NoLogicalReplication, nil)
	if err != nil {
		t.Fatal(err)
	}

	// Delete.
	_, err = MVCCDelete(ctx, engine, nil, testKey1, hlc.Timestamp{Logical: 3}, hlc.ClockTimestamp{}, NoLogicalReplication, nil)
	if err != nil {
		t.Fatal(err)
	}

	// Reinserting the value fails if we fail on tombstones.
	err = MVCCInitPut(ctx, engine, nil, testKey1, hlc.Timestamp{Logical: 4}, hlc.ClockTimestamp{}, value1, true, NoLogicalReplication, nil)
	...
	err = MVCCInitPut(ctx, engine, nil, testKey1, hlc.Timestamp{Logical: 5}, hlc.ClockTimestamp{}, value1, false, NoLogicalReplication, nil)
	if err != nil {
		t.Fatal(err)
	}

	// A repeat of the command with a different value will fail.
	err = MVCCInitPut(ctx, engine, nil, testKey1, hlc.Timestamp{Logical: 6}, hlc.ClockTimestamp{}, value2, false, NoLogicalReplication, nil)
	if e := (*kvpb.ConditionFailedError)(nil); errors.As(err, &e) {
...
func TestMVCCInitPutWithTxn(t *testing.T) {
	...
	txn := *txn1
	txn.Sequence++
	err := MVCCInitPut(ctx, engine, nil, testKey1, txn.ReadTimestamp, hlc.ClockTimestamp{}, value1, false, NoLogicalReplication, &txn)
	require.NoError(t, err)
	...
	txn.Sequence++
	txn.Epoch = 2
	err = MVCCInitPut(ctx, engine, nil, testKey1, txn.ReadTimestamp, hlc.ClockTimestamp{}, value2, false, NoLogicalReplication, &txn)
	require.NoError(t, err)
	...
	err = MVCCInitPut(ctx, engine, nil, testKey1, clock.Now(), hlc.ClockTimestamp{}, value4, false, NoLogicalReplication, nil)
	require.ErrorAs(t, err, new(*kvpb.WriteTooOldError))
}
...
func TestMVCCReverseScan(t *testing.T) {
	...
	if err := MVCCPut(ctx, engine, nil, testKey1, hlc.Timestamp{WallTime: 2}, hlc.ClockTimestamp{}, value2, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
	if err := MVCCPut(ctx, engine, nil, testKey2, hlc.Timestamp{WallTime: 1}, hlc.ClockTimestamp{}, value3, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
	if err := MVCCPut(ctx, engine, nil, testKey2, hlc.Timestamp{WallTime: 3}, hlc.ClockTimestamp{}, value4, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
	if err := MVCCPut(ctx, engine, nil, testKey3, hlc.Timestamp{WallTime: 1}, hlc.ClockTimestamp{}, value1, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
	if err := MVCCPut(ctx, engine, nil, testKey4, hlc.Timestamp{WallTime: 1}, hlc.ClockTimestamp{}, value2, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
	if err := MVCCPut(ctx, engine, nil, testKey5, hlc.Timestamp{WallTime: 3}, hlc.ClockTimestamp{}, value5, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
	if err := MVCCPut(ctx, engine, nil, testKey6, hlc.Timestamp{WallTime: 3}, hlc.ClockTimestamp{}, value6, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
...
func TestMVCCReverseScanFirstKeyInFuture(t *testing.T) {
	...
	if err := MVCCPut(ctx, engine, nil, testKey3, hlc.Timestamp{WallTime: 3}, hlc.ClockTimestamp{}, value3, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
...
func TestMVCCReverseScanSeeksOverRepeatedKeys(t *testing.T) {
	...
	for i := 1; i <= 10; i++ {
		if err := MVCCPut(ctx, engine, nil, testKey2, hlc.Timestamp{WallTime: int64(i)}, hlc.ClockTimestamp{}, value2, NoLogicalReplication, nil); err != nil {
			t.Fatal(err)
		}
	}
...
func TestMVCCReverseScanStopAtSmallestKey(t *testing.T) {
	...
	run := func(numPuts int, ts int64) {
		...
		for i := 1; i <= numPuts; i++ {
			if err := MVCCPut(ctx, engine, nil, testKey1, hlc.Timestamp{WallTime: int64(i)}, hlc.ClockTimestamp{}, value1, NoLogicalReplication, nil); err != nil {
				t.Fatal(err)
			}
		}
...
func TestMVCCResolveNewerIntent(t *testing.T) {
	...
	// Write first value.
	if err := MVCCPut(ctx, engine, nil, testKey1, txn1Commit.WriteTimestamp, hlc.ClockTimestamp{}, value1, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
	// Now, put down an intent which should return a write too old error
	// (but will still write the intent at tx1Commit.Timestamp+1.
	err := MVCCPut(ctx, engine, nil, testKey1, txn1.ReadTimestamp, hlc.ClockTimestamp{}, value2, NoLogicalReplication, txn1)
...
func TestMVCCResolveIntentTxnTimestampMismatch(t *testing.T) {
	...
	if err := MVCCPut(ctx, engine, nil, testKey1, tsEarly, hlc.ClockTimestamp{}, value1, NoLogicalReplication, txn); err != nil {
		t.Fatal(err)
	}
...
func TestMVCCConditionalPutOldTimestamp(t *testing.T) {
	...
	err := MVCCPut(ctx, engine, nil, testKey1, hlc.Timestamp{WallTime: 1}, hlc.ClockTimestamp{}, value1, NoLogicalReplication, nil)
	require.NoError(t, err)
	err = MVCCPut(ctx, engine, nil, testKey1, hlc.Timestamp{WallTime: 3}, hlc.ClockTimestamp{}, value2, NoLogicalReplication, nil)
	require.NoError(t, err)
	...
	for _, expVal := range []roachpb.Value{
		...
		err = MVCCConditionalPut(ctx, engine, nil, testKey1, hlc.Timestamp{WallTime: 2}, hlc.ClockTimestamp{}, value3, expVal.TagAndDataBytes(), CPutFailIfMissing, NoLogicalReplication, nil)
		require.ErrorAs(t, err, new(*kvpb.WriteTooOldError))
...
func TestMVCCMultiplePutOldTimestamp(t *testing.T) {
	...
	err := MVCCPut(ctx, engine, nil, testKey1, hlc.Timestamp{WallTime: 3}, hlc.ClockTimestamp{}, value1, NoLogicalReplication, nil)
	require.NoError(t, err)
	...
	txn := makeTxn(*txn1, hlc.Timestamp{WallTime: 1})
	txn.Sequence++
	err = MVCCPut(ctx, engine, nil, testKey1, txn.ReadTimestamp, hlc.ClockTimestamp{}, value2, NoLogicalReplication, txn)
	...
	txn.Sequence++
	err = MVCCPut(ctx, engine, nil, testKey1, txn.ReadTimestamp, hlc.ClockTimestamp{}, value3, NoLogicalReplication, txn)
	require.NoError(t, err)
...
func TestMVCCPutNegativeTimestampError(t *testing.T) {
	...
	err := MVCCPut(ctx, engine, nil, testKey1, timestamp, hlc.ClockTimestamp{}, value1, NoLogicalReplication, nil)
...
func TestMVCCAbortTxnWithPreviousVersion(t *testing.T) {
	...
	if err := MVCCPut(ctx, engine, nil, testKey1, hlc.Timestamp{Logical: 1}, hlc.ClockTimestamp{}, value1, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
	if err := MVCCPut(ctx, engine, nil, testKey1, hlc.Timestamp{WallTime: 1}, hlc.ClockTimestamp{}, value2, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
	txn1ts := makeTxn(*txn1, hlc.Timestamp{WallTime: 2})
	if err := MVCCPut(ctx, engine, nil, testKey1, txn1ts.ReadTimestamp, hlc.ClockTimestamp{}, value3, NoLogicalReplication, txn1ts); err != nil {
		t.Fatal(err)
	}
...
func TestMVCCWriteWithDiffTimestampsAndEpochs(t *testing.T) {
	...
	txn := *txn1
	txn.Sequence++
	err := MVCCPut(ctx, engine, nil, testKey1, txn.ReadTimestamp, hlc.ClockTimestamp{}, value1, NoLogicalReplication, &txn)
	require.NoError(t, err)
	...
	err = MVCCPut(ctx, engine, nil, testKey1, txne2.ReadTimestamp, hlc.ClockTimestamp{}, value2, NoLogicalReplication, &txne2)
	require.NoError(t, err)
	// Try a write with an earlier timestamp; this is just ignored.
	txne2.Sequence++
	txne2.WriteTimestamp = hlc.Timestamp{WallTime: 1}
	err = MVCCPut(ctx, engine, nil, testKey1, txne2.ReadTimestamp, hlc.ClockTimestamp{}, value1, NoLogicalReplication, &txne2)
	require.NoError(t, err)
	...
	txne2.Sequence++
	err = MVCCPut(ctx, engine, nil, testKey1, txne2.ReadTimestamp, hlc.ClockTimestamp{}, value3, NoLogicalReplication, &txne2)
	require.NoError(t, err)
	// Resolve the intent.
	txne2Commit := txne2
	...
	err = MVCCPut(ctx, engine, nil, testKey1, hlc.Timestamp{Logical: 1}, hlc.ClockTimestamp{}, value4, NoLogicalReplication, nil)
	var wtoErr *kvpb.WriteTooOldError
	require.ErrorAs(t, err, &wtoErr)
	require.Equal(t, expTS, wtoErr.ActualTimestamp)
	// Verify no value was written.
...
func TestMVCCGetWithDiffEpochsAndTimestamps(t *testing.T) {
	...
	err = MVCCPut(ctx, engine, nil, testKey1, txn1ts.ReadTimestamp, hlc.ClockTimestamp{}, value3, NoLogicalReplication, txn1ts)
	require.NoError(t, err)
...
func TestMVCCGetWithOldEpoch(t *testing.T) {
	...
	if err := MVCCPut(ctx, engine, nil, testKey1, txn1e2.ReadTimestamp, hlc.ClockTimestamp{}, value2, NoLogicalReplication, txn1e2); err != nil {
		t.Fatal(err)
	}
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			for i := enginepb.TxnSeq(0); i < 3; i++ {
				...
				txn.Sequence = 2 + i
				if err := MVCCPut(ctx, engine, nil, key, txn.WriteTimestamp, hlc.ClockTimestamp{}, value1, NoLogicalReplication, &txn); err != nil {
					t.Fatal(err)
				}
			}
...
func TestMVCCResolveWithDiffEpochs(t *testing.T) {
	...
	if err := MVCCPut(ctx, engine, nil, testKey2, txn1e2.ReadTimestamp, hlc.ClockTimestamp{}, value2, NoLogicalReplication, txn1e2); err != nil {
		t.Fatal(err)
	}
...
func TestMVCCResolveTxnNoOps(t *testing.T) {
	...
	if err := MVCCPut(ctx, engine, nil, testKey2, txn1.ReadTimestamp, hlc.ClockTimestamp{}, value2, NoLogicalReplication, txn1); err != nil {
		t.Fatal(err)
	}
...
func TestMVCCResolveTxnRange(t *testing.T) {
	...
	if err := MVCCPut(ctx, engine, nil, testKey2, hlc.Timestamp{Logical: 1}, hlc.ClockTimestamp{}, value2, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
	if err := MVCCPut(ctx, engine, nil, testKey3, txn2.ReadTimestamp, hlc.ClockTimestamp{}, value3, NoLogicalReplication, txn2); err != nil {
		t.Fatal(err)
	}
	if err := MVCCPut(ctx, engine, nil, testKey4, txn1.ReadTimestamp, hlc.ClockTimestamp{}, value4, NoLogicalReplication, txn1); err != nil {
		t.Fatal(err)
	}
...
func TestMVCCResolveTxnRangeResume(t *testing.T) {
	...
	for i := 0; i < 30; i += 3 {
		...
		if err := MVCCPut(ctx, engine, nil, key0, txn1.ReadTimestamp, hlc.ClockTimestamp{}, value1, NoLogicalReplication, txn1); err != nil {
			t.Fatal(err)
		}
		txn2ts := makeTxn(*txn2, hlc.Timestamp{Logical: 2})
		if err := MVCCPut(ctx, engine, nil, key1, txn2ts.ReadTimestamp, hlc.ClockTimestamp{}, value2, NoLogicalReplication, txn2ts); err != nil {
			t.Fatal(err)
		}
		if err := MVCCPut(ctx, engine, nil, key2, hlc.Timestamp{Logical: 3}, hlc.ClockTimestamp{}, value3, NoLogicalReplication, nil); err != nil {
			t.Fatal(err)
		}
	}
...
func writeToEngine(
	...
	for _, p := range puts {
		for i := range p.writeTS {
			...
			require.NoError(t, MVCCPut(ctx, eng, nil, p.key, txn.ReadTimestamp, hlc.ClockTimestamp{}, p.values[i], NoLogicalReplication, txn))
		}
	}
}
...
func TestFindSplitKey(t *testing.T) {
	...
	for i := 0; i < splitReservoirSize; i++ {
		...
		if err := MVCCPut(ctx, engine, ms, []byte(k), hlc.Timestamp{Logical: 1}, hlc.ClockTimestamp{}, val, NoLogicalReplication, nil); err != nil {
			t.Fatal(err)
		}
	}
	...
	for i, test := range testCases {
		t.Run("", func(t *testing.T) {
			...
			for j, keySize := range test.keySizes {
				...
				if err := MVCCPut(ctx, engine, ms, key, hlc.Timestamp{Logical: 1}, hlc.ClockTimestamp{}, val, NoLogicalReplication, nil); err != nil {
					t.Fatal(err)
				}
			}
			targetSize := (ms.KeyBytes + ms.ValBytes) / 2
...
func testPopulateKeysWithVersions(
	...
	for _, k := range keys {
		...
		for j := 1; j <= 3; j++ {
			...
			require.NoError(
				t,
				MVCCPut(ctx, engine, ms, []byte(k), ts, hlc.ClockTimestamp{}, val, NoLogicalReplication, nil),
			)
		}
	}
}
		...
		for _, test := range testData {
			...
			for _, val := range test.vals[i : i+1] {
				if i == len(test.vals)-1 && test.isDeleted {
					if _, err := MVCCDelete(ctx, engine, ms, test.key, val.Timestamp, hlc.ClockTimestamp{}, NoLogicalReplication, nil); err != nil {
						t.Fatal(err)
					}
					continue
				}
				...
				if err := MVCCPut(ctx, engine, ms, test.key, val.Timestamp, hlc.ClockTimestamp{}, valCpy, NoLogicalReplication, nil); err != nil {
					t.Fatal(err)
				}
			}
		}
...
func TestMVCCGarbageCollectNonDeleted(t *testing.T) {
	...
	for _, test := range testData {
		for _, val := range test.vals {
			valCpy := *protoutil.Clone(&val).(*roachpb.Value)
			valCpy.Timestamp = hlc.Timestamp{}
			if err := MVCCPut(ctx, engine, nil, test.key, val.Timestamp, hlc.ClockTimestamp{}, valCpy, NoLogicalReplication, nil); err != nil {
				t.Fatal(err)
			}
		}
...
func TestMVCCGarbageCollectIntent(t *testing.T) {
	...
	key := roachpb.Key("a")
	{
		...
		if err := MVCCPut(ctx, engine, nil, key, ts1, hlc.ClockTimestamp{}, val1, NoLogicalReplication, nil); err != nil {
			t.Fatal(err)
		}
	}
	txn := &roachpb.Transaction{
	...
	if _, err := MVCCDelete(ctx, engine, nil, key, txn.ReadTimestamp, hlc.ClockTimestamp{}, NoLogicalReplication, txn); err != nil {
		t.Fatal(err)
	}
	keys := []kvpb.GCRequest_GCKey{
	...
	runTestCase := func(t *testing.T, tc testCase, engine Engine) {
		...
		for _, key := range tc.keys {
			for _, seconds := range key.timestamps {
				...
				ts := toHLC(seconds)
				if err := MVCCPut(ctx, engine, ms, roachpb.Key(key.key), ts, hlc.ClockTimestamp{}, val, NoLogicalReplication, nil); err != nil {
					t.Fatal(err)
				}
			}
		}
	...
	for _, v := range d {
		if v.rangeTombstone.Timestamp.IsEmpty() {
			if v.point.Value != nil {
				require.NoError(t, MVCCPut(ctx, engine, ms, v.point.Key.Key, v.point.Key.Timestamp, hlc.ClockTimestamp{}, roachpb.MakeValueFromBytes(v.point.Value), NoLogicalReplication, v.txn),
					"failed to insert test value into engine (%s)", v.point.Key.String())
			} else {
				_, err := MVCCDelete(ctx, engine, ms, v.point.Key.Key, v.point.Key.Timestamp, hlc.ClockTimestamp{}, NoLogicalReplication, v.txn)
...
func TestResolveIntentWithLowerEpoch(t *testing.T) {
	...
	if err := MVCCPut(ctx, engine, nil, testKey1, txn1e2.ReadTimestamp, hlc.ClockTimestamp{}, value1, NoLogicalReplication, txn1e2); err != nil {
		t.Fatal(err)
	}
