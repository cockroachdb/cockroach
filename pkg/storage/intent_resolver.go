...
// Returns the number of resolved intents. On success, returns the
// number of resolved intents. On error, a subset of the intents may
// have been resolved, but zero will be returned.
...
// intentResolver's semaphore is maxed out). This method updates the
// metrics for intents resolved on GC on success.
