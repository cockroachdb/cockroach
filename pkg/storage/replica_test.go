...
// correctly.
func testReplicaCommandQueueCancellation(t *testing.T, instructions []cancellationTestInstruction) {
	...
	instructions = append([]cancellationTestInstruction{initial}, instructions...)
...
func TestReplicaCommandQueueCancelSingleDependent(t *testing.T) {
	...
	testReplicaCommandQueueCancellation(t, []cancellationTestInstruction{
		{
			span:   span1,
			cancel: false,
		},
...
func TestReplicaCommandQueueCancelMultipleDependencies(t *testing.T) {
	...
	setup := []cancellationTestInstruction{
		{
...
func TestReplicaCommandQueueCancelChain(t *testing.T) {
	...
	key1 := roachpb.Key("one")
	span1 := roachpb.Span{Key: key1, EndKey: key1.Next()}
	chain := []cancellationTestInstruction{
		{
			span:   span1,
			cancel: false,
		},
