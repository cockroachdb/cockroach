...
func TestReadCompleteAsOfIterator(t *testing.T) {
	...
	tests := []asOfTest{
		...
		{input: "b3c2Xc1d1", expectedNextKey: "c2Xd1", asOf: "2"},
		...
		{input: "b2b1Xc1", expectedNextKey: "b1Xc1", asOf: "1"},
	}
		...
		t.Run(name, func(t *testing.T) {
			...
			for _, subtest := range subtests {
				t.Run(subtest.name, func(t *testing.T) {
					...
					it := NewReadCompleteAsOfIterator(iter, asOf)
...
func TestReadCompleteAsOfIteratorSeek(t *testing.T) {
	defer leaktest.AfterTest(t)()
	defer log.Scope(t).Close(t)
