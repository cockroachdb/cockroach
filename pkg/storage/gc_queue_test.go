...
func TestGCQueueMakeGCScoreLargeAbortSpan(t *testing.T) {
	...
	{
		r := makeGCQueueScoreImpl(context.Background(), seed, hlc.Timestamp{WallTime: storagebase.TxnCleanupThreshold.Nanoseconds()}, ms, zonepb.GCPolicy{TTLSeconds: 10000}, hlc.Timestamp{WallTime: 1})
