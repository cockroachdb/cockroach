...
func TestGCQueueChunkRequests(t *testing.T) {
	...
	// Next write 2 keys, each with keyCount different GC'able versions.
	...
	// each have enough old versions to fill a whole batch each, adding
	// up to four batches in total.
