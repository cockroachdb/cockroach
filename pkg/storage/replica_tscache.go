...
//    or being written in the first place if a PushTxn(ABORT) has succeeded.
//    This mechanism ensures that a transaction never needs to explicitly create
//    the transaction record for concurrent actors.
//
