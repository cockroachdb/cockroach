...
func cmdIterNew(e *evalCtx) error {
	...
	mit := newMetamorphicIterator(e.t, e.metamorphicIterSeed(), iter)
	iter = &metamorphicMVCCIterator{mit}
...
func cmdIterScan(e *evalCtx) error {
	...
	if iit := e.tryMVCCIncrementalIter(); iit == nil {
...
func checkAndUpdateRangeKeyChanged(e *evalCtx) bool {
	...
	if e.tryMVCCIncrementalIter() != nil {
		return false
	}
	...
	e.t.Logf("rangeKeys is now %s", e.iterRangeKeys)
...
func (e *evalCtx) visit(fn func(it SimpleMVCCIterator) (done bool)) {
	iter := e.iter
	if iter == nil {
		return
	}
...
func (e *evalCtx) mvccIter() MVCCIterator {
	...
	e.visit(func(it SimpleMVCCIterator) (done bool) {
		iter, done = it.(MVCCIterator)
		return done
	})
	require.NotNil(e.t, iter)
	return iter
}
...
func (e *evalCtx) tryMVCCIncrementalIter() *MVCCIncrementalIterator {
	var iter *MVCCIncrementalIterator
	e.visit(func(it SimpleMVCCIterator) (done bool) {
		iter, done = it.(*MVCCIncrementalIterator)
		return done
	})
	return iter
}
