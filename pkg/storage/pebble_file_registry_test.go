...
func TestFileRegistryOps(t *testing.T) {
	...
	// {file3 => foo}
	require.Error(t, registry.MaybeCopyEntry("file7", "file4"))
	require.NoError(t, registry.MaybeDeleteEntry("file4"))
	...
	// Errors
	require.Error(t, registry.MaybeCopyEntry("file4", "file5"))
