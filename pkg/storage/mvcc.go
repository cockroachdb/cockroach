...
const (
	...
	// TargetLockConflictBytesErrorDefault is the default value for maximum
	// size of locks reported by ExportToSST and Scan operations in
	// LockConflictError. This value
	// is subject to tuning in real environment as we have more data available.
	TargetLockConflictBytesErrorDefault = 8388608
)
...
var TargetLockConflictBytesError = settings.RegisterIntSetting(
	settings.ApplicationLevel,
	"storage.mvcc.target_bytes_per_error",
	"maximum total lock size returned in errors during evaluation",
	TargetLockConflictBytesErrorDefault,
