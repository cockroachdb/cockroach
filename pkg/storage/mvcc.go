...
func MVCCGet(
	...
	iter := newMVCCIterator(reader, timestamp == (hlc.Timestamp{}), IterOptions{Prefix: true})
	defer iter.Close()
...
func MVCCScan(
	...
	iter := newMVCCIterator(reader, timestamp == (hlc.Timestamp{}), IterOptions{LowerBound: key, UpperBound: endKey})
	defer iter.Close()
...
func MVCCIterate(
	...
	iter := newMVCCIterator(
		reader, timestamp == (hlc.Timestamp{}), IterOptions{LowerBound: key, UpperBound: endKey})
	defer iter.Close()
