...
//
// If passed a non-nil ms, this function handles the stats computations to
// determine the correct incremental deltas of clearing these keys (and
// correctly determining if it does or not not change the live and gc keys).
func MVCCClearTimeRange(
	...
	// the next KV to iterate over. This patters allows us to quickly skip over
