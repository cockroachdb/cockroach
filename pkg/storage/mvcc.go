...
// SwitchIterInBuf switches to iter, and relinquishes ownership of the
// existing iter.
func SwitchIterInBuf(iterAndBuf IterAndBuf, iter MVCCIterator) IterAndBuf {
	iterAndBuf.iter = iter
	return iterAndBuf
}
