...
// raftSnapshotQueueMinimumTimeout is an escape hatch to raise the minimum
// timeout for sending a raft snapshot which is sent much more slowly than the
// allowable rate as specified by kv.snapshot_recovery.max_rate. See the
// timeoutFunc in newRaftSnapshotQueue.
