...
// TestStoreRangeMergeTimestampCacheCausality verifies that range
// merges update the clock on the subsuming store as necessary to preserve
// causality.
//
...
// S3 holds the lease on A, while S4 holds the lease on B. Every store's clock
// starts at time T1.
//
