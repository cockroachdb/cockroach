...
func TestStoreRangeMergeRHSLeaseExpiration(t *testing.T) {
	...
	// on the replica between when the lease acquired by the first request is
	// installed and when the mergeComplete channel is installed. (This race has
	// since been fixed by installing the mergeComplete channel before the new
	// lease.)
