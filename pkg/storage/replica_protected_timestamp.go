...
// time will apply. It returns false if it may not. If the state of the cache
// is not sufficiently new to determine whether the record will apply, the cache
// is refreshed and then the check is performed again.
