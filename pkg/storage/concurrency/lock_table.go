...
// part of the specified transaction. It returns whether one of those writers
// was the distinguished waiter.
// REQUIRES: l.mu is locked.
func (l *lockState) releaseWritersFromTxn(txn *enginepb.TxnMeta) (releasedDistinguished bool) {
