...
// Bootstrapped tells the store that it was bootstrapped and allows the store
// to campaign idle replicas immediately. This primarily affects tests.
func (s *Store) Bootstrapped() {
	s.idleReplicaElectionTime.Lock()
