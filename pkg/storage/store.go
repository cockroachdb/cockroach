...
func (s *Store) ForceSplitScanAndProcess() {
	mustForceScanAndProcess(context.TODO(), s, s.splitQueue.baseQueue)
}
...
func (s *Store) ForceTimeSeriesMaintenanceQueueProcess() {
	mustForceScanAndProcess(context.TODO(), s, s.tsMaintenanceQueue.baseQueue)
}
...
func (s *Store) ForceRaftSnapshotQueueProcess() {
	mustForceScanAndProcess(context.TODO(), s, s.raftSnapshotQueue.baseQueue)
}
