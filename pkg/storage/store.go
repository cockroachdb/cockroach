...
type StoreTestingKnobs struct {
	...
	// RefreshReasonTicksPeriodicity overrides the default periodicity in which
	// pending commands are refreshed. The period is specified as a multiple of
	// Raft group ticks.
	RefreshReasonTicksPeriodicity int
