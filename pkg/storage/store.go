...
const (
	...
	snapshotApplySemBusyMsg = "store already applying snapshot or removing replica"
...
// non-empty rejectionMessage indicates the reservation was declined.
func (s *Store) reserveSnapshot(
	ctx context.Context, header *SnapshotRequest_Header,
) (cleanup func(), rejectionMsg string, err error) {
