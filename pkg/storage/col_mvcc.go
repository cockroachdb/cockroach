...
// the storage.CFetcherWrapper in order to implement a subset of the
...
func (f *mvccScanFetchAdapter) NextKV(
	...
	case MVCCDecodingRequired:
		...
		if err != nil {
			return false, false, kv, errors.AssertionFailedf("invalid encoded mvcc key: %x", encKey)
		}
