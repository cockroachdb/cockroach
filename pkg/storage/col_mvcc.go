...
// - ContinuesFirstRow and MaybeTrimPartialLastRow are used by the lower layer
// to aid the implementation of the `results` interface which needs to
// introspect what has already been included into the coldata.Batch'es in the
// colfetcher.cFetcher.
