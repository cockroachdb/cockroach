...
func TestNeedsSystemConfig(t *testing.T) {
	...
	bqNeedsSysCfg := makeTestBaseQueue("test", testQueue, tc.store, emptyGossip, queueConfig{needsSystemConfig: true, maxSize: 1})
	...
	bqNoSysCfg := makeTestBaseQueue("test", testQueue, tc.store, emptyGossip, queueConfig{needsSystemConfig: false, maxSize: 1})
