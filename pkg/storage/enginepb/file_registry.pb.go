...
const (
	// The old protobuf-based version.
	RegistryVersion_Base RegistryVersion = 0
	// The current records-based version.
...
func (m *NamedFileEntry) Reset()         { *m = NamedFileEntry{} }
func (m *NamedFileEntry) String() string { return proto.CompactTextString(m) }
func (*NamedFileEntry) ProtoMessage()    {}
func (*NamedFileEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_1c23ce5e71079250, []int{2}
}
func (m *NamedFileEntry) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *NamedFileEntry) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *NamedFileEntry) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NamedFileEntry.Merge(m, src)
}
func (m *NamedFileEntry) XXX_Size() int {
	return m.Size()
}
func (m *NamedFileEntry) XXX_DiscardUnknown() {
	xxx_messageInfo_NamedFileEntry.DiscardUnknown(m)
}

var xxx_messageInfo_NamedFileEntry proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*NamedFileEntry)(nil), "cockroach.storage.enginepb.NamedFileEntry")
}
...
var fileDescriptor_1c23ce5e71079250 = []byte{
	...
	,
}
...
func (m *NamedFileEntry) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *NamedFileEntry) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *NamedFileEntry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *NamedFileEntry) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *NamedFileEntry) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: NamedFileEntry: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: NamedFileEntry: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
