...
func (*MVCCMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc_bf47292549509b01, []int{0}
}
...
func (*MVCCMetadata_SequencedIntent) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc_bf47292549509b01, []int{0, 0}
}
...
func (*MVCCMetadataSubsetForMergeSerialization) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc_bf47292549509b01, []int{1}
}
...
func (*MVCCStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc_bf47292549509b01, []int{2}
}
...
func (*MVCCStatsLegacyRepresentation) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc_bf47292549509b01, []int{3}
}
...
func init() { proto.RegisterFile("storage/enginepb/mvcc.proto", fileDescriptor_mvcc_bf47292549509b01) }

var fileDescriptor_mvcc_bf47292549509b01 = []byte{
