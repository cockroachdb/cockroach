...
func (*MVCCMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc_b0add2c614d42689, []int{0}
}
...
func (*MVCCMetadata_SequencedIntent) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc_b0add2c614d42689, []int{0, 0}
}
...
func (*MVCCMetadataSubsetForMergeSerialization) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc_b0add2c614d42689, []int{1}
}
...
type MVCCStats struct {
	...
	// AbortSpan. These bytes are a subset of sys_bytes.
...
func (*MVCCStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc_b0add2c614d42689, []int{2}
}
...
func init() { proto.RegisterFile("storage/enginepb/mvcc.proto", fileDescriptor_mvcc_b0add2c614d42689) }

var fileDescriptor_mvcc_b0add2c614d42689 = []byte{
