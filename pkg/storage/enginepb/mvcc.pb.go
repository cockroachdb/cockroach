...
type MVCCMetadata struct {
	...
	// than one Put without an intervening Delete. We assume that it is
	// common for this to be true. The default is false to accommodate code
	// that did not track this state.
	// This is used as an optimization when writing MVCCMetadata to the
	// separated lock key space, where the key for MVCCMetadata is unique per
	// transaction. In that case, when this is true, one can optimize removal of
	// the MVCCMetadata by doing a SingleDelete instead of Delete.
	TxnDidNotUpdateMeta bool `protobuf:"varint,9,opt,name=txn_did_not_update_meta,json=txnDidNotUpdateMeta" json:"txn_did_not_update_meta"`
}

func (m *MVCCMetadata) Reset()      { *m = MVCCMetadata{} }
func (*MVCCMetadata) ProtoMessage() {}
func (*MVCCMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc_3e4def3ac392fcc6, []int{0}
}
...
func (*MVCCMetadata_SequencedIntent) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc_3e4def3ac392fcc6, []int{0, 0}
}
...
func (*MVCCMetadataSubsetForMergeSerialization) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc_3e4def3ac392fcc6, []int{1}
}
...
func (*MVCCStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc_3e4def3ac392fcc6, []int{2}
}
...
func (*MVCCStatsLegacyRepresentation) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc_3e4def3ac392fcc6, []int{3}
}
...
func (this *MVCCMetadata) Equal(that interface{}) bool {
	...
	if this.TxnDidNotUpdateMeta != that1.TxnDidNotUpdateMeta {
		return false
	}
	return true
}
...
func NewPopulatedMVCCMetadata(r randyMvcc, easy bool) *MVCCMetadata {
	...
	this.TxnDidNotUpdateMeta = bool(bool(r.Intn(2) == 0))
	if !easy && r.Intn(10) != 0 {
	}
	return this
}
...
func (m *MVCCMetadata) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			...
			m.TxnDidNotUpdateMeta = bool(v != 0)
		default:
			iNdEx = preIndex
...
func init() { proto.RegisterFile("storage/enginepb/mvcc.proto", fileDescriptor_mvcc_3e4def3ac392fcc6) }

var fileDescriptor_mvcc_3e4def3ac392fcc6 = []byte{
	// 775 bytes of a gzipped FileDescriptorProto
	,
}
