...
func (*MVCCMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc_559684ca8c4034f5, []int{0}
}
...
func (*MVCCMetadata_SequencedIntent) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc_559684ca8c4034f5, []int{0, 0}
}
...
func (*MVCCStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc_559684ca8c4034f5, []int{1}
}
...
func init() { proto.RegisterFile("storage/enginepb/mvcc.proto", fileDescriptor_mvcc_559684ca8c4034f5) }

var fileDescriptor_mvcc_559684ca8c4034f5 = []byte{
	// 655 bytes of a gzipped FileDescriptorProto
	,
}
