...
type TxnMeta struct {
	...
	//       transaction commits.
	//
	WriteTimestamp TxnTimestamp `protobuf:"bytes,5,opt,name=write_timestamp,json=writeTimestamp,proto3,casttype=TxnTimestamp" json:"write_timestamp"`
	...
	//    to have been alive.
	MinTimestamp TxnTimestamp `protobuf:"bytes,9,opt,name=min_timestamp,json=minTimestamp,proto3,casttype=TxnTimestamp" json:"min_timestamp"`
...
func (*TxnMeta) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_be904b17dffa4ef8, []int{0}
}
...
func (*IgnoredSeqNumRange) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_be904b17dffa4ef8, []int{1}
}
...
func (*MVCCStatsDelta) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_be904b17dffa4ef8, []int{2}
}
...
func (*MVCCPersistentStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_be904b17dffa4ef8, []int{3}
}
...
func (*RangeAppliedState) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_be904b17dffa4ef8, []int{4}
}
...
type MVCCWriteValueOp struct {
	...
	Timestamp TxnTimestamp `protobuf:"bytes,2,opt,name=timestamp,proto3,casttype=TxnTimestamp" json:"timestamp"`
...
func (*MVCCWriteValueOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_be904b17dffa4ef8, []int{5}
}
...
type MVCCWriteIntentOp struct {
	...
	TxnMinTimestamp TxnTimestamp                                        `protobuf:"bytes,4,opt,name=txn_min_timestamp,json=txnMinTimestamp,proto3,casttype=TxnTimestamp" json:"txn_min_timestamp"`
	Timestamp       TxnTimestamp                                        `protobuf:"bytes,3,opt,name=timestamp,proto3,casttype=TxnTimestamp" json:"timestamp"`
}
...
func (*MVCCWriteIntentOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_be904b17dffa4ef8, []int{6}
}
...
func (*MVCCUpdateIntentOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_be904b17dffa4ef8, []int{7}
}
...
func (*MVCCCommitIntentOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_be904b17dffa4ef8, []int{8}
}
...
func (*MVCCAbortIntentOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_be904b17dffa4ef8, []int{9}
}
...
func (*MVCCAbortTxnOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_be904b17dffa4ef8, []int{10}
}
...
func (*MVCCLogicalOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_be904b17dffa4ef8, []int{11}
}
...
func NewPopulatedTxnMeta(r randyMvcc3, easy bool) *TxnMeta {
	...
	v3 := NewPopulatedTxnTimestamp(r, easy)
	...
	v4 := NewPopulatedTxnTimestamp(r, easy)
...
func init() {
	proto.RegisterFile("storage/enginepb/mvcc3.proto", fileDescriptor_mvcc3_be904b17dffa4ef8)
}

var fileDescriptor_mvcc3_be904b17dffa4ef8 = []byte{
	// 1206 bytes of a gzipped FileDescriptorProto
	,
}
