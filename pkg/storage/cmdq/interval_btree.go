...
// desc descends into the node's child at position pos. It maintains a stack of
// (parent, position) pairs so that the tree can be ascended again later.
func (i *iterator) desc(n *node, pos int16) {
	if i.s == nil {
		i.s = i.sBuf[:0]
	}
