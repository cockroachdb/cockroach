...
// MVCCRangeTombstoneIterator iterates over range tombstones in an engine,
// defragmenting them into contiguous range tombstones. It does not support
