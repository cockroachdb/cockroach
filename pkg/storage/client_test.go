...
// advanceClock advances the manual clock such that all expiration-based leases
// become expired. The liveness records all the nodes will also become expired
// on the new clock value (and this will cause all the epoch-based leases to be
// considered expired until the liveness record is heartbeated).
