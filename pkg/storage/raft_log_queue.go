...
const (
	...
	// truncate even if there are fewer entries to truncate. The value of 64 KB
	// was chosen experimentally by looking at when Raft log truncation usually
	// occurs when using the number of entries as the sole criteria.
