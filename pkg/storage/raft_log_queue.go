...
func computeTruncateDecision(input truncateDecisionInput) truncateDecision {
	// XXX: (Ask about this during review) We're using progress.RecentActive to
	// determine recent activity, and only care about lagging followers that
	// were recently active. Is this proper usage of RecentActive?
	...
	//
	// XXX: (Ask about this during review) Is the comment above still applicable?
