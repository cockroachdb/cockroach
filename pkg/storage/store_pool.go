...
const (
	// storeMatchDead - the store is not yet available or has been timed out.
	storeMatchDead storeMatch = iota
	// storeMatchAlive - the store is alive, but its attributes didn't match
	// the required ones.
	storeMatchAlive
	// storeMatchThrottled - the store is alive and its attributes matched, but
	// it is throttled.
	storeMatchThrottled
	// storeMatchReplicaCorrupted - the store is alive and its attributes
	// matched, but a replica for the same rangeID was recently discovered to
	// be corrupt.
	storeMatchReplicaCorrupted
	// storeMatchAvailable - the store is alive, available and its attributes
	// matched.
	storeMatchAvailable
)
