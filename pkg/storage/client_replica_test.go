...
func TestSystemZoneConfigs(t *testing.T) {
	...
	// innopportune time (or on the replicate queue blocking on a needed split
	...
	// effectively waiting on replica GC to kick in, since the testcluster
	// waits until nothing is underreplicated).
