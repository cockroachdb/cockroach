...
// Package apply provides abstractions and routines associated with the
...
func (t *Task) applyOneBatch(ctx context.Context, iter CommandIterator) error {
	...
	// Acknowledge the outcome of each command.
	return forEachAppliedCmdIter(appliedIter, AppliedCommand.AckOutcomeAndFinish)
}
