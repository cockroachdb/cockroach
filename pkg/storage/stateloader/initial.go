...
func WriteInitialReplicaState(
	...
	// useLegacyTruncatedState argument).
	...
	newMS, err := rsl.Save(ctx, eng, s, useLegacyTruncatedState)
	if err != nil {
		return enginepb.MVCCStats{}, err
	}
...
func WriteInitialState(
	...
	newMS, err := WriteInitialReplicaState(
		ctx, eng, ms, desc, lease, gcThreshold, txnSpanGCThreshold, bootstrapVersion, useLegacyTruncatedState)
	if err != nil {
		return enginepb.MVCCStats{}, err
	}
