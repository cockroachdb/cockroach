...
func (rsl StateLoader) SetGCThreshold(
	ctx context.Context, readWriter engine.ReadWriter, ms *enginepb.MVCCStats, threshold *hlc.Timestamp,
) error {
	if threshold == nil {
...
func (rsl StateLoader) SynthesizeRaftState(ctx context.Context, readWriter engine.ReadWriter) error {
