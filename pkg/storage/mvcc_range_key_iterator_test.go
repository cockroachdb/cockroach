...
// TestMVCCRangeKeyIteratorPebbleTimestampBounds tests that MVCCRangeKeyIterator
// and pebbleIterator returns appropriate range bounds, even in corner cases
// where Pebble has range keys split in the middle of timestamps. Pebble should
// defragment these range keys internally.
func TestMVCCIRangeKeyteratorPebbleTimestampBounds(t *testing.T) {
	defer leaktest.AfterTest(t)()
	...
	// Scan the fragmented range keys. Pebble should return fragments
	// without timestamp bounds.
