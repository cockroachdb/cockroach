...
func ParseProvisionedRate(value string) (ProvisionedRate, error) {
	...
	if err != nil || bps == 0 {
		return ProvisionedRate{}, errors.Errorf("provisioned rate has invalid bandiwdth value %q", subValue)
	}
