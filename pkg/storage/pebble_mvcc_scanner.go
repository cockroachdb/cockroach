...
// one MVCCGet / MVCCScan call. Note that this struct must be used in the
// implementation of MVCCGet / MVCCScan as it implements the logic to deal with
// child transactions.
...
// transaction or one of its parents. If the intent is owned by the reading
// transactions or any of its ancestors, the relevant epoch, sequence number,
