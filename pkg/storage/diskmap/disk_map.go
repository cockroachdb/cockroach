...
type Factory interface {
	// NewMap returns a fresh SortedDiskMap with no contents.
	NewMap() SortedDiskMap
	// NewMultiMap returns a fresh SortedDiskMap with no contents that permits
	// duplicate keys.
	NewMultiMap() SortedDiskMap
}
