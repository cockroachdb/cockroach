...
//
// MVCCIncrementalIterator will return an error if it encounters an
// inline value (non-user data).
//
// Intents outside the time bounds are ignored. Intents inside the
// time bounds are handled according to the provided
// MVCCIncrementalIterIntentPolicy.
//
//
...
const (
	...
	// MVCCIncrementaIterIntentPolicyEmit will return intents to
...
const (
	...
	// MVCCIncrementaIterInlinePolicyEmit will return inline
