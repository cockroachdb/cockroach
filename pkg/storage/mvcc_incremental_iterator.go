...
// NumIntentErrors returns number of intents encountered during iteration.
...
// GetIntentError returns roachpb.WriteIntentError with all intents collected
// in the iterator. If iterator collected no intents or if intent aggregation
