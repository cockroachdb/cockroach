...
// resolveMetaAndCheckForIntentOrInline resolves the MVCCMetadata, and throws an
...
func (i *MVCCIncrementalIterator) resolveMetaAndCheckForIntentOrInline() error {
...
func (i *MVCCIncrementalIterator) advance() {
	for {
		...
		if err := i.resolveMetaAndCheckForIntentOrInline(); err != nil {
			return
		}
