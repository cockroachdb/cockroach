...
func (m *metamorphicMVCCIncrementalIterator) TryGetIntentError(TargetSize uint64) error {
	return m.it.(*storage.MVCCIncrementalIterator).TryGetIntentError(TargetSize)
}
