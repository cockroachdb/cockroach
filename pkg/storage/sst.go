...
func CheckSSTConflicts(
	...
	maxLockConflicts, targetBytesPerLockConflict int64,
	usePrefixSeek bool,
	...
	if locks, err := ScanLocks(
		ctx, reader, start.Key, end.Key, maxLockConflicts, targetBytesPerLockConflict, BatchEvalReadCategory); err != nil {
