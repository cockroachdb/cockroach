...
// Set the {raft,lease} applied index values, properly accounting for existing
// keys in the returned stats.
...
// Set the {raft,lease} applied index values using a "blind" put which ignores
// any existing keys. This is identical to setAppliedIndex but is used to
// optimize the writing of the applied index values during write operations
// where we definitively know the size of the previous values.
