...
// GetTerm returns the term of the given entry in the raft log.
...
func (rec ReplicaEvalContext) GetMVCCStats() (enginepb.MVCCStats, error) {
	...
	return rec.ReplicaI.GetMVCCStats(), nil
}
...
func (rec ReplicaEvalContext) GetGCThreshold() (hlc.Timestamp, error) {
	...
	return rec.ReplicaI.GetGCThreshold(), nil
}
...
func (rec ReplicaEvalContext) GetTxnSpanGCThreshold() (hlc.Timestamp, error) {
	...
	return rec.ReplicaI.GetTxnSpanGCThreshold(), nil
}

// GetTxnSpanGCThreshold returns the time of the replica's last transactino span
// GC.
...
func (rec ReplicaEvalContext) GetLastReplicaGCTimestamp(
	...
	return rec.ReplicaI.GetLastReplicaGCTimestamp(ctx)
}
...
func (rec ReplicaEvalContext) GetLease() (roachpb.Lease, *roachpb.Lease, error) {
	...
	lease, nextLease := rec.ReplicaI.GetLease()
