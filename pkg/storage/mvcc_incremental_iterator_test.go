...
func TestMVCCIncrementalIteratorInlinePolicy(t *testing.T) {
	...
	for _, engineImpl := range mvccEngineImpls {
		...
		t.Run(engineImpl.name, func(t *testing.T) {
			t.Run("MVCCIncrementalIteratorInlinePolicyError returns error if inline value is found", func(t *testing.T) {
				iter := NewMVCCIncrementalIterator(e, MVCCIncrementalIterOptions{
					EndKey:       keyMax,
					StartTime:    tsMin,
					EndTime:      tsMax,
			...
			t.Run("MVCCIncrementalIteratorInlinePolicyEmit returns inline values to caller", func(t *testing.T) {
				iter := NewMVCCIncrementalIterator(e, MVCCIncrementalIterOptions{
					EndKey:       keyMax,
					StartTime:    tsMin,
					EndTime:      tsMax,
...
func TestMVCCIncrementalIteratorIntentPolicy(t *testing.T) {
	...
	for _, engineImpl := range mvccEngineImpls {
		...
		t.Run(engineImpl.name, func(t *testing.T) {
			t.Run("MVCCIncrementalIteratorIntentPolicyError returns error if an intent is found in time range", func(t *testing.T) {
				iter := NewMVCCIncrementalIterator(e, MVCCIncrementalIterOptions{
					EndKey:       keyMax,
					StartTime:    tsMin,
					EndTime:      tsMax,
			...
			t.Run("MVCCIncrementalIteratorIntentPolicyError ignores intents outside of time range", func(t *testing.T) {
				iter := NewMVCCIncrementalIterator(e, MVCCIncrementalIterOptions{
					EndKey:       keyMax,
					StartTime:    ts2,
					EndTime:      tsMax,
			...
			t.Run("MVCCIncrementalIteratorIntentPolicyEmit returns inline values to caller", func(t *testing.T) {
				iter := NewMVCCIncrementalIterator(e, MVCCIncrementalIterOptions{
					EndKey:       keyMax,
					StartTime:    tsMin,
					EndTime:      tsMax,
			...
			t.Run("MVCCIncrementalIteratorIntentPolicyEmit ignores intents outside of time range", func(t *testing.T) {
				iter := NewMVCCIncrementalIterator(e, MVCCIncrementalIterOptions{
					EndKey:       keyMax,
					StartTime:    ts2,
					EndTime:      tsMax,
