...
func TestMVCCIncrementalIterator(t *testing.T) {
	...
	for _, engineImpl := range mvccEngineImpls {
		t.Run(engineImpl.name+"-latest", func(t *testing.T) {
			...
			t.Run("del", assertEqualKVs(e, localMax, keyMax, ts1, tsMax, latest, kvs(kv1Deleted3, kv2_2_2), nil))
			...
			t.Run("intents-filtered-1", assertEqualKVs(e, localMax, keyMax, tsMin, ts3, latest, kvs(kv1Deleted3, kv2_2_2), nil))
	...
	for _, engineImpl := range mvccEngineImpls {
		t.Run(engineImpl.name+"-all", func(t *testing.T) {
			...
			t.Run("del", assertEqualKVs(e, localMax, keyMax, ts1, tsMax, all, kvs(kv1Deleted3, kv1_2_2, kv2_2_2), nil))
			...
			t.Run("intents-multi",
				assertEqualKVs(e, testKey1, testKey2.PrefixEnd(), tsMin, tsMax, all, nil, intents(intentErr1, intentErr2)))
			// Intents above the upper time bound or beneath the lower time bound must
			// be ignored (#28358). Note that the lower time bound is exclusive while
			// the upper time bound is inclusive.
			t.Run("intents-filtered-1", assertEqualKVs(e, localMax, keyMax, tsMin, ts3, all, kvs(kv1Deleted3, kv1_2_2, kv1_1_1, kv2_2_2), nil))
			...
			t.Run("intents-resolved", assertEqualKVs(e, localMax, keyMax, tsMin, tsMax, all, kvs(kv1_4_4, kv1Deleted3, kv1_2_2, kv1_1_1, kv2_2_2), nil))
		})
	}
}
