...
// RemovingOrRemoved returns whether the replica is removed or in the process of
// being removed.
func (s destroyStatus) RemovingOrRemoved() bool {
...
func (r *Replica) setTombstoneKey(
	...
	if nextReplicaID > r.mu.tombstoneReplicaID {
		r.mu.tombstoneReplicaID = nextReplicaID
	}
	r.mu.Unlock()
