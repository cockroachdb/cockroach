...
func TestMVCCStatsDeleteCommitMovesTimestamp(t *testing.T) {
	...
	if err := MVCCPut(ctx, engine, aggMS, key, ts1, hlc.ClockTimestamp{}, value, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
	...
	if _, err := MVCCDelete(ctx, engine, aggMS, key, txn.ReadTimestamp, hlc.ClockTimestamp{}, NoLogicalReplication, txn); err != nil {
		t.Fatal(err)
	}
...
func TestMVCCStatsPutCommitMovesTimestamp(t *testing.T) {
	...
	value := roachpb.MakeValueFromString("value")
	if err := MVCCPut(ctx, engine, aggMS, key, ts1, hlc.ClockTimestamp{}, value, NoLogicalReplication, txn); err != nil {
		t.Fatal(err)
	}
...
func TestMVCCStatsPutPushMovesTimestamp(t *testing.T) {
	...
	// Write an intent.
	value := roachpb.MakeValueFromString("value")
	if err := MVCCPut(ctx, engine, aggMS, key, txn.ReadTimestamp, hlc.ClockTimestamp{}, value, NoLogicalReplication, txn); err != nil {
		t.Fatal(err)
	}
...
func TestMVCCStatsDelDelCommitMovesTimestamp(t *testing.T) {
	...
	if _, err := MVCCDelete(ctx, engine, aggMS, key, ts1, hlc.ClockTimestamp{}, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
...
func TestMVCCStatsPutDelPutMovesTimestamp(t *testing.T) {
	...
	t.Run("Put", func(t *testing.T) {
		...
		txn.WriteTimestamp.Forward(ts3)
		if err := MVCCPut(ctx, engine, &aggMS, key, txn.ReadTimestamp, hlc.ClockTimestamp{}, val2, NoLogicalReplication, txn); err != nil {
			t.Fatal(err)
		}
...
func TestMVCCStatsDelDelGC(t *testing.T) {
	...
	if _, err := MVCCDelete(ctx, engine, aggMS, key, ts2, hlc.ClockTimestamp{}, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
...
func TestMVCCStatsPutWaitDeleteGC(t *testing.T) {
	...
	if err := MVCCPut(ctx, engine, aggMS, key, ts1, hlc.ClockTimestamp{}, val1, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
...
func TestMVCCStatsTxnSysPutPut(t *testing.T) {
	...
	val1 := roachpb.MakeValueFromString("value")
	if err := MVCCPut(ctx, engine, aggMS, key, txn.ReadTimestamp, hlc.ClockTimestamp{}, val1, NoLogicalReplication, txn); err != nil {
		t.Fatal(err)
	}
...
func TestMVCCStatsSysPutPut(t *testing.T) {
	...
	if err := MVCCPut(ctx, engine, aggMS, key, ts2, hlc.ClockTimestamp{}, val2, NoLogicalReplication, nil); err != nil {
		t.Fatal(err)
	}
...
func TestMVCCStatsRandomized(t *testing.T) {
	...
	actions["Put"] = func(s *state) (bool, string) {
		if err := MVCCPut(ctx, s.batch, s.MSDelta, s.key, s.TS, hlc.ClockTimestamp{}, s.rngVal(), NoLogicalReplication, s.Txn); err != nil {
	...
	actions["InitPut"] = func(s *state) (bool, string) {
		...
		if err := MVCCInitPut(ctx, s.batch, s.MSDelta, s.key, s.TS, hlc.ClockTimestamp{}, s.rngVal(), failOnTombstones, NoLogicalReplication, s.Txn); err != nil {
			return false, desc + ": " + err.Error()
		}
		return true, desc
	}
	actions["Del"] = func(s *state) (bool, string) {
		if _, err := MVCCDelete(ctx, s.batch, s.MSDelta, s.key, s.TS, hlc.ClockTimestamp{}, NoLogicalReplication, s.Txn); err != nil {
			return false, err.Error()
		}
		return true, ""
	}
