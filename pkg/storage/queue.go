...
// this early. The `MaybeAddCallback` method can be used to receive notification
// of a replica making it all the way through the queue and being processed.
//
...
// returns false. If the replica this attaches to is dropped from an overfull
// queue, this callback is never called.
