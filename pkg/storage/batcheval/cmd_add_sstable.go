...
func EvalAddSSTable(
	...
	if args.DisallowShadowing {
		if err := checkForKeyCollisions(ctx, batch, mvccStartKey, mvccEndKey, args.Data); err != nil {
			return result.Result{}, errors.Wrap(err, "checking key collisions for IMPORT INTO")
		}
	}
...
func checkForKeyCollisions(
	...
	// Create iterator over the SST being added.
	...
	var checkErr error
	if checkErr = engine.CheckForKeyCollisions(existingDataIter, sstIterator); checkErr != nil {
		return checkErr
	}
