...
//
// Provided the merge transaction has placed intents on the local copy and
// meta2's copy of the right-hand side's descriptor before sending a
// GetSnapshotForMerge, these four guarantees combine to ensure a correct merge.
// If the merge transaction commits, the right-hand side never serves another
// request. If the merge transaction aborts, the right-hand side resumes
