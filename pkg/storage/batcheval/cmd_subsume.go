...
// SubsumeRequest, these four guarantees combine to ensure a correct merge. If
// the merge transaction commits, the right-hand side never serves another
...
func Subsume(
	...
	// NOTE: we don't check whether an intent has been laid down on the range's
	// meta2 descriptor, but that is just as importance to correctness.
