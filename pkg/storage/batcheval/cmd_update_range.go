...
func init() {
	RegisterCommand(roachpb.UpdateRange, DefaultDeclareKeys, UpdateRange)
}

// UpdateRange scans the key range specified by start key through end
...
func UpdateRange(
	...
	args := cArgs.Args.(*roachpb.UpdateRangeRequest)
	h := cArgs.Header
