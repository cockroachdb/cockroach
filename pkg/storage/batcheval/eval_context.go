...
// For technical reasons, the interface is implemented by a wrapper .Impl().
...
// Impl returns the MockEvalCtx as an EvalContext. Modifications to the
// MockEvalContext are reflected in the impl.
func (m *MockEvalCtx) Impl() EvalContext {
