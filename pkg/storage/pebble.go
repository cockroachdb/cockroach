...
func minPebbleFormatVersionInCluster(clusterVersion roachpb.Version) pebble.FormatMajorVersion {
	...
	for _, k := range pebbleFormatVersionKeys {
		...
		//
		// Say that pebbleFormatVersionMap defines a new Pebble format version 19 at
		...
		// to upgrade their version, which includes bumping the Pebble format to 19,
		...
		// ratcheted to Pebble format 19 and are ready to accept sstables in the new
