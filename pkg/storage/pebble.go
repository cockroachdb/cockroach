...
// When this value is larger than the max concurrency, this value takes
// precedence (i.e. the max concurrency will also equal this value).
//
// This value is temporarily overridden while
...
// the two.
//
// In all cases, this value is temporarily overridden while
// crdb_internal.set_compaction_concurrency is running (which uses
// SetCompactionConcurrency).
