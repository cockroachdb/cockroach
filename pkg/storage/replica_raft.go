...
// apply.ErrRemoved.
func maybeFatalOnRaftReadyErr(ctx context.Context, expl string, err error) {
	switch err {
	case nil, apply.ErrRemoved:
	default:
		log.FatalfDepth(ctx, 1, "%s: %+v", log.Safe(expl), err) // TODO(bdarnell)
	}
}
