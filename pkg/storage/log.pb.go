...
type RangeLogEvent_Info struct {
	UpdatedDesc    *cockroach_roachpb1.RangeDescriptor  `protobuf:"bytes,1,opt,name=updated_desc,json=updatedDesc" json:"UpdatedDesc,omitempty"`
	NewDesc        *cockroach_roachpb1.RangeDescriptor  `protobuf:"bytes,2,opt,name=new_desc,json=newDesc" json:"NewDesc,omitempty"`
...
func (m *RangeLogEvent_Info) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.UpdatedDesc == nil {
				m.UpdatedDesc = &cockroach_roachpb1.RangeDescriptor{}
			}
		...
		case 2:
			...
			if m.NewDesc == nil {
				m.NewDesc = &cockroach_roachpb1.RangeDescriptor{}
			}
...
var fileDescriptorLog = []byte{
	...
	,
}
