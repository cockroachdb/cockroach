...
func ClearRangeWithHeuristic(reader Reader, writer Writer, start, end roachpb.Key) error {
	...
	// ranges.
	//
	// TODO(sumeer): Could add the iterated keys to the batch, so don't have
	// to do the scan again. If there are too many keys, this will mean a mix
	// of point tombstones and range tombstone.
	count := 0
