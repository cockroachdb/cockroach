...
type MVCCIterator interface {
	...
	// WriteIntentError. Returns stats on skipped KVs, or an error if a collision
	// is found.
	CheckForKeyCollisions(sstData []byte, start, end roachpb.Key, maxIntents int64) (enginepb.MVCCStats, error)
