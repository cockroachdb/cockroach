...
// lower/upper bounds.
//
// Iteration does not follow MVCCRangeKey ordering (StartKey,Timestamp), but
// rather EndKey,Timestamp. This is a memory optimization, to allow emitting
...
// buffered in memory before they could be emitted). For example, [a-z)@3 will be
// emitted after [c-e)@2, but before [x-z)@1.
