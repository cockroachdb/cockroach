...
func (disruptiveElectionTestHandler) HandleRaftRequest(_ context.Context, _ *storage.RaftMessageRequest, _ storage.RaftMessageResponseStream) *roachpb.Error {
	panic("unimplemented")
}
...
func (disruptiveElectionTestHandler) HandleSnapshot(_ *storage.SnapshotRequest_Header, _ storage.SnapshotResponseStream) error {
	panic("unimplemented")
}
