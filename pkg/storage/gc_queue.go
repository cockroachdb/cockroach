...
// A cleanupTxnIntentsFunc cleans up intents from a transaction
// record, pushing the transaction first if it is PENDING. Once all
// intents are resolved successfully, removes the transaction record.
