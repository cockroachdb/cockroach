...
func NewStores(
	ambient log.AmbientContext, clock *hlc.Clock, binaryVersion, binaryMinSupportedVersion roachpb.Version,
) *Stores {
	return &Stores{
...
func SynthesizeClusterVersionFromEngines(
	ctx context.Context, engines []engine.Engine, binaryVersion, binaryMinSupportedVersion roachpb.Version,
) (clusterversion.ClusterVersion, error) {
	// Find the most recent bootstrap info.
