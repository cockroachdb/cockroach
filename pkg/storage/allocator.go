...
// that it's so new it hasn't finished initializing yet.
...
// initializing yet. This is important when we've just added a replica in order
// to rebalance to it (#17879).
