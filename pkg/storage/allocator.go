...
func (a *Allocator) ComputeAction(
	...
	// Ensure that we don't up-replicate to an even number of replicas. In case of one node decommissioning
	// we would have the choice of refusing to down-replicate effectively blocking decommissioning or reduce
	// the replication factor further.
	if need%2 == 0 {
		need = need - 1
	}
