...
func TestEngineMVCCRangeKeyMutations(t *testing.T) {
	...
	testutils.RunTrueAndFalse(t, "batch", func(t *testing.T, useBatch bool) {
		...
		require.Error(t, rw.ExperimentalPutMVCCRangeKey(zeroLength, nil))
		...
		require.NoError(t, rw.ExperimentalClearMVCCRangeKey(rangeKey("c", "p", 1)))
		require.NoError(t, rw.ExperimentalClearMVCCRangeKey(rangeKey("c", "p", 2)))
		require.NoError(t, rw.ExperimentalClearMVCCRangeKey(rangeKey("c", "p", 3)))
		require.NoError(t, rw.ExperimentalClearMVCCRangeKey(rangeKey("c", "p", 10)))
		require.Equal(t, []MVCCRangeKeyValue{
			rangeKV("a", "c", 10, ""),
			rangeKV("a", "c", 2, "ad2"),
			rangeKV("a", "c", 1, "az1"),
