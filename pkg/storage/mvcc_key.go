...
// zero-valued:
//
// [key] [sentinel] [timeWall] [timeLogical] [localTimeWall] [localTimeLogical] [timeLength]
// [key] [sentinel] [timeWall] [timeLogical] [localTimeWall] [timeLength]
...
// localTimeWall:    LocalTimestamp.WallTime              (8 bytes: big-endian uint64)
// localTimeLogical: LocalTimestamp.Logical               (4 bytes: big-endian uint32)
