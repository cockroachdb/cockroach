...
type StoreMetrics struct {
	...
	// Slow request counts.
	SlowCommandQueueRequests *metric.IncrementableGauge
	SlowLeaseRequests        *metric.IncrementableGauge
	SlowRaftRequests         *metric.IncrementableGauge
...
func newStoreMetrics(sampleInterval time.Duration) *StoreMetrics {
	...
	sm := &StoreMetrics{
		...
		SlowCommandQueueRequests: metric.NewIncrementableGauge(metaSlowCommandQueueRequests),
		SlowLeaseRequests:        metric.NewIncrementableGauge(metaSlowLeaseRequests),
		SlowRaftRequests:         metric.NewIncrementableGauge(metaSlowRaftRequests),
	}
