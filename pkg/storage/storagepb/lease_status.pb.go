...
func (LeaseState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_lease_status_496ce2be5161cabe, []int{0}
}
...
func init() {
	proto.RegisterFile("storage/storagepb/lease_status.proto", fileDescriptor_lease_status_496ce2be5161cabe)
}

var fileDescriptor_lease_status_496ce2be5161cabe = []byte{
