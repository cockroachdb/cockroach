...
const (
	...
	// should fall under in uncertainty window. Even without the statis, writes
...
func (LeaseState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_lease_status_668c021e896f389c, []int{0}
}
...
func init() {
	proto.RegisterFile("storage/storagepb/lease_status.proto", fileDescriptor_lease_status_668c021e896f389c)
}

var fileDescriptor_lease_status_668c021e896f389c = []byte{
