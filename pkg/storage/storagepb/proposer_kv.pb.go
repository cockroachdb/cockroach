...
func (*Split) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_5c308ea109f60cca, []int{0}
}
...
func (*Merge) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_5c308ea109f60cca, []int{1}
}
...
func (*ChangeReplicas) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_5c308ea109f60cca, []int{2}
}
...
func (*ComputeChecksum) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_5c308ea109f60cca, []int{3}
}
...
func (*Compaction) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_5c308ea109f60cca, []int{4}
}
...
func (*SuggestedCompaction) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_5c308ea109f60cca, []int{5}
}
...
func (*ReplicatedEvalResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_5c308ea109f60cca, []int{6}
}
...
func (*ReplicatedEvalResult_AddSSTable) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_5c308ea109f60cca, []int{6, 0}
}
...
func (*WriteBatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_5c308ea109f60cca, []int{7}
}
...
func (*LogicalOpLog) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_5c308ea109f60cca, []int{8}
}
...
func (*RaftCommand) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_5c308ea109f60cca, []int{9}
}
...
func init() {
	proto.RegisterFile("storage/storagepb/proposer_kv.proto", fileDescriptor_proposer_kv_5c308ea109f60cca)
}

var fileDescriptor_proposer_kv_5c308ea109f60cca = []byte{
	...
	,
}
