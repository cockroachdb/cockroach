...
func (RangeLogEventType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_log_e92ff5cd33cd1ebc, []int{0}
}
...
func (*RangeLogEvent_Info) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_e92ff5cd33cd1ebc, []int{0, 0}
}
...
func init() { proto.RegisterFile("storage/storagepb/log.proto", fileDescriptor_log_e92ff5cd33cd1ebc) }

var fileDescriptor_log_e92ff5cd33cd1ebc = []byte{
