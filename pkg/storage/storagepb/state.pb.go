...
func (*ReplicaState) Descriptor() ([]byte, []int) {
	return fileDescriptor_state_0344a06dbdbb75f1, []int{0}
}
...
func (*RangeInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_state_0344a06dbdbb75f1, []int{1}
}
...
func (*RangeInfo_CTEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_state_0344a06dbdbb75f1, []int{1, 0}
}
...
func (*LatchManagerInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_state_0344a06dbdbb75f1, []int{2}
}
...
func init() {
	proto.RegisterFile("storage/storagepb/state.proto", fileDescriptor_state_0344a06dbdbb75f1)
}

var fileDescriptor_state_0344a06dbdbb75f1 = []byte{
	...
	0x15, 0xb1, 0xd8, 0xa2, 0xcb, 0x0f, 0x69, 0xc5, 0xa5, 0x49, 0x11, 0x4a, 0x69, 0xab, 0xc5, 0x8d,
	0x38, 0x2c, 0x07, 0x6b, 0x62, 0x4f, 0x9d, 0x51, 0xed, 0x19, 0x33, 0x33, 0xde, 0x4d, 0xf7, 0x0f,
	0xe0, 0xcc, 0x9f, 0xc0, 0x9d, 0x7f, 0xa4, 0xc7, 0x1e, 0x97, 0x4b, 0x04, 0xa9, 0x84, 0x38, 0x73,
	0xe4, 0x84, 0x66, 0x6c, 0x67, 0x93, 0x76, 0xb5, 0xea, 0xc9, 0xce, 0xf7, 0x7d, 0xef, 0xcd, 0x7b,
	...
	0xa1, 0x03, 0x3e, 0x88, 0x31, 0x12, 0xf8, 0x96, 0x7c, 0x55, 0xcb, 0xdf, 0xd7, 0xd4, 0x92, 0xfe,
	0x2b, 0x60, 0x86, 0x58, 0x04, 0x56, 0x65, 0xd7, 0xd8, 0x6b, 0xee, 0x77, 0x9d, 0x37, 0x73, 0x2b,
	0x7a, 0x71, 0x3c, 0x44, 0x23, 0x7c, 0x88, 0x45, 0xc0, 0x49, 0x2a, 0x19, 0xf7, 0xb4, 0x1e, 0x3a,
	0xa0, 0xaa, 0x93, 0x59, 0xa6, 0x0e, 0xb4, 0xde, 0x12, 0x78, 0xac, 0x78, 0x2f, 0x97, 0xc1, 0x53,
	0xb0, 0x29, 0x79, 0x46, 0x03, 0x24, 0x71, 0xe8, 0xeb, 0x9b, 0xb2, 0xaa, 0x3a, 0xf2, 0xa3, 0xb7,
	...
	0x19, 0xf5, 0xef, 0xd4, 0x6e, 0xcf, 0x03, 0xc2, 0xd1, 0xd3, 0x2e, 0x47, 0x34, 0xa4, 0x59, 0x1c,
	0xa3, 0x51, 0x8c, 0xbb, 0x5e, 0x33, 0x0a, 0xe6, 0x52, 0xd8, 0x03, 0x55, 0x55, 0xb6, 0xb0, 0xd6,
	0xf4, 0x49, 0x8f, 0x9d, 0xbb, 0x0e, 0xcb, 0x7d, 0xe4, 0x94, 0x76, 0x72, 0x4e, 0x7e, 0xec, 0xf7,
	...
	,
}
