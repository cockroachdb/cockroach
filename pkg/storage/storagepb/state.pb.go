...
func (*ReplicaState) Descriptor() ([]byte, []int) {
	return fileDescriptor_state_2bce47fcbfc9c8fa, []int{0}
}
...
func (*RangeInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_state_2bce47fcbfc9c8fa, []int{1}
}
...
func (*RangeInfo_CTEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_state_2bce47fcbfc9c8fa, []int{1, 0}
}
...
func (*LatchManagerInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_state_2bce47fcbfc9c8fa, []int{2}
}
...
func init() {
	proto.RegisterFile("storage/storagepb/state.proto", fileDescriptor_state_2bce47fcbfc9c8fa)
}

var fileDescriptor_state_2bce47fcbfc9c8fa = []byte{
	// 984 bytes of a gzipped FileDescriptorProto
	,
}
