...
func (r *Replica) AdminSplit(
	...
	err := r.executeCommand(ctx, func() error {
		var err error
		reply, err = r.adminSplitWithDescriptor(ctx, args, r.Desc(), true /* delayable */, reason)
		return err
	})
	return reply, err
}
...
func (r *Replica) AdminUnsplit(
	...
	err := r.executeCommand(ctx, func() error {
		var err error
		reply, err = r.adminUnsplitWithDescriptor(ctx, args, r.Desc(), reason)
		return err
	})
	return reply, err
}
