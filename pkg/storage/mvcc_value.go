...
// encodedSizeEx returns the size of the MVCCValue when encoded and a flag
// indicating if the MVCC value header would be encoded.
//
//gcassert:inline
func (v *MVCCValue) encodedSizeEx() (size int, extendedEncoding bool) {
	if v.useSimpleEncoding() {
