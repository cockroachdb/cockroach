...
func checkNumberOfPayloadChunks(
	...
	return count == expectedNumChunks
}
...
func TestReadWriteFile(t *testing.T) {
	...
	for _, testCase := range testCases {
		...
		require.True(t, checkMetadataEntryExists(ctx, t, testFileName, "root", sqlDB))
		expectedNumChunks := (testCase.fileSize / testCase.chunkSize) +
			(testCase.fileSize % testCase.chunkSize)
		require.True(t, checkNumberOfPayloadChunks(ctx, t, testFileName, "root",
