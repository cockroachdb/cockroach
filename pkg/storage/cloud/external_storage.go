...
func (l *localFileStorage) WriteFile(
	...
	return l.blobClient.WriteFile(ctx, joinWithoutClean(l.base, basename), content)
}

func (l *localFileStorage) ReadFile(ctx context.Context, basename string) (io.ReadCloser, error) {
	return l.blobClient.ReadFile(ctx, joinWithoutClean(l.base, basename))
}
...
func (l *localFileStorage) Delete(ctx context.Context, basename string) error {
	return l.blobClient.Delete(ctx, joinWithoutClean(l.base, basename))
}

func (l *localFileStorage) Size(ctx context.Context, basename string) (int64, error) {
	stat, err := l.blobClient.Stat(ctx, joinWithoutClean(l.base, basename))
	if err != nil {
		return 0, nil
	}
