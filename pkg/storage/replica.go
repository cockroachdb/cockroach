			...
			for _, newCmd := range accessCmds {
				...
				for {
					...
					case <-ctxDone:
						...
						//
						// To avoid transferring already resolved prerequisites to our dependencies,
						// we perform one last optimistic scan over our prerequisites and resolve
						// any that are no longer pending and were not canceled themselves. This
						// helps bound the quadratic blowup of prerequisites during cascading
						// cancellations.
						newCmd.OptimisticallyResolvePrereqs()
