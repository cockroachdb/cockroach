...
func (r *Replica) maybeAcquireProposalQuotaRaftMuLocked(ctx context.Context) (func(), error) {
	r.mu.RLock()
	...
	// quotaPool.acquire is a blocking command, will block if there's
...
func (r *Replica) propose(
	...
	endCmds *endCmds,
	spans *SpanSet,
) (_ chan proposalResult, _ func() bool, err error) {
	if err := r.IsDestroyed(); err != nil {
		return nil, nil, err
	}
	...
	returnQuota, err := r.maybeAcquireProposalQuotaRaftMuLocked(ctx)
	if err != nil {
		return nil, nil, err
	}
	defer func() {
