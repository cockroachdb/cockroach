...
func (r *Replica) destroyDataRaftMuLocked(ctx context.Context, desc roachpb.RangeDescriptor) error {
	iter := NewReplicaDataIterator(r.Desc(), r.store.Engine(), false /* !replicatedOnly */)
	defer iter.Close()
