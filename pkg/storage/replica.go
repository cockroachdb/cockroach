...
func (r *Replica) beginCmds(ctx context.Context, ba *roachpb.BatchRequest, spans *SpanSet) (*endCmds, error) {
...
func (r *Replica) requestToProposal(
	ctx context.Context, idKey storagebase.CmdIDKey, ba roachpb.BatchRequest, endCmds *endCmds, spans *SpanSet,
...
func (r *Replica) propose(
	ctx context.Context, lease *roachpb.Lease, ba roachpb.BatchRequest, endCmds *endCmds, spans *SpanSet,
