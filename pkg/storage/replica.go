...
func (r *Replica) acquireMergeLock(
	...
	// then fatal the node upon realizing the store had overlapping replicas. With
	// an uninitialized and locked right-hand replica in place, any snapshots for
	// the right-hand range will block on raftMu, waiting for the merge to
