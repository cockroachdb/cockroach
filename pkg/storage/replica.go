...
func (r *Replica) tick(livenessMap IsLiveMap) (bool, error) {
	...
	r.maybeTransferRaftLeadershipRLocked(ctx)
...
// maybeTransferRaftLeadershipRLocked attempts to transfer the leadership away
...
// replicas).
func (r *Replica) maybeTransferRaftLeadershipRLocked(ctx context.Context) {
