...
type ReplicatedEvalResult struct {
	...
	AppliedIndexSysBytesDelta int64                                       `protobuf:"varint,10014,opt,name=applied_index_sys_bytes_delta,json=appliedIndexSysBytesDelta" json:"applied_index_sys_bytes_delta"`
}
...
func (m *ReplicatedEvalResult) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x4
	i++
	i = encodeVarintProposerKv(dAtA, i, uint64(m.AppliedIndexSysBytesDelta))
	return i, nil
}
...
func (m *ReplicatedEvalResult) Size() (n int) {
	...
	n += 3 + sovProposerKv(uint64(m.AppliedIndexSysBytesDelta))
	return n
}
...
func (m *ReplicatedEvalResult) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10014:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AppliedIndexSysBytesDelta", wireType)
			}
			m.AppliedIndexSysBytesDelta = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowProposerKv
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.AppliedIndexSysBytesDelta |= (int64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorProposerKv = []byte{
	...
	,
}
