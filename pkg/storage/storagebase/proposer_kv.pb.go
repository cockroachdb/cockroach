...
func (m *RaftCommand) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DeprecatedProposerLease != nil {
		...
		n16, err := m.DeprecatedProposerLease.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n16
...
var fileDescriptorProposerKv = []byte{
	...
	,
}
