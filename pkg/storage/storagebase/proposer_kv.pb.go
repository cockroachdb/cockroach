...
type Compaction struct {
	...
	// voided indicates this compaction is for a key span which will
	// never be re-used.
	Voided bool `protobuf:"varint,3,opt,name=voided,proto3" json:"voided,omitempty"`
}
...
func (m *Compaction) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Voided", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorProposerKv = []byte{
	...
	,
}
