...
// Raft command hasn't committed yet. This isn't so much an issue with
// AddSSTable since these Ranges are not user-visible, but it is a general
// concern assuming other such side effects are added.
type ReplicatedEvalResult_AddSSTable struct {
	...
	// The byte offset of the 64-bit global sequence number within the SST. The
	// sequence number is always zero when the SST is proposed through Raft, but
	// RocksDB might modify the on-disk copy when the SST is ingested. Storing
	// the offset allows us to recover the original bytes when loading the Raft
	// log. It is guaranteed that RocksDB will not otherwise modify the SST.
	GlobalSeqnoOffset uint64 `protobuf:"varint,3,opt,name=global_seqno_offset,json=globalSeqnoOffset,proto3" json:"global_seqno_offset,omitempty"`
}
...
func (this *ReplicatedEvalResult_AddSSTable) Equal(that interface{}) bool {
	...
	if this.GlobalSeqnoOffset != that1.GlobalSeqnoOffset {
		return false
	}
	return true
}
...
func (m *ReplicatedEvalResult_AddSSTable) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.GlobalSeqnoOffset != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintProposerKv(dAtA, i, uint64(m.GlobalSeqnoOffset))
	}
	return i, nil
}
...
func (m *ReplicatedEvalResult_AddSSTable) Size() (n int) {
	...
	if m.GlobalSeqnoOffset != 0 {
		n += 1 + sovProposerKv(uint64(m.GlobalSeqnoOffset))
	}
	return n
}
...
func (m *ReplicatedEvalResult_AddSSTable) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field GlobalSeqnoOffset", wireType)
			}
			m.GlobalSeqnoOffset = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowProposerKv
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.GlobalSeqnoOffset |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorProposerKv = []byte{
	...
	,
}
