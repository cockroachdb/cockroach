...
type ReplicatedEvalResult struct {
	...
	AddSSTable     *ReplicatedEvalResult_AddSSTable            `protobuf:"bytes,16,opt,name=add_sstable,json=addSstable" json:"add_sstable,omitempty"`
}
...
type ReplicatedEvalResult_AddSSTable struct {
	...
	SideloadedCRC32 []byte `protobuf:"bytes,2,opt,name=sideloaded_crc32,json=sideloadedCrc32" json:"sideloaded_crc32,omitempty"`
}
...
func (m *ReplicatedEvalResult_AddSSTable) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.SideloadedCRC32 != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintProposerKv(dAtA, i, uint64(len(m.SideloadedCRC32)))
		i += copy(dAtA[i:], m.SideloadedCRC32)
	}
	return i, nil
}
...
func (m *ReplicatedEvalResult_AddSSTable) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SideloadedCRC32", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SideloadedCRC32 = append(m.SideloadedCRC32[:0], dAtA[iNdEx:postIndex]...)
			if m.SideloadedCRC32 == nil {
				m.SideloadedCRC32 = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
var fileDescriptorProposerKv = []byte{
	...
	,
}
