...
type ReplicatedEvalResult struct {
	...
	AddSSTable     []byte                                      `protobuf:"bytes,16,opt,name=add_sstable,json=addSstable" json:"add_sstable"`
}
...
func (m *ReplicatedEvalResult) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AddSSTable != nil {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintProposerKv(dAtA, i, uint64(len(m.AddSSTable)))
		i += copy(dAtA[i:], m.AddSSTable)
	}
	return i, nil
}
...
func (m *RaftCommand) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TestingBatchRequest != nil {
		...
		n13, err := m.TestingBatchRequest.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n13
...
func (m *ReplicatedEvalResult) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 16:
			...
			m.AddSSTable = append(m.AddSSTable[:0], dAtA[iNdEx:postIndex]...)
			if m.AddSSTable == nil {
				m.AddSSTable = []byte{}
			}
			iNdEx = postIndex
...
var fileDescriptorProposerKv = []byte{
	...
	,
}
