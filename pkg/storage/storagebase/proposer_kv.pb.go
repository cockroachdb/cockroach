...
type ReplicatedEvalResult struct {
	...
	OldDelta       *cockroach_storage_engine_enginepb.MVCCStats        `protobuf:"bytes,10,opt,name=old_delta,json=oldDelta" json:"old_delta,omitempty"`
...
func (this *ReplicatedEvalResult) Equal(that interface{}) bool {
	...
	if !this.OldDelta.Equal(that1.OldDelta) {
		return false
	}
...
func (m *ReplicatedEvalResult) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.OldDelta != nil {
		dAtA[i] = 0x52
		i++
		i = encodeVarintProposerKv(dAtA, i, uint64(m.OldDelta.Size()))
		n10, err := m.OldDelta.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n10
...
func (m *ReplicatedEvalResult) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OldDelta", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.OldDelta == nil {
				m.OldDelta = &cockroach_storage_engine_enginepb.MVCCStats{}
			}
			if err := m.OldDelta.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 12:
...
var fileDescriptorProposerKv = []byte{
	...
	,
}
