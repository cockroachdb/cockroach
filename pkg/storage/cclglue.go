...
// CanSideloadSSTable returns true if we allow sideloading of SSTable entries.
// This is usually true only if running the enterprise version of CockroachDB.
var CanSideloadSSTable = func() bool {
	return false
}
