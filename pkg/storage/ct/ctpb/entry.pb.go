...
type Entry struct {
	...
	MLAI            map[github_com_cockroachdb_cockroach_pkg_roachpb.RangeID]int64 `protobuf:"bytes,4,rep,name=mlai,castkey=github.com/cockroachdb/cockroach/pkg/roachpb.RangeID" json:"mlai,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
func (m *Entry) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.MLAI == nil {
				m.MLAI = make(map[github_com_cockroachdb_cockroach_pkg_roachpb.RangeID]int64)
			}
			var mapkey int32
			var mapvalue int64
			for iNdEx < postIndex {
			...
			m.MLAI[github_com_cockroachdb_cockroach_pkg_roachpb.RangeID(mapkey)] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipEntry(dAtA[iNdEx:])
...
var fileDescriptorEntry = []byte{
	...
	,
}
