			...
			Knobs: base.TestingKnobs{
				...
				UpgradeManager: &upgrade.TestingKnobs{
					...
					RegistryOverride: func(cv clusterversion.ClusterVersion) (upgrade.Migration, bool) {
						...
						return upgrade.NewTenantMigration("test", cv, upgrades.NoPrecondition, func(
			...
			Knobs: base.TestingKnobs{
				...
				UpgradeManager: &upgrade.TestingKnobs{
					...
					RegistryOverride: func(cv clusterversion.ClusterVersion) (upgrade.Migration, bool) {
						...
						return upgrade.NewSystemMigration("test", cv, func(
...
func TestPrecondition(t *testing.T) {
	...
	cf := func(run *int64, err *atomic.Value) upgrade.TenantMigrationFunc {
		return func(
	...
	knobs := base.TestingKnobs{
		...
		UpgradeManager: &upgrade.TestingKnobs{
			...
			RegistryOverride: func(cv clusterversion.ClusterVersion) (upgrade.Migration, bool) {
				switch cv {
				case v1:
					return upgrade.NewTenantMigration("v1", cv,
				...
				case v2:
					return upgrade.NewTenantMigration("v2", cv,
