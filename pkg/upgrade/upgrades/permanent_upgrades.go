...
func addRootUser(
	...
	if deps.Settings.Version.ActiveVersion(ctx).IsActive(clusterversion.V23_1RoleMembersTableHasIDColumns) {
		upsertStmt = `
	...
	_, err = deps.InternalExecutor.Exec(
		ctx, "addRootToAdminRole", nil /* txn */, upsertStmt, upsertVals...)
	return err
}
