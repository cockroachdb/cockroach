...
func TestTableStatisticsDelayDeleteColumnMigration(t *testing.T) {
	...
	clusterversion.SkipWhenMinSupportedVersionIsAtLeast(t, clusterversion.V26_1_AddTableStatisticsDelayDeleteColumn)
	...
	upgrades.Upgrade(
		t,
		sqlDB,
		clusterversion.V26_1_AddTableStatisticsDelayDeleteColumn,
		nil,   /* done */
		false, /* expectError */
	)
