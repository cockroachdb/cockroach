...
func TestPreconditionBeforeStartingAnUpgrade(t *testing.T) {
	...
	var (
		v0 = clusterversion.ByKey(clusterversion.Start22_2 - 1)
		v1 = clusterversion.ByKey(clusterversion.Start22_2)
	)
	...
	t.Run("upgrade fails if there exists invalid descriptors", func(t *testing.T) {
		...
		*/
		...
		const tableDescriptorToInject = ""
		...
		require.Equal(t, "pq: internal error: verifying precondition for version 22.1-2: There exists invalid "+
