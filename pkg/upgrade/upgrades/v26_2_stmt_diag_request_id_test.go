...
func TestStmtDiagnosticsRequestIDMigration(t *testing.T) {
	...
	// Inject the old copy of the descriptor (without request_id column and index).
	...
	// Validate that the statement_diagnostics table has the old schema.
	...
	// Validate that the table has the new schema.
