...
// its index to the system.statement_diagnostics table. This column links
// bundles to their originating diagnostic request, enabling multiple bundles
// per request. The index enables efficient lookup of all bundles for a given
// diagnostic request.
