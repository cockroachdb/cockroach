...
// Intentionally starts with a version that will descriptor transaction tracking
// keys. and confirms that we will go through version gates to first stop
// generating them, and finally delete them.
