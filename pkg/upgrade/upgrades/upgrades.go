...
var upgrades = []upgradebase.Upgrade{
	...
	upgrade.NewTenantUpgrade(
		...
		upgrade.RestoreActionNotRequired("jobs table that is not restored"),
	),
	...
	upgrade.NewTenantUpgrade(
		...
		upgrade.RestoreActionNotRequired("jobs table is not restored"),
	),
	upgrade.NewTenantUpgrade(
	...
	upgrade.NewTenantUpgrade(
		...
		upgrade.RestoreActionNotRequired("ephemeral system table that is not restored"),
	),
	...
	upgrade.NewTenantUpgrade(
		...
		upgrade.RestoreActionNotRequired("this system table is not restored"),
	),
	upgrade.NewTenantUpgrade(
