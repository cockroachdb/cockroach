...
var upgrades = []upgrade.Upgrade{
	...
	upgrade.NewTenantUpgrade("alter role_id and member_id columns in system.role_members to be NOT NULL",
		toCV(clusterversion.V23_1RoleMembersIDColumnsNotNull),
		NoPrecondition,
		alterSystemRoleMembersSetIDColumnsNotNull,
	),
}
