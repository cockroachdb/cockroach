...
var upgrades = []upgradebase.Upgrade{
	...
	upgrade.NewPermanentTenantUpgrade(
		...
		clusterversion.Permanent_V22_2SQLSchemaTelemetryScheduledJobs,
	...
	newFirstUpgrade(clusterversion.V23_2Start),
	...
	upgrade.NewTenantUpgrade(
		...
		clusterversion.V23_2_GrantExecuteToPublic,
		upgrade.NoPrecondition,
	...
	newFirstUpgrade(clusterversion.V24_1Start),
