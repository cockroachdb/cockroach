...
func alterSystemPrivilegesAddSecondaryIndex(
	...
	op := operation{
		...
		schemaList:     []string{"privileges_path_username_idx_key"},
		query:          `CREATE UNIQUE INDEX IF NOT EXISTS privileges_path_username_idx_key ON system.privileges (path,username) STORING (privileges, grant_options)`,
