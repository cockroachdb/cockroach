...
func TestUpdateInvalidColumnIDsInSequenceBackReferences(t *testing.T) {
	...
	type TestCase struct {
		seqDescToInject                                 string
		tblDescsToInject                                []string
		expectedColumnIDsInSeqBackReferencesAfterUpdate [][]string
	}
	...
	*/
	testCases := []TestCase{
		{
			...
			*/
			seqDescToInject: "",
			tblDescsToInject: []string{
			...
			expectedColumnIDsInSeqBackReferencesAfterUpdate: [][]string{{"[2]"}},
		},
		{
			/*
				CREATE SEQUENCE s;
			...
			*/
			seqDescToInject: "",
			tblDescsToInject: []string{
			...
			expectedColumnIDsInSeqBackReferencesAfterUpdate: [][]string{{"[2, 3]"}},
		},
		{
			/*
					CREATE SEQUENCE s;
			...
			*/
			seqDescToInject: "",
			tblDescsToInject: []string{
			...
			expectedColumnIDsInSeqBackReferencesAfterUpdate: [][]string{{"[2]"}, {"[2, 3]"}, {"[2, 3]"}},
		},
	}
	...
	run := func(testCase TestCase) {
		...
		decodeTableDescriptorAndInsert(testCase.seqDescToInject)
		...
		// back reference.
		query := "select jsonb_array_elements(crdb_internal.pb_to_json('cockroach.sql.sqlbase.Descriptor', descriptor)->'table'->'dependedOnBy')->'columnIds' from system.descriptor where id = 's'::REGCLASS;"
		tdb.CheckQueryResults(t, query, testCase.expectedColumnIDsInSeqBackReferencesAfterUpdate)
	}
