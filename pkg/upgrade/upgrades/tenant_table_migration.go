...
ALTER TABLE system.public.tenants,
  ...
  ADD COLUMN data_state STRING,
  ADD COLUMN service_mode STRING`

const addTenantIndexes = `
...
func extendTenantsTable(
	...
	for _, op := range []operation{
		...
		},
		{
			...
			schemaList:     []string{"tenants_name_idx", "tenants_service_mode_idx"},
			query:          addTenantIndexes,
