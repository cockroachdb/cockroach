...
// upgrades. Note that there are two types of upgrades, a SystemMigration
...
// more details. Following that, define a Migration in the upgrades package
...
type JobDeps interface {
	...
	// GetMigration returns the upgrade associated with the cluster version
	// if one exists.
