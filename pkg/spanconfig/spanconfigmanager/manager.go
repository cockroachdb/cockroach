...
// tenantJobEnabledSetting is a tenant-readonly setting that controls whether
// secondary tenants are able to run the span config reconciliation job. It has
// no effect on the host tenant. Both
