...
func TestScalability(t *testing.T) {
	...
	tdb.Exec(t, `ANALYZE system.span_configurations`)                              // XXX: Does this help?
	tdb.Exec(t, `SET CLUSTER SETTING spanconfig.kvaccessor.batch_size = $1`, 2500) // XXX: Really I only care about bounding delete batches.
