...
// limit the KVSubscriber is instantiated with), the old rangefeed is wound down
// and a new one re-established.
//
...
//      errors, we could also surface a checkpoint to use the next time the
