...
// - subscribe starts the subscription process. It can also be used to verify
//   behavior when re-estabslishing subscriptions after hard errors.
...
// - inject-buffer-overflow can be used to inject a single rangefeed buffer
//   overflow errors within the kvsubscriber. It pokes into the internals of the
//   kvsubscriber and is useful to test teardown behavior.
//
	...
	datadriven.Walk(t, testutils.TestDataPath(t), func(t *testing.T, path string) {
		...
		datadriven.RunTest(t, path, func(t *testing.T, d *datadriven.TestData) string {
			...
			case "subscribe":
				...
				go func() {
					_ = kvSubscriber.TestingSubscribeInner(ctx)
				}()
