...
func TestEncodeDecodeSystemTarget(t *testing.T) {
	for _, testTarget := range []SystemTarget{
		...
		makeSystemTargetOrFatal(t, roachpb.MakeTenantID(10), roachpb.MakeTenantID(10)),
		...
		makeSystemTargetOrFatal(t, roachpb.SystemTenantID, roachpb.MakeTenantID(10)),
	} {
...
func TestTargetSortingRandomized(t *testing.T) {
	...
	sortedTargets := Targets{
		...
		MakeTargetFromSystemTarget(makeSystemTargetOrFatal(t, roachpb.SystemTenantID, roachpb.MakeTenantID(10))),
		MakeTargetFromSystemTarget(makeSystemTargetOrFatal(t, roachpb.SystemTenantID, roachpb.MakeTenantID(20))),
		MakeTargetFromSystemTarget(makeSystemTargetOrFatal(t, roachpb.MakeTenantID(5), roachpb.MakeTenantID(5))),
		MakeTargetFromSystemTarget(makeSystemTargetOrFatal(t, roachpb.MakeTenantID(10), roachpb.MakeTenantID(10))),
