...
func (s *Store) GetSpanConfigForKey(
	...
	if err == nil {
		spanConfig = s.wrapSpanConfig(ctx, spanConfig, key)
	}
	return spanConfig, err
}

// TODO: This is duplicated from wrappingLivenessStoreReader, refactor
func (s *Store) wrapSpanConfig(ctx context.Context, spanConfig roachpb.SpanConfig, key roachpb.RKey) roachpb.SpanConfig {
