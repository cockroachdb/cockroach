...
func (s *Store) ForEachOverlappingSpanConfig(
	...
	// For a span that doesn't overlap with any span configs, we still want to
	// construct a config that is combined with the system span configs that may
	// be applicable to the span.
	//
