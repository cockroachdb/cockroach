...
type StoreWriter interface {
	...
	// itself is adding an entry, that too is added. This is best illustrated
	...
	// find all overlapping spans and issue KVAccessor deletes for them + upsert
	...
	//      overlapping span config is the same as the one we'd be looking to
	//      upsert. Using Apply (dryrun=true) for e.g. would return empty lists,
	//      indicating a no-op.
