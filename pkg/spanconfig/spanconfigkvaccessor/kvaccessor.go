...
`,
	...
	return getStmtBuffer.String(), queryArgs
}
...
func (k *KVAccessor) constructUpsertStmtAndArgs(toUpsert []roachpb.SpanConfigEntry) (string, []interface{}, error) {
...
func (k *KVAccessor) constructValidationStmtAndArgs(toUpsert []roachpb.SpanConfigEntry) (string, []interface{}) {
