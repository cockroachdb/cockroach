...
// TODO(arul): All this needs to be reworked now that we've changed
// the SQLWatcher significantly.
//import (
//	"context"
//	"testing"
//
...
//	"github.com/cockroachdb/cockroach/pkg/spanconfig/spanconfigsqlreconciler"
...
//
//		updateCh, err := sqlWatcher.WatchForSQLUpdates(ctx, ts.Clock().Now())
//		require.NoError(t, err)
//
