...
func (og *operationGenerator) alterTableAlterPrimaryKey(
	...
	// TODO(sql-foundations): once #130271 is in the latest release, we can remove
	// this allow list/the version gate.
	...
	expectedErr := pgcode.FeatureNotSupported
	if typeIsIndexableNotSupported {
		...
		expectedErr = pgcode.SuccessfulCompletion
	}
