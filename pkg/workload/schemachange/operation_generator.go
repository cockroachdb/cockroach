...
func (og *operationGenerator) setTableStorageParam(
	...
	param, value, err := og.randStorageParam()
	if err != nil {
		return nil, err
	}
...
func (og *operationGenerator) resetTableStorageParam(
	...
	// Randomly decide whether to set TTL parameters or a single non-TTL parameter
	param, _, err := og.randStorageParam()
	if err != nil {
		return nil, err
	}
...
func (og *operationGenerator) randBoolString() string {
	...
	return boolVals[og.params.rng.Intn(len(boolVals))]
}
...
func (og *operationGenerator) randIntervalString() string {
	...
	return intervals[og.params.rng.Intn(len(intervals))]
}
...
func (og *operationGenerator) randCronString() string {
	...
	return crons[og.params.rng.Intn(len(crons))]
}
...
func (og *operationGenerator) randStorageParam() (string, string, error) {
	params := []struct {
		name     string
		...
		{
			name:     "sql_stats_automatic_collection_enabled",
			valueGen: func() string { return og.randBoolString() },
		},
		{
			name:     "fillfactor",
			valueGen: func() string { return fmt.Sprintf("%d", og.params.rng.Intn(100)) },
		},
		{
			name:     "sql_stats_histogram_samples_count",
			valueGen: func() string { return fmt.Sprintf("%d", og.params.rng.Intn(10000)) },
		},
		{
			name:     "sql_stats_histogram_buckets_count",
			valueGen: func() string { return fmt.Sprintf("%d", og.params.rng.Intn(1000)) },
		},
		{
			name:     "ttl",
	...
	randParam := params[og.params.rng.Intn(len(params))]
	return randParam.name, randParam.valueGen(), nil
}
