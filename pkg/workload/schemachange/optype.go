...
var opDeclarativeVersion = map[opType]clusterversion.Key{
	alterTableAddColumn:               clusterversion.V22_2,
	alterTableAddConstraintForeignKey: clusterversion.V23_1,
	alterTableAddConstraintUnique:     clusterversion.V23_1,
	alterTableDropColumn:              clusterversion.V22_2,
	alterTableDropConstraint:          clusterversion.V23_1,
	alterTableDropNotNull:             clusterversion.V23_1,
