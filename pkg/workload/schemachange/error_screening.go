...
//   - It is a foreign key and includeFKs is false.
//   - It is a self-dependency (i.e., the table depends on itself) and:
//       - It is a foreign key, or
//       - skipSelfRef is true (regardless of dependency type).
