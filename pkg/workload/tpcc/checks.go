...
type Check struct {
	...
	CanBeSkippedForLongDuration bool
}

// AllChecks returns a slice of all of the checks.
func AllChecks() []Check {
	return []Check{
		{Name: "3.3.2.1", Fn: check3321, CanBeSkippedForLongDuration: true},
		...
		{Name: "3.3.2.8", Fn: check3328, CanBeSkippedForLongDuration: true},
		{Name: "3.3.2.9", Fn: check3329},
