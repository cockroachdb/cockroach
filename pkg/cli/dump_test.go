...
func TestDumpRow(t *testing.T) {
	...
	INSERT INTO d.t VALUES (
		...
		2.3,
		'striiing',
		b'\x61\x31\x62\x32\x63\x33', '2016-03-26', '2016-01-25 10:10:10' ,
		'2h30m30s',
		true,
		1.2345,
...
INSERT INTO t (i, f, s, b, d, t, n, o, e, u, ip, tz, e1, e2, s1) VALUES
	(1, 2.3, 'striiing', b'\x61\x31\x62\x32\x63\x33', '2016-03-26', '2016-01-25 10:10:10+00:00', '2h30m30s', true, 1.2345, 'e9716c74-2638-443d-90ed-ffde7bea7d1d', '192.168.0.1', '2016-01-25 10:10:10+00:00', 3, 4.5, 's'),
