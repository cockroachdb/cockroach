...
// uploadLogToDatadog is a fallback function to upload the logs to datadog. We would receive cryptic "Decompression error"
...
func uploadLogToDatadog(chunk *tableDumpChunk) {
