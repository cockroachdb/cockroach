...
func getUserfileConf(
	...
	reqUsername, _ := username.MakeSQLUsernameFromUserInput(connURL.User.Username(), username.UsernameValidation)
...
func uploadUserFile(
	...
	username, err := username.MakeSQLUsernameFromUserInput(connURL.User.Username(), username.UsernameCreation)
	if err != nil {
		return "", err
	}
