...
using a SQL connection, to the current directory or 'destination' if provided. If destination
...
func getUserfileConf(ctx context.Context, conn *sqlConn, glob string) (roachpb.ExternalStorage_FileTable, error) {
...
func downloadUserfile(ctx context.Context, store cloud.ExternalStorage, src, dst string) (int64, error) {
