...
func Example_nodelocal() {
	...
	// Output:
	// nodelocal upload /Users/georgiahong/go/src/github.com/cockroachdb/cockroach/pkg/cli/test.csv /test/file1.csv
	// nodelocal upload /Users/georgiahong/go/src/github.com/cockroachdb/cockroach/pkg/cli/test.csv /test/file2.csv
	// nodelocal upload /Users/georgiahong/go/src/github.com/cockroachdb/cockroach/pkg/cli/test.csv /test/file1.csv
	// ERROR: destination file already exists for /test/file1.csv
	// nodelocal upload notexist.csv /test/file1.csv
	// ERROR: unable to get source file stats for notexist.csv: stat notexist.csv: no such file or directory
}
...
func createTestFile() (string, func()) {
	filePath, err := filepath.Abs("test.csv")
	if err != nil {
		return "", func() {}
	}
