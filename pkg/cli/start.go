...
var debugTSImportMapping = envutil.EnvOrDefaultString("COCKROACH_DEBUG_TS_IMPORT_MAPPING", debugTSImportFile+".yaml")
...
func runStartSingleNode(cmd *cobra.Command, args []string) error {
	...
	if debugTSImportFile != "" {
		serverCfg.TestingKnobs.Server = &server.TestingKnobs{
			...
			ImportTimeseriesMapping: debugTSImportMapping,
		}
	}
