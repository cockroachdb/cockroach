...
func TestServerConnSettings(t *testing.T) {
	...
	testData := []struct {
		...
		{[]string{"start", "--host", "127.0.0.1", "--locality-advertise-address", "zone=1:235.0.0.5"}, "127.0.0.1:" + base.DefaultPort, "127.0.0.1:" + base.DefaultPort, "[{{tcp 235.0.0.5} zone=1}]"},
		{[]string{"start", "--host", "127.0.0.1", "--locality-advertise-address", "zone=1:235.0.0.5,zone=2:123.0.0.5"}, "127.0.0.1:" + base.DefaultPort, "127.0.0.1:" + base.DefaultPort, "[{{tcp 235.0.0.5} zone=1} {{tcp 123.0.0.5} zone=2}]"},
	}
