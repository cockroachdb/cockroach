...
// rowStrIter is an iterator interface for the printQueryOutput function. Its
...
// rowSliceIter is an implementation of the rowStrIter interface and its used
...
// newRowSliceIter is an implementation of the rowStrIter interface and its
