...
func TestZip(t *testing.T) {
	...
	datadriven.RunTest(t, "testdata/zip/testzip", func(td *datadriven.TestData) string {
		return out
	})
}
...
func TestPartialZip(t *testing.T) {
	...
	storage.TimeUntilStoreDead.Override(&s.ClusterSettings().SV, storage.TestTimeUntilStoreDead)
