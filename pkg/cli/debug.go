...
func runDebugCompact(cmd *cobra.Command, args []string) error {
	...
	{
		approxBytesBefore, _, _, _, err := db.ApproximateDiskBytes(roachpb.KeyMin, roachpb.KeyMax)
		if err != nil {
	...
	{
		approxBytesAfter, _, _, _, err := db.ApproximateDiskBytes(roachpb.KeyMin, roachpb.KeyMax)
		if err != nil {
