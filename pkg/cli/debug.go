...
func init() {
	...
	f.BoolVar(&debugTimeSeriesDumpOpts.discoverChildMetrics, "discover-child-metrics", false, "discover and include child metrics that match known metric name prefixes")
