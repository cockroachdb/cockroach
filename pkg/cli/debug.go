...
// debugNeedsConfirmation contains commands that need a confirmation flag
var debugNeedsConfirmation = []*cobra.Command{
	debugRecoverCollectInfoCmd,
	debugRecoverPlanCmd,
	debugRecoverExecuteCmd,
}
...
func init() {
	...
	f.StringVarP(&debugRecoverPlanOpts.outputFileName, "plan", "o", "replica-remove-plan.json",
