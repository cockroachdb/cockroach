...
// PopulateEnvConfigHook populates any needed fields in the EnvConfig.
...
`,
	...
	PopulateEnvConfigHook = fillEncryptionOptionsForStore
	EncryptedStorePathsHook = func() []string {
		var res []string
...
func fillEncryptionOptionsForStore(dir string, cfg *fs.EnvConfig) error {
	opts, err := configpb.EncryptionOptionsForStore(dir, encryptionSpecs)
	if err != nil {
		return err
	}
