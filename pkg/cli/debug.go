...
func init() {
	...
	f.StringVar(&debugSendKVBatchOpts.traceFormat, "trace", debugSendKVBatchOpts.traceFormat,
		"which format to use for the trace output (off, text, jaeger)")
	f.BoolVar(&debugSendKVBatchOpts.keepCollectedSpans, "keep-collected-spans", debugSendKVBatchOpts.keepCollectedSpans,
		"whether to keep the CollectedSpans field on the response, to learn about how traces work")
	f.StringVar(&debugSendKVBatchOpts.traceOutput, "trace-output", debugSendKVBatchOpts.traceOutput,
