...
func init() {
	...
	f.StringVar(&debugZipUploadOpts.customerName, "customer-name", "",
		"Name of the customer to associate with the debug zip artifacts. This can be used to identify the upstream observability tool.")
