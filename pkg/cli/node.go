...
func printDecommissionStatusAndReadiness(statusResp serverpb.DecommissionStatusResponse, checkResp *serverpb.DecommissionPreCheckResponse) error {
	if checkResp == nil {
...
func printDecommissionBlockingErrorSummary(resp *serverpb.DecommissionPreCheckResponse, reportLimit int) {
