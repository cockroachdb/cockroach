...
func newCLITest(t *testing.T) cliTest {
	...
	for _, a := range assets {
		securitytest.RestrictedCopy(nil, a, test.certsDir, filepath.Base(a))
	}

	test.TestServer = s.(*server.TestServer)
	return test
}
