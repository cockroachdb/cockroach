...
/*
Package systembench is a generated protocol buffer package.

It is generated from these files:
	cli/systembench/systembenchpb/ping.proto
...
func (c *pingerClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PingResponse, error) {
	...
	err := grpc.Invoke(ctx, "/systembench.Pinger/Ping", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func init() { proto.RegisterFile("cli/systembench/systembenchpb/ping.proto", fileDescriptorPing) }
