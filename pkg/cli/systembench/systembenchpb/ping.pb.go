...
func (*PingRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ping_f0cfb55ea412c66c, []int{0}
}
...
func (*PingResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ping_f0cfb55ea412c66c, []int{1}
}
...
func init() {
	proto.RegisterFile("cli/systembench/systembenchpb/ping.proto", fileDescriptor_ping_f0cfb55ea412c66c)
}

var fileDescriptor_ping_f0cfb55ea412c66c = []byte{
