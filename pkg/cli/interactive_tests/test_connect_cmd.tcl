...
start_test "Check that the options URL param is preserved when changing database"

spawn $argv sql --certs-dir=$certs_dir --url=postgres://root@localhost:26257/defaultdb?options=--search_path%3Dcustom_path
eexpect root@
eexpect "/defaultdb>"
