...
send "$argv node recommission 1 --insecure --host=localhost --wait=none --disable-cluster-name-verification\r"
end_test


start_test "Check that debug commands work with a cluster name provided"
send "$argv node recommission 1 --insecure --host=localhost --wait=none --cluster-name=foo\r"
end_test
