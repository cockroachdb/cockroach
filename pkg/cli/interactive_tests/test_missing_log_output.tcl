...
# Try running quit, this time with --logtostderr. Test that
# the default logging level is WARNING, so that no INFO
# messages are printed between the marker and the
# (first line) error message from quit.
