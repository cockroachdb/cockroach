...
eexpect "2 | beat chef@;"
eexpect "3 | more&text"
# Sometimes the tab complete glitches here and adds an extra space.
# It's hard to reproduce this by hand and difficult to debug, blaming this on unix/osx glitches for now.
eexpect "4 |"
eexpect "epa! epa!"
eexpect "(4 rows)"
...
send "cat >/tmp/test_copy.sql <<EOF\rCOPY t FROM STDIN CSV;\r1,a\r\\.\r\rCOPY t FROM STDIN CSV;\r2,b\rEOF\r"
eexpect ":/# "
send "$argv sql --insecure -f /tmp/test_copy.sql\r"
eexpect ":/# "
