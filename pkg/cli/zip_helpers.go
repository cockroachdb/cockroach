...
// zipPathJoin constructs a zip archive path from an arbitrary number
// of path components. It uses path.Join to produce a clean,
// forward-slash-separated path regardless of whether components have
// leading or trailing slashes. Examples:
//
//	zipPathJoin("debug/nodes/1", "details.json") => "debug/nodes/1/details.json"
//	zipPathJoin("debug/nodes/1", "logs", "cockroach.log") => "debug/nodes/1/logs/cockroach.log"
func zipPathJoin(elems ...string) string {
