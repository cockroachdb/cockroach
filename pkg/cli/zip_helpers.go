...
// zipPathJoin constructs a zip archive path from a directory prefix
// and a file name. It uses path.Join to produce a clean,
// forward-slash-separated path regardless of whether components have
// leading or trailing slashes. Example:
//
//	zipPathJoin("debug/nodes/1", "details.json") => "debug/nodes/1/details.json"
func zipPathJoin(prefix, name string) string {
