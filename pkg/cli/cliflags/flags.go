...
disabled by setting the environment variable COCKROACH_SKIP_KEY_PERMISSION_CHECK to true.`,
	...
	//
	// </PRE>
	// Specifying the string value 'clockless' instead of a duration runs the cluster in
	// clockless reads mode. In that mode, reads are routed through Raft and subsequently
