...
var (
	fileRE = regexp.MustCompile(log.FilePattern)
...
func TestFilePrefixerWithOptions(t *testing.T) {
	...
	cases := []struct {
		...
		{
			"TestFilePrefixerWithOptions(delimiter)",
			[]fileInfo{
				fInfo("test__data1/!1/1/cockroach.test-0001.ubuntu.2018-11-30T22_06_47Z.003959.log", fileRE),
				fInfo("test__data2/!2/2/cockroach.test-0001.ubuntu.2018-11-29T22_05_47Z.003955.log", fileRE),
				fInfo("test__data3/!3/3/cockroach.test-0001.ubuntu.2018-11-30T22_06_47Z.003960.log", fileRE),
			},

			[]filePrefixerOption{withTemplate("(${fpath}) ${host}>"), withDelimiters([]string{"__", "!"})},
			[][]byte{
				[]byte("(1) test-0001>"),
				[]byte("(2) test-0001>"),
				[]byte("(3) test-0001>"),
