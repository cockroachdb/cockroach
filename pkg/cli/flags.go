...
func init() {
	...
	for _, cmd := range append(serverCmds, connectInitCmd, connectJoinCmd) {
		...
		cliflagcfg.VarFlag(f, addr.NewPortRangeSetter(&baseCfg.SecondaryTenantPortMin, &baseCfg.SecondaryTenantPortMax), cliflags.SecondaryTenantPortRange)
		_ = f.MarkHidden(cliflags.SecondaryTenantPortRange.Name)
	}
