...
func init() {
	...
	// Logging flags common to all commands.
	{
		...
		varFlag(pf, &stringSetter{settableString: &cliCtx.logConfigInput}, cliflags.Log)
		varFlag(pf, &fileSetter{settableString: &cliCtx.logConfigInput, fileName: "<unset>"}, cliflags.LogConfigFile)
		...
		varFlag(pf, &stringSetter{&cliCtx.deprecatedLogOverrides.logDir}, cliflags.DeprecatedLogDir)
		...
		varFlag(pf, &stringSetter{&cliCtx.deprecatedLogOverrides.sqlAuditLogDir}, cliflags.DeprecatedSQLAuditLogDir)
