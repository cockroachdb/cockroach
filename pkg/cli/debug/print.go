...
func PrintKeyValue(kv engine.MVCCKeyValue, sizes bool) error {
	s, err := SprintKeyValue(kv, sizes)
	if err == nil {
		fmt.Println(s)
	}
	return err
...
func SprintKeyValue(kv engine.MVCCKeyValue, sizes bool) (string, error) {
