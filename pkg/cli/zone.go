...
func runGetZone(_ *cobra.Command, _ []string) error {
	return errors.New(
		`Command "get" has been removed. Use SHOW ZONE CONFIGURATION FOR ... in a SQL client instead.`)
}
...
func runLsZones(_ *cobra.Command, _ []string) error {
	return errors.New(
		`Command "ls" has been removed. Use SHOW ZONE CONFIGURATIONS in a SQL client instead.`)
}
...
func runRmZone(_ *cobra.Command, _ []string) error {
	return errors.New(
		`Command "rm" has been removed. Use ALTER ... CONFIGURE ZONE DISCARD in a SQL client instead.`)
}
...
func runSetZone(_ *cobra.Command, _ []string) error {
	return errors.New(
		`Command "set" has been removed. Use ALTER ... CONFIGURE ZONE in a SQL client instead.`)
}
