...
func Example_statement_diag() {
	...
	commands := []string{
		...
		`INSERT INTO system.statement_diagnostics_requests(id, completed, statement_fingerprint, statement_diagnostics_id, requested_at, min_execution_latency_ms, expires_at)
	...
	//   5   2010-01-02 03:04:11 UTC  SELECT _ - _  NULL                   2010-01-02 03:04:12 +0000 UTC
	//   4   2010-01-02 03:04:10 UTC  SELECT _ + _  100ms                  NULL
