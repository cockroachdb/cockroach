...
func Example_statement_diag() {
	...
	commands := []string{
		...
		`INSERT INTO system.statement_diagnostics_requests(
                     id, completed, statement_fingerprint, plan_gist, statement_diagnostics_id,
		 ...
		 VALUES (1, TRUE, 'SELECT _ FROM _', '', 10, '2010-01-02 03:04:00', NULL, NULL, NULL),
		        ...
		        (5, FALSE, 'SELECT _ - _', 'foo', NULL, '2010-01-02 03:04:11', 1.0, NULL, '2030-01-02 03:04:12'),
		        (6, FALSE, 'SELECT _ / _', 'bar', NULL, '2010-01-02 03:04:12', NULL, '0s', NULL)`,
	}
	...
	//   ID  Activation time          Statement     Plan gist  Sampling probability  Min execution latency  Expires at
	//   6   2010-01-02 03:04:12 UTC  SELECT _ / _  bar        1.0000                N/A                    never
	//   5   2010-01-02 03:04:11 UTC  SELECT _ - _  foo        1.0000                N/A                    2030-01-02 03:04:12 +0000 UTC
