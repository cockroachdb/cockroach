...
func Example_statement_diag() {
	...
	commands := []string{
		...
		`INSERT INTO system.statement_diagnostics_requests(id, completed, statement_fingerprint, statement_diagnostics_id, requested_at, min_execution_latency)
		 VALUES (1, TRUE, 'SELECT _ FROM _', 10, '2010-01-02 03:04:00', '0'),
		        (2, TRUE, 'SELECT _ FROM _ WHERE _ > _', 20, '2010-01-02 03:04:02', '1s'),
		        (3, TRUE, 'SELECT _ FROM _ WHERE _ > _', 30, '2010-01-02 03:04:05', '1d 2h 3m'),
