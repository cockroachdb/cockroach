...
var stmtDiagDeleteCmd = &cobra.Command{
	Use:   "delete <id>",
	Short: "delete a statement diagnostics bundle",
	Long: `Delete a statements diagnostics bundle, using an ID returned by the list
command.`,
...
var stmtDiagCancelCmd = &cobra.Command{
	Use:   "cancel <id>",
	Short: "cancel an outstanding activation request",
