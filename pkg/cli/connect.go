...
var connectCmd = &cobra.Command{
	Use:   "connect --certs-dir=<path to cockroach certs dir> --init-token=<shared secret> <host 1> <host 2> ... <host N>",
...
`,
	Args: func(cmd *cobra.Command, args []string) error {
		if len(args) == 0 {
			return errors.Errorf("connect requires hostnames of all peers being initialized, none was specified")
		}
		return nil
	},
