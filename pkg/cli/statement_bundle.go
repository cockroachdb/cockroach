...
`, zipdir, bundle.statement)
	...
	if placeholderPairs != nil {
		...
		inputs, outputs, err := getExplainCombinations(conn, placeholderToColMap, bundle)
		if err != nil {
			return err
		}
...
// getExplainCombinations finds all unique explain plans for a given statement
...
func getExplainCombinations(
	conn clisqlclient.Conn, placeholderToColMap map[int]string, bundle *statementBundle,
