...
var _ flag.Value = &statementsValue{}
var _ pflag.Value = &statementsValue{}

var _ flag.Value = &mvccKey{}
var _ pflag.Value = &mvccKey{}

var _ flag.Value = &bytesOrPercentageValue{}
var _ pflag.Value = &bytesOrPercentageValue{}

// Go is a nuisance and doesn't let one instantiate a pointer-to-T
// value with the syntax &T{} if T is an alias for int. Until then, do
// this.
var _ = func() {
	var d dumpMode
	var _ flag.Value = &d
	...
	var tf tableDisplayFormat
	var _ flag.Value = &tf
	var _ pflag.Value = &tf

	var nd nodeDecommissionWaitType
	var _ flag.Value = &nd
	var _ pflag.Value = &nd
}
