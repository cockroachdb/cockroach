...
// source: liveness/livenesspb/liveness.proto
...
func (MembershipStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_liveness_80992826cd15d671, []int{0}
}
...
func (NodeLivenessStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_liveness_80992826cd15d671, []int{1}
}
...
type Liveness struct {
	...
	// representation.
	Membership MembershipStatus `protobuf:"varint,5,opt,name=membership,proto3,enum=cockroach.liveness.livenesspb.MembershipStatus" json:"membership,omitempty"`
}
...
func init() {
	proto.RegisterType((*Liveness)(nil), "cockroach.liveness.livenesspb.Liveness")
	proto.RegisterEnum("cockroach.liveness.livenesspb.MembershipStatus", MembershipStatus_name, MembershipStatus_value)
	proto.RegisterEnum("cockroach.liveness.livenesspb.NodeLivenessStatus", NodeLivenessStatus_name, NodeLivenessStatus_value)
}
...
func init() {
	proto.RegisterFile("liveness/livenesspb/liveness.proto", fileDescriptor_liveness_80992826cd15d671)
}

var fileDescriptor_liveness_80992826cd15d671 = []byte{
	// 533 bytes of a gzipped FileDescriptorProto
	,
}
