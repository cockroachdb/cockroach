...
func (dsp *DistSQLPlanner) Run(
	...
	ctx, flow, err := dsp.setupFlows(
		ctx, evalCtx, leafInputState, flows, recv, localState, vectorizedThresholdMet, planCtx.collectStats,
	)
	if err != nil {
		recv.SetError(err)
		return func() {}
...
func (dsp *DistSQLPlanner) planAndRunSubquery(
	...
	subqueryPlanCtx.collectStats = planner.instrumentation.collectStats
...
func (dsp *DistSQLPlanner) planAndRunPostquery(
	...
	postqueryPlanCtx.collectStats = planner.instrumentation.collectStats
