...
// evaluation failed.
// - subqueryResultMemAcc is the memory account that the result of subqueries'
//   evaluation will be registered with. It is the caller's responsibility to
//   shrink it (or close it) accordingly, once the references to those results
//   are lost.
...
// subqueryResultMemAcc must be non-nil memory account that the result of the
