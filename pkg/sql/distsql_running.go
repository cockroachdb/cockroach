...
func (dsp *DistSQLPlanner) setupFlows(
	...
	runnerCtx, runnerSpan := tracing.ChildSpan(origCtx, "SetupFlow" /* opName */)
	var cancelRunnerCtx context.CancelFunc
	runnerCtx, cancelRunnerCtx = context.WithCancel(runnerCtx)
	runnerCleanup := func() {
		cancelRunnerCtx()
		runnerSpan.Finish()
	}
