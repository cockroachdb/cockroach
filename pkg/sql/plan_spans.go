...
//
// Author: Nathan VanBenschoten <nathan@cockroachlabs.com>
...
func indexJoinSpans(ctx context.Context, n *indexJoinNode) (reads, writes roachpb.Spans, err error) {
...
func concatSpans(ctx context.Context, left, right planNode) (reads, writes roachpb.Spans, err error) {
