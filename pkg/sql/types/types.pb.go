...
func (Family) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_types_79d195be833777be, []int{0}
}
...
func init() { proto.RegisterFile("sql/types/types.proto", fileDescriptor_types_79d195be833777be) }

var fileDescriptor_types_79d195be833777be = []byte{
