...
import fmt "fmt"
import math "math"
import geo "github.com/cockroachdb/cockroach/pkg/geo"

import github_com_cockroachdb_cockroach_pkg_geo "github.com/cockroachdb/cockroach/pkg/geo"
...
const (
	...
	// GeometryFamily ...
	GeometryFamily Family = 90000
	// GeographyFamily...
	GeographyFamily Family = 90001
)
...
var Family_name = map[int32]string{
	...
	21:    "BitFamily",
	100:   "AnyFamily",
	90000: "GeometryFamily",
	90001: "GeographyFamily",
}
var Family_value = map[string]int32{
	...
	"BitFamily":            21,
	"AnyFamily":            100,
	"GeometryFamily":       90000,
	"GeographyFamily":      90001,
}
...
func (Family) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_types_7ae44d7f719cbe5a, []int{0}
}
...
func (IntervalDurationType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_types_7ae44d7f719cbe5a, []int{1}
}
...
// GeoField represents geography-specific data.
type GeoField struct {
	SpatialDataType geo.SpatialDataType                           `protobuf:"varint,1,opt,name=spatial_data_type,json=spatialDataType,enum=cockroach.geo.SpatialDataType" json:"spatial_data_type"`
	SRID            github_com_cockroachdb_cockroach_pkg_geo.SRID `protobuf:"varint,2,opt,name=srid,casttype=github.com/cockroachdb/cockroach/pkg/geo.SRID" json:"srid"`
}

func (m *GeoField) Reset()         { *m = GeoField{} }
func (m *GeoField) String() string { return proto.CompactTextString(m) }
func (*GeoField) ProtoMessage()    {}
func (*GeoField) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_7ae44d7f719cbe5a, []int{1}
}
func (m *GeoField) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GeoField) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalTo(b)
	if err != nil {
		return nil, err
...
func (dst *GeoField) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GeoField.Merge(dst, src)
}
func (m *GeoField) XXX_Size() int {
	return m.Size()
}
func (m *GeoField) XXX_DiscardUnknown() {
	xxx_messageInfo_GeoField.DiscardUnknown(m)
}

var xxx_messageInfo_GeoField proto.InternalMessageInfo
...
type InternalType struct {
	...
	// GeoField ...
	GeoField *GeoField `protobuf:"bytes,14,opt,name=geo_field,json=geoField" json:"geo_field,omitempty"`
}
...
func (*InternalType) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_7ae44d7f719cbe5a, []int{2}
}
...
func init() {
	...
	proto.RegisterType((*GeoField)(nil), "cockroach.sql.sem.types.GeoField")
...
func (m *GeoField) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *GeoField) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	dAtA[i] = 0x8
	i++
	i = encodeVarintTypes(dAtA, i, uint64(m.SpatialDataType))
	dAtA[i] = 0x10
	i++
...
func (m *InternalType) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.GeoField != nil {
		dAtA[i] = 0x72
		i++
		i = encodeVarintTypes(dAtA, i, uint64(m.GeoField.Size()))
		n3, err := m.GeoField.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n3
...
func (m *GeoField) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	n += 1 + sovTypes(uint64(m.SpatialDataType))
...
func (m *GeoField) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GeoField: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GeoField: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SpatialDataType", wireType)
			}
			m.SpatialDataType = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SpatialDataType |= (geo.SpatialDataType(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SRID |= (github_com_cockroachdb_cockroach_pkg_geo.SRID(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *InternalType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 14:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field GeoField", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.GeoField.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func init() { proto.RegisterFile("sql/types/types.proto", fileDescriptor_types_7ae44d7f719cbe5a) }

var fileDescriptor_types_7ae44d7f719cbe5a = []byte{
	...
	,
}
