...
// Canonical returns the canonical type for this type. Types with the same
// canonical type share an in-memory datum representation. If you have a datum
// of a type T, then `datum.ResolvedType` will be T.Canonical().
