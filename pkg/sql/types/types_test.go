...
func TestMarshalCompat(t *testing.T) {
	...
	testCases := []struct {
		...
		{RefCursor, InternalType{Family: StringFamily, Oid: oid.T_refcursor, VisibleType: visibleREFCURSOR}},
	}
...
func TestUnmarshalCompat(t *testing.T) {
	...
	testCases := []struct {
		...
		{InternalType{Family: StringFamily, VisibleType: visibleREFCURSOR}, RefCursor},
	}
