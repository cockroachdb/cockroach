...
func TestMakeTableDescColumns(t *testing.T) {
	...
	testData := []struct {
		...
		{
			"CHAR",
			types.ColumnType{SemanticType: types.STRING, Width: 1, XXX_Oid: oid.T_bpchar},
			true,
		},
		{
			"CHAR(3)",
			types.ColumnType{SemanticType: types.STRING, Width: 3, XXX_Oid: oid.T_bpchar},
			true,
		},
		{
			"VARCHAR",
			types.ColumnType{SemanticType: types.STRING, Width: 0, XXX_Oid: oid.T_varchar},
			true,
		},
		{
			"VARCHAR(3)",
			types.ColumnType{SemanticType: types.STRING, Width: 3, XXX_Oid: oid.T_varchar},
			true,
		},
		{
			"TEXT",
