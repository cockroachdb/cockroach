...
func PlanAndRunExport(
	...
	// just like in DistSQLPlanner.addAggregators, we need to update
	// planToStreamColMap, which was whatever came out of createPlanForNode,
	// with to reflect our new processor's outputs.
