...
// only code but not in test package because logictest isn't in a test package.
func RunCopyFrom(
	ctx context.Context,
	...
	// TODO: I believe newInternalPlanner should do this but doing it there causes lots of
	// diffs and test failures.
