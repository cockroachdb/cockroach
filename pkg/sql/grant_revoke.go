...
func (n *changePrivilegesNode) startExec(params runParams) error {
	...
	granteeInfo, err := ToSQLUsernamesWithCache(ctx, params.extendedEvalCtx.ExecCfg, params.extendedEvalCtx.Descs, params.extendedEvalCtx.ExecCfg.InternalExecutor, p.txn, n.grantees)
	if err != nil {
		return err
	}
