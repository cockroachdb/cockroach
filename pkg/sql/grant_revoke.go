...
func (p *planner) Grant(ctx context.Context, n *tree.Grant) (planNode, error) {
	...
	return &changePrivilegesNode{
		...
		changePrivilege: func(privDesc *catpb.PrivilegeDescriptor, privileges privilege.List, grantee username.SQLUsername) bool {
...
type changePrivilegesNode struct {
	...
	changePrivilege func(*catpb.PrivilegeDescriptor, privilege.List, username.SQLUsername) bool
