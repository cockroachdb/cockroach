...
func (p *planner) Grant(ctx context.Context, n *tree.Grant) (planNode, error) {
	grantOn, err := p.getPrivilegeObjectTypeFromGrantTargetList(
		ctx, n.Targets, sqltelemetry.IncIAMGrantPrivilegesCounter,
	)
	if err != nil {
...
func (p *planner) getPrivilegeObjectTypeFromGrantTargetList(
	ctx context.Context, targets tree.GrantTargetList, telemetryCounterIncrement func(string),
) (grantOn privilege.ObjectType, err error) {
	p.runWithOptions(resolveFlags{skipCache: true}, func() {
		grantOn, err = p.getGrantOnObject(ctx, targets, telemetryCounterIncrement)
	})
	if err != nil {
		return "", err
	}
...
func (p *planner) Revoke(ctx context.Context, n *tree.Revoke) (planNode, error) {
	grantOn, err := p.getPrivilegeObjectTypeFromGrantTargetList(
		ctx, n.Targets, sqltelemetry.IncIAMRevokePrivilegesCounter,
	)
	if err != nil {
