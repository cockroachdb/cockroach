...
// TestDescriptorRepairOrphanedDescriptors exercises cases where corruptions to the catalog could
// exist due to bugs and can now be repaired programmatically from SQL.
//
...
func TestDescriptorRepairOrphanedDescriptors(t *testing.T) {
	...
	// This test will inject the table an demonstrate
	// that there are problems. It will then repair it by injecting a new
	// database descriptor and namespace entry and then
