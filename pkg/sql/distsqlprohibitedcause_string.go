...
func _() {
	...
	_ = x[numDistSQLProhibitedCauses-65536]
}

func (i distSQLProhibitedCause) String() string {
	switch i {
	...
	case numDistSQLProhibitedCauses:
		return "numDistSQLProhibitedCauses"
	default:
		return "distSQLProhibitedCause(" + strconv.FormatInt(int64(i), 10) + ")"
	}
}
