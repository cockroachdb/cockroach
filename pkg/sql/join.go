...
// interleaveNodes returns the interleave ancestor and descendant scan node if
// the left and right children of the joinNode are both scan nodes and either
// of them is interleaved into the other. Otherwise, nils are returned.
