...
func (p *planner) AlterDomain(ctx context.Context, n *tree.AlterDomain) (planNode, error) {
	...
	case *tree.AlterDomainAddCheckConstraint:
		cmdName = "ALTER DOMAIN ADD CHECK CONSTRAINT"
	case *tree.AlterDomainAddNotNullConstraint:
		cmdName = "ALTER DOMAIN ADD NOT NULL CONSTRAINT"
