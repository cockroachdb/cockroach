...
func (ib *IndexBackfiller) InitForDistributedUse(
	...
	// Initialize ib.added.
	if err := ib.initIndexes(ctx, evalCtx, desc, allowList, sourceIndexID, flowCtx.Cfg.VecIndexManager.(*vecindex.Manager)); err != nil {
		return err
	}
...
func (ib *IndexBackfiller) initIndexes(
	...
	for _, idx := range ib.added {
		...
		if err := vecstore.InitGetFullVectorsFetchSpec(&helper.fullVecFetchSpec, evalCtx, desc, idx, ib.sourceIndex); err != nil {
			return err
		}
