...
func (ib *IndexBackfiller) initCols(desc *tabledesc.ImmutableTableDescriptor) {
...
func (ib *IndexBackfiller) initIndexes(desc *tabledesc.ImmutableTableDescriptor) util.FastIntSet {
	var valNeededForCol util.FastIntSet
