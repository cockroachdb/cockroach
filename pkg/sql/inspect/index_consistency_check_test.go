...
func TestInspectWithoutASOFSchemaChange(t *testing.T) {
	...
	var blockJobStart atomic.Bool
	blockJobStart.Store(true)
	...
	require.Regexp(t, "table has had a schema change", jobErr.String)
