...
// ValidateExpr takes an expr de-qualifies the column names and validates that
// expression is valid, has the correct type and has no impure functions if
// allowImpure is false. Returns the type-checked and constant-folded expression.
func ValidateExpr(
	ctx context.Context,
	desc sqlbase.TableDescriptorInterface,
	expr tree.Expr,
