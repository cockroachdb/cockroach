...
func DequalifyColumnRefs(source *sqlbase.DataSourceInfo, expr tree.Expr) (tree.Expr, error) {
...
// iterColDescriptors iterates over the expressions variable columns and
// calls f on each.
//
...
func (d *dummyColumn) TypeCheck(_ *tree.SemaContext, desired *types.T) (tree.TypedExpr, error) {
	return d, nil
}
