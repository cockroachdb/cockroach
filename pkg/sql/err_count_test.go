...
func TestErrorCounts(t *testing.T) {
	...
	count1 := telemetry.GetFeatureCounts()["pgerror."+pgerror.CodeSyntaxError]
	...
	count2 := telemetry.GetFeatureCounts()["pgerror."+pgerror.CodeSyntaxError]
	...
	count3 := telemetry.GetFeatureCounts()["pgerror."+pgerror.CodeSyntaxError]
