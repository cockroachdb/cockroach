...
// IdentityOption represents an option on a ALTER TABLE statement.
...
// Format implements the NodeFormatter interface.
func (node *IdentityOption) Format(ctx *FmtCtx) {
	if node.SeqOption != nil {
