...
// AlterTableSetGeneratedAlways represents an ALTER COLUMN SET GENERATED ALWAYS
// command.
type AlterTableSetGeneratedAlways struct {
	Column Name
}

// GetColumn implemnets the ColumnMutationCmd interface.
func (node *AlterTableSetGeneratedAlways) GetColumn() Name {
	return node.Column
}

// TelemetryName implements the AlterTableCmd interface.
func (node *AlterTableSetGeneratedAlways) TelemetryName() string {
	return "set_generated_always"
}

// Format implements the NodeFormatter interface.
func (node *AlterTableSetGeneratedAlways) Format(ctx *FmtCtx) {
	ctx.WriteString(" ALTER COLUMN ")
	ctx.FormatNode(&node.Column)
	ctx.WriteString(" SET GENERATED ALWAYS")
}

// AlterTableSetGeneratedDefault represents an ALTER COLUMN SET GENERATED BY
// DEFAULT command.
type AlterTableSetGeneratedDefault struct {
	Column Name
}

// GetColumn implemnets the ColumnMutationCmd interface.
func (node *AlterTableSetGeneratedDefault) GetColumn() Name {
	return node.Column
}

// TelemetryName implements the AlterTableCmd interface.
func (node *AlterTableSetGeneratedDefault) TelemetryName() string {
	return "set_generated_default"
}

// Format implements the NodeFormatter interface.
func (node *AlterTableSetGeneratedDefault) Format(ctx *FmtCtx) {
	ctx.WriteString(" ALTER COLUMN ")
	ctx.FormatNode(&node.Column)
