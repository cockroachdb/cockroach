...
func CanWriteData(stmt Statement) bool {
	...
	case *Split, *TestingRelocate, *TestingRelocateLease, *Scatter:
		return true
	}
	return false
}
...
// StatementType implements the Statement interface.
func (*TestingRelocateLease) StatementType() StatementType { return Rows }

// StatementTag returns a short string identifying the type of statement.
func (*TestingRelocateLease) StatementTag() string { return "EXPERIMENTAL_RELOCATE LEASE" }
...
func (n *TestingRelocateLease) String() string      { return AsString(n) }
