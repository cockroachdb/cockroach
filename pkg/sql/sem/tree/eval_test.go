...
func TestEval(t *testing.T) {
	testData := []struct {
		...
		{`'A' LIKE '\A' ESCAPE ''`, `false`},
		{`'\' LIKE '\' ESCAPE '-'`, `true`},
		{`'\' LIKE '-\' ESCAPE '-'`, `true`},
		{`'\abc\' LIKE '-\___-\' ESCAPE '-'`, `true`},
		{`'\abc\' LIKE '\___\' ESCAPE '-'`, `true`},
		{`'\abc\' LIKE '-\___-\' ESCAPE ''`, `false`},
		{`'___' LIKE '\___' ESCAPE ''`, `false`},
		{`'aa' LIKE '__' ESCAPE '_'`, `false`},
		{`'aa' LIKE '_a_a' ESCAPE '_'`, `true`},
		{`'_' LIKE '__' ESCAPE '_'`, `true`},
		{`'__' LIKE '____' ESCAPE '_'`, `true`},
		{`'___' LIKE '______' ESCAPE '_'`, `true`},
		{`'abc' LIKE 'a%%' ESCAPE '%'`, `false`},
		{`'ab' LIKE '____' ESCAPE '_'`, `false`},
		{`'\a\b\c' LIKE '\_\_\_' ESCAPE ''`, `true`},
		{`'%%' LIKE '_%_%' ESCAPE '_'`, `true`},
		{`'%%a' LIKE '_%_%' ESCAPE '_'`, `false`},
		{`'\-\' LIKE '-\---\' ESCAPE '-'`, `true`},
		{`'\-\' LIKE '\--\' ESCAPE '-'`, `true`},
		{`'_%' LIKE 'a_a%' ESCAPE 'a'`, `true`},
		{`'\---\' LIKE '-\-------\' ESCAPE '-'`, `true`},
		{`'abc' LIKE '%bc' ESCAPE '%'`, `false`},
		{`'abc' LIKE '_bc' ESCAPE '_'`, `false`},
		{`'abc' LIKE '_b%' ESCAPE '_'`, `false`},
		{`'abc' LIKE '%b_' ESCAPE '%'`, `false`},
		{`'abc' LIKE '_a%' ESCAPE '_'`, `true`},
		{`'abc' LIKE '%a__' ESCAPE '%'`, `true`},
		// ILIKE with ESCAPE clause
		{`'A' ILIKE '\a' ESCAPE ''`, `false`},
		{`'\' ILIKE '\' ESCAPE '-'`, `true`},
		{`'\' ILIKE '-\' ESCAPE '-'`, `true`},
		{`'\ABC\' ILIKE '-\___-\' ESCAPE '-'`, `true`},
		{`'\ABC\' ILIKE '\___\' ESCAPE '-'`, `true`},
		{`'\ABC\' ILIKE '-\___-\' ESCAPE ''`, `false`},
		{`'___' ILIKE '\___' ESCAPE ''`, `false`},
		{`'AA' ILIKE '__' ESCAPE '_'`, `false`},
		{`'AA' ILIKE '_a_a' ESCAPE '_'`, `true`},
		{`'_' ILIKE '__' ESCAPE '_'`, `true`},
		{`'__' ILIKE '____' ESCAPE '_'`, `true`},
		{`'___' ILIKE '______' ESCAPE '_'`, `true`},
		{`'ABC' ILIKE 'a%%' ESCAPE '%'`, `false`},
		{`'AB' ILIKE '____' ESCAPE '_'`, `false`},
		{`'\A\B\C' ILIKE '\_\_\_' ESCAPE ''`, `true`},
		{`'%%' ILIKE '_%_%' ESCAPE '_'`, `true`},
		{`'%%a' ILIKE '_%_%' ESCAPE '_'`, `false`},
		{`'\-\' ILIKE '-\---\' ESCAPE '-'`, `true`},
		{`'\-\' ILIKE '\--\' ESCAPE '-'`, `true`},
		{`'_%' ILIKE 'a_a%' ESCAPE 'a'`, `true`},
		{`'\---\' ILIKE '-\-------\' ESCAPE '-'`, `true`},
		{`'abc' ILIKE '%bc' ESCAPE '%'`, `false`},
		{`'abc' ILIKE '_bc' ESCAPE '_'`, `false`},
		{`'abc' ILIKE '_b%' ESCAPE '_'`, `false`},
		{`'abc' ILIKE '%b_' ESCAPE '%'`, `false`},
		{`'abc' ILIKE '_a%' ESCAPE '_'`, `true`},
		{`'abc' ILIKE '%a__' ESCAPE '%'`, `true`},
		{`'abCD' ILIKE 'AB-c-d' ESCAPE '-'`, `true`},
		// NOT LIKE with ESCAPE clause
		{`'A' NOT LIKE '\A' ESCAPE ''`, `true`},
		{`'\' NOT LIKE '\' ESCAPE '-'`, `false`},
		{`'\' NOT LIKE '-\' ESCAPE '-'`, `false`},
		{`'\abc\' NOT LIKE '-\___-\' ESCAPE '-'`, `false`},
		{`'\abc\' NOT LIKE '\___\' ESCAPE '-'`, `false`},
		{`'\abc\' NOT LIKE '-\___-\' ESCAPE ''`, `true`},
		{`'___' NOT LIKE '\___' ESCAPE ''`, `true`},
		{`'aa' NOT LIKE '__' ESCAPE '_'`, `true`},
		{`'aa' NOT LIKE '_a_a' ESCAPE '_'`, `false`},
		{`'_' NOT LIKE '__' ESCAPE '_'`, `false`},
		{`'__' NOT LIKE '____' ESCAPE '_'`, `false`},
		{`'___' NOT LIKE '______' ESCAPE '_'`, `false`},
		{`'abc' NOT LIKE 'a%%' ESCAPE '%'`, `true`},
		{`'ab' NOT LIKE '____' ESCAPE '_'`, `true`},
		{`'\a\b\c' NOT LIKE '\_\_\_' ESCAPE ''`, `false`},
		{`'%%' NOT LIKE '_%_%' ESCAPE '_'`, `false`},
		{`'%%a' NOT LIKE '_%_%' ESCAPE '_'`, `true`},
		{`'\-\' NOT LIKE '-\---\' ESCAPE '-'`, `false`},
		{`'\-\' NOT LIKE '\--\' ESCAPE '-'`, `false`},
		{`'_%' NOT LIKE 'a_a%' ESCAPE 'a'`, `false`},
		{`'\---\' NOT LIKE '-\-------\' ESCAPE '-'`, `false`},
		{`'abc' NOT LIKE '%bc' ESCAPE '%'`, `true`},
		{`'abc' NOT LIKE '_bc' ESCAPE '_'`, `true`},
		{`'abc' NOT LIKE '_b%' ESCAPE '_'`, `true`},
		{`'abc' NOT LIKE '%b_' ESCAPE '%'`, `true`},
		{`'abc' NOT LIKE '_a%' ESCAPE '_'`, `false`},
		{`'abc' NOT LIKE '%a__' ESCAPE '%'`, `false`},
		// NOT ILIKE with ESCAPE clause
		{`'A' NOT ILIKE '\a' ESCAPE ''`, `true`},
		{`'\' NOT ILIKE '\' ESCAPE '-'`, `false`},
		{`'\' NOT ILIKE '-\' ESCAPE '-'`, `false`},
		{`'\ABC\' NOT ILIKE '-\___-\' ESCAPE '-'`, `false`},
		{`'\ABC\' NOT ILIKE '\___\' ESCAPE '-'`, `false`},
		{`'\ABC\' NOT ILIKE '-\___-\' ESCAPE ''`, `true`},
		{`'___' NOT ILIKE '\___' ESCAPE ''`, `true`},
		{`'AA' NOT ILIKE '__' ESCAPE '_'`, `true`},
		{`'AA' NOT ILIKE '_a_a' ESCAPE '_'`, `false`},
		{`'_' NOT ILIKE '__' ESCAPE '_'`, `false`},
		{`'__' NOT ILIKE '____' ESCAPE '_'`, `false`},
		{`'___' NOT ILIKE '______' ESCAPE '_'`, `false`},
		{`'ABC' NOT ILIKE 'a%%' ESCAPE '%'`, `true`},
		{`'AB' NOT ILIKE '____' ESCAPE '_'`, `true`},
		{`'\A\B\C' NOT ILIKE '\_\_\_' ESCAPE ''`, `false`},
		{`'%%' NOT ILIKE '_%_%' ESCAPE '_'`, `false`},
		{`'%%a' NOT ILIKE '_%_%' ESCAPE '_'`, `true`},
		{`'\-\' NOT ILIKE '-\---\' ESCAPE '-'`, `false`},
		{`'\-\' NOT ILIKE '\--\' ESCAPE '-'`, `false`},
		{`'_%' NOT ILIKE 'a_a%' ESCAPE 'a'`, `false`},
		{`'\---\' NOT ILIKE '-\-------\' ESCAPE '-'`, `false`},
		{`'abc' NOT ILIKE '%bc' ESCAPE '%'`, `true`},
		{`'abc' NOT ILIKE '_bc' ESCAPE '_'`, `true`},
		{`'abc' NOT ILIKE '_b%' ESCAPE '_'`, `true`},
		{`'abc' NOT ILIKE '%b_' ESCAPE '%'`, `true`},
		{`'abc' NOT ILIKE '_a%' ESCAPE '_'`, `false`},
		{`'abc' NOT ILIKE '%a__' ESCAPE '%'`, `false`},
		{`'abCD' NOT ILIKE 'AB-c-d' ESCAPE '-'`, `false`},
...
func TestEvalError(t *testing.T) {
	testData := []struct {
		...
		{`'___' LIKE '\___' ESCAPE 'abc'`, `invalid escape string`},
		{`'__' LIKE '_' ESCAPE '_'`, `LIKE pattern must not end with escape character`},
		{`'%%' LIKE '%' ESCAPE '%'`, `LIKE pattern must not end with escape character`},
		{`'__' LIKE '___' ESCAPE '_'`, `LIKE regexp compilation failed: LIKE pattern must not end with escape character`},
		{`'%%' LIKE '%%%' ESCAPE '%'`, `LIKE regexp compilation failed: LIKE pattern must not end with escape character`},
		{`'abc' LIKE 'ab%' ESCAPE '%'`, `LIKE regexp compilation failed: pattern ends with escape character`},
		{`'abc' LIKE '%b%' ESCAPE '%'`, `LIKE regexp compilation failed: pattern ends with escape character`},
		{`'abc' LIKE 'ab_' ESCAPE '_'`, `LIKE regexp compilation failed: pattern ends with escape character`},
		{`'abc' LIKE '%b_' ESCAPE '_'`, `LIKE regexp compilation failed: pattern ends with escape character`},
	}
	for _, d := range testData {
		expr, err := parser.ParseExpr(d.expr)
		if err != nil {
