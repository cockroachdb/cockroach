...
// NewPrefixedOverload creates a new PrefixedOverload.
func NewPrefixedOverload(schema string, overload *Overload) *PrefixedOverload {
...
func (fd *ResolvedFunctionDefinition) MergeWith(
	...
	return &ResolvedFunctionDefinition{
		Name:            fd.Name,
		Overloads:       combinePrefixedOverloads(fd.Overloads, another.Overloads),
		OriginOverloads: combineOverloads(fd.OriginOverloads, another.OriginOverloads),
	}, nil
}

func combineOverloads(a, b []*Overload) []*Overload {
	return append(append(make([]*Overload, 0, len(a)+len(b)), a...), b...)
}

func combinePrefixedOverloads(a, b []*PrefixedOverload) []*PrefixedOverload {
	return append(append(make([]*PrefixedOverload, 0, len(a)+len(b)), a...), b...)
}
...
func (fd *ResolvedFunctionDefinition) GetClass() (FunctionClass, error) {
	return getFuncClass(fd.Name, fd.OriginOverloads)
}
...
func (fd *ResolvedFunctionDefinition) GetReturnLabel() ([]string, error) {
	return getFuncReturnLabels(fd.Name, fd.OriginOverloads)
}
...
func (fd *ResolvedFunctionDefinition) GetHasSequenceArguments() (bool, error) {
	return getHasSequenceArguments(fd.Name, fd.OriginOverloads)
}
