...
// GetClass returns function class by checking each overload's Class and return
...
// GetReturnLabel returns function ReturnLabel by checking each overload's and
// return a ReturnLabel if all overloads have ReturnLabel of same length.
