...
func TestParseColumnType(t *testing.T) {
	testData := []struct {
		...
		{"STRING COLLATE da", &coltypes.TCollatedString{Variant: coltypes.TStringVariantSTRING, Locale: "da"}},
		{"CHAR COLLATE de", &coltypes.TCollatedString{Variant: coltypes.TStringVariantCHAR, N: 1, Locale: "de"}},
		{"CHAR(11) COLLATE de", &coltypes.TCollatedString{Variant: coltypes.TStringVariantCHAR, N: 11, Locale: "de"}},
		{"VARCHAR COLLATE en", &coltypes.TCollatedString{Variant: coltypes.TStringVariantVARCHAR, Locale: "en"}},
		{"VARCHAR(2) COLLATE en", &coltypes.TCollatedString{Variant: coltypes.TStringVariantVARCHAR, N: 2, Locale: "en"}},
	}
