...
// N.B. Wherever an IsOfTypeExpr is cased on before typechecking, make sure
// to also consider an UnresolvedIsOfTypeExpr in the same context.
...
// N.B. Wherever an UnresolvedCastExpr is cased on before typechecking, make
// sure to also consider an UnresolvedCastExpr in the same context.
...
// UnresolvedAnnotateTypeExpr represents a ANNOTATE_TYPE(expr, type) expression
...
// N.B. Wherever an AnnotateTypeExpr is cased on before typechecking, make sure
// to also consider an UnresolvedAnnotateTypeExpr in the same context.
