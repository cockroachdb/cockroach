...
func (_ FunctionNullInputBehavior) functionOption() {}
...
func (node FunctionNullInputBehavior) Format(f *FmtCtx) {
	f.WriteString(string(node))
}

const (
	FunctionCalledOnNullInput      FunctionNullInputBehavior = "CALLED ON NULL INPUT"
	FunctionReturnsNullOnNullInput FunctionNullInputBehavior = "RETURNS NULL ON NULL INPUT"
	FunctionStrict                 FunctionNullInputBehavior = "STRICT"
)
