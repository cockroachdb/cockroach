...
const (
	...
	pgCast
	// automaticIOConversion specifies that a cast's maximum context is not
	// included in Postgres's pg_cast table. In Postgres's internals, these
	// casts are evaluated by each data type's input and output functions.
	//
...
//
// Entries with a pgCast origin were automatically generated by the
// cast_map_gen.sh script. The script outputs some types that we do not support.
// Those types were manually deleted. Entries with an automaticIOConversion
// origin were manually added.
var castMap = map[oid.Oid]map[oid.Oid]cast{
	oid.T_bit: {
		oid.T_bit:    {maxContext: CastContextImplicit, origin: pgCast},
		oid.T_int4:   {maxContext: CastContextExplicit, origin: pgCast},
		oid.T_int8:   {maxContext: CastContextExplicit, origin: pgCast},
		oid.T_varbit: {maxContext: CastContextImplicit, origin: pgCast},
		// Automatic I/O conversions to string types.
		oid.T_bpchar:  {maxContext: CastContextAssignment, origin: automaticIOConversion},
		oid.T_char:    {maxContext: CastContextAssignment, origin: automaticIOConversion},
		oid.T_name:    {maxContext: CastContextAssignment, origin: automaticIOConversion},
		oid.T_text:    {maxContext: CastContextAssignment, origin: automaticIOConversion},
		oid.T_varchar: {maxContext: CastContextAssignment, origin: automaticIOConversion},
	},
	oid.T_bool: {
		oid.T_bpchar:  {maxContext: CastContextAssignment, origin: pgCast},
		oid.T_int4:    {maxContext: CastContextExplicit, origin: pgCast},
		oid.T_text:    {maxContext: CastContextAssignment, origin: pgCast},
		oid.T_varchar: {maxContext: CastContextAssignment, origin: pgCast},
		// Automatic I/O conversions to string types.
		oid.T_char: {maxContext: CastContextAssignment, origin: automaticIOConversion},
		oid.T_name: {maxContext: CastContextAssignment, origin: automaticIOConversion},
	},
	oidext.T_box2d: {
		oidext.T_geometry: {maxContext: CastContextImplicit, origin: pgCast},
		// Automatic I/O conversions to string types.
		oid.T_bpchar:  {maxContext: CastContextAssignment, origin: automaticIOConversion},
		oid.T_char:    {maxContext: CastContextAssignment, origin: automaticIOConversion},
		oid.T_name:    {maxContext: CastContextAssignment, origin: automaticIOConversion},
	...
	oid.T_bpchar: {
		oid.T_bpchar:  {maxContext: CastContextImplicit, origin: pgCast},
		oid.T_char:    {maxContext: CastContextAssignment, origin: pgCast},
		oid.T_name:    {maxContext: CastContextImplicit, origin: pgCast},
		oid.T_text:    {maxContext: CastContextImplicit, origin: pgCast},
		oid.T_varchar: {maxContext: CastContextImplicit, origin: pgCast},
		// Automatic I/O conversions from bpchar to other types.
		oid.T_bit:          {maxContext: CastContextExplicit, origin: automaticIOConversion},
		oidext.T_box2d:     {maxContext: CastContextExplicit, origin: automaticIOConversion},
		oid.T_bytea:        {maxContext: CastContextExplicit, origin: automaticIOConversion},
		oid.T_date:         {maxContext: CastContextExplicit, origin: automaticIOConversion},
		oid.T_float4:       {maxContext: CastContextExplicit, origin: automaticIOConversion},
		oid.T_float8:       {maxContext: CastContextExplicit, origin: automaticIOConversion},
		oidext.T_geography: {maxContext: CastContextExplicit, origin: automaticIOConversion},
		oidext.T_geometry:  {maxContext: CastContextExplicit, origin: automaticIOConversion},
		oid.T_inet:         {maxContext: CastContextExplicit, origin: automaticIOConversion},
		oid.T_int2:         {maxContext: CastContextExplicit, origin: automaticIOConversion},
		oid.T_int4:         {maxContext: CastContextExplicit, origin: automaticIOConversion},
		oid.T_int8:         {maxContext: CastContextExplicit, origin: automaticIOConversion},
		oid.T_interval:     {maxContext: CastContextExplicit, origin: automaticIOConversion},
		oid.T_jsonb:        {maxContext: CastContextExplicit, origin: automaticIOConversion},
		oid.T_numeric:      {maxContext: CastContextExplicit, origin: automaticIOConversion},
		oid.T_oid:          {maxContext: CastContextExplicit, origin: automaticIOConversion},
		oid.T_regclass:     {maxContext: CastContextExplicit, origin: automaticIOConversion},
		oid.T_regnamespace: {maxContext: CastContextExplicit, origin: automaticIOConversion},
		oid.T_regproc:      {maxContext: CastContextExplicit, origin: automaticIOConversion},
		oid.T_regprocedure: {maxContext: CastContextExplicit, origin: automaticIOConversion},
		oid.T_regrole:      {maxContext: CastContextExplicit, origin: automaticIOConversion},
		oid.T_regtype:      {maxContext: CastContextExplicit, origin: automaticIOConversion},
		oid.T_time:         {maxContext: CastContextExplicit, origin: automaticIOConversion},
		oid.T_timestamp:    {maxContext: CastContextExplicit, origin: automaticIOConversion},
		oid.T_timestamptz:  {maxContext: CastContextExplicit, origin: automaticIOConversion},
		oid.T_timetz:       {maxContext: CastContextExplicit, origin: automaticIOConversion},
		oid.T_varbit:       {maxContext: CastContextExplicit, origin: automaticIOConversion},
	},
	oid.T_bytea: {
		oidext.T_geography: {maxContext: CastContextImplicit, origin: pgCast},
		oidext.T_geometry:  {maxContext: CastContextImplicit, origin: pgCast},
		// Automatic I/O conversions to string types.
		oid.T_bpchar:  {maxContext: CastContextAssignment, origin: automaticIOConversion},
		oid.T_char:    {maxContext: CastContextAssignment, origin: automaticIOConversion},
	...
	oid.T_date: {
		oid.T_timestamp:   {maxContext: CastContextImplicit, origin: pgCast},
		oid.T_timestamptz: {maxContext: CastContextImplicit, origin: pgCast},
		// Automatic I/O conversions to string types.
		oid.T_bpchar:  {maxContext: CastContextAssignment, origin: automaticIOConversion},
		oid.T_char:    {maxContext: CastContextAssignment, origin: automaticIOConversion},
		oid.T_name:    {maxContext: CastContextAssignment, origin: automaticIOConversion},
	...
	oid.T_float4: {
		oid.T_float8:  {maxContext: CastContextImplicit, origin: pgCast},
		oid.T_int2:    {maxContext: CastContextAssignment, origin: pgCast},
		oid.T_int4:    {maxContext: CastContextAssignment, origin: pgCast},
		oid.T_int8:    {maxContext: CastContextAssignment, origin: pgCast},
		oid.T_numeric: {maxContext: CastContextAssignment, origin: pgCast},
		// Automatic I/O conversions to string types.
		oid.T_bpchar:  {maxContext: CastContextAssignment, origin: automaticIOConversion},
		oid.T_char:    {maxContext: CastContextAssignment, origin: automaticIOConversion},
		oid.T_name:    {maxContext: CastContextAssignment, origin: automaticIOConversion},
	...
	oid.T_float8: {
		oid.T_float4:  {maxContext: CastContextAssignment, origin: pgCast},
		oid.T_int2:    {maxContext: CastContextAssignment, origin: pgCast},
		oid.T_int4:    {maxContext: CastContextAssignment, origin: pgCast},
		oid.T_int8:    {maxContext: CastContextAssignment, origin: pgCast},
		oid.T_numeric: {maxContext: CastContextAssignment, origin: pgCast},
	...
	oidext.T_geography: {
		oid.T_bytea:        {maxContext: CastContextImplicit, origin: pgCast},
		oidext.T_geography: {maxContext: CastContextImplicit, origin: pgCast},
		oidext.T_geometry:  {maxContext: CastContextExplicit, origin: pgCast},
		// Automatic I/O conversions to string types.
		oid.T_bpchar:  {maxContext: CastContextAssignment, origin: automaticIOConversion},
		oid.T_char:    {maxContext: CastContextAssignment, origin: automaticIOConversion},
		oid.T_name:    {maxContext: CastContextAssignment, origin: automaticIOConversion},
	...
	oidext.T_geometry: {
		oidext.T_box2d:     {maxContext: CastContextImplicit, origin: pgCast},
		oid.T_bytea:        {maxContext: CastContextImplicit, origin: pgCast},
		oidext.T_geography: {maxContext: CastContextImplicit, origin: pgCast},
		oidext.T_geometry:  {maxContext: CastContextImplicit, origin: pgCast},
		oid.T_jsonb:        {maxContext: CastContextExplicit, origin: pgCast},
		oid.T_text:         {maxContext: CastContextImplicit, origin: pgCast},
		// Automatic I/O conversions to string types.
		oid.T_bpchar:  {maxContext: CastContextAssignment, origin: automaticIOConversion},
		oid.T_char:    {maxContext: CastContextAssignment, origin: automaticIOConversion},
	...
	oid.T_int2: {
		oid.T_float4:       {maxContext: CastContextImplicit, origin: pgCast},
		oid.T_float8:       {maxContext: CastContextImplicit, origin: pgCast},
		oid.T_int4:         {maxContext: CastContextImplicit, origin: pgCast},
		oid.T_int8:         {maxContext: CastContextImplicit, origin: pgCast},
		oid.T_numeric:      {maxContext: CastContextImplicit, origin: pgCast},
		oid.T_oid:          {maxContext: CastContextImplicit, origin: pgCast},
		oid.T_regclass:     {maxContext: CastContextImplicit, origin: pgCast},
		oid.T_regnamespace: {maxContext: CastContextImplicit, origin: pgCast},
		oid.T_regproc:      {maxContext: CastContextImplicit, origin: pgCast},
		oid.T_regprocedure: {maxContext: CastContextImplicit, origin: pgCast},
		oid.T_regrole:      {maxContext: CastContextImplicit, origin: pgCast},
		oid.T_regtype:      {maxContext: CastContextImplicit, origin: pgCast},
		// Automatic I/O conversions to string types.
		oid.T_bpchar:  {maxContext: CastContextAssignment, origin: automaticIOConversion},
		oid.T_char:    {maxContext: CastContextAssignment, origin: automaticIOConversion},
		oid.T_name:    {maxContext: CastContextAssignment, origin: automaticIOConversion},
	...
	oid.T_int4: {
		oid.T_bit:          {maxContext: CastContextExplicit, origin: pgCast},
		oid.T_bool:         {maxContext: CastContextExplicit, origin: pgCast},
		oid.T_char:         {maxContext: CastContextExplicit, origin: pgCast},
		oid.T_float4:       {maxContext: CastContextImplicit, origin: pgCast},
		oid.T_float8:       {maxContext: CastContextImplicit, origin: pgCast},
		oid.T_int2:         {maxContext: CastContextAssignment, origin: pgCast},
		oid.T_int8:         {maxContext: CastContextImplicit, origin: pgCast},
	...
	oid.T_interval: {
		oid.T_interval: {maxContext: CastContextImplicit, origin: pgCast},
		oid.T_time:     {maxContext: CastContextAssignment, origin: pgCast},
		// Automatic I/O conversions to string types.
		oid.T_bpchar:  {maxContext: CastContextAssignment, origin: automaticIOConversion},
		oid.T_char:    {maxContext: CastContextAssignment, origin: automaticIOConversion},
		oid.T_name:    {maxContext: CastContextAssignment, origin: automaticIOConversion},
	...
	oid.T_jsonb: {
		oid.T_bool:    {maxContext: CastContextExplicit, origin: pgCast},
		oid.T_float4:  {maxContext: CastContextExplicit, origin: pgCast},
		oid.T_float8:  {maxContext: CastContextExplicit, origin: pgCast},
		oid.T_int2:    {maxContext: CastContextExplicit, origin: pgCast},
		oid.T_int4:    {maxContext: CastContextExplicit, origin: pgCast},
		oid.T_int8:    {maxContext: CastContextExplicit, origin: pgCast},
		oid.T_numeric: {maxContext: CastContextExplicit, origin: pgCast},
		// Automatic I/O conversions to string types.
		oid.T_bpchar:  {maxContext: CastContextAssignment, origin: automaticIOConversion},
		oid.T_char:    {maxContext: CastContextAssignment, origin: automaticIOConversion},
		oid.T_name:    {maxContext: CastContextAssignment, origin: automaticIOConversion},
	...
	oid.T_time: {
		oid.T_interval: {maxContext: CastContextImplicit, origin: pgCast},
		oid.T_time:     {maxContext: CastContextImplicit, origin: pgCast},
		oid.T_timetz:   {maxContext: CastContextImplicit, origin: pgCast},
		// Automatic I/O conversions to string types.
		oid.T_bpchar:  {maxContext: CastContextAssignment, origin: automaticIOConversion},
		oid.T_char:    {maxContext: CastContextAssignment, origin: automaticIOConversion},
		oid.T_name:    {maxContext: CastContextAssignment, origin: automaticIOConversion},
	...
	oid.T_timestamp: {
		oid.T_date:        {maxContext: CastContextAssignment, origin: pgCast},
		oid.T_time:        {maxContext: CastContextAssignment, origin: pgCast},
		oid.T_timestamp:   {maxContext: CastContextImplicit, origin: pgCast},
		oid.T_timestamptz: {maxContext: CastContextImplicit, origin: pgCast},
		// Automatic I/O conversions to string types.
	...
	oid.T_timestamptz: {
		oid.T_date:        {maxContext: CastContextAssignment, origin: pgCast},
		oid.T_time:        {maxContext: CastContextAssignment, origin: pgCast},
		oid.T_timestamp:   {maxContext: CastContextAssignment, origin: pgCast},
		oid.T_timestamptz: {maxContext: CastContextImplicit, origin: pgCast},
		oid.T_timetz:      {maxContext: CastContextAssignment, origin: pgCast},
		// Automatic I/O conversions to string types.
		oid.T_bpchar:  {maxContext: CastContextAssignment, origin: automaticIOConversion},
		oid.T_char:    {maxContext: CastContextAssignment, origin: automaticIOConversion},
		oid.T_name:    {maxContext: CastContextAssignment, origin: automaticIOConversion},
...
func init() {
	...
	for src, tgts := range castMap {
		for tgt := range tgts {
			...
			if isStringType(tgt) && ent.origin == automaticIOConversion &&
			...
			if isStringType(src) && !isStringType(tgt) && ent.origin == automaticIOConversion &&
