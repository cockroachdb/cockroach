...
var castMap = map[oid.Oid]map[oid.Oid]cast{
	...
	oid.T_bpchar: {
		...
		oid.T_oid:          {maxContext: CastContextExplicit, origin: contextOriginAutomaticIOConversion, volatility: volatilityTODO},
		oid.T_regclass:     {maxContext: CastContextExplicit, origin: contextOriginAutomaticIOConversion, volatility: volatilityTODO},
		oid.T_regnamespace: {maxContext: CastContextExplicit, origin: contextOriginAutomaticIOConversion, volatility: volatilityTODO},
		oid.T_regproc:      {maxContext: CastContextExplicit, origin: contextOriginAutomaticIOConversion, volatility: volatilityTODO},
		oid.T_regprocedure: {maxContext: CastContextExplicit, origin: contextOriginAutomaticIOConversion, volatility: volatilityTODO},
		oid.T_regrole:      {maxContext: CastContextExplicit, origin: contextOriginAutomaticIOConversion, volatility: volatilityTODO},
		oid.T_regtype:      {maxContext: CastContextExplicit, origin: contextOriginAutomaticIOConversion, volatility: volatilityTODO},
	...
	oid.T_int2: {
		...
		oid.T_oid:          {maxContext: CastContextImplicit, origin: contextOriginPgCast, volatility: volatilityTODO},
		oid.T_regclass:     {maxContext: CastContextImplicit, origin: contextOriginPgCast, volatility: volatilityTODO},
		oid.T_regnamespace: {maxContext: CastContextImplicit, origin: contextOriginPgCast, volatility: volatilityTODO},
		oid.T_regproc:      {maxContext: CastContextImplicit, origin: contextOriginPgCast, volatility: volatilityTODO},
		oid.T_regprocedure: {maxContext: CastContextImplicit, origin: contextOriginPgCast, volatility: volatilityTODO},
		oid.T_regrole:      {maxContext: CastContextImplicit, origin: contextOriginPgCast, volatility: volatilityTODO},
		oid.T_regtype:      {maxContext: CastContextImplicit, origin: contextOriginPgCast, volatility: volatilityTODO},
		// Automatic I/O conversions to string types.
		oid.T_bpchar:  {maxContext: CastContextAssignment, origin: contextOriginAutomaticIOConversion, volatility: volatilityTODO},
		oid.T_char:    {maxContext: CastContextAssignment, origin: contextOriginAutomaticIOConversion, volatility: volatilityTODO},
		oid.T_name:    {maxContext: CastContextAssignment, origin: contextOriginAutomaticIOConversion, volatility: volatilityTODO},
