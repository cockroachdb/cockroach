...
// at most two levels of the tree. In essence, it determines whether an
// expression is constant by checking whether its children are const Datums.
//
...
type fastIsConstVisitor struct {
	...
	// fastIsConstVisitor only visits at most two levels of the tree.
	visited bool
}
