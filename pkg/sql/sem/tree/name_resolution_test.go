...
func (f *fakeSource) Resolve(
	_ context.Context, prefix *tree.TableName, srcMeta interface{}, colHint int, col tree.Name,
) (interface{}, error) {
	f.t.Logf("in Resolve: prefix %s meta %v colHint %d col %s",
		prefix, srcMeta, colHint, col)
	columns, ok := srcMeta.([]tree.Name)
	if !ok {
	...
	if colHint >= 0 {
		...
		return fmt.Sprintf("%s.%s(%d)", prefix, col, colHint), nil
	}
	for c, cn := range columns {
		if col == cn {
			// Resolution succeeded.
			return fmt.Sprintf("%s.%s(%d)", prefix, col, c), nil
		}
	}
	...
	for _, tc := range testCases {
		t.Run(tc.in, func(t *testing.T) {
			...
			out, err := func() (string, error) {
				...
				s, ok := res.(string)
				if !ok {
					return "", fmt.Errorf("fake resolver did not return string, found %T instead", res)
				}
				return s, nil
			}()
			if !testutils.IsError(err, tc.err) {
...
) (found bool, obMeta interface{}, err error) {
	defer func() {
...
func TestResolveTablePatternOrName(t *testing.T) {
	testCases := []struct {
		...
		{`foo`, `db1`, mpath([]string{"public", "pg_catalog"}), true, `foo`, `db1.public.foo`, `db1.public[0]`, ``},
		{`blix`, `db1`, mpath([]string{"public", "pg_catalog"}), true, ``, ``, ``, `prefix or object not found`},
		{`pg_tables`, `db1`, mpath([]string{"public", "pg_catalog"}), true, `pg_tables`, `db1.pg_catalog.pg_tables`, `db1.pg_catalog[0]`, ``},

		{`blix`, `db1`, mpath([]string{"public", "pg_catalog"}), false, `blix`, `db1.public.blix`, `db1.public`, ``},

		// A valid table is invisible if "public" is not in the search path.
		{`kv`, `db1`, mpath(nil), true, ``, ``, ``, `prefix or object not found`},

		// But pg_catalog is magic and "always there".
		{`pg_tables`, `db1`, mpath(nil), true, `pg_tables`, `db1.pg_catalog.pg_tables`, `db1.pg_catalog[0]`, ``},
		{`blix`, `db1`, mpath(nil), false, `blix`, `db1.pg_catalog.blix`, `db1.pg_catalog`, ``},

		// If there's a table with the same name as a pg_catalog table, then search path order matters.
		{`pg_tables`, `db2`, mpath([]string{"extended", "pg_catalog"}), true, `pg_tables`, `db2.extended.pg_tables`, `db2.extended[1]`, ``},
		{`pg_tables`, `db2`, mpath([]string{"pg_catalog", "extended"}), true, `pg_tables`, `db2.pg_catalog.pg_tables`, `db2.pg_catalog[0]`, ``},
		// When pg_catalog is not explicitly mentioned in the search path, it is searched first.
		{`pg_tables`, `db2`, mpath([]string{"foo"}), true, `pg_tables`, `db2.pg_catalog.pg_tables`, `db2.pg_catalog[0]`, ``},

		// Names of length 2.

		{`public.kv`, `db1`, mpath([]string{"public", "pg_catalog"}), true, `public.kv`, `db1.public.kv`, `db1.public[1]`, ``},
		{`public.foo`, `db1`, mpath([]string{"public", "pg_catalog"}), true, `public.foo`, `db1.public.foo`, `db1.public[0]`, ``},
		{`public.blix`, `db1`, mpath([]string{"public", "pg_catalog"}), true, ``, ``, ``, `prefix or object not found`},
		{`public.pg_tables`, `db1`, mpath([]string{"public", "pg_catalog"}), true, ``, ``, ``, `prefix or object not found`},
		{`extended.pg_tables`, `db2`, mpath([]string{"public", "pg_catalog"}), true, `extended.pg_tables`, `db2.extended.pg_tables`, `db2.extended[1]`, ``},
		{`pg_catalog.pg_tables`, `db1`, mpath([]string{"public", "pg_catalog"}), true, `pg_catalog.pg_tables`, `db1.pg_catalog.pg_tables`, `db1.pg_catalog[0]`, ``},

		{`public.blix`, `db1`, mpath([]string{"public", "pg_catalog"}), false, `public.blix`, `db1.public.blix`, `db1.public`, ``},

		// Compat with CockroachDB v1.x.
		{`db1.kv`, `db1`, mpath([]string{"public", "pg_catalog"}), true, `db1.public.kv`, `db1.public.kv`, `db1.public[1]`, ``},

		{`blix.foo`, `db1`, mpath([]string{"public", "pg_catalog"}), true, ``, ``, ``, `prefix or object not found`},
		{`blix.pg_tables`, `db1`, mpath([]string{"public", "pg_catalog"}), true, ``, ``, ``, `prefix or object not found`},

		// Names of length 3.

		{`db1.public.foo`, `db1`, mpath([]string{"public", "pg_catalog"}), true, `db1.public.foo`, `db1.public.foo`, `db1.public[0]`, ``},
		{`db1.public.kv`, `db1`, mpath(nil), true, `db1.public.kv`, `db1.public.kv`, `db1.public[1]`, ``},
		{`db1.public.blix`, `db1`, mpath(nil), false, `db1.public.blix`, `db1.public.blix`, `db1.public`, ``},

		{`blix.public.foo`, `db1`, mpath([]string{"public"}), true, ``, ``, ``, `prefix or object not found`},
		{`blix.public.foo`, `db1`, mpath([]string{"public"}), false, ``, ``, ``, `prefix or object not found`},

		// Beware: vtables only exist in valid databases and the empty database name.
		{`db1.pg_catalog.pg_tables`, `db1`, mpath(nil), true, `db1.pg_catalog.pg_tables`, `db1.pg_catalog.pg_tables`, `db1.pg_catalog[0]`, ``},
		{`"".pg_catalog.pg_tables`, `db1`, mpath(nil), true, `"".pg_catalog.pg_tables`, `"".pg_catalog.pg_tables`, `.pg_catalog[0]`, ``},
		{`blix.pg_catalog.pg_tables`, `db1`, mpath([]string{"public"}), true, ``, ``, ``, `prefix or object not found`},
		{`blix.pg_catalog.pg_tables`, `db1`, mpath([]string{"public"}), false, ``, ``, ``, `prefix or object not found`},
		{`"".pg_catalog.blix`, `db1`, mpath(nil), false, `"".pg_catalog.blix`, `"".pg_catalog.blix`, `.pg_catalog`, ``},

		//
		// Tests for table names with no current database.
		//

		{`kv`, ``, mpath([]string{"public", "pg_catalog"}), true, ``, ``, ``, `prefix or object not found`},
		{`pg_tables`, ``, mpath([]string{"public", "pg_catalog"}), true, `pg_tables`, `"".pg_catalog.pg_tables`, `.pg_catalog[0]`, ``},
		{`pg_tables`, ``, mpath(nil), true, `pg_tables`, `"".pg_catalog.pg_tables`, `.pg_catalog[0]`, ``},

		{`blix`, ``, mpath([]string{"public", "pg_catalog"}), false, `blix`, `"".pg_catalog.blix`, `.pg_catalog`, ``},

		// Names of length 2.

		{`public.kv`, ``, mpath([]string{"public", "pg_catalog"}), true, ``, ``, ``, `prefix or object not found`},
		{`pg_catalog.pg_tables`, ``, mpath([]string{"public", "pg_catalog"}), true, `pg_catalog.pg_tables`, `"".pg_catalog.pg_tables`, `.pg_catalog[0]`, ``},

		// Compat with CockroachDB v1.x.
		{`db1.kv`, ``, mpath([]string{"public", "pg_catalog"}), true, `db1.public.kv`, `db1.public.kv`, `db1.public[1]`, ``},
		{`db1.blix`, ``, mpath([]string{"public", "pg_catalog"}), true, ``, ``, ``, `prefix or object not found`},

		{`blix.pg_tables`, ``, mpath([]string{"public", "pg_catalog"}), true, ``, ``, ``, `prefix or object not found`},

		// Names of length 3.

		{`db1.public.foo`, ``, mpath([]string{"public", "pg_catalog"}), true, `db1.public.foo`, `db1.public.foo`, `db1.public[0]`, ``},
		{`db1.public.kv`, ``, mpath(nil), true, `db1.public.kv`, `db1.public.kv`, `db1.public[1]`, ``},
		{`db1.public.blix`, ``, mpath(nil), false, `db1.public.blix`, `db1.public.blix`, `db1.public`, ``},

		{`blix.public.foo`, ``, mpath([]string{"public"}), true, ``, ``, ``, `prefix or object not found`},
		{`blix.public.foo`, ``, mpath([]string{"public"}), false, ``, ``, ``, `prefix or object not found`},

		// Beware: vtables only exist in valid databases and the empty database name.
		{`db1.pg_catalog.pg_tables`, ``, mpath(nil), true, `db1.pg_catalog.pg_tables`, `db1.pg_catalog.pg_tables`, `db1.pg_catalog[0]`, ``},
		{`"".pg_catalog.pg_tables`, ``, mpath(nil), true, `"".pg_catalog.pg_tables`, `"".pg_catalog.pg_tables`, `.pg_catalog[0]`, ``},
		{`blix.pg_catalog.pg_tables`, ``, mpath([]string{"public"}), true, ``, ``, ``, `prefix or object not found`},
		{`blix.pg_catalog.pg_tables`, ``, mpath([]string{"public"}), false, ``, ``, ``, `prefix or object not found`},
		{`"".pg_catalog.blix`, ``, mpath(nil), false, `"".pg_catalog.blix`, `"".pg_catalog.blix`, `.pg_catalog`, ``},
		...
		{`*`, `db1`, mpath([]string{"public", "pg_catalog"}), false, `*`, `db1.public.*`, `db1.public`, ``},
		// When pg_catalog is not explicitly mentioned in the search path, it is searched first.
		{`*`, `db1`, mpath([]string{"public"}), false, `*`, `db1.pg_catalog.*`, `db1.pg_catalog`, ``},

		// Patterns of length 2.
		{`public.*`, `db1`, mpath([]string{"public"}), false, `public.*`, `db1.public.*`, `db1.public`, ``},
		{`public.*`, `db1`, mpath([]string{"public", "pg_catalog"}), false, `public.*`, `db1.public.*`, `db1.public`, ``},
		{`public.*`, `db1`, mpath(nil), false, `public.*`, `db1.public.*`, `db1.public`, ``},

		{`blix.*`, `db1`, mpath([]string{"public"}), false, ``, ``, ``, `prefix or object not found`},

		{`pg_catalog.*`, `db1`, mpath([]string{"public"}), false, `pg_catalog.*`, `db1.pg_catalog.*`, `db1.pg_catalog`, ``},
		{`pg_catalog.*`, `db1`, mpath([]string{"public", "pg_catalog"}), false, `pg_catalog.*`, `db1.pg_catalog.*`, `db1.pg_catalog`, ``},
		{`pg_catalog.*`, `db1`, mpath(nil), false, `pg_catalog.*`, `db1.pg_catalog.*`, `db1.pg_catalog`, ``},
		...
		{`*`, ``, mpath([]string{"public", "pg_catalog"}), false, `*`, `"".pg_catalog.*`, `.pg_catalog`, ``},

		// Patterns of length 2.

		{`public.*`, ``, mpath([]string{"public", "pg_catalog"}), false, ``, ``, ``, `prefix or object not found`},
		// vtables exist also in the empty database.
		{`pg_catalog.*`, ``, mpath([]string{"public", "pg_catalog"}), false, `pg_catalog.*`, `"".pg_catalog.*`, `.pg_catalog`, ``},
		{`pg_catalog.*`, ``, mpath(nil), false, `pg_catalog.*`, `"".pg_catalog.*`, `.pg_catalog`, ``},

		// Compat with CockroachDB v1.x.
		{`db1.*`, ``, mpath([]string{"public", "pg_catalog"}), false, `db1.public.*`, `db1.public.*`, `db1.public`, ``},

		{`blix.*`, ``, mpath([]string{"public"}), false, ``, ``, ``, `prefix or object not found`},
		{`blix.*`, ``, mpath([]string{"public", "pg_catalog"}), false, ``, ``, ``, `prefix or object not found`},
		{`blix.*`, ``, mpath(nil), false, ``, ``, ``, `prefix or object not found`},

		// Patterns of length 3.

		{`db1.public.*`, ``, mpath([]string{"public", "pg_catalog"}), false, `db1.public.*`, `db1.public.*`, `db1.public`, ``},
		{`db1.public.*`, ``, mpath(nil), false, `db1.public.*`, `db1.public.*`, `db1.public`, ``},

		{`blix.public.*`, ``, mpath([]string{"public"}), false, ``, ``, ``, `prefix or object not found`},
		{`blix.public.*`, ``, mpath([]string{"public", "pg_catalog"}), false, ``, ``, ``, `prefix or object not found`},

		// Beware: vtables only exist in valid databases and the empty database name.
		{`db1.pg_catalog.*`, ``, mpath(nil), false, `db1.pg_catalog.*`, `db1.pg_catalog.*`, `db1.pg_catalog`, ``},
		{`"".pg_catalog.*`, ``, mpath(nil), false, `"".pg_catalog.*`, `"".pg_catalog.*`, `.pg_catalog`, ``},
		{`blix.pg_catalog.*`, ``, mpath([]string{"public"}), false, ``, ``, ``, `prefix or object not found`},
	}
		...
		t.Run(fmt.Sprintf("%s/%s/%s/%v", tc.in, tc.curDb, tc.searchPath, tc.expected), func(t *testing.T) {
			...
			tp, sc, err := func() (tree.TablePattern, string, error) {
				...
				if scMeta != nil {
					...
					if !ok {
						t.Fatalf("%s: scMeta not of correct type: %v", scMeta)
					}
				...
				if obMeta != nil {
					obIdx, ok := obMeta.(int)
					if !ok {
						t.Fatalf("%s: obMeta not of correct type: %v", obMeta)
					}
			...
			if out := tp.String(); tc.expanded != out {
				t.Errorf("%s: expected full %s, but found %s", tc.in, tc.expanded, out)
			}
			if tc.scName != sc {
				t.Errorf("%s: expected schema %s, but found %s", tc.in, tc.scName, sc)
			}
		})
	}
}
