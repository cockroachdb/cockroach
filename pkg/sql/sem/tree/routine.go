...
// within a routine. The given RoutinePlanEnumerator is called for each plan
// generated.
//
// A RoutinePlanGenerator must return an error if the RoutinePlanEnumerator
// returns an error.
type RoutinePlanGenerator func(
	_ context.Context, _ RoutineExecFactory, args Datums, fn RoutinePlanEnumerator,
) error

// RoutinePlanEnumerator is a callback that is called for each plan enumerated
