...
// - stmtForDistSQLDiagramGetter, if set, will be used when generating DistSQL
// diagram to fetch the SQL stmt corresponding to the plan.
// - isFinalPlan is true if no more plans will be generated after the current
// plan.
type RoutinePlanGeneratedFunc func(plan RoutinePlan, stmtForDistSQLDiagramGetter func() string, isFinalPlan bool) error
