...
// plan.
type RoutinePlanGeneratedFunc func(plan RoutinePlan, builder *sqlstats.RecordedStatementStatsBuilder[*sqlstats.LatencyRecorder], stmtForDistSQLDiagram string, isFinalPlan bool) error
