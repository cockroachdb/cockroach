...
func (*AlterDomainAddCheckConstraint) alterDomainCmd()   {}
func (*AlterDomainAddNotNullConstraint) alterDomainCmd() {}
...
var _ AlterDomainCmd = &AlterDomainAddCheckConstraint{}
var _ AlterDomainCmd = &AlterDomainAddNotNullConstraint{}
...
// AlterDomainAddCheckConstraint represents an ALTER DOMAIN ADD [CONSTRAINT]
// CHECK command.
type AlterDomainAddCheckConstraint struct {
	Name               Name
	Check              Expr
...
// Format implements the NodeFormatter interface.
func (node *AlterDomainAddCheckConstraint) Format(ctx *FmtCtx) {
	ctx.WriteString(" ADD")
	if node.Name != "" {
...
// TelemetryName implements the AlterDomainCmd interface.
func (node *AlterDomainAddCheckConstraint) TelemetryName() string {
	return "add_check_constraint"
}

// AlterDomainAddNotNullConstraint represents an ALTER DOMAIN ADD [CONSTRAINT]
// NOT NULL command.
type AlterDomainAddNotNullConstraint struct {
	Name               Name
	ValidationBehavior ValidationBehavior
}

// Format implements the NodeFormatter interface.
func (node *AlterDomainAddNotNullConstraint) Format(ctx *FmtCtx) {
	ctx.WriteString(" ADD")
	if node.Name != "" {
		ctx.WriteString(" CONSTRAINT ")
		ctx.FormatNode(&node.Name)
...
// TelemetryName implements the AlterDomainCmd interface.
func (node *AlterDomainAddNotNullConstraint) TelemetryName() string {
	return "add_not_null_constraint"
}
