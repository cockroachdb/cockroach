...
// getActualIndex is a helper function that returns an "actual index" of the
// IndexedVar.
func (h *IndexedVarHelper) getActualIndex(ivar *IndexedVar) int {
	if ivar.Used {
