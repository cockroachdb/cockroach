...
//    duplicate name, that will result in an error.
//
// Note that it is possible to specify the schema or catalog without specifying
// a table name; in this case, Table.TableNamePrefix has the fields set but
