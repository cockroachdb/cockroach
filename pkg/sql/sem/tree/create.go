...
// Generatedtype represents either GENERATED ALWAYS AS IDENTITY
// or GENERATED BY DEFAULT AS IDENTITY
type Generatedtype int

// The values of GeneratedIdentity.GeneratedType
const (
...
func NewColumnTableDef(
	...
	for _, c := range qualifications {
		...
		case *GeneratedAlwaysAsIdentity:
			d.GeneratedIdentity.IsGenerated = true
			d.GeneratedIdentity.GeneratedType = GeneratedAlways
			d.GeneratedIdentity.ConstraintName = c.Name
		case *GeneratedByDefAsIdentity:
			d.GeneratedIdentity.IsGenerated = true
			d.GeneratedIdentity.GeneratedType = GeneratedByDefault
			d.GeneratedIdentity.ConstraintName = c.Name
...
func (node *ColumnTableDef) Format(ctx *FmtCtx) {
	...
	if node.GeneratedIdentity.IsGenerated {
		...
		if node.GeneratedIdentity.ConstraintName != "" {
			ctx.FormatNode(&node.GeneratedIdentity.ConstraintName)
		}
	}
