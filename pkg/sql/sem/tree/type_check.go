...
func (expr *FuncExpr) TypeCheck(
	...
	// setProperties updates the properties of the SemaContext and returns a
	// function to reset them back. All sub-expressions of the FuncExpr need to
	// be type-checked while having the updated properties.
	setProperties := func() func() {
		return func() {}
	}
	if semaCtx != nil {
		searchPath = semaCtx.SearchPath
		resolver = semaCtx.FunctionResolver
		origProperties := semaCtx.Properties
		setProperties = func() func() {
			...
			return func() {
				semaCtx.Properties.Restore(origProperties)
			}
		}
	}
