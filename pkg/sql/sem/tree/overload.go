...
type Overload struct {
	...
	// UsesSecurityDefiner is true when privilege checks for function execution
	// should be performed against a specific role rather than the invoking user.
	UsesSecurityDefiner bool
}
