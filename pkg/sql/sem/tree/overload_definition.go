...
type OverloadDefinition struct {
	...
	// OverloadDefinition with the `PreferredOverload` flag set to true it can be selected
...
func (b OverloadDefinition) params() TypeList { return b.Types }

// returnType implements the overloadImpl interface.
func (b OverloadDefinition) returnType() ReturnTyper { return b.ReturnType }

// preferred implements the overloadImpl interface.
func (b OverloadDefinition) preferred() bool { return b.PreferredOverload }
...
func (b OverloadDefinition) FixedReturnType() types.T {
	if b.ReturnType == nil {
		return nil
	}
...
func (b OverloadDefinition) Signature() string {
