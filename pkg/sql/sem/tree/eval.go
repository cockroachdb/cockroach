...
func (*UnaryOp) outParamInfo() (RoutineType, []int32, TypeList, Exprs) {
...
func (op *BinOp) outParamInfo() (RoutineType, []int32, TypeList, Exprs) {
	return BuiltinRoutine, nil, nil, nil
}
...
func (op *CmpOp) outParamInfo() (RoutineType, []int32, TypeList, Exprs) {
	return BuiltinRoutine, nil, nil, nil
}
