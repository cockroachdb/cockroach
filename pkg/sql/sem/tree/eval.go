...
// SQLStatisticsResetter is an interface embedded in EvalCtx which can be used by
// the builtins to reset SQL stats.
type SQLStatisticsResetter interface {
	SQLStatsReset(ctx context.Context) error
}
...
type EvalContext struct {
	...
	SQLStatsResetter SQLStatisticsResetter
}
