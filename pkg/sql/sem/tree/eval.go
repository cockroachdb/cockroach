...
func initNonArrayToNonArrayConcatenation() {
	addConcat := func(leftType, rightType *types.T, volatility volatility.Volatility) {
		BinOps[treebin.Concat] = append(BinOps[treebin.Concat], &BinOp{
			LeftType:     leftType,
			RightType:    rightType,
...
func cmpOpFixups(
	...
	findVolatility := func(op treecmp.ComparisonOperatorSymbol, t *types.T) volatility.Volatility {
...
func makeCmpOpOverload(
	op treecmp.ComparisonOperatorSymbol, a, b *types.T, nullableArgs bool, v volatility.Volatility,
) *CmpOp {
	return &CmpOp{
		LeftType:     a,
		RightType:    b,
...
func makeEqFn(a, b *types.T, v volatility.Volatility) *CmpOp {
	return makeCmpOpOverload(treecmp.EQ, a, b, false, v)
}
func makeLtFn(a, b *types.T, v volatility.Volatility) *CmpOp {
	return makeCmpOpOverload(treecmp.LT, a, b, false, v)
}
func makeLeFn(a, b *types.T, v volatility.Volatility) *CmpOp {
	return makeCmpOpOverload(treecmp.LE, a, b, false, v)
}
func makeIsFn(a, b *types.T, v volatility.Volatility) *CmpOp {
...
func makeEvalTupleIn(typ *types.T, v volatility.Volatility) *CmpOp {
	return &CmpOp{
		LeftType:     typ,
		RightType:    types.AnyTuple,
		EvalOp:       &InTupleOp{},
