...
func (a *DatumAlloc) NewDCitext(contents string, locale string) (Datum, error) {
	if a == nil {
		return NewDCitext(contents, locale, &CollationEnvironment{})
	}
	return NewDCitext(contents, locale, &a.env)
}
