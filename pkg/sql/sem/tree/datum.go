...
type Datum interface {
	...
	// CompareError returns -1 if the receiver is less than other, 0 if receiver
	// is equal to other and +1 if receiver is greater than other.
	// TODO(yuzefovich): rename this to Compare.
