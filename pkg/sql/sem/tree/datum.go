...
func DatumPrev(
	...
	case *DInterval:
		// Subtract 1ms.
		prev := d.Sub(duration.MakeDuration(1000 /* nanos */, 0 /* days */, 0 /* months */))
...
func DatumNext(
	...
	case *DCollatedString:
		...
		return c, true
	case *DInterval:
		next := d.Add(duration.MakeDuration(1000 /* nanos */, 0 /* days */, 0 /* months */))
