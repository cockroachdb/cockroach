...
var (
	...
	dMinTimeTZOffsetSecs = -1 * dMaxTimeTZOffsetSecs
	dMinTimeTZ           = NewDTimeTZFromOffset(timeofday.Min, dMinTimeTZOffsetSecs)
	dMaxTimeTZ           = NewDTimeTZFromOffset(timeofday.Time2400, dMaxTimeTZOffsetSecs)
)
...
func (d *DTimeTZ) IsMax(_ *EvalContext) bool {
	return d.TimeOfDay == dMaxTimeTZ.TimeOfDay && d.OffsetSecs == dMaxTimeTZ.OffsetSecs
}

// IsMin implements the Datum interface.
func (d *DTimeTZ) IsMin(_ *EvalContext) bool {
	return d.TimeOfDay == dMinTimeTZ.TimeOfDay && d.OffsetSecs == dMinTimeTZ.OffsetSecs
}
