...
type ParseTimeContext interface {
	duration.Context
	// GetRelativeParseTime returns a time that is used to calculate
	// relative dates, like "tomorrow" and also provides a default
	// time.Location for parsed times, i.e. the current time
