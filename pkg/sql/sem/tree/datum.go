...
var (
	...
	// postgres 4713 BC and 294276 AD.
	maxSupportedTime = time.Unix(9224318016000-1, 999999000) // 294276-12-31 23:59:59.999999
	minSupportedTime = time.Unix(-210863520000, 0)           // 4713-01-01 00:00:00 BC
)
...
// MustDTimestamp wraps MakeDTimestamp but panics if there is an error.
// This is intended for testing applications only.
func MustDTimestamp(t time.Time, precision time.Duration) *DTimestamp {
...
// MustDTimestampTZ wraps MakeDTimestampTZ but panics if there is an error.
// This is intended for testing applications only.
func MustDTimestampTZ(t time.Time, precision time.Duration) *DTimestampTZ {
