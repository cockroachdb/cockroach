...
type RowBatch struct {
	row  uint32 // the row in the batch being accessed (see RowBatch.Row)
	cols uint32
	data unsafe.Pointer
	ptrs unsafe.Pointer
}
...
//
// TODO(peter): figure out how to handle NULLs.
