...
func AllowExplicitDirection(t T) bool {
	return t == FORWARD
}
...
func AllowsPrefixColumns(t T) bool {
...
func SupportsSharding(t T) bool {
	return t == FORWARD
}
