...
func (e *evaluator) EvalPlusDecimalPGLSNOp(
	...
	return decimalPGLSNEval(left, right, lsnMathCtx.Add, false)
}

func (e *evaluator) EvalPlusPGLSNDecimalOp(
	ctx context.Context, _ *tree.PlusPGLSNDecimalOp, left, right tree.Datum,
) (tree.Datum, error) {
	return decimalPGLSNEval(right, left, lsnMathCtx.Add, false)
}
...
func (e *evaluator) EvalMinusPGLSNDecimalOp(
	...
	return decimalPGLSNEval(right, left, lsnMathCtx.Sub, true)
}

func decimalPGLSNEval(
	decDatum tree.Datum, lsnDatum tree.Datum, op func(d, x, y *apd.Decimal) (apd.Condition, error), subtraction bool,
) (tree.Datum, error) {
