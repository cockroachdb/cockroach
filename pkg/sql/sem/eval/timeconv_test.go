...
func TestClusterTimestampConversion(t *testing.T) {
	...
	for _, d := range testData {
		...
		txnProto := roachpb.MakeTransaction("test", nil /* baseKey */, isolation.Serializable, roachpb.NormalUserPriority, ts.ToTimestamp(), 0 /* maxOffsetNs */, 1 /* coordinatorNodeID */, 0, false)
