...
func floatOverload1(
	f func(float64) (tree.Datum, error), info string, volatility volatility.Volatility,
) tree.Overload {
...
func decimalOverload1(
	f func(*apd.Decimal) (tree.Datum, error), info string, volatility volatility.Volatility,
) tree.Overload {
	return tree.Overload{
		Types:      tree.ArgTypes{{"val", types.Decimal}},
		ReturnType: tree.FixedReturnType(types.Decimal),
