...
func makeRegressionAccumulatorDecimalBase(
	...
	return makeEmptyRegressionAccumulatorDecimalBase(
		makeSingleDatumAggregateBase(evalCtx), &ed,
	)
}

// makeEmptyRegressionAccumulatorDecimalBase returns a new
// regressionAccumulatorDecimalBase, that is ready to use.
func makeEmptyRegressionAccumulatorDecimalBase(
...
func (a *regressionAccumulatorDecimalBase) Reset(ctx context.Context) {
	*a = makeEmptyRegressionAccumulatorDecimalBase(a.singleDatumAggregateBase, a.ed)
	a.reset(ctx)
}
