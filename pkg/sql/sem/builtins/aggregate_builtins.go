...
// Note that the assumption is that the following fields are constant between
// objects being aggregated: QuerySummary, Query, ImplicitTxn, and StmtType.
// The tmp object will be reset before any data is copied into it.
func mergeAggregatedMetadataHelper(
	...
	// Reset the tmpMetadata object to avoid any potential issues with leftover data.
	*tmpMetadata = appstatspb.AggregatedStatementMetadata{}
	var err error
