...
const sizeOfStatementStatistics = int64(unsafe.Sizeof(appstatspb.StatementStatistics{}))
const sizeOfAggregatedStatementMetadata = int64(unsafe.Sizeof(appstatspb.AggregatedStatementMetadata{}))
const sizeOfTransactionStatistics = int64(unsafe.Sizeof(appstatspb.TransactionStatistics{}))
...
func (a *aggStatementStatistics) Add(ctx context.Context, datum tree.Datum, _ ...tree.Datum) error {
	if datum != nil && a.firstJsonDatumSize == 0 {
		a.firstJsonDatumSize = int64(datum.Size())
		err := a.updateMemoryUsage(ctx, a.firstJsonDatumSize)
		if err != nil {
			return err
		}
	}
