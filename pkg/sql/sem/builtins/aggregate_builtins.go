...
// extraMaxMinAggregateTypes contains extra types that aren't in
// types.Scalar that the max/min aggregate functions are defined on.
var extraMaxMinAggregateTypes = append(
