...
func newRegressionAccumulatorDecimalBase(
	...
	return newEmptyRegressionAccumulatorDecimalBase(
		makeSingleDatumAggregateBase(evalCtx), &ed,
	)
}

// newEmptyRegressionAccumulatorDecimalBase returns a new
// regressionAccumulatorDecimalBase, that is ready to use.
func newEmptyRegressionAccumulatorDecimalBase(
	singleDatumAggregateBase singleDatumAggregateBase, ed *apd.ErrDecimal,
) regressionAccumulatorDecimalBase {
...
func (a *regressionAccumulatorDecimalBase) Reset(ctx context.Context) {
	*a = newEmptyRegressionAccumulatorDecimalBase(a.singleDatumAggregateBase, a.ed)
	a.reset(ctx)
}
...
func (a *corrAggregate) Result() (tree.Datum, error) {
	...
	res := &apd.Decimal{}
	a.ed.Quo(res, a.sxy, a.ed.Sqrt(a.tmp, a.ed.Mul(a.tmp, a.sxx, a.syy)))
	return mapToDFloat(res, a.ed.Err())
}
...
func (a *covarSampAggregate) Result() (tree.Datum, error) {
	...
	res := &apd.Decimal{}
	a.ed.Quo(res, a.sxy, a.ed.Sub(a.tmp, a.n, decimalOne))
	return mapToDFloat(res, a.ed.Err())
}
...
func (a *regressionR2Aggregate) Result() (tree.Datum, error) {
	...
	res, tmp1 := &apd.Decimal{}, &apd.Decimal{}
	a.ed.Quo(
		res,
		a.ed.Mul(tmp1, a.sxy, a.sxy),
