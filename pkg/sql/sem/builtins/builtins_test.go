...
// TestResetIndexUsageStatsOnRemoteSQLNode asserts that the built-in for resetting index usage
// statistics works when it's being set up on a remote node via DistSQL.
