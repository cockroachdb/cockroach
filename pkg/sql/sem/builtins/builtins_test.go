...
func TestTruncateTimestamp(t *testing.T) {
	...
	testCases := []struct {
		...
		{time.Date(2118, time.March, 11, 5, 6, 7, 80009001, loc), "millennium", tree.MustDTimestampTZ(time.Date(2001, time.January, 1, 0, 0, 0, 0, loc), time.Microsecond)},
		{time.Date(2118, time.March, 11, 5, 6, 7, 80009001, loc), "century", tree.MustDTimestampTZ(time.Date(2101, time.January, 1, 0, 0, 0, 0, loc), time.Microsecond)},
		{time.Date(2118, time.March, 11, 5, 6, 7, 80009001, loc), "decade", tree.MustDTimestampTZ(time.Date(2110, time.January, 1, 0, 0, 0, 0, loc), time.Microsecond)},
		{time.Date(2118, time.March, 11, 5, 6, 7, 80009001, loc), "year", tree.MustDTimestampTZ(time.Date(2118, time.January, 1, 0, 0, 0, 0, loc), time.Microsecond)},
		{time.Date(2118, time.March, 11, 5, 6, 7, 80009001, loc), "quarter", tree.MustDTimestampTZ(time.Date(2118, time.January, 1, 0, 0, 0, 0, loc), time.Microsecond)},
		{time.Date(2118, time.March, 11, 5, 6, 7, 80009001, loc), "month", tree.MustDTimestampTZ(time.Date(2118, time.March, 1, 0, 0, 0, 0, loc), time.Microsecond)},
		{time.Date(2118, time.March, 11, 5, 6, 7, 80009001, loc), "day", tree.MustDTimestampTZ(time.Date(2118, time.March, 11, 0, 0, 0, 0, loc), time.Microsecond)},
		{time.Date(2118, time.March, 11, 5, 6, 7, 80009001, loc), "week", tree.MustDTimestampTZ(time.Date(2118, time.March, 7, 0, 0, 0, 0, loc), time.Microsecond)},
		{time.Date(2118, time.March, 11, 5, 6, 7, 80009001, loc), "hour", tree.MustDTimestampTZ(time.Date(2118, time.March, 11, 5, 0, 0, 0, loc), time.Microsecond)},
		{time.Date(2118, time.March, 11, 5, 6, 7, 80009001, loc), "second", tree.MustDTimestampTZ(time.Date(2118, time.March, 11, 5, 6, 7, 0, loc), time.Microsecond)},
		{time.Date(2118, time.March, 11, 5, 6, 7, 80009001, loc), "millisecond", tree.MustDTimestampTZ(time.Date(2118, time.March, 11, 5, 6, 7, 80000000, loc), time.Microsecond)},
		{time.Date(2118, time.March, 11, 5, 6, 7, 80009001, loc), "microsecond", tree.MustDTimestampTZ(time.Date(2118, time.March, 11, 5, 6, 7, 80009000, loc), time.Microsecond)},

		// Test Monday and Sunday boundaries.
		{time.Date(2019, time.November, 11, 5, 6, 7, 80009001, loc), "week", tree.MustDTimestampTZ(time.Date(2019, time.November, 11, 0, 0, 0, 0, loc), time.Microsecond)},
		{time.Date(2019, time.November, 10, 5, 6, 7, 80009001, loc), "week", tree.MustDTimestampTZ(time.Date(2019, time.November, 4, 0, 0, 0, 0, loc), time.Microsecond)},
	}
