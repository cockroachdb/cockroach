...
var generators = map[string]builtinDefinition{
	...
	"json_object_keys":          makeBuiltin(genPropsWithLabels(jsonObjectKeysGeneratorLabels), jsonObjectKeysImpl),
	"jsonb_object_keys":         makeBuiltin(genPropsWithLabels(jsonObjectKeysGeneratorLabels), jsonObjectKeysImpl),
