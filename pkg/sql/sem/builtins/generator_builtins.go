...
func newStorageInternalKeysGenerator(
	evalCtx *eval.Context, nodeID, storeID int32, start, end []byte, megaBytesPerSecond int32,
...
func makeStorageInternalKeysGenerator(
	...
	var megabytesPerSecond int32
	if len(args) > 4 {
		megabytesPerSecond = int32(tree.MustBeDInt(args[4]))
	} else {
		megabytesPerSecond = int32(10)
	}
