...
`,
	...
	"crdb_internal.show_create_all_schemas": makeBuiltin(
		...
		makeGeneratorOverload(
			...
			`Returns rows of CREATE schema statements followed by 
ALTER schema statements that add schema constraints. 
The output can be used to recreate a database.'
`,
			tree.VolatilityVolatile,
		),
...
// are being generated for showCreateAllTables or showCreateAllSchemas.
type Phase int
