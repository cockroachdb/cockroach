...
SELECT description
 ...
 LIMIT 1`,
	...
	"information_schema._pg_numeric_precision": makeBuiltin(defProps(),
		tree.Overload{
			Types: tree.ArgTypes{
				{"typid", types.Oid},
				{"typmod", types.Int4},
	...
	"information_schema._pg_numeric_precision_radix": makeBuiltin(defProps(),
		tree.Overload{
			Types: tree.ArgTypes{
				{"typid", types.Oid},
				{"typmod", types.Int4},
	...
	"information_schema._pg_numeric_scale": makeBuiltin(defProps(),
		tree.Overload{
			Types: tree.ArgTypes{
				{"typid", types.Oid},
				{"typmod", types.Int4},
