...
// UpdateCommands Enumeration to match update operations in postgres
const (
	UpdateCommand = 2 + iota
	InsertCommand
	DeleteCommand
)
...
var (
	zero = tree.NewDInt(0)
	allEvents = tree.NewDInt((1 << UpdateCommand) | (1 << InsertCommand) | (1 << DeleteCommand))
)
 ...
 LIMIT 1`,
	...
	"pg_relation_is_updatable": makeBuiltin(
		...
		tree.Overload{
			...
			Info: "pg_relation_is_updatable was created for compatibility. This " +
	...
	"pg_column_is_updatable" : makeBuiltin(
		...
		tree.Overload{
			...
			Info: "pg_column_is_updatable was created for compatibility. This " +
