...
Note ST_Perimeter is only valid for Polygon - use ST_Length for LineString.`,
	...
	"st_distance": makeBuiltin(
		...
		tree.Overload{
			...
			Info: infoBuilder{
				info:         "Returns the distance in meters between geography_a and geography_b." + usesSpheroidMessage,
		...
		tree.Overload{
			...
			Info: infoBuilder{
				info:         "Returns the distance in meters between geography_a and geography_b.",
	...
	"st_dwithin": makeBuiltin(
		...
		tree.Overload{
			...
			Info: infoBuilder{
				info:         "Returns true if any of geography_a is within distance meters of geography_b." + usesSpheroidMessage,
				libraryUsage: usesGeographicLib,
				precision:    "1cm",
				canUseIndex:  true,
			}.String(),
...
func geographyOverload1WithUseSpheroid(
	...
	infoWithSpheroid.libraryUsage = usesS2
