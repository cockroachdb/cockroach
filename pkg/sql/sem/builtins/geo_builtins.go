	...
	"st_voronoipolygons": makeBuiltin(
		...
		tree.Overload{
			...
			Fn: func(ctx *tree.EvalContext, args tree.Datums) (tree.Datum, error) {
				...
				ret, err := geomfn.VoronoiDiagram(a.Geometry, env, 0.0, false /* onlyEdges */)
				if err != nil {
					return nil, err
				}
				return tree.NewDGeometry(ret), nil
		...
		tree.Overload{
			...
			Fn: func(ctx *tree.EvalContext, args tree.Datums) (tree.Datum, error) {
				...
				var env geo.Geometry
				ret, err := geomfn.VoronoiDiagram(a.Geometry, env, float64(tolerance), false /* onlyEdges */)
				if err != nil {
					return nil, err
				}
				return tree.NewDGeometry(ret), nil
		...
		tree.Overload{
			...
			Fn: func(ctx *tree.EvalContext, args tree.Datums) (tree.Datum, error) {
				...
				ret, err := geomfn.VoronoiDiagram(a.Geometry, env.Geometry, float64(tolerance), false /* onlyEdges */)
				if err != nil {
					return nil, err
				}
				return tree.NewDGeometry(ret), nil
	...
	"st_voronoilines": makeBuiltin(
		...
		tree.Overload{
			...
			Fn: func(ctx *tree.EvalContext, args tree.Datums) (tree.Datum, error) {
				a := tree.MustBeDGeometry(args[0])
				var env geo.Geometry
				ret, err := geomfn.VoronoiDiagram(a.Geometry, env,0.0, true /* onlyEdges */)
				if err != nil {
					return nil, err
				}
				return tree.NewDGeometry(ret), nil
		...
		tree.Overload{
			...
			Fn: func(ctx *tree.EvalContext, args tree.Datums) (tree.Datum, error) {
				...
				tolerance := tree.MustBeDFloat(args[1])
				var env geo.Geometry
				ret, err := geomfn.VoronoiDiagram(a.Geometry, env, float64(tolerance), true /* onlyEdges */)
				if err != nil {
					return nil, err
				}
				return tree.NewDGeometry(ret), nil
		...
		tree.Overload{
			...
			Fn: func(ctx *tree.EvalContext, args tree.Datums) (tree.Datum, error) {
				...
				tolerance := tree.MustBeDFloat(args[1])
				env := tree.MustBeDGeometry(args[2])
				ret, err := geomfn.VoronoiDiagram(a.Geometry, env.Geometry, float64(tolerance), true /* onlyEdges */)
				if err != nil {
					return nil, err
				}
				return tree.NewDGeometry(ret), nil
