...
var builtinOidsArray = []string{
	...
	2608: `crdb_internal.index_span(tenant_id: int, table_id: int, index_id: int) -> bytes[]`,
	2609: `crdb_internal.split_at(key: bytes, ttl: interval) -> void`,
	2610: `crdb_internal.scatter(key: bytes) -> void`,
	2611: `crdb_internal.scatter(key: bytes, end_key: bytes) -> void`,
}
