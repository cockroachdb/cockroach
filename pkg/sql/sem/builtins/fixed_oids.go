...
var builtinOidsArray = []string{
	...
	2844: `ltreesend(ltree: ltree) -> bytes`,
	2845: `ltreein(input: anyelement) -> ltree`,
	2846: `ltreeout(ltree: ltree) -> bytes`,
	2847: `ltreerecv(input: anyelement) -> ltree`,
	2848: `lquerysend(lquery: lquery) -> bytes`,
	2849: `lqueryin(input: anyelement) -> lquery`,
	2850: `lqueryout(lquery: lquery) -> bytes`,
	2851: `lqueryrecv(input: anyelement) -> lquery`,
	2852: `ltxtquerysend(ltxtquery: ltxtquery) -> bytes`,
	2853: `ltxtqueryin(input: anyelement) -> ltxtquery`,
	2854: `ltxtqueryout(ltxtquery: ltxtquery) -> bytes`,
	2855: `ltxtqueryrecv(input: anyelement) -> ltxtquery`,
	2856: `bpchar(ltree: ltree) -> bpchar`,
	2857: `char(ltree: ltree) -> "char"`,
	2858: `citext(ltree: ltree) -> citext`,
	2859: `name(ltree: ltree) -> name`,
	2860: `text(ltree: ltree) -> string`,
	2861: `varchar(ltree: ltree) -> varchar`,
	2862: `ltree(bpchar: bpchar) -> ltree`,
	2863: `ltree(char: "char") -> ltree`,
	2864: `ltree(citext: citext) -> ltree`,
	2865: `ltree(name: name) -> ltree`,
	2866: `ltree(text: text) -> ltree`,
	2867: `ltree(string: string) -> ltree`,
	2868: `ltree(varchar: varchar) -> ltree`,
	2869: `ltree(ltree: ltree) -> ltree`,
	2870: `max(arg1: ltree) -> anyelement`,
	2871: `min(arg1: ltree) -> anyelement`,
	2872: `array_agg(arg1: ltree) -> ltree[]`,
	2873: `array_cat_agg(arg1: ltree[]) -> ltree[]`,
	2874: `percentile_disc_impl(arg1: float, arg2: ltree) -> ltree`,
	2875: `percentile_disc_impl(arg1: float[], arg2: ltree) -> ltree[]`,
	2876: `array_agg(arg1: ltree[]) -> ltree[][]`,
	2877: `array_append(array: ltree[], elem: ltree) -> ltree[]`,
	2878: `array_positions(array: ltree[], elem: ltree) -> int[]`,
	2879: `array_remove(array: ltree[], elem: ltree) -> anyelement`,
	2880: `array_prepend(elem: ltree, array: ltree[]) -> ltree[]`,
	2881: `array_position(array: ltree[], elem: ltree) -> int`,
	2882: `array_cat(left: ltree[], right: ltree[]) -> ltree[]`,
	2883: `array_replace(array: ltree[], toreplace: ltree, replacewith: ltree) -> anyelement`,
	2884: `array_position(array: ltree[], elem: ltree, start: int) -> int`,
	2885: `first_value(val: ltree) -> ltree`,
	2886: `nth_value(val: ltree, n: int) -> ltree`,
	2887: `lag(val: ltree) -> ltree`,
	2888: `lag(val: ltree, n: int) -> ltree`,
	2889: `lag(val: ltree, n: int, default: ltree) -> ltree`,
	2890: `lead(val: ltree) -> ltree`,
	2891: `lead(val: ltree, n: int) -> ltree`,
	2892: `lead(val: ltree, n: int, default: ltree) -> ltree`,
	2893: `last_value(val: ltree) -> ltree`,
	2894: `subltree(ltree: ltree, start: int, end: int) -> ltree`,
	2895: `subpath(ltree: ltree, offset: int, length: int) -> ltree`,
	2896: `subpath(ltree: ltree, offset: int) -> ltree`,
	2897: `nlevel(ltree: ltree) -> int`,
	2898: `index(a: ltree, b: ltree) -> int`,
	2899: `index(a: ltree, b: ltree, offset: int) -> int`,
	2900: `text2ltree(text: string) -> ltree`,
	2901: `ltree2text(ltree: ltree) -> string`,
	2902: `lca(ltree, ltree, ltree...) -> ltree`,
	2903: `lca(ltree[]: ltree[]) -> ltree`,
}
