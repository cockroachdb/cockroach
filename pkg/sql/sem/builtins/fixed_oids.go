...
var builtinOidsArray = []string{
	...
	2401: `ts_rank(weights: float[], vector: tsvector, query: tsquery, normalization: int) -> float4`,
	2402: `ts_rank(vector: tsvector, query: tsquery, normalization: int) -> float4`,
	2403: `ts_rank(vector: tsvector, query: tsquery) -> float4`,
	2404: `ts_rank(weights: float[], vector: tsvector, query: tsquery) -> float4`,
}
