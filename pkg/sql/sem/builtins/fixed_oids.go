...
var builtinOidsBySignature = map[string]oid.Oid{
	...
	`tsquerysend(tsquery: tsquery) -> bytes`:                                                                                                                                        2039,
	`tsvectorsend(tsvector: tsvector) -> bytes`:                                                                                                                                     2040,
	`tsqueryout(tsquery: tsquery) -> bytes`:                                                                                                                                         2041,
	`tsvectorout(tsvector: tsvector) -> bytes`:                                                                                                                                      2042,
	`tsqueryrecv(input: anyelement) -> tsquery`:                                                                                                                                     2043,
	`tsvectorrecv(input: anyelement) -> tsvector`:                                                                                                                                   2044,
	`tsqueryin(input: anyelement) -> tsquery`:                                                                                                                                       2045,
	`tsvectorin(input: anyelement) -> tsvector`:                                                                                                                                     2046,
