...
var builtinOidsBySignature = map[string]oid.Oid{
	...
	`tsquerysend(tsquery: tsquery) -> bytes`:                                                                                                                                        2045,
	`tsvectorsend(tsvector: tsvector) -> bytes`:                                                                                                                                     2046,
	`tsqueryout(tsquery: tsquery) -> bytes`:                                                                                                                                         2047,
	`tsvectorout(tsvector: tsvector) -> bytes`:                                                                                                                                      2048,
	`tsqueryrecv(input: anyelement) -> tsquery`:                                                                                                                                     2049,
	`tsvectorrecv(input: anyelement) -> tsvector`:                                                                                                                                   2050,
	`tsqueryin(input: anyelement) -> tsquery`:                                                                                                                                       2051,
	`tsvectorin(input: anyelement) -> tsvector`:                                                                                                                                     2052,
