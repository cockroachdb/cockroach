...
var builtinOidsArray = []string{
	...
	2647: `array_agg(arg1: jsonpath) -> jsonpath[]`,
	2648: `array_agg(arg1: jsonpath[]) -> jsonpath[][]`,
	2649: `percentile_disc_impl(arg1: float, arg2: jsonpath) -> jsonpath`,
	2650: `array_cat_agg(arg1: jsonpath[]) -> jsonpath[]`,
	2651: `percentile_disc_impl(arg1: float[], arg2: jsonpath) -> jsonpath[]`,
	2652: `max(arg1: jsonpath) -> anyelement`,
	2653: `min(arg1: jsonpath) -> anyelement`,
	2654: `array_append(array: jsonpath[], elem: jsonpath) -> jsonpath[]`,
	2655: `array_positions(array: jsonpath[], elem: jsonpath) -> int[]`,
	2656: `array_remove(array: jsonpath[], elem: jsonpath) -> anyelement`,
	2657: `array_prepend(elem: jsonpath, array: jsonpath[]) -> jsonpath[]`,
	2658: `array_position(array: jsonpath[], elem: jsonpath) -> int`,
	2659: `array_cat(left: jsonpath[], right: jsonpath[]) -> jsonpath[]`,
	2660: `array_replace(array: jsonpath[], toreplace: jsonpath, replacewith: jsonpath) -> anyelement`,
	2661: `array_position(array: jsonpath[], elem: jsonpath, start: int) -> int`,
	2662: `jsonpathrecv(input: anyelement) -> jsonpath`,
	2663: `jsonpathsend(jsonpath: jsonpath) -> bytes`,
	2664: `jsonpathout(jsonpath: jsonpath) -> bytes`,
	2665: `jsonpathin(input: anyelement) -> jsonpath`,
	2666: `last_value(val: jsonpath) -> jsonpath`,
	2667: `nth_value(val: jsonpath, n: int) -> jsonpath`,
	2668: `lag(val: jsonpath) -> jsonpath`,
	2669: `lag(val: jsonpath, n: int) -> jsonpath`,
	2670: `lag(val: jsonpath, n: int, default: jsonpath) -> jsonpath`,
	2671: `lead(val: jsonpath) -> jsonpath`,
	2672: `first_value(val: jsonpath) -> jsonpath`,
	2673: `lead(val: jsonpath, n: int) -> jsonpath`,
	2674: `lead(val: jsonpath, n: int, default: jsonpath) -> jsonpath`,
	2675: `jsonpath(string: string) -> jsonpath`,
	2676: `bpchar(jsonpath: jsonpath) -> bpchar`,
	2677: `text(jsonpath: jsonpath) -> string`,
	2678: `name(jsonpath: jsonpath) -> name`,
	2679: `jsonpath(jsonpath: jsonpath) -> jsonpath`,
	2680: `varchar(jsonpath: jsonpath) -> varchar`,
	2681: `char(jsonpath: jsonpath) -> "char"`,
}
