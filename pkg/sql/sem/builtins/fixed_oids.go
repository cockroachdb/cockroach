...
var builtinOidsArray = []string{
	...
	2519: `pg_encoding_max_length(encoding: int) -> int`,
	2520: `information_schema._pg_datetime_precision(typid: oid, typmod: int4) -> int`,
	2521: `information_schema._pg_interval_type(typid: oid, typmod: int4) -> string`,
}
