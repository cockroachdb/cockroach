...
var builtinOidsArray = []string{
	...
	2648: `anysend(anyelement: anyelement) -> bytes`,
	2649: `anyrecv(input: anyelement) -> anyelement`,
	2650: `anyout(anyelement: anyelement) -> bytes`,
	2651: `anyin(input: anyelement) -> anyelement`,
}
