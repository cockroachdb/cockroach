...
var builtinOidsArray = []string{
	...
	2908: `information_schema.crdb_rewrite_inline_hints(statement_fingerprint: string, donor_sql: string) -> int`,
	2909: `information_schema.crdb_clear_statement_hints_cache() -> void`,
	2910: `information_schema.crdb_await_statement_hints_cache() -> void`,
