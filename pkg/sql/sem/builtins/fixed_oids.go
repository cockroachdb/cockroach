...
var builtinOidsArray = []string{
	...
	2797: `lquerysend(lquery: lquery) -> bytes`,
	2798: `lqueryin(input: anyelement) -> lquery`,
	2799: `lqueryout(lquery: lquery) -> bytes`,
	2800: `lqueryrecv(input: anyelement) -> lquery`,
	2801: `ltxtquerysend(ltxtquery: ltxtquery) -> bytes`,
	2802: `ltxtqueryin(input: anyelement) -> ltxtquery`,
	2803: `ltxtqueryout(ltxtquery: ltxtquery) -> bytes`,
	2804: `ltxtqueryrecv(input: anyelement) -> ltxtquery`,
