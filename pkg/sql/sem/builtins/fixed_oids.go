...
var builtinOidsArray = []string{
	...
	2078: `array_concat_agg(arg1: bool[]) -> bool[]`,
	2079: `array_concat_agg(arg1: box2d[]) -> box2d[]`,
	2080: `array_concat_agg(arg1: int[]) -> int[]`,
	2081: `array_concat_agg(arg1: float[]) -> float[]`,
	2082: `array_concat_agg(arg1: decimal[]) -> decimal[]`,
	2083: `array_concat_agg(arg1: date[]) -> date[]`,
	2084: `array_concat_agg(arg1: timestamp[]) -> timestamp[]`,
	2085: `array_concat_agg(arg1: interval[]) -> interval[]`,
	2086: `array_concat_agg(arg1: geography[]) -> geography[]`,
	2087: `array_concat_agg(arg1: geometry[]) -> geometry[]`,
	2088: `array_concat_agg(arg1: string[]) -> string[]`,
	2089: `array_concat_agg(arg1: bytes[]) -> bytes[]`,
	2090: `array_concat_agg(arg1: timestamptz[]) -> timestamptz[]`,
	2091: `array_concat_agg(arg1: oid[]) -> oid[]`,
	2092: `array_concat_agg(arg1: uuid[]) -> uuid[]`,
	2093: `array_concat_agg(arg1: inet[]) -> inet[]`,
	2094: `array_concat_agg(arg1: time[]) -> time[]`,
	2095: `array_concat_agg(arg1: timetz[]) -> timetz[]`,
	2096: `array_concat_agg(arg1: jsonb[]) -> jsonb[]`,
	2097: `array_concat_agg(arg1: varbit[]) -> varbit[]`,
	2098: `array_concat_agg(arg1: anyenum[]) -> anyenum[]`,
	2099: `array_concat_agg(arg1: tuple[]) -> tuple[]`,
}
