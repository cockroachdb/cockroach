...
var builtinOidsArray = []string{
	...
	2037: `crdb_internal.rename_tenant(id: int, name: string) -> int`,
	...
	2055: `crdb_internal.anonymize_sql_constants(val: string) -> string`,
	2056: `crdb_internal.anonymize_sql_constants(val: string[]) -> string[]`,
