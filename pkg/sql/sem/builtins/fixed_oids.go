...
var builtinOidsArray = []string{
	...
	2723: `timestamptz(citext: citext) -> timestamptz`,
	2724: `regnamespace(citext: citext) -> regnamespace`,
	2725: `oid(citext: citext) -> oid`,
	2726: `regtype(citext: citext) -> regtype`,
	2727: `regrole(citext: citext) -> regrole`,
	2728: `regclass(citext: citext) -> regclass`,
	2729: `regproc(citext: citext) -> regproc`,
	2730: `regprocedure(citext: citext) -> regprocedure`,
	2731: `pg_lsn(citext: citext) -> pg_lsn`,
	2732: `box2d(citext: citext) -> box2d`,
	2733: `bit(citext: citext) -> bit`,
	2734: `date(citext: citext) -> date`,
	2735: `time(citext: citext) -> time`,
	2736: `timetz(citext: citext) -> timetz`,
	2737: `interval(citext: citext) -> interval`,
	2738: `decimal(citext: citext) -> decimal`,
	2739: `float8(citext: citext) -> float`,
	2740: `geography(citext: citext) -> geography`,
	2741: `varbit(citext: citext) -> varbit`,
	2742: `jsonpath(citext: citext) -> jsonpath`,
	2743: `int2(citext: citext) -> int2`,
	2744: `int4(citext: citext) -> int4`,
	2745: `float4(citext: citext) -> float4`,
	2746: `numeric(citext: citext) -> decimal`,
	2747: `uuid(citext: citext) -> uuid`,
	2748: `tsquery(citext: citext) -> tsquery`,
	2749: `citext(bytes: bytes) -> citext`,
	2750: `geometry(citext: citext) -> geometry`,
	2751: `void(citext: citext) -> void`,
	2752: `int8(citext: citext) -> int`,
	2753: `record(citext: citext) -> anyelement`,
	2754: `citext(int: int) -> citext`,
	2755: `vector(citext: citext) -> vector`,
	2756: `tsvector(citext: citext) -> tsvector`,
	2757: `jsonb(citext: citext) -> jsonb`,
	2758: `citext(oid: oid) -> citext`,
	2759: `bytes(citext: citext) -> bytes`,
	2760: `timestamp(citext: citext) -> timestamp`,
	2761: `citext(float: float) -> citext`,
	2762: `citext(date: date) -> citext`,
	2763: `refcursor(citext: citext) -> refcursor`,
	2764: `citext(time: time) -> citext`,
	2765: `citext(timestamp: timestamp) -> citext`,
	2766: `citext(timestamptz: timestamptz) -> citext`,
	2767: `citext(interval: interval) -> citext`,
	2768: `citext(timetz: timetz) -> citext`,
	2769: `citext(bit: bit) -> citext`,
	2770: `citext(decimal: decimal) -> citext`,
	2771: `citext(refcursor: refcursor) -> citext`,
	2772: `citext(tuple: tuple) -> citext`,
	2773: `citext(void: void) -> citext`,
	2774: `citext(jsonb: jsonb) -> citext`,
	2775: `citext(varbit: varbit) -> citext`,
	2776: `citext(uuid: uuid) -> citext`,
	2777: `citext(pg_lsn: pg_lsn) -> citext`,
	2778: `citext(tsvector: tsvector) -> citext`,
	2779: `citext(geography: geography) -> citext`,
	2780: `citext(geometry: geometry) -> citext`,
	2781: `citext(tsquery: tsquery) -> citext`,
	2782: `citext(jsonpath: jsonpath) -> citext`,
	2783: `citext(box2d: box2d) -> citext`,
	2784: `citext(vector: vector) -> citext`,
}
