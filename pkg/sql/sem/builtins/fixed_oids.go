...
var builtinOidsBySignature = map[string]oid.Oid{
	...
	`phraseto_tsquery(config: string, text: string) -> tsquery`:                                         2057,
	`pi() -> float`:                                                                                     785,
	`plainto_tsquery(config: string, text: string) -> tsquery`:                                          2058,
	...
	`to_tsquery(config: string, text: string) -> tsquery`:                                                                                                                           2055,
	`to_tsvector(config: string, text: string) -> tsvector`:                                                                                                                         2056,
