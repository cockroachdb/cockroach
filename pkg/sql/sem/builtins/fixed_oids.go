...
var builtinOidsArray = []string{
	...
	2684: `array_agg(arg1: macaddr[]) -> macaddr[][]`,
	2685: `percentile_disc_impl(arg1: float, arg2: macaddr) -> macaddr`,
	2686: `min(arg1: macaddr) -> anyelement`,
	2687: `max(arg1: macaddr) -> anyelement`,
	2688: `array_agg(arg1: macaddr) -> macaddr[]`,
	2689: `array_agg(arg1: macaddr) -> macaddr[]`,
	2690: `percentile_disc_impl(arg1: float[], arg2: macaddr) -> macaddr[]`,
	2691: `array_cat_agg(arg1: macaddr[]) -> macaddr[]`,
	2692: `array_agg(farg1: macaddr[]) -> macaddr[][]`,
	2693: `array_cat(left: macaddr[], right: macaddr[]) -> macaddr[]`,
	2694: `array_prepend(elem: macaddr, array: macaddr[]) -> macaddr[]`,
	2695: `array_remove(array: macaddr[], elem: macaddr) -> anyelement`,
	2696: `array_append(array: macaddr[], elem: macaddr) -> macaddr[]`,
	2697: `array_positions(array: macaddr[], elem: macaddr) -> int[]`,
	2698: `array_replace(array: macaddr[], toreplace: macaddr, replacewith: macaddr) -> anyelement`,
	2799: `array_position(array: macaddr[], elem: macaddr) -> int`,
	2700: `array_position(array: macaddr[], elem: macaddr, start: int) -> int`,
	2701: `macaddrsend(macaddr: macaddr) -> bytes`,
	2702: `macaddrout(macaddr: macaddr) -> bytes`,
	2703: `macaddrrecv(input: anyelement) -> macaddr`,
	2704: `macaddrin(input: anyelement) -> macaddr`,
	2705: `nth_value(val: macaddr, n: int) -> macaddr`,
	2706: `lead(val: macaddr) -> macaddr`,
	2707: `lag(val: macaddr) -> macaddr`,
	2708: `lag(val: macaddr, n: int) -> macaddr`,
	2709: `lag(val: macaddr, n: int, default: macaddr) -> macaddr`,
	2710: `lag(val: macaddr, n: int, default: macaddr) -> macaddr`,
	2711: `first_value(val: macaddr) -> macaddr`,
	2712: `lead(val: macaddr, n: int) -> macaddr`,
	2713: `lead(val: macaddr, n: int) -> macaddr`,
	2714: `last_value(val: macaddr) -> macaddr`,
	2715: `lead(val: macaddr, n: int, default: macaddr) -> macaddr`,
}
