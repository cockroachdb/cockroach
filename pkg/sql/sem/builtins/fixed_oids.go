...
var builtinOidsArray = []string{
	...
	2367: `crdb_internal.tenant_span_stats(database_name: string) -> tuple{int AS database_id, int AS table_id, int AS range_count, int AS approximate_disk_bytes, int AS live_bytes, int AS total_bytes, float AS live_percentage}`,
	2368: `crdb_internal.tenant_span_stats(database_name: string, table_name: string) -> tuple{int AS database_id, int AS table_id, int AS range_count, int AS approximate_disk_bytes, int AS live_bytes, int AS total_bytes, float AS live_percentage}`,
	2369: `pg_advisory_unlock(key1: int4, key2: int4) -> bool`,
	2370: `pg_advisory_unlock_shared(key: int) -> bool`,
	2371: `pg_advisory_unlock_shared(key1: int4, key2: int4) -> bool`,
	2372: `pg_advisory_unlock_all() -> void`,
	2373: `crdb_internal.redactable_sql_constants(val: string) -> string`,
	2374: `crdb_internal.redactable_sql_constants(val: string[]) -> string[]`,
	2375: `crdb_internal.redact(val: string) -> string`,
	2376: `crdb_internal.redact(val: string[]) -> string[]`,
	2377: `array_cat_agg(arg1: bool[]) -> bool[]`,
	2378: `array_cat_agg(arg1: box2d[]) -> box2d[]`,
	2379: `array_cat_agg(arg1: int[]) -> int[]`,
	2380: `array_cat_agg(arg1: float[]) -> float[]`,
	2381: `array_cat_agg(arg1: decimal[]) -> decimal[]`,
	2382: `array_cat_agg(arg1: date[]) -> date[]`,
	2383: `array_cat_agg(arg1: timestamp[]) -> timestamp[]`,
	2384: `array_cat_agg(arg1: interval[]) -> interval[]`,
	2385: `array_cat_agg(arg1: geography[]) -> geography[]`,
	2386: `array_cat_agg(arg1: geometry[]) -> geometry[]`,
	2387: `array_cat_agg(arg1: string[]) -> string[]`,
	2388: `array_cat_agg(arg1: bytes[]) -> bytes[]`,
	2389: `array_cat_agg(arg1: timestamptz[]) -> timestamptz[]`,
	2390: `array_cat_agg(arg1: oid[]) -> oid[]`,
	2391: `array_cat_agg(arg1: uuid[]) -> uuid[]`,
	2392: `array_cat_agg(arg1: inet[]) -> inet[]`,
	2393: `array_cat_agg(arg1: time[]) -> time[]`,
	2394: `array_cat_agg(arg1: timetz[]) -> timetz[]`,
	2395: `array_cat_agg(arg1: jsonb[]) -> jsonb[]`,
	2396: `array_cat_agg(arg1: varbit[]) -> varbit[]`,
	2397: `array_cat_agg(arg1: anyenum[]) -> anyenum[]`,
	2398: `array_cat_agg(arg1: tuple[]) -> tuple[]`,
	2399: `crdb_internal.update_tenant_resource_limits(tenant_name: string, available_request_units: float, refill_rate: float, max_burst_request_units: float, as_of: timestamp, as_of_consumed_request_units: float) -> int`,
}
