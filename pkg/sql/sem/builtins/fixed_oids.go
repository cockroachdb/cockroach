...
var builtinOidsArray = []string{
	...
	2606: `crdb_internal.protect_cluster(timestamp: decimal, expiration_window: interval, description: string) -> int`,
	2607: `crdb_internal.extend_cluster_protection(job_id: int) -> void`,
}
