...
var blowfishEncoding = base64.NewEncoding("./ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789").WithPadding(base64.NoPadding)
...
func genSaltBlowfish(rounds int) ([]byte, error) {
	...
	saltLength := blowfishEncoding.EncodedLen(len(input))
	...
	blowfishEncoding.Encode(output[7:], input)
