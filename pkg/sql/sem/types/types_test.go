...
func TestTypes(t *testing.T) {
	...
	testCases := []struct {
		...
		{MakeArray(IntArray), &T{InternalType: InternalType{
			SemanticType: ARRAY, ArrayContents: IntArray, Oid: 0, Locale: &emptyLocale}}},
	...
	for _, tc := range testCases {
		...
		// Roundtrip type by marshaling, then unmarshaling.
...
func TestMarshalCompat(t *testing.T) {
	...
	testCases := []struct {
		...
		{MakeArray(MakeArray(Int2)), InternalType{SemanticType: ARRAY, Oid: 0, ArrayContents: MakeArray(Int2)}},
