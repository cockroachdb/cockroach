...
// EqualTypes returns true if types x and y are equal. We need this function because
// the Go == operator is not defined over all T instances, in particular TTuple.
