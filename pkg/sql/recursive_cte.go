...
func (n *recursiveCTENode) startExec(params runParams) error {
	...
	n.workingRows.init(n.typs, params.extendedEvalCtx, "cte" /* opName */, false /* enableDeduplication */)
	if n.deduplicate {
		n.allRows.init(n.typs, params.extendedEvalCtx, "cte-all" /* opName */, true /* enableDeduplciation */)
	}
	return nil
}
...
func (n *recursiveCTENode) Next(params runParams) (bool, error) {
	...
	n.workingRows.init(n.typs, params.extendedEvalCtx, "cte" /* opName */, n.deduplicate)
