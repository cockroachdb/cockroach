...
// LogEventForSchemaChanger allows then new schema changer
...
func LogEventForSchemaChanger(
	...
	return logEventInternalForSQLStatements(ctx, execCfg.(*ExecutorConfig), txn, depth, eventLogOptions{dst: LogEverywhere}, *commonPayload, entry)
}
