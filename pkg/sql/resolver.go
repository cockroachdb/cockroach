...
func resolveExistingObjectImpl(
	...
	default:
		return nil, prefix, errors.AssertionFailedf("unknown desired object kind")
	}
}
...
func (p *planner) LookupObject(
	...
	objDesc, err := sc.GetObjectDesc(ctx, p.txn, p.ExecCfg().Settings, dbName, scName, tbName, lookupFlags)
