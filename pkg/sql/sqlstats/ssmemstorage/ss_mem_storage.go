...
func NewTempContainerFromExistingStmtStats(
	...
	for i := range statistics {
		...
		stmtStats.meta.stmtNoConstants = statistics[i].Key.KeyData.Query
		stmtStats.meta.implicitTxn = statistics[i].Key.KeyData.ImplicitTxn
		stmtStats.meta.database = statistics[i].Key.KeyData.Database
