...
func NewTempContainerFromExistingData(
	...
	for i := range statistics {
		...
		stmtStats, _, throttled :=
			container.getStatsForStmtWithKeyNotLocked(key, statistics[i].ID, true /* createIfNonexistent */)
		if throttled {
...
func (s *Container) getStatsForStmtWithKey(
	...
	return s.getStatsForStmtWithKeyNotLocked(key, stmtFingerprintID, createIfNonexistent)
}
