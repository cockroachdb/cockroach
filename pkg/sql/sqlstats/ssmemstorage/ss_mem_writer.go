...
// arguments.
func (s *StatsContainer) RecordStatement(
	...
	stats, statementKey, stmtID, created, throttled := s.getStatsForStmt(
...
func (s *StatsContainer) RecordStatementExecStats(
...
func (s *StatsContainer) ShouldSaveLogicalPlanDesc(
...
func (s *StatsContainer) RecordTransaction(
	...
	// Get the statistics object.
	stats, created, throttled := s.getStatsForTxnWithKey(key, value.StatementIDs, true /* createIfNonexistent */)
...
func (s *StatsContainer) recordTransactionHighLevelStats(
