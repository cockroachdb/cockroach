...
// PlanMetadata, LatencyRecorder, and QueryLevelStats must have been called.
	...
	if !b.validate() {
		if buildutil.CrdbTestBuild {
			panic("RecordedStatementStatsBuilder: not all required fields set. " +
				"plan metadata, latencies, and query stats are required.")
		}
		return nil
	}
	return b.stmtStats
...
func (b *RecordedStatementStatsBuilder) validate() bool {
	...
	return b.planMetadataSet && b.latenciesRecorded && b.queryStatsSet
}
