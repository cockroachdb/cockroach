...
func TestSQLStatsPersistedLimitReached(t *testing.T) {
	...
	for smallestStatsCountByShard(t, sqlConn) <= minCountByShard {
	...
	smallest := smallestStatsCountByShard(t, sqlConn)
...
func smallestStatsCountByShard(t *testing.T, sqlConn *sqlutils.SQLRunner) (numStmtStats int64) {
