...
func (s *PersistedSQLStats) Flush(ctx context.Context) {
	...
	enabled := SQLStatsFlushEnabled.Get(&s.cfg.Settings.SV) && s.clusterVersionSupportPersistedSQLStats(ctx)
...
// clusterVersionSupportPersistedSQLStats returns true the cluster version is high enough to
// support persisted SQL Stats.
func (s *PersistedSQLStats) clusterVersionSupportPersistedSQLStats(ctx context.Context) bool {
