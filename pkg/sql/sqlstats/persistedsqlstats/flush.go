...
func (s *PersistedSQLStats) Flush(ctx context.Context) {
	...
	_ = s.IterateStatementStats(ctx, &sqlstats.IteratorOptions{}, func(_ context.Context, statistics *roachpb.CollectedStatementStatistics) error {
	...
	_ = s.IterateTransactionStats(ctx, &sqlstats.IteratorOptions{}, func(_ context.Context, key roachpb.TransactionFingerprintID, statistics *roachpb.CollectedTransactionStatistics) error {
		s.doFlush(ctx, func() error {
