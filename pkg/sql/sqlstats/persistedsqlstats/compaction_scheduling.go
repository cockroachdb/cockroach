...
// disableFollowerReadForTest disables the use of follower read used in
// persistedsqlstats package. This is used because follower read can cause
// problems in unit tests where we immediately start running follower read SQL
// queries on system tables that are yet to be created. This is not a scenario
// that is possible in outside of testing.
var disableFollowerReadForTest = false

func DisableFollowerReadForTest() {
	disableFollowerReadForTest = true
}
