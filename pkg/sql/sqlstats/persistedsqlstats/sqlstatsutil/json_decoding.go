...
// representation of the statement statistics into
// roachpb.CollectedStatementStatistics.
func DecodeMetadataJSON(metadata json.JSON, result *roachpb.StatementDetailsStatisticsKey) error {
	return (*stmtDetailsStatsMetadata)(result).jsonFields().decodeJSON(metadata)
}
