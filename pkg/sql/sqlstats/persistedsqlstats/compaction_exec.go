...
func (c *StatsCompactor) removeStaleRowsPerShard(
	...
	limitPerShard := c.getRowLimitPerShard()
...
func (c *StatsCompactor) getRowCountForShard(
	ctx context.Context, stmt string, shardIdx int64, count *int64,
) error {
...
func (c *StatsCompactor) removeStaleRowsForShard(
	ctx context.Context, stmt string, shardIdx, existingRowCountPerShard, maxRowLimitPerShard int64,
) error {
