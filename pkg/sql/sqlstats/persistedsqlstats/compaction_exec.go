...
//  value.
const (
	// N.B.: statement and transaction statistics system tables have hash sharded
...
var (
	stmtStatsCleanupOps = &cleanupOperations{
      ...
      %s
      WHERE crdb_internal_aggregated_ts_app_name_fingerprint_id_node_id_plan_hash_transaction_fingerprint_id_shard_8 = $1`,
		unconstrainedDeleteStmt: deleteFromStmtStatsWithWideScan,
		constrainedDeleteStmt:   deleteFromStmtStatsWithConstrainedScan,
	}
	txnStatsCleanupOps = &cleanupOperations{
      ...
      %s
      WHERE crdb_internal_aggregated_ts_app_name_fingerprint_id_node_id_shard_8 = $1`,
		unconstrainedDeleteStmt: deleteFromTxnStatsWithWideScan,
		constrainedDeleteStmt:   deleteFromTxnStatsWithConstrainedScan,
	}
)
