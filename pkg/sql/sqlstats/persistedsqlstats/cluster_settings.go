...
// PeriodicallyDiscardWhenFlushDisabled is the cluster setting that allows the
// older in-memory SQL stats to be discarded when flushing to persisted tables
// is disabled.
var PeriodicallyDiscardWhenFlushDisabled = settings.RegisterBoolSetting(
	settings.TenantWritable,
	"sql.stats.flush.periodically_discard_when_disabled",
