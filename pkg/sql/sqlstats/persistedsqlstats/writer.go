...
func (s *StatsWriter) RecordStatement(
	...
	s.recordStatsOrSendMemoryPressureSignal(func() (err error) {
...
func (s *StatsWriter) RecordTransaction(
	...
	s.recordStatsOrSendMemoryPressureSignal(func() error {
		return s.memWriter.RecordTransaction(ctx, key, value)
	})
	return nil
}

func (s *StatsWriter) recordStatsOrSendMemoryPressureSignal(fn func() error) {
	err := fn()
