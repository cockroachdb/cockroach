...
func (i *SQLStatsIngester) ingest(ctx context.Context, events *eventBuffer) {
	for idx, e := range events {
		...
		if e.statement != nil {
			...
			i.metrics.IngesterNumProcessed.Inc(1)
			i.metrics.IngesterQueueSize.Dec(1)
...
func (i *SQLStatsIngester) RecordStatement(
	_ctx context.Context, value *sqlstats.RecordedStmtStats,
) {
	i.BufferStatement(value)
...
func (i *SQLStatsIngester) RecordTransaction(
	_ctx context.Context, value *sqlstats.RecordedTxnStats,
) {

	i.BufferTransaction(value)
...
func (i *SQLStatsIngester) BufferStatement(statement *sqlstats.RecordedStmtStats) {
	...
	i.guard.AtomicWrite(func(writerIdx int64) {
		...
		i.metrics.IngesterQueueSize.Inc(1)
	})
}
