...
// NewSQLStatsLocalProvider returns an local in-memory implementation of
// sqlstats.Provider.
...
// IterateStatements implements sqlstats.Provider interface.
func (s *sqlStats) IterateStatementStats(
	...
	for _, appName := range appNames {
		...
		for _, stmtKey := range stmtKeys {
			...
			statementStats, _, _ := appStats.getStatsForStmtWithKey(stmtKey, stmtID, false /* createIfNonexistent */)
...
// IterateTransactions implements sqlstats.Provider interface.
...
// GetStatementStatistics implements sqlstats.Provider interface.
...
// GetTransactionStatistics implements sqlstats.Provider interface.
