...
// processEmittedStmtStats is used for processing logged statement stats flushed from the eventagg.MapReduceAggregator
// initialized by NewStmtStatsAggregator. It is meant to serve as a toy example for how
func processEmittedStmtStats(
	_ context.Context,
...
func InitStmtStatsProcessor(ctx context.Context, stopper *stop.Stopper) {
	processor := eventagg.NewEmittedKVProcessor[appstatspb.StmtFingerprintID, *StmtStatistics](processEmittedStmtStats)
