...
// it will return (if any). additionally, if it would like any sub-plans to be
// planned for it by the usual sql machinery. `fn` will be called in a goroutine
// during the `Start` phase of plan execution, and is passed the fully planned
// and started version of the subplans returned above.
//
