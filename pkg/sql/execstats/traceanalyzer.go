...
type FlowsMetadata struct {
	...
	// extracted from a trace. Note that it is possible for the processorStats to
	// have nil stats, which indicates that no stats were found for the given
	// processor in the trace.
