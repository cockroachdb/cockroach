...
func TestQueryLevelStatsAccumulate(t *testing.T) {
	...
	a := execstats.QueryLevelStats{
		...
		KVSeeksInternal:                  14,
		KVBlockBytes:                     15,
		KVBlockBytesInCache:              16,
		KVKeyBytes:                       17,
		KVValueBytes:                     18,
		KVPointCount:                     19,
		KVPointsCoveredByRangeTombstones: 20,
		KVRangeKeyCount:                  21,
		KVRangeKeyContainedPoints:        22,
		KVRangeKeySkippedPoints:          23,
	}
	...
	b := execstats.QueryLevelStats{
		...
		KVSeeksInternal:                  21,
		KVBlockBytes:                     22,
		KVBlockBytesInCache:              23,
		KVKeyBytes:                       24,
		KVValueBytes:                     25,
		KVPointCount:                     26,
		KVPointsCoveredByRangeTombstones: 27,
		KVRangeKeyCount:                  28,
		KVRangeKeyContainedPoints:        29,
		KVRangeKeySkippedPoints:          30,
	}
	expected := execstats.QueryLevelStats{
		NetworkBytesSent:                 9,
		MaxMemUsage:                      9,
		...
		KVSeeksInternal:                  35,
		KVBlockBytes:                     37,
		KVBlockBytesInCache:              39,
		KVKeyBytes:                       41,
		KVValueBytes:                     43,
		KVPointCount:                     45,
		KVPointsCoveredByRangeTombstones: 47,
		KVRangeKeyCount:                  49,
		KVRangeKeyContainedPoints:        51,
		KVRangeKeySkippedPoints:          53,
	}
