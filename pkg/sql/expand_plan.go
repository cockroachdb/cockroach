...
func (p *planner) expandPlan(plan planNode) error {
	...
	case *limitNode:
		panic("expandPlan for limitNode must be handled by selectTopNode")

	case *sortNode:
		panic("expandPlan for sortNode must be handled by selectTopNode")

	case *windowNode:
		panic("expandPlan for windowNode must be handled by selectTopNode")

	case *groupNode:
		panic("expandPlan for groupNode must be handled by selectTopNode")

	case *distinctNode:
		panic("expandPlan for distinctNode must be handled by selectTopNode")
