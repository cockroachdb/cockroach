...
// OrderByNullsNonDefaultCounter is to be incremented whenever a non-default
// ordering of nulls is used for ORDER BY (either ASC NULLS LAST or DESC NULLS
// FIRST).
var OrderByNullsNonDefaultCounter = telemetry.GetCounterOnce("sql.plan.opt.order-by-nulls-non-default")
