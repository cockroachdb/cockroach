...
// trackedSchemas have the schemas that we track by
// telemetry.
...
// IncrementGetVirtualTableEntry is used to increment telemetry counter
// for any use of tracked schemas tables.
