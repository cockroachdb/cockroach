...
//
// For legacy files with ConvertedType annotations, we convert them to LogicalType
// during initialization using Apache Arrow's ToLogicalType() method, allowing a
// single conversion path for all files.
