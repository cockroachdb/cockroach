...
func ingestKvs(
	...
	if flowCtx.Cfg.Settings.Version.IsActive(ctx, clusterversion.ImportRollbacksWithoutMVCC) {
		// TODO (msbutler): add ImportEpoch to sql table descriptor and plumb to job details.
