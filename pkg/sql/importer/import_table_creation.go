...
// unit tests.
//
// Any occurrence of SERIAL in the column definitions is handled using the
// CockroachDB legacy behavior, i.e. INT NOT NULL DEFAULT unique_rowid().
//
// It uses parentID and parentSchemaID instead of descriptors.
...
// LookupObject implements the resolver.ObjectNameExistingResolver interface.
