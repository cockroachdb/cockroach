...
func (n *showTenantNode) getTenantValues(
	...
	if n.withCapabilities {
		...
		showTenantNodeCapabilities := make([]showTenantNodeCapability, 0, len(tenantcapabilitiesapi.BoolCapabilityNames))
		...
		for _, capabilityName := range tenantcapabilitiesapi.Int32RangeCapabilityNames {
