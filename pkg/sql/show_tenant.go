...
func (n *showTenantNode) getTenantValues(
	...
	if n.withCapabilities {
		...
		showTenantNodeCapabilities := make([]showTenantNodeCapability, 0, len(tenantcapabilitiesapi.CapabilityIDs))
		for _, capabilityID := range tenantcapabilitiesapi.CapabilityIDs {
