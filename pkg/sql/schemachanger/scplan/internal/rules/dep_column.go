	...
	registerDepRule(
		...
		func(from, to nodeVars) rel.Clauses {
			return rel.Clauses{
				...
				depEdgeToPublic(from, scpb.Status_DELETE_ONLY, to, scpb.Status_PUBLIC),
	...
	registerDepRule(
		...
		func(from, to nodeVars) rel.Clauses {
			return rel.Clauses{
				...
				joinOnColumnID(from, to, "table-id", "col-id"),
				depEdgeToPublic(from, scpb.Status_PUBLIC, to, scpb.Status_WRITE_ONLY),
			}
		},
	)
	...
	registerDepRule(
		...
		func(from, to nodeVars) rel.Clauses {
			return rel.Clauses{
				...
				joinOnColumnID(from, to, "table-id", "col-id"),
				depEdgeToAbsent(from, scpb.Status_WRITE_ONLY, to, scpb.Status_ABSENT),
			}
		},
	)
	...
	registerDepRule(
		...
		func(from, to nodeVars) rel.Clauses {
			...
			return rel.Clauses{
				...
				depEdgeElementFilter("SmallerColumnIDFirst", from, to, func(from, to *scpb.Column) bool {
