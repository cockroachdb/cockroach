	...
	registerDepRule(
		...
		func(from, to nodeVars) rel.Clauses {
			return rel.Clauses{
				...
				depEdgeElementFilter("primaryIndexesDependency", from, to, func(i1, i2 *scpb.PrimaryIndex) bool {
...
func init() {
	...
	registerDepRule(
		...
		func(from, to nodeVars) rel.Clauses {
			return rel.Clauses{
				...
				joinOnIndexID(from, to, "table-id", "index-id"),
				depEdgeToAbsent(from, scpb.Status_DELETE_ONLY, to, scpb.Status_ABSENT),
			}
		},
	)
	registerDepRule(
		...
		func(from, to nodeVars) rel.Clauses {
			return rel.Clauses{
				...
				joinOnIndexID(from, to, "table-id", "index-id"),
				depEdgeToAbsent(from, scpb.Status_ABSENT, to, scpb.Status_TRANSIENT_ABSENT),
			}
		},
	)
	registerDepRule(
		...
		func(from, to nodeVars) rel.Clauses {
			return rel.Clauses{
				...
				to.Type((*scpb.IndexColumn)(nil)),
				joinOnIndexID(from, to, "table-id", "index-id"),
				depEdgeToAbsent(from, scpb.Status_TRANSIENT_DELETE_ONLY, to, scpb.Status_ABSENT),
			}
		},
	)
	...
	registerDepRule(
		...
		func(from, to nodeVars) rel.Clauses {
			return rel.Clauses{
				elementTypes(from, isIndex),
				elementTypes(to, isIndexDependent),
				joinOnIndexID(from, to, "table-id", "index-id"),
				depEdgeToAbsent(from, scpb.Status_VALIDATED, to, scpb.Status_ABSENT),
			}
		},
	)
	...
	registerDepRule(
		...
		func(from, to nodeVars) rel.Clauses {
			return rel.Clauses{
				elementTypes(from, isIndexDependent),
				elementTypes(to, isIndex),
				joinOnIndexID(from, to, "table-id", "index-id"),
				depEdgeToAbsent(from, scpb.Status_ABSENT, to, scpb.Status_ABSENT),
			}
		},
	...
	registerDepRule(
		...
		func(from, to nodeVars) rel.Clauses {
			return rel.Clauses{
				...
				depEdgeToPublic(from, scpb.Status_PUBLIC, to, scpb.Status_BACKFILL_ONLY),
			}
		})
	registerDepRule(
