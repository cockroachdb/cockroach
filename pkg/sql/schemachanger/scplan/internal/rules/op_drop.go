	...
	registerOpRule(
		...
		screl.MustQuery(
			...
			dep.el.Type(
				...
				(*scpb.DatabaseZoneConfig)(nil),
				(*scpb.TableZoneConfig)(nil),
				(*scpb.TableSubZoneConfig)(nil),
				(*scpb.TableZoneConfigOption)(nil),
				(*scpb.TableSubZoneConfigOption)(nil),
				(*scpb.DatabaseZoneConfigOption)(nil),
			),
