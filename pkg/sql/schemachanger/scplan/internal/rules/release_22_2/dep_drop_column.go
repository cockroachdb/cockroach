...
func init() {
	...
	registerDepRuleForDrop(
		...
		func(from, to common.NodeVars) rel.Clauses {
			return rel.Clauses{
				...
				to.TypeFilter(common.IsColumnDependent),
				common.JoinOnColumnID(from, to, "table-id", "col-id"),
			}
		},
	)
	...
	registerDepRuleForDrop(
		...
		func(from, to common.NodeVars) rel.Clauses {
			return rel.Clauses{
				from.TypeFilter(common.IsColumnDependent),
...
func init() {
	...
	registerDepRule(
		...
		func(from, to common.NodeVars) rel.Clauses {
			return rel.Clauses{
				from.TypeFilter(common.IsColumnTypeDependent),
				to.Type((*scpb.ColumnType)(nil)),
				common.JoinOnColumnID(from, to, "table-id", "col-id"),
				common.StatusesToAbsent(from, scpb.Status_ABSENT, to, scpb.Status_ABSENT),
			}
		},
	)
	...
	registerDepRule(
		"column type removed right before column when common.Not dropping relation",
		scgraph.SameStagePrecedence,
		"column-type", "column",
		func(from, to common.NodeVars) rel.Clauses {
			return rel.Clauses{
