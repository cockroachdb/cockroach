...
func init() {
	...
	// index and common.Not the descriptor, we need to make sure that we only
	...
	// clause.
	registerDepRuleForDrop(
		"partial predicate removed right before secondary index when common.Not dropping relation",
