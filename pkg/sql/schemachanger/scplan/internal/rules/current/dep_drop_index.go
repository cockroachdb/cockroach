...
func init() {
	...
	registerDepRuleForDrop(
		...
		func(from, to common.NodeVars) rel.Clauses {
			return rel.Clauses{
				...
				to.TypeFilter(common.IsIndexDependent),
	...
	registerDepRuleForDrop(
		...
		func(from, to common.NodeVars) rel.Clauses {
			return rel.Clauses{
				from.TypeFilter(common.IsIndexDependent),
				to.TypeFilter(common.IsIndex),
				common.JoinOnIndexID(from, to, "table-id", "index-id"),
			}
		},
	)
	...
	registerDepRuleForDrop(
		...
		func(from, to common.NodeVars) rel.Clauses {
			return rel.Clauses{
				...
				to.Type((*scpb.SecondaryIndex)(nil)),
				common.FilterElements("viewReferencesIndex", from, to, func(from *scpb.View, to *scpb.SecondaryIndex) bool {
	...
	registerDepRuleForDrop(
		...
		func(from, to common.NodeVars) rel.Clauses {
			return rel.Clauses{
				...
				common.FilterElements("viewReferencesIndex", from, to, func(from *scpb.SecondaryIndex, to *scpb.View) bool {
