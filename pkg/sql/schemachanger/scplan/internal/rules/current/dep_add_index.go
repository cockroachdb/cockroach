	...
	registerDepRule(
		...
		func(from, to common.NodeVars) rel.Clauses {
			return rel.Clauses{
				...
				to.TypeFilter(common.IsIndexDependent),
				common.JoinOnIndexID(from, to, "table-id", "index-id"),
				common.StatusesToPublicOrTransient(from, scpb.Status_DELETE_ONLY, to, scpb.Status_PUBLIC),
			}
		},
	)
	...
	registerDepRule(
		...
		func(from, to common.NodeVars) rel.Clauses {
			return rel.Clauses{
				...
				common.JoinOnIndexID(from, to, "table-id", "index-id"),
				common.StatusesToPublicOrTransient(from, scpb.Status_PUBLIC, to, scpb.Status_VALIDATED),
			}
		},
	)
}
	...
	registerDepRule(
		...
		func(from, to common.NodeVars) rel.Clauses {
			return rel.Clauses{
				...
				common.StatusesToPublicOrTransient(from, scpb.Status_PUBLIC, to, scpb.Status_BACKFILL_ONLY),
			}
		})
	...
	registerDepRule(
		...
		func(from, to common.NodeVars) rel.Clauses {
			return rel.Clauses{
				...
				common.StatusesToPublicOrTransient(from, scpb.Status_PUBLIC, to, scpb.Status_DELETE_ONLY),
			}
		})
}
