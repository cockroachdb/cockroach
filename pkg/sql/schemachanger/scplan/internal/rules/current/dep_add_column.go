...
func init() {
	...
	registerDepRule(
		...
		func(from, to NodeVars) rel.Clauses {
			return rel.Clauses{
				rel.And(setColumnDependency(from, to, isColumnDependent)...),
				rel.And(JoinDeleteOnlyColToPublicDep(from, to, "table-id", "col-id")...),
	...
	registerDepRule(
		...
		func(from, to NodeVars) rel.Clauses {
			return rel.Clauses{
				rel.And(setColumnDependency(from, to, isColumnDependentExceptColumnName)...),
				rel.And(JoinDeleteOnlyColToPublicDep(from, to, "table-id", "col-id")...),
