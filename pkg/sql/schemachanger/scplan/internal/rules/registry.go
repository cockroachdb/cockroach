...
// Package rules contains shared structures / helper functions
...
// MarshalDepRules marshals registered deprules into YAML for testing.
...
// MarshalOpRules marshals registered oprules into YAML for testing.
...
// NewRegistry constructs a new registry for registering op/deprules.
...
type NodeVars struct {
	// El scpb.Element for this entity.
	El rel.Var
	// Target scpb.Target for this entity.
	Target rel.Var
	// Node screl.Node for this entity.
	Node rel.Var
}
...
// CurrentStatus requires that the current status is one of the specified
// status.
...
// TargetStatus requires that the target status is one of the specified
// status.
...
// MkNodeVars constructs a node with the given element name.
