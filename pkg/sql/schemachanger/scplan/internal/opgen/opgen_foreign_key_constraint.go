			...
			to(scpb.Status_WRITE_ONLY,
				emit(func(this *scpb.ForeignKeyConstraint) *scop.MakeAbsentForeignKeyConstraintWriteOnly {
					return &scop.MakeAbsentForeignKeyConstraintWriteOnly{
						...
						OnUpdateAction:          descpb.ForeignKeyReferenceActionValue[this.OnUpdateAction],
						OnDeleteAction:          descpb.ForeignKeyReferenceActionValue[this.OnDeleteAction],
						CompositeKeyMatchMethod: descpb.CompositeKeyMatchMethodValue[this.CompositeKeyMatchMethod],
					}
				}),
			),
