...
func init() {
	opRegistry.register((*scpb.CompositeType)(nil),
		...
		toAbsent(
			scpb.Status_PUBLIC,
			to(scpb.Status_TXN_DROPPED,
				emit(func(this *scpb.CompositeType, md *targetsWithElementMap) *scop.MarkDescriptorAsSyntheticallyDropped {
			...
			to(scpb.Status_ABSENT,
				emit(func(this *scpb.CompositeType, md *targetsWithElementMap) *scop.LogEvent {
