...
type MutationVisitor interface {
	...
	RemoveDescriptorName(context.Context, RemoveDescriptorName) error
...
// Visit is part of the MutationOp interface.
func (op RemoveDescriptorName) Visit(ctx context.Context, v MutationVisitor) error {
	return v.RemoveDescriptorName(ctx, op)
}
