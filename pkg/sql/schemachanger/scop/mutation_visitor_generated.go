...
type MutationVisitor interface {
	...
	MakeAbsentCheckConstraintValidating(context.Context, MakeAbsentCheckConstraintValidating) error
...
// Visit is part of the MutationOp interface.
func (op MakeAbsentCheckConstraintValidating) Visit(ctx context.Context, v MutationVisitor) error {
	return v.MakeAbsentCheckConstraintValidating(ctx, op)
}
