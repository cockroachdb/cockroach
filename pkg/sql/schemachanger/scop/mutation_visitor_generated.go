...
type MutationVisitor interface {
	...
	UpdateJobProgress(context.Context, UpdateJobProgress) error
}
...
// Visit is part of the MutationOp interface.
func (op UpdateJobProgress) Visit(ctx context.Context, v MutationVisitor) error {
	return v.UpdateJobProgress(ctx, op)
}
