...
type MutationVisitor interface {
	...
	MarkDescriptorAsDroppedInTxn(context.Context, MarkDescriptorAsDroppedInTxn) error
...
// Visit is part of the MutationOp interface.
func (op MarkDescriptorAsDroppedInTxn) Visit(ctx context.Context, v MutationVisitor) error {
	return v.MarkDescriptorAsDroppedInTxn(ctx, op)
}
