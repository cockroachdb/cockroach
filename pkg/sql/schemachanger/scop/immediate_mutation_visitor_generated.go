...
type ImmediateMutationVisitor interface {
	...
	SetDescriptorName(context.Context, SetDescriptorName) error
...
// Visit is part of the ImmediateMutationOp interface.
func (op SetDescriptorName) Visit(ctx context.Context, v ImmediateMutationVisitor) error {
	return v.SetDescriptorName(ctx, op)
}
