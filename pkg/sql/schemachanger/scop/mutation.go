...
// MakeAbsentCheckConstraintValidating adds a non-existent check constraint
// to the table in the VALIDATING state.
type MakeAbsentCheckConstraintValidating struct {
	mutationOp
	TableID      descpb.ID
	ConstraintID descpb.ConstraintID
