...
var Schema = rel.MustSchema("screl",
	...
	rel.EntityMapping(t((*scpb.UniqueConstraint)(nil)),
		rel.EntityAttr(DescID, "TableID"),
		rel.EntityAttr(IndexID, "IndexID"),
		rel.EntityAttr(ConstraintType, "ConstraintID.Type"),
		rel.EntityAttr(ConstraintOrdinal, "ConstraintID.Ordinal"),
	),
	rel.EntityMapping(t((*scpb.CheckConstraint)(nil)),
		rel.EntityAttr(DescID, "TableID"),
		rel.EntityAttr(Name, "Name"),
		rel.EntityAttr(ConstraintType, "Id.Type"),
		rel.EntityAttr(ConstraintOrdinal, "Id.Ordinal"),
	),
