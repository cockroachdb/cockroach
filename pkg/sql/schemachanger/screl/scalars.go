...
func VersionSupportsElementUse(el scpb.Element, version clusterversion.ClusterVersion) bool {
	...
	case *scpb.PolicyRole, *scpb.PolicyUsingExpr, *scpb.PolicyWithCheckExpr, *scpb.PolicyDeps, *scpb.RowLevelSecurityEnabled, *scpb.RowLevelSecurityForced, *scpb.CanaryWindow:
