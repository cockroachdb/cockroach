...
[[Table:{DescID: 2}, PUBLIC], ABSENT]
[[Sequence:{DescID: 1}, PUBLIC], ABSENT]
[[ForeignKeyConstraint:{DescID: 2, ReferencedDescID: 1, ConstraintID: 0}, PUBLIC], ABSENT]`, `
[[Table:{DescID: 2}, PUBLIC], PUBLIC]
[[Sequence:{DescID: 1}, PUBLIC], PUBLIC]
[[ForeignKeyConstraint:{DescID: 2, ReferencedDescID: 1, ConstraintID: 0}, PUBLIC], PUBLIC]`, `
[[Table:{DescID: 4}, PUBLIC], ABSENT]
[[Sequence:{DescID: 3}, PUBLIC], ABSENT]
[[ForeignKeyConstraint:{DescID: 4, ReferencedDescID: 3, ConstraintID: 0}, PUBLIC], ABSENT]`,
					},
				},
			},
		},
