...
func runRankTestForGraph(t *testing.T, addNode []bool, depEdges []depEdge, expectedOrder []int) {
...
func TestGraphRanks(t *testing.T) {
	...
	t.Run("cyclic graph", func(t *testing.T) {
		require.Panicsf(t, func() {
			...
			"cyclic graph should always panic")
	})
	...
	t.Run("depedency grap swap", func(t *testing.T) {
		runRankTestForGraph(t,
