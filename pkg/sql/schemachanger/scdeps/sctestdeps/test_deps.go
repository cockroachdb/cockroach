...
func (s *TestState) GetTypeDescriptor(
	...
	desc, err := s.mustReadDescriptor(id)
	if err != nil {
...
func (s *TestState) getQualifiedObjectNameByID(id descpb.ID) (*tree.TableName, error) {
	obj, err := s.mustReadDescriptor(id)
	if err != nil {
		return nil, err
	}
...
func (s *TestState) mustReadDescriptor(id descpb.ID) (catalog.MutableDescriptor, error) {
...
// MustReadImmutableDescriptor implements the scexec.Catalog interface.
func (s *TestState) MustReadImmutableDescriptor(
	ctx context.Context, id descpb.ID,
) (catalog.Descriptor, error) {
	return s.mustReadDescriptor(id)
}
...
func (s *TestState) GetResumeSpans(
	...
	desc, err := s.mustReadDescriptor(tableID)
	if err != nil {
		return nil, err
	}
	table, err := catalog.AsTableDescriptor(desc)
...
// WithTxn implements the scrun.SchemaChangeJobExecutionDependencies interface.
func (s *TestState) WithTxn(
	ctx context.Context,
