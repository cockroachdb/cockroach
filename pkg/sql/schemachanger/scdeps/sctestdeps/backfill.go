...
func (s *backfillTracker) GetBackfillProgress(
...
func (s *backfillTracker) SetBackfillProgress(
	ctx context.Context, progress scexec.BackfillProgress,
) error {
	return nil
}

func (s *backfillTracker) FlushCheckpoint(ctx context.Context) error {
	return nil
}

func (s *backfillTracker) FlushFractionCompleted(ctx context.Context) error {
	return nil
}

// StartPeriodicFlush implements the scexec.PeriodicBackfillProgressFlusher interface.
...
var _ scexec.Backfiller = (*backfiller)(nil)

// BackfillIndex implements the scexec.Backfiller interface.
func (s *backfiller) BackfillIndex(
	_ context.Context,
...
func (s *backfiller) MaybePrepareDestIndexesForBackfill(
