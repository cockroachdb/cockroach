...
func (s *TestState) get(
	objID catid.DescID, subID uint32, commentType keys.CommentType,
...
func (s *TestState) GetDatabaseComment(dbID catid.DescID) (comment string, ok bool) {
	return s.get(dbID, 0, keys.DatabaseCommentType)
}
...
func (s *TestState) GetSchemaComment(schemaID catid.DescID) (comment string, ok bool) {
	return s.get(schemaID, 0, keys.SchemaCommentType)
}
...
func (s *TestState) GetTableComment(tableID catid.DescID) (comment string, ok bool) {
	return s.get(tableID, 0, keys.TableCommentType)
}
...
func (s *TestState) GetColumnComment(
	...
	return s.get(tableID, uint32(pgAttrNum), keys.ColumnCommentType)
}
...
func (s *TestState) GetIndexComment(
	...
	return s.get(tableID, uint32(indexID), keys.IndexCommentType)
}
...
func (s *TestState) GetConstraintComment(
	...
	return s.get(tableID, uint32(constraintID), keys.ConstraintCommentType)
}
