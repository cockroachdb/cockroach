...
func (m *visitor) AddColumnToIndex(ctx context.Context, op scop.AddColumnToIndex) error {
	...
	case scpb.IndexColumn_KEY:
		insertIntoIDs(&id.KeyColumnIDs)
		insertIntoNames(&id.KeyColumnNames)
		insertIntoDirections(&id.KeyColumnDirections)
	case scpb.IndexColumn_KEY_SUFFIX:
		insertIntoIDs(&id.KeySuffixColumnIDs)
	case scpb.IndexColumn_STORED:
		insertIntoIDs(&id.StoreColumnIDs)
		insertIntoNames(&id.StoreColumnNames)
	}
