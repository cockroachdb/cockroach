...
// the current value of the sequences when appropriate.
...
// UnsetSequenceOption sets a sequence option to its default. It updates the
// current value of the sequences when appropriate.
