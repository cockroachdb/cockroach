...
func (m *visitor) MakeAbsentForeignKeyConstraintWriteOnly(
	...
	fk := &descpb.ForeignKeyConstraint{
		...
		Name:                tabledesc.ConstraintNamePlaceholder(op.ConstraintID),
		Validity:            descpb.ConstraintValidity_Validating,
		OnDelete:            descpb.BuildEquivFKAction(op.OnDeleteAction).AsCatpb,
		OnUpdate:            descpb.BuildEquivFKAction(op.OnUpdateAction).AsCatpb,
		Match:               descpb.BuildEquivFKMatchMethod(op.CompositeKeyMatchMethod).AsDescpb,
		ConstraintID:        op.ConstraintID,
	}
