...
type Dependencies interface {
	...
	PeriodicProgressWriter() PeriodicBackfillProgressFlusher
...
// PeriodicBackfillProgressFlusher is used to write updates to backfill progress
// periodically.
type PeriodicBackfillProgressFlusher interface {
