...
// PeriodicProgressWriter mocks base method.
func (m *MockDependencies) PeriodicProgressWriter() scexec.PeriodicBackfillProgressFlusher {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PeriodicProgressWriter")
	ret0, _ := ret[0].(scexec.PeriodicBackfillProgressFlusher)
	return ret0
}

// PeriodicProgressWriter indicates an expected call of PeriodicProgressWriter.
func (mr *MockDependenciesMockRecorder) PeriodicProgressWriter() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PeriodicProgressWriter", reflect.TypeOf((*MockDependencies)(nil).PeriodicProgressWriter))
}
...
func (m *MockCatalog) AddPartitioning(tableDesc *tabledesc.Mutable, indexDesc *descpb.IndexDescriptor, partitionFields []string, listPartition []*scpb.ListPartition, rangePartition []*scpb.RangePartitions, allowedNewColumnNames []tree.Name, allowImplicitPartitioning bool) error {
	m.ctrl.T.Helper()
...
func (mr *MockCatalogMockRecorder) AddPartitioning(tableDesc, indexDesc, partitionFields, listPartition, rangePartition, allowedNewColumnNames, allowImplicitPartitioning interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockCatalog) MustReadImmutableDescriptor(ctx context.Context, id descpb.ID) (catalog.Descriptor, error) {
	m.ctrl.T.Helper()
...
func (m *MockCatalog) MustReadMutableDescriptor(ctx context.Context, id descpb.ID) (catalog.MutableDescriptor, error) {
	m.ctrl.T.Helper()
...
func (m *MockEventLogger) EnqueueEvent(ctx context.Context, descID descpb.ID, metadata *scpb.ElementMetadata, event eventpb.EventPayload) error {
	m.ctrl.T.Helper()
...
func (mr *MockEventLoggerMockRecorder) EnqueueEvent(ctx, descID, metadata, event interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockCatalogChangeBatcher) CreateOrUpdateDescriptor(ctx context.Context, desc catalog.MutableDescriptor) error {
	m.ctrl.T.Helper()
...
func (mr *MockCatalogChangeBatcherMockRecorder) CreateOrUpdateDescriptor(ctx, desc interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockCatalogChangeBatcher) DeleteName(ctx context.Context, nameInfo descpb.NameInfo, id descpb.ID) error {
	m.ctrl.T.Helper()
...
func (mr *MockCatalogChangeBatcherMockRecorder) DeleteName(ctx, nameInfo, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockTransactionalJobCreator) UpdateSchemaChangeJob(ctx context.Context, id jobspb.JobID, fn scexec.JobProgressUpdateFunc) error {
	m.ctrl.T.Helper()
...
func (mr *MockTransactionalJobCreatorMockRecorder) UpdateSchemaChangeJob(ctx, id, fn interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// AddPartitioning mocks base method.
func (m *MockPartitioner) AddPartitioning(ctx context.Context, tableDesc *tabledesc.Mutable, indexDesc *descpb.IndexDescriptor, partitionFields []string, listPartition []*scpb.ListPartition, rangePartition []*scpb.RangePartitions, allowedNewColumnNames []tree.Name, allowImplicitPartitioning bool) error {
	m.ctrl.T.Helper()
...
// AddPartitioning indicates an expected call of AddPartitioning.
func (mr *MockPartitionerMockRecorder) AddPartitioning(ctx, tableDesc, indexDesc, partitionFields, listPartition, rangePartition, allowedNewColumnNames, allowImplicitPartitioning interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockIndexValidator) ValidateForwardIndexes(ctx context.Context, tableDesc catalog.TableDescriptor, indexes []catalog.Index, withFirstMutationPublic, gatherAllInvalid bool, override sessiondata.InternalExecutorOverride) error {
	m.ctrl.T.Helper()
...
func (mr *MockIndexValidatorMockRecorder) ValidateForwardIndexes(ctx, tableDesc, indexes, withFirstMutationPublic, gatherAllInvalid, override interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockIndexValidator) ValidateInvertedIndexes(ctx context.Context, tableDesc catalog.TableDescriptor, indexes []catalog.Index, gatherAllInvalid bool, override sessiondata.InternalExecutorOverride) error {
	m.ctrl.T.Helper()
...
func (mr *MockIndexValidatorMockRecorder) ValidateInvertedIndexes(ctx, tableDesc, indexes, gatherAllInvalid, override interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockIndexSpanSplitter) MaybeSplitIndexSpans(ctx context.Context, table catalog.TableDescriptor, indexToBackfill catalog.Index) error {
	m.ctrl.T.Helper()
...
func (mr *MockIndexSpanSplitterMockRecorder) MaybeSplitIndexSpans(ctx, table, indexToBackfill interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockBackfillTracker) GetBackfillProgress(ctx context.Context, b scexec.Backfill) (scexec.BackfillProgress, error) {
	m.ctrl.T.Helper()
...
func (m *MockBackfillTracker) SetBackfillProgress(ctx context.Context, progress scexec.BackfillProgress) error {
	m.ctrl.T.Helper()
...
func (mr *MockBackfillTrackerMockRecorder) SetBackfillProgress(ctx, progress interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// MockPeriodicBackfillProgressFlusher is a mock of PeriodicBackfillProgressFlusher interface.
...
func NewMockPeriodicBackfillProgressFlusher(ctrl *gomock.Controller) *MockPeriodicBackfillProgressFlusher {
...
func (m *MockPeriodicBackfillProgressFlusher) StartPeriodicUpdates(ctx context.Context, tracker scexec.BackfillProgressFlusher) func() error {
	m.ctrl.T.Helper()
...
func (mr *MockPeriodicBackfillProgressFlusherMockRecorder) StartPeriodicUpdates(ctx, tracker interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// GetBackfillProgress mocks base method.
func (m *MockBackfillProgressReader) GetBackfillProgress(ctx context.Context, b scexec.Backfill) (scexec.BackfillProgress, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetBackfillProgress", ctx, b)
	ret0, _ := ret[0].(scexec.BackfillProgress)
	ret1, _ := ret[1].(error)
...
// GetBackfillProgress indicates an expected call of GetBackfillProgress.
func (mr *MockBackfillProgressReaderMockRecorder) GetBackfillProgress(ctx, b interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// SetBackfillProgress mocks base method.
func (m *MockBackfillProgressWriter) SetBackfillProgress(ctx context.Context, progress scexec.BackfillProgress) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetBackfillProgress", ctx, progress)
	ret0, _ := ret[0].(error)
	return ret0
...
// SetBackfillProgress indicates an expected call of SetBackfillProgress.
func (mr *MockBackfillProgressWriterMockRecorder) SetBackfillProgress(ctx, progress interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// FlushFractionCompleted indicates an expected call of FlushFractionCompleted.
func (mr *MockBackfillProgressFlusherMockRecorder) FlushFractionCompleted(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
