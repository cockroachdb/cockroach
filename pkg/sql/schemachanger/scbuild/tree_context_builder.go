...
var _ scbuildstmts.TreeContextBuilder = buildCtx{}

// SemaCtx implements the scbuildstmts.TreeContextBuilder interface.
...
// EvalCtx implements the scbuildstmts.TreeContextBuilder interface.
func (b buildCtx) EvalCtx(ctx context.Context) *tree.EvalContext {
