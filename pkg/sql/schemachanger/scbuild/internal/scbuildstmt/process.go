...
var supportedStatements = map[reflect.Type]supportedStatement{
	...
	reflect.TypeOf((*tree.DropOwnedBy)(nil)):         {DropOwnedBy, true, nil},
	...
	reflect.TypeOf((*tree.CommentOnDatabase)(nil)):   {CommentOnDatabase, true, nil},
	reflect.TypeOf((*tree.CommentOnSchema)(nil)):     {CommentOnSchema, true, nil},
	reflect.TypeOf((*tree.CommentOnTable)(nil)):      {CommentOnTable, true, nil},
	reflect.TypeOf((*tree.CommentOnColumn)(nil)):     {CommentOnColumn, true, nil},
	reflect.TypeOf((*tree.CommentOnIndex)(nil)):      {CommentOnIndex, true, nil},
	reflect.TypeOf((*tree.CommentOnConstraint)(nil)): {CommentOnConstraint, true, nil},
	// TODO (Xiang): turn on `DROP INDEX` as fully supported.
	reflect.TypeOf((*tree.DropIndex)(nil)): {DropIndex, false, nil},
}
