...
var supportedStatements = map[reflect.Type]supportedStatement{
	// Alter is fully supported, but subcommands may not be.
...
func init() {
	// Sanity: All function signatures are sane in the supported  statements array
	// are sane and take in the BuildCtx and a matching statement type.
