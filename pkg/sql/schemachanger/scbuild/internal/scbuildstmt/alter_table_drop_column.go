...
func dropColumn(
	...
	b.QueryByID(col.TableID).Filter(orFilter(publicTargetFilter, transientTargetFilter)).FilterPrimaryIndex().ForEach(func(current scpb.Status, target scpb.TargetStatus, e *scpb.PrimaryIndex) {
