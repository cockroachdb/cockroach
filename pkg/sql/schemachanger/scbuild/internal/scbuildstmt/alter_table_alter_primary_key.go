...
func recreateAllSecondaryIndexes(
	...
	var inKeySuffix []indexColumnSpec
	{
		newPrimaryIndexElts := publicTableElts.Filter(hasIndexIDAttrFilter(newPrimaryIndex.IndexID))
		scpb.ForEachIndexColumn(newPrimaryIndexElts, func(_ scpb.Status, _ scpb.TargetStatus, ic *scpb.IndexColumn) {
			if ic.Kind == scpb.IndexColumn_KEY {
				inKeySuffix = append(inKeySuffix, indexColumnSpec{
