...
import (
	...
	"github.com/cockroachdb/cockroach/pkg/sql/vecindex/vecdesc"
...
func maybeApplyStorageParameters(b BuildCtx, storageParams tree.StorageParams, idxSpec *indexSpec) {
	...
	if idxSpec.secondary.IsVector {
		...
		idxSpec.secondary.VecConfig = &vecdesc.Config{Dims: int64(typeElem.Type.Width()), Seed: 0}
	}
}
