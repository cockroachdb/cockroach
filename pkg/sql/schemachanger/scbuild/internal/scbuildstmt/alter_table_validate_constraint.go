...
func alterTableValidateConstraint(
	...
	validateConstraint(b, tbl.TableID, spec)
}
...
func retrieveForeignKeyConstraintElem(
	b BuildCtx, tableID catid.DescID, constraintID catid.ConstraintID,
) (foreignKeyConstraintElem *scpb.ForeignKeyConstraint) {
	scpb.ForEachForeignKeyConstraint(b.QueryByID(tableID), func(
		...
		if e.ConstraintID == constraintID {
			foreignKeyConstraintElem = e
		}
	})
	return foreignKeyConstraintElem
}
