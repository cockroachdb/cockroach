...
var supportedAlterTypeStatements = map[reflect.Type]supportedAlterTypeCommand{
	reflect.TypeOf((*tree.AlterTypeAddValue)(nil)):    {fn: alterTypeAddValue, on: true, checks: isV262Active}, // FIXME(bghal): Should gate on v26.3 when possible.
