...
func validateIndexesForRegionalByRow(
	...
	scpb.ForEachPrimaryIndex(elts, func(_ scpb.Status, _ scpb.TargetStatus, idx *scpb.PrimaryIndex) {
		validateIndex(&idx.Index, false /* checkStored */)
	})
	scpb.ForEachSecondaryIndex(elts, func(_ scpb.Status, _ scpb.TargetStatus, idx *scpb.SecondaryIndex) {
