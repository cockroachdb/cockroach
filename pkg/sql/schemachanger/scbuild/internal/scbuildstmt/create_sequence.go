...
func CreateSequence(b BuildCtx, n *tree.CreateSequence) {
	...
	addSequenceOption(tree.SeqOptIncrement, tempSequenceOpts.Increment)
	addSequenceOption(tree.SeqOptMinValue, tempSequenceOpts.MinValue)
	addSequenceOption(tree.SeqOptMaxValue, tempSequenceOpts.MaxValue)
