...
func CommentOnIndex(b BuildCtx, n *tree.CommentOnIndex) {
	...
	if len(n.Index.Table.ObjectName) > 0 {
		...
		tableElements = b.ResolveTableWithIndexBestEffort(tree.Name(n.Index.Index), n.Index.Table.ObjectNamePrefix, commentResolveParams)
	}
	...
	indexElements := b.ResolveIndex(tableID, tree.Name(n.Index.Index), commentResolveParams)
