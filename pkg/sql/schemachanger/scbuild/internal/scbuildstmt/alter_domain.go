...
func alterDomainAddCheckConstraint(
	...
	panic(scerrors.NotImplementedErrorf(t, "ALTER DOMAIN ADD CHECK CONSTRAINT is not supported"))
}
...
func alterDomainAddNotNullConstraint(
	...
	panic(scerrors.NotImplementedErrorf(t, "ALTER DOMAIN ADD NOT NULL CONSTRAINT is not supported"))
}

func alterDomainDropConstraint(
	b BuildCtx, tn *tree.TypeName, domainType *scpb.DomainType, t *tree.AlterDomainDropConstraint,
) {
	panic(scerrors.NotImplementedErrorf(t, "ALTER DOMAIN DROP CONSTRAINT is not supported"))
}
...
func alterDomainRenameConstraint(
	...
	panic(scerrors.NotImplementedErrorf(t, "ALTER DOMAIN RENAME CONSTRAINT is not supported"))
}
...
func alterDomainValidateConstraint(
	...
	panic(scerrors.NotImplementedErrorf(t, "ALTER DOMAIN VALIDATE CONSTRAINT is not supported"))
}

func alterDomainOwner(
	b BuildCtx, tn *tree.TypeName, domainType *scpb.DomainType, t *tree.AlterDomainOwner,
) {
	panic(scerrors.NotImplementedErrorf(t, "ALTER DOMAIN OWNER TO is not supported"))
}

func alterDomainRename(
	b BuildCtx, tn *tree.TypeName, domainType *scpb.DomainType, t *tree.AlterDomainRename,
) {
	panic(scerrors.NotImplementedErrorf(t, "ALTER DOMAIN RENAME TO is not supported"))
}

func alterDomainSetSchema(
	b BuildCtx, tn *tree.TypeName, domainType *scpb.DomainType, t *tree.AlterDomainSetSchema,
) {
	panic(scerrors.NotImplementedErrorf(t, "ALTER DOMAIN SET SCHEMA is not supported"))
}
