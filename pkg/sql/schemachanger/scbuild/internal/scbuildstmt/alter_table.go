...
func AlterTable(b BuildCtx, n *tree.AlterTable) {
	...
	dropRedundantPrimaryIndexes(b, tbl.TableID)
}

// dropRedundantPrimaryIndexes is the post-processing invoked at the end of
// building each ALTER TABLE statement to remove possibly redundant primary
// indexes.
// The rules are
...
func dropRedundantPrimaryIndexes(b BuildCtx, tableID catid.DescID) {
