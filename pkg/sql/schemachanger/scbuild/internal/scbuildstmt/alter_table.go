...
var supportedAlterTableStatements = map[reflect.Type]supportedAlterTableCommand{
	...
	// TODO(Dedej-Bergin): add isV252Active() check when V25_2 becomes available
	reflect.TypeOf((*tree.AlterTableSetRLSMode)(nil)): {fn: alterTableSetRLSMode, on: true, checks: isV251Active},
}
