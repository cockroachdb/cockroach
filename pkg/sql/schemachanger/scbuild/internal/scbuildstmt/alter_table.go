...
var supportedAlterTableStatements = map[reflect.Type]supportedAlterTableCommand{
	...
	reflect.TypeOf((*tree.AlterTableDropNotNull)(nil)):        {fn: alterTableDropNotNull, on: true, checks: isV251Active},
	reflect.TypeOf((*tree.AlterTableAddConstraint)(nil)):      {fn: alterTableAddConstraint, on: true, checks: isV253Active},
