...
func alterTableAddCheck(
	...
	b.Add(&scpb.CheckConstraint{
		...
		IndexIDToValidate:     getIndexIDToValidateForCheckConstraint(b, tbl.TableID),
	})
...
// getIndexIDToValidateForCheckConstraint returns the index ID this check constraint is supposed to
...
func getIndexIDToValidateForCheckConstraint(b BuildCtx, tableID catid.DescID) (ret catid.IndexID) {
