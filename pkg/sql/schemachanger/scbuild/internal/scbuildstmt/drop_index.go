...
func maybeDropIndex(
	...
	// TODO(136320): If a region is being added or dropped on this database, we
	// should block this schema change for RBR tables. The logic for blocking is
	// not yet in the DSC; falling back for now.
