	...
	for _, index := range n.IndexList {
		...
		if sie == nil {
			panic(errors.AssertionFailedf("programming error: cannot find secondary index element "+
				"for %v after having resolved it", index.String()))
		}
		...
		maybeDropDependentViews(b, toBeDroppedIndexElms, n.DropBehavior)
		...
		maybeDropDependentFKConstraints(b, toBeDroppedIndexElms, n.DropBehavior)
		...
		maybeDropAdditionallyForShardedIndex(b, toBeDroppedIndexElms, n.DropBehavior)
...
func maybeDropDependentViews(
	...
	if sie == nil || sine == nil {
		panic(errors.AssertionFailedf("programming error: invalid input 'toBeDroppedSecondaryIndexElms'; " +
			"it does not contain a secondary index element."))
	}
...
func maybeDropDependentFKConstraints(
	...
	scpb.ForEachForeignKeyConstraint(b.BackReferences(sie.TableID), func(
...
func maybeDropAdditionallyForShardedIndex(
	...
	scpb.ForEachCheckConstraint(b.QueryByID(sie.TableID), func(
