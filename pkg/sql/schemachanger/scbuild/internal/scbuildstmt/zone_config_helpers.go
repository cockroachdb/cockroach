...
var _ zoneconfig.MultiRegionTableValidatorData = (*multiRegionTableValidatorData)(nil)
...
func validateZoneConfigForMultiRegionTable(
	...
	reader := multiRegionTableValidatorData{
		b:            b,
		tableID:      tableID,
		regionConfig: regionConfig,
	}

	return zoneconfig.ValidateZoneConfigForMultiRegionTable(
		tree.Name(tableName),
		currentZoneConfig,
		expectedZoneConfig,
		&reader,
