...
// getAffectedSubzoneSpansWithIdx groups each subzone span by their subzoneIdxs
...
func getAffectedSubzoneSpansWithIdx(
	...
	idxToSpans := make(map[int32][]zonepb.SubzoneSpan, subzonesSlice)
	for i := range subzonesSlice {
