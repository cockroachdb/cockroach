...
func AlterTable(ctx context.Context, b BuildCtx, n *tree.AlterTable) {
	...
	_, tbl := b.ResolveTable(ctx, n.Table, ResolveParams{
	...
	for _, cmd := range n.Cmds {
		alterTableCmd(ctx, b, tbl, cmd, &tn)
...
func alterTableCmd(
	...
	case *tree.AlterTableAddColumn:
		alterTableAddColumn(ctx, b, table, t, tn)
	default:
