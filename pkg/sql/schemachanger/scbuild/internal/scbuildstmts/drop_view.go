...
func DropView(ctx context.Context, b BuildCtx, n *tree.DropView) {
	for _, name := range n.Names {
		_, view := b.ResolveView(ctx, name.ToUnresolvedObjectName(), ResolveParams{
...
func dropView(
	ctx context.Context, b BuildCtx, view catalog.TableDescriptor, behavior tree.DropBehavior,
) {
