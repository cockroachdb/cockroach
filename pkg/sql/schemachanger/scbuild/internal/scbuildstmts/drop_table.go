...
func DropTable(ctx context.Context, b BuildCtx, n *tree.DropTable) {
	// Find the table first.
	for _, name := range n.Names {
		_, tbl := b.ResolveTable(ctx, name.ToUnresolvedObjectName(), ResolveParams{
...
func dropTable(
	ctx context.Context, b BuildCtx, tbl catalog.TableDescriptor, behavior tree.DropBehavior,
) {
	{
...
func maybeCleanTableSequenceRefs(
	ctx context.Context, b BuildCtx, table catalog.TableDescriptor, behavior tree.DropBehavior,
) {
