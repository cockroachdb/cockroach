...
func DropSequence(ctx context.Context, b BuildCtx, n *tree.DropSequence) {
	for _, name := range n.Names {
		_, seq := b.ResolveSequence(ctx, name.ToUnresolvedObjectName(), ResolveParams{
...
func dropSequence(
	ctx context.Context, b BuildCtx, seq catalog.TableDescriptor, cascade tree.DropBehavior,
) {
