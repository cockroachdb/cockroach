...
func removeTypeBackRefDeps(
	ctx context.Context, b scbuildctx.BuildCtx, table catalog.TableDescriptor,
) {
...
func removeColumnTypeBackRefs(
	b scbuildctx.BuildCtx, table catalog.TableDescriptor, id descpb.ColumnID,
) {
