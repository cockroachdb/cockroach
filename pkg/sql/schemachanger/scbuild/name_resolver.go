...
var _ scbuildstmts.NameResolver = buildCtx{}

// ResolveDatabase implements the scbuildstmts.NameResolver interface.
func (b buildCtx) ResolveDatabase(
	ctx context.Context, name tree.Name, p scbuildstmts.ResolveParams,
...
// ResolveSchema implements the scbuildstmts.NameResolver interface.
func (b buildCtx) ResolveSchema(
	ctx context.Context, name tree.ObjectNamePrefix, p scbuildstmts.ResolveParams,
...
// ResolveType implements the scbuildstmts.NameResolver interface.
func (b buildCtx) ResolveType(
	ctx context.Context, name *tree.UnresolvedObjectName, p scbuildstmts.ResolveParams,
...
// ResolveRelation implements the scbuildstmts.NameResolver interface.
...
// ResolveTable implements the scbuildstmts.NameResolver interface.
...
// ResolveSequence implements the scbuildstmts.NameResolver interface.
...
// ResolveView implements the scbuildstmts.NameResolver interface.
...
// ResolveIndex implements the scbuildstmts.NameResolver interface.
func (b buildCtx) ResolveIndex(
	ctx context.Context,
	relationName *tree.UnresolvedObjectName,
	indexName tree.Name,
	p scbuildstmts.ResolveParams,
) (catalog.ResolvedObjectPrefix, catalog.TableDescriptor, catalog.Index) {
	prefix, rel := b.ResolveRelation(ctx, relationName, scbuildstmts.ResolveParams{
