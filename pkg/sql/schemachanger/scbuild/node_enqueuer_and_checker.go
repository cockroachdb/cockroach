...
var _ scbuildctx.NodeEnqueuerAndChecker = buildCtx{}

// HasNode implements the NodeEnqueuerAndChecker interface.
...
// HasTarget implements the NodeEnqueuerAndChecker interface.
...
// HasElement implements the NodeEnqueuerAndChecker interface.
...
// EnqueueAdd implements the NodeEnqueuerAndChecker interface.
func (b buildCtx) EnqueueAdd(elem scpb.Element) {
	b.AddNode(scpb.Target_ADD, elem)
}

// EnqueueDrop implements the NodeEnqueuerAndChecker interface.
func (b buildCtx) EnqueueDrop(elem scpb.Element) {
	b.AddNode(scpb.Target_DROP, elem)
}

// EnqueueDropIfNotExists implements the NodeEnqueuerAndChecker interface.
