...
var _ scbuildstmts.NodeEnqueuerAndChecker = buildCtx{}

// HasNode implements the scbuildstmts.NodeEnqueuerAndChecker interface.
...
// HasTarget implements the scbuildstmts.NodeEnqueuerAndChecker interface.
...
// HasElement implements the scbuildstmts.NodeEnqueuerAndChecker interface.
...
// EnqueueAdd implements the scbuildstmts.NodeEnqueuerAndChecker interface.
func (b buildCtx) EnqueueAdd(elem scpb.Element) {
	b.AddNode(scpb.Target_ADD, elem)
}

// EnqueueDrop implements the scbuildstmts.NodeEnqueuerAndChecker interface.
func (b buildCtx) EnqueueDrop(elem scpb.Element) {
	b.AddNode(scpb.Target_DROP, elem)
}

// EnqueueDropIfNotExists implements the scbuildstmts.NodeEnqueuerAndChecker
// interface.
