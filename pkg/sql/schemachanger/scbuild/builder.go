...
func (b *BuildContext) Build(ctx context.Context, n tree.Statement) (err error) {
	defer func() {
...
// GetOutputNodes returns the output nodes.
func (b *BuildContext) GetOutputNodes() []*scpb.Node {
	return b.outputNodes
}
