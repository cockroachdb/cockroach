...
var (
	...
	SequenceDependencyElement   = GetElementType((*SequenceDependency)(nil))
	UniqueConstraintElement     = GetElementType((*UniqueConstraint)(nil))
	CheckConstraintElement      = GetElementType((*CheckConstraint)(nil))
	SequenceElement             = GetElementType((*Sequence)(nil))
	DefaultExpressionElement    = GetElementType((*DefaultExpression)(nil))
	ViewElement                 = GetElementType((*View)(nil))
	TypeRefElement              = GetElementType((*TypeReference)(nil))
	TableElement                = GetElementType((*Table)(nil))
	OutForeignKeyElement        = GetElementType((*OutboundForeignKey)(nil))
	InForeignKeyElement         = GetElementType((*InboundForeignKey)(nil))
	RelationDependedOnByElement = GetElementType((*RelationDependedOnBy)(nil))
	SequenceOwnerElement        = GetElementType((*SequenceOwnedBy)(nil))
	TypeElement                 = GetElementType((*Type)(nil))
	SchemaElement               = GetElementType((*Schema)(nil))
	DatabaseElement             = GetElementType((*Database)(nil))
