...
const (
	...
	InvalidTarget = TargetStatus(Status_UNKNOWN)
	...
	ToAbsent = TargetStatus(Status_ABSENT)
	...
	ToPublic = TargetStatus(Status_PUBLIC)
	...
	Transient = TargetStatus(Status_TRANSIENT_ABSENT)
)
