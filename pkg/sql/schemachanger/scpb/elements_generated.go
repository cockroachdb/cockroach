...
func ForEachColumnOnUpdateExpression(
	b ElementStatusIterator,
	fn func(current Status, target TargetStatus, e *ColumnOnUpdateExpression),
) {
	if b == nil {
		return
	}
...
func FindConstraintName(
	b ElementStatusIterator,
) (current Status, target TargetStatus, element *ConstraintName) {
	if b == nil {
		return current, target, element
	}
	b.ForEachElementStatus(func(c Status, t TargetStatus, e Element) {
...
func FindObjectParent(
	b ElementStatusIterator,
) (current Status, target TargetStatus, element *ObjectParent) {
	if b == nil {
		return current, target, element
	}
	b.ForEachElementStatus(func(c Status, t TargetStatus, e Element) {
...
func ForEachOwner(b ElementStatusIterator, fn func(current Status, target TargetStatus, e *Owner)) {
	if b == nil {
		return
	}
	b.ForEachElementStatus(func(current Status, target TargetStatus, e Element) {
...
func ForEachTable(b ElementStatusIterator, fn func(current Status, target TargetStatus, e *Table)) {
	if b == nil {
		return
	}
	b.ForEachElementStatus(func(current Status, target TargetStatus, e Element) {
...
func ForEachTableLocalityPrimaryRegion(
	b ElementStatusIterator,
	fn func(current Status, target TargetStatus, e *TableLocalityPrimaryRegion),
) {
	if b == nil {
		return
	}
...
func ForEachTableLocalityRegionalByRow(
	b ElementStatusIterator,
	fn func(current Status, target TargetStatus, e *TableLocalityRegionalByRow),
) {
	if b == nil {
		return
	}
...
func ForEachTableLocalitySecondaryRegion(
	b ElementStatusIterator,
	fn func(current Status, target TargetStatus, e *TableLocalitySecondaryRegion),
) {
	if b == nil {
		return
	}
...
func ForEachUniqueWithoutIndexConstraint(
	b ElementStatusIterator,
	fn func(current Status, target TargetStatus, e *UniqueWithoutIndexConstraint),
) {
	if b == nil {
		return
	}
...
func ForEachView(b ElementStatusIterator, fn func(current Status, target TargetStatus, e *View)) {
	if b == nil {
		return
	}
	b.ForEachElementStatus(func(current Status, target TargetStatus, e Element) {
