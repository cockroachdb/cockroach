...
func TestSchemaChangeWaitsForOtherSchemaChanges(t *testing.T) {
	...
	t.Run("wait for legacy schema changes", func(t *testing.T) {
		...
		tdb.CheckQueryResults(t,
			...
			[][]string{
				{jobspb.TypeSchemaChange.String(), string(jobs.StatusSucceeded), "updating version for users table"},
				{jobspb.TypeSchemaChange.String(), string(jobs.StatusSucceeded), "updating version for role options table"},
				{jobspb.TypeSchemaChange.String(), string(jobs.StatusSucceeded), "updating version for users table"},
				{jobspb.TypeSchemaChange.String(), string(jobs.StatusSucceeded), "updating version for role options table"},
				{jobspb.TypeSchemaChange.String(), string(jobs.StatusSucceeded), "updating version for users table"},
				{jobspb.TypeSchemaChange.String(), string(jobs.StatusSucceeded), "updating version for role options table"},
