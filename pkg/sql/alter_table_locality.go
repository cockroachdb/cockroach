...
func (n *alterTableSetLocalityNode) alterTableLocalityRegionalByTableToGlobal(
	...
	if err := assertCorrectTablePattern(
	...
	tableName := tree.MakeTableName(tree.Name(desc.Name), tree.Name(n.tableDesc.GetName()))
...
func (n *alterTableSetLocalityNode) startExec(params runParams) error {
	...
	case *descpb.TableDescriptor_LocalityConfig_Global_:
		...
		case tree.LocalityLevelTable:
			if err = n.alterTableLocalityGlobalToRegionalByTable(params, desc); err != nil {
				return err
			}
		default:
