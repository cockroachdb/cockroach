...
// spooled) during the start phase. This is currently implemented
// by all mutation statements except for upsert.
...
// planNodeSpool is implemented by nodes that can perform all their
