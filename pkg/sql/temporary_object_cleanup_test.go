...
func TestTempTablesDeletionJob(t *testing.T) {
	defer leaktest.AfterTest(t)()

	knobs := base.TestingKnobs{
		SQLExecutor: &ExecutorTestingKnobs{
			DisableTempTableCleanupOnSessionExit: true,
			TempTableCleanupInterval:             time.Second,
		},
	}
	...
	// DisableTempTableCleanupOnSessionExit testing knob.
