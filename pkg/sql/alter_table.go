...
func applyColumnMutation(
	...
	case *tree.AlterTableSetDefault:
		...
		if t.Default == nil {
			...
			var s string
			defaultExpr, s, err = sanitizeColumnExpression(params, t.Default, col, "DEFAULT")
			if err != nil {
				return err
			}
		...
		if col.HasOnUpdate() {
			...
			onUpdateExpr, _, err = sanitizeColumnExpression(params, untypedOnUpdateExpr, col, "ON UPDATE")
			if err != nil {
				return err
			}
		}
	...
	case *tree.AlterTableSetOnUpdate:
		...
		if t.Expr == nil {
			...
			var s string
			onUpdateExpr, s, err = sanitizeColumnExpression(params, t.Expr, col, "ON UPDATE")
			if err != nil {
				return err
			}
		...
		if col.HasDefault() {
			...
			defaultExpr, _, err = sanitizeColumnExpression(
				params,
				untypedDefaultExpr,
				col,
				"DEFAULT",
