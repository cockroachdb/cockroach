...
type instrumentationHelper struct {
	...
	generic bool
	// reoptimized is true if the plan was optimized or re-optimized during the
	// current execution.
	reoptimized bool
...
func (ih *instrumentationHelper) PlanForStats(ctx context.Context) *appstatspb.ExplainTreePlanNode {
	...
	ob.AddPlanType(ih.generic, ih.reoptimized)
