...
func (p *planner) maybeLogStatementInternal(
	...
	if telemetryLoggingEnabled {
		...
		// sampled.
		// TODO(esr): add the effective sample rate to the SampledQuery event. Reference: https://github.com/cockroachdb/cockroach/issues/69653
		if !shouldSampleEventToTelemetry {
			...
			// TODO(esr): event has not been sampled, increment the not emitted count. Reference: https://github.com/cockroachdb/cockroach/issues/69653
		}
	}
}
