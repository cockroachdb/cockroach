...
var varGen = map[string]sessionVar{
	...
	`client_min_messages`: makeConstantStringVar(`client_min_messages`, `notice`, `debug5`, `debug4`, `debug3`, `debug2`, `debug1`, `debug`, `log`, `warning`, `error`, `fatal`, `panic`),

	// Supported for PG compatibility only.
	// See https://www.postgresql.org/docs/9.6/static/multibyte.html
	// Also aliased to SET NAMES.
	`client_encoding`: makeConstantStringVar(`client_encoding`, "UTF8", "utf-8", "unicode", "cp65001"),

	// Supported for PG compatibility only.
	// See https://www.postgresql.org/docs/9.6/static/multibyte.html
	`server_encoding`: makeConstantStringVar(`server_encoding`, "UTF8", "utf-8", "unicode", "cp65001"),
	...
	`datestyle`: makeConstantStringVar(`DateStyle`, "ISO"),
	...
	`intervalstyle`: makeConstantStringVar(`IntervalStyle`, "postgres"),
	...
	`standard_conforming_strings`: makeConstantStringVar(`standard_conforming_strings`, "on"),
...
func makeConstantStringVar(varName, displayValue string, extraAllowed ...string) sessionVar {
	...
	return sessionVar{
		...
		Set: func(
			...
			return newVarValueError(varName, s, allowedVals...)
		},
