...
func (*traceNode) Columns() sqlbase.ResultColumns { return traceColumnsWithTS }
func (*traceNode) Ordering() orderingInfo         { return orderingInfo{} }
func (*traceNode) MarkDebug(_ explainMode)        {}
func (*traceNode) DebugValues() debugValues       { return debugValues{} }

func (n *traceNode) Spans(ctx context.Context) (_, _ roachpb.Spans, _ error) {
