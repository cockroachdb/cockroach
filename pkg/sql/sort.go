...
func (n *sortNode) Start(params nextParams) error {
	return n.plan.Start(params)
}

func (n *sortNode) Next(params nextParams) (bool, error) {
...
func (ss *sortAllStrategy) Next(params nextParams) (bool, error) {
...
func (ss *iterativeSortStrategy) Next(nextParams) (bool, error) {
	if ss.vNode.Len() == 0 {
		return false, nil
	}
...
func (ss *sortTopKStrategy) Next(params nextParams) (bool, error) {
	return ss.vNode.Next(params)
}
