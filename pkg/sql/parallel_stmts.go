...
type DependencyAnalyzer interface {
	...
	// independence decisions about the planNode. It should be called before
	// calling Independent for each planNode, and the planNode provided should
	...
	// so it will not modify the plans in any way. Implementations of
