...
func TestSqlExecLog(t *testing.T) {
	...
	t.Run("verify error codes", func(t *testing.T) {
		...
		require.Equal(t, string(logs[1].ErrorText), "query execution canceled due to statement timeout")
	})
}
