...
func (BytesEncodeFormat) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_session_data_5d0d83c5d6ef22b6, []int{0}
}
...
const (
	...
	// Vectorize201Auto means that queries only with streaming operators are run
	// using the columnar execution. This was the default in 20.1.
	//
...
func (VectorizeExecMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_session_data_5d0d83c5d6ef22b6, []int{1}
}
...
func (*SequenceState) Descriptor() ([]byte, []int) {
	return fileDescriptor_session_data_5d0d83c5d6ef22b6, []int{2}
}
...
func (*SequenceState_Seq) Descriptor() ([]byte, []int) {
	return fileDescriptor_session_data_5d0d83c5d6ef22b6, []int{2, 0}
}
...
func init() {
	proto.RegisterFile("sql/sessiondatapb/session_data.proto", fileDescriptor_session_data_5d0d83c5d6ef22b6)
}

var fileDescriptor_session_data_5d0d83c5d6ef22b6 = []byte{
