...
func (ds *ServerImpl) setupFlow(
	...
	f := newFlow(
		flowCtx, ds.flowRegistry, syncFlowConsumer, localState.LocalProcs,
		isVectorized, onFlowCleanup, req.StatementSQL,
	)
...
func newFlow(
	...
	base := flowinfra.NewFlowBase(flowCtx, flowReg, syncFlowConsumer, localProcessors, onFlowCleanup, statementSQL)
	if isVectorized {
