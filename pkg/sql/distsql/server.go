...
func (ds *ServerImpl) setupFlow(
	...
	f := newFlow(
		...
		localState.LocalProcs, isVectorized, onFlowCleanup, req.Stmt,
	)
...
func newFlow(
	...
	base := flowinfra.NewFlowBase(flowCtx, flowReg, rowSyncFlowConsumer, batchSyncFlowConsumer, localProcessors, onFlowCleanup, stmt)
	if isVectorized {
