...
func TestPlanDiagram(t *testing.T) {
	...
	expected := `
		{"nodeNames":["1","2","3"],
			"processors":[
				{"nodeIdx":0,"inputs":[],"core":{"title":"TableReader","lines":["SomeIndex@Table","0,1"]},"outputs":[]},
				{"nodeIdx":1,"inputs":[],"core":{"title":"TableReader","lines":["SomeIndex@Table","0,1"]},"outputs":[]},
				{"nodeIdx":2,"inputs":[],"core":{"title":"TableReader","lines":["SomeIndex@Table","0,1"]},"outputs":[]},
				{"nodeIdx":2,"inputs":[{"title":"ordered","lines":["1+"]}],"core":{"title":"JoinReader","lines":["primary@Table","2","$0+$1\u003c$2"]},"outputs":[]},
				{"nodeIdx":2,"inputs":[],"core":{"title":"Response","lines":[]},"outputs":[]}
			],
			"edges":[
	...
	expected := `
		{
			"nodeNames":["1","2","3","4"],
			"processors":[
				{"nodeIdx":0,"inputs":[],"core":{"title":"TableReader","lines":["primary@TableA","0,1,3"]},"outputs":[{"title":"by hash","lines":["0,1"]}]},
				{"nodeIdx":1,"inputs":[],"core":{"title":"TableReader","lines":["primary@TableA","0,1,3"]},"outputs":[{"title":"by hash","lines":["0,1"]}]},
				{"nodeIdx":1,"inputs":[{"title":"unordered","lines":[]},{"title":"unordered","lines":[]}],"core":{"title":"HashJoiner","lines":["ON left(0,2)=right(2,1)","0,1,2,3,4,5","$0+$1\u003c$5"]},"outputs":[]},
				{"nodeIdx":1,"inputs":[{"title":"unordered","lines":[]}],"core":{"title":"No-op","lines":[]},"outputs":[]},
				{"nodeIdx":2,"inputs":[],"core":{"title":"TableReader","lines":["primary@TableA","0,1,3"]},"outputs":[{"title":"by hash","lines":["0,1"]}]},
				{"nodeIdx":2,"inputs":[],"core":{"title":"TableReader","lines":["primary@TableB","1,2,4"]},"outputs":[{"title":"by hash","lines":["2,1"]}]},
				{"nodeIdx":2,"inputs":[{"title":"unordered","lines":[]},{"title":"unordered","lines":[]}],"core":{"title":"HashJoiner","lines":["ON left(0,2)=right(2,1)","0,1,2,3,4,5","$0+$1\u003c$5"]},"outputs":[]},
				{"nodeIdx":3,"inputs":[],"core":{"title":"TableReader","lines":["primary@TableB","1,2,4"]},"outputs":[{"title":"by hash","lines":["2,1"]}]},
				{"nodeIdx":1,"inputs":[],"core":{"title":"Response","lines":[]},"outputs":[]}
			],
			"edges":[
