...
type MailboxSpec struct {
	...
	SyncResponse bool `protobuf:"varint,1,opt,name=sync_response,json=syncResponse" json:"sync_response"`
	// Serving address for the target host, used for outgoing mailboxes.
	TargetAddr string `protobuf:"bytes,2,opt,name=target_addr,json=targetAddr" json:"target_addr"`
}
...
type StreamEndpointSpec struct {
	...
	StreamID StreamID `protobuf:"varint,1,opt,name=stream_id,json=streamId,casttype=StreamID" json:"stream_id"`
...
var fileDescriptorData = []byte{
	...
	,
}
