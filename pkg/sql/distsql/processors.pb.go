...
type DistinctSpec struct {
	...
	OrderedColumns []bool `protobuf:"varint,1,rep,name=ordered_columns,json=orderedColumns" json:"ordered_columns,omitempty"`
}
...
func (m *DistinctSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.OrderedColumns) > 0 {
		for _, b := range m.OrderedColumns {
			dAtA[i] = 0x8
			i++
			if b {
				dAtA[i] = 1
...
func (m *DistinctSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.OrderedColumns = append(m.OrderedColumns, bool(v != 0))
		default:
			iNdEx = preIndex
			skippy, err := skipProcessors(dAtA[iNdEx:])
			if err != nil {
...
var fileDescriptorProcessors = []byte{
	...
	,
}
