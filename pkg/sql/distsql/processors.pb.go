...
type DistinctSpec struct {
	...
	// Ordered columns, the columns the input is already sorted by, can be
	// optionally specified for possible optimizations taking advantage of the
	// partial orderings.
	OrderedCols []uint32 `protobuf:"varint,2,rep,name=ordered_cols,json=orderedCols" json:"ordered_cols,omitempty"`
}
...
func (m *DistinctSpec) MarshalTo(data []byte) (int, error) {
	...
	if len(m.OrderedCols) > 0 {
		for _, num := range m.OrderedCols {
			data[i] = 0x10
			i++
			i = encodeVarintProcessors(data, i, uint64(num))
		}
...
func (m *DistinctSpec) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field OrderedCols", wireType)
			}
			var v uint32
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OrderedCols = append(m.OrderedCols, v)
		default:
			iNdEx = preIndex
			skippy, err := skipProcessors(data[iNdEx:])
			if err != nil {
...
var fileDescriptorProcessors = []byte{
	...
	,
}
