...
func (n *createDatabaseNode) Next(_ context.Context) (bool, error) { return false, nil }
func (n *createDatabaseNode) Close(_ context.Context)              {}
...
func (n *createIndexNode) Next(_ context.Context) (bool, error) { return false, nil }
func (n *createIndexNode) Close(_ context.Context)              {}
...
func (n *createUserNode) Next(_ context.Context) (bool, error) { return false, nil }
func (n *createUserNode) Close(_ context.Context)              {}
...
func (n *createViewNode) Next(_ context.Context) (bool, error) { return false, nil }
...
func (n *createTableNode) Start(ctx context.Context) error {
	...
	if n.n.As() {
		...
		insertPlan, err := n.p.Insert(ctx, insert, nil, false)
		if err != nil {
			return err
		}
...
func (n *createTableNode) Next(_ context.Context) (bool, error) { return false, nil }
