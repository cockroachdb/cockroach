...
func (*createDatabaseNode) Spans(context.Context) (reads, writes roachpb.Spans) {
	panic("unimplemented")
}
...
func (*createIndexNode) Spans(context.Context) (reads, writes roachpb.Spans) {
	panic("unimplemented")
}
...
func (*createUserNode) Spans(context.Context) (_, _ roachpb.Spans) { panic("unimplemented") }
...
func (*createViewNode) Spans(context.Context) (_, _ roachpb.Spans) { panic("unimplemented") }
...
func (*createTableNode) Spans(context.Context) (_, _ roachpb.Spans) { panic("unimplemented") }
