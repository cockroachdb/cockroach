...
// necessarily equal on all columns. A case of this is when we have a unique
// index on the columns in S.
//
...
// the ordering a+,b+ and the key flag tells us that this satisfies any
// desired ordering that has a+,b+ as a prefix (such as a+,b+,c-,d+).
//
