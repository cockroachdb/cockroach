...
func TestTriggerCaseSensitivity(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			shouldFail: false, // Trigger should succeed because NEW.last_modified exists.
		},
		{
			...
			shouldFail: true, // Trigger shouldn't succeed because NEW.LAST_MODIFIED doesn't exist.
		},
	}
