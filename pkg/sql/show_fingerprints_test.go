...
func TestShowTenantFingerprintsProtectsTimestamp(t *testing.T) {
	...
	systemSQL.Exec(t, "SET CLUSTER SETTING kv.closed_timestamp.target_duration = '10ms'")
	systemSQL.Exec(t, "SET CLUSTER SETTING kv.closed_timestamp.side_transport_interval ='10ms'")
	systemSQL.Exec(t, "SET CLUSTER SETTING kv.rangefeed.closed_timestamp_refresh_interval ='10ms'")
