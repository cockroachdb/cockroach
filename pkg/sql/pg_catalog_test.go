...
const (
	...
	virtualTableTempl        = `var %s = virtualSchemaTable{
	comment: "%s was created for compatibility",
	schema:  vtable.%s,
...
// constantName create constant names for pg_catalog fixableTables following constant names standards
...
func formatColumn(sb *strings.Builder, prefix, columnName string, columnType *PGCatalogColumn) {
