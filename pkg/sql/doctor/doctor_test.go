	...
	tests := []struct {
		...
		},
		{
			descTable: doctor.DescriptorTable{
				{
					ID: 1,
					DescBytes: toBytes(&descpb.Descriptor{&descpb.Descriptor_Table{
						&descpb.TableDescriptor{ID: 2},
					}}),
				},
			},
			expected: `Examining 1 descriptors and 0 namespace entries...
			...
			descTable: doctor.DescriptorTable{
				{
					ID: 1,
					DescBytes: toBytes(&descpb.Descriptor{&descpb.Descriptor_Table{
						&descpb.TableDescriptor{Name: "foo", ID: 1, State: descpb.DescriptorState_DROP},
					}}),
				},
			},
			expected: `Examining 1 descriptors and 0 namespace entries...
			...
			descTable: doctor.DescriptorTable{
				{
					ID: 1,
					DescBytes: toBytes(&descpb.Descriptor{&descpb.Descriptor_Table{
						&descpb.TableDescriptor{Name: "foo", ID: 1},
					}}),
				},
			},
			namespaceTable: doctor.NamespaceTable{
...
`,
		},
		{
			descTable: doctor.DescriptorTable{
				{
					ID: 1,
					DescBytes: toBytes(&descpb.Descriptor{&descpb.Descriptor_Database{
						&descpb.DatabaseDescriptor{Name: "db", ID: 1},
					}}),
				},
			},
			expected: `Examining 1 descriptors and 0 namespace entries...
		...
		},
		{
			descTable: doctor.DescriptorTable{
				...
				},
				{
					ID: 2,
					DescBytes: toBytes(&descpb.Descriptor{&descpb.Descriptor_Database{
						&descpb.DatabaseDescriptor{Name: "db", ID: 2},
					}}),
				},
			},
			namespaceTable: doctor.NamespaceTable{
...
`,
		},
		{
			descTable: doctor.DescriptorTable{
				{
					ID: 1,
					DescBytes: toBytes(&descpb.Descriptor{&descpb.Descriptor_Schema{
						&descpb.SchemaDescriptor{Name: "schema", ID: 1, ParentID: 2},
					}}),
				},
			},
			namespaceTable: doctor.NamespaceTable{
			...
			expected: `Examining 1 descriptors and 1 namespace entries...
  Schema   1: ParentID   2, ParentSchemaID  0, Name 'schema': invalid parent id
`,
		},
		{
			descTable: doctor.DescriptorTable{
				{
					ID: 1,
					DescBytes: toBytes(&descpb.Descriptor{&descpb.Descriptor_Type{
						&descpb.TypeDescriptor{Name: "type", ID: 1, ParentSchemaID: 2},
					}}),
				},
			},
			namespaceTable: doctor.NamespaceTable{
			...
			expected: `Examining 1 descriptors and 1 namespace entries...
    Type   1: ParentID   0, ParentSchemaID  2, Name 'type': invalid parent schema id
`,
		},
		{
			namespaceTable: doctor.NamespaceTable{
...
`,
	...
	for i, test := range tests {
		...
		valid, err := doctor.Examine(test.descTable, test.namespaceTable, false, &buf)
