...
func (p *planner) checkCanDropSystemDatabaseRegion(
	ctx context.Context, region tree.Name, physicalRegion []byte,
) error {
...
func (n *alterDatabaseDropRegionNode) startExec(params runParams) error {
	...
	if n.desc.GetID() == keys.SystemDatabaseID {
		if err := params.p.checkCanDropSystemDatabaseRegion(params.ctx, n.n.Region, physicalRegionRep); err != nil {
			return err
		}
