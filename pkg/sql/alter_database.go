...
func (p *planner) AlterDatabaseSetZoneConfigExtension(
	...
	options, err := p.getUpdatedZoneConfigOptions(ctx, n.ZoneConfigSettings, "database")
	if err != nil {
		return nil, err
	}

	if n.ZoneConfigSettings != nil && n.ZoneConfigSettings.SetDefault {
...
func (n *alterDatabaseSetZoneConfigExtensionNode) startExec(params runParams) error {
	...
	if deleteZone {
		...
		info = &eventpb.SetZoneConfigExtension{CommonZoneConfigDetails: eventDetails}
	}
