...
type alterTenantServiceNode struct {
	...
	newMode    descpb.TenantServiceMode
}
...
func (p *planner) alterTenantService(
	...
	var newMode descpb.TenantServiceMode
	switch n.Command {
	case tree.TenantStopService:
		newMode = descpb.ServiceModeNone
	case tree.TenantStartServiceExternal:
		newMode = descpb.ServiceModeExternal
	case tree.TenantStartServiceShared:
		newMode = descpb.ServiceModeShared
	default:
