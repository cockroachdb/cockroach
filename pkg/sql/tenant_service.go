...
type alterTenantServiceNode struct {
	...
	newMode    descpb.TenantInfo_ServiceMode
}
...
func (p *planner) alterTenantService(
	...
	var newMode descpb.TenantInfo_ServiceMode
	switch n.Command {
	case tree.TenantStopService:
		newMode = descpb.TenantInfo_NONE
	case tree.TenantStartServiceExternal:
		newMode = descpb.TenantInfo_EXTERNAL
	case tree.TenantStartServiceShared:
		newMode = descpb.TenantInfo_SHARED
	default:
