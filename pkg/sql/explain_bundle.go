...
func buildStatementBundle(
	...
	if plan == nil {
		return diagnosticsBundle{collectionErr: errors.AssertionFailedf("execution terminated early")}, nil
	}
	...
	buf, err := b.finalize()
	if err != nil {
		return diagnosticsBundle{collectionErr: err, errorStrings: b.errorStrings}, nil
	}
	return diagnosticsBundle{zip: buf.Bytes(), errorStrings: b.errorStrings}, nil
}
