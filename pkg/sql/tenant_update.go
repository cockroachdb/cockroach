...
func UpdateTenantRecord(
	ctx context.Context, settings *cluster.Settings, txn isql.Txn, info *mtinfopb.ExtendedTenantInfo,
) error {
...
func validateTenantInfo(
	ctx context.Context, settings *cluster.Settings, info *mtinfopb.ExtendedTenantInfo,
) error {
...
func (p *planner) setTenantService(
	ctx context.Context, info *mtinfopb.ExtendedTenantInfo, newMode mtinfopb.TenantServiceMode,
) error {
...
func (p *planner) renameTenant(
	ctx context.Context, info *mtinfopb.ExtendedTenantInfo, newName roachpb.TenantName,
) error {
	if p.EvalContext().TxnReadOnly {
