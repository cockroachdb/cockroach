...
func (n *setZoneConfigNode) startExec(params runParams) error {
	...
	applyZoneConfig := func(zs tree.ZoneSpecifier) error {
		...
		eventDetails := eventpb.ZoneConfigDetails{
		...
		if deleteZone {
			info = &eventpb.RemoveZoneConfig{ZoneConfigDetails: eventDetails}
		} else {
			info = &eventpb.SetZoneConfig{ZoneConfigDetails: eventDetails}
		}
