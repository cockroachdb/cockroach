...
func (p *planner) getUpdatedZoneConfigYamlConfig(
	...
	if n.GetYAMLConfig() != nil {
		...
		yamlConfig, err = p.analyzeExpr(
			ctx, n.GetYAMLConfig(), nil, tree.IndexedVarHelper{}, types.String, false /*requireType*/, "configure zone")
		if err != nil {
			return nil, err
		}
...
func (p *planner) SetZoneConfig(ctx context.Context, n *tree.SetZoneConfig) (planNode, error) {
	...
	options, err := p.getUpdatedZoneConfigOptions(ctx, n, n.ZoneSpecifier.TelemetryName())
	if err != nil {
		return nil, err
	}
