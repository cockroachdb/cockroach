	...
	datadriven.Walk(t, "testdata/telemetry", func(t *testing.T, path string) {
		...
		t.Run("server", func(t *testing.T) {
			datadriven.RunTest(t, path, func(t *testing.T, td *datadriven.TestData) string {
				...
				statsController := test.server.SQLServer().(*sql.Server).GetSQLStatsProvider()
		...
		if testTenant {
			...
			t.Run("tenant", func(t *testing.T) {
				datadriven.RunTest(t, path, func(t *testing.T, td *datadriven.TestData) string {
					...
					statsController := test.tenant.SQLServer().(*sql.Server).GetSQLStatsProvider()
...
func (tt *telemetryTest) RunTest(
	...
	statsController *sssystem.SQLStats,
) (out string) {
	defer func() {
		if out == "" {
			return
	...
	case "sql-stats":
		...
		if err := statsController.ResetLocalStats(ctx); err != nil {
