...
func (n *dropIndexNode) Start(params runParams) error {
	...
	for _, index := range n.idxNames {
		...
		if err := params.p.dropIndexByName(
			ctx, index.idxName, tableDesc, n.n.IfExists, n.n.DropBehavior, checkOutboudFK,
...
// This is used e.g. when the the element constrained be being dropped anyway.
type dropIdxFKCheck bool

const (
	checkOutboudFK   dropIdxFKCheck = true
