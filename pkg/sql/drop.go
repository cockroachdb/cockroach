...
func (*dropDatabaseNode) Spans(context.Context) (_, _ roachpb.Spans) { panic("unimplemented") }
...
func (*dropIndexNode) Spans(context.Context) (_, _ roachpb.Spans) { panic("unimplemented") }
...
func (*dropViewNode) Spans(context.Context) (_, _ roachpb.Spans) { panic("unimplemented") }
...
func (*dropTableNode) Spans(context.Context) (_, _ roachpb.Spans) { panic("unimplemented") }
