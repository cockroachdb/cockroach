...
func TestSampledStatsCollection(t *testing.T) {
	...
	t.Run("ExplicitTxn", func(t *testing.T) {
		...
		require.Greater(t, aggStats.mu.data.MaxMemUsage.Mean, float64(0), "expected statement to have requested bytes")
		...
		require.Greater(t, selectStats.mu.data.MaxMemUsage.Mean, float64(0), "expected statement to have requested bytes")
