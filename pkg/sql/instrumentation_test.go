...
func TestSampledStatsCollection(t *testing.T) {
	...
	t.Run("ImplicitTxn", func(t *testing.T) {
		...
		stats, _ := getStmtStats(t, s, selectOrderBy, true /* implicitTxn */, "test")
	...
	t.Run("ExplicitTxn", func(t *testing.T) {
		...
		aggStats, aggID := getStmtStats(t, s, aggregation, false /* implicitTxn */, "test")
		selectStats, selectID := getStmtStats(t, s, selectOrderBy, false /* implicitTxn */, "test")
