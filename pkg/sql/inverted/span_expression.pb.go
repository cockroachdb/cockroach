...
func (SetOperator) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_span_expression_7887e0e70d35c4bc, []int{0}
}
...
func (*SpanExpressionProto_Span) Descriptor() ([]byte, []int) {
	return fileDescriptor_span_expression_7887e0e70d35c4bc, []int{0, 0}
}
...
func (*SpanExpressionProto_Node) Descriptor() ([]byte, []int) {
	return fileDescriptor_span_expression_7887e0e70d35c4bc, []int{0, 1}
}
...
func init() {
	proto.RegisterFile("sql/inverted/span_expression.proto", fileDescriptor_span_expression_7887e0e70d35c4bc)
}

var fileDescriptor_span_expression_7887e0e70d35c4bc = []byte{
