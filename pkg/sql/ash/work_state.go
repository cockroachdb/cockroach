...
//
// The returned cleanup function is ClearWorkState, which uses goid.Get()
// to determine the caller's goroutine ID rather than capturing it in a
// closure. This avoids a heap allocation on every call.
//
// Example usage:
//
