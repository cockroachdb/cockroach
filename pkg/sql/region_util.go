...
func zoneConfigFromTableLocalityConfig(
	...
	case *descpb.TableDescriptor_LocalityConfig_Global_:
		...
		// Technically, we do not need to run any zone config changes here at all
		// (the outer loop can return early). However, it is much easier to think about state
		// if we force an entry into system.zones even for global configurations.
	...
	case *descpb.TableDescriptor_LocalityConfig_RegionalByRow_:
		...
		// exercise other functionality (i.e. SHOW) passes.
	}
	return &ret, nil
}
