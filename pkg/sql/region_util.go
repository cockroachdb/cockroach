...
func zoneConfigForMultiRegionPartition(
	...
	addConstraintsForSuperRegion(partitionRegion, regions, zc, numReplicas, regionConfig)
...
func zoneConfigForMultiRegionTable(
	...
	case *catpb.LocalityConfig_RegionalByTable_:
		...
		addConstraintsForSuperRegion(primaryRegion, regions, ret, numReplicas, regionConfig)
