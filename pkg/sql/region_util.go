...
func zoneConfigForMultiRegionDatabase(
	...
	return regionConfig.ApplyZoneConfigExtensionForRegionalIn(zc, regionConfig.PrimaryRegion())
}
...
func zoneConfigForMultiRegionPartition(
	...
	return regionConfig.ApplyZoneConfigExtensionForRegionalIn(zc, partitionRegion)
}
...
func zoneConfigForMultiRegionTable(
	...
	case *catpb.LocalityConfig_Global_:
		...
		if !regionConfig.GlobalTablesInheritDatabaseConstraints() {
			...
			zc, err = regionConfig.ApplyZoneConfigExtensionForGlobal(zc)
			if err != nil {
				return zonepb.ZoneConfig{}, err
			}
		}
	...
	case *catpb.LocalityConfig_RegionalByTable_:
		...
		return regionConfig.ApplyZoneConfigExtensionForRegionalIn(zc, affinityRegion)
