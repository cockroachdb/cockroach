 ...
 * table. If there is no next row (end of table is reached), then return false.
 * If there is an error, then return false and error. */
type virtualTableGenerator func() (tree.Datums, bool, error)
