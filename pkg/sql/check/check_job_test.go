...
func TestCheckJobImplicitTxnSemantics(t *testing.T) {
  ...
  `)
	...
	for _, tc := range []struct {
		...
		{desc: "statement timeout", setupSQL: "SET statement_timeout = '100ms'", tearDownSQL: "RESET statement_timeout", pauseAtStart: true, expectedErrRegex: "query execution canceled due to statement timeout"},
	} {
