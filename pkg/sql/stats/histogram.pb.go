...
func (*HistogramData) Descriptor() ([]byte, []int) {
	return fileDescriptor_histogram_19fc978511170f76, []int{0}
}
...
func (*HistogramData_Bucket) Descriptor() ([]byte, []int) {
	return fileDescriptor_histogram_19fc978511170f76, []int{0, 0}
}
...
func init() {
	proto.RegisterFile("sql/stats/histogram.proto", fileDescriptor_histogram_19fc978511170f76)
}

var fileDescriptor_histogram_19fc978511170f76 = []byte{
