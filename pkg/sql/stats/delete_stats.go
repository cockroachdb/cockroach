...
// DeleteStats deletes old statistics from the system.table_statistics table.
// For the given tableID and columnIDs, DeleteStats keeps the most recent
// keepCount automatic statistics and deletes all the others.
func DeleteStats(
	ctx context.Context,
