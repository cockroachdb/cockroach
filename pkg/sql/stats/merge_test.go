...
func TestMergeStatistics(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			initial: &testStat{
				at: 1, row: 15, dist: 9, null: 4, size: 1,
		...
		},
		{
			...
			initial: &testStat{
				at: 2, row: 25, dist: 12, null: 2, size: 3,
				hist: testHistogram{
					{3, 3, 2, 5},
					{3, 3, 2, 8},
					{3, 3, 2, 12},
			...
			partial: &testStat{
				at: 3, row: 6, dist: 3, null: 3, size: 5,
				hist: testHistogram{
					{1, 0, 0, 2},
					{1, 0, 0, 3},
					{1, 0, 0, 4},
...
func TestMergedStatistics(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			full: []*testStat{
				{
					at: 5, row: 15, dist: 9, null: 4, size: 1, colID: 1,
					hist: testHistogram{{1, 0, 0, 30}, {1, 9, 7, 40}},
				},
				{
					at: 5, row: 15, dist: 9, null: 4, size: 1, colID: 2,
					hist: testHistogram{{1, 0, 0, 20}, {1, 9, 7, 30}},
				},
			},
			partial: []*testStat{
				{
					at: 8, row: 26, dist: 18, null: 4, size: 1, colID: 1,
					hist: testHistogram{{2, 0, 0, 50}, {1, 9, 8, 60}, {1, 9, 7, 70}},
				},
				{
					at: 7, row: 6, dist: 2, null: 4, size: 1, colID: 2,
					hist: testHistogram{{1, 0, 0, 40}, {1, 0, 0, 50}},
				},
				{
					at: 7, row: 15, dist: 9, null: 4, size: 1, colID: 1,
					hist: testHistogram{{1, 0, 0, 50}, {1, 9, 7, 60}},
				},
				{
					at: 6, row: 5, dist: 1, null: 4, size: 1, colID: 2,
