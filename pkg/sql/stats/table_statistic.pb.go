...
type TableStatisticProto struct {
	...
	// The size, in bytes, of all of the data in the columns in ColumnIDs.
	DataSize uint64 `protobuf:"varint,10,opt,name=data_size,json=dataSize,proto3" json:"data_size,omitempty"`
}
...
func (*TableStatisticProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_table_statistic_ed1008b20f4a8c0a, []int{0}
}
...
func (m *TableStatisticProto) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DataSize != 0 {
		dAtA[i] = 0x50
		i++
		i = encodeVarintTableStatistic(dAtA, i, uint64(m.DataSize))
	}
	return i, nil
}
...
func (m *TableStatisticProto) Size() (n int) {
	...
	if m.DataSize != 0 {
		n += 1 + sovTableStatistic(uint64(m.DataSize))
	}
	return n
}
...
func init() {
	proto.RegisterFile("sql/stats/table_statistic.proto", fileDescriptor_table_statistic_ed1008b20f4a8c0a)
}

var fileDescriptor_table_statistic_ed1008b20f4a8c0a = []byte{
	// 479 bytes of a gzipped FileDescriptorProto
	,
}
