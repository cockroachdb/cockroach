...
// MaybeResize safely decreases K without introducing bias. (Note that K can
// only decrease without introducing bias. Increasing K would cause later rows
// to be over-represented relative to earlier rows.)
