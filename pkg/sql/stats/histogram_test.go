	...
	testData := []struct {
		...
		{ // One bucket but two distinct values.
			...
			expected: []cat.HistogramBucket{
				...
				{NumRange: 3, NumEq: 4, DistinctRange: 0.5, UpperBound: d(1)},
				{NumRange: 3, NumEq: 0, DistinctRange: 0.5, UpperBound: d(math.MaxInt64)},
			},
		},
		{ // One bucket with UUIDs.
			...
			expected: []cat.HistogramBucket{
				...
				{NumRange: 49500, NumEq: 1000, DistinctRange: 500, UpperBound: uuids[1]},
				{NumRange: 49500, NumEq: 0, DistinctRange: 500, UpperBound: uuids[len(uuids)-1]},
			},
		},
		{ // One bucket with enums.
			...
			expected: []cat.HistogramBucket{
				...
				{NumRange: 0, NumEq: 1000, DistinctRange: 0, UpperBound: enums[1]},
				{NumRange: 8998, NumEq: 1, DistinctRange: 2, UpperBound: enums[len(enums)-1]},
			},
		},
		...
		{ // Two buckets matching distinctCount but not rowCount.
			...
			expected: []cat.HistogramBucket{
				{NumRange: 0, NumEq: 4, DistinctRange: 0, UpperBound: d(1)},
				{NumRange: 8, NumEq: 2, DistinctRange: 3, UpperBound: d(10)},
			},
		},
		...
		{ // Large number of rows and distinct values.
			...
			expected: []cat.HistogramBucket{
				{NumRange: 0, NumEq: 1, DistinctRange: 0, UpperBound: d(1)},
				{NumRange: 113.17, NumEq: 100, DistinctRange: 7.39, UpperBound: d(10)},
				{NumRange: 9685.83, NumEq: 100, DistinctRange: 889.61, UpperBound: d(1000)},
			},
		},
		{ // Large number of rows and distinct values with floats.
			...
			expected: []cat.HistogramBucket{
				{NumRange: 0, NumEq: 1, DistinctRange: 0, UpperBound: f(1)},
				{NumRange: 3999.5, NumEq: 1000, DistinctRange: 447, UpperBound: f(10)},
				{NumRange: 3999.5, NumEq: 1000, DistinctRange: 450, UpperBound: f(1000)},
			},
		},
	}
