...
func TestAdjustCounts(t *testing.T) {
	...
	testData := []struct {
		...
		{ // One bucket but two distinct values.
			...
			expected: []cat.HistogramBucket{
				...
				{NumRange: 4.5, NumEq: 1, DistinctRange: 0.5, UpperBound: d(1)},
				{NumRange: 4.5, NumEq: 0, DistinctRange: 0.5, UpperBound: d(math.MaxInt64)},
			},
		},
		{ // One bucket with UUIDs.
			h: []cat.HistogramBucket{
				{NumRange: 0, NumEq: 1, DistinctRange: 0, UpperBound: uuids[1]},
			},
			rowCount:      10,
			distinctCount: 2,
			expected: []cat.HistogramBucket{
				{NumRange: 0, NumEq: 0, DistinctRange: 0, UpperBound: uuids[0]},
				{NumRange: 4.5, NumEq: 1, DistinctRange: 0.5, UpperBound: uuids[1]},
				{NumRange: 4.5, NumEq: 0, DistinctRange: 0.5, UpperBound: uuids[len(uuids)-1]},
			},
		},
		{ // One bucket with enums.
			h: []cat.HistogramBucket{
				{NumRange: 0, NumEq: 1, DistinctRange: 0, UpperBound: enums[1]},
			},
			rowCount:      10,
			distinctCount: 5,
			expected: []cat.HistogramBucket{
				...
				{NumRange: 0, NumEq: 1, DistinctRange: 0, UpperBound: enums[1]},
				{NumRange: 7, NumEq: 1, DistinctRange: 2, UpperBound: enums[len(enums)-1]},
			},
		},
		...
		{ // Two buckets matching distinctCount but not rowCount.
			...
			expected: []cat.HistogramBucket{
				{NumRange: 0, NumEq: 1, DistinctRange: 0, UpperBound: d(1)},
				{NumRange: 11, NumEq: 2, DistinctRange: 3, UpperBound: d(10)},
			},
		},
		{ // Two buckets, matching rowCount but not distinctCount.
			...
			expected: []cat.HistogramBucket{
				{NumRange: 0, NumEq: 1, DistinctRange: 0, UpperBound: d(1)},
				{NumRange: 4, NumEq: 2, DistinctRange: 4, UpperBound: d(10)},
			},
		},
		{ // Two buckets, matching neither count.
			...
			distinctCount: 2,
			expected: []cat.HistogramBucket{
				{NumRange: 0, NumEq: 2, DistinctRange: 0, UpperBound: d(1)},
				{NumRange: 0, NumEq: 4, DistinctRange: 0, UpperBound: d(10)},
			},
		},
		{ // Two buckets, more distinct values than the range can hold.
			...
			expected: []cat.HistogramBucket{
				{NumRange: 0, NumEq: 0, DistinctRange: 0, UpperBound: d(math.MinInt64)},
				{NumRange: 4.25, NumEq: 1, DistinctRange: 4.5, UpperBound: d(1)},
				{NumRange: 8.5, NumEq: 2, DistinctRange: 8, UpperBound: d(10)},
				{NumRange: 4.25, NumEq: 0, DistinctRange: 4.5, UpperBound: d(math.MaxInt64)},
			},
		},
		{ // Two buckets with floats.
			...
			expected: []cat.HistogramBucket{
				{NumRange: 0, NumEq: 1, DistinctRange: 0, UpperBound: f(1)},
				{NumRange: 17, NumEq: 2, DistinctRange: 17, UpperBound: f(10)},
			},
		},
		{ // Two buckets with enums.
			h: []cat.HistogramBucket{
				{NumRange: 0, NumEq: 1, DistinctRange: 0, UpperBound: enums[1]},
				{NumRange: 0, NumEq: 1, DistinctRange: 0, UpperBound: enums[3]},
			},
			rowCount:      5,
			distinctCount: 5,
			expected: []cat.HistogramBucket{
				{NumRange: 0, NumEq: 1, DistinctRange: 0, UpperBound: enums[0]},
				{NumRange: 0, NumEq: 1, DistinctRange: 0, UpperBound: enums[1]},
				{NumRange: 1, NumEq: 1, DistinctRange: 1, UpperBound: enums[3]},
		...
		{ // Three buckets with enums.
			h: []cat.HistogramBucket{
				{NumRange: 0, NumEq: 1, DistinctRange: 0, UpperBound: enums[0]},
				{NumRange: 0, NumEq: 1, DistinctRange: 0, UpperBound: enums[1]},
				{NumRange: 0, NumEq: 1, DistinctRange: 0, UpperBound: enums[2]},
			},
			rowCount:      10,
			distinctCount: 5,
			expected: []cat.HistogramBucket{
				...
				{NumRange: 0, NumEq: 1, DistinctRange: 0, UpperBound: enums[1]},
				{NumRange: 0, NumEq: 1, DistinctRange: 0, UpperBound: enums[2]},
				{NumRange: 6, NumEq: 1, DistinctRange: 1, UpperBound: enums[len(enums)-1]},
			},
		},
		{ // Large number of rows and distinct values.
			h: []cat.HistogramBucket{
				{NumRange: 0, NumEq: 1, DistinctRange: 0, UpperBound: d(1)},
				{NumRange: 5, NumEq: 10, DistinctRange: 2, UpperBound: d(10)},
				{NumRange: 5, NumEq: 10, DistinctRange: 5, UpperBound: d(1000)},
			},
			rowCount:      1000,
			distinctCount: 900,
			expected: []cat.HistogramBucket{
				{NumRange: 0, NumEq: 1, DistinctRange: 0, UpperBound: d(1)},
				{NumRange: 11.31, NumEq: 10, DistinctRange: 7.39, UpperBound: d(10)},
				{NumRange: 967.69, NumEq: 10, DistinctRange: 889.61, UpperBound: d(1000)},
			},
		},
		{ // Large number of rows and distinct values with floats.
			h: []cat.HistogramBucket{
				{NumRange: 0, NumEq: 1, DistinctRange: 0, UpperBound: f(1)},
				{NumRange: 5, NumEq: 10, DistinctRange: 2, UpperBound: f(10)},
				{NumRange: 5, NumEq: 10, DistinctRange: 5, UpperBound: f(1000)},
			},
			rowCount:      1000,
			distinctCount: 900,
			expected: []cat.HistogramBucket{
				{NumRange: 0, NumEq: 1, DistinctRange: 0, UpperBound: f(1)},
				{NumRange: 489.5, NumEq: 10, DistinctRange: 447, UpperBound: f(10)},
				{NumRange: 489.5, NumEq: 10, DistinctRange: 450, UpperBound: f(1000)},
			},
		},
	}
	...
	t.Run("random", func(t *testing.T) {
		...
		randHist := func() histogram {
			...
			buckets[0].NumEq = float64(rand.Intn(1000))
			for i := 1; i < len(buckets); i++ {
				...
				buckets[i].NumEq = float64(rand.Intn(1000))
		...
		for trial := 0; trial < 100; trial++ {
			...
			rowCount += len(h.buckets)
			distinctCount += len(h.buckets)
