...
type Refresher struct {
	...
	spansForFixups map[tableIDIndexID]roachpb.Spans
...
func MakeRefresher(
	...
	return &Refresher{
		...
		spansForFixups:   make(map[tableIDIndexID]roachpb.Spans, 16),
...
func (r *Refresher) GetSpansForTableIDIndexID(
	...
	if !ok {
		return roachpb.Spans{}, errors.AssertionFailedf("didn't find spans for auto partial fixup refresh for table ID %d", tableID)
	}
	return spans, nil
}
...
func (r *Refresher) refreshAutoPartialUsingSpans(
	ctx context.Context, target tableIDIndexID, spans roachpb.Spans,
) error {
