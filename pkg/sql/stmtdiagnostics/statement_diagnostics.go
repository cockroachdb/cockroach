...
func (r *Registry) insertRequestInternal(
	...
	err := r.db.Txn(ctx, func(ctx context.Context, txn isql.Txn) error {
		...
		if maxExecutionLatency != 0 && r.st.Version.IsActive(ctx, clusterversion.V26_2_StmtDiagnosticsMaxLatency) {
...
func (r *Registry) pollStmtRequests(ctx context.Context) error {
	...
	maxLatencySupported := r.st.Version.IsActive(ctx, clusterversion.V26_2_StmtDiagnosticsMaxLatency)
