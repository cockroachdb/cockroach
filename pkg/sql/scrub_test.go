...
`); err != nil {
	...
	colIDtoRowIndex := util.FastIntMap{}
	colIDtoRowIndex.Set(int(tableDesc.Columns[0].ID), 0)
	colIDtoRowIndex.Set(int(tableDesc.Columns[1].ID), 1)
...
`); err != nil {
	...
	colIDtoRowIndex.Set(int(tableDesc.Columns[0].ID), 0)
	colIDtoRowIndex.Set(int(tableDesc.Columns[1].ID), 1)
	colIDtoRowIndex.Set(int(tableDesc.Columns[2].ID), 2)
