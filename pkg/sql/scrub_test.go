...
`); err != nil {
	...
	// database.
	secondaryIndexKey, err := sqlbase.EncodeSecondaryIndex(nil, tableDesc, secondaryIndex, nil,
...
`); err != nil {
	...
	secondaryIndex, err := sqlbase.EncodeSecondaryIndex(nil, tableDesc, secondaryIndexDesc, nil, colIDtoRowIndex, values, true /* includeEmpty */)
	if err != nil {
		t.Fatalf("unexpected error: %s", err)
	}
...
`); err != nil {
	...
	secondaryIndex, err := sqlbase.EncodeSecondaryIndex(nil, tableDesc, secondaryIndexDesc, nil,
		colIDtoRowIndex, values, true /* includeEmpty */)
