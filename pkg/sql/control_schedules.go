...
type controlAllSchedulesNode struct {
	rows    planNode
...
// func (n *controlAllSchedulesNode) FastPathResults() (int, bool) {
...
func (n *controlAllSchedulesNode) startExec(params runParams) error {
	for {
...
func (*controlAllSchedulesNode) Next(runParams) (bool, error) { return false, nil }

// Values implements planNode interface.
func (*controlAllSchedulesNode) Values() tree.Datums { return nil }

// Close implements planNode interface.
func (n *controlAllSchedulesNode) Close(ctx context.Context) {
	n.rows.Close(ctx)
}
