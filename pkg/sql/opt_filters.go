...
func (p *planner) addJoinFilter(
	...
	onAndExprs := splitAndExpr(&p.extendedEvalCtx.EvalContext, n.pred.onCond, nil /* exprs */)
	...
	if n.joinType == joinTypeInner {
		...
		onAndExprs = splitAndExpr(&p.extendedEvalCtx.EvalContext, extraFilter, onAndExprs)
		extraFilter = nil
	}
	...
	if n.joinType != joinTypeFullOuter {
		onCond = expandOnCond(n, onCond, &p.extendedEvalCtx.EvalContext)
	}
