...
type scanNode struct {
	...
	// row on local nodes (relative to the gateway region) before fanning out to
	// remote nodes. In order for this optimization to work, the DistSQL planner
	// must create a local plan.
