...
`); err != nil {
	...
	downgradeForeignKey := func(tbl *descpb.TableDescriptor) *descpb.TableDescriptor {
	...
	err := kvDB.Txn(ctx, func(ctx context.Context, txn *kv.Txn) error {
		b := txn.NewBatch()
		newDesc := sqlbase.NewImmutableTableDescriptor(*downgradeForeignKey(desc.TableDesc()))
