...
func (so *DummySequenceOperators) ValidateCurrentDatabaseMultiRegionZoneConfigs(
	_ context.Context,
) error {
...
// ValidateCurrentDatabaseMultiRegionZoneConfigs is part of the tree.EvalDatabase interface.
func (ep *DummyEvalPlanner) ValidateCurrentDatabaseMultiRegionZoneConfigs(_ context.Context) error {
	return errors.WithStack(errEvalPlanner)
}
