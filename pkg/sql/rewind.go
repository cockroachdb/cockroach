...
func isRewindable(plan planNode) (bool, error) {
	o := planObserver{
...
var errNotRewindableMarker = errors.NewError("not rewindable")
...
// FIXME(knz/joran) make unionNode rewindable. This may be complicated
