...
func TestTraceAnalyzer(t *testing.T) {
	...
	for _, vectorizeMode := range []sessiondata.VectorizeExecMode{sessiondata.VectorizeOff, sessiondata.VectorizeOn} {
		...
		case sessiondata.VectorizeOff:
			rowexecTraceAnalyzer = analyzer
		case sessiondata.VectorizeOn:
