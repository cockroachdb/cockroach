...
func (n *groupNode) Next(params runParams) (bool, error) {
	// We're going to consume n.plan and accumulate its rows until it's either
	// exhausted or the ordered group columns change. Subsequent calls to Next
	// will return the result of each bucket, then continue consuming n.plan when
