...
//
// The bottom of the complex is always a groupNode which initially initially
// uses the given renderNode as its own data source; the data source can be
// changed later with an equivalent one if the renderNode is optimized out.
//
