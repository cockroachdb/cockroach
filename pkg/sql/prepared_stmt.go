...
type PreparedPortal struct {
	...
	// rowsAffected tracks the number of rows affected by this portal so far.
	// It is only used with tree.Rows statement type but is stored
	// unconditionally.
	// See comments around portalSuspensionStrategy for details.
	rowsAffected int
}
