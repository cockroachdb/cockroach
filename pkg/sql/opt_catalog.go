...
// InvertedPrefixColumnCount is part of the cat.Index interface.
func (oi *optIndex) InvertedPrefixColumnCount() int {
	if !oi.IsInverted() {
...
// InvertedPrefixColumnCount is part of the cat.Index interface.
func (oi *optVirtualIndex) InvertedPrefixColumnCount() int {
