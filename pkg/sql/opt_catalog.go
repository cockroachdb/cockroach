...
// IsRefreshRequired is part of the cat.Table interface.
func (ot *optTable) IsRefreshRequired() bool {
	return ot.desc.MaterializedView() && ot.desc.IsRefreshViewRequired()
}
...
// IsRefreshRequired is part of the cat.Table interface.
func (ot *optVirtualTable) IsRefreshRequired() bool {
	return ot.desc.MaterializedView() && ot.desc.IsRefreshViewRequired()
}
