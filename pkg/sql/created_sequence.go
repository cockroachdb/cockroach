...
func (createdSequences noopCreatedSequences) addCreatedSequence(id descpb.ID) error {
	return errors.AssertionFailedf("addCreatedSequence not supported in noopCreatedSequences")
}

func (createdSequences noopCreatedSequences) isCreatedSequence(id descpb.ID) bool {
	return false
}
