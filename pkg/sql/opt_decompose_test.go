...
func testTableDesc(
	...
	mut := sqlbase.NewMutableCreatedTableDescriptor(sqlbase.TableDescriptor{
		...
		Columns: []sqlbase.ColumnDescriptor{
			{Name: "a", Type: types.ColumnType{SemanticType: types.INT}},
			{Name: "b", Type: types.ColumnType{SemanticType: types.INT}},
			{Name: "c", Type: types.ColumnType{SemanticType: types.BOOL}},
			{Name: "d", Type: types.ColumnType{SemanticType: types.BOOL}},
			{Name: "e", Type: types.ColumnType{SemanticType: types.BOOL}},
			{Name: "f", Type: types.ColumnType{SemanticType: types.BOOL}},
			{Name: "g", Type: types.ColumnType{SemanticType: types.BOOL}},
			{Name: "h", Type: types.ColumnType{SemanticType: types.FLOAT}},
			{Name: "i", Type: types.ColumnType{SemanticType: types.STRING}},
			{Name: "j", Type: types.ColumnType{SemanticType: types.INT}},
			{Name: "k", Type: types.ColumnType{SemanticType: types.BYTES}},
			{Name: "l", Type: types.ColumnType{SemanticType: types.DECIMAL}},
			{Name: "m", Type: types.ColumnType{SemanticType: types.DECIMAL}},
			{Name: "n", Type: types.ColumnType{SemanticType: types.DATE}},
			{Name: "o", Type: types.ColumnType{SemanticType: types.TIMESTAMP}},
			{Name: "p", Type: types.ColumnType{SemanticType: types.TIMESTAMPTZ}},
			{Name: "q", Type: types.ColumnType{SemanticType: types.INT}, Nullable: true},
			{Name: "r", Type: types.ColumnType{SemanticType: types.UUID}},
			{Name: "s", Type: types.ColumnType{SemanticType: types.INET}},
		},
