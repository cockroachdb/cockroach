...
func testTableDesc(
	...
	mut := sqlbase.NewMutableCreatedTableDescriptor(sqlbase.TableDescriptor{
		...
		Columns: []sqlbase.ColumnDescriptor{
			{Name: "a", Type: types.ColumnType{SemanticType: types.ColumnType_INT}},
			{Name: "b", Type: types.ColumnType{SemanticType: types.ColumnType_INT}},
			{Name: "c", Type: types.ColumnType{SemanticType: types.ColumnType_BOOL}},
			{Name: "d", Type: types.ColumnType{SemanticType: types.ColumnType_BOOL}},
			{Name: "e", Type: types.ColumnType{SemanticType: types.ColumnType_BOOL}},
			{Name: "f", Type: types.ColumnType{SemanticType: types.ColumnType_BOOL}},
			{Name: "g", Type: types.ColumnType{SemanticType: types.ColumnType_BOOL}},
			{Name: "h", Type: types.ColumnType{SemanticType: types.ColumnType_FLOAT}},
			{Name: "i", Type: types.ColumnType{SemanticType: types.ColumnType_STRING}},
			{Name: "j", Type: types.ColumnType{SemanticType: types.ColumnType_INT}},
			{Name: "k", Type: types.ColumnType{SemanticType: types.ColumnType_BYTES}},
			{Name: "l", Type: types.ColumnType{SemanticType: types.ColumnType_DECIMAL}},
			{Name: "m", Type: types.ColumnType{SemanticType: types.ColumnType_DECIMAL}},
			{Name: "n", Type: types.ColumnType{SemanticType: types.ColumnType_DATE}},
			{Name: "o", Type: types.ColumnType{SemanticType: types.ColumnType_TIMESTAMP}},
			{Name: "p", Type: types.ColumnType{SemanticType: types.ColumnType_TIMESTAMPTZ}},
			{Name: "q", Type: types.ColumnType{SemanticType: types.ColumnType_INT}, Nullable: true},
		},
