...
func (*ChangeAggregatorSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_changefeeds_aa0d0c94fd4061ba, []int{0}
}
...
func (*ChangeAggregatorSpec_Watch) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_changefeeds_aa0d0c94fd4061ba, []int{0, 0}
}
...
func (*ChangeFrontierSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_changefeeds_aa0d0c94fd4061ba, []int{1}
}
...
func init() {
	proto.RegisterFile("sql/distsqlpb/processors_changefeeds.proto", fileDescriptor_processors_changefeeds_aa0d0c94fd4061ba)
}

var fileDescriptor_processors_changefeeds_aa0d0c94fd4061ba = []byte{
