...
func (ScanVisibility) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a076c26dc4c037a0, []int{0}
}
...
func (AggregatorSpec_Func) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a076c26dc4c037a0, []int{10, 0}
}
...
func (AggregatorSpec_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a076c26dc4c037a0, []int{10, 1}
}
...
func (WindowerSpec_WindowFunc) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a076c26dc4c037a0, []int{13, 0}
}
...
func (WindowerSpec_Frame_Mode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a076c26dc4c037a0, []int{13, 1, 0}
}
...
func (WindowerSpec_Frame_BoundType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a076c26dc4c037a0, []int{13, 1, 1}
}
...
func (WindowerSpec_Frame_Exclusion) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a076c26dc4c037a0, []int{13, 1, 2}
}
...
type TableReaderSpec struct {
	...
	// Indicates the length of the prefix of the current index over which
	// we are doing an index-skip-scan. It is the length of the prefix of the
	// index that we are performing a distinct over. By default, this is 0
	// indicating that in index-skip-scan is not being used.
	PrefixSkipLen uint32 `protobuf:"varint,10,opt,name=prefix_skip_len,json=prefixSkipLen" json:"prefix_skip_len"`
}
...
func (*TableReaderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a076c26dc4c037a0, []int{1}
}
...
type IndexSkipTableReaderSpec struct {
	...
	// Indicates the length of the prefix of the current index over which
	// we are doing an index-skip-scan. It is the length of the prefix of the
	// index that we are performing a distinct over.
	PrefixSkipLen uint32 `protobuf:"varint,6,opt,name=prefix_skip_len,json=prefixSkipLen" json:"prefix_skip_len"`
}
...
func (*IndexSkipTableReaderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a076c26dc4c037a0, []int{2}
}
...
func (*JoinReaderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a076c26dc4c037a0, []int{3}
}
...
func (*SorterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a076c26dc4c037a0, []int{4}
}
...
func (*DistinctSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a076c26dc4c037a0, []int{5}
}
...
func (*OrdinalitySpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a076c26dc4c037a0, []int{6}
}
...
func (*ZigzagJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a076c26dc4c037a0, []int{7}
}
...
func (*MergeJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a076c26dc4c037a0, []int{8}
}
...
func (*HashJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a076c26dc4c037a0, []int{9}
}
...
func (*AggregatorSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a076c26dc4c037a0, []int{10}
}
...
func (*InterleavedReaderJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a076c26dc4c037a0, []int{11}
}
...
func (*InterleavedReaderJoinerSpec_Table) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a076c26dc4c037a0, []int{11, 0}
}
...
func (*ProjectSetSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a076c26dc4c037a0, []int{12}
}
...
func (*WindowerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a076c26dc4c037a0, []int{13}
}
...
func (*WindowerSpec_Frame) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a076c26dc4c037a0, []int{13, 1}
}
...
func (*WindowerSpec_WindowFn) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a076c26dc4c037a0, []int{13, 2}
}
...
func (m *TableReaderSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x50
	i++
	i = encodeVarintProcessorsSql(dAtA, i, uint64(m.PrefixSkipLen))
	return i, nil
}
...
func (m *TableReaderSpec) Size() (n int) {
	...
	n += 1 + sovProcessorsSql(uint64(m.PrefixSkipLen))
	return n
}
...
func (m *TableReaderSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PrefixSkipLen", wireType)
			}
			m.PrefixSkipLen = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PrefixSkipLen |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func init() {
	proto.RegisterFile("sql/distsqlpb/processors_sql.proto", fileDescriptor_processors_sql_a076c26dc4c037a0)
}

var fileDescriptor_processors_sql_a076c26dc4c037a0 = []byte{
	...
	,
}
