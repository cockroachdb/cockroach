...
func (BackfillerSpec_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_4088a46c3d250943, []int{0, 0}
}
...
func (*BackfillerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_4088a46c3d250943, []int{0}
}
...
func (*JobProgress) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_4088a46c3d250943, []int{1}
}
...
func (*ReadImportDataSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_4088a46c3d250943, []int{2}
}
...
type ReadImportDataSpec_Progress struct {
	CompletedRow      map[int32]uint64  `protobuf:"bytes,1,rep,name=completed_row,json=completedRow" json:"completed_row,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
...
func (m *ReadImportDataSpec_Progress) Reset()         { *m = ReadImportDataSpec_Progress{} }
func (m *ReadImportDataSpec_Progress) String() string { return proto.CompactTextString(m) }
func (*ReadImportDataSpec_Progress) ProtoMessage()    {}
func (*ReadImportDataSpec_Progress) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_4088a46c3d250943, []int{2, 0}
}
func (m *ReadImportDataSpec_Progress) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ReadImportDataSpec_Progress) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalTo(b)
	if err != nil {
		return nil, err
...
func (dst *ReadImportDataSpec_Progress) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReadImportDataSpec_Progress.Merge(dst, src)
}
func (m *ReadImportDataSpec_Progress) XXX_Size() int {
	return m.Size()
}
func (m *ReadImportDataSpec_Progress) XXX_DiscardUnknown() {
	xxx_messageInfo_ReadImportDataSpec_Progress.DiscardUnknown(m)
}

var xxx_messageInfo_ReadImportDataSpec_Progress proto.InternalMessageInfo
...
func (*ReadImportDataSpec_ImportTable) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_4088a46c3d250943, []int{2, 1}
}
...
func (*SSTWriterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_4088a46c3d250943, []int{3}
}
...
func (*SSTWriterSpec_SpanName) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_4088a46c3d250943, []int{3, 0}
}
...
func (*CSVWriterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_4088a46c3d250943, []int{4}
}
...
func (*BulkRowWriterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_4088a46c3d250943, []int{5}
}
...
func init() {
	...
	proto.RegisterType((*ReadImportDataSpec_Progress)(nil), "cockroach.sql.distsqlrun.ReadImportDataSpec.Progress")
	proto.RegisterMapType((map[int32]float32)(nil), "cockroach.sql.distsqlrun.ReadImportDataSpec.Progress.CompletedFractionEntry")
	proto.RegisterMapType((map[int32]uint64)(nil), "cockroach.sql.distsqlrun.ReadImportDataSpec.Progress.CompletedRowEntry")
...
func (m *ReadImportDataSpec_Progress) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ReadImportDataSpec_Progress) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if len(m.CompletedFraction) > 0 {
		...
		for _, k := range keysForCompletedFraction {
			...
			mapSize := 1 + sovProcessorsBulkIo(uint64(k)) + 1 + 4
			i = encodeVarintProcessorsBulkIo(dAtA, i, uint64(mapSize))
			dAtA[i] = 0x8
			i++
			i = encodeVarintProcessorsBulkIo(dAtA, i, uint64(k))
...
func (m *ReadImportDataSpec_Progress) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if len(m.CompletedFraction) > 0 {
		for k, v := range m.CompletedFraction {
			_ = k
			_ = v
			mapEntrySize := 1 + sovProcessorsBulkIo(uint64(k)) + 1 + 4
			n += mapEntrySize + 1 + sovProcessorsBulkIo(uint64(mapEntrySize))
		}
	}
	return n
...
func (m *ReadImportDataSpec_Progress) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func init() {
	proto.RegisterFile("sql/distsqlpb/processors_bulk_io.proto", fileDescriptor_processors_bulk_io_4088a46c3d250943)
}

var fileDescriptor_processors_bulk_io_4088a46c3d250943 = []byte{
	...
	,
}
