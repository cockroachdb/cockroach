...
func (BackfillerSpec_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_043971b0651ea852, []int{0, 0}
}
...
func (*BackfillerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_043971b0651ea852, []int{0}
}
...
func (*JobProgress) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_043971b0651ea852, []int{1}
}
...
func (*ReadImportDataSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_043971b0651ea852, []int{2}
}
...
func (*SSTWriterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_043971b0651ea852, []int{3}
}
...
func (*SSTWriterSpec_SpanName) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_043971b0651ea852, []int{3, 0}
}
...
func (*CSVWriterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_043971b0651ea852, []int{4}
}
...
func init() {
	proto.RegisterFile("sql/distsqlpb/processors_bulk_io.proto", fileDescriptor_processors_bulk_io_043971b0651ea852)
}

var fileDescriptor_processors_bulk_io_043971b0651ea852 = []byte{
