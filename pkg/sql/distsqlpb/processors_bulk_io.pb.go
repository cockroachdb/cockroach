...
func (BackfillerSpec_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_8db5d426bb6177c5, []int{0, 0}
}
...
func (*BackfillerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_8db5d426bb6177c5, []int{0}
}
...
func (*JobProgress) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_8db5d426bb6177c5, []int{1}
}
...
type ReadImportDataSpec struct {
	...
	TargetCols map[string]*ReadImportDataSpec_TargetColList `protobuf:"bytes,13,rep,name=targetCols" json:"targetCols,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
func (*ReadImportDataSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_8db5d426bb6177c5, []int{2}
}
...
// being imported into. If it is non-empty, the keys specify the names of
// tables, and the values specify the columns for which the processor should
// read and emit data (ignoring data for any other tables or columns outside
// of the targetCols, that is present in the input).
type ReadImportDataSpec_TargetColList struct {
	ColNames []string `protobuf:"bytes,1,rep,name=colNames" json:"colNames,omitempty"`
}

func (m *ReadImportDataSpec_TargetColList) Reset()         { *m = ReadImportDataSpec_TargetColList{} }
func (m *ReadImportDataSpec_TargetColList) String() string { return proto.CompactTextString(m) }
func (*ReadImportDataSpec_TargetColList) ProtoMessage()    {}
func (*ReadImportDataSpec_TargetColList) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_8db5d426bb6177c5, []int{2, 1}
}
func (m *ReadImportDataSpec_TargetColList) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ReadImportDataSpec_TargetColList) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalTo(b)
	if err != nil {
		return nil, err
...
func (dst *ReadImportDataSpec_TargetColList) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReadImportDataSpec_TargetColList.Merge(dst, src)
}
func (m *ReadImportDataSpec_TargetColList) XXX_Size() int {
	return m.Size()
}
func (m *ReadImportDataSpec_TargetColList) XXX_DiscardUnknown() {
	xxx_messageInfo_ReadImportDataSpec_TargetColList.DiscardUnknown(m)
}

var xxx_messageInfo_ReadImportDataSpec_TargetColList proto.InternalMessageInfo
...
func (*SSTWriterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_8db5d426bb6177c5, []int{3}
}
...
func (*SSTWriterSpec_SpanName) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_8db5d426bb6177c5, []int{3, 0}
}
...
func (*CSVWriterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_8db5d426bb6177c5, []int{4}
}
...
func (*BulkRowWriterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_8db5d426bb6177c5, []int{5}
}
...
func init() {
	...
	proto.RegisterMapType((map[string]*ReadImportDataSpec_TargetColList)(nil), "cockroach.sql.distsqlrun.ReadImportDataSpec.TargetColsEntry")
	proto.RegisterMapType((map[int32]string)(nil), "cockroach.sql.distsqlrun.ReadImportDataSpec.UriEntry")
	proto.RegisterType((*ReadImportDataSpec_TargetColList)(nil), "cockroach.sql.distsqlrun.ReadImportDataSpec.TargetColList")
...
func (m *ReadImportDataSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.TargetCols) > 0 {
		keysForTargetCols := make([]string, 0, len(m.TargetCols))
		for k := range m.TargetCols {
			keysForTargetCols = append(keysForTargetCols, string(k))
		}
		github_com_gogo_protobuf_sortkeys.Strings(keysForTargetCols)
		for _, k := range keysForTargetCols {
			dAtA[i] = 0x6a
			i++
			v := m.TargetCols[string(k)]
			msgSize := 0
			if v != nil {
				msgSize = v.Size()
				msgSize += 1 + sovProcessorsBulkIo(uint64(msgSize))
...
func (m *ReadImportDataSpec_TargetColList) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ReadImportDataSpec_TargetColList) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ReadImportDataSpec_TargetColList) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ReadImportDataSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			...
			if m.TargetCols == nil {
				m.TargetCols = make(map[string]*ReadImportDataSpec_TargetColList)
			}
			var mapkey string
			var mapvalue *ReadImportDataSpec_TargetColList
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
				...
				if fieldNum == 1 {
					...
					mapvalue = &ReadImportDataSpec_TargetColList{}
					if err := mapvalue.Unmarshal(dAtA[iNdEx:postmsgIndex]); err != nil {
						return err
					}
					iNdEx = postmsgIndex
...
func (m *ReadImportDataSpec_TargetColList) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TargetColList: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TargetColList: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func init() {
	proto.RegisterFile("sql/distsqlpb/processors_bulk_io.proto", fileDescriptor_processors_bulk_io_8db5d426bb6177c5)
}

var fileDescriptor_processors_bulk_io_8db5d426bb6177c5 = []byte{
	...
	,
}
