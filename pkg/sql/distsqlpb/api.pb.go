...
func (BytesEncodeFormat) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_api_f73c3942e4fe4344, []int{0}
}
...
type SetupFlowRequest struct {
	...
	DeprecatedTxn *roachpb.Transaction `protobuf:"bytes,1,opt,name=deprecated_txn,json=deprecatedTxn" json:"deprecated_txn,omitempty"`
...
type EvalContext struct {
	...
	BytesEncodeFormat    BytesEncodeFormat `protobuf:"varint,10,opt,name=bytes_encode_format,json=bytesEncodeFormat,enum=cockroach.sql.distsqlpb.BytesEncodeFormat" json:"bytes_encode_format"`
...
func (*EvalContext) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_f73c3942e4fe4344, []int{1}
}
...
func (*SequenceState) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_f73c3942e4fe4344, []int{2}
}
...
func (*SequenceState_Seq) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_f73c3942e4fe4344, []int{2, 0}
}
...
func (*SimpleResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_f73c3942e4fe4344, []int{3}
}
...
func (*ConsumerSignal) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_f73c3942e4fe4344, []int{4}
}
...
func (*DrainRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_f73c3942e4fe4344, []int{5}
}
...
func (*ConsumerHandshake) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_f73c3942e4fe4344, []int{6}
}
...
func init() {
	proto.RegisterType((*SetupFlowRequest)(nil), "cockroach.sql.distsqlpb.SetupFlowRequest")
	proto.RegisterType((*EvalContext)(nil), "cockroach.sql.distsqlpb.EvalContext")
	proto.RegisterType((*SequenceState)(nil), "cockroach.sql.distsqlpb.SequenceState")
	proto.RegisterType((*SequenceState_Seq)(nil), "cockroach.sql.distsqlpb.SequenceState.Seq")
	proto.RegisterType((*SimpleResponse)(nil), "cockroach.sql.distsqlpb.SimpleResponse")
	proto.RegisterType((*ConsumerSignal)(nil), "cockroach.sql.distsqlpb.ConsumerSignal")
	proto.RegisterType((*DrainRequest)(nil), "cockroach.sql.distsqlpb.DrainRequest")
	proto.RegisterType((*ConsumerHandshake)(nil), "cockroach.sql.distsqlpb.ConsumerHandshake")
	proto.RegisterEnum("cockroach.sql.distsqlpb.BytesEncodeFormat", BytesEncodeFormat_name, BytesEncodeFormat_value)
}
...
func (c *distSQLClient) RunSyncFlow(ctx context.Context, opts ...grpc.CallOption) (DistSQL_RunSyncFlowClient, error) {
	stream, err := c.cc.NewStream(ctx, &_DistSQL_serviceDesc.Streams[0], "/cockroach.sql.distsqlpb.DistSQL/RunSyncFlow", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *distSQLClient) SetupFlow(ctx context.Context, in *SetupFlowRequest, opts ...grpc.CallOption) (*SimpleResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cockroach.sql.distsqlpb.DistSQL/SetupFlow", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *distSQLClient) FlowStream(ctx context.Context, opts ...grpc.CallOption) (DistSQL_FlowStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_DistSQL_serviceDesc.Streams[1], "/cockroach.sql.distsqlpb.DistSQL/FlowStream", opts...)
	if err != nil {
		return nil, err
	}
...
func _DistSQL_SetupFlow_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cockroach.sql.distsqlpb.DistSQL/SetupFlow",
	}
...
var _DistSQL_serviceDesc = grpc.ServiceDesc{
	ServiceName: "cockroach.sql.distsqlpb.DistSQL",
...
func (m *SetupFlowRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.DeprecatedTxn == nil {
				m.DeprecatedTxn = &roachpb.Transaction{}
			}
...
func init() { proto.RegisterFile("sql/distsqlpb/api.proto", fileDescriptor_api_f73c3942e4fe4344) }

var fileDescriptor_api_f73c3942e4fe4344 = []byte{
	...
	,
}
