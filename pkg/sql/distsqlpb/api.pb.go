...
func (BytesEncodeFormat) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_api_712d1da74e8be957, []int{0}
}
...
func (*FlowSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_712d1da74e8be957, []int{1}
}
...
type EvalContext struct {
	...
	Vectorize            int64             `protobuf:"varint,12,opt,name=vectorize" json:"vectorize"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (*EvalContext) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_712d1da74e8be957, []int{2}
}
...
func (*SequenceState) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_712d1da74e8be957, []int{3}
}
...
func (*SequenceState_Seq) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_712d1da74e8be957, []int{3, 0}
}
...
func (*SimpleResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_712d1da74e8be957, []int{4}
}
...
func (*ConsumerSignal) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_712d1da74e8be957, []int{5}
}
...
func (*DrainRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_712d1da74e8be957, []int{6}
}
...
func (*ConsumerHandshake) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_712d1da74e8be957, []int{7}
}
	...
	for iNdEx < l {
		...
		case 12:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Vectorize |= (int64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func init() { proto.RegisterFile("sql/distsqlpb/api.proto", fileDescriptor_api_712d1da74e8be957) }

var fileDescriptor_api_712d1da74e8be957 = []byte{
	...
	,
}
