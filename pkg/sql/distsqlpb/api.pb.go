...
/*
	Package distsqlpb is a generated protocol buffer package.

	It is generated from these files:
		sql/distsqlpb/api.proto
		sql/distsqlpb/data.proto
		sql/distsqlpb/processors.proto
...
func (c *distSQLClient) RunSyncFlow(ctx context.Context, opts ...grpc.CallOption) (DistSQL_RunSyncFlowClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_DistSQL_serviceDesc.Streams[0], c.cc, "/cockroach.sql.distsqlpb.DistSQL/RunSyncFlow", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *distSQLClient) SetupFlow(ctx context.Context, in *SetupFlowRequest, opts ...grpc.CallOption) (*SimpleResponse, error) {
	...
	err := grpc.Invoke(ctx, "/cockroach.sql.distsqlpb.DistSQL/SetupFlow", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *distSQLClient) FlowStream(ctx context.Context, opts ...grpc.CallOption) (DistSQL_FlowStreamClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_DistSQL_serviceDesc.Streams[1], c.cc, "/cockroach.sql.distsqlpb.DistSQL/FlowStream", opts...)
	if err != nil {
		return nil, err
	}
...
func init() { proto.RegisterFile("sql/distsqlpb/api.proto", fileDescriptorApi) }
