...
func (SketchType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_table_stats_cf7f04ac831f1f53, []int{0}
}
...
func (*SamplerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_table_stats_cf7f04ac831f1f53, []int{1}
}
...
func (*SampleAggregatorSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_table_stats_cf7f04ac831f1f53, []int{2}
}
...
func init() {
	proto.RegisterFile("sql/distsqlpb/processors_table_stats.proto", fileDescriptor_processors_table_stats_cf7f04ac831f1f53)
}

var fileDescriptor_processors_table_stats_cf7f04ac831f1f53 = []byte{
