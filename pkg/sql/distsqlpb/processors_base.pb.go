...
func (*PostProcessSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_base_621ade334462b02c, []int{0}
}
...
func (*Columns) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_base_621ade334462b02c, []int{1}
}
...
func (*TableReaderSpan) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_base_621ade334462b02c, []int{2}
}
...
func init() {
	proto.RegisterFile("sql/distsqlpb/processors_base.proto", fileDescriptor_processors_base_621ade334462b02c)
}

var fileDescriptor_processors_base_621ade334462b02c = []byte{
