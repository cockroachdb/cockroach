...
func (*ProcessorSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_c9f8ec7ee260e7db, []int{0}
}
...
func (*ProcessorCoreUnion) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_c9f8ec7ee260e7db, []int{1}
}
...
func (*NoopCoreSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_c9f8ec7ee260e7db, []int{2}
}
...
func (*LocalPlanNodeSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_c9f8ec7ee260e7db, []int{3}
}
...
func (*MetadataTestSenderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_c9f8ec7ee260e7db, []int{4}
}
...
func (*MetadataTestReceiverSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_c9f8ec7ee260e7db, []int{5}
}
...
func init() {
	proto.RegisterFile("sql/distsqlpb/processors.proto", fileDescriptor_processors_c9f8ec7ee260e7db)
}

var fileDescriptor_processors_c9f8ec7ee260e7db = []byte{
	// 1059 bytes of a gzipped FileDescriptorProto
	,
}
