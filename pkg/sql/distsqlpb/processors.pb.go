...
func (*ProcessorSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_5075a50408635cd8, []int{0}
}
...
func (*ProcessorCoreUnion) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_5075a50408635cd8, []int{1}
}
...
func (*NoopCoreSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_5075a50408635cd8, []int{2}
}
...
func (*LocalPlanNodeSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_5075a50408635cd8, []int{3}
}
...
func (*MetadataTestSenderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_5075a50408635cd8, []int{4}
}
...
func (*MetadataTestReceiverSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_5075a50408635cd8, []int{5}
}
...
func init() {
	proto.RegisterFile("sql/distsqlpb/processors.proto", fileDescriptor_processors_5075a50408635cd8)
}

var fileDescriptor_processors_5075a50408635cd8 = []byte{
	...
	,
}
