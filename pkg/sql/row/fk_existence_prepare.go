...
// need to create additional CheckHelpers. It does this using the AnalyzeExpr
// TableLookupFunction, and CheckPrivilegeFunction functions, so these must be
// provided if there's a possibility of a cascading operation.
func MakeFkMetadata(
	ctx context.Context,
