...
// defaultTraceKVSampleFrequency is used when KV tracing is enabled but there
// is no sample frequency specified. Default to logging all KVs.
const defaultTraceKVSampleFrequency = 0
