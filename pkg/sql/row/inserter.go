...
// insertPutLockingFn is used by insertRow when conflicts should be ignored
// while ensuring that an exclusive lock is acquired on the key.
func insertPutLockingFn(
	ctx context.Context,
	b Putter,
	key *roachpb.Key,
	value *roachpb.Value,
