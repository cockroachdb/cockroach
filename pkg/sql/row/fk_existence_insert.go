...
func (h fkExistenceCheckForInsert) addAllIdxChecks(ctx context.Context, row tree.Datums, traceKV bool) error {
	for idx := range h.fks {
...
func (h fkExistenceCheckForInsert) CollectSpansForValues(values tree.Datums) (roachpb.Spans, error) {
