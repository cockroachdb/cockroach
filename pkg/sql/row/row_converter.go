...
// TestingSetDatumRowConverterBatchSize sets kvDatumRowConverterBatchSize and returns old value.
func TestingSetDatumRowConverterBatchSize(newSize int) int {
	oldValue := kvDatumRowConverterBatchSize
