...
// internally submitted low-priorority reads (like row-level TTL selects)
...
func (f *txnKVFetcher) maybeAdmitBatchResponse(ctx context.Context, br *kvpb.BatchResponse) error {
	...
	if f.admissionPacer != nil {
		...
		// mechanism (the work is elastic in nature using the slots based
