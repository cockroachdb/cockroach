...
type Payload struct {
	...
	LegacyModifiedMicros    int64                                                 `protobuf:"varint,5,opt,name=legacy_modified_micros,json=legacyModifiedMicros,proto3" json:"legacy_modified_micros,omitempty"`
...
func (*Progress) Descriptor() ([]byte, []int) { return fileDescriptorJobs, []int{8} }
...
func (m *Payload) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.LegacyModifiedMicros != 0 {
		dAtA[i] = 0x28
		i++
		i = encodeVarintJobs(dAtA, i, uint64(m.LegacyModifiedMicros))
	}
...
func (m *Payload) Size() (n int) {
	...
	if m.LegacyModifiedMicros != 0 {
		n += 1 + sovJobs(uint64(m.LegacyModifiedMicros))
	}
	if len(m.DescriptorIDs) > 0 {
		l = 0
...
func (m *Payload) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LegacyModifiedMicros", wireType)
			}
			m.LegacyModifiedMicros = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowJobs
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LegacyModifiedMicros |= (int64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorJobs = []byte{
	...
	,
}
