...
type BackupDetails struct {
	...
	ExportStorage cockroach_roachpb3.ExportStorage `protobuf:"bytes,3,opt,name=export_storage,json=exportStorage" json:"export_storage"`
}
...
func (m *BackupDetails) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x1a
	i++
	i = encodeVarintJobs(dAtA, i, uint64(m.ExportStorage.Size()))
	n3, err := m.ExportStorage.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n3
...
func (m *BackupDetails) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExportStorage", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.ExportStorage.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorJobs = []byte{
	...
	,
}
