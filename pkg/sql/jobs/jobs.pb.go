...
type ImportDetails_Table struct {
	...
	HasNullif bool   `protobuf:"varint,11,opt,name=has_nullif,json=hasNullif,proto3" json:"has_nullif,omitempty"`
	Nullif    string `protobuf:"bytes,12,opt,name=nullif,proto3" json:"nullif,omitempty"`
	SSTSize   int64  `protobuf:"varint,13,opt,name=sst_size,json=sstSize,proto3" json:"sst_size,omitempty"`
	Walltime  int64  `protobuf:"varint,14,opt,name=walltime,proto3" json:"walltime,omitempty"`
	Local     bool   `protobuf:"varint,15,opt,name=local,proto3" json:"local,omitempty"`
}
...
func (m *ImportDetails_Table) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field HasNullif", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorJobs = []byte{
	...
	,
}
