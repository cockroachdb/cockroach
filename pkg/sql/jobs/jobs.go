...
// HighwaterProgressedFn is a callback that computes a job's highwater mark
// given its details. It is safe to modify details in the callback; those
// modifications will be automatically persisted to the database record.
...
// job's FractionCompleted field to the value returned by progressedFn and
// persists progressedFn's modifications to the job's progress details, if any.
