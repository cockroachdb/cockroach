...
// uses its own liveness mechanism here since node-liveness for
// interactive behaviors (e.g. running queries) has different semantics
// from liveness used for multi-hour jobs.
//
...
func (r *Registry) lenientNow() hlc.Timestamp {
	...
	return r.clock.Now().Add(int64(-offset), 0)
}
