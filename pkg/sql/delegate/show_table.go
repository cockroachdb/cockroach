...
ORDER BY
	...
	return d.populateShowCreateTableQueryDetails(n.Name, showCreateQuery)
}
...
ORDER BY
	...
	return d.populateShowCreateTableQueryDetails(n.Table, getIndexesQuery)
}
...
ORDER BY
	...
	return d.populateShowCreateTableQueryDetails(n.Table, getColumnsQuery)
}
...
func (d *delegator) delegateShowConstraints(n *tree.ShowConstraints) (tree.Statement, error) {
	...
	return d.populateShowCreateTableQueryDetails(n.Table, getConstraintsQuery)
}
...
ORDER BY
	...
	return d.populateShowCreateTablesQueryDetails(unresolvedObjNames, showCreateQuery)
}
...
ORDER BY
	...
	return d.populateShowCreateTablesQueryDetails(nil, showCreateQuery)
}

// populateShowCreateTableQueryDetails returns the AST of a query which extracts
// information about the given table using the given query patterns in SQL.
// populateShowCreateTableQueryDetails is used for all SHOW CREATE commands
...
// populateShowCreateTablesQueryDetails returns the AST of a query which
// extracts information about the given table using the given query patterns
// in SQL.
// populateShowCreateTablesQueryDetails is used for SHOW CREATE TABLES and
...
//   %[4]s the table ID(s)
func (d *delegator) populateShowCreateTablesQueryDetails(
	names []*tree.UnresolvedObjectName, query string,
) (tree.Statement, error) {
