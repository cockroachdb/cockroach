...
func (p *planner) HasOwnershipOnSchema(ctx context.Context, schemaID descpb.ID) (bool, error) {
	...
	case catalog.SchemaTemporary:
		...
		// TODO(arul): This would mean every user has ownership over the temp schema,
		// which seems wrong. We currently lack the ability to track ownership of
		// the temp schema, as it doesn't have a schema descriptor.
