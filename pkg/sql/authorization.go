...
func (p *planner) CheckPrivilegeForUser(
	...
	if (user.IsRootUser() || user.IsAdminRole() || user.IsNodeUser()) &&
		...
		return pgerror.Newf(pgcode.InsufficientPrivilege,
			...
			user, privilegeKind, privilegeObject.GetObjectTypeName(), privilegeObject.GetName())
	}
...
func (p *planner) CheckAnyPrivilege(
	...
	return pgerror.Newf(pgcode.InsufficientPrivilege,
		...
		p.SessionData().User(), privilegeObject.GetObjectTypeName(), privilegeObject.GetName())
}
