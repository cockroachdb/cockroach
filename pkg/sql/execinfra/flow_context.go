...
type FlowCtx struct {
	...
	// ParentMon is the parent monitor of Mon. It should not be used directly
	// and is only plumbed here for reporting memory usage for EXPLAIN ANALYZE
	// only of the _gateway_ flow.
