...
// source: sql/execinfra/execinfrapb/processors_table_stats.proto
...
func (SketchType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_table_stats_d393be2ea52e4b9d, []int{0}
}
...
func (*SamplerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_table_stats_d393be2ea52e4b9d, []int{1}
}
...
func (*SampleAggregatorSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_table_stats_d393be2ea52e4b9d, []int{2}
}
...
func init() {
	proto.RegisterFile("sql/execinfra/execinfrapb/processors_table_stats.proto", fileDescriptor_processors_table_stats_d393be2ea52e4b9d)
}

var fileDescriptor_processors_table_stats_d393be2ea52e4b9d = []byte{
	// 620 bytes of a gzipped FileDescriptorProto
	,
}
