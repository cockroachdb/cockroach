...
// source: sql/execinfra/execinfrapb/processors.proto
...
func (*ProcessorSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_d936d2919b5e9175, []int{0}
}
...
func (*ProcessorCoreUnion) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_d936d2919b5e9175, []int{1}
}
...
func (*NoopCoreSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_d936d2919b5e9175, []int{2}
}
...
func (*LocalPlanNodeSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_d936d2919b5e9175, []int{3}
}
...
func (*MetadataTestSenderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_d936d2919b5e9175, []int{4}
}
...
func (*MetadataTestReceiverSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_d936d2919b5e9175, []int{5}
}
...
func init() {
	proto.RegisterFile("sql/execinfra/execinfrapb/processors.proto", fileDescriptor_processors_d936d2919b5e9175)
}

var fileDescriptor_processors_d936d2919b5e9175 = []byte{
	// 1090 bytes of a gzipped FileDescriptorProto
	,
}
