...
type ServerConfig struct {
	...
	// SecretDirectory is the absolute local file path under which sink
	// credential files (e.g. the JWT client assertion referenced by a
	// changefeed via sasl_proprietary_client_assertion_location) may be read.
	// Empty disables file-based credential references.
