...
func MakeDistSQLMetrics(histogramWindow time.Duration) DistSQLMetrics {
	return DistSQLMetrics{
		...
		MaxBytesHist:          metric.NewHistogram(metaMemMaxBytes, histogramWindow, metric.MemoryUsage16MBBuckets),
		CurBytesCount:         metric.NewGauge(metaMemCurBytes),
		VecOpenFDs:            metric.NewGauge(metaVecOpenFDs),
		CurDiskBytesCount:     metric.NewGauge(metaDiskCurBytes),
		MaxDiskBytesHist:      metric.NewHistogram(metaDiskMaxBytes, histogramWindow, metric.MemoryUsage16MBBuckets),
