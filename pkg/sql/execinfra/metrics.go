...
type DistSQLMetrics struct {
	...
	CurByteDiskCount *metric.Gauge
	MaxDiskByteHist  *metric.Histogram
}
...
var (
	...
	metaDiskCurMonitors = metric.Metadata{
...
func MakeDistSQLMetrics(histogramWindow time.Duration) DistSQLMetrics {
	return DistSQLMetrics{
		...
		CurByteDiskCount: metric.NewGauge(metaDiskCurMonitors),
		MaxDiskByteHist:  metric.NewHistogram(metaDiskMaxMonitors, histogramWindow, log10int64times1000, 3),
	}
}
