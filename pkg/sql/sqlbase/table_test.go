...
func TestMarshalColumnValue(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			datum: func() (v parser.Datum) { v, _ = parser.ParseDDecimal("1234567890.123456890"); return }(),
			exp: func() (v roachpb.Value) {
				dDecimal, _ := parser.ParseDDecimal("1234567890.123456890")
				v.SetDecimal(&dDecimal.Decimal)
				return
			}(),
		},
		{
		...
		},
		{
			...
			datum: func() (v parser.Datum) {
				v, _ = parser.ParseDUuidFromString("63616665-6630-3064-6465-616462656562")
				return
			}(),
			exp: func() (v roachpb.Value) {
				dUUID, _ := parser.ParseDUuidFromString("63616665-6630-3064-6465-616462656562")
		...
		},
		{
			...
			datum: func() (v parser.Datum) { v, _ = parser.ParseDIPAddrFromINetString("192.168.0.1"); return }(),
			exp: func() (v roachpb.Value) {
				ipAddr, _ := parser.ParseDIPAddrFromINetString("192.168.0.1")
