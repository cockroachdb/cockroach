...
func (desc *ImmutableDatabaseDescriptor) SchemaDesc() *descpb.SchemaDescriptor {
	return nil
}

// TableDesc implements the ObjectDescriptor interface.
func (desc *ImmutableDatabaseDescriptor) TableDesc() *descpb.TableDescriptor {
	return nil
}

// TypeDesc implements the ObjectDescriptor interface.
func (desc *ImmutableDatabaseDescriptor) TypeDesc() *descpb.TypeDescriptor {
	return nil
}
...
// GetParentID implements the DescriptorInterface interface.
