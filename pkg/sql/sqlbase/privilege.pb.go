...
func (*UserPrivileges) Descriptor() ([]byte, []int) {
	return fileDescriptor_privilege_b03a44acf1e83c66, []int{0}
}
...
func (*PrivilegeDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_privilege_b03a44acf1e83c66, []int{1}
}
...
func init() {
	proto.RegisterFile("sql/sqlbase/privilege.proto", fileDescriptor_privilege_b03a44acf1e83c66)
}

var fileDescriptor_privilege_b03a44acf1e83c66 = []byte{
