...
// PartialIndexUpdateManager keeps track of partial indexes that should be not
...
// index.
type PartialIndexUpdateManager struct {
...
// Init initilizes a PartialIndexUpdateManager to track partial index IDs that
...
func (pm *PartialIndexUpdateManager) Init(
	partialIndexPutVals tree.Datums,
	partialIndexDelVals tree.Datums,
	tabDesc *ImmutableTableDescriptor,
) error {
	colIdx := 0
