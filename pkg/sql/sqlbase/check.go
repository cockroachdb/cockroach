...
// evaluation.
//
// In the Input mode, calles should call NewInputCheckHelper to initialize a new
// instance of CheckHelper. For each row, they call CheckInput with the boolean
// check columns.
...
// CheckInput expects checkEvals to already contain the boolean result of
