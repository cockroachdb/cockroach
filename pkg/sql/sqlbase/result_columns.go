...
type ResultColumn struct {
	...
	// TableID/ColumnID identify the source of the column, if it is a simple
	...
	ColumnID ColumnID // Column's number in source table (pg_attribute.attnum).
}
