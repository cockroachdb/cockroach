...
type TableDescriptor struct {
	...
	// This is used when dropping the view, to quickly access
	// the depended-on table descriptors where the DependedOn field
	// needs to be updated to reflect the drop.
	// This information is technically redundant with apparentSchema defined
	// below but needs to be preserved/maintained/populated to ensure
	// compatibility of newly created view descriptors with nodes running
	// previous versions.
	...
	ApparentSchema []TableDescriptor_SchemaDependency `protobuf:"bytes,28,rep,name=apparentSchema" json:"apparentSchema"`
}
...
func (m *TableDescriptor) GetApparentSchema() []TableDescriptor_SchemaDependency {
	if m != nil {
		return m.ApparentSchema
	}
	return nil
}
...
// The visible schema from the perspective of this view when it was
// created. Only populated for views.
type TableDescriptor_SchemaDependency struct {
	// The name of the relation being depended on,
	// from the perspective of this view at the time it was created.
	DatabaseName string `protobuf:"bytes,1,opt,name=database_name,json=databaseName" json:"database_name"`
	TableName    string `protobuf:"bytes,2,opt,name=table_name,json=tableName" json:"table_name"`
	// The ID of the relation being depended on.
	ID ID `protobuf:"varint,3,opt,name=id,casttype=ID" json:"id"`
	// The indexes visible to the view at the time of view creation are listed
	// here.
	IndexNames []string  `protobuf:"bytes,4,rep,name=index_names,json=indexNames" json:"index_names,omitempty"`
	IndexIDs   []IndexID `protobuf:"varint,5,rep,name=index_ids,json=indexIds,casttype=IndexID" json:"index_ids,omitempty"`
	// The columns visible to the view at the time of view creation are listed
	// here.
	ColumnNames []string   `protobuf:"bytes,6,rep,name=column_names,json=columnNames" json:"column_names,omitempty"`
	ColumnIDs   []ColumnID `protobuf:"varint,7,rep,name=column_ids,json=columnIds,casttype=ColumnID" json:"column_ids,omitempty"`
}

func (m *TableDescriptor_SchemaDependency) Reset()         { *m = TableDescriptor_SchemaDependency{} }
func (m *TableDescriptor_SchemaDependency) String() string { return proto.CompactTextString(m) }
func (*TableDescriptor_SchemaDependency) ProtoMessage()    {}
func (*TableDescriptor_SchemaDependency) Descriptor() ([]byte, []int) {
	return fileDescriptorStructured, []int{7, 5}
}
...
func init() {
	...
	proto.RegisterType((*TableDescriptor_SchemaDependency)(nil), "cockroach.sql.sqlbase.TableDescriptor.SchemaDependency")
...
func (m *TableDescriptor) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.ApparentSchema) > 0 {
		for _, msg := range m.ApparentSchema {
			dAtA[i] = 0xe2
			i++
			dAtA[i] = 0x1
			i++
...
func (m *TableDescriptor_SchemaDependency) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *TableDescriptor_SchemaDependency) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	dAtA[i] = 0xa
	i++
	i = encodeVarintStructured(dAtA, i, uint64(len(m.DatabaseName)))
...
func (m *TableDescriptor) Size() (n int) {
	...
	if len(m.ApparentSchema) > 0 {
		for _, e := range m.ApparentSchema {
			l = e.Size()
			n += 2 + l + sovStructured(uint64(l))
		}
	}
...
func (m *TableDescriptor_SchemaDependency) Size() (n int) {
	var l int
	_ = l
...
func (m *TableDescriptor) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 28:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ApparentSchema", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ApparentSchema = append(m.ApparentSchema, TableDescriptor_SchemaDependency{})
			if err := m.ApparentSchema[len(m.ApparentSchema)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *TableDescriptor_SchemaDependency) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SchemaDependency: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SchemaDependency: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorStructured = []byte{
	...
	,
}
