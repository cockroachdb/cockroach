...
type IndexDescriptor struct {
	...
	// For secondary indexes, an ordered list of IDs for the collated string
	// columns associated with the index.
	CollatedStringColumnIDs []ColumnID            `protobuf:"varint,13,rep,name=collated_string_column_ids,json=collatedStringColumnIds,casttype=ColumnID" json:"collated_string_column_ids,omitempty"`
...
func (m *IndexDescriptor) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.CollatedStringColumnIDs) > 0 {
		for _, num := range m.CollatedStringColumnIDs {
			dAtA[i] = 0x68
			i++
			i = encodeVarintStructured(dAtA, i, uint64(num))
		}
...
func (m *IndexDescriptor) Size() (n int) {
	...
	if len(m.CollatedStringColumnIDs) > 0 {
		for _, e := range m.CollatedStringColumnIDs {
			n += 1 + sovStructured(uint64(e))
		}
	}
	return n
	...
	for iNdEx < l {
		...
		case 13:
			if wireType == 0 {
				...
				m.CollatedStringColumnIDs = append(m.CollatedStringColumnIDs, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field CollatedStringColumnIDs", wireType)
			}
		default:
			iNdEx = preIndex
			skippy, err := skipStructured(dAtA[iNdEx:])
...
var fileDescriptorStructured = []byte{
	...
	,
}
