...
type DescriptorMutation struct {
	...
	// processing can resume in the event of a node failure.
	ResumeSpan []cockroach_roachpb1.Span `protobuf:"bytes,6,rep,name=resume_span,json=resumeSpan" json:"resume_span"`
}
...
func (m *DescriptorMutation) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.ResumeSpan) > 0 {
		for _, msg := range m.ResumeSpan {
			dAtA[i] = 0x32
			i++
			i = encodeVarintStructured(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *DescriptorMutation) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			m.ResumeSpan = append(m.ResumeSpan, cockroach_roachpb1.Span{})
			if err := m.ResumeSpan[len(m.ResumeSpan)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorStructured = []byte{
	...
	,
}
