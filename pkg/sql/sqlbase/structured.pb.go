...
type DescriptorMutation struct {
	...
	// The GC deadline is set when an index mutation is a DROP,
	// based on the current time and the GC TTL in the zone config. It's
	// the timestamp after which the index will be cleared
	// from the cluster. In nanoseconds since the epoch.
	GCDeadline int64 `protobuf:"varint,8,opt,name=gc_deadline,json=gcDeadline" json:"gc_deadline"`
}
...
type TableDescriptor struct {
	...
	// The columns or indexes being added or dropped in a FIFO order.
	...
	//
	// TODO(vivek) This is currently only used by the non-interleaved drop
	// index case. Also use for dropped interleaved indexes and columns.
	GCMutations []DescriptorMutation               `protobuf:"bytes,32,rep,name=gc_mutations,json=gcMutations" json:"gc_mutations"`
...
func (m *TableDescriptor) GetGCMutations() []DescriptorMutation {
	if m != nil {
...
func (m *DescriptorMutation) Size() (n int) {
	...
	n += 2
	n += 1 + sovStructured(uint64(m.GCDeadline))
	return n
}
...
func (m *TableDescriptor) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 32:
			...
			m.GCMutations = append(m.GCMutations, DescriptorMutation{})
...
var fileDescriptorStructured = []byte{
	...
	,
}
