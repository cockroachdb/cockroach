...
type ColumnDescriptor struct {
	...
	// Id of a sequence used in this column's DEFAULT expression, in a call to nextval().
	// null if no sequence is used.
	UsesSequenceId *ID `protobuf:"varint,10,opt,name=uses_sequence_id,json=usesSequenceId,casttype=ID" json:"uses_sequence_id,omitempty"`
}
...
func (m *ColumnDescriptor) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	if m.UsesSequenceId != nil {
		dAtA[i] = 0x50
		i++
		i = encodeVarintStructured(dAtA, i, uint64(*m.UsesSequenceId))
	}
	return i, nil
}
...
func (m *ColumnDescriptor) Size() (n int) {
	...
	n += 2
	if m.UsesSequenceId != nil {
		n += 1 + sovStructured(uint64(*m.UsesSequenceId))
	}
	return n
}
...
func (m *ColumnDescriptor) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field UsesSequenceId", wireType)
			}
			var v ID
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorStructured = []byte{
	...
	,
}
