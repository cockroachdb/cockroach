...
type IndexDescriptor struct {
	...
	// For secondary indexes, SplitKeyColumnIDs contains an ordered list of IDs of
	// columns that appear in the index and have a split key encoding. Includes
	// IDs from both column_ids and extra_column_ids.
	SplitKeyColumnIDs []ColumnID            `protobuf:"varint,13,rep,name=split_key_column_ids,json=splitKeyColumnIds,casttype=ColumnID" json:"split_key_column_ids,omitempty"`
...
func (m *IndexDescriptor) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.SplitKeyColumnIDs) > 0 {
		for _, num := range m.SplitKeyColumnIDs {
			dAtA[i] = 0x68
			i++
			i = encodeVarintStructured(dAtA, i, uint64(num))
		}
...
func (m *IndexDescriptor) Size() (n int) {
	...
	if len(m.SplitKeyColumnIDs) > 0 {
		for _, e := range m.SplitKeyColumnIDs {
			n += 1 + sovStructured(uint64(e))
		}
	}
	return n
	...
	for iNdEx < l {
		...
		case 13:
			if wireType == 0 {
				...
				m.SplitKeyColumnIDs = append(m.SplitKeyColumnIDs, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field SplitKeyColumnIDs", wireType)
			}
		default:
			iNdEx = preIndex
			skippy, err := skipStructured(dAtA[iNdEx:])
...
var fileDescriptorStructured = []byte{
	...
	,
}
