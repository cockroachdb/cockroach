...
const (
	...
	// yet complete. If validation fails, the constraint will be dropped. This
	// state is unique to constraints being added using ADD CONSTRAINT, and
	// indicates that the constraint should be dropped on failure. Unvalidated
	// constraints undergoing validation using VALIDATE CONSTRAINT never enter
	// this state.
...
func (ConstraintValidity) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_structured_61e3c58a0c55decd, []int{0}
}
...
func (ForeignKeyReference_Action) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_structured_61e3c58a0c55decd, []int{0, 0}
}
...
func (ForeignKeyReference_Match) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_structured_61e3c58a0c55decd, []int{0, 1}
}
...
func (IndexDescriptor_Direction) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_structured_61e3c58a0c55decd, []int{5, 0}
}
...
func (IndexDescriptor_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_structured_61e3c58a0c55decd, []int{5, 1}
}
...
func (ConstraintToUpdate_ConstraintType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_structured_61e3c58a0c55decd, []int{6, 0}
}

type ConstraintToUpdate_UpdateType int32

const (
	// The constraint needs to be added (and possibly validated for existing rows before being made public)
	ConstraintToUpdate_ADD_CONSTRAINT ConstraintToUpdate_UpdateType = 0
	// The constraint already exists, and needs to be validated
	ConstraintToUpdate_VALIDATE_CONSTRAINT ConstraintToUpdate_UpdateType = 1
)

var ConstraintToUpdate_UpdateType_name = map[int32]string{
	0: "ADD_CONSTRAINT",
	1: "VALIDATE_CONSTRAINT",
}
var ConstraintToUpdate_UpdateType_value = map[string]int32{
	"ADD_CONSTRAINT":      0,
	"VALIDATE_CONSTRAINT": 1,
}

func (x ConstraintToUpdate_UpdateType) Enum() *ConstraintToUpdate_UpdateType {
	p := new(ConstraintToUpdate_UpdateType)
	*p = x
	return p
}
func (x ConstraintToUpdate_UpdateType) String() string {
	return proto.EnumName(ConstraintToUpdate_UpdateType_name, int32(x))
}
func (x *ConstraintToUpdate_UpdateType) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(ConstraintToUpdate_UpdateType_value, data, "ConstraintToUpdate_UpdateType")
	if err != nil {
		return err
	}
	*x = ConstraintToUpdate_UpdateType(value)
	return nil
}
func (ConstraintToUpdate_UpdateType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_structured_61e3c58a0c55decd, []int{6, 1}
}
...
func (DescriptorMutation_State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_structured_61e3c58a0c55decd, []int{7, 0}
}
...
func (DescriptorMutation_Direction) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_structured_61e3c58a0c55decd, []int{7, 1}
}
...
func (TableDescriptor_State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_structured_61e3c58a0c55decd, []int{8, 0}
}
...
func (TableDescriptor_AuditMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_structured_61e3c58a0c55decd, []int{8, 1}
}
...
func (*ColumnDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_61e3c58a0c55decd, []int{1}
}
...
func (*ColumnFamilyDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_61e3c58a0c55decd, []int{2}
}
...
func (*InterleaveDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_61e3c58a0c55decd, []int{3}
}
...
func (*InterleaveDescriptor_Ancestor) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_61e3c58a0c55decd, []int{3, 0}
}
...
func (*PartitioningDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_61e3c58a0c55decd, []int{4}
}
...
func (*PartitioningDescriptor_List) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_61e3c58a0c55decd, []int{4, 0}
}
...
func (*PartitioningDescriptor_Range) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_61e3c58a0c55decd, []int{4, 1}
}
...
func (*IndexDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_61e3c58a0c55decd, []int{5}
}
...
// ConstraintToUpdate represents a constraint to be added or validated. This
// mutation effects changes only in the backfill step of the schema changer, as
// follows:
//
// In the case where a constraint is added and needs to be validated for
// existing rows, a new version of the table descriptor with the constraint
...
//
// If the constraint already exists and just needs to be validated, then only
// the validation query is run.
//
// Adding a constraint without the validation step, with ADD CONSTRAINT ... NOT
// VALID, is not yet supported.
type ConstraintToUpdate struct {
	...
	UpdateType           ConstraintToUpdate_UpdateType     `protobuf:"varint,7,opt,name=update_type,json=updateType,enum=cockroach.sql.sqlbase.ConstraintToUpdate_UpdateType" json:"update_type"`
	XXX_NoUnkeyedLiteral struct{}                          `json:"-"`
	XXX_sizecache        int32                             `json:"-"`
}
...
func (*ConstraintToUpdate) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_61e3c58a0c55decd, []int{6}
}
...
func (*DescriptorMutation) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_61e3c58a0c55decd, []int{7}
}
...
func (*TableDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_61e3c58a0c55decd, []int{8}
}
...
func (*TableDescriptor_NameInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_61e3c58a0c55decd, []int{8, 2}
}
...
func (*TableDescriptor_Reference) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_61e3c58a0c55decd, []int{8, 3}
}
...
func (*TableDescriptor_MutationJob) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_61e3c58a0c55decd, []int{8, 4}
}
...
func (*TableDescriptor_SequenceOpts) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_61e3c58a0c55decd, []int{8, 5}
}
...
func (*TableDescriptor_Replacement) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_61e3c58a0c55decd, []int{8, 6}
}
...
func (*TableDescriptor_GCDescriptorMutation) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_61e3c58a0c55decd, []int{8, 7}
}
...
func (*DatabaseDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_61e3c58a0c55decd, []int{9}
}
...
func (*Descriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_structured_61e3c58a0c55decd, []int{10}
}
...
func init() {
	...
	proto.RegisterEnum("cockroach.sql.sqlbase.ConstraintToUpdate_UpdateType", ConstraintToUpdate_UpdateType_name, ConstraintToUpdate_UpdateType_value)
...
func (m *ConstraintToUpdate) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x38
	i++
	i = encodeVarintStructured(dAtA, i, uint64(m.UpdateType))
	return i, nil
}
...
func (m *ConstraintToUpdate) Size() (n int) {
	...
	n += 1 + sovStructured(uint64(m.UpdateType))
	return n
}
	...
	for iNdEx < l {
		...
		case 7:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.UpdateType |= (ConstraintToUpdate_UpdateType(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func init() {
	proto.RegisterFile("sql/sqlbase/structured.proto", fileDescriptor_structured_61e3c58a0c55decd)
}

var fileDescriptor_structured_61e3c58a0c55decd = []byte{
	...
	,
}
