...
type PartitioningDescriptor_Range struct {
	// Name is the partition name.
	Name string `protobuf:"bytes,1,opt,name=name" json:"name"`
	// From is the inclusive lower bound of this range partition. It is encoded
	// with the EncDatum value encoding. MINVALUE and MAXVALUE are encoded as
	// NOT NULL followed by a PartitionSpecialValCode encoded as a non-sorting
	// uvarint.
	From []byte `protobuf:"bytes,3,opt,name=from" json:"from,omitempty"`
	// To is the exclusive upper bound of this range partition. It is encoded
	// in the smae way as From..
...
func (m *PartitioningDescriptor_Range) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.To != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintStructured(dAtA, i, uint64(len(m.To)))
		i += copy(dAtA[i:], m.To)
	}
	if m.From != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintStructured(dAtA, i, uint64(len(m.From)))
...
var fileDescriptorStructured = []byte{
	...
	,
}
