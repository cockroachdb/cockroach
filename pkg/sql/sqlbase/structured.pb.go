...
type TableDescriptor struct {
	...
	// renamed multiple times before the schema change is processed, there will be
	...
	// Replaced can be set to the ID of a table that was replaced by this one --
	// e.g. when TRUNCATE creates a replacement of a table and swaps it in for the
	// the old name, it can note the old table's ID. This can be used when trying
	// to track the history of a table across a truncatation.
	Replaced ID `protobuf:"varint,30,opt,name=replaced,casttype=ID" json:"replaced"`
}
...
func (m *TableDescriptor) GetReplaced() ID {
	if m != nil {
		return m.Replaced
	}
	return 0
...
func (m *TableDescriptor) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x1
	i++
	i = encodeVarintStructured(dAtA, i, uint64(m.Replaced))
	return i, nil
}
...
func (m *TableDescriptor) Size() (n int) {
	...
	n += 2 + sovStructured(uint64(m.Replaced))
	return n
}
...
func (m *TableDescriptor) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 30:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Replaced", wireType)
			}
			m.Replaced = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorStructured = []byte{
	...
	,
}
