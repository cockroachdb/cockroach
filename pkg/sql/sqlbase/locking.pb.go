...
// during the intial scan instead of waiting until the mutation to acquire a
...
func (ScanLockingStrength) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_locking_6062bb649214c66a, []int{0}
}
...
func (ScanLockingWaitPolicy) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_locking_6062bb649214c66a, []int{1}
}
...
func init() { proto.RegisterFile("sql/sqlbase/locking.proto", fileDescriptor_locking_6062bb649214c66a) }

var fileDescriptor_locking_6062bb649214c66a = []byte{
