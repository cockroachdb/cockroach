...
func NewCCLRequiredError(err error) error {
	return pgerror.WithDefaultCode(err, pgerror.CodeCCLRequired)
}
...
var NewStatementCompletionUnknownError = pgerror.NewStatementCompletionUnknownError
