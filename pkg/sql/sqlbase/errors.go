...
// returned for a COMMIT/RELEASE SAVEPOINT - there manual inspection may be
// necessary to check whether the transaction committed. When this is returned
// for other statements, the transaction has been rolled back (like it is for
// any errors).
//
