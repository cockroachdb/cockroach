...
func ColumnMutationFilter(m DescriptorMutation) bool {
	return m.GetColumn() != nil &&
		(m.Direction == DescriptorMutation_ADD || m.Direction == DescriptorMutation_DROP)
}
...
func (ib *IndexBackfiller) BuildIndexEntriesChunk(
	ctx context.Context, txn *client.Txn, tableDesc TableDescriptor, sp roachpb.Span, chunkSize int64,
