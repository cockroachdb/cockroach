...
type DescriptorInterfaces []DescriptorInterface
...
func GetDatabaseDescFromID(
	...
	MaybeSetDescriptorModificationTimeFromMVCCTimestamp(ctx, desc, ts)
...
// in a similar way.
//
// TODO(ajwerner): Get rid of this function.
func GetTableDescFromID(
	...
	if err := MaybeFillInDescriptor(ctx, protoGetter, codec, table); err != nil {
		return nil, err
	}
...
func GetTableDescFromIDWithFKsChanged(
	ctx context.Context, protoGetter protoGetter, codec keys.SQLCodec, id descpb.ID,
) (*descpb.TableDescriptor, bool, error) {
	table, err := getTableDescFromIDRaw(ctx, protoGetter, codec, id)
	if err != nil {
		return nil, false, err
	}
	maybeUpgradeFormatVersion(table)
	descpb.MaybeFixPrivileges(table.ID, table.Privileges)
	changed, err := MaybeUpgradeForeignKeyRepresentation(ctx, protoGetter, codec,
		false /* skipFKsWithNoMatchingTable */, table)
	if err != nil {
		return nil, false, err
	}
...
func MaybeFillInDescriptor(
	ctx context.Context, protoGetter protoGetter, codec keys.SQLCodec, desc *descpb.TableDescriptor,
) error {
	maybeUpgradeFormatVersion(desc)
	descpb.MaybeFixPrivileges(desc.ID, desc.Privileges)

	if protoGetter != nil {
		if _, err := MaybeUpgradeForeignKeyRepresentation(ctx, protoGetter, codec, false /* skipFKsWithNoMatchingTable*/, desc); err != nil {
			return err
		}
	}
	return nil
...
func ForEachExprStringInTableDesc(
	descI TableDescriptorInterface, f func(expr *string) error,
) error {
...
func (desc *ImmutableTableDescriptor) GetAllReferencedTypeIDs(
	getType func(descpb.ID) (TypeDescriptorInterface, error),
) (descpb.IDs, error) {
...
func (desc *ImmutableTableDescriptor) validateCrossReferences(
	...
	getType := func(id descpb.ID) (TypeDescriptorInterface, error) {
...
func (desc *MutableTableDescriptor) TableDesc() *descpb.TableDescriptor {
...
func (desc *MutableTableDescriptor) TypeDesc() *descpb.TypeDescriptor {
	return nil
}

// DatabaseDesc implements the ObjectDescriptor interface.
func (desc *ImmutableTableDescriptor) DatabaseDesc() *descpb.DatabaseDescriptor {
	return nil
}

// SchemaDesc implements the ObjectDescriptor interface.
func (desc *ImmutableTableDescriptor) SchemaDesc() *descpb.SchemaDescriptor {
	return nil
}
...
// TypeDesc implements the ObjectDescriptor interface.
func (desc *ImmutableTableDescriptor) TypeDesc() *descpb.TypeDescriptor {
	return nil
}
