...
type MutableTableDescriptor struct {
	...
	// QueuedMutations indicates that the table descriptor has a schema changer queued
	// with a valid mutation ID.
	QueuedMutations bool

	// NumFinalizedMutations is the count of mutations associated with a job.
	NumFinalizedMutations int

	// MutationJobID is the ID of the created job for all of the finalized mutations
