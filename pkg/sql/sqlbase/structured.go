...
// Create a MutableTableDescriptor from the ImmutableTableDescriptor by making the
// first mutation public. This is super valuable when trying to run SQL over data
// associated with a schema mutation that is still not yet public: Data validation,
// error reporting.
