...
func (ru *RowUpdater) UpdateRow(
	...
	for i, newSecondaryIndexEntry := range newSecondaryIndexEntries {
		...
		secondaryValueChanged := !bytes.Equal(newSecondaryIndexEntry.Value.RawBytes,
			secondaryIndexEntry.Value.RawBytes)
		...
		} else if secondaryValueChanged {
			expValue = &secondaryIndexEntry.Value
		}
		if secondaryKeyChanged || secondaryValueChanged {
