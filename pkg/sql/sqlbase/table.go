...
// MakePrimaryIndexKey creates a key that refers to a table row (in the primary
// index); it is intended for tests. The value types must match the primary key
// columns; supported types are:
//  - Datum
