...
func SanitizeVarFreeExpr(
	...
	// context.
	defer func(sp tree.ScalarProperties) { semaCtx.DerivedProperties = sp }(semaCtx.DerivedProperties)
	...
	// Make sure there are no aggregation/window/generator functions in the expression.
	if err := AssertNoSpecialFunctions(context,
		false /* agg */, false /* win */, false /* gen */, allowImpure,
		semaCtx,
	); err != nil {
		return nil, err
	}
