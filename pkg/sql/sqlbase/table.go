...
type tableLookupFn func(descpb.ID) (TableDescriptorInterface, error)
...
func (desc *ImmutableTableDescriptor) GetConstraintInfo(
	...
	if txn != nil {
		tableLookup = func(id descpb.ID) (TableDescriptorInterface, error) {
...
func FindFKReferencedIndex(
	referencedTable TableDescriptorInterface, referencedColIDs descpb.ColumnIDs,
...
func FindFKOriginIndex(
	originTable *descpb.TableDescriptor, originColIDs descpb.ColumnIDs,
) (*descpb.IndexDescriptor, error) {
...
func ConditionalGetTableDescFromTxn(
	ctx context.Context, txn *kv.Txn, codec keys.SQLCodec, expectation TableDescriptorInterface,
) ([]byte, error) {
