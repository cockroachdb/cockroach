...
type tableInfo struct {
	...
	// The "sideband" fields computed as kvs are iterated. They're only
	// meaningful to clients of RowFetcher immediately after NextRow has
	// returned a non-nil row.
	//
