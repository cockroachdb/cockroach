...
// GetParentSchemaID implements the DescriptorInterface interface.
...
func (desc *ImmutableSchemaDescriptor) DatabaseDesc() *descpb.DatabaseDescriptor {
	return nil
}
...
func (desc *ImmutableSchemaDescriptor) TableDesc() *descpb.TableDescriptor {
	return nil
}

// TypeDesc implements the ObjectDescriptor interface.
func (desc *ImmutableSchemaDescriptor) TypeDesc() *descpb.TypeDescriptor {
	return nil
}

// Adding implements the DescriptorInterface interface.
func (desc *ImmutableSchemaDescriptor) Adding() bool {
	return false
}

// Dropped implements the DescriptorInterface interface.
func (desc *ImmutableSchemaDescriptor) Dropped() bool {
	return false
}

// Offline implements the DescriptorInterface interface.
func (desc *ImmutableSchemaDescriptor) Offline() bool {
	return false
}

// GetOfflineReason implements the DescriptorInterface interface.
