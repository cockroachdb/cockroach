...
CREATE TABLE system.scheduled_jobs (
    ...
    FAMILY sched (schedule_id, next_run, schedule_status),
    FAMILY other (
...
var (
	...
	ScheduledJobsTable = NewImmutableTableDescriptor(descpb.TableDescriptor{
		...
		Columns: []descpb.ColumnDescriptor{
			...
			{Name: "schedule_status", ID: 6, Type: types.String, Nullable: true},
		...
		Families: []descpb.ColumnFamilyDescriptor{
			{
				Name:            "sched",
				ID:              0,
				ColumnNames:     []string{"schedule_id", "next_run", "schedule_status"},
