...
var (
	...
	CommentsTable = TableDescriptor{
		...
		Version:                 1,
		Columns: []ColumnDescriptor{
			{Name: "type", ID: 1, LogicalColumnID: 1, Type: *types.Int},
			{Name: "object_id", ID: 2, LogicalColumnID: 2, Type: *types.Int},
			{Name: "sub_id", ID: 3, LogicalColumnID: 3, Type: *types.Int},
			{Name: "comment", ID: 4, LogicalColumnID: 4, Type: *types.String},
		},
		NextColumnID: 5,
		Families: []ColumnFamilyDescriptor{
	...
	ReportsMetaTable = TableDescriptor{
		...
		Columns: []ColumnDescriptor{
			{Name: "id", ID: 1, LogicalColumnID: 1, Type: *types.Int},
			{Name: "generated", ID: 2, LogicalColumnID: 2, Type: *types.TimestampTZ},
		},
		NextColumnID: 3,
		Families: []ColumnFamilyDescriptor{
			{
	...
	ReplicationConstraintStatsTable = TableDescriptor{
		...
		Version:                 1,
		Columns: []ColumnDescriptor{
			{Name: "zone_id", ID: 1, LogicalColumnID: 1, Type: *types.Int},
			{Name: "subzone_id", ID: 2, LogicalColumnID: 2, Type: *types.Int},
			{Name: "type", ID: 3, LogicalColumnID: 3, Type: *types.String},
			{Name: "config", ID: 4, LogicalColumnID: 4, Type: *types.String},
			{Name: "report_id", ID: 5, LogicalColumnID: 5, Type: *types.Int},
			{Name: "violation_start", ID: 6, LogicalColumnID: 6, Type: *types.TimestampTZ, Nullable: true},
			{Name: "violating_ranges", ID: 7, LogicalColumnID: 7, Type: *types.Int},
		},
		NextColumnID: 8,
		Families: []ColumnFamilyDescriptor{
			{
	...
	ReplicationCriticalLocalitiesTable = TableDescriptor{
		...
		Columns: []ColumnDescriptor{
			{Name: "zone_id", ID: 1, LogicalColumnID: 1, Type: *types.Int},
			{Name: "subzone_id", ID: 2, LogicalColumnID: 2, Type: *types.Int},
			{Name: "locality", ID: 3, LogicalColumnID: 3, Type: *types.String},
			{Name: "report_id", ID: 4, LogicalColumnID: 4, Type: *types.Int},
			{Name: "at_risk_ranges", ID: 5, LogicalColumnID: 5, Type: *types.Int},
		},
		NextColumnID: 6,
		Families: []ColumnFamilyDescriptor{
			{
	...
	ReplicationStatsTable = TableDescriptor{
		...
		Columns: []ColumnDescriptor{
			{Name: "zone_id", ID: 1, LogicalColumnID: 1, Type: *types.Int},
			{Name: "subzone_id", ID: 2, LogicalColumnID: 2, Type: *types.Int},
			{Name: "report_id", ID: 3, LogicalColumnID: 3, Type: *types.Int},
			{Name: "total_ranges", ID: 4, LogicalColumnID: 4, Type: *types.Int},
			{Name: "unavailable_ranges", ID: 5, LogicalColumnID: 5, Type: *types.Int},
			{Name: "under_replicated_ranges", ID: 6, LogicalColumnID: 6, Type: *types.Int},
			{Name: "over_replicated_ranges", ID: 7, LogicalColumnID: 7, Type: *types.Int},
		},
		NextColumnID: 8,
		Families: []ColumnFamilyDescriptor{
			{
	...
	ProtectedTimestampsMetaTable = TableDescriptor{
		...
		Columns: []ColumnDescriptor{
			...
			{Name: "version", ID: 2, LogicalColumnID: 2, Type: *types.Int},
			{Name: "num_records", ID: 3, LogicalColumnID: 3, Type: *types.Int},
			{Name: "num_spans", ID: 4, LogicalColumnID: 4, Type: *types.Int},
			{Name: "total_bytes", ID: 5, LogicalColumnID: 5, Type: *types.Int},
		},
	...
	ProtectedTimestampsRecordsTable = TableDescriptor{
		...
		Version:                 1,
		Columns: []ColumnDescriptor{
			{Name: "id", ID: 1, LogicalColumnID: 1, Type: *types.Uuid},
			{Name: "ts", ID: 2, LogicalColumnID: 2, Type: *types.Decimal},
			{Name: "meta_type", ID: 3, LogicalColumnID: 3, Type: *types.String},
			{Name: "meta", ID: 4, LogicalColumnID: 4, Type: *types.Bytes, Nullable: true},
			{Name: "num_spans", ID: 5, LogicalColumnID: 5, Type: *types.Int},
			{Name: "spans", ID: 6, LogicalColumnID: 6, Type: *types.Bytes},
			{Name: "verified", ID: 7, LogicalColumnID: 7, Type: *types.Bool, DefaultExpr: &falseBoolString},
		},
		NextColumnID: 8,
		Families: []ColumnFamilyDescriptor{
			{
	...
	RoleOptionsTable = TableDescriptor{
		...
		Columns: []ColumnDescriptor{
			{Name: "username", ID: 1, LogicalColumnID: 1, Type: *types.String},
			{Name: "option", ID: 2, LogicalColumnID: 2, Type: *types.String},
			{Name: "value", ID: 3, LogicalColumnID: 3, Type: *types.String, Nullable: true},
		},
		NextColumnID: 4,
		Families: []ColumnFamilyDescriptor{
			{
	...
	StatementBundleChunksTable = TableDescriptor{
		...
		Columns: []ColumnDescriptor{
			{Name: "id", ID: 1, LogicalColumnID: 1, Type: *types.Int, DefaultExpr: &uniqueRowIDString},
			{Name: "description", ID: 2, LogicalColumnID: 2, Type: *types.String, Nullable: true},
			{Name: "data", ID: 3, LogicalColumnID: 3, Type: *types.Bytes},
		},
		NextColumnID: 4,
		Families: []ColumnFamilyDescriptor{
			{
	...
	StatementDiagnosticsRequestsTable = TableDescriptor{
		...
		Version:                 1,
		Columns: []ColumnDescriptor{
			{Name: "id", ID: 1, LogicalColumnID: 1, Type: *types.Int, DefaultExpr: &uniqueRowIDString, Nullable: false},
			{Name: "completed", ID: 2, LogicalColumnID: 2, Type: *types.Bool, Nullable: false, DefaultExpr: &falseBoolString},
			{Name: "statement_fingerprint", ID: 3, LogicalColumnID: 3, Type: *types.String, Nullable: false},
			{Name: "statement_diagnostics_id", ID: 4, LogicalColumnID: 4, Type: *types.Int, Nullable: true},
			{Name: "requested_at", ID: 5, LogicalColumnID: 5, Type: *types.TimestampTZ, Nullable: false},
		},
		NextColumnID: 6,
		Families: []ColumnFamilyDescriptor{
			{
	...
	StatementDiagnosticsTable = TableDescriptor{
		...
		Columns: []ColumnDescriptor{
			{Name: "id", ID: 1, LogicalColumnID: 1, Type: *types.Int, DefaultExpr: &uniqueRowIDString, Nullable: false},
			{Name: "statement_fingerprint", ID: 2, LogicalColumnID: 2, Type: *types.String, Nullable: false},
			{Name: "statement", ID: 3, LogicalColumnID: 3, Type: *types.String, Nullable: false},
			{Name: "collected_at", ID: 4, LogicalColumnID: 4, Type: *types.TimestampTZ, Nullable: false},
			{Name: "trace", ID: 5, LogicalColumnID: 5, Type: *types.Jsonb, Nullable: true},
