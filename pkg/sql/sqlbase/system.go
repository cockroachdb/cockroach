...
var (
	...
	StatementExecutionsTable = TableDescriptor{
		...
		Columns: []ColumnDescriptor{
			...
			{Name: "statement_key", ID: 5, Type: colTypeString},
			{Name: "application_name", ID: 6, Type: colTypeString},
			{Name: "distributed", ID: 7, Type: colTypeBool},
			{Name: "optimized", ID: 8, Type: colTypeBool},
			{Name: "automatic_retry_count", ID: 9, Type: colTypeInt},
			{Name: "error", ID: 10, Type: colTypeString, Nullable: true},
			{Name: "rows_affected", ID: 11, Type: colTypeInt},
			{Name: "parse_lat", ID: 12, Type: colTypeInterval},
			{Name: "plan_lat", ID: 13, Type: colTypeInterval},
			{Name: "run_lat", ID: 14, Type: colTypeInterval},
			{Name: "service_lat", ID: 15, Type: colTypeInterval},
		},
		NextColumnID: 16,
		Families: []ColumnFamilyDescriptor{
