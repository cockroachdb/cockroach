...
// considered for a split. If it is a database or a view table descriptor,
// it should not be considered. Similarly, neither user-defined types nor
// user-defined schemas should be considered. Only plain tables are
