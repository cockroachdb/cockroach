...
const SystemColumnCount = 0
const MVCCTimestampColumnName = "mvcc_timestamp"

var MVCCTimestampColumnType = types.Decimal

// TODO (rohany): Should be changed to a function.
var MVCCTimestampColumn = ColumnDescriptor{
	Name:     MVCCTimestampColumnName,
	Type:     MVCCTimestampColumnType,
	Hidden:   true,
	Nullable: true,
	// Not sure where I can use this yet.
	SystemColumnKind: ColumnDescriptor_MVCCTIMESTAMP,
}
