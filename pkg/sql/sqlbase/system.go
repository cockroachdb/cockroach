...
CREATE TABLE system.table_statistics (
	...
	FAMILY("tableID", "statisticID", name, "columnIDs", "createdAt", "rowCount", "distinctCount", "nullValues", histogram)
);`
)
...
var (
	...
	TableStatisticsTable = TableDescriptor{
		...
		Columns: []ColumnDescriptor{
			...
			{Name: "nullValues", ID: 8, Type: colTypeInt},
			{Name: "histogram", ID: 9, Type: colTypeBytes, Nullable: true},
		},
		NextColumnID: 10,
		Families: []ColumnFamilyDescriptor{
			{
				Name: "fam_0_tableID_statisticID_name_columnIDs_createdAt_rowCount_distinctCount_nullValues_histogram",
				ID:   0,
				ColumnNames: []string{
					"tableID",
					"statisticID",
