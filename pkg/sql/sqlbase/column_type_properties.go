...
// InformationSchemaVisibleType returns the string suitable to populate the
// data_type column of information_schema.columns.
//
...
// It returns nil if there is no such type.
//
// This is a lossy conversion - many type attributes are not preserved.
