...
func (*JsonbColType) castTargetType()          {}
...
// JsonbColType represents the JSONB column type.
type JsonbColType struct{}

// Format implements the NodeFormatter interface.
func (node *JsonbColType) Format(buf *bytes.Buffer, _ FmtFlags) {
	buf.WriteString("JSONB")
}

// Pre-allocated immutable JSONB column type.
var jsonbColType = &JsonbColType{}
...
func (node *JsonbColType) String() string          { return AsString(node) }
