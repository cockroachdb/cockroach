...
func TestParse2(t *testing.T) {
	testData := []struct {
		...
		{`SHOW TRACE FOR SELECT 42`,
			`SET TRACING = 'assert_off', 'on', 'results'; SELECT 42; SET TRACING = 'off'; SHOW TRACE FOR SESSION`},
		{`SHOW TRACE FOR TABLE foo`,
			`SET TRACING = 'assert_off', 'on', 'results'; TABLE foo; SET TRACING = 'off'; SHOW TRACE FOR SESSION`},
		{`SHOW KV TRACE FOR TABLE foo`,
			`SET TRACING = 'assert_off', 'on', 'results', 'kv'; TABLE foo; SET TRACING = 'off'; SHOW KV TRACE FOR SESSION`},
		{`SHOW COMPACT TRACE FOR TABLE foo`,
			`SET TRACING = 'assert_off', 'on', 'results'; TABLE foo; SET TRACING = 'off'; SHOW COMPACT TRACE FOR SESSION`},
		{`SHOW COMPACT KV TRACE FOR TABLE foo`,
			`SET TRACING = 'assert_off', 'on', 'results', 'kv'; TABLE foo; SET TRACING = 'off'; SHOW COMPACT KV TRACE FOR SESSION`},
		{`SHOW EXPERIMENTAL_REPLICA TRACE FOR SELECT 42`,
			`SET TRACING = 'assert_off', 'on', 'results'; SELECT 42; SET TRACING = 'off'; SHOW EXPERIMENTAL_REPLICA TRACE FOR SESSION`},
