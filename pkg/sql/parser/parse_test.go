...
$function$`,
		...
		{
			`ALTER TABLE a SET LOCALITY PARTITIONED REGIONAL`,
			`ALTER TABLE a SET LOCALITY REGIONAL BY ROW`,
		},
		{
			`ALTER TABLE a SET LOCALITY PARTITIONED REGIONAL AS bobby`,
			`ALTER TABLE a SET LOCALITY REGIONAL BY ROW AS bobby`,
		},
		{
			`ALTER TABLE a SET LOCALITY REGIONAL PARTITIONED`,
			`ALTER TABLE a SET LOCALITY REGIONAL BY ROW`,
		},
		{
			`ALTER TABLE a SET LOCALITY REGIONAL PARTITIONED AS bobby`,
			`ALTER TABLE a SET LOCALITY REGIONAL BY ROW AS bobby`,
		},
		{
