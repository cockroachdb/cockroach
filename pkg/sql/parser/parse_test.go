...
func TestParse(t *testing.T) {
	testData := []struct {
		...
		{`CREATE TABLE a (b INT8, INDEX (b) STORING (FAMILY f1 (b), FAMILY f2 (c)))`},
		{`CREATE TABLE a (b INT8, INDEX (b) STORING (c, FAMILY f1 (b), FAMILY f2 (c)))`},
		...
		{`CREATE INDEX ON a (x, y) STORING (z, FAMILY f1 (x, y), FAMILY f2 (z, w))`},
		{`CREATE UNIQUE INDEX ON a (x, y) STORING (z, FAMILY f1 (x, y), FAMILY f2 (z, w))`},
		{`CREATE INDEX ON a (x, y) STORING (FAMILY f1 (x, y), FAMILY f2 (z, w))`},
		{`CREATE UNIQUE INDEX ON a (x, y) STORING (FAMILY f1 (x, y), FAMILY f2 (z, w))`},
...
func TestParse2(t *testing.T) {
	testData := []struct {
		...
		{`CREATE TABLE a (b INT8, UNIQUE INDEX (b) STORING (FAMILY f1 (b), FAMILY f2 (c)))`,
			`CREATE TABLE a (b INT8, UNIQUE (b) STORING (FAMILY f1 (b), FAMILY f2 (c)))`},
		{`CREATE TABLE a (b INT8, UNIQUE INDEX (b) STORING (FAMILY f1 (b), c, FAMILY f2 (c)))`,
			`CREATE TABLE a (b INT8, UNIQUE (b) STORING (c, FAMILY f1 (b), FAMILY f2 (c)))`},
