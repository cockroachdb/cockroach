...
func TestParse(t *testing.T) {
	testData := []struct {
		...
		{`CREATE TABLE a (b INT8, c STRING, CONSTRAINT d UNIQUE (b, c) INT8ERLEAVE IN PARENT d (e, f))`},
...
func TestParse2(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			`CREATE TABLE a (b INT, c STRING, FOREIGN KEY (b, c) REFERENCES other MATCH SIMPLE)`,
		},
		{
			`CREATE TABLE a (b INT, c STRING, FOREIGN KEY (b, c) REFERENCES other (x, y))`,
			`CREATE TABLE a (b INT, c STRING, FOREIGN KEY (b, c) REFERENCES other (x, y) MATCH SIMPLE)`,
		},
		{
			`CREATE TABLE a (b INT, c STRING, CONSTRAINT s FOREIGN KEY (b, c) REFERENCES other (x, y))`,
			`CREATE TABLE a (b INT, c STRING, CONSTRAINT s FOREIGN KEY (b, c) REFERENCES other (x, y) MATCH SIMPLE)`,
		},
