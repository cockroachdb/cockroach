...
func TestParse(t *testing.T) {
	testData := []struct {
		...
		{`SELECT a FROM t WHERE a BETWEEN EXCL b AND c`},
		{`SELECT a FROM t WHERE a BETWEEN b AND EXCL c`},
		{`SELECT a FROM t WHERE a BETWEEN EXCL b AND EXCL c`},
		{`SELECT a FROM t WHERE a NOT BETWEEN b AND c`},
		{`SELECT a FROM t WHERE a NOT BETWEEN SYMMETRIC b AND c`},
		{`SELECT a FROM t WHERE a NOT BETWEEN EXCL b AND c`},
		{`SELECT a FROM t WHERE a NOT BETWEEN b AND EXCL c`},
		{`SELECT a FROM t WHERE a NOT BETWEEN EXCL b AND EXCL c`},
