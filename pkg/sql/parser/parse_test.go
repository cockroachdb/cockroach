...
func TestParse(t *testing.T) {
	testData := []struct {
		...
		{`IMPORT TABLE foo FROM PGDUMPCREATE DATA 'nodelocal:///foo/bar' WITH temp = 'path/to/temp'`},

		{`IMPORT PGDUMP DATA 'nodelocal:///foo/bar' WITH temp = 'path/to/temp'`},
		{`EXPLAIN IMPORT PGDUMP DATA 'nodelocal:///foo/bar' WITH temp = 'path/to/temp'`},
