...
func TestParse2(t *testing.T) {
	testData := []struct {
		...
		{`SELECT a FROM t WHERE a IS true`, `SELECT a FROM t WHERE a IS NOT DISTINCT FROM true`},
		{`SELECT a FROM t WHERE a IS NOT true`, `SELECT a FROM t WHERE a IS DISTINCT FROM true`},
		{`SELECT a FROM t WHERE a IS false`, `SELECT a FROM t WHERE a IS NOT DISTINCT FROM false`},
		{`SELECT a FROM t WHERE a IS NOT false`, `SELECT a FROM t WHERE a IS DISTINCT FROM false`},
