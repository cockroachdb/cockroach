...
$function$`,
		...
		{`BACKUP foo TO 'bar' WITH KMS_URI = 'foo', revision_history`,
			`BACKUP TABLE foo TO 'bar' WITH revision_history, kms_uri='foo'`},
		{`BACKUP foo TO 'bar' WITH KMS_URI = ('foo', 'bar'), revision_history`,
			`BACKUP TABLE foo TO 'bar' WITH revision_history, kms_uri=('foo', 'bar')`},
		...
		{`BACKUP foo TO 'bar' WITH OPTIONS (detached, KMS_URI = ('foo', 'bar'), revision_history)`,
			`BACKUP TABLE foo TO 'bar' WITH revision_history, detached, kms_uri=('foo', 'bar')`},
