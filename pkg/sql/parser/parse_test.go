...
func TestParse(t *testing.T) {
	testData := []struct {
		...
		{`CREATE TABLE a (b INT8, INDEX (b) FAMILIES (FAMILY f1 (b), FAMILY f2 (c)))`},
		{`CREATE TABLE a (b INT8, INDEX (b) STORING (c) FAMILIES (FAMILY f1 (b), FAMILY f2 (c)))`},
		...
		{`CREATE INDEX ON a (x, y) STORING (z) FAMILIES (FAMILY f1 (x, y), FAMILY f2 (z, w))`},
		{`CREATE UNIQUE INDEX ON a (x, y) STORING (z) FAMILIES (FAMILY f1 (x, y), FAMILY f2 (z, w))`},
		{`CREATE INDEX ON a (x, y) FAMILIES (FAMILY f1 (x, y), FAMILY f2 (z, w))`},
		{`CREATE UNIQUE INDEX ON a (x, y) FAMILIES (FAMILY f1 (x, y), FAMILY f2 (z, w))`},
...
func TestParse2(t *testing.T) {
	testData := []struct {
		...
		{`CREATE TABLE a (b INT8, UNIQUE INDEX (b) FAMILIES (FAMILY f1 (b), FAMILY f2 (c)))`,
			`CREATE TABLE a (b INT8, UNIQUE (b) FAMILIES (FAMILY f1 (b), FAMILY f2 (c)))`},
		{`CREATE TABLE a (b INT8, UNIQUE INDEX (b) STORING (c) FAMILIES (FAMILY f1 (b), FAMILY f2 (c)))`,
			`CREATE TABLE a (b INT8, UNIQUE (b) STORING (c) FAMILIES (FAMILY f1 (b), FAMILY f2 (c)))`},
