...
//   return values of type DTable (this is a new Datum type).
//
// - the return type of generators is a new TTable type. This
//   describes objects that are conceptually sets of rows. A TTable
//   type is characterized by its column types (no names).
//
...
//   Start/Next/Values/Stop API similar to planNode.
//
...
// ValueGenerator is the interface provided by the object
// held by a DTable.
