...
`,
	...
	"CANCEL": {hGroup, ``, `CANCEL JOB, CANCEL QUERY`, ``},

	"CANCEL JOB": {hMisc, "cancel a background job",
		`CANCEL JOB <jobid>`,
		`SHOW JOBS
  PAUSE JOB
  RESUME JOB`,
	...
	"PAUSE JOB": {hMisc, "pause a background job",
		`PAUSE JOB <jobid>`,
		`SHOW JOBS
  CANCEL JOB
  RESUME JOB`,
	...
	"RESUME JOB": {hMisc, "resume a background job",
		`RESUME JOB <jobid>`,
		`SHOW JOBS
  CANCEL JOB
  PAUSE JOB`,
	...
	"CANCEL QUERY": {hMisc, "cancel a running query",
...
`,
  ...
  https://www.cockroachlabs.com/docs/create-table-as.html`,
	...
	"DISCARD": {hCfg, "reset the session to its initial state", `DISCARD ALL`, ``},

	"DROP": {hGroup, ``, `DROP DATABASE, DROP INDEX, DROP TABLE, DROP VIEW, DROP USER`, ``},
...
`, `https://www.cockroachlabs.com/docs/cluster-settings.html`},
	...
	"SHOW USERS": {hPriv, "list defined users",
		`SHOW USERS`,
		`CREATE USER
  DROP USER
  https://www.cockroachlabs.com/docs/show-users.html`},

	"SHOW JOBS": {hMisc, "list background jobs",
		`SHOW JOBS`,
		`CANCEL JOB
  PAUSE JOB
  RESUME JOB`,
	...
	"SHOW QUERIES": {hMisc, "list running queries",
		`SHOW [CLUSTER | LOCAL] QUERIES`,
		`CANCEL QUERY`,
	},

	"SHOW SESSIONS": {hMisc, "list opened sessions",
		`SHOW [CLUSTER | LOCAL] SESSIONS`,
		``,
	},

	"SHOW TRACE": {hMisc, "display an execution trace",
