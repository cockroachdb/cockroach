...
func TestParseColumnType(t *testing.T) {
	testData := []struct {
		...
		{"SMALLINT", &IntColType{Name: "SMALLINT", Precision: 16}},
		{"BIGINT", &IntColType{Name: "BIGINT"}},
		{"INTEGER", &IntColType{Name: "INTEGER"}},
		{"INT", &IntColType{Name: "INT"}},
		{"INT2", &IntColType{Name: "INT2", Precision: 16}},
		{"INT4", &IntColType{Name: "INT4", Precision: 32}},
		...
		{"FLOAT4", &FloatColType{Name: "FLOAT4", Prec: 4, PrecSpecified: true}},
		{"FLOAT8", &FloatColType{Name: "FLOAT8", Prec: 8, PrecSpecified: true}},
