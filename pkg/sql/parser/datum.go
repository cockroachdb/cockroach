...
type DOid struct {
	// Oid is the underlying integer for this OID datum.
	Oid *DInt
...
// IsMax implements the Datum interface.
func (d *DOid) IsMax() bool { return d.Oid.IsMax() }

// IsMin implements the Datum interface.
func (d *DOid) IsMin() bool { return d.Oid.IsMin() }
...
func NewDOidFromDInt(d *DInt) Datum {
	return &DOid{Oid: d, kind: oidColTypeOid, name: ""}
}
