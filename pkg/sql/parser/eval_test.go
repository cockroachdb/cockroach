...
func TestEval(t *testing.T) {
	testData := []struct {
		...
		{`x'636174'`, `b'\x63\x61\x74'`},
		{`X'636174'`, `b'\x63\x61\x74'`},
		{`x'636174'::string`, `'cat'`},
		{`e'\\x636174'::BYTES`, `b'\x63\x61\x74'`},
		{`e'\\X636174'::BYTES`, `b'\x63\x61\x74'`},
		{`e'\\x636174'::STRING::BYTES`, `b'\x63\x61\x74'`},
		{`e'\\x636174'::STRING`, `e'\\x636174'`},
		// String concatenation.
		{`'a' || 'b'`, `'ab'`},
		{`'a' || (1 + 2)::char`, `'a3'`},
		{`b'hello' || 'world'`, `b'\x68\x65\x6c\x6c\x6f\x77\x6f\x72\x6c\x64'`},
		// Bit shift operators.
		{`1 << 2`, `4`},
		{`4 >> 2`, `1`},
		// Boolean expressions.
		...
		{`'hello'::char(2)`, `'he'`},
		{`'hello'::bytes`, `b'\x68\x65\x6c\x6c\x6f'`},
