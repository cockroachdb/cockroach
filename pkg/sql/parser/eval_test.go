...
func TestEval(t *testing.T) {
	testData := []struct {
		...
		{`ANNOTATE_TYPE('2 02:12', interval)`, `'2d2h12m0s'`},
		{`ANNOTATE_TYPE('2 02:12:34', interval)`, `'2d2h12m34s'`},
		{`ANNOTATE_TYPE('1-2 02:12', interval)`, `'14mon2h12m0s'`},
		...
		{`'1-2'::interval`, `'14mon'`},
		{`'-1-2'::interval`, `'-14mon'`},
		{`'1-2 3'::interval`, `'14mon3s'`},
		{`'1-2 -3'::interval`, `'14mon-3s'`},
		{`'-1-2 -3'::interval`, `'-14mon-3s'`},
		{`'2 4:08'::interval`, `'2d4h8m0s'`},
		{`'-2 4:08'::interval`, `'-2d4h8m0s'`},
		{`'2 -4:08'::interval`, `'2d-4h8m0s'`},
		{`'1-2 4:08'::interval`, `'14mon4h8m0s'`},
		{`'1-2 3 4:08'::interval`, `'14mon3d4h8m0s'`},
		{`'1-2 3 4:08:05'::interval`, `'14mon3d4h8m5s'`},
		{`'1-2 4:08:23'::interval`, `'14mon4h8m23s'`},
		{`'1- 4:08:23'::interval`, `'12mon4h8m23s'`},
		{`'0-2 3 4:08'::interval`, `'2mon3d4h8m0s'`},
		{`'1- 3 4:08:'::interval`, `'12mon3d4h8m0s'`},
		{`'-1- 3 4:08:'::interval`, `'-12mon3d4h8m0s'`},
		{`'0- 3 4:08'::interval`, `'3d4h8m0s'`},
		{`'-0- 3 4:08'::interval`, `'3d4h8m0s'`},
		{`'-0- -0 4:08'::interval`, `'4h8m0s'`},
		{`'-0- -0 0:0'::interval`, `'0s'`},
		{`'-0- -0 -0:0'::interval`, `'0s'`},
		{`'-0- -3 -4:08'::interval`, `'-3d-4h8m0s'`},
		{`'0- 3 4::08'::interval`, `'3d4h0m8s'`},
		{`'	0-   3    4::08  '::interval`, `'3d4h0m8s'`},
		{`'2 4:08:23'::interval`, `'2d4h8m23s'`},
		{`'1-2 3 4:08:23'::interval`, `'14mon3d4h8m23s'`},
		{`'1-'::interval`, `'12mon'`},
		{`'1- 2'::interval`, `'12mon2s'`},
		{`'2 3:'::interval`, `'2d3h0m0s'`},
		{`'2 3:4:'::interval`, `'2d3h4m0s'`},
		{`'1- 3:'::interval`, `'12mon3h0m0s'`},
		{`'1- 3:4'::interval`, `'12mon3h4m0s'`},
