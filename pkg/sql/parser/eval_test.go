...
func TestEval(t *testing.T) {
	testData := []struct {
		...
		{`'P-1Y2M-10DT-2H29M'::interval IS OF (INTERVAL)`, `true`},
		{`'-1 year -2 month -10 day -2 hour 29 minute'::interval IS OF (INTERVAL)`, `true`},
		...
		{`'-1.2'::interval`, `INTERVAL '-1.2s'`},
		{`'-1:0:0'::interval`, `INTERVAL '-1h0m0s'`},
		{`'PT-1H1M2S'::interval`, `INTERVAL '-58m58s'`},
		{`'-1 hour 1 minute 2 second'::interval`, `INTERVAL '-58m58s'`},
		{`'-1:1.2'::interval`, `INTERVAL '-1h1m12s'`},
		{`'-1:2'::interval`, `INTERVAL '-1h2m0s'`},
		{`'-1:2.3'::interval`, `INTERVAL '-1h2m18s'`},
		{`'-1:2:3'::interval`, `INTERVAL '-1h2m3s'`},
		...
		{`'P-1Y-2M'::interval`, `INTERVAL '-14m0d0ns'`},
		{`'-1 year -2 month'::interval`, `INTERVAL '-14m0d0ns'`},
		{`'-1-2'::interval`, `INTERVAL '-14m0d0ns'`},
		{`'1-2 3'::interval`, `INTERVAL '14m0d3s'`},
		{`'1-2 -3'::interval`, `INTERVAL '14m0d-3s'`},
		{`'P-1Y-2MT-3S'::interval`, `INTERVAL '-14m0d-3s'`},
		{`'-1 year -2 month -3 second'::interval`, `INTERVAL '-14m0d-3s'`},
		{`'-1-2 -3'::interval`, `INTERVAL '-14m0d-3s'`},
