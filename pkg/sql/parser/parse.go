...
func (p *Parser) parseOneWithInt(sql string, nakedIntType *types.T) (statements.Statement[tree.Statement], error) {
...
func (p *Parser) parseWithDepth(depth int, sql string, nakedIntType *types.T) (statements.Statements, error) {
