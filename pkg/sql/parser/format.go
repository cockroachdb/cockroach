...
type fmtFlags struct {
	...
	// are nil.
	tableNameNormalizer func(*NormalizableTableName) NodeFormatter
...
func FmtNormalizeTableNames(base FmtFlags, fn func(*NormalizableTableName) NodeFormatter) FmtFlags {
	f := *base
