...
import (
	...
	unimp "github.com/cockroachdb/cockroach/pkg/util/errutil/unimplemented"
...
func (l *lexer) setErr(err error) {
	err = errpgcode.WithCandidateCode(err, pgcode.Syntax)
	l.lastError = err
	l.populateErrorDetails()
}
...
func (l *lexer) Error(e string) {
	...
	l.lastError = errpgcode.WithCandidateCode(errors.New(e), pgcode.Syntax)
	l.populateErrorDetails()
}
...
func (l *lexer) populateErrorDetails() {
	...
	if lastTok.id == ERROR {
		...
		err := errpgcode.WithCandidateCode(errors.Newf("lexical error: %s", lastTok.str), pgcode.Syntax)
...
func (l *lexer) SetHelp(msg HelpMessage) {
	if l.lastError == nil {
		l.lastError = errpgcode.WithCandidateCode(errors.New("help request"), pgcode.Syntax)
	}
