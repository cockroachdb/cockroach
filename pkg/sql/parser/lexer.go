...
func (l *lexer) Unimplemented(feature string) {
	l.lastError = errors.Unimplemented(feature, "this syntax")
...
func (l *lexer) UnimplementedWithIssue(issue int) {
	l.lastError = errors.UnimplementedWithIssue(issue, "this syntax")
	l.populateErrorDetails()
}
...
func (l *lexer) UnimplementedWithIssueDetail(issue int, detail string) {
	l.lastError = errors.UnimplementedWithIssueDetail(issue, detail, "this syntax")
	l.populateErrorDetails()
}
...
func (l *lexer) setErr(err error) {
	err = errors.WithCandidateCode(err, pgcode.Syntax)
	l.lastError = err
	l.populateErrorDetails()
}
...
func (l *lexer) Error(e string) {
	...
	l.lastError = errors.WithCandidateCode(errors.New(e), pgcode.Syntax)
	l.populateErrorDetails()
}
...
func (l *lexer) populateErrorDetails() {
	...
	if lastTok.id == ERROR {
		...
		err := errors.WithCandidateCode(errors.Newf("lexical error: %s", lastTok.str), pgcode.Syntax)
...
func (l *lexer) SetHelp(msg HelpMessage) {
	if l.lastError == nil {
		l.lastError = errors.WithCandidateCode(errors.New("help request"), pgcode.Syntax)
	}
