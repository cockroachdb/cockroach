...
var typeBuiltinsHaveUnderscore = map[oid.Oid]struct{}{
	types.PGOid(types.Any):         {},
	types.PGOid(types.Date):        {},
	types.PGOid(types.Decimal):     {},
	types.PGOid(types.Interval):    {},
	types.PGOid(types.JSON):        {},
	types.PGOid(types.UUID):        {},
	types.PGOid(types.Timestamp):   {},
	types.PGOid(types.TimestampTZ): {},
