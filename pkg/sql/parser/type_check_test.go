...
func TestTypeCheckError(t *testing.T) {
	testData := []struct {
		...
		{`(1, 2) = (1, 'a')`, `tuples (1, 2), (1, 'a') are not the same type: expected 'a' to be of type int, found type string`},
		...
		{`1.0 BETWEEN 2 AND '5'`, `expected '5' to be of type decimal, found type string`},
