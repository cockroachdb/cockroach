...
func TestSQLIntervalSyntax(t *testing.T) {
	testData := []struct {
		...
		{`2 -4:08`, `2d-4h-8m`},
		{`1-2 4:08`, `14mon4h8m`},
		{`1-2 3 4:08`, `14mon3d4h8m`},
		{`1-2 3 4:08:05`, `14mon3d4h8m5s`},
		{`1-2 4:08:23`, `14mon4h8m23s`},
		{`1- 4:08:23`, `12mon4h8m23s`},
		{`0-2 3 4:08`, `2mon3d4h8m`},
		{`1- 3 4:08:`, `12mon3d4h8m`},
		{`-1- 3 4:08:`, `-12mon3d4h8m`},
		{`0- 3 4:08`, `3d4h8m`},
		{`-0- 3 4:08`, `3d4h8m`},
		{`-0- -0 4:08`, `4h8m`},
...
func TestPGIntervalSyntax(t *testing.T) {
	testData := []struct {
		...
		{`-9223372036854775808mon`, `-9223372036854775808mon`, ``},
		{`9223372036854775807mon`, `9223372036854775807mon`, ``},
