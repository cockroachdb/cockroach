...
var Builtins = map[string][]Builtin{
	...
	"concat_ws": {
		Builtin{
			...
			Info: "Uses the first string as a separator between the concatenation of the " +
	...
	"unique_rowid": {
		Builtin{
			...
			Info: "Returns a unique ID used by CockroachDB to generate unique row IDs if a " +
				"Primary Key isn't defined for the table.",
		},
	},
	...
	"round": {
		...
		Builtin{
			...
			Info: "Keeps `decimcal_accuracy` number of figures to the right of the zero position " +
				" in `input`.",
		},
		Builtin{
