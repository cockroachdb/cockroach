...
var Builtins = map[string][]Builtin{
	...
	"pg_catalog.format_type": {
		Builtin{
			...
			category: categoryCompatibility,
			Info: "format_type returns the SQL name of a data type that is identified by its type OID and possibly a type" +
				"modifier. Currently, the type modifier is ignored.",
		},
	},
}
