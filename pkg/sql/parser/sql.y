...
create_view_stmt:
  CREATE opt_temp opt_view_recursive VIEW view_name opt_column_list opt_with_storage_parameter_list AS select_stmt /* SKIP DOC */
  {
    name := $5.unresolvedObjectName().ToTableName()
    $$.val = &tree.CreateView{
      Name: name,
...
| CREATE OR REPLACE opt_temp opt_view_recursive VIEW view_name opt_column_list opt_with_storage_parameter_list AS select_stmt /* SKIP DOC */
  {
    name := $7.unresolvedObjectName().ToTableName()
    $$.val = &tree.CreateView{
      Name: name,
...
| CREATE opt_temp opt_view_recursive VIEW IF NOT EXISTS view_name opt_column_list opt_with_storage_parameter_list AS select_stmt /* SKIP DOC */
  {
...
| CREATE MATERIALIZED VIEW view_name opt_column_list AS select_stmt opt_with_data /* SKIP DOC */
  {
    name := $4.unresolvedObjectName().ToTableName()
    $$.val = &tree.CreateView{
      Name: name,
...
| CREATE MATERIALIZED VIEW IF NOT EXISTS view_name opt_column_list AS select_stmt opt_with_data /* SKIP DOC */
  {
    name := $7.unresolvedObjectName().ToTableName()
    $$.val = &tree.CreateView{
      Name: name,
