...
alter_tenant_csetting_stmt:
  ALTER TENANT iconst64 SET CLUSTER SETTING var_name to_or_eq var_value
  {
    ...
    $$.val = &tree.SetClusterSetting{Name: strings.Join($7.strs(), "."), Value: $9.expr(), TenantID: roachpb.MakeTenantID(tenID)}
  }
| ALTER TENANT ALL SET CLUSTER SETTING var_name to_or_eq var_value
  {
    $$.val = &tree.SetClusterSetting{Name: strings.Join($7.strs(), "."), Value: $9.expr(), TenantAll: true}
  }
| ALTER TENANT iconst64 RESET CLUSTER SETTING var_name
  {
    ...
    $$.val = &tree.SetClusterSetting{Name: strings.Join($7.strs(), "."), Value: tree.DefaultVal{}, TenantID: roachpb.MakeTenantID(tenID)}
  }
| ALTER TENANT ALL RESET CLUSTER SETTING var_name
  {
    $$.val = &tree.SetClusterSetting{Name: strings.Join($7.strs(), "."), Value: tree.DefaultVal{}, TenantAll: true}
  }
