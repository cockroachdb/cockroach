...
alter_backup_stmt:
  ALTER BACKUP list_of_string_or_placeholder_opt_list
  ADD NEW_KMS '=' string_or_placeholder_opt_list
  WITH OLD_KMS '=' string_or_placeholder_opt_list
  {
		$$.val = &tree.AlterBackup {
			Backup: 		$3.listOfStringOrPlaceholderOptList(),
			NewKMSURI:  $7.stringOrPlaceholderOptList(),
			OldKMSURI:  $11.stringOrPlaceholderOptList(),
		}
  }
| ALTER BACKUP string_or_placeholder IN list_of_string_or_placeholder_opt_list
	ADD NEW_KMS '=' string_or_placeholder_opt_list
	WITH OLD_KMS '=' string_or_placeholder_opt_list
	{
		$$.val = &tree.AlterBackup {
			Subdir: 		$3.expr(),
			Backup: 		$5.listOfStringOrPlaceholderOptList(),
