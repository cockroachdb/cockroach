...
create_view_stmt:
  CREATE opt_temp opt_view_recursive VIEW view_name opt_column_list opt_view_with AS select_stmt /* SKIP DOC */
  {
    name := $5.unresolvedObjectName().ToTableName()
    $$.val = &tree.CreateView{
      Name: name,
...
| CREATE OR REPLACE opt_temp opt_view_recursive VIEW view_name opt_column_list opt_view_with AS select_stmt /* SKIP DOC */
  {
    name := $7.unresolvedObjectName().ToTableName()
    $$.val = &tree.CreateView{
      Name: name,
      ...
      SecurityInvoker: $9.boolPtr(),
      IfNotExists: false,
      Replace: true,
    }
  }
| CREATE opt_temp opt_view_recursive VIEW IF NOT EXISTS view_name opt_column_list opt_view_with AS select_stmt /* SKIP DOC */
  {
