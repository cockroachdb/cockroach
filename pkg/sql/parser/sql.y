...
func (u *sqlSymUnion) showBeforeAfter() *tree.ShowBeforeAfter {
  return u.val.(*tree.ShowBeforeAfter)
}
...
%type <*tree.ShowBeforeAfter> opt_show_before_after_clause
...
show_backup_stmt:
  SHOW BACKUPS IN string_or_placeholder_opt_list opt_show_before_after_clause
 {

    $$.val = &tree.ShowBackup{
      InCollection:    $4.stringOrPlaceholderOptList(),
      TimeRange: *$5.showBeforeAfter(),
    }
  }
...
opt_show_before_after_clause:
  BEFORE a_expr
  {
    $$.val = &tree.ShowBeforeAfter{Before: $2.expr()}
  }
  | AFTER a_expr
  {
    $$.val = &tree.ShowBeforeAfter{After: $2.expr()}
  }
  | BEFORE a_expr AFTER a_expr
  {
    $$.val = &tree.ShowBeforeAfter{Before: $2.expr(), After: $4.expr()}
  }
  | AFTER a_expr BEFORE a_expr
  {
    $$.val = &tree.ShowBeforeAfter{Before: $4.expr(), After: $2.expr()}
  }
  | /* EMPTY */
  {
    $$.val = &tree.ShowBeforeAfter{}
  }
