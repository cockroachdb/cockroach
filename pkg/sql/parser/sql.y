...
// Preserve some of the contextual error hinting that was lost when we made
// target_list token optional.
| SELECT opt_all_clause opt_target_list from_clause WHERE group_clause having_clause window_clause error // SHOW HELP: SELECT
| SELECT distinct_clause error // SHOW HELP: SELECT
| SELECT distinct_on_clause error // SHOW HELP: SELECT
