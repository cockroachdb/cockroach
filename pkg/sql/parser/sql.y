...
%type <tree.TableExpr> table_expr_opt_alias_idx table_expr_with_index
...
table_expr_opt_alias_idx:
  table_expr_with_index %prec UMINUS
  {
     $$.val = $1.tblExpr()
  }
| table_expr_with_index table_alias_name
  {
     alias := $1.tblExpr().(*tree.AliasedTableExpr)
     alias.As = tree.AliasClause{Alias: tree.Name($2)}
     $$.val = alias
  }
| table_expr_with_index AS table_alias_name
  {
     alias := $1.tblExpr().(*tree.AliasedTableExpr)
