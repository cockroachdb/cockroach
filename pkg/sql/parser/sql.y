...
%type <tree.TargetList>    targets on_targets
...
//    <some table pattern list>". So first, inline the definition of table_pattern_list.
//
//    on_targets ::=
...
//        ON ROLE name_list
//        ON IDENT                                 # <- here
//        ON col_name_keyword                      # <- here
//        ON unreserved_keyword                    # <- here
//        ON complex_table_pattern
//        ON table_pattern ',' table_pattern_list
//        ON TABLE table_pattern_list
//        ON DATABASE name_list
//
// 8. And finally, we want to recognize "ON ROLE" without any
//    subsequent name list. This requires some care: we can't add "ON
//    ROLE" to the set of rules above, because "ON
//    unreserved_keywords" would then overlap. However the rule is now
//    sufficiently simple that we can disambiguate in the action, like
//    this:
//
//        on_targets ::=
//          ...
