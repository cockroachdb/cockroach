...
%token <str> RANGE RANGES READ READER REAL REASON REASSIGN RECURSIVE RECURRING REDACT REF REFERENCES REFERENCING REFRESH
...
| ENABLE READER TENANT
  {
    $$.val = &tree.TenantReplicationOptions{EnableReaderTenant: tree.MakeDBool(true)}
  }
| ENABLE READER TENANT '=' TRUE
  {
    $$.val = &tree.TenantReplicationOptions{EnableReaderTenant: tree.MakeDBool(true)}
  }
| ENABLE READER TENANT '=' FALSE
  {
    $$.val = &tree.TenantReplicationOptions{EnableReaderTenant: tree.MakeDBool(false)}
  }
