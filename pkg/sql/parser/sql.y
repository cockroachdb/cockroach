...
// %Category: Misc
// %Text: SHOW STATISTICS [AS JSON] FOR TABLE <table_name>
//
// Returns the available statistics for a table.
// The statistics can include a histogram ID, which can
// be used with SHOW HISTOGRAM.
// If AS JSON is specified, the statistics and histograms
...
| SHOW STATISTICS AS JSON FOR TABLE table_name
  {
    $$.val = &tree.ShowTableStats{Table: $7.normalizableTableNameFromUnresolvedName(), AsJSON: true}
  }
