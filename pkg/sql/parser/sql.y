...
func (u *sqlSymUnion) idOpt() tree.IdentityOption {
    return u.val.(tree.IdentityOption)
}
...
%type <tree.IdentityOption> alter_identity_column_option
...
| ALTER opt_column column_name alter_identity_column_option
  {
    $$.val = &tree.AlterTableIdentity{Column: tree.Name($3), Option: $4.idOpt()}
  }
...
| SET GENERATED_BY_DEFAULT BY DEFAULT {
    $$.val = tree.IdentityOption{GeneratedAsIdentityType: tree.GeneratedByDefault}
  }
| alter_column_sequence_option_elem {
    x := $1.seqOpt()
    $$.val = tree.IdentityOption{SeqOption: &x}
  }
