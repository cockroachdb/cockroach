...
%token <str> ELSE ENCODING ENCRYPTION_PASSPHRASE END ENUM ESCAPE EVERY EXCEPT EXCLUDE EXCLUDING
...
//
// RECURRING <crontab>:
//   The RECURRING expression specifies when we backup.  By default these are incremental backups
//   that capture changes since the last backup, writing to the "current" backup.
//
