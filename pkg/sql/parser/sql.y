...
func (u *sqlSymUnion) alterColumnTypeControl() tree.AlterColumnTypeControl {
    return u.val.(tree.AlterColumnTypeControl)
}
...
%token <str>   COMMITTED COMPACT COMPLETE
%token <str>   CONCAT CONFIGURATION CONFIGURATIONS CONFIGURE
...
%token <str>   DEALLOCATE DEFERRED DEFERRABLE DELETE DESC
...
%type <tree.AlterColumnTypeControl> opt_alter_column_control
...
//                                            [USING <expr>] [DEFERRED | COMPLETE | ABORT]
...
| ALTER opt_column column_name opt_set_data TYPE typename opt_alter_column_collate opt_alter_column_using opt_alter_column_control
  {
    $$.val = &tree.AlterTableAlterColumnType{
      ...
      Collation: $7,
      Using: $8.expr(),
      Control: $9.alterColumnTypeControl(),
    }
  }
...
opt_alter_column_control:
  DEFERRED
  {
    $$.val = tree.AlterColumnTypeDeferred
  }
| COMPLETE
  {
    $$.val = tree.AlterColumnTypeComplete
  }
| ABORT
  {
    $$.val = tree.AlterColumnTypeAbort
  }
| /* EMPTY */
  {
    $$.val = tree.AlterColumnTypeDefault
  }
