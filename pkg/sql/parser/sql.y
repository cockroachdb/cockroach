...
// %Category: Misc
// %Text:
// SHOW INSPECT ERRORS FOR JOB <ID> [FOR TABLE <name>] [WITH DETAILS]
// %SeeAlso: INSPECT
show_inspect_errors_stmt:
  SHOW INSPECT ERRORS for_job_clause opt_for_table_clause opt_with_details
  {
      $$.val = &tree.ShowInspectErrors{
        JobID:      $4.int64Ptr(),
        TableName:  $5.tableNamePtr(),
        WithDetails: $6.bool(),
      }
  }
