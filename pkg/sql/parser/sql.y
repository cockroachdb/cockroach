...
show_zone_stmt:
  SHOW ZONE CONFIGURATION for_with_implicit_from_alias RANGE zone_name
  {
    $$.val = &tree.ShowZoneConfig{ZoneSpecifier: tree.ZoneSpecifier{NamedZone: tree.UnrestrictedName($6)}}
  }
| SHOW ZONE CONFIGURATION for_with_implicit_from_alias DATABASE database_name
  {
    $$.val = &tree.ShowZoneConfig{ZoneSpecifier: tree.ZoneSpecifier{Database: tree.Name($6)}}
  }
| SHOW ZONE CONFIGURATION for_with_implicit_from_alias TABLE table_name opt_partition
  {
    name := $6.unresolvedObjectName().ToTableName()
...
| SHOW ZONE CONFIGURATION for_with_implicit_from_alias PARTITION partition_name OF TABLE table_name
  {
...
| SHOW ZONE CONFIGURATION for_with_implicit_from_alias INDEX table_index_name opt_partition
  {
    $$.val = &tree.ShowZoneConfig{ZoneSpecifier: tree.ZoneSpecifier{
      TableOrIndex: $6.tableIndexName(),
      Partition: tree.Name($7),
...
| SHOW ZONE CONFIGURATION for_with_implicit_from_alias PARTITION partition_name OF INDEX table_index_name
  {
    $$.val = &tree.ShowZoneConfig{ZoneSpecifier: tree.ZoneSpecifier{
