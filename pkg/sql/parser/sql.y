...
| SHOW BACKUP string_or_placeholder opt_with_show_backup_options error
	{
    setErr(sqllex, errors.New("The `SHOW BACKUP` syntax without the `IN` keyword has been removed. Please use `SHOW BACKUP FROM <subdirectory> IN <collectionURI>`."))
    return helpWith(sqllex, "SHOW BACKUP")
	}
| SHOW BACKUP SCHEMAS string_or_placeholder opt_with_show_backup_options error
	{
    setErr(sqllex, errors.New("The `SHOW BACKUP SCHEMAS` syntax without the `IN` keyword has been removed. Please use `SHOW BACKUP SCHEMAS FROM <subdirectory> IN <collectionURI>`."))
    return helpWith(sqllex, "SHOW BACKUP")
	}
| SHOW BACKUP FILES string_or_placeholder opt_with_show_backup_options error
	{
    /* SKIP DOC */
    setErr(sqllex, errors.New("The `SHOW BACKUP FILES` syntax without the `IN` keyword has been removed. Please use `SHOW BACKUP FILES FROM <subdirectory> IN <collectionURI>`."))
    return helpWith(sqllex, "SHOW BACKUP")
	}
| SHOW BACKUP RANGES string_or_placeholder opt_with_show_backup_options error
	{
    /* SKIP DOC */
    setErr(sqllex, errors.New("The `SHOW BACKUP RANGES` syntax without the `IN` keyword has been removed. Please use `SHOW BACKUP RANGES FROM <subdirectory> IN <collectionURI>`."))
    return helpWith(sqllex, "SHOW BACKUP")
	}
| SHOW BACKUP VALIDATE string_or_placeholder opt_with_show_backup_options error
	{
		/* SKIP DOC */
		setErr(sqllex, errors.New("The `SHOW BACKUP VALIDATE` syntax without the `IN` keyword has been removed. Please use `SHOW BACKUP VALIDATE FROM <subdirectory> IN <collectionURI>`."))
    return helpWith(sqllex, "SHOW BACKUP")
	}
