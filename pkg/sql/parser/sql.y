...
%token <str> DISABLE_PROTECTED_TIMESTAMP DISCARD DISTINCT DO DOMAIN DOUBLE DROP
...
| DISABLE_PROTECTED_TIMESTAMP
  {
    $$.val = &tree.BackupOptions{DisableProtectedTimestamp: true}
  }
