...
%token <str> SAFE SAVEPOINT SCANS SCATTER SCHEDULE SCHEDULES SCROLL SCHEMA SCHEMAS SCRUB SEARCH SECOND SECURITY SELECT SEQUENCE SEQUENCES
...
| PARALLEL UNSAFE
  {
    $$.val = tree.FunctionParallelUnsafe
  }
| PARALLEL RESTRICTED
  {
    $$.val = tree.FunctionParallelRestricted
  }
| PARALLEL SAFE
  {
    $$.val = tree.FunctionParallelSafe
  }
