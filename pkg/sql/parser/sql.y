...
%token <str> GENERATED GLOBAL GRANT GRANTS GREATEST GROUP GROUPING GROUPS
...
like_table_option:
  COMMENTS			{ return unimplemented(sqllex, "like table in/excluding comments") }
...
| IDENTITY	  	{ return unimplemented(sqllex, "like table in/excluding identity") }
...
| STATISTICS		{ return unimplemented(sqllex, "like table in/excluding statistics") }
| STORAGE			{ return unimplemented(sqllex, "like table in/excluding storage") }
