...
func (u *sqlSymUnion) geoFigure() geopb.Figure {
  return u.val.(geopb.Figure)
}
...
geo_figure:
  POINT { $$.val = geopb.Figure_Point }
| LINESTRING { $$.val = geopb.Figure_LineString }
| POLYGON { $$.val = geopb.Figure_Polygon }
| GEOMETRYCOLLECTION { $$.val = geopb.Figure_GeometryCollection }
| MULTIPOLYGON { $$.val = geopb.Figure_MultiPolygon }
| MULTILINESTRING { $$.val = geopb.Figure_MultiLineString }
| MULTIPOINT { $$.val = geopb.Figure_MultiPoint }
| GEOMETRY { $$.val = geopb.Figure_Geometry }
