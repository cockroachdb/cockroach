...
| BACKUP opt_backup_targets TO error
  {
    setErr(sqllex, errors.New("The `BACKUP TO` syntax has been removed. Please use `BACKUP INTO` to create a backup collection."))
...
restore_stmt:
  RESTORE FROM error
  {
    setErr(sqllex, errors.New("The `RESTORE FROM <backupURI>` syntax has been removed. Please use `RESTORE FROM <subdirectory> IN <collectionURI>`."))
...
| RESTORE backup_targets FROM error
  {
    setErr(sqllex, errors.New("The `RESTORE <targets> FROM <backupURI>` syntax has been removed. Please use `RESTORE <targets> FROM <subdirectory> IN <collectionURI>`."))
    return helpWith(sqllex, "RESTORE")
  }
...
| SHOW BACKUP string_or_placeholder opt_with_show_backup_options error
	{
    setErr(sqllex, errors.New("The `SHOW BACKUP <backupURI>` syntax has been removed. Please use `SHOW BACKUP FROM <subdirectory> IN <collectionURI>`."))
    return helpWith(sqllex, "SHOW BACKUP")
	}
| SHOW BACKUP SCHEMAS string_or_placeholder opt_with_show_backup_options error
	{
    setErr(sqllex, errors.New("The `SHOW BACKUP SCHEMAS <backupURI>` syntax has been removed. Please use `SHOW BACKUP SCHEMAS FROM <subdirectory> IN <collectionURI>`."))
    return helpWith(sqllex, "SHOW BACKUP")
	}
| SHOW BACKUP FILES string_or_placeholder opt_with_show_backup_options error
	{
    /* SKIP DOC */
    setErr(sqllex, errors.New("The `SHOW BACKUP FILES <backupURI>` syntax has been removed. Please use `SHOW BACKUP FILES FROM <subdirectory> IN <collectionURI>`."))
    return helpWith(sqllex, "SHOW BACKUP")
	}
| SHOW BACKUP RANGES string_or_placeholder opt_with_show_backup_options error
	{
    /* SKIP DOC */
    setErr(sqllex, errors.New("The `SHOW BACKUP RANGES <backupURI>` syntax has been removed. Please use `SHOW BACKUP RANGES FROM <subdirectory> IN <collectionURI>`."))
    return helpWith(sqllex, "SHOW BACKUP")
	}
| SHOW BACKUP VALIDATE string_or_placeholder opt_with_show_backup_options error
	{
		/* SKIP DOC */
		setErr(sqllex, errors.New("The `SHOW BACKUP VALIDATE <backupURI>` syntax has been removed. Please use `SHOW BACKUP VALIDATE FROM <subdirectory> IN <collectionURI>`."))
    return helpWith(sqllex, "SHOW BACKUP")
	}
| SHOW BACKUP CONNECTION string_or_placeholder opt_with_show_backup_connection_options_list error
	{
		setErr(sqllex, errors.New("The `SHOW BACKUP CONNECTION <backupURI>` syntax has been removed. Please use `SHOW BACKUP CONNECTION FROM <subdirectory> IN <collectionURI>`."))
    return helpWith(sqllex, "SHOW BACKUP")
	}
