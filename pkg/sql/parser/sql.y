...
%token <str> CONFLICT CONSTRAINT CONSTRAINTS CONTAINS CONVERSION COPY COVERING CREATE CREATEDB CREATEROLE
...
%token <str> NAN NAME NAMES NATURAL NEVER NEXT NO NOCREATEDB NOCREATEROLE NOLOGIN NO_INDEX_JOIN
