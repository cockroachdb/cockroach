...
alter_rename_index_stmt:
  ...
  {
    $$.val = &RenameIndex{Index: $3.tableWithIdx(), NewName: UnrestrictedName($6), IfExists: false}
  }
| ALTER INDEX IF EXISTS table_name_with_index RENAME TO unrestricted_name
  {
    $$.val = &RenameIndex{Index: $5.tableWithIdx(), NewName: UnrestrictedName($8), IfExists: true}
  }
