...
list_partitions:
  PARTITION name VALUES list_partition_values ',' list_partitions
  {
...
| PARTITION name VALUES list_partition_values partition_by ',' list_partitions
  {
    $$.val = append([]ListPartition{{
      Name: Name($2),
      Tuples: $4.tuples(),
...
| PARTITION name VALUES list_partition_values opt_partition_by
  {
    $$.val = []ListPartition{{
      Name: Name($2),
      Tuples: $4.tuples(),
