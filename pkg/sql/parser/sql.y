...
//   ALTER TABLE ... ALTER [COLUMN] <colname> ADD GENERATED { ALWAYS | BY DEFAULT } [( <opt_sequence_option_list> )]
...
| ALTER opt_column column_name DROP NOT NULL
  ...
  // ALTER TABLE <name> ALTER [COLUMN] <colname> ADD GENERATED ALWAYS
| ALTER opt_column column_name ADD GENERATED_ALWAYS ALWAYS {
    $$.val = &tree.AlterTableAddIdentity{Column: tree.Name($3), GeneratedAsIdentityType: tree.GeneratedAlways}
  }
  // ALTER TABLE <name> ALTER [COLUMN] <colname> ADD GENERATED BY DEFAULT
| ALTER opt_column column_name ADD GENERATED_BY_DEFAULT BY DEFAULT {
    $$.val = &tree.AlterTableAddIdentity{Column: tree.Name($3), GeneratedAsIdentityType: tree.GeneratedByDefault}
  }
  // ALTER TABLE <name> ALTER [COLUMN] <colname> ADD GENERATED ALWAYS ( <opt_sequence_option_list> )
| ALTER opt_column column_name ADD GENERATED_ALWAYS ALWAYS '(' opt_sequence_option_list ')' {
  //, SeqOptions: $8.seqOpts()
    $$.val = &tree.AlterTableAddIdentity{Column: tree.Name($3), GeneratedAsIdentityType: tree.GeneratedAlways, SeqOptions: $8.seqOpts()}
  }
  // ALTER TABLE <name> ALTER [COLUMN] <colname> ADD GENERATED BY DEFAULT ( <opt_sequence_option_list> )
| ALTER opt_column column_name ADD GENERATED_BY_DEFAULT BY DEFAULT '(' opt_sequence_option_list ')' {
    $$.val = &tree.AlterTableAddIdentity{Column: tree.Name($3), GeneratedAsIdentityType: tree.GeneratedByDefault, SeqOptions: $9.seqOpts()}
  }
  // ALTER TABLE <name> ALTER [COLUMN] <colname> SET GENERATED ALWAYS
| ALTER opt_column column_name SET GENERATED_ALWAYS ALWAYS {
...
| ALTER opt_column column_name SET GENERATED_BY_DEFAULT BY DEFAULT {
