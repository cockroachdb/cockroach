...
alter_relocate_lease_stmt:
  ...
  {
    /* SKIP DOC */
    $$.val = &tree.TestingRelocateLease{Table: $3.newNormalizableTableNameFromUnresolvedName(), Rows: $6.slct()}
  }
...
alter_relocate_index_lease_stmt:
  ...
  {
    /* SKIP DOC */
    $$.val = &tree.TestingRelocateLease{Index: $3.newTableWithIdx(), Rows: $6.slct()}
  }
