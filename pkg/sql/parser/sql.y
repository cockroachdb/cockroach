...
| EXTERNAL SECURITY DEFINER
  {
    $$.val = tree.RoutineSecurity{Security: tree.RoutineDefiner, External: true}
  }
| EXTERNAL SECURITY INVOKER
  {
    $$.val = tree.RoutineSecurity{Security: tree.RoutineInvoker, External: true}
  }
| SECURITY DEFINER
  {
    $$.val = tree.RoutineSecurity{Security: tree.RoutineDefiner, External: false}
  }
| SECURITY INVOKER
  {
    $$.val = tree.RoutineSecurity{Security: tree.RoutineInvoker, External: false}
  }
| LEAKPROOF
  {
