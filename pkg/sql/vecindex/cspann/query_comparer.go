...
// parameter affects distance computation for certain metrics: InnerProduct and
// Cosine use normalized centroids at interior levels, while L2Squared remains
// unchanged across all levels. The Vector field must be populated in each
