...
func (vi *Index) searchForInsertHelper(
	...
	maxResults := 1
	var fullResults, results []SearchResult
	...
	for {
		...
		if len(results) == 0 {
			...
			fullResults := idxCtx.tempSearchSet.PopResults()
