...
// ForeignKey points to the unique row in the primary index that contains the
// indexed vector.
type ForeignKey []byte
...
// foreign key if this is a leaf partition, or a child partition key if this is
...
// in this partition. If this is a leaf partition, then these are foreign keys
