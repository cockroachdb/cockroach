...
// GetUnquantizedVectorChildKeyOffset returns the offset of the child key in an
// encoded full vector entry.
func GetUnquantizedVectorChildKeyOffset(dims int) int {
