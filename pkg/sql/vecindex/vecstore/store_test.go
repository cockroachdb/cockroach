...
func commonStoreTests(
	...
	primaryKey100 := ChildKey{PrimaryBytes: KeyBytes{1, 00}}
	...
	primaryKey500 := ChildKey{PrimaryBytes: KeyBytes{5, 00}}
	primaryKey600 := ChildKey{PrimaryBytes: KeyBytes{6, 00}}
	...
	t.Run("get full vectors", func(t *testing.T) {
		...
		results := []VectorWithKey{
			...
			{Key: ChildKey{PrimaryBytes: KeyBytes{0}}},
