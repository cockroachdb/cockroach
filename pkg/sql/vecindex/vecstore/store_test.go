...
func commonStoreTests(
	...
	primaryKey500 := ChildKey{PrimaryBytes: PrimaryBytes{5, 00}}
	primaryKey600 := ChildKey{PrimaryBytes: PrimaryBytes{6, 00}}
	...
	t.Run("get full vectors", func(t *testing.T) {
		...
		results := []VectorWithKey{
			...
			{Key: ChildKey{PrimaryBytes: PrimaryBytes{0}}},
			{Key: ChildKey{PrimaryBytes: testPKs[1]}},
			{Key: ChildKey{PrimaryBytes: PrimaryBytes{0}}},
			{Key: ChildKey{PrimaryBytes: testPKs[0]}},
		}
