...
func TestPersistentStore(t *testing.T) {
	...
	primaryKey200 := ChildKey{PrimaryBytes: PrimaryBytes{2, 00}}
	primaryKey300 := ChildKey{PrimaryBytes: PrimaryBytes{3, 00}}
	primaryKey400 := ChildKey{PrimaryBytes: PrimaryBytes{4, 00}}
