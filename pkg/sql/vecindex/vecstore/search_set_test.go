...
func TestSearchResult(t *testing.T) {
	...
	r1 := SearchResult{
		...
		ChildKey:             ChildKey{PrimaryBytes: []byte{10}},
	}
	r2 := SearchResult{
		...
		ChildKey:             ChildKey{PrimaryBytes: []byte{20}},
	}
	r3 := SearchResult{
		QuerySquaredDistance: 2,
		ErrorBound:           1,
		CentroidDistance:     20,
		ParentPartitionKey:   200,
		ChildKey:             ChildKey{PrimaryBytes: []byte{30}},
	}
	r4 := SearchResult{
		QuerySquaredDistance: 2,
		ErrorBound:           1,
		...
		ChildKey:             ChildKey{PrimaryBytes: []byte{40}},
	}
	r5 := SearchResult{
...
func TestSearchSet(t *testing.T) {
	...
	result1 := SearchResult{
		QuerySquaredDistance: 3, ErrorBound: 0.5, CentroidDistance: 10, ParentPartitionKey: 100, ChildKey: ChildKey{PrimaryBytes: []byte{10}}}
	result2 := SearchResult{
		QuerySquaredDistance: 6, ErrorBound: 1, CentroidDistance: 20, ParentPartitionKey: 200, ChildKey: ChildKey{PrimaryBytes: []byte{20}}}
	result3 := SearchResult{
		QuerySquaredDistance: 1, ErrorBound: 0.5, CentroidDistance: 30, ParentPartitionKey: 300, ChildKey: ChildKey{PrimaryBytes: []byte{30}}}
	result4 := SearchResult{
		QuerySquaredDistance: 4, ErrorBound: 0.5, CentroidDistance: 40, ParentPartitionKey: 400, ChildKey: ChildKey{PrimaryBytes: []byte{40}}}
	...
	result5 := SearchResult{
		QuerySquaredDistance: 6, ErrorBound: 1.5, CentroidDistance: 50, ParentPartitionKey: 500, ChildKey: ChildKey{PrimaryBytes: []byte{50}}}
	result6 := SearchResult{
		QuerySquaredDistance: 5, ErrorBound: 1, CentroidDistance: 60, ParentPartitionKey: 600, ChildKey: ChildKey{PrimaryBytes: []byte{60}}}
	...
	result7 := SearchResult{
		QuerySquaredDistance: 4, ErrorBound: 1.5, CentroidDistance: 70, ParentPartitionKey: 700, ChildKey: ChildKey{PrimaryBytes: []byte{70}}}
	...
	result8 := SearchResult{
		QuerySquaredDistance: 0.5, ErrorBound: 0.5, CentroidDistance: 80, ParentPartitionKey: 800, ChildKey: ChildKey{PrimaryBytes: []byte{80}}}
