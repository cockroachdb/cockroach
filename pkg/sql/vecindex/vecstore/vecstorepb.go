...
// Equal returns true if this key has the same partition key and foreign key as
// the given key.
func (k ChildKey) Equal(other ChildKey) bool {
	return k.PartitionKey == other.PartitionKey && bytes.Equal(k.ForeignKey, other.ForeignKey)
}
