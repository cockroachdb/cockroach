...
func (m *Manager) getVecConfig(
	...
	if err != nil {
		return vecdesc.Config{}, err
	}
	if tableDesc == nil {
		return vecdesc.Config{}, errTableNotFound
	}
	...
	if idxDesc == nil {
		return vecdesc.Config{}, errIndexNotFound
	}
	config := idxDesc.GetVecConfig()
	if config.Dims <= 0 {
		return vecdesc.Config{}, errInvalidVecConfig
	}
	return config, nil
}
