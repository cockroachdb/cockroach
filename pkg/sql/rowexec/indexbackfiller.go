...
func (ib *indexBackfiller) ingestIndexEntries(
	...
	g.GoCtx("push index backfill progress", func(ctx context.Context) error {
	...
	g.GoCtx("add index entries to BulkAdder", func(ctx context.Context) error {
...
func (ib *indexBackfiller) runBackfill(
	...
	group.GoCtx("build index entries", func(ctx context.Context) error {
	...
	group.GoCtx("ingest index entries", func(ctx context.Context) error {
