...
func newTableReader(
	...
	if _, _, err := initRowFetcher(
		flowCtx.EvalCtx.Ctx(), &fetcher, &spec.Table, int(spec.IndexIdx), columnIdxMap, spec.Reverse,
		neededColumns, spec.IsCheck, flowCtx.EvalCtx.Mon, &tr.alloc, spec.Visibility, spec.LockingStrength,
	); err != nil {
		return nil, err
	}
