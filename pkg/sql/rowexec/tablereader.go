...
func newTableReader(
	...
	var virtualColumn catalog.Column
	if spec.VirtualColumn != nil {
		found, _ := tableDesc.FindColumnWithID(spec.VirtualColumn.ID)
		if found != nil {
			virtualColumn = found.DeepCopy()
			*virtualColumn.ColumnDesc() = *spec.VirtualColumn
		}
	}
