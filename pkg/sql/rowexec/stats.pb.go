...
func (*InputStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_stats_6a6e6bd9900deb6e, []int{0}
}
...
func (*TableReaderStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_stats_6a6e6bd9900deb6e, []int{1}
}
...
type JoinReaderStats struct {
	InputStats       InputStats `protobuf:"bytes,1,opt,name=input_stats,json=inputStats,proto3" json:"input_stats"`
	IndexLookupStats InputStats `protobuf:"bytes,4,opt,name=index_lookup_stats,json=indexLookupStats,proto3" json:"index_lookup_stats"`
	IndexBytesRead   int64      `protobuf:"varint,5,opt,name=index_bytes_read,json=indexBytesRead,proto3" json:"index_bytes_read,omitempty"`
	IndexBatchesRead int64      `protobuf:"varint,6,opt,name=index_batches_read,json=indexBatchesRead,proto3" json:"index_batches_read,omitempty"`
}
...
func (*JoinReaderStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_stats_6a6e6bd9900deb6e, []int{2}
}
...
func (*HashJoinerStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_stats_6a6e6bd9900deb6e, []int{3}
}
...
func (*AggregatorStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_stats_6a6e6bd9900deb6e, []int{4}
}
...
func (*DistinctStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_stats_6a6e6bd9900deb6e, []int{5}
}
...
func (*OrdinalityStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_stats_6a6e6bd9900deb6e, []int{6}
}
...
func (*MergeJoinerStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_stats_6a6e6bd9900deb6e, []int{7}
}
...
func (*SorterStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_stats_6a6e6bd9900deb6e, []int{8}
}
...
func (*WindowerStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_stats_6a6e6bd9900deb6e, []int{9}
}
...
func (*InvertedFiltererStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_stats_6a6e6bd9900deb6e, []int{10}
}
...
func (*InvertedJoinerStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_stats_6a6e6bd9900deb6e, []int{11}
}
...
func (m *JoinReaderStats) MarshalTo(dAtA []byte) (int, error) {
	...
	i += n4
	if m.IndexBytesRead != 0 {
		dAtA[i] = 0x28
		i++
		i = encodeVarintStats(dAtA, i, uint64(m.IndexBytesRead))
	}
	if m.IndexBatchesRead != 0 {
		dAtA[i] = 0x30
		i++
		i = encodeVarintStats(dAtA, i, uint64(m.IndexBatchesRead))
	}
	return i, nil
}
...
func (m *JoinReaderStats) Size() (n int) {
	...
	n += 1 + l + sovStats(uint64(l))
	if m.IndexBytesRead != 0 {
		n += 1 + sovStats(uint64(m.IndexBytesRead))
	}
	if m.IndexBatchesRead != 0 {
		n += 1 + sovStats(uint64(m.IndexBatchesRead))
	}
	return n
}
...
func (m *JoinReaderStats) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IndexBytesRead", wireType)
			}
			m.IndexBytesRead = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.IndexBytesRead |= (int64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IndexBatchesRead", wireType)
			}
			m.IndexBatchesRead = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowStats
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.IndexBatchesRead |= (int64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func init() { proto.RegisterFile("sql/rowexec/stats.proto", fileDescriptor_stats_6a6e6bd9900deb6e) }

var fileDescriptor_stats_6a6e6bd9900deb6e = []byte{
	// 671 bytes of a gzipped FileDescriptorProto
	,
}
