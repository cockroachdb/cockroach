...
func newInvertedJoiner(
	...
	datumToInvertedExpr invertedexpr.DatumsToInvertedExpr,
	input execinfra.RowSource,
	...
	ij := &invertedJoiner{
		...
		datumsToInvertedExpr: datumToInvertedExpr,
		joinType:             spec.Type,
	...
	if ij.datumsToInvertedExpr == nil {
		...
		ij.datumsToInvertedExpr, err = invertedidx.NewDatumToInvertedExpr(
