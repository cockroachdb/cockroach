...
func newScrubTableReader(
	...
	if _, _, err := initRowFetcher(
		flowCtx.EvalCtx.Ctx(), &fetcher, &tr.tableDesc, int(spec.IndexIdx), tr.tableDesc.ColumnIdxMap(), spec.Reverse,
		neededColumns, true /* isCheck */, flowCtx.EvalCtx.Mon, &tr.alloc,
