...
type joinReaderStrategy interface {
	...
	// getInputRows returns the input rows for the current batch.
	getInputRows() []rowenc.EncDatumRow
...
func (s *joinReaderNoOrderingStrategy) getInputRows() []rowenc.EncDatumRow {
	return s.inputRows
}
...
func (s *joinReaderIndexJoinStrategy) getInputRows() []rowenc.EncDatumRow {
	return s.inputRows
}
...
func (s *joinReaderOrderingStrategy) getInputRows() []rowenc.EncDatumRow {
	return s.inputRows
}
