...
func (jb *joinerBase) init(
	...
	jb.emptyLeft, rowBuf = rowBuf[:len(leftTypes)], rowBuf[len(leftTypes):]
	jb.emptyRight, rowBuf = rowBuf[:len(rightTypes)], rowBuf[len(rightTypes):]
	jb.combinedRow = rowBuf[:rowSize]
