...
func newVectorSearchProcessor(
	...
	v.searcher.Init(idx, flowCtx.Txn, tabledesc.NewBuilder(&spec.Table).BuildImmutableTable(), searchBeamSize, maxResults, flowCtx.EvalCtx)
...
func newVectorMutationSearchProcessor(
	...
	v.searcher.Init(idx, flowCtx.Txn, tabledesc.NewBuilder(&spec.Table).BuildImmutableTable(), flowCtx.EvalCtx)
