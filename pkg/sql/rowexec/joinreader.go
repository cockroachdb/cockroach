...
// UnsafeParallizeLookupJoinsEnabled determines whether the joinReader
// parallelizes KV batches in all cases.
var UnsafeParallizeLookupJoinsEnabled = settings.RegisterBoolSetting(
	"sql.distsql.unsafe_parallelize_lookup_joins.enabled",
...
func newJoinReader(
	...
	if flowCtx.EvalCtx.SessionData().UnsafeParallelizeLookupJoinsEnabled {
