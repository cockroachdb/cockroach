...
func newJoinReader(
	...
	_, _, err = initRowFetcher(
		flowCtx.EvalCtx.Ctx(), &fetcher, &jr.desc, int(spec.IndexIdx), jr.colIdxMap, false, /* reverse */
		neededRightCols, false /* isCheck */, jr.EvalCtx.Mon, &jr.alloc, spec.Visibility, spec.LockingStrength,
	)
	if err != nil {
		return nil, err
	}
