...
func (n *reassignOwnedByNode) reassignSchemaOwner(
	...
	if err := params.p.setNewSchemaOwner(
		params.ctx, mutableSchemaDesc.(*schemadesc.Mutable), dbDesc, n.n.NewRole); err != nil {
		return err
	}
...
func (n *reassignOwnedByNode) reassignTableOwner(
	...
	if err := params.p.setNewTableOwner(
		params.ctx, mutableTbDesc.(*tabledesc.Mutable), nil /* prefix */, n.n.NewRole); err != nil {
		return err
	}
...
func (n *reassignOwnedByNode) reassignTypeOwner(
	...
	if err := params.p.setNewTypeOwner(
		params.ctx, mutableTypDesc.(*typedesc.Mutable), arrayDesc, nil /* prefix */, n.n.NewRole); err != nil {
		return err
	}
