...
// NewIndexSplitAndScatter creates a new scexec.IndexSpanSplitter implemetation.
...
func (is *indexSplitAndScatter) MaybeSplitIndexSpans(
	...
	if is.shouldSplitAndScatter(indexToBackfill) {
	...
	return is.db.AdminSplit(ctx, span.Key, expirationTime, oppurpose.SplitSchema)
}
