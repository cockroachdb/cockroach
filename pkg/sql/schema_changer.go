...
type SchemaChangerTestingKnobs struct {
	...
	// Warning: This knob is currently unimplemented in the schema changer because
	// we no longer have a way of guaranteeing that this knob runs before the jobs
	// start. It remains in some skipped tests, which need to be reworked and then
	// un-skipped.
