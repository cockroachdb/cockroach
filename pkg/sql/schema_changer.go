...
const (
	...
	// state.
	RunningStatusDeleteOnly jobs.RunningStatus = "waiting in DELETE_ONLY"
	...
	RunningStatusDeleteAndWriteOnly jobs.RunningStatus = "waiting in DELETE_AND_WRITE_ONLY"
	// RunningStatusBackfill is for jobs that are currently running a backfill
	// for a schema element.
	RunningStatusBackfill jobs.RunningStatus = "backfilling"
)
