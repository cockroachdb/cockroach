...
func tuplesDiffer(t types.T) (func(ColVec, int, ColVec, int, *bool), error) {
	switch t {
	// {{range .}}
	case _TYPES_T:
		return tuplesDiffer_TYPE, nil
	// {{end}}
	default:
		return nil, errors.Errorf("unsupported tuplesDiffer type %s", t)
	}
}
...
// the tuples differ.
func tuplesDiffer_TYPE(aColVec ColVec, aTupleIdx int, bColVec ColVec, bTupleIdx int, differ *bool) {
