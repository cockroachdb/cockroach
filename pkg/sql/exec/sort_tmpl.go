...
func (s *sort_TYPE_DIROp) init(col ColVec, order []uint64) {
...
func (s *sort_TYPE_DIROp) reorder(index []uint64) {
	// Initialize our input index vector to the inverse of the order vector. This
