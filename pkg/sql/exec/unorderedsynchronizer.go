...
// batchChanBufferSize is the number of batches a channel should buffer.
const batchChanBufferSize = 16

// unorderedSynchronizerMsg is a light wrapper over a coldata.Batch sent over a
// channel so that the main goroutine can know from which input this message
// originated from.
...
// UnorderedSynchronizer is an Operator that combines multiples Operator streams
// into one.
...
// and push to batchCh. Cancelling the context results in all goroutines
