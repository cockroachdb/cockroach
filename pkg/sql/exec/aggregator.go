...
type aggregateFunc interface {
	...
	Compute(batch col.Batch, inputIdxs []uint32)
}
...
func (a *orderedAggregator) initWithBatchSize(inputSize, outputSize int) {
	...
	a.scratch.Batch = col.NewMemBatchWithSize(a.outputTyps, inputSize*2)
...
func (a *orderedAggregator) Init() {
	a.initWithBatchSize(col.BatchSize, col.BatchSize)
}

func (a *orderedAggregator) Next() col.Batch {
	if a.done {
