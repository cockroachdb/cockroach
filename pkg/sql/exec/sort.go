...
// spooler is an operator that spools the data from its input.
...
// by general sort over the whole input.
...
func (p *allSpooler) Next() ColBatch {
	panic("Next() should not be called on allSpooler")
}
