...
// VectorizedInternalPanic simply panics with the provided error. In case when
// err does not have a PG code, it will be returned as internal error to the
// client with the corresponding stack trace. This method should be called to
// propagate all errors that originated within the vectorized engine.
