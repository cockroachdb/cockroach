...
// random elements equal to length (capcity if length is 0). The values will be
// null with a probability of nullProbability.
func RandomBatch(rng *rand.Rand, typs []coltypes.T, capacity int, length int, nullProbability float64) coldata.Batch {
