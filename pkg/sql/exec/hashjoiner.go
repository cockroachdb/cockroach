...
//    probe key, which are added to the resulting batch.
...
// fastProbe is called if the build table equality columns are distinct. It
...
// fastCollect prepares the batch with the joined output columns where the build
