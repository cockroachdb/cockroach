...
func FromColumnType(ct catpb.ColumnType) types.T {
...
// resulting slice.
func FromColumnTypes(cts []catpb.ColumnType) []types.T {
...
func GetDatumToPhysicalFn(ct catpb.ColumnType) func(tree.Datum) (interface{}, error) {
	switch ct.SemanticType {
	case catpb.ColumnType_BOOL:
