...
func (o *mergeJoinOp) resetBuilderCrossProductStateForSide(
	builderState *mjBuilderCrossProductState,
) {
	o.setBuilderColumnState(builderState, zeroMJBuilderState)
	builderState.colIdx = zeroMJBuilderState.colIdx
	builderState.finished = true
}
