...
func (m mockAddressResolver) GetInstance(_ context.Context, id base.SQLInstanceID) (sqlinstance.InstanceInfo, error) {
	return sqlinstance.InstanceInfo{InstanceID: id, Locality: m[id]}, nil
}

func (m mockAddressResolver) GetAllInstances(_ context.Context) ([]sqlinstance.InstanceInfo, error) {
