...
var LDRImmediateModeWriter = settings.RegisterStringSetting(
	...
	// TODO(jeffswenson): re-enable the crud writer
	metamorphic.ConstantWithTestChoice("logical_replication.consumer.immediate_mode_writer", string(LDRWriterTypeSQL), string(LDRWriterTypeLegacyKV)),
