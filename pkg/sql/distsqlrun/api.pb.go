...
type SetupFlowRequest struct {
	...
	// Major version of distsqlrun protocol; this has to match with the server's
	// major version.
	MajorVersion uint32 `protobuf:"varint,4,opt,name=major_version,json=majorVersion" json:"major_version"`
	// Minor version of distsqlrun protocol; a server accepts a certain range of
	// minor versions, up to its own minor version. This can be used to provide a
	// "window" of compatibility.
	//
	// Example:
	//  - we start with minor version 1; distsqlrun servers with minor version 1
	//    only accept requests with minor version 1.
	//  - a new distsqlrun feature is added; minor version is bumped to 2. The
	//    planner does not yet use this feature by default; it still issues
	//    requests with minor version 1.
	//  - servers with minor version 2 accept both version 1 and 2.
	...
	//    servers only accept minor versions >= 2.
	MinorVersion uint32 `protobuf:"varint,5,opt,name=minor_version,json=minorVersion" json:"minor_version"`
...
func (m *SetupFlowRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x20
	i++
	i = encodeVarintApi(dAtA, i, uint64(m.MajorVersion))
	dAtA[i] = 0x28
	i++
	i = encodeVarintApi(dAtA, i, uint64(m.MinorVersion))
	return i, nil
}
...
func (m *SetupFlowRequest) Size() (n int) {
	...
	l = m.Flow.Size()
	n += 1 + l + sovApi(uint64(l))
	n += 1 + sovApi(uint64(m.MajorVersion))
	n += 1 + sovApi(uint64(m.MinorVersion))
	return n
}
	...
	for iNdEx < l {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MajorVersion |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorApi = []byte{
	...
	,
}
