...
func (*ConsumerSignal) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{1} }
...
func (*DrainRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{2} }

type SetupFlowResponse struct {
}

func (m *SetupFlowResponse) Reset()                    { *m = SetupFlowResponse{} }
func (m *SetupFlowResponse) String() string            { return proto.CompactTextString(m) }
func (*SetupFlowResponse) ProtoMessage()               {}
func (*SetupFlowResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{3} }
...
func init() {
	...
	proto.RegisterType((*SetupFlowResponse)(nil), "cockroach.sql.distsqlrun.SetupFlowResponse")
}
...
type DistSQLClient interface {
	...
	SetupFlow(ctx context.Context, in *SetupFlowRequest, opts ...grpc.CallOption) (*SetupFlowResponse, error)
...
func (c *distSQLClient) SetupFlow(ctx context.Context, in *SetupFlowRequest, opts ...grpc.CallOption) (*SetupFlowResponse, error) {
	out := new(SetupFlowResponse)
...
type DistSQLServer interface {
	...
	// SetupFlow instantiates a flow (subgraphs of a distributed SQL
	// computation) on the receiving node.
	SetupFlow(context.Context, *SetupFlowRequest) (*SetupFlowResponse, error)
	// FlowStream is used to push a stream of messages that is part of a flow. The
	// first message will have a StreamHeader which identifies the flow and the
	// stream (mailbox).
	//
...
func (m *ConsumerSignal) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DrainRequest != nil {
		...
		n4, err := m.DrainRequest.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n4
	...
	if m.SetupFlowRequest != nil {
		...
		n5, err := m.SetupFlowRequest.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n5
...
func (m *SetupFlowResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *SetupFlowResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *SetupFlowResponse) Size() (n int) {
	var l int
	_ = l
	return n
}
...
func (m *SetupFlowResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SetupFlowResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SetupFlowResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
var fileDescriptorApi = []byte{
	...
	,
}
