...
type ConsumerSignal struct {
	...
	// The consumer is canceled, and is asking the producer to cancel itself as
	// well. The consumer will no longer send anything to the producer, but it
	// does require the RPC stream to be closed.
	CancelRequest *CancelRequest `protobuf:"bytes,4,opt,name=cancel_request,json=cancelRequest" json:"cancel_request,omitempty"`
}
...
func (*CancelRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{5} }
...
func init() {
	...
	proto.RegisterType((*CancelRequest)(nil), "cockroach.sql.distsqlrun.CancelRequest")
...
func (m *ConsumerSignal) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CancelRequest != nil {
		dAtA[i] = 0x22
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.CancelRequest.Size()))
		n9, err := m.CancelRequest.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n9
...
var fileDescriptorApi = []byte{
	...
	,
}
