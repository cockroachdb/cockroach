...
type ConsumerSignal struct {
	...
	// Used in the flow.Cancel() case to signal context cancellation down from
	// consumers to producers.
	CancelFlowRequest *CancelFlowRequest `protobuf:"bytes,3,opt,name=cancel_flow_request,json=cancelFlowRequest" json:"cancel_flow_request,omitempty"`
}
...
func (*CancelFlowRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{5} }
...
func init() {
	...
	proto.RegisterType((*CancelFlowRequest)(nil), "cockroach.sql.distsqlrun.CancelFlowRequest")
}
...
func (m *ConsumerSignal) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CancelFlowRequest != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.CancelFlowRequest.Size()))
		n8, err := m.CancelFlowRequest.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n8
...
func (m *CancelFlowRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *CancelFlowRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *CancelFlowRequest) Size() (n int) {
	var l int
	_ = l
	return n
}
...
func (this *ConsumerSignal) GetValue() interface{} {
	...
	if this.CancelFlowRequest != nil {
		return this.CancelFlowRequest
	}
	return nil
}
...
func (this *ConsumerSignal) SetValue(value interface{}) bool {
	...
	case *CancelFlowRequest:
		this.CancelFlowRequest = vt
	default:
		return false
	}
	return true
...
func (m *ConsumerSignal) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CancelFlowRequest", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.CancelFlowRequest == nil {
				m.CancelFlowRequest = &CancelFlowRequest{}
			}
			if err := m.CancelFlowRequest.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *CancelFlowRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CancelFlowRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CancelFlowRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
var fileDescriptorApi = []byte{
	...
	,
}
