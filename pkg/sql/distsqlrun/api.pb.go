...
type SetupFlowRequest struct {
	// TxnMeta is the TxnCoordMeta for the transaction in which the flow will run.
	// If nil, the flow will not run in a transaction higher-level transaction
	...
	TxnMeta *cockroach_roachpb1.TxnCoordMeta `protobuf:"bytes,7,opt,name=txn_meta,json=txnMeta" json:"txn_meta,omitempty"`
	// deprecated_txn used to play the role that TxnMeta now plays. It can be
	// removed in v2.2.
...
func (m *SetupFlowRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			if m.TxnMeta == nil {
				m.TxnMeta = &cockroach_roachpb1.TxnCoordMeta{}
			}
...
var fileDescriptorApi = []byte{
	...
	,
}
