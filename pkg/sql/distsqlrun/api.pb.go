...
// EvalContext is used to marshall some planner.EvalContext members, so that it
// can be reconstructed on the flow-runner node. Other members of that struct
// are initialized on each node.
