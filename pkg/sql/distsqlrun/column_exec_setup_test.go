...
// the main point of this test. The outbox's input is ends up being some inbox
// pulling from node 3. If it drains the depicted inbox, that is pulling from
// node 2 which is in turn pulling from an outbox, a cycle is created and the
// flow is blocked.
//          +------------+
//          |  Node 3    |
//          +-----+------+
