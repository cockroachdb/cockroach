	...
	*/
	...
	testCases := []zigzagJoinerTestCase{
		...
		},
		{
			...
			outCols:       []uint32{0, 1, 2, 4, 5, 7},
			expectedTypes: intCols(6),
			expected: "[[9 3 3 9 1 7] [9 0 3 9 1 7] [10 4 3 10 4 7] [10 1 3 10 4 7] [10 4 3 10 0 7] [10 1 3 10 0 7] " +
				"[11 2 3 11 3 7] [12 3 3 12 2 7] [12 0 3 12 2 7]]",
		},
		{
		...
		},
		{
			...
			spec: ZigzagJoinerSpec{
				...
				EqColumns: []Columns{{[]uint32{2}}, {[]uint32{3}}},
				Type:      sqlbase.InnerJoin,
				IndexIds:  []uint32{1 /* (e) */, 2 /* (d) */},
			},
			outCols:       []uint32{0, 1, 2, 4, 5, 7},
			expectedTypes: intCols(6),
			expected: "[[1 2 4 1 2 4] [0 3 4 1 2 4] [1 2 4 0 3 4] [0 3 4 0 3 4] [1 3 5 1 3 5] [0 4 5 1 3 5] " +
				"[1 3 5 0 4 5] [0 4 5 0 4 5] [1 4 6 1 4 6] [0 1 6 1 4 6] [1 4 6 1 0 6] [0 1 6 1 0 6] [1 4 6 0 1 6] " +
				"[0 1 6 0 1 6] [1 1 7 2 0 7] [0 2 7 2 0 7] [1 1 7 1 1 7] [0 2 7 1 1 7] [1 1 7 0 2 7] [0 2 7 0 2 7]]",
		},
		{
			desc: "test joining with primary key",
			spec: ZigzagJoinerSpec{
				Tables:    []sqlbase.TableDescriptor{*medDesc, *medDesc},
				EqColumns: []Columns{{[]uint32{0}}, {[]uint32{3}}},
				Type:      sqlbase.InnerJoin,
				IndexIds:  []uint32{0 /* primary (a, b) */, 2 /* (d) */},
			},
			outCols:       []uint32{0, 1, 2, 3, 4, 5, 7},
			expectedTypes: intCols(7),
			expected: "[[4 2 4 7 3 4 4] [4 2 4 7 3 0 4] [4 2 4 7 2 1 4] [4 2 4 7 1 2 4] [4 2 4 7 0 3 4] [4 1 3 6 3 4 4] " +
				"[4 1 3 6 3 0 4] [4 1 3 6 2 1 4] [4 1 3 6 1 2 4] [4 1 3 6 0 3 4] [4 0 5 5 3 4 4] [4 0 5 5 3 0 4] " +
				"[4 0 5 5 2 1 4] [4 0 5 5 1 2 4] [4 0 5 5 0 3 4]]",
		},
	}
...
func TestZigzagJoinerDrain(t *testing.T) {
	...
	t.Run("ConsumerClosed", func(t *testing.T) {
		...
		zz, err := newZigzagJoiner(
			...
			&PostProcessSpec{Projection: true, OutputColumns: []uint32{0, 1}},
			out,
		)
		if err != nil {
			t.Fatal(err)
