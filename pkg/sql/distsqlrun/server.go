...
var settingDiskBudgetPercent = settings.RegisterValidatedIntSetting(
	...
	"maximum amount of disk space used for a single query (as a percentage of the total capacity; requires restart); also see sql.distsql.tempstorage.max_bytes",
	10,
...
var settingDiskBudgetAbsolute = settings.RegisterByteSizeSetting(
	...
	"maximum amount of disk space used for a single query (in bytes; requires restart); also see sql.distsql.tempstorage.max_percent",
