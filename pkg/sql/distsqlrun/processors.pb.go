...
// A backfiller performs KV operations to retrieve rows for a table and
// backfills the new indexes/columns contained in the table descriptor.
type BackfillerSpec struct {
	...
	// The backfill will always at least one backfill chunk.
