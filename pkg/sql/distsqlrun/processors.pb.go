...
func (WindowerSpec_Frame_Mode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorProcessors, []int{30, 1, 0}
}
...
func (WindowerSpec_Frame_BoundType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorProcessors, []int{30, 1, 1}
}
...
type ProcessorCoreUnion struct {
	...
	CountStarTableSpec      *CountStarTableSpec          `protobuf:"bytes,25,opt,name=countStarTableSpec" json:"countStarTableSpec,omitempty"`
}
...
type CountStarTableSpec struct {
	Table cockroach_sql_sqlbase1.TableDescriptor `protobuf:"bytes,1,opt,name=table" json:"table"`
}

func (m *CountStarTableSpec) Reset()                    { *m = CountStarTableSpec{} }
func (m *CountStarTableSpec) String() string            { return proto.CompactTextString(m) }
func (*CountStarTableSpec) ProtoMessage()               {}
func (*CountStarTableSpec) Descriptor() ([]byte, []int) { return fileDescriptorProcessors, []int{29} }
...
func (*WindowerSpec) Descriptor() ([]byte, []int) { return fileDescriptorProcessors, []int{30} }
...
func (*WindowerSpec_Func) Descriptor() ([]byte, []int) { return fileDescriptorProcessors, []int{30, 0} }
...
func (*WindowerSpec_Frame) Descriptor() ([]byte, []int) { return fileDescriptorProcessors, []int{30, 1} }
...
func (*WindowerSpec_WindowFn) Descriptor() ([]byte, []int) {
	return fileDescriptorProcessors, []int{30, 2}
}
...
func init() {
	...
	proto.RegisterType((*CountStarTableSpec)(nil), "cockroach.sql.distsqlrun.CountStarTableSpec")
...
func (m *ProcessorCoreUnion) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CountStarTableSpec != nil {
		dAtA[i] = 0xca
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintProcessors(dAtA, i, uint64(m.CountStarTableSpec.Size()))
		n28, err := m.CountStarTableSpec.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n28
...
func (m *JoinReaderSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.LookupColumns) > 0 {
		dAtA33 := make([]byte, len(m.LookupColumns)*10)
		var j32 int
	...
	n35, err := m.IndexFilterExpr.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n35
...
func (m *ZigzagJoinerSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.IndexIds) > 0 {
		dAtA38 := make([]byte, len(m.IndexIds)*10)
		var j37 int
...
func (m *Columns) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.Columns) > 0 {
		dAtA41 := make([]byte, len(m.Columns)*10)
		var j40 int
...
func (m *MergeJoinerSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	n42, err := m.LeftOrdering.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n42
	...
	n43, err := m.RightOrdering.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n43
...
func (m *HashJoinerSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.LeftEqColumns) > 0 {
		dAtA46 := make([]byte, len(m.LeftEqColumns)*10)
		var j45 int
	...
	if len(m.RightEqColumns) > 0 {
		dAtA48 := make([]byte, len(m.RightEqColumns)*10)
		var j47 int
...
func (m *AggregatorSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.GroupCols) > 0 {
		dAtA51 := make([]byte, len(m.GroupCols)*10)
		var j50 int
	...
	if len(m.OrderedGroupCols) > 0 {
		dAtA53 := make([]byte, len(m.OrderedGroupCols)*10)
		var j52 int
...
func (m *BackfillerSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.Table.Size()))
	n54, err := m.Table.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n54
	...
	n55, err := m.ReadAsOf.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n55
...
func (m *FlowSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	n56, err := m.FlowID.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n56
...
func (m *ReadImportDataSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	n58, err := m.Format.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n58
...
func (m *SSTWriterSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.Progress.Size()))
	n60, err := m.Progress.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n60
...
func (m *InterleavedReaderJoinerSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.OnExpr.Size()))
	n62, err := m.OnExpr.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n62
...
func (m *InterleavedReaderJoinerSpec_Table) MarshalTo(dAtA []byte) (int, error) {
	...
	n63, err := m.Desc.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n63
	...
	n65, err := m.Ordering.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n65
...
func (m *CountStarTableSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *CountStarTableSpec) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.Table.Size()))
	n66, err := m.Table.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n66
...
func (m *CountStarTableSpec) Size() (n int) {
	var l int
	_ = l
	l = m.Table.Size()
	n += 1 + l + sovProcessors(uint64(l))
...
func (this *ProcessorCoreUnion) GetValue() interface{} {
	...
	if this.CountStarTableSpec != nil {
		return this.CountStarTableSpec
	}
	return nil
}
...
func (this *ProcessorCoreUnion) SetValue(value interface{}) bool {
	...
	case *CountStarTableSpec:
		this.CountStarTableSpec = vt
	default:
		return false
	}
	return true
...
func (m *ProcessorCoreUnion) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 25:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CountStarTableSpec", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.CountStarTableSpec == nil {
				m.CountStarTableSpec = &CountStarTableSpec{}
			}
			if err := m.CountStarTableSpec.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *CountStarTableSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CountStarTableSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CountStarTableSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorProcessors = []byte{
	...
	,
}
