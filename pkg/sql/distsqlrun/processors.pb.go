...
type SetOpSpec_Type int32

const (
	SetOpSpec_UnionAll  SetOpSpec_Type = 0
	SetOpSpec_ExceptAll SetOpSpec_Type = 1
)

var SetOpSpec_Type_name = map[int32]string{
	0: "UnionAll",
	1: "ExceptAll",
}
var SetOpSpec_Type_value = map[string]int32{
	"UnionAll":  0,
	"ExceptAll": 1,
}

func (x SetOpSpec_Type) Enum() *SetOpSpec_Type {
	p := new(SetOpSpec_Type)
	*p = x
	return p
}
func (x SetOpSpec_Type) String() string {
	return proto.EnumName(SetOpSpec_Type_name, int32(x))
}
func (x *SetOpSpec_Type) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(SetOpSpec_Type_value, data, "SetOpSpec_Type")
	if err != nil {
		return err
	}
	*x = SetOpSpec_Type(value)
	return nil
}
func (SetOpSpec_Type) EnumDescriptor() ([]byte, []int) { return fileDescriptorProcessors, []int{15, 0} }
...
type ProcessorCoreUnion struct {
	...
	Set         *SetOpSpec       `protobuf:"bytes,12,opt,name=set" json:"set,omitempty"`
}
...
type SetOpSpec struct {
	...
	Ordering Ordering       `protobuf:"bytes,1,opt,name=ordering" json:"ordering"`
	Type     SetOpSpec_Type `protobuf:"varint,2,opt,name=type,enum=cockroach.sql.distsqlrun.SetOpSpec_Type" json:"type"`
}

func (m *SetOpSpec) Reset()                    { *m = SetOpSpec{} }
func (m *SetOpSpec) String() string            { return proto.CompactTextString(m) }
func (*SetOpSpec) ProtoMessage()               {}
func (*SetOpSpec) Descriptor() ([]byte, []int) { return fileDescriptorProcessors, []int{15} }
...
func init() {
	...
	proto.RegisterType((*SetOpSpec)(nil), "cockroach.sql.distsqlrun.SetOpSpec")
	...
	proto.RegisterEnum("cockroach.sql.distsqlrun.SetOpSpec_Type", SetOpSpec_Type_name, SetOpSpec_Type_value)
}
...
func (m *ProcessorCoreUnion) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Set != nil {
		dAtA[i] = 0x62
		i++
		i = encodeVarintProcessors(dAtA, i, uint64(m.Set.Size()))
...
func (m *SetOpSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *SetOpSpec) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *SetOpSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SetOpSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SetOpSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= (SetOpSpec_Type(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorProcessors = []byte{
	...
	,
}
