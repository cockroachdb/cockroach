...
func (WindowerSpec_Frame_Exclusion) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorProcessors, []int{29, 1, 2}
}
...
func (m *JoinReaderSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.LookupColumns) > 0 {
		dAtA32 := make([]byte, len(m.LookupColumns)*10)
		var j31 int
	...
	n34, err := m.IndexFilterExpr.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n34
...
func (m *SorterSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	n35, err := m.OutputOrdering.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n35
...
func (m *ZigzagJoinerSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.IndexIds) > 0 {
		dAtA37 := make([]byte, len(m.IndexIds)*10)
		var j36 int
	...
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.OnExpr.Size()))
	n38, err := m.OnExpr.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n38
...
func (m *Columns) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.Columns) > 0 {
		dAtA40 := make([]byte, len(m.Columns)*10)
		var j39 int
...
func (m *MergeJoinerSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	n41, err := m.LeftOrdering.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n41
	...
	n42, err := m.RightOrdering.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n42
...
func (m *HashJoinerSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.LeftEqColumns) > 0 {
		dAtA45 := make([]byte, len(m.LeftEqColumns)*10)
		var j44 int
		...
		dAtA[i] = 0xa
		i++
		i = encodeVarintProcessors(dAtA, i, uint64(j44))
		i += copy(dAtA[i:], dAtA45[:j44])
	}
	if len(m.RightEqColumns) > 0 {
		dAtA47 := make([]byte, len(m.RightEqColumns)*10)
		var j46 int
	...
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.OnExpr.Size()))
	n48, err := m.OnExpr.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n48
...
func (m *AggregatorSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.GroupCols) > 0 {
		dAtA50 := make([]byte, len(m.GroupCols)*10)
		var j49 int
	...
	if len(m.OrderedGroupCols) > 0 {
		dAtA52 := make([]byte, len(m.OrderedGroupCols)*10)
		var j51 int
...
func (m *BackfillerSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.Table.Size()))
	n53, err := m.Table.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n53
	...
	n54, err := m.ReadAsOf.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n54
...
func (m *FlowSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	n55, err := m.FlowID.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n55
...
func (m *ReadImportDataSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	n57, err := m.Format.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n57
...
func (m *CSVWriterSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	n60, err := m.Options.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n60
...
func (m *InterleavedReaderJoinerSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.OnExpr.Size()))
	n61, err := m.OnExpr.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n61
...
func (m *InterleavedReaderJoinerSpec_Table) MarshalTo(dAtA []byte) (int, error) {
	...
	n62, err := m.Desc.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n62
	...
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.Post.Size()))
	n63, err := m.Post.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n63
	...
	n64, err := m.Ordering.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n64
...
func (m *WindowerSpec_Frame) MarshalTo(dAtA []byte) (int, error) {
	...
	n65, err := m.Bounds.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n65
...
func (m *WindowerSpec_Frame_Bound) MarshalTo(dAtA []byte) (int, error) {
	...
	n66, err := m.OffsetType.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n66
...
func (m *WindowerSpec_Frame_Bounds) MarshalTo(dAtA []byte) (int, error) {
	...
	n67, err := m.Start.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n67
	if m.End != nil {
		...
		n68, err := m.End.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n68
...
func (m *WindowerSpec_WindowFn) MarshalTo(dAtA []byte) (int, error) {
	...
	n69, err := m.Func.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n69
	...
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.Ordering.Size()))
	n70, err := m.Ordering.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n70
	if m.Frame != nil {
		...
		n71, err := m.Frame.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n71
...
var fileDescriptorProcessors = []byte{
	...
	,
}
