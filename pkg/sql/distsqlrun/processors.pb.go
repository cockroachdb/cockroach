...
type SamplerSpec struct {
	Sketches   []SamplerSpec_SketchSpec `protobuf:"bytes,1,rep,name=sketches" json:"sketches"`
...
func (*SamplerSpec) Descriptor() ([]byte, []int) { return fileDescriptorProcessors, []int{18} }

type SamplerSpec_SketchSpec struct {
...
func (m *SamplerSpec_SketchSpec) Reset()         { *m = SamplerSpec_SketchSpec{} }
func (m *SamplerSpec_SketchSpec) String() string { return proto.CompactTextString(m) }
func (*SamplerSpec_SketchSpec) ProtoMessage()    {}
func (*SamplerSpec_SketchSpec) Descriptor() ([]byte, []int) {
	return fileDescriptorProcessors, []int{18, 0}
}

// SampleAggregatorSpec is the specification of a processor that aggregates the
// results form multiple sampler processors and writes out the statistics to
// system.table_statistics.
//
// The input schema it expects matches the output schema of a sampler spec:
//  1. sampled row columns:
//    - sampled columns
//    - row rank
//  2. sketch columns:
...
type SampleAggregatorSpec struct {
	...
	Sketches         []SampleAggregatorSpec_SketchSpec                           `protobuf:"bytes,4,rep,name=sketches" json:"sketches"`
}
...
func (*SampleAggregatorSpec) Descriptor() ([]byte, []int) { return fileDescriptorProcessors, []int{19} }

type SampleAggregatorSpec_SketchSpec struct {
	SketchType SketchType `protobuf:"varint,1,opt,name=sketch_type,json=sketchType,enum=cockroach.sql.distsqlrun.SketchType" json:"sketch_type"`
	// Columns for which to compute the sketch.
	// TODO(radu): currently only one column is supported.
	ColumnIDs []github_com_cockroachdb_cockroach_pkg_sql_sqlbase.ColumnID `protobuf:"varint,2,rep,name=column_ids,json=columnIds,casttype=github.com/cockroachdb/cockroach/pkg/sql/sqlbase.ColumnID" json:"column_ids,omitempty"`
	...
	// If set, controls the maximum number of buckets in the histogram.
...
func (m *SampleAggregatorSpec_SketchSpec) Reset()         { *m = SampleAggregatorSpec_SketchSpec{} }
func (m *SampleAggregatorSpec_SketchSpec) String() string { return proto.CompactTextString(m) }
func (*SampleAggregatorSpec_SketchSpec) ProtoMessage()    {}
func (*SampleAggregatorSpec_SketchSpec) Descriptor() ([]byte, []int) {
...
func init() {
	...
	proto.RegisterType((*SamplerSpec_SketchSpec)(nil), "cockroach.sql.distsqlrun.SamplerSpec.SketchSpec")
	proto.RegisterType((*SampleAggregatorSpec)(nil), "cockroach.sql.distsqlrun.SampleAggregatorSpec")
	proto.RegisterType((*SampleAggregatorSpec_SketchSpec)(nil), "cockroach.sql.distsqlrun.SampleAggregatorSpec.SketchSpec")
...
func (m *SamplerSpec_SketchSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *SamplerSpec_SketchSpec) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *SampleAggregatorSpec_SketchSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *SampleAggregatorSpec_SketchSpec) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *SamplerSpec_SketchSpec) Size() (n int) {
	var l int
	_ = l
...
func (m *SampleAggregatorSpec_SketchSpec) Size() (n int) {
	var l int
	_ = l
	n += 1 + sovProcessors(uint64(m.SketchType))
	if len(m.ColumnIDs) > 0 {
...
func (m *SamplerSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Sketches = append(m.Sketches, SamplerSpec_SketchSpec{})
...
func (m *SamplerSpec_SketchSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *SampleAggregatorSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.Sketches = append(m.Sketches, SampleAggregatorSpec_SketchSpec{})
			if err := m.Sketches[len(m.Sketches)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
func (m *SampleAggregatorSpec_SketchSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
var fileDescriptorProcessors = []byte{
	...
	,
}
