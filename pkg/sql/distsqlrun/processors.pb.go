...
type AlgebraicSetSpec_Type int32

const (
	AlgebraicSetSpec_UnionAll  AlgebraicSetSpec_Type = 0
	AlgebraicSetSpec_ExceptAll AlgebraicSetSpec_Type = 1
)

var AlgebraicSetSpec_Type_name = map[int32]string{
	0: "UnionAll",
	1: "ExceptAll",
}
var AlgebraicSetSpec_Type_value = map[string]int32{
	"UnionAll":  0,
	"ExceptAll": 1,
}

func (x AlgebraicSetSpec_Type) Enum() *AlgebraicSetSpec_Type {
	p := new(AlgebraicSetSpec_Type)
	*p = x
	return p
}
func (x AlgebraicSetSpec_Type) String() string {
	return proto.EnumName(AlgebraicSetSpec_Type_name, int32(x))
}
func (x *AlgebraicSetSpec_Type) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(AlgebraicSetSpec_Type_value, data, "AlgebraicSetSpec_Type")
	if err != nil {
		return err
	}
	*x = AlgebraicSetSpec_Type(value)
	return nil
}
func (AlgebraicSetSpec_Type) EnumDescriptor() ([]byte, []int) {
...
type ProcessorCoreUnion struct {
	...
	AlgebraicSet *AlgebraicSetSpec `protobuf:"bytes,12,opt,name=algebraicSet" json:"algebraicSet,omitempty"`
}
...
// AlgebraicSetSpec is a specification for the UNION ALL and EXCEPT ALL set
// operations. INTERSECT can be implemented with HashJoinerSpec, so is not
// included here.
type AlgebraicSetSpec struct {
	// If the two input streams are both ordered by a common column ordering,
	// that ordering will be preserved in the output stream.
	Ordering Ordering              `protobuf:"bytes,1,opt,name=ordering" json:"ordering"`
	Type     AlgebraicSetSpec_Type `protobuf:"varint,2,opt,name=type,enum=cockroach.sql.distsqlrun.AlgebraicSetSpec_Type" json:"type"`
}

func (m *AlgebraicSetSpec) Reset()                    { *m = AlgebraicSetSpec{} }
func (m *AlgebraicSetSpec) String() string            { return proto.CompactTextString(m) }
func (*AlgebraicSetSpec) ProtoMessage()               {}
func (*AlgebraicSetSpec) Descriptor() ([]byte, []int) { return fileDescriptorProcessors, []int{15} }
...
func init() {
	...
	proto.RegisterType((*AlgebraicSetSpec)(nil), "cockroach.sql.distsqlrun.AlgebraicSetSpec")
	...
	proto.RegisterEnum("cockroach.sql.distsqlrun.AlgebraicSetSpec_Type", AlgebraicSetSpec_Type_name, AlgebraicSetSpec_Type_value)
}
...
func (m *ProcessorCoreUnion) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AlgebraicSet != nil {
		dAtA[i] = 0x62
		i++
		i = encodeVarintProcessors(dAtA, i, uint64(m.AlgebraicSet.Size()))
		n16, err := m.AlgebraicSet.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n16
...
func (m *DistinctSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	n21, err := m.Ordering.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n21
...
func (m *AlgebraicSetSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *AlgebraicSetSpec) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.Ordering.Size()))
	n34, err := m.Ordering.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n34
...
func (m *AlgebraicSetSpec) Size() (n int) {
	var l int
	_ = l
	l = m.Ordering.Size()
	n += 1 + l + sovProcessors(uint64(l))
...
func (this *ProcessorCoreUnion) GetValue() interface{} {
	...
	if this.AlgebraicSet != nil {
		return this.AlgebraicSet
	}
	return nil
}
...
func (this *ProcessorCoreUnion) SetValue(value interface{}) bool {
	...
	case *BackfillerSpec:
		this.Backfiller = vt
	case *AlgebraicSetSpec:
		this.AlgebraicSet = vt
	default:
		return false
	}
	return true
...
func (m *ProcessorCoreUnion) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AlgebraicSet", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.AlgebraicSet == nil {
				m.AlgebraicSet = &AlgebraicSetSpec{}
			}
			if err := m.AlgebraicSet.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *AlgebraicSetSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AlgebraicSetSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AlgebraicSetSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= (AlgebraicSetSpec_Type(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorProcessors = []byte{
	...
	,
}
