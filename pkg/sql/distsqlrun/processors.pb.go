...
type AggregatorSpec_Aggregation struct {
	...
	// CRDB version 1.0 nodes were sending this field instead of the newer
	// col_idx. Generally, queries coming from these nodes are rejected through
	// the MinAcceptedVersion mechanism and so we shouldn't have to care about
	// this field, except when the --extra-1.0-compatibility flag is set; in
	// that case, this field is supported too.
	ColIdx_1_0 *uint32 `protobuf:"varint,3,opt,name=col_idx_1_0,json=colIdx10" json:"col_idx_1_0,omitempty"`
}
...
func (m *AggregatorSpec_Aggregation) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ColIdx_1_0 != nil {
		dAtA[i] = 0x18
		i++
		i = encodeVarintProcessors(dAtA, i, uint64(*m.ColIdx_1_0))
	}
...
func (m *AggregatorSpec_Aggregation) Size() (n int) {
	...
	n += 2
	if m.ColIdx_1_0 != nil {
		n += 1 + sovProcessors(uint64(*m.ColIdx_1_0))
	}
	if m.FilterColIdx != nil {
...
func (m *AggregatorSpec_Aggregation) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ColIdx_1_0", wireType)
			}
			var v uint32
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorProcessors = []byte{
	...
	,
}
