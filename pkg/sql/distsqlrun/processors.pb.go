...
// with those of the table, depending on the lookup columns as described below.
// Internally, only the values for the columns needed by the post-processing
// stage are be populated.
//
// Input stream columns: a (int) | b (string)           Table columns: c (bool)
// If performing a lookup join (lookup columns is not empty):
//        Internal columns: a (int) | b (string) | c (bool)
// If performing an index join (lookup columns is empty):
//        Internal columns: c (bool)
type JoinReaderSpec struct {
	...
	IndexIdx uint32 `protobuf:"varint,2,opt,name=index_idx,json=indexIdx" json:"index_idx"`
	// Column indicies in the input stream which specify which columns match
	// to values in the index. These are the equality columns of the join.
	// If empty, the start of the columns is assumed to match the index columns.
	// The joinReader will perform an index join and the "internal columns" will
	// be the columns of the table.
...
var fileDescriptorProcessors = []byte{
	...
	,
}
