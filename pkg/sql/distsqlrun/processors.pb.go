...
func (AggregatorSpec_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorProcessors, []int{16, 1}
}
...
type WindowerSpec_Func int32

const (
	// These mirror aggregate functions from AggregatorSpec.
	WindowerSpec_ANY_NOT_NULL   WindowerSpec_Func = 0
	WindowerSpec_AVG            WindowerSpec_Func = 1
	WindowerSpec_BOOL_AND       WindowerSpec_Func = 2
	WindowerSpec_BOOL_OR        WindowerSpec_Func = 3
	WindowerSpec_CONCAT_AGG     WindowerSpec_Func = 4
	WindowerSpec_COUNT          WindowerSpec_Func = 5
	WindowerSpec_MAX            WindowerSpec_Func = 7
	WindowerSpec_MIN            WindowerSpec_Func = 8
	WindowerSpec_STDDEV         WindowerSpec_Func = 9
	WindowerSpec_SUM            WindowerSpec_Func = 10
	WindowerSpec_SUM_INT        WindowerSpec_Func = 11
	WindowerSpec_VARIANCE       WindowerSpec_Func = 12
	WindowerSpec_XOR_AGG        WindowerSpec_Func = 13
	WindowerSpec_COUNT_ROWS     WindowerSpec_Func = 14
	WindowerSpec_SQRDIFF        WindowerSpec_Func = 15
	WindowerSpec_FINAL_VARIANCE WindowerSpec_Func = 16
	WindowerSpec_FINAL_STDDEV   WindowerSpec_Func = 17
	WindowerSpec_ARRAY_AGG      WindowerSpec_Func = 18
	WindowerSpec_JSON_AGG       WindowerSpec_Func = 19
	// JSONB_AGG is an alias for JSON_AGG, they do the same thing.
	WindowerSpec_JSONB_AGG WindowerSpec_Func = 20
	// These mirror window functions from window_builtins.go.
	WindowerSpec_ROW_NUMBER   WindowerSpec_Func = 21
	WindowerSpec_RANK         WindowerSpec_Func = 22
	WindowerSpec_DENSE_RANK   WindowerSpec_Func = 23
	WindowerSpec_PERCENT_RANK WindowerSpec_Func = 24
	WindowerSpec_CUME_DIST    WindowerSpec_Func = 25
	WindowerSpec_NTILE        WindowerSpec_Func = 26
	WindowerSpec_LAG          WindowerSpec_Func = 27
	WindowerSpec_LEAD         WindowerSpec_Func = 28
	WindowerSpec_FIRST_VALUE  WindowerSpec_Func = 29
	WindowerSpec_LAST_VALUE   WindowerSpec_Func = 30
	WindowerSpec_NTH_VALUE    WindowerSpec_Func = 31
)

var WindowerSpec_Func_name = map[int32]string{
	0:  "ANY_NOT_NULL",
	1:  "AVG",
	2:  "BOOL_AND",
	3:  "BOOL_OR",
...
var WindowerSpec_Func_value = map[string]int32{
	"ANY_NOT_NULL":   0,
	"AVG":            1,
	"BOOL_AND":       2,
	"BOOL_OR":        3,
...
func (x WindowerSpec_Func) Enum() *WindowerSpec_Func {
	p := new(WindowerSpec_Func)
	*p = x
	return p
}
func (x WindowerSpec_Func) String() string {
	return proto.EnumName(WindowerSpec_Func_name, int32(x))
}
func (x *WindowerSpec_Func) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(WindowerSpec_Func_value, data, "WindowerSpec_Func")
	if err != nil {
		return err
	}
	*x = WindowerSpec_Func(value)
	return nil
}
func (WindowerSpec_Func) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorProcessors, []int{28, 0}
}
...
func (WindowerSpec_Frame_Mode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorProcessors, []int{28, 0, 0}
}
...
const (
	...
	WindowerSpec_Frame_VALUE_PRECEDING     WindowerSpec_Frame_BoundType = 1
	WindowerSpec_Frame_CURRENT_ROW         WindowerSpec_Frame_BoundType = 2
	WindowerSpec_Frame_VALUE_FOLLOWING     WindowerSpec_Frame_BoundType = 3
	WindowerSpec_Frame_UNBOUNDED_FOLLOWING WindowerSpec_Frame_BoundType = 4
)
...
func (WindowerSpec_Frame_BoundType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorProcessors, []int{28, 0, 1}
}
...
func (*ProjectSetSpec) Descriptor() ([]byte, []int) { return fileDescriptorProcessors, []int{27} }

// WindowerSpec is the specification of a processors that performs computations
// of window functions that have the same PARTITION BY clause. For a particular
// windowFn, the processor puts the output at windowFn.ArgIdxStart and "consumes"
...
func (*WindowerSpec) Descriptor() ([]byte, []int) { return fileDescriptorProcessors, []int{28} }
...
func (*WindowerSpec_Frame) Descriptor() ([]byte, []int) { return fileDescriptorProcessors, []int{28, 0} }

// Bound specifies the offset and the type of boundary.
...
type WindowerSpec_WindowFn struct {
	...
	Func WindowerSpec_Func `protobuf:"varint,1,opt,name=func,enum=cockroach.sql.distsqlrun.WindowerSpec_Func" json:"func"`
	// ArgIdxStart indicates from which index arguments to this window function start.
	...
	// Ordering specifies in which order rows should be considered by this window function.
	// Its contents come from ORDER BY clause of a window function.
	Ordering Ordering `protobuf:"bytes,4,opt,name=ordering" json:"ordering"`
	// Frame specifies over which frame this window function should be computed.
...
func (*WindowerSpec_WindowFn) Descriptor() ([]byte, []int) {
	return fileDescriptorProcessors, []int{28, 1}
}
...
func init() {
	...
	proto.RegisterEnum("cockroach.sql.distsqlrun.WindowerSpec_Func", WindowerSpec_Func_name, WindowerSpec_Func_value)
...
func (m *WindowerSpec_Frame) MarshalTo(dAtA []byte) (int, error) {
	...
	n64, err := m.Bounds.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n64
...
func (m *WindowerSpec_Frame_Bounds) MarshalTo(dAtA []byte) (int, error) {
	...
	n65, err := m.Start.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n65
	if m.End != nil {
		...
		n66, err := m.End.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n66
...
func (m *WindowerSpec_WindowFn) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Frame != nil {
		...
		n68, err := m.Frame.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n68
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Func |= (WindowerSpec_Func(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorProcessors = []byte{
	...
	,
}
