...
type ProcessorCoreUnion struct {
	...
	RowToSST    *RowToSSTSpec       `protobuf:"bytes,14,opt,name=rowToSST" json:"rowToSST,omitempty"`
}
...
type RowToSSTSpec struct {
	SSTDestination string `protobuf:"bytes,1,opt,name=SST_destination,json=SSTDestination" json:"SST_destination"`
	Name           string `protobuf:"bytes,2,opt,name=name" json:"name"`
	Walltime       int64  `protobuf:"varint,3,opt,name=walltime" json:"walltime"`
}

func (m *RowToSSTSpec) Reset()                    { *m = RowToSSTSpec{} }
func (m *RowToSSTSpec) String() string            { return proto.CompactTextString(m) }
func (*RowToSSTSpec) ProtoMessage()               {}
func (*RowToSSTSpec) Descriptor() ([]byte, []int) { return fileDescriptorProcessors, []int{17} }
...
func init() {
	...
	proto.RegisterType((*RowToSSTSpec)(nil), "cockroach.sql.distsqlrun.RowToSSTSpec")
...
func (m *ProcessorCoreUnion) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RowToSST != nil {
		dAtA[i] = 0x72
		i++
		i = encodeVarintProcessors(dAtA, i, uint64(m.RowToSST.Size()))
		n18, err := m.RowToSST.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n18
...
func (m *ReadCSVSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	n37, err := m.TableDesc.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n37
...
func (m *RowToSSTSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *RowToSSTSpec) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	dAtA[i] = 0xa
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(len(m.SSTDestination)))
	i += copy(dAtA[i:], m.SSTDestination)
	dAtA[i] = 0x12
	i++
	...
	dAtA[i] = 0x18
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.Walltime))
	return i, nil
}
...
func (m *RowToSSTSpec) Size() (n int) {
	var l int
	_ = l
	l = len(m.SSTDestination)
	n += 1 + l + sovProcessors(uint64(l))
	l = len(m.Name)
	n += 1 + l + sovProcessors(uint64(l))
	n += 1 + sovProcessors(uint64(m.Walltime))
	return n
}
...
func (this *ProcessorCoreUnion) GetValue() interface{} {
	...
	if this.RowToSST != nil {
		return this.RowToSST
	}
	return nil
}
...
func (m *ProcessorCoreUnion) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 14:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RowToSST", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.RowToSST == nil {
				m.RowToSST = &RowToSSTSpec{}
			}
			if err := m.RowToSST.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *RowToSSTSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RowToSSTSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RowToSSTSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SSTDestination", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SSTDestination = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
...
var fileDescriptorProcessors = []byte{
	...
	,
}
