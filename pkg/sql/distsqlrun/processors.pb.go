...
type AggregatorSpec struct {
	...
	// For queries where there are no group columns (e.g. `SELECT MAX(x)`), if
	// there are no input rows, we still emit a row of results (0 for COUNT, NULL
	// for everything else). If this flag is set, this row is suppressed. This is
	// useful for the local stage of a distributed aggregation.
	SuppressEmptyResult bool `protobuf:"varint,4,opt,name=suppress_empty_result,json=suppressEmptyResult" json:"suppress_empty_result"`
}
...
func (m *AggregatorSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SuppressEmptyResult", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SuppressEmptyResult = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipProcessors(dAtA[iNdEx:])
			if err != nil {
...
var fileDescriptorProcessors = []byte{
	...
	,
}
