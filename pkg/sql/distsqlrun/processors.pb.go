...
type HashJoinerSpec struct {
	...
	OnExpr Expression `protobuf:"bytes,5,opt,name=on_expr,json=onExpr" json:"on_expr"`
	Type   JoinType   `protobuf:"varint,6,opt,name=type,enum=cockroach.sql.distsqlrun.JoinType" json:"type"`
	// Extra merged columns that are added in case of OUTER JOINS.
	// These columns occupy first positions in a row and have a value
	// either from left or right stream whatever not NULL. In INNER JOIN case
	// no merged columns are needed since left stream values guaranteed to be not NULL.
...
var fileDescriptorProcessors = []byte{
	...
	,
}
