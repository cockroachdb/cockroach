...
type HashJoinerSpec struct {
	...
	OnExpr Expression `protobuf:"bytes,5,opt,name=on_expr,json=onExpr" json:"on_expr"`
	Type   JoinType   `protobuf:"varint,6,opt,name=type,enum=cockroach.sql.distsqlrun.JoinType" json:"type"`
	// Number of extra merged columns that are added in case of OUTER JOINS.
	// These columns occupy first positions in a row.
	NumMergedColumns uint32 `protobuf:"varint,7,opt,name=num_merged_columns,json=numMergedColumns" json:"num_merged_columns"`
}
...
func (m *HashJoinerSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x38
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.NumMergedColumns))
	return i, nil
}
...
func (m *HashJoinerSpec) Size() (n int) {
	...
	n += 1 + l + sovProcessors(uint64(l))
	n += 1 + sovProcessors(uint64(m.Type))
	n += 1 + sovProcessors(uint64(m.NumMergedColumns))
	return n
}
...
func (m *HashJoinerSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field NumMergedColumns", wireType)
			}
			m.NumMergedColumns = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowProcessors
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.NumMergedColumns |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorProcessors = []byte{
	...
	,
}
