...
type SetSpec_Type int32

const (
	SetSpec_Union        SetSpec_Type = 0
	SetSpec_UnionAll     SetSpec_Type = 1
	SetSpec_Intersect    SetSpec_Type = 2
	SetSpec_IntersectAll SetSpec_Type = 3
	SetSpec_Except       SetSpec_Type = 4
	SetSpec_ExceptAll    SetSpec_Type = 5
)

var SetSpec_Type_name = map[int32]string{
	0: "Union",
	1: "UnionAll",
	2: "Intersect",
	3: "IntersectAll",
...
var SetSpec_Type_value = map[string]int32{
	"Union":        0,
	"UnionAll":     1,
	"Intersect":    2,
	"IntersectAll": 3,
...
func (x SetSpec_Type) Enum() *SetSpec_Type {
	p := new(SetSpec_Type)
	*p = x
	return p
}
func (x SetSpec_Type) String() string {
	return proto.EnumName(SetSpec_Type_name, int32(x))
}
func (x *SetSpec_Type) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(SetSpec_Type_value, data, "SetSpec_Type")
	if err != nil {
		return err
	}
	*x = SetSpec_Type(value)
	return nil
}
func (SetSpec_Type) EnumDescriptor() ([]byte, []int) { return fileDescriptorProcessors, []int{15, 0} }
...
type ProcessorCoreUnion struct {
	...
	Set         *SetSpec         `protobuf:"bytes,12,opt,name=set" json:"set,omitempty"`
}
...
type SetSpec struct {
	...
	Type     SetSpec_Type `protobuf:"varint,2,opt,name=type,enum=cockroach.sql.distsqlrun.SetSpec_Type" json:"type"`
}

func (m *SetSpec) Reset()                    { *m = SetSpec{} }
func (m *SetSpec) String() string            { return proto.CompactTextString(m) }
func (*SetSpec) ProtoMessage()               {}
func (*SetSpec) Descriptor() ([]byte, []int) { return fileDescriptorProcessors, []int{15} }
...
func init() {
	...
	proto.RegisterType((*SetSpec)(nil), "cockroach.sql.distsqlrun.SetSpec")
	...
	proto.RegisterEnum("cockroach.sql.distsqlrun.SetSpec_Type", SetSpec_Type_name, SetSpec_Type_value)
}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= (SetSpec_Type(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorProcessors = []byte{
	...
	,
}
