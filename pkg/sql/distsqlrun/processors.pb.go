...
type InterleaveReaderJoinerTable struct {
	...
	// projections) after reading from the table as if the rows had been read from
	// TableReaders themselves.
...
// performs intermediate filtering on rows from each table, and performs a merge
// join on the rows from the 2+ tables based on some equality constraints.
//
// The rows from 2+ tables must have the same ordering on the columns that
// have equality constraints. For example:
//   SELECT * FROM child INNER JOIN parent ON child.C1 = parent.C5 AND child.C2 = parent.C4.
//
// To perform a merge join, the streams corresponding to child and parent must
// have the same ordering on columns C1, C2 and C5, C4 respectively. For
// example: C1+,C2- and C5+,C4-.
//
...
var fileDescriptorProcessors = []byte{
	...
	,
}
