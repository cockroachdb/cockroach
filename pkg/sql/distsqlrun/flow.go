...
// Run starts the flow just like Start but the last processor is run
// synchronously. f.Wait() is called internally, so the call blocks until all
// the flow's goroutines are done.
