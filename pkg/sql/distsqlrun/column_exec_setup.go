...
type vectorizedFlowRunner interface {
	...
	// runComponent adds a component (either a router or an outbox) to be run
	// asynchronously.
	runComponent(runFn)
...
func (r *actualVectorizedFlowRunner) runComponent(run runFn) {
...
func (f *Flow) setupVectorizedFlow(ctx context.Context, acc *mon.BoundAccount) error {
	...
	creator := newVectorizedFlowCreator(
		runner, recordingStats, &f.waitGroup, f.syncFlowConsumer, f.nodeDialer, f.id,
	)
...
func (r *noopVectorizedFlowRunner) runComponent(runFn) {}
