...
func newColOperator(
	...
	case core.Aggregator != nil:
		...
		if len(aggSpec.Aggregations) == 0 {
			...
			return nil, nil, isStreamingOp, errors.Newf("aggregator with no aggregate functions is unsupported in vectorized")
		}
	...
	case core.MergeJoiner != nil:
		...
		if core.MergeJoiner.Type == sqlbase.JoinType_INTERSECT_ALL ||
			...
			return nil, nil, isStreamingOp, errors.AssertionFailedf("unexpectedly %s merge join was planned", core.MergeJoiner.Type.String())
		}
