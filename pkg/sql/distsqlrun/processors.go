...
//           // The next loop iteration will take the `return nil, p.drainHelper()`
//           // brach. We could do that return here directly instead of looping
//           // around, but we choose to loop around for consistency with the case
//           // where processRowHelper() calls moveToDraining() internally.
//           p.moveToDraining(nil /* err */)
//         }
//         continue
//       }
