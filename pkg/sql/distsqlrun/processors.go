...
type processorBase struct {
	...
	// preGetTraceData, if set, will be called before getting the trace data from
	// the span and adding the recording to the trailing metadata. Useful for
	// adding any extra informaion (e.g. stats) that should be captured in a
	// trace.
	preGetTraceData func()
