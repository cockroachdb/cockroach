...
// in the spec.
func (spec *WindowerSpec_Frame_Bounds) initFromAST(b tree.WindowFrameBounds, evalCtx *tree.EvalContext) error {
	if b.StartBound == nil {
...
func (spec *WindowerSpec_Frame) InitFromAST(
	...
	if err := spec.Bounds.initFromAST(f.Bounds, evalCtx); err != nil {
		return err
	}
	return nil
}

func (m WindowerSpec_Frame_Mode) convertToAST() tree.WindowFrameMode {
	switch m {
...
func (bt WindowerSpec_Frame_BoundType) convertToAST() tree.WindowFrameBoundType {
	switch bt {
...
func (b WindowerSpec_Frame_Bounds) convertToAST() tree.WindowFrameBounds {
	bounds := tree.WindowFrameBounds{StartBound: &tree.WindowFrameBound{
		BoundType: b.Start.BoundType.convertToAST(),
	}}
	if b.End != nil {
		bounds.EndBound = &tree.WindowFrameBound{BoundType: b.End.BoundType.convertToAST()}
	}
	return bounds
}

func (f *WindowerSpec_Frame) convertToAST() *tree.WindowFrame {
	return &tree.WindowFrame{Mode: f.Mode.convertToAST(), Bounds: f.Bounds.convertToAST()}
}
