...
type mergeJoinerTestCase struct {
	...
	outCols       []uint32
	leftTypes     []catpb.ColumnType
	leftInput     sqlbase.EncDatumRows
	rightTypes    []catpb.ColumnType
	rightInput    sqlbase.EncDatumRows
	expectedTypes []catpb.ColumnType
...
func TestMergeJoiner(t *testing.T) {
	...
	testCases := []mergeJoinerTestCase{
		...
		},
		{
			...
			expectedTypes: []catpb.ColumnType{sqlbase.IntType, sqlbase.IntType, sqlbase.IntType, sqlbase.IntType},
			expected: sqlbase.EncDatumRows{
				{null, v[4], null, null},
				{null, null, null, v[4]},
				{v[0], null, null, null},
