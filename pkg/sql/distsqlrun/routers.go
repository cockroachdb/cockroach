...
// them.
func makeRouter(spec *execinfrapb.OutputRouterSpec, streams []distsql.RowReceiver) (router, error) {
	if len(streams) == 0 {
...
func (rb *routerBase) setupStreams(
	spec *execinfrapb.OutputRouterSpec, streams []distsql.RowReceiver,
) {
