...
type RowSource interface {
	...
	// Start prepares the RowSource for future Next() calls and
	// provides the context in which these future calls should operate.
	// Start needs to be called before Next/ConsumerDone/ConsumerClosed.
	//
...
// Start is part of the RowSource interface.
func (mrc *MultiplexedRowChannel) Start(ctx context.Context) {
