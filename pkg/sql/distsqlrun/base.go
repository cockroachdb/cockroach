...
// ProducerDone().
func (rc *RowChannel) InitWithNumSenders(types []catpb.ColumnType, numSenders int) {
...
func (rc *RowChannel) initWithBufSizeAndNumSenders(
	types []catpb.ColumnType, chanBufSize, numSenders int,
) {
	rc.types = types
...
func (rc *RowChannel) OutputTypes() []catpb.ColumnType {
	return rc.types
}
...
func (rc *RowChannel) Types() []catpb.ColumnType {
	return rc.types
}
...
func NewRowBuffer(
	types []catpb.ColumnType, rows sqlbase.EncDatumRows, hooks RowBufferArgs,
) *RowBuffer {
	if types == nil {
...
// Types is part of the RowReceiver interface.
func (rb *RowBuffer) Types() []catpb.ColumnType {
	return rb.types
}

// OutputTypes is part of the RowSource interface.
func (rb *RowBuffer) OutputTypes() []catpb.ColumnType {
	if rb.types == nil {
