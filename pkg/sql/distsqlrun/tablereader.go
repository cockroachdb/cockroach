...
type tableReader struct {
	...
	// maxResultHint is non-zero if there is a limit on the total number of rows
...
func newTableReader(
	...
	tr.maxResultHint = spec.MaxResultHint
...
func (tr *tableReader) Start(ctx context.Context) context.Context {
	...
	// TODO(asubiotto): I'm not sure this limitHint == 0 check is necessary.
	if tr.maxResultHint != 0 &&
		tr.maxResultHint < ParallelScanResultThreshold &&
		tr.limitHint == 0 &&
