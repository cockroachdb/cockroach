...
type OutputRouterSpec_RangeRouterSpec struct {
	...
	// []byte, which is used as input to the spans.
...
type OutputRouterSpec_RangeRouterSpec_ColumnEncoding struct {
	...
	// encoding is the sqlbase.DatumEncoding to use.
	Encoding int32 `protobuf:"varint,2,opt,name=encoding" json:"encoding"`
}
...
var fileDescriptorData = []byte{
	...
	,
}
