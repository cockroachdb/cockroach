...
type Expression struct {
	...
	LocalExprIdx uint32 `protobuf:"varint,3,opt,name=local_expr_idx,json=localExprIdx" json:"local_expr_idx"`
}
...
func (m *Expression) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x18
	i++
	i = encodeVarintData(dAtA, i, uint64(m.LocalExprIdx))
	return i, nil
}
...
func (m *Expression) Size() (n int) {
	...
	l = len(m.Expr)
	n += 1 + l + sovData(uint64(l))
	n += 1 + sovData(uint64(m.LocalExprIdx))
	return n
}
...
func (m *Expression) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LocalExprIdx", wireType)
			}
			m.LocalExprIdx = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LocalExprIdx |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorData = []byte{
	...
	,
}
