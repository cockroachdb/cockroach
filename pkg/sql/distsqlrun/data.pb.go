...
type OutputRouterSpec_RangeRouterSpec struct {
	// spans is a slice of roachpb.Span. A key matching the Nth span will be
	// routed to the Nth stream (and thus the number of spans must match the
	// number of streams).
	Spans []cockroach_roachpb1.Span `protobuf:"bytes,4,rep,name=spans" json:"spans"`
	// default_dest, if not nil, is the index of the stream to send both NULLs
	// and keys that do not match any span. (Key columns of incorrect types
	// always produce an error.) If nil, a NULL or key that does not match a
	// span will produce an error in the router.
	DefaultDest *int32 `protobuf:"varint,5,opt,name=default_dest,json=defaultDest" json:"default_dest,omitempty"`
	// key_column is the index of the key column in incoming rows. It must be
	// of type DBytes.
	KeyColumn uint32 `protobuf:"varint,6,opt,name=key_column,json=keyColumn" json:"key_column"`
}
...
func (m *OutputRouterSpec_RangeRouterSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x30
	i++
	i = encodeVarintData(dAtA, i, uint64(m.KeyColumn))
	return i, nil
}
...
func (m *OutputRouterSpec_RangeRouterSpec) Size() (n int) {
	...
	n += 1 + sovData(uint64(m.KeyColumn))
	return n
}
...
var fileDescriptorData = []byte{
	...
	,
}
