...
type Error_VersionMismatchError struct {
	VersionMismatchError *VersionMismatchError `protobuf:"bytes,3,opt,name=version_mismatch_error,json=versionMismatchError,oneof"`
}

func (*Error_PGError) isError_Detail()              {}
func (*Error_RetryableTxnError) isError_Detail()    {}
func (*Error_VersionMismatchError) isError_Detail() {}
...
func (m *Error) GetVersionMismatchError() *VersionMismatchError {
	if x, ok := m.GetDetail().(*Error_VersionMismatchError); ok {
		return x.VersionMismatchError
	}
	return nil
}
...
func (*Error) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _Error_OneofMarshaler, _Error_OneofUnmarshaler, _Error_OneofSizer, []interface{}{
		...
		(*Error_VersionMismatchError)(nil),
	}
}
...
func _Error_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Error_VersionMismatchError:
		...
		if err := b.EncodeMessage(x.VersionMismatchError); err != nil {
			return err
		}
	case nil:
	default:
...
func _Error_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 2: // detail.retryableTxnError
		...
		return true, err
	case 3: // detail.version_mismatch_error
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(VersionMismatchError)
		err := b.DecodeMessage(msg)
		m.Detail = &Error_VersionMismatchError{msg}
		return true, err
	default:
		return false, nil
	}
...
func _Error_OneofSizer(msg proto.Message) (n int) {
	...
	case *Error_RetryableTxnError:
		...
		n += s
	case *Error_VersionMismatchError:
		s := proto.Size(x.VersionMismatchError)
...
// VersionMismatchError is returned by SetupFlowRequest when the requested
// version is outside of [server_min_version..server_version].
type VersionMismatchError struct {
	RequestedVersion uint32 `protobuf:"varint,1,opt,name=requested_version,json=requestedVersion" json:"requested_version"`
	ServerVersion    uint32 `protobuf:"varint,2,opt,name=server_version,json=serverVersion" json:"server_version"`
	ServerMinVersion uint32 `protobuf:"varint,3,opt,name=server_min_version,json=serverMinVersion" json:"server_min_version"`
}

func (m *VersionMismatchError) Reset()                    { *m = VersionMismatchError{} }
func (m *VersionMismatchError) String() string            { return proto.CompactTextString(m) }
func (*VersionMismatchError) ProtoMessage()               {}
func (*VersionMismatchError) Descriptor() ([]byte, []int) { return fileDescriptorData, []int{1} }
...
type StreamEndpointSpec struct {
	...
	// Address to attempt if connecting to target_addr fails or is slow. Only used
	// for outgoing remote streams.
	// It's guaranteed that at most one of the attempts to connect to
	// {target_addr, fallback_addr} will succeed (so it's safe to attempt them in
	// parallel) - they will not both accept the incoming stream.
	//
	// If the field is left null, then no fallback will be used.
	FallbackAddr *string `protobuf:"bytes,4,opt,name=fallback_addr,json=fallbackAddr" json:"fallback_addr,omitempty"`
}
...
func (*RemoteProducerMetadata_TraceData) Descriptor() ([]byte, []int) {
	return fileDescriptorData, []int{11, 1}
}

func init() {
	proto.RegisterType((*Error)(nil), "cockroach.sql.distsqlrun.Error")
	proto.RegisterType((*VersionMismatchError)(nil), "cockroach.sql.distsqlrun.VersionMismatchError")
...
func (m *Error_VersionMismatchError) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.VersionMismatchError != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintData(dAtA, i, uint64(m.VersionMismatchError.Size()))
		n4, err := m.VersionMismatchError.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n4
...
func (m *VersionMismatchError) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *VersionMismatchError) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	dAtA[i] = 0x8
	i++
	i = encodeVarintData(dAtA, i, uint64(m.RequestedVersion))
	dAtA[i] = 0x10
	i++
	i = encodeVarintData(dAtA, i, uint64(m.ServerVersion))
	dAtA[i] = 0x18
	i++
	i = encodeVarintData(dAtA, i, uint64(m.ServerMinVersion))
	return i, nil
}
...
func (m *StreamEndpointSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.FallbackAddr != nil {
		dAtA[i] = 0x22
		i++
		i = encodeVarintData(dAtA, i, uint64(len(*m.FallbackAddr)))
...
func (m *Error_VersionMismatchError) Size() (n int) {
	var l int
	_ = l
	if m.VersionMismatchError != nil {
		l = m.VersionMismatchError.Size()
		n += 1 + l + sovData(uint64(l))
	}
	return n
}
func (m *VersionMismatchError) Size() (n int) {
	var l int
	_ = l
	n += 1 + sovData(uint64(m.RequestedVersion))
	n += 1 + sovData(uint64(m.ServerVersion))
	n += 1 + sovData(uint64(m.ServerMinVersion))
	return n
}
...
func (m *Error) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field VersionMismatchError", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &VersionMismatchError{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Detail = &Error_VersionMismatchError{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *VersionMismatchError) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: VersionMismatchError: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: VersionMismatchError: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RequestedVersion |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ServerMinVersion", wireType)
			}
			m.ServerMinVersion = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowData
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ServerMinVersion |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorData = []byte{
	...
	,
}
