...
type RemoteProducerMetadata_RowNum struct {
	ReaderId string `protobuf:"bytes,1,opt,name=reader_id,json=readerId" json:"reader_id"`
...
func (m *RemoteProducerMetadata_RowNum) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0xa
	i++
	i = encodeVarintData(dAtA, i, uint64(len(m.ReaderId)))
	i += copy(dAtA[i:], m.ReaderId)
	dAtA[i] = 0x10
	i++
...
func (m *RemoteProducerMetadata_RowNum) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.ReaderId = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RowNum", wireType)
...
var fileDescriptorData = []byte{
	...
	,
}
