...
type Error struct {
	// Node at which the error was generated.
	...
	// In distsql a particular error on a node can result in a cascade of
	// errors on other nodes, all seen by the gateway node.
	// This is to allow a gateway node to identify an error that is indeed
	// the original authoritative one.
	Authoritative bool `protobuf:"varint,3,opt,name=authoritative" json:"authoritative"`
...
type Error_PGError struct {
	PGError *cockroach_pgerror.Error `protobuf:"bytes,4,opt,name=pg_error,json=pgError,oneof"`
}
...
var fileDescriptorData = []byte{
	...
	,
}
