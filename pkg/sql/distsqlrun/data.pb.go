...
type Error_RetryableTxnError struct {
	RetryableTxnError *cockroach_roachpb2.InternalRetryableTxnError `protobuf:"bytes,2,opt,name=retryableTxnError,oneof"`
}
...
func (m *Error) GetRetryableTxnError() *cockroach_roachpb2.InternalRetryableTxnError {
...
func _Error_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 2: // detail.retryableTxnError
		...
		msg := new(cockroach_roachpb2.InternalRetryableTxnError)
		err := b.DecodeMessage(msg)
...
func (m *Error) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			v := &cockroach_roachpb2.InternalRetryableTxnError{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
...
var fileDescriptorData = []byte{
	...
	,
}
