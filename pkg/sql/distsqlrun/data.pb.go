...
type InputStats struct {
	...
	NumRows int32 `protobuf:"varint,2,opt,name=num_rows,json=numRows" json:"num_rows"`
}
...
func (*InputStats) Descriptor() ([]byte, []int) { return fileDescriptorData, []int{11} }

// BytesAccountStats represents the stats collected from a mon.BytesAccount,
// which is usually used to monitor in-memory and disk usage.
type BytesAccountStats struct {
	Name string `protobuf:"bytes,1,opt,name=name" json:"name"`
	// max_used is the maximum number of bytes used.
	MaxUsed int32 `protobuf:"varint,2,opt,name=max_used,json=maxUsed" json:"max_used"`
}

func (m *BytesAccountStats) Reset()                    { *m = BytesAccountStats{} }
func (m *BytesAccountStats) String() string            { return proto.CompactTextString(m) }
func (*BytesAccountStats) ProtoMessage()               {}
func (*BytesAccountStats) Descriptor() ([]byte, []int) { return fileDescriptorData, []int{12} }
...
func (*DistSQLVersionGossipInfo) Descriptor() ([]byte, []int) { return fileDescriptorData, []int{13} }
...
func (*DistSQLDrainingInfo) Descriptor() ([]byte, []int) { return fileDescriptorData, []int{14} }
...
func init() {
	...
	proto.RegisterType((*BytesAccountStats)(nil), "cockroach.sql.distsqlrun.BytesAccountStats")
...
func (m *InputStats) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x10
	i++
	i = encodeVarintData(dAtA, i, uint64(m.NumRows))
	return i, nil
}

func (m *BytesAccountStats) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *BytesAccountStats) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	dAtA[i] = 0x10
	i++
	i = encodeVarintData(dAtA, i, uint64(m.MaxUsed))
	return i, nil
}
...
func (m *InputStats) Size() (n int) {
	...
	l = len(m.Name)
	n += 1 + l + sovData(uint64(l))
	n += 1 + sovData(uint64(m.NumRows))
	return n
}

func (m *BytesAccountStats) Size() (n int) {
	var l int
	_ = l
	l = len(m.Name)
	n += 1 + l + sovData(uint64(l))
	n += 1 + sovData(uint64(m.MaxUsed))
	return n
}
...
func (m *BytesAccountStats) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BytesAccountStats: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BytesAccountStats: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxUsed", wireType)
			}
			m.MaxUsed = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorData = []byte{
	...
	,
}
