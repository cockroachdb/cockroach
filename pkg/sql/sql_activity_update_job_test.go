...
func TestSqlActivityUpdateJob(t *testing.T) {
	...
	ts.SQLServer().(*Server).GetSQLStatsProvider().(*persistedsqlstats.PersistedSQLStats).
		Flush(ctx, ts.SQLServer().(*Server).GetInsightsProvider())
...
func TestMergeFunctionLogic(t *testing.T) {
	...
	srv.SQLServer().(*Server).GetSQLStatsProvider().(*persistedsqlstats.PersistedSQLStats).
		Flush(ctx, srv.SQLServer().(*Server).GetInsightsProvider())
