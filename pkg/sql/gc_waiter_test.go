...
// TODO(pbardea): Still need to test dropping multiple indexes with different GC
// TTLs and dropping multiple tables + database where each database has a
// different GC TTL.
// Another case that needs to be tested is dropping indexes and entire tables
// with different deadlines. (e.g. Index to be deleted in 2s and Table to be
// deleted in 20s).
