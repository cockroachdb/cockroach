...
// newColBatchScan creates a new colBatchScan.
...
) (*colBatchScan, *roachpb.BoundedStalenessHeader, *cFetcherTableArgs, error) {
...
func NewColBatchScan(
	...
	base, bsHeader, tableArgs, err := newColBatchScan(
	...
	if err = fetcher.Init(allocator, kvFetcher, tableArgs); err != nil {
		fetcher.Release()
		return nil, nil, err
	}
	return &ColBatchScan{
