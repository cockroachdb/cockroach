...
func NewColBatchScan(
	...
	if err = keepOnlyNeededColumns(
		evalCtx, tableArgs, idxMap, spec.NeededColumns, post, helper, flowCtx.TraceKV,
	); err != nil {
		return nil, err
	}
	...
	if err = fetcher.Init(flowCtx.Codec(), allocator, tableArgs, spec.HasSystemColumns); err != nil {
		fetcher.Release()
		return nil, err
	}
