...
func (rf *cFetcher) StartScanStreaming(
	...
	var err error
	rf.streamerInfo.budget, err = kvcoord.NewBudget(ctx, rf.streamerInfo.budgetAcc, rf.streamerInfo.budgetLimit)
	if err != nil {
		return err
	}
	rf.streamerInfo.Streamer = kvcoord.NewStreamer(
