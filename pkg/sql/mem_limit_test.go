...
func TestMemoryLimit(t *testing.T) {
	...
	// We'll use a small value for --max-sql-memory startup argument but will
	// not modify the distsql_workmem variable (which is 64MiB by default).
	s, db, _ := serverutils.StartServer(t, base.TestServerArgs{
		SQLMemoryPoolSize: 4 << 20, /* 4MiB */
	})
