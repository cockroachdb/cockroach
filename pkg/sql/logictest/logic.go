...
func (t *logicTest) newTestServerCluster(bootstrapBinaryPath, upgradeBinaryPath string) func() {
...
func (t *logicTest) setup(
	...
	if cfg.UseCockroachGoTestserver {
		...
		cleanupTestCluster := t.newTestServerCluster(bootstrapBinaryPath, upgradeBinaryPath)
		t.testCleanupFuncs = append(t.testCleanupFuncs, cleanupTestCluster)
	} else {
		t.newCluster(serverArgs, t.clusterOpts, t.knobOpts, t.toa)
	}
