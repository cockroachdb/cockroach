...
var logicTestConfigs = []testClusterConfig{
	...
	{name: "local-opt", numNodes: 1,
		overrideDistSQLMode: "off", overrideOptimizerMode: "on", overrideAutoStats: "false",
	},
	{name: "local-vec", numNodes: 1,
		overrideOptimizerMode: "on", overrideVectorize: "on",
	},
	{name: "fakedist", numNodes: 3, useFakeSpanResolver: true,
		overrideDistSQLMode: "on", overrideOptimizerMode: "off", overrideVectorize: "off",
	},
	{name: "fakedist-opt", numNodes: 3, useFakeSpanResolver: true,
		overrideDistSQLMode: "on", overrideOptimizerMode: "on", overrideAutoStats: "false",
		overrideVectorize: "off",
	},
	{name: "fakedist-metadata", numNodes: 3, useFakeSpanResolver: true,
		overrideDistSQLMode: "on", overrideOptimizerMode: "off",
		distSQLMetadataTestEnabled: true, skipShort: true, overrideVectorize: "off",
	},
	{name: "fakedist-disk", numNodes: 3, useFakeSpanResolver: true,
		overrideDistSQLMode: "on", overrideOptimizerMode: "off",
		distSQLUseDisk: true, skipShort: true, overrideVectorize: "off",
	},
	{name: "5node-local", numNodes: 5,
		overrideDistSQLMode: "off", overrideOptimizerMode: "off",
	},
	{name: "5node-dist", numNodes: 5,
		overrideDistSQLMode: "on", overrideOptimizerMode: "off", overrideVectorize: "off",
	},
	{name: "5node-dist-vec", numNodes: 5,
		overrideDistSQLMode: "on", overrideOptimizerMode: "on", overrideVectorize: "on",
		overrideAutoStats: "false",
	},
	{name: "5node-dist-opt", numNodes: 5,
		overrideDistSQLMode: "on", overrideOptimizerMode: "on", overrideAutoStats: "false",
		overrideVectorize: "off",
	},
	{name: "5node-dist-metadata", numNodes: 5,
		overrideDistSQLMode: "on", distSQLMetadataTestEnabled: true,
		skipShort: true, overrideOptimizerMode: "off", overrideVectorize: "off",
	},
	{name: "5node-dist-disk", numNodes: 5,
		overrideDistSQLMode: "on", distSQLUseDisk: true, skipShort: true,
		overrideOptimizerMode: "off", overrideVectorize: "off",
	},
}
