...
func (t *logicTest) newCluster(
	...
	supportsMVCCRangeTombstones := (t.cfg.BootstrapVersion.Equal(roachpb.Version{}) ||
		!t.cfg.BootstrapVersion.Less(clusterversion.ByKey(clusterversion.TODOAlwaysTrue))) &&
		(t.cfg.BinaryVersion.Equal(roachpb.Version{}) ||
			!t.cfg.BinaryVersion.Less(clusterversion.ByKey(clusterversion.TODOAlwaysTrue)))
...
`); err != nil {
	...
	if !t.cfg.BootstrapVersion.Equal(roachpb.Version{}) && t.cfg.BootstrapVersion.Less(clusterversion.ByKey(clusterversion.TODOAlwaysTrue)) {
