...
type logicTest struct {
	...
	// with 25% probability, a random value in [1, 100] range with 25%
...
func RunLogicTestWithDefaultConfig(
	...
	randomizedMutationsMaxBatchSize := randomValue(rng, []int{1, 1 + rng.Intn(100)}, []float64{0.25, 0.25}, mutations.MaxBatchSize())
