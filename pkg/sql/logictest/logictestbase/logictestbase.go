...
var LogicTestConfigs = []TestClusterConfig{
	...
	},
	{
		...
		NumNodes:            1,
		OverrideDistSQLMode: "off",
		// The primary configurations which exercise this configuration are virtual
		// table tests, many of which do not support secondary tenants.
		DisableDefaultTestTenant:               true,
		UseIndexLookupForDescriptorsInDatabase: true,
	},
	{
