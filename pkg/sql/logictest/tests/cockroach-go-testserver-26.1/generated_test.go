...
package testcockroach_go_testserver_261
...
func TestLogic_mixed_version_statement_hints_hash_with_database(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
	runLogicTest(t, "mixed_version_statement_hints_hash_with_database")
}
