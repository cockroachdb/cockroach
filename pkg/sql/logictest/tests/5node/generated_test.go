...
func TestLogic_5node_contentionevent(
	t *testing.T,
) {
...
func TestLogic_5node_distvectorize(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestLogic_5node_distsqlagg(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestLogic_5node_distsqlcrdbinternal(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestLogic_5node_distsqldatetime(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestLogic_5node_distsqldistincton(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestLogic_5node_distsqlenum(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestLogic_5node_distsqlnumtables(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestLogic_5node_distsqlstats(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestLogic_5node_distsqlsubquery(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestLogic_5node_distsqlunion(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestLogic_5node_experimentaldistsqlplanning5node(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestLogic_5node_hashjoindist(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestLogic_5node_invertedfiltergeospatialdist(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestLogic_5node_invertedjoingeospatialdist(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestLogic_5node_mergejoindist(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestLogic_5node_tenantslowrepro(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
