...
func TestLogic_localmixed212221_rowlevelttlmixed212221(
	t *testing.T,
) {
...
func TestLogic_localmixed212221_scram221upgrade(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestLogic_localmixed212221_superregionsmixedversion(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
	runLogicTest(t, "super_regions_mixed_version")
}
