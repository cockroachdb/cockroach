...
func TestLogic_5nodedisk_contentionevent(
	t *testing.T,
) {
...
func TestLogic_5nodedisk_distvectorize(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestLogic_5nodedisk_distsqlagg(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestLogic_5nodedisk_distsqlcrdbinternal(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestLogic_5nodedisk_distsqldatetime(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestLogic_5nodedisk_distsqldistincton(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestLogic_5nodedisk_distsqlenum(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestLogic_5nodedisk_distsqlnumtables(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestLogic_5nodedisk_distsqlsubquery(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestLogic_5nodedisk_distsqlunion(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestLogic_5nodedisk_hashjoindist(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestLogic_5nodedisk_invertedjoingeospatialdist(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
...
func TestLogic_5nodedisk_mergejoindist(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
