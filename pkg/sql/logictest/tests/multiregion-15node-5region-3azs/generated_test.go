...
func TestLogic_multi_region_zone_config_extensions(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
	runLogicTest(t, "multi_region_zone_config_extensions")
}

func TestLogic_secondary_region(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
	runLogicTest(t, "secondary_region")
}

func TestLogic_super_regions(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
	runLogicTest(t, "super_regions")
}

func TestLogic_super_regions_backup(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
	runLogicTest(t, "super_regions_backup")
}

func TestLogic_super_regions_cluster_settings(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
	runLogicTest(t, "super_regions_cluster_settings")
}

func TestLogic_super_regions_survival_goal(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
	runLogicTest(t, "super_regions_survival_goal")
}
