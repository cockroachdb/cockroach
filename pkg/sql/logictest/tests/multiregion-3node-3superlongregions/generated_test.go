...
package testmultiregion_3node_3superlongregions
...
func TestLogic_multi_region_zone_configs_long_regions(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
	runLogicTest(t, "multi_region_zone_configs_long_regions")
}
