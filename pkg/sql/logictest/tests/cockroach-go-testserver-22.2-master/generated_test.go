...
package testcockroach_go_testserver_222_master
...
func TestLogic_testserver_22_2_23_1_external_connections_user_id_upgrade(
	t *testing.T,
) {
	defer leaktest.AfterTest(t)()
	runLogicTest(t, "testserver_22.2_23.1_external_connections_user_id_upgrade")
}
