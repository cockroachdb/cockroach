...
func captureMVCCStats(
	...
	lastUpdatedNanos := tree.MustBeDInt(row[1])
	...
	return &eventpb.MVCCStats{
		ContainsEstimates:    int64(containsEstimates),
		LastUpdatedNanos:     int64(lastUpdatedNanos),
		...
		ValueBytes:           int64(valBytes),
		ValueCount:           int64(valCount),
