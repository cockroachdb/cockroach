...
type Server struct {
	...
	// ServerMetrics is used to account Server activities that are unrelated to
...
// ServerMetrics collects timeseries data about Server activity that are
// unrelated to SQL plannings and executions.
