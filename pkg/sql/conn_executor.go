...
func NewServer(cfg *ExecutorConfig, pool *mon.BytesMonitor) *Server {
	...
	s.schemaTelemetryController = schematelemetrycontroller.NewController(
		s.cfg.DB, &schemaTelemetryIE, s.cfg.Settings, s.cfg.JobRegistry,
	)
...
func (s *Server) Start(ctx context.Context, stopper *stop.Stopper) {
	...
	s.schemaTelemetryController.EnsureScheduleAtStartup(ctx)
	s.schemaTelemetryController.RegisterClusterSettingHook(ctx)
