...
//
// sdMutator can be nil; this is appropriate for session-bound internal
// executors which are not supposed to modify session data.
func (s *Server) newConnExecutor(
	...
	if sdMutator != nil {
		// TODO(radu, andrei): these fields are kind of hacky, couldn't they live in
		// SessionData?
		sdMutator.curTxnReadOnly = &ex.state.readOnly
