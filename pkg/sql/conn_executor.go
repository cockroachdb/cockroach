...
type connExecutor struct {
	...
	extraTxnState struct {
		...
		storedProcTxnState struct {
			...
			// callRowDescSent tracks whether RowDescription has already been sent for a CALL statement
			// to prevent duplicate RowDescription messages when stored procedures contain COMMIT/ROLLBACK.
