...
type connExecutor struct {
	...
	extraTxnState struct {
		...
		// kvCPUTimeNanos is separate from accumulatedStats since it is always
		// collected as opposed to QueryLevelStats which are sampled. Like
		// accumulatedStats, it spans all execution attempts.
