...
func GetStatusParam(ctx context.Context, connHandler ConnectionHandler, varName string) string {
	...
	hasDefault, defVal := getSessionVarDefaultString(name, v, &ex.dataMutator)
	if !hasDefault {
