...
func NewServer(cfg *ExecutorConfig, pool *mon.BytesMonitor) *Server {
	...
	reportedSQLStats := sslocal.NewSQLStatsLocalProvider(
		cfg.Settings,
	...
	sqlStats := sslocal.NewSQLStatsLocalProvider(
		cfg.Settings,
...
func (s *Server) GetUnscrubbedStmtStats(
	...
	var stmtStatsVisitor sqlstats.StatementVisitor
...
func (s *Server) GetUnscrubbedTxnStats(
	...
	var txnStatsVisitor sqlstats.TransactionVisitor
