...
func (ex *connExecutor) initEvalCtx(ctx context.Context, p *planner, evalCtx *extendedEvalContext) {
...
func (ex *connExecutor) resetEvalCtx(
	txn *client.Txn, stmtTS time.Time, evalCtx *extendedEvalContext,
) {
...
func (ex *connExecutor) initPlanner(ctx context.Context, p *planner) {
	...
	ex.initEvalCtx(ctx, p, &p.extendedEvalCtx)
...
func (ex *connExecutor) resetPlanner(
	...
	ex.resetEvalCtx(txn, stmtTS, &p.extendedEvalCtx)
