...
func (h ConnectionHandler) RegisterOnSessionDataChange(key string, f func(val interface{})) {
...
func (s *Server) newConnExecutor(
	...
	if sdMutator != nil {
		...
		sdMutator.RegisterOnSessionDataChange("application_name", func(val interface{}) {
			newName := val.(string)
