...
type StatementCounters struct {
	...
	// TotalCRUDCount includes all 4 CRUD statements above.
	TotalCRUDCount telemetry.CounterWithMetric
...
func makeStartedStatementCounters(internal bool) StatementCounters {
	return StatementCounters{
		...
		TotalCRUDCount: telemetry.NewCounterWithMetric(
			getMetricMeta(MetaTotalCRUDStarted, internal)),
...
func makeExecutedStatementCounters(internal bool) StatementCounters {
	return StatementCounters{
		...
		TotalCRUDCount: telemetry.NewCounterWithMetric(
			getMetricMeta(MetaTotalCRUDExecuted, internal)),
		DdlCount: telemetry.NewCounterWithMetric(
