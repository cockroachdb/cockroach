		...
		err := func() error {
			...
			if portal.pauseInfo != nil {
				if tcmd.Limit != 0 {
					...
					// When a portal has no execution limit, it will continue to run until
					// it has exhausted all rows. Therefore, this type of portal is not
					// intended to be paused mid-execution.
