...
func (sp sessionParams) sessionData(settings *cluster.Settings) *sessiondata.SessionData {
	if sp.data != nil {
		return sp.data
	}
	...
	sd.SetApplicationName(sp.args.ApplicationName)
	return sd
}
...
func (s *Server) newConnExecutor(
	...
	sd := sargs.sessionData(s.cfg.Settings)
