...
// setSizeConstants updates the values defined above for tests. If any of the
// passed-in arguments is not positive, it is ignored. A cleanup function is
// returned to restore the original values.
