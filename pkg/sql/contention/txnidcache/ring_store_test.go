...
func TestShard(t *testing.T) {
	...
	t.Run("multi-strips", func(t *testing.T) {
		...
		// Looking up an empty ringStore shouldn't cause any problem.
		...
		// We are inserting more than the capacity of the ringStore. This means
