...
func (p *planner) SetSessionCharacteristics(n *tree.SetSessionCharacteristics) (planNode, error) {
	...
	// Note: We also support SET DEFAULT_TRANSACTION_USE_FOLLOWER_READ_TIMESTAMP TO ' .... '.
	//
	...
	// way to do this is SET DEFAULT_TRANSACTION_USE_FOLLOWER_READ_TIMESTAMP TO FALSE;
