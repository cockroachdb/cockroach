...
func addSeconds(curr time.Time, seconds int) func() time.Time {
		...
		datadriven.RunTest(t, path, func(t *testing.T, d *datadriven.TestData) string {
			...
			case "addSessionBatch":
				...
				for i := 0; i < sessions; i++ {
					...
					// TODO(gtr): sleeping doesn't change the actual time of the cache.
					//						this could be a problem for real use cases where
					//						sessions may be added with delays.
