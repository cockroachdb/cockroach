...
// PGString returns the representation of CastContext as a string.
func PGString(castCtx tree.CastContext) string {
	switch castCtx {
	case tree.CastContextExplicit:
		return "e"
	case tree.CastContextAssignment:
		return "a"
	case tree.CastContextImplicit:
		return "i"
	}
	return ""
}
