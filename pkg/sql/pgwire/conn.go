...
func (c *conn) serveImpl(
	...
	if sqlServer != nil {
		...
		if err := c.sendReadyForQuery(0 /* backendKeyData */); err != nil {
			reserved.Close(ctx)
			return
		}
	}
...
func (c *conn) sendInitialConnData(
	...
	if err := c.sendReadyForQuery(connHandler.GetBackendKeyData()); err != nil {
		return sql.ConnectionHandler{}, err
	}
...
func (c *conn) sendReadyForQuery(backendKeyData pgwirecancel.BackendKeyData) error {
	...
	c.msgBuilder.putInt64(int64(backendKeyData))
