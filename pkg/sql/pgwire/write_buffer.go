...
func (b *writeBuffer) writeLengthPrefixedString(s string, specifiedLength int) {
	b.putInt32(int32(specifiedLength))
	b.writeString(s)
}

// writeLengthPrefixedByteSlice writes a length-prefixed byte slice. The
// length is encoded as an int32.
func (b *writeBuffer) writeLengthPrefixedByteSlice(v []byte, specifiedLength int) {
	b.putInt32(int32(specifiedLength))
	b.write(v)
}
