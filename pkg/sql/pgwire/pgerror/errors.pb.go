...
type Error struct {
	...
	OriginMarker         string   `protobuf:"bytes,8,opt,name=origin_marker,json=originMarker,proto3" json:"origin_marker,omitempty"`
...
func (*Error) Descriptor() ([]byte, []int) {
	return fileDescriptor_errors_7e07537ae42edeaa, []int{0}
}
...
func (*Error_Source) Descriptor() ([]byte, []int) {
	return fileDescriptor_errors_7e07537ae42edeaa, []int{0, 0}
}
...
func (*Error_SafeDetail) Descriptor() ([]byte, []int) {
	return fileDescriptor_errors_7e07537ae42edeaa, []int{0, 1}
}
...
func (m *Error) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.OriginMarker) > 0 {
		dAtA[i] = 0x42
		i++
		i = encodeVarintErrors(dAtA, i, uint64(len(m.OriginMarker)))
		i += copy(dAtA[i:], m.OriginMarker)
	}
	return i, nil
}
...
func (m *Error) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OriginMarker", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OriginMarker = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func init() {
	proto.RegisterFile("sql/pgwire/pgerror/errors.proto", fileDescriptor_errors_7e07537ae42edeaa)
}

var fileDescriptor_errors_7e07537ae42edeaa = []byte{
	// 365 bytes of a gzipped FileDescriptorProto
	,
}
