...
func (*Error) Descriptor() ([]byte, []int) {
	return fileDescriptor_errors_f6bf33d2d6b32c16, []int{0}
}
...
func (*Error_Source) Descriptor() ([]byte, []int) {
	return fileDescriptor_errors_f6bf33d2d6b32c16, []int{0, 0}
}
...
func (*Error_SafeDetail) Descriptor() ([]byte, []int) {
	return fileDescriptor_errors_f6bf33d2d6b32c16, []int{0, 1}
}
...
func init() {
	proto.RegisterFile("sql/pgwire/pgerror/errors.proto", fileDescriptor_errors_f6bf33d2d6b32c16)
}

var fileDescriptor_errors_f6bf33d2d6b32c16 = []byte{
