...
func (*Error) Descriptor() ([]byte, []int) {
	return fileDescriptor_errors_080b775addbd2a6b, []int{0}
}
...
func (*Error_Source) Descriptor() ([]byte, []int) {
	return fileDescriptor_errors_080b775addbd2a6b, []int{0, 0}
}
...
func init() {
	proto.RegisterFile("sql/pgwire/pgerror/errors.proto", fileDescriptor_errors_080b775addbd2a6b)
}

var fileDescriptor_errors_080b775addbd2a6b = []byte{
