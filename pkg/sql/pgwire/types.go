...
// appending to the provided tmp buffer if it is large enough and returning the
// resulting buffer. The function is mostly cribbed from github.com/lib/pq.
