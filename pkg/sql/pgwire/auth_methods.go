...
func authTrust(
	...
	return func(_ context.Context, _, _ security.SQLUsername, _ bool) (func(), error) { return nil, nil }, nil
}
...
func authReject(
	...
	return func(_ context.Context, _, _ security.SQLUsername, _ bool) (func(), error) {
