...
type JWTVerifier interface {
	...
	ExtractGroups(st *cluster.Settings, token []byte) ([]string, error)
}
...
func (c *noJWTConfigured) ExtractGroups(_ *cluster.Settings, _ []byte) ([]string, error) {
...
func authJwtToken(
	...
	b.SetAuthenticator(func(
		...
		groups, err := jwtVerifier.ExtractGroups(execCfg.Settings, []byte(token))
		if err != nil {
