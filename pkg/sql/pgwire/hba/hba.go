...
// files. "go generate" should be executed in this directory when conf.rl is
// changed. Since it is changed so rarely it is not hooked up to the Makefile
// dependency checker, and thus ragel isn't a dependency for all developers.

//go:generate ragel -Z conf.rl
//go:generate sed -i "1s/^/\\/\\/ Code generated by ragel. DO NOT EDIT.\\n/" conf.go
//go:generate gofmt -w -s conf.go
