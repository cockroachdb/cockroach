...
var _ fmt.Formatter = (*withMessageTooBig)(nil)
var _ errors.Formatter = (*withMessageTooBig)(nil)
...
func (w *withMessageTooBig) Format(s fmt.State, verb rune) { errors.FormatError(w, s, verb) }

func (w *withMessageTooBig) FormatError(p errors.Printer) (next error) {
	return w.cause
}
