...
func decodeWithCandidateCode(cause error, _ string, details []string, _ proto.Message) error {
...
func init() {
	errbase.RegisterWrapperDecoder(errbase.GetTypeKey(&withCandidateCode{}), decodeWithCandidateCode)
}
