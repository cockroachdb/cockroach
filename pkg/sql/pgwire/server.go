...
// MaxNumConnections is the maximum number of SQL connections to the server allowed at a given time. 0 is unlimited.
var MaxNumConnections = settings.RegisterIntSetting(
	settings.TenantWritable,
	"server.max_connections_per_gateway",
	"the maximum number of SQL connections to the server allowed at a given time, 0 is unlimited",
	0,
