...
func TestPLpgSQLErrorContext(t *testing.T) {
	...
	t.Run("named_function_raise", func(t *testing.T) {
		...
		require.Equal(t, "PL/pgSQL function test_check_positive line 4 at RAISE", pqErr.Where)
	})
	...
	t.Run("named_function_constraint_error", func(t *testing.T) {
		...
		require.Equal(t, "PL/pgSQL function test_withdraw line 6 at SQL statement", pqErr.Where)
	})
	...
	t.Run("named_procedure_call", func(t *testing.T) {
		...
		require.Equal(t, "PL/pgSQL function test_validate_name line 4 at RAISE", pqErr.Where)
	})
	...
	t.Run("nested_function_call", func(t *testing.T) {
		...
		require.Contains(t, pqErr.Where, "PL/pgSQL function test_inner_fn line 3 at RAISE")
	})
}
