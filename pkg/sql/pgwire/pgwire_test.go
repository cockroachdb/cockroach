...
func TestPGPreparedQuery(t *testing.T) {
	...
	queryTests := []struct {
		...
		{"SHOW INDEXES FROM system.users", []preparedQueryTest{
			baseTest.Results("users", "primary", false, 1, "username", "N/A", "ASC", false, false, true).
				Results("users", "primary", false, 2, "hashedPassword", "N/A", "N/A", true, false, true).
				Results("users", "primary", false, 3, "isRole", "N/A", "N/A", true, false, true).
				Results("users", "primary", false, 4, "user_id", "N/A", "N/A", true, false, true).
				Results("users", "users_user_id_idx", false, 1, "user_id", "N/A", "ASC", false, false, true).
				Results("users", "users_user_id_idx", false, 2, "username", "N/A", "ASC", true, true, true),
		}},
