...
func TestPGPreparedQuery(t *testing.T) {
	...
	queryTests := []struct {
		...
		{"SHOW INDEXES FROM system.users", []preparedQueryTest{
			baseTest.Results("users", "primary", false, 1, "username", "ASC", false, false, false).
				Results("users", "primary", false, 2, "hashedPassword", "N/A", true, false, false).
				Results("users", "primary", false, 3, "isRole", "N/A", true, false, false),
		}},
