...
func WithColumnFilter(filter func(*tree.ColumnTableDef) bool) TableOption {
	return func(o *tableOptions) {
...
func WithPrimaryIndexFilter(
	filter func(*tree.IndexTableDef, []*tree.ColumnTableDef) bool,
) TableOption {
	return func(o *tableOptions) {
...
func WithIndexFilter(filter func(tree.TableDef, []*tree.ColumnTableDef) bool) TableOption {
	return func(o *tableOptions) {
