...
func (s *Builder) InitWithFetchSpec(
	...
	s.KeyPrefix = rowenc.MakeIndexKeyPrefix(codec, descpb.ID(spec.TableID), descpb.IndexID(spec.IndexID))
}
...
func (s *Builder) SpanFromEncDatumsWithRange(
	...
	isDesc := s.keyAndPrefixCols[prefixLen].Direction == fetchpb.IndexColumn_DESC
	if isDesc {
