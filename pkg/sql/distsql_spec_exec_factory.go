...
func (e *distSQLSpecExecFactory) ConstructLiteralValues(
	...
	// Handle special cases for zero or one row.
...
func (e *distSQLSpecExecFactory) makeTrivialValues(
	...
	// Special case no columns or no rows.
...
func (e *distSQLSpecExecFactory) constructValues(
	...
	if wrapPlan {
		...
		physPlan, pIdx, err := e.dsp.createValuesPlan(planCtx, spec, colTypes)
		if err != nil {
			return nil, err
		}
...
func (e *distSQLSpecExecFactory) ConstructOrdinality(
	...
	physPlan.AddSingleGroupStage(e.ctx, e.gatewaySQLInstanceID, ordinalitySpec, execinfrapb.PostProcessSpec{}, outputTypes)
...
func (e *distSQLSpecExecFactory) ConstructWindow(
	...
	if len(partitionIdxs) > 0 {
		...
		// execution. TODO(yuzefovich): we might want to be smarter about this and
