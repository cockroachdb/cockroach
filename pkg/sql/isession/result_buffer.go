...
type resultBuffer struct {
	// resultBuffer does not contain a mutex. It does not require synchronization
	// because InternalSession calls RunOneCmd to run query execution instead of
	// pushing commands to another goroutine and using the resultBuffer to
	// synchronize the query caller and the query executor.
...
func (i *resultBuffer) Flush(pos sql.CmdPos) error {
	...
	// by without it. Either by explicitly paginating large queries or pushing
