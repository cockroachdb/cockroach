...
func performMultiRegionFinalization(
	...
	regionConfig, err := SynthesizeRegionConfig(ctx, txn, dbDesc, descsCol)
	if err != nil {
		return nil, err
	}
	...
	return repartitionRegionalByRowTables(ctx, typeDesc, dbDesc, txn, execCfg, descsCol, regionConfig)
}
