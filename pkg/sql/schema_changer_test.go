...
func addIndexSchemaChange(t *testing.T, sqlDB *gosql.DB, kvDB *client.DB, maxValue int, numKeysPerRow int) {
...
func addColumnSchemaChange(t *testing.T, sqlDB *gosql.DB, kvDB *client.DB, maxValue int, numKeysPerRow int) {
...
func dropColumnSchemaChange(t *testing.T, sqlDB *gosql.DB, kvDB *client.DB, maxValue int, numKeysPerRow int) {
...
`); err != nil {
	...
	addIndexSchemaChange(t, sqlDB, kvDB, maxValue, 2)
	if e := 1; numReevaluated != e {
		t.Fatalf("exected %d reevaluations, but seen %d", e, numReevaluated)
	}
