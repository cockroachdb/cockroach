...
`,
	populate: func(ctx context.Context, p *planner, dbContext *dbdesc.Immutable, addRow func(...tree.Datum) error) error {
		...
		return forEachTableDescAllWithTableLookup(ctx, p, dbContext, hideVirtual, true,
...
CREATE TABLE crdb_internal.invalid_objects (
  ...
  error         STRING
	...
	populate: func(
		...
		return forEachTableDescAllWithTableLookup(ctx, p, dbContext, hideVirtual, false, func(
