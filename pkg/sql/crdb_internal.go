...
func changefeedPrivilegeCheck(
	...
	if p.ExecCfg().DistSQLSrv.TestingKnobs.JobsTestingKnobs.(*jobs.TestingKnobs).OrderChangefeedDescriptorsInPrivilegeCheck {
		sort.Sort(jobspb.ChangefeedTargetSpecifications(specs))
	}
