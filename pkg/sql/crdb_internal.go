...
// crdb_internal.statement_transactions view merges in-memory cluster transactions statistics from
// the crdb_internal.cluster_transaction_statistics virtual table with persisted statement
// statistics from the system table. Equivalent stats between tables are aggregated. This
// view is primarily used to query statement stats info by date range.
