...
func ExplainTreePlanNodeToJSON(node *roachpb.ExplainTreePlanNode) json.JSON {
	...
	// Create a new json.ObjectBuilder with 3 key-value pairs for the node's name, attributes, and children.
	...
	for _, attr := range node.Attrs {
		// Create a new json.ObjectBuilder with 1 key-value pair, for the attribute's key/value.
		attrBuilder := json.NewObjectBuilder(1 /* numAddsHint */)
