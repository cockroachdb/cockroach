...
`
const contentionEventsCommentPattern = `
%s
...
var crdbInternalLocalContentionEventsTable = virtualSchemaTable{
	...
	comment: fmt.Sprintf(contentionEventsCommentPattern, "contention information (RAM; local node only)"),
	populate: func(ctx context.Context, p *planner, _ *dbdesc.Immutable, addRow func(...tree.Datum) error) error {
...
var crdbInternalClusterContentionEventsTable = virtualSchemaTable{
	...
	comment: fmt.Sprintf(contentionEventsCommentPattern, "contention information (cluster RPC; expensive!)"),
	populate: func(ctx context.Context, p *planner, _ *dbdesc.Immutable, addRow func(...tree.Datum) error) error {
