	...
	populate: func(ctx context.Context, p *planner, _ catalog.DatabaseDescriptor, addRow func(...tree.Datum) error) error {
		...
		statementVisitor := func(_ context.Context, stats *roachpb.CollectedStatementStatistics) error {
			...
			err := addRow(
				...
				execStatAvg(stats.Stats.ExecStats.Count, stats.Stats.ExecStats.MvccStepCount),                      // mvcc_step_avg
				execStatVar(stats.Stats.ExecStats.Count, stats.Stats.ExecStats.MvccStepCount),                      // mvcc_step_var
				execStatAvg(stats.Stats.ExecStats.Count, stats.Stats.ExecStats.MvccStepCountInternal),              // mvcc_step_internal_avg
				execStatVar(stats.Stats.ExecStats.Count, stats.Stats.ExecStats.MvccStepCountInternal),              // mvcc_step_internal_var
				execStatAvg(stats.Stats.ExecStats.Count, stats.Stats.ExecStats.MvccSeekCount),                      // mvcc_seek_avg
				execStatVar(stats.Stats.ExecStats.Count, stats.Stats.ExecStats.MvccSeekCount),                      // mvcc_seek_var
				execStatAvg(stats.Stats.ExecStats.Count, stats.Stats.ExecStats.MvccSeekCountInternal),              // mvcc_seek_internal_avg
				execStatVar(stats.Stats.ExecStats.Count, stats.Stats.ExecStats.MvccSeekCountInternal),              // mvcc_seek_internal_var
				execStatAvg(stats.Stats.ExecStats.Count, stats.Stats.ExecStats.MvccBlockBytes),                     // mvcc_block_bytes_avg
				execStatVar(stats.Stats.ExecStats.Count, stats.Stats.ExecStats.MvccBlockBytes),                     // mvcc_block_bytes_var
				execStatAvg(stats.Stats.ExecStats.Count, stats.Stats.ExecStats.MvccBlockBytesInCache),              // mvcc_block_bytes_in_cache_avg
				execStatVar(stats.Stats.ExecStats.Count, stats.Stats.ExecStats.MvccBlockBytesInCache),              // mvcc_block_bytes_in_cache_var
				execStatAvg(stats.Stats.ExecStats.Count, stats.Stats.ExecStats.MvccKeyBytes),                       // mvcc_key_bytes_avg
				execStatVar(stats.Stats.ExecStats.Count, stats.Stats.ExecStats.MvccKeyBytes),                       // mvcc_key_bytes_var
				execStatAvg(stats.Stats.ExecStats.Count, stats.Stats.ExecStats.MvccValueBytes),                     // mvcc_value_bytes_avg
				execStatVar(stats.Stats.ExecStats.Count, stats.Stats.ExecStats.MvccValueBytes),                     // mvcc_value_bytes_var
				execStatAvg(stats.Stats.ExecStats.Count, stats.Stats.ExecStats.MvccPointCount),                     // mvcc_point_count_avg
				execStatVar(stats.Stats.ExecStats.Count, stats.Stats.ExecStats.MvccPointCount),                     // mvcc_point_count_var
				execStatAvg(stats.Stats.ExecStats.Count, stats.Stats.ExecStats.MvccPointsCoveredByRangeTombstones), // mvcc_points_covered_by_range_tombstones_avg
				execStatVar(stats.Stats.ExecStats.Count, stats.Stats.ExecStats.MvccPointsCoveredByRangeTombstones), // mvcc_points_covered_by_range_tombstones_var
				execStatAvg(stats.Stats.ExecStats.Count, stats.Stats.ExecStats.MvccRangeKeyCount),                  // mvcc_range_key_count_avg
				execStatVar(stats.Stats.ExecStats.Count, stats.Stats.ExecStats.MvccRangeKeyCount),                  // mvcc_range_key_count_var
				execStatAvg(stats.Stats.ExecStats.Count, stats.Stats.ExecStats.MvccRangeKeyContainedPoints),        // mvcc_range_key_contained_points_avg
				execStatVar(stats.Stats.ExecStats.Count, stats.Stats.ExecStats.MvccRangeKeyContainedPoints),        // mvcc_range_key_contained_points_var
				execStatAvg(stats.Stats.ExecStats.Count, stats.Stats.ExecStats.MvccRangeKeySkippedPoints),          // mvcc_range_key_skipped_points_avg
				execStatVar(stats.Stats.ExecStats.Count, stats.Stats.ExecStats.MvccRangeKeySkippedPoints),          // mvcc_range_key_skipped_points_var
