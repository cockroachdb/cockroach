...
type tableWriter interface {
	...
	//
	// The ignoreIndexesForPut and ignoreIndexesForDel parameters are sets of
	// IndexIDs to avoid updating when performing the row modification. They are
	// necessary to avoid adding or removing entries from partial indexes when
	// rows do not satisfy the partial index predicate.
	//
	...
	row(context.Context, tree.Datums, sqlbase.PartialIndexUpdateManager, bool /* traceKV */) error
