...
func (tb *tableWriterBase) init(
	...
	tb.desc = tableDesc
	tb.b = txn.NewBatch()
	tb.maxBatchSize = mutations.MaxBatchSize(evalCtx.TestingKnobs.ForceProductionBatchSizes)
	tb.forceProductionBatchSizes = evalCtx.TestingKnobs.ForceProductionBatchSizes
}
