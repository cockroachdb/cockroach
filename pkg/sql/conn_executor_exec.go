...
func (ex *connExecutor) execStmtInOpenState(
	...
	if !ex.extraTxnState.transactionSteppingDisabled {
	...
	if !os.ImplicitTxn.Get() && (!ex.extraTxnState.transactionSteppingDisabled && txn.IsSerializablePushAndRefreshNotPossible()) {
