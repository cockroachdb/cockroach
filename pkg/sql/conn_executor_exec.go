...
// function that indicates whether the transaction is implicit.
func (ex *connExecutor) recordTransactionStart() func() (implicit bool) {
	...
	return func() bool { return implicit }
}
