...
// is of the subsequent version. This method may only be used to update a
// descriptor one time per transaction and may not be used to interact with a
// descriptor that has already been modified in the transaction. It will also
// validate the structure of the descriptor but not its references.
//
