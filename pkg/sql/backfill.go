...
func (sc *SchemaChanger) validateCheckInTxn(
	...
	return sc.ieFactory.WithTxn(ctx, txn, sessionData, func(ctx context.Context, txn *kv.Txn, ie sqlutil.InternalExecutor) error {
...
func (sc *SchemaChanger) validateFkInTxn(
	...
	return sc.ieFactory.WithTxn(ctx, txn, sd, func(ctx context.Context, txn *kv.Txn, ie sqlutil.InternalExecutor) error {
		return ie.WithSyntheticDescriptors(
			syntheticDescs,
			func() error {
