...
// makeFixedTimestampRunner creates a runAtFixedTimestamp suitable for use by the helpers.
func (sc *SchemaChanger) makeFixedTimestampRunner(
	...
	runner := func(ctx context.Context, retryable scTxnFn) error {
		return sc.db.FixedTimestampTxn(ctx, readAsOf, func(ctx context.Context, txn *client.Txn) error {
...
func (sc *SchemaChanger) validateConstraints(
	...
	if err := sc.db.FixedTimestampTxn(ctx, readAsOf, func(ctx context.Context, txn *client.Txn) error {
		...
		case sqlbase.DescriptorMutation_ADD:
			...
			case *sqlbase.DescriptorMutation_Constraint:
				...
				case sqlbase.ConstraintToUpdate_FOREIGN_KEY:
					...
					if err := planner.writeSchemaChange(ctx, referencedTableDesc, sqlbase.InvalidMutationID); err != nil {
						return err
					}
