...
var sessionVarDescriptions = map[string]string{
	...
	"enable_split_and_scatter_backfill":                               "Controls whether the schema changer creates split and scatter operations during index backfills. Disabling can reduce range count for schema changes on empty tables, but will cause slower backfills on tables that already have data.",
