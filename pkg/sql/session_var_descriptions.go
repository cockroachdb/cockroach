...
var sessionVarDescriptions = map[string]string{
	...
	"optimizer_max_disjunction_split_count":                           "Sets the maximum number of OR-connected filter conjuncts that the SplitDisjunction exploration rule will split. 0 value means using the default.",
	...
	"optimizer_use_histograms_for_with_scans":                         "Controls whether the optimizer propagates histogram statistics through Common Table Expressions (CTEs) for cardinality estimation.",
