...
var sessionVarDescriptions = map[string]string{
	...
	"authentication_method":                                           "The authentication method used for the session. Possible values include `password`, `cert`, `cert-password`, `scram-sha-256`, `cert-scram-sha-256`, `trust`, `ldap`, and `gss`.",
