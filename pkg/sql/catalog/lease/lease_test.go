...
`); err != nil {
	...
	test1Desc := desctestutils.TestingGetPublicTableDescriptor(
		t.kvDB,
		keys.SystemSQLCodec,
		t.version,
		"t",
		"test1")
	test2Desc := desctestutils.TestingGetPublicTableDescriptor(
		t.kvDB,
		keys.SystemSQLCodec,
		t.version,
		"t",
...
`); err != nil {
	...
	beforeDesc := desctestutils.TestingGetPublicTableDescriptor(
		t.kvDB,
		keys.SystemSQLCodec,
		t.version,
		"t",
		"before")
	afterDesc := desctestutils.TestingGetPublicTableDescriptor(
		t.kvDB,
		keys.SystemSQLCodec,
		t.version,
		"t",
