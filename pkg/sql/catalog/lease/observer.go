...
// RegisterLeaseObserver registers an observer.
func (m *Manager) RegisterLeaseObserver(observer Observer) (unregisterFn func()) {
	...
	return func() {
		...
		// Wait for a flush, which guarantees that the
		// observer will not be invoked again. The internal
		// buffer should be drained.
		m.observerEvent <- struct{}{}
	}
}
