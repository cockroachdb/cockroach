	...
	for _, tc := range []struct {
		...
		// Confirm order of SchemaDescriptors with varying name.
		{
			sqlExprs: map[string]string{
				...
				"medschema":     "CREATE SCHEMA medschema",
				"largeschema":   "CREATE SCHEMA largeschema",
				"largestschema": "CREATE SCHEMA largestschema",
			},
			expOrder: []string{
				"sschema",
				"medschema",
		...
		t.Run(fmt.Sprintf("test number"), func(t *testing.T) {
