...
func MaybeWithDatabaseRegionConfig(
	regionConfig *multiregion.InitializationRegionConfig,
) NewInitialOption {
...
func (desc *Mutable) SetInitialMultiRegionConfig(
	config *multiregion.InitializationRegionConfig,
) error {
