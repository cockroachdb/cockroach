...
func TestValidateSuperRegionConfig(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			regionConfig: multiregion.MakeRegionConfig(catpb.RegionNames{"region_a", "region_b", "region_c"}, "region_b", descpb.SurvivalGoal_ZONE_FAILURE, validRegionEnumID, descpb.DataPlacement_DEFAULT, []descpb.DatabaseDescriptor_SuperRegion{
				{
					SuperRegionName: "sr1",
		...
		},
		{
			...
			regionConfig: multiregion.MakeRegionConfig(catpb.RegionNames{"region_a", "region_b", "region_c"}, "region_b", descpb.SurvivalGoal_REGION_FAILURE, validRegionEnumID, descpb.DataPlacement_DEFAULT, []descpb.DatabaseDescriptor_SuperRegion{
				{
					SuperRegionName: "sr1",
