...
func (*UserPrivileges) Descriptor() ([]byte, []int) {
	return fileDescriptor_privilege_4fa37cd33ed3c7dd, []int{0}
}
...
func (*PrivilegeDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_privilege_4fa37cd33ed3c7dd, []int{1}
}
...
func init() {
	proto.RegisterFile("sql/catalog/descpb/privilege.proto", fileDescriptor_privilege_4fa37cd33ed3c7dd)
}

var fileDescriptor_privilege_4fa37cd33ed3c7dd = []byte{
