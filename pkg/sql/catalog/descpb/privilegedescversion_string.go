...
func _() {
	...
	_ = x[OwnerVersion-1]
	_ = x[Version21_2-2]
	_ = x[GrantOptionVersion-3]
}

const _PrivilegeDescVersion_name = "InitialVersionOwnerVersionVersion21_2GrantOptionVersion"

var _PrivilegeDescVersion_index = [...]uint8{0, 14, 26, 37, 55}
