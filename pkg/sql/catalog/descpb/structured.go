...
func init() {
	protoreflect.RegisterShorthand("Descriptor", (*Descriptor)(nil))
	protoreflect.RegisterShorthand("desc", (*Descriptor)(nil))
	protoreflect.RegisterShorthand("TableDescriptor", (*TableDescriptor)(nil))
}
