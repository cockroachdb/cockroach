...
func (p *DefaultPrivilegeDescriptor) getOrCreateDefaultPrivilegesForAllRoles() map[tree.AlterDefaultPrivilegesTargetObject]PrivilegeDescriptor {
	if p.DefaultPrivilegesForAllRoles == nil {
		p.DefaultPrivilegesForAllRoles = map[tree.AlterDefaultPrivilegesTargetObject]PrivilegeDescriptor{}
	}
	return p.DefaultPrivilegesForAllRoles
}
