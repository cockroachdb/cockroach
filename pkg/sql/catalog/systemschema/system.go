...
CREATE TABLE system.statement_activity (
    ...
    CONSTRAINT "primary" PRIMARY KEY (aggregated_ts, fingerprint_id, transaction_fingerprint_id, plan_hash, app_name, node_id),
    INDEX "fingerprint_stats_idx" (fingerprint_id, transaction_fingerprint_id),
		INDEX "execution_count_idx" (execution_count, aggregated_ts),
    INDEX "total_estimated_execution_time_idx" (total_estimated_execution_time, aggregated_ts),
    INDEX "contention_time_avg_idx" (contention_time_avg, aggregated_ts),
    INDEX "cpu_sql_nanos_avg_idx" (cpu_sql_nanos_avg, aggregated_ts),
    INDEX "service_latency_avg_idx" (service_latency_avg, aggregated_ts),
		FAMILY "primary" (
			aggregated_ts,
			fingerprint_id,
			transaction_fingerprint_id,
...
CREATE TABLE system.transaction_activity (
    ...
    CONSTRAINT "primary" PRIMARY KEY (aggregated_ts, fingerprint_id, app_name, node_id),
		INDEX "execution_count_idx" (execution_count, aggregated_ts),
    INDEX "contention_time_avg_idx" (contention_time_avg, aggregated_ts),
    INDEX "cpu_sql_nanos_avg	_idx" (cpu_sql_nanos_avg, aggregated_ts),
    INDEX "service_latency_avg_idx" (service_latency_avg, aggregated_ts),
    INDEX "total_estimated_execution_time_idx" (total_estimated_execution_time, aggregated_ts),
		FAMILY "primary" (
			aggregated_ts,
	...
	TransactionActivityTable = makeSystemTable(
		...
		systemTable(
			...
			[]descpb.ColumnDescriptor{
				...
				{Name: "total_estimated_execution_time", ID: 9, Type: types.Float, Nullable: false},
				{Name: "cluster_estimated_execution_time", ID: 10, Type: types.Float, Nullable: false},
				{Name: "contention_time_avg", ID: 11, Type: types.Float, Nullable: false},
				{Name: "cpu_sql_nanos_avg", ID: 12, Type: types.Float, Nullable: false},
				{Name: "service_latency_avg", ID: 13, Type: types.Float, Nullable: false},
			},
			[]descpb.ColumnFamilyDescriptor{
				{
					Name: "primary",
					...
					ColumnNames: []string{
						"aggregated_ts", "fingerprint_id", "app_name", "node_id",
						"agg_interval", "metadata", "statistics", "execution_count",
						"total_estimated_execution_time", "cluster_estimated_execution_time",
						"contention_time_avg", "cpu_sql_nanos_avg", "service_latency_avg",
					},
