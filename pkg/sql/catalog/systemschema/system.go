...
var (
	...
	zeroIntervalString          = "'00:00:00':::INTERVAL"
	...
	StatementDiagnosticsRequestsTable = registerSystemTable(
		...
		systemTable(
			...
			[]descpb.ColumnDescriptor{
				...
				{Name: "min_execution_latency", ID: 6, Type: types.Interval, Nullable: false, DefaultExpr: &zeroIntervalString},
