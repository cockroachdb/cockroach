...
CREATE TABLE system.external_connections (
	...
	FAMILY "primary" (connection_name, created, "lastUpdated", connection_type, connection_details)
);`
)
			...
			[]descpb.ColumnFamilyDescriptor{
				{
					Name:        "primary",
					ID:          0,
					ColumnNames: []string{"connection_name", "created", "lastUpdated", "connection_type", "connection_details"},
					ColumnIDs:   []descpb.ColumnID{1, 2, 3, 4, 5},
				},
			},
			descpb.IndexDescriptor{
