...
CREATE TABLE system.cluster_metrics (
    ...
    INDEX last_updated_idx (last_updated DESC) STORING (name, labels, type, value, stopwatch_ts, unit, help_text),
    FAMILY "primary" (id, name, labels, type, value, stopwatch_ts, unit, help_text, last_updated)
);`
	...
	ClusterMetricsTable         = makeSystemTable(
		...
		systemTable(
			...
			[]descpb.ColumnDescriptor{
				...
				{Name: "unit", ID: 7, Type: types.String},
				{Name: "help_text", ID: 8, Type: types.String},
				{Name: "last_updated", ID: 9, Type: types.TimestampTZ, DefaultExpr: &nowTZString},
			},
			[]descpb.ColumnFamilyDescriptor{
				{
					Name:        "primary",
					ID:          0,
					ColumnNames: []string{"id", "name", "labels", "type", "value", "stopwatch_ts", "unit", "help_text", "last_updated"},
					ColumnIDs:   []descpb.ColumnID{1, 2, 3, 4, 5, 6, 7, 8, 9},
				},
			},
			descpb.IndexDescriptor{
			...
			descpb.IndexDescriptor{
				...
				KeySuffixColumnIDs: []descpb.ColumnID{1},
				StoreColumnIDs:     []descpb.ColumnID{2, 3, 4, 5, 6, 7, 8},
				StoreColumnNames:   []string{"name", "labels", "type", "value", "stopwatch_ts", "unit", "help_text"},
				Version:            descpb.StrictIndexColumnIDGuaranteesVersion,
			},
		),
	)
