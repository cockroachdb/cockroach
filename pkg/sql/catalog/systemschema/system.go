	...
	TransactionExecInsightsTable = makeSystemTable(
		...
		systemTable(
			...
			[]descpb.ColumnDescriptor{
				...
				{Name: "contention_events", ID: 20, Type: types.JSONBArray, Nullable: true},
	...
	StatementExecInsightsTable = makeSystemTable(
		...
		systemTable(
			...
			[]descpb.ColumnDescriptor{
				...
				{Name: "execution_node_ids", ID: 20, Type: types.IntArray},
				...
				{Name: "contention_events", ID: 30, Type: types.JSONBArray, Nullable: true},
