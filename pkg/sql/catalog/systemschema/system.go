...
(
    ...
    INDEX "fingerprint_stats_idx" (fingerprint_id, transaction_fingerprint_id),
    INDEX "execution_count_idx" (aggregated_ts, execution_count),
    INDEX "total_estimated_execution_time_idx" (aggregated_ts, total_estimated_execution_time),
    INDEX "contention_time_avg_idx" (aggregated_ts, contention_time_avg),
    INDEX "cpu_sql_nanos_avg_idx" (aggregated_ts, cpu_sql_nanos_avg),
    INDEX "service_latency_avg_idx" (aggregated_ts, service_latency_avg),
    FAMILY "primary" (
                      aggregated_ts,
                      fingerprint_id,
                      transaction_fingerprint_id,
...
(
    ...
    INDEX "execution_count_idx" (aggregated_ts, execution_count),
    INDEX "contention_time_avg_idx" (aggregated_ts, contention_time_avg),
    INDEX "cpu_sql_nanos_avg	_idx" (aggregated_ts, cpu_sql_nanos_avg),
    INDEX "service_latency_avg_idx" (aggregated_ts, service_latency_avg),
    INDEX "total_estimated_execution_time_idx" (aggregated_ts, total_estimated_execution_time),
    FAMILY "primary" (
                      aggregated_ts,
