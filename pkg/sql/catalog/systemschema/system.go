...
CREATE TABLE system.statement_statistics (
    ...
    indexes_usage JSONB NOT NULL AS (` + indexUsageComputeExpr + `) VIRTUAL,
	...
	StatementStatisticsTable = makeSystemTable(
		...
		systemTable(
			...
			[]descpb.ColumnDescriptor{
				...
				{Name: "indexes_usage", ID: 13, Type: types.Jsonb, Nullable: false, Virtual: true, ComputeExpr: &indexUsageComputeExprStr},
			},
			[]descpb.ColumnFamilyDescriptor{
				{
					Name: "primary",
