...
CREATE TABLE system.jobs (
  ...
  INDEX jobs_job_type_idx (job_type),
	FAMILY fam_0_id_status_created_payload (id, status, created, dropped_payload, created_by_type, created_by_id, job_type, owner, description, statement, error_msg, finished),
	...
	JobsTable = makeSystemTable(
		...
		systemTable(
			...
			[]descpb.ColumnDescriptor{
				...
				{Name: "statement", ID: 15, Type: types.String, Nullable: true},
				{Name: "error_msg", ID: 16, Type: types.String, Nullable: true},
			...
			[]descpb.ColumnFamilyDescriptor{
				{
					...
					ID:          0,
					ColumnNames: []string{"id", "status", "created", "dropped_payload", "created_by_type", "created_by_id", "job_type", "owner", "description", "statement", "error_msg", "finished"},
					ColumnIDs:   []descpb.ColumnID{1, 2, 3, 4, 6, 7, 12, 13, 14, 15, 16, 17},
				},
				{
					// NB: We are using family name that existed prior to adding created_by_type,
					// created_by_id, and job_type columns. This is done to minimize and simplify migration work
