...
CREATE TABLE system.mvcc_statistics (
	...
	replicationSizeBytesExpr = `COALESCE((span_stats->'approximate_disk_bytes':::STRING)::INT8, 0:::INT8)`
	totalRangesExpr          = `COALESCE((span_stats->'range_count':::STRING)::INT8, 0:::INT8)`
	totalLiveDataBytesExpr   = `COALESCE(((span_stats->'total_stats':::STRING)->'live_bytes':::STRING)::INT8, 0:::INT8)`
	totalDataBytesExpr       = `COALESCE(((((span_stats->'total_stats':::STRING)->'key_bytes':::STRING)::INT8 + ((span_stats->'total_stats':::STRING)->'val_bytes':::STRING)::INT8) + ((span_stats->'total_stats':::STRING)->'range_key_bytes':::STRING)::INT8) + ((span_stats->'total_stats':::STRING)->'range_val_bytes':::STRING)::INT8, 0:::INT8)`
	percentDataLiveBytesExpr = "IF(" + totalDataBytesExpr + " = 0:::INT8, 0.0:::FLOAT8, (" + totalLiveDataBytesExpr + " / " + totalDataBytesExpr + ")::FLOAT8)"
	qualifiedTableNameExpr   = `(schema_name || '.':::STRING) || table_name`
)

var (
	replicationSizeBytesStr = replicationSizeBytesExpr
	totalRangesStr          = totalRangesExpr
	totalLiveDataBytesStr   = totalLiveDataBytesExpr
	totalDataBytesStr       = totalDataBytesExpr
	percentDataLiveBytesStr = percentDataLiveBytesExpr
	qualifiedTableNameStr   = qualifiedTableNameExpr
)
...
const (
    ...
    table_name STRING NOT NULL,
		span_stats JSONB NOT NULL,
    total_columns INT8 NOT NULL,
    total_indexes INT8 NOT NULL,
    store_ids INT[] NOT NULL,
    last_update_error string,
    last_updated TIMESTAMPTZ NOT NULL DEFAULT now(),
		qualified_table_name STRING NOT NULL AS (` + qualifiedTableNameExpr + `) STORED,
    replication_size_bytes INT NOT NULL AS (` + replicationSizeBytesExpr + `) STORED,
    total_ranges INT NOT NULL AS (` + totalRangesExpr + `) STORED,
    total_live_data_bytes INT NOT NULL AS (` + totalLiveDataBytesExpr + `) STORED,
    total_data_bytes INT NOT NULL AS (` + totalDataBytesExpr + `) STORED,
    perc_live_data FLOAT NOT NULL AS (` + percentDataLiveBytesExpr + `) STORED,
    ...
    CONSTRAINT "primary" PRIMARY KEY (db_id, table_id),
		...
		INVERTED INDEX qualified_table_name_gin (qualified_table_name gin_trgm_ops),
	...
	TableMetadata = makeSystemTable(
		...
		systemTable(catconstants.TableMetadata,
			...
			[]descpb.ColumnDescriptor{
				...
				{Name: "span_stats", ID: 6, Type: types.Jsonb, Nullable: false},
				{Name: "total_columns", ID: 7, Type: types.Int, Nullable: false},
				{Name: "total_indexes", ID: 8, Type: types.Int, Nullable: false},
				{Name: "store_ids", ID: 9, Type: types.IntArray, Nullable: false},
				{Name: "last_update_error", ID: 10, Type: types.String, Nullable: true},
				{Name: "last_updated", ID: 11, Type: types.TimestampTZ, Nullable: false, DefaultExpr: &nowTZString},
				{Name: "qualified_table_name", ID: 12, Type: types.String, Nullable: false, ComputeExpr: &qualifiedTableNameStr},
				{Name: "replication_size_bytes", ID: 13, Type: types.Int, Nullable: false, ComputeExpr: &replicationSizeBytesStr},
				{Name: "total_ranges", ID: 14, Type: types.Int, Nullable: false, ComputeExpr: &totalRangesStr},
				{Name: "total_live_data_bytes", ID: 15, Type: types.Int, Nullable: false, ComputeExpr: &totalLiveDataBytesStr},
				{Name: "total_data_bytes", ID: 16, Type: types.Int, Nullable: false, ComputeExpr: &totalDataBytesStr},
				{Name: "perc_live_data", ID: 17, Type: types.Float, Nullable: false, ComputeExpr: &percentDataLiveBytesStr},
				{
			...
			descpb.IndexDescriptor{
				...
				KeyColumnIDs:       []descpb.ColumnID{14, 2},
				KeySuffixColumnIDs: []descpb.ColumnID{1},
			},
			descpb.IndexDescriptor{
			...
			descpb.IndexDescriptor{
				...
				KeyColumnIDs:       []descpb.ColumnID{8, 2},
				KeySuffixColumnIDs: []descpb.ColumnID{1},
			},
			descpb.IndexDescriptor{
				...
				KeyColumnIDs:       []descpb.ColumnID{17, 2},
				KeySuffixColumnIDs: []descpb.ColumnID{1},
				CompositeColumnIDs: []descpb.ColumnID{17},
			},
			descpb.IndexDescriptor{
				...
				KeyColumnIDs:       []descpb.ColumnID{18, 11, 2},
				KeySuffixColumnIDs: []descpb.ColumnID{1},
				Sharded: catpb.ShardedDescriptor{
					IsSharded:    true,
					Name:         "crdb_internal_last_updated_table_id_shard_16",
			...
			descpb.IndexDescriptor{
				Name:                "qualified_table_name_gin",
				Type:                descpb.IndexDescriptor_INVERTED,
				ID:                  9,
				Unique:              false,
				Version:             descpb.StrictIndexColumnIDGuaranteesVersion,
				KeyColumnNames:      []string{"qualified_table_name"},
				KeyColumnDirections: []catenumpb.IndexColumn_Direction{catenumpb.IndexColumn_ASC},
				InvertedColumnKinds: []catpb.InvertedIndexColumnKind{catpb.InvertedIndexColumnKind_TRIGRAM},
				KeyColumnIDs:        []descpb.ColumnID{12},
				KeySuffixColumnIDs:  []descpb.ColumnID{1, 2},
