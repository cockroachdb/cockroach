...
CREATE TABLE system.span_stats_tenant_boundaries (
	...
	CREATE TABLE system.txn_exec_insights (
		...
		statistics                 JSONB NOT NULL,
		created                    TIMESTAMPTZ NOT NULL DEFAULT now(),
		CONSTRAINT "primary" PRIMARY KEY (txn_id),
		INDEX txn_fingerprint_id_idx (txn_fingerprint_id),
		INDEX time_range_idx (start_time DESC, end_time DESC),
		INDEX user_name_idx (user_name),
		INDEX app_name_idx (app_name),
		INVERTED INDEX problems_idx (problems),
		INVERTED INDEX causes_idx (causes),
		INVERTED INDEX stmt_execution_ids_idx (stmt_execution_ids),
		...
		FAMILY "primary" (
  		...
  		ttl_expiration_expression = "((created AT TIME ZONE) + INTERVAL '14 days') AT TIME ZONE 'UTC'",
	    ttl_job_cron = '@hourly'
	);`

	StatementExecutionStatsTableSchema = `
	CREATE TABLE system.stmt_exec_insights (
		session_id                 STRING NOT NULL,
		txn_id                     UUID NOT NULL,
		txn_fingerprint_id         BYTES NOT NULL,
		...
		retry_lat                  FLOAT NOT NULL,
		commit_lat                 FLOAT NOT NULL,
		idle_lat                   FLOAT NOT NULL,
		statistics                 JSONB NOT NULL,
		created                    TIMESTAMPTZ NOT NULL DEFAULT now(),
		CONSTRAINT "primary" PRIMARY KEY (stmt_id, txn_id),
		INDEX txn_id_idx (txn_id),
		INDEX txn_fingerprint_id_idx (txn_fingerprint_id),
		INDEX stmt_fingerprint_id_idx (stmt_fingerprint_id),
		INDEX time_range_idx (start_time DESC, end_time DESC),
		INVERTED INDEX causes_idx (causes),
		INDEX problem_idx (problem),
		INVERTED INDEX exec_node_ids_idx (exec_node_ids),
		INVERTED INDEX index_recommendations_idx (index_recommendations),
		FAMILY "primary" (
			session_id,
			txn_id,
			txn_fingerprint_id,
...
var (
	...
	// rowLevelTTLFunc defines default expiration expression that will be used
	// in txn_exec_insights and stmt_exec_insights tables. It relies on `created`
	// column that should be defined in tables.
	rowLevelTTLFunc = func(tbl *descpb.TableDescriptor) {
		tbl.RowLevelTTL = &catpb.RowLevelTTL{
			Pause:          false,
			ExpirationExpr: "((created AT TIME ZONE 'UTC') + INTERVAL '14 days') AT TIME ZONE 'UTC'",
		}
	}
	...
	TransactionExecInsightsTable = makeSystemTable(
		...
		systemTable(
			...
			descpb.InvalidID, // dynamically assigned table ID
			[]descpb.ColumnDescriptor{
				{Name: "txn_id", ID: 1, Type: types.Uuid, Nullable: false},
				{Name: "txn_fingerprint_id", ID: 2, Type: types.Bytes, Nullable: false},
				{Name: "implicit_txn", ID: 3, Type: types.Bool, Nullable: false},
				{Name: "session_id", ID: 4, Type: types.String, Nullable: false},
				{Name: "start_time", ID: 5, Type: types.Timestamp, Nullable: false},
				{Name: "end_time", ID: 6, Type: types.Timestamp, Nullable: false},
				{Name: "user_name", ID: 7, Type: types.String, Nullable: false},
				{Name: "app_name", ID: 8, Type: types.String, Nullable: false},
				{Name: "rows_read", ID: 9, Type: types.Int, Nullable: false},
				{Name: "rows_written", ID: 10, Type: types.Int, Nullable: false},
				{Name: "user_priority", ID: 11, Type: types.String, Nullable: false},
				{Name: "retries", ID: 12, Type: types.Int, Nullable: false},
				{Name: "last_retry_reason", ID: 13, Type: types.String},
				{Name: "contention", ID: 14, Type: types.Interval},
				{Name: "problems", ID: 15, Type: types.StringArray, Nullable: false},
				{Name: "causes", ID: 16, Type: types.StringArray, Nullable: false},
				{Name: "stmt_execution_ids", ID: 17, Type: types.StringArray, Nullable: false},
				{Name: "cpu_sql_nanos", ID: 18, Type: types.Int},
				{Name: "last_error_code", ID: 19, Type: types.String},
				{Name: "status", ID: 20, Type: types.String, Nullable: false},
				{Name: "statistics", ID: 21, Type: types.Jsonb, Nullable: false},
				{Name: "details", ID: 22, Type: types.Jsonb, Nullable: false},
				{Name: "created", ID: 23, Type: types.TimestampTZ, Nullable: false, DefaultExpr: &nowTZString},
			},
			[]descpb.ColumnFamilyDescriptor{
				{
					Name: "primary",
			...
			descpb.IndexDescriptor{
				...
				ID:                  1,
				Unique:              true,
				KeyColumnNames:      []string{"txn_id"},
				KeyColumnDirections: []catenumpb.IndexColumn_Direction{catenumpb.IndexColumn_ASC},
				KeyColumnIDs:        []descpb.ColumnID{1},
			},
			descpb.IndexDescriptor{
				Name:           "txn_fingerprint_id_idx",
				ID:             2,
				Unique:         false,
				KeyColumnNames: []string{"txn_fingerprint_id"},
				KeyColumnDirections: []catenumpb.IndexColumn_Direction{
					catenumpb.IndexColumn_ASC,
				},
				KeyColumnIDs: []descpb.ColumnID{2},
			...
			descpb.IndexDescriptor{
				...
				KeyColumnIDs: []descpb.ColumnID{5, 6},
			},
			descpb.IndexDescriptor{
				Name:           "user_name_idx",
				ID:             4,
				Unique:         false,
				KeyColumnNames: []string{"user_name"},
				KeyColumnDirections: []catenumpb.IndexColumn_Direction{
					catenumpb.IndexColumn_ASC,
				},
				KeyColumnIDs: []descpb.ColumnID{7},
			...
			descpb.IndexDescriptor{
				...
				ID:             5,
				Unique:         false,
				KeyColumnNames: []string{"app_name"},
				KeyColumnDirections: []catenumpb.IndexColumn_Direction{
					catenumpb.IndexColumn_ASC,
				},
			...
			descpb.IndexDescriptor{
				...
				InvertedColumnKinds: []catpb.InvertedIndexColumnKind{catpb.InvertedIndexColumnKind_DEFAULT},
				Unique:              false,
				KeyColumnNames:      []string{"problems"},
				KeyColumnDirections: []catenumpb.IndexColumn_Direction{
					catenumpb.IndexColumn_ASC,
				},
				KeyColumnIDs: []descpb.ColumnID{15},
			},
			descpb.IndexDescriptor{
				Name:                "causes_idx",
				ID:                  7,
				...
				InvertedColumnKinds: []catpb.InvertedIndexColumnKind{catpb.InvertedIndexColumnKind_DEFAULT},
				Unique:              false,
				KeyColumnNames:      []string{"causes"},
				KeyColumnDirections: []catenumpb.IndexColumn_Direction{
					catenumpb.IndexColumn_ASC,
				},
				KeyColumnIDs: []descpb.ColumnID{16},
			},
			descpb.IndexDescriptor{
				Name:                "stmt_execution_ids_idx",
				ID:                  8,
				Type:                descpb.IndexDescriptor_INVERTED,
				InvertedColumnKinds: []catpb.InvertedIndexColumnKind{catpb.InvertedIndexColumnKind_DEFAULT},
				Unique:              false,
				KeyColumnNames:      []string{"stmt_execution_ids"},
				KeyColumnDirections: []catenumpb.IndexColumn_Direction{
					catenumpb.IndexColumn_ASC,
				},
				KeyColumnIDs: []descpb.ColumnID{17},
			},
			descpb.IndexDescriptor{
				Name:           "status_idx",
				ID:             9,
				Unique:         false,
				KeyColumnNames: []string{"status"},
				KeyColumnDirections: []catenumpb.IndexColumn_Direction{
					catenumpb.IndexColumn_ASC,
				},
				KeyColumnIDs: []descpb.ColumnID{20},
			},
		),
		rowLevelTTLFunc,
	)
	...
	StatementExecInsightsTable = makeSystemTable(
		...
		systemTable(
			...
			descpb.InvalidID, // dynamically assigned table ID
			[]descpb.ColumnDescriptor{
				{Name: "session_id", ID: 1, Type: types.String, Nullable: false},
				{Name: "txn_id", ID: 2, Type: types.Uuid, DefaultExpr: &genRandomUUIDString},
				{Name: "txn_fingerprint_id", ID: 3, Type: types.Bytes, Nullable: false},
				{Name: "stmt_id", ID: 4, Type: types.String, Nullable: false},
				{Name: "stmt_fingerprint_id", ID: 5, Type: types.Bytes, Nullable: false},
				{Name: "problem", ID: 6, Type: types.String, Nullable: false},
				{Name: "causes", ID: 7, Type: types.StringArray, Nullable: false},
				{Name: "query", ID: 8, Type: types.String, Nullable: false},
				{Name: "status", ID: 9, Type: types.String, Nullable: false},
				{Name: "start_time", ID: 10, Type: types.Timestamp, Nullable: false},
				{Name: "end_time", ID: 11, Type: types.Timestamp, Nullable: false},
				{Name: "full_scan", ID: 12, Type: types.Bool, Nullable: false},
				{Name: "user_name", ID: 13, Type: types.String, Nullable: false},
				{Name: "app_name", ID: 14, Type: types.String, Nullable: false},
				{Name: "database_name", ID: 15, Type: types.String, Nullable: false},
				{Name: "plan_gist", ID: 16, Type: types.String, Nullable: false},
				{Name: "rows_read", ID: 17, Type: types.Int, Nullable: false},
				{Name: "rows_written", ID: 18, Type: types.Int, Nullable: false},
				{Name: "retries", ID: 19, Type: types.Int, Nullable: false},
				{Name: "last_retry_reason", ID: 20, Type: types.String},
				{Name: "exec_node_ids", ID: 21, Type: types.IntArray, Nullable: false},
				{Name: "contention", ID: 22, Type: types.Interval},
				{Name: "index_recommendations", ID: 23, Type: types.StringArray, Nullable: false},
				{Name: "implicit_txn", ID: 24, Type: types.Bool, Nullable: false},
				{Name: "cpu_sql_nanos", ID: 25, Type: types.Int},
				{Name: "error_code", ID: 26, Type: types.String},
				{Name: "service_lat", ID: 27, Type: types.Float},
				{Name: "retry_lat", ID: 28, Type: types.Float},
				{Name: "commit_lat", ID: 29, Type: types.Float},
				{Name: "idle_lat", ID: 30, Type: types.Float},
				{Name: "statistics", ID: 31, Type: types.Jsonb, Nullable: false},
				{Name: "details", ID: 32, Type: types.Jsonb, Nullable: false},
				{Name: "created", ID: 33, Type: types.TimestampTZ, Nullable: false, DefaultExpr: &nowTZString},
			},
			[]descpb.ColumnFamilyDescriptor{
				{
					Name: "primary",
			...
			descpb.IndexDescriptor{
				...
				ID:             1,
				Unique:         true,
				KeyColumnNames: []string{"stmt_id", "txn_id"},
				KeyColumnDirections: []catenumpb.IndexColumn_Direction{
					catenumpb.IndexColumn_ASC,
					catenumpb.IndexColumn_ASC,
				},
			...
			descpb.IndexDescriptor{
				Name:           "stmt_fingerprint_id_idx",
				ID:             4,
				Unique:         false,
				KeyColumnNames: []string{"stmt_fingerprint_id"},
				KeyColumnDirections: []catenumpb.IndexColumn_Direction{
					catenumpb.IndexColumn_ASC,
				},
				KeyColumnIDs: []descpb.ColumnID{5},
			...
			descpb.IndexDescriptor{
				Name:                "exec_node_ids_idx",
				ID:                  8,
				Type:                descpb.IndexDescriptor_INVERTED,
				InvertedColumnKinds: []catpb.InvertedIndexColumnKind{catpb.InvertedIndexColumnKind_DEFAULT},
				Unique:              false,
				KeyColumnNames:      []string{"exec_node_ids"},
				KeyColumnDirections: []catenumpb.IndexColumn_Direction{
					catenumpb.IndexColumn_ASC,
				},
				KeyColumnIDs: []descpb.ColumnID{21},
			},
			descpb.IndexDescriptor{
				Name:                "index_recommendations_idx",
				ID:                  9,
				Type:                descpb.IndexDescriptor_INVERTED,
				InvertedColumnKinds: []catpb.InvertedIndexColumnKind{catpb.InvertedIndexColumnKind_DEFAULT},
				Unique:              false,
				KeyColumnNames:      []string{"index_recommendations"},
				KeyColumnDirections: []catenumpb.IndexColumn_Direction{
					catenumpb.IndexColumn_ASC,
				},
				KeyColumnIDs: []descpb.ColumnID{23},
			},
			descpb.IndexDescriptor{
				Name:           "full_scan_idx",
				ID:             10,
				Unique:         false,
				KeyColumnNames: []string{"full_scan"},
				KeyColumnDirections: []catenumpb.IndexColumn_Direction{
					catenumpb.IndexColumn_ASC,
				},
				KeyColumnIDs: []descpb.ColumnID{12},
