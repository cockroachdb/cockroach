	...
	TableMetadata = makeSystemTable(
		...
		systemTable(catconstants.TableMetadata,
			...
			[]descpb.ColumnDescriptor{
				...
				{Name: "store_ids", ID: 11, Type: types.IntArray, Nullable: false},
				...
				{Name: "perc_live_data", ID: 14, Type: types.Float, Nullable: false},
				{
			...
			descpb.IndexDescriptor{
				...
				KeyColumnIDs:       []descpb.ColumnID{9, 3},
				KeySuffixColumnIDs: []descpb.ColumnID{1},
			},
			descpb.IndexDescriptor{
				...
				KeyColumnIDs:       []descpb.ColumnID{10, 3},
				KeySuffixColumnIDs: []descpb.ColumnID{1},
			},
			descpb.IndexDescriptor{
