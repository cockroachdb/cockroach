	...
	TransactionExecInsightsTable = makeSystemTable(
		...
		systemTable(
			...
			[]descpb.ColumnDescriptor{
				...
				{Name: "start_time", ID: 6, Type: types.TimestampTZ},
				...
				{Name: "problems", ID: 13, Type: types.IntArray},
				{Name: "causes", ID: 14, Type: types.IntArray},
	...
	StatementExecInsightsTable = makeSystemTable(
		...
		systemTable(
			...
			[]descpb.ColumnDescriptor{
				...
				{Name: "problem", ID: 6, Type: types.Int},
				{Name: "causes", ID: 7, Type: types.IntArray},
				{Name: "query", ID: 8, Type: types.String},
				{Name: "status", ID: 9, Type: types.Int, Nullable: true},
				{Name: "start_time", ID: 10, Type: types.TimestampTZ},
				...
				{Name: "database_name", ID: 15, Type: types.String, Nullable: true},
				{Name: "plan_gist", ID: 16, Type: types.String, Nullable: true},
				{Name: "retries", ID: 17, Type: types.Int, Nullable: true},
				{Name: "last_retry_reason", ID: 18, Type: types.String, Nullable: true},
				{Name: "execution_node_ids", ID: 19, Type: types.IntArray},
				{Name: "index_recommendations", ID: 20, Type: types.StringArray, Nullable: true},
				...
				{Name: "service_lat_seconds", ID: 24, Type: types.Float, Nullable: true},
				{Name: "retry_lat_seconds", ID: 25, Type: types.Float, Nullable: true},
				{Name: "commit_lat_seconds", ID: 26, Type: types.Float, Nullable: true},
				{Name: "idle_lat_seconds", ID: 27, Type: types.Float, Nullable: true},
				{Name: "contention_time", ID: 28, Type: types.Interval, Nullable: true},
				{Name: "contention_info", ID: 29, Type: types.Jsonb, Nullable: true},
				{Name: "details", ID: 30, Type: types.Jsonb, Nullable: true},
