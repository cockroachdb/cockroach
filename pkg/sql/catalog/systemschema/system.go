...
`
	...
	CREATE TABLE system.transaction_execution_insights (
		...
		INDEX user_name_time_idx (user_name, start_time DESC, end_time DESC) USING HASH,
		INDEX app_name_time_idx (app_name, start_time DESC, end_time DESC) USING HASH,
		INDEX status_time_idx (status, start_time DESC, end_time DESC) USING HASH,
		INVERTED INDEX problems_idx (problems),
		INVERTED INDEX problems_time_idx (start_time DESC, end_time DESC, problems) USING HASH,
		INVERTED INDEX causes_idx (causes),
		INVERTED INDEX causes_time_idx (start_time DESC, end_time DESC, causes) USING HASH,
	...
	CREATE TABLE system.statement_execution_insights (
	  ...
	  user_priority              STRING,
		...
		INDEX time_range_idx (start_time DESC, end_time DESC) USING HASH,
		INVERTED INDEX causes_idx (causes),
		INVERTED INDEX causes_time_idx (start_time DESC, end_time DESC, causes),
		INDEX problem_idx (problem, start_time DESC, end_time DESC),
		INVERTED INDEX execution_node_ids_idx (execution_node_ids),
		INVERTED INDEX index_recommendations_idx (index_recommendations),
		INVERTED INDEX index_recommendations_time_idx (start_time DESC, end_time DESC, index_recommendations),
		INDEX full_scan_time_idx (full_scan, start_time DESC, end_time DESC),
		INVERTED INDEX details_idx (details),
		FAMILY "primary" (
			session_id,
			transaction_id,
...
var (
	...
	TransactionExecInsightsTable = makeSystemTable(
		...
		systemTable(
			...
			descpb.IndexDescriptor{
				Name:           "user_name_time_idx",
				ID:             4,
				Unique:         false,
				KeyColumnNames: []string{"user_name", "start_time", "end_time"},
				KeyColumnDirections: []catenumpb.IndexColumn_Direction{
					catenumpb.IndexColumn_ASC,
					catenumpb.IndexColumn_DESC,
					catenumpb.IndexColumn_DESC,
				},
				KeyColumnIDs:       []descpb.ColumnID{8, 6, 7},
				KeySuffixColumnIDs: []descpb.ColumnID{1},
				Version:            descpb.StrictIndexColumnIDGuaranteesVersion,
			},
			descpb.IndexDescriptor{
				Name:           "app_name_time_idx",
				ID:             5,
				Unique:         false,
				KeyColumnNames: []string{"app_name", "start_time", "end_time"},
				KeyColumnDirections: []catenumpb.IndexColumn_Direction{
					catenumpb.IndexColumn_ASC,
					catenumpb.IndexColumn_DESC,
					catenumpb.IndexColumn_DESC,
				},
				KeyColumnIDs:       []descpb.ColumnID{9, 6, 7},
				KeySuffixColumnIDs: []descpb.ColumnID{1},
				Version:            descpb.StrictIndexColumnIDGuaranteesVersion,
			},
			descpb.IndexDescriptor{
				...
				ID:             6,
				Unique:         false,
				KeyColumnNames: []string{"status", "start_time", "end_time"},
				KeyColumnDirections: []catenumpb.IndexColumn_Direction{
					catenumpb.IndexColumn_ASC,
					catenumpb.IndexColumn_DESC,
					catenumpb.IndexColumn_DESC,
				},
				KeyColumnIDs:       []descpb.ColumnID{18, 6, 7},
				KeySuffixColumnIDs: []descpb.ColumnID{1},
				Version:            descpb.StrictIndexColumnIDGuaranteesVersion,
			},
			descpb.IndexDescriptor{
			...
			descpb.IndexDescriptor{
				Name:           "problems_time_idx",
				ID:             8,
				Type:           descpb.IndexDescriptor_INVERTED,
				Unique:         false,
				KeyColumnNames: []string{"start_time", "end_time", "problems"},
				KeyColumnDirections: []catenumpb.IndexColumn_Direction{
					catenumpb.IndexColumn_DESC,
					catenumpb.IndexColumn_DESC,
					catenumpb.IndexColumn_ASC,
				},
				KeyColumnIDs:       []descpb.ColumnID{6, 7, 13},
				KeySuffixColumnIDs: []descpb.ColumnID{1},
				Version:            descpb.StrictIndexColumnIDGuaranteesVersion,
			},
			descpb.IndexDescriptor{
			...
			descpb.IndexDescriptor{
				Name:           "causes_time_idx",
				ID:             10,
				Type:           descpb.IndexDescriptor_INVERTED,
				Unique:         false,
				KeyColumnNames: []string{"start_time", "end_time", "causes"},
				KeyColumnDirections: []catenumpb.IndexColumn_Direction{
					catenumpb.IndexColumn_DESC,
					catenumpb.IndexColumn_DESC,
					catenumpb.IndexColumn_ASC,
				},
				KeyColumnIDs:       []descpb.ColumnID{6, 7, 14},
				KeySuffixColumnIDs: []descpb.ColumnID{1},
				Version:            descpb.StrictIndexColumnIDGuaranteesVersion,
			},
			descpb.IndexDescriptor{
	...
	StatementExecInsightsTable = makeSystemTable(
		...
		systemTable(
			...
			descpb.IndexDescriptor{
				...
				KeyColumnIDs:       []descpb.ColumnID{10, 11, 7},
				KeySuffixColumnIDs: []descpb.ColumnID{4, 2},
				Version:            descpb.StrictIndexColumnIDGuaranteesVersion,
			},
			descpb.IndexDescriptor{
				...
				ID:             8,
				Unique:         false,
				KeyColumnNames: []string{"problem", "start_time", "end_time"},
				KeyColumnDirections: []catenumpb.IndexColumn_Direction{
					catenumpb.IndexColumn_ASC,
					catenumpb.IndexColumn_DESC,
					catenumpb.IndexColumn_DESC,
				},
				KeyColumnIDs:       []descpb.ColumnID{6, 10, 11},
				KeySuffixColumnIDs: []descpb.ColumnID{4, 2},
				Version:            descpb.StrictIndexColumnIDGuaranteesVersion,
			},
			descpb.IndexDescriptor{
			...
			descpb.IndexDescriptor{
				Name:           "index_recommendations_time_idx",
				ID:             11,
				Type:           descpb.IndexDescriptor_INVERTED,
				Unique:         false,
				KeyColumnNames: []string{"start_time", "end_time", "index_recommendations"},
				KeyColumnDirections: []catenumpb.IndexColumn_Direction{
					catenumpb.IndexColumn_DESC,
					catenumpb.IndexColumn_DESC,
					catenumpb.IndexColumn_ASC,
				},
				KeyColumnIDs:       []descpb.ColumnID{10, 11, 21},
				KeySuffixColumnIDs: []descpb.ColumnID{4, 2},
				Version:            descpb.StrictIndexColumnIDGuaranteesVersion,
			},
			descpb.IndexDescriptor{
				...
				ID:             12,
				Unique:         false,
				KeyColumnNames: []string{"full_scan", "start_time", "end_time"},
				KeyColumnDirections: []catenumpb.IndexColumn_Direction{
					catenumpb.IndexColumn_ASC,
					catenumpb.IndexColumn_DESC,
					catenumpb.IndexColumn_DESC,
				},
				KeyColumnIDs:       []descpb.ColumnID{12, 10, 11},
				KeySuffixColumnIDs: []descpb.ColumnID{4, 2},
				Version:            descpb.StrictIndexColumnIDGuaranteesVersion,
			},
			descpb.IndexDescriptor{
				...
				KeyColumnIDs:       []descpb.ColumnID{31},
				KeySuffixColumnIDs: []descpb.ColumnID{1},
				Version:            descpb.StrictIndexColumnIDGuaranteesVersion,
			},
		),
