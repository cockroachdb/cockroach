...
`
	...
	SystemMVCCStatisticsCacheSchema = `
CREATE TABLE system.mvcc_statistics_cache (
	id INT8 NOT NULL DEFAULT unique_rowid(),
	...
	statistics JSONB NOT NULL,
	CONSTRAINT mvcc_statistics_cache_pkey PRIMARY KEY (id ASC),
...
func MakeSystemTables() []SystemTable {
	return []SystemTable{
		...
		RegionLivenessTable,
		SystemMVCCStatisticsCacheTable,
	}
}
...
var (
	...
	SystemMVCCStatisticsCacheTable = makeSystemTable(
		SystemMVCCStatisticsCacheSchema,
		systemTable(
			...
			[]descpb.ColumnDescriptor{
				...
				{Name: "created_at", ID: 5, Type: types.Timestamp,
					DefaultExpr: &nowString},
			...
			descpb.IndexDescriptor{
				Name:           "mvcc_statistics_cache_pkey",
				ID:             1,
				Unique:         true,
				KeyColumnNames: []string{"id"},
				KeyColumnDirections: []catenumpb.IndexColumn_Direction{
