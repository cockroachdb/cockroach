...
CREATE TABLE system.span_stats_tenant_boundaries (
	...
	CREATE TABLE system.txn_exec_insights (
		...
		FAMILY "primary" (
  		...
  		ttl_expiration_expression = "((created AT TIME ZONE 'UTC') + INTERVAL '14 days') AT TIME ZONE 'UTC'"
	);`
...
var (
	...
	TransactionExecInsightsTable = makeSystemTable(
		...
		systemTable(
			...
			descpb.InvalidID, // dynamically assigned table ID
			[]descpb.ColumnDescriptor{
				{Name: "txn_id", ID: 1, Type: types.Uuid},
				{Name: "txn_fingerprint_id", ID: 2, Type: types.Bytes},
				{Name: "implicit_txn", ID: 3, Type: types.Bool},
				{Name: "session_id", ID: 4, Type: types.String},
				{Name: "start_time", ID: 5, Type: types.Timestamp},
				{Name: "end_time", ID: 6, Type: types.Timestamp},
				{Name: "user_name", ID: 7, Type: types.String},
				{Name: "app_name", ID: 8, Type: types.String},
				{Name: "rows_read", ID: 9, Type: types.Int},
				{Name: "rows_written", ID: 10, Type: types.Int},
				{Name: "user_priority", ID: 11, Type: types.String},
				{Name: "retries", ID: 12, Type: types.Int},
				{Name: "last_retry_reason", ID: 13, Type: types.String, Nullable: true},
				{Name: "contention", ID: 14, Type: types.Interval, Nullable: true},
				{Name: "problems", ID: 15, Type: types.StringArray},
				{Name: "causes", ID: 16, Type: types.StringArray},
				{Name: "stmt_execution_ids", ID: 17, Type: types.StringArray},
				{Name: "cpu_sql_nanos", ID: 18, Type: types.Int, Nullable: true},
				{Name: "last_error_code", ID: 19, Type: types.String, Nullable: true},
				{Name: "status", ID: 20, Type: types.String},
				{Name: "statistics", ID: 21, Type: types.Jsonb},
				{Name: "details", ID: 22, Type: types.Jsonb},
				{Name: "created", ID: 23, Type: types.TimestampTZ, DefaultExpr: &nowTZString},
			},
			[]descpb.ColumnFamilyDescriptor{
				{
					Name: "primary",
	...
	StatementExecInsightsTable = makeSystemTable(
		...
		systemTable(
			...
			[]descpb.ColumnDescriptor{
				...
				{Name: "txn_id", ID: 2, Type: types.Uuid},
				{Name: "txn_fingerprint_id", ID: 3, Type: types.Bytes},
				{Name: "stmt_id", ID: 4, Type: types.String},
				{Name: "stmt_fingerprint_id", ID: 5, Type: types.Bytes},
				{Name: "problem", ID: 6, Type: types.String},
				{Name: "causes", ID: 7, Type: types.StringArray},
				{Name: "query", ID: 8, Type: types.String},
				{Name: "status", ID: 9, Type: types.String},
				{Name: "start_time", ID: 10, Type: types.Timestamp},
				{Name: "end_time", ID: 11, Type: types.Timestamp},
				{Name: "full_scan", ID: 12, Type: types.Bool},
				{Name: "user_name", ID: 13, Type: types.String},
				{Name: "app_name", ID: 14, Type: types.String},
				{Name: "database_name", ID: 15, Type: types.String},
				{Name: "plan_gist", ID: 16, Type: types.String},
				{Name: "rows_read", ID: 17, Type: types.Int},
				{Name: "rows_written", ID: 18, Type: types.Int},
				{Name: "retries", ID: 19, Type: types.Int},
				{Name: "last_retry_reason", ID: 20, Type: types.String, Nullable: true},
				{Name: "exec_node_ids", ID: 21, Type: types.IntArray},
				{Name: "contention", ID: 22, Type: types.Interval, Nullable: true},
				{Name: "index_recommendations", ID: 23, Type: types.StringArray},
				{Name: "implicit_txn", ID: 24, Type: types.Bool},
				{Name: "cpu_sql_nanos", ID: 25, Type: types.Int},
				{Name: "error_code", ID: 26, Type: types.String, Nullable: true},
				...
				{Name: "statistics", ID: 31, Type: types.Jsonb},
				{Name: "details", ID: 32, Type: types.Jsonb},
				{Name: "created", ID: 33, Type: types.TimestampTZ, DefaultExpr: &nowTZString},
			},
			[]descpb.ColumnFamilyDescriptor{
				{
					Name: "primary",
