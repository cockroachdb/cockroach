...
CREATE TABLE system.span_stats_tenant_boundaries (
	...
	CREATE TABLE system.txn_exec_insights (
		...
		contention                 INTERVAL,
		problems                   INT8[] NOT NULL, 
		causes                     INT8[] NOT NULL,
	...
	TxnExecInsightsTable = makeSystemTable(
		...
		systemTable(
			...
			[]descpb.ColumnDescriptor{
				...
				{Name: "query", ID: 3, Type: types.String, Nullable: false},
				{Name: "implicit_txn", ID: 4, Type: types.Bool, Nullable: false},
				{Name: "session_id", ID: 5, Type: types.String, Nullable: false},
				{Name: "start_time", ID: 6, Type: types.Timestamp, Nullable: false},
				{Name: "end_time", ID: 7, Type: types.Timestamp, Nullable: false},
				{Name: "user_name", ID: 8, Type: types.String, Nullable: false},
				{Name: "app_name", ID: 9, Type: types.String, Nullable: false},
				{Name: "rows_read", ID: 10, Type: types.Int, Nullable: false},
				{Name: "rows_written", ID: 11, Type: types.Int, Nullable: false},
				{Name: "user_priority", ID: 12, Type: types.String, Nullable: false},
				{Name: "retries", ID: 13, Type: types.Int, Nullable: false},
				{Name: "last_retry_reason", ID: 14, Type: types.String},
				{Name: "contention", ID: 15, Type: types.Interval},
				{Name: "problems", ID: 16, Type: types.IntArray, Nullable: false},
				{Name: "causes", ID: 17, Type: types.IntArray, Nullable: false},
				{Name: "stmt_execution_ids", ID: 18, Type: types.StringArray, Nullable: false},
				{Name: "cpu_sql_nanos", ID: 19, Type: types.Int},
				{Name: "last_error_code", ID: 20, Type: types.String},
				{Name: "status", ID: 21, Type: types.Int, Nullable: false},
				{Name: "created", ID: 22, Type: types.TimestampTZ, Nullable: false, DefaultExpr: &nowTZString},
			},
			[]descpb.ColumnFamilyDescriptor{
				{
					Name: "primary",
			...
			descpb.IndexDescriptor{
				...
				KeyColumnIDs: []descpb.ColumnID{1, 5, 6, 7},
			},
			descpb.IndexDescriptor{
			...
			descpb.IndexDescriptor{
				...
				KeyColumnIDs: []descpb.ColumnID{18},
			},
			descpb.IndexDescriptor{
				Name:           "status_idx",
				ID:             9,
