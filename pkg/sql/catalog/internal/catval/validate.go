...
func ValidateSelf(descriptors ...catalog.Descriptor) error {
...
// sealed implements the ValidationErrorAccumulator interface
func (vea *validationErrorAccumulator) sealed() {}
