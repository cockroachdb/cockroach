			...
			if err := extracted.ForEachDescriptor(func(fromDesc catalog.Descriptor) error {
				...
				case *descpb.Descriptor_Table:
					...
					if existingRawBytes != nil {
						...
						mutBuilder.BuildExistingMutableTable().TableDescriptor = *protoutil.Clone(t.Table).(*descpb.TableDescriptor)
				...
				case *descpb.Descriptor_Database:
					...
					if existingRawBytes != nil {
						...
						mutBuilder.BuildExistingMutableDatabase().DatabaseDescriptor = *protoutil.Clone(t.Database).(*descpb.DatabaseDescriptor)
				...
				case *descpb.Descriptor_Schema:
					...
					if existingRawBytes != nil {
						...
						mutBuilder.BuildExistingMutableSchema().SchemaDescriptor = *protoutil.Clone(t.Schema).(*descpb.SchemaDescriptor)
						mut = mutBuilder.BuildExistingMutable()
					} else {
				...
				case *descpb.Descriptor_Function:
					...
					if existingRawBytes != nil {
						...
						mutBuilder.BuildExistingMutableFunction().FunctionDescriptor = *protoutil.Clone(t.Function).(*descpb.FunctionDescriptor)
						mut = mutBuilder.BuildExistingMutable()
					} else {
				...
				case *descpb.Descriptor_Type:
					...
					if existingRawBytes != nil {
						...
						mutBuilder.BuildExistingMutableType().TypeDescriptor = *protoutil.Clone(t.Type).(*descpb.TypeDescriptor)
						mut = mutBuilder.BuildExistingMutable()
					} else {
