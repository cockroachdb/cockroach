...
func (tc *Collection) Validate(
	...
	return catval.Validate(ctx, cbd, telemetry, targetLevel, descriptors...).CombinedError()
}
...
// catval.ValidationDereferencer interface for validation.
type collectionBackedDereferencer struct {
	tc  *Collection
	txn *kv.Txn
}

var _ catval.ValidationDereferencer = &collectionBackedDereferencer{}
