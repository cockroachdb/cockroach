...
// ExecuteJob is part of the jobs.ScheduledJobController interface.
...
// NotifyJobTermination is part of the jobs.ScheduledJobController interface.
...
// Metrics is part of the jobs.ScheduledJobController interface.
