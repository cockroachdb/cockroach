...
func (desc *tableDescriptorWrapper) GetConstraintInfo(
...
func (desc *tableDescriptorWrapper) GetConstraintInfoWithLookup(
...
func (desc *tableDescriptorWrapper) CheckUniqueConstraints() error {
...
func (desc *tableDescriptorWrapper) collectConstraintInfo(
	tableLookup catalog.TableLookupFn,
) (map[string]descpb.ConstraintDetail, error) {
...
func InitTableDescriptor(
	...
	return Mutable{
		tableDescriptorWrapper: tableDescriptorWrapper{
