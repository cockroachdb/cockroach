...
func (desc *wrapper) validateAutoStatsSettings(vea catalog.ValidationErrorAccumulator) {
	...
	desc.validateBoolSetting(vea, desc.AutoStatsSettings.Enabled,
		catpb.AutoStatsEnabledTableSettingName)
	desc.validateIntSetting(vea, desc.AutoStatsSettings.MinStaleRows,
		catpb.AutoStatsMinStaleTableSettingName, settings.NonNegativeInt)
	desc.validateFloatSetting(vea, desc.AutoStatsSettings.FractionStaleRows,
