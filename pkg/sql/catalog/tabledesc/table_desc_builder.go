...
func maybeUpgradeSequenceReferenceForView(
	...
	replaceSeqFunc := func(expr tree.Expr) (recurse bool, newExpr tree.Expr, err error) {
		...
		seqNameToIDMappingInExpr, err := seqexpr.SeqNameToIDMappingInExpr(expr.String(), usedSequenceIDToNames)
		if err != nil {
			return false, expr, err
		}
		hasUpgradedInExpr, err := seqexpr.UpgradeSequenceReferenceInExpr(&newExprStr, seqNameToIDMappingInExpr)
		if err != nil {
			return false, expr, err
		}
