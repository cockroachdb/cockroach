...
func newBuilder(desc *descpb.TableDescriptor) *tableDescriptorBuilder {
	return &tableDescriptorBuilder{
		...
		desc:     *protoutil.Clone(desc).(*descpb.TableDescriptor),
	}
}

// TypeName implements the catalog.DescriptorBuilder interface.
func (tdb *tableDescriptorBuilder) TypeName() catalog.DescriptorType {
...
func (tdb *tableDescriptorBuilder) RunPostDeserializationChanges(
	...
	tdb.changes, err = maybeFillInDescriptor(ctx, dg, &tdb.desc, tdb.skipFKsWithNoMatchingTable)
	return err
}
