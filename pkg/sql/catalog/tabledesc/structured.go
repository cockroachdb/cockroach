...
func NewCreatedMutable(tbl descpb.TableDescriptor) *Mutable {
	return &Mutable{tableDescriptorWrapper: tableDescriptorWrapper{TableDescriptor: tbl}}
}
...
func NewFilledInExistingMutable(
	...
	m := &Mutable{tableDescriptorWrapper: desc.tableDescriptorWrapper}
	m.ClusterVersion = *tbl
	return m, nil
}
...
func MakeImmutable(tbl descpb.TableDescriptor) Immutable {
	...
	desc := Immutable{tableDescriptorWrapper: tableDescriptorWrapper{TableDescriptor: tbl}}
...
func (desc *tableDescriptorWrapper) TypeName() string {
	return "relation"
}
...
// descriptor.
func (desc *tableDescriptorWrapper) GetPrimaryIndex() *descpb.IndexDescriptor {
...
func (desc *tableDescriptorWrapper) GetParentSchemaID() descpb.ID {
...
// the KV layer.
func (desc *tableDescriptorWrapper) IsPhysicalTable() bool {
...
func (desc *tableDescriptorWrapper) FindIndexByID(
	id descpb.IndexID,
...
func (desc *tableDescriptorWrapper) KeysPerRow(indexID descpb.IndexID) (int, error) {
...
// in the mutations.
func (desc *tableDescriptorWrapper) AllNonDropColumns() []descpb.ColumnDescriptor {
...
// in the mutations.
func (desc *tableDescriptorWrapper) AllNonDropIndexes() []*descpb.IndexDescriptor {
...
func (desc *tableDescriptorWrapper) AllActiveAndInactiveChecks() []*descpb.TableDescriptor_CheckConstraint {
...
func (desc *tableDescriptorWrapper) AllActiveAndInactiveUniqueWithoutIndexConstraints() []*descpb.UniqueWithoutIndexConstraint {
...
// same index.
func (desc *tableDescriptorWrapper) AllActiveAndInactiveForeignKeys() []*descpb.ForeignKeyConstraint {
...
func (desc *tableDescriptorWrapper) ForeachPublicColumn(
...
func (desc *tableDescriptorWrapper) ForeachNonDropColumn(
	f func(column *descpb.ColumnDescriptor) error,
) error {
...
func (desc *tableDescriptorWrapper) ForeachNonDropIndex(
...
func (desc *tableDescriptorWrapper) ForeachIndex(
...
// added in the mutations.
func (desc *tableDescriptorWrapper) ForeachDependedOnBy(
...
// error is returned.
func (desc *tableDescriptorWrapper) ForeachOutboundFK(
...
// error is returned.
func (desc *tableDescriptorWrapper) ForeachInboundFK(
...
func (desc *tableDescriptorWrapper) NumFamilies() int {
	return len(desc.Families)
}

// ForeachFamily calls f for every column family key in desc until an
// error is returned.
func (desc *tableDescriptorWrapper) ForeachFamily(
...
func ForEachExprStringInTableDesc(descI catalog.TableDescriptor, f func(expr *string) error) error {
	var desc *tableDescriptorWrapper
	switch descV := descI.(type) {
	case *tableDescriptorWrapper:
		desc = descV
	case *Immutable:
		desc = &descV.tableDescriptorWrapper
	case *Mutable:
		desc = &descV.tableDescriptorWrapper
	default:
...
// with the desired ID.
func (desc *tableDescriptorWrapper) GetAllReferencedTypeIDs(
...
func (desc *tableDescriptorWrapper) Validate(ctx context.Context, dg catalog.DescGetter) error {
	err := desc.ValidateTable(ctx)
	if err != nil {
		return err
	}
...
func (desc *tableDescriptorWrapper) validateTableIfTesting(ctx context.Context) error {
...
func (desc *tableDescriptorWrapper) validateCrossReferencesIfTesting(
...
func (desc *tableDescriptorWrapper) validateCrossReferences(
...
func (desc *tableDescriptorWrapper) ValidateIndexNameIsUnique(indexName string) error {
	for _, index := range desc.AllNonDropIndexes() {
...
func (desc *tableDescriptorWrapper) ValidateTable(ctx context.Context) error {
...
func (desc *tableDescriptorWrapper) validateColumns(
...
func (desc *tableDescriptorWrapper) validateColumnFamilies(
...
func (desc *tableDescriptorWrapper) validateCheckConstraints(
	columnIDs map[descpb.ColumnID]*descpb.ColumnDescriptor,
) error {
...
// column names.
func (desc *tableDescriptorWrapper) validateUniqueWithoutIndexConstraints(
	columnIDs map[descpb.ColumnID]*descpb.ColumnDescriptor,
) error {
...
func (desc *tableDescriptorWrapper) validateTableIndexes(
	columnNames map[string]descpb.ColumnID,
) error {
...
func (desc *tableDescriptorWrapper) ensureShardedIndexNotComputed(
...
// table descriptor.
func (desc *tableDescriptorWrapper) PrimaryKeyString() string {
...
func (desc *tableDescriptorWrapper) validatePartitioningDescriptor(
	a *rowenc.DatumAlloc,
...
func (desc *tableDescriptorWrapper) FindIndexesWithPartition(
	name string,
...
func (desc *tableDescriptorWrapper) validatePartitioning() error {
...
// or returns an error.
func (desc *tableDescriptorWrapper) FindActiveColumnsByNames(
	names tree.NameList,
...
func (desc *tableDescriptorWrapper) HasColumnWithName(
	name tree.Name,
) (*descpb.ColumnDescriptor, bool) {
	for i := range desc.Columns {
		c := &desc.Columns[i]
...
func (desc *tableDescriptorWrapper) FindColumnByName(
	name tree.Name,
...
func (desc *tableDescriptorWrapper) FindColumnMutationByName(
	name tree.Name,
...
// column.
func (desc *tableDescriptorWrapper) ColumnIdxMap() catalog.TableColMap {
...
// bool is true.
func (desc *tableDescriptorWrapper) ColumnIdxMapWithMutations(mutations bool) catalog.TableColMap {
...
func (desc *tableDescriptorWrapper) FindActiveColumnByName(
	name string,
) (*descpb.ColumnDescriptor, error) {
	for i := range desc.Columns {
		c := &desc.Columns[i]
...
func (desc *tableDescriptorWrapper) FindColumnByID(
	id descpb.ColumnID,
) (*descpb.ColumnDescriptor, error) {
	for i := range desc.Columns {
		c := &desc.Columns[i]
...
func (desc *tableDescriptorWrapper) FindActiveColumnByID(
	id descpb.ColumnID,
) (*descpb.ColumnDescriptor, error) {
	for i := range desc.Columns {
		c := &desc.Columns[i]
...
func (desc *tableDescriptorWrapper) ContainsUserDefinedTypes() bool {
...
func (desc *tableDescriptorWrapper) UserDefinedTypeColsHaveSameVersion(
	otherDesc catalog.TableDescriptor,
) bool {
...
// schema change.
func (desc *tableDescriptorWrapper) FindReadableColumnByID(
	id descpb.ColumnID,
) (*descpb.ColumnDescriptor, bool, error) {
...
func (desc *tableDescriptorWrapper) FindFamilyByID(
	id descpb.FamilyID,
...
func (desc *tableDescriptorWrapper) FindIndexByName(
	name string,
...
// hot path code.
func (desc *tableDescriptorWrapper) NamesForColumnIDs(ids descpb.ColumnIDs) ([]string, error) {
...
func (desc *tableDescriptorWrapper) FindActiveIndexByID(id descpb.IndexID) *descpb.IndexDescriptor {
	if desc.PrimaryIndex.ID == id {
		return &desc.PrimaryIndex
	}
	for i := range desc.Indexes {
...
func (desc *tableDescriptorWrapper) FindIndexByIndexIdx(
	indexIdx int,
...
func (desc *tableDescriptorWrapper) GetIndexMutationCapabilities(id descpb.IndexID) (bool, bool) {
...
// callers can use returned values to modify the TableDesc.
func (desc *tableDescriptorWrapper) FindFKByName(
	name string,
...
func (desc *tableDescriptorWrapper) IsInterleaved() bool {
	for _, index := range desc.AllNonDropIndexes() {
...
func (desc *tableDescriptorWrapper) IsPrimaryIndexDefaultRowID() bool {
...
// error reporting.
func (desc *tableDescriptorWrapper) MakeFirstMutationPublic(
...
func (desc *tableDescriptorWrapper) HasPrimaryKey() bool {
...
func (desc *tableDescriptorWrapper) HasColumnBackfillMutation() bool {
	for _, m := range desc.Mutations {
		col := m.GetColumn()
		if col == nil {
...
func (desc *tableDescriptorWrapper) VisibleColumns() []descpb.ColumnDescriptor {
...
func (desc *tableDescriptorWrapper) ColumnTypesWithMutations(mutations bool) []*types.T {
...
func (desc *tableDescriptorWrapper) InvalidateFKConstraints() {
...
func (desc *tableDescriptorWrapper) AllIndexSpans(codec keys.SQLCodec) roachpb.Spans {
...
func (desc *tableDescriptorWrapper) PrimaryIndexSpan(codec keys.SQLCodec) roachpb.Span {
...
func (desc *tableDescriptorWrapper) IndexSpan(
...
func (desc *tableDescriptorWrapper) TableSpan(codec keys.SQLCodec) roachpb.Span {
...
// See #22322.
func (desc *tableDescriptorWrapper) ColumnsUsed(
...
// specified column.
func (desc *tableDescriptorWrapper) CheckConstraintUsesColumn(
...
func (desc *tableDescriptorWrapper) GetFamilyOfColumn(
	colID descpb.ColumnID,
) (*descpb.ColumnFamilyDescriptor, error) {
...
func (desc *tableDescriptorWrapper) PartitionNames() []string {
	var names []string
	for _, index := range desc.AllNonDropIndexes() {
...
func (desc *tableDescriptorWrapper) FindAllReferences() (map[descpb.ID]struct{}, error) {
...
func (desc *tableDescriptorWrapper) TableDesc() *descpb.TableDescriptor {
