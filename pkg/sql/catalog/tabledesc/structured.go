...
type PostDeserializationTableDescriptorChanges [numPostDeserializationChangeTypes]bool
...
const (
	...
	numPostDeserializationChangeTypes int = iota
)

func (c *PostDeserializationTableDescriptorChanges) combineWith(
