	...
	testData := []struct {
		...
		{`conflicting NULL/NOT NULL declarations for column "bar"`,
			descpb.TableDescriptor{
				...
				FormatVersion: descpb.InterleavedFormatVersion,
				Columns: []descpb.ColumnDescriptor{
					{ID: 1, Name: "bar", GeneratedAsIdentityType: descpb.GeneratedAsIdentityType_GENERATED_ALWAYS, Nullable: true},
				},
				NextColumnID: 3,
			}},
		{`conflicting NULL/NOT NULL declarations for column "bar"`,
			descpb.TableDescriptor{
				...
				FormatVersion: descpb.InterleavedFormatVersion,
				Columns: []descpb.ColumnDescriptor{
					{ID: 1, Name: "bar", GeneratedAsIdentityType: descpb.GeneratedAsIdentityType_GENERATED_BY_DEFAULT, Nullable: true},
				},
				NextColumnID: 3,
			}},
		{`both identity and generation expression specified for column "bar"`,
			descpb.TableDescriptor{
				...
				FormatVersion: descpb.InterleavedFormatVersion,
				Columns: []descpb.ColumnDescriptor{
					{ID: 1, Name: "bar", GeneratedAsIdentityType: descpb.GeneratedAsIdentityType_GENERATED_ALWAYS, ComputeExpr: &computedExpr},
				},
				NextColumnID: 3,
			}},
		{`both identity and generation expression specified for column "bar"`,
