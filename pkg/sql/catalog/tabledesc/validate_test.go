...
func TestValidateCrossTableReferences(t *testing.T) {
	...
	tests := []struct {
		...
		// Foreign keys
		{ // 0
			err: `invalid foreign key: missing table=52: referenced table descriptor 52 not found`,
			desc: descpb.TableDescriptor{
				Name:                    "foo",
				ID:                      51,
				ParentID:                1,
		...
		{ // 2
			err: `invalid foreign key backreference: missing table=52: referenced table descriptor 52 not found`,
			desc: descpb.TableDescriptor{
				Name:                    "foo",
				ID:                      51,
				ParentID:                1,
		...
		// Interleaves
		{ // 6
			err: `invalid interleave: missing table=52 index=2: referenced table descriptor 52 not found`,
			desc: descpb.TableDescriptor{
				Name:                    "foo",
				ID:                      51,
				ParentID:                1,
		...
		{ // 9
			err: `invalid interleave backreference table=52 index=2: referenced table descriptor 52 not found`,
			desc: descpb.TableDescriptor{
				Name:                    "foo",
				ID:                      51,
				ParentID:                1,
		...
		{ // 12
			err: `referenced type descriptor 500 not found`,
			desc: descpb.TableDescriptor{
				Name:                    "foo",
				ID:                      51,
				ParentID:                1,
