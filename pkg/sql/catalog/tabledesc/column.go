...
func (w column) IsGeneratedAsIdentity() bool {
	return w.desc.GeneratedAsIdType != descpb.GeneratedAsIdentityType_NOT_IDENTITY_COLUMN
}
...
func (w column) IsGeneratedAlwaysAsIdentity() bool {
	return w.desc.GeneratedAsIdType == descpb.GeneratedAsIdentityType_GENERATED_ALWAYS
}
...
func (w column) IsGeneratedByDefaultAsIdentity() bool {
	return w.desc.GeneratedAsIdType == descpb.GeneratedAsIdentityType_GENERATED_BY_DEFAULT
}
