...
func (sdb *schemaDescriptorBuilder) TypeName() catalog.DescriptorType {
...
func (sdb *schemaDescriptorBuilder) BuildImmutableSchema() *Immutable {
	return &Immutable{SchemaDescriptor: sdb.desc}
}
...
func (sdb *schemaDescriptorBuilder) BuildExistingMutableSchema() *Mutable {
	return &Mutable{
		Immutable:      Immutable{SchemaDescriptor: sdb.desc},
...
func (sdb *schemaDescriptorBuilder) BuildCreatedMutableSchema() *Mutable {
	return &Mutable{Immutable: Immutable{SchemaDescriptor: sdb.desc}}
}
