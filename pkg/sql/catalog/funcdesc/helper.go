...
// ToPbFunctionVolatility converts sql statement input volatility to protobuf
// type.
func ToPbFunctionVolatility(v tree.FunctionVolatility) (catpb.Function_Volatility, error) {
	switch v {
...
// ToPbFunctionNullInputBehavior converts sql statement input null input
...
// ToPbFunctionLang converts sql statement input language to protobuf type.
func ToPbFunctionLang(v tree.FunctionLanguage) (catpb.Function_Language, error) {
	switch v {
...
// ToPbFunctionArgClass converts sql statement input argument class to protobuf
// type.
func ToPbFunctionArgClass(v tree.FuncArgClass) (catpb.Function_Arg_Class, error) {
	switch v {
