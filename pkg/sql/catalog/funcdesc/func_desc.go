...
// SetSecurity
func (desc *Mutable) SetSecurity(v catpb.FunctionRoutineSecurity) {
	desc.Security = v
}
...
func (desc *immutable) GetSecurity() catpb.FunctionRoutineSecurity {
...
func (desc *immutable) getCreateExprSecurity() tree.RoutineSecurity {
	switch desc.Security.Security {
	case catpb.Function_RoutineSecurity_INVOKER:
		return tree.RoutineSecurity{Security: tree.RoutineInvoker, External: desc.Security.External}
	case catpb.Function_RoutineSecurity_DEFINER:
		return tree.RoutineSecurity{Security: tree.RoutineDefiner, External: desc.Security.External}
	}
	return tree.RoutineSecurity{}
}
