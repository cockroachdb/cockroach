...
// InitFunctionDescriptor returns a new mutable function descriptor.
...
func (desc *immutable) ValidateSelf(vea catalog.ValidationErrorAccumulator) {
	...
	if desc.LeakProof && desc.Volatility != descpb.FunctionDescriptor_Immutable {
...
// FunctionDesc implements the catalog.FunctionDescriptor interface.
...
// SetDrainingNames implements the catalog.MutableDescriptor interface.
func (desc *Mutable) SetDrainingNames([]descpb.NameInfo) {}

// AddDrainingName implements the catalog.MutableDescriptor interface.
