...
type Column interface {
	...
	// GetGeneratedAsIdentityType returns the GeneratedAsIdentityType
	// of the column descriptor. If the column was created with the
	// GENERATED ALWAYS AS IDENTITY token,
	// it returns descpb.GeneratedAsIdentityType_GENERATEDALWAYS;
	// if the column was created with GENERATED BY DEFAULT AS IDENTITY token,
	// it returns descpb.GeneratedAsIdentityType_GENERATEDBYDEFAULT.
	// Otherwise, this column is not an IDENTITY column, and
	// it returns descpb.GeneratedAsIdentityType_NOTIDENTITYCOLUMN.
