...
type Column interface {
	...
	// IsGeneratedAlwaysAsIdentity returns true iff the columns is created
	// with GENERATED ALWAYS AS IDENTITY token.
	IsGeneratedAlwaysAsIdentity() bool

	// IsGeneratedByDefaultAsIdentity returns true iff the columns is created
	// with GENERATED BY DEFAULT AS IDENTITY token.
