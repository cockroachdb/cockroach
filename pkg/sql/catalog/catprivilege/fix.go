...
type PrivilegeDescriptorBuilder interface {
	GetLatestPrivilege() *catpb.PrivilegeDescriptor
...
func (d dummyPrivilegeDescriptorBuilder) GetMutablePrivilege() *catpb.PrivilegeDescriptor {
	return d.GetLatestPrivilege()
}
...
func MaybeFixPrivileges(
	...
	return MaybeFixPrivilegesWithBuilder(dummyPrivilegeDescriptorBuilder{
		p: ptr,
	},
		parentID,
		parentSchemaID,
...
func MaybeFixPrivilegesWithBuilder(
	...
	readOnlyPriv := reader.GetLatestPrivilege()
