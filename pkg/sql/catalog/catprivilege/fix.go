...
// MaybeAddGrantOptions iterates over the users of the descriptor and checks
...
func MaybeAddGrantOptions(ptr **descpb.PrivilegeDescriptor) bool {
	...
	//if p.Version < descpb.Version21_2 { // Should this be changed to 22.1? There is no descpb.Version22_1
	//	p.SetVersion(descpb.Version21_2)
	//	changed = true
	//}
