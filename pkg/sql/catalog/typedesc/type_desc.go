...
// TypeDescriptor. It ensures that duplicates are not added. It returns false if
// nothing was added.
...
// from the catalog.TypeDescriptor. It has no effect if the requested ID is not
// present. A value of false is returned for that case.
