...
func TestValidateTypeDesc(t *testing.T) {
	...
	testData := []struct {
		...
		{
			`referenced database descriptor 500 not found`,
			descpb.TypeDescriptor{
				Name:           "t",
				ID:             typeDescID,
				ParentID:       500,
		...
		{
			`referenced schema descriptor 500 not found`,
			descpb.TypeDescriptor{
				Name:           "t",
				ID:             typeDescID,
				ParentID:       100,
		...
		{
			`arrayTypeID 500 does not exist for "ENUM": referenced type descriptor 500 not found`,
			descpb.TypeDescriptor{
				Name:           "t",
				ID:             typeDescID,
				ParentID:       100,
		...
		{
			`arrayTypeID 500 does not exist for "MULTIREGION_ENUM": referenced type descriptor 500 not found`,
			descpb.TypeDescriptor{
				Name:           "t",
				ID:             typeDescID,
				ParentID:       200,
		...
		{
			"referencing descriptor 500: referenced table descriptor 500 not found",
			descpb.TypeDescriptor{
				Name:                     "t",
				ID:                       typeDescID,
				ParentID:                 100,
