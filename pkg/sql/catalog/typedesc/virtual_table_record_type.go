...
func (v TableImplicitRecordType) GetReferencedDescIDs() (catalog.DescriptorIDSet, error) {
	return catalog.DescriptorIDSet{}, errors.AssertionFailedf("id closure unsupported for implicit table record types")
	ret := catalog.DescriptorIDSet{}
	idmap, err := v.GetIDClosure()
	if err != nil {
		return ret, err
	}
	idmap[v.GetID()] = struct{}{}
	idmap[v.GetParentID()] = struct{}{}
	idmap[v.GetParentSchemaID()] = struct{}{}
	for id := range idmap {
		ret.Add(id)
	}
	return ret, nil
...
func (v TableImplicitRecordType) GetIDClosure() (map[descpb.ID]struct{}, error) {
	return nil, errors.AssertionFailedf("id closure unsupported for implicit table record types")
