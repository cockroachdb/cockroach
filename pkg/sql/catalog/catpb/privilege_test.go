	...
	testCases := []struct {
		...
		{testUser,
			...
			privilege.List{privilege.BACKUP, privilege.CHANGEFEED, privilege.CREATE, privilege.DROP, privilege.SELECT, privilege.INSERT,
				privilege.DELETE, privilege.TRIGGER, privilege.REPLICATIONDEST, privilege.UPDATE, privilege.ZONECONFIG},
			[]catpb.UserPrivilege{
				{User: username.AdminRoleName(), Privileges: []privilege.Privilege{{Kind: privilege.ALL, GrantOption: true}}},
			},
			privilege.Table,
...
func TestRevokeWithGrantOption(t *testing.T) {
	...
	testCases := []struct {
		...
		{catpb.NewPrivilegeDescriptor(testUser, privilege.List{privilege.ALL}, privilege.List{privilege.ALL}, username.AdminRoleName()),
			...
			privilege.List{privilege.ALL},
			privilege.List{privilege.BACKUP, privilege.CHANGEFEED, privilege.DROP, privilege.SELECT, privilege.INSERT, privilege.DELETE, privilege.REPLICATIONDEST, privilege.TRIGGER, privilege.UPDATE, privilege.ZONECONFIG},
			false},
		{catpb.NewPrivilegeDescriptor(testUser, privilege.List{privilege.ALL}, privilege.List{privilege.ALL}, username.AdminRoleName()),
			testUser, privilege.Table,
			true,
		...
		{catpb.NewPrivilegeDescriptor(testUser, privilege.List{privilege.ALL}, privilege.List{privilege.ALL}, username.AdminRoleName()),
			...
			false,
			privilege.List{privilege.CREATE},
			privilege.List{privilege.BACKUP, privilege.CHANGEFEED, privilege.DROP, privilege.SELECT, privilege.INSERT, privilege.DELETE, privilege.TRIGGER, privilege.UPDATE, privilege.ZONECONFIG, privilege.REPLICATIONDEST},
			privilege.List{privilege.BACKUP, privilege.CHANGEFEED, privilege.DROP, privilege.SELECT, privilege.INSERT, privilege.DELETE, privilege.TRIGGER, privilege.UPDATE, privilege.ZONECONFIG, privilege.REPLICATIONDEST},
			false},
