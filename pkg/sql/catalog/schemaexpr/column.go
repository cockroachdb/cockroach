...
func ReplaceTableIDsWithFQNames(
	...
	replaceFn := func(expr tree.Expr) (recurse bool, newExpr tree.Expr, err error) {
		...
		case *tree.ColumnNameRef:
			...
			// TODO(chengxiong): maybe omit the database qualification.
			return false, &tree.ColumnItem{TableName: tblName.ToUnresolvedObjectName(), ColumnName: tree.Name(t.ColumnName)}, nil
