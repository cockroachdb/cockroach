...
func deserializeExprForFormatting(
	...
	// expressions, when possible (e.g., turn Array expr into a DArrray).
	if fmtFlags == tree.FmtPGCatalog {
		...
		// it and turn it into a constant. An empty EvalContext is fine here since
		// the expression has VolatilityImmutable.
		if err == nil {
