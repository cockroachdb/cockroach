...
func TestConstraintRetrieval(t *testing.T) {
	...
	t.Run("test-AllConstraints", func(t *testing.T) {
		...
		checkConstraintIsAsExpected(t, all[0], 1, descpb.ConstraintValidity_Validated, descpb.ConstraintTypePK)
		checkConstraintIsAsExpected(t, all[1], 2, descpb.ConstraintValidity_Validated, descpb.ConstraintTypeCheck)
		checkConstraintIsAsExpected(t, all[2], 3, descpb.ConstraintValidity_Unvalidated, descpb.ConstraintTypeCheck)
		checkConstraintIsAsExpected(t, all[3], 4, descpb.ConstraintValidity_Validated, descpb.ConstraintTypeUnique)
		checkConstraintIsAsExpected(t, all[4], 5, descpb.ConstraintValidity_Validated, descpb.ConstraintTypeFK)
		checkConstraintIsAsExpected(t, all[5], 6, descpb.ConstraintValidity_Validated, descpb.ConstraintTypeFK)
		checkConstraintIsAsExpected(t, all[6], 7, descpb.ConstraintValidity_Dropping, descpb.ConstraintTypeUnique)
		checkConstraintIsAsExpected(t, all[7], 8, descpb.ConstraintValidity_Validating, descpb.ConstraintTypeCheck)
		checkConstraintIsAsExpected(t, all[8], 9, descpb.ConstraintValidity_Validating, descpb.ConstraintTypeUnique)
	})
	...
	t.Run("test-AllActiveAndInactiveConstraints", func(t *testing.T) {
		...
		checkConstraintIsAsExpected(t, allActiveAndInactive[0], 1, descpb.ConstraintValidity_Validated, descpb.ConstraintTypePK)
		checkConstraintIsAsExpected(t, allActiveAndInactive[1], 2, descpb.ConstraintValidity_Validated, descpb.ConstraintTypeCheck)
		checkConstraintIsAsExpected(t, allActiveAndInactive[2], 3, descpb.ConstraintValidity_Unvalidated, descpb.ConstraintTypeCheck)
		checkConstraintIsAsExpected(t, allActiveAndInactive[3], 4, descpb.ConstraintValidity_Validated, descpb.ConstraintTypeUnique)
		checkConstraintIsAsExpected(t, allActiveAndInactive[4], 5, descpb.ConstraintValidity_Validated, descpb.ConstraintTypeFK)
		checkConstraintIsAsExpected(t, allActiveAndInactive[5], 6, descpb.ConstraintValidity_Validated, descpb.ConstraintTypeFK)
		checkConstraintIsAsExpected(t, allActiveAndInactive[6], 8, descpb.ConstraintValidity_Validating, descpb.ConstraintTypeCheck)
		checkConstraintIsAsExpected(t, allActiveAndInactive[7], 9, descpb.ConstraintValidity_Validating, descpb.ConstraintTypeUnique)
	})
	...
	t.Run("test-AllActiveConstraints", func(t *testing.T) {
		...
		checkConstraintIsAsExpected(t, allActive[0], 1, descpb.ConstraintValidity_Validated, descpb.ConstraintTypePK)
		checkConstraintIsAsExpected(t, allActive[1], 2, descpb.ConstraintValidity_Validated, descpb.ConstraintTypeCheck)
		checkConstraintIsAsExpected(t, allActive[2], 4, descpb.ConstraintValidity_Validated, descpb.ConstraintTypeUnique)
		checkConstraintIsAsExpected(t, allActive[3], 5, descpb.ConstraintValidity_Validated, descpb.ConstraintTypeFK)
		checkConstraintIsAsExpected(t, allActive[4], 6, descpb.ConstraintValidity_Validated, descpb.ConstraintTypeFK)
	})
}

// checkConstraintIsAsExpected ensures `c`
...
func checkConstraintIsAsExpected(
	...
	expectedType descpb.ConstraintType,
) {
	...
	case descpb.ConstraintTypePK:
		require.Equal(t, true, c.IsPrimaryKey())
	case descpb.ConstraintTypeFK:
		require.Equal(t, true, c.IsForeignKey())
	case descpb.ConstraintTypeUnique:
		require.Equal(t, true, c.IsUniqueConstraint() || c.IsUniqueWithoutIndex())
	case descpb.ConstraintTypeCheck:
		require.Equal(t, true, c.IsCheck())
	}
}
