...
// MigrationOnlyFunc represents the work that is applied when
// RunMigrationOnlyChanges() is called
type MigrationOnlyFunc = func(b DescriptorBuilder)
...
type DescriptorBuilder interface {
	...
	RunMigrationOnlyChanges(workFunc ...MigrationOnlyFunc) error
