...
type Descriptor interface {
	...
	// GetDeclarativeSchemaChangeJobID returns the job ID of the corresponding
	// declarative schema change currently operating on this descriptor.
	GetDeclarativeSchemaChangeJobID() catpb.JobID
	// GetDeclarativeSchemaChangeState returns the state of the declarative
	...
	GetDeclarativeSchemaChangeState() *scpb.DescriptorState
}
