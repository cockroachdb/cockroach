...
type TableDescriptor interface {
	...
	// EnforcedOutboundForeignKeys returns the subset of foreign key constraints in
	// EnforcedConstraints for this table.
	EnforcedOutboundForeignKeys() []ForeignKeyConstraint
	// InboundForeignKeys returns all foreign key back-references from this table.
	InboundForeignKeys() []ForeignKeyConstraint

	// UniqueConstraintsWithIndex returns the subset of index-backed unique
	// constraints in AllConstraints for this table.
	...
	// unique constraints in EnforcedConstraints for this table.
	...
	// unique constraints in AllConstraints for this table.
	...
	// FindConstraintWithID returns the first catalog.Constraint that matches the
	// ID in the set of all constraints, or an error if none was found. The order
	// of traversal is undefined.
	FindConstraintWithID(id descpb.ConstraintID) (Constraint, error)
	// FindConstraintWithName returns the first catalog.Constraint that matches the
	// name in the set of all constraints, or an error if none was found. The order
	// of traversal is undefined.
	...
	// ForeignKeyReferencedColumns returns the slice of columns referenced by this
	...
	// defined as unique by this non-index-backed constraint.
