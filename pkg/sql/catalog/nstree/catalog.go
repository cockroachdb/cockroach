...
var _ catval.ValidationDereferencer = Catalog{}
var _ catval.ValidationDereferencer = MutableCatalog{}
...
// Validate delegates to catval.Validate.
func (c Catalog) Validate(
	...
	return catval.Validate(ctx, c, telemetry, targetLevel, descriptors...)
}
