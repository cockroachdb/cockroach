...
func addSystemDescriptorsToSchema(target *MetadataSchema) {
	...
	target.AddDescriptor(systemschema.ResourceGroupsTable)
	target.AddDescriptor(systemschema.ResourceGroupIDSequence)
	target.AddDescriptor(systemschema.TenantResourceGroupsTable)
...
const NumSystemTablesForSystemTenant = 73
