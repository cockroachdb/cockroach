...
func NewDisallowedSchemaChangeOnLDRTableErr(tableName string, jobIDs []int64) error {
	...
	return errors.WithHintf(
		...
		"To perform the schema change, cancel the logical replication job, then execute "+
			"the schema change on both sides of the stream and create a new replication stream.")
}
