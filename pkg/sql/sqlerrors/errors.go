...
// NewGeneratedAlwaysAsIdentityColumnUpdateError creates an error for updating a column
// created with `GENERATED ALWAYS AS IDENTITY` syntax to an expression other than "DEFAULT".
