...
type multiRegionFinalizer struct {
	typeID              descpb.ID
	regionalByRowTables []descpb.ID
}

// NewMultiRegionFinalizer returns a multiRegionFinalizer.
func NewMultiRegionFinalizer(typeID descpb.ID) *multiRegionFinalizer {
	return &multiRegionFinalizer{
		typeID: typeID,
	}
}
...
func (r *multiRegionFinalizer) finalize(
...
func (r *multiRegionFinalizer) repartitionRegionalByRowTables(
	ctx context.Context, txn *kv.Txn, descsCol *descs.Collection, execCfg *ExecutorConfig,
) error {
...
// repartitioned.
func (r *multiRegionFinalizer) waitToUpdateLeases(
