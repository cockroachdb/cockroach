...
// isVerifyIndexCountQuery is used to determine if the query for an index scan
// is to verify its count. This occurs as part of the validation process for a
// new index (see ValidateForwardIndexes &
...
func isVerifyIndexCountQuery(stmt string, tableID int, idxID int) bool {
	...
	return stmt == verifyIndexCountString
}
