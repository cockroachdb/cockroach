...
func (ef *execFactory) ConstructSimpleProject(
	...
	for i, col := range cols {
		...
		if colNames == nil {
			rb.addExpr(v, inputCols[col].Name, inputCols[col].TableID, inputCols[col].ColumnID)
		} else {
			rb.addExpr(v, colNames[i], 0 /* tableID */, 0 /* columnID */)
		}
	}
	return rb.res, nil
}
...
func (ef *execFactory) ConstructRender(
	...
	for i, expr := range exprs {
		...
		rb.addExpr(expr, colNames[i], 0 /* tableID */, 0 /* columnID */)
	}
	return rb.res, nil
}
...
func (rb *renderBuilder) addExpr(
	expr tree.TypedExpr, colName string, tableID sqlbase.ID, columnID sqlbase.ColumnID,
) {
