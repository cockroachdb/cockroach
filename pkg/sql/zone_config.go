...
func ZonesTableExists(ctx context.Context, codec keys.SQLCodec, settings *cluster.Settings) bool {
	if codec.ForSystemTenant() ||
		settings.Version.IsActive(ctx, clusterversion.ZonesTableForSecondaryTenants) {
		return true
	}
	return false
}
