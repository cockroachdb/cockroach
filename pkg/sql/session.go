...
func (r *SessionRegistry) CancelSession(sessionIDStr string, username string) (bool, error) {
	sessionID, err := uint128.FromString(sessionIDStr)
	if err != nil {
		return false, fmt.Errorf("session ID %s malformed: %s", sessionID, err)
	}
