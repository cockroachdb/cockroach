...
// context, for whether the query has been cancelled. Both of these need to
// be checked; a CANCEL QUERY directed at this query will set the flag as well
...
func (q *queryMeta) isQueryCancelled() bool {
...
type txnState struct {
	...
	// the context. Can be nil when no txn is in progress.
	cancel context.CancelFunc
