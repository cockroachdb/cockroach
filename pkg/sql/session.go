...
var DistSQLClusterExecMode = settings.RegisterEnumSetting(
	...
	"Auto",
	map[int64]string{
		int64(tree.DistSQLOff):  "Off",
		int64(tree.DistSQLAuto): "Auto",
		int64(tree.DistSQLOn):   "On",
	},
)
...
func NewSession(
	...
	distSQLMode := tree.DistSQLExecMode(DistSQLClusterExecMode.Get(&e.cfg.Settings.SV))
...
func (m *sessionDataMutator) SetDistSQLMode(val tree.DistSQLExecMode) {
...
func (m *sessionDataMutator) SetSearchPath(val tree.SearchPath) {
