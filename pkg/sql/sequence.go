...
func assignSequenceOptions(
	...
	// Set increment-dependent and integerType-dependent defaults.
	if setDefaults {
		setSequenceDefaultVals(opts, integerType, isAscending, &lowerIntBound, &upperIntBound)
	}
