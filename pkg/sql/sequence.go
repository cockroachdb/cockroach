...
func incrementSequenceHelper(
	ctx context.Context, p *planner, descriptor *tabledesc.Immutable,
) (int64, error) {
...
func getLatestValueInSessionForSequenceHelper(
	p *planner, descriptor *tabledesc.Immutable, seqName *tree.TableName,
) (int64, error) {
...
// to set the value for the given sequence.
