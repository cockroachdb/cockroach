...
func (dsp *DistSQLPlanner) tryCreatePlanForInterleavedJoin(
	...
	if ancsPartitions, err = adjustPartitionsForInterleave(ancsPartitions, ancestor.desc, ancestor.index); err != nil {
		return physicalPlan{}, false, err
	}
	if descPartitions, err = adjustPartitionsForInterleave(descPartitions, descendant.desc, descendant.index); err != nil {
		return physicalPlan{}, false, err
	}
