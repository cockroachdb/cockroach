...
// shiftExprCols remaps the expression columns for an expression that was
// originally applied to the right side of a join, and shifts it so the
// columns are remapped to the correct position in the merged row.
func shiftExprCols(
