...
func (dsp *DistSQLPlanner) planVectorSearch(
	...
	if err := vecstore.InitGetFullVectorsFetchSpec(&spec.GetFullVectorsFetchSpec, planCtx.EvalContext(), planInfo.table, planInfo.index, planInfo.table.GetPrimaryIndex()); err != nil {
		return err
	}
