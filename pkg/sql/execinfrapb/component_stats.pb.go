...
type KVStats struct {
	...
	StepCount         optional.Uint     `protobuf:"bytes,5,opt,name=num_interface_steps,json=numInterfaceSteps" json:"num_interface_steps"`
	InternalStepCount optional.Uint     `protobuf:"bytes,6,opt,name=num_internal_steps,json=numInternalSteps" json:"num_internal_steps"`
	SeekCount         optional.Uint     `protobuf:"bytes,7,opt,name=num_interface_seeks,json=numInterfaceSeeks" json:"num_interface_seeks"`
	InternalSeekCount optional.Uint     `protobuf:"bytes,8,opt,name=num_internal_seeks,json=numInternalSeeks" json:"num_internal_seeks"`
}
...
func (m *KVStats) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size, err := m.InternalSeekCount.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	dAtA[i] = 0x3a
	{
		size, err := m.InternalStepCount.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *KVStats) Size() (n int) {
	...
	l = m.StepCount.Size()
	n += 1 + l + sovComponentStats(uint64(l))
	l = m.InternalStepCount.Size()
	n += 1 + l + sovComponentStats(uint64(l))
	l = m.SeekCount.Size()
	n += 1 + l + sovComponentStats(uint64(l))
	l = m.InternalSeekCount.Size()
	n += 1 + l + sovComponentStats(uint64(l))
	return n
}
...
func (m *KVStats) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InternalStepCount", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.InternalStepCount.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 7:
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InternalSeekCount", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.InternalSeekCount.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
