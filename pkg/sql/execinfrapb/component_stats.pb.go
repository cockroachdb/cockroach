...
func (*ComponentStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_component_stats_eeca6d80f872e429, []int{0}
}
...
type InputStats struct {
	...
	WaitTime time.Duration `protobuf:"bytes,2,opt,name=wait_time,json=waitTime,stdduration" json:"wait_time"`
}
...
func (*InputStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_component_stats_eeca6d80f872e429, []int{1}
}
...
type NetworkRxStats struct {
	...
	Latency time.Duration `protobuf:"bytes,1,opt,name=latency,stdduration" json:"latency"`
	// Cumulated time spent waiting to receive or transmit tuple data.
	WaitTime time.Duration `protobuf:"bytes,2,opt,name=wait_time,json=waitTime,stdduration" json:"wait_time"`
	// Time spent deserializing network data.
	DeserializationTime time.Duration `protobuf:"bytes,3,opt,name=deserialization_time,json=deserializationTime,stdduration" json:"deserialization_time"`
...
func (*NetworkRxStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_component_stats_eeca6d80f872e429, []int{2}
}
...
func (*NetworkTxStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_component_stats_eeca6d80f872e429, []int{3}
}
...
type KVStats struct {
	...
	KVTime time.Duration `protobuf:"bytes,3,opt,name=kv_time,json=kvTime,stdduration" json:"kv_time"`
}
...
func (*KVStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_component_stats_eeca6d80f872e429, []int{4}
}
...
type ExecStats struct {
	...
	ExecTime time.Duration `protobuf:"bytes,1,opt,name=exec_time,json=execTime,stdduration" json:"exec_time"`
...
func (*ExecStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_component_stats_eeca6d80f872e429, []int{5}
}
...
func (*OutputStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_component_stats_eeca6d80f872e429, []int{6}
}
...
type FlowStats struct {
	MaxMemUsage IntValue `protobuf:"varint,1,opt,name=max_mem_usage,json=maxMemUsage,customtype=IntValue" json:"max_mem_usage"`
}
...
func (*FlowStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_component_stats_eeca6d80f872e429, []int{7}
}
...
func (m *ComponentStats) MarshalTo(dAtA []byte) (int, error) {
	...
	n6, err := m.FlowStats.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n6
...
func (m *NetworkRxStats) MarshalTo(dAtA []byte) (int, error) {
	...
	n8, err := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.Latency, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n8
	...
	i++
	i = encodeVarintComponentStats(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdDuration(m.WaitTime)))
	n9, err := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.WaitTime, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n9
	...
	n10, err := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.DeserializationTime, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n10
...
func (m *KVStats) MarshalTo(dAtA []byte) (int, error) {
	...
	n11, err := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.KVTime, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n11
...
func (m *ExecStats) MarshalTo(dAtA []byte) (int, error) {
	...
	n12, err := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.ExecTime, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n12
...
func (m *FlowStats) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x8
	i++
	i = encodeVarintComponentStats(dAtA, i, uint64(m.MaxMemUsage))
	return i, nil
}
...
func (m *FlowStats) Size() (n int) {
	...
	var l int
	_ = l
	n += 1 + sovComponentStats(uint64(m.MaxMemUsage))
	return n
}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxMemUsage |= (IntValue(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func init() {
	proto.RegisterFile("sql/execinfrapb/component_stats.proto", fileDescriptor_component_stats_eeca6d80f872e429)
}

var fileDescriptor_component_stats_eeca6d80f872e429 = []byte{
	// 770 bytes of a gzipped FileDescriptorProto
	,
}
