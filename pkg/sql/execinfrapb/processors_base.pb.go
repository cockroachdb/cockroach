...
func (*PostProcessSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_base_1dc90e5508aef604, []int{0}
}
...
func (*Columns) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_base_1dc90e5508aef604, []int{1}
}
...
func (*TableReaderSpan) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_base_1dc90e5508aef604, []int{2}
}
...
func init() {
	proto.RegisterFile("sql/execinfrapb/processors_base.proto", fileDescriptor_processors_base_1dc90e5508aef604)
}

var fileDescriptor_processors_base_1dc90e5508aef604 = []byte{
