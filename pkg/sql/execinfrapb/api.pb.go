...
func (BytesEncodeFormat) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_api_51f6a094dd718256, []int{0}
}
...
func (*FlowSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_51f6a094dd718256, []int{1}
}
...
type EvalContext struct {
	...
	VectorizeBatchSize  int32             `protobuf:"varint,14,opt,name=vectorize_batch_size,json=vectorizeBatchSize" json:"vectorize_batch_size"`
}
...
func (*EvalContext) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_51f6a094dd718256, []int{2}
}
...
func (*SequenceState) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_51f6a094dd718256, []int{3}
}
...
func (*SequenceState_Seq) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_51f6a094dd718256, []int{3, 0}
}
...
func (*SimpleResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_51f6a094dd718256, []int{4}
}
...
func (*ConsumerSignal) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_51f6a094dd718256, []int{5}
}
...
func (*DrainRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_51f6a094dd718256, []int{6}
}
...
func (*ConsumerHandshake) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_51f6a094dd718256, []int{7}
}
...
func (m *EvalContext) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x70
	i++
	i = encodeVarintApi(dAtA, i, uint64(m.VectorizeBatchSize))
	return i, nil
}
...
func (m *EvalContext) Size() (n int) {
	...
	n += 1 + l + sovApi(uint64(l))
	n += 1 + sovApi(uint64(m.VectorizeBatchSize))
	return n
}
...
func (m *EvalContext) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 14:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field VectorizeBatchSize", wireType)
			}
			m.VectorizeBatchSize = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowApi
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.VectorizeBatchSize |= (int32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func init() { proto.RegisterFile("sql/execinfrapb/api.proto", fileDescriptor_api_51f6a094dd718256) }

var fileDescriptor_api_51f6a094dd718256 = []byte{
	...
	,
}
