...
func (*SetupFlowRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_f646ddbfe3bfc7ef, []int{0}
}
...
func (*FlowSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_f646ddbfe3bfc7ef, []int{1}
}
...
func (*EvalContext) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_f646ddbfe3bfc7ef, []int{2}
}
...
func (*SimpleResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_f646ddbfe3bfc7ef, []int{3}
}
...
func (*ConsumerSignal) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_f646ddbfe3bfc7ef, []int{4}
}
...
func (*DrainRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_f646ddbfe3bfc7ef, []int{5}
}
...
func (*ConsumerHandshake) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_f646ddbfe3bfc7ef, []int{6}
}
...
func (*CancelDeadFlowsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_f646ddbfe3bfc7ef, []int{7}
}
...
func init() { proto.RegisterFile("sql/execinfrapb/api.proto", fileDescriptor_api_f646ddbfe3bfc7ef) }

var fileDescriptor_api_f646ddbfe3bfc7ef = []byte{
	...
	,
}
