...
func (*ProcessorSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_5d58c43e1fdd98e0, []int{0}
}
...
type ProcessorCoreUnion struct {
	...
	BackupData              *BackupDataSpec              `protobuf:"bytes,30,opt,name=backupData" json:"backupData,omitempty"`
}
...
func (*ProcessorCoreUnion) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_5d58c43e1fdd98e0, []int{1}
}
...
func (*NoopCoreSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_5d58c43e1fdd98e0, []int{2}
}
...
func (*LocalPlanNodeSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_5d58c43e1fdd98e0, []int{3}
}
...
func (*MetadataTestSenderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_5d58c43e1fdd98e0, []int{4}
}
...
func (*MetadataTestReceiverSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_5d58c43e1fdd98e0, []int{5}
}
...
func init() {
	proto.RegisterFile("sql/execinfrapb/processors.proto", fileDescriptor_processors_5d58c43e1fdd98e0)
}

var fileDescriptor_processors_5d58c43e1fdd98e0 = []byte{
	// 1117 bytes of a gzipped FileDescriptorProto
	,
}
