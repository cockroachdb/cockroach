...
func (*ProcessorSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_9cf8f5ebe80972a4, []int{0}
}
...
type ProcessorCoreUnion struct {
	...
	Logger                  *IntermediateResultsLoggerSpec `protobuf:"bytes,29,opt,name=logger" json:"logger,omitempty"`
}
...
func (*ProcessorCoreUnion) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_9cf8f5ebe80972a4, []int{1}
}
...
func (*NoopCoreSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_9cf8f5ebe80972a4, []int{2}
}
...
func (*LocalPlanNodeSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_9cf8f5ebe80972a4, []int{3}
}
...
func (*MetadataTestSenderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_9cf8f5ebe80972a4, []int{4}
}
...
func (*MetadataTestReceiverSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_9cf8f5ebe80972a4, []int{5}
}
...
// IntermediateResultsLoggerSpec indicates a logger core that can be used while
// debugging to log the intermediate results of a processor.
type IntermediateResultsLoggerSpec struct {
	ComponentID string `protobuf:"bytes,1,opt,name=component_id,json=componentId" json:"component_id"`
}

func (m *IntermediateResultsLoggerSpec) Reset()         { *m = IntermediateResultsLoggerSpec{} }
func (m *IntermediateResultsLoggerSpec) String() string { return proto.CompactTextString(m) }
func (*IntermediateResultsLoggerSpec) ProtoMessage()    {}
func (*IntermediateResultsLoggerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_9cf8f5ebe80972a4, []int{6}
}
func (m *IntermediateResultsLoggerSpec) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *IntermediateResultsLoggerSpec) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalTo(b)
	if err != nil {
		return nil, err
...
func (dst *IntermediateResultsLoggerSpec) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IntermediateResultsLoggerSpec.Merge(dst, src)
}
func (m *IntermediateResultsLoggerSpec) XXX_Size() int {
	return m.Size()
}
func (m *IntermediateResultsLoggerSpec) XXX_DiscardUnknown() {
	xxx_messageInfo_IntermediateResultsLoggerSpec.DiscardUnknown(m)
}

var xxx_messageInfo_IntermediateResultsLoggerSpec proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*IntermediateResultsLoggerSpec)(nil), "cockroach.sql.distsqlrun.IntermediateResultsLoggerSpec")
}
...
func (m *ProcessorCoreUnion) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Logger != nil {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintProcessors(dAtA, i, uint64(m.Logger.Size()))
		n28, err := m.Logger.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n28
...
func (m *IntermediateResultsLoggerSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *IntermediateResultsLoggerSpec) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	dAtA[i] = 0xa
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(len(m.ComponentID)))
...
func (m *IntermediateResultsLoggerSpec) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *ProcessorCoreUnion) SetValue(value interface{}) bool {
	...
	case *IntermediateResultsLoggerSpec:
		this.Logger = vt
	default:
		return false
	}
...
func (m *ProcessorCoreUnion) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 29:
			...
			if m.Logger == nil {
				m.Logger = &IntermediateResultsLoggerSpec{}
			}
			if err := m.Logger.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *IntermediateResultsLoggerSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: IntermediateResultsLoggerSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: IntermediateResultsLoggerSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func init() {
	proto.RegisterFile("sql/execinfrapb/processors.proto", fileDescriptor_processors_9cf8f5ebe80972a4)
}

var fileDescriptor_processors_9cf8f5ebe80972a4 = []byte{
	...
	,
}
