...
func (*ProcessorSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_3357679d9ae8557d, []int{0}
}
...
type ProcessorCoreUnion struct {
	...
	BackupData              *BackupDataSpec              `protobuf:"bytes,29,opt,name=backupData" json:"backupData,omitempty"`
}
...
func (*ProcessorCoreUnion) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_3357679d9ae8557d, []int{1}
}
...
func (*NoopCoreSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_3357679d9ae8557d, []int{2}
}
...
func (*LocalPlanNodeSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_3357679d9ae8557d, []int{3}
}
...
func (*MetadataTestSenderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_3357679d9ae8557d, []int{4}
}
...
func (*MetadataTestReceiverSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_3357679d9ae8557d, []int{5}
}
...
func (m *ProcessorCoreUnion) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.BackupData != nil {
		...
		n28, err := m.BackupData.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n28
...
func init() {
	proto.RegisterFile("sql/execinfrapb/processors.proto", fileDescriptor_processors_3357679d9ae8557d)
}

var fileDescriptor_processors_3357679d9ae8557d = []byte{
	...
	,
}
