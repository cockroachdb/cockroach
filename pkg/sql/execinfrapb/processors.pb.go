...
func (*ProcessorSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_d5e8679458716032, []int{0}
}
...
func (*ProcessorCoreUnion) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_d5e8679458716032, []int{1}
}
...
func (*NoopCoreSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_d5e8679458716032, []int{2}
}
...
func (*LocalPlanNodeSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_d5e8679458716032, []int{3}
}
...
func (*MetadataTestSenderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_d5e8679458716032, []int{4}
}
...
func (*MetadataTestReceiverSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_d5e8679458716032, []int{5}
}
...
func init() {
	proto.RegisterFile("sql/execinfrapb/processors.proto", fileDescriptor_processors_d5e8679458716032)
}

var fileDescriptor_processors_d5e8679458716032 = []byte{
	// 1088 bytes of a gzipped FileDescriptorProto
	,
}
