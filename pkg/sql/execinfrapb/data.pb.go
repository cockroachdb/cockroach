...
type RemoteProducerMetadata struct {
	...
	//	*RemoteProducerMetadata_ContentionEvents_
...
type RemoteProducerMetadata_ContentionEvents_ struct {
	ContentionEvents *RemoteProducerMetadata_ContentionEvents `protobuf:"bytes,10,opt,name=contention_events,json=contentionEvents,oneof"`
}
...
func (*RemoteProducerMetadata_ContentionEvents_) isRemoteProducerMetadata_Value()      {}
...
func (m *RemoteProducerMetadata) GetContentionEvents() *RemoteProducerMetadata_ContentionEvents {
	if x, ok := m.GetValue().(*RemoteProducerMetadata_ContentionEvents_); ok {
		return x.ContentionEvents
	}
	return nil
}
...
func (*RemoteProducerMetadata) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _RemoteProducerMetadata_OneofMarshaler, _RemoteProducerMetadata_OneofUnmarshaler, _RemoteProducerMetadata_OneofSizer, []interface{}{
		...
		(*RemoteProducerMetadata_ContentionEvents_)(nil),
	}
}
...
func _RemoteProducerMetadata_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *RemoteProducerMetadata_ContentionEvents_:
		...
		if err := b.EncodeMessage(x.ContentionEvents); err != nil {
			return err
		}
	case nil:
	default:
...
func _RemoteProducerMetadata_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 9: // value.bulk_processor_progress
		...
		return true, err
	case 10: // value.contention_events
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(RemoteProducerMetadata_ContentionEvents)
		err := b.DecodeMessage(msg)
		m.Value = &RemoteProducerMetadata_ContentionEvents_{msg}
		return true, err
	default:
		return false, nil
	}
...
func _RemoteProducerMetadata_OneofSizer(msg proto.Message) (n int) {
	...
	case *RemoteProducerMetadata_BulkProcessorProgress_:
		...
		n += s
	case *RemoteProducerMetadata_ContentionEvents_:
		s := proto.Size(x.ContentionEvents)
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case nil:
...
// ContentionEvents are any contention events that occurred during query
// execution.
type RemoteProducerMetadata_ContentionEvents struct {
	ContentionEvents []roachpb.ContentionEvent `protobuf:"bytes,1,rep,name=contention_events,json=contentionEvents" json:"contention_events"`
}

func (m *RemoteProducerMetadata_ContentionEvents) Reset() {
	*m = RemoteProducerMetadata_ContentionEvents{}
}
...
func (m *RemoteProducerMetadata_ContentionEvents) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalTo(b)
	if err != nil {
		return nil, err
...
func (dst *RemoteProducerMetadata_ContentionEvents) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RemoteProducerMetadata_ContentionEvents.Merge(dst, src)
}
func (m *RemoteProducerMetadata_ContentionEvents) XXX_Size() int {
	return m.Size()
}
func (m *RemoteProducerMetadata_ContentionEvents) XXX_DiscardUnknown() {
	xxx_messageInfo_RemoteProducerMetadata_ContentionEvents.DiscardUnknown(m)
}

var xxx_messageInfo_RemoteProducerMetadata_ContentionEvents proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*RemoteProducerMetadata_ContentionEvents)(nil), "cockroach.sql.distsqlrun.RemoteProducerMetadata.ContentionEvents")
...
func (m *RemoteProducerMetadata_ContentionEvents_) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.ContentionEvents != nil {
		dAtA[i] = 0x52
		i++
		i = encodeVarintData(dAtA, i, uint64(m.ContentionEvents.Size()))
		n17, err := m.ContentionEvents.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n17
...
func (m *RemoteProducerMetadata_ContentionEvents) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *RemoteProducerMetadata_ContentionEvents) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.ContentionEvents) > 0 {
		for _, msg := range m.ContentionEvents {
			dAtA[i] = 0xa
			i++
			i = encodeVarintData(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *RemoteProducerMetadata_ContentionEvents_) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RemoteProducerMetadata_ContentionEvents) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RemoteProducerMetadata) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			...
			v := &RemoteProducerMetadata_ContentionEvents{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Value = &RemoteProducerMetadata_ContentionEvents_{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipData(dAtA[iNdEx:])
...
func (m *RemoteProducerMetadata_ContentionEvents) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ContentionEvents: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ContentionEvents: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptor_data_6e2d4ee9b531ae93 = []byte{
	...
	,
}
