...
func (Ordering_Column_Direction) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_data_94734ced1fdcf666, []int{2, 0, 0}
}
...
func (StreamEndpointSpec_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_data_94734ced1fdcf666, []int{3, 0}
}
...
func (InputSyncSpec_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_data_94734ced1fdcf666, []int{4, 0}
}
...
func (OutputRouterSpec_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_data_94734ced1fdcf666, []int{5, 0}
}
...
func (*Error) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_94734ced1fdcf666, []int{0}
}
...
func (*Expression) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_94734ced1fdcf666, []int{1}
}
...
func (*Ordering) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_94734ced1fdcf666, []int{2}
}
...
func (*Ordering_Column) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_94734ced1fdcf666, []int{2, 0}
}
...
func (*StreamEndpointSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_94734ced1fdcf666, []int{3}
}
...
func (*InputSyncSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_94734ced1fdcf666, []int{4}
}
...
func (*OutputRouterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_94734ced1fdcf666, []int{5}
}
...
func (*OutputRouterSpec_RangeRouterSpec_ColumnEncoding) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_94734ced1fdcf666, []int{5, 0, 0}
}
...
func (*OutputRouterSpec_RangeRouterSpec_Span) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_94734ced1fdcf666, []int{5, 0, 1}
}
...
func (*DatumInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_94734ced1fdcf666, []int{6}
}
...
func (*ProducerHeader) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_94734ced1fdcf666, []int{7}
}
...
func (*ProducerData) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_94734ced1fdcf666, []int{8}
}
...
// LatencyResponse is the msg an outbox sends an inbox when a LatencyRequest
// is received. This response helps measure the latency time between the
// inbox and outbox.
type LatencyResponse struct {
}

func (m *LatencyResponse) Reset()         { *m = LatencyResponse{} }
func (m *LatencyResponse) String() string { return proto.CompactTextString(m) }
func (*LatencyResponse) ProtoMessage()    {}
func (*LatencyResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_94734ced1fdcf666, []int{9}
}
func (m *LatencyResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *LatencyResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalTo(b)
	if err != nil {
		return nil, err
...
func (dst *LatencyResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LatencyResponse.Merge(dst, src)
}
func (m *LatencyResponse) XXX_Size() int {
	return m.Size()
}
func (m *LatencyResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_LatencyResponse.DiscardUnknown(m)
}

var xxx_messageInfo_LatencyResponse proto.InternalMessageInfo
...
type ProducerMessage struct {
	...
	LatencyResponse *LatencyResponse `protobuf:"bytes,4,opt,name=latency_response,json=latencyResponse" json:"latency_response,omitempty"`
}
...
func (*ProducerMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_94734ced1fdcf666, []int{10}
}
...
func (*RemoteProducerMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_94734ced1fdcf666, []int{11}
}
...
func (*RemoteProducerMetadata_RangeInfos) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_94734ced1fdcf666, []int{11, 0}
}
...
func (*RemoteProducerMetadata_TraceData) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_94734ced1fdcf666, []int{11, 1}
}
...
func (*RemoteProducerMetadata_RowNum) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_94734ced1fdcf666, []int{11, 2}
}
...
func (*RemoteProducerMetadata_SamplerProgress) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_94734ced1fdcf666, []int{11, 3}
}
...
func (*RemoteProducerMetadata_BulkProcessorProgress) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_94734ced1fdcf666, []int{11, 4}
}
...
func (*RemoteProducerMetadata_Metrics) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_94734ced1fdcf666, []int{11, 5}
}
...
func (*DistSQLVersionGossipInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_94734ced1fdcf666, []int{12}
}
...
func (*DistSQLDrainingInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_94734ced1fdcf666, []int{13}
}
...
func init() {
	...
	proto.RegisterType((*LatencyResponse)(nil), "cockroach.sql.distsqlrun.LatencyResponse")
...
func (m *LatencyResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *LatencyResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ProducerMessage) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.LatencyResponse != nil {
		dAtA[i] = 0x22
		i++
		i = encodeVarintData(dAtA, i, uint64(m.LatencyResponse.Size()))
		n8, err := m.LatencyResponse.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n8
...
func (m *LatencyResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *LatencyResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LatencyResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LatencyResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *ProducerMessage) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LatencyResponse", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.LatencyResponse == nil {
				m.LatencyResponse = &LatencyResponse{}
			}
			if err := m.LatencyResponse.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func init() { proto.RegisterFile("sql/execinfrapb/data.proto", fileDescriptor_data_94734ced1fdcf666) }

var fileDescriptor_data_94734ced1fdcf666 = []byte{
	...
	,
}
