...
func init() {
	...
	// changes in the future, upperBufferSize or ToUpper will need to be
	// adjusted.
...
// ToUpper returns a string where every lowercase ASCII character in "s"
// has been converted to an uppercase character.
