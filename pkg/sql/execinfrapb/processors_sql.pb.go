...
func (ScanVisibility) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_2a83e5d4be424620, []int{0}
}
...
func (AggregatorSpec_Func) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_2a83e5d4be424620, []int{13, 0}
}
...
func (AggregatorSpec_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_2a83e5d4be424620, []int{13, 1}
}
...
func (WindowerSpec_WindowFunc) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_2a83e5d4be424620, []int{15, 0}
}
...
func (WindowerSpec_Frame_Mode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_2a83e5d4be424620, []int{15, 1, 0}
}
...
func (WindowerSpec_Frame_BoundType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_2a83e5d4be424620, []int{15, 1, 1}
}
...
func (WindowerSpec_Frame_Exclusion) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_2a83e5d4be424620, []int{15, 1, 2}
}
...
type TableReaderSpec struct {
	...
	// Indicates virtual columns which may have a different type than the columns
	...
	// table.
	VirtualColumns []*descpb.ColumnDescriptor `protobuf:"bytes,16,rep,name=virtual_columns,json=virtualColumns" json:"virtual_columns,omitempty"`
}
...
func (*TableReaderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_2a83e5d4be424620, []int{1}
}
...
func (*FiltererSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_2a83e5d4be424620, []int{2}
}
...
func (*IndexSkipTableReaderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_2a83e5d4be424620, []int{3}
}
...
func (*JoinReaderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_2a83e5d4be424620, []int{4}
}
...
func (*SorterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_2a83e5d4be424620, []int{5}
}
...
func (*DistinctSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_2a83e5d4be424620, []int{6}
}
...
func (*OrdinalitySpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_2a83e5d4be424620, []int{7}
}
...
func (*ZigzagJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_2a83e5d4be424620, []int{8}
}
...
func (*MergeJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_2a83e5d4be424620, []int{9}
}
...
func (*HashJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_2a83e5d4be424620, []int{10}
}
...
func (*InvertedJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_2a83e5d4be424620, []int{11}
}
...
func (*InvertedFiltererSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_2a83e5d4be424620, []int{12}
}
...
func (*InvertedFiltererSpec_PreFiltererSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_2a83e5d4be424620, []int{12, 0}
}
...
func (*AggregatorSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_2a83e5d4be424620, []int{13}
}
...
func (*ProjectSetSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_2a83e5d4be424620, []int{14}
}
...
func (*WindowerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_2a83e5d4be424620, []int{15}
}
...
func (*WindowerSpec_Frame) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_2a83e5d4be424620, []int{15, 1}
}
...
func (*WindowerSpec_WindowFn) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_2a83e5d4be424620, []int{15, 2}
}
...
func (m *TableReaderSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.VirtualColumns) > 0 {
		for _, msg := range m.VirtualColumns {
			dAtA[i] = 0x82
			i++
			dAtA[i] = 0x1
			i++
...
func (m *ZigzagJoinerSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.IndexOrdinals) > 0 {
		dAtA11 := make([]byte, len(m.IndexOrdinals)*10)
		var j10 int
		...
		dAtA[i] = 0x1a
		i++
		i = encodeVarintProcessorsSql(dAtA, i, uint64(j10))
...
func (m *MergeJoinerSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	n13, err := m.LeftOrdering.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n13
	...
	n14, err := m.RightOrdering.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n14
	...
	i++
	i = encodeVarintProcessorsSql(dAtA, i, uint64(m.OnExpr.Size()))
	n15, err := m.OnExpr.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n15
...
func (m *InvertedFiltererSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PreFiltererSpec != nil {
		...
		n25, err := m.PreFiltererSpec.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n25
...
func (m *InvertedFiltererSpec_PreFiltererSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Type != nil {
		...
		n27, err := m.Type.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n27
...
func (m *AggregatorSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.OrderedGroupCols) > 0 {
		dAtA31 := make([]byte, len(m.OrderedGroupCols)*10)
		var j30 int
		...
		dAtA[i] = 0x22
		i++
		i = encodeVarintProcessorsSql(dAtA, i, uint64(j30))
...
func (m *WindowerSpec_Frame) MarshalTo(dAtA []byte) (int, error) {
	...
	n32, err := m.Bounds.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n32
...
func (m *WindowerSpec_Frame_Bound) MarshalTo(dAtA []byte) (int, error) {
	...
	n33, err := m.OffsetType.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n33
...
func (m *WindowerSpec_Frame_Bounds) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.End != nil {
		...
		n35, err := m.End.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n35
...
func (m *WindowerSpec_WindowFn) MarshalTo(dAtA []byte) (int, error) {
	...
	n36, err := m.Func.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n36
	...
	if m.Frame != nil {
		...
		n38, err := m.Frame.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n38
...
func (m *TableReaderSpec) Size() (n int) {
	...
	if len(m.VirtualColumns) > 0 {
		for _, e := range m.VirtualColumns {
			l = e.Size()
...
func (m *TableReaderSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 16:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field VirtualColumns", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.VirtualColumns = append(m.VirtualColumns, &descpb.ColumnDescriptor{})
			if err := m.VirtualColumns[len(m.VirtualColumns)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func init() {
	proto.RegisterFile("sql/execinfrapb/processors_sql.proto", fileDescriptor_processors_sql_2a83e5d4be424620)
}

var fileDescriptor_processors_sql_2a83e5d4be424620 = []byte{
	...
	,
}
