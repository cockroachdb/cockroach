...
func (ScanVisibility) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_6555d57cd1d5b623, []int{0}
}
...
func (AggregatorSpec_Func) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_6555d57cd1d5b623, []int{10, 0}
}
...
func (AggregatorSpec_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_6555d57cd1d5b623, []int{10, 1}
}
...
func (WindowerSpec_WindowFunc) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_6555d57cd1d5b623, []int{13, 0}
}
...
func (WindowerSpec_Frame_Mode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_6555d57cd1d5b623, []int{13, 1, 0}
}
...
func (WindowerSpec_Frame_BoundType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_6555d57cd1d5b623, []int{13, 1, 1}
}
...
func (WindowerSpec_Frame_Exclusion) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_6555d57cd1d5b623, []int{13, 1, 2}
}
...
type TableReaderSpec struct {
	...
	// This is the batch size that will be used for all KV batches (excluding the
	// first if limit hint is set).
	//
	// Not used if there is a limit set in the PostProcessSpec of this processor
	// (that value will be used for sizing batches instead).
...
func (*TableReaderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_6555d57cd1d5b623, []int{1}
}
...
func (*IndexSkipTableReaderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_6555d57cd1d5b623, []int{2}
}
...
func (*JoinReaderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_6555d57cd1d5b623, []int{3}
}
...
func (*SorterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_6555d57cd1d5b623, []int{4}
}
...
func (*DistinctSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_6555d57cd1d5b623, []int{5}
}
...
func (*OrdinalitySpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_6555d57cd1d5b623, []int{6}
}
...
func (*ZigzagJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_6555d57cd1d5b623, []int{7}
}
...
func (*MergeJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_6555d57cd1d5b623, []int{8}
}
...
func (*HashJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_6555d57cd1d5b623, []int{9}
}
...
func (*AggregatorSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_6555d57cd1d5b623, []int{10}
}
...
func (*InterleavedReaderJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_6555d57cd1d5b623, []int{11}
}
...
func (*InterleavedReaderJoinerSpec_Table) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_6555d57cd1d5b623, []int{11, 0}
}
...
func (*ProjectSetSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_6555d57cd1d5b623, []int{12}
}
...
func (*WindowerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_6555d57cd1d5b623, []int{13}
}
...
func (*WindowerSpec_Frame) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_6555d57cd1d5b623, []int{13, 1}
}
...
func (*WindowerSpec_WindowFn) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_6555d57cd1d5b623, []int{13, 2}
}
...
func init() {
	proto.RegisterFile("sql/execinfrapb/processors_sql.proto", fileDescriptor_processors_sql_6555d57cd1d5b623)
}

var fileDescriptor_processors_sql_6555d57cd1d5b623 = []byte{
