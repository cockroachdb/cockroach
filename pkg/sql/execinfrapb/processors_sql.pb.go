...
func (ScanVisibility) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_9dee4514ef97188c, []int{0}
}
...
func (AggregatorSpec_Func) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_9dee4514ef97188c, []int{11, 0}
}
...
func (AggregatorSpec_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_9dee4514ef97188c, []int{11, 1}
}
...
func (WindowerSpec_WindowFunc) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_9dee4514ef97188c, []int{14, 0}
}
...
func (WindowerSpec_Frame_Mode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_9dee4514ef97188c, []int{14, 1, 0}
}
...
func (WindowerSpec_Frame_BoundType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_9dee4514ef97188c, []int{14, 1, 1}
}
...
func (WindowerSpec_Frame_Exclusion) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_9dee4514ef97188c, []int{14, 1, 2}
}
...
func (*TableReaderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_9dee4514ef97188c, []int{1}
}
...
func (*IndexSkipTableReaderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_9dee4514ef97188c, []int{2}
}
...
func (*JoinReaderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_9dee4514ef97188c, []int{3}
}
...
func (*SorterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_9dee4514ef97188c, []int{4}
}
...
func (*DistinctSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_9dee4514ef97188c, []int{5}
}
...
func (*OrdinalitySpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_9dee4514ef97188c, []int{6}
}
...
func (*ZigzagJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_9dee4514ef97188c, []int{7}
}
...
func (*MergeJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_9dee4514ef97188c, []int{8}
}
...
func (*HashJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_9dee4514ef97188c, []int{9}
}
...
// InvertedJoinerSpec is the specification for a join between two columns
// where one has an inverted index.
type InvertedJoinerSpec struct {
	Table sqlbase.TableDescriptor `protobuf:"bytes,1,opt,name=table" json:"table"`
	// The inverted index. The first column is the inverted column, and the
	// the remaining columns are the primary key.
	IndexIdx uint32 `protobuf:"varint,2,opt,name=index_idx,json=indexIdx" json:"index_idx"`
	...
	// RowToInvertedIndexExpr. The expression is something that can be exactly
	// evaluated by the index -- for Geospatial, where the index can produce
	// false positives for the expression specified in the original query, this
	// expression must use the index-specific functions (after the mapping from
	// the user-specified functions), and not the user expression.
	...
	// inverted column) and the columns in the input stream (other than the
	// lookup column). Assuming that the input stream has N columns and the
	// table that has been indexed has M columns, in this expression variables
	// @1 to @N refer to columns of the input stream and variables @(N+1) to
	// @(N+M) refer to columns in the table. The numbering does not omit the
	// column in the table corresponding to the inverted column, or other table
	// columns absent from the index, but they cannot be present in this
	// expression. Similarly, the numbering does not omit the lookup column in
	// the input stream, though it cannot be present in this expression.
	OnExpr Expression `protobuf:"bytes,5,opt,name=on_expr,json=onExpr" json:"on_expr"`
...
func (*InvertedJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_9dee4514ef97188c, []int{10}
}
...
func (*AggregatorSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_9dee4514ef97188c, []int{11}
}
...
func (*InterleavedReaderJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_9dee4514ef97188c, []int{12}
}
...
func (*InterleavedReaderJoinerSpec_Table) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_9dee4514ef97188c, []int{12, 0}
}
...
func (*ProjectSetSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_9dee4514ef97188c, []int{13}
}
...
func (*WindowerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_9dee4514ef97188c, []int{14}
}
...
func (*WindowerSpec_Frame) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_9dee4514ef97188c, []int{14, 1}
}
...
func (*WindowerSpec_WindowFn) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_9dee4514ef97188c, []int{14, 2}
}
...
func (m *AggregatorSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.GroupCols) > 0 {
		dAtA23 := make([]byte, len(m.GroupCols)*10)
		var j22 int
	...
	if len(m.OrderedGroupCols) > 0 {
		dAtA25 := make([]byte, len(m.OrderedGroupCols)*10)
		var j24 int
...
func (m *InterleavedReaderJoinerSpec_Table) MarshalTo(dAtA []byte) (int, error) {
	...
	n27, err := m.Desc.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n27
	...
	n29, err := m.Ordering.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n29
...
func init() {
	proto.RegisterFile("sql/execinfrapb/processors_sql.proto", fileDescriptor_processors_sql_9dee4514ef97188c)
}

var fileDescriptor_processors_sql_9dee4514ef97188c = []byte{
	...
	,
}
