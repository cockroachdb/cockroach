...
func (ScanVisibility) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_94dd7e42a457c38c, []int{0}
}
...
func (AggregatorSpec_Func) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_94dd7e42a457c38c, []int{12, 0}
}
...
func (AggregatorSpec_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_94dd7e42a457c38c, []int{12, 1}
}
...
func (WindowerSpec_WindowFunc) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_94dd7e42a457c38c, []int{15, 0}
}
...
func (WindowerSpec_Frame_Mode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_94dd7e42a457c38c, []int{15, 1, 0}
}
...
func (WindowerSpec_Frame_BoundType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_94dd7e42a457c38c, []int{15, 1, 1}
}
...
func (WindowerSpec_Frame_Exclusion) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_94dd7e42a457c38c, []int{15, 1, 2}
}
...
type TableReaderSpec struct {
	...
	TableIsUncommittedVersion bool                   `protobuf:"varint,14,opt,name=table_is_uncommitted_version,json=tableIsUncommittedVersion" json:"table_is_uncommitted_version"`
	...
	// output by the TableReader, in the order specified.
	SystemColumns []descpb.SystemColumnKind `protobuf:"varint,13,rep,name=system_columns,json=systemColumns,enum=cockroach.sql.sqlbase.SystemColumnKind" json:"system_columns,omitempty"`
}
...
func (*TableReaderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_94dd7e42a457c38c, []int{1}
}
...
type IndexSkipTableReaderSpec struct {
	Table                     descpb.TableDescriptor `protobuf:"bytes,1,opt,name=table" json:"table"`
	TableIsUncommittedVersion bool                   `protobuf:"varint,8,opt,name=table_is_uncommitted_version,json=tableIsUncommittedVersion" json:"table_is_uncommitted_version"`
	// If 0, we use the primary index. If non-zero, we use the index_idx-th index,
	// i.e. table.indexes[index_idx-1]
	IndexIdx uint32            `protobuf:"varint,2,opt,name=index_idx,json=indexIdx" json:"index_idx"`
...
func (*IndexSkipTableReaderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_94dd7e42a457c38c, []int{2}
}
...
type JoinReaderSpec struct {
	Table                     descpb.TableDescriptor `protobuf:"bytes,1,opt,name=table" json:"table"`
	TableIsUncommittedVersion bool                   `protobuf:"varint,13,opt,name=table_is_uncommitted_version,json=tableIsUncommittedVersion" json:"table_is_uncommitted_version"`
...
func (*JoinReaderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_94dd7e42a457c38c, []int{3}
}
...
func (*SorterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_94dd7e42a457c38c, []int{4}
}
...
func (*DistinctSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_94dd7e42a457c38c, []int{5}
}
...
func (*OrdinalitySpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_94dd7e42a457c38c, []int{6}
}
...
type ZigzagJoinerSpec struct {
	...
	TableIsUncommittedVersion []bool                   `protobuf:"varint,7,rep,name=table_is_uncommitted_version,json=tableIsUncommittedVersion" json:"table_is_uncommitted_version,omitempty"`
...
func (*ZigzagJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_94dd7e42a457c38c, []int{7}
}
...
func (*MergeJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_94dd7e42a457c38c, []int{8}
}
...
func (*HashJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_94dd7e42a457c38c, []int{9}
}
...
func (*InvertedJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_94dd7e42a457c38c, []int{10}
}
...
func (*InvertedFiltererSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_94dd7e42a457c38c, []int{11}
}
...
func (*AggregatorSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_94dd7e42a457c38c, []int{12}
}
...
func (*InterleavedReaderJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_94dd7e42a457c38c, []int{13}
}
...
type InterleavedReaderJoinerSpec_Table struct {
	...
	TableIsUncommittedVersion bool                   `protobuf:"varint,6,opt,name=table_is_uncommitted_version,json=tableIsUncommittedVersion" json:"table_is_uncommitted_version"`
	// If 0, we use the primary index. If non-zero, we use the index_idx-th index,
...
func (*InterleavedReaderJoinerSpec_Table) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_94dd7e42a457c38c, []int{13, 0}
}
...
func (*ProjectSetSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_94dd7e42a457c38c, []int{14}
}
...
func (*WindowerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_94dd7e42a457c38c, []int{15}
}
...
func (*WindowerSpec_Frame) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_94dd7e42a457c38c, []int{15, 1}
}
...
func (*WindowerSpec_WindowFn) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_94dd7e42a457c38c, []int{15, 2}
}
...
func (m *TableReaderSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	if len(m.SystemColumns) > 0 {
		for _, num := range m.SystemColumns {
			dAtA[i] = 0x68
			i++
	...
	dAtA[i] = 0x70
	i++
	if m.TableIsUncommittedVersion {
		dAtA[i] = 1
	} else {
		dAtA[i] = 0
	}
...
func (m *ZigzagJoinerSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintProcessorsSql(dAtA, i, uint64(m.Type))
	if len(m.TableIsUncommittedVersion) > 0 {
		for _, b := range m.TableIsUncommittedVersion {
			dAtA[i] = 0x38
			i++
			if b {
				dAtA[i] = 1
...
func (m *ZigzagJoinerSpec) Size() (n int) {
	...
	n += 1 + sovProcessorsSql(uint64(m.Type))
	if len(m.TableIsUncommittedVersion) > 0 {
		n += 2 * len(m.TableIsUncommittedVersion)
	}
	return n
}
		...
		case 13:
			if wireType == 0 {
				...
				for shift := uint(0); ; shift += 7 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					v |= (descpb.SystemColumnKind(b) & 0x7F) << shift
					if b < 0x80 {
						break
					}
				}
				m.SystemColumns = append(m.SystemColumns, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				if elementCount != 0 && len(m.SystemColumns) == 0 {
					m.SystemColumns = make([]descpb.SystemColumnKind, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v descpb.SystemColumnKind
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field SystemColumns", wireType)
			}
		case 14:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TableIsUncommittedVersion", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TableIsUncommittedVersion = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipProcessorsSql(dAtA[iNdEx:])
			if err != nil {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType == 0 {
				...
				m.TableIsUncommittedVersion = append(m.TableIsUncommittedVersion, bool(v != 0))
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				if elementCount != 0 && len(m.TableIsUncommittedVersion) == 0 {
					m.TableIsUncommittedVersion = make([]bool, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v int
					for shift := uint(0); ; shift += 7 {
...
func init() {
	proto.RegisterFile("sql/execinfrapb/processors_sql.proto", fileDescriptor_processors_sql_94dd7e42a457c38c)
}

var fileDescriptor_processors_sql_94dd7e42a457c38c = []byte{
	...
	,
}
