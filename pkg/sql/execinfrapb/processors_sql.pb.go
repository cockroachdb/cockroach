...
func (ScanVisibility) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a5b1a84518ab2dfc, []int{0}
}
...
func (AggregatorSpec_Func) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a5b1a84518ab2dfc, []int{10, 0}
}
...
func (AggregatorSpec_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a5b1a84518ab2dfc, []int{10, 1}
}
...
func (WindowerSpec_WindowFunc) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a5b1a84518ab2dfc, []int{13, 0}
}
...
func (WindowerSpec_Frame_Mode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a5b1a84518ab2dfc, []int{13, 1, 0}
}
...
func (WindowerSpec_Frame_BoundType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a5b1a84518ab2dfc, []int{13, 1, 1}
}
...
func (WindowerSpec_Frame_Exclusion) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a5b1a84518ab2dfc, []int{13, 1, 2}
}
...
func (*TableReaderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a5b1a84518ab2dfc, []int{1}
}
...
func (*IndexSkipTableReaderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a5b1a84518ab2dfc, []int{2}
}
...
func (*JoinReaderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a5b1a84518ab2dfc, []int{3}
}
...
func (*SorterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a5b1a84518ab2dfc, []int{4}
}
...
func (*DistinctSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a5b1a84518ab2dfc, []int{5}
}
...
func (*OrdinalitySpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a5b1a84518ab2dfc, []int{6}
}
...
func (*ZigzagJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a5b1a84518ab2dfc, []int{7}
}
...
func (*MergeJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a5b1a84518ab2dfc, []int{8}
}
...
type HashJoinerSpec struct {
	...
	// columns occupy first positions in a row and it's the left value if it's not
...
func (*HashJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a5b1a84518ab2dfc, []int{9}
}
...
func (*AggregatorSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a5b1a84518ab2dfc, []int{10}
}
...
func (*InterleavedReaderJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a5b1a84518ab2dfc, []int{11}
}
...
func (*InterleavedReaderJoinerSpec_Table) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a5b1a84518ab2dfc, []int{11, 0}
}
...
func (*ProjectSetSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a5b1a84518ab2dfc, []int{12}
}
...
func (*WindowerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a5b1a84518ab2dfc, []int{13}
}
...
func (*WindowerSpec_Frame) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a5b1a84518ab2dfc, []int{13, 1}
}
...
func (*WindowerSpec_WindowFn) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a5b1a84518ab2dfc, []int{13, 2}
}
...
// MergeHashJoinerSpec is the specification for a merge hash join processor.
// The processor has two inputs and one output. The inputs must have the same
// ordering on the subset of columns that have equality constraints. For
// example:
//   SELECT * FROM T1 INNER JOIN T2 ON T1.C1 = T2.C5 AND T1.C2 = T2.C4
//
// To perform a merge hash join, the streams corresponding to T1 and T2 must
// have the same ordering on columns (C1 and C5) or (C2 and C4) respectively.
// For example: (C1+ and C5+) or (C2- and C4-).
//
// The processor works by first applying a merge logic to find the groups of
// rows from both inputs that are equal on the "ordering" equality columns, and
// then performing a hash join only within those groups based on the
// "non-ordering" equality columns.
//
// The "internal columns" of a MergeHashJoiner (see ProcessorSpec) are the
// concatenation of left input columns and right input columns. If the left
// input has N columns and the right input has M columns, the first N columns
// contain values from the left side and the following M columns contain values
// from the right side.
...
// In the case of semi-join and anti-join, the processor core outputs only the
// left columns.
type MergeHashJoinerSpec struct {
	// The streams must be ordered according to the columns that have equality
	// constraints. The first column of the left ordering is constrained to be
	// equal to the first column in the right ordering and so on. The ordering
	// lengths and directions must match.
	// In the example above, left ordering describes C1+ or C2- and right
	// ordering describes C5+ or C4-.
	LeftOrdering  Ordering `protobuf:"bytes,1,opt,name=left_ordering,json=leftOrdering" json:"left_ordering"`
	RightOrdering Ordering `protobuf:"bytes,2,opt,name=right_ordering,json=rightOrdering" json:"right_ordering"`
	// The join constraints certain columns from the left stream to equal
	// corresponding columns on the right stream. These must have the same
	// length.
	LeftEqColumns  []uint32 `protobuf:"varint,3,rep,packed,name=left_eq_columns,json=leftEqColumns" json:"left_eq_columns,omitempty"`
	RightEqColumns []uint32 `protobuf:"varint,4,rep,packed,name=right_eq_columns,json=rightEqColumns" json:"right_eq_columns,omitempty"`
	// "ON" expression (in addition to the equality constraints captured by the
	// orderings). Assuming that the left stream has N columns and the right
	// stream has M columns, in this expression variables @1 to @N refer to
	// columns of the left stream and variables @N to @(N+M) refer to columns in
...
func (m *MergeHashJoinerSpec) Reset()         { *m = MergeHashJoinerSpec{} }
func (m *MergeHashJoinerSpec) String() string { return proto.CompactTextString(m) }
func (*MergeHashJoinerSpec) ProtoMessage()    {}
func (*MergeHashJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_a5b1a84518ab2dfc, []int{14}
}
func (m *MergeHashJoinerSpec) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MergeHashJoinerSpec) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalTo(b)
	if err != nil {
		return nil, err
...
func (dst *MergeHashJoinerSpec) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MergeHashJoinerSpec.Merge(dst, src)
}
func (m *MergeHashJoinerSpec) XXX_Size() int {
	return m.Size()
}
func (m *MergeHashJoinerSpec) XXX_DiscardUnknown() {
	xxx_messageInfo_MergeHashJoinerSpec.DiscardUnknown(m)
}

var xxx_messageInfo_MergeHashJoinerSpec proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*MergeHashJoinerSpec)(nil), "cockroach.sql.distsqlrun.MergeHashJoinerSpec")
...
func (m *MergeHashJoinerSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *MergeHashJoinerSpec) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	i++
	i = encodeVarintProcessorsSql(dAtA, i, uint64(m.LeftOrdering.Size()))
	n34, err := m.LeftOrdering.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n34
	...
	i++
	i = encodeVarintProcessorsSql(dAtA, i, uint64(m.RightOrdering.Size()))
	n35, err := m.RightOrdering.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n35
	if len(m.LeftEqColumns) > 0 {
		dAtA37 := make([]byte, len(m.LeftEqColumns)*10)
		var j36 int
		for _, num := range m.LeftEqColumns {
			for num >= 1<<7 {
	...
	if len(m.RightEqColumns) > 0 {
		dAtA39 := make([]byte, len(m.RightEqColumns)*10)
		var j38 int
		for _, num := range m.RightEqColumns {
			for num >= 1<<7 {
		...
		dAtA[i] = 0x22
		i++
		i = encodeVarintProcessorsSql(dAtA, i, uint64(j38))
...
func (m *MergeHashJoinerSpec) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MergeHashJoinerSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MergeHashJoinerSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MergeHashJoinerSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func init() {
	proto.RegisterFile("sql/execinfrapb/processors_sql.proto", fileDescriptor_processors_sql_a5b1a84518ab2dfc)
}

var fileDescriptor_processors_sql_a5b1a84518ab2dfc = []byte{
	...
	,
}
