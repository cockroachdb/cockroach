...
func (ScanVisibility) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_0f7bc38624b731d9, []int{0}
}
...
func (AggregatorSpec_Func) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_0f7bc38624b731d9, []int{12, 0}
}
...
func (AggregatorSpec_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_0f7bc38624b731d9, []int{12, 1}
}
...
func (WindowerSpec_WindowFunc) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_0f7bc38624b731d9, []int{15, 0}
}
...
func (WindowerSpec_Frame_Mode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_0f7bc38624b731d9, []int{15, 1, 0}
}
...
func (WindowerSpec_Frame_BoundType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_0f7bc38624b731d9, []int{15, 1, 1}
}
...
func (WindowerSpec_Frame_Exclusion) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_0f7bc38624b731d9, []int{15, 1, 2}
}
...
func (*TableReaderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_0f7bc38624b731d9, []int{1}
}
...
func (*IndexSkipTableReaderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_0f7bc38624b731d9, []int{2}
}
...
func (*JoinReaderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_0f7bc38624b731d9, []int{3}
}
...
func (*SorterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_0f7bc38624b731d9, []int{4}
}
...
func (*DistinctSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_0f7bc38624b731d9, []int{5}
}
...
func (*OrdinalitySpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_0f7bc38624b731d9, []int{6}
}
...
func (*ZigzagJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_0f7bc38624b731d9, []int{7}
}
...
func (*MergeJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_0f7bc38624b731d9, []int{8}
}
...
func (*HashJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_0f7bc38624b731d9, []int{9}
}
...
type InvertedJoinerSpec struct {
	...
	// Expression involving only the indexed column and the lookup column, where
	// @1 refers to the lookup column and @2 to the indexed column. The
	// expression is used to construct an implementation of
	// RowToInvertedIndexExpr which will be fed each input row and output
	// an expression to evaluate over the inverted index.
	//
	// TODO(sumeer): RowToInvertedIndexExpr will be added with the
	// invertedJoiner implementation. And update this comment when all the
	// expression generation machinery is in place to refer to actual code
	// abstractions.
	...
	// they cannot be present in this expression.
	OnExpr Expression `protobuf:"bytes,5,opt,name=on_expr,json=onExpr" json:"on_expr"`
...
func (*InvertedJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_0f7bc38624b731d9, []int{10}
}
...
//
// TODO(sumeer): pushing the PK filter down before the inverted filtering
// would usually be better than the OnExpr evaluated here since the former can
// always be distributed. The only case where doing the OnExpr here (which
// gets evaluated after the InvertedExpr) is if the PK filter is expensive to
// evaluate, has high selectivity, and evaluating it on duplicates of the same
// PK is more expensive than the de-duplicated evaluation that happens here.
// Should we remove the OnExpr from here or keep it for now?
//
// Example:
...
//
// Internal columns are | a | d |. The output omits the inverted column, while
// leaving the relative position of the PK columns unchanged.
type InvertedFiltererSpec struct {
	...
	// Optional expression involving the primary key columns, where
	// @1 refers to the first PK column, and so on. The inverted index
	// column is not part of this numbering.
	OnExpr Expression `protobuf:"bytes,3,opt,name=on_expr,json=onExpr" json:"on_expr"`
}
...
func (*InvertedFiltererSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_0f7bc38624b731d9, []int{11}
}
...
func (*AggregatorSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_0f7bc38624b731d9, []int{12}
}
...
func (*InterleavedReaderJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_0f7bc38624b731d9, []int{13}
}
...
func (*InterleavedReaderJoinerSpec_Table) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_0f7bc38624b731d9, []int{13, 0}
}
...
func (*ProjectSetSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_0f7bc38624b731d9, []int{14}
}
...
func (*WindowerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_0f7bc38624b731d9, []int{15}
}
...
func (*WindowerSpec_Frame) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_0f7bc38624b731d9, []int{15, 1}
}
...
func (*WindowerSpec_WindowFn) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_0f7bc38624b731d9, []int{15, 2}
}
...
func (m *AggregatorSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.GroupCols) > 0 {
		dAtA25 := make([]byte, len(m.GroupCols)*10)
		var j24 int
	...
	if len(m.OrderedGroupCols) > 0 {
		dAtA27 := make([]byte, len(m.OrderedGroupCols)*10)
		var j26 int
...
func (m *InterleavedReaderJoinerSpec_Table) MarshalTo(dAtA []byte) (int, error) {
	...
	n29, err := m.Desc.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n29
	...
	n30, err := m.Post.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n30
	...
	n31, err := m.Ordering.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n31
...
func init() {
	proto.RegisterFile("sql/execinfrapb/processors_sql.proto", fileDescriptor_processors_sql_0f7bc38624b731d9)
}

var fileDescriptor_processors_sql_0f7bc38624b731d9 = []byte{
	...
	,
}
