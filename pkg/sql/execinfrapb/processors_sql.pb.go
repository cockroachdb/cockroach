...
func (ScanVisibility) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_3a604963f9a66bbd, []int{0}
}
...
func (AggregatorSpec_Func) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_3a604963f9a66bbd, []int{12, 0}
}
...
func (AggregatorSpec_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_3a604963f9a66bbd, []int{12, 1}
}
...
func (WindowerSpec_WindowFunc) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_3a604963f9a66bbd, []int{14, 0}
}
...
func (WindowerSpec_Frame_Mode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_3a604963f9a66bbd, []int{14, 1, 0}
}
...
func (WindowerSpec_Frame_BoundType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_3a604963f9a66bbd, []int{14, 1, 1}
}
...
func (WindowerSpec_Frame_Exclusion) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_3a604963f9a66bbd, []int{14, 1, 2}
}
...
func (*TableReaderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_3a604963f9a66bbd, []int{1}
}
...
func (*IndexSkipTableReaderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_3a604963f9a66bbd, []int{2}
}
...
// join is a inverted join (see InvertedJoinerSpec), but can also be the case
...
//
// The mapping from original join to the pair of joins is:
...
// a1, b1, c1, d1,   null, null
// a1, b2, c1, null, null, null
// a2, b2, c1, d4,   d4,   f1
// The d column is not part of the original left row, so will be projected
// away after the join.
//
// The output for LEFT_ANTI:
// a1, b1, c1, d1
// a1, b2, c1, null
// Again, the d column will be projected away after the join.
//
...
func (*JoinReaderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_3a604963f9a66bbd, []int{3}
}
...
func (*SorterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_3a604963f9a66bbd, []int{4}
}
...
func (*DistinctSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_3a604963f9a66bbd, []int{5}
}
...
func (*OrdinalitySpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_3a604963f9a66bbd, []int{6}
}
...
func (*ZigzagJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_3a604963f9a66bbd, []int{7}
}
...
func (*MergeJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_3a604963f9a66bbd, []int{8}
}
...
func (*HashJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_3a604963f9a66bbd, []int{9}
}
...
// whether this row is a continuation of a group. This is paired with a lookup
// join that also knows about the semantics of this bool column. For a user
// query with LEFT_SEMI, the inverted join is run as an INNER join with the
// same special mode. See the JoinReaderSpec for an example.
//
// Example:
...
//
// For a LEFT_OUTER with OutputGroupCountForLeftJoin = true, the internal
// columns including an additional bool column as the last column.
type InvertedJoinerSpec struct {
	...
	// left row.
	OutputContinuationForLeftJoin bool `protobuf:"varint,8,opt,name=output_continuation_for_left_join,json=outputContinuationForLeftJoin" json:"output_continuation_for_left_join"`
}
...
func (*InvertedJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_3a604963f9a66bbd, []int{10}
}
...
func (*InvertedFiltererSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_3a604963f9a66bbd, []int{11}
}
...
func (*InvertedFiltererSpec_PreFiltererSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_3a604963f9a66bbd, []int{11, 0}
}
...
func (*AggregatorSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_3a604963f9a66bbd, []int{12}
}
...
func (*ProjectSetSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_3a604963f9a66bbd, []int{13}
}
...
func (*WindowerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_3a604963f9a66bbd, []int{14}
}
...
func (*WindowerSpec_Frame) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_3a604963f9a66bbd, []int{14, 1}
}
...
func (*WindowerSpec_WindowFn) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_sql_3a604963f9a66bbd, []int{14, 2}
}
...
func (m *InvertedJoinerSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x40
	i++
	if m.OutputContinuationForLeftJoin {
		dAtA[i] = 1
	} else {
		dAtA[i] = 0
	}
...
func (m *InvertedJoinerSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field OutputContinuationForLeftJoin", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OutputContinuationForLeftJoin = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipProcessorsSql(dAtA[iNdEx:])
			if err != nil {
...
func init() {
	proto.RegisterFile("sql/execinfrapb/processors_sql.proto", fileDescriptor_processors_sql_3a604963f9a66bbd)
}

var fileDescriptor_processors_sql_3a604963f9a66bbd = []byte{
	// 2766 bytes of a gzipped FileDescriptorProto
	,
}
