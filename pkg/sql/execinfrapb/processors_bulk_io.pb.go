...
type ReadImportDataSpec struct {
	...
	DatabasePrimaryRegion github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.RegionName `protobuf:"bytes,17,opt,name=database_primary_region,json=databasePrimaryRegion,casttype=github.com/cockroachdb/cockroach/pkg/sql/catalog/descpb.RegionName" json:"database_primary_region"`
}
...
type ParquetWriterSpec struct {
	...
	CompressionCodec FileCompression `protobuf:"varint,5,opt,name=compression_codec,json=compressionCodec,enum=cockroach.sql.distsqlrun.FileCompression" json:"compression_codec"`
	// logical_col_names specifies the logical column names for the exported parquet file
	LogicalColNames []string `protobuf:"bytes,6,rep,name=logical_col_names,json=logicalColNames" json:"logical_col_names,omitempty"`
	// nullable_cols specifies which columns allow null values in the exported parquet file
	NullableCols []bool `protobuf:"varint,9,rep,name=nullable_cols,json=nullableCols" json:"nullable_cols,omitempty"`
	// User who initiated the export. This is used to check access privileges
	// when using FileTable ExternalStorage.
	UserProto github_com_cockroachdb_cockroach_pkg_security.SQLUsernameProto `protobuf:"bytes,8,opt,name=user_proto,json=userProto,casttype=github.com/cockroachdb/cockroach/pkg/security.SQLUsernameProto" json:"user_proto"`
}
...
var fileDescriptor_6d46d06b67eadaca = []byte{
	...
	,
}
...
func (m *ParquetWriterSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.NullableCols) > 0 {
		for iNdEx := len(m.NullableCols) - 1; iNdEx >= 0; iNdEx-- {
			i--
			if m.NullableCols[iNdEx] {
				dAtA[i] = 1
			} else {
				dAtA[i] = 0
			}
	...
	i--
	dAtA[i] = 0x38
	if len(m.LogicalColNames) > 0 {
		for iNdEx := len(m.LogicalColNames) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.LogicalColNames[iNdEx])
			copy(dAtA[i:], m.LogicalColNames[iNdEx])
			i = encodeVarintProcessorsBulkIo(dAtA, i, uint64(len(m.LogicalColNames[iNdEx])))
			i--
			dAtA[i] = 0x32
		}
	}
...
func (m *ParquetWriterSpec) Size() (n int) {
	...
	n += 1 + sovProcessorsBulkIo(uint64(m.CompressionCodec))
	if len(m.LogicalColNames) > 0 {
		for _, s := range m.LogicalColNames {
			l = len(s)
			n += 1 + l + sovProcessorsBulkIo(uint64(l))
		}
	}
...
func (m *ParquetWriterSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LogicalColNames", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.LogicalColNames = append(m.LogicalColNames, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ChunkSize", wireType)
		...
		case 9:
			if wireType == 0 {
				...
				m.NullableCols = append(m.NullableCols, bool(v != 0))
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				if elementCount != 0 && len(m.NullableCols) == 0 {
					m.NullableCols = make([]bool, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v int
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field NullableCols", wireType)
			}
		default:
			iNdEx = preIndex
			skippy, err := skipProcessorsBulkIo(dAtA[iNdEx:])
