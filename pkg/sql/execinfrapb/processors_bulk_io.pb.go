...
func (FileCompression) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_1497ebb2fa778119, []int{0}
}
...
func (BackfillerSpec_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_1497ebb2fa778119, []int{0, 0}
}
...
func (*JobProgress) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_1497ebb2fa778119, []int{1}
}
...
func (*ReadImportDataSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_1497ebb2fa778119, []int{2}
}
...
func (*ReadImportDataSpec_ImportTable) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_1497ebb2fa778119, []int{2, 0}
}
...
func (*StreamIngestionDataSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_1497ebb2fa778119, []int{3}
}
...
func (*StreamIngestionFrontierSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_1497ebb2fa778119, []int{4}
}
...
func (*BackupDataSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_1497ebb2fa778119, []int{5}
}
...
func (*RestoreSpanEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_1497ebb2fa778119, []int{6}
}
...
func (*RestoreDataSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_1497ebb2fa778119, []int{7}
}
...
func (*SplitAndScatterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_1497ebb2fa778119, []int{8}
}
...
func (*SplitAndScatterSpec_RestoreEntryChunk) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_1497ebb2fa778119, []int{8, 0}
}
...
func (*CSVWriterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_1497ebb2fa778119, []int{9}
}
...
func (*BulkRowWriterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_1497ebb2fa778119, []int{10}
}
...
func init() {
	proto.RegisterFile("sql/execinfrapb/processors_bulk_io.proto", fileDescriptor_processors_bulk_io_1497ebb2fa778119)
}

var fileDescriptor_processors_bulk_io_1497ebb2fa778119 = []byte{
