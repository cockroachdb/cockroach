...
func (FileCompression) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_ecc449c1f87c16d7, []int{0}
}
...
func (BackfillerSpec_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_ecc449c1f87c16d7, []int{0, 0}
}
...
func (*JobProgress) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_ecc449c1f87c16d7, []int{1}
}
...
func (*ReadImportDataSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_ecc449c1f87c16d7, []int{2}
}
...
func (*ReadImportDataSpec_ImportTable) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_ecc449c1f87c16d7, []int{2, 0}
}
...
func (*BackupDataSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_ecc449c1f87c16d7, []int{3}
}
...
func (*CSVWriterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_ecc449c1f87c16d7, []int{4}
}
...
func (*BulkRowWriterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_ecc449c1f87c16d7, []int{5}
}
...
func init() {
	proto.RegisterFile("sql/execinfrapb/processors_bulk_io.proto", fileDescriptor_processors_bulk_io_ecc449c1f87c16d7)
}

var fileDescriptor_processors_bulk_io_ecc449c1f87c16d7 = []byte{
	...
	,
}
