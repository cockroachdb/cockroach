...
func (BackfillerSpec_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_cdf607adb89ac96f, []int{0, 0}
}
...
func (*BackfillerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_cdf607adb89ac96f, []int{0}
}
...
func (*JobProgress) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_cdf607adb89ac96f, []int{1}
}
...
func (*ReadImportDataSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_cdf607adb89ac96f, []int{2}
}
...
type ReadImportDataSpec_ImportTable struct {
	...
	// targetColIds is used to store the target column ids for each existing table
	// being imported into. These are the columns ids for which the processor should
	// read and emit data (ignoring data for any other tables or columns outside
	// of the targetCols, that is present in the input).
	TargetColIds []uint32 `protobuf:"varint,3,rep,name=targetColIds" json:"targetColIds,omitempty"`
}
...
func (*ReadImportDataSpec_ImportTable) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_cdf607adb89ac96f, []int{2, 0}
}
...
func (*CSVWriterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_cdf607adb89ac96f, []int{3}
}
...
func (*BulkRowWriterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_cdf607adb89ac96f, []int{4}
}
...
func init() {
	proto.RegisterFile("sql/execinfrapb/processors_bulk_io.proto", fileDescriptor_processors_bulk_io_cdf607adb89ac96f)
}

var fileDescriptor_processors_bulk_io_cdf607adb89ac96f = []byte{
	...
	,
}
