...
func (BackfillerSpec_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_c18227ff0a4c029c, []int{0, 0}
}

// Compression list of the compression codecs which are currently
// supported for CSVWriter spec
type CSVWriterSpec_Compression int32

const (
	CSVWriterSpec_none CSVWriterSpec_Compression = 0
	CSVWriterSpec_gzip CSVWriterSpec_Compression = 1
)

var CSVWriterSpec_Compression_name = map[int32]string{
	0: "none",
	1: "gzip",
}
var CSVWriterSpec_Compression_value = map[string]int32{
	"none": 0,
	"gzip": 1,
}

func (x CSVWriterSpec_Compression) Enum() *CSVWriterSpec_Compression {
	p := new(CSVWriterSpec_Compression)
	*p = x
	return p
}
func (x CSVWriterSpec_Compression) String() string {
	return proto.EnumName(CSVWriterSpec_Compression_name, int32(x))
}
func (x *CSVWriterSpec_Compression) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(CSVWriterSpec_Compression_value, data, "CSVWriterSpec_Compression")
	if err != nil {
		return err
	}
	*x = CSVWriterSpec_Compression(value)
	return nil
}
func (CSVWriterSpec_Compression) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_c18227ff0a4c029c, []int{3, 0}
}
...
func (*BackfillerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_c18227ff0a4c029c, []int{0}
}
...
func (*JobProgress) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_c18227ff0a4c029c, []int{1}
}
...
func (*ReadImportDataSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_c18227ff0a4c029c, []int{2}
}
...
func (*ReadImportDataSpec_ImportTable) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_c18227ff0a4c029c, []int{2, 0}
}
...
type CSVWriterSpec struct {
	...
	// compression code type to be used while epxporting CSV file,
	// if it's null (i.e. not defined), no compression will be used.
	CompressionCodec CSVWriterSpec_Compression `protobuf:"varint,5,opt,name=compression_codec,json=compressionCodec,enum=cockroach.sql.distsqlrun.CSVWriterSpec_Compression" json:"compression_codec"`
}
...
func (*CSVWriterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_c18227ff0a4c029c, []int{3}
}
...
func (*BulkRowWriterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_c18227ff0a4c029c, []int{4}
}
...
func init() {
	...
	proto.RegisterEnum("cockroach.sql.distsqlrun.CSVWriterSpec_Compression", CSVWriterSpec_Compression_name, CSVWriterSpec_Compression_value)
}
	...
	for iNdEx < l {
		...
		case 5:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CompressionCodec |= (CSVWriterSpec_Compression(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func init() {
	proto.RegisterFile("sql/execinfrapb/processors_bulk_io.proto", fileDescriptor_processors_bulk_io_c18227ff0a4c029c)
}

var fileDescriptor_processors_bulk_io_c18227ff0a4c029c = []byte{
	...
	,
}
