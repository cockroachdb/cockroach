...
func (BackfillerSpec_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_8f8356906c8c7727, []int{0, 0}
}
...
func (*BackfillerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_8f8356906c8c7727, []int{0}
}
...
func (*JobProgress) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_8f8356906c8c7727, []int{1}
}
...
func (*ReadImportDataSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_8f8356906c8c7727, []int{2}
}
...
func (*ReadImportDataSpec_ImportTable) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_8f8356906c8c7727, []int{2, 0}
}
...
func (*CSVWriterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_8f8356906c8c7727, []int{3}
}
...
func (*BulkRowWriterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_bulk_io_8f8356906c8c7727, []int{4}
}
...
func init() {
	proto.RegisterFile("sql/execinfrapb/processors_bulk_io.proto", fileDescriptor_processors_bulk_io_8f8356906c8c7727)
}

var fileDescriptor_processors_bulk_io_8f8356906c8c7727 = []byte{
	...
	,
}
