...
type RequestDeadlineSpec struct {
}

func (m *RequestDeadlineSpec) Reset()         { *m = RequestDeadlineSpec{} }
func (m *RequestDeadlineSpec) String() string { return proto.CompactTextString(m) }
func (*RequestDeadlineSpec) ProtoMessage()    {}
func (*RequestDeadlineSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_6d46d06b67eadaca, []int{3}
}
func (m *RequestDeadlineSpec) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RequestDeadlineSpec) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *RequestDeadlineSpec) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestDeadlineSpec.Merge(m, src)
}
func (m *RequestDeadlineSpec) XXX_Size() int {
	return m.Size()
}
func (m *RequestDeadlineSpec) XXX_DiscardUnknown() {
	xxx_messageInfo_RequestDeadlineSpec.DiscardUnknown(m)
}

var xxx_messageInfo_RequestDeadlineSpec proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*RequestDeadlineSpec)(nil), "cockroach.sql.distsqlrun.RequestDeadlineSpec")
...
var fileDescriptor_6d46d06b67eadaca = []byte{
	...
	,
}
...
func (m *RequestDeadlineSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RequestDeadlineSpec) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RequestDeadlineSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *RequestDeadlineSpec) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RequestDeadlineSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RequestDeadlineSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RequestDeadlineSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
