...
func (SketchType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_table_stats_440c04bbc571bb2d, []int{0}
}
...
//       - an INT column indicating the number of NULL rows
//         on the columns of the sketch.
...
func (*SamplerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_table_stats_440c04bbc571bb2d, []int{1}
}
...
//    - number of NULL rows encountered on the columns of the sketch
//    - binary sketch data
...
func (*SampleAggregatorSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_table_stats_440c04bbc571bb2d, []int{2}
}
...
func init() {
	proto.RegisterFile("sql/execinfrapb/processors_table_stats.proto", fileDescriptor_processors_table_stats_440c04bbc571bb2d)
}

var fileDescriptor_processors_table_stats_440c04bbc571bb2d = []byte{
