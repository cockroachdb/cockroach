...
func (SketchType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_table_stats_287e338bdb9e0847, []int{0}
}
...
//
// The internal schema of the processor is formed of four column groups:
...
//   4. inverted sketch columns:
//       - an INT column identifying the column index for this inverted sketch
//       - an INT column indicating the number of rows processed
//       - an INT column indicating the number of rows with NULL values
//         on all columns of the sketch.
//       - a BYTES column with the binary sketch data (format
...
func (*SamplerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_table_stats_287e338bdb9e0847, []int{1}
}
...
//    - sample column
//  4. inverted sketch columns:
//    - column index for inverted sketch
//    - number of rows processed
//    - number of rows encountered with NULL values on all columns of the sketch
//    - binary sketch data
...
func (*SampleAggregatorSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_table_stats_287e338bdb9e0847, []int{2}
}
...
func init() {
	proto.RegisterFile("sql/execinfrapb/processors_table_stats.proto", fileDescriptor_processors_table_stats_287e338bdb9e0847)
}

var fileDescriptor_processors_table_stats_287e338bdb9e0847 = []byte{
