...
func (SketchType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_table_stats_f51ed4ceb8e4167e, []int{0}
}
...
func (*SamplerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_table_stats_f51ed4ceb8e4167e, []int{1}
}
...
func (*SampleAggregatorSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_table_stats_f51ed4ceb8e4167e, []int{2}
}
...
func init() {
	proto.RegisterFile("sql/execinfrapb/processors_table_stats.proto", fileDescriptor_processors_table_stats_f51ed4ceb8e4167e)
}

var fileDescriptor_processors_table_stats_f51ed4ceb8e4167e = []byte{
