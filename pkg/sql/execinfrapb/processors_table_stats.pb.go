...
func (SketchType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_table_stats_d783a94a9078d2de, []int{0}
}
...
func (*SamplerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_table_stats_d783a94a9078d2de, []int{1}
}
...
func (*SampleAggregatorSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_table_stats_d783a94a9078d2de, []int{2}
}
...
func init() {
	proto.RegisterFile("sql/execinfrapb/processors_table_stats.proto", fileDescriptor_processors_table_stats_d783a94a9078d2de)
}

var fileDescriptor_processors_table_stats_d783a94a9078d2de = []byte{
