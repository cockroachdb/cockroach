...
func _() {
	...
	_ = x[NOLOGIN-5]
	_ = x[VALIDUNTIL-6]
	_ = x[CONTROLCHANGEFEED-7]
	_ = x[NOCONTROLCHANGEFEED-8]
}

const _Option_name = "CREATEROLENOCREATEROLEPASSWORDLOGINNOLOGINVALIDUNTILCONTROLCHANGEFEEDNOCONTROLCHANGEFEED"

var _Option_index = [...]uint8{0, 10, 22, 30, 35, 42, 52, 69, 88}
