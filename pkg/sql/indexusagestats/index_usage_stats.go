...
type IndexUsageType int

const (
	// LookupJoin indicates that the index is being used for lookup join.
	LookupJoin IndexUsageType = iota

	// InvertedJoin indicates that the index is being used for inverted join.
	InvertedJoin

	// ZigzagJoin indicates that the index is being used for inverted join.
	ZigzagJoin

	// NonFullScan indicates that the index is being used for partial scan.
	NonFullScan

	// FullScan indicates that the index is being used for full scan.
	FullScan
)
