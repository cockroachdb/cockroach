...
func getTableCreateParams(
	...
	if err == nil && exists {
		...
		// Check if the type of object doesn't match
		var tableDescriptor, isTableDescriptor = desc.(catalog.TableDescriptor)
		var mismatchedType = true

		// If it's not a table descriptor, then validate
		// if the type matches.
