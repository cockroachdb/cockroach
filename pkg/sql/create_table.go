...
func makeTableDesc(
	...
	for i, def := range n.Defs {
		...
		newDef, seqDbDesc, seqName, err := params.p.processSerialInColumnDef(params.ctx, d, tableName)
		if err != nil {
			return ret, err
		}
		if seqName != nil {
			if err := doCreateSequence(params, n.String(), seqDbDesc, seqName, nil); err != nil {
				return ret, err
			}
		}
		if d != newDef {
