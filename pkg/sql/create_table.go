...
func findTargetConstraintColumnIDs(
	targetUniqueConstraint descpb.UniqueConstraint, target *tabledesc.Mutable,
) []descpb.ColumnID {
	...
	constraint, ok := constraints[targetUniqueConstraint.GetName()]
	if !ok {
		return nil
	}
