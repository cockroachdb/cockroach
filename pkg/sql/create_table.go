...
func MakeTableDesc(
	...
	// Now that the user defined columns have been assigned their respective column
	// families, we check if we created any implicit shard columns for hash sharded
	// indexes and assign column families to them.
	desc.AssignFamiliesToShardColumns()
