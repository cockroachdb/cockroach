...
func ResolveFK(
	...
	if !allowSubset {
		_, _, err = catalog.FindFKReferencedUniqueConstraint(target, fkConstraint, false /* allowSubset */)
		return err
	}
	_, isStrictSubset, err := catalog.FindFKReferencedUniqueConstraint(target, fkConstraint, true /* allowSubset */)
	if err != nil {
		return err
	}
	if isStrictSubset {
