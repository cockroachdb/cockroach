...
// NewMutableCreateTableDescriptor returns a MutableTableDescriptor from the
...
func NewMutableCreateTableDescriptor(tbl sqlbase.TableDescriptor) *sqlbase.MutableTableDescriptor {
...
func InitTableDescriptor(
	...
	return *NewMutableCreateTableDescriptor(sqlbase.TableDescriptor{
		ID:               id,
		Name:             name,
		ParentID:         parentID,
