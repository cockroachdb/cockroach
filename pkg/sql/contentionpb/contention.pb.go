...
func (*IndexContentionEvents) Descriptor() ([]byte, []int) {
	return fileDescriptor_contention_a7b2a7c0f4083dc2, []int{0}
}
...
func (*SingleKeyContention) Descriptor() ([]byte, []int) {
	return fileDescriptor_contention_a7b2a7c0f4083dc2, []int{1}
}
...
func (*SingleKeyContention_SingleTxnContention) Descriptor() ([]byte, []int) {
	return fileDescriptor_contention_a7b2a7c0f4083dc2, []int{1, 0}
}
...
func init() {
	proto.RegisterFile("sql/contentionpb/contention.proto", fileDescriptor_contention_a7b2a7c0f4083dc2)
}

var fileDescriptor_contention_a7b2a7c0f4083dc2 = []byte{
