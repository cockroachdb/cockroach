...
// produced (but not necessarily delivered to the client). Statements after the
...
// Session is in charge of removing old statements that are no longer needed for
// retries from the (head of the) buffer.
//
