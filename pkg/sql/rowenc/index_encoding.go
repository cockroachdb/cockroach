...
// maps descpb.ColumnIDs to indices in `values`. keyPrefixMap maps
// descpb.IndexIDs to their key prefix; the caller can reuse this between rows
// to save work from creating key prefixes. secondaryIndexEntries is the
