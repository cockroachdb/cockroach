...
func MakeSpanFromEncDatums(
	...
	startKey, containsNull, err := MakeKeyFromEncDatums(values, types, dirs, alloc, keyPrefix)
	if err != nil {
...
func DecodeIndexKey(
	...
	return DecodeKeyVals(types, vals, colDirs, key)
}
...
func EncodePrimaryIndex(
	...
	indexKey, _, err := EncodeIndexKey(index, colMap, values, keyPrefix)
	if err != nil {
		return nil, err
	}
...
func EncodeSecondaryIndex(
	...
	if secondaryIndex.GetType() == descpb.IndexDescriptor_INVERTED {
		...
		secondaryIndexKey, containsNull, err = EncodeIndexKey(secondaryIndex, colMap, values, secondaryIndexKeyPrefix)
