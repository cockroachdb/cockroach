...
func (i ColumnConversionKind) classifier() classifier {
	return func(_ *catpb.ColumnType, _ *catpb.ColumnType) ColumnConversionKind {
		return i
	}
}
...
type classifier func(oldType *catpb.ColumnType, newType *catpb.ColumnType) ColumnConversionKind

// classifiers contains the logic for looking up conversions which
// don't require a fully-generalized approach.
var classifiers = map[catpb.ColumnType_SemanticType]map[catpb.ColumnType_SemanticType]classifier{
	catpb.ColumnType_BYTES: {
		catpb.ColumnType_BYTES:  classifierWidth,
		catpb.ColumnType_STRING: ColumnConversionValidate.classifier(),
		catpb.ColumnType_UUID:   ColumnConversionValidate.classifier(),
	},
	catpb.ColumnType_DECIMAL: {
		// Decimals are always encoded as an apd.Decimal
		catpb.ColumnType_DECIMAL: classifierHardestOf(classifierPrecision, classifierWidth),
	},
	catpb.ColumnType_FLOAT: {
		...
		catpb.ColumnType_FLOAT: ColumnConversionTrivial.classifier(),
	},
	catpb.ColumnType_INT: {
		catpb.ColumnType_INT: func(from *catpb.ColumnType, to *catpb.ColumnType) ColumnConversionKind {
			return classifierWidth(from, to)
		},
	},
	catpb.ColumnType_BIT: {
		catpb.ColumnType_BIT: func(from *catpb.ColumnType, to *catpb.ColumnType) ColumnConversionKind {
			return classifierWidth(from, to)
		},
	},
	catpb.ColumnType_STRING: {
		...
		catpb.ColumnType_BYTES: func(s *catpb.ColumnType, b *catpb.ColumnType) ColumnConversionKind {
			switch {
			case b.Width == 0:
		...
		catpb.ColumnType_STRING: classifierWidth,
	},
	catpb.ColumnType_TIMESTAMP: {
		catpb.ColumnType_TIMESTAMPTZ: ColumnConversionTrivial.classifier(),
	},
	catpb.ColumnType_TIMESTAMPTZ: {
		catpb.ColumnType_TIMESTAMP: ColumnConversionTrivial.classifier(),
	},
}
...
func classifierHardestOf(classifiers ...classifier) classifier {
	return func(oldType *catpb.ColumnType, newType *catpb.ColumnType) ColumnConversionKind {
...
func classifierPrecision(
	oldType *catpb.ColumnType, newType *catpb.ColumnType,
...
// no-op.  Otherwise, it returns validate.
func classifierWidth(oldType *catpb.ColumnType, newType *catpb.ColumnType) ColumnConversionKind {
	switch {
