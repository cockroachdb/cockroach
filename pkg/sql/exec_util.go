...
var (
	...
	MetaTxnPrepareStarted = metric.Metadata{
		...
		Unit:         metric.Unit_COUNT,
		LabeledName:  "sql.started.count",
		StaticLabels: metric.MakeLabelPairs(metric.LabelQueryType, "prepare-transaction"),
	}
	MetaTxnCommitPreparedStarted = metric.Metadata{
		...
		Unit:         metric.Unit_COUNT,
		LabeledName:  "sql.started.count",
		StaticLabels: metric.MakeLabelPairs(metric.LabelQueryType, "commit-prepared"),
	}
	MetaTxnRollbackPreparedStarted = metric.Metadata{
		...
		Unit:         metric.Unit_COUNT,
		LabeledName:  "sql.started.count",
		StaticLabels: metric.MakeLabelPairs(metric.LabelQueryType, "rollback-prepared"),
	}
	...
	MetaReleaseSavepointStarted = metric.Metadata{
		...
		Unit:         metric.Unit_COUNT,
		LabeledName:  "sql.started.count",
		StaticLabels: metric.MakeLabelPairs(metric.LabelQueryType, "release-savepoint"),
	}
	MetaRollbackToSavepointStarted = metric.Metadata{
		...
		Unit:         metric.Unit_COUNT,
		LabeledName:  "sql.started.count",
		StaticLabels: metric.MakeLabelPairs(metric.LabelQueryType, "rollback-to-savepoint"),
	}
	MetaRestartSavepointStarted = metric.Metadata{
		...
		Unit:         metric.Unit_COUNT,
		LabeledName:  "sql.started.count",
		StaticLabels: metric.MakeLabelPairs(metric.LabelQueryType, "restart-savepoint"),
	}
	MetaReleaseRestartSavepointStarted = metric.Metadata{
		...
		Unit:         metric.Unit_COUNT,
		LabeledName:  "sql.started.count",
		StaticLabels: metric.MakeLabelPairs(metric.LabelQueryType, "release-restart-savepoint"),
	}
	MetaRollbackToRestartSavepointStarted = metric.Metadata{
		...
		Unit:         metric.Unit_COUNT,
		LabeledName:  "sql.started.count",
		StaticLabels: metric.MakeLabelPairs(metric.LabelQueryType, "rollback-to-restart-savepoint"),
	}
