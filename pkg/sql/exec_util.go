...
// UpdateTenantVersionSettingHook provides a callback that allows us
...
// each step.
type UpdateTenantVersionSettingHook func(
	ctx context.Context,
...
type VersionUpgradeHook func(
	...
	updateSystemVersionSettings UpdateTenantVersionSettingHook,
) error
