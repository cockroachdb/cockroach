...
// planning being handled by DistSQL physical planner. If the passed-in plan
// already has physical representation (meaning it was constructed by a
// distSQLSpecExecFactory), then the pre-populated plan distribution is
// returned.
