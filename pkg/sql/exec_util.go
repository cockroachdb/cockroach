...
var (
	...
	MetaTxnRowsWrittenLog = metric.Metadata{
		Name:        "sql.guardrails.txn_rows_written_log.count",
	...
	MetaTxnRowsWrittenErr = metric.Metadata{
		Name:        "sql.guardrails.txn_rows_written_err.count",
