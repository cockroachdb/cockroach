...
type BackupRestoreTestingKnobs struct {
	...
	// SkipDescriptorChangeIntroduction simulates the bug in #88042 and ensures the
	// Restore properly fails if it observes a backup that failed to reintroduce all
	// previously offline spans.
