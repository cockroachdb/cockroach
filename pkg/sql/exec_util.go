...
var experimentalUseNewSchemaChanger = settings.RegisterBoolSetting(
...
func (m *sessionDataMutator) SetUseNewSchemaChanger(val bool) {
	m.data.UseNewSchemaChanger = val
}
