...
// move the transaction back to stateOpen.
...
// not started as a result of rolling back to a savepoint (i.e. the normal
// case).
...
// eventTxnReleaseFailed represents a failed RELEASE SAVEPOINT cockroach_restart.
type eventTxnReleaseFailed struct{}
...
func (eventTxnReleaseFailed) Event()  {}
