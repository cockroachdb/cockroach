...
const (
	...
	CommitOrReleaseStateStr = sqlfsm.CommitOrReleaseWaitStr
...
type stateCommitOrReleaseWait struct{}

var _ fsm.State = stateCommitOrReleaseWait{}

func (stateCommitOrReleaseWait) String() string {
	return CommitOrReleaseStateStr
}
...
func (stateCommitOrReleaseWait) State() {}
