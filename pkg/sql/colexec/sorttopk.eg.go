		...
		var meta *execinfrapb.ProducerMetadata
		{
			var __retval_0 *execinfrapb.ProducerMetadata
			{
				...
				if meta != nil {
					...
					goto nextBatch_false_return_11
				}
				t.inputBatch = batch
				t.firstUnprocessedTupleIdx = 0
				{
