...
// disk-backed queues.
// - maxNumberActivePartitions (when non-zero) overrides the semi-dynamically
// computed maximum number of partitions to merge at once. It should be
...
func newExternalSorter(
	...
	return &externalSorter{
		...
		ordering:                  ordering,
		maxNumberActivePartitions: numberActivePartitions,
		cfg:                       cfg,
	}
}
