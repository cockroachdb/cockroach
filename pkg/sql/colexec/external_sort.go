...
func newExternalSorter(
	...
	// well.
	batchMemSize := colexecbase.EstimateBatchSizeBytesFromSQLTypes(inputTypes, coldata.BatchSize())
...
func (o *inputPartitioningOperator) Next(ctx context.Context) coldata.Batch {
	...
	// for correctly.)
	batchMemSize := colexecbase.GetProportionalBatchMemSize(b, int64(b.Length()))
