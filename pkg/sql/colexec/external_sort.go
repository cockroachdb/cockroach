...
func (s *externalSorter) Next(ctx context.Context) coldata.Batch {
	for {
		...
		case externalSorterRepeatedMerging:
			...
			// [0 0 0 0] [1 0 0 0] (e, f, g h) (1, 1, 0, 0) (e,i,j,k) (1, 1, 1 ,0) (e,i,l,m)
			// (2, 1, 1, 0) (n, r, u, v)
...
// to the last n of the current partitions to be merged.
...
func (s *externalSorter) createMergerForPartitions(
	...
	if log.V(2) {
		...
		log.Infof(ctx,
			"external sorter is merging partitions with partition indices %s with sizes [%s]",
