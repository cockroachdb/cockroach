...
// schema passed into vectorTypeEnforcer *must* include the output type of the
// Operator that the enforcer will be the input to.
//
...
// caseOp and logical projection operators).
