...
func NewSingleTupleNoInputOp(allocator *colexecbase.Allocator) colexecbase.Operator {
...
func newVectorTypeEnforcer(
	allocator *colexecbase.Allocator, input colexecbase.Operator, typ *types.T, idx int,
) colexecbase.Operator {
