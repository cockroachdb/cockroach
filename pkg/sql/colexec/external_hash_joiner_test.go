...
// newBytesColumns returns nCols columns of types.Int with non-decreasing values
// of 8 byte size, starting at '00000000'. dupCount controls the number of
// duplicates for each row (including the row itself), use dupCount=1 for
// distinct tuples.
