...
type defaultComparisonLConstOp struct {
	projConstOpBase
...
var _ colexecbase.Operator = &defaultComparisonLConstOp{}

func (d *defaultComparisonLConstOp) Init() {
	d.input.Init()
}

func (d *defaultComparisonLConstOp) Next(ctx context.Context) coldata.Batch {
