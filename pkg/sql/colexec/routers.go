...
func newRouterOutputOp(
	allocator *Allocator, types []colphystypes.T, unblockedEventsChan chan<- struct{},
) *routerOutputOp {
...
type HashRouter struct {
	OneInputNode
	// types are the input colphystypes.
	types []colphystypes.T
...
func NewHashRouter(
	allocator *Allocator, input Operator, types []colphystypes.T, hashCols []int, numOutputs int,
) (*HashRouter, []Operator) {
