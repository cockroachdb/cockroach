...
func newRouterOutputOp(
	allocator *Allocator, types []phystypes.T, unblockedEventsChan chan<- struct{},
) *routerOutputOp {
...
func NewHashRouter(
	allocator *Allocator, input Operator, types []phystypes.T, hashCols []int, numOutputs int,
) (*HashRouter, []Operator) {
