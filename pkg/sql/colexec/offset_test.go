...
func TestOffset(t *testing.T) {
	...
	for _, tc := range tcs {
		...
		colexectestutils.RunTestsWithoutAllNullsInjection(t, testAllocator, []colexectestutils.Tuples{tc.tuples}, nil /* typs */, tc.expected, colexectestutils.UnorderedVerifier, nil, /* orderedCols */
