...
//   - makeConstructorConcurrencySafe - the function that performs any necessary
//     setup to make diskBackedOpConstructor concurrency-safe. It will be called
//     immediately.
...
func NewOneInputDiskSpiller(
	...
	makeConstructorConcurrencySafe func(),
