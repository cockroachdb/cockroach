...
func BenchmarkSortChunks(b *testing.B) {
	...
	sorterConstructors := []func(coldata.BatchAllocator, Operator, []coltypes.T, []execinfrapb.Ordering_Column, int) (Operator, error){
		NewSortChunks,
		func(allocator coldata.BatchAllocator, input Operator, inputTypes []coltypes.T, orderingCols []execinfrapb.Ordering_Column, _ int) (Operator, error) {
