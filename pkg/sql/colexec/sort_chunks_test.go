...
func TestSortChunks(t *testing.T) {
	...
	tcs := []struct {
	...
	}{
		{
			...
			typ:         []colphystypes.T{colphystypes.Int64},
		...
		},
		{
			...
			typ:         []colphystypes.T{colphystypes.Int64, colphystypes.Int64},
		...
		},
		{
			...
			typ:      []colphystypes.T{colphystypes.Int64, colphystypes.Int64, colphystypes.Int64},
...
func TestSortChunksRandomized(t *testing.T) {
	...
	typs := make([]colphystypes.T, maxCols)
	for i := range typs {
...
func BenchmarkSortChunks(b *testing.B) {
	...
	sorterConstructors := []func(*Allocator, Operator, []colphystypes.T, []execinfrapb.Ordering_Column, int) (Operator, error){
		NewSortChunks,
		func(allocator *Allocator, input Operator, inputTypes []colphystypes.T, orderingCols []execinfrapb.Ordering_Column, _ int) (Operator, error) {
