...
func (o *mergeJoinInnerOp) buildLeftGroups(
	leftGroups []group,
	colOffset int,
...
// SIDE EFFECTS: writes into o.output.
func (o *mergeJoinInnerOp) buildRightGroups(
	rightGroups []group,
	colOffset int,
	input *mergeJoinInput,
	batch coldata.Batch,
...
// buffered group.
func (o *mergeJoinInnerOp) setBuilderSourceToBufferedGroup(
	ctx context.Context,
) {
...
// accordingly.
func (o *mergeJoinInnerOp) calculateOutputCount(
	groups []group,
) uint16 {
