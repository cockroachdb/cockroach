...
// NewNotExprProjOp returns a new notExprProjOp if the underlying type
// family of the input expression is boolean. If the type family of
// the input expression is unknown, it returns a notNullProj operator.
...
// NewNotExprSelOp returns a new notExprSelOp if the underlying type
// family of the input expression is boolean. If the type family of
// the input expression is unknown, it returns a zero operator. Else,
// it throws an error
