...
func BenchmarkCompareSpecializedOperators(b *testing.B) {
	...
	batch := testAllocator.NewMemBatch([]colphystypes.T{colphystypes.Bytes, colphystypes.Int64, colphystypes.Int64, colphystypes.Bytes})
	...
	defaultOp := &defaultBuiltinFuncOperator{
		...
		outputPhysType: colphystypes.Bytes,
