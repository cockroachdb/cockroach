	...
	for _, spillForced := range []bool{false, true} {
		...
		for _, tc := range []windowFnTestCase{
			...
			},
			{
				tuples: colexectestutils.Tuples{{1, 7}, {1, 3}, {1, -5}, {2, nil}, {2, 0}, {3, 6}},
				expected: colexectestutils.Tuples{
					{1, 7, dec("1.6666666666666666666666666666666666667")}, {1, 3, dec("1.6666666666666666666666666666666666667")},
					{1, -5, dec("1.6666666666666666666666666666666666667")}, {2, nil, dec("0")},
					{2, 0, dec("0")}, {3, 6, dec("6.0000000000000000000000000000000000000")},
				},
				windowerSpec: execinfrapb.WindowerSpec{
					PartitionBy: []uint32{0},
					WindowFns: []execinfrapb.WindowerSpec_WindowFn{
			...
			},
			{
				tuples: colexectestutils.Tuples{{nil, 4}, {nil, -6}, {1, 2}, {1, nil}, {2, -3}, {3, 1}, {3, 7}},
				expected: colexectestutils.Tuples{
					{nil, 4, dec("-1.0000000000000000000000000000000000000")}, {nil, -6, dec("-1.0000000000000000000000000000000000000")},
					{1, 2, dec("0")}, {1, nil, dec("0")}, {2, -3, dec("-0.75000000000000000000000000000000000000")},
					{3, 1, dec("0.83333333333333333333333333333333333333")}, {3, 7, dec("0.83333333333333333333333333333333333333")}},
				windowerSpec: execinfrapb.WindowerSpec{
					WindowFns: []execinfrapb.WindowerSpec_WindowFn{
						{
							Func:         execinfrapb.WindowerSpec_Func{AggregateFunc: &avgFn},
			...
			},
			{
				...
				expected: colexectestutils.Tuples{
					{nil, nil, -10, dec("-3.0000000000000000000000000000000000000")}, {nil, nil, 4, dec("-3.0000000000000000000000000000000000000")},
					{nil, 1, 6, dec("0")}, {1, nil, 2, dec("2.0000000000000000000000000000000000000")},
					{1, 2, 5, dec("3.5000000000000000000000000000000000000")}, {2, 1, nil, nil},
					{3, 1, 8, dec("8.0000000000000000000000000000000000000")}, {3, 2, 1, dec("4.5000000000000000000000000000000000000")},
				},
				windowerSpec: execinfrapb.WindowerSpec{
					PartitionBy: []uint32{0},
					WindowFns: []execinfrapb.WindowerSpec_WindowFn{
			...
			},
			{
				tuples: colexectestutils.Tuples{{1}, {2}, {nil}, {4}, {nil}, {6}},
				expected: colexectestutils.Tuples{
					{1, dec("3.2500000000000000000000000000000000000")}, {2, dec("3.2500000000000000000000000000000000000")},
					{nil, dec("3.2500000000000000000000000000000000000")}, {4, dec("3.2500000000000000000000000000000000000")},
					{nil, dec("3.2500000000000000000000000000000000000")}, {6, dec("3.2500000000000000000000000000000000000")},
				},
				windowerSpec: execinfrapb.WindowerSpec{
					WindowFns: []execinfrapb.WindowerSpec_WindowFn{
						{
