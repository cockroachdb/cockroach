...
// firstValueComputeFields extracts the fields that are used to calculate firstValue
// output values.
type firstValueComputeFields struct {
	partitionSize int
	idx           int
}

// seekNextPartition implements the bufferedWindower interface.
func (b *firstValueBase) seekNextPartition(
