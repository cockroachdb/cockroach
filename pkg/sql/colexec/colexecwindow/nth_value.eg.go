...
// nthValueComputeFields extracts the fields that are used to calculate nthValue
// output values.
type nthValueComputeFields struct {
	partitionSize int
	idx           int
}

// seekNextPartition implements the bufferedWindower interface.
func (b *nthValueBase) seekNextPartition(
