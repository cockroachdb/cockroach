...
// lastValueComputeFields extracts the fields that are used to calculate lastValue
// output values.
type lastValueComputeFields struct {
	partitionSize int
	idx           int
}

// seekNextPartition implements the bufferedWindower interface.
func (b *lastValueBase) seekNextPartition(
