...
func NewLagOperator(
	...
	case types.INetFamily:
		...
		default:
			return newBufferedWindowOperator(
				args, &lagINetWindow{lagBase: base}, argType, mainMemLimit), nil
		}
...
type lagINetWindow struct {
	lagBase
}

var _ bufferedWindower = &lagINetWindow{}

func (w *lagINetWindow) processBatch(batch coldata.Batch, startIdx, endIdx int) {
	if startIdx >= endIdx {
		// No processing needs to be done for this portion of the current partition.
		return
	}
