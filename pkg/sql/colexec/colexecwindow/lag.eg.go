...
func NewLagOperator(
	...
	case types.EnumFamily:
		...
		default:
			return newBufferedWindowOperator(
				args, &lagEnumWindow{lagBase: base}, argType, mainMemLimit), nil
		}
...
type lagEnumWindow struct {
	lagBase
}

var _ bufferedWindower = &lagEnumWindow{}

func (w *lagEnumWindow) processBatch(batch coldata.Batch, startIdx, endIdx int) {
	if startIdx >= endIdx {
		// No processing needs to be done for this portion of the current partition.
		return
	}
