...
func getSlidingWindowIntervals(
	...
	for {
		...
		// each list, and iterate whichever index has the 'smaller' interval (e.g.)
		// whichever ends first. The portions of the intervals that overlap are
		// ignored, while those that don't are added to one of the 'toAdd' and
		// 'toRemove' sets.
