...
const (
	// nTileLoading is the state in which case the ntile operators load an
	// additional input batch into the currentBatch field. If necessary, the old
	// value of currentBatch will be pushed to the buffer queue.
	//
	...
	// nTileSeeking is the state in which case the ntile operators seek to the
	// index of the next partition and retrieve the number of ntile buckets for
	// the current partition, as well as the number of tuples in the partition.
	//
	...
	nTileSeeking
	// nTileProcessing is the state in which case the ntile operators fill in the
	...
	nTileProcessing
	// nTileFinished is the state in which case the ntile operators close any
