...
func runTestsWithTyps(
	...
	OUTER:
		...
		closeIfCloser(t, ctx, originalOp)
		closeIfCloser(t, ctx, opWithNulls)
	}
}
...
func closeIfCloser(t *testing.T, ctx context.Context, op colexecbase.Operator) {
