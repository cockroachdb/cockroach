...
func TestMergeJoiner(t *testing.T) {
	...
	tcs := []mjTestCase{
		...
		},
		{
			...
			leftTypes:    []phystypes.T{phystypes.Bool, phystypes.Int16, phystypes.Float64},
			rightTypes:   []phystypes.T{phystypes.Bool, phystypes.Int16, phystypes.Float64},
		...
		},
		{
			...
			leftTypes:    []phystypes.T{phystypes.Bool, phystypes.Int16, phystypes.Float64},
			rightTypes:   []phystypes.T{phystypes.Int16, phystypes.Float64, phystypes.Bool},
			leftTuples:   tuples{{false, int16(10), 1.2}, {true, int16(20), 2.2}, {true, int16(30), 3.2}},
		...
		},
		{
			...
			joinType:     sqlbase.JoinType_FULL_OUTER,
			leftTypes:    []phystypes.T{phystypes.Int64, phystypes.Bytes},
			rightTypes:   []phystypes.T{phystypes.Int64, phystypes.Bytes},
...
func newBatchesOfRandIntRows(
	nTuples int, typs []phystypes.T, maxRunLength int64, skipValues bool, randomIncrement int64,
