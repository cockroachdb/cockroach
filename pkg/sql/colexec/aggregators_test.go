...
var aggregatorsTestCases = []aggregatorTestCase{
	...
	},
	{
		...
		expected: colexectestutils.Tuples{
			{0, "1.5333333333333333333333333333333333333", 4.6},
			{1, "4.3200000000000000000000000000000000000", 8.64},
		},
		convToDecimal: true,
	},
	{
	...
	},
	{
		...
		expected: colexectestutils.Tuples{
			{0, 2, "2.1000000000000000000000000000000000000", 2, 4.2, 5, 2, 3, false, true, "zero", "zerozero"},
			{1, 2, "2.6000000000000000000000000000000000000", 2, 5.2, 1, 0, 1, false, false, "one", "oneone"},
			{2, 1, "1.1000000000000000000000000000000000000", 1, 1.1, 1, 1, 1, true, true, "two", "two"},
			{3, 2, "4.6000000000000000000000000000000000000", 2, 9.2, 0, 0, 0, false, true, "three", "threethree"},
		},
		convToDecimal: true,
	},
	{
		...
		expected: colexectestutils.Tuples{
			{nil, 1, 1.1, 1, 1.1, "1.1000000000000000000000000000000000000", 4, 4, 4, true, true, "a"},
			{0, 2, 3.1, 1, 3.1, "3.1000000000000000000000000000000000000", 5, 5, 5, nil, nil, "b"},
