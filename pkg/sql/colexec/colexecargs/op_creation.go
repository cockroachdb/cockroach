...
type NewColOperatorArgs struct {
	...
	// trees rooted in Inputs. If NewColOperator call creates a
	// colexec.Materializer, then it will take over the responsibility of
	// draining the sources; otherwise, they will be returned in
