...
func (op *spanEncoderBoolAsc) next(batch coldata.Batch) *coldata.Bytes {
	n := batch.Length()
	if n == 0 {
		return nil
	}
...
// next implements the spanEncoder interface.
func (op *spanEncoderBytesAsc) next(batch coldata.Batch) *coldata.Bytes {
	n := batch.Length()
	if n == 0 {
		return nil
	}
...
// next implements the spanEncoder interface.
func (op *spanEncoderDecimalAsc) next(batch coldata.Batch) *coldata.Bytes {
	n := batch.Length()
	if n == 0 {
		return nil
	}
...
// next implements the spanEncoder interface.
func (op *spanEncoderInt16Asc) next(batch coldata.Batch) *coldata.Bytes {
	n := batch.Length()
	if n == 0 {
		return nil
	}
...
// next implements the spanEncoder interface.
func (op *spanEncoderInt32Asc) next(batch coldata.Batch) *coldata.Bytes {
	n := batch.Length()
	if n == 0 {
		return nil
	}
...
// next implements the spanEncoder interface.
func (op *spanEncoderInt64Asc) next(batch coldata.Batch) *coldata.Bytes {
	n := batch.Length()
	if n == 0 {
		return nil
	}
...
// next implements the spanEncoder interface.
func (op *spanEncoderFloat64Asc) next(batch coldata.Batch) *coldata.Bytes {
	n := batch.Length()
	if n == 0 {
		return nil
	}
...
// next implements the spanEncoder interface.
func (op *spanEncoderTimestampAsc) next(batch coldata.Batch) *coldata.Bytes {
	n := batch.Length()
	if n == 0 {
		return nil
	}
...
// next implements the spanEncoder interface.
func (op *spanEncoderIntervalAsc) next(batch coldata.Batch) *coldata.Bytes {
	n := batch.Length()
	if n == 0 {
		return nil
	}
...
// next implements the spanEncoder interface.
func (op *spanEncoderDatumAsc) next(batch coldata.Batch) *coldata.Bytes {
	n := batch.Length()
	if n == 0 {
		return nil
	}
			...
			for _, i := range sel {
				{
					...
					var err error
					op.scratch, err = rowenc.EncodeTableKey(op.scratch, val.(*coldataext.Datum).Datum, encoding.Ascending)
					if err != nil {
						colexecerror.ExpectedError(err)
					}
...
// next implements the spanEncoder interface.
func (op *spanEncoderBoolDesc) next(batch coldata.Batch) *coldata.Bytes {
	n := batch.Length()
	if n == 0 {
		return nil
	}
...
// next implements the spanEncoder interface.
func (op *spanEncoderBytesDesc) next(batch coldata.Batch) *coldata.Bytes {
	n := batch.Length()
	if n == 0 {
		return nil
	}
...
// next implements the spanEncoder interface.
func (op *spanEncoderDecimalDesc) next(batch coldata.Batch) *coldata.Bytes {
	n := batch.Length()
	if n == 0 {
		return nil
	}
...
// next implements the spanEncoder interface.
func (op *spanEncoderInt16Desc) next(batch coldata.Batch) *coldata.Bytes {
	n := batch.Length()
	if n == 0 {
		return nil
	}
...
// next implements the spanEncoder interface.
func (op *spanEncoderInt32Desc) next(batch coldata.Batch) *coldata.Bytes {
	n := batch.Length()
	if n == 0 {
		return nil
	}
...
// next implements the spanEncoder interface.
func (op *spanEncoderInt64Desc) next(batch coldata.Batch) *coldata.Bytes {
	n := batch.Length()
	if n == 0 {
		return nil
	}
...
// next implements the spanEncoder interface.
func (op *spanEncoderFloat64Desc) next(batch coldata.Batch) *coldata.Bytes {
	n := batch.Length()
	if n == 0 {
		return nil
	}
...
// next implements the spanEncoder interface.
func (op *spanEncoderTimestampDesc) next(batch coldata.Batch) *coldata.Bytes {
	n := batch.Length()
	if n == 0 {
		return nil
	}
...
// next implements the spanEncoder interface.
func (op *spanEncoderIntervalDesc) next(batch coldata.Batch) *coldata.Bytes {
	n := batch.Length()
	if n == 0 {
		return nil
	}
...
// next implements the spanEncoder interface.
func (op *spanEncoderDatumDesc) next(batch coldata.Batch) *coldata.Bytes {
	n := batch.Length()
	if n == 0 {
		return nil
	}
			...
			for _, i := range sel {
				{
					...
					var err error
					op.scratch, err = rowenc.EncodeTableKey(op.scratch, val.(*coldataext.Datum).Datum, encoding.Descending)
					if err != nil {
						colexecerror.ExpectedError(err)
					}
