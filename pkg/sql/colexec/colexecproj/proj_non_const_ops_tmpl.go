...
func _SET_PROJECTION(_HAS_NULLS bool) {
	...
	//If nullableArgs is true and nullableArgs is true, the function’s definition
	//can handle null arguments. So there is no need to call projVec.SetNulls().
...
func _SET_SINGLE_TUPLE_PROJECTION(_HAS_NULLS bool, _HAS_SEL bool) { // */}}
	...
	// {{with $.Overload}}
	// {{if _HAS_NULLS}}
	if (!col1Nulls.NullAt(i) && !col2Nulls.NullAt(i)) || nullableArgs {
