...
type castFunc func(to, from, toCol, fromCol string) string
...
func (o *lastArgWidthOverload) Cast(to, from, toCol, fromCol string) string {
	if o.CastFunc != nil {
		if ret := o.CastFunc(to, from, toCol, fromCol); ret != "" {
			return ret
		}
	}
