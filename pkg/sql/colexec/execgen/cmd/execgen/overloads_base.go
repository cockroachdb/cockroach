...
func get(family types.Family, target, i string) string {
	switch family {
	case types.BytesFamily, types.AnyFamily:
...
func registerTypeCustomizers() {
	...
	registerTypeCustomizer(typePair{types.AnyFamily, anyWidth, types.AnyFamily, anyWidth}, datumCustomizer{})
