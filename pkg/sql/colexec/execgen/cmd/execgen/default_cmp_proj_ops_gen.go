...
func getDefaultCmpProjOps(targetPkg string, overload defaultCmpProjOpOverload) generator {
	return func(inputFileContents string, wr io.Writer) error {
		...
		tmpl, err = tmpl.Parse(fmt.Sprintf(defaultCmpProjTemplate, targetPkg))
		if err != nil {
			return err
		}
