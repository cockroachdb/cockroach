...
var typesToSortOverloads map[phystypes.T]map[bool]sortOverloads
...
func genSortOps(wr io.Writer) error {
	...
	s = strings.Replace(s, "_TYPES_T", "phystypes.{{$typ}}", -1)
...
func init() {
	...
	typesToSortOverloads = make(map[phystypes.T]map[bool]sortOverloads)
