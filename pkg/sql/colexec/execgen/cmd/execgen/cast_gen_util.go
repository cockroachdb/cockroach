...
func (i castToWidthTmplInfo) Set(col, idx, castV string) string {
	return set(typeconv.TypeFamilyToCanonicalTypeFamily(i.toType.Family()), col, idx, castV)
}
