...
func (*VectorizedStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_20e5efcd32b5659c, []int{0}
}
...
func (m *VectorizedStats) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VectorizedStats.Merge(m, src)
}
...
func init() { proto.RegisterFile("sql/colexec/execpb/stats.proto", fileDescriptor_20e5efcd32b5659c) }

var fileDescriptor_20e5efcd32b5659c = []byte{
...
func (m *VectorizedStats) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
