...
func (*VectorizedStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_stats_8eba052e4749a9f7, []int{0}
}
...
func init() {
	proto.RegisterFile("sql/colexec/execpb/stats.proto", fileDescriptor_stats_8eba052e4749a9f7)
}

var fileDescriptor_stats_8eba052e4749a9f7 = []byte{
