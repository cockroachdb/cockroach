...
func makeHashTable(
	...
	keepTypes := make([]phystypes.T, 0, nCols)
	...
	nKeys := len(eqCols)
	keyTypes := make([]phystypes.T, nKeys)
	...
	outTypes := make([]phystypes.T, nOutCols)
