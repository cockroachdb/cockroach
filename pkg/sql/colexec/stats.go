...
// StreamID 'id' (with 'idTagKey' distinguishing between the two). 'ioIncluded'
// indicates whether IO time is included in the time being measured.
func NewVectorizedStatsCollector(
	...
	return &VectorizedStatsCollector{
		Operator:             op,
		VectorizedStats:      execpb.VectorizedStats{ID: id, IoIncluded: ioIncluded},
		idTagKey:             idTagKey,
