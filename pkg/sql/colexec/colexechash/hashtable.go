...
type hashTableProbeBuffer struct {
	...
	// to the keyID of that match, then HashTable.Same slice is used to traverse
	// all equality matches for the given probing tuple.
	//
	...
	// matches i'th tuple. Since i'th tuple always matches itself (and possibly
