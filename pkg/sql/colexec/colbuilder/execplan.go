	...
	case *tree.ComparisonExpr:
		...
		if constArg, ok := t.Right.(tree.Datum); ok {
			...
			case tree.Like, tree.NotLike:
				...
				rightString, _ := tree.UnescapePattern(string(tree.MustBeDString(constArg)), `\`, false)
	...
	if lConstArg, lConst := left.(tree.Datum); lConst {
		...
		if rConstArg, rConst := right.(tree.Datum); rConst {
			...
			case tree.Like, tree.NotLike:
				...
				rightString, _ := tree.UnescapePattern(string(tree.MustBeDString(rConstArg)), `\`, false)
