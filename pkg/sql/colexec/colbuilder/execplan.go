...
func wrapRowSources(
	...
	var releaseables []execinfra.Releasable
...
func (r opResult) createAndWrapRowSource(
	...
	c, releseables, err := wrapRowSources(
		ctx,
		flowCtx,
		inputs,
		inputTypes,
	...
	r.Releasables = append(r.Releasables, releseables...)
	return nil
}
