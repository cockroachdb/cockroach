			...
			if args.TestingKnobs.DiskSpillingDisabled {
				...
				result.Op = newTwoInputDiskSpiller(
					...
					func(inputOne, inputTwo Operator) Operator {
						...
						diskQueueCfg.BufferSizeBytes = colcontainer.DefaultBufferSizeBytesReuseCacheMode
						return newExternalHashJoiner(allocator, hjSpec, inputOne, inputTwo, diskQueueCfg, args.FDSemaphore)
					},
