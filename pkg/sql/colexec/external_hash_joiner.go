...
const (
	...
	// input + 4 (2 for each spilling queue that the merge joiner uses). For
	...
	//   spillingQueues with 2 FDs each for a total of 4. Since each sorter will
	//   use externalSorterMinPartitions, the FDs used at this stage are 4 +
	//   (2 * externalSorterMinPartitions).
	externalHJMinPartitions = 4 + (externalSorterMinPartitions * 2)
)
