...
func NewSorter(
	...
	return newSorter(newAllSpooler(allocator, input, inputTypes), inputTypes, orderingCols)
}
...
func newAllSpooler(
	allocator coldata.BatchAllocator, input Operator, inputTypes []coltypes.T,
) spooler {
	return &allSpooler{
