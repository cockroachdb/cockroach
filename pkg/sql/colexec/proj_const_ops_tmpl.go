...
type defaultCmp_CONST_SIDEConstProjOp struct {
	projConstOpBase
...
var _ colexecbase.Operator = &defaultCmp_CONST_SIDEConstProjOp{}

func (d *defaultCmp_CONST_SIDEConstProjOp) Init() {
	d.input.Init()
}

func (d *defaultCmp_CONST_SIDEConstProjOp) Next(ctx context.Context) coldata.Batch {
