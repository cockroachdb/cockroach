...
func (ht *hashTable) checkCol(
	probeType, buildType coltypes.T, keyColIdx int, nToCheck uint64, sel []uint64,
) {
...
func (ht *hashTable) check(probeKeyTypes []coltypes.T, nToCheck uint64, sel []uint64) uint64 {
