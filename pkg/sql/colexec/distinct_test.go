...
func BenchmarkDistinct(b *testing.B) {
	...
	distinctConstructors := []func(*colexecbase.Allocator, colexecbase.Operator, []uint32, int, []types.T) (colexecbase.Operator, error){
		func(allocator *colexecbase.Allocator, input colexecbase.Operator, distinctCols []uint32, numOrderedCols int, typs []types.T) (colexecbase.Operator, error) {
