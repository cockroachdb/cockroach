...
var (
	...
	TablePrivileges       = List{ALL, BACKUP, CHANGEFEED, CREATE, DROP, SELECT, INSERT, DELETE, UPDATE, ZONECONFIG, TRIGGER, REPLICATIONDEST}
	...
	GlobalPrivileges   = List{
		...
		REPAIRCLUSTER, BYPASSRLS, REPLICATIONDEST,
	}
