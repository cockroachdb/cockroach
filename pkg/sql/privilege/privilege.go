...
const (
	...
	CHANGEFEED               Kind = 26
	MODIFYSQLCLUSTERSETTING  Kind = 27
)
...
var (
	...
	GlobalPrivileges             = List{ALL, BACKUP, RESTORE, MODIFYCLUSTERSETTING, EXTERNALCONNECTION, VIEWACTIVITY, VIEWACTIVITYREDACTED, VIEWCLUSTERSETTING, CANCELQUERY, NOSQLLOGIN, VIEWCLUSTERMETADATA, VIEWDEBUG, EXTERNALIOIMPLICITACCESS, MODIFYSQLCLUSTERSETTING}
