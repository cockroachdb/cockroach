...
var (
	...
	TablePrivileges       = List{ALL, BACKUP, CHANGEFEED, CREATE, DROP, SELECT, INSERT, DELETE, UPDATE, ZONECONFIG, TRIGGER, REPLICATIONSOURCE, REPLICATIONDEST}
	...
	GlobalPrivileges   = List{
		...
		REPAIRCLUSTER, BYPASSRLS, REPLICATIONSOURCE, REPLICATIONDEST,
	}
