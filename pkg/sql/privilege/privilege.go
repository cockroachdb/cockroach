...
var (
	...
	SystemPrivileges   = List{ALL, MODIFYCLUSTERSETTING, EXTERNALCONNECTION}
)
...
var ByValue = [...]Kind{
	ALL, CREATE, DROP, SELECT, INSERT, DELETE, UPDATE, USAGE, ZONECONFIG, CONNECT, RULE, MODIFYCLUSTERSETTING, EXTERNALCONNECTION, EXECUTE,
}
