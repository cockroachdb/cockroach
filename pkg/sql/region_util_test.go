	...
	testCases := []struct {
	...
	}{
		{
			...
			regionConfig: multiregion.MakeRegionConfig(catpb.RegionNames{
				...
				"region_a",
				"region_d",
			}, "region_b", descpb.SurvivalGoal_ZONE_FAILURE, validMultiRegionEnumID, descpb.DataPlacement_DEFAULT, []descpb.DatabaseDescriptor_SuperRegion{
				{
		...
		},
		{
			...
			regionConfig: multiregion.MakeRegionConfig(catpb.RegionNames{
				...
				"region_a",
				"region_d",
			}, "region_b", descpb.SurvivalGoal_REGION_FAILURE, validMultiRegionEnumID, descpb.DataPlacement_DEFAULT, []descpb.DatabaseDescriptor_SuperRegion{
				{
