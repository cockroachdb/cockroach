...
// isTableStatValid is a helper function that returns true if the input
// table statistic can be used as the base full statistic for a new partial
// statistic collection, for the specified column.
func isTableStatValid(column catalog.Column, t *stats.TableStatistic) bool {
