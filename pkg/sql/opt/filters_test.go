...
// TestDuplicateTableWithCheckConstraint tests that we can accurately duplicate the optimizer's
// representation check constraint filters when calling DuplicateTable.
