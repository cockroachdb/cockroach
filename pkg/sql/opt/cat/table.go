...
type Table interface {
	...
	// SkipRBRUniqueRowIDCrossRegionChecks returns true if cross-region uniqueness
	// checks should be skipped for columns generated by unique_rowid() or
	// unordered_unique_rowid() in REGIONAL BY ROW tables. Within-region checks
	// are still enforced when this is true.
