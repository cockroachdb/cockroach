...
// InitNonArtificial is used by catalog implementations to populate a
// non-artificial Column. It should not be used anywhere else.
func (c *Column) InitNonArtificial(
	ordinal int,
	stableID StableID,
	name tree.Name,
	kind ColumnKind,
