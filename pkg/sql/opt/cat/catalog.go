...
type Catalog interface {
	...
	// CheckPrivilegeForRoutineCreator is like CheckPrivilege, but specialized
	// to run the given privilege check on the creator of the routineOid.
	CheckPrivilegeForRoutineCreator(
