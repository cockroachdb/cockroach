...
type Index interface {
	...
	// InvertedOrdinal returns the ordinal of the VirtualInverted column of an
	// inverted index. An inverted index has exactly one VirtualInverted column.
	// Panics if the index is not an inverted index.
	InvertedOrdinal() int
