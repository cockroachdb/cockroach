...
const (
	...
	// listOp is an operator used to combine auxiliary expressions of the same
	// type.  For example, multiple filters can be implicitly AND'ed together
	// using a listOp (i.e. they are in conjunctive normal form).
	listOp
