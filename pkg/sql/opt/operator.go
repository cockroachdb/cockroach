...
// OperatorTransmitsNulls returns true if the given operator always returns NULL
// when at least one of its inputs is NULL.
func OperatorTransmitsNulls(op Operator) bool {
	switch op {
