...
var AggregateOpReverseMap = map[Operator]string{
	...
	ArrayUnnestAggOp:      "array_unnest_agg",
	AvgOp:                 "avg",
	BitAndAggOp:           "bit_and",
	BitOrAggOp:            "bit_or",
	BoolAndOp:             "bool_and",
...
func AggregateIgnoresNulls(op Operator) bool {
	...
	case ArrayAggOp, ArrayUnnestAggOp, ConcatAggOp, ConstAggOp, CountRowsOp,
...
func AggregateIsNullOnEmpty(op Operator) bool {
	...
	case AnyNotNullAggOp, ArrayAggOp, ArrayUnnestAggOp, AvgOp, BitAndAggOp,
...
func AggregatesCanMerge(inner, outer Operator) bool {
	...
	case ArrayAggOp, ArrayUnnestAggOp, AvgOp, ConcatAggOp, CorrOp, JsonAggOp, JsonbAggOp,
...
func AggregateIgnoresDuplicates(op Operator) bool {
	...
	case ArrayAggOp, ArrayUnnestAggOp, AvgOp, ConcatAggOp, CountOp, CorrOp, CountRowsOp,
