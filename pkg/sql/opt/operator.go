...
var AggregateOpReverseMap = map[Operator]string{
	...
	AvgOp:             "avg",
	BitAndAggregateOp: "bit_and",
	BitOrAggregateOp:  "bit_or",
	BoolAndOp:         "bool_and",
	BoolOrOp:          "bool_or",
...
func AggregateIgnoresNulls(op Operator) bool {
	switch op {
	case AvgOp, BitAndAggregateOp, BitOrAggregateOp, BoolAndOp, BoolOrOp, CountOp, MaxOp, MinOp,
...
func AggregateIsNullOnEmpty(op Operator) bool {
	switch op {
	case AvgOp, BitAndAggregateOp, BitOrAggregateOp, BoolAndOp, BoolOrOp, MaxOp, MinOp, SumIntOp,
