...
//
// The remaining filters are identical to the input filters, but any part that
// matches the predicate expression are removed. This reduces the complexity of
// the filters, allow any columns that are referenced only in the filters to be
// pruned from the query plan.
//
