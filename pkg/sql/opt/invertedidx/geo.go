...
// function represented by expr, with args. The second arg is checked to be
// the one corresponding to the indexed column and all args after the second
// are checked to be constant. The returned relationship includes the effect
// of commuteArgs.
// REQUIRES: the function has at least to args.
