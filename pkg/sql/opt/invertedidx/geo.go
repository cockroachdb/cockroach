...
// and getSpanExprForGeometryIndex and used in extractInvertedFilterCondition.
...
func (g *geoFilterPlanner) extractInvertedFilterConditionFromLeaf(
	...
	// We can never guarantee that the spans produced for a geospatial inverted
	// index will have no duplicates, so return noDuplicates=false.
	return invertedExpr, pfState, false /* noDuplicates */
}
