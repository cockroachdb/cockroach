...
// geoDatumToInvertedExpr implements invertedexpr.DatumsToInvertedExpr for
// geospatial columns.
...
var _ invertedexpr.DatumsToInvertedExpr = &geoDatumToInvertedExpr{}
var _ tree.IndexedVarContainer = &geoDatumToInvertedExpr{}

// IndexedVarEval is part of the IndexedVarContainer interface.
func (g *geoDatumToInvertedExpr) IndexedVarEval(
...
func (g *geoDatumToInvertedExpr) IndexedVarResolvedType(idx int) *types.T {
	return g.colTypes[idx]
}

// IndexedVarNodeFormatter is part of the IndexedVarContainer interface.
func (g *geoDatumToInvertedExpr) IndexedVarNodeFormatter(idx int) tree.NodeFormatter {
