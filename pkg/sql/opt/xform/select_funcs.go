...
//   2) optionalFilters does not involve any index key columns.
...
func (c *CustomFuncs) MakeCombinedFiltersConstraint(
	...
	optionalFiltersColumns opt.ColSet,
) (
	...
	if !optionalFiltersColumns.Contains(firstIndexCol) &&
		indexColumns.Intersects(optionalFiltersColumns) {
