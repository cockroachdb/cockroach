...
func TestLogicalScanProps(t *testing.T) {
	...
	expected := "columns: a.x:null:1 a.y:2\n"
...
func TestLogicalProjectProps(t *testing.T) {
	...
	expected := "columns: b.z:null:2 false:3\n"
...
func TestLogicalJoinProps(t *testing.T) {
	...
	joinFunc(InnerJoinOp, "columns: a.x:null:1 a.y:2 b.x:null:3 b.z:null:4\n")
	joinFunc(InnerJoinApplyOp, "columns: a.x:null:1 a.y:2 b.x:null:3 b.z:null:4\n")
	joinFunc(LeftJoinOp, "columns: a.x:null:1 a.y:2 b.x:3 b.z:4\n")
	joinFunc(LeftJoinApplyOp, "columns: a.x:null:1 a.y:2 b.x:3 b.z:4\n")
	joinFunc(RightJoinOp, "columns: a.x:1 a.y:2 b.x:null:3 b.z:null:4\n")
	joinFunc(RightJoinApplyOp, "columns: a.x:1 a.y:2 b.x:null:3 b.z:null:4\n")
	joinFunc(FullJoinOp, "columns: a.x:1 a.y:2 b.x:3 b.z:4\n")
	joinFunc(FullJoinApplyOp, "columns: a.x:1 a.y:2 b.x:3 b.z:4\n")
	joinFunc(SemiJoinOp, "columns: a.x:null:1 a.y:2\n")
	joinFunc(SemiJoinApplyOp, "columns: a.x:null:1 a.y:2\n")
	joinFunc(AntiJoinOp, "columns: a.x:null:1 a.y:2\n")
	joinFunc(AntiJoinApplyOp, "columns: a.x:null:1 a.y:2\n")
}
...
func TestLogicalSetProps(t *testing.T) {
	...
	expected := "columns: b.x:3 b.z:null:4\n"
