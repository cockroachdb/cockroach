...
// optStateAlloc allocates pages of optState structs. This is preferable to a
// slice of optState structs because pointers are not invalidated when a resize
