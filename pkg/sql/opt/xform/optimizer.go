...
type Optimizer struct {
	...
	// cluster is the object that's used to get information about neighborhoods
	// where data is stored in the cluster.
...
func (o *Optimizer) Init(evalCtx *tree.EvalContext, catalog cat.Catalog, cluster cluster.Info) {
	o.evalCtx = evalCtx
	o.catalog = catalog
	o.cluster = cluster
	o.f.Init(evalCtx, catalog, cluster)
	o.mem = o.f.Memo()
	o.explorer.init(o)
	o.defaultCoster.Init(evalCtx, o.mem, o.cluster, evalCtx.TestingKnobs.OptimizerCostPerturbation)
...
func (o *Optimizer) DetachMemo() *memo.Memo {
	...
	o.Init(o.evalCtx, o.catalog, o.cluster)
	return detach
}
...
func (o *Optimizer) RecomputeCost() {
	var c coster
	c.Init(o.evalCtx, o.mem, o.cluster, 0 /* perturbation */)
