...
// DisableOptimizations disables all transformation rules, including normalizer
...
func (o *Optimizer) DisableOptimizations() {
	o.OnRuleMatch(func(opt.RuleName) bool { return false })
}

// OnRuleMatch sets a callback function which is invoked each time an
...
func (o *Optimizer) OnRuleMatch(onRuleMatch func(ruleName opt.RuleName) bool) {
	o.onRuleMatch = onRuleMatch

	// Also pass through the call to the factory so that normalization rules
	// make same callback.
	o.f.OnRuleMatch(onRuleMatch)
}
