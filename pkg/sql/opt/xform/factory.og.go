...
func (_f *factory) ConstructProject(
	...
	// [FilterUnusedLimitCols]
	{
		...
		if _limit != nil {
			...
			if _f.hasUnusedColumns(input, _f.projAndOrderingNeededCols(projections, ordering)) {
				_f.reportOptimization()
				_group = _f.ConstructProject(_f.ConstructLimit(_f.filterUnusedColumns(input, _f.projAndOrderingNeededCols(projections, ordering)), limit, ordering), projections)
				_f.mem.addAltFingerprint(_projectExpr.fingerprint(), _group)
				return _group
			}
		}
	...
	// [FilterUnusedOffsetCols]
	{
		...
		if _offset != nil {
			...
			if _f.hasUnusedColumns(input, _f.projAndOrderingNeededCols(projections, ordering)) {
				_f.reportOptimization()
				_group = _f.ConstructProject(_f.ConstructOffset(_f.filterUnusedColumns(input, _f.projAndOrderingNeededCols(projections, ordering)), offset, ordering), projections)
				_f.mem.addAltFingerprint(_projectExpr.fingerprint(), _group)
				return _group
			}
		}
