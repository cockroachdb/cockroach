...
// CanMaybeGenerateLocalityOptimizedSearch performs precondition checks to see
// if generating a locality-optimized search of lookup joins is legal, and
// returns the input scan if the join input is a canonical scan or select
// from a canonical scan. It also returns the input filters, if any, and ok=true
// if all checks passed.
func (c *CustomFuncs) CanMaybeGenerateLocalityOptimizedSearch(
