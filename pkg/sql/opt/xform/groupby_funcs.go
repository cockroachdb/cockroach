...
// aggregate expressions (aggs) and a ScanExpr (input) into
...
// consists of two or more MIN or MAX expressions on variable
// expressions with no other type of aggregate function.
//
