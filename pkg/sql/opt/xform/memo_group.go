...
// for each pair of (required property set, best expression).
// NOTE: The bestExpr references passed to the function are only valid until
//       the next call to ensureBestExpr, which may cause a resize of the
//       bestExprs slice.
