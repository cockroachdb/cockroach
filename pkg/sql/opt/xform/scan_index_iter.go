...
const (
	...
	// rejectNoIndexes includes all indexes during iteration.
...
//
//   iter := newScanIndexIter(mem, scanPrivate, rejectNoIndexes)
//   for iter.next() {
//     index := iter.index
...
// newScanIndexIter returns an initialized scanIndexIter.
//
// The rejectFlags determine which types of indexes to skip when iterating.
func newScanIndexIter(
...
//
// The rejectFlags set in newScanIndexIter determine which indexes to skip when
// iterating, if any.
//
