...
func TestLocalityMatchScore(t *testing.T) {
	testCases := []struct {
		...
		{locality: "region=us,dc=east", constraints: "[+region=eu,+dc=east]", expected: 0.5},
		...
		{locality: "region=us,dc=east", constraints: "[+region=eu,+dc=east,+region=us]", expected: 1.0},
		...
		{locality: "region=us,dc=east", constraints: `{"+region=us,+dc=east":3,"+region=eu,+dc=east":2}`, expected: 0.5},
		{locality: "region=us,dc=east", constraints: `{"+region=us,+dc=east":3,"+region=us":2}`, expected: 0.5},
		{locality: "region=us,dc=east", constraints: `{"+region=us,+dc=east":3,"+dc=east":2}`, expected: 1.0},
