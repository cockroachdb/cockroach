...
func (c *CustomFuncs) SplitScanIntoUnionScans(
	...
	cons := c.getKnownScanConstraint(sp)
	if cons == nil {
...
// constraints.
func (c *CustomFuncs) getKnownScanConstraint(sp *memo.ScanPrivate) *constraint.Constraint {
	var cons *constraint.Constraint
	if sp.InvertedConstraint != nil {
		// This is an inverted Scan.
		return nil
	}
