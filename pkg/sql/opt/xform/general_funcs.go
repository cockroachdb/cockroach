...
func (c *CustomFuncs) splitScanIntoUnionScansOrSelects(
	...
	// first index column exist, use that to find the number for maxScanCount. Is
	// there a more efficient way to represent this plan when # of scans is high,
	// for example, introduce new operation types like "SkipScanExpr",
	// "SkipSelectExpr", "LooseScanExpr", "LooseSelectExpr" (see
	...
	//
	// We may want to lift this max entirely at some point.
	maxScanCount := 256
