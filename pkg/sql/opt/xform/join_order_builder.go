...
const (
	// invalid indicates that the transformation represented by the table entry is
	// unconditionally incorrect.
	invalid lookupTableEntry = 0

	// correct indicates that the transformation represented by the table entry is
	// unconditionally correct.
	correct lookupTableEntry = 1 << (iota - 1)
	...
	// entry1 indicates that the filters of operator "B" must reject nulls on the
	// relations of the right input of operator "A".
	entry1 = filterB | rejectsOnRightA

	// entry2 indicates that the filters of operators "A" and "B" must reject
	// nulls on the relations of the right input of operator "A".
	entry2 = (filterA | filterB) | rejectsOnRightA

	// entry3 indicates that the filters of operator "A" must reject nulls on the
	// relations of the left input of operator "A".
	entry3 = filterA | rejectsOnLeftA

	// entry4 indicates that the filters of operator "B" must reject nulls on the
	// relations of the right input of operator "B".
	entry4 = filterB | rejectsOnRightB

	// entry5 indicates that the filters of operators "A" and "B" must reject
	// nulls on the relations of the left input of operator "A".
	entry5 = (filterA | filterB) | rejectsOnLeftA

	// entry6 indicates that the filters of operators "A" and "B" must reject
	// nulls on the relations of the right input of operator "B".
	entry6 = (filterA | filterB) | rejectsOnRightB
)
...
var assocTable = [5][5]lookupTableEntry{
	...
	/* inner-A */ {correct, correct, correct, correct, invalid},
	/* semi-A  */ {invalid, invalid, invalid, invalid, invalid},
	/* anti-A  */ {invalid, invalid, invalid, invalid, invalid},
	/* left-A  */ {invalid, invalid, invalid, entry1, invalid},
	/* full-A  */ {invalid, invalid, invalid, entry1, entry2},
}
...
var leftAsscomTable = [5][5]lookupTableEntry{
	//             inner-B  semi-B   anti-B   left-B   full-B
	/* inner-A */ {correct, correct, correct, correct, invalid},
	/* semi-A  */ {correct, correct, correct, correct, invalid},
	/* anti-A  */ {correct, correct, correct, correct, invalid},
	/* left-A  */ {correct, correct, correct, correct, entry3},
	/* full-A  */ {invalid, invalid, invalid, entry4, entry5},
}
...
var rightAsscomTable = [5][5]lookupTableEntry{
	//             inner-B  semi-B   anti-B   left-B   full-B
	/* inner-A */ {correct, invalid, invalid, invalid, invalid},
	/* semi-A  */ {invalid, invalid, invalid, invalid, invalid},
	/* anti-A  */ {invalid, invalid, invalid, invalid, invalid},
	/* left-A  */ {invalid, invalid, invalid, invalid, invalid},
	/* full-A  */ {invalid, invalid, invalid, invalid, entry6},
}
