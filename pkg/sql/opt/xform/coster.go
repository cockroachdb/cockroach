...
var (
	...
	SmallDistributeCost = memo.Cost{Cost: randIOCostFactor}
	...
	DistributeCost = memo.Cost{Cost: 200}
...
var fnCost = map[string]memo.Cost{
	"st_3dclosestpoint":           {Cost: 1000 * cpuCostFactor},
	"st_3ddfullywithin":           {Cost: 10000 * cpuCostFactor},
	"st_3ddistance":               {Cost: 1000 * cpuCostFactor},
	"st_3ddwithin":                {Cost: 10000 * cpuCostFactor},
	"st_3dintersects":             {Cost: 10000 * cpuCostFactor},
	"st_3dlength":                 {Cost: 100 * cpuCostFactor},
	"st_3dlongestline":            {Cost: 1000 * cpuCostFactor},
	"st_3dmakebox":                {Cost: 100 * cpuCostFactor},
	"st_3dmaxdistance":            {Cost: 1000 * cpuCostFactor},
	"st_3dperimeter":              {Cost: 100 * cpuCostFactor},
	"st_3dshortestline":           {Cost: 1000 * cpuCostFactor},
	"st_addmeasure":               {Cost: 1000 * cpuCostFactor},
	"st_addpoint":                 {Cost: 100 * cpuCostFactor},
	"st_affine":                   {Cost: 100 * cpuCostFactor},
	"st_angle":                    {Cost: 100 * cpuCostFactor},
	"st_area":                     {Cost: 100 * cpuCostFactor},
	"st_area2d":                   {Cost: 100 * cpuCostFactor},
	"st_asbinary":                 {Cost: 100 * cpuCostFactor},
	"st_asencodedpolyline":        {Cost: 100 * cpuCostFactor},
	"st_asewkb":                   {Cost: 100 * cpuCostFactor},
	"st_asewkt":                   {Cost: 100 * cpuCostFactor},
	"st_asgeojson":                {Cost: 100 * cpuCostFactor},
	"st_asgml":                    {Cost: 100 * cpuCostFactor},
	"st_ashexewkb":                {Cost: 100 * cpuCostFactor},
	"st_askml":                    {Cost: 100 * cpuCostFactor},
	"st_aslatlontext":             {Cost: 100 * cpuCostFactor},
	"st_assvg":                    {Cost: 100 * cpuCostFactor},
	"st_asmvtgeom":                {Cost: 100 * cpuCostFactor},
	"st_astext":                   {Cost: 100 * cpuCostFactor},
	"st_astwkb":                   {Cost: 1000 * cpuCostFactor},
	"st_asx3d":                    {Cost: 100 * cpuCostFactor},
	"st_azimuth":                  {Cost: 100 * cpuCostFactor},
	"st_bdmpolyfromtext":          {Cost: 100 * cpuCostFactor},
	"st_bdpolyfromtext":           {Cost: 100 * cpuCostFactor},
	"st_boundary":                 {Cost: 1000 * cpuCostFactor},
	"st_boundingdiagonal":         {Cost: 100 * cpuCostFactor},
	"st_box2dfromgeohash":         {Cost: 1000 * cpuCostFactor},
	"st_buffer":                   {Cost: 100 * cpuCostFactor},
	"st_buildarea":                {Cost: 10000 * cpuCostFactor},
	"st_centroid":                 {Cost: 100 * cpuCostFactor},
	"st_chaikinsmoothing":         {Cost: 10000 * cpuCostFactor},
	"st_cleangeometry":            {Cost: 10000 * cpuCostFactor},
	"st_clipbybox2d":              {Cost: 10000 * cpuCostFactor},
	"st_closestpoint":             {Cost: 1000 * cpuCostFactor},
	"st_closestpointofapproach":   {Cost: 10000 * cpuCostFactor},
	"st_clusterdbscan":            {Cost: 10000 * cpuCostFactor},
	"st_clusterintersecting":      {Cost: 10000 * cpuCostFactor},
	"st_clusterkmeans":            {Cost: 10000 * cpuCostFactor},
	"st_clusterwithin":            {Cost: 10000 * cpuCostFactor},
	"st_collectionextract":        {Cost: 100 * cpuCostFactor},
	"st_collectionhomogenize":     {Cost: 100 * cpuCostFactor},
	"st_concavehull":              {Cost: 10000 * cpuCostFactor},
	"st_contains":                 {Cost: 10000 * cpuCostFactor},
	"st_containsproperly":         {Cost: 10000 * cpuCostFactor},
	"st_convexhull":               {Cost: 10000 * cpuCostFactor},
	"st_coorddim":                 {Cost: 100 * cpuCostFactor},
	"st_coveredby":                {Cost: 100 * cpuCostFactor},
	"st_covers":                   {Cost: 100 * cpuCostFactor},
	"st_cpawithin":                {Cost: 10000 * cpuCostFactor},
	"st_createtopogeo":            {Cost: 100 * cpuCostFactor},
	"st_crosses":                  {Cost: 10000 * cpuCostFactor},
	"st_curvetoline":              {Cost: 10000 * cpuCostFactor},
	"st_delaunaytriangles":        {Cost: 10000 * cpuCostFactor},
	"st_dfullywithin":             {Cost: 10000 * cpuCostFactor},
	"st_difference":               {Cost: 10000 * cpuCostFactor},
	"st_dimension":                {Cost: 100 * cpuCostFactor},
	"st_disjoint":                 {Cost: 10000 * cpuCostFactor},
	"st_distance":                 {Cost: 100 * cpuCostFactor},
	"st_distancecpa":              {Cost: 10000 * cpuCostFactor},
	"st_distancesphere":           {Cost: 100 * cpuCostFactor},
	"st_distancespheroid":         {Cost: 1000 * cpuCostFactor},
	"st_dump":                     {Cost: 1000 * cpuCostFactor},
	"st_dumppoints":               {Cost: 100 * cpuCostFactor},
	"st_dumprings":                {Cost: 1000 * cpuCostFactor},
	"st_dwithin":                  {Cost: 100 * cpuCostFactor},
	"st_endpoint":                 {Cost: 100 * cpuCostFactor},
	"st_envelope":                 {Cost: 100 * cpuCostFactor},
	"st_equals":                   {Cost: 10000 * cpuCostFactor},
	"st_expand":                   {Cost: 100 * cpuCostFactor},
	"st_exteriorring":             {Cost: 100 * cpuCostFactor},
	"st_filterbym":                {Cost: 1000 * cpuCostFactor},
	"st_findextent":               {Cost: 100 * cpuCostFactor},
	"st_flipcoordinates":          {Cost: 1000 * cpuCostFactor},
	"st_force2d":                  {Cost: 100 * cpuCostFactor},
	"st_force3d":                  {Cost: 100 * cpuCostFactor},
	"st_force3dm":                 {Cost: 100 * cpuCostFactor},
	"st_force3dz":                 {Cost: 100 * cpuCostFactor},
	"st_force4d":                  {Cost: 100 * cpuCostFactor},
	"st_forcecollection":          {Cost: 100 * cpuCostFactor},
	"st_forcecurve":               {Cost: 1000 * cpuCostFactor},
	"st_forcepolygonccw":          {Cost: 100 * cpuCostFactor},
	"st_forcepolygoncw":           {Cost: 1000 * cpuCostFactor},
	"st_forcerhr":                 {Cost: 1000 * cpuCostFactor},
	"st_forcesfs":                 {Cost: 1000 * cpuCostFactor},
	"st_frechetdistance":          {Cost: 10000 * cpuCostFactor},
	"st_generatepoints":           {Cost: 10000 * cpuCostFactor},
	"st_geogfromtext":             {Cost: 100 * cpuCostFactor},
	"st_geogfromwkb":              {Cost: 100 * cpuCostFactor},
	"st_geographyfromtext":        {Cost: 100 * cpuCostFactor},
	"st_geohash":                  {Cost: 1000 * cpuCostFactor},
	"st_geomcollfromtext":         {Cost: 100 * cpuCostFactor},
	"st_geomcollfromwkb":          {Cost: 100 * cpuCostFactor},
	"st_geometricmedian":          {Cost: 10000 * cpuCostFactor},
	"st_geometryfromtext":         {Cost: 1000 * cpuCostFactor},
	"st_geometryn":                {Cost: 100 * cpuCostFactor},
	"st_geometrytype":             {Cost: 100 * cpuCostFactor},
	"st_geomfromewkb":             {Cost: 100 * cpuCostFactor},
	"st_geomfromewkt":             {Cost: 100 * cpuCostFactor},
	"st_geomfromgeohash":          {Cost: 1000 * cpuCostFactor},
	"st_geomfromgeojson":          {Cost: 1000 * cpuCostFactor},
	"st_geomfromgml":              {Cost: 100 * cpuCostFactor},
	"st_geomfromkml":              {Cost: 1000 * cpuCostFactor},
	"st_geomfromtext":             {Cost: 1000 * cpuCostFactor},
	"st_geomfromtwkb":             {Cost: 100 * cpuCostFactor},
	"st_geomfromwkb":              {Cost: 100 * cpuCostFactor},
	"st_gmltosql":                 {Cost: 100 * cpuCostFactor},
	"st_hasarc":                   {Cost: 100 * cpuCostFactor},
	"st_hausdorffdistance":        {Cost: 10000 * cpuCostFactor},
	"st_inittopogeo":              {Cost: 100 * cpuCostFactor},
	"st_interiorringn":            {Cost: 100 * cpuCostFactor},
	"st_interpolatepoint":         {Cost: 1000 * cpuCostFactor},
	"st_intersection":             {Cost: 100 * cpuCostFactor},
	"st_intersects":               {Cost: 100 * cpuCostFactor},
	"st_isclosed":                 {Cost: 100 * cpuCostFactor},
	"st_iscollection":             {Cost: 1000 * cpuCostFactor},
	"st_isempty":                  {Cost: 100 * cpuCostFactor},
	"st_ispolygonccw":             {Cost: 100 * cpuCostFactor},
	"st_ispolygoncw":              {Cost: 100 * cpuCostFactor},
	"st_isring":                   {Cost: 1000 * cpuCostFactor},
	"st_issimple":                 {Cost: 1000 * cpuCostFactor},
	"st_isvalid":                  {Cost: 100 * cpuCostFactor},
	"st_isvaliddetail":            {Cost: 10000 * cpuCostFactor},
	"st_isvalidreason":            {Cost: 100 * cpuCostFactor},
	"st_isvalidtrajectory":        {Cost: 10000 * cpuCostFactor},
	"st_length":                   {Cost: 100 * cpuCostFactor},
	"st_length2d":                 {Cost: 100 * cpuCostFactor},
	"st_length2dspheroid":         {Cost: 1000 * cpuCostFactor},
	"st_lengthspheroid":           {Cost: 1000 * cpuCostFactor},
	"st_linecrossingdirection":    {Cost: 10000 * cpuCostFactor},
	"st_linefromencodedpolyline":  {Cost: 1000 * cpuCostFactor},
	"st_linefrommultipoint":       {Cost: 100 * cpuCostFactor},
	"st_linefromtext":             {Cost: 100 * cpuCostFactor},
	"st_linefromwkb":              {Cost: 100 * cpuCostFactor},
	"st_lineinterpolatepoint":     {Cost: 1000 * cpuCostFactor},
	"st_lineinterpolatepoints":    {Cost: 1000 * cpuCostFactor},
	"st_linelocatepoint":          {Cost: 1000 * cpuCostFactor},
	"st_linemerge":                {Cost: 10000 * cpuCostFactor},
	"st_linestringfromwkb":        {Cost: 100 * cpuCostFactor},
	"st_linesubstring":            {Cost: 1000 * cpuCostFactor},
	"st_linetocurve":              {Cost: 10000 * cpuCostFactor},
	"st_locatealong":              {Cost: 1000 * cpuCostFactor},
	"st_locatebetween":            {Cost: 1000 * cpuCostFactor},
	"st_locatebetweenelevations":  {Cost: 1000 * cpuCostFactor},
	"st_longestline":              {Cost: 100 * cpuCostFactor},
	"st_makeenvelope":             {Cost: 100 * cpuCostFactor},
	"st_makeline":                 {Cost: 100 * cpuCostFactor},
	"st_makepoint":                {Cost: 100 * cpuCostFactor},
	"st_makepointm":               {Cost: 100 * cpuCostFactor},
	"st_makepolygon":              {Cost: 100 * cpuCostFactor},
	"st_makevalid":                {Cost: 10000 * cpuCostFactor},
	"st_maxdistance":              {Cost: 100 * cpuCostFactor},
	"st_memsize":                  {Cost: 100 * cpuCostFactor},
	"st_minimumboundingcircle":    {Cost: 10000 * cpuCostFactor},
	"st_minimumboundingradius":    {Cost: 10000 * cpuCostFactor},
	"st_minimumclearance":         {Cost: 10000 * cpuCostFactor},
	"st_minimumclearanceline":     {Cost: 10000 * cpuCostFactor},
	"st_mlinefromtext":            {Cost: 100 * cpuCostFactor},
	"st_mlinefromwkb":             {Cost: 100 * cpuCostFactor},
	"st_mpointfromtext":           {Cost: 100 * cpuCostFactor},
	"st_mpointfromwkb":            {Cost: 100 * cpuCostFactor},
	"st_mpolyfromtext":            {Cost: 100 * cpuCostFactor},
	"st_mpolyfromwkb":             {Cost: 100 * cpuCostFactor},
	"st_multi":                    {Cost: 100 * cpuCostFactor},
	"st_multilinefromwkb":         {Cost: 100 * cpuCostFactor},
	"st_multilinestringfromtext":  {Cost: 100 * cpuCostFactor},
	"st_multipointfromtext":       {Cost: 100 * cpuCostFactor},
	"st_multipointfromwkb":        {Cost: 100 * cpuCostFactor},
	"st_multipolyfromwkb":         {Cost: 100 * cpuCostFactor},
	"st_multipolygonfromtext":     {Cost: 100 * cpuCostFactor},
	"st_node":                     {Cost: 10000 * cpuCostFactor},
	"st_normalize":                {Cost: 100 * cpuCostFactor},
	"st_npoints":                  {Cost: 100 * cpuCostFactor},
	"st_nrings":                   {Cost: 100 * cpuCostFactor},
	"st_numgeometries":            {Cost: 100 * cpuCostFactor},
	"st_numinteriorring":          {Cost: 100 * cpuCostFactor},
	"st_numinteriorrings":         {Cost: 100 * cpuCostFactor},
	"st_numpatches":               {Cost: 100 * cpuCostFactor},
	"st_numpoints":                {Cost: 100 * cpuCostFactor},
	"st_offsetcurve":              {Cost: 10000 * cpuCostFactor},
	"st_orderingequals":           {Cost: 10000 * cpuCostFactor},
	"st_orientedenvelope":         {Cost: 10000 * cpuCostFactor},
	"st_overlaps":                 {Cost: 10000 * cpuCostFactor},
	"st_patchn":                   {Cost: 100 * cpuCostFactor},
	"st_perimeter":                {Cost: 100 * cpuCostFactor},
	"st_perimeter2d":              {Cost: 100 * cpuCostFactor},
	"st_point":                    {Cost: 100 * cpuCostFactor},
	"st_pointfromgeohash":         {Cost: 1000 * cpuCostFactor},
	"st_pointfromtext":            {Cost: 100 * cpuCostFactor},
	"st_pointfromwkb":             {Cost: 100 * cpuCostFactor},
	"st_pointinsidecircle":        {Cost: 1000 * cpuCostFactor},
	"st_pointn":                   {Cost: 100 * cpuCostFactor},
	"st_pointonsurface":           {Cost: 1000 * cpuCostFactor},
	"st_points":                   {Cost: 1000 * cpuCostFactor},
	"st_polyfromtext":             {Cost: 100 * cpuCostFactor},
	"st_polyfromwkb":              {Cost: 100 * cpuCostFactor},
	"st_polygon":                  {Cost: 100 * cpuCostFactor},
	"st_polygonfromtext":          {Cost: 100 * cpuCostFactor},
	"st_polygonfromwkb":           {Cost: 100 * cpuCostFactor},
	"st_polygonize":               {Cost: 10000 * cpuCostFactor},
	"st_project":                  {Cost: 1000 * cpuCostFactor},
	"st_quantizecoordinates":      {Cost: 1000 * cpuCostFactor},
	"st_relate":                   {Cost: 10000 * cpuCostFactor},
	"st_relatematch":              {Cost: 1000 * cpuCostFactor},
	"st_removepoint":              {Cost: 100 * cpuCostFactor},
	"st_removerepeatedpoints":     {Cost: 1000 * cpuCostFactor},
	"st_reverse":                  {Cost: 1000 * cpuCostFactor},
	"st_rotate":                   {Cost: 100 * cpuCostFactor},
	"st_rotatex":                  {Cost: 100 * cpuCostFactor},
	"st_rotatey":                  {Cost: 100 * cpuCostFactor},
	"st_rotatez":                  {Cost: 100 * cpuCostFactor},
	"st_scale":                    {Cost: 100 * cpuCostFactor},
	"st_segmentize":               {Cost: 1000 * cpuCostFactor},
	"st_seteffectivearea":         {Cost: 1000 * cpuCostFactor},
	"st_setpoint":                 {Cost: 100 * cpuCostFactor},
	"st_setsrid":                  {Cost: 100 * cpuCostFactor},
	"st_sharedpaths":              {Cost: 10000 * cpuCostFactor},
	"st_shortestline":             {Cost: 1000 * cpuCostFactor},
	"st_simplify":                 {Cost: 100 * cpuCostFactor},
	"st_simplifypreservetopology": {Cost: 10000 * cpuCostFactor},
	"st_simplifyvw":               {Cost: 10000 * cpuCostFactor},
	"st_snap":                     {Cost: 10000 * cpuCostFactor},
	"st_snaptogrid":               {Cost: 100 * cpuCostFactor},
	"st_split":                    {Cost: 10000 * cpuCostFactor},
	"st_srid":                     {Cost: 100 * cpuCostFactor},
	"st_startpoint":               {Cost: 100 * cpuCostFactor},
	"st_subdivide":                {Cost: 10000 * cpuCostFactor},
	"st_summary":                  {Cost: 100 * cpuCostFactor},
	"st_swapordinates":            {Cost: 100 * cpuCostFactor},
	"st_symdifference":            {Cost: 10000 * cpuCostFactor},
	"st_symmetricdifference":      {Cost: 10000 * cpuCostFactor},
	"st_tileenvelope":             {Cost: 100 * cpuCostFactor},
	"st_touches":                  {Cost: 10000 * cpuCostFactor},
	"st_transform":                {Cost: 100 * cpuCostFactor},
	"st_translate":                {Cost: 100 * cpuCostFactor},
	"st_transscale":               {Cost: 100 * cpuCostFactor},
	"st_unaryunion":               {Cost: 10000 * cpuCostFactor},
	"st_union":                    {Cost: 10000 * cpuCostFactor},
	"st_voronoilines":             {Cost: 100 * cpuCostFactor},
	"st_voronoipolygons":          {Cost: 100 * cpuCostFactor},
	"st_within":                   {Cost: 10000 * cpuCostFactor},
	"st_wkbtosql":                 {Cost: 100 * cpuCostFactor},
	"st_wkttosql":                 {Cost: 1000 * cpuCostFactor},
}
...
func (c *coster) ComputeCost(candidate memo.RelExpr, required *physical.Required) memo.Cost {
	...
	if c.perturbation != 0 {
		...
		if cost.Less(hugeCost) {
			...
			perturbedCost := cost.Cost * (1 + c.perturbation*multiplier)
			cost.Cost = math.Max(0, perturbedCost)
		}
	}
...
func (c *coster) computeTopKCost(topk *memo.TopKExpr, required *physical.Required) memo.Cost {
	...
	// max heap.
	cost := memo.Cost{Cost: cpuCostFactor * float64(rel.OutputCols.Len()) * outputRowCount}
	...
	cost.Cost += c.rowCmpCost(len(topk.Ordering.Columns)).Cost * (1 + math.Log2(math.Max(outputRowCount, 1))) * inputRowCount
...
func (c *coster) computeSortCost(sort *memo.SortExpr, required *physical.Required) memo.Cost {
	...
	cost := memo.Cost{Cost: cpuCostFactor * float64(rel.OutputCols.Len()) * stats.RowCount}
	...
	if !sort.InputOrdering.Any() {
		...
		cost.Cost += cpuCostFactor * float64(numPreorderedCols) * stats.RowCount
	}
	...
	if segmentSize := stats.RowCount / numSegments; segmentSize > 1 {
		...
		cost.Cost += numSegments * c.rowBufferCost(segmentSize).Cost
	}
	cost.Cost += c.rowCmpCost(numKeyCols-numPreorderedCols).Cost * numCmpOpsPerRow * stats.RowCount
...
func (c *coster) computeScanCost(scan *memo.ScanExpr, required *physical.Required) memo.Cost {
	...
	if ordering.ScanIsReverse(scan, &required.Ordering) {
		if rowCount > 1 {
			...
			perRowCost.Cost += math.Log2(rowCount) * cpuCostFactor
		}
	}
	...
	if isUnfiltered {
		...
		if partitionCount := index.PartitionCount(); partitionCount > 1 {
			...
			// counting spans.
			baseCost.Cost += float64(partitionCount-1) * randIOCostFactor
		}
	}
	...
	cost := baseCost
	cost.Cost += rowCount * (seqIOCostFactor + perRowCost.Cost)
...
func (c *coster) computeSelectCost(sel *memo.SelectExpr, required *physical.Required) memo.Cost {
	...
	cost := memo.Cost{Cost: inputRowCount * filterPerRow.Cost}
...
func (c *coster) computeProjectCost(prj *memo.ProjectExpr) memo.Cost {
	...
	cost := memo.Cost{Cost: rowCount * float64(synthesizedColCount) * cpuCostFactor}

	// Add the CPU cost of emitting the rows.
	cost.Cost += rowCount * cpuCostFactor
	return cost
}
...
func (c *coster) computeInvertedFilterCost(invFilter *memo.InvertedFilterExpr) memo.Cost {
	...
	cost := memo.Cost{Cost: inputRowCount * cpuCostFactor}
	return cost
}

func (c *coster) computeValuesCost(values *memo.ValuesExpr) memo.Cost {
	return memo.Cost{Cost: values.Relational().Statistics().RowCount * cpuCostFactor}
}
...
func (c *coster) computeHashJoinCost(join memo.RelExpr) memo.Cost {
	...
	cost := memo.Cost{Cost: (1.25*leftRowCount + 1.75*rightRowCount) * cpuCostFactor}
	...
	cost.Cost += rowsProcessed * filterPerRow.Cost
...
func (c *coster) computeMergeJoinCost(join *memo.MergeJoinExpr) memo.Cost {
	...
	cost := memo.Cost{Cost: (0.9*leftRowCount + 1.1*rightRowCount) * cpuCostFactor}
...
func (c *coster) computeIndexLookupJoinCost(
	...
	if !lookupColsAreTableKey {
		...
		perLookupCost.Cost += 4 * randIOCostFactor
	}
	if c.mem.Metadata().Table(table).IsVirtualTable() {
		...
		perLookupCost.Cost += virtualScanTableDescriptorFetchCost
	}
	cost := memo.Cost{Cost: lookupCount * perLookupCost.Cost}
	...
	perRowCost := lookupJoinRetrieveRowCost + filterPerRow.Cost +
		c.rowScanCost(table, index, lookupCols).Cost

	cost.Cost += rowsProcessed * perRowCost

	if flags.Has(memo.PreferLookupJoinIntoRight) {
		// If we prefer a lookup join, make the cost much smaller.
		cost.Cost *= preferLookupJoinFactor
	}
...
func (c *coster) computeInvertedJoinCost(
	...
	perLookupCost := memo.Cost{Cost: randIOCostFactor}
	...
	perRowCost := memo.Cost{Cost: lookupJoinRetrieveRowCost + filterPerRow.Cost +
		c.rowScanCost(join.Table, join.Index, lookupCols).Cost}

	cost.Cost += rowsProcessed * perRowCost.Cost
...
func (c *coster) computeZigzagJoinCost(join *memo.ZigzagJoinExpr) memo.Cost {
	...
	seekCost := memo.Cost{Cost: randIOCostFactor + lookupJoinRetrieveRowCost}

	// Double the cost of emitting rows as well as the cost of seeking rows,
	// given two indexes will be accessed.
	cost := memo.Cost{Cost: rowCount * (2*(cpuCostFactor+seekCost.Cost) + scanCost.Cost + filterPerRow.Cost)}
	cost.Add(filterSetup)
...
func (c *coster) computeSetCost(set memo.RelExpr, required *physical.Required) memo.Cost {
	...
	cost := memo.Cost{Cost: outputRowCount * cpuCostFactor}
	...
	if set.Op() != opt.UnionAllOp && set.Op() != opt.LocalityOptimizedSearchOp &&
		...
		cost.Cost += (leftRowCount + rightRowCount) * cpuCostFactor
...
func (c *coster) computeGroupingCost(grouping memo.RelExpr, required *physical.Required) memo.Cost {
	...
	cost := memo.Cost{Cost: cpuCostFactor}

	// Add the CPU cost of emitting the rows.
	outputRowCount := grouping.Relational().Statistics().RowCount
	cost.Cost += outputRowCount * cpuCostFactor
	...
	// aggregates.
	cost.Cost += inputRowCount * float64(aggsCount+groupingColCount) * cpuCostFactor
	...
	if groupingColCount > 0 && streamingType != memo.Streaming {
		...
		cost.Cost += inputRowCount * cpuCostFactor
...
func (c *coster) computeLimitCost(limit *memo.LimitExpr) memo.Cost {
	// Add the CPU cost of emitting the rows.
	cost := memo.Cost{Cost: limit.Relational().Statistics().RowCount * cpuCostFactor}
	return cost
}

func (c *coster) computeOffsetCost(offset *memo.OffsetExpr) memo.Cost {
	// Add the CPU cost of emitting the rows.
	cost := memo.Cost{Cost: offset.Relational().Statistics().RowCount * cpuCostFactor}
	return cost
}

func (c *coster) computeOrdinalityCost(ord *memo.OrdinalityExpr) memo.Cost {
	// Add the CPU cost of emitting the rows.
	cost := memo.Cost{Cost: ord.Relational().Statistics().RowCount * cpuCostFactor}
	return cost
}

func (c *coster) computeProjectSetCost(projectSet *memo.ProjectSetExpr) memo.Cost {
	// Add the CPU cost of emitting the rows.
	cost := memo.Cost{Cost: projectSet.Relational().Statistics().RowCount * cpuCostFactor}
	return cost
}
...
func (c *coster) rowScanCost(tabID opt.TableID, idxOrd int, scannedCols opt.ColSet) memo.Cost {
	...
	if c.evalCtx != nil && c.evalCtx.SessionData().CostScansWithDefaultColSize {
		...
		return memo.Cost{Cost: float64(numCols+numScannedCols) * costFactor}
	}
	var cost float64
	for i := 0; i < idx.ColumnCount(); i++ {
...
func (c *coster) rowBufferCost(rowCount float64) memo.Cost {
	...
	return memo.Cost{Cost: rowCount * spillCostFactor * fraction}
}
...
func (c *coster) largeCardinalityCostPenalty(
	...
	if cardinality.IsUnbounded() {
		return memo.Cost{Cost: unboundedMaxCardinalityScanCostPenalty}
	}
...
func indexLookupJoinPerLookupCost(join memo.RelExpr) memo.Cost {
	...
	cost := memo.Cost{Cost: randIOCostFactor}
	...
	if ok && len(lookupJoin.LookupExpr) > 0 {
		...
		if numSpans > 1 {
			...
			cost.Cost += randIOCostFactor * float64(numSpans-1)
		}
		...
		cost.Cost += cpuCostFactor * float64(len(lookupJoin.LookupExpr)) * 1.1
	}
	return cost
}
