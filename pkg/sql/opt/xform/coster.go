...
func (c *coster) computeHashJoinCost(join memo.RelExpr) memo.Cost {
	...
	if leftRowCount < rightRowCount {
		// For all join types, during the execbuilding we choose the relation
		// with smaller cardinality to be on the right side, so we need to swap
		// row counts accordingly.
