...
type getSpanExprForGeoIndexFn func(
	context.Context, tree.Datum, geoindex.RelationshipType, cat.Index,
...
func getSpanExprForGeographyIndex(
	ctx context.Context, d tree.Datum, relationship geoindex.RelationshipType, index cat.Index,
) *invertedexpr.SpanExpression {
...
func constrainGeoIndex(
	...
	return getSpanExpr(ctx, d, relationship, index)
}
...
func NewGeoDatumToInvertedExpr(
	relationship geoindex.RelationshipType, index cat.Index,
) invertedexpr.DatumToInvertedExpr {
...
func (g *geoDatumToInvertedExpr) Convert(
	...
	spanExpr := g.getSpanExpr(ctx, d.Datum, g.relationship, g.index)
