...
// copyScalars replaces all scalar expressions in the table metadata with a copy
// that is generated by the copyScalar function. This is used when copying a
// Metadata.
//
// copyScalar must be a function that returns a copy of the given scalar
// expression.
func (tm *TableMeta) copyScalars(copyScalar func(Expr) Expr) {
	...
	if len(tm.partialIndexPredicates) > 0 {
