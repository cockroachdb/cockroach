...
// FingerprintIndexRec is a wrapper for index recommendation and
type FingerprintIndexRec[T any] struct {
...
type createIndex FingerprintIndexRec[tree.CreateIndex]
type dropIndex FingerprintIndexRec[tree.DropIndex]
