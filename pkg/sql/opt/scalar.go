...
func init() {
	...
	scalarOpInfos := map[operator]operatorInfo{
		...
		existenceOp:         {name: "existence"},
		allExistenceOp:      {name: "all-existence"},
		someExistenceOp:     {name: "some-existence"},
		anyOp:               {name: "any"},
		someOp:              {name: "some"},
		allOp:               {name: "all"},
		...
		fetchValOp:          {name: "fetch-val"},
		fetchTextOp:         {name: "fetch-text"},
		fetchValPathOp:      {name: "fetch-val-path"},
		fetchTextPathOp:     {name: "fetch-text-path"},
