...
// may be incorrect when projection expressions reference columns. It is up to
// the caller to validate the cases which are allowed to merge a projection with
// values.
