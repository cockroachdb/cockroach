...
// to inline a CTE, the following must be true:
//
//  1. The CTE expression is not volatile.
//  2. The CTE expression does not contain mutation statements, like
//     INSERT.
//
// In addition, the materialize clause can affect whether or not a CTE is
// inlined:
//
