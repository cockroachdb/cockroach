...
// HasPlaceholders returns true if the given expression contains at least one
// placeholder expression.
func (c *CustomFuncs) HasPlaceholders(expr memo.RelExpr) bool {
	return expr.Relational().HasPlaceholder
}
