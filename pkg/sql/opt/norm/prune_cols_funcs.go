...
//
// disabledRules is the set of rules currently disabled (only used for testing).
// It is used to prevent propagating the PruneCols property when the
// corresponding column-pruning normalization rule is disabled. This prevents
// rule cycles during testing.
