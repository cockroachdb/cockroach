...
// BinaryColumnType returns the column type of the binary overload for the
// given operator and operands.
func (c *CustomFuncs) BinaryColumnType(op opt.Operator, left, right opt.ScalarExpr) coltypes.T {
