...
// mapSetOpFilter maps filters expressions to use the output columns of the
// relational expression dst instead of the columns in src.
//
// mapSetOpFilter assumes the src and dst column sets are union compatible.
//
...
//
// If mapSetOpFilter is called on the left subtree of the Union, the filter x < 5
