...
// MakeCoalesce2 creates a Coalesce expression with two inputs.
func (c *CustomFuncs) MakeCoalesce2(a, b opt.ScalarExpr) opt.ScalarExpr {
	return c.f.ConstructCoalesce(memo.ScalarListExpr{a, b})
}
