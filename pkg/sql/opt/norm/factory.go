...
// depth is not zero. The stack depth should be 0 after a top-level construct
...
func (f *Factory) onMaxConstructorStackDepthExceeded() {
	...
	if util.CrdbTestBuild {
		panic(errors.AssertionFailedf(e))
	}
	errorutil.SendReport(
		f.evalCtx.Ctx(),
		&f.evalCtx.Settings.SV,
		errors.AssertionFailedf(e),
	)
}
