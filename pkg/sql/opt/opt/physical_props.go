...
// include row order, column naming, and data distribution. Physical properties
// exist outside of the relational algebra, and arise from both the SQL query
// itself (e.g. the non-relational ORDER BY operator) and by the selection of
// specific implementations during optimization (e.g. a merge join requires the
// inputs to be sorted in a particular order).
//
