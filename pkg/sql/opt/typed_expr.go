...
func init() {
	...
	typedExprConvMap = [numOperators]func(c *typedExprConvCtx, e *Expr) tree.TypedExpr{
		...
		existenceOp:     comparisonOpToTypedExpr,
		allExistenceOp:  comparisonOpToTypedExpr,
		someExistenceOp: comparisonOpToTypedExpr,
		...
		fetchValOp:      binaryOpToTypedExpr,
		fetchTextOp:     binaryOpToTypedExpr,
		fetchValPathOp:  binaryOpToTypedExpr,
		fetchTextPathOp: binaryOpToTypedExpr,
