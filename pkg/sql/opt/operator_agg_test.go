...
// aggregation is inserted into a table. The table after all the aggregations
// have been performed for the same datum, the table should have only one
// distinct value. If there is more than one distinct value, then the aggregate
// does not ignore duplicates and should not be marked as such.
//
