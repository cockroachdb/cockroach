...
func parseOrdering(str string) opt.Ordering {
	prov := props.ParseOrderingChoice(str)
...
func newDummyRelExpr(rel *props.Relational, provided opt.Ordering) memo.RelExpr {
	return &dummyRelExpr{rel: rel, provided: provided}
}

// Op is part of the RelExpr interface.
func (d *dummyRelExpr) Op() opt.Operator {
...
// ProvidedOrdering is part of the RelExpr interface.
func (d *dummyRelExpr) ProvidedOrdering() opt.Ordering {
	return d.provided
}
