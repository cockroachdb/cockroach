...
// the Plan, and "InputNames", which are the values from which the parameters
...
type Spec struct {
	...
	// InputNames is the set of possible InputNames, along with a set of potential values
	// for each. This allows enumerating all combinations of possible InputNames.
	Inputs []Choice
