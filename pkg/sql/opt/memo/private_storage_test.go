...
func TestInternGroupByDef(t *testing.T) {
	...
	groupByDef1 := &GroupByDef{util.MakeFastIntSet(1, 2), Ordering{1, -1}}
	groupByDef2 := &GroupByDef{util.MakeFastIntSet(2, 1), Ordering{1, -1}}
	groupByDef3 := &GroupByDef{util.MakeFastIntSet(1), Ordering{1, 1}}
	groupByDef4 := &GroupByDef{util.MakeFastIntSet(), Ordering{1, 1, 1}}
...
func TestPrivateStorageAllocations(t *testing.T) {
	...
	groupByDef := &GroupByDef{InputOrdering: ordering, GroupingCols: colSet}
