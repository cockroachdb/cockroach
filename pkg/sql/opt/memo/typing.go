...
// stored it in the expression's Type field by Memoize[Expr] functions.
// Depending upon the operator, the type may be fixed, or it may be dependent
// upon the expression children.
