...
var colIDType = reflect.TypeOf(opt.ColumnID(0))
...
func (ps *privateStorage) internColumnID(colID opt.ColumnID) PrivateID {
	...
	if id, ok := ps.privatesMap[privateKey{iface: colIDType, str: ps.keyBuf.String()}]; ok {
		return id
	}
	return ps.addValue(privateKey{iface: colIDType, str: ps.keyBuf.String()}, colID)
}

var colSetType = reflect.TypeOf((*opt.ColSet)(nil))
...
// been previously added to storage, then intern always returns the same private
// id that was returned from the previous call.
func (ps *privateStorage) internColSet(colSet opt.ColSet) PrivateID {
	// The below code is carefully constructed to not allocate in the case
	// where the value is already in the map. Be careful when modifying.
	ps.keyBuf.Reset()
	ps.keyBuf.writeColSet(colSet)
	if id, ok := ps.privatesMap[privateKey{iface: colSetType, str: ps.keyBuf.String()}]; ok {
		return id
	}
	return ps.addValue(privateKey{iface: colSetType, str: ps.keyBuf.String()}, colSet)
}

var colListType = reflect.TypeOf((*opt.ColList)(nil))
...
func (ps *privateStorage) internColList(colList opt.ColList) PrivateID {
	...
	if id, ok := ps.privatesMap[privateKey{iface: colListType, str: ps.keyBuf.String()}]; ok {
		return id
	}
	return ps.addValue(privateKey{iface: colListType, str: ps.keyBuf.String()}, colList)
}

var orderingType = reflect.TypeOf((*Ordering)(nil))
...
func (ps *privateStorage) internOrdering(ordering Ordering) PrivateID {
	...
	if id, ok := ps.privatesMap[privateKey{iface: orderingType, str: ps.keyBuf.String()}]; ok {
		return id
	}
	return ps.addValue(privateKey{iface: orderingType, str: ps.keyBuf.String()}, ordering)
}
...
var scanOpDefType = reflect.TypeOf((*ScanOpDef)(nil))
...
func (ps *privateStorage) internScanOpDef(def *ScanOpDef) PrivateID {
	...
	if id, ok := ps.privatesMap[privateKey{iface: scanOpDefType, str: ps.keyBuf.String()}]; ok {
		return id
	}
	return ps.addValue(privateKey{iface: scanOpDefType, str: ps.keyBuf.String()}, def)
}

var setOpColMapType = reflect.TypeOf((*SetOpColMap)(nil))
...
func (ps *privateStorage) internSetOpColMap(setOpColMap *SetOpColMap) PrivateID {
	...
	if id, ok := ps.privatesMap[privateKey{iface: setOpColMapType, str: ps.keyBuf.String()}]; ok {
		return id
	}
	return ps.addValue(privateKey{iface: setOpColMapType, str: ps.keyBuf.String()}, setOpColMap)
}
...
func (ps *privateStorage) internDatum(datum tree.Datum) PrivateID {
	...
	id, ok := ps.privatesMap[privateKey{iface: reflect.TypeOf(datum), str: ps.keyBuf.String()}]
	if ok {
		return id
	}
	return ps.addValue(privateKey{iface: reflect.TypeOf(datum), str: ps.keyBuf.String()}, datum)
}
