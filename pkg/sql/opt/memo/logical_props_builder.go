...
func (b *logicalPropsBuilder) buildVectorPartitionSearchProps(
	...
	// Output Columns
	// --------------
	// VectorPartitionSearch output columns are stored in the definition.
	rel.OutputCols = search.Cols
	...
	// Functional Dependencies
	// -----------------------
	// Copy the input FDs, and remove any columns that are not projected by the
	// VectorPartitionSearch operator.
	rel.FuncDeps.CopyFrom(&inputProps.FuncDeps)
	rel.FuncDeps.ProjectCols(rel.OutputCols)
