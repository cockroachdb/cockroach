...
func TestInterner(t *testing.T) {
	...
	// added to ScanFlags.
	viewDep1 := opt.ViewDep{nil, util.FastIntSet{}, nil, false, 0}
	...
	testCases := []struct {
		...
		{hashFn: in.hasher.HashMaterializeClause, eqFn: in.hasher.IsMaterializeClauseEqual, variations: []testVariation{
			{val1: tree.MaterializeClause{true, true}, val2: tree.MaterializeClause{true, true}, equal: true},
			{val1: tree.MaterializeClause{true, false}, val2: tree.MaterializeClause{true, false}, equal: true},
			{val1: tree.MaterializeClause{true, false}, val2: tree.MaterializeClause{false, true}, equal: false},
		}},
