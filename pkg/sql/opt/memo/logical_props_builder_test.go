...
func TestLogicalPropsBuilder(t *testing.T) {
	runDataDrivenTest(t, "testdata/logprops/", memo.ExprFmtHideCost|memo.ExprFmtHideRulesProps)
	runDataDrivenTest(t, "testdata/stats/", memo.ExprFmtHideCost|memo.ExprFmtHideRulesProps)
}
