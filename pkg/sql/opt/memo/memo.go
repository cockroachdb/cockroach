...
type Memo struct {
	...
	alwaysUseCascadeFastPathForRBRTables             bool
...
func (m *Memo) Init(ctx context.Context, evalCtx *eval.Context) {
	...
	*m = Memo{
		...
		alwaysUseCascadeFastPathForRBRTables:             evalCtx.SessionData().OptimizerDisableCrossRegionCascadeFastPathForRBRTables,
...
func (m *Memo) IsStale(
	...
	if m.reorderJoinsLimit != int(evalCtx.SessionData().ReorderJoinsLimit) ||
		...
		m.alwaysUseCascadeFastPathForRBRTables != evalCtx.SessionData().OptimizerDisableCrossRegionCascadeFastPathForRBRTables ||
