...
// CopyLockGroupIntoLookupJoin helps us create a mock LookupJoinExpr in
// execbuilder during building of LockExpr.
func CopyLockGroupIntoLookupJoin(lock *LockExpr, join *LookupJoinExpr) {
	join.grp = lock.grp
}
