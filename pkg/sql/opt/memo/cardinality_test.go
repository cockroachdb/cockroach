...
func TestCardinality(t *testing.T) {
	...
	// Filter variations.
	test(Cardinality{Min: 0, Max: 10}.Filter(0), "[0 - 10]")
	test(Cardinality{Min: 1, Max: 10}.Filter(0), "[0 - 10]")
	test(Cardinality{Min: 5, Max: 10}.Filter(1), "[1 - 10]")
	test(Cardinality{Min: 1, Max: 10}.Filter(5), "[1 - 10]")
	test(Cardinality{Min: 1, Max: 10}.Filter(20), "[1 - 10]")
	test(AnyCardinality.Filter(1), "[0 - ]")
