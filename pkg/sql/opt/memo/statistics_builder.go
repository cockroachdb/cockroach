...
func (sb *statisticsBuilder) selectivityFromDistinctCount(
	...
	nonNullSelectivity := props.MakeSelectivity(newDistinct / oldDistinct)
	nullSelectivity := props.MakeSelectivity(colStat.NullCount / inputColStat.NullCount)
...
func (sb *statisticsBuilder) selectivityFromHistograms(
	...
	for col, ok := cols.Next(0); ok; col, ok = cols.Next(col + 1) {
		...
		// Calculate the selectivity of the predicate.
		nonNullSelectivity := props.MakeSelectivity(newCount / oldCount)
		nullSelectivity := props.MakeSelectivity(colStat.NullCount / inputColStat.NullCount)
...
func (sb *statisticsBuilder) selectivityFromEquivalency(
	...
	return props.MakeSelectivity(1 / maxDistinctCount)
}
...
func (sb *statisticsBuilder) selectivityFromEquivalencySemiJoin(
	...
	return props.MakeSelectivity(minDistinctCountRight / maxDistinctCountLeft)
}
