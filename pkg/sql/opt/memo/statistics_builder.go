...
func (sb *statisticsBuilder) buildScan(scan *ScanExpr, relProps *props.Relational) {
	...
	if scan.Constraint == nil && scan.InvertedConstraint == nil {
		sb.filterRelExpr(pred, scan, relProps, s, &scan.Relational().FuncDeps)
		sb.finalizeFromCardinality(relProps)
		return
	}
...
func (sb *statisticsBuilder) buildSelect(sel *SelectExpr, relProps *props.Relational) {
	...
	sb.filterRelExpr(sel.Filters, sel, relProps, s, &sel.Input.Relational().FuncDeps)
...
func (sb *statisticsBuilder) filterRelExpr(
	...
	s.ApplySelectivity(sb.selectivityFromEquivalencies(equivReps, &equivFD, e, s))
	s.ApplySelectivity(sb.selectivityFromUnappliedConjuncts(numUnappliedConjuncts))
	s.ApplySelectivity(sb.selectivityFromNullsRemoved(e, relProps.NotNullCols, constrainedCols))
	...
	sb.applyEquivalencies(equivReps, &equivFD, e, relProps.NotNullCols, s)
}
