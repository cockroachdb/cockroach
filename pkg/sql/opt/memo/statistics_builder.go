...
func (sb *statisticsBuilder) finalizeFromRowCountAndDistinctCounts(
	...
	// fail loudly in test builds so the upstream bug surfaces, but bump
	// the distinct count in production so an internal estimation slip
	// doesn't fail the user's query.
