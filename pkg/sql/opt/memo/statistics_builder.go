...
func (sb *statisticsBuilder) availabilityFromInput(e RelExpr) bool {
	...
	case *GeospatialLookupJoinExpr:
		ensureGeospatialLookupJoinInputProps(t, sb)
		return t.lookupProps.Stats.Available && t.Input.Relational().Stats.Available
...
func (sb *statisticsBuilder) colStatFromInput(
	...
	var geospatialLookupJoin *GeospatialLookupJoinExpr
	...
	case *GeospatialLookupJoinExpr:
		...
		ensureGeospatialLookupJoinInputProps(geospatialLookupJoin, sb)
...
func (sb *statisticsBuilder) colStat(colSet opt.ColSet, e RelExpr) *props.ColumnStatistic {
	...
	case opt.InnerJoinOp, opt.LeftJoinOp, opt.RightJoinOp, opt.FullJoinOp,
		...
		opt.GeospatialLookupJoinOp, opt.ZigzagJoinOp:
...
func (sb *statisticsBuilder) buildJoin(
	...
	if join.Op() == opt.GeospatialLookupJoinOp {
		s.ApplySelectivity(sb.selectivityFromGeospatialRelationship(join, s))
	}
...
func (sb *statisticsBuilder) colStatJoin(colSet opt.ColSet, join RelExpr) *props.ColumnStatistic {
	...
	case *GeospatialLookupJoinExpr:
		joinType = j.JoinType
		leftProps = j.Input.Relational()
		ensureGeospatialLookupJoinInputProps(j, sb)
		rightProps = &j.lookupProps
...
const (
	...
	// columns.
	unknownGeospatialRelationshipSelectivity = 1.0 / 100.0
)
...
func (sb *statisticsBuilder) selectivityFromGeospatialRelationship(
	e RelExpr, s *props.Statistics,
) (selectivity float64) {
	return unknownGeospatialRelationshipSelectivity
}
