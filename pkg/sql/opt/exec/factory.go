...
type Factory interface {
	...
	// ConstructProjection returns a node that applies a projection on the results
	// of the given input node.
	ConstructProjection(n Node, exprs tree.TypedExprs) (Node, error)
}
