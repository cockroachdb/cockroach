...
// InsertFastPathMaxRows is the maximum amount of rows for which we can use the
// insert fast path.
...
type InsertFastPathFKCheck struct {
	...
	// FK Columns from the origin table, in the order of the ReferencedIndex
	// columns.
