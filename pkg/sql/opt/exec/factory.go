...
type InsertFastPathFKUniqCheck struct {
	...
	// entries corresponds with the number of KV lookups. For example, for a
	// locality-optimized operation accessing 1 local region and 2 remote regions,
	// this would have 3 entries.
