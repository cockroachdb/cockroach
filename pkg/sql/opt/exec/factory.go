...
type Factory interface {
	...
	// ConstructControlAllSchedules creates a node that implements PAUSE/CANCEL/DROP
	// SCHEDULES.
	ConstructControlAllSchedules(command tree.ScheduleCommand, input Node) (Node, error)
