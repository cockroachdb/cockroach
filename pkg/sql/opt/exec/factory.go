...
type Factory interface {
	...
	//
	// If skipFKChecks is set, foreign keys are not checked as part of the
	// execution of the upsert. This is used when the FK checks are planned by
	// the optimizer and are run separately as plan postqueries.
	ConstructUpsert(
		input Node,
		table cat.Table,
	...
	//
	// If skipFKChecks is set, foreign keys are not checked as part of the
	// execution of the delete, for the insert half. This is used when the
	// FK checks are planned by the optimizer and are run separately as plan
	// postqueries.
	ConstructDelete(
		input Node,
		table cat.Table,
