...
// routine's CanMutate status. When unknown, it inspects the body if
// available, or conservatively assumes mutations when the body is
// permanently unavailable (deferred optbuild with BodyBuilder set).
