...
func (b *Builder) buildRelational(e memo.RelExpr) (execPlan, error) {
	...
	case *memo.InvertedLookupJoinExpr:
		ep, err = b.builInvertedLookupJoin(t)
...
func (b *Builder) builInvertedLookupJoin(join *memo.InvertedLookupJoinExpr) (execPlan, error) {
	input, err := b.buildRelational(join.Input)
	if err != nil {
		return execPlan{}, err
	}
	...
	res.root, err = b.factory.ConstructInvertedLookupJoin(
		joinOpToJoinType(join.JoinType),
