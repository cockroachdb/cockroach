...
func (b *Builder) buildDistinct(distinct memo.RelExpr) (execPlan, error) {
	...
	// If this is UpsertDistinctOn or EnsureUpsertDistinctOn, then treat NULL values as distinct.
	var nullsAreDistinct bool
	if distinct.Op() == opt.UpsertDistinctOnOp || distinct.Op() == opt.EnsureUpsertDistinctOnOp {
