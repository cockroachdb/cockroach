...
func (b *Builder) buildScan(scan *memo.ScanExpr) (execPlan, error) {
	...
	b.IndexesUsed = append(b.IndexesUsed, fmt.Sprintf("%d@%d", idx.Table().ID(), idx.ID()))
...
func (b *Builder) buildIndexJoin(join *memo.IndexJoinExpr) (execPlan, error) {
	...
	b.IndexesUsed = append(b.IndexesUsed, fmt.Sprintf("%d@%d", pri.Table().ID(), pri.ID()))
...
func (b *Builder) buildZigzagJoin(join *memo.ZigzagJoinExpr) (execPlan, error) {
	...
	b.IndexesUsed = append(b.IndexesUsed, fmt.Sprintf("%d@%d", leftIndex.Table().ID(), leftIndex.ID()))
	b.IndexesUsed = append(b.IndexesUsed, fmt.Sprintf("%d@%d", rightIndex.Table().ID(), rightIndex.ID()))
