...
type Builder struct {
	...
	// postqueries accumulates check queries that are run after the main query and
	// any cascades.
...
func (b *Builder) Build() (_ exec.Plan, err error) {
	...
	return b.factory.ConstructPlan(plan.root, b.subqueries, b.cascades, b.postqueries)
}
