...
func (b *Builder) buildExplain(explain *memo.ExplainExpr) (execPlan, error) {
	...
	if explain.Options.Mode == tree.ExplainOpt {
		...
		plan, err := b.factory.ConstructPlan(input.root, b.subqueries, b.cascades, b.postqueries)
		if err != nil {
			return execPlan{}, err
		}
	...
	// The subqueries/cascades/postqueries are now owned by the explain node;
