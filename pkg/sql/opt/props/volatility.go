...
// For (1) we can cache the final optimized plan. For 2, we can only cache
// the memo if we don't constant fold stable operators, and subsequently fold
// them each time we try to execute an instance of the query.
//
