...
// expression. See volatility.Volatility for more info on volatility values.
//
...
func (vs *VolatilitySet) Add(v volatility.Volatility) {
	*vs |= volatilityBit(v)
}
...
func volatilityBit(v volatility.Volatility) VolatilitySet {
