...
// expressions.
// Note: If new fields are added to this struct, the Equals and CopyScalarProps
...
// CopyScalarProps copies all properties from fromProps into s, remapping any
...
// filled in later.
func (s *Scalar) CopyScalarProps(fromProps *Scalar, colMap opt.ColMap) {
	// Shared Properties
