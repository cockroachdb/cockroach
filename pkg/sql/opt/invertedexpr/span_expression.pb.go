...
func (SetOperator) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_span_expression_4ccfadb6eb610790, []int{0}
}
...
func (*SpanExpressionProto_Span) Descriptor() ([]byte, []int) {
	return fileDescriptor_span_expression_4ccfadb6eb610790, []int{0, 0}
}
...
func (*SpanExpressionProto_Node) Descriptor() ([]byte, []int) {
	return fileDescriptor_span_expression_4ccfadb6eb610790, []int{0, 1}
}
...
func init() {
	proto.RegisterFile("sql/opt/invertedexpr/span_expression.proto", fileDescriptor_span_expression_4ccfadb6eb610790)
}

var fileDescriptor_span_expression_4ccfadb6eb610790 = []byte{
