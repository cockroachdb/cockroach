...
func (SetOperator) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_expression_8f1e9593a2833cee, []int{0}
}
...
func (*SpanExpressionProto_Span) Descriptor() ([]byte, []int) {
	return fileDescriptor_expression_8f1e9593a2833cee, []int{0, 0}
}
...
func (*SpanExpressionProto_Node) Descriptor() ([]byte, []int) {
	return fileDescriptor_expression_8f1e9593a2833cee, []int{0, 1}
}
...
// TwoVariableExpressionProto is a proto representation of an InvertedExpression
// consisting of an expression containing two variables and an optional
// SpanExpression. It is intended for use in expression execution.
type TwoVariableExpressionProto struct {
	Expression     string               `protobuf:"bytes,1,opt,name=expression,proto3" json:"expression,omitempty"`
	SpanExpression *SpanExpressionProto `protobuf:"bytes,2,opt,name=span_expression,json=spanExpression,proto3" json:"span_expression,omitempty"`
}

func (m *TwoVariableExpressionProto) Reset()         { *m = TwoVariableExpressionProto{} }
func (m *TwoVariableExpressionProto) String() string { return proto.CompactTextString(m) }
func (*TwoVariableExpressionProto) ProtoMessage()    {}
func (*TwoVariableExpressionProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_expression_8f1e9593a2833cee, []int{1}
}
func (m *TwoVariableExpressionProto) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TwoVariableExpressionProto) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalTo(b)
	if err != nil {
		return nil, err
...
func (dst *TwoVariableExpressionProto) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TwoVariableExpressionProto.Merge(dst, src)
}
func (m *TwoVariableExpressionProto) XXX_Size() int {
	return m.Size()
}
func (m *TwoVariableExpressionProto) XXX_DiscardUnknown() {
	xxx_messageInfo_TwoVariableExpressionProto.DiscardUnknown(m)
}

var xxx_messageInfo_TwoVariableExpressionProto proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*TwoVariableExpressionProto)(nil), "cockroach.sql.opt.invertedexpr.TwoVariableExpressionProto")
...
func (m *TwoVariableExpressionProto) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *TwoVariableExpressionProto) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.Expression) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintExpression(dAtA, i, uint64(len(m.Expression)))
		i += copy(dAtA[i:], m.Expression)
	}
	if m.SpanExpression != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintExpression(dAtA, i, uint64(m.SpanExpression.Size()))
		n4, err := m.SpanExpression.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n4
...
func (m *TwoVariableExpressionProto) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TwoVariableExpressionProto) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TwoVariableExpressionProto: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TwoVariableExpressionProto: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SpanExpression", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.SpanExpression == nil {
				m.SpanExpression = &SpanExpressionProto{}
			}
			if err := m.SpanExpression.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func init() {
	proto.RegisterFile("sql/opt/invertedexpr/expression.proto", fileDescriptor_expression_8f1e9593a2833cee)
}

var fileDescriptor_expression_8f1e9593a2833cee = []byte{
	// 447 bytes of a gzipped FileDescriptorProto
	,
}
