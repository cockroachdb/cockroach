...
// SpanExpressionProto_Spans is a slice of SpanExpressionProto_Span.
type SpanExpressionProto_Spans []SpanExpressionProto_Span

// Len implements the span.KeyableInvertedSpans interface.
func (s SpanExpressionProto_Spans) Len() int {
	return len(s)
}

// Start implements the span.KeyableInvertedSpans interface.
func (s SpanExpressionProto_Spans) Start(i int) []byte {
	return s[i].Start
}

// End implements the span.KeyableInvertedSpans interface.
func (s SpanExpressionProto_Spans) End(i int) []byte {
	return s[i].End
}
