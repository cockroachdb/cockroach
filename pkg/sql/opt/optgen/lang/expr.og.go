...
func (e *RootExpr) Visit(accept AcceptFunc) Expr {
	...
	if children != nil {
		return accept(&RootExpr{Defines: *children[0].(*DefineSetExpr), Rules: *children[1].(*RuleSetExpr)})
	}
	return accept(e)
}

func (e *RootExpr) Source() *Source {
	return e.Src
}
...
func (e *DefineSetExpr) Source() *Source {
	return nil
}
...
func (e *RuleSetExpr) Source() *Source {
	return nil
}
...
func (e *DefineExpr) Visit(accept AcceptFunc) Expr {
	children := visitExprChildren(e, accept)
	if children != nil {
		return accept(&DefineExpr{Tags: *children[0].(*TagsExpr), Name: *children[1].(*StringExpr), Fields: *children[2].(*DefineFieldsExpr)})
	}
	return accept(e)
}

func (e *DefineExpr) Source() *Source {
	return e.Src
}
...
func (e *DefineFieldsExpr) Source() *Source {
	return nil
}
...
func (e *DefineFieldExpr) Visit(accept AcceptFunc) Expr {
	children := visitExprChildren(e, accept)
	if children != nil {
		return accept(&DefineFieldExpr{Name: *children[0].(*StringExpr), Type: *children[1].(*StringExpr)})
	}
	return accept(e)
}

func (e *DefineFieldExpr) Source() *Source {
	return e.Src
}
...
func (e *RuleExpr) Visit(accept AcceptFunc) Expr {
	children := visitExprChildren(e, accept)
	if children != nil {
		return accept(&RuleExpr{Name: *children[0].(*StringExpr), Tags: *children[1].(*TagsExpr), Match: children[2].(*MatchExpr), Replace: children[3]})
	}
	return accept(e)
}

func (e *RuleExpr) Source() *Source {
	return e.Src
}
...
func (e *BindExpr) Visit(accept AcceptFunc) Expr {
	children := visitExprChildren(e, accept)
	if children != nil {
		return accept(&BindExpr{Label: *children[0].(*StringExpr), Target: children[1]})
	}
	return accept(e)
}

func (e *BindExpr) Source() *Source {
	return e.Src
}
...
func (e *RefExpr) Visit(accept AcceptFunc) Expr {
	children := visitExprChildren(e, accept)
	if children != nil {
		return accept(&RefExpr{Label: *children[0].(*StringExpr)})
	}
	return accept(e)
}

func (e *RefExpr) Source() *Source {
	return e.Src
}
...
func (e *MatchExpr) Visit(accept AcceptFunc) Expr {
	children := visitExprChildren(e, accept)
	if children != nil {
		return accept(&MatchExpr{Names: *children[0].(*OpNamesExpr), Fields: *children[1].(*ListExpr)})
	}
	return accept(e)
}

func (e *MatchExpr) Source() *Source {
	return e.Src
}
...
func (e *OpNamesExpr) Source() *Source {
	return nil
}
...
func (e *OpNameExpr) Source() *Source {
	return nil
}
...
func (e *MatchAndExpr) Visit(accept AcceptFunc) Expr {
	children := visitExprChildren(e, accept)
	if children != nil {
		return accept(&MatchAndExpr{Left: children[0], Right: children[1]})
	}
	return accept(e)
}

func (e *MatchAndExpr) Source() *Source {
	return e.Src
}
...
func (e *MatchInvokeExpr) Visit(accept AcceptFunc) Expr {
	children := visitExprChildren(e, accept)
	if children != nil {
		return accept(&MatchInvokeExpr{FuncName: *children[0].(*StringExpr), Args: *children[1].(*ListExpr)})
	}
	return accept(e)
}

func (e *MatchInvokeExpr) Source() *Source {
	return e.Src
}
...
func (e *MatchNotExpr) Visit(accept AcceptFunc) Expr {
	children := visitExprChildren(e, accept)
	if children != nil {
		return accept(&MatchNotExpr{Input: children[0]})
	}
	return accept(e)
}

func (e *MatchNotExpr) Source() *Source {
	return e.Src
}
...
var MatchAnySingleton = &MatchAnyExpr{}
...
func (e *MatchAnyExpr) Visit(accept AcceptFunc) Expr {
	children := visitExprChildren(e, accept)
	if children != nil {
		return accept(&MatchAnyExpr{})
	}
	return accept(e)
}

func (e *MatchAnyExpr) Source() *Source {
	return nil
}
...
func (e *MatchListExpr) Visit(accept AcceptFunc) Expr {
	children := visitExprChildren(e, accept)
	if children != nil {
		return accept(&MatchListExpr{MatchItem: children[0]})
	}
	return accept(e)
}

func (e *MatchListExpr) Source() *Source {
	return e.Src
}
...
func (e *ConstructExpr) Visit(accept AcceptFunc) Expr {
	children := visitExprChildren(e, accept)
	if children != nil {
		return accept(&ConstructExpr{OpName: children[0], Args: *children[1].(*ListExpr)})
	}
	return accept(e)
}

func (e *ConstructExpr) Source() *Source {
	return e.Src
}
...
func (e *ConstructListExpr) Visit(accept AcceptFunc) Expr {
	children := visitExprChildren(e, accept)
	if children != nil {
		return accept(&ConstructListExpr{Items: *children[0].(*ListExpr)})
	}
	return accept(e)
}

func (e *ConstructListExpr) Source() *Source {
	return e.Src
}
...
func (e *StringExpr) Source() *Source {
	return nil
}
