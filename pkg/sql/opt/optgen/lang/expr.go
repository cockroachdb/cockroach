...
// DynamicName returns the function used to dynamically generate the name of
// this function. This is used when constructing result expression trees where
// the name of an operator is not known until run-time.
func (e *FuncExpr) DynamicName() *FuncExpr {
	return e.Name.(*FuncExpr)
}
