...
func (g *factoryGen) genReplace() {
	...
	g.w.writeIndent("}\n")
	g.w.writeIndent("panic(pgerror.NewAssertionErrorf(\"unhandled op %%s\", e.Op()))\n")
	g.w.unnest("}\n\n")
...
func (g *factoryGen) genCopyAndReplaceDefault() {
	...
	g.w.writeIndent("}\n")
	g.w.writeIndent("panic(pgerror.NewAssertionErrorf(\"unhandled op %%s\", src.Op()))\n")
	g.w.unnest("}\n\n")
...
func (g *factoryGen) genDynamicConstruct() {
	...
	g.w.writeIndent("}\n")
	g.w.writeIndent("panic(pgerror.NewAssertionErrorf(\"cannot dynamically construct operator %%s\", op))\n")
	g.w.unnest("}\n")
}
