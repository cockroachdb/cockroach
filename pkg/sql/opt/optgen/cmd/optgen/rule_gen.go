...
func (g *newRuleGen) genMatch(match lang.Expr, context *contextDecl, noMatch bool) {
	...
	case *lang.MultiVarBindExpr:
		g.genMatchMultiVarBind(t, noMatch)
...
// genMatchMultiVarBind generates code for multi-variable bind expression
// matching.
func (g *newRuleGen) genMatchMultiVarBind(matchMultiVarBind *lang.MultiVarBindExpr, noMatch bool) {
	g.genBoundStatements(matchMultiVarBind)
	...
	g.genNestedExpr(matchMultiVarBind)
