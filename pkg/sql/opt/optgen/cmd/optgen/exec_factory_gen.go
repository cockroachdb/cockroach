...
func (g *execFactoryGen) genExecFactory() {
	...
	g.w.write("// natural tree order, that is after an operators children are constructed the\n")
	g.w.write("// next factory method to be called must be those nodes parent. The gists\n")
	g.w.write("// flattened tree representation relies on this to enable the use of a stack to\n")
	g.w.write("// hold children avoiding the complexity of dealing with other tree traversal\n")
	g.w.write("// methods.\n")
	g.w.write("//\n")
