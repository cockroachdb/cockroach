...
// usedStoredColOrds. The function also updates usedStoredColOrds to include the
// existing index's stored columns. This is to ensure that we do not remove
// existing stored columns in the recommendation (if redundantRecommendation
// returns false and a replacement recommendation is made).
func (ir *indexRecommendation) redundantRecommendation() bool {
	...
	// Update usedStoredColOrds to contain the existingStoredOrds. We want to
