...
func testStoredCols() (cat.Index, util.FastIntSet) {
	...
	index := &testcat.Index{Columns: []cat.IndexColumn{indexCol1, indexCol2}, ExplicitColCount: 1, KeyCount: 1}
...
func testInvertedIndexCols(diffSourceCol bool) (cat.Index, []cat.IndexColumn) {
	...
	sameInvertedIndex := &testcat.Index{Columns: []cat.IndexColumn{indexCol1, indexCol2, indexCol3}, ExplicitColCount: 3, KeyCount: 3, Inverted: true}
	diffSourceIndex := &testcat.Index{Columns: []cat.IndexColumn{indexCol1, indexCol2, indexCol4}, ExplicitColCount: 3, KeyCount: 3, Inverted: true}
...
func testFindBestExistingIndexToReplace() (cat.Table, *hypotheticalIndex, util.FastIntSet, indexRecType, cat.Index, util.FastIntSet) {
	...
	table.Indexes = []*testcat.Index{
		...
		{Columns: []cat.IndexColumn{indexCol1}, ExplicitColCount: 1, KeyCount: 1},
		...
		// best candidate.
		{Columns: []cat.IndexColumn{indexCol1, indexCol2}, ExplicitColCount: 1, KeyCount: 1},
	}
...
func testFindBestExistingIndexToReplaceWithInverted() (cat.Table, *hypotheticalIndex, util.FastIntSet, indexRecType, cat.Index, util.FastIntSet) {
	...
	// Add existing indexes.
	table.Indexes = []*testcat.Index{
		{NotVisible: true, Columns: []cat.IndexColumn{indexCol1, indexCol2}, ExplicitColCount: 2, KeyCount: 2, Inverted: true},
	}
