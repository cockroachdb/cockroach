...
// but do not fall into one of these categories. This will be the final case,
// *memo.VariableExpr. See the papers referenced in this RFC for inspiration:
// https://github.com/cockroachdb/cockroach/pull/71784.
