...
func (c *indexConstraintCtx) makeSpansForAnd(
	...
	// tightDeltaMap maps each filter to the relative offset at which we generated
	// tight constraints for that expression (if any).
...
func (c *indexConstraintCtx) simplifyFilter(
	...
	// Special handling for And, Or, Range.
