...
func (k *LogicalKey) copy() LogicalKey {
...
func (c *indexConstraintCalc) intersectSpan(
	...
	return LogicalSpan{Start: res.Start.copy(), End: res.End.copy()}, true
}

// intersectSpanSet intersects a span with (the union of) a set of spans. The
// spans must be ordered and non-overlapping. The spanSet is modified in-place
// by this method.
