...
//
//    Column ids in the left and output of the generated UnionAll are reused from the
//    original input expression. This is safe because the columns from the
//    left side of the union as essentially passed-through to the parent
//    expression.
//
//  - Uncorrelated sub-expressions
//
//    This is safe because columns within correlated sub-expressions cannot
