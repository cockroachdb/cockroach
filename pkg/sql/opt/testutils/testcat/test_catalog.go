...
type Table struct {
	...
	outboundFKs []ForeignKeyReference
	inboundFKs  []ForeignKeyReference
}
...
func (tt *Table) OutboundForeignKey(i int) cat.ForeignKeyReference {
...
func (tt *Table) InboundForeignKey(i int) cat.ForeignKeyReference {
...
// ForeignKeyReference implements cat.ForeginKeyReference. See that interface
...
func (fk *ForeignKeyReference) ReferencedColumnOrdinal(referencedTable cat.Table, i int) int {
...
func (fk *ForeignKeyReference) Validated() bool {
	return fk.validated
}

// MatchMethod is part of the cat.ForeignKeyReference interface.
func (fk *ForeignKeyReference) MatchMethod() tree.CompositeKeyMatchMethod {
