...
func (tc *Catalog) CreateTable(stmt *tree.CreateTable) *Table {
	...
	// numeric references.
	// TODO(madhav): 53 is a magic number derived
	// from how CRDB internally stores tables.
	// The first user table is 53. This magic number
	// is used to have tests look consistent.
