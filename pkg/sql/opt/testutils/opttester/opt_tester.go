...
type Flags struct {
	...
	// MemoGroupLimit is used by the check-size command to disable printing of
	// the number of rules applied or memo groups are constructed when so that it
	// can be used as an upper-bound sanity check and not a requirement for an
