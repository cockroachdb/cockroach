...
type Flags struct {
	...
	// ShouldSetJoinLimit indicates whether opttester should set JoinLimit to a
	// value other than the default.
	ShouldSetJoinLimit bool
...
func (ot *OptTester) RunCommand(tb testing.TB, d *datadriven.TestData) string {
	...
	if ot.Flags.ShouldSetJoinLimit {
