...
type Flags struct {
	...
	// ExperimentalPropagateInputOrdering is the default value for
	// SessionData.ExperimentalPropagateInputOrdering
...
func (ot *OptTester) RunCommand(tb testing.TB, d *datadriven.TestData) string {
	...
	ot.evalCtx.SessionData.ExperimentalPropagateInputOrdering =
		ot.Flags.ExperimentalPropagateInputOrdering
...
func (f *Flags) Set(arg datadriven.CmdArg) error {
	...
	case "preserve-input-order":
		f.ExperimentalPropagateInputOrdering = true
