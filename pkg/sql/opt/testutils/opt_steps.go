...
type optSteps struct {
	...
	// remaining is the number of steps remaining in this iteration.
	remaining int
...
// done returns true if there are no more steps. Further calls to the next
