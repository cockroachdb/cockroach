...
// getPrimaryKeyOrdinals returns the ordinals of the primary key columns,
// excluding any implicit partitioning columns in the primary index.
func getPrimaryKeyOrdinals(tab cat.Table) util.FastIntSet {
