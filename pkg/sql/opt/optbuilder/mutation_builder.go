...
// The extraAccessibleCols param contains all the columns that the RETURNING
...
func (mb *mutationBuilder) buildReturning(
	returning tree.ReturningExprs, extraAccessibleCols []scopeColumn,
) {
	...
	// The returning columns can reference the columns defined in the FROM clause of
	// an Update.
	inScope.appendColumns(extraAccessibleCols)
