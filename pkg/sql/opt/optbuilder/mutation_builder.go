...
//
// The applySelectPolicies flag indicates whether SELECT policies should also be
// included in the constraint. This is needed in cases where the mutation operation
// involves reading and returning the affected rows—such as INSERT ... RETURNING.
...
//
// The `onlyUsingExpr` flag controls this behaviour:
