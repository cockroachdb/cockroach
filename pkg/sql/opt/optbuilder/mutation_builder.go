...
func (mb *mutationBuilder) init(b *Builder, opName string, tab cat.Table, alias tree.TableName) {
	...
	// TODO: I think I'll need two sets of Ords here, 1 for writes and another
	// for deletes.
	// TODO: Is this more trouble than it's worth? It seems pretty odd to me to
	// go through all these plumbing for something logically so simple.
