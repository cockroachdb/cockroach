...
// are not valid.
func (b *Builder) buildLimit(limit *tree.Limit, parentScope, inScope *scope) (outScope *scope) {
	outScope = inScope
	...
	if limit.Offset != nil {
		...
		outScope.group = b.factory.ConstructOffset(outScope.group, offset, orderingPrivID)
	}
	if limit.Count != nil {
		op := "LIMIT"
		...
		outScope.group = b.factory.ConstructLimit(outScope.group, limit, orderingPrivID)
	}
	return outScope
}
