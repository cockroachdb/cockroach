...
func (b *Builder) buildFunction(
	...
	allowUnsafeOverride := b.evalCtx.TestingKnobs.AllowInternalAccess
	if b.isUnsafeBuiltin(overload, def) {
		if err := unsafesql.CheckInternalsAccess(b.ctx, b.evalCtx.SessionData(), b.stmt, b.evalCtx.Annotations, &b.evalCtx.Settings.SV, allowUnsafeOverride); err != nil {
			panic(err)
		}
	}
