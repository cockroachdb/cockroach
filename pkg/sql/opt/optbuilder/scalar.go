...
func (b *Builder) buildScalar(
	...
	case *tree.CaseExpr:
		...
		if t.Else != nil {
			...
			whens = append(whens, b.factory.ConstructDatum(tree.DNull))
		}
	...
	case *tree.NullIfExpr:
		...
		whens := []memo.GroupID{
			b.factory.ConstructWhen(e2, b.factory.ConstructDatum(tree.DNull)),
			e1,
		}
	...
	case *tree.Placeholder:
		if b.evalCtx.HasPlaceholders() {
			...
			out = b.factory.ConstructDatum(d)
		} else {
	...
	// Datum.
	case tree.Datum:
		out = b.factory.ConstructDatum(t)
