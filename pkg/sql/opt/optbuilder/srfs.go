...
type srf struct {
	...
	// expr is the resolved function expression.
	expr *tree.FuncExpr
}

// String is part of the tree.Expr interface.
func (s *srf) String() string {
	return s.expr.String()
}

// Format is part of the tree.Expr interface.
func (s *srf) Format(ctx *tree.FmtCtx) {
	s.expr.Format(ctx)
}
...
func (s *srf) ResolvedType() types.T {
	return s.expr.ResolvedType()
}
