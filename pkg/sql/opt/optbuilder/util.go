...
// buildSynthesizedColumn is similar to synthesizeColumn, but it fills in the
// given existing column rather than allocating a new one.
func (b *Builder) buildSynthesizedColumn(col *scopeColumn, group memo.GroupID) {
	if col.name == "" {
