...
func (mb *mutationBuilder) buildInsert(returning tree.ReturningExprs) {
	...
	mb.projectPartialIndexCols(preCheckScope, nil /* delScope */, putCols)
...
func (mb *mutationBuilder) buildUpsert(returning tree.ReturningExprs) {
	...
	projectCols := putCols
	if mb.needExistingRows() {
		projectCols = putAndDelCols
	}
	mb.projectPartialIndexCols(preCheckScope, mb.fetchScope, projectCols)
