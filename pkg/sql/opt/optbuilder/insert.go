...
// While it may appear there's an obvious mutation ordering for simple INSERT
// statements, the ON CONFLICT clause introduces a new set of rows which can be
// updated, and the order of mutations and return values becomes hard to explain
// and requires extra overhead to maintain.
