...
func (b *Builder) buildTable(texpr tree.TableExpr, inScope *scope) (outScope *scope) {
	...
	case *tree.AliasedTableExpr:
		...
		if source.Ordinality {
			outScope = b.buildRowNumber(outScope, "ordinality")
		}
...
// buildRowNumber builds a group which appends an increasing integer column to
// the output. colName optionally denotes the name this column is given, or can
// be blank for none.
//
// See Builder.buildStmt for a description of the remaining input and
// return values.
func (b *Builder) buildRowNumber(inScope *scope, colName string) (outScope *scope) {
