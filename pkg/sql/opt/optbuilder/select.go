...
func (b *Builder) buildView(
	...
	skipAllPrivilegeChecks := sqlclustersettings.SkipUnderlyingViewPrivilegeChecks.Get(&b.evalCtx.Settings.SV)
	...
	if !isActive || skipAllPrivilegeChecks || view.IsSystemView() {
