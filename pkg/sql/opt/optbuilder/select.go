...
func (b *Builder) buildScan(
	...
	if ordinals == nil {
		...
		outScope.cols = make([]scopeColumn, 0, tab.DeletableAndSystemColumnCount())
		...
		// Add in the system columns.
		for i := tab.DeletableColumnCount(); i < tab.DeletableAndSystemColumnCount(); i++ {
			addCol(i)
		}
	} else {
