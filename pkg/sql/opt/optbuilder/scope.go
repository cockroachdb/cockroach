...
func (s *scope) push() *scope {
	...
	r.parent = s
	r.plpgsqlVarRef = s.plpgsqlVarRef
	return r
}
...
func (s *scope) VisitPre(expr tree.Expr) (recurse bool, newExpr tree.Expr) {
	...
	case *tree.ColumnItem:
		...
		if resolveErr != nil {
			...
			if sqlerrors.IsUndefinedRelationError(resolveErr) && t.TableName.Object() != "" {
				...
				if s.plpgsqlVarRef != nil {
					rewritten, knownVar := s.plpgsqlVarRef(t)
					if rewritten != nil {
		...
		if s.plpgsqlVarRef != nil && t.TableName != nil && t.TableName.Object() != "" {
			if rewritten, _ := s.plpgsqlVarRef(t); rewritten != nil {
