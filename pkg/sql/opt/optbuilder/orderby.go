...
func (b *Builder) buildOrderBy(
	...
	out, outScope = b.buildAppendingProject(in, projections, orderByProjections, inScope, projectionsScope, orderByScope)
	return out, outScope
...
// buildAppendingProject builds a projection that combines projected
// columns from a SELECT list and ORDER BY columns.
// If the combined set of output columns matches the set of input columns,
// buildAppendingProject simply returns the input -- it does not construct
