...
// findArbiters returns a set arbiters for an INSERT ON CONFLICT statement. Both
// unique indexes and unique constraints can be arbiters. This function panics
// if no arbiters are found.
//
...
func (mb *mutationBuilder) findArbiters(
	...
	// Err if we did not previously return and did not any partial arbiters.
	if arbiters.Empty() {
