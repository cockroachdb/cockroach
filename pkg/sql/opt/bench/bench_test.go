...
//   - ExecBuild
//
// With the prepare protocol, the query is built at prepare time and the memo is
// saved and reused. On each execution, placeholders are assigned before
// exploration. Only these phases are valid with the prepare protocol:
...
const (
	...
	// enabled. OptBuild includes the time to Parse.
	OptBuildNorm
