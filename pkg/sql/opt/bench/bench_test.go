...
var slowSchemas = []string{
	`
    CREATE TABLE tab1 (
        col1 INT8 NOT NULL DEFAULT unique_rowid(),
        col2 DECIMAL NOT NULL DEFAULT 0:::DECIMAL,
        col3 INT2 NOT NULL DEFAULT 0:::INT8,
        col4 TIMESTAMPTZ NULL DEFAULT now():::TIMESTAMPTZ,
        col5 STRING NULL,
        col6 STRING NOT NULL DEFAULT 'a':::STRING,
        col7 STRING NOT NULL,
        col8 TIMESTAMPTZ NOT NULL DEFAULT now():::TIMESTAMPTZ,
        col9 DECIMAL NOT NULL,
        col10 STRING NOT NULL,
        col11 INT8 NULL,
        col12 INT8 NULL,
        col13 TIMESTAMPTZ NULL,
        col14 DECIMAL NULL,
        col15 DECIMAL NULL,
        col16 STRING NOT NULL,
        col17 STRING NOT NULL,
        col18 INT8 NULL,
        col19 INT8 NOT NULL,
        col20 INT8 NOT NULL,
        col21 DECIMAL NOT NULL DEFAULT 0:::DECIMAL,
        col22 STRING NULL,
        col23 STRING NULL,
        col24 DECIMAL NOT NULL DEFAULT 1:::DECIMAL,
        col25 DECIMAL NOT NULL DEFAULT 0:::DECIMAL,
        col26 DECIMAL NULL,
        col27 STRING NULL,
        col28 DECIMAL NOT NULL DEFAULT 0:::DECIMAL,
        col29 INT2 NULL,
        col30 INT2 NOT NULL,
        col31 DECIMAL NOT NULL,
        col32 TIMESTAMPTZ NULL,
        col33 STRING NULL,
        col34 INT2 NULL,
        col35 DECIMAL NULL,
        col36 DECIMAL NULL,
        ...
        col80 DECIMAL NULL,
        col81 INT8 NULL,
        col82 TIMESTAMPTZ NULL,
        col83 BOOL NULL,
        col84 STRING NULL,
        col85 INT2 NOT NULL DEFAULT 0:::INT8,
        col86 DECIMAL NULL,
        col87 INT2 NULL,
        col88 TIMESTAMPTZ NULL,
        col89 INT8 NULL,
        col90 STRING NULL,
        col91 DECIMAL NULL,
        col92 BOOL NULL,
        ...
        col98 STRING NULL,
        col99 BOOL NULL,
        col100 BOOL NULL DEFAULT false,
        col101 DECIMAL NULL,
        col102 STRING NULL,
        col103 STRING NULL,
        col104 INT8 NULL,
        col105 STRING NULL,
        col106 TIMESTAMPTZ NULL,
        col107 TIMESTAMPTZ NULL,
        col108 INT8 NULL,
        col109 DECIMAL NULL,
        col110 STRING NULL,
        col111 INT8 NULL,
        col112 INT8 NOT NULL,
        col113 BOOL NOT NULL DEFAULT false,
        col114 BOOL NULL,
        col115 DECIMAL NULL,
        col116 JSONB NULL,
        col117 DECIMAL NULL,
        col118 INT8 NULL,
        col119 INT2 NOT NULL DEFAULT 0:::INT8,
        col120 INT2 NOT NULL DEFAULT 0:::INT8,
        col121 STRING NULL,
        col122 STRING NULL,
        col123 DECIMAL NULL,
        col124 INT8 NULL,
        ...
        col128 INT8 NULL,
        col129 STRING NULL,
        col130 BOOL NULL DEFAULT false,
        col131 TIMESTAMPTZ NULL,
        col132 STRING NULL,
        col133 TIMESTAMPTZ NULL,
        col134 INT8 NULL,
        col135 BOOL NULL DEFAULT false,
        col136 INT4 NOT NULL,
        col137 UUID NOT NULL DEFAULT gen_random_uuid(),
        col138 STRING NULL,
        col139 STRING NULL,
        col140 STRING NULL,
        col141 INT8 NULL,
        ...
        col147 INT8 NULL,
        col148 BOOL NULL,
        CONSTRAINT "primary" PRIMARY KEY (col136 ASC, col1 ASC),
        INDEX index1 (col136 ASC, col20 ASC, col40 ASC) PARTITION BY LIST (col136) (
        ...
        INDEX index2 (col136 ASC, col18 ASC, col6 ASC) PARTITION BY LIST (col136) (
            PARTITION p1 VALUES IN ((1)),
            PARTITION p2 VALUES IN ((2)),
            PARTITION p3 VALUES IN ((3)),
            PARTITION p4 VALUES IN ((4)),
        ...
        INDEX index3 (col136 ASC, col87 ASC) PARTITION BY LIST (col136) (
            PARTITION p1 VALUES IN ((1)),
            PARTITION p2 VALUES IN ((2)),
            PARTITION p3 VALUES IN ((3)),
            PARTITION p4 VALUES IN ((4)),
        ...
        INDEX index4 (col136 ASC, col8 ASC) PARTITION BY LIST (col136) (
            PARTITION p1 VALUES IN ((1)),
            PARTITION p2 VALUES IN ((2)),
            PARTITION p3 VALUES IN ((3)),
            PARTITION p4 VALUES IN ((4)),
        ...
        INDEX index5 (col136 ASC, col4 ASC, col7 ASC) PARTITION BY LIST (col136) (
            PARTITION p1 VALUES IN ((1)),
            PARTITION p2 VALUES IN ((2)),
            PARTITION p3 VALUES IN ((3)),
            PARTITION p4 VALUES IN ((4)),
        ...
        INDEX index6 (col136 ASC, col20 ASC, col40 ASC, col30 ASC, col8 DESC) STORING (col18) PARTITION BY LIST (col136) (
            PARTITION p1 VALUES IN ((1)),
            PARTITION p2 VALUES IN ((2)),
            PARTITION p3 VALUES IN ((3)),
            PARTITION p4 VALUES IN ((4)),
        ...
        INDEX index7 (col136 ASC, col30 ASC, col8 ASC, col1 ASC) PARTITION BY LIST (col136) (
            PARTITION p1 VALUES IN ((1)),
            PARTITION p2 VALUES IN ((2)),
            PARTITION p3 VALUES IN ((3)),
            PARTITION p4 VALUES IN ((4)),
        ...
        INDEX index8 (col136 ASC, col56 ASC, col1 ASC) PARTITION BY LIST (col136) (
            PARTITION p1 VALUES IN ((1)),
            PARTITION p2 VALUES IN ((2)),
            PARTITION p3 VALUES IN ((3)),
            PARTITION p4 VALUES IN ((4)),
        ...
        INDEX index9 (col136 ASC, col8 ASC) PARTITION BY LIST (col136) (
            PARTITION p1 VALUES IN ((1)),
            PARTITION p2 VALUES IN ((2)),
            PARTITION p3 VALUES IN ((3)),
            PARTITION p4 VALUES IN ((4)),
        ...
        INDEX index10 (col136 ASC, col20 ASC, col40 ASC, col1 ASC, col8 ASC) PARTITION BY LIST (col136) (
            PARTITION p1 VALUES IN ((1)),
            PARTITION p2 VALUES IN ((2)),
            PARTITION p3 VALUES IN ((3)),
            PARTITION p4 VALUES IN ((4)),
        ...
        INDEX index11 (col136 ASC, col1 ASC, col30 ASC) STORING (col137, col2, col3, col4, col5, col6, col7, col8, col9, col10, col11, col12, col13, col14, col15, col16, col17, col18, col19, col20, col21, col22, col23, col24, col25, col26, col27, col28, col29, col31, col32, col33, col34, col35, col36, col37, col38, col39, col40, col41, col42, col43, col44, col45, col46, col47, col48, col49, col50, col51, col52, col53, col54, col55, col56, col57, col58, col59, col60, col61, col62, col63, col64, col65, col66, col67, col68, col69, col70, col71, col72, col73, col74, col75, col76, col77, col78, col79, col80, col81, col82, col83, col84, col85, col86, col87, col88, col89, col90, col91, col92, col93, col94, col95, col96, col97, col98, col99, col100, col101, col102, col103, col104, col105, col106, col107, col108, col109, col110, col111, col112, col113, col114, col115, col116, col117, col118, col119, col120, col121, col122, col123, col124, col125, col126, col127, col128, col129, col130, col131, col132, col133, col134, col135, col138, col139, col140, col141, col142, col143, col144, col145, col146, col147, col148) PARTITION BY LIST (col136) (
            PARTITION p1 VALUES IN ((1)),
            PARTITION p2 VALUES IN ((2)),
            PARTITION p3 VALUES IN ((3)),
            PARTITION p4 VALUES IN ((4)),
        ...
        INDEX index12 (col136 ASC, col140 ASC) PARTITION BY LIST (col136) (
            PARTITION p1 VALUES IN ((1)),
            PARTITION p2 VALUES IN ((2)),
            PARTITION p3 VALUES IN ((3)),
            PARTITION p4 VALUES IN ((4)),
        ...
        INDEX index13 (col136 ASC, col8 ASC, col13 ASC) STORING (col9, col20, col41, col53, col56, col61, col62, col112, col6, col113) PARTITION BY LIST (col136) (
            PARTITION p1 VALUES IN ((1)),
            PARTITION p2 VALUES IN ((2)),
            PARTITION p3 VALUES IN ((3)),
            PARTITION p4 VALUES IN ((4)),
            ...
            PARTITION p17 VALUES IN ((17)),
            PARTITION p18 VALUES IN ((18))
        ) WHERE ((col112 = 3:::INT8) AND (col113 = false)) AND (col6 NOT IN ('b':::STRING, 'c':::STRING)),
        CONSTRAINT check1 CHECK (col136 IN (1:::INT8, 2:::INT8, 3:::INT8, 4:::INT8, 5:::INT8, 6:::INT8, 7:::INT8, 8:::INT8, 9:::INT8, 10:::INT8, 11:::INT8, 12:::INT8, 13:::INT8, 14:::INT8, 15:::INT8, 16:::INT8, 17:::INT8, 18:::INT8))
    ) PARTITION BY LIST (col136) (
        PARTITION p1 VALUES IN ((1)),
        PARTITION p2 VALUES IN ((2)),
        PARTITION p3 VALUES IN ((3)),
        PARTITION p4 VALUES IN ((4)),
  ...
  `,
    ...
    CREATE TABLE tab2 (
        ...
        col2 DECIMAL NOT NULL DEFAULT 0:::DECIMAL,
        col3 INT2 NOT NULL DEFAULT 0:::INT8,
        col4 TIMESTAMPTZ NOT NULL DEFAULT now():::TIMESTAMPTZ,
        col5 INT8 NOT NULL,
        col6 STRING NULL,
        col7 STRING NULL,
        ...
        col13 STRING NULL,
        col14 FLOAT8 NOT NULL DEFAULT 0.0:::FLOAT8,
        col15 DECIMAL NOT NULL DEFAULT 0:::DECIMAL,
        col16 STRING NULL,
        col17 INT8 NULL,
        col18 INT8 NULL,
        col19 INT4 NULL,
        col20 TIMESTAMPTZ NULL,
        col21 INT8 NULL,
        col22 INT8 NULL,
        col23 INT8 NULL,
        col24 STRING NULL,
        ...
        col27 STRING NULL,
        col28 STRING NULL,
        col29 DECIMAL NOT NULL DEFAULT 0:::DECIMAL,
        col30 TIMESTAMPTZ NULL DEFAULT now():::TIMESTAMPTZ,
        col31 INT8 NOT NULL DEFAULT 1:::INT8,
        col32 TIMESTAMPTZ NULL,
        col33 TIMESTAMPTZ NOT NULL DEFAULT now():::TIMESTAMPTZ,
        col34 DECIMAL NULL DEFAULT 1:::DECIMAL,
        col35 STRING NULL,
        col36 STRING NULL,
        col37 INT2 NOT NULL,
        col38 INT2 NULL,
        ...
        col88 STRING NULL,
        col89 INT4 NOT NULL,
        col90 UUID NOT NULL DEFAULT gen_random_uuid(),
        CONSTRAINT "primary" PRIMARY KEY (col89 ASC, col5 ASC, col1 ASC),
        CONSTRAINT fk1 FOREIGN KEY (col89, col5) REFERENCES tab1(col136, col1),
        UNIQUE INDEX index1 (col89 ASC, col1 ASC) PARTITION BY LIST (col89) (
            PARTITION p1 VALUES IN ((1)),
            PARTITION p2 VALUES IN ((2)),
            PARTITION p3 VALUES IN ((3)),
            PARTITION p4 VALUES IN ((4)),
        ...
        INDEX index2 (col89 ASC, col5 ASC, col38 ASC, col33 ASC) PARTITION BY LIST (col89) (
            PARTITION p1 VALUES IN ((1)),
            PARTITION p2 VALUES IN ((2)),
            PARTITION p3 VALUES IN ((3)),
            PARTITION p4 VALUES IN ((4)),
        ...
        INDEX index3 (col89 ASC, col11 ASC) PARTITION BY LIST (col89) (
            PARTITION p1 VALUES IN ((1)),
            PARTITION p2 VALUES IN ((2)),
            PARTITION p3 VALUES IN ((3)),
            PARTITION p4 VALUES IN ((4)),
        ...
        INDEX index4 (col89 ASC, col17 ASC) PARTITION BY LIST (col89) (
            PARTITION p1 VALUES IN ((1)),
            PARTITION p2 VALUES IN ((2)),
            PARTITION p3 VALUES IN ((3)),
            PARTITION p4 VALUES IN ((4)),
        ...
        INDEX index5 (col89 ASC, col18 ASC) PARTITION BY LIST (col89) (
            PARTITION p1 VALUES IN ((1)),
            PARTITION p2 VALUES IN ((2)),
            PARTITION p3 VALUES IN ((3)),
            PARTITION p4 VALUES IN ((4)),
        ...
        INDEX index6 (col89 ASC, col5 ASC) STORING (col38, col9, col10, col42, col40, col47, col46, col53, col11, col19, col8, col72, col73, col74, col49, col76, col29, col58, col82, col24) PARTITION BY LIST (col89) (
            PARTITION p1 VALUES IN ((1)),
            PARTITION p2 VALUES IN ((2)),
            PARTITION p3 VALUES IN ((3)),
            PARTITION p4 VALUES IN ((4)),
        ...
        INDEX index7 (col89 ASC, col11 ASC, col17 ASC, col38 ASC, col8 ASC, col51 ASC, col5 ASC, col75 ASC, col33 ASC, col1 ASC) STORING (col3, col35) PARTITION BY LIST (col89) (
            PARTITION p1 VALUES IN ((1)),
            PARTITION p2 VALUES IN ((2)),
            PARTITION p3 VALUES IN ((3)),
            PARTITION p4 VALUES IN ((4)),
        ...
        INDEX index8 (col89 ASC, col51 ASC, col17 ASC, col33 ASC) PARTITION BY LIST (col89) (
            PARTITION p1 VALUES IN ((1)),
            PARTITION p2 VALUES IN ((2)),
            PARTITION p3 VALUES IN ((3)),
            PARTITION p4 VALUES IN ((4)),
        ...
        INDEX index9 (col89 ASC, col5 ASC, col33 ASC) PARTITION BY LIST (col89) (
            PARTITION p1 VALUES IN ((1)),
            PARTITION p2 VALUES IN ((2)),
            PARTITION p3 VALUES IN ((3)),
            PARTITION p4 VALUES IN ((4)),
        ...
        INDEX index10 (col89 ASC, col18 ASC, col5 ASC, col33 ASC) PARTITION BY LIST (col89) (
            PARTITION p1 VALUES IN ((1)),
            PARTITION p2 VALUES IN ((2)),
            PARTITION p3 VALUES IN ((3)),
            PARTITION p4 VALUES IN ((4)),
        ...
        CONSTRAINT check1 CHECK (col89 IN (1:::INT8, 2:::INT8, 3:::INT8, 4:::INT8, 5:::INT8, 6:::INT8, 7:::INT8, 8:::INT8, 9:::INT8, 10:::INT8, 11:::INT8, 12:::INT8, 13:::INT8, 14:::INT8, 15:::INT8, 16:::INT8, 17:::INT8, 18:::INT8))
    ) PARTITION BY LIST (col89) (
        PARTITION p1 VALUES IN ((1)),
        PARTITION p2 VALUES IN ((2)),
        PARTITION p3 VALUES IN ((3)),
        PARTITION p4 VALUES IN ((4)),
...
var slowQueries = [...]benchQuery{
	...
	// 3. A long-running query from support issue #1710.
	{
		name: "slow-query-1",
		query: `
	...
	},
	{
      ...
      FROM
        tab1
        INNER JOIN tab2 ON
            tab1.col1 = tab2.col5 AND tab1.col136 = tab2.col89
      WHERE
        tab1.col1
        IN (
            10:::INT8,
        ...
        AND tab1.col8 > '2022-01-20 00:00:00+00:00'
        AND tab1.col8 < '2022-02-20 00:00:00+00:00'
        AND tab1.col20 = 450
        AND tab1.col40 = 10
      ORDER BY
        tab1.col8 DESC;
