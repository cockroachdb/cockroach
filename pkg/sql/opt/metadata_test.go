...
func TestMatchPredicatesInNewTable(t *testing.T) {
	...
	// Create test catalog with matching tables
	testCat := testcat.New()
	...
	// Verify all matched predicates use the same expression
	...
	// Test with non-matching predicates
