...
var informationSchema = virtualSchema{
	...
	tableDefs: map[descpb.ID]virtualSchemaDef{
		...
		catconstants.InformationSchemaCrdbStatementStatisticsTableID:         informationSchemaCrdbStatementStatisticsTable,
		catconstants.InformationSchemaCrdbTransactionStatisticsTableID:       informationSchemaCrdbTransactionStatisticsTable,
...
// informationSchemaCrdbStatementStatisticsTable exposes persisted statement
// statistics through information_schema.
var informationSchemaCrdbStatementStatisticsTable = virtualSchemaView{
	comment: `persisted user-workload statement statistics.`,
	schema:  vtable.CRDBStatementStatistics,
	resultColumns: colinfo.ResultColumns{
		...
		{Name: "exec_sample_count", Typ: types.Int},
		{Name: "svc_lat_sum", Typ: types.Float},
		{Name: "cpu_sql_nanos_sum", Typ: types.Float},
		{Name: "contention_time_sum", Typ: types.Float},
		{Name: "svc_lat_sum_sq", Typ: types.Float},
		{Name: "cpu_sql_nanos_sum_sq", Typ: types.Float},
		{Name: "contention_time_sum_sq", Typ: types.Float},
		{Name: "kv_cpu_time_nanos_sum", Typ: types.Float},
		{Name: "kv_cpu_time_nanos_sum_sq", Typ: types.Float},
		{Name: "admission_wait_time_sum", Typ: types.Float},
		{Name: "admission_wait_time_sum_sq", Typ: types.Float},
		{Name: "rows_read_sum", Typ: types.Float},
		{Name: "rows_written_sum", Typ: types.Float},
		{Name: "bytes_read_sum", Typ: types.Float},
		{Name: "bytes_read_sum_sq", Typ: types.Float},
		{Name: "max_retries", Typ: types.Int},
...
// informationSchemaCrdbTransactionStatisticsTable exposes persisted transaction
// statistics through information_schema.
var informationSchemaCrdbTransactionStatisticsTable = virtualSchemaView{
	comment: `persisted user-workload transaction statistics.`,
	schema:  vtable.CRDBTransactionStatistics,
	resultColumns: colinfo.ResultColumns{
		{Name: "aggregated_ts", Typ: types.TimestampTZ},
		{Name: "fingerprint_id", Typ: types.Bytes},
		{Name: "app_name", Typ: types.String},
		...
		{Name: "bytes_read_sum_sq", Typ: types.Float},
		{Name: "max_retries", Typ: types.Int},
		{Name: "commit_lat_sum", Typ: types.Float},
		{Name: "commit_lat_sum_sq", Typ: types.Float},
		{Name: "stmt_fingerprint_ids", Typ: types.BytesArray},
	},
}
