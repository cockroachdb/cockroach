...
// on demand. This is important for callers dealing with objects like foreign keys.
...
func forEachForeignKeyInTable(
	table *sqlbase.TableDescriptor,
	fn func(
		*sqlbase.IndexDescriptor,
		*sqlbase.ForeignKeyReference,
	) error,
) error {
	for i := range table.Indexes {
