...
func userCanSeeTable(
	ctx context.Context, p *planner, table sqlbase.TableDescriptorInterface, allowAdding bool,
) bool {
	return tableIsVisible(table, allowAdding) && p.CheckAnyPrivilege(ctx, table) == nil
}

func tableIsVisible(table sqlbase.TableDescriptorInterface, allowAdding bool) bool {
