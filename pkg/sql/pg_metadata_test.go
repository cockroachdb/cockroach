...
// This var will be used to map automatically function names with specific
...
func cacheGetFile(file string) func() string {
	path := ""
	return func() string {
		if path == "" {
			var err error
...
var getSQLPGCatalogFile = cacheGetFile(pgCatalogGo)
var getVTablePGCatalogFile = cacheGetFile(filepath.Join(vtablePkg, pgCatalogGo))
