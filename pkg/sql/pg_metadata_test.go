...
func NewDiffTool(t *testing.T) *DiffTool {
	flag.Parse()
	return &DiffTool{
		rewrite:          *rewriteFlag,
...
func (d *DiffTool) Catalog(catalogName string) *DiffTool {
	d.catalogName = catalogName
	return d
}

func (d *DiffTool) RDBMS(rdbms string) *DiffTool {
	d.rdbmsName = rdbms
	return d
}
...
func (d *DiffTool) expectedDiffsFilename() string {
...
func (d *DiffTool) loadTestData(testdataFile string, file interface{}) {
...
func (d *DiffTool) loadCockroachPgCatalog() PGMetadataTables {
...
func (d *DiffTool) errorf(format string, args ...interface{}) {
	if !d.rewrite {
		d.t.Errorf(format, args...)
	}
}

func (d *DiffTool) rewriteDiffs(diffs PGMetadataTableDiffs, source PGMetadataFile, sum Summary) {
	if !d.rewrite {
		return
	}
...
func (d *DiffTool) TestTable(tableName string, fn func(t *testing.T)) {
...
// Run will execute the diff tool with all the configurations that are in DiffTool structure.
func (d *DiffTool) Run() {
...
func (d *DiffTool) getTestDataFileName() string {
