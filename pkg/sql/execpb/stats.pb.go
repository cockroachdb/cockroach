...
func (*VectorizedStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_stats_253d84d55000215a, []int{0}
}
...
func init() { proto.RegisterFile("sql/execpb/stats.proto", fileDescriptor_stats_253d84d55000215a) }

var fileDescriptor_stats_253d84d55000215a = []byte{
