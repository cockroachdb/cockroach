...
func populateExplain(
	...
	if plan.main.physPlan != nil {
		physicalPlan = *plan.main.physPlan
	} else {
		physicalPlan, err = makePhysicalPlan(planCtx, distSQLPlanner, plan.main.planNode)
	}
	if err == nil {
...
func observePlan(
	...
	if plan.main.physPlan != nil {
		return errors.AssertionFailedf(
			"EXPLAIN of a query with execbuilder-driven physical plan creation is not supported",
		)
	}
