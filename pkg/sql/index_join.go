...
func (p *planner) makeIndexJoin(
	...
	_ = table.initDescDefaults(p.planDeps, origScan.scanVisibility, nil /* wantedColumns */)
	table.initOrdering(0 /* exactPrefix */, &p.evalCtx.EvalContext)
	...
	indexScan.initOrdering(exactPrefix, &p.evalCtx.EvalContext)
