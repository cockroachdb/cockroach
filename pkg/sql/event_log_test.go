...
func TestPerfLogging(t *testing.T) {
	...
	var testCases = []struct {
		...
		// Tests for the limits on the number of txn rows written/rows.
		{
			// Enable the relevant cluster settings and reset the session
			// variables to the values of the cluster settings just set.
			setup: `
                    SET CLUSTER SETTING sql.defaults.transaction_rows_written.log = 2;
                    SET CLUSTER SETTING sql.defaults.transaction_rows_written.err = 3;
                    SET CLUSTER SETTING sql.defaults.transaction_rows_read.log = 2;
                    SET CLUSTER SETTING sql.defaults.transaction_rows_read.err = 3;
		...
		},
		{
			...
			errRe:       ``,
			logRe:       `"EventType":"txn_rows_written_limit_reached"`,
			logExpected: false,
			channel:     channel.SQL_PERF,
		},
		{
		...
		},
		{
			...
			errRe:       `pq: txn reached the number of rows written.*`,
			logRe:       `"EventType":"txn_rows_written_limit_reached"`,
			logExpected: true,
			channel:     channel.SQL_PERF,
		},
		...
		},
		{
			...
			errRe:       ``,
			logRe:       `"EventType":"txn_rows_read_limit_reached"`,
			logExpected: false,
			channel:     channel.SQL_PERF,
		},
		{
		...
		},
		{
			...
			errRe:       `pq: txn reached the number of rows read.*`,
			logRe:       `"EventType":"txn_rows_read_limit_reached"`,
			logExpected: true,
			channel:     channel.SQL_PERF,
		},
		...
		},
		{
			...
			// variables to the values of the cluster settings just set.
			setup: `
                    SET CLUSTER SETTING sql.defaults.transaction_rows_written.log = DEFAULT;
                    SET CLUSTER SETTING sql.defaults.transaction_rows_written.err = DEFAULT;
                    SET CLUSTER SETTING sql.defaults.transaction_rows_read.log = DEFAULT;
                    SET CLUSTER SETTING sql.defaults.transaction_rows_read.err = DEFAULT;
                    RESET transaction_rows_written_log;
                    RESET transaction_rows_written_err;
                    RESET transaction_rows_read_log;
                    RESET transaction_rows_read_err;
