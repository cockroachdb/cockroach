...
func TestPerfLogging(t *testing.T) {
	...
	var testCases = []struct {
		...
		// limits are reached when the former is smaller.
		{
			...
			errRe:       `pq: txn reached the number of rows written \(3\): TxnID .* SessionID .*`,
			logRe:       `"EventType":"txn_rows_written_limit","Statement":"INSERT INTO.*","TxnID":".*","SessionID":".*","LimitValue":2`,
			logExpected: true,
			channel:     channel.SQL_PERF,
		},
		{
			...
			query:       `INSERT INTO t(i) VALUES (15), (16); INSERT INTO t(i) VALUES (17);`,
			errRe:       `pq: txn reached the number of rows written \(3\): TxnID .* SessionID .*`,
			logRe:       `"EventType":"txn_rows_written_limit","Statement":"INSERT INTO.*","TxnID":".*","SessionID":".*","LimitValue":3`,
			logExpected: true,
			channel:     channel.SQL_PERF,
		},
		{
