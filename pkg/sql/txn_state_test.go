...
func checkAdv(adv advanceInfo, expCode advanceCode, expFlush flushOpt, expRewPos cmdPos) error {
	if adv.code != expCode {
...
func TestTransitions(t *testing.T) {
	...
	tests := []test{
		...
		//
		{
			...
			evPayload: eventTxnStartPayload{tranCtx: tranCtx, iso: iso, pri: pri},
