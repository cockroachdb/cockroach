...
// WaitForIndexStatsIngestionForTest takes
// * the event channel created by CreateIndexStatsIngestedCallbackForTest
// * an expected map of roachpb.IndexUsageKey
// * the total expected event counts
// * maximum amount of time it will wait for the event to occur
// and blocks until all the expected events in the expected map has occurred.
