...
// implements additional methods to support unused index recommendations.
...
// AddRecommendationsForIndex add index recommendations to the index
// if applicable.
