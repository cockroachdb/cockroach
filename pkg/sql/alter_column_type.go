...
func AlterColumnType(
	...
	case schemachange.ColumnConversionGeneral:
		if err := alterColumnTypeGeneral(tableDesc, col, typ, t.Using, params); err != nil {
			return err
		}
		if err := params.p.createOrUpdateSchemaChangeJob(params.ctx, tableDesc, t.String(), tableDesc.ClusterVersion.NextMutationID); err != nil {
			return err
		}
