...
func (d *rowCodec) encodeValue(
	guard settingswatcher.VersionGuard,
	rpcAddr string,
	sqlAddr string,
	...
	if guard.IsActive(clusterversion.V24_2_SQLInstancesAddDraining) {
...
func (d *rowCodec) encodeAvailableValue(
	guard settingswatcher.VersionGuard,
) (*roachpb.Value, error) {
	value, err := d.encodeValue(guard, "", "", sqlliveness.SessionID([]byte{}), roachpb.Locality{}, roachpb.Version{}, false)
	if err != nil {
