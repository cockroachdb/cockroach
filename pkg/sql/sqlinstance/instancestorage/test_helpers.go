...
// FakeStorage implements the instanceprovider.writer interface.
...
// StartIDAllocator implements the instanceprovider.writer interface.
func (f *FakeStorage) StartIDAllocator(
	ctx context.Context,
