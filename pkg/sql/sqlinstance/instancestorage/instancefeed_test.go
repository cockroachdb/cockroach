...
func TestEmptyInstanceFeed(t *testing.T) {
	...
	var feed instanceFeed = &emptyInstanceFeed{}
...
func TestSingletonFeed(t *testing.T) {
	...
	var feed instanceFeed = &singletonInstanceFeed{instance: instance}
...
func TestRangeFeed(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		feed, err := storage.newInstanceFeed(ctx)
	...
	t.Run("auth_error", func(t *testing.T) {
		...
		_, err := storage.newInstanceFeed(ctx)
