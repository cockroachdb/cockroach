...
// InternalSQLExecutor is meant to be used by layers below SQL in the system that
...
type InternalSQLExecutor interface {
	...
	Exec(ctx context.Context, txn *client.Txn, statement string, params ...interface{}) (int, error)
	...
	// If txn is not nil, the statement will be executed in the respective txn.
	Query(
		ctx context.Context, txn *client.Txn, statement string, qargs ...interface{},
