...
func (t *ttlProcessor) work(ctx context.Context) error {
	...
	updateFractionCompleted := func() error {
		jobID := ttlSpec.JobID
		spansToAdd := spansProccessedSinceLastUpdate.Load()
		rowsToAdd := rowsProccessedSinceLastUpdate.Load()
		spansProccessedSinceLastUpdate.Add(-spansToAdd)
		rowsProccessedSinceLastUpdate.Add(-rowsToAdd)
