...
func TestConcurrentGrants(t *testing.T) {
	...
	t.Run("concurrent GRANTs", func(t *testing.T) {
		runConcurrentGrantsWithPriority(t, "NORMAL" /* priority */)
	})

	t.Run("concurrent GRANTs high priority", func(t *testing.T) {
		runConcurrentGrantsWithPriority(t, "HIGH" /* priority */)
	})
}
