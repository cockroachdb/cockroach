...
func TestCheckAnyPrivilegeForNodeUser(t *testing.T) {
	...
	cf.TxnWithExecutor(ctx, ts.DB(), nil /* sessionData */, func(ctx context.Context, txn *kv.Txn, collection collectionfactory.DescsCollection, ie sqlutil.InternalExecutor) error {
