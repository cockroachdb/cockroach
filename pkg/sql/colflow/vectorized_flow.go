...
// TODO(alyshan): Will need to plumb workload info through to these interface
// methods so remote components can instrument their work. Why does outbox get
// the flowCtx but not inbox? Workload info will be present in flowCtx.EvalCtx.
