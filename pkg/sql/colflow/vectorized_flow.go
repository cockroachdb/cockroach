...
type flowCreatorHelper interface {
	...
	addMaterializer(*colfetcher.Materializer)
...
func (s *vectorizedFlowCreator) setupOutput(
	...
	case execinfrapb.StreamEndpointSpec_SYNC_RESPONSE:
		...
		proc, err := colfetcher.NewMaterializer(
			flowCtx,
			pspec.ProcessorID,
			op,
			columnTypes,
...
func (r *vectorizedFlowCreatorHelper) addMaterializer(m *colfetcher.Materializer) {
...
func (r *noopFlowCreatorHelper) addMaterializer(*colfetcher.Materializer) {}
