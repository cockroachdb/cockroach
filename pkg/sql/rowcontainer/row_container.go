...
// concurrently after all rows have already been added into the container.
type RowIterator interface {
	...
	// modified, so shallow copying is sufficient. Note that it does *not* copy
	// the row: callers must copy the row if they wish to mutate it.
