...
// De-duplication is a special feature of the DiskRowContainer that must be
// used in conjunction with AddRowWithDeDup(). It should not be mixed with
