...
func TestGetZoneConfig(t *testing.T) {
	...
	tb21Cfg := config.ZoneConfig{
		...
		SubzoneSpans: []config.SubzoneSpan{
			{SubzoneIndex: 0, Span: roachpb.Span{Key: []byte{1}}},
			{SubzoneIndex: 1, Span: roachpb.Span{Key: []byte{3}, EndKey: []byte{5}}},
			{SubzoneIndex: 0, Span: roachpb.Span{Key: []byte{6}}},
		},
	}
	...
	tb22Cfg := config.ZoneConfig{
		...
		SubzoneSpans: []config.SubzoneSpan{
			{SubzoneIndex: 0, Span: roachpb.Span{Key: []byte{1}, EndKey: []byte{255}}},
		},
	}
