...
type planner struct {
	...
	// isSingleStmtTxn tracks if this transaction only consists of a single
	// statement, implying this transaction is implicit and consists of one
	// statement.
	isSingleStmtTxn bool
