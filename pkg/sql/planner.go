...
func (p *planner) DeleteStatementHint(
	ctx context.Context, rowID int64, statementFingerprint string, donorSQL string,
) (int64, error) {
	return hints.DeleteHintFromDB(ctx, p.InternalSQLTxn(), rowID, statementFingerprint, donorSQL)
}
