...
const All_Slot_Rn_Num = 6
const All_Slot_Rn_BitSize = 64
const All_Slot_Rn_BitOffset = 0
const All_Slot_Rn_ByteSize = 8
const All_Slot_Rn_ByteOffset = 0
const All_Slot_Rn_ValueMask = 0xffffffffffffffff
...
func (x AllValue) R(a Allocator) All {
	...
	ref.nums[2] = numvalslot(x.I8)
	ref.nums[3] = numvalslot(x.U8)
	ref.nums[4] = numvalslot(x.I16)
	ref.nums[5] = numvalslot(x.U16)
	ref.nums[6] = numvalslot(x.Rn)
	ref.nums[7] = numvalslot(x.I32)
	ref.nums[8] = numvalslot(x.U32)
	ref.nums[9] = numvalslot(x.I64)
	extra.U64 = x.U64
...
func (x All) I8() int8 { return int8(x.ref.nums[2]) }

// U8 returns the U8 field.
func (x All) U8() uint8 { return uint8(x.ref.nums[3]) }

// I16 returns the I16 field.
func (x All) I16() int16 { return int16(x.ref.nums[4]) }

// U16 returns the U16 field.
func (x All) U16() uint16 { return uint16(x.ref.nums[5]) }

// Rn returns the Rn field.
func (x All) Rn() rune { return rune(x.ref.nums[6]) }

// I32 returns the I32 field.
func (x All) I32() int32 { return int32(x.ref.nums[7]) }

// U32 returns the U32 field.
func (x All) U32() uint32 { return uint32(x.ref.nums[8]) }

// I64 returns the I64 field.
func (x All) I64() int64 { return int64(x.ref.nums[9]) }
...
func (x All) V() AllValue {
	return AllValue{
		...
		I8:  int8(x.ref.nums[2]),
		U8:  uint8(x.ref.nums[3]),
		I16: int16(x.ref.nums[4]),
		U16: uint16(x.ref.nums[5]),
		Rn:  rune(x.ref.nums[6]),
		I32: int32(x.ref.nums[7]),
		U32: uint32(x.ref.nums[8]),
		I64: int64(x.ref.nums[9]),
...
func (x SmallBefore) C() byte { return byte(x.ref.nums[2]) }

// D returns the D field.
func (x SmallBefore) D() byte { return byte(x.ref.nums[3]) }

// E returns the E field.
func (x SmallBefore) E() byte { return byte(x.ref.nums[4]) }
...
// E returns the E field.
func (x BigBefore) E() byte { return byte(x.ref.nums[4]) }

// F returns the F field.
func (x BigBefore) F() byte { return byte(x.ref.nums[5]) }

// G returns the G field.
func (x BigBefore) G() byte { return byte(x.ref.nums[6]) }
