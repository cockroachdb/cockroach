...
func (x SmallBefore) FormatSExpr(buf *bytes.Buffer) {
	...
	buf.WriteString(" C: ")
	FormatSExprByte(buf, x.C())

	buf.WriteString(" D: ")
	FormatSExprByte(buf, x.D())

	buf.WriteString(" E: ")
	FormatSExprByte(buf, x.E())
...
func (x BigBefore) FormatSExpr(buf *bytes.Buffer) {
	...
	buf.WriteString(" F: ")
	FormatSExprByte(buf, x.F())

	buf.WriteString(" G: ")
	FormatSExprByte(buf, x.G())
