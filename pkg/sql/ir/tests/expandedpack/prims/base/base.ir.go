...
const All_Slot_B_Num = 4
const All_Slot_B_BitSize = 1
const All_Slot_B_BitOffset = 8
const All_Slot_B_ByteSize = 1
const All_Slot_B_ByteOffset = 1
const All_Slot_B_ValueMask = 0x1

const All_Slot_Bi_Type = 1
const All_Slot_Bi_Num = 3
const All_Slot_Bi_BitSize = 8
const All_Slot_Bi_BitOffset = 48
const All_Slot_Bi_ByteSize = 1
const All_Slot_Bi_ByteOffset = 6
const All_Slot_Bi_ValueMask = 0xff
...
const All_Slot_I8_Num = 3
const All_Slot_I8_BitSize = 8
const All_Slot_I8_BitOffset = 56
const All_Slot_I8_ByteSize = 1
const All_Slot_I8_ByteOffset = 7
const All_Slot_I8_ValueMask = 0xff

const All_Slot_Rn_Type = 1
const All_Slot_Rn_Num = 3
const All_Slot_Rn_BitSize = 16
const All_Slot_Rn_BitOffset = 32
const All_Slot_Rn_ByteSize = 2
const All_Slot_Rn_ByteOffset = 4
const All_Slot_Rn_ValueMask = 0xffff
...
func (x AllValue) R(a Allocator) All {
	...
	if x.B {
		ref.nums[4] |= (numvalslot(1) << All_Slot_B_BitOffset)
	} else {
		ref.nums[4] &^= (numvalslot(1) << All_Slot_B_BitOffset)
	}
	ref.nums[3] = (ref.nums[3] &^ (All_Slot_Bi_ValueMask << All_Slot_Bi_BitOffset)) | (numvalslot(x.Bi) << All_Slot_Bi_BitOffset)
	ref.nums[3] = (ref.nums[3] &^ (All_Slot_I8_ValueMask << All_Slot_I8_BitOffset)) | (numvalslot(x.I8) << All_Slot_I8_BitOffset)
	ref.nums[4] = (ref.nums[4] &^ (All_Slot_U8_ValueMask << All_Slot_U8_BitOffset)) | (numvalslot(x.U8) << All_Slot_U8_BitOffset)
	ref.nums[3] = (ref.nums[3] &^ (All_Slot_I16_ValueMask << All_Slot_I16_BitOffset)) | (numvalslot(x.I16) << All_Slot_I16_BitOffset)
	ref.nums[3] = (ref.nums[3] &^ (All_Slot_U16_ValueMask << All_Slot_U16_BitOffset)) | (numvalslot(x.U16) << All_Slot_U16_BitOffset)
	ref.nums[3] = (ref.nums[3] &^ (All_Slot_Rn_ValueMask << All_Slot_Rn_BitOffset)) | (numvalslot(x.Rn) << All_Slot_Rn_BitOffset)
	ref.nums[2] = (ref.nums[2] &^ (All_Slot_I32_ValueMask << All_Slot_I32_BitOffset)) | (numvalslot(x.I32) << All_Slot_I32_BitOffset)
	ref.nums[2] = (ref.nums[2] &^ (All_Slot_U32_ValueMask << All_Slot_U32_BitOffset)) | (numvalslot(x.U32) << All_Slot_U32_BitOffset)
	ref.nums[0] = numvalslot(x.I64)
	ref.nums[1] = numvalslot(x.U64)
	ref.strs[0] = string(x.S)
	extra.F32 = x.F32
	extra.F64 = x.F64
	return All{ref}
}
...
func (x All) B() bool { return !(0 == (x.ref.nums[4] >> All_Slot_B_BitOffset & All_Slot_B_ValueMask)) }

// Bi returns the Bi field.
func (x All) Bi() byte { return byte((x.ref.nums[3] >> All_Slot_Bi_BitOffset) & All_Slot_Bi_ValueMask) }

// I8 returns the I8 field.
func (x All) I8() int8 { return int8((x.ref.nums[3] >> All_Slot_I8_BitOffset) & All_Slot_I8_ValueMask) }

// U8 returns the U8 field.
func (x All) U8() uint8 {
	return uint8((x.ref.nums[4] >> All_Slot_U8_BitOffset) & All_Slot_U8_ValueMask)
}

// I16 returns the I16 field.
func (x All) I16() int16 {
	return int16((x.ref.nums[3] >> All_Slot_I16_BitOffset) & All_Slot_I16_ValueMask)
}

// U16 returns the U16 field.
func (x All) U16() uint16 {
	return uint16((x.ref.nums[3] >> All_Slot_U16_BitOffset) & All_Slot_U16_ValueMask)
}

// Rn returns the Rn field.
func (x All) Rn() rune { return rune((x.ref.nums[3] >> All_Slot_Rn_BitOffset) & All_Slot_Rn_ValueMask) }

// I32 returns the I32 field.
func (x All) I32() int32 {
	return int32((x.ref.nums[2] >> All_Slot_I32_BitOffset) & All_Slot_I32_ValueMask)
}

// U32 returns the U32 field.
func (x All) U32() uint32 {
	return uint32((x.ref.nums[2] >> All_Slot_U32_BitOffset) & All_Slot_U32_ValueMask)
}
...
func (x All) S() string { return string(x.ref.strs[0]) }
...
func (x All) V() AllValue {
	return AllValue{
		B:   !(0 == (x.ref.nums[4] >> All_Slot_B_BitOffset & All_Slot_B_ValueMask)),
		Bi:  byte((x.ref.nums[3] >> All_Slot_Bi_BitOffset) & All_Slot_Bi_ValueMask),
		I8:  int8((x.ref.nums[3] >> All_Slot_I8_BitOffset) & All_Slot_I8_ValueMask),
		U8:  uint8((x.ref.nums[4] >> All_Slot_U8_BitOffset) & All_Slot_U8_ValueMask),
		I16: int16((x.ref.nums[3] >> All_Slot_I16_BitOffset) & All_Slot_I16_ValueMask),
		U16: uint16((x.ref.nums[3] >> All_Slot_U16_BitOffset) & All_Slot_U16_ValueMask),
		Rn:  rune((x.ref.nums[3] >> All_Slot_Rn_BitOffset) & All_Slot_Rn_ValueMask),
		I32: int32((x.ref.nums[2] >> All_Slot_I32_BitOffset) & All_Slot_I32_ValueMask),
		U32: uint32((x.ref.nums[2] >> All_Slot_U32_BitOffset) & All_Slot_U32_ValueMask),
		I64: int64(x.ref.nums[0]),
		U64: uint64(x.ref.nums[1]),
		S:   string(x.ref.strs[0]),
...
func (x SmallBefore) C() byte {
	return byte((x.ref.nums[2] >> SmallBefore_Slot_C_BitOffset) & SmallBefore_Slot_C_ValueMask)
}

// D returns the D field.
func (x SmallBefore) D() byte {
	return byte((x.ref.nums[2] >> SmallBefore_Slot_D_BitOffset) & SmallBefore_Slot_D_ValueMask)
}

// E returns the E field.
func (x SmallBefore) E() byte {
	return byte((x.ref.nums[2] >> SmallBefore_Slot_E_BitOffset) & SmallBefore_Slot_E_ValueMask)
}
...
func (x SmallBefore) V() SmallBeforeValue {
	return SmallBeforeValue{
		...
		C: byte((x.ref.nums[2] >> SmallBefore_Slot_C_BitOffset) & SmallBefore_Slot_C_ValueMask),
		D: byte((x.ref.nums[2] >> SmallBefore_Slot_D_BitOffset) & SmallBefore_Slot_D_ValueMask),
		E: byte((x.ref.nums[2] >> SmallBefore_Slot_E_BitOffset) & SmallBefore_Slot_E_ValueMask),
...
// E returns the E field.
func (x BigBefore) E() byte {
	return byte((x.ref.nums[2] >> BigBefore_Slot_E_BitOffset) & BigBefore_Slot_E_ValueMask)
}

// F returns the F field.
func (x BigBefore) F() byte {
	return byte((x.ref.nums[2] >> BigBefore_Slot_F_BitOffset) & BigBefore_Slot_F_ValueMask)
}

// G returns the G field.
func (x BigBefore) G() byte {
	return byte((x.ref.nums[2] >> BigBefore_Slot_G_BitOffset) & BigBefore_Slot_G_ValueMask)
}
...
func (x BigBefore) V() BigBeforeValue {
	return BigBeforeValue{
		...
		E: byte((x.ref.nums[2] >> BigBefore_Slot_E_BitOffset) & BigBefore_Slot_E_ValueMask),
		F: byte((x.ref.nums[2] >> BigBefore_Slot_F_BitOffset) & BigBefore_Slot_F_ValueMask),
		G: byte((x.ref.nums[2] >> BigBefore_Slot_G_BitOffset) & BigBefore_Slot_G_ValueMask),
...
// Codegen parameters:
// {NumNumericSlots:10 NumericSlotSize:64 NumRefSlots:10 NumStrSlots:10 Pack:true AllowUnsafe:false}
//
