...
const All_Slot_B_BitOffset = 48
const All_Slot_B_ByteSize = 1
const All_Slot_B_ByteOffset = 6
...
const All_Slot_I8_BitOffset = 32
const All_Slot_I8_ByteSize = 1
const All_Slot_I8_ByteOffset = 4
...
const All_Slot_U8_Num = 3
const All_Slot_U8_BitSize = 8
const All_Slot_U8_BitOffset = 40
const All_Slot_U8_ByteSize = 1
const All_Slot_U8_ByteOffset = 5
...
func (x AllValue) R(a *Allocator) All {
	...
	ref.nums[3] = (ref.nums[3] &^ (All_Slot_U8_ValueMask << All_Slot_U8_BitOffset)) | (numvalslot(x.U8) << All_Slot_U8_BitOffset)
...
func (x All) U8() uint8 {
	return uint8((x.ref.nums[3] >> All_Slot_U8_BitOffset) & All_Slot_U8_ValueMask)
}
...
func (x All) V() AllValue {
	return AllValue{
		...
		U8:  uint8((x.ref.nums[3] >> All_Slot_U8_BitOffset) & All_Slot_U8_ValueMask),
