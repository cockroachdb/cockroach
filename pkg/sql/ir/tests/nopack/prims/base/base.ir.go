...
const All_Slot_Bi_BitSize = 64
const All_Slot_Bi_BitOffset = 0
const All_Slot_Bi_ByteSize = 8
const All_Slot_Bi_ByteOffset = 0
const All_Slot_Bi_ValueMask = 0xffffffffffffffff
...
func (x All) Bi() byte { return byte(x.ref.nums[1]) }
