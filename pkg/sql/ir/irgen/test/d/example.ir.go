// DO NOT EDIT -- code generated by ./irgen d/template.go test/example.def
...
func (x All) A() All { return All{x.ref.extra.(*extraAll).refs[2]} }
...
func (x All) V() AllValue {
	return AllValue{
		...
		BinOp(x.ref.enums[0]),
		All{x.ref.extra.(*extraAll).refs[2]},
	}
}
...
// the argument.
func (x AllValue) WithA(y All) AllValue {
	x.A = y
	return x
}
