...
`); err != nil {
	...
	require.Equal(t, `relation "test" (53): referenced database descriptor 52 not found`, errStr)
	...
	require.Equal(t, `relation "tbl" (55): invalid foreign key: missing table=54: referenced table descriptor 54 not found`, errStr)
