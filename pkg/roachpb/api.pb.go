...
// ScatterRequest is the argument to the Scatter() method, which moves replicas
// and leaseholders for a selection of ranges. Scatter is best-effort,
// specifically ranges that cannot be moved will include an error detail in the
// response and won't fail the request.
type ScatterRequest struct {
	Span  `protobuf:"bytes,1,opt,name=header,embedded=header" json:"header"`
	Spans []Span `protobuf:"bytes,2,rep,name=spans" json:"spans"`
}

func (m *ScatterRequest) Reset()                    { *m = ScatterRequest{} }
func (m *ScatterRequest) String() string            { return proto.CompactTextString(m) }
func (*ScatterRequest) ProtoMessage()               {}
func (*ScatterRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{71} }

// ScatterResponse is the response to a Scatter() operation.
type ScatterResponse struct {
	ResponseHeader `protobuf:"bytes,1,opt,name=header,embedded=header" json:"header"`
	Ranges         []ScatterResponse_Range `protobuf:"bytes,2,rep,name=ranges" json:"ranges"`
}

func (m *ScatterResponse) Reset()                    { *m = ScatterResponse{} }
func (m *ScatterResponse) String() string            { return proto.CompactTextString(m) }
func (*ScatterResponse) ProtoMessage()               {}
func (*ScatterResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{72} }

type ScatterResponse_Range struct {
	Key Key `protobuf:"bytes,1,opt,name=key,casttype=Key" json:"key,omitempty"`
	// Error will be nil if this range was successfully scattered.
	Error *Error `protobuf:"bytes,2,opt,name=error" json:"error,omitempty"`
}

func (m *ScatterResponse_Range) Reset()                    { *m = ScatterResponse_Range{} }
func (m *ScatterResponse_Range) String() string            { return proto.CompactTextString(m) }
func (*ScatterResponse_Range) ProtoMessage()               {}
func (*ScatterResponse_Range) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{72, 0} }
...
type RequestUnion struct {
	...
	Scatter                  *ScatterRequest                  `protobuf:"bytes,36,opt,name=scatter" json:"scatter,omitempty"`
}
...
type ResponseUnion struct {
	...
	Scatter                  *ScatterResponse                  `protobuf:"bytes,36,opt,name=scatter" json:"scatter,omitempty"`
}
...
func init() {
	...
	proto.RegisterType((*ScatterRequest)(nil), "cockroach.roachpb.ScatterRequest")
	proto.RegisterType((*ScatterResponse)(nil), "cockroach.roachpb.ScatterResponse")
	proto.RegisterType((*ScatterResponse_Range)(nil), "cockroach.roachpb.ScatterResponse.Range")
...
func (m *ScatterRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ScatterRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ScatterResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ScatterResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ScatterResponse_Range) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ScatterResponse_Range) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *RequestUnion) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Get != nil {
		...
		n111, err := m.Get.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n111
	...
	if m.Put != nil {
		...
		n112, err := m.Put.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n112
	...
	if m.ConditionalPut != nil {
		...
		n113, err := m.ConditionalPut.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n113
	...
	if m.Increment != nil {
		...
		n114, err := m.Increment.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n114
	...
	if m.Delete != nil {
		...
		n115, err := m.Delete.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n115
	...
	if m.DeleteRange != nil {
		...
		n116, err := m.DeleteRange.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n116
	...
	if m.BeginTransaction != nil {
		...
		n118, err := m.BeginTransaction.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n118
	...
	if m.EndTransaction != nil {
		...
		n119, err := m.EndTransaction.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n119
	...
	if m.AdminSplit != nil {
		...
		n120, err := m.AdminSplit.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n120
	...
	if m.AdminMerge != nil {
		...
		n121, err := m.AdminMerge.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n121
	...
	if m.HeartbeatTxn != nil {
		...
		n122, err := m.HeartbeatTxn.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n122
	...
	if m.Gc != nil {
		...
		n123, err := m.Gc.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n123
	...
	if m.RangeLookup != nil {
		...
		n125, err := m.RangeLookup.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n125
	...
	if m.ResolveIntent != nil {
		...
		n126, err := m.ResolveIntent.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n126
	...
	if m.ResolveIntentRange != nil {
		...
		n127, err := m.ResolveIntentRange.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n127
	...
	if m.Merge != nil {
		...
		n128, err := m.Merge.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n128
	...
	if m.TruncateLog != nil {
		...
		n129, err := m.TruncateLog.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n129
	...
	if m.RequestLease != nil {
		...
		n130, err := m.RequestLease.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n130
	...
	if m.ReverseScan != nil {
		...
		n131, err := m.ReverseScan.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n131
	...
	if m.ComputeChecksum != nil {
		...
		n132, err := m.ComputeChecksum.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n132
	...
	if m.DeprecatedVerifyChecksum != nil {
		...
		n133, err := m.DeprecatedVerifyChecksum.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n133
	...
	if m.CheckConsistency != nil {
		...
		n134, err := m.CheckConsistency.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n134
	...
	if m.Noop != nil {
		...
		n135, err := m.Noop.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n135
	...
	if m.InitPut != nil {
		...
		n136, err := m.InitPut.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n136
	...
	if m.Scatter != nil {
		...
		dAtA[i] = 0x2
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.Scatter.Size()))
		n145, err := m.Scatter.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n145
...
func (m *ResponseUnion) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RangeLookup != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.RangeLookup.Size()))
		n160, err := m.RangeLookup.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n160
	...
	if m.DeprecatedVerifyChecksum != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.DeprecatedVerifyChecksum.Size()))
		n168, err := m.DeprecatedVerifyChecksum.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n168
	...
	if m.Noop != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.Noop.Size()))
		n170, err := m.Noop.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n170
	...
	if m.Scatter != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.Scatter.Size()))
		n179, err := m.Scatter.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n179
...
func (m *Header) MarshalTo(dAtA []byte) (int, error) {
	...
	n181, err := m.Replica.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n181
	...
	if m.Txn != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.Txn.Size()))
		n182, err := m.Txn.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n182
	...
	if m.TraceContext != nil {
		...
		n183, err := m.TraceContext.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n183
...
func (m *BatchRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	n184, err := m.Header.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n184
...
func (m *BatchResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	n185, err := m.BatchResponse_Header.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n185
...
func (m *BatchResponse_Header) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Error != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.Error.Size()))
		n186, err := m.Error.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n186
	...
	i++
	i = encodeVarintApi(dAtA, i, uint64(m.Now.Size()))
	n189, err := m.Now.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n189
...
func (m *ScatterRequest) Size() (n int) {
	var l int
	_ = l
	l = m.Span.Size()
	n += 1 + l + sovApi(uint64(l))
...
func (m *ScatterResponse) Size() (n int) {
	var l int
	_ = l
	l = m.ResponseHeader.Size()
	n += 1 + l + sovApi(uint64(l))
...
func (m *ScatterResponse_Range) Size() (n int) {
	var l int
	_ = l
	if m.Key != nil {
		l = len(m.Key)
...
func (m *ScatterRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ScatterRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ScatterRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ScatterResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ScatterResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ScatterResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			m.Ranges = append(m.Ranges, ScatterResponse_Range{})
			if err := m.Ranges[len(m.Ranges)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
func (m *ScatterResponse_Range) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
var fileDescriptorApi = []byte{
	...
	,
}
