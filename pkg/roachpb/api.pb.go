...
// UpdateSpanRequest is arguments to the UpdateSpan() method, which
...
// at the current transaction timestamp. If keys in the span were
// written more recently than the original txn timestamp, returns an
// error and does not update the timestamp cache.
...
func (m *UpdateSpanRequest) Reset()                    { *m = UpdateSpanRequest{} }
func (m *UpdateSpanRequest) String() string            { return proto.CompactTextString(m) }
func (*UpdateSpanRequest) ProtoMessage()               {}
func (*UpdateSpanRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{78} }

// UpdateSpanResponse is the response to the UdpateSpan() operation.
type UpdateSpanResponse struct {
	ResponseHeader `protobuf:"bytes,1,opt,name=header,embedded=header" json:"header"`
}

func (m *UpdateSpanResponse) Reset()                    { *m = UpdateSpanResponse{} }
func (m *UpdateSpanResponse) String() string            { return proto.CompactTextString(m) }
func (*UpdateSpanResponse) ProtoMessage()               {}
func (*UpdateSpanResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{79} }
...
type RequestUnion struct {
	...
	UpdateSpan               *UpdateSpanRequest               `protobuf:"bytes,39,opt,name=update_span,json=updateSpan" json:"update_span,omitempty"`
}
...
type ResponseUnion struct {
	...
	UpdateSpan               *UpdateSpanResponse               `protobuf:"bytes,39,opt,name=update_span,json=updateSpan" json:"update_span,omitempty"`
}
...
func init() {
	...
	proto.RegisterType((*UpdateSpanRequest)(nil), "cockroach.roachpb.UpdateSpanRequest")
	proto.RegisterType((*UpdateSpanResponse)(nil), "cockroach.roachpb.UpdateSpanResponse")
...
func (this *UpdateSpanRequest) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*UpdateSpanRequest)
	if !ok {
		that2, ok := that.(UpdateSpanRequest)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *UpdateSpanRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *UpdateSpanRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *UpdateSpanResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *UpdateSpanResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *RequestUnion) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.UpdateSpan != nil {
		...
		dAtA[i] = 0x2
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.UpdateSpan.Size()))
		n158, err := m.UpdateSpan.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n158
...
func (m *ResponseUnion) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.UpdateSpan != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.UpdateSpan.Size()))
		n195, err := m.UpdateSpan.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n195
...
func (m *UpdateSpanRequest) Size() (n int) {
	var l int
	_ = l
	l = m.Span.Size()
	n += 1 + l + sovApi(uint64(l))
...
func (m *UpdateSpanResponse) Size() (n int) {
	var l int
	_ = l
	l = m.ResponseHeader.Size()
	n += 1 + l + sovApi(uint64(l))
...
func (m *UpdateSpanRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UpdateSpanRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UpdateSpanRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *UpdateSpanResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UpdateSpanResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UpdateSpanResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *RequestUnion) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 39:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UpdateSpan", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.UpdateSpan == nil {
				m.UpdateSpan = &UpdateSpanRequest{}
			}
			if err := m.UpdateSpan.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ResponseUnion) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 39:
			...
			if m.UpdateSpan == nil {
				m.UpdateSpan = &UpdateSpanResponse{}
			}
			if err := m.UpdateSpan.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
...
var fileDescriptorApi = []byte{
	...
	,
}
