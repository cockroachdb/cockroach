...
const (
	...
	ExportStorageProvider_BlobSharing ExportStorageProvider = 6
)
...
type ExportStorage struct {
	...
	Blob              *ExportStorage_BlobSharing  `protobuf:"bytes,7,opt,name=blob" json:"blob,omitempty"`
}
...
type ExportStorage_BlobSharing struct {
	MetadataNode NodeID `protobuf:"varint,1,opt,name=metadataNode,casttype=NodeID" json:"metadataNode"`
	Prefix       string `protobuf:"bytes,2,opt,name=prefix" json:"prefix"`
}

func (m *ExportStorage_BlobSharing) Reset()                    { *m = ExportStorage_BlobSharing{} }
func (m *ExportStorage_BlobSharing) String() string            { return proto.CompactTextString(m) }
func (*ExportStorage_BlobSharing) ProtoMessage()               {}
func (*ExportStorage_BlobSharing) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{63, 5} }
...
func (*GetBlobRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{80} }
...
func (*GetBlobResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{81} }
...
func (*PutBlobRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{82} }
...
func (*PutBlobResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{83} }
...
func init() {
	...
	proto.RegisterType((*ExportStorage_BlobSharing)(nil), "cockroach.roachpb.ExportStorage.BlobSharing")
...
func (this *ExportStorage_BlobSharing) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*ExportStorage_BlobSharing)
	if !ok {
		that2, ok := that.(ExportStorage_BlobSharing)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.MetadataNode != that1.MetadataNode {
		return false
	}
	if this.Prefix != that1.Prefix {
		return false
...
func (c *blobClient) Get(ctx context.Context, in *GetBlobRequest, opts ...grpc.CallOption) (*GetBlobResponse, error) {
	...
	err := grpc.Invoke(ctx, "/cockroach.roachpb.Blob/Get", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *blobClient) Put(ctx context.Context, in *PutBlobRequest, opts ...grpc.CallOption) (*PutBlobResponse, error) {
	...
	err := grpc.Invoke(ctx, "/cockroach.roachpb.Blob/Put", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (m *ExportStorage) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Blob != nil {
		dAtA[i] = 0x3a
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.Blob.Size()))
		n96, err := m.Blob.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n96
...
func (m *ExportStorage_BlobSharing) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ExportStorage_BlobSharing) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	dAtA[i] = 0x8
	i++
	i = encodeVarintApi(dAtA, i, uint64(m.MetadataNode))
	dAtA[i] = 0x12
	i++
	i = encodeVarintApi(dAtA, i, uint64(len(m.Prefix)))
	i += copy(dAtA[i:], m.Prefix)
...
func (m *BatchRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	n190, err := m.Header.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n190
...
func (m *BatchResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	n191, err := m.BatchResponse_Header.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n191
...
func (m *BatchResponse_Header) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Error != nil {
		...
		n192, err := m.Error.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n192
	...
	i++
	i = encodeVarintApi(dAtA, i, uint64(m.Now.Size()))
	n195, err := m.Now.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n195
...
func (m *ExportStorage_BlobSharing) Size() (n int) {
	var l int
	_ = l
	n += 1 + sovApi(uint64(m.MetadataNode))
	l = len(m.Prefix)
	n += 1 + l + sovApi(uint64(l))
	return n
}
...
func (m *ExportStorage) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			if m.Blob == nil {
				m.Blob = &ExportStorage_BlobSharing{}
			}
...
func (m *ExportStorage_BlobSharing) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BlobSharing: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BlobSharing: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MetadataNode", wireType)
			}
			m.MetadataNode = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MetadataNode |= (NodeID(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorApi = []byte{
	...
	,
}
