...
func (*RequestUnion) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{61} }
...
func (*ResponseUnion) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{62} }
...
type Header struct {
	...
	// If set, this indicates to the batch evaluation process that, in case of a
	// retriable error, this batch will not be retried. This is used in
	// relationship with WriteTooOldError's: normally, these errors are
	// swallowed for transactional batches in replica.executeBatch() so that the
	// the batch continues to lay down intents even if it's going to have to be
	// retried. If will_not_be_retried is set, then the batch is not allowed to
	// continue, since the intents would not be useful.
	// Concretely, this is set when a batch is retried at the Raft level and the
	// retry is ambiguous (i.e. the batch might had been already applied before
	// and, if the retry fails, we need to report an AmbiguousResultError to the
	// client and not retry the batch at higher levels (with a different
	// timestamp)).
	// Note(andrei): besides optimizing these retries, the field was introduced to
	// prevent retries from leaving around intents that were inconveniencing
	// tests.
	WillNotBeRetried bool `protobuf:"varint,11,opt,name=will_not_be_retried,json=willNotBeRetried" json:"will_not_be_retried"`
}

func (m *Header) Reset()                    { *m = Header{} }
func (m *Header) String() string            { return proto.CompactTextString(m) }
func (*Header) ProtoMessage()               {}
func (*Header) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{63} }
...
func (*BatchRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{64} }
...
func (*BatchResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{65} }
...
func (*BatchResponse_Header) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{65, 0} }
...
func (m *RequestUnion) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Get != nil {
		...
		n87, err := m.Get.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n87
	...
	if m.Put != nil {
		...
		n88, err := m.Put.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n88
	...
	if m.ConditionalPut != nil {
		...
		n89, err := m.ConditionalPut.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n89
	...
	if m.Increment != nil {
		...
		n90, err := m.Increment.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n90
	...
	if m.Delete != nil {
		...
		n91, err := m.Delete.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n91
	...
	if m.DeleteRange != nil {
		...
		n92, err := m.DeleteRange.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n92
	...
	if m.Scan != nil {
		...
		n93, err := m.Scan.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n93
	...
	if m.BeginTransaction != nil {
		...
		n94, err := m.BeginTransaction.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n94
	...
	if m.EndTransaction != nil {
		...
		n95, err := m.EndTransaction.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n95
	...
	if m.AdminSplit != nil {
		...
		n96, err := m.AdminSplit.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n96
	...
	if m.AdminMerge != nil {
		...
		n97, err := m.AdminMerge.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n97
	...
	if m.HeartbeatTxn != nil {
		...
		n98, err := m.HeartbeatTxn.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n98
	...
	if m.PushTxn != nil {
		...
		n100, err := m.PushTxn.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n100
	...
	if m.RangeLookup != nil {
		...
		n101, err := m.RangeLookup.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n101
	...
	if m.ResolveIntent != nil {
		...
		n102, err := m.ResolveIntent.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n102
	...
	if m.ResolveIntentRange != nil {
		...
		n103, err := m.ResolveIntentRange.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n103
	...
	if m.Merge != nil {
		...
		n104, err := m.Merge.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n104
	...
	if m.TruncateLog != nil {
		...
		n105, err := m.TruncateLog.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n105
	...
	if m.RequestLease != nil {
		...
		n106, err := m.RequestLease.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n106
	...
	if m.ReverseScan != nil {
		...
		n107, err := m.ReverseScan.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n107
	...
	if m.ComputeChecksum != nil {
		...
		n108, err := m.ComputeChecksum.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n108
	...
	if m.DeprecatedVerifyChecksum != nil {
		...
		n109, err := m.DeprecatedVerifyChecksum.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n109
	...
	if m.CheckConsistency != nil {
		...
		n110, err := m.CheckConsistency.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n110
	...
	if m.Noop != nil {
		...
		n111, err := m.Noop.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n111
	...
	if m.InitPut != nil {
		...
		n112, err := m.InitPut.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n112
	...
	if m.ChangeFrozen != nil {
		...
		n113, err := m.ChangeFrozen.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n113
	...
	if m.TransferLease != nil {
		...
		n114, err := m.TransferLease.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n114
	...
	if m.AdminTransferLease != nil {
		...
		n115, err := m.AdminTransferLease.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n115
	...
	if m.LeaseInfo != nil {
		...
		n116, err := m.LeaseInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n116
...
func (m *ResponseUnion) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ChangeFrozen != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.ChangeFrozen.Size()))
		n143, err := m.ChangeFrozen.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n143
...
func (m *Header) MarshalTo(dAtA []byte) (int, error) {
	...
	n147, err := m.Replica.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n147
	...
	if m.Txn != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.Txn.Size()))
		n148, err := m.Txn.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n148
	...
	if m.TraceContext != nil {
		...
		n149, err := m.TraceContext.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n149
...
func (m *BatchResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	n151, err := m.BatchResponse_Header.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n151
...
func (m *BatchResponse_Header) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Error != nil {
		...
		n152, err := m.Error.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n152
	...
	i++
	i = encodeVarintApi(dAtA, i, uint64(m.Timestamp.Size()))
	n153, err := m.Timestamp.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n153
	if m.Txn != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.Txn.Size()))
		n154, err := m.Txn.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n154
	...
	i++
	i = encodeVarintApi(dAtA, i, uint64(m.Now.Size()))
	n155, err := m.Now.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n155
...
func (m *Header) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field WillNotBeRetried", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorApi = []byte{
	...
	,
}
