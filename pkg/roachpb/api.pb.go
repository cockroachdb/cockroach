...
type RequestUnion_CheckExists struct {
	CheckExists *CheckExistsRequest `protobuf:"bytes,45,opt,name=check_exists,json=checkExists,oneof"`
}
...
type ResponseUnion_CheckExists struct {
	CheckExists *CheckExistsResponse `protobuf:"bytes,45,opt,name=check_exists,json=checkExists,oneof"`
}
...
func (m *RequestUnion_CheckExists) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CheckExists != nil {
		...
		n178, err := m.CheckExists.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n178
...
func (m *ResponseUnion_CheckExists) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CheckExists != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.CheckExists.Size()))
		n219, err := m.CheckExists.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n219
...
var fileDescriptorApi = []byte{
	...
	,
}
