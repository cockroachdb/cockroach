...
type ScanRequest struct {
	Span `protobuf:"bytes,1,opt,name=header,embedded=header" json:"header"`
	// return the key/value pairs in batch repr format rather than
	// KeyValue messages. This reduces allocations on both the sending
	// and receiving sides is a marginally more compact.
	ReturnBatchRepr bool `protobuf:"varint,3,opt,name=return_batch_repr,json=returnBatchRepr" json:"return_batch_repr"`
}
...
type ScanResponse struct {
	...
	BatchRepr []byte     `protobuf:"bytes,3,opt,name=batch_repr,json=batchRepr" json:"batch_repr,omitempty"`
}
...
func (this *ScanRequest) Equal(that interface{}) bool {
	...
	if this.ReturnBatchRepr != that1.ReturnBatchRepr {
		return false
	}
	return true
}
...
func (m *ScanResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.BatchRepr != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintApi(dAtA, i, uint64(len(m.BatchRepr)))
		i += copy(dAtA[i:], m.BatchRepr)
	}
	return i, nil
}
...
func (m *ScanRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReturnBatchRepr", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *ScanResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BatchRepr", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.BatchRepr = append(m.BatchRepr[:0], dAtA[iNdEx:postIndex]...)
			if m.BatchRepr == nil {
				m.BatchRepr = []byte{}
			}
			iNdEx = postIndex
...
var fileDescriptorApi = []byte{
	...
	,
}
