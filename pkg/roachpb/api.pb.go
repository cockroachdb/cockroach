...
type RangeLookupRequest struct {
	...
	// Continuation indicates that the lookup request is an extension of a
	// previous RangeLookupRequest that failed to find the desired descriptor.
	// This can happen if a user space range is split across two meta2 ranges
	// and a RangeLookupRequest first goes to the left meta2 range. See
	// comment on RangeDescriptorCache.performRangeLookupContinuation for more
	// details. If continuation is set to true, then reverse must be false.
	//
	// DURING REVIEW: "continuation" is an overloaded term in CS. I think its
	// standard meaning is appropriate here and that it's not confusing, but
	// Lisp-enthusiasts may disagree.
	Continuation bool `protobuf:"varint,5,opt,name=continuation" json:"continuation"`
}
...
func (this *RangeLookupRequest) Equal(that interface{}) bool {
	...
	if this.Continuation != that1.Continuation {
		return false
	}
	return true
}
...
var fileDescriptorApi = []byte{
	...
	,
}
