...
type AdjustStatsRequest struct {
	Span              `protobuf:"bytes,1,opt,name=header,embedded=header" json:"header"`
	ComputationEndKey Key `protobuf:"bytes,2,opt,name=computation_end_key,json=computationEndKey,proto3,casttype=Key" json:"computation_end_key,omitempty"`
	// When dry_run is true, the stats delta is computed, but no stats adjustment
	// is performed.
	DryRun bool `protobuf:"varint,3,opt,name=dry_run,json=dryRun,proto3" json:"dry_run,omitempty"`
}

func (m *AdjustStatsRequest) Reset()                    { *m = AdjustStatsRequest{} }
func (m *AdjustStatsRequest) String() string            { return proto.CompactTextString(m) }
func (*AdjustStatsRequest) ProtoMessage()               {}
func (*AdjustStatsRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{25} }

// An AdjustStatsResponse is the response to an AdjustStatsRequest.
type AdjustStatsResponse struct {
	ResponseHeader `protobuf:"bytes,1,opt,name=header,embedded=header" json:"header"`
...
func (m *AdjustStatsResponse) Reset()                    { *m = AdjustStatsResponse{} }
func (m *AdjustStatsResponse) String() string            { return proto.CompactTextString(m) }
func (*AdjustStatsResponse) ProtoMessage()               {}
func (*AdjustStatsResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{26} }
...
type RequestUnion struct {
	...
	AdjustStats              *AdjustStatsRequest              `protobuf:"bytes,39,opt,name=adjust_stats,json=adjustStats" json:"adjust_stats,omitempty"`
}
...
type ResponseUnion struct {
	...
	AdjustStats              *AdjustStatsResponse              `protobuf:"bytes,39,opt,name=adjust_stats,json=adjustStats" json:"adjust_stats,omitempty"`
}
...
func init() {
	...
	proto.RegisterType((*AdjustStatsRequest)(nil), "cockroach.roachpb.AdjustStatsRequest")
	proto.RegisterType((*AdjustStatsResponse)(nil), "cockroach.roachpb.AdjustStatsResponse")
...
func (this *AdjustStatsRequest) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*AdjustStatsRequest)
	if !ok {
		that2, ok := that.(AdjustStatsRequest)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !bytes.Equal(this.ComputationEndKey, that1.ComputationEndKey) {
		return false
	}
...
func (m *AdjustStatsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *AdjustStatsRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	i += n32
	if len(m.ComputationEndKey) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintApi(dAtA, i, uint64(len(m.ComputationEndKey)))
		i += copy(dAtA[i:], m.ComputationEndKey)
	}
	if m.DryRun {
		dAtA[i] = 0x18
		i++
...
func (m *AdjustStatsResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *AdjustStatsResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ComputeChecksumRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	n92, err := m.ChecksumID.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n92
...
func (m *ExportStorage) MarshalTo(dAtA []byte) (int, error) {
	...
	n96, err := m.LocalFile.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n96
	...
	n97, err := m.HttpPath.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n97
	if m.GoogleCloudConfig != nil {
		...
		n98, err := m.GoogleCloudConfig.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n98
	...
	if m.S3Config != nil {
		...
		n99, err := m.S3Config.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n99
	...
	if m.AzureConfig != nil {
		...
		n100, err := m.AzureConfig.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n100
...
func (m *WriteBatchRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	n102, err := m.DataSpan.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n102
...
func (m *ExportRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	n105, err := m.Storage.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n105
	...
	n106, err := m.StartTime.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n106
...
func (m *RequestUnion) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AdjustStats != nil {
		dAtA[i] = 0xba
		i++
		dAtA[i] = 0x2
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.AdjustStats.Size()))
		n158, err := m.AdjustStats.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n158
...
func (m *ResponseUnion) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AdjustStats != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.AdjustStats.Size()))
		n195, err := m.AdjustStats.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n195
...
func (m *AdjustStatsRequest) Size() (n int) {
	var l int
	_ = l
	l = m.Span.Size()
	n += 1 + l + sovApi(uint64(l))
	l = len(m.ComputationEndKey)
	if l > 0 {
		n += 1 + l + sovApi(uint64(l))
	}
	if m.DryRun {
...
func (m *AdjustStatsResponse) Size() (n int) {
	var l int
	_ = l
	l = m.ResponseHeader.Size()
	n += 1 + l + sovApi(uint64(l))
...
func (this *RequestUnion) GetValue() interface{} {
	...
	if this.AdjustStats != nil {
		return this.AdjustStats
	}
	return nil
}
...
func (m *AdjustStatsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AdjustStatsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AdjustStatsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ComputationEndKey", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ComputationEndKey = append(m.ComputationEndKey[:0], dAtA[iNdEx:postIndex]...)
			if m.ComputationEndKey == nil {
				m.ComputationEndKey = []byte{}
			}
			iNdEx = postIndex
		case 3:
			if wireType != 0 {
...
func (m *AdjustStatsResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AdjustStatsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AdjustStatsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *RequestUnion) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 39:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AdjustStats", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.AdjustStats == nil {
				m.AdjustStats = &AdjustStatsRequest{}
			}
			if err := m.AdjustStats.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ResponseUnion) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 39:
			...
			if m.AdjustStats == nil {
				m.AdjustStats = &AdjustStatsResponse{}
			}
			if err := m.AdjustStats.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
...
var fileDescriptorApi = []byte{
	...
	,
}
