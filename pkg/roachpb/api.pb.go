...
type ExportStorage_LocalFilePath struct {
	...
	IsSharedFS bool   `protobuf:"varint,2,opt,name=isSharedFS" json:"isSharedFS"`
}
...
func (this *ExportStorage_LocalFilePath) Equal(that interface{}) bool {
	...
	if this.IsSharedFS != that1.IsSharedFS {
		return false
	}
	return true
}
...
func (m *ExportStorage_LocalFilePath) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IsSharedFS", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorApi = []byte{
	...
	,
}
