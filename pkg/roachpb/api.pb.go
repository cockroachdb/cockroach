...
type IncrementRequest struct {
	...
	// Options for sequence boundaries. When not set, defaults to:
	// min_value = math.MinInt64
	// max_value = math.MaxInt64
	// cycle = false
	// start = 0
	BoundsOptions *IncrementRequest_BoundsOptions `protobuf:"bytes,3,opt,name=bounds_options,json=boundsOptions" json:"bounds_options,omitempty"`
}
...
type IncrementRequest_BoundsOptions struct {
	// Return an error if this value is gone under.
	MinValue int64 `protobuf:"varint,1,opt,name=min_value,json=minValue,proto3" json:"min_value,omitempty"`
	// Return an error if this value is exceeded.
	MaxValue int64 `protobuf:"varint,2,opt,name=max_value,json=maxValue,proto3" json:"max_value,omitempty"`
	// Whether to go back to the start if min_value or max_value is exceeded.
	Cycle bool `protobuf:"varint,3,opt,name=cycle,proto3" json:"cycle,omitempty"`
	// Value to set the key to if max_value or min_value is exceeded and cycle is true.
	Start int64 `protobuf:"varint,4,opt,name=start,proto3" json:"start,omitempty"`
}

func (m *IncrementRequest_BoundsOptions) Reset()         { *m = IncrementRequest_BoundsOptions{} }
func (m *IncrementRequest_BoundsOptions) String() string { return proto.CompactTextString(m) }
func (*IncrementRequest_BoundsOptions) ProtoMessage()    {}
func (*IncrementRequest_BoundsOptions) Descriptor() ([]byte, []int) {
	return fileDescriptorApi, []int{10, 0}
}
...
func init() {
	...
	proto.RegisterType((*IncrementRequest_BoundsOptions)(nil), "cockroach.roachpb.IncrementRequest.BoundsOptions")
...
func (this *IncrementRequest) Equal(that interface{}) bool {
	...
	if !this.BoundsOptions.Equal(that1.BoundsOptions) {
		return false
	}
	return true
}
func (this *IncrementRequest_BoundsOptions) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*IncrementRequest_BoundsOptions)
	if !ok {
		that2, ok := that.(IncrementRequest_BoundsOptions)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *IncrementRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.BoundsOptions != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.BoundsOptions.Size()))
		n19, err := m.BoundsOptions.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n19
...
func (m *IncrementRequest_BoundsOptions) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *IncrementRequest_BoundsOptions) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.MinValue != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.MinValue))
	}
	if m.MaxValue != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.MaxValue))
	}
	if m.Cycle {
		dAtA[i] = 0x18
		i++
...
func (m *EndTransactionRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Deadline != nil {
		...
		n36, err := m.Deadline.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n36
	...
	if m.InternalCommitTrigger != nil {
		...
		n37, err := m.InternalCommitTrigger.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n37
...
func (m *HeartbeatTxnRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	n50, err := m.Now.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n50
...
func (m *GCRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	n53, err := m.Threshold.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n53
	...
	n54, err := m.TxnSpanGCThreshold.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n54
...
func (m *GCRequest_GCKey) MarshalTo(dAtA []byte) (int, error) {
	...
	n55, err := m.Timestamp.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n55
...
func (m *PushTxnRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	n58, err := m.PusherTxn.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n58
	...
	n59, err := m.PusheeTxn.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n59
	...
	n60, err := m.PushTo.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n60
...
func (m *QueryTxnRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintApi(dAtA, i, uint64(m.Span.Size()))
	n64, err := m.Span.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n64
	...
	i++
	i = encodeVarintApi(dAtA, i, uint64(m.Txn.Size()))
	n65, err := m.Txn.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n65
...
func (m *QueryTxnResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	n67, err := m.QueriedTxn.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n67
...
func (m *RequestUnion) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Get != nil {
		...
		n119, err := m.Get.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n119
	...
	if m.Put != nil {
		...
		n120, err := m.Put.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n120
	...
	if m.ConditionalPut != nil {
		...
		n121, err := m.ConditionalPut.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n121
	...
	if m.Increment != nil {
		...
		n122, err := m.Increment.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n122
	...
	if m.Delete != nil {
		...
		n123, err := m.Delete.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n123
	...
	if m.DeleteRange != nil {
		...
		n124, err := m.DeleteRange.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n124
	...
	if m.Scan != nil {
		...
		n125, err := m.Scan.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n125
	...
	if m.BeginTransaction != nil {
		...
		n126, err := m.BeginTransaction.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n126
	...
	if m.EndTransaction != nil {
		...
		n127, err := m.EndTransaction.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n127
	...
	if m.AdminSplit != nil {
		...
		n128, err := m.AdminSplit.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n128
	...
	if m.AdminMerge != nil {
		...
		n129, err := m.AdminMerge.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n129
	...
	if m.HeartbeatTxn != nil {
		...
		n130, err := m.HeartbeatTxn.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n130
	...
	if m.Gc != nil {
		...
		n131, err := m.Gc.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n131
	...
	if m.PushTxn != nil {
		...
		n132, err := m.PushTxn.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n132
	...
	if m.RangeLookup != nil {
		...
		n133, err := m.RangeLookup.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n133
	...
	if m.ResolveIntent != nil {
		...
		n134, err := m.ResolveIntent.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n134
	...
	if m.ResolveIntentRange != nil {
		...
		n135, err := m.ResolveIntentRange.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n135
	...
	if m.Merge != nil {
		...
		n136, err := m.Merge.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n136
	...
	if m.TruncateLog != nil {
		...
		n137, err := m.TruncateLog.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n137
	...
	if m.RequestLease != nil {
		...
		n138, err := m.RequestLease.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n138
	...
	if m.ReverseScan != nil {
		...
		n139, err := m.ReverseScan.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n139
	...
	if m.ComputeChecksum != nil {
		...
		n140, err := m.ComputeChecksum.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n140
	...
	if m.DeprecatedVerifyChecksum != nil {
		...
		n141, err := m.DeprecatedVerifyChecksum.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n141
	...
	if m.CheckConsistency != nil {
		...
		n142, err := m.CheckConsistency.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n142
	...
	if m.Noop != nil {
		...
		n143, err := m.Noop.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n143
	...
	if m.InitPut != nil {
		...
		n144, err := m.InitPut.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n144
	...
	if m.TransferLease != nil {
		...
		n145, err := m.TransferLease.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n145
	...
	if m.AdminTransferLease != nil {
		...
		n146, err := m.AdminTransferLease.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n146
	...
	if m.LeaseInfo != nil {
		...
		n147, err := m.LeaseInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n147
	...
	if m.WriteBatch != nil {
		...
		n148, err := m.WriteBatch.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n148
	...
	if m.Export != nil {
		...
		n149, err := m.Export.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n149
	...
	if m.QueryTxn != nil {
		...
		n150, err := m.QueryTxn.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n150
	...
	if m.Import != nil {
		...
		n151, err := m.Import.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n151
	...
	if m.AdminChangeReplicas != nil {
		...
		n152, err := m.AdminChangeReplicas.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n152
	...
	if m.AdminScatter != nil {
		...
		n153, err := m.AdminScatter.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n153
	...
	if m.AddSstable != nil {
		...
		n154, err := m.AddSstable.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n154
	...
	if m.ClearRange != nil {
		...
		n155, err := m.ClearRange.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n155
...
func (m *ResponseUnion) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Get != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.Get.Size()))
		n156, err := m.Get.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n156
	...
	if m.Put != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.Put.Size()))
		n157, err := m.Put.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n157
	...
	if m.ConditionalPut != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.ConditionalPut.Size()))
		n158, err := m.ConditionalPut.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n158
	...
	if m.Increment != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.Increment.Size()))
		n159, err := m.Increment.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n159
	...
	if m.Delete != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.Delete.Size()))
		n160, err := m.Delete.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n160
	...
	if m.DeleteRange != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.DeleteRange.Size()))
		n161, err := m.DeleteRange.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n161
	...
	if m.Scan != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.Scan.Size()))
		n162, err := m.Scan.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n162
	...
	if m.BeginTransaction != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.BeginTransaction.Size()))
		n163, err := m.BeginTransaction.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n163
	...
	if m.EndTransaction != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.EndTransaction.Size()))
		n164, err := m.EndTransaction.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n164
	...
	if m.AdminSplit != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.AdminSplit.Size()))
		n165, err := m.AdminSplit.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n165
	...
	if m.AdminMerge != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.AdminMerge.Size()))
		n166, err := m.AdminMerge.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n166
	...
	if m.HeartbeatTxn != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.HeartbeatTxn.Size()))
		n167, err := m.HeartbeatTxn.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n167
	...
	if m.Gc != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.Gc.Size()))
		n168, err := m.Gc.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n168
	...
	if m.PushTxn != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.PushTxn.Size()))
		n169, err := m.PushTxn.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n169
	...
	if m.RangeLookup != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.RangeLookup.Size()))
		n170, err := m.RangeLookup.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n170
	...
	if m.DeprecatedVerifyChecksum != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.DeprecatedVerifyChecksum.Size()))
		n178, err := m.DeprecatedVerifyChecksum.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n178
	...
	if m.CheckConsistency != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.CheckConsistency.Size()))
		n179, err := m.CheckConsistency.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n179
	...
	if m.Noop != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.Noop.Size()))
		n180, err := m.Noop.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n180
	...
	if m.AdminTransferLease != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.AdminTransferLease.Size()))
		n182, err := m.AdminTransferLease.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n182
	...
	if m.LeaseInfo != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.LeaseInfo.Size()))
		n183, err := m.LeaseInfo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n183
	...
	if m.WriteBatch != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.WriteBatch.Size()))
		n184, err := m.WriteBatch.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n184
	...
	if m.Export != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.Export.Size()))
		n185, err := m.Export.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n185
	...
	if m.QueryTxn != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.QueryTxn.Size()))
		n186, err := m.QueryTxn.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n186
	...
	if m.Import != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.Import.Size()))
		n187, err := m.Import.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n187
	...
	if m.AdminChangeReplicas != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.AdminChangeReplicas.Size()))
		n188, err := m.AdminChangeReplicas.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n188
	...
	if m.AdminScatter != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.AdminScatter.Size()))
		n189, err := m.AdminScatter.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n189
	...
	if m.AddSstable != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.AddSstable.Size()))
		n190, err := m.AddSstable.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n190
	...
	if m.ClearRange != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.ClearRange.Size()))
		n191, err := m.ClearRange.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n191
...
func (m *Header) MarshalTo(dAtA []byte) (int, error) {
	...
	n193, err := m.Replica.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n193
	...
	if m.Txn != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.Txn.Size()))
		n194, err := m.Txn.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n194
	...
	if m.ScanOptions != nil {
		...
		n195, err := m.ScanOptions.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n195
...
func (m *BatchRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	n196, err := m.Header.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n196
...
func (m *BatchResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	n197, err := m.BatchResponse_Header.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n197
...
func (m *BatchResponse_Header) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Error != nil {
		...
		n198, err := m.Error.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n198
	...
	i++
	i = encodeVarintApi(dAtA, i, uint64(m.Timestamp.Size()))
	n199, err := m.Timestamp.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n199
	if m.Txn != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.Txn.Size()))
		n200, err := m.Txn.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n200
	...
	i++
	i = encodeVarintApi(dAtA, i, uint64(m.Now.Size()))
	n201, err := m.Now.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n201
...
func (m *IncrementRequest) Size() (n int) {
	...
	if m.BoundsOptions != nil {
		l = m.BoundsOptions.Size()
		n += 1 + l + sovApi(uint64(l))
	}
	return n
}

func (m *IncrementRequest_BoundsOptions) Size() (n int) {
	var l int
	_ = l
	if m.MinValue != 0 {
		n += 1 + sovApi(uint64(m.MinValue))
	}
	if m.MaxValue != 0 {
		n += 1 + sovApi(uint64(m.MaxValue))
	}
	if m.Cycle {
		n += 2
	}
...
func (m *IncrementRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BoundsOptions", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.BoundsOptions == nil {
				m.BoundsOptions = &IncrementRequest_BoundsOptions{}
			}
			if err := m.BoundsOptions.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *IncrementRequest_BoundsOptions) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BoundsOptions: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BoundsOptions: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
var fileDescriptorApi = []byte{
	...
	,
}
