...
type Header struct {
	...
	// rspan is the key span which encompasses all requests in the
	// batch, inclusive of span.Key, and exclusive of span.EndKey. Note
	// that this span is a raw span, where the local addressing has been
	// accounted for.
	RSpan RSpan `protobuf:"bytes,12,opt,name=rspan" json:"rspan"`
}
...
func (m *Header) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x62
	i++
	i = encodeVarintApi(dAtA, i, uint64(m.RSpan.Size()))
	n189, err := m.RSpan.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n189
...
func (m *Header) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RSpan", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.RSpan.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorApi = []byte{
	...
	,
}
