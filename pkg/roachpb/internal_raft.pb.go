...
func (*RaftTruncatedState) Descriptor() ([]byte, []int) {
	return fileDescriptor_internal_raft_b8d913f5fab0b149, []int{0}
}
...
func (*RaftTombstone) Descriptor() ([]byte, []int) {
	return fileDescriptor_internal_raft_b8d913f5fab0b149, []int{1}
}
...
func (*RaftSnapshotData) Descriptor() ([]byte, []int) {
	return fileDescriptor_internal_raft_b8d913f5fab0b149, []int{2}
}
...
func (*RaftSnapshotData_KeyValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_internal_raft_b8d913f5fab0b149, []int{2, 0}
}
...
func init() {
	proto.RegisterFile("roachpb/internal_raft.proto", fileDescriptor_internal_raft_b8d913f5fab0b149)
}

var fileDescriptor_internal_raft_b8d913f5fab0b149 = []byte{
