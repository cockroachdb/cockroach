...
func (*RaftTruncatedState) Descriptor() ([]byte, []int) {
	return fileDescriptor_internal_raft_f8fc1259360887bf, []int{0}
}
...
func (*RaftTombstone) Descriptor() ([]byte, []int) {
	return fileDescriptor_internal_raft_f8fc1259360887bf, []int{1}
}
...
func (*RaftSnapshotData) Descriptor() ([]byte, []int) {
	return fileDescriptor_internal_raft_f8fc1259360887bf, []int{2}
}
...
func (*RaftSnapshotData_KeyValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_internal_raft_f8fc1259360887bf, []int{2, 0}
}
...
func (*SSTSnapshotInProgressData) Descriptor() ([]byte, []int) {
	return fileDescriptor_internal_raft_f8fc1259360887bf, []int{3}
}
...
func (m *SSTSnapshotInProgressData) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.UUID != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintInternalRaft(dAtA, i, uint64(len(m.UUID)))
...
func init() {
	proto.RegisterFile("roachpb/internal_raft.proto", fileDescriptor_internal_raft_f8fc1259360887bf)
}

var fileDescriptor_internal_raft_f8fc1259360887bf = []byte{
	// 492 bytes of a gzipped FileDescriptorProto
	,
}
