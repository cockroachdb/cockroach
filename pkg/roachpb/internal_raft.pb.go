...
func (*RaftTruncatedState) Descriptor() ([]byte, []int) {
	return fileDescriptor_internal_raft_57b43f385af18f11, []int{0}
}
...
func (*RangeTombstone) Descriptor() ([]byte, []int) {
	return fileDescriptor_internal_raft_57b43f385af18f11, []int{1}
}
...
func (dst *RangeTombstone) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RangeTombstone.Merge(dst, src)
}
...
func (*RaftSnapshotData) Descriptor() ([]byte, []int) {
	return fileDescriptor_internal_raft_57b43f385af18f11, []int{2}
}
...
type RaftSnapshotData_KeyValue struct {
	...
	Timestamp github_com_cockroachdb_cockroach_pkg_storage_enginepb.TxnTimestamp `protobuf:"bytes,3,opt,name=timestamp,casttype=github.com/cockroachdb/cockroach/pkg/storage/enginepb.TxnTimestamp" json:"timestamp"`
}
...
func (*RaftSnapshotData_KeyValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_internal_raft_57b43f385af18f11, []int{2, 0}
}
...
func init() {
	proto.RegisterFile("roachpb/internal_raft.proto", fileDescriptor_internal_raft_57b43f385af18f11)
}

var fileDescriptor_internal_raft_57b43f385af18f11 = []byte{
	// 464 bytes of a gzipped FileDescriptorProto
	,
}
