...
func _() {
	...
	_ = x[CommitWaitBeforeIntentResolutionErrType-41]
...
const (
	...
	_ErrorDetailType_name_5 = "BatchTimestampBeforeGCErrTypeTxnAlreadyEncounteredErrTypeIntentMissingErrTypeMergeInProgressErrTypeRangeFeedRetryErrTypeIndeterminateCommitErrTypeInvalidLeaseErrTypeCommitWaitBeforeIntentResolutionErrType"
)
...
var (
	...
	_ErrorDetailType_index_5 = [...]uint8{0, 29, 57, 77, 99, 120, 146, 165, 204}
)
