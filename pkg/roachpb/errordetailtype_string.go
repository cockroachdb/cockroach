...
func _() {
	...
	_ = x[ParentAbortedErrorType-40]
	_ = x[RefreshFailedErrorType-41]
...
const (
	...
	_ErrorDetailType_name_5 = "BatchTimestampBeforeGCErrTypeTxnAlreadyEncounteredErrTypeIntentMissingErrTypeMergeInProgressErrTypeRangeFeedRetryErrTypeIndeterminateCommitErrTypeParentAbortedErrorTypeRefreshFailedErrorType"
)
...
var (
	...
	_ErrorDetailType_index_5 = [...]uint8{0, 29, 57, 77, 99, 120, 146, 168, 190}
)
