...
func (ba *BatchRequest) CreateReply() *BatchResponse {
	...
	var buf43 []scanInterleavedIntentsResponseAlloc
	...
	for i, r := range ba.Requests {
		...
		case *RequestUnion_ScanInterleavedIntents:
			if buf43 == nil {
				buf43 = make([]scanInterleavedIntentsResponseAlloc, counts[43])
			}
			buf43[0].union.ScanInterleavedIntents = &buf43[0].resp
