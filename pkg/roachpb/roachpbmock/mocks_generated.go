...
// Recv mocks base method.
func (m *MockInternal_MuxRangeFeedClient) Recv() (*MuxRangeFeedEvent, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Recv")
	ret0, _ := ret[0].(*MuxRangeFeedEvent)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// Send mocks base method.
func (m *MockInternal_MuxRangeFeedServer) Send(arg0 *MuxRangeFeedEvent) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Send", arg0)
	ret0, _ := ret[0].(error)
	return ret0
