...
// Recv mocks base method.
func (m *MockInternal_MuxRangeFeedServer) Recv() (*roachpb.RangeFeedRequest, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Recv")
	ret0, _ := ret[0].(*roachpb.RangeFeedRequest)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// Send mocks base method.
func (m *MockInternal_MuxRangeFeedServer) Send(arg0 *roachpb.MuxRangeFeedEvent) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Send", arg0)
	ret0, _ := ret[0].(error)
	return ret0
