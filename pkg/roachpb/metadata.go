...
func (l Locality) CompareWithLocality(
	...
	if isCrossRegion {
		if isCrossZone {
			return CROSS_REGION_CROSS_ZONE, regionErr, zoneErr
		} else {
			return CROSS_REGION_SAME_ZONE, regionErr, zoneErr
		}
	} else {
		if isCrossZone {
			return SAME_REGION_CROSS_ZONE, regionErr, zoneErr
		} else {
			return SAME_REGION_SAME_ZONE, regionErr, zoneErr
		}
	}
}
