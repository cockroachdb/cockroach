...
type GetSpanConfigsRequest struct {
	// Spans to request the configurations for.
...
type GetSpanConfigsResponse struct {
	// Results capture the span configurations over the specified spans. There's
	// one result for each Span in the matching GetSpanConfigsRequest, in the same
	// order. A result will be present for each Span even if there are no configs
	// to return.
	Results []GetSpanConfigsResponse_Result `protobuf:"bytes,2,rep,name=results,proto3" json:"results"`
}
...
type GetSpanConfigsResponse_Result struct {
	SpanConfigs []SpanConfigEntry `protobuf:"bytes,1,rep,name=span_configs,json=spanConfigs,proto3" json:"span_configs"`
}

func (m *GetSpanConfigsResponse_Result) Reset()         { *m = GetSpanConfigsResponse_Result{} }
func (m *GetSpanConfigsResponse_Result) String() string { return proto.CompactTextString(m) }
func (*GetSpanConfigsResponse_Result) ProtoMessage()    {}
func (*GetSpanConfigsResponse_Result) Descriptor() ([]byte, []int) {
	return fileDescriptor_91c9f1dcea14470a, []int{6, 0}
}
func (m *GetSpanConfigsResponse_Result) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GetSpanConfigsResponse_Result) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *GetSpanConfigsResponse_Result) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetSpanConfigsResponse_Result.Merge(m, src)
}
func (m *GetSpanConfigsResponse_Result) XXX_Size() int {
	return m.Size()
}
func (m *GetSpanConfigsResponse_Result) XXX_DiscardUnknown() {
	xxx_messageInfo_GetSpanConfigsResponse_Result.DiscardUnknown(m)
}

var xxx_messageInfo_GetSpanConfigsResponse_Result proto.InternalMessageInfo
...
// being updated with new configs. If spans are being added, they're expected to
// not overlap with any existing spans. When divvying up an existing span into
// multiple others, callers are expected to delete the old and upsert the new
// ones. This can happen as part of the same request; we delete the spans marked
// for deletion before upserting whatever was requested.
//
...
type UpdateSpanConfigsRequest struct {
	// ToDelete lists out the spans we want to delete span configs for.
	ToDelete []Span `protobuf:"bytes,1,rep,name=to_delete,json=toDelete,proto3" json:"to_delete"`
	// ToUpsert lists out the spans we want to upsert and the configs we want to
	// upsert with.
...
func init() {
	...
	proto.RegisterType((*GetSpanConfigsResponse_Result)(nil), "cockroach.roachpb.GetSpanConfigsResponse.Result")
...
var fileDescriptor_91c9f1dcea14470a = []byte{
	...
	,
}
...
func (m *GetSpanConfigsResponse_Result) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GetSpanConfigsResponse_Result) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GetSpanConfigsResponse_Result) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GetSpanConfigsResponse_Result) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GetSpanConfigsResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Results = append(m.Results, GetSpanConfigsResponse_Result{})
...
func (m *GetSpanConfigsResponse_Result) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 1:
			...
			m.SpanConfigs = append(m.SpanConfigs, SpanConfigEntry{})
