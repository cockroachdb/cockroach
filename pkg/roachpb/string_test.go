...
func TestTransactionString(t *testing.T) {
	...
	txn := roachpb.Transaction{
		TxnMeta: enginepb.TxnMeta{
			...
			ID:             txnID,
			Epoch:          2,
			WriteTimestamp: enginepb.ToTxnTimestamp(hlc.Timestamp{WallTime: 20, Logical: 21}),
			MinTimestamp:   enginepb.ToTxnTimestamp(hlc.Timestamp{WallTime: 10, Logical: 11}),
			Priority:       957356782,
			Sequence:       15,
		},
		Name:          "name",
		...
		ReadTimestamp: enginepb.ToTxnTimestamp(hlc.Timestamp{WallTime: 30, Logical: 31}),
		MaxTimestamp:  enginepb.ToTxnTimestamp(hlc.Timestamp{WallTime: 40, Logical: 41}),
	}
