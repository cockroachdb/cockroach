...
func (*Percentiles) Descriptor() ([]byte, []int) { return fileDescriptorMetadata, []int{4} }
...
func (*Locality) Descriptor() ([]byte, []int) { return fileDescriptorMetadata, []int{9} }
...
func (*Tier) Descriptor() ([]byte, []int) { return fileDescriptorMetadata, []int{10} }
...
func (*Version) Descriptor() ([]byte, []int) { return fileDescriptorMetadata, []int{11} }
...
var fileDescriptorMetadata = []byte{
	...
	,
}
