...
// this joint config, the VOTER_DEMOTING_{LEARNER, NON_VOTER} and VOTER_INCOMING
// types are used as well to denote voters which are being downgraded to
// learners and newly added by the change, respectively. A demoting voter is
// turning into a learner, which we prefer over a direct removal, which was used
// prior to v20.1 and uses the VOTER_OUTGOING type instead (see
...
func (ReplicaType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_metadata_9f69811db2887c28, []int{0}
}
...
func (*ReplicationTarget) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_9f69811db2887c28, []int{1}
}
...
func (*ReplicaDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_9f69811db2887c28, []int{2}
}
...
func (*ReplicaIdent) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_9f69811db2887c28, []int{3}
}
...
func (*RangeDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_9f69811db2887c28, []int{4}
}
...
func (*Percentiles) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_9f69811db2887c28, []int{5}
}
...
func (*StoreCapacity) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_9f69811db2887c28, []int{6}
}
...
func (*NodeDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_9f69811db2887c28, []int{7}
}
...
func (*LocalityAddress) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_9f69811db2887c28, []int{8}
}
...
func (*StoreDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_9f69811db2887c28, []int{9}
}
...
func (*StoreDeadReplicas) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_9f69811db2887c28, []int{10}
}
...
func (*Locality) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_9f69811db2887c28, []int{11}
}
...
func (*Tier) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_9f69811db2887c28, []int{12}
}
...
func (*Version) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_9f69811db2887c28, []int{13}
}
...
func init() { proto.RegisterFile("roachpb/metadata.proto", fileDescriptor_metadata_9f69811db2887c28) }

var fileDescriptor_metadata_9f69811db2887c28 = []byte{
	...
	,
}
