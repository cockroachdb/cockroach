...
// In normal operation, Voter and Learner are the only used states. However,
// atomic replication changes require a transition through a "joint config";
// in this joint config, the VoterOutgoing and VoterIncoming types are used
// as well to denote voters which are being removed and newly added by the
// change, respectively.
//
...
// requires a majority of voters to reach a decision. In the joint config,
// two separate majorities are required: one from the set of replicas that
// have either type Voter or VoterOutgoing, as well as that of the set of
// types Voter and VoterIncoming. For example, when type Voter is assigned
...
// second, {1,4} is a quorum of the second but not the first, and {3,4} is a
// quorum of neither.
type ReplicaType int32

const (
	// ReplicaType_VoterFull indicates a replica that is a voter both in the
	// incoming and outgoing set.
	ReplicaType_VoterFull ReplicaType = 0
	// ReplicaType_VoterIncoming indicates a voting replica that will be a
	// VoterFull once the ongoing atomic replication change is finalized; that is,
	// it is in the process of being added. In practice, this replica type should
	// be treated like a VoterFull.
	ReplicaType_VoterIncoming ReplicaType = 2
	// ReplicaType_VoterOutgoing indicates a voting replica that will not be part
	...
	// it.
	ReplicaType_VoterOutgoing ReplicaType = 3
	// ReplicaType_Learner indicates a replica that applies committed entries, but
	// does not count towards the quorum(s). Learners do not vote for leadership
	// nor do their acknowledged log entries get taken into account for
	// determining the committed index. At the time of writing, learners in
...
func (ReplicaType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_metadata_e31f96670cc94504, []int{0}
}
...
func (*ReplicationTarget) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_e31f96670cc94504, []int{1}
}
...
func (*ReplicaDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_e31f96670cc94504, []int{2}
}
...
func (*ReplicaIdent) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_e31f96670cc94504, []int{3}
}
...
func (*RangeDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_e31f96670cc94504, []int{4}
}
...
func (*Percentiles) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_e31f96670cc94504, []int{5}
}
...
func (*StoreCapacity) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_e31f96670cc94504, []int{6}
}
...
func (*NodeDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_e31f96670cc94504, []int{7}
}
...
func (*LocalityAddress) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_e31f96670cc94504, []int{8}
}
...
func (*StoreDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_e31f96670cc94504, []int{9}
}
...
func (*StoreDeadReplicas) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_e31f96670cc94504, []int{10}
}
...
func (*Locality) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_e31f96670cc94504, []int{11}
}
...
func (*Tier) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_e31f96670cc94504, []int{12}
}
...
func (*Version) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_e31f96670cc94504, []int{13}
}
...
func NewPopulatedReplicaDescriptor(r randyMetadata, easy bool) *ReplicaDescriptor {
	...
	if r.Intn(10) != 0 {
		v1 := ReplicaType([]int32{0, 2, 3, 1}[r.Intn(4)])
		this.Type = &v1
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func init() { proto.RegisterFile("roachpb/metadata.proto", fileDescriptor_metadata_e31f96670cc94504) }

var fileDescriptor_metadata_e31f96670cc94504 = []byte{
	...
	,
}
