...
// normal operation, VOTER_FULL and LEARNER_EPHEMERAL are the only used states.
// However, atomic replication changes require a transition through a "joint
// config"; in this joint config, the VOTER_DEMOTING and VOTER_INCOMING types
// are used as well to denote voters which are being downgraded to ephemeral
// learners and newly added by the change, respectively. A demoting voter is
// turning into an ephemeral learner, which we prefer over a direct removal,
// which was used prior to v20.1 and uses the VOTER_OUTGOING type instead (see
// VersionChangeReplicasDemotion for details on why we're not doing that any
// more).
//
...
const (
	...
	// VOTER_DEMOTING indicates a voting replica that will become an ephemeral
	// learner once the ongoing atomic replication change is finalized; that is,
	// it is in the process of being demoted. Since these learners are
	...
	// LEARNER_EPHEMERAL indicates a replica that applies committed entries, but
	// does not count towards the quorum(s). Candidates will not ask for (or take
	// into account) votes of (peers they consider) LEARNER_EPHEMERALs for
	// leadership nor do their acknowledged log entries get taken into account for
	// determining the committed index. Ephemeral learners in CockroachDB are a
	...
	LEARNER_EPHEMERAL ReplicaType = 1
	// LEARNER_PERSISTENT indicates a replica that applies committed entries, does
	// not count towards the quorum(s), and is persistent (unlike the ephemeral
	// state used for atomic replication changes). Candidates will not ask for (or
	// take into account) votes of (peers they consider) LEARNER_PERSISTENTs for
	// leadership nor do their acknowledged log entries get taken into account for
	// determining the committed index.
	LEARNER_PERSISTENT ReplicaType = 5
)
...
func (ReplicaType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_metadata_6085ff34a83a5fc3, []int{0}
}
...
func (*ReplicationTarget) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_6085ff34a83a5fc3, []int{1}
}
...
func (*ReplicaDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_6085ff34a83a5fc3, []int{2}
}
...
func (*ReplicaIdent) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_6085ff34a83a5fc3, []int{3}
}
...
func (*RangeDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_6085ff34a83a5fc3, []int{4}
}
...
func (*Percentiles) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_6085ff34a83a5fc3, []int{5}
}
...
func (*StoreCapacity) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_6085ff34a83a5fc3, []int{6}
}
...
func (*NodeDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_6085ff34a83a5fc3, []int{7}
}
...
func (*LocalityAddress) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_6085ff34a83a5fc3, []int{8}
}
...
func (*StoreDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_6085ff34a83a5fc3, []int{9}
}
...
func (*StoreDeadReplicas) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_6085ff34a83a5fc3, []int{10}
}
...
func (*Locality) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_6085ff34a83a5fc3, []int{11}
}
...
func (*Tier) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_6085ff34a83a5fc3, []int{12}
}
...
func (*Version) Descriptor() ([]byte, []int) {
	return fileDescriptor_metadata_6085ff34a83a5fc3, []int{13}
}
...
func init() { proto.RegisterFile("roachpb/metadata.proto", fileDescriptor_metadata_6085ff34a83a5fc3) }

var fileDescriptor_metadata_6085ff34a83a5fc3 = []byte{
	// 1424 bytes of a gzipped FileDescriptorProto
	,
}
