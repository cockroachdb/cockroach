...
type NodeDescriptor struct {
	...
	ServerVersion Version                       `protobuf:"bytes,5,opt,name=server_version,json=serverVersion" json:"server_version"`
}
...
func (m *NodeDescriptor) MarshalTo(dAtA []byte) (int, error) {
	...
	n5, err := m.ServerVersion.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n5
...
var fileDescriptorMetadata = []byte{
	...
	,
}
