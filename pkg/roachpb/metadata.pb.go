...
type StoreCapacity struct {
	...
	AppliesPerSecond float64 `protobuf:"fixed64,5,opt,name=applies_per_second,json=appliesPerSecond" json:"applies_per_second"`
}
...
func (m *StoreCapacity) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x29
	i++
	i = encodeFixed64Metadata(dAtA, i, uint64(math.Float64bits(float64(m.AppliesPerSecond))))
	return i, nil
}
...
func (m *StoreCapacity) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 1 {
				return fmt.Errorf("proto: wrong wireType = %d for field AppliesPerSecond", wireType)
			}
			var v uint64
			if (iNdEx + 8) > l {
				return io.ErrUnexpectedEOF
			...
			m.AppliesPerSecond = float64(math.Float64frombits(v))
		default:
			iNdEx = preIndex
			skippy, err := skipMetadata(dAtA[iNdEx:])
			if err != nil {
...
var fileDescriptorMetadata = []byte{
	...
	,
}
