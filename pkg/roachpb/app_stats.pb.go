...
func (*StatementStatistics) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_efed1359c2d52ac9, []int{0}
}
...
func (*SensitiveInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_efed1359c2d52ac9, []int{1}
}
...
func (*NumericStat) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_efed1359c2d52ac9, []int{2}
}
...
func (*StatementStatisticsKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_efed1359c2d52ac9, []int{3}
}
...
func (*CollectedStatementStatistics) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_efed1359c2d52ac9, []int{4}
}
...
func (*ExplainTreePlanNode) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_efed1359c2d52ac9, []int{5}
}
...
func (*ExplainTreePlanNode_Attr) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_efed1359c2d52ac9, []int{5, 0}
}
...
type TxnInfo struct {
	TotalTimeInSeconds float64 `protobuf:"fixed64,1,opt,name=total_time_in_seconds,json=totalTimeInSeconds" json:"total_time_in_seconds"`
	Committed          bool    `protobuf:"varint,2,opt,name=committed" json:"committed"`
	Implicit           bool    `protobuf:"varint,3,opt,name=implicit" json:"implicit"`
}
...
func (*TxnInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_efed1359c2d52ac9, []int{6}
}
...
func init() {
	...
	proto.RegisterType((*TxnInfo)(nil), "cockroach.sql.TxnInfo")
}
...
func (m *TxnInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x9
	i++
	encoding_binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.TotalTimeInSeconds))))
	i += 8
	dAtA[i] = 0x10
	i++
	if m.Committed {
...
func (m *TxnInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 1 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalTimeInSeconds", wireType)
			}
			var v uint64
			if (iNdEx + 8) > l {
				return io.ErrUnexpectedEOF
			...
			v = uint64(encoding_binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
			m.TotalTimeInSeconds = float64(math.Float64frombits(v))
		case 2:
			if wireType != 0 {
...
func init() { proto.RegisterFile("roachpb/app_stats.proto", fileDescriptor_app_stats_efed1359c2d52ac9) }

var fileDescriptor_app_stats_efed1359c2d52ac9 = []byte{
	// 915 bytes of a gzipped FileDescriptorProto
	,
}
