...
type StatementStatistics struct {
	...
	// StatCollectionCount keeps track of how many times execution stats were
	...
	// the mean of some NumericStat values.
	StatCollectionCount int64 `protobuf:"varint,19,opt,name=stat_collection_count,json=statCollectionCount" json:"stat_collection_count"`
...
func (*StatementStatistics) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_af8d6d18334586f2, []int{0}
}
...
func (*TransactionStatistics) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_af8d6d18334586f2, []int{1}
}
...
func (*SensitiveInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_af8d6d18334586f2, []int{2}
}
...
func (*NumericStat) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_af8d6d18334586f2, []int{3}
}
...
func (*StatementStatisticsKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_af8d6d18334586f2, []int{4}
}
...
func (*CollectedStatementStatistics) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_af8d6d18334586f2, []int{5}
}
...
func (*CollectedTransactionStatistics) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_af8d6d18334586f2, []int{6}
}
...
func (*ExplainTreePlanNode) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_af8d6d18334586f2, []int{7}
}
...
func (*ExplainTreePlanNode_Attr) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_af8d6d18334586f2, []int{7, 0}
}
...
func (*TxnStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_af8d6d18334586f2, []int{8}
}
...
func (m *StatementStatistics) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x1
	i++
	i = encodeVarintAppStats(dAtA, i, uint64(m.StatCollectionCount))
	dAtA[i] = 0xa2
	i++
	dAtA[i] = 0x1
	i++
...
func (m *SensitiveInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	n17, err := m.MostRecentPlanDescription.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n17
	...
	n18, err := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.MostRecentPlanTimestamp, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n18
...
func (m *TxnStats) MarshalTo(dAtA []byte) (int, error) {
	...
	n22, err := m.TxnTimeSec.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n22
...
func (m *StatementStatistics) Size() (n int) {
	...
	n += 2 + l + sovAppStats(uint64(l))
	n += 2 + sovAppStats(uint64(m.StatCollectionCount))
...
func (m *StatementStatistics) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 19:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field StatCollectionCount", wireType)
			}
			m.StatCollectionCount = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowAppStats
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.StatCollectionCount |= (int64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func init() { proto.RegisterFile("roachpb/app_stats.proto", fileDescriptor_app_stats_af8d6d18334586f2) }

var fileDescriptor_app_stats_af8d6d18334586f2 = []byte{
	...
	,
}
