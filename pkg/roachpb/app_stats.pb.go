...
type ApplicationStatistics struct {
	// NumAutocommitTxns is the number of single-statement transactions.
	NumAutocommitTxns int64 `protobuf:"varint,1,opt,name=num_autocommit_txns,json=numAutocommitTxns" json:"num_autocommit_txns"`
	// NumExplicitTxns is the number of explicit (BEGIN/COMMIT) transactions.
	NumExplicitTxns int64 `protobuf:"varint,2,opt,name=num_explicit_txns,json=numExplicitTxns" json:"num_explicit_txns"`
	// AutocommitTxnLat is the total execution time of autocommit transactions.
	AutocommitTxnLat NumericStat `protobuf:"bytes,3,opt,name=autocommit_txn_lat,json=autocommitTxnLat" json:"autocommit_txn_lat"`
	// ExplicitTxnLat is the total execution time of explicit transactions.
	ExplicitTxnLat NumericStat `protobuf:"bytes,4,opt,name=explicit_txn_lat,json=explicitTxnLat" json:"explicit_txn_lat"`
}

func (m *ApplicationStatistics) Reset()                    { *m = ApplicationStatistics{} }
func (m *ApplicationStatistics) String() string            { return proto.CompactTextString(m) }
func (*ApplicationStatistics) ProtoMessage()               {}
func (*ApplicationStatistics) Descriptor() ([]byte, []int) { return fileDescriptorAppStats, []int{0} }
...
func (*StatementStatistics) Descriptor() ([]byte, []int) { return fileDescriptorAppStats, []int{1} }
...
type CollectedApplicationStatistics struct {
	App   string                `protobuf:"bytes,1,opt,name=app" json:"app"`
	Stats ApplicationStatistics `protobuf:"bytes,2,opt,name=stats" json:"stats"`
}

func (m *CollectedApplicationStatistics) Reset()         { *m = CollectedApplicationStatistics{} }
func (m *CollectedApplicationStatistics) String() string { return proto.CompactTextString(m) }
func (*CollectedApplicationStatistics) ProtoMessage()    {}
func (*CollectedApplicationStatistics) Descriptor() ([]byte, []int) {
	return fileDescriptorAppStats, []int{5}
}

func init() {
	proto.RegisterType((*ApplicationStatistics)(nil), "cockroach.sql.ApplicationStatistics")
	...
	proto.RegisterType((*CollectedApplicationStatistics)(nil), "cockroach.sql.CollectedApplicationStatistics")
}
func (m *ApplicationStatistics) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *ApplicationStatistics) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	dAtA[i] = 0x8
	i++
	i = encodeVarintAppStats(dAtA, i, uint64(m.NumAutocommitTxns))
	dAtA[i] = 0x10
	i++
	i = encodeVarintAppStats(dAtA, i, uint64(m.NumExplicitTxns))
	dAtA[i] = 0x1a
	i++
	i = encodeVarintAppStats(dAtA, i, uint64(m.AutocommitTxnLat.Size()))
	n1, err := m.AutocommitTxnLat.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n1
	dAtA[i] = 0x22
	i++
	i = encodeVarintAppStats(dAtA, i, uint64(m.ExplicitTxnLat.Size()))
	n2, err := m.ExplicitTxnLat.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n2
...
func (m *StatementStatistics) MarshalTo(dAtA []byte) (int, error) {
	...
	n3, err := m.NumRows.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n3
	...
	n4, err := m.ParseLat.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n4
	...
	n5, err := m.PlanLat.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n5
	...
	n6, err := m.RunLat.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n6
	...
	n7, err := m.ServiceLat.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n7
	...
	n8, err := m.OverheadLat.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n8
...
func (m *CollectedApplicationStatistics) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *CollectedApplicationStatistics) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ApplicationStatistics) Size() (n int) {
	var l int
	_ = l
	n += 1 + sovAppStats(uint64(m.NumAutocommitTxns))
	n += 1 + sovAppStats(uint64(m.NumExplicitTxns))
	l = m.AutocommitTxnLat.Size()
	n += 1 + l + sovAppStats(uint64(l))
	l = m.ExplicitTxnLat.Size()
	n += 1 + l + sovAppStats(uint64(l))
	return n
}
...
func (m *CollectedApplicationStatistics) Size() (n int) {
	var l int
	_ = l
	l = len(m.App)
	n += 1 + l + sovAppStats(uint64(l))
...
func (m *ApplicationStatistics) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: ApplicationStatistics: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ApplicationStatistics: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field NumAutocommitTxns", wireType)
			}
			m.NumAutocommitTxns = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowAppStats
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.NumAutocommitTxns |= (int64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field NumExplicitTxns", wireType)
			}
			m.NumExplicitTxns = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.NumExplicitTxns |= (int64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AutocommitTxnLat", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.AutocommitTxnLat.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExplicitTxnLat", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.ExplicitTxnLat.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *CollectedApplicationStatistics) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CollectedApplicationStatistics: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CollectedApplicationStatistics: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorAppStats = []byte{
	...
	,
}
