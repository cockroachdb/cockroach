...
func (*StatementStatistics) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_b80ab935055ad34e, []int{0}
}
...
func (*SensitiveInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_b80ab935055ad34e, []int{1}
}
...
func (*NumericStat) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_b80ab935055ad34e, []int{2}
}
...
func (*StatementStatisticsKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_b80ab935055ad34e, []int{3}
}
...
func (*CollectedStatementStatistics) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_b80ab935055ad34e, []int{4}
}
...
func (*ExplainTreePlanNode) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_b80ab935055ad34e, []int{5}
}
...
func (*ExplainTreePlanNode_Attr) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_b80ab935055ad34e, []int{5, 0}
}
...
type TxnStats struct {
	...
	AggTotalTimeSec float64 `protobuf:"fixed64,2,opt,name=agg_total_time_sec,json=aggTotalTimeSec" json:"agg_total_time_sec"`
...
func (*TxnStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_b80ab935055ad34e, []int{6}
}
...
func (m *TxnStats) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x11
	i++
	encoding_binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.AggTotalTimeSec))))
	i += 8
	dAtA[i] = 0x18
	i++
...
func (m *TxnStats) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 1 {
				return fmt.Errorf("proto: wrong wireType = %d for field AggTotalTimeSec", wireType)
			}
			var v uint64
			if (iNdEx + 8) > l {
				return io.ErrUnexpectedEOF
			...
			v = uint64(encoding_binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
			m.AggTotalTimeSec = float64(math.Float64frombits(v))
		case 3:
			if wireType != 0 {
...
func init() { proto.RegisterFile("roachpb/app_stats.proto", fileDescriptor_app_stats_b80ab935055ad34e) }

var fileDescriptor_app_stats_b80ab935055ad34e = []byte{
	...
	,
}
