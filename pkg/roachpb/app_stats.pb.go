...
func (*StatementStatistics) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_e4f794cdaf437eeb, []int{0}
}
...
func (*SensitiveInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_e4f794cdaf437eeb, []int{1}
}
...
func (*NumericStat) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_e4f794cdaf437eeb, []int{2}
}
...
func (*StatementStatisticsKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_e4f794cdaf437eeb, []int{3}
}
...
func (*CollectedStatementStatistics) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_e4f794cdaf437eeb, []int{4}
}
...
func (*ExplainTreePlanNode) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_e4f794cdaf437eeb, []int{5}
}
...
func (*ExplainTreePlanNode_Attr) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_e4f794cdaf437eeb, []int{5, 0}
}
...
func init() { proto.RegisterFile("roachpb/app_stats.proto", fileDescriptor_app_stats_e4f794cdaf437eeb) }

var fileDescriptor_app_stats_e4f794cdaf437eeb = []byte{
