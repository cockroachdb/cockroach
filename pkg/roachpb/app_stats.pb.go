...
func (*StatementStatistics) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_2864278ec842fe55, []int{0}
}
...
func (*TransactionStatistics) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_2864278ec842fe55, []int{1}
}
...
func (*SensitiveInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_2864278ec842fe55, []int{2}
}
...
func (*NumericStat) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_2864278ec842fe55, []int{3}
}
...
func (*StatementStatisticsKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_2864278ec842fe55, []int{4}
}
...
func (*CollectedStatementStatistics) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_2864278ec842fe55, []int{5}
}
...
func (*CollectedTransactionStatistics) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_2864278ec842fe55, []int{6}
}
...
func (*ExplainTreePlanNode) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_2864278ec842fe55, []int{7}
}
...
func (*ExplainTreePlanNode_Attr) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_2864278ec842fe55, []int{7, 0}
}
...
func (*TxnStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_2864278ec842fe55, []int{8}
}
...
func init() { proto.RegisterFile("roachpb/app_stats.proto", fileDescriptor_app_stats_2864278ec842fe55) }

var fileDescriptor_app_stats_2864278ec842fe55 = []byte{
