...
func (*StatementStatistics) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_7fcfc3c86028ed70, []int{0}
}
...
type TransactionStatistics struct {
	...
	// in order.
	StatementIDs []string `protobuf:"bytes,1,rep,name=statement_ids,json=statementIds" json:"statement_ids,omitempty"`
	...
	// statements.
	NumRows NumericStat `protobuf:"bytes,4,opt,name=num_rows,json=numRows" json:"num_rows"`
	// ServiceLat is the time to service the transaction, from the time a
	// transaction was received to end of exection.
	ServiceLat NumericStat `protobuf:"bytes,5,opt,name=service_lat,json=serviceLat" json:"service_lat"`
	// App is the name of the app which executed the transaction.
	App string `protobuf:"bytes,6,opt,name=app" json:"app"`
	// RetryLat is the amount of time spent retrying the transaction.
	RetryLat NumericStat `protobuf:"bytes,7,opt,name=retry_lat,json=retryLat" json:"retry_lat"`
	// CommitLat is the amount of time required to commit the transaction after
	// all statement operations have been applied.
	CommitLat NumericStat `protobuf:"bytes,8,opt,name=commit_lat,json=commitLat" json:"commit_lat"`
}
...
func (*TransactionStatistics) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_7fcfc3c86028ed70, []int{1}
}
...
func (*SensitiveInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_7fcfc3c86028ed70, []int{2}
}
...
func (*NumericStat) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_7fcfc3c86028ed70, []int{3}
}
...
func (*StatementStatisticsKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_7fcfc3c86028ed70, []int{4}
}
...
func (*CollectedStatementStatistics) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_7fcfc3c86028ed70, []int{5}
}
...
func (*ExplainTreePlanNode) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_7fcfc3c86028ed70, []int{6}
}
...
func (*ExplainTreePlanNode_Attr) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_7fcfc3c86028ed70, []int{6, 0}
}
...
func (*TxnStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_7fcfc3c86028ed70, []int{7}
}
...
func (m *TxnStats) MarshalTo(dAtA []byte) (int, error) {
	...
	n18, err := m.TxnTimeSec.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n18
...
func (m *TransactionStatistics) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.StatementIDs = append(m.StatementIDs, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Count", wireType)
...
func init() { proto.RegisterFile("roachpb/app_stats.proto", fileDescriptor_app_stats_7fcfc3c86028ed70) }

var fileDescriptor_app_stats_7fcfc3c86028ed70 = []byte{
	...
	,
}
