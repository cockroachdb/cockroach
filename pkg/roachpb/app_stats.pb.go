...
func (*StatementStatistics) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_d5ef37d026cef5e1, []int{0}
}
...
func (*SensitiveInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_d5ef37d026cef5e1, []int{1}
}
...
func (*NumericStat) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_d5ef37d026cef5e1, []int{2}
}
...
type StatementStatisticsKey struct {
	...
	ImplicitTransaction  bool     `protobuf:"varint,6,opt,name=implicitTransaction" json:"implicitTransaction"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*StatementStatisticsKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_d5ef37d026cef5e1, []int{3}
}
...
func (*CollectedStatementStatistics) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_d5ef37d026cef5e1, []int{4}
}
...
func (*ExplainTreePlanNode) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_d5ef37d026cef5e1, []int{5}
}
...
func (*ExplainTreePlanNode_Attr) Descriptor() ([]byte, []int) {
	return fileDescriptor_app_stats_d5ef37d026cef5e1, []int{5, 0}
}
...
func (m *StatementStatisticsKey) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ImplicitTransaction", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ImplicitTransaction = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipAppStats(dAtA[iNdEx:])
			if err != nil {
...
func init() { proto.RegisterFile("roachpb/app_stats.proto", fileDescriptor_app_stats_d5ef37d026cef5e1) }

var fileDescriptor_app_stats_d5ef37d026cef5e1 = []byte{
	// 813 bytes of a gzipped FileDescriptorProto
	,
}
