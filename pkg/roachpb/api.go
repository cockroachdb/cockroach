...
// IsEmpty is true if key is not initialized. e.g. its start or end keys are
// empty.
func (gcr GCRequest_GCClearRangeKey) IsEmpty() bool {
	return len(gcr.StartKey) == 0 && len(gcr.EndKey) == 0
}
