...
// UpdatesReadTimestampCache returns whether the command must update
// the read timestamp cache.
func UpdatesReadTimestampCache(args Request) bool {
	return (args.flags() & updatesReadTSCache) != 0
}
...
// See comments for ConditionalPut on why Increment must update the
// timestamp cache.
