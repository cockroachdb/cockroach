...
// Combine implements the combinable interface.
func (r *ScatterResponse) combine(c combinable) error {
	if r != nil {
		otherR := c.(*ScatterResponse)
...
var _ combinable = &ScatterResponse{}
...
// Method implements the Request interface.
func (*ScatterRequest) Method() Method { return Scatter }
...
// ShallowCopy implements the Request interface.
func (r *ScatterRequest) ShallowCopy() Request {
	shallowCopy := *r
	return &shallowCopy
}
...
func (*ScatterRequest) flags() int                  { return isAdmin | isAlone | isRange }
