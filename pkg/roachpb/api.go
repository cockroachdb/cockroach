...
const (
	...
	canBypassReplicaCircuitBreaker                  // commands which bypass the replica circuit breaker, i.e. opt out of fail-fast
)
...
// CanBypassReplicaCircuitBreaker returns whether the command bypasses
...
func CanBypassReplicaCircuitBreaker(args Request) bool {
	return (args.flags() & canBypassReplicaCircuitBreaker) != 0
}
...
func (*ClearRangeRequest) flags() flag {
	return isWrite | isRange | isAlone | canBypassReplicaCircuitBreaker
}

// Note that RevertRange commands cannot be part of a transaction as
// they clear all MVCC versions above their target time.
func (*RevertRangeRequest) flags() flag { return isWrite | isRange | canBypassReplicaCircuitBreaker }
...
func (*GCRequest) flags() flag {
	...
	return isWrite | isRange | canBypassReplicaCircuitBreaker
}
...
func (*ProbeRequest) flags() flag {
	return isWrite | isAlone | skipsLeaseCheck | canBypassReplicaCircuitBreaker
}
...
func (*ExportRequest) flags() flag {
	return isRead | isRange | updatesTSCache | canBypassReplicaCircuitBreaker
}
...
func (r *AddSSTableRequest) flags() flag {
	flags := isWrite | isRange | isAlone | isUnsplittable | canBackpressure | canBypassReplicaCircuitBreaker
