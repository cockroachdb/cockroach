...
func (e *ConflictUpdatingRangeDesc) Error() string {
	return "conflict updating range descriptor"
}

func (e *ConflictUpdatingRangeDesc) message(_ *Error) string {
	return e.Error()
}

var _ ErrorDetailInterface = &ConflictUpdatingRangeDesc{}
