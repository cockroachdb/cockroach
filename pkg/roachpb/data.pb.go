...
type Transaction struct {
	...
	// Safe timestamp is the timestamp at which the transaction can
	// commit without necessitating a serializable restart. This value
	// is forwarded to the transaction's current timestamp while and if the
	// transaction coordinator is able to update all spans encountered
	// during the course of the txn.
	SafeTimestamp cockroach_util_hlc.Timestamp `protobuf:"bytes,15,opt,name=safe_timestamp,json=safeTimestamp" json:"safe_timestamp"`
...
type TxnCoordMeta struct {
	...
	// update_reads and update_writes store key spans which were read
	...
	// coordinator uses the UpdateSpan RPC to verify that no write has
	// occurred to the spans more recently than the txn's original
	// timestamp, and updates the affected timestamp caches to the
	// transaction's pushed timestamp. On failure, the retry error is
	// propagated. On success, the transaction's original and current
	// timestamps are forwarded to the restart timestamp, and the end
	// transaction is resent, with the expectation of success.
	UpdateReads  []Span `protobuf:"bytes,4,rep,name=update_reads,json=updateReads" json:"update_reads"`
	UpdateWrites []Span `protobuf:"bytes,5,rep,name=update_writes,json=updateWrites" json:"update_writes"`
	// updates_exceeded indicates that too many updates were set over
	// the course of the transaction to track them all, so they were
	// discarded, making it impossible to update spans to avoid a
	// serializable txn restart.
	UpdatesExceeded bool `protobuf:"varint,6,opt,name=updates_exceeded,json=updatesExceeded,proto3" json:"updates_exceeded,omitempty"`
}
...
func (this *Transaction) Equal(that interface{}) bool {
	...
	if !this.SafeTimestamp.Equal(&that1.SafeTimestamp) {
		return false
	}
...
func (m *Transaction) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x7a
	i++
	i = encodeVarintData(dAtA, i, uint64(m.SafeTimestamp.Size()))
	n20, err := m.SafeTimestamp.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n20
...
func (m *TxnCoordMeta) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.UpdateReads) > 0 {
		for _, msg := range m.UpdateReads {
			dAtA[i] = 0x22
			i++
			i = encodeVarintData(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
	...
	if len(m.UpdateWrites) > 0 {
		for _, msg := range m.UpdateWrites {
			dAtA[i] = 0x2a
			i++
			i = encodeVarintData(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *TxnCoordMeta) Size() (n int) {
	...
	if len(m.UpdateReads) > 0 {
		for _, e := range m.UpdateReads {
			l = e.Size()
			n += 1 + l + sovData(uint64(l))
		}
	}
	if len(m.UpdateWrites) > 0 {
		for _, e := range m.UpdateWrites {
			l = e.Size()
			n += 1 + l + sovData(uint64(l))
		}
	}
...
func (m *Transaction) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 15:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SafeTimestamp", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.SafeTimestamp.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *TxnCoordMeta) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UpdateReads", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.UpdateReads = append(m.UpdateReads, Span{})
			if err := m.UpdateReads[len(m.UpdateReads)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UpdateWrites", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.UpdateWrites = append(m.UpdateWrites, Span{})
			if err := m.UpdateWrites[len(m.UpdateWrites)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field UpdatesExceeded", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorData = []byte{
	...
	,
}
