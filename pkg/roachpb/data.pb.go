...
// RSpan specifies a span whose key and end key have been translated
// into "raw" keys (Key -> RKey). Raw keys are keys whose local
// addressing has been accounted for.
type RSpan struct {
	// The key for request. If the request operates on a range, this
	// represents the starting key for the range.
	Key RKey `protobuf:"bytes,3,opt,name=key,casttype=RKey" json:"key,omitempty"`
	// The end key is empty if the request spans only a single key. Otherwise,
	// it must order strictly after Key. The span is exclusive of end key.
	EndKey RKey `protobuf:"bytes,4,opt,name=end_key,json=endKey,casttype=RKey" json:"end_key,omitempty"`
}

func (m *RSpan) Reset()                    { *m = RSpan{} }
func (*RSpan) ProtoMessage()               {}
func (*RSpan) Descriptor() ([]byte, []int) { return fileDescriptorData, []int{1} }
...
type Lease struct {
	...
	Expiration *cockroach_util_hlc1.Timestamp `protobuf:"bytes,2,opt,name=expiration" json:"expiration,omitempty" cockroachdb:"randnullable"`
	...
	DeprecatedStartStasis *cockroach_util_hlc1.Timestamp `protobuf:"bytes,4,opt,name=deprecated_start_stasis,json=deprecatedStartStasis" json:"deprecated_start_stasis,omitempty" cockroachdb:"randnullable"`
...
func (*CSVOptions) Descriptor() ([]byte, []int) { return fileDescriptorData, []int{15} }

func init() {
	proto.RegisterType((*Span)(nil), "cockroach.roachpb.Span")
	proto.RegisterType((*RSpan)(nil), "cockroach.roachpb.RSpan")
...
func (this *RSpan) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
...
func (m *RSpan) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *RSpan) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *CSVOptions) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x8
	i++
	i = encodeVarintData(dAtA, i, uint64(m.Comma))
	dAtA[i] = 0x10
	i++
	i = encodeVarintData(dAtA, i, uint64(m.Comment))
	if m.Nullif != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintData(dAtA, i, uint64(len(*m.Nullif)))
...
func NewPopulatedRSpan(r randyData, easy bool) *RSpan {
	this := &RSpan{}
	if r.Intn(10) != 0 {
		v3 := r.Intn(100)
		this.Key = make(RKey, v3)
		for i := 0; i < v3; i++ {
			this.Key[i] = byte(r.Intn(256))
		}
	}
...
func NewPopulatedTransaction(r randyData, easy bool) *Transaction {
	this := &Transaction{}
	v6 := cockroach_storage_engine_enginepb.NewPopulatedTxnMeta(r, easy)
	this.TxnMeta = *v6
	...
	this.LastHeartbeat = *v7
	v8 := cockroach_util_hlc1.NewPopulatedTimestamp(r, easy)
	this.OrigTimestamp = *v8
	v9 := cockroach_util_hlc1.NewPopulatedTimestamp(r, easy)
	this.MaxTimestamp = *v9
	if r.Intn(10) != 0 {
		v10 := r.Intn(5)
		this.ObservedTimestamps = make([]ObservedTimestamp, v10)
		for i := 0; i < v10; i++ {
			v11 := NewPopulatedObservedTimestamp(r, easy)
			this.ObservedTimestamps[i] = *v11
		}
	}
	this.Writing = bool(bool(r.Intn(2) == 0))
	if r.Intn(10) != 0 {
		v12 := r.Intn(5)
		this.Intents = make([]Span, v12)
		for i := 0; i < v12; i++ {
			v13 := NewPopulatedSpan(r, easy)
			this.Intents[i] = *v13
		}
	}
...
func NewPopulatedLease(r randyData, easy bool) *Lease {
	this := &Lease{}
	v14 := cockroach_util_hlc1.NewPopulatedTimestamp(r, easy)
	this.Start = *v14
	if r.Intn(10) != 0 {
...
func NewPopulatedAbortCacheEntry(r randyData, easy bool) *AbortCacheEntry {
	...
	v18 := cockroach_util_hlc1.NewPopulatedTimestamp(r, easy)
	this.Timestamp = *v18
...
func (m *CSVOptions) Size() (n int) {
	var l int
	_ = l
	n += 1 + sovData(uint64(m.Comma))
	n += 1 + sovData(uint64(m.Comment))
	if m.Nullif != nil {
		l = len(*m.Nullif)
		n += 1 + l + sovData(uint64(l))
	}
...
func (m *RSpan) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RSpan: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RSpan: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 3:
			if wireType != 2 {
...
var fileDescriptorData = []byte{
	...
	,
}
