...
// A TransactionDelta is ...
// TODO(tschottdorf): avoid diverging from Transaction (wire compatibility).
type TransactionDelta struct {
	Meta               cockroach_storage_engine_enginepb.TxnMetaDelta `protobuf:"bytes,1,opt,name=meta" json:"meta"`
	Status             TransactionStatus                              `protobuf:"varint,4,opt,name=status,proto3,enum=cockroach.roachpb.TransactionStatus" json:"status,omitempty"`
	...
	ObservedTimestamps []ObservedTimestamp                            `protobuf:"bytes,8,rep,name=observed_timestamps,json=observedTimestamps" json:"observed_timestamps"`
	// NB: zero values are not sent on the wire thanks to proto3.
	Writing     bool `protobuf:"varint,9,opt,name=writing,proto3" json:"writing,omitempty"`
	WriteTooOld bool `protobuf:"varint,12,opt,name=write_too_old,json=writeTooOld,proto3" json:"write_too_old,omitempty"`
	RetryOnPush bool `protobuf:"varint,13,opt,name=retry_on_push,json=retryOnPush,proto3" json:"retry_on_push,omitempty"`
}

func (m *TransactionDelta) Reset()                    { *m = TransactionDelta{} }
func (m *TransactionDelta) String() string            { return proto.CompactTextString(m) }
func (*TransactionDelta) ProtoMessage()               {}
func (*TransactionDelta) Descriptor() ([]byte, []int) { return fileDescriptorData, []int{11} }

func (m *TransactionDelta) GetMeta() cockroach_storage_engine_enginepb.TxnMetaDelta {
	if m != nil {
		return m.Meta
	}
	return cockroach_storage_engine_enginepb.TxnMetaDelta{}
}

func (m *TransactionDelta) GetStatus() TransactionStatus {
	if m != nil {
		return m.Status
	}
	return PENDING
...
func (m *TransactionDelta) GetLastHeartbeat() *cockroach_util_hlc.Timestamp {
	if m != nil {
...
func (m *TransactionDelta) GetObservedTimestamps() []ObservedTimestamp {
	if m != nil {
		return m.ObservedTimestamps
	}
	return nil
}

func (m *TransactionDelta) GetWriting() bool {
	if m != nil {
		return m.Writing
	}
	return false
...
func (m *TransactionDelta) GetWriteTooOld() bool {
	if m != nil {
...
func (m *TransactionDelta) GetRetryOnPush() bool {
	if m != nil {
		return m.RetryOnPush
	}
	return false
}
...
func init() {
	...
	proto.RegisterType((*TransactionDelta)(nil), "cockroach.roachpb.TransactionDelta")
...
func (this *TransactionDelta) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*TransactionDelta)
	if !ok {
		that2, ok := that.(TransactionDelta)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *TransactionDelta) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *TransactionDelta) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *Lease) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DeprecatedStartStasis != nil {
		...
		n27, err := m.DeprecatedStartStasis.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n27
	...
	if m.ProposedTS != nil {
		...
		n28, err := m.ProposedTS.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n28
...
func NewPopulatedTransactionDelta(r randyData, easy bool) *TransactionDelta {
	this := &TransactionDelta{}
	v13 := cockroach_storage_engine_enginepb.NewPopulatedTxnMetaDelta(r, easy)
	this.Meta = *v13
	this.Status = TransactionStatus([]int32{0, 1, 2}[r.Intn(3)])
	if r.Intn(10) != 0 {
	...
	if r.Intn(10) != 0 {
		v14 := r.Intn(5)
		this.ObservedTimestamps = make([]ObservedTimestamp, v14)
		for i := 0; i < v14; i++ {
			v15 := NewPopulatedObservedTimestamp(r, easy)
			this.ObservedTimestamps[i] = *v15
		}
	}
	this.Writing = bool(bool(r.Intn(2) == 0))
	this.WriteTooOld = bool(bool(r.Intn(2) == 0))
...
func NewPopulatedAbortSpanEntry(r randyData, easy bool) *AbortSpanEntry {
	this := &AbortSpanEntry{}
	v18 := r.Intn(100)
	this.Key = make(Key, v18)
	for i := 0; i < v18; i++ {
		this.Key[i] = byte(r.Intn(256))
	}
	v19 := cockroach_util_hlc.NewPopulatedTimestamp(r, easy)
	this.Timestamp = *v19
...
func randFieldData(dAtA []byte, r randyData, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateData(dAtA, uint64(v21))
	case 1:
		dAtA = encodeVarintPopulateData(dAtA, uint64(key))
...
func (m *TransactionDelta) Size() (n int) {
	var l int
	_ = l
	l = m.Meta.Size()
	n += 1 + l + sovData(uint64(l))
...
func (m *TransactionDelta) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TransactionDelta: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TransactionDelta: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorData = []byte{
	...
	,
}
