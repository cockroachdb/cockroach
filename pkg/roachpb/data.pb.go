...
func (this *StoreIdent) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*StoreIdent)
	if !ok {
		that2, ok := that.(StoreIdent)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *AbortCacheEntry) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*AbortCacheEntry)
	if !ok {
		that2, ok := that.(AbortCacheEntry)
		if ok {
			that1 = &that2
		} else {
			return false
...
var fileDescriptorData = []byte{
	...
	,
}
