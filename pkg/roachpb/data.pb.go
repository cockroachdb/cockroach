...
type MergeTrigger struct {
	LeftDesc       RangeDescriptor                              `protobuf:"bytes,1,opt,name=left_desc,json=leftDesc" json:"left_desc"`
	RightDesc      RangeDescriptor                              `protobuf:"bytes,2,opt,name=right_desc,json=rightDesc" json:"right_desc"`
	RightData      []byte                                       `protobuf:"bytes,3,opt,name=right_data,json=rightData,proto3" json:"right_data,omitempty"`
...
func (this *MergeTrigger) Equal(that interface{}) bool {
	...
	if !bytes.Equal(this.RightData, that1.RightData) {
		return false
	}
...
func (m *MergeTrigger) MarshalTo(dAtA []byte) (int, error) {
	...
	i += n7
	if len(m.RightData) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintData(dAtA, i, uint64(len(m.RightData)))
		i += copy(dAtA[i:], m.RightData)
	}
	dAtA[i] = 0x22
	i++
...
func (m *MergeTrigger) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RightData", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RightData = append(m.RightData[:0], dAtA[iNdEx:postIndex]...)
			if m.RightData == nil {
				m.RightData = []byte{}
			}
			iNdEx = postIndex
...
var fileDescriptorData = []byte{
	...
	,
}
