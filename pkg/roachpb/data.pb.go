...
const (
	...
	// move from PENDING to one of COMMITTED, ABORTED, or
	// PREPARED. Mutations made as part of a PENDING transactions are
	...
	// PREPARED is the state for a transaction which has been prepared
	// as part of a two phase commit protocol. Transactions in state
	// PREPARED can be subsequently moved to either state COMMITTED or
	// ABORTED.
	PREPARED TransactionStatus = 3
)
...
func NewPopulatedTransaction(r randyData, easy bool) *Transaction {
	...
	this.Status = TransactionStatus([]int32{0, 1, 2, 3}[r.Intn(4)])
...
var fileDescriptorData = []byte{
	...
	,
}
