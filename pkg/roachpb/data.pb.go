...
func (ValueType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_data_f474be7fd10340ea, []int{0}
}
...
const (
	...
	ADD_LEARNER_PERSISTENT    ReplicaChangeType = 2
	REMOVE_LEARNER_PERSISTENT ReplicaChangeType = 3
)

var ReplicaChangeType_name = map[int32]string{
	0: "ADD_VOTER",
	1: "REMOVE_VOTER",
	2: "ADD_LEARNER_PERSISTENT",
	3: "REMOVE_LEARNER_PERSISTENT",
}
var ReplicaChangeType_value = map[string]int32{
	"ADD_VOTER":                 0,
	"REMOVE_VOTER":              1,
	"ADD_LEARNER_PERSISTENT":    2,
	"REMOVE_LEARNER_PERSISTENT": 3,
}
...
func (ReplicaChangeType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_data_f474be7fd10340ea, []int{1}
}
...
func (TransactionStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_data_f474be7fd10340ea, []int{2}
}
...
func (*StoreIdent) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_f474be7fd10340ea, []int{3}
}
...
func (*SplitTrigger) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_f474be7fd10340ea, []int{4}
}
...
func (*MergeTrigger) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_f474be7fd10340ea, []int{5}
}
...
type ChangeReplicasTrigger struct {
	...
	AddedReplicas []ReplicaDescriptor `protobuf:"bytes,6,rep,name=added_replicas,json=addedReplicas,proto3" json:"added_replicas"`
	...
	RemovedReplicas []ReplicaDescriptor `protobuf:"bytes,7,rep,name=removed_replicas,json=removedReplicas,proto3" json:"removed_replicas"`
}
...
func (*ChangeReplicasTrigger) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_f474be7fd10340ea, []int{6}
}
...
func (*ModifiedSpanTrigger) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_f474be7fd10340ea, []int{7}
}
...
func (*StickyBitTrigger) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_f474be7fd10340ea, []int{8}
}
...
func (*InternalCommitTrigger) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_f474be7fd10340ea, []int{9}
}
...
func (*ObservedTimestamp) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_f474be7fd10340ea, []int{10}
}
...
func (*Transaction) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_f474be7fd10340ea, []int{11}
}
...
func (*TransactionRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_f474be7fd10340ea, []int{12}
}
...
func (*Intent) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_f474be7fd10340ea, []int{13}
}
...
func (*Intent_SingleKeySpan) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_f474be7fd10340ea, []int{13, 0}
}
...
func (*LockAcquisition) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_f474be7fd10340ea, []int{14}
}
...
func (*LockUpdate) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_f474be7fd10340ea, []int{15}
}
...
func (*SequencedWrite) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_f474be7fd10340ea, []int{16}
}
...
func (*Lease) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_f474be7fd10340ea, []int{17}
}
...
func (*AbortSpanEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_f474be7fd10340ea, []int{18}
}
...
func (*LeafTxnInputState) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_f474be7fd10340ea, []int{19}
}
...
func (*LeafTxnFinalState) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_f474be7fd10340ea, []int{20}
}
...
func (*RangeInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_f474be7fd10340ea, []int{21}
}
...
func (this *ChangeReplicasTrigger) Equal(that interface{}) bool {
	...
	if len(this.AddedReplicas) != len(that1.AddedReplicas) {
		return false
	}
	for i := range this.AddedReplicas {
		if !this.AddedReplicas[i].Equal(&that1.AddedReplicas[i]) {
			return false
		}
	}
	if len(this.RemovedReplicas) != len(that1.RemovedReplicas) {
		return false
	}
	for i := range this.RemovedReplicas {
		if !this.RemovedReplicas[i].Equal(&that1.RemovedReplicas[i]) {
			return false
		}
	}
	return true
...
func (m *ChangeReplicasTrigger) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.AddedReplicas) > 0 {
		for _, msg := range m.AddedReplicas {
			dAtA[i] = 0x32
			i++
	...
	if len(m.RemovedReplicas) > 0 {
		for _, msg := range m.RemovedReplicas {
			dAtA[i] = 0x3a
			i++
			i = encodeVarintData(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *Transaction) MarshalTo(dAtA []byte) (int, error) {
	...
	n21, err := m.MaxTimestamp.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n21
	...
	n22, err := m.ReadTimestamp.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n22
...
func (m *Intent) MarshalTo(dAtA []byte) (int, error) {
	...
	n25, err := m.Intent_SingleKeySpan.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n25
...
func (m *Lease) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Expiration != nil {
		...
		n32, err := m.Expiration.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n32
	...
	n33, err := m.Replica.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n33
	if m.DeprecatedStartStasis != nil {
		...
		n34, err := m.DeprecatedStartStasis.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n34
	...
	if m.ProposedTS != nil {
		...
		n35, err := m.ProposedTS.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n35
...
func (m *RangeInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintData(dAtA, i, uint64(m.Desc.Size()))
	n39, err := m.Desc.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n39
	...
	n40, err := m.Lease.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n40
...
func (m *ChangeReplicasTrigger) Size() (n int) {
	...
	if len(m.AddedReplicas) > 0 {
		for _, e := range m.AddedReplicas {
			l = e.Size()
			n += 1 + l + sovData(uint64(l))
		}
	}
	if len(m.RemovedReplicas) > 0 {
		for _, e := range m.RemovedReplicas {
			l = e.Size()
			n += 1 + l + sovData(uint64(l))
		}
	}
...
func (m *ChangeReplicasTrigger) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AddedReplicas", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AddedReplicas = append(m.AddedReplicas, ReplicaDescriptor{})
			if err := m.AddedReplicas[len(m.AddedReplicas)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RemovedReplicas", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RemovedReplicas = append(m.RemovedReplicas, ReplicaDescriptor{})
			if err := m.RemovedReplicas[len(m.RemovedReplicas)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func init() { proto.RegisterFile("roachpb/data.proto", fileDescriptor_data_f474be7fd10340ea) }

var fileDescriptor_data_f474be7fd10340ea = []byte{
	...
	,
}
