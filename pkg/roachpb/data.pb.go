...
type Transaction struct {
	...
	// TODO
	Knowledge *TransactionKnowledge `protobuf:"bytes,17,opt,name=knowledge" json:"knowledge,omitempty"`
}
...
type TransactionKnowledge struct {
	Epoch             int32    `protobuf:"varint,1,opt,name=epoch,proto3" json:"epoch,omitempty"`
	KnownDispositions []Intent `protobuf:"bytes,2,rep,name=known_dispositions,json=knownDispositions" json:"known_dispositions"`
}

func (m *TransactionKnowledge) Reset()                    { *m = TransactionKnowledge{} }
func (m *TransactionKnowledge) String() string            { return proto.CompactTextString(m) }
func (*TransactionKnowledge) ProtoMessage()               {}
func (*TransactionKnowledge) Descriptor() ([]byte, []int) { return fileDescriptorData, []int{11} }
...
func (*SequencedWrite) Descriptor() ([]byte, []int) { return fileDescriptorData, []int{13} }
...
func (*Lease) Descriptor() ([]byte, []int) { return fileDescriptorData, []int{14} }
...
func (*AbortSpanEntry) Descriptor() ([]byte, []int) { return fileDescriptorData, []int{15} }
...
func (*TxnCoordMeta) Descriptor() ([]byte, []int) { return fileDescriptorData, []int{16} }
...
func init() {
	...
	proto.RegisterType((*TransactionKnowledge)(nil), "cockroach.roachpb.TransactionKnowledge")
...
func (this *Transaction) Equal(that interface{}) bool {
	...
	if !this.Knowledge.Equal(that1.Knowledge) {
		return false
	}
	return true
}
func (this *TransactionKnowledge) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*TransactionKnowledge)
	if !ok {
		that2, ok := that.(TransactionKnowledge)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if len(this.KnownDispositions) != len(that1.KnownDispositions) {
		return false
	}
	for i := range this.KnownDispositions {
		if !this.KnownDispositions[i].Equal(&that1.KnownDispositions[i]) {
			return false
		}
	}
	return true
...
func (m *Transaction) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Knowledge != nil {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintData(dAtA, i, uint64(m.Knowledge.Size()))
		n23, err := m.Knowledge.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n23
...
func (m *TransactionKnowledge) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *TransactionKnowledge) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if len(m.KnownDispositions) > 0 {
		for _, msg := range m.KnownDispositions {
			dAtA[i] = 0x12
			i++
			i = encodeVarintData(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *Intent) MarshalTo(dAtA []byte) (int, error) {
	...
	n25, err := m.Txn.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n25
...
func NewPopulatedTransaction(r randyData, easy bool) *Transaction {
	...
	if r.Intn(10) != 0 {
		this.Knowledge = NewPopulatedTransactionKnowledge(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedTransactionKnowledge(r randyData, easy bool) *TransactionKnowledge {
	this := &TransactionKnowledge{}
	this.Epoch = int32(r.Int31())
	if r.Intn(2) == 0 {
		this.Epoch *= -1
	}
	if r.Intn(10) != 0 {
		v14 := r.Intn(5)
		this.KnownDispositions = make([]Intent, v14)
		for i := 0; i < v14; i++ {
			v15 := NewPopulatedIntent(r, easy)
			this.KnownDispositions[i] = *v15
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedIntent(r randyData, easy bool) *Intent {
	this := &Intent{}
	v16 := NewPopulatedSpan(r, easy)
	this.Span = *v16
	v17 := cockroach_storage_engine_enginepb.NewPopulatedTxnMeta(r, easy)
	this.Txn = *v17
	this.Status = TransactionStatus([]int32{0, 1, 2}[r.Intn(3)])
	if !easy && r.Intn(10) != 0 {
	}
...
func (m *TransactionKnowledge) Size() (n int) {
	var l int
	_ = l
	if m.Epoch != 0 {
	...
	if len(m.KnownDispositions) > 0 {
		for _, e := range m.KnownDispositions {
			l = e.Size()
			n += 1 + l + sovData(uint64(l))
		}
	}
...
func (m *Transaction) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 17:
			...
			if m.Knowledge == nil {
				m.Knowledge = &TransactionKnowledge{}
			}
			if err := m.Knowledge.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *TransactionKnowledge) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TransactionKnowledge: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TransactionKnowledge: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field KnownDispositions", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.KnownDispositions = append(m.KnownDispositions, Intent{})
			if err := m.KnownDispositions[len(m.KnownDispositions)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorData = []byte{
	...
	,
}
