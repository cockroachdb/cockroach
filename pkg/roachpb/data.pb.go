...
type Lease struct {
	...
	Epoch int64 `protobuf:"varint,6,opt,name=epoch" json:"epoch"`
}
...
func (m *Lease) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ProposedTS != nil {
		...
		n24, err := m.ProposedTS.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n24
...
func randFieldData(dAtA []byte, r randyData, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateData(dAtA, uint64(v15))
	case 1:
		dAtA = encodeVarintPopulateData(dAtA, uint64(key))
...
var fileDescriptorData = []byte{
	...
	,
}
