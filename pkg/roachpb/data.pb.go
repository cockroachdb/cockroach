...
import fmt "fmt"
import math "math"
import lock "github.com/cockroachdb/cockroach/pkg/kv/storage/concurrency/lock"
...
func (ValueType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_data_03419c6f4e5fb074, []int{0}
}
...
func (ReplicaChangeType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_data_03419c6f4e5fb074, []int{1}
}
...
func (TransactionStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_data_03419c6f4e5fb074, []int{2}
}
...
func (*StoreIdent) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_03419c6f4e5fb074, []int{3}
}
...
func (*SplitTrigger) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_03419c6f4e5fb074, []int{4}
}
...
func (*MergeTrigger) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_03419c6f4e5fb074, []int{5}
}
...
func (*ChangeReplicasTrigger) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_03419c6f4e5fb074, []int{6}
}
...
func (*ModifiedSpanTrigger) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_03419c6f4e5fb074, []int{7}
}
...
func (*StickyBitTrigger) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_03419c6f4e5fb074, []int{8}
}
...
func (*InternalCommitTrigger) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_03419c6f4e5fb074, []int{9}
}
...
func (*ObservedTimestamp) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_03419c6f4e5fb074, []int{10}
}
...
func (*Transaction) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_03419c6f4e5fb074, []int{11}
}
...
func (*TransactionRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_03419c6f4e5fb074, []int{12}
}
...
func (*Intent) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_03419c6f4e5fb074, []int{13}
}
...
func (*Intent_SingleKeySpan) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_03419c6f4e5fb074, []int{13, 0}
}
...
type LockUpdate struct {
	...
	Durability     lock.Durability               `protobuf:"varint,5,opt,name=durability,proto3,enum=cockroach.kv.storage.concurrency.lock.Durability" json:"durability,omitempty"`
}
...
func (*LockUpdate) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_03419c6f4e5fb074, []int{14}
}
...
type SequencedWrite struct {
	...
	Sequence github_com_cockroachdb_cockroach_pkg_kv_storage_engine_enginepb.TxnSeq `protobuf:"varint,2,opt,name=sequence,proto3,casttype=github.com/cockroachdb/cockroach/pkg/kv/storage/engine/enginepb.TxnSeq" json:"sequence,omitempty"`
}
...
func (*SequencedWrite) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_03419c6f4e5fb074, []int{15}
}
...
func (*Lease) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_03419c6f4e5fb074, []int{16}
}
...
type AbortSpanEntry struct {
	...
	Priority github_com_cockroachdb_cockroach_pkg_kv_storage_engine_enginepb.TxnPriority `protobuf:"varint,3,opt,name=priority,proto3,casttype=github.com/cockroachdb/cockroach/pkg/kv/storage/engine/enginepb.TxnPriority" json:"priority,omitempty"`
}
...
func (*AbortSpanEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_03419c6f4e5fb074, []int{17}
}
...
type LeafTxnInputState struct {
	...
	ReadSeqNum github_com_cockroachdb_cockroach_pkg_kv_storage_engine_enginepb.TxnSeq `protobuf:"varint,10,opt,name=read_seq_num,json=readSeqNum,proto3,casttype=github.com/cockroachdb/cockroach/pkg/kv/storage/engine/enginepb.TxnSeq" json:"read_seq_num,omitempty"`
}
...
func (*LeafTxnInputState) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_03419c6f4e5fb074, []int{18}
}
...
func (*LeafTxnFinalState) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_03419c6f4e5fb074, []int{19}
}
...
func NewPopulatedSequencedWrite(r randyData, easy bool) *SequencedWrite {
	...
	this.Sequence = github_com_cockroachdb_cockroach_pkg_kv_storage_engine_enginepb.TxnSeq(r.Int31())
	if r.Intn(2) == 0 {
		this.Sequence *= -1
	}
	if !easy && r.Intn(10) != 0 {
...
func NewPopulatedAbortSpanEntry(r randyData, easy bool) *AbortSpanEntry {
	...
	this.Timestamp = *v29
	this.Priority = github_com_cockroachdb_cockroach_pkg_kv_storage_engine_enginepb.TxnPriority(r.Int31())
	if r.Intn(2) == 0 {
		this.Priority *= -1
	}
	if !easy && r.Intn(10) != 0 {
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Priority |= (github_com_cockroachdb_cockroach_pkg_kv_storage_engine_enginepb.TxnPriority(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 10:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ReadSeqNum |= (github_com_cockroachdb_cockroach_pkg_kv_storage_engine_enginepb.TxnSeq(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func init() { proto.RegisterFile("roachpb/data.proto", fileDescriptor_data_03419c6f4e5fb074) }

var fileDescriptor_data_03419c6f4e5fb074 = []byte{
	...
	,
}
