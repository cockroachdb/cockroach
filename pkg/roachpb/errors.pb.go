...
type RetryableTxnError struct {
	...
	//
	// When retrying, a client is not supposed to call Transaction.Restart() on
	// this transaction, and pass the fields below.
...
func (m *RetryableTxnError) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RetryTimestamp != nil {
		...
		n42, err := m.RetryTimestamp.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n42
...
var fileDescriptorErrors = []byte{
	...
	0x15, 0x17, 0x25, 0xd2, 0x14, 0x1f, 0x45, 0x91, 0xda, 0x28, 0x0a, 0xac, 0x36, 0x94, 0x82, 0xfc,
	...
	,
}
