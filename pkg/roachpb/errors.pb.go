...
// A StaleProposalError indicated that a Raft command cannot be applied because
// the lease under which it was proposed is different than the current lease at
// command application time. See comments on RaftCommand.origin_lease.
// These errors are generally retried at the DistSender level; it's OK to
// evaluate and propose this command again under a new lease.
type StaleProposalError struct {
	CurrentLease *Lease `protobuf:"bytes,1,opt,name=current_lease,json=currentLease" json:"current_lease,omitempty"`
	OriginLease  *Lease `protobuf:"bytes,2,opt,name=origin_lease,json=originLease" json:"origin_lease,omitempty"`
}

func (m *StaleProposalError) Reset()                    { *m = StaleProposalError{} }
func (m *StaleProposalError) String() string            { return proto.CompactTextString(m) }
func (*StaleProposalError) ProtoMessage()               {}
func (*StaleProposalError) Descriptor() ([]byte, []int) { return fileDescriptorErrors, []int{1} }
...
func (*NodeUnavailableError) Descriptor() ([]byte, []int) { return fileDescriptorErrors, []int{2} }
...
func (*RangeFrozenError) Descriptor() ([]byte, []int) { return fileDescriptorErrors, []int{5} }
...
func (*ReadWithinUncertaintyIntervalError) Descriptor() ([]byte, []int) {
	return fileDescriptorErrors, []int{6}
}
...
func (*TransactionAbortedError) Descriptor() ([]byte, []int) { return fileDescriptorErrors, []int{7} }
...
func (*TransactionPushError) Descriptor() ([]byte, []int) { return fileDescriptorErrors, []int{8} }
...
func (*TransactionRetryError) Descriptor() ([]byte, []int) { return fileDescriptorErrors, []int{9} }
...
func (*TransactionReplayError) Descriptor() ([]byte, []int) { return fileDescriptorErrors, []int{10} }
...
func (*TransactionStatusError) Descriptor() ([]byte, []int) { return fileDescriptorErrors, []int{11} }
...
type ErrorDetail struct {
	...
	StaleProposalError            *StaleProposalError                 `protobuf:"bytes,28,opt,name=stale_proposal_error,json=staleProposalError" json:"stale_proposal_error,omitempty"`
...
func init() {
	...
	proto.RegisterType((*StaleProposalError)(nil), "cockroach.roachpb.StaleProposalError")
...
func (m *StaleProposalError) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *StaleProposalError) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.CurrentLease != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintErrors(dAtA, i, uint64(m.CurrentLease.Size()))
		n4, err := m.CurrentLease.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n4
	...
	if m.OriginLease != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintErrors(dAtA, i, uint64(m.OriginLease.Size()))
		n5, err := m.OriginLease.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n5
...
func (m *ErrorDetail) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.StaleProposalError != nil {
		dAtA[i] = 0xe2
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintErrors(dAtA, i, uint64(m.StaleProposalError.Size()))
		n39, err := m.StaleProposalError.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n39
...
func (m *StaleProposalError) Size() (n int) {
	var l int
	_ = l
	if m.CurrentLease != nil {
...
func (this *ErrorDetail) GetValue() interface{} {
	...
	if this.StaleProposalError != nil {
		return this.StaleProposalError
	}
	return nil
}
...
func (this *ErrorDetail) SetValue(value interface{}) bool {
	...
	case *StaleProposalError:
		this.StaleProposalError = vt
	default:
		return false
	}
	return true
...
func (m *StaleProposalError) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: StaleProposalError: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: StaleProposalError: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ErrorDetail) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 28:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field StaleProposalError", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.StaleProposalError == nil {
				m.StaleProposalError = &StaleProposalError{}
			}
			if err := m.StaleProposalError.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorErrors = []byte{
	...
	,
}
