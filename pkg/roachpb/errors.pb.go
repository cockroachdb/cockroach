...
// A TxnAbortedAsyncErr indicates a batch response for a request sent through
...
type TxnAbortedAsyncErr struct {
}

func (m *TxnAbortedAsyncErr) Reset()                    { *m = TxnAbortedAsyncErr{} }
func (m *TxnAbortedAsyncErr) String() string            { return proto.CompactTextString(m) }
func (*TxnAbortedAsyncErr) ProtoMessage()               {}
func (*TxnAbortedAsyncErr) Descriptor() ([]byte, []int) { return fileDescriptorErrors, []int{24} }
...
type ErrorDetail struct {
	...
	TxnAbortedAsyncErr       *TxnAbortedAsyncErr       `protobuf:"bytes,30,opt,name=txn_aborted_async_err,json=txnAbortedAsyncErr" json:"txn_aborted_async_err,omitempty"`
}
...
func init() {
	...
	proto.RegisterType((*TxnAbortedAsyncErr)(nil), "cockroach.roachpb.TxnAbortedAsyncErr")
...
func (this *TxnAbortedAsyncErr) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*TxnAbortedAsyncErr)
	if !ok {
		that2, ok := that.(TxnAbortedAsyncErr)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *TxnAbortedAsyncErr) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *TxnAbortedAsyncErr) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *TxnAbortedAsyncErr) Size() (n int) {
	var l int
	_ = l
	return n
}
...
func (m *TxnAbortedAsyncErr) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TxnAbortedAsyncErr: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TxnAbortedAsyncErr: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *ErrorDetail) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 30:
			...
			if m.TxnAbortedAsyncErr == nil {
				m.TxnAbortedAsyncErr = &TxnAbortedAsyncErr{}
			}
...
var fileDescriptorErrors = []byte{
	...
	,
}
