...
// An InitialHeartBeatFailedError indicates that while attempting a GRPC
...
type InitialHeartBeatFailedError struct {
	// This can be set to give extra information about the connection failure.
	WrappedErr *Error `protobuf:"bytes,1,opt,name=wrapped_err,json=wrappedErr" json:"wrapped_err,omitempty"`
}

func (m *InitialHeartBeatFailedError) Reset()         { *m = InitialHeartBeatFailedError{} }
func (m *InitialHeartBeatFailedError) String() string { return proto.CompactTextString(m) }
func (*InitialHeartBeatFailedError) ProtoMessage()    {}
func (*InitialHeartBeatFailedError) Descriptor() ([]byte, []int) {
	return fileDescriptorErrors, []int{17}
}
...
func (*AmbiguousResultError) Descriptor() ([]byte, []int) { return fileDescriptorErrors, []int{18} }
...
func (*RaftGroupDeletedError) Descriptor() ([]byte, []int) { return fileDescriptorErrors, []int{19} }
...
func (*ReplicaCorruptionError) Descriptor() ([]byte, []int) { return fileDescriptorErrors, []int{20} }
...
func (*ReplicaTooOldError) Descriptor() ([]byte, []int) { return fileDescriptorErrors, []int{21} }
...
func (*StoreNotFoundError) Descriptor() ([]byte, []int) { return fileDescriptorErrors, []int{22} }
...
func (*UnhandledRetryableError) Descriptor() ([]byte, []int) { return fileDescriptorErrors, []int{23} }
...
func (*HandledRetryableTxnError) Descriptor() ([]byte, []int) { return fileDescriptorErrors, []int{24} }
...
func (*IntegerOverflowError) Descriptor() ([]byte, []int) { return fileDescriptorErrors, []int{27} }
...
func (*MixedSuccessError) Descriptor() ([]byte, []int) { return fileDescriptorErrors, []int{28} }
...
func (*BatchTimestampBeforeGCError) Descriptor() ([]byte, []int) {
	return fileDescriptorErrors, []int{29}
}
...
func (*IntentMissingError) Descriptor() ([]byte, []int) { return fileDescriptorErrors, []int{30} }
...
type ErrorDetail struct {
	...
	IntentMissing              *IntentMissingError              `protobuf:"bytes,36,opt,name=intent_missing,json=intentMissing" json:"intent_missing,omitempty"`
}

func (m *ErrorDetail) Reset()                    { *m = ErrorDetail{} }
func (m *ErrorDetail) String() string            { return proto.CompactTextString(m) }
func (*ErrorDetail) ProtoMessage()               {}
func (*ErrorDetail) Descriptor() ([]byte, []int) { return fileDescriptorErrors, []int{31} }
...
func (*ErrPosition) Descriptor() ([]byte, []int) { return fileDescriptorErrors, []int{32} }
...
func (*Error) Descriptor() ([]byte, []int) { return fileDescriptorErrors, []int{33} }
...
func init() {
	...
	proto.RegisterType((*InitialHeartBeatFailedError)(nil), "cockroach.roachpb.InitialHeartBeatFailedError")
...
func (this *InitialHeartBeatFailedError) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*InitialHeartBeatFailedError)
	if !ok {
		that2, ok := that.(InitialHeartBeatFailedError)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *InitialHeartBeatFailedError) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *InitialHeartBeatFailedError) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *MixedSuccessError) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Wrapped != nil {
		...
		n20, err := m.Wrapped.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n20
...
func (m *ErrorDetail) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TransactionReplay != nil {
		...
		n42, err := m.TransactionReplay.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n42
	...
	if m.HandledRetryableTxnError != nil {
		...
		n45, err := m.HandledRetryableTxnError.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n45
	...
	if m.TxnAbortedAsyncErr != nil {
		...
		n46, err := m.TxnAbortedAsyncErr.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n46
	...
	if m.IntegerOverflow != nil {
		...
		n47, err := m.IntegerOverflow.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n47
	...
	if m.UnsupportedRequest != nil {
		...
		n48, err := m.UnsupportedRequest.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n48
	...
	if m.MixedSuccess != nil {
		...
		n49, err := m.MixedSuccess.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n49
...
func (m *InitialHeartBeatFailedError) Size() (n int) {
	var l int
	_ = l
	if m.WrappedErr != nil {
		l = m.WrappedErr.Size()
...
func (this *ErrorDetail) GetValue() interface{} {
	...
	if this.IntentMissing != nil {
		return this.IntentMissing
	}
	return nil
}
...
func (m *InitialHeartBeatFailedError) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: InitialHeartBeatFailedError: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: InitialHeartBeatFailedError: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ErrorDetail) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 36:
			...
			if m.IntentMissing == nil {
				m.IntentMissing = &IntentMissingError{}
			}
			if err := m.IntentMissing.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorErrors = []byte{
	...
	,
}
