...
type ErrorDetail struct {
	...
	HandledRetryableError         *HandledRetryableError              `protobuf:"bytes,28,opt,name=handled_retryable_error,json=handledRetryableError" json:"handled_retryable_error,omitempty"`
...
type InternalRetryableTxnError struct {
	...
	RetryTimestamp *cockroach_util_hlc.Timestamp `protobuf:"bytes,5,opt,name=retry_timestamp,json=retryTimestamp" json:"retry_timestamp,omitempty"`
}

func (m *InternalRetryableTxnError) Reset()                    { *m = InternalRetryableTxnError{} }
func (m *InternalRetryableTxnError) String() string            { return proto.CompactTextString(m) }
func (*InternalRetryableTxnError) ProtoMessage()               {}
func (*InternalRetryableTxnError) Descriptor() ([]byte, []int) { return fileDescriptorErrors, []int{24} }
...
type HandledRetryableError struct {
	// A user-readable message.
	Msg string `protobuf:"bytes,1,opt,name=msg" json:"msg"`
	// The ID of the transaction being restarted. The client is supposed to check
	// this against the ID of its transaction and make sure the retryable error
...
func (m *HandledRetryableError) Reset()                    { *m = HandledRetryableError{} }
func (m *HandledRetryableError) String() string            { return proto.CompactTextString(m) }
func (*HandledRetryableError) ProtoMessage()               {}
func (*HandledRetryableError) Descriptor() ([]byte, []int) { return fileDescriptorErrors, []int{25} }
...
func init() {
	...
	proto.RegisterType((*InternalRetryableTxnError)(nil), "cockroach.roachpb.InternalRetryableTxnError")
	proto.RegisterType((*HandledRetryableError)(nil), "cockroach.roachpb.HandledRetryableError")
...
func (m *ErrorDetail) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.HandledRetryableError != nil {
		dAtA[i] = 0xe2
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintErrors(dAtA, i, uint64(m.HandledRetryableError.Size()))
		n36, err := m.HandledRetryableError.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n36
...
func (m *InternalRetryableTxnError) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *InternalRetryableTxnError) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.TxnID != nil {
		...
		n41, err := m.TxnID.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n41
	...
	if m.Transaction != nil {
		...
		n42, err := m.Transaction.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n42
	...
	if m.RetryTimestamp != nil {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintErrors(dAtA, i, uint64(m.RetryTimestamp.Size()))
		n43, err := m.RetryTimestamp.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n43
...
func (m *HandledRetryableError) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *HandledRetryableError) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.TxnID != nil {
		...
		i++
		i = encodeVarintErrors(dAtA, i, uint64(m.TxnID.Size()))
		n44, err := m.TxnID.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n44
	...
	if m.Transaction != nil {
		...
		i++
		i = encodeVarintErrors(dAtA, i, uint64(m.Transaction.Size()))
		n45, err := m.Transaction.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n45
...
func (m *ErrorDetail) Size() (n int) {
	...
	if m.HandledRetryableError != nil {
		l = m.HandledRetryableError.Size()
		n += 2 + l + sovErrors(uint64(l))
	}
	return n
}
...
func (m *InternalRetryableTxnError) Size() (n int) {
	var l int
	_ = l
	l = len(m.Msg)
	n += 1 + l + sovErrors(uint64(l))
	...
	if m.RetryTimestamp != nil {
		l = m.RetryTimestamp.Size()
		n += 1 + l + sovErrors(uint64(l))
	}
	return n
}

func (m *HandledRetryableError) Size() (n int) {
	var l int
	_ = l
	l = len(m.Msg)
	n += 1 + l + sovErrors(uint64(l))
...
func (this *ErrorDetail) GetValue() interface{} {
	...
	if this.HandledRetryableError != nil {
		return this.HandledRetryableError
	}
	return nil
}
...
func (this *ErrorDetail) SetValue(value interface{}) bool {
	...
	case *HandledRetryableError:
		this.HandledRetryableError = vt
	default:
		return false
	}
	return true
...
func (m *ErrorDetail) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 28:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field HandledRetryableError", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.HandledRetryableError == nil {
				m.HandledRetryableError = &HandledRetryableError{}
			}
			if err := m.HandledRetryableError.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *InternalRetryableTxnError) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: InternalRetryableTxnError: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: InternalRetryableTxnError: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RetryTimestamp", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.RetryTimestamp == nil {
				m.RetryTimestamp = &cockroach_util_hlc.Timestamp{}
			}
			if err := m.RetryTimestamp.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *HandledRetryableError) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: HandledRetryableError: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: HandledRetryableError: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorErrors = []byte{
	...
	,
}
