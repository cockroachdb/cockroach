...
// An AmbiguousCommitError is true to indicate that an EndTransaction
// request may have succeeded or failed, but the response was not
// received and the final result is ambiguous.
