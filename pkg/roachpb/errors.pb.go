...
type BoundsExceededError struct {
	...
	Overflow       bool  `protobuf:"varint,4,opt,name=overflow" json:"overflow"`
	MinValue       int64 `protobuf:"varint,5,opt,name=min_value,json=minValue" json:"min_value"`
	MaxValue       int64 `protobuf:"varint,6,opt,name=max_value,json=maxValue" json:"max_value"`
}

func (m *BoundsExceededError) Reset()                    { *m = BoundsExceededError{} }
func (m *BoundsExceededError) String() string            { return proto.CompactTextString(m) }
func (*BoundsExceededError) ProtoMessage()               {}
func (*BoundsExceededError) Descriptor() ([]byte, []int) { return fileDescriptorErrors, []int{25} }
...
type ErrorDetail struct {
	...
	BoundsExceeded           *BoundsExceededError      `protobuf:"bytes,31,opt,name=bounds_exceeded,json=boundsExceeded" json:"bounds_exceeded,omitempty"`
}

func (m *ErrorDetail) Reset()                    { *m = ErrorDetail{} }
func (m *ErrorDetail) String() string            { return proto.CompactTextString(m) }
func (*ErrorDetail) ProtoMessage()               {}
func (*ErrorDetail) Descriptor() ([]byte, []int) { return fileDescriptorErrors, []int{26} }
...
func (*ErrPosition) Descriptor() ([]byte, []int) { return fileDescriptorErrors, []int{27} }
...
func (*Error) Descriptor() ([]byte, []int) { return fileDescriptorErrors, []int{28} }
...
func init() {
	...
	proto.RegisterType((*BoundsExceededError)(nil), "cockroach.roachpb.BoundsExceededError")
...
func (this *BoundsExceededError) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*BoundsExceededError)
	if !ok {
		that2, ok := that.(BoundsExceededError)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.Overflow != that1.Overflow {
		return false
	}
...
func (this *ErrorDetail) Equal(that interface{}) bool {
	...
	if !this.BoundsExceeded.Equal(that1.BoundsExceeded) {
		return false
	}
	return true
}
...
func (m *BoundsExceededError) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *BoundsExceededError) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	dAtA[i] = 0x28
	i++
	i = encodeVarintErrors(dAtA, i, uint64(m.MinValue))
	dAtA[i] = 0x30
	i++
	i = encodeVarintErrors(dAtA, i, uint64(m.MaxValue))
	return i, nil
}
...
func (m *ErrorDetail) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.BoundsExceeded != nil {
		dAtA[i] = 0xfa
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintErrors(dAtA, i, uint64(m.BoundsExceeded.Size()))
		n42, err := m.BoundsExceeded.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n42
...
func (m *Error) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.UnexposedTxn != nil {
		...
		n43, err := m.UnexposedTxn.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n43
	...
	if m.Detail != nil {
		...
		n44, err := m.Detail.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n44
	...
	if m.Index != nil {
		...
		n45, err := m.Index.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n45
...
func (m *BoundsExceededError) Size() (n int) {
	var l int
	_ = l
	if m.Key != nil {
		l = len(m.Key)
	...
	n += 2
	n += 1 + sovErrors(uint64(m.MinValue))
	n += 1 + sovErrors(uint64(m.MaxValue))
	return n
}
...
func (this *ErrorDetail) SetValue(value interface{}) bool {
	...
	case *BoundsExceededError:
		this.BoundsExceeded = vt
	default:
		return false
	}
	return true
...
func (m *BoundsExceededError) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BoundsExceededError: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BoundsExceededError: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ErrorDetail) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 31:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BoundsExceeded", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.BoundsExceeded == nil {
				m.BoundsExceeded = &BoundsExceededError{}
			}
			if err := m.BoundsExceeded.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorErrors = []byte{
	...
	,
}
