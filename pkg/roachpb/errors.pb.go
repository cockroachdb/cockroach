...
type RefreshSpanError_Reason int32

const (
	RefreshSpanError_REASON_KEY    RefreshSpanError_Reason = 0
	RefreshSpanError_REASON_INTENT RefreshSpanError_Reason = 1
)

var RefreshSpanError_Reason_name = map[int32]string{
	0: "REASON_KEY",
	1: "REASON_INTENT",
}

var RefreshSpanError_Reason_value = map[string]int32{
	"REASON_KEY":    0,
	"REASON_INTENT": 1,
}

func (x RefreshSpanError_Reason) Enum() *RefreshSpanError_Reason {
	p := new(RefreshSpanError_Reason)
	*p = x
	return p
}

func (x RefreshSpanError_Reason) String() string {
	return proto.EnumName(RefreshSpanError_Reason_name, int32(x))
}

func (x *RefreshSpanError_Reason) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(RefreshSpanError_Reason_value, data, "RefreshSpanError_Reason")
	if err != nil {
		return err
	}
	*x = RefreshSpanError_Reason(value)
	return nil
}

func (RefreshSpanError_Reason) EnumDescriptor() ([]byte, []int) {
...
// A RefreshSpanError indicates that a refresh or a range refresh failed because
// of a recently written key or intent.
type RefreshSpanError struct {
	Reason RefreshSpanError_Reason `protobuf:"varint,1,opt,name=reason,enum=cockroach.kv.kvpb.RefreshSpanError_Reason" json:"reason"`
	Key    Key                     `protobuf:"bytes,2,opt,name=key,casttype=Key" json:"key,omitempty"`
	// The timestamp the key/intent was last updated.
	Timestamp hlc.Timestamp `protobuf:"bytes,3,opt,name=timestamp" json:"timestamp"`
}

func (m *RefreshSpanError) Reset()         { *m = RefreshSpanError{} }
func (m *RefreshSpanError) String() string { return proto.CompactTextString(m) }
func (*RefreshSpanError) ProtoMessage()    {}
func (*RefreshSpanError) Descriptor() ([]byte, []int) {
	return fileDescriptor_123941c6716fd549, []int{32}
}
func (m *RefreshSpanError) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RefreshSpanError) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *RefreshSpanError) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RefreshSpanError.Merge(m, src)
}
func (m *RefreshSpanError) XXX_Size() int {
	return m.Size()
}
func (m *RefreshSpanError) XXX_DiscardUnknown() {
	xxx_messageInfo_RefreshSpanError.DiscardUnknown(m)
}

var xxx_messageInfo_RefreshSpanError proto.InternalMessageInfo
...
type ErrorDetail_RefreshSpanError struct {
	RefreshSpanError *RefreshSpanError `protobuf:"bytes,43,opt,name=refresh_span_error,json=refreshSpanError,oneof" json:"refresh_span_error,omitempty"`
}
...
func (*ErrorDetail_RefreshSpanError) isErrorDetail_Value()                 {}
...
func (m *ErrorDetail) GetRefreshSpanError() *RefreshSpanError {
	if x, ok := m.GetValue().(*ErrorDetail_RefreshSpanError); ok {
		return x.RefreshSpanError
	}
	return nil
}
...
func (*ErrorDetail) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*ErrorDetail_RefreshSpanError)(nil),
	}
}
...
func init() {
	...
	proto.RegisterEnum("cockroach.kv.kvpb.RefreshSpanError_Reason", RefreshSpanError_Reason_name, RefreshSpanError_Reason_value)
	...
	proto.RegisterType((*RefreshSpanError)(nil), "cockroach.kv.kvpb.RefreshSpanError")
...
var fileDescriptor_123941c6716fd549 = []byte{
	...
	,
}
...
func (m *RefreshSpanError) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RefreshSpanError) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RefreshSpanError) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ErrorDetail_RefreshSpanError) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ErrorDetail_RefreshSpanError) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.RefreshSpanError != nil {
		{
			size, err := m.RefreshSpanError.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *RefreshSpanError) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ErrorDetail_RefreshSpanError) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RefreshSpanError) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RefreshSpanError: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RefreshSpanError: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Reason |= RefreshSpanError_Reason(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *ErrorDetail) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 43:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RefreshSpanError", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Value = &ErrorDetail_RefreshSpanError{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipErrors(dAtA[iNdEx:])
