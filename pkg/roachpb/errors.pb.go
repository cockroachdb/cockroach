...
// to move a transaction to a COMMITTED status, but that the transaction wanted
// to perform a commit-wait before committing and resolving intents. This error
// is used by transactions with commit triggers to ensure that their commit
// trigger does not fire and go into effect before the rest of the transaction's
// effects (i.e. its intent writes) will be visible upon resolution.
//
// This error is handled by the Store and should not escape to higher levels.
type CommitWaitBeforeIntentResolutionError struct {
	WaitUntil hlc.Timestamp `protobuf:"bytes,1,opt,name=wait_until,json=waitUntil" json:"wait_until"`
}

func (m *CommitWaitBeforeIntentResolutionError) Reset()         { *m = CommitWaitBeforeIntentResolutionError{} }
func (m *CommitWaitBeforeIntentResolutionError) String() string { return proto.CompactTextString(m) }
func (*CommitWaitBeforeIntentResolutionError) ProtoMessage()    {}
func (*CommitWaitBeforeIntentResolutionError) Descriptor() ([]byte, []int) {
	return fileDescriptor_123941c6716fd549, []int{30}
}
func (m *CommitWaitBeforeIntentResolutionError) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CommitWaitBeforeIntentResolutionError) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *CommitWaitBeforeIntentResolutionError) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CommitWaitBeforeIntentResolutionError.Merge(m, src)
}
func (m *CommitWaitBeforeIntentResolutionError) XXX_Size() int {
	return m.Size()
}
func (m *CommitWaitBeforeIntentResolutionError) XXX_DiscardUnknown() {
	xxx_messageInfo_CommitWaitBeforeIntentResolutionError.DiscardUnknown(m)
}

var xxx_messageInfo_CommitWaitBeforeIntentResolutionError proto.InternalMessageInfo
...
type ErrorDetail struct {
	...
	//	*ErrorDetail_CommitWaitBeforeIntentResolution
...
type ErrorDetail_CommitWaitBeforeIntentResolution struct {
	CommitWaitBeforeIntentResolution *CommitWaitBeforeIntentResolutionError `protobuf:"bytes,41,opt,name=commit_wait_before_intent_resolution,json=commitWaitBeforeIntentResolution,oneof" json:"commit_wait_before_intent_resolution,omitempty"`
}
...
func (*ErrorDetail_CommitWaitBeforeIntentResolution) isErrorDetail_Value() {}
...
func (m *ErrorDetail) GetCommitWaitBeforeIntentResolution() *CommitWaitBeforeIntentResolutionError {
	if x, ok := m.GetValue().(*ErrorDetail_CommitWaitBeforeIntentResolution); ok {
		return x.CommitWaitBeforeIntentResolution
	}
	return nil
}
...
func (*ErrorDetail) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*ErrorDetail_CommitWaitBeforeIntentResolution)(nil),
	}
}
...
func init() {
	...
	proto.RegisterType((*CommitWaitBeforeIntentResolutionError)(nil), "cockroach.kv.kvpb.CommitWaitBeforeIntentResolutionError")
...
var fileDescriptor_123941c6716fd549 = []byte{
	...
	,
}
...
func (m *CommitWaitBeforeIntentResolutionError) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CommitWaitBeforeIntentResolutionError) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CommitWaitBeforeIntentResolutionError) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ErrorDetail_CommitWaitBeforeIntentResolution) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ErrorDetail_CommitWaitBeforeIntentResolution) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.CommitWaitBeforeIntentResolution != nil {
		{
			size, err := m.CommitWaitBeforeIntentResolution.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *CommitWaitBeforeIntentResolutionError) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ErrorDetail_CommitWaitBeforeIntentResolution) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.CommitWaitBeforeIntentResolution != nil {
		l = m.CommitWaitBeforeIntentResolution.Size()
		n += 2 + l + sovErrors(uint64(l))
	}
	return n
}
...
func (m *CommitWaitBeforeIntentResolutionError) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CommitWaitBeforeIntentResolutionError: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CommitWaitBeforeIntentResolutionError: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ErrorDetail) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 41:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CommitWaitBeforeIntentResolution", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &CommitWaitBeforeIntentResolutionError{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Value = &ErrorDetail_CommitWaitBeforeIntentResolution{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipErrors(dAtA[iNdEx:])
