...
// IsExpiring returns true if this is an expiration-based lease.
func (l Lease) IsExpiring() bool {
	return l.Epoch == 0
}

// IsEpoch returns true if this is an epoch-based lease.
func (l Lease) IsEpoch() bool {
	return l.Epoch != 0
}
