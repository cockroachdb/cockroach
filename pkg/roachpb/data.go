...
func (t Transaction) String() string {
	...
	fmt.Fprintf(&buf, "{%s} rw=%t stat=%s orig=%s max=%s rts=%s wto=%t",
		t.TxnMeta.String(), t.IsWriting(), t.Status, t.OrigTimestamp, t.MaxTimestamp, t.RefreshedTimestamp, t.WriteTooOld)
