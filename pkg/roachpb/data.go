...
// Valid returns whether or not the span is a "valid span". A valid span
// must have a non-empty start key and satisfy either:
...
func (s Span) Valid() bool {
	...
	// s.Key is non-empty from this point.
