...
const (
	...
	// Barrier is a command that ensures all in-flight write operations on this range
	// before this command have finished by the time it returns. It does not block
	// new operations that started after this command's evaluation.
	Barrier
