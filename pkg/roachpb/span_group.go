...
// Encloses returns whether the provided Span is fully contained within
// the group of Spans in the SpanGroup.
func (g *SpanGroup) Encloses(span Span) bool {
	if g.rg == nil {
		return false
	}
	return g.rg.Encloses(s2r(span))
}
