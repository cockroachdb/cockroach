...
func TestAddClearChecksumMiddleware(t *testing.T) {
	...
	createMultipartInput := &s3svc.CreateMultipartUploadInput{ChecksumAlgorithm: types.ChecksumAlgorithmCrc32}
	completeMultipartInput := &s3svc.CompleteMultipartUploadInput{ChecksumType: types.ChecksumTypeFullObject}
	...
	for _, tc := range []struct {
		...
		{"CreateMultipartUploadInput", createMultipartInput},
		{"CompleteMultipartUploadInput", completeMultipartInput},
	} {
