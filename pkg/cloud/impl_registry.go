...
func makeLimiter(ctx context.Context, sv *settings.Values, s rateAndBurstSettings) *quotapool.RateLimiter {
...
func (l *limitWrapper) ReadFileAt(ctx context.Context, basename string, offset int64) (ioctx.ReadCloserCtx, int64, error) {
