...
func MakeExternalStorage(
	...
	return makeExternalStorage[ExternalStorageContext](ctx, dest, conf, limiters, metrics, args, getImpl, opts...)
}
...
func MakeEarlyBootExternalStorage(
	...
	return makeExternalStorage[EarlyBootExternalStorageContext](ctx, dest, conf, limiters, metrics, args, getImpl, opts...)
}
...
// makeExternalStorage creates an ExternalStorage from the given config.
func makeExternalStorage[T any](
	ctx context.Context,
	dest cloudpb.ExternalStorage,
	conf base.ExternalIODirConfig,
	limiters Limiters,
