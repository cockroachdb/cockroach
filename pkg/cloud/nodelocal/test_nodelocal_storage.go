...
// HijackNodeLocalForTesting replaces the implementation of of
// nodelocal with one reads and writes directly from the given
// directory.
func HijackNodeLocalForTesting(root string) func() {
	...
	return cloud.HijackProviderForTesting(cloudpb.ExternalStorageProvider_nodelocal, cloud.RegisteredProvider{
