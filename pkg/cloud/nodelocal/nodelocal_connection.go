...
func (l *localFileConnectionDetails) Dial(
	...
	externalStorageConf := roachpb.ExternalStorage{
...
func init() {
	scheme := "nodelocal"
	externalconn.RegisterConnectionDetailsFromURIFactory(connectionpb.ConnectionProvider_nodelocal,
		scheme, parseLocalFileConnectionURI, makeLocalFileConnectionDetails)
}
