...
func TestPutUserFileTable(t *testing.T) {
	...
	t.Run("empty-qualified-table-name", func(t *testing.T) {
		...
		cloudtestutils.CheckListFilesCanonical(t, "userfile:///listing-test/basepath", "userfile://defaultdb.public.userfiles_root/listing-test/basepath", username.RootUserName(), ie, cf, kvDB, testSettings)
	})
