...
) (roachpb.ExternalConnectionConfig, error) {
	externalConnCfg := roachpb.ExternalConnectionConfig{}
	if uri.Host == "" {
...
func parseExternalConnectionURL(
	...
	conf.Provider = roachpb.ExternalStorageProvider_external
	var err error
...
func init() {
	scheme := "external"
	cloud.RegisterExternalStorageProvider(roachpb.ExternalStorageProvider_external, parseExternalConnectionURL,
