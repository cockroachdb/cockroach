...
type connectionParserFactory func(ctx context.Context, uri *url.URL) (connectionpb.ConnectionDetails, error)
...
// Connection object.
type connectionDetailsFactory func(ctx context.Context, details connectionpb.ConnectionDetails) ConnectionDetails
