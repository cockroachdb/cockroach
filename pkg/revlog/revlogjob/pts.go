...
func (p *ptsManager) install(ctx context.Context) error {
	//lint:ignore SA1019 PTS UUID lives on BackupDetails so the existing BACKUP OnFailOrCancel can release it; migrating to InfoStorage requires duplicating that teardown.
