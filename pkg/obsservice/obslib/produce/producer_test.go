...
func TestProducerGroup_Consume(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			validators: []validate.Validator{&TestValidator{}, &TestValidator{}}, // Empty TestValidators will succeed
			producers:  []EventProducer{&TestProducer{}, &TestProducer{}},        // Empty TestProducers will succeed
		},
		{
			...
			validators: []validate.Validator{&TestValidator{}},
			producers:  []EventProducer{&TestProducer{}},
			wantErr:    true,
...
func (t *TestProducer) Produce(_ interface{}) error {
	t.called = true
	return t.retErr
}

var _ EventProducer = (*TestProducer)(nil)
...
var _ validate.Validator = (*TestValidator)(nil)

func (t *TestValidator) Validate(_ interface{}) error {
	t.called = true
	return t.retErr
}
...
var _ transform.EventTransformer = (*TestTransformer)(nil)

func (t *TestTransformer) Transform(_ *obspb.Event) (interface{}, error) {
	t.called = true
	if t.toReturn != nil {
