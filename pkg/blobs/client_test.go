...
func TestBlobClientFetch(t *testing.T) {
...
func TestBlobClientSend(t *testing.T) {
	defer leaktest.AfterTest(t)()
	...
	for _, tc := range []struct {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			err := blobService.Send(ctx, tc.nodeID, tc.filename, bytes.NewReader(byteContent))
			if err != nil {
				t.Fatal(err)
			}
...
func TestBlobClientFetchList(t *testing.T) {
	defer leaktest.AfterTest(t)()
...
func TestBlobClientDeleteFrom(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		t.Run(tc.name, func(t *testing.T) {
			ctx := context.TODO()
			err := blobService.DeleteFrom(ctx, tc.nodeID, tc.filename)
			if err != nil {
...
func TestBlobClientFetchSize(t *testing.T) {
	defer leaktest.AfterTest(t)()
	...
	for _, tc := range []struct {
		...
		t.Run(tc.name, func(t *testing.T) {
			ctx := context.TODO()
			resp, err := blobService.FetchSize(ctx, tc.nodeID, tc.filename)
			if err != nil {
				if tc.err != "" && strings.Contains(err.Error(), tc.err) {
					// the correct error was returned
					return
