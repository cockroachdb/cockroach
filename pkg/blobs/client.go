...
func (c *remoteClient) ReadFile(
	...
	// Use flow-controlled streaming if version gate is active.
	if c.settings != nil &&
		c.settings.Version.IsActive(ctx, clusterversion.V26_2_BlobServiceFlowControl) {
...
//
// settings is used to check the cluster version gate for flow-controlled
// streaming. If nil, the legacy streaming API is used.
