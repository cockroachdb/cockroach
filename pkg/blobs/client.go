...
func (c *remoteClient) ReadFile(ctx context.Context, file string, offset int64) (io.ReadCloser, int64, error) {
...
func (c *localClient) ReadFile(ctx context.Context, file string, offset int64) (io.ReadCloser, int64, error) {
