...
// closeFuncSendAndClose creates a GetStreamClient that has a nop SendAndClose function.
...
func newGetStreamReader(close func(), client blobspb.Blob_GetStreamClient) ioctx.ReadCloserCtx {
