...
var _ cloudbase.ReadCloserCtx = &blobStreamReader{}
...
func newGetStreamReader(client blobspb.Blob_GetStreamClient) cloudbase.ReadCloserCtx {
...
// to read chunks of data.
func newPutStreamReader(client blobspb.Blob_PutStreamServer) cloudbase.ReadCloserCtx {
...
func streamContent(ctx context.Context, sender streamSender, content cloudbase.ReaderCtx) error {
