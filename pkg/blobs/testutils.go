...
func TestBlobServiceClient(externalIODir string) BlobClientFactory {
	return func(dialing roachpb.NodeID) (BlobClient, error) { return newLocalClient(externalIODir) }
}

// TestEmptyBlobClientFactory can be used as a mock BlobClient
// in tests that create ExternalStorage but do not use
// nodelocal storage
var TestEmptyBlobClientFactory = func(dialing roachpb.NodeID) (BlobClient, error) { return nil, nil }
