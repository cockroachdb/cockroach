...
func init() {
	proto.RegisterFile("testutils/grpcutils/testservice.proto", fileDescriptor_testservice_e326d78c9e5539cb)
}

var fileDescriptor_testservice_e326d78c9e5539cb = []byte{
