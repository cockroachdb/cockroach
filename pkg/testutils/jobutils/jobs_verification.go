...
func VerifyRunningSystemJob(
	...
	if expectedRunningStatus != jobs.RunningStatusGeneral {
		expectedStatus += " (" + string(expectedRunningStatus) + ")"
	}
	return verifySystemJob(t, db, offset, expectedType, expectedStatus, expected)
}
