...
func StartServerOnlyE(t TestLogger, params base.TestServerArgs) (TestServerInterface, error) {
	...
	params.DefaultDRPCOption = ResolveTestDRPCOption(ctx, t, params.DefaultDRPCOption)
...
// ResolveTestDRPCOption determines the final DRPC option based on the input
// option and any global overrides, resolving random choices to a concrete
// enabled/disabled state.
func ResolveTestDRPCOption(
