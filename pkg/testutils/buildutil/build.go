...
var Default = func() build.Context {
	...
	// future version of Go, but suffices until we move to using go modules. See
	// go/build.Context.importGo
	// (https://github.com/golang/go/blob/master/src/go/build/build.go#L999) and
	// the logic to skip using `go list` if a Context.JoinPath is non-nil. Note
	// that the behavior for a non-nil Context.JoinPath mimics the behavior for
