...
// VerifyZoneConfig verifies that the specified zone matches the specified
// ZoneRow.
func VerifyZoneConfig(sqlDB *SQLRunner, target string, row ZoneRow) {
	sqlDB.Helper()
...
// VerifyZoneConfigs verifies that the specified ZoneRows appear in the list of
// active zone configs.
func VerifyZoneConfigs(sqlDB *SQLRunner, rows ...ZoneRow) {
	sqlDB.Helper()
