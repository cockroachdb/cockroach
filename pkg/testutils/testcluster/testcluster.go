...
func (tc *TestCluster) CrashNode(idx int) {
	...
	// undo is needed.
	//
	// This step is first because we want to prevent any message sent after
	// the CrashClone of the VFS. Otherwise it would be able to leak false
	// durability signal into the cluster, such as with raft messages like
