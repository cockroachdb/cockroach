...
// All modifications are Copyright 20\d\d Cockroach Labs, Inc.`)
	...
	t.Run("TestTODOTestTenantDisabled", func(t *testing.T) {
		...
		cmd, stderr, filter, err := dirCmd(
			...
			":!ccl/streamingccl/physical/replication_random_client_test.go",
			":!ccl/streamingccl/physical/stream_ingestion_job_test.go",
			":!ccl/streamingccl/physical/stream_ingestion_processor_test.go",
			":!ccl/streamingccl/producer/producer_job_test.go",
			":!ccl/streamingccl/producer/replication_stream_test.go",
