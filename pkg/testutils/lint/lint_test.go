...
`)
	...
	// this linter nudges folks to do so.
	// TODO(yuzefovich): expand the scope where the linter is applied. Also
	// introduce a way to ignore the linter where bool map value is actually
	// needed.
