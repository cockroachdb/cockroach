...
var requireConstFmt = map[string]bool{
	...
	"github.com/cockroachdb/cockroach/pkg/kv/kvserver/kvserverbase.MakeNonDeterministicFailuref":     true,
	"github.com/cockroachdb/cockroach/pkg/kv/kvserver/kvserverbase.WrapWithNonDeterministicFailuref": true,
