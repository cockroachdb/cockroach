...
func TestMaybeAggregateBoundaries(t *testing.T) {
	{
		...
		combined := maybeAggregateBoundaries(boundaries, 10 /* max */)
	...
	}
	{
		...
		boundaries := makeBoundaries(10)
		combined := maybeAggregateBoundaries(boundaries, 9 /* max */)
	...
	}
	{
		...
		combined := maybeAggregateBoundaries(boundaries, 1 /* max */)
