...
type SpanStatsCollector interface {
	...
	// Start starts the rangefeed watcher. The watcher watches for spans that a tenant
	// wishes to have request statistics collected for.
	// An error is returned if the watcher is not started successfully.
