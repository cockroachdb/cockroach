...
// DeleteSamplesOlderThanUnixTime deletes collected samples that were taken before `seconds`.
func DeleteSamplesOlderThanUnixTime(
	ctx context.Context, ie *sql.InternalExecutor, seconds int64,
) error {
