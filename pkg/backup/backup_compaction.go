...
func StartCompactionJob(
	...
	details := jobspb.BackupDetails{
		CompactionDetails: &jobspb.BackupDetails_CompactionDetails{
			StartTime: start,
			EndTime:   end,
	...
	description, err := compactionJobDescription(*details.CompactionDetails)
	if err != nil {
		return 0, err
	}
...
func compactBackups(
	...
	details jobspb.BackupDetails_CompactionDetails,
) error {
...
func compactionJobDescription(details jobspb.BackupDetails_CompactionDetails) (string, error) {
