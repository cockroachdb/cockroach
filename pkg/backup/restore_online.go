...
func sendAdminScatter(
	...
	// maxSize of 1 here. The link phase should only ever be scattering non-empty
	// ranges, but since the link phase can retry, we may end up attempting to
	// scatter a range that contains external SSTs. If a scatter request fails
