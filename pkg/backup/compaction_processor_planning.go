...
//
// TODO (kev-cao): This currently distributes the spans so that each node gets
// roughly the same number of entries. This could be further improved to take
// into consideration the size of the spans.
