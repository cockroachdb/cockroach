...
func TestListIndexesSkipsInvalidFiles(t *testing.T) {
	defer leaktest.AfterTest(t)()
	defer log.Scope(t).Close(t)
	...
	// Invalid file 1: looks like an index file but ends in _metadata.pb123.tmp
	...
	// Invalid file 2: has the right suffix but invalid timestamp format.
	...
	// ListIndexes should only return the 3 valid index files.
