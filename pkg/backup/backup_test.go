...
func TestBackupRestoreSystemUsers(t *testing.T) {
	...
	t.Run("system users", func(t *testing.T) {
		...
		sqlDBRestore.CheckQueryResults(t, "SELECT username, options, member_of from [SHOW USERS]", [][]string{
			{"admin", "{}", "{}"},
			{"app", "{}", "{admin,app_role}"},
			{"app_role", "{NOLOGIN}", "{}"},
			{"root", "{}", "{admin}"},
	...
	t.Run("restore-from-backup-with-no-system-role-members", func(t *testing.T) {
		...
		sqlDBRestore1.CheckQueryResults(t, "SELECT username, options, member_of from [SHOW USERS]", [][]string{
			{"admin", "{}", "{}"},
			{"app", "{}", "{}"},
			{"app_role", "{}", "{}"},
			{"root", "{}", "{admin}"},
	...
	t.Run("restore-from-backup-with-existing-user", func(t *testing.T) {
		...
		sqlDBRestore2.CheckQueryResults(t, "SELECT username, options, member_of from [SHOW USERS]", [][]string{
			{"admin", "{}", "{}"},
			{"app", "{}", "{}"},
			{"app_role", "{}", "{}"},
			{"root", "{}", "{admin}"},
