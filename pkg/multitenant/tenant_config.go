...
var DefaultTenantSelect = func() *settings.StringSetting {
	...
	s.SetName(DefaultClusterSelectSettingName)
	return s
}()
...
var VerifyTenantService = func() *settings.BoolSetting {
	...
	s.SetName(DefaultClusterSelectSettingName + ".check_service.enabled")
	return s
}()
