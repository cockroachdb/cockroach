...
var reqTypeToCap = map[reflect.Type]tenantcapabilities.CapabilityID{
	...
	reflect.TypeOf((*kvpb.LeaseInfoRequest)(nil)):          noCapCheckNeeded,
	...
	reflect.TypeOf((*kvpb.RangeStatsRequest)(nil)):         noCapCheckNeeded,
	...
	reflect.TypeOf((*kvpb.AdminSplitRequest)(nil)): tenantcapabilities.CanAdminSplit,

	// TODO(ecwall): The following should also be authorized via specific capabilities.
	reflect.TypeOf((*kvpb.AdminChangeReplicasRequest)(nil)): noCapCheckNeeded,
	reflect.TypeOf((*kvpb.AdminMergeRequest)(nil)):          noCapCheckNeeded,
	reflect.TypeOf((*kvpb.AdminRelocateRangeRequest)(nil)):  noCapCheckNeeded,
	reflect.TypeOf((*kvpb.AdminScatterRequest)(nil)):        noCapCheckNeeded,
	reflect.TypeOf((*kvpb.AdminTransferLeaseRequest)(nil)):  noCapCheckNeeded,
	reflect.TypeOf((*kvpb.AdminUnsplitRequest)(nil)):        noCapCheckNeeded,
...
const noCapCheckNeeded = tenantcapabilities.LastCapabilityID + 1
const onlySystemTenant = tenantcapabilities.LastCapabilityID + 2
