...
type TypedCapability[T any] interface {
	Capability
	Get(*tenantcapabilitiespb.TenantCapabilities) TypedValue[T]
}
...
func (b boolCapability) Get(t *tenantcapabilitiespb.TenantCapabilities) BoolValue {
...
func (b spanConfigBoundsCapability) Get(
