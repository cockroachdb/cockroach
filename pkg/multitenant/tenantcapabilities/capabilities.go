...
// TestingAlteredCapabilitiesString prints all altered capability values that no
// longer match DefaultCapabilities. This is different from
// TenantCapabilities.String which only prints non-zero value fields.
func TestingAlteredCapabilitiesString(capabilities TenantCapabilities) string {
...
const MinCapabilityID CapabilityID = 1
