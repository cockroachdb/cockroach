...
func init() {
	if runtime.GOOS == "windows" {
		// File modes are not implemented on windows and default to 0666 for r/w files:
		...
		skipPermissionChecks = envutil.EnvOrDefaultBool("COCKROACH_SKIP_KEY_PERMISSION_CHECK", true)
	}
}
