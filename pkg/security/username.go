...
// ErrUsernameTooLong is a sentinel error that indicates that a
// username string was too long. It is returned by
// ValidateForCreation() or MakeSQLUserFromUserInput() with purpose
// UsernameCreation.
var ErrUsernameTooLong = errors.WithHint(errors.New("username is too long"), usernameHelp)

// ErrUsernameInvalid is a sentinel error that indicates that a
// username string contained invalid characters. It is returned by
// ValidateForCreation() or MakeSQLUserFromUserInput() with purpose
// UsernameCreation.
var ErrUsernameInvalid = errors.WithHint(errors.New("username is invalid"), usernameHelp)

// MakeSQLUsernameFromPreNormalizedString takes a string containing
...
func (s SQLUsername) SQLIdentifier() string {
	...
	lex.EncodeRestrictedSQLIdent(&buf, s.u, lex.EncNoFlags)
	return buf.String()
}
...
// legitimate form.
func (u SQLUsernameProto) Decode() SQLUsername { return SQLUsername{u: string(u)} }
