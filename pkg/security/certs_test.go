...
func TestUseCerts(t *testing.T) {
	...
	sCtx := rpc.NewSecurityContext(clientContext, security.CommandTLSSettings{}, roachpb.SystemTenantID)
...
func TestUseWrongSplitCACerts(t *testing.T) {
	...
	clientContext.SSLCertsDir = certsDir
	{
		secondCtx := rpc.NewSecurityContext(clientContext, security.CommandTLSSettings{}, roachpb.SystemTenantID)
