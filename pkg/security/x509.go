...
func newTemplate(
	commonName string, orgUnits []string, lifetime time.Duration,
...
func GenerateServerCert(
	...
	template, err := newTemplate(user, nil, lifetime)
	if err != nil {
		return nil, err
	}
...
func GenerateTenantClientCert(
	...
	// Create template for user.
	template, err := newTemplate(fmt.Sprintf("%d", tenantId), []string{tenantsOU}, lifetime)
	if err != nil {
		return nil, err
	}
