...
const (
	...
	tenantURISANFormatString = "crdb://tenant/%d"
...
func GenerateClientCert(
	...
	urls, err := MakeTenantURISANs(tenantIDs)
	if err != nil {
		return nil, err
	}
...
func MakeTenantURISANs(tenantIDs []roachpb.TenantID) (urls []*url.URL, _ error) {
	for _, tenantID := range tenantIDs {
		url, err := url.Parse(fmt.Sprintf(tenantURISANFormatString, tenantID.ToUint64()))
		if err != nil {
			return urls, err
		}
