...
func LoadServerTLSConfig(
	settings TLSSettings, sslCA, sslClientCA, sslCert, sslCertKey string,
) (*tls.Config, error) {
	...
	return newServerTLSConfig(settings, certPEM, keyPEM, caPEM, clientCAPEM)
}
...
func newServerTLSConfig(
	settings TLSSettings, certPEM, keyPEM, caPEM, caClientPEM []byte,
) (*tls.Config, error) {
...
func LoadClientTLSConfig(
	settings TLSSettings, sslCA, sslCert, sslCertKey string,
) (*tls.Config, error) {
	certPEM, err := assetLoaderImpl.ReadFile(sslCert)
	if err != nil {
		return nil, err
	...
	return newClientTLSConfig(settings, certPEM, keyPEM, caPEM)
}
