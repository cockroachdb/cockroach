...
func test_certsNodeCrt() (*asset, error) {
	...
	info := bindataFileInfo{name: "test_certs/node.crt", size: 1192, mode: os.FileMode(420), modTime: time.Unix(1400000000, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
