...
func (cd CertsLocator) CACertPath() string {
	return filepath.Join(cd.certsDir, CACertFilename())
}
...
// CA certificate.
func (cd CertsLocator) TenantServerCACertPath() string {
	return filepath.Join(cd.certsDir, TenantServerCACertFilename())
}
...
// certificate.
func (cd CertsLocator) TenantClientCACertPath() string {
	return filepath.Join(cd.certsDir, TenantClientCACertFilename())
}
...
func (cd CertsLocator) ClientCACertPath() string {
	return filepath.Join(cd.certsDir, "ca-client"+certExtension)
}

// UICACertPath returns the expected file path for the CA certificate
// used to verify Admin UI certificates.
func (cd CertsLocator) UICACertPath() string {
	return filepath.Join(cd.certsDir, "ca-ui"+certExtension)
}

// NodeCertPath returns the expected file path for the node certificate.
func (cd CertsLocator) NodeCertPath() string {
	return filepath.Join(cd.certsDir, NodeCertFilename())
}
...
func (cd CertsLocator) NodeKeyPath() string {
	return filepath.Join(cd.certsDir, NodeKeyFilename())
}
...
// certificate.
func (cd CertsLocator) TenantServerCertPath() string {
	return filepath.Join(cd.certsDir, TenantServerCertFilename())
}
...
func (cd CertsLocator) TenantServerKeyPath() string {
	return filepath.Join(cd.certsDir, TenantServerKeyFilename())
}
...
func (cd CertsLocator) UICertPath() string {
	return filepath.Join(cd.certsDir, "ui"+certExtension)
}

// UIKeyPath returns the expected file path for the UI key.
func (cd CertsLocator) UIKeyPath() string {
	return filepath.Join(cd.certsDir, "ui"+keyExtension)
}

// TenantClientCertPath returns the expected file path for the user's certificate.
func (cd CertsLocator) TenantClientCertPath(tenantIdentifier string) string {
	return filepath.Join(cd.certsDir, TenantClientCertFilename(tenantIdentifier))
}
...
func (cd CertsLocator) TenantClientKeyPath(tenantIdentifier string) string {
	return filepath.Join(cd.certsDir, TenantClientKeyFilename(tenantIdentifier))
}
...
func (cd CertsLocator) ClientCertPath(user string) string {
	return filepath.Join(cd.certsDir, ClientCertFilename(user))
}
...
func (cd CertsLocator) ClientKeyPath(user string) string {
	return filepath.Join(cd.certsDir, ClientKeyFilename(user))
}
