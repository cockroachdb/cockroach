...
var (
	...
	// LocalDummyRangeKeySuffix is the suffix for keys that are never written to.
	// They're useful for reading, though, for example as a way to force a lease
	// acquisition.
	LocalDummyRangeKeySuffix = roachpb.RKey("dumy")
