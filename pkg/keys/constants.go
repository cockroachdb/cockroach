...
var (
	...
	// PredefinedDataMax is the end key of user-level database objects that
	// are created initially in empty clusters (default databases).
	PredefinedUserTableDataMax = roachpb.Key(MakeTablePrefix(MinNonPredefinedUserDescID))
