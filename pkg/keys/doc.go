...
// also logically separated so that they do not pollute the user key space. This
// is further elaborated on in the "Key Addressing" section below.
// Local data also includes data "local" to a node, such as the store metadata
// and the raft log, which is where the name originated.
//
