...
func TestPrettyPrint(t *testing.T) {
	...
	ten5KeyGen := keys.MakeTenantIDKeyGen(roachpb.MakeTenantID(5))
...
func TestPrettyPrintRange(t *testing.T) {
	...
	key := makeKey([]byte("a"))
	key2 := makeKey([]byte("z"))
	tableKey := makeKey(tenSysKeyGen.TablePrefix(61), encoding.EncodeVarintAscending(nil, 4))
	tableKey2 := makeKey(tenSysKeyGen.TablePrefix(61), encoding.EncodeVarintAscending(nil, 500))
	tenTableKey := makeKey(ten5KeyGen.TablePrefix(61), encoding.EncodeVarintAscending(nil, 999))
