...
func TestPrettyPrint(t *testing.T) {
	...
	testCases := []struct {
		...
		{keys.MakeRangeKeyPrefix(roachpb.RKey(keys.SystemTenantKeyGen.TablePrefix(42))), `/Local/Range/Table/42`, revertSupportUnknown},
		{keys.RangeDescriptorKey(roachpb.RKey(keys.SystemTenantKeyGen.TablePrefix(42))), `/Local/Range/Table/42/RangeDescriptor`, revertSupportUnknown},
		{keys.TransactionKey(keys.SystemTenantKeyGen.TablePrefix(42), txnID), fmt.Sprintf(`/Local/Range/Table/42/Transaction/%q`, txnID), revertSupportUnknown},
		{keys.QueueLastProcessedKey(roachpb.RKey(keys.SystemTenantKeyGen.TablePrefix(42)), "foo"), `/Local/Range/Table/42/QueueLastProcessed/"foo"`, revertSupportUnknown},
		...
		// key of key
		{keys.RangeMetaKey(roachpb.RKey(keys.MakeRangeKeyPrefix(roachpb.RKey(keys.SystemTenantKeyGen.TablePrefix(42))))).AsRawKey(), `/Meta2/Local/Range/Table/42`, revertSupportUnknown},
		{keys.RangeMetaKey(roachpb.RKey(makeKey(keys.SystemTenantKeyGen.TablePrefix(42), roachpb.RKey("foo")))).AsRawKey(), `/Meta2/Table/42/"foo"`, revertSupportUnknown},
		...
		{keys.SystemTenantKeyGen.TablePrefix(111), "/Table/111", revertMustSupport},
		{makeKey(keys.SystemTenantKeyGen.TablePrefix(42), encoding.EncodeUvarintAscending(nil, 1)), `/Table/42/1`, revertMustSupport},
		{makeKey(keys.SystemTenantKeyGen.TablePrefix(42), roachpb.RKey("foo")), `/Table/42/"foo"`, revertSupportUnknown},
		{makeKey(keys.SystemTenantKeyGen.TablePrefix(42),
		...
		{roachpb.Key(makeKey(keys.SystemTenantKeyGen.TablePrefix(42),
		...
		// sequence
		{keys.SystemTenantKeyGen.SequenceKey(55), `/Table/55/1/0/0`, revertSupportUnknown},
		...
		{makeKey(keys.SystemTenantKeyGen.TablePrefix(42), roachpb.RKey([]byte{0xf6})), `/Table/42/109/PrefixEnd`, revertSupportUnknown},
		{makeKey(keys.SystemTenantKeyGen.TablePrefix(42), roachpb.RKey([]byte{0xf7})), `/Table/42/255/PrefixEnd`, revertSupportUnknown},
		{makeKey(keys.SystemTenantKeyGen.TablePrefix(42), roachpb.RKey([]byte{0x12, 'a', 0x00, 0x02})), `/Table/42/"a"/PrefixEnd`, revertSupportUnknown},
		{makeKey(keys.SystemTenantKeyGen.TablePrefix(42), roachpb.RKey([]byte{0x12, 'a', 0x00, 0x03})), `/Table/42/???`, revertSupportUnknown},
	}
