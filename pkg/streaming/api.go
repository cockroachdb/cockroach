...
var GetReplicationStreamManagerHook func(ctx context.Context, evalCtx *eval.Context, txn *kv.Txn, ie sqlutil.InternalExecutor) (eval.ReplicationStreamManager, error)

// GetStreamIngestManagerHook is the hook to get access to the ingestion side replication APIs.
// Used by builtin functions to trigger streaming replication.
var GetStreamIngestManagerHook func(ctx context.Context, evalCtx *eval.Context, txn *kv.Txn, ie sqlutil.InternalExecutor) (eval.StreamIngestManager, error)
...
func GetReplicationStreamManager(
	...
	return GetReplicationStreamManagerHook(ctx, evalCtx, txn, ie)
}
...
func GetStreamIngestManager(
	...
	return GetStreamIngestManagerHook(ctx, evalCtx, txn, ie)
}
