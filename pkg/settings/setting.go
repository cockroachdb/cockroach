...
type Setting interface {
	...
	// TenantConfigurable indicates if a setting can be set by any
	// non-system tenant for non-root users.
	TenantConfigurable() bool
}
...
func (i common) TenantConfigurable() bool {
	return i.tenantConfigurable
}
...
// SetTenantConfigurable controls whether the non-system tenant can
// configure this.
func (i *common) SetTenantConfigurable(b bool) {
	i.tenantConfigurable = b
}

// Fool the unused linter.
var _ = (*common).SetTenantConfigurable
