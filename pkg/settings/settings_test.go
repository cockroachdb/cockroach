...
func TestCache(t *testing.T) {
	...
	t.Run("an invalid update to a given setting preserves its previously set value", func(t *testing.T) {
		...
		// Doing after attempting to set with wrong type preserves the current
		// value.
		{
			u := settings.NewUpdater(sv)
		...
		// Doing after attempting to set with the wrong type preserves the
		// current value.
		{
			u := settings.NewUpdater(sv)
		...
		// Doing after attempting to set with invalid value preserves the
		// current value.
