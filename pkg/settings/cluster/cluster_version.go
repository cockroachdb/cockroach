...
// 1.1.2 can't coordinate the switch over to 1.0.4. Such clusters would need to
// be wiped. As a result, we recommend not bumping to a new minor version until
// the prior 1.X.0 release has been performed.
var (
