...
func (*ClusterVersion) Descriptor() ([]byte, []int) {
	return fileDescriptor_cluster_version_de4d25b8e1e07bad, []int{0}
}
...
func init() {
	proto.RegisterFile("settings/cluster/cluster_version.proto", fileDescriptor_cluster_version_de4d25b8e1e07bad)
}

var fileDescriptor_cluster_version_de4d25b8e1e07bad = []byte{
