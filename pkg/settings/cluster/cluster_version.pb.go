...
type ClusterVersion struct {
	...
	MinimumVersion roachpb.Version `protobuf:"bytes,1,opt,name=minimum_version,json=minimumVersion,proto3" json:"minimum_version"`
...
func (*ClusterVersion) Descriptor() ([]byte, []int) {
	return fileDescriptor_cluster_version_0ae72bf8da5cffa7, []int{0}
}
...
func init() {
	proto.RegisterFile("settings/cluster/cluster_version.proto", fileDescriptor_cluster_version_0ae72bf8da5cffa7)
}

var fileDescriptor_cluster_version_0ae72bf8da5cffa7 = []byte{
