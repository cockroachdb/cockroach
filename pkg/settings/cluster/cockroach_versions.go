...
// Versions lists all historical versions here in chronological order, with
...
// where the PATCH and UNSTABLE components can be omitted if zero.
//
// Keep in mind that a version with an unstable component, like 1.1-2,
// represents a version that was developed AFTER v1.1 was released and is not
// slated for release until the next stable version (either 1.2-0 or 2.0-0).
// Patch releases, like 1.1.2, do not have associated migrations.
//
...
var versionsSingleton = keyedVersions([]keyedVersion{
	...
	{
		// Version1_1 is CockroachDB v1.1. It remains unchanged for all v1.1.x
		// releases unless we need to introduce a new migration.
		Key:     Version1_1,
