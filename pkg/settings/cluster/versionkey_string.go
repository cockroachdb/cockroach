...
func _() {
	...
	_ = x[VersionHashShardedIndexes-24]
}

const _VersionKey_name = "Version19_1VersionStart19__2VersionStart20_"

var _VersionKey_index = [...]uint16{0, 11, 27, 51, 67, 89, 116, 138, 164, 198, 225, 265, 289, 300, 316, 347, 376, 411, 443, 469, 493, 530, 569, 588, 613}
