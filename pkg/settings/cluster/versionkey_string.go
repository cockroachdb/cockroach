...
func _() {
	...
	_ = x[VersionLearnerReplicas-17]
}

const _VersionKey_name = "Version2__1VersionStart19_2VersionQueryTxnTimestampVersionStickyBitVersionParallelCommitsVersionLearnerReplicas"

var _VersionKey_index = [...]uint16{0, 10, 37, 54, 82, 102, 123, 160, 178, 197, 232, 257, 283, 294, 310, 334, 350, 372, 394}
