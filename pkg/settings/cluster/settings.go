...
// TestingClusterVersion is an ExposedClusterVersion to use in tests.
var TestingClusterVersion = BinaryServerVersion

// MakeTestingClusterVersion returns a cluster version which has had
// initialized to BinaryServerVersion.
func MakeTestingClusterVersion() ExposedClusterVersion {
	return MakeTestingClusterSettings().Version
}
