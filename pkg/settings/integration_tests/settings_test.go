...
// TestSettingsPersistenceEndToEndDifferentNodew checks that a stale
// entry in the local cache on one node properly gets overridden
// by an update to the setting in a different node.
