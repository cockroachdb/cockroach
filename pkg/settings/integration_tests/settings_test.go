...
func TestSettingsPersistenceEndToEnd(t *testing.T) {
	...
	testClusterArgs := base.TestClusterArgs{
		...
		ServerArgsPerNode: map[int]base.TestServerArgs{
			0: {
				StoreSpecs: []base.StoreSpec{{Type: storageconfig.StoreTypeInMemory, StickyVFSID: "1"}},
				Knobs:      base.TestingKnobs{Server: serverKnobs},
			},
			1: {
				StoreSpecs: []base.StoreSpec{{Type: storageconfig.StoreTypeInMemory, StickyVFSID: "2"}},
				Knobs:      base.TestingKnobs{Server: serverKnobs},
			},
		},
	}
