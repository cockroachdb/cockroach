...
func TestDatumWithEvalCtx(t *testing.T) {
	defer leaktest.AfterTest(t)()

	evalCtx := &tree.EvalContext{}

	var d1 *DatumWithEvalCtx
	var d2 tree.Datum
	d1 = &DatumWithEvalCtx{
	...
	// DatumWithEvalCtx can be compared with regular datum.
	require.True(t, d1.CompareDatum(d2) == 0)
	...
	// DatumWithEvalCtx can be compared with another DatumWithEvalCtx.
	require.True(t, d1.CompareDatum(d2) == 0)

	// DatumWithEvalCtx implicitly views nil as tree.DNull.
	require.True(t, d1.CompareDatum(tree.DNull) == d1.CompareDatum(nil /* other */))

	// DatumWithEvalCtx panics if compared with incompatible type.
