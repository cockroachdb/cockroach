...
func (u unknown) Type() phystypes.T {
...
func (u unknown) Window(colType phystypes.T, start uint64, end uint64) Vec {
	panic("Vec is of unknown type and should not be accessed")
}

func (u unknown) PrettyValueAt(idx uint16, colType phystypes.T) string {
	panic("Vec is of unknown type and should not be accessed")
}
