...
// inlinedLength byte) are not used, and then we have a boolean 'true'
...
type element struct {
	...
	// element was valid (namely, it'll contain an inlined value with zero
	// length).
	nonInlined bool
}
