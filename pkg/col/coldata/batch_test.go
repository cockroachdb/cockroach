...
func TestBatchReset(t *testing.T) {
	...
	resetAndCheck := func(b coldata.Batch, typs []phystypes.T, n int, shouldReuse bool) {
		t.Helper()
	...
	typsInt := []phystypes.T{phystypes.Int64}
	typsBytes := []phystypes.T{phystypes.Bytes}
	typsIntBytes := []phystypes.T{phystypes.Int64, phystypes.Bytes}
	var b coldata.Batch
