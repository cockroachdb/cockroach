...
// duplicate copies over a slice [args.SrcStartIdx: args.SrcEndIdx] of the
// nulls vector from args.Src and puts it starting at args.DestIdx. If the
// length of this nulls is smaller than args.DestIdx, then this nulls is
// extended; otherwise, any overlapping old values are overwritten, and this
// nulls is also extended if necessary.
func (n *Nulls) duplicate(args *VecArgs) {
