...
import { userLogin, userLogout } from "../util/api";
import { AdminUIState } from "./state";
import { LOGIN_PAGE, LOGOUT_PAGE } from "../routes/login";
import { cockroach } from "../js/protos";
import { getDataFromServer } from "../util/dataFromServer";

const UserLoginRequest = cockroach.server.serverpb.UserLoginRequest
