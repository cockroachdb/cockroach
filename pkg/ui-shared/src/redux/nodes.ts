...
import { NoConnection } from "../network";
import { INodeStatus, MetricConstants, BytesUsed } from "../util/proto";
 ...
 * keyword.
 */
export const LivenessStatus = protos.cockroach.kv.kvserver.storagepb.NodeLivenessStatus;
