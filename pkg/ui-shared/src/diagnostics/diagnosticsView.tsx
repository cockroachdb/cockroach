...
import { getStatementDiagnostics } from "../util/api";
...
import { createStatementDiagnosticsReportAction } from "../redux/statements";
...
import { statementDiagnostics } from "../util/docs";
import { createStatementDiagnosticsAlertLocalSetting } from "../redux/alerts";
import { trackActivateDiagnostics, trackDownloadDiagnosticsBundle } from "../util/analytics";
import { Empty } from "../empty";
import { ColumnsConfig, Table } from '../table'
import { Button } from '../button'
import { DownloadFile, DownloadFileRef } from '../downloadFile'
import { TextTypes, Text } from '../text'
            ...
            <div className={cx("crl-statements-diagnostics-view__actions-column")}>
              <a href={`_admin/v1/stmtbundle/${record.statement_diagnostics_id}`}
                ...
                <Button
                  ...
                  iconPosition="left"
                  icon={() => (
                    <span className={cx("crl-statements-diagnostics-view__icon")}>
                      <Icons.Download />
                    </span>
                  )}
                >
