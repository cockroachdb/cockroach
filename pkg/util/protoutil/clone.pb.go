...
func (*RecursiveAndUncloneable) Descriptor() ([]byte, []int) {
	return fileDescriptor_clone_60bd14b17fefc2e1, []int{0}
}
...
func init() { proto.RegisterFile("util/protoutil/clone.proto", fileDescriptor_clone_60bd14b17fefc2e1) }

var fileDescriptor_clone_60bd14b17fefc2e1 = []byte{
