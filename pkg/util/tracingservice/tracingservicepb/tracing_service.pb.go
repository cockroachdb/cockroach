...
var fileDescriptor_07369dc3d476b54b = []byte{
	...
	0xdb, 0x52, 0x6c, 0xd4, 0xc5, 0xc8, 0xc5, 0x0a, 0x76, 0x8c, 0x50, 0x03, 0x23, 0x97, 0xa0, 0x7b,
	0x6a, 0x09, 0x8a, 0x2b, 0x8a, 0x85, 0x8c, 0xf5, 0xf0, 0x86, 0x9c, 0x1e, 0x36, 0x4f, 0x4b, 0x99,
	0x90, 0xa6, 0x09, 0xe2, 0x53, 0x25, 0x06, 0x27, 0xa3, 0x13, 0x0f, 0xe5, 0x18, 0x4e, 0x3c, 0x92,
	0x63, 0xbc, 0xf0, 0x48, 0x8e, 0xf1, 0xc6, 0x23, 0x39, 0xc6, 0x07, 0x8f, 0xe4, 0x18, 0x27, 0x3c,
	0x96, 0x63, 0xb8, 0xf0, 0x58, 0x8e, 0xe1, 0xc6, 0x63, 0x39, 0x86, 0x28, 0x01, 0xf4, 0xf8, 0x4e,
	0x62, 0x03, 0x87, 0xbf, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x94, 0xde, 0x12, 0x63, 0x1e, 0x02,
	0x00, 0x00,
}
...
func (c *traceClient) GetSpanRecordings(ctx context.Context, in *SpanRecordingRequest, opts ...grpc.CallOption) (*SpanRecordingResponse, error) {
	out := new(SpanRecordingResponse)
	err := c.cc.Invoke(ctx, "/cockroach.util.tracingservice.Trace/GetSpanRecordings", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedTraceServer) GetSpanRecordings(ctx context.Context, req *SpanRecordingRequest) (*SpanRecordingResponse, error) {
...
func _Trace_GetSpanRecordings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SpanRecordingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TraceServer).GetSpanRecordings(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cockroach.util.tracingservice.Trace/GetSpanRecordings",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TraceServer).GetSpanRecordings(ctx, req.(*SpanRecordingRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _Trace_serviceDesc = grpc.ServiceDesc{
	ServiceName: "cockroach.util.tracingservice.Trace",
	HandlerType: (*TraceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetSpanRecordings",
			Handler:    _Trace_GetSpanRecordings_Handler,
		},
	},
