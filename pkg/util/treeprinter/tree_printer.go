...
//   └ qux
//
var CompactStyle = Style{
	compact: true,
}

// WithBulletsStyle is a style that shows a bullet for each node, and groups any
...
type tree struct {
	...
	// Information pertaining to the last node at a given depth.
	stack []nodeInfo
