...
// DoRangeEntryReverse loop will exit; false, it will continue.
// DoRangeEntryReverse returns whether the iteration exited early.
func (oc *OrderedCache) DoRangeEntryReverse(f func(e *Entry) bool, from, to interface{}) bool {
