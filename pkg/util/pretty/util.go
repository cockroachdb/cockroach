...
// This file contains utility and other non-standard functions not listed in
// the paper (see the package-level doc). Utility functions are those that
// are generally useful or need to create certain structures (like union)
// in a correct way.
