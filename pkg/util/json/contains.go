...
// Contains is the public interface to the @>, <@ operators.
...
// all objects equal, and all arrays equal (all objects are still less than all
// arrays, and both are greater than all scalars).
