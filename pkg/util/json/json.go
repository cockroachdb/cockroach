...
var errTrailingCharacters = errpgcode.WithCandidateCode(errors.New("trailing characters after JSON document"), pgcode.InvalidTextRepresentation)
...
func ParseJSON(s string) (JSON, error) {
	...
	if err != nil {
		...
		err = errpgcode.WithCandidateCode(err, pgcode.InvalidTextRepresentation)
		return nil, err
	}
	if decoder.More() {
...
var errCannotSetPathInScalar = errpgcode.WithCandidateCode(errors.New("cannot set path in scalar"), pgcode.InvalidParameterValue)
...
var errCannotReplaceExistingKey = errpgcode.WithCandidateCode(errors.New("cannot replace existing key"), pgcode.InvalidParameterValue)
...
var errCannotDeleteFromScalar = errpgcode.WithCandidateCode(errors.New("cannot delete from scalar"), pgcode.InvalidParameterValue)
var errCannotDeleteFromObject = errpgcode.WithCandidateCode(errors.New("cannot delete from object using integer index"), pgcode.InvalidParameterValue)
...
var errInvalidConcat = errpgcode.WithCandidateCode(errors.New("invalid concatenation of jsonb objects"), pgcode.InvalidParameterValue)
...
var errCannotDeletePathInScalar = errpgcode.WithCandidateCode(errors.New("cannot delete path in scalar"), pgcode.InvalidParameterValue)
