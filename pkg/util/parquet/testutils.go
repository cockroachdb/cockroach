...
//
// Note the read datums may not be hydrated or identical to the ones which were
// written. See comment on ValidateDatum for more info.
...
//
// Note that the returned datums may not be hydrated or identical to the ones
