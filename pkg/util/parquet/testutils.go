...
// WithTestingKnobs adds testing knobs to the writer.
...
type testingKnobs struct {
	// byteEstimateCallback is called once for every physical column when AddRow
	// is called. The parameter corresponds to the byte estimate for that
	// column.
	byteEstimateCallback func(int64)
}
