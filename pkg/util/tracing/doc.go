...
// This package encapsulates all tracing facilities used in CockroachDB.
...
//                          and "second" span as being the "parent" and "child"
//                          respectively (they're still nodes in the DAG, just
//                          with a different kind of edge between them)[5].
//
