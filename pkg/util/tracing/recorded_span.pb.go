...
func (*RecordedSpan) Descriptor() ([]byte, []int) {
	return fileDescriptor_recorded_span_77320bfde16b7b8a, []int{0}
}
...
func (*RecordedSpan_LogRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_recorded_span_77320bfde16b7b8a, []int{0, 2}
}
...
func (*RecordedSpan_LogRecord_Field) Descriptor() ([]byte, []int) {
	return fileDescriptor_recorded_span_77320bfde16b7b8a, []int{0, 2, 0}
}
...
func init() {
	proto.RegisterFile("util/tracing/recorded_span.proto", fileDescriptor_recorded_span_77320bfde16b7b8a)
}

var fileDescriptor_recorded_span_77320bfde16b7b8a = []byte{
