...
func (i *InternalInflightTraceZipper) getZipper() *tracing.MemZipper {
	return i.z
}
...
func (s *SQLConnInflightTraceZipper) getZipper() *tracing.MemZipper {
	return s.z
}
