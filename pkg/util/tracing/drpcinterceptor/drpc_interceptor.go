...
// StreamServerInterceptor returns a drpcmux.StreamServerInterceptor for tracing.// It creates a single span that covers the entire lifetime of the streaming RPC.
