...
type spanContext struct {
	...
	// is responsible for calling GetRecording() on them and marshalling the
...
func StartRecording(os opentracing.Span, recType RecordingType) {
	...
	sp.enableRecording(nil /* parent */, recType, false)
}
