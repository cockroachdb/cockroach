...
type Tracer struct {
	...
	// This is a *float64 represented as an unsafe pointer for atomics. It contains
	// to the fraction (between 0.0 and 1.0) of traces to record and collect. Set by
	// changing the cluster setti
	//ngs. Accessed via t.samplingRate().
