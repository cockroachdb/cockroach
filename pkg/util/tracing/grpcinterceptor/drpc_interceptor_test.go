	...
	for _, tc := range []struct {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			clientConn, err := drpcclient.NewClientConnWithOptions(
				bgCtx,
				dialer,
				drpcclient.WithChainUnaryInterceptor(grpcinterceptor.ClientInterceptorDrpc(tr, nil)),
				drpcclient.WithChainStreamInterceptor(grpcinterceptor.StreamClientInterceptorDrpc(tr, nil)),
			)
