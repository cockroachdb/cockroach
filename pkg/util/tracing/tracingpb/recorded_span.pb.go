...
func (*LogRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_recorded_span_12eb7ffdb48f0c5b, []int{0}
}
...
func (*LogRecord_Field) Descriptor() ([]byte, []int) {
	return fileDescriptor_recorded_span_12eb7ffdb48f0c5b, []int{0, 0}
}
...
type RecordedSpan struct {
	...
	// Goroutine ID associated with this span at time of span creation.
...
func (*RecordedSpan) Descriptor() ([]byte, []int) {
	return fileDescriptor_recorded_span_12eb7ffdb48f0c5b, []int{1}
}
...
func (*NormalizedSpan) Descriptor() ([]byte, []int) {
	return fileDescriptor_recorded_span_12eb7ffdb48f0c5b, []int{2}
}
...
func init() {
	proto.RegisterFile("util/tracing/tracingpb/recorded_span.proto", fileDescriptor_recorded_span_12eb7ffdb48f0c5b)
}

var fileDescriptor_recorded_span_12eb7ffdb48f0c5b = []byte{
	// 695 bytes of a gzipped FileDescriptorProto
	,
}
