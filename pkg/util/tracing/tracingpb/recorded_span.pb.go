...
func (*LogRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_recorded_span_bdd6f7c4f7a96f29, []int{0}
}
...
func (*LogRecord_Field) Descriptor() ([]byte, []int) {
	return fileDescriptor_recorded_span_bdd6f7c4f7a96f29, []int{0, 0}
}
...
type RecordedSpan struct {
	...
	// Structured payloads attached to this Span.
	Structured []*types.Any `protobuf:"bytes,11,rep,name=structured,proto3" json:"structured,omitempty"`
}

func (m *RecordedSpan) Reset()      { *m = RecordedSpan{} }
func (*RecordedSpan) ProtoMessage() {}
func (*RecordedSpan) Descriptor() ([]byte, []int) {
	return fileDescriptor_recorded_span_bdd6f7c4f7a96f29, []int{1}
}
...
func (*NormalizedSpan) Descriptor() ([]byte, []int) {
	return fileDescriptor_recorded_span_bdd6f7c4f7a96f29, []int{2}
}
...
func (m *RecordedSpan) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			...
			m.Structured = append(m.Structured, &types.Any{})
			if err := m.Structured[len(m.Structured)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func init() {
	proto.RegisterFile("util/tracing/tracingpb/recorded_span.proto", fileDescriptor_recorded_span_bdd6f7c4f7a96f29)
}

var fileDescriptor_recorded_span_bdd6f7c4f7a96f29 = []byte{
	// 645 bytes of a gzipped FileDescriptorProto
	,
}
