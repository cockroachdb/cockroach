...
type EventListener interface {
	...
	//
	// Note that this method should not run for a long time as it will hold up
	// the span recording Structured events during traced operations.
	//
	// Notify will not be called concurrently on the same span.
	//
	// NB: the span's mutex is locked.
