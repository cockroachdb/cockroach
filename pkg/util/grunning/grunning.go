...
// Difference is a helper function to compute the difference between two
// durations from another. It's commonly used to measure how much running time
// is spent doing some piece of work.
