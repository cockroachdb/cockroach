...
// general class of aggregators that are associative, such as geometric mean,
// bloom filters etc. These require special treatment with user defined
...
// NewSwag returns a new sliding window aggregator. The number of windows,
// rotation interval and binary operation are declared at creation and must not
// be altered after.
func NewSwag(
