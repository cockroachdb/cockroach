...
func TestRegistry(t *testing.T) {
	...
	r.AddMetric(NewHistogram(Metadata{Name: "top.histogram"}, time.Minute, CountBuckets))
	...
	ms := &struct {
		...
		StructHistogram: NewHistogram(Metadata{Name: "struct.histogram"}, time.Minute, CountBuckets),
		NestedStructGauge: NestedStruct{
		...
		privateStructHistogram: NewHistogram(Metadata{Name: "private.struct.histogram"}, time.Minute, CountBuckets),
		privateNestedStructGauge: NestedStruct{
