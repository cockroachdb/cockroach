...
// AggCounter maintains a value as the sum of its tenant children. The counter
...
// Counter is a child of a AggCounter. When it is incremented or decremented,
// so too does the parent. When metrics are collected by prometheus, each of the
