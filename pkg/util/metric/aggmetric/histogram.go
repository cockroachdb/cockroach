...
func NewSQLHistogram(opts metric.HistogramOptions) *SQLHistogram {
	...
	s.SQLMetric = NewSQLMetric(metric.LabelConfigDisabled, histogram, histogram)
...
// Inspect is part of the metric.Iterable interface.
func (h *HighCardinalityHistogram) Inspect(f func(interface{})) { f(h) }
