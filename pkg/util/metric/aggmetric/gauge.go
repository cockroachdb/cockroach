...
// UpsertChildFn updates the callback function for a child of this
// AggFunctionalGauge. If no child exists with the given labelVals, a new child
// will be created with the provided callback.
func (g *AggFunctionalGauge) UpsertChildFn(fn func() int64, labelVals ...string) {
	child := g.GetOrCreateChild(fn, labelVals...)
	child.fn = fn
}
