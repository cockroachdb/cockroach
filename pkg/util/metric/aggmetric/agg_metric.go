...
// StorageType represents the type of storage used for storing children.
// The default storage type is BTree.
...
func (cs *childSet) init(labels []string, storageType StorageType) {
	cs.labels = labels
	switch storageType {
	...
	default:
		panic(errors.AssertionFailedf(
			"unknwon storage type %d", storageType))
	}
	cs.storageType = storageType
}
