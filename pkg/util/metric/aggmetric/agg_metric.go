...
var _ metric.Iterable = (*SQLMetric)(nil)
...
func (sm *SQLMetric) Inspect(f func(interface{})) {
	f(sm)
}
...
// Inspect is part of the metric.Iterable interface.
func (b *baseAggMetric) Inspect(f func(interface{})) {
	f(b)
}

var _ metric.Iterable = (*baseAggMetric)(nil)
