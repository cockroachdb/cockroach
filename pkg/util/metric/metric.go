...
// cumulative and current windowed histogram manually via Update. This means
// that it is the responsibility of the creator of this histogram to replace
// the values by calling ManualWindowHistogram.Update or
// ManualWindowHistogram.RecordValue and ManualWindowHistogram.Rotate.
