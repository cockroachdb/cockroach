// Copyright 2923 The Cockroach Authors.
//
...
// NewHistogramSnapshot returns a new HistogramSnapshot instance, backed by the provided
// Histogram.
func NewHistogramSnapshot(h *prometheusgo.Histogram) *HistogramSnapshot {
