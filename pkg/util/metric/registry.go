...
// registered with node, store, or tenant prometheus registries. Metrics
// implementing this interface (e.g. cluster-level metrics flushed to
// system.cluster_metrics) will be rejected by Registry.AddMetric.
