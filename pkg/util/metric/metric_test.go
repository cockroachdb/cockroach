...
func TestHistogramVec(t *testing.T) {
	t.Run("Observe", func(t *testing.T) {
		...
		h := NewExportedHistogramVec(NewHistogramVecOpts(emptyMetadata, prometheus.HistogramOpts{}),
...
func TestNewHistogramVecOpts(t *testing.T) {
	metadata := Metadata{
		Name: "my_metric",
		Help: "help string",
	}

	promHistOpts := prometheus.HistogramOpts{
		Name: "wrong_name",
		Help: "another help string",
	}

	histVecOpts := NewHistogramVecOpts(metadata, promHistOpts)
	require.Equal(t, metadata.Name, histVecOpts.histOpts.Name)
	require.Equal(t, metadata.Help, histVecOpts.histOpts.Help)
}
