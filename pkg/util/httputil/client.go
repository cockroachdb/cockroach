...
// It also uses the default client with a default 3 second timeout.
func Put(
	ctx context.Context, url string, h *RequestHeaders, body io.Reader) (resp *http.Response, err error) {
...
// It also uses the default client with a default 3 second timeout.
func Delete(
	ctx context.Context, url string, h *RequestHeaders) (resp *http.Response, err error) {
...
func (c *Client) Put(ctx context.Context, url string, h *RequestHeaders, body io.Reader) (
	resp *http.Response, err error) {
...
func (c *Client) Delete(ctx context.Context, url string, h *RequestHeaders) (resp *http.Response, err error) {
