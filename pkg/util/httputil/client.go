...
const standardHTTPTimeout time.Duration = 5 * time.Second
...
// It also uses the default client.
...
// Get does like http.Client.Head but uses the provided context and obeys its cancellation.
