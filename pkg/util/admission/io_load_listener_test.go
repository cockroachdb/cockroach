...
func (g *testGranterWithIOTokens) setAvailableTokens(
	...
	fmt.Fprintf(&g.buf, "setAvailableTokens: %s %s",
...
func (g *testGranterWithIOTokens) getDiskTokensUsedAndReset() [numWorkClasses]int64 {
...
func (g *testGranterNonNegativeTokens) getDiskTokensUsedAndReset() [numWorkClasses]int64 {
