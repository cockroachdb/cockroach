...
// bool that it replaces. The class should be revisited (likely
// changed to SystemOnly) when the legacy bool is retired, since all
// current callers of cpuTimeTokenACIsEnabled use system tenant
// settings.
