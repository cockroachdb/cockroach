...
func makeWorkQueue(
	...
	q := &WorkQueue{}
	initWorkQueue(q, ambientCtx, workKind, KVAdmissionQueue, granter, settings, metrics, opts, nil)
	return q
}
...
func makeStoreWorkQueue(
	...
	for i := range q.q {
		initWorkQueue(&q.q[i], ambientCtx, KVWork, StoreQueue, granters[i], settings, metrics, opts, knobs)
