...
// RunCallbackOnClose provides a function to run when the GrantCoordinator is
// closed, that does additional cleanup related to how this GrantCoordinator
// is wired up into its environment.
func (coord *GrantCoordinator) RunCallbackOnClose(cb func()) {
	coord.closeCB = cb
}
