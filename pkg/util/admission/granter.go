...
func (sg *slotGranter) tryGet(_ getterQualification, count int64) bool {
...
// tryGet implements granter.
func (tg *tokenGranter) tryGet(_ getterQualification, count int64) bool {
...
// tryGet implements granter.
func (cg *kvStoreTokenChildGranter) tryGet(_ getterQualification, count int64) bool {
