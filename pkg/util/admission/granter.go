...
func (io *ioLoadListener) adjustTokens(ctx context.Context, m *pebble.Metrics) {
	...
	var storeRequestEstimates storeRequestEstimates
	storeRequestEstimates.workByteAddition = int64(io.smoothedPerWorkUnaccountedBytesAdded)
	if storeRequestEstimates.workByteAddition < 1 {
		storeRequestEstimates.workByteAddition = 1
	}
	...
	storeRequestEstimates.fractionOfIngestIntoL0 = io.smoothedFractionOfIngestIntoL0
	...
	io.kvRequester.setStoreRequestEstimates(storeRequestEstimates)
}
