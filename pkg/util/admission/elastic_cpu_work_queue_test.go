...
func (t *testElasticCPUGranter) tryGet(_ getterQualification, count int64) (granted bool) {
	panic("unimplemented")
}
...
func (t *testElasticCPUInternalWorkQueue) hasWaitingRequests() (bool, getterQualification) {
	panic("unimplemented")
}
