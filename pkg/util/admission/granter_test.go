...
init-grant-coordinator min-cpu=<int> max-cpu=<int> sql-kv-tokens=<int> sql-sql-tokens=<int>
  sql-leaf=<int> sql-root=<int>
...
// TODO(sumeer):
// - Test metrics
// - Test GrantCoordinator with serverless configurations
