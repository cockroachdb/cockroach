...
var KVCPUTimeUtilBurstDelta = settings.RegisterFloatSetting(
	...
	this delta is the same for both system & app tenant work, and is expressed in the same units as
	admission.cpu_time_tokens.target_util.app_tenant & admission.cpu_time_tokens.target_util.system_tenant
	(value is in the interval [0,1] where 1 means "all cores")`,
