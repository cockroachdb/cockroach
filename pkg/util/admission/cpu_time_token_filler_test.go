...
func TestDampeningFactor(t *testing.T) {
	...
	// Burst refill should NOT be dampened. It uses the undampened allocations.
	// Burst = noBurst/4 = 4000/4 = 1000 for tier0.
	require.Equal(t, int64(1000), burstMgrs[testTier0].tokens)
	require.Equal(t, int64(500), burstMgrs[testTier1].tokens)
