...
func NewGrantCoordinators(
	...
	return GrantCoordinators{
		...
		IOGrantCoordinator: newIOGrantCoordinator(),
	}
}
...
// StoreGrantCoordinators is a container for GrantCoordinators for all stores on
// the local node. It's used for KV admission of writes, and takes store health
// into account internally.
//
// XXX: Suffix this with "Local"?
