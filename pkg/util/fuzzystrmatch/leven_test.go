...
func TestLevenshteinLessThanDistance(t *testing.T) {
	tt := []struct {
		Source      string
		Target      string
		MaxDistance int
	...
	for _, tc := range tt {
		got := LevenshteinLessThanDistance(tc.Source, tc.Target, tc.MaxDistance)
		if tc.Expected != got {
...
func TestLevenshteinLessThanDistanceWithCost(t *testing.T) {
	tt := []struct {
		Source      string
		Target      string
		MaxDistance int
	...
	for _, tc := range tt {
		got := LevenshteinLessThanDistanceWithCost(tc.Source, tc.Target, 2, 3, 4, tc.MaxDistance)
		if tc.Expected != got {
