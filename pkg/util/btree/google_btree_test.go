...
// This file was extracted and adapted from github.com/google/btree at
// 8e29150ba321eef204059de2ab494f179b6cff2c
...
import (
	...
	"github.com/cockroachdb/cockroach/pkg/util/btree/gbtree"
...
func intAll(t *gbtree.BTreeG[int]) (out []int) {
...
func intAllRev(t *gbtree.BTreeG[int]) (out []int) {
...
func NewOrderedG[T constraints.Ordered]() *gbtree.BTreeG[T] {
	return gbtree.New(ordered.Compare[T])
}
