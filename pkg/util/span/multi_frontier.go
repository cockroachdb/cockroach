...
type MultiFrontier[P comparable] struct {
	...
	mu struct {
		syncutil.Mutex
		frontiers *multiFrontierHeapP[P]
	}
}
...
func NewMultiFrontierAt[P comparable](
	...
	f.mu.frontiers = newMultiFrontierHeapP[P]()
...
// multiFrontierHeapP is a heap of frontiers that are sorted by their
// frontier timestamps with convenience methods so that frontiers can
// be accessed by their partition. It is not safe for concurrent use.
type multiFrontierHeapP[P comparable] struct {
...
// newMultiFrontierHeapP returns a new multiFrontierHeapP.
func newMultiFrontierHeapP[P comparable]() *multiFrontierHeapP[P] {
	return &multiFrontierHeapP[P]{
...
func (h *multiFrontierHeapP[P]) pushUnordered(partition P, frontier Frontier) error {
...
func (h *multiFrontierHeapP[P]) get(partition P) Frontier {
...
func (h *multiFrontierHeapP[P]) min() Frontier {
	if len(h.h) == 0 {
		return nil
	}
...
func (h *multiFrontierHeapP[P]) fixup(partition P) error {
...
func (h *multiFrontierHeapP[P]) heapify() {
	heap.Init(&h.h)
}

// clear releases and removes all the frontiers in the heap.
func (h *multiFrontierHeapP[P]) clear() {
...
func (h *multiFrontierHeapP[P]) len() int {
	return len(h.h)
}

// all returns an iterator over the partitions and frontiers tracked
// by the heap.
func (h *multiFrontierHeapP[P]) all() iter.Seq2[P, Frontier] {
	return func(yield func(P, Frontier) bool) {
...
func (h *multiFrontierHeapP[P]) valid() bool {
