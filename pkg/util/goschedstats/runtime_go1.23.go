...
// go1.23. Before allowing newer versions, please check
// that the structures still match with those in go/src/runtime.

// N.B. `sysmontick` struct was modified in [1]. As a result, the definitions in this
// file are _not_ compatible with Go versions prior to 1.23. Otherwise, everything else
// was copied verbatim from `runtime_go1.20_21_22.go`.
//
