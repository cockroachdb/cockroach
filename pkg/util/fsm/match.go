...
// Binding allows variables to be bound to names and used in the match
// expression. If the binding name is the empty string, it acts as a wildcard
// but does not add any variable to the expression scope.
type Binding string
