...
func TestMatchPattern(t *testing.T) {
	...
	p8 := expandPattern(Pattern{
		...
		state2{}: {
			event3{Wildcard}: {state2{}, noAction},
		},
	})
...
func TestInvalidPattern(t *testing.T) {
	...
	require.Panics(t, func() {
		expandPattern(Pattern{
			state1{}: {
				event4{Wildcard, False}: {state2{}, noAction},
				event4{True, Wildcard}:  {state2{}, noAction},
			},
		})
	})
	...
	require.Panics(t, func() {
		expandPattern(Pattern{
			state3{Binding("a")}: {
				event3{Binding("a")}: {state2{}, noAction},
			},
		})
	})
	require.Panics(t, func() {
		expandPattern(Pattern{
			state4{Binding("a"), Binding("a")}: {
				event1{}: {state2{}, noAction},
			},
		})
	})
	require.Panics(t, func() {
		expandPattern(Pattern{
			state1{}: {
				event4{Binding("a"), Binding("a")}: {state2{}, noAction},
			},
		})
	})
	...
	require.Panics(t, func() {
		expandPattern(Pattern{
			state1{}: {
				event3{Binding("a")}: {state3{Binding("b")}, noAction},
			},
		})
	})
	...
	require.Panics(t, func() {
		expandPattern(Pattern{
			state1{}: {
				event1{}: {state3{Wildcard}, noAction},
			},
		})
	})
}
