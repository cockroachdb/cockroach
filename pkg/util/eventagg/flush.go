...
// FlushMeta is a type used to communicate metadata from a FlushTrigger to the
// targets of the flush, such as the type of flush, and associated timestamps.
// This can be used to better understand things such as aggregation periods.
...
func (w *WindowedFlush) shouldFlush() (bool, FlushMeta) {
	t := w.nowFn()
