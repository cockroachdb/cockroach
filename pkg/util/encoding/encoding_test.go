...
func TestKeyEncodeDecodeBitArray(t *testing.T) {
...
func TestUpperBoundValueEncodingSize(t *testing.T) {
	tests := []struct {
		...
		{colID: 0, typ: BitArray, width: 31, size: 22},
		{colID: 0, typ: BitArray, width: 64, size: 26},
		{colID: 0, typ: BitArray, width: 120, size: 33},
