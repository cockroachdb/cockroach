...
// minimal prefix 0x00, and similarly for repeated 0xff sequences.
//
// Formally:
//
//     PrefixEnd(UndoPrefixEnd(p)) = p for all prefixes p
//     UndoPrefixEnd(PrefixEnd(p)) = p for all non-maximal prefixes p
//
// A maximal prefix is a prefix that consists only of one or more 0xff bytes.
//
