...
// EncodeJSONEmptyArray returns a byte array b with a byte to signify and empty JSON array.
func EncodeJSONEmptyArray(b []byte) []byte {
	return append(b, JSONEmptyArray)
}

// EncodeJSONEmptyObject returns a byte array b with a byte to signify and empty JSON object.
