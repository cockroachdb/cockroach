...
var (
	// FatalAssertions will fatal the process on assertion failures. It defaults
	// to true in non-release builds.
...
// in release builds. This should be used very rarely, only when it is
// appropriate to fatal the node even in release builds because it is provably
// unsafe to continue.
//
// gcassert:inline
...
// builds. The given function should use assertions as usual, which will always
// fatal since Expensive is never enabled in release builds.
