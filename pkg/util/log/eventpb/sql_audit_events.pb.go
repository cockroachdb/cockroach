...
func (*CommonSQLExecDetails) Descriptor() ([]byte, []int) {
	return fileDescriptor_sql_audit_events_1815596ae9ad3de5, []int{0}
}
...
func (*SensitiveTableAccess) Descriptor() ([]byte, []int) {
	return fileDescriptor_sql_audit_events_1815596ae9ad3de5, []int{1}
}
...
func (*AdminQuery) Descriptor() ([]byte, []int) {
	return fileDescriptor_sql_audit_events_1815596ae9ad3de5, []int{2}
}
...
func (*SlowQuery) Descriptor() ([]byte, []int) {
	return fileDescriptor_sql_audit_events_1815596ae9ad3de5, []int{3}
}
...
func (*CommonLargeRowDetails) Descriptor() ([]byte, []int) {
	return fileDescriptor_sql_audit_events_1815596ae9ad3de5, []int{4}
}
...
func (*LargeRow) Descriptor() ([]byte, []int) {
	return fileDescriptor_sql_audit_events_1815596ae9ad3de5, []int{5}
}
...
func (*CommonTxnRowsLimitDetails) Descriptor() ([]byte, []int) {
	return fileDescriptor_sql_audit_events_1815596ae9ad3de5, []int{6}
}
...
func (*TxnRowsWrittenLimit) Descriptor() ([]byte, []int) {
	return fileDescriptor_sql_audit_events_1815596ae9ad3de5, []int{7}
}
...
func (*TxnRowsReadLimit) Descriptor() ([]byte, []int) {
	return fileDescriptor_sql_audit_events_1815596ae9ad3de5, []int{8}
}
...
func (*SlowQueryInternal) Descriptor() ([]byte, []int) {
	return fileDescriptor_sql_audit_events_1815596ae9ad3de5, []int{9}
}
...
func (*LargeRowInternal) Descriptor() ([]byte, []int) {
	return fileDescriptor_sql_audit_events_1815596ae9ad3de5, []int{10}
}
...
func (*TxnRowsWrittenLimitInternal) Descriptor() ([]byte, []int) {
	return fileDescriptor_sql_audit_events_1815596ae9ad3de5, []int{11}
}
...
func (*TxnRowsReadLimitInternal) Descriptor() ([]byte, []int) {
	return fileDescriptor_sql_audit_events_1815596ae9ad3de5, []int{12}
}
...
func (*QueryExecute) Descriptor() ([]byte, []int) {
	return fileDescriptor_sql_audit_events_1815596ae9ad3de5, []int{13}
}
...
func init() {
	proto.RegisterFile("util/log/eventpb/sql_audit_events.proto", fileDescriptor_sql_audit_events_1815596ae9ad3de5)
}

var fileDescriptor_sql_audit_events_1815596ae9ad3de5 = []byte{
