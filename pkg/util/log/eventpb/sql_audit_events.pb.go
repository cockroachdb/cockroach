...
func (*CommonSQLExecDetails) Descriptor() ([]byte, []int) {
	return fileDescriptor_sql_audit_events_9e22fedf369d02c1, []int{0}
}
...
func (*SensitiveTableAccess) Descriptor() ([]byte, []int) {
	return fileDescriptor_sql_audit_events_9e22fedf369d02c1, []int{1}
}
...
// AdminQuery is recorded when a query has effectively used
// the session user's membership to the admin role, i.e.
// admin privileges were used.
type AdminQuery struct {
	CommonEventDetails    `protobuf:"bytes,1,opt,name=common,proto3,embedded=common" json:""`
	CommonSQLEventDetails `protobuf:"bytes,2,opt,name=sql,proto3,embedded=sql" json:""`
	CommonSQLExecDetails  `protobuf:"bytes,3,opt,name=exec,proto3,embedded=exec" json:""`
	// How the admin role participated in the planning or execution.
	AdminUse []string `protobuf:"bytes,4,rep,name=admin_use,json=adminUse,proto3" json:",omitempty" redact:"nonsensitive"`
}
...
func (*AdminQuery) Descriptor() ([]byte, []int) {
	return fileDescriptor_sql_audit_events_9e22fedf369d02c1, []int{2}
}
...
func (*SlowQuery) Descriptor() ([]byte, []int) {
	return fileDescriptor_sql_audit_events_9e22fedf369d02c1, []int{3}
}
...
func (*SlowQueryInternal) Descriptor() ([]byte, []int) {
	return fileDescriptor_sql_audit_events_9e22fedf369d02c1, []int{4}
}
...
func (*QueryExecute) Descriptor() ([]byte, []int) {
	return fileDescriptor_sql_audit_events_9e22fedf369d02c1, []int{5}
}
...
func (m *AdminQuery) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AdminUse", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AdminUse = append(m.AdminUse, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipSqlAuditEvents(dAtA[iNdEx:])
...
func init() {
	proto.RegisterFile("util/log/eventpb/sql_audit_events.proto", fileDescriptor_sql_audit_events_9e22fedf369d02c1)
}

var fileDescriptor_sql_audit_events_9e22fedf369d02c1 = []byte{
	// 611 bytes of a gzipped FileDescriptorProto
	,
}
