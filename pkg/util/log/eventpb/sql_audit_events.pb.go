...
type CommonTxnRowsLimitReachedDetails struct {
	TxnID                   string `protobuf:"bytes,1,opt,name=txn_id,json=txnId,proto3" json:",omitempty"`
	SessionID               string `protobuf:"bytes,2,opt,name=session_id,json=sessionId,proto3" json:",omitempty"`
...
type TxnRowsWrittenLimitReached struct {
	CommonEventDetails               `protobuf:"bytes,1,opt,name=common,proto3,embedded=common" json:""`
	CommonTxnRowsLimitReachedDetails `protobuf:"bytes,2,opt,name=info,proto3,embedded=info" json:""`
}
...
var fileDescriptor_b7a82d5e93041841 = []byte{
	...
	,
}
