...
func (*CommonSQLExecDetails) Descriptor() ([]byte, []int) {
	return fileDescriptor_sql_audit_events_a2e66f503a4fb03b, []int{0}
}
...
func (*SensitiveTableAccess) Descriptor() ([]byte, []int) {
	return fileDescriptor_sql_audit_events_a2e66f503a4fb03b, []int{1}
}
...
func (*SlowQuery) Descriptor() ([]byte, []int) {
	return fileDescriptor_sql_audit_events_a2e66f503a4fb03b, []int{2}
}
...
func (*SlowQueryInternal) Descriptor() ([]byte, []int) {
	return fileDescriptor_sql_audit_events_a2e66f503a4fb03b, []int{3}
}
...
func (*QueryExecute) Descriptor() ([]byte, []int) {
	return fileDescriptor_sql_audit_events_a2e66f503a4fb03b, []int{4}
}
...
func init() {
	proto.RegisterFile("util/log/eventpb/sql_audit_events.proto", fileDescriptor_sql_audit_events_a2e66f503a4fb03b)
}

var fileDescriptor_sql_audit_events_a2e66f503a4fb03b = []byte{
