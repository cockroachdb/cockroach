...
func (*SetClusterSetting) Descriptor() ([]byte, []int) {
	return fileDescriptor_misc_sql_events_c56139b4ad2ca2db, []int{0}
}
...
func init() {
	proto.RegisterFile("util/log/eventpb/misc_sql_events.proto", fileDescriptor_misc_sql_events_c56139b4ad2ca2db)
}

var fileDescriptor_misc_sql_events_c56139b4ad2ca2db = []byte{
