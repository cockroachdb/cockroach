...
func (m *ClientAuthenticationFailed) AppendJSONFields(printComma bool, b redact.RedactableBytes) (bool, redact.RedactableBytes) {
	...
	if m.Reason != "" {
		...
		b = append(b, "\"Reason\":\""...)
		b = append(b, redact.StartMarker()...)
		b = redact.RedactableBytes(jsonbytes.EncodeString([]byte(b), string(redact.EscapeMarkers([]byte(m.Reason)))))
		b = append(b, redact.EndMarker()...)
		b = append(b, '"')
	}
	...
	if m.Method != "" {
		...
		b = append(b, "\"Method\":\""...)
		b = append(b, redact.StartMarker()...)
		b = redact.RedactableBytes(jsonbytes.EncodeString([]byte(b), string(redact.EscapeMarkers([]byte(m.Method)))))
		b = append(b, redact.EndMarker()...)
		b = append(b, '"')
	}
...
func (m *CommonConnectionDetails) AppendJSONFields(printComma bool, b redact.RedactableBytes) (bool, redact.RedactableBytes) {
	...
	if m.Network != "" {
		...
		b = append(b, "\"Network\":\""...)
		b = append(b, redact.StartMarker()...)
		b = redact.RedactableBytes(jsonbytes.EncodeString([]byte(b), string(redact.EscapeMarkers([]byte(m.Network)))))
		b = append(b, redact.EndMarker()...)
		b = append(b, '"')
	}
...
func (m *CommonSessionDetails) AppendJSONFields(printComma bool, b redact.RedactableBytes) (bool, redact.RedactableBytes) {
	...
	if m.Transport != "" {
		...
		b = append(b, redact.StartMarker()...)
		b = redact.RedactableBytes(jsonbytes.EncodeString([]byte(b), string(redact.EscapeMarkers([]byte(m.Transport)))))
		b = append(b, redact.EndMarker()...)
		b = append(b, '"')
	}
