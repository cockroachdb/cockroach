...
func (m *CommonLargeRowDetails) AppendJSONFields(printComma bool, b redact.RedactableBytes) (bool, redact.RedactableBytes) {
	...
	if m.MaxRowSize != 0 {
		...
		printComma = true
		b = append(b, "\"MaxRowSize\":"...)
		b = strconv.AppendUint(b, uint64(m.MaxRowSize), 10)
	}
	...
	if m.Key != "" {
		...
		b = append(b, "\"Key\":\""...)
		b = append(b, redact.StartMarker()...)
		b = redact.RedactableBytes(jsonbytes.EncodeString([]byte(b), string(redact.EscapeMarkers([]byte(m.Key)))))
		b = append(b, redact.EndMarker()...)
		b = append(b, '"')
	}
