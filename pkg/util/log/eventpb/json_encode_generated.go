...
func (m *RoleBasedAuditEvent) AppendJSONFields(printComma bool, b redact.RedactableBytes) (bool, redact.RedactableBytes) {
	...
	if m.StatementType != "" {
		...
		printComma = true
		b = append(b, "\"StatementType\":\""...)
		b = append(b, redact.StartMarker()...)
		b = redact.RedactableBytes(jsonbytes.EncodeString([]byte(b), string(redact.EscapeMarkers([]byte(m.StatementType)))))
		b = append(b, redact.EndMarker()...)
		b = append(b, '"')
	}
	...
	if m.ServerAddress != "" {
		...
		printComma = true
		b = append(b, "\"ServerAddress\":\""...)
		b = append(b, redact.StartMarker()...)
		b = redact.RedactableBytes(jsonbytes.EncodeString([]byte(b), string(redact.EscapeMarkers([]byte(m.ServerAddress)))))
		b = append(b, redact.EndMarker()...)
		b = append(b, '"')
	}
	...
	if m.ConnectionType != "" {
		...
		printComma = true
		b = append(b, "\"ConnectionType\":\""...)
		b = append(b, redact.StartMarker()...)
		b = redact.RedactableBytes(jsonbytes.EncodeString([]byte(b), string(redact.EscapeMarkers([]byte(m.ConnectionType)))))
		b = append(b, redact.EndMarker()...)
		b = append(b, '"')
	}
