...
func (m *CommonJobEventDetails) AppendJSONFields(printComma bool, b redact.RedactableBytes) (bool, redact.RedactableBytes) {
	...
	if m.JobType != "" {
		...
		b = append(b, "\"JobType\":\""...)
		b = append(b, redact.StartMarker()...)
		b = redact.RedactableBytes(jsonbytes.EncodeString([]byte(b), string(redact.EscapeMarkers([]byte(m.JobType)))))
		b = append(b, redact.EndMarker()...)
		b = append(b, '"')
	}
	...
	if m.Status != "" {
		...
		b = append(b, "\"Status\":\""...)
		b = append(b, redact.StartMarker()...)
		b = redact.RedactableBytes(jsonbytes.EncodeString([]byte(b), string(redact.EscapeMarkers([]byte(m.Status)))))
		b = append(b, redact.EndMarker()...)
		b = append(b, '"')
	}
