...
// AppendJSONFields implements the EventPayload interface.
func (m *SetSessionSettingHint) AppendJSONFields(printComma bool, b redact.RedactableBytes) (bool, redact.RedactableBytes) {
	...
	if m.SettingValue != "" {
		...
		printComma = true
		b = append(b, "\"SettingValue\":\""...)
		b = append(b, redact.StartMarker()...)
		b = redact.RedactableBytes(jsonbytes.EncodeString([]byte(b), string(redact.EscapeMarkers([]byte(m.SettingValue)))))
		b = append(b, redact.EndMarker()...)
		b = append(b, '"')
	}
