...
// AppendJSONFields implements the EventPayload interface.
func (m *FailedQuery) AppendJSONFields(printComma bool, b redact.RedactableBytes) (bool, redact.RedactableBytes) {
...
// AppendJSONFields implements the EventPayload interface.
func (m *FailedQueryInternal) AppendJSONFields(printComma bool, b redact.RedactableBytes) (bool, redact.RedactableBytes) {
...
// AppendJSONFields implements the EventPayload interface.
func (m *RenameTrigger) AppendJSONFields(printComma bool, b redact.RedactableBytes) (bool, redact.RedactableBytes) {
	...
	if m.NewTriggerName != "" {
		...
		printComma = true
		b = append(b, "\"NewTriggerName\":\""...)
		b = redact.RedactableBytes(jsonbytes.EncodeString([]byte(b), string(m.NewTriggerName)))
		b = append(b, '"')
	}
