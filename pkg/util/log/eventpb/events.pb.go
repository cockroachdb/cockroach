...
func (*CommonEventDetails) Descriptor() ([]byte, []int) {
	return fileDescriptor_events_927ca545c7be3481, []int{0}
}
...
func (*CommonSQLEventDetails) Descriptor() ([]byte, []int) {
	return fileDescriptor_events_927ca545c7be3481, []int{1}
}
...
func init() {
	proto.RegisterFile("util/log/eventpb/events.proto", fileDescriptor_events_927ca545c7be3481)
}

var fileDescriptor_events_927ca545c7be3481 = []byte{
