...
func (*CommonNodeEventDetails) Descriptor() ([]byte, []int) {
	return fileDescriptor_cluster_events_b5aa6d7c12f66885, []int{0}
}
...
func (*NodeJoin) Descriptor() ([]byte, []int) {
	return fileDescriptor_cluster_events_b5aa6d7c12f66885, []int{1}
}
...
func (*NodeRestart) Descriptor() ([]byte, []int) {
	return fileDescriptor_cluster_events_b5aa6d7c12f66885, []int{2}
}
...
func (*CommonNodeDecommissionDetails) Descriptor() ([]byte, []int) {
	return fileDescriptor_cluster_events_b5aa6d7c12f66885, []int{3}
}
...
func (*NodeDecommissioning) Descriptor() ([]byte, []int) {
	return fileDescriptor_cluster_events_b5aa6d7c12f66885, []int{4}
}
...
func (*NodeDecommissioned) Descriptor() ([]byte, []int) {
	return fileDescriptor_cluster_events_b5aa6d7c12f66885, []int{5}
}
...
func (*NodeRecommissioned) Descriptor() ([]byte, []int) {
	return fileDescriptor_cluster_events_b5aa6d7c12f66885, []int{6}
}
...
func (*CertsReload) Descriptor() ([]byte, []int) {
	return fileDescriptor_cluster_events_b5aa6d7c12f66885, []int{7}
}
...
// EmergencyAuthRule is recorded when an emergency authentication rule
// for the HTTP interface is added to a node.
type EmergencyAuthRule struct {
	CommonEventDetails `protobuf:"bytes,1,opt,name=common,proto3,embedded=common" json:""`
	// The ID of the emergency session.
	SessionID int64 `protobuf:"varint,2,opt,name=session_id,json=sessionId,proto3" json:",omitempty"`
	// The that the emergency session logs in at.
	Username string `protobuf:"bytes,3,opt,name=username,proto3" json:",omitempty"`
	// Whether the user is considered as an admin or not when processing requests.
	IsAdmin bool `protobuf:"varint,4,opt,name=is_admin,json=isAdmin,proto3" json:",omitempty"`
	// When the emergency session expires.
	ExpiresAt int64 `protobuf:"varint,5,opt,name=expires_at,json=expiresAt,proto3" json:",omitempty"`
}

func (m *EmergencyAuthRule) Reset()         { *m = EmergencyAuthRule{} }
func (m *EmergencyAuthRule) String() string { return proto.CompactTextString(m) }
func (*EmergencyAuthRule) ProtoMessage()    {}
func (*EmergencyAuthRule) Descriptor() ([]byte, []int) {
	return fileDescriptor_cluster_events_b5aa6d7c12f66885, []int{8}
}
func (m *EmergencyAuthRule) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EmergencyAuthRule) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalTo(b)
	if err != nil {
		return nil, err
...
func (dst *EmergencyAuthRule) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EmergencyAuthRule.Merge(dst, src)
}
func (m *EmergencyAuthRule) XXX_Size() int {
	return m.Size()
}
func (m *EmergencyAuthRule) XXX_DiscardUnknown() {
	xxx_messageInfo_EmergencyAuthRule.DiscardUnknown(m)
}

var xxx_messageInfo_EmergencyAuthRule proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*EmergencyAuthRule)(nil), "cockroach.util.log.eventpb.EmergencyAuthRule")
}
...
func (m *EmergencyAuthRule) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *EmergencyAuthRule) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.SessionID != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintClusterEvents(dAtA, i, uint64(m.SessionID))
	}
	if len(m.Username) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintClusterEvents(dAtA, i, uint64(len(m.Username)))
	...
	if m.ExpiresAt != 0 {
		dAtA[i] = 0x28
		i++
		i = encodeVarintClusterEvents(dAtA, i, uint64(m.ExpiresAt))
	}
	return i, nil
}
...
func (m *EmergencyAuthRule) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	n += 1 + l + sovClusterEvents(uint64(l))
	if m.SessionID != 0 {
		n += 1 + sovClusterEvents(uint64(m.SessionID))
	}
	l = len(m.Username)
	if l > 0 {
		n += 1 + l + sovClusterEvents(uint64(l))
	...
	if m.ExpiresAt != 0 {
		n += 1 + sovClusterEvents(uint64(m.ExpiresAt))
	}
	return n
}
...
func (m *EmergencyAuthRule) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EmergencyAuthRule: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EmergencyAuthRule: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func init() {
	proto.RegisterFile("util/log/eventpb/cluster_events.proto", fileDescriptor_cluster_events_b5aa6d7c12f66885)
}

var fileDescriptor_cluster_events_b5aa6d7c12f66885 = []byte{
	// 609 bytes of a gzipped FileDescriptorProto
	,
}
