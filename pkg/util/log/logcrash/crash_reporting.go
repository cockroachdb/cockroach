...
func validateDiagnosticsEnabled(sv *settings.Values, b bool) error {
	...
	licenseSetting, ok := settings.LookupForLocalAccess("enterprise.license", true /* forSystemTenant */)
	if !ok {
