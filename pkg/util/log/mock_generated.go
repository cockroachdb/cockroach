...
func (m *MockLogSink) output(b []byte, opts sinkOutputOptions) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "output", b, opts)
	ret0, _ := ret[0].(error)
	return ret0
}

// output indicates an expected call of output.
func (mr *MockLogSinkMockRecorder) output(b, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "output", reflect.TypeOf((*MockLogSink)(nil).output), b, opts)
}
