...
const (
	...
	// name of the instrumentation library (which is supposed to create the logs)
	// we use a homegrown implementation so we can name it
	logIntrumentationLibrary = "cockroachdb.logger"
)
