...
// REPLICATION is used to report logical data replication events
// including row-level tracing of writes and reads.
const REPLICATION = logpb.Channel_REPLICATION
