...
// The `INFO` severity is used for informational messages that do not
// require action.
func (loggerChangefeed) InfofDepth(
	ctx context.Context, depth int, format string, args ...interface{},
) {
...
// The `WARNING` severity is used for situations which may require special handling,
// where normal operation is expected to resume automatically.
func (loggerChangefeed) VWarningf(
	ctx context.Context, level Level, format string, args ...interface{},
) {
	if VDepth(level, 1) {
		logfDepth(ctx, 1, severity.WARNING, channel.CHANGEFEED, format, args...)
...
// The `WARNING` severity is used for situations which may require special handling,
// where normal operation is expected to resume automatically.
func (loggerChangefeed) WarningfDepth(
	ctx context.Context, depth int, format string, args ...interface{},
) {
...
// where normal operation could not proceed as expected.
// Other operations can continue mostly unaffected.
func (loggerChangefeed) ErrorfDepth(
	ctx context.Context, depth int, format string, args ...interface{},
) {
...
// server shutdown. A report is also sent to telemetry if telemetry
// is enabled.
func (loggerChangefeed) FatalfDepth(
	ctx context.Context, depth int, format string, args ...interface{},
) {
...
// at the given depth in the call stack.
// The `CHANGEFEED` channel is used to report changefeed events
func (loggerChangefeed) VEventfDepth(
	ctx context.Context, depth int, level Level, format string, args ...interface{},
) {
...
// The `WARNING` severity is used for situations which may require special handling,
// where normal operation is expected to resume automatically.
func (loggerKvExec) WarningfDepth(
	ctx context.Context, depth int, format string, args ...interface{},
) {
...
// The `KV_EXEC` channel is used to report KV execution events that don't fall into the
// KV_DISTRIBUTION channel.
func (loggerKvExec) VEventfDepth(
	ctx context.Context, depth int, level Level, format string, args ...interface{},
) {
	vEventf(ctx, false /* isErr */, 1+depth, level, channel.KV_EXEC, format, args...)
}

// loggerReplication is the logger type for the REPLICATION channel.
type loggerReplication struct{}

// Replication is a logger that logs to the REPLICATION channel.
//
// The `REPLICATION` channel is used to report logical data replication events
// including row-level tracing of writes and reads.
var Replication loggerReplication

// Replication and loggerReplication implement ChannelLogger.
//
// We do not force use of ChannelLogger when instantiating the logger
// object above (e.g. by giving it the interface type), to ensure
// the calls to the API methods remain inlinable in the common case.
var _ ChannelLogger = Replication

// Infof logs to the REPLICATION channel with severity INFO.
// It extracts log tags from the context and logs them along with the given
// message. Arguments are handled in the manner of fmt.Printf.
//
// The `REPLICATION` channel is used to report logical data replication events
...
// The `INFO` severity is used for informational messages that do not
// require action.
func (loggerReplication) Infof(ctx context.Context, format string, args ...interface{}) {
	logfDepth(ctx, 1, severity.INFO, channel.REPLICATION, format, args...)
}

// VInfof logs to the REPLICATION channel with severity INFO,
// if logging has been enabled for the source file where the call is
// performed at the provided verbosity level, via the vmodule setting.
// It extracts log tags from the context and logs them along with the given
// message. Arguments are handled in the manner of fmt.Printf.
...
// Info logs to the REPLICATION channel with severity INFO.
// It extracts log tags from the context and logs them along with the given
// message.
//
// The `REPLICATION` channel is used to report logical data replication events
...
// The `INFO` severity is used for informational messages that do not
// require action.
func (loggerReplication) Info(ctx context.Context, msg string) {
	logfDepth(ctx, 1, severity.INFO, channel.REPLICATION, msg)
}

// InfofDepth logs to the REPLICATION channel with severity INFO,
// offsetting the caller's stack frame by 'depth'.
// It extracts log tags from the context and logs them along with the given
// message. Arguments are handled in the manner of fmt.Printf.
//
...
// The `INFO` severity is used for informational messages that do not
// require action.
func (loggerReplication) InfofDepth(
	ctx context.Context, depth int, format string, args ...interface{},
) {
	logfDepth(ctx, depth+1, severity.INFO, channel.REPLICATION, format, args...)
}

// Warningf logs to the REPLICATION channel with severity WARNING.
// It extracts log tags from the context and logs them along with the given
// message. Arguments are handled in the manner of fmt.Printf.
//
// The `REPLICATION` channel is used to report logical data replication events
...
// The `WARNING` severity is used for situations which may require special handling,
// where normal operation is expected to resume automatically.
func (loggerReplication) Warningf(ctx context.Context, format string, args ...interface{}) {
	logfDepth(ctx, 1, severity.WARNING, channel.REPLICATION, format, args...)
}

// VWarningf logs to the REPLICATION channel with severity WARNING,
// if logging has been enabled for the source file where the call is
// performed at the provided verbosity level, via the vmodule setting.
// It extracts log tags from the context and logs them along with the given
// message. Arguments are handled in the manner of fmt.Printf.
...
// The `WARNING` severity is used for situations which may require special handling,
// where normal operation is expected to resume automatically.
func (loggerReplication) VWarningf(
	ctx context.Context, level Level, format string, args ...interface{},
) {
	if VDepth(level, 1) {
		logfDepth(ctx, 1, severity.WARNING, channel.REPLICATION, format, args...)
...
// Warning logs to the REPLICATION channel with severity WARNING.
// It extracts log tags from the context and logs them along with the given
// message.
//
// The `REPLICATION` channel is used to report logical data replication events
...
// The `WARNING` severity is used for situations which may require special handling,
// where normal operation is expected to resume automatically.
func (loggerReplication) Warning(ctx context.Context, msg string) {
	logfDepth(ctx, 1, severity.WARNING, channel.REPLICATION, msg)
}

// WarningfDepth logs to the REPLICATION channel with severity WARNING,
// offsetting the caller's stack frame by 'depth'.
// It extracts log tags from the context and logs them along with the given
// message. Arguments are handled in the manner of fmt.Printf.
//
...
// The `WARNING` severity is used for situations which may require special handling,
// where normal operation is expected to resume automatically.
func (loggerReplication) WarningfDepth(
	ctx context.Context, depth int, format string, args ...interface{},
) {
	logfDepth(ctx, depth+1, severity.WARNING, channel.REPLICATION, format, args...)
}

// Errorf logs to the REPLICATION channel with severity ERROR.
// It extracts log tags from the context and logs them along with the given
// message. Arguments are handled in the manner of fmt.Printf.
//
// The `REPLICATION` channel is used to report logical data replication events
...
// where normal operation could not proceed as expected.
// Other operations can continue mostly unaffected.
func (loggerReplication) Errorf(ctx context.Context, format string, args ...interface{}) {
	logfDepth(ctx, 1, severity.ERROR, channel.REPLICATION, format, args...)
}

// VErrorf logs to the REPLICATION channel with severity ERROR,
// if logging has been enabled for the source file where the call is
// performed at the provided verbosity level, via the vmodule setting.
// It extracts log tags from the context and logs them along with the given
// message. Arguments are handled in the manner of fmt.Printf.
...
// where normal operation could not proceed as expected.
// Other operations can continue mostly unaffected.
func (loggerReplication) VErrorf(
	ctx context.Context, level Level, format string, args ...interface{},
) {
	if VDepth(level, 1) {
		logfDepth(ctx, 1, severity.ERROR, channel.REPLICATION, format, args...)
...
// Error logs to the REPLICATION channel with severity ERROR.
// It extracts log tags from the context and logs them along with the given
// message.
//
// The `REPLICATION` channel is used to report logical data replication events
...
// where normal operation could not proceed as expected.
// Other operations can continue mostly unaffected.
func (loggerReplication) Error(ctx context.Context, msg string) {
	logfDepth(ctx, 1, severity.ERROR, channel.REPLICATION, msg)
}

// ErrorfDepth logs to the REPLICATION channel with severity ERROR,
// offsetting the caller's stack frame by 'depth'.
// It extracts log tags from the context and logs them along with the given
// message. Arguments are handled in the manner of fmt.Printf.
//
...
// where normal operation could not proceed as expected.
// Other operations can continue mostly unaffected.
func (loggerReplication) ErrorfDepth(
	ctx context.Context, depth int, format string, args ...interface{},
) {
	logfDepth(ctx, depth+1, severity.ERROR, channel.REPLICATION, format, args...)
}

// Fatalf logs to the REPLICATION channel with severity FATAL.
// It extracts log tags from the context and logs them along with the given
// message. Arguments are handled in the manner of fmt.Printf.
//
// The `REPLICATION` channel is used to report logical data replication events
...
// server shutdown. A report is also sent to telemetry if telemetry
// is enabled.
func (loggerReplication) Fatalf(ctx context.Context, format string, args ...interface{}) {
	logfDepth(ctx, 1, severity.FATAL, channel.REPLICATION, format, args...)
}

// VFatalf logs to the REPLICATION channel with severity FATAL,
// if logging has been enabled for the source file where the call is
// performed at the provided verbosity level, via the vmodule setting.
// It extracts log tags from the context and logs them along with the given
// message. Arguments are handled in the manner of fmt.Printf.
...
// server shutdown. A report is also sent to telemetry if telemetry
// is enabled.
func (loggerReplication) VFatalf(
	ctx context.Context, level Level, format string, args ...interface{},
) {
	if VDepth(level, 1) {
		logfDepth(ctx, 1, severity.FATAL, channel.REPLICATION, format, args...)
...
// Fatal logs to the REPLICATION channel with severity FATAL.
// It extracts log tags from the context and logs them along with the given
// message.
//
// The `REPLICATION` channel is used to report logical data replication events
...
// server shutdown. A report is also sent to telemetry if telemetry
// is enabled.
func (loggerReplication) Fatal(ctx context.Context, msg string) {
	logfDepth(ctx, 1, severity.FATAL, channel.REPLICATION, msg)
}

// FatalfDepth logs to the REPLICATION channel with severity FATAL,
// offsetting the caller's stack frame by 'depth'.
// It extracts log tags from the context and logs them along with the given
// message. Arguments are handled in the manner of fmt.Printf.
//
...
// server shutdown. A report is also sent to telemetry if telemetry
// is enabled.
func (loggerReplication) FatalfDepth(
	ctx context.Context, depth int, format string, args ...interface{},
) {
	logfDepth(ctx, depth+1, severity.FATAL, channel.REPLICATION, format, args...)
}

// Shout logs to channel REPLICATION, and also to the real stderr if logging
// is currently redirected to a file.
//
// The `REPLICATION` channel is used to report logical data replication events
// including row-level tracing of writes and reads.
func (loggerReplication) Shout(ctx context.Context, sev Severity, msg string) {
	shoutfDepth(ctx, 1, sev, channel.REPLICATION, msg)
}

// Shoutf logs to channel REPLICATION, and also to the real stderr if
// logging is currently redirected to a file. Arguments are handled in
// the manner of fmt.Printf.
//
// The `REPLICATION` channel is used to report logical data replication events
// including row-level tracing of writes and reads.
func (loggerReplication) Shoutf(
	ctx context.Context, sev Severity, format string, args ...interface{},
) {
	shoutfDepth(ctx, 1, sev, channel.REPLICATION, format, args...)
}
...
// The `REPLICATION` channel is used to report logical data replication events
// including row-level tracing of writes and reads.
func (loggerReplication) VEvent(ctx context.Context, level Level, msg string) {
	vEvent(ctx, false /* isErr */, 1, level, channel.REPLICATION, msg)
}
...
// The `REPLICATION` channel is used to report logical data replication events
// including row-level tracing of writes and reads.
func (loggerReplication) VEventf(
	ctx context.Context, level Level, format string, args ...interface{},
) {
	vEventf(ctx, false /* isErr */, 1, level, channel.REPLICATION, format, args...)
}
...
// The `REPLICATION` channel is used to report logical data replication events
// including row-level tracing of writes and reads.
func (loggerReplication) VEventfDepth(
	ctx context.Context, depth int, level Level, format string, args ...interface{},
) {
	vEventf(ctx, false /* isErr */, 1+depth, level, channel.REPLICATION, format, args...)
}
