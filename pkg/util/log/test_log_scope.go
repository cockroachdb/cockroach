...
func ScopeWithoutShowLogs(t tShim) (sc *TestLogScope) {
	...
	sc.previous.stderrSinkInfo = logging.stderrSinkInfo
	sc.previous.channels = logging.channels
...
func (l *TestLogScope) Close(t tShim) {
	...
	logging.stderrSinkInfo = l.previous.stderrSinkInfo
	logging.channels = l.previous.channels
