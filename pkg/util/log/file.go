...
// TemporarilyDisableFileGC disables the file-based GC until the
...
func TemporarilyDisableFileGC() (cleanup func()) {
	oldLogLimit := atomic.LoadInt64(&logFilesCombinedMaxSize)
	atomic.CompareAndSwapInt64(&logFilesCombinedMaxSize, oldLogLimit, math.MaxInt64)
	return func() {
		atomic.CompareAndSwapInt64(&logFilesCombinedMaxSize, math.MaxInt64, oldLogLimit)
	}
}
