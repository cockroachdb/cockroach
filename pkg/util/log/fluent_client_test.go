...
func TestFluentClientEncodeEntry(t *testing.T) {
	...
	testCases := []struct {
		...
		{logpb.Entry{}, `
{"tag":"log.test.dev","c":0,"t":"0.000000000","s":0,"g":0,"f":"","l":0,"n":0,"r":0,"message":""}
`},
		{logpb.Entry{Time: tm.UnixNano(), Severity: severity.INFO, File: "hello", Goroutine: 876, Line: 432, Counter: 543, Redactable: true}, `
{"tag":"log.test.dev","c":0,"t":"1136214245.654321000","s":1,"sev":"I","g":876,"f":"hello","l":432,"n":543,"r":1,"message":""}
`},
...
{"tag":"log.test.dev","c":0,"t":"0.000000000","s":0,"g":0,"f":"","l":0,"n":0,"r":0,"tags":"hai","message":"hello\nsnowman \"☃\""}
`},
	}

	for _, tc := range testCases {
		var f formatFluentJSON
