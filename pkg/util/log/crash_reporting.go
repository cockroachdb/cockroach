...
var (
	...
	// ReportUnanonymized enables reporting of unanonymized data.
	//
	...
	ReportUnanonymized = envutil.EnvOrDefaultBool("COCKROACH_REPORT_UNANONYMIZED", false)
)
