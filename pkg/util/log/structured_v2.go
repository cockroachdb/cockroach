...
func structuredEvent(ctx context.Context, sev logpb.Severity, event logpb.EventPayload, depth int) {
...
func logStructured(ctx context.Context, entry logEntry) {
