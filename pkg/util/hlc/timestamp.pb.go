...
const (
	...
	// writes for the purposes of tracking causality between the write and
	// its observers.
...
func (TimestampFlag) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_timestamp_d0260c54e366d430, []int{0}
}
...
func init() { proto.RegisterFile("util/hlc/timestamp.proto", fileDescriptor_timestamp_d0260c54e366d430) }

var fileDescriptor_timestamp_d0260c54e366d430 = []byte{
