...
func (TimestampFlag) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_timestamp_3d06174efd2169e7, []int{0}
}
...
func init() {
	proto.RegisterFile("util/hlc/timestamp.proto", fileDescriptor_timestamp_3d06174efd2169e7)
}

var fileDescriptor_timestamp_3d06174efd2169e7 = []byte{
