...
func (*LegacyTimestamp) Descriptor() ([]byte, []int) {
	return fileDescriptor_legacy_timestamp_2982002a070840ce, []int{0}
}
...
func init() {
	proto.RegisterFile("util/hlc/legacy_timestamp.proto", fileDescriptor_legacy_timestamp_2982002a070840ce)
}

var fileDescriptor_legacy_timestamp_2982002a070840ce = []byte{
