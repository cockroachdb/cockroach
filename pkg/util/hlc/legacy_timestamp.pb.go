...
func (*LegacyTimestamp) Descriptor() ([]byte, []int) {
	return fileDescriptor_legacy_timestamp_33176654823ca650, []int{0}
}
...
func init() {
	proto.RegisterFile("util/hlc/legacy_timestamp.proto", fileDescriptor_legacy_timestamp_33176654823ca650)
}

var fileDescriptor_legacy_timestamp_33176654823ca650 = []byte{
