...
func (*LegacyTimestamp) Descriptor() ([]byte, []int) {
	return fileDescriptor_legacy_timestamp_d07ba6e8cfcb51fb, []int{0}
}
...
func init() {
	proto.RegisterFile("util/hlc/legacy_timestamp.proto", fileDescriptor_legacy_timestamp_d07ba6e8cfcb51fb)
}

var fileDescriptor_legacy_timestamp_d07ba6e8cfcb51fb = []byte{
