...
type LegacyTimestamp struct {
	...
	// Indicates whether the Timestamp came from an HLC clock somewhere in
	// the system and has the capability of being able to update a peer's
	// HLC clock.
	//
	// See the commentary on Timestamp.from_clock for more information.
	//
	...
	FromClock *bool `protobuf:"varint,3,opt,name=from_clock,json=fromClock" json:"from_clock,omitempty"`
}

func (m *LegacyTimestamp) Reset()      { *m = LegacyTimestamp{} }
func (*LegacyTimestamp) ProtoMessage() {}
func (*LegacyTimestamp) Descriptor() ([]byte, []int) {
	return fileDescriptor_legacy_timestamp_090ebc9caacabb16, []int{0}
}
...
func (this *LegacyTimestamp) Equal(that interface{}) bool {
	...
	if this.FromClock != nil && that1.FromClock != nil {
		if *this.FromClock != *that1.FromClock {
			return false
		}
	} else if this.FromClock != nil {
		return false
	} else if that1.FromClock != nil {
		return false
	}
	return true
}
...
func init() {
	proto.RegisterFile("util/hlc/legacy_timestamp.proto", fileDescriptor_legacy_timestamp_090ebc9caacabb16)
}

var fileDescriptor_legacy_timestamp_090ebc9caacabb16 = []byte{
	...
	,
}
