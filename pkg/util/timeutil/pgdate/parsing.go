...
var (
	...
	// The next microsecond after "MaxSupportedTime". (294277-01-01 00:00:00 +0000 UTC)
	TimeInfinity    = timeutil.Unix(9224318016000, 0)
	TimeInfinitySec = float64(TimeInfinity.Unix()) // 9224318016000
	// The previous microsecond before "MinSupportedTime". (-4713-11-23 23:59:59.999999 +0000 UTC)
	TimeNegativeInfinity    = timeutil.Unix(-210866803201, 999999000)
	TimeNegativeInfinitySec = float64(TimeNegativeInfinity.Unix()) // -210866803201
)
