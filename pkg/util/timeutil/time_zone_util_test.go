...
func TestTimeZoneStringToLocation(t *testing.T) {
	...
	testCases := []struct {
		...
		{`GMT+3:00`, TimeZoneStringToLocationISO8601Standard, FixedOffsetTimeZoneToLocation(-3*60*60, "GMT+3:00"), true},
		{`UTC-3:00`, TimeZoneStringToLocationISO8601Standard, FixedOffsetTimeZoneToLocation(3*60*60, "UTC-3:00"), true},
		{`UTC+3:00`, TimeZoneStringToLocationISO8601Standard, FixedOffsetTimeZoneToLocation(-3*60*60, "UTC+3:00"), true},
		...
		{`GMT-3:00`, TimeZoneStringToLocationPOSIXStandard, FixedOffsetTimeZoneToLocation(3*60*60, "GMT-3:00"), true},
		{`GMT+3:00`, TimeZoneStringToLocationPOSIXStandard, FixedOffsetTimeZoneToLocation(-3*60*60, "GMT+3:00"), true},
		{`UTC-3:00`, TimeZoneStringToLocationPOSIXStandard, FixedOffsetTimeZoneToLocation(3*60*60, "UTC-3:00"), true},
		{`UTC+3:00`, TimeZoneStringToLocationPOSIXStandard, FixedOffsetTimeZoneToLocation(-3*60*60, "UTC+3:00"), true},

		{"fixed offset:43200 (12)", TimeZoneStringToLocationISO8601Standard, FixedOffsetTimeZoneToLocation(12*60*60, "12"), true},
		{"fixed offset:43200 (12)", TimeZoneStringToLocationPOSIXStandard, FixedOffsetTimeZoneToLocation(12*60*60, "12"), true},
	}
