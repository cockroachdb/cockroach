...
func TestTimeZoneStringToLocation(t *testing.T) {
	...
	testCases := []struct {
		...
		{"-10:30", TimeZoneStringToLocationISO8601Standard, FixedTimeZoneStringToLocation((10*60*60 + 30*60), "-10:30"), true},
		{"10:30", TimeZoneStringToLocationISO8601Standard, FixedTimeZoneStringToLocation(-(10*60*60 + 30*60), "10:30"), true},
		{`GMT-3:00`, TimeZoneStringToLocationISO8601Standard, FixedTimeZoneStringToLocation(3*60*60, "GMT-3:00"), true},
		{`GMT+3:00`, TimeZoneStringToLocationISO8601Standard, FixedTimeZoneStringToLocation(-3*60*60, "GMT+3:00"), true},
		{`UTC-3:00`, TimeZoneStringToLocationISO8601Standard, FixedTimeZoneStringToLocation(3*60*60, "UTC-3:00"), true},
		{`UTC+3:00`, TimeZoneStringToLocationISO8601Standard, FixedTimeZoneStringToLocation(-3*60*60, "UTC+3:00"), true},
		...
		{" +10", TimeZoneStringToLocationPOSIXStandard, TimeZoneOffsetToLocation(-10 * 60 * 60), true},
		{" -10", TimeZoneStringToLocationPOSIXStandard, TimeZoneOffsetToLocation(10 * 60 * 60), true},
		{`GMT-3:00`, TimeZoneStringToLocationPOSIXStandard, FixedTimeZoneStringToLocation(3*60*60, "GMT-3:00"), true},
		{"asdf", TimeZoneStringToLocationPOSIXStandard, nil, false},
		{"-10:30", TimeZoneStringToLocationPOSIXStandard, FixedTimeZoneStringToLocation((10*60*60 + 30*60), "-10:30"), true},
		{"10:30", TimeZoneStringToLocationPOSIXStandard, FixedTimeZoneStringToLocation(-(10*60*60 + 30*60), "10:30"), true},
		{`GMT-3:00`, TimeZoneStringToLocationPOSIXStandard, FixedTimeZoneStringToLocation(3*60*60, "GMT-3:00"), true},
		{`GMT+3:00`, TimeZoneStringToLocationPOSIXStandard, FixedTimeZoneStringToLocation(-3*60*60, "GMT+3:00"), true},
		{`UTC-3:00`, TimeZoneStringToLocationPOSIXStandard, FixedTimeZoneStringToLocation(3*60*60, "UTC-3:00"), true},
		{`UTC+3:00`, TimeZoneStringToLocationPOSIXStandard, FixedTimeZoneStringToLocation(-3*60*60, "UTC+3:00"), true},
	}
