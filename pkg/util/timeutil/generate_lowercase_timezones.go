...
func main() {
	...
	zipdataFile, err := os.Open(filepath.Join(runtime.GOROOT(), "src", "lib", "time", "zoneinfo.zip"))
	if err != nil {
...
func loadFromTZData(z string) ([]string, error) {
	...
	for i := 0; i < n; i++ {
		...
		if meth != 0 {
			return nil, errors.New("unsupported compression for " + zname + " in embedded tzdata")
		}
	}
