...
type Path interface {
	...
	Validate(vars map[string]struct{}, nestingLevel int, insideArraySubscript bool) error
}
...
func (a Any) Validate(vars map[string]struct{}, nestingLevel int, insideArraySubscript bool) error {
	return nil
}
