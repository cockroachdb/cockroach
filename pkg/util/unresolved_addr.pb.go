...
func (*UnresolvedAddr) Descriptor() ([]byte, []int) {
	return fileDescriptor_unresolved_addr_dc9f224edd64f5a1, []int{0}
}
...
func init() {
	proto.RegisterFile("util/unresolved_addr.proto", fileDescriptor_unresolved_addr_dc9f224edd64f5a1)
}

var fileDescriptor_unresolved_addr_dc9f224edd64f5a1 = []byte{
