...
// SplitHostPort is like net.SplitHostPort with the following added feature:
// - it supports addresses without a port number. In that case, the
//   provided port number is used.
// - it recognizes an IPv6 address is provided without [...] and no port number.
