...
func TestIPNetParseInet(t *testing.T) {
	testCases := []struct {
		...
		// Edge cases.
		{"0.0.0.0", &IPNet{Family: IPv4Family, IPNet: net.IPNet{IP: net.IPv4zero, Mask: net.CIDRMask(32, 32)}}, ""},
		{"0.0.0.0/32", &IPNet{Family: IPv4Family, IPNet: net.IPNet{IP: net.IPv4zero, Mask: net.CIDRMask(32, 32)}}, ""},
		{"0.0.0.0/0", &IPNet{Family: IPv4Family, IPNet: net.IPNet{IP: net.IPv4zero, Mask: net.CIDRMask(0, 32)}}, ""},
		{"0.0.0.0/10", &IPNet{Family: IPv4Family, IPNet: net.IPNet{IP: net.IPv4zero, Mask: net.CIDRMask(10, 32)}}, ""},

		{"255.255.255.255", &IPNet{Family: IPv4Family, IPNet: net.IPNet{IP: net.IPv4bcast, Mask: net.CIDRMask(32, 32)}}, ""},
		{"255.255.255.255/32", &IPNet{Family: IPv4Family, IPNet: net.IPNet{IP: net.IPv4bcast, Mask: net.CIDRMask(32, 32)}}, ""},
		{"255.255.255.255/0", &IPNet{Family: IPv4Family, IPNet: net.IPNet{IP: net.IPv4bcast, Mask: net.CIDRMask(0, 32)}}, ""},
		{"255.255.255.255/10", &IPNet{Family: IPv4Family, IPNet: net.IPNet{IP: net.IPv4bcast, Mask: net.CIDRMask(10, 32)}}, ""},

		{"::0", &IPNet{Family: IPv6Family, IPNet: net.IPNet{IP: net.IPv6zero, Mask: net.CIDRMask(128, 128)}}, ""},
		{"::0/0", &IPNet{Family: IPv6Family, IPNet: net.IPNet{IP: net.IPv6zero, Mask: net.CIDRMask(0, 128)}}, ""},
		{"::0/10", &IPNet{Family: IPv6Family, IPNet: net.IPNet{IP: net.IPv6zero, Mask: net.CIDRMask(10, 128)}}, ""},
