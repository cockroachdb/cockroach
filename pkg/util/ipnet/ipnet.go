...
// IP family denotes which classification the IP belongs to.
const (
	IPv4Family int = iota
	IPv6Family
)
...
// batch allocation on the []byte that CIDRMask makes otherwise.
func populateMask(mask net.IPMask, ones uint, family int) net.IPMask {
	var maskSize int
