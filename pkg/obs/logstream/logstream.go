...
// passed to log.Structured. If you're looking to create a new structured log processor externally, See the
// LogProcessor interface for a more convenient way, to be used in conjunction with StructuredLogProcessor.
type Processor interface {
	// Process processes a single log stream event.
	process(context.Context, any) error
}

// RegisterProcessor registers the given StructuredLogProcessor to consume all log stream events of
