...
func TestWatcher(t *testing.T) {
	...
	r.Exec(t, `INSERT INTO system.cluster_metrics (id, name, labels, type, value, node_id, unit, help_text, measurement)
		VALUES (100, 'cpu.percent', '{"node": "1"}',
			'gauge', 55, 1, 0, 'CPU usage', 'percent')`)
	r.Exec(t, `INSERT INTO system.cluster_metrics (id, name, labels, type, value, node_id, unit, help_text, measurement)
		VALUES (200, 'mem.bytes', '{}', 'gauge', 1024, 1, 1, 'Memory usage', 'bytes')`)
	...
	r.Exec(t, `INSERT INTO system.cluster_metrics (id, name, labels, type, value, node_id, unit, help_text, measurement)
		VALUES (300, 'disk.iops', '{}', 'counter', 999, 2, 0, 'Disk IOPS', 'ops')`)
	...
	r.Exec(t, `UPSERT INTO system.cluster_metrics (id, name, labels, type, value, node_id, unit, help_text, measurement)
		VALUES (100, 'cpu.percent', '{"node": "1"}',
			'gauge', 75, 1, 0, 'CPU usage', 'percent')`)
