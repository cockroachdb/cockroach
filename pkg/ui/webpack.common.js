// This file contains webpack configuration shared by the Apache and CCL build
// configurations of the Admin UI.
...
module.exports = function webpackConfig(...additionalRoots) {
  ...
  return {
    ...
    resolve: {
      ...
      modules: additionalRoots.concat(path.resolve(__dirname), path.resolve(__dirname, "node_modules")),
    },
    ...
    module: {
      rules: [
        ...
        {
          test: /\.tsx?$/,
          include: additionalRoots.map(addSrc).concat(path.resolve(__dirname, "src")),
          use: [
            "cache-loader",
            "babel-loader",
