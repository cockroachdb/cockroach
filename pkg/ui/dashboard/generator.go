...
func (g *Generator) sortChartsByConfigOrder(allChartTitles []string, configOrder []string) []string {
...
func (g *Generator) generateTypeScriptFile(generatedDashboard GeneratedDashboard, outputDir, dashboardName string) error {
