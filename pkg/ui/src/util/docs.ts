...
export const howAreCapacityMetricsCalculatedOverview = docsURL("admin-ui-cluster-overview-page.html#capacity-metrics");
export const keyValuePairs = docsURL("architecture/distribution-layer.html#table-data");
export const writeIntents = docsURL("architecture/transaction-layer.html#write-intents");
export const metaRanges = docsURL("architecture/distribution-layer.html#meta-ranges");
