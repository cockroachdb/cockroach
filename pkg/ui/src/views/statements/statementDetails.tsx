...
class StatementDetails extends React.Component<StatementDetailsProps, StatementDetailsState> {
  ...
  renderContent = () => {
    ...
    const { stats, statement, app, distSQL, opt, failed, implicitTransaction } = this.props.statement;
        ...
        <div className="l-columns__right">
          ...
          <table className="numeric-stats-table">
            <tbody>
              ...
              <tr className="numeric-stats-table__row--body">
                <th className="numeric-stats-table__cell" style={{ textAlign: "left" }}>Implicit Txn?</th>
                <td className="numeric-stats-table__cell" style={{ textAlign: "right" }}>{ renderBools(implicitTransaction) }</td>
              </tr>
              <tr className="numeric-stats-table__row--body">
...
export const selectStatement = createSelector(
  ...
  (statements, props) => {
    ...
    return {
      ...
      implicitTransaction: fractionMatching(results, s => s.implicitTransaction),
