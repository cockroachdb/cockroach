...
const mapStateToProps = (state: AdminUIState, props: StatementDetailsProps): StatementDetailsStateProps => {
  ...
  return {
    ...
    diagnosticsReports: selectDiagnosticsReportsByStatementFingerprint(state, statementFingerprint),
  };
};
...
const mapDispatchToProps: StatementDetailsDispatchProps = {
  ...
  dismissStatementDiagnosticsAlertMessage: () => createStatementDiagnosticsAlertLocalSetting.set({ show: false }),
