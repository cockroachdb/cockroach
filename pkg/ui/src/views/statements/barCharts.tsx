...
const latencyStdDev = bar("latency-overall-dev", (d: StatementStatistics) =>
  stdDevLong(d.stats.service_lat, d.stats.count),
);
const rowsStdDev = bar("rows-dev", (d: StatementStatistics) =>
    ...
    return function renderBarChart(d: StatementStatistics) {
      ...
      if (stdDevAccessor) {
        ...
        return (
          <div
            className={
              "bar-chart" + (rows.length === 0 ? " bar-chart--singleton" : "")
            }
          >
