...
export class PlanView extends React.Component<PlanViewProps, PlanViewState> {
  ...
  showExpandDirections() {
    ...
    const innerContainer = document.getElementById("plan-view-inner-container");
    return innerContainer.scrollHeight > innerContainer.clientHeight;
  }
        ...
        <tr className="plan-view-table__row--body">
          <td className="plan-view plan-view-table__cell" style={{ textAlign: "left" }}>
            <div className="plan-view-container">
              <div id="plan-view-inner-container" className={this.state.expanded ? "" : "plan-view-container-scroll"}>
                <PlanNodes
