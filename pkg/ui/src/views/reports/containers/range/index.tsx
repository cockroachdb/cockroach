...
interface RangeOwnProps {
  ...
  allocatorRange: CachedDataReducerState<protos.cockroach.server.serverpb.AllocatorRangeResponse>;
  ...
  render() {
    ...
    return (
      <div className="section">
        ...
        <AllocatorOutput allocatorRangeResponse={this.props.allocatorRange} />
...
function mapStateToProps(state: AdminUIState, props: RangeProps) {
  ...
  return {
    ...
    allocatorRange: state.cachedData.allocatorRange[rangeID],
