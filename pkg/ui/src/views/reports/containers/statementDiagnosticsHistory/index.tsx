      ...
      <section className="section">
        ...
        <StatementDiagnosticsHistoryTable
          ...
          emptyProps={{
            ...
            description:
              "Statement diagnostics can help when troubleshooting issues with specific queries. The diagnostic bundle can be activated from individual statement pages and will include EXPLAIN plans, table statistics, and traces.",
            label: "Learn more",
