...
export class Search extends React.Component<TSearchProps, ISearchState> {
      ...
      if (submitted) {
        return (
          <Button
            ...
            type="default"
            className={styles["_clear-search"]}
          >
            <img className={styles["_suffix-icon"]} src={CancelIcon} />
          </Button>
        );
      }
      return <Button type="default" htmlType="submit" className={styles["_submit-search"]}>Enter</Button>;
    }
    return null;
  }
  ...
  render() {
    ...
    */
    ...
    return (
      <Form onSubmit={this.onSubmit} className={styles["_search-form"]}>
        <Form.Item>
          <MyInput
            className={className}
            placeholder="Search Statement"
            onChange={this.onChange}
            prefix={<img className={styles["_prefix-icon"]} src={SearchIcon} />}
