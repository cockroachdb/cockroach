...
export class Search extends React.Component<TSearchProps, ISearchState> {
  ...
  renderSuffix = () => {
    ...
    if (value.length > 0) {
      if (submitted) {
        return <Button onClick={this.onClear} type="link" className="_clear-search" icon="close" />;
      }
      return <Button type="link" htmlType="submit" className="_submit-search">Enter</Button>;
    }
    return null;
  }
