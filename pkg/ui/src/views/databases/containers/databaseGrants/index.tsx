...
export class DatabaseSummaryGrants extends DatabaseSummaryBase {
  ...
  noDatabaseResults = () => (
    <>
      <h3 className="table__no-results--title"><DatabaseIcon />No users have been granted access to this database.</h3>
      <p className="table__no-results--description">
        <a href={privileges} target="_blank">Read more about privileges.</a>
      </p>
    </>
  )
