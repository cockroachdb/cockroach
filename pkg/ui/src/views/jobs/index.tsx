...
import spinner from "!!raw-loader!assets/spinner.gif";
...
class JobStatusCell extends React.Component<{ job: Job }, {}> {
  ...
  renderProgress() {
    if (this.is(JOB_STATUS_SUCCEEDED, JOB_STATUS_FAILED, JOB_STATUS_CANCELLED)) {
      return (
        <div className="jobs-table__status">
          {this.props.job.status !== JOB_STATUS_CANCELLED
            ? <div
