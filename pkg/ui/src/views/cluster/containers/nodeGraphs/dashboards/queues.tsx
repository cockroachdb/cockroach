  ...
  return [
    <LineGraph title="Queue Processing Failures" sources={storeSources}>
      <Axis units={AxisUnits.Count} label="failures">
        ...
        />
        <Metric
          name="cr.store.compactor.compactions.failure"
          title="Compaction"
          nonNegativeRate
        />
      </Axis>
    ...
    <LineGraph title="Queue Processing Times" sources={storeSources}>
      <Axis units={AxisUnits.Duration} label="processing time">
        ...
        />
        <Metric
          name="cr.store.compactor.compactingnanos"
          title="Compaction"
          nonNegativeRate
        />
      </Axis>
    ...
    >
      <Axis units={AxisUnits.Bytes} label="bytes">
        <Metric
          name="cr.store.compactor.suggestionbytes.compacted"
          title="Bytes compacted / sec"
          nonNegativeRate
        />
        <Metric
          name="cr.store.compactor.suggestionbytes.queued"
          title="Queued bytes"
          downsampleMax
        />
      </Axis>
