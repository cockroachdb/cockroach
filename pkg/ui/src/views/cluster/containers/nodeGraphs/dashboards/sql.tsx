...
export default function (props: GraphDashboardProps) {
  ...
  return [
    ...
    <LineGraph
      ...
      tooltip={
        <div>
          Over the last minute, this node executed 99% of transactions within this time.&nbsp;
        <em>
    ...
    <LineGraph
      ...
      tooltip={
        <div>
          Over the last minute, this node executed 90% of transactions within this time.&nbsp;
        <em>
          This time does not include network latency between the node and client.
        </em>
      </div>
