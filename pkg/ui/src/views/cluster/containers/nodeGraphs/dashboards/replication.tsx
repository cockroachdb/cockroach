  ...
  return [
    ...
    <LineGraph
      ...
      tooltip={(
        ...
        <br/>
        Quiesced replicas have no pending reads or writes and have temporarily disabled Raft's.
        </div>
      )}
    >
      <Axis label="replicas">
    ...
    <LineGraph title="Range Operations" sources={storeSources} tooltip={`Ranges with split, add, or remove operations ${tooltipSelection}.`}>
      <Axis label="ranges">
