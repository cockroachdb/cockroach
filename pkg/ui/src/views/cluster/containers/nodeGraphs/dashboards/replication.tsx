  ...
  return [
    <LineGraph title="Ranges" sources={storeSources}>
      <Axis label="ranges">
        ...
        <Metric name="cr.store.ranges.underreplicatedForConfig" title="Under-replicated for config" />
        <Metric name="cr.store.ranges.overreplicated" title="Over-replicated" />
        <Metric name="cr.store.ranges.overreplicatedForConfig" title="Over-replicated for config" />
      </Axis>
    </LineGraph>,
