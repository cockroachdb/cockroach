...
import { LiveBytesTooltip, KeyBytesTooltip, ValueBytesTooltip, IntentBytesTooltip, SysBytesTooltip, NodeUsedCapacityTooltip, NodeAvailableCapacityTooltip, NodeTotalCapacityTooltip } from "./tooltips";
            ...
            <table className="table">
              ...
              <tbody>
                ...
                <TableRow data={node}
                          ...
                          nodeName={nodesSummary.nodeDisplayNameByID[node.desc.node_id]}
                          CellTooltip={NodeTotalCapacityTooltip} />
              </tbody>
            </table>
          </div>
