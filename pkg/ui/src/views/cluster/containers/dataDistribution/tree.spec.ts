...
import {
  flatten,
  layoutTree, sumValuesUnderPaths, TreePath,
} from "./tree";
...
describe("tree", () => {
  ...
  describe("layoutTree", () => {
    ...
    it("inserts placeholders under a collapsed node, if other subtrees are deeper", () => {
      ...
      // | c | d | f | g |
      const expectedLayout = [
        [ { width: 4, depth: 3, name: "a", path: [], isCollapsed: false, isPlaceholder: false } ],
        [ { width: 2, depth: 2, path: [ "b" ], name: "b", isCollapsed: false, isPlaceholder: false },
          { width: 2, depth: 2, path: [ "e" ], name: "e", isCollapsed: false, isPlaceholder: false },
        ],
      ...
      const expectedLayoutCollapseBE = [
        [ { width: 2, depth: 3, name: "a", path: [], isCollapsed: false, isPlaceholder: false } ],
