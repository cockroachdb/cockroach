...
describe("tree", () => {
  ...
  describe("layoutTree", () => {
    ...
    it("lays out a simple tree", () => {
      ...
      const expectedLayout: LayoutNode<string>[][] = [
        [ { width: 2, depth: 2, data: "a", path: [], isCollapsed: false, isPlaceholder: false } ],
        [
    ...
    it("lays out a tree of inconsistent depth, inserting a placeholder", () => {
      ...
      const expectedLayout = [
        [ { width: 3, depth: 3, data: "a", path: [], isCollapsed: false, isPlaceholder: false } ],
        [ { width: 1, depth: 1, path: ["b"], data: "b", isCollapsed: false, isPlaceholder: true },
          { width: 2, depth: 2, data: "c", path: ["c" ], isCollapsed: false, isPlaceholder: false },
        ],
        [ { width: 1, depth: 1, path: ["b"], data: "b", isCollapsed: false, isPlaceholder: false },
          { width: 1, depth: 1, path: ["c", "d"], data: "d", isCollapsed: false, isPlaceholder: false },
          { width: 1, depth: 1, path: ["c", "e"], data: "e", isCollapsed: false, isPlaceholder: false },
        ],
      ];
    ...
    it("inserts placeholders under a collapsed node, if other subtrees are deeper", () => {
      ...
      // | c | d | f | g |
      const expectedLayout = [
        [ { width: 4, depth: 3, data: "a", path: [], isCollapsed: false, isPlaceholder: false } ],
        [ { width: 2, depth: 2, path: ["b"], data: "b", isCollapsed: false, isPlaceholder: false },
          { width: 2, depth: 2, path: ["e"], data: "e", isCollapsed: false, isPlaceholder: false },
        ],
        [ { width: 1, depth: 1, path: ["b", "c"], data: "c", isCollapsed: false, isPlaceholder: false },
          { width: 1, depth: 1, path: ["b", "d"], data: "d", isCollapsed: false, isPlaceholder: false },
          { width: 1, depth: 1, path: ["e", "f"], data: "f", isCollapsed: false, isPlaceholder: false },
          { width: 1, depth: 1, path: ["e", "g"], data: "g", isCollapsed: false, isPlaceholder: false },
        ],
      ];
      const actualLayout = layoutTree(tree, []);
      assert.deepEqual(actualLayout, expectedLayout);
      ...
      const expectedLayoutCollapseE = [
        [ { width: 3, depth: 3, data: "a", path: [], isCollapsed: false, isPlaceholder: false } ],
        [ { width: 2, depth: 2, path: ["b"], data: "b", isCollapsed: false, isPlaceholder: false },
          { width: 1, depth: 2, path: ["e"], data: "e", isCollapsed: true, isPlaceholder: false },
        ],
        [ { width: 1, depth: 1, path: ["b", "c"], data: "c", isCollapsed: false, isPlaceholder: false },
          { width: 1, depth: 1, path: ["b", "d"], data: "d", isCollapsed: false, isPlaceholder: false },
          { width: 1, depth: 1, path: ["e"], data: "e", isCollapsed: false, isPlaceholder: true },
        ],
      ];
      ...
      const expectedLayoutCollapseBE: LayoutNode<string>[][] = [
        [ { width: 2, depth: 3, data: "a", path: [], isCollapsed: false, isPlaceholder: false } ],
        [ { width: 1, depth: 2, path: ["b"], data: "b", isCollapsed: true, isPlaceholder: false },
          { width: 1, depth: 2, path: ["e"], data: "e", isCollapsed: true, isPlaceholder: false },
        ],
      ];
  ...
  describe("flatten", () => {
    ...
    describe("with inclueNodes = false", () => {
