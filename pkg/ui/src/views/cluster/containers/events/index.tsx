...
export function getEventInfo(e: Event$Properties): SimplifiedEvent {
  ...
  switch (e.event_type) {
    ...
    case eventTypes.FINISH_SCHEMA_CHANGE:
      content = <span>Schema Change Finished: Schema change with ID {info.MutationID} was completed.</span>;
      break;
    case eventTypes.FINISH_SCHEMA_CHANGE_ROLLBACK:
      content = <span>Schema Change Rollback Finished: Rollback of schema change with ID {info.MutationID} was completed.</span>;
      break;
