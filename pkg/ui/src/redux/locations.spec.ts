 ...
 * properties are typed as the $Properties variant.  And the $Properties variant
 ...
 * Location$Properties (which we hide behind the imported type Location, which
 * is, admittedly, probably a bad idea, too).  Unfortunately, since they're
 * actually protobuf-generated classes, they have a bunch of other stuff in
 * addition to the properties we care about.
 *
