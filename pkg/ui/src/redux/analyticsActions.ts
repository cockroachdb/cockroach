...
export const TRACK_DOWNLOAD_DIAGNOSTIC_BUNDLE = "cockroachui/analytics/TRACK_DOWNLOAD_DIAGNOSTIC_BUNDLE";
export const TRACK_STATEMENT_DETAILS_SUBNAV_SELECTION = "cockroachui/analytics/TRACK_STATEMENT_DETAILS_SUBNAV_SELECTION";
...
export function trackDownloadDiagnosticsBundleAction(statementFingerprint: string): PayloadAction<string> {
  return {
...
export function trackStatementDetailsSubnavSelectionAction(tabName: string): PayloadAction<string> {
  return {
