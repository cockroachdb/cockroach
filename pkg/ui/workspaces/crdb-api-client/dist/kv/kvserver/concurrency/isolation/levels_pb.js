...
// @generated from file kv/kvserver/concurrency/isolation/levels.proto (package cockroach.kv.kvserver.concurrency.isolation, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 *
 * @generated from enum cockroach.kv.kvserver.concurrency.isolation.Level
 */
export const Level = proto3.makeEnum(
  "cockroach.kv.kvserver.concurrency.isolation.Level",
  [
    {no: 0, name: "Serializable"},
    {no: 1, name: "Snapshot"},
    {no: 2, name: "ReadCommitted"},
  ],
);
