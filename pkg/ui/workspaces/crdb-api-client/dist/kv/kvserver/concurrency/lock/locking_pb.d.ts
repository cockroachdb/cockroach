...
import type { Level } from "../isolation/levels_pb.js";
...
export declare enum Strength {
   ...
   *
   * @generated from enum value: Exclusive = 3;
   */
  Exclusive = 3,
   ...
   *
   * @generated from enum value: Intent = 4;
   */
  Intent = 4,
}
...
export declare enum Durability {
   ...
   *
   * @generated from enum value: Unreplicated = 0;
   */
  Unreplicated = 0,
   ...
   *
   * @generated from enum value: Replicated = 1;
   */
  Replicated = 1,
}
 ...
 */
export declare enum WaitPolicy {
  /**
   ...
   *
   * @generated from enum value: SkipLocked = 2;
   */
  SkipLocked = 2,
}
...
export declare class Mode extends Message<Mode> {
   ...
   *
   * @generated from field: cockroach.kv.kvserver.concurrency.lock.Strength strength = 1;
   */
  strength: Strength;
   ...
   *
   * @generated from field: cockroach.kv.kvserver.concurrency.isolation.Level iso_level = 3;
   */
  isoLevel: Level;

  constructor(data?: PartialMessage<Mode>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "cockroach.kv.kvserver.concurrency.lock.Mode";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): Mode;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): Mode;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): Mode;

  static equals(a: Mode | PlainMessage<Mode> | undefined, b: Mode | PlainMessage<Mode> | undefined): boolean;
}
