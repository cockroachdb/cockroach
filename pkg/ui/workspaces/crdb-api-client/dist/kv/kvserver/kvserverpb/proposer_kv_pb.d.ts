...
import type { ChangeReplicasTrigger, MergeTrigger, Span, SplitTrigger } from "../../../roachpb/data_pb.js";
import type { MVCCStats } from "../../../storage/enginepb/mvcc_pb.js";
import type { ChecksumMode } from "../../kvpb/api_pb.js";
...
import type { MVCCLogicalOp, MVCCStatsDelta } from "../../../storage/enginepb/mvcc3_pb.js";
import type { RaftTruncatedState } from "./internal_raft_pb.js";
import type { ReadSummary } from "../readsummary/rspb/summary_pb.js";
 ...
 */
export declare class Split extends Message<Split> {
  /**
   * @generated from field: cockroach.roachpb.SplitTrigger trigger = 1;
   */
   ...
   *
   * @generated from field: cockroach.storage.enginepb.MVCCStats rhs_delta = 2;
   */
  rhsDelta?: MVCCStats;

  constructor(data?: PartialMessage<Split>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "cockroach.kv.kvserver.storagepb.Split";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): Split;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): Split;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): Split;

  static equals(a: Split | PlainMessage<Split> | undefined, b: Split | PlainMessage<Split> | undefined): boolean;
}
 ...
 */
export declare class Merge extends Message<Merge> {
  /**
   * @generated from field: cockroach.roachpb.MergeTrigger trigger = 1;
   */
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "cockroach.kv.kvserver.storagepb.Merge";
  static readonly fields: FieldList;
 ...
 */
export declare class ChangeReplicas extends Message<ChangeReplicas> {
  /**
   * @generated from field: cockroach.roachpb.ChangeReplicasTrigger trigger = 1;
   */
  trigger?: ChangeReplicasTrigger;

  constructor(data?: PartialMessage<ChangeReplicas>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "cockroach.kv.kvserver.storagepb.ChangeReplicas";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ChangeReplicas;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ChangeReplicas;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ChangeReplicas;

  static equals(a: ChangeReplicas | PlainMessage<ChangeReplicas> | undefined, b: ChangeReplicas | PlainMessage<ChangeReplicas> | undefined): boolean;
}
 ...
 */
export declare class ComputeChecksum extends Message<ComputeChecksum> {
  /**
   * ChecksumID is a handle by which the checksum can be retrieved in a later
   * CollectChecksum request.
   *
   * @generated from field: bytes checksum_id = 1;
   */
   ...
   *
   * @generated from field: bool checkpoint = 4;
   */
  checkpoint: boolean;
   ...
   *
   * @generated from field: repeated cockroach.roachpb.ReplicaDescriptor terminate = 6;
   */
  terminate: ReplicaDescriptor[];

  constructor(data?: PartialMessage<ComputeChecksum>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "cockroach.kv.kvserver.storagepb.ComputeChecksum";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ComputeChecksum;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ComputeChecksum;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ComputeChecksum;

  static equals(a: ComputeChecksum | PlainMessage<ComputeChecksum> | undefined, b: ComputeChecksum | PlainMessage<ComputeChecksum> | undefined): boolean;
}
 ...
 */
export declare class Compaction extends Message<Compaction> {
  /**
   ...
   *
   * @generated from field: int64 suggested_at_nanos = 2;
   */
  suggestedAtNanos: bigint;

  constructor(data?: PartialMessage<Compaction>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "cockroach.kv.kvserver.storagepb.Compaction";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): Compaction;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): Compaction;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): Compaction;

  static equals(a: Compaction | PlainMessage<Compaction> | undefined, b: Compaction | PlainMessage<Compaction> | undefined): boolean;
}
 ...
 */
export declare class SuggestedCompaction extends Message<SuggestedCompaction> {
  /**
  ...
  /**
   * @generated from field: cockroach.kv.kvserver.storagepb.Compaction compaction = 3;
   */
  compaction?: Compaction;

  constructor(data?: PartialMessage<SuggestedCompaction>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "cockroach.kv.kvserver.storagepb.SuggestedCompaction";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): SuggestedCompaction;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): SuggestedCompaction;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): SuggestedCompaction;

  static equals(a: SuggestedCompaction | PlainMessage<SuggestedCompaction> | undefined, b: SuggestedCompaction | PlainMessage<SuggestedCompaction> | undefined): boolean;
}
 ...
 */
export declare class ReplicatedEvalResult extends Message<ReplicatedEvalResult> {
  /**
   ...
   *
   * @generated from field: cockroach.kv.kvserver.storagepb.ReplicaState state = 2;
   */
  state?: ReplicaState;

  /**
   * @generated from field: cockroach.kv.kvserver.storagepb.Split split = 3;
   */
  split?: Split;

  /**
   * @generated from field: cockroach.kv.kvserver.storagepb.Merge merge = 4;
   */
  merge?: Merge;

  /**
   * @generated from field: cockroach.kv.kvserver.storagepb.ComputeChecksum compute_checksum = 21;
   */
  computeChecksum?: ComputeChecksum;

  /**
   * @generated from field: bool is_lease_request = 6;
   */
  isLeaseRequest: boolean;
   ...
   *
   * @generated from field: bool is_lease_request_with_expiration_to_epoch_equivalent = 26;
   */
  isLeaseRequestWithExpirationToEpochEquivalent: boolean;

  /**
   * @generated from field: bool is_probe = 23;
   */
  isProbe: boolean;
   ...
   *
   * @generated from field: cockroach.util.hlc.Timestamp write_timestamp = 8;
   */
   ...
   *
   * @generated from field: cockroach.storage.enginepb.MVCCStatsDelta delta = 18;
   */
  delta?: MVCCStatsDelta;

  /**
   * @generated from field: cockroach.kv.kvserver.storagepb.ChangeReplicas change_replicas = 12;
   */
   ...
   *
   * @generated from field: cockroach.kv.kvserver.storagepb.RaftTruncatedState raft_truncated_state = 28;
   */
   ...
   *
   * @generated from field: int64 raft_log_delta = 13;
   */
  raftLogDelta: bigint;
   ...
   *
   * @generated from field: uint64 raft_expected_first_index = 25;
   */
  raftExpectedFirstIndex: bigint;

  /**
   * @generated from field: cockroach.kv.kvserver.storagepb.ReplicatedEvalResult.MVCCHistoryMutation mvcc_history_mutation = 24;
   */
  mvccHistoryMutation?: ReplicatedEvalResult_MVCCHistoryMutation;

  /**
   * @generated from field: cockroach.kv.kvserver.storagepb.ReplicatedEvalResult.AddSSTable add_sstable = 17;
   */
  addSstable?: ReplicatedEvalResult_AddSSTable;
   ...
   *
   * @generated from field: cockroach.util.hlc.Timestamp prev_lease_proposal = 20;
   */
  prevLeaseProposal?: Timestamp;
   ...
   *
   * @generated from field: cockroach.kv.kvserver.readsummary.ReadSummary prior_read_summary = 22;
   */
  priorReadSummary?: ReadSummary;

  /**
   * @generated from field: cockroach.kv.kvserver.storagepb.ReplicatedEvalResult.LinkExternalSSTable link_external_sstable = 27;
   */
  linkExternalSstable?: ReplicatedEvalResult_LinkExternalSSTable;
   ...
   *
   * @generated from field: bool do_timely_application_to_all_replicas = 29;
   */
  doTimelyApplicationToAllReplicas: boolean;

  constructor(data?: PartialMessage<ReplicatedEvalResult>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "cockroach.kv.kvserver.storagepb.ReplicatedEvalResult";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ReplicatedEvalResult;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ReplicatedEvalResult;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ReplicatedEvalResult;

  static equals(a: ReplicatedEvalResult | PlainMessage<ReplicatedEvalResult> | undefined, b: ReplicatedEvalResult | PlainMessage<ReplicatedEvalResult> | undefined): boolean;
}
 ...
 */
export declare class ReplicatedEvalResult_MVCCHistoryMutation extends Message<ReplicatedEvalResult_MVCCHistoryMutation> {
  /**
   * @generated from field: repeated cockroach.roachpb.Span spans = 1;
   */
  spans: Span[];

  constructor(data?: PartialMessage<ReplicatedEvalResult_MVCCHistoryMutation>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "cockroach.kv.kvserver.storagepb.ReplicatedEvalResult.MVCCHistoryMutation";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ReplicatedEvalResult_MVCCHistoryMutation;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ReplicatedEvalResult_MVCCHistoryMutation;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ReplicatedEvalResult_MVCCHistoryMutation;

  static equals(a: ReplicatedEvalResult_MVCCHistoryMutation | PlainMessage<ReplicatedEvalResult_MVCCHistoryMutation> | undefined, b: ReplicatedEvalResult_MVCCHistoryMutation | PlainMessage<ReplicatedEvalResult_MVCCHistoryMutation> | undefined): boolean;
}
 ...
 */
export declare class ReplicatedEvalResult_AddSSTable extends Message<ReplicatedEvalResult_AddSSTable> {
  /**
  ...
  /**
   * @generated from field: uint32 crc32 = 2;
   */
  crc32: number;

  /**
   * @generated from field: cockroach.roachpb.Span span = 3;
   */
  span?: Span;
   ...
   *
   * @generated from field: bool at_write_timestamp = 4;
   */
  atWriteTimestamp: boolean;

  constructor(data?: PartialMessage<ReplicatedEvalResult_AddSSTable>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "cockroach.kv.kvserver.storagepb.ReplicatedEvalResult.AddSSTable";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ReplicatedEvalResult_AddSSTable;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ReplicatedEvalResult_AddSSTable;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ReplicatedEvalResult_AddSSTable;

  static equals(a: ReplicatedEvalResult_AddSSTable | PlainMessage<ReplicatedEvalResult_AddSSTable> | undefined, b: ReplicatedEvalResult_AddSSTable | PlainMessage<ReplicatedEvalResult_AddSSTable> | undefined): boolean;
}
 ...
 */
export declare class ReplicatedEvalResult_LinkExternalSSTable extends Message<ReplicatedEvalResult_LinkExternalSSTable> {
  /**
  ...
  /**
   * @generated from field: string remote_file_loc = 2;
   */
  remoteFileLoc: string;

  /**
   * @generated from field: string remote_file_path = 3;
   */
  remoteFilePath: string;

  /**
   * @generated from field: uint64 backing_file_size = 4;
   */
  backingFileSize: bigint;

  /**
   * @generated from field: uint64 approximate_physical_size = 5;
   */
  approximatePhysicalSize: bigint;

  /**
   * @generated from field: cockroach.util.hlc.Timestamp remote_rewrite_timestamp = 6;
   */
  remoteRewriteTimestamp?: Timestamp;

  /**
   * @generated from field: bytes remote_synthetic_prefix = 7;
   */
  remoteSyntheticPrefix: Uint8Array;

  constructor(data?: PartialMessage<ReplicatedEvalResult_LinkExternalSSTable>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "cockroach.kv.kvserver.storagepb.ReplicatedEvalResult.LinkExternalSSTable";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ReplicatedEvalResult_LinkExternalSSTable;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ReplicatedEvalResult_LinkExternalSSTable;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ReplicatedEvalResult_LinkExternalSSTable;

  static equals(a: ReplicatedEvalResult_LinkExternalSSTable | PlainMessage<ReplicatedEvalResult_LinkExternalSSTable> | undefined, b: ReplicatedEvalResult_LinkExternalSSTable | PlainMessage<ReplicatedEvalResult_LinkExternalSSTable> | undefined): boolean;
}
 ...
 */
export declare class WriteBatch extends Message<WriteBatch> {
  /**
   * @generated from field: bytes data = 1;
   */
  data: Uint8Array;

  constructor(data?: PartialMessage<WriteBatch>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "cockroach.kv.kvserver.storagepb.WriteBatch";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): WriteBatch;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): WriteBatch;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): WriteBatch;

  static equals(a: WriteBatch | PlainMessage<WriteBatch> | undefined, b: WriteBatch | PlainMessage<WriteBatch> | undefined): boolean;
}
 ...
 */
export declare class LogicalOpLog extends Message<LogicalOpLog> {
  /**
   * @generated from field: repeated cockroach.storage.enginepb.MVCCLogicalOp ops = 1;
   */
  ops: MVCCLogicalOp[];

  constructor(data?: PartialMessage<LogicalOpLog>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "cockroach.kv.kvserver.storagepb.LogicalOpLog";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): LogicalOpLog;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): LogicalOpLog;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): LogicalOpLog;

  static equals(a: LogicalOpLog | PlainMessage<LogicalOpLog> | undefined, b: LogicalOpLog | PlainMessage<LogicalOpLog> | undefined): boolean;
}
 ...
 */
export declare class RaftCommand extends Message<RaftCommand> {
  /**
   ...
   *
   * @generated from field: uint64 proposer_lease_sequence = 6;
   */
  proposerLeaseSequence: bigint;
   ...
   *
   * @generated from field: uint64 max_lease_index = 4;
   */
  maxLeaseIndex: bigint;
   ...
   *
   * @generated from field: cockroach.util.hlc.Timestamp closed_timestamp = 17;
   */
   ...
   *
   * @generated from field: cockroach.kv.kvserver.storagepb.ReplicatedEvalResult replicated_eval_result = 13;
   */
  replicatedEvalResult?: ReplicatedEvalResult;
   ...
   * change.
   *
   * @generated from field: cockroach.kv.kvserver.storagepb.WriteBatch write_batch = 14;
   */
   ...
   *
   * @generated from field: cockroach.kv.kvserver.storagepb.LogicalOpLog logical_op_log = 15;
   */
  logicalOpLog?: LogicalOpLog;
   ...
   * from" the proposer.
   *
   * @generated from field: map<string, string> trace_data = 16;
   */
  traceData: { [key: string]: string };
  ...
  constructor(data?: PartialMessage<RaftCommand>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "cockroach.kv.kvserver.storagepb.RaftCommand";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): RaftCommand;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): RaftCommand;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): RaftCommand;

  static equals(a: RaftCommand | PlainMessage<RaftCommand> | undefined, b: RaftCommand | PlainMessage<RaftCommand> | undefined): boolean;
}
 ...
 */
export declare class RaftCommandFooter extends Message<RaftCommandFooter> {
  /**
   * @generated from field: uint64 max_lease_index = 4;
   */
  maxLeaseIndex: bigint;
  ...
  constructor(data?: PartialMessage<RaftCommandFooter>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "cockroach.kv.kvserver.storagepb.RaftCommandFooter";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): RaftCommandFooter;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): RaftCommandFooter;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): RaftCommandFooter;

  static equals(a: RaftCommandFooter | PlainMessage<RaftCommandFooter> | undefined, b: RaftCommandFooter | PlainMessage<RaftCommandFooter> | undefined): boolean;
}
