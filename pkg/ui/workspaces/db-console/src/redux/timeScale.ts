...
export const SET_METRICS_MOVING_WINDOW = "cockroachui/timewindow/SET_WINDOW";
export const SET_METRICS_FIXED_WINDOW = "cockroachui/timewindow/SET_RANGE";
...
export class TimeScaleState {
   ...
   *  Specifically, when the end is "now", scale.fixedWindowEnd is null and metricsTime.currentWindow.end is a specific time
   *  that is continually updated in order to do polling.
   */
  metricsTime: {
