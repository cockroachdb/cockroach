...
export default function (props: GraphDashboardProps) {
  ...
  return [
    ...
    <LineGraph
      title="Network Packets Received With Error"
    ...
    <LineGraph
      title="Network Receiving Packets Dropped"
      showMetricsInTooltip={true}
    >
      <Axis units={AxisUnits.Count} label="packets">
        {nodeIDs.map(nid => (
    ...
    <LineGraph
      title="Network Packets Sent With Error"
      showMetricsInTooltip={true}
    >
      <Axis units={AxisUnits.Count} label="packets">
        {nodeIDs.map(nid => (
    ...
    <LineGraph
      title="Network Sending Packets Dropped"
      showMetricsInTooltip={true}
    >
      <Axis units={AxisUnits.Count} label="packets">
        {nodeIDs.map(nid => (
