...
export default function (props: GraphDashboardProps) {
  ...
  return [
    <LineGraph
      ...
      sources={nodeSources}
      tooltip={`A ten-second moving average of the number of SELECT, INSERT, UPDATE, and DELETE statements
    ...
    <LineGraph
      ...
      sources={nodeSources}
      tooltip={`A thirty-second moving average of the number of SQL statements executed per second that experienced contention ${tooltipSelection}.`}
      preCalcGraphSize={true}
    >
