...
export default function (props: GraphDashboardProps) {
  ...
  return [
    <LineGraph
      ...
      tooltip={
        <>
          Metrics:
          <ul>
            <li>cr.node.distsender.batches</li>
            <li>cr.node.distsender.batches.partial</li>
          </ul>
        </>
      }
    >
    ...
    <LineGraph
      ...
      tooltip={
        <>
          Metrics:
          <ul>
            <li>cr.node.distsender.rpc.sent</li>
            <li>cr.node.distsender.rpc.sent.local</li>
          </ul>
        </>
      }
    >
    ...
    <LineGraph
      ...
      tooltip={
        <>
          Metrics:
          <ul>
            <li>cr.node.distsender.rpc.sent.sendnexttimeout</li>
            <li>cr.node.distsender.rpc.sent.nextreplicaerror</li>
            <li>cr.node.distsender.errors.notleaseholder</li>
          </ul>
        </>
      }
    >
    ...
    <LineGraph
      ...
      tooltip={
        <>
          Metrics:
          <ul>
            <li>cr.node.txn.commits</li>
            <li>cr.node.txn.commits1PC</li>
            <li>cr.node.txn.aborts</li>
          </ul>
        </>
      }
    >
    ...
    <LineGraph
      ...
      tooltip={
        <>
          ...
          <br />
          <br />
          Metric: cr.node.txn.durations-p99
        </>
      }
    >
    ...
    <LineGraph
      ...
      tooltip={
        <>
          ...
          <br />
          <br />
          Metric: cr.node.txn.durations-p90
        </>
      }
    >
      <Axis units={AxisUnits.Duration} label="transaction duration">
    ...
    <LineGraph
      ...
      tooltip={
        <>
          The 99th percentile of latency to heartbeat a node's internal liveness
          record over a 1 minute period. Values are displayed individually for
          each node.
          <br />
          <br />
          Metric: cr.node.liveness.heartbeatlatency-p99
        </>
      }
    >
    ...
    <LineGraph
      ...
      tooltip={
        <>
          The 90th percentile of latency to heartbeat a node's internal liveness
          record over a 1 minute period. Values are displayed individually for
          each node.
          <br />
          <br />
          Metric: cr.node.liveness.heartbeatlatency-p90
        </>
      }
    >
      <Axis units={AxisUnits.Duration} label="heartbeat latency">
