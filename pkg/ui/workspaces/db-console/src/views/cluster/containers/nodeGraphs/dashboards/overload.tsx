        ...
        {nodeIDs.map(nid => (
          <>
            ...
            <Metric
              ...
              title={"KV write request rate " + nodeDisplayName(nodesSummary, nid)}
              sources={[nid]}
              nonNegativeRate
            />
            <Metric
              ...
              title={"SQL-KV response rate " + nodeDisplayName(nodesSummary, nid)}
              sources={[nid]}
              nonNegativeRate
            />
            <Metric
              ...
              title={"SQL-SQL response rate " + nodeDisplayName(nodesSummary, nid)}
              sources={[nid]}
              nonNegativeRate
            />
          </>
