...
export default function (props: GraphDashboardProps) {
  ...
  return [
        ...
        {nodeIDs.map(nid => (
          <>
            <Metric
              ...
              title={
                "IO Overload " + nodeDisplayName(nodeDisplayNameByID, nid)
              }
    ...
    <LineGraph
      title="Flow Control Admission Rate"
      sources={nodeSources}
      tenantSource={tenantSource}
    >
        ...
        {nodeIDs.map(nid => (
          <>
            <Metric
              ...
              title={
                "Regular admitted rate " + nodeDisplayName(nodeDisplayNameByID, nid)
              }
              sources={[nid]}
              nonNegativeRate
            />
            <Metric
              key={nid}
              name="cr.node.kvadmission.flow_controller.elastic_requests_admitted"
              title={
                "Elastic admitted rate " + nodeDisplayName(nodeDisplayNameByID, nid)
              }
              sources={[nid]}
              nonNegativeRate
            />
        ...
        {nodeIDs.map(nid => (
          <>
            <Metric
              ...
              title={"Regular flow token wait time " + nodeDisplayName(nodeDisplayNameByID, nid)}
              sources={[nid]}
              downsampleMax
            />
            <Metric
              ...
              title={"Elastic flow token wait time " + nodeDisplayName(nodeDisplayNameByID, nid)}
              sources={[nid]}
              downsampleMax
            />
          </>
      ...
      <Axis label="Count">
        {nodeIDs.map(nid => (
          ...
          <Metric
            ...
            title={
              "Regular requests waiting " + nodeDisplayName(nodeDisplayNameByID, nid)
            }
            sources={[nid]}
          />
          <Metric
            ...
            title={
              "Elastic requests waiting " + nodeDisplayName(nodeDisplayNameByID, nid)
            }
            sources={[nid]}
          />
          </>
      ...
      <Axis label="Count">
        {nodeIDs.map(nid => (
          ...
          <Metric
            ...
            title={
              "Blocked regular streams " + nodeDisplayName(nodeDisplayNameByID, nid)
            }
            sources={[nid]}
          />
          <Metric
            ...
            title={
              "Blocked elastic streams " + nodeDisplayName(nodeDisplayNameByID, nid)
            }
            sources={[nid]}
          />
          </>
    ...
    <LineGraph
      title="Flow Tokens Taken"
      sources={nodeSources}
      tenantSource={tenantSource}
    >
      <Axis units={AxisUnits.Bytes} label="Flow tokens taken">
        {_.map(nodeIDs, nid => (
          <>
            <Metric
              key={nid}
              name="cr.node.kvadmission.flow_controller.regular_tokens_deducted"
              title={"Regular tokens takens " + nodeDisplayName(nodeDisplayNameByID, nid)}
              sources={[nid]}
              nonNegativeRate
            />
            <Metric
              key={nid}
              name="cr.node.kvadmission.flow_controller.elastic_tokens_deducted"
              title={"Elastic tokens takens " + nodeDisplayName(nodeDisplayNameByID, nid)}
              sources={[nid]}
              nonNegativeRate
            />
          </>
