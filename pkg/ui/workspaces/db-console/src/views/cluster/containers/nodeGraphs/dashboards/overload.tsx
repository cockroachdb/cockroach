    ...
    >
      <Axis label="Duration (micros/sec)">
        {storeMetrics({
          ...
          aggregateMax: true,
        }, nodeIDs, storeIDsByNodeID, "regular (foreground)")}
        {storeMetrics({
          name: "cr.store.admission.granter.elastic_io_tokens_exhausted_duration.kv",
          nonNegativeRate: true,
          aggregateMax: true,
        }, nodeIDs, storeIDsByNodeID, "elastic (background)")}
      </Axis>
    </LineGraph>,
    ...
    >
      <Axis units={AxisUnits.Duration} label="Write Delay Duration">
        {storeMetrics({
          ...
          aggregateMax: true,
        }, nodeIDs, storeIDsByNodeID, "KV")}
        {storeMetrics({
          name: "cr.store.admission.wait_durations.elastic-stores-p99",
          aggregateMax: true,
        }, nodeIDs, storeIDsByNodeID, "elastic")}
      </Axis>
    </LineGraph>,
