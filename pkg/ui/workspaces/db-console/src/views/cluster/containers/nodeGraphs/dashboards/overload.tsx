...
export default function (props: GraphDashboardProps) {
  ...
  return [
    ...
    <LineGraph
      ...
      sources={nodeSources}
      tenantSource={tenantSource}
      tooltip={`Total time goroutines were delayed by runtime.Yield per second of wall time, measured in nanoseconds/second. This shows how much elastic CPU work was paused by cooperative scheduling.`}
      showMetricsInTooltip={true}
    >
      <Axis label="Duration (nanos/sec)">
        {nodeIDs.map(nid => (
          <Metric
            key={nid}
