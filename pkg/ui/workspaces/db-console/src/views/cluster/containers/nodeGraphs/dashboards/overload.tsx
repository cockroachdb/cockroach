        ...
        {nodeIDs.map(nid => (
          <>
            <Metric
              ...
              title={"Regular admitted rate " + nodeDisplayName(nodeDisplayNameByID, nid)}
              sources={[nid]}
              nonNegativeRate
            />
            <Metric
              ...
              title={"Elastic admitted rate " + nodeDisplayName(nodeDisplayNameByID, nid)}
              sources={[nid]}
              nonNegativeRate
            />
          </>
      ...
      <Axis label="Count">
        {nodeIDs.map(nid => (
          ...
          <Metric
            ...
            title={"Regular requests waiting " + nodeDisplayName(nodeDisplayNameByID, nid)}
            sources={[nid]}
          />
          <Metric
            key={nid}
            name="cr.node.kvadmission.flow_controller.elastic_requests_waiting"
            title={"Elastic requests waiting " + nodeDisplayName(nodeDisplayNameByID, nid)}
            sources={[nid]}
          />
          </>
        ))}
      ...
      <Axis label="Count">
        {nodeIDs.map(nid => (
          ...
          <Metric
            ...
            title={"Blocked regular streams " + nodeDisplayName(nodeDisplayNameByID, nid)}
            sources={[nid]}
          />
          <Metric
            key={nid}
            name="cr.node.kvadmission.flow_controller.elastic_blocked_stream_count"
            title={"Blocked elastic streams " + nodeDisplayName(nodeDisplayNameByID, nid)}
            sources={[nid]}
          />
          </>
        ))}
