...
// SWR hooks for statement diagnostics API
...
// Props for the pure presentation component
...
// Pure presentation component - exported for testing
...
> = ({
  ...
  // SWR handles data fetching automatically, no need for useEffect
...
// Container component with data fetching and Redux integration
const StatementDiagnosticsHistoryContainer: React.FC = () => {
  ...
  // Get statements data from Redux for statement fingerprint lookups
