  ...
  displayIdentities: [
    {
      ...
      connectivity: {
        peers: {
          "1": makePeer(),
          "2": makePeer({ status: ConnectionStatus.PARTITIONED }),
          "3": makePeer({
            status: ConnectionStatus.PARTITIONED,
            latency: { nanos: 0 },
          }),
          "4": makePeer(),
          "5": makePeer(),
    ...
    },
    {
      ...
      connectivity: {
        peers: {
          "1": makePeer({ status: ConnectionStatus.CLOSED }),
          "2": makePeer({
  ...
  displayIdentities: [
    {
      ...
      connectivity: {
        peers: {
          "1": makePeer(),
          "2": makePeer({ status: ConnectionStatus.NOT_CONNECTED }),
          "3": makePeer({
            status: ConnectionStatus.NOT_CONNECTED,
            latency: { nanos: 0 },
          }),
          "4": makePeer({ status: ConnectionStatus.NOT_CONNECTED }),
          "5": makePeer(),
        },
      },
      address: "127.0.0.1:26257",
