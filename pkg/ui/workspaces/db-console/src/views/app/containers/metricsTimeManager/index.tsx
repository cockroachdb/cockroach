...
> {
   ...
   * current time.
   * this is used to update the window according to the scale, except when the scale is simultaneously custom and fixedWindowEnd=null
   *  I think this exception happens when custom is set because of a custom sample size. but there's a chance that this could have been overlooked
   */
