...
const ClusterExplorerPage = (_props: RouteComponentProps) => {
  ...
  // Create stable function reference that won't change on re-renders
  const stableHandleNodeClick = useRef(handleNodeClick).current;
      ...
      <div style={{ display: "flex", gap: "20px", marginTop: "20px" }}>
        ...
        <div>
          <BarGraph
            ...
            data={currentRangeData.map(range => ({
