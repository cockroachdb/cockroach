...
storiesOf("AlertBar", module)
  ...
  // .add(
  //   `3.4.3 [patch upgrade] license key required by <date>, cluster upgraded to a patch version that doesn't support core`,
  //   () => <AlertBar />,
  // )
  // .add(
  //   `3.4.4 [patch upgrade] license key required, cluster throttled (cluster upgraded to patch version that doesn’t support core)`,
  //   () => <AlertBar />,
  // )
  .add(
