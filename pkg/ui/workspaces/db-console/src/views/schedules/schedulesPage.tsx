...
import { SchedulesResponseMessage } from "src/util/api";
...
const selectSchedulesState = createSelector(
  ...
  (schedules, key): CachedDataReducerState<SchedulesResponseMessage> => {
    if (!schedules) {
      return null;
    }
...
const mapStateToProps = (
  ...
  const key = schedulesKey(status, parseInt(show, 10));
