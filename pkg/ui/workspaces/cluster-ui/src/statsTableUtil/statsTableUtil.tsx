        ...
        content={
          <>
            <p>
              ...
              interval. This can be thought of as KV work that is on the critical
              path of serving the query. It does not include any asynchronous replication
              related work. The gray bar indicates mean KV CPU time.
              The blue bar indicates one standard deviation from the mean.
            </p>
          </>
        }
