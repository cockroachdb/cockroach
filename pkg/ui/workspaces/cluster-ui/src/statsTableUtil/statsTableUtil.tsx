  ...
  latencyMax: (statType: StatisticType) => {
    ...
    return (
      <Tooltip
        placement="bottom"
        style="tableTitle"
        content={<p>The highest latency value in the sampled {contentModifier} executions with this fingerprint.</p>}
      >
        {getLabel("latencyMax")}
      </Tooltip>
    );
  ...
  latencyMin: (statType: StatisticType) => {
    ...
    return (
      <Tooltip
        placement="bottom"
        style="tableTitle"
        content={<p>The lowest latency value in the sampled {contentModifier} executions with this fingerprint.</p>}
      >
        {getLabel("latencyMin")}
      </Tooltip>
    );
  ...
  latencyP50: (statType: StatisticType) => {
    ...
    return (
      <Tooltip
        placement="bottom"
        style="tableTitle"
        content={<p>The 50th latency percentile for {contentModifier} executions with this fingerprint.</p>}
      >
        {getLabel("latencyP50")}
      </Tooltip>
    );
  ...
  latencyP90: (statType: StatisticType) => {
    ...
    return (
      <Tooltip
        placement="bottom"
        style="tableTitle"
        content={<p>The 90th latency percentile for {contentModifier} executions with this fingerprint.</p>}
      >
        {getLabel("latencyP90")}
      </Tooltip>
    );
  ...
  latencyP99: (statType: StatisticType) => {
    ...
    return (
      <Tooltip
        placement="bottom"
        style="tableTitle"
        content={<p>The 99th latency percentile for {contentModifier} executions with this fingerprint.</p>}
      >
        {getLabel("latencyP99")}
      </Tooltip>
    );
