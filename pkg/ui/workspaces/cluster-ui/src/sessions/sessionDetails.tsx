            ...
            <Row>
              <Col className="gutter-row" span={10}>
                <SummaryCardItem
                  ...
                  value={<Timestamp time={TimestampToMoment(stmt.start)} format={DATE_FORMAT_24_TZ} />}
          ...
          <Col className="gutter-row" span={12}>
            <SummaryCard className={cx("summary-card")}>
              <SummaryCardItem
                ...
                value={<Timestamp time={TimestampToMoment(session.start)} format={DATE_FORMAT_24_TZ} />}
              />
              {session.end && (
                <SummaryCardItem
                  label={"Session End Time"}
                  value={<Timestamp time={TimestampToMoment(session.end)} format={DATE_FORMAT_24_TZ} />}
                />
              )}
              <SummaryCardItem
