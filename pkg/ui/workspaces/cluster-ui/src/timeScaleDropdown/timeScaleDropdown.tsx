  ...
  const arrowClick = (direction: ArrowDirection) => {
    ...
    switch (direction) {
      case ArrowDirection.RIGHT:
        /**
         * This endTime variable should always be equal to the local `end` variable, which is always a specific time.
         * Thus, it seems like this `if` condition should always be true.
         */
        if (endTime) {
