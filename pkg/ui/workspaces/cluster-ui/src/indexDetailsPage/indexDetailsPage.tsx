...
type IndexDetailsPageProps = IndexDetailsPageData & IndexDetailPageActions;
        ...
        <div className="root table-area">
          ...
          <div className={cx("header-container")}>
            ...
            <div className={cx("clear-info")}>
              ...
              >
                <div className={cx("last-cleared", "underline")}>
                  Last cleared:{" "}
                  ...
                  <table className="table">
                    <tbody>
                      <tr className={cx("summary-card--row", "table__row")}>
                        ...
                        <td className="table__cell">
                          <p className={cx("summary-card--label")}>
