...
import { isColumnSelected } from "../../columnsSelector/utils";
...
>[] {
  ...
  const columns: ColumnDescriptor<ActiveTransaction>[] = [
    ...
    },
    {
      ...
      cell: (item: ActiveTransaction) => item.mostRecentStatement?.query,
...
export function getColumnOptions(
  ...
  return makeActiveTransactionsColumns().map(col => ({
    value: col.name,
