 ...
 * @param ss the current sort settings
 * @param defaultSS the default sort settings
 * @param history
 */
export const updateSortSettingQueryParamsOnTab = (
  ...
  const ascending =
    (searchParams.get("ascending") || defaultSS.ascending.toString()) ===
    "true";
  const columnTitle = searchParams.get("columnTitle") || defaultSS.columnTitle;
  if (
    currentTab === tab &&
    (ss.columnTitle != columnTitle || ss.ascending != ascending)
  ) {
    const params = {
