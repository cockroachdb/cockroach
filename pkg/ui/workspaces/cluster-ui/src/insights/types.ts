...
// TODO (xinhaoz these fields should be placed required and placed into
// TxnInsightEvent once they are available for contention insights.
// MergedTxnInsightEvent can then be deleted.
...
export type Insight = {
  ...
  count: number; // Used by transactions to count stmt insights.
};
