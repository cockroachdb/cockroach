...
import { Filters, defaultFilters } from "src/queryFilter";
import { InsightEventsResponse, InsightEventState } from "src/api/insightsApi";
import { Insight, InsightExecEnum, InsightTypes, InsightEvent } from "./types";
...
export const defaultInsightFilters: InsightEventFilters = {
