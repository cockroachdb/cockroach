...
import {calculateActiveFilters, defaultFilters, Filter, getFullFiltersAsStringRecord} from "../../queryFilter";
...
export const SchemaInsightsView: React.FC<SchemaInsightsViewProps> = (
  ...
  useEffect(() => {
    ...
    const filtersFromURL = getSchemaInsightEventFiltersFromURL(history.location);
  ...
  // TODO(thomas): is this what we want?
  const clearFilters = () =>
    onSubmitFilters({
  ...
  // TODO(thomas): do we want/need this? are we filtering by app ?
      ...
      <PageConfig>
        ...
        <PageConfigItem>
          <Filter
            ...
            // TODO(thomas): don't want to include app names?
            appNames={[]}
            filters={filters}
          />
        </PageConfigItem>
