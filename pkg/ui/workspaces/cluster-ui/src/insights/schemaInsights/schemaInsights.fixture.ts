  ...
  schemaInsights: [
    {
      type: "DROP_INDEX",
      database: "db_name",
      lastUsed: "This index has not been used and can be removed for better write performance.",
      indexDetails: {
        table: "table_name",
        indexID: 1,
    ...
    },
    {
      type: "DROP_INDEX",
      database: "db_name2",
      lastUsed: "This index has not been used in over 9 days, 5 hours, and 3 minutes and can be removed for better write performance.",
      indexDetails: {
        table: "table_name2",
        indexID: 2,
