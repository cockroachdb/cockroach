...
import { DATE_WITH_SECONDS_AND_MILLISECONDS_FORMAT_24_TZ, Duration } from "src/util";
import {
  InsightExecEnum,
  TransactionStatus,
  TxnInsightEvent,
  ...
  return [
    ...
    },
    {
      ...
      cell: item => item.startTime
        ? <Timestamp time={item.startTime} format={DATE_WITH_SECONDS_AND_MILLISECONDS_FORMAT_24_TZ} />
        : <>N/A</>,
