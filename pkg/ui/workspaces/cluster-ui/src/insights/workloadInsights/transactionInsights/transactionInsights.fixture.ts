...
import { InsightExecEnum, InsightNameEnum } from "../../types";
import { defaultInsightFilters } from "../../utils";
  ...
  transactions: [
    {
      ...
      insightName: InsightNameEnum.highWaitTime,
