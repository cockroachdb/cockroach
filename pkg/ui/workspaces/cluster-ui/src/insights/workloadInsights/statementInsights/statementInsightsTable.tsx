...
export function makeStatementInsightsColumns(): ColumnDescriptor<StatementInsightEvent>[] {
  ...
  return [
    ...
    {
      name: "rowsRead",
      title: insightsTableTitles.rowsRead(execType),
      cell: (item: StatementInsightEvent) => item.rowsRead,
      sort: (item: StatementInsightEvent) => item.rowsRead,
      showByDefault: false,
    },
    {
      name: "rowsWritten",
      title: insightsTableTitles.rowsWritten(execType),
      cell: (item: StatementInsightEvent) => item.rowsWritten,
      sort: (item: StatementInsightEvent) => item.rowsWritten,
      showByDefault: false,
    },
  ];
}
