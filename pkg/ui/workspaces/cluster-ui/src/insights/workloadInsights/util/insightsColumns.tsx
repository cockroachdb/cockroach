...
export const insightsTableTitles: InsightsTableTitleType = {
  ...
  queryTags: (execType: InsightExecEnum) => {
    return makeToolTip(
      <p>
        The SQL commenter query tags extracted from comments in the {execType}{" "}
        query. These tags provide application context and can be used to
        correlate query performance with client-side application state.
      </p>,
      "queryTags",
    );
  },
