...
import { InsightExecType } from "../../types";
...
type InsightsTableTitleType = {
  [key in InsightsTableColumnKeys]: (execType: InsightExecType) => JSX.Element;
};
...
export function getLabel(
  ...
  switch (execType) {
    case InsightExecType.TRANSACTION:
      return "Transaction " + insightsColumnLabels[key];
    case InsightExecType.STATEMENT:
...
export const insightsTableTitles: InsightsTableTitleType = {
  executionID: (execType: InsightExecType) => {
    return (
      <Tooltip
        placement="bottom"
        style="tableTitle"
  ...
  query: (execType: InsightExecType) => {
    let tooltipText = `The ${execType} query.`;
    if (execType == InsightExecType.TRANSACTION) {
  ...
  insights: (execType: InsightExecType) => {
    return (
      <Tooltip
        placement="bottom"
        style="tableTitle"
  ...
  startTime: (execType: InsightExecType) => {
    return (
      <Tooltip
        style="tableTitle"
        placement="bottom"
  ...
  elapsedTime: (execType: InsightExecType) => {
    return (
      <Tooltip
        style="tableTitle"
        placement="bottom"
  ...
  applicationName: (execType: InsightExecType) => {
    return (
      <Tooltip
        style="tableTitle"
        placement="bottom"
