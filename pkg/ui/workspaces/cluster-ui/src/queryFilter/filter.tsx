...
export function Filter({
  ...
  const handleSelectChange = useCallback(
    (event: { label: string; value: string }, field: string): void => {
      setFilters(prev => ({
        ...prev,
        [field]: event.value,
      }));
  ...
  const toggleFullScan = useCallback(
  ...
  const isOptionSelected = useCallback(
    (option: string, field: string): boolean => {
  ...
  const handleMultiSelectChange = useCallback(
    (field: string, selected: string): void => {
      setFilters(prev => ({
        ...prev,
        [field]: selected,
      }));
