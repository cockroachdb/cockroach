...
const admissionWaitTimeStdDev = bar(cx("admission-wait-time-dev"), (d: StatementStatistics) =>
  stdDevLong(d.stats.exec_stats.admission_wait_time, d.stats.exec_stats.count),
);
