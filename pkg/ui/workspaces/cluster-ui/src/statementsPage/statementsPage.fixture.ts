...
const statementsPagePropsFixture: StatementsPageProps = {
  ...
  statements: [
    {
      aggregateKey: "1253500548539870016" + aggregatedTs + aggregationInterval,
      label:
        "SELECT IFNULL(a, b)\n" +
        "    FROM (\n" +
    ...
    {
      aggregateKey: "1985666523427702831" + aggregatedTs + aggregationInterval,
    ...
    {
      aggregateKey: "13649565517143827225" + aggregatedTs + aggregationInterval,
      label:
        "SELECT IFNULL(a, b)\n" +
        "    FROM (\n" +
    ...
    {
      aggregateKey: "1533636712988872414" + aggregatedTs + aggregationInterval,
      label:
    ...
    {
      aggregateKey: "2461578209191418170" + aggregatedTs + aggregationInterval,
    ...
    {
      aggregateKey: "4705782015019656142" + aggregatedTs + aggregationInterval,
    ...
    {
      aggregateKey: "2298970482983227199" + aggregatedTs + aggregationInterval,
      label:
    ...
    {
      aggregateKey: "4716433305747424413" + aggregatedTs + aggregationInterval,
    ...
    {
      aggregateKey: "367828504526856403" + aggregatedTs + aggregationInterval,
      label:
    ...
    {
      aggregateKey: "14972494059652918390" + aggregatedTs + aggregationInterval,
    ...
    {
      aggregateKey: "15897033026745880862" + aggregatedTs + aggregationInterval,
      label:
    ...
    {
      aggregateKey: '49958554803360403681' + aggregatedTs + aggregationInterval,
    ...
    {
      aggregateKey: '9233296116064220812' + aggregatedTs + aggregationInterval,
    ...
    {
      aggregateKey: '6117473345491440803' + aggregatedTs + aggregationInterval,
      label:
    ...
    {
      aggregateKey: '1301242584620444873' + aggregatedTs + aggregationInterval,
      label: "SHOW database",
    ...
    {
      aggregateKey: '11195381626529102926' + aggregatedTs + aggregationInterval,
      label:
    ...
    {
      aggregateKey: '18127289707013477303' + aggregatedTs + aggregationInterval,
    ...
    {
      aggregateKey: '2499764450427976233' + aggregatedTs + aggregationInterval,
    ...
    {
      aggregateKey: '818321793552651414' + aggregatedTs + aggregationInterval,
      label:
    ...
    {
      aggregateKey: '13217779306501326587' + aggregatedTs + aggregationInterval,
      label:
    ...
    {
      aggregateKey: '6325213731862855938' + aggregatedTs + aggregationInterval,
    ...
    {
      aggregateKey: '17372586739449521577' + aggregatedTs + aggregationInterval,
    ...
    {
      aggregateKey: '17098541896015126122' + aggregatedTs + aggregationInterval,
    ...
    {
      aggregateKey: '13350023170184726428' + aggregatedTs + aggregationInterval,
      label:
    ...
    {
      aggregateKey: '2695725667586429780' + aggregatedTs + aggregationInterval,
      label:
    ...
    {
      aggregateKey: '6754865160812330169' + aggregatedTs + aggregationInterval,
      label:
    ...
    {
      aggregateKey: '6810471486115018510' + aggregatedTs + aggregationInterval,
    ...
    {
      aggregateKey: '13265908854908549668' + aggregatedTs + aggregationInterval,
    ...
    {
      aggregateKey: '18377382163116490400' + aggregatedTs + aggregationInterval,
    ...
    {
      aggregateKey: '8695470234690735168' + aggregatedTs + aggregationInterval,
      label:
    ...
    {
      aggregateKey: '9261848985398568228' + aggregatedTs + aggregationInterval,
      label:
    ...
    {
      aggregateKey: '4176684928840388768' + aggregatedTs + aggregationInterval,
    ...
    {
      aggregateKey: "15868120298061590648" + aggregatedTs + aggregationInterval,
    ...
    {
      aggregateKey: "13070583869906258880" + aggregatedTs + aggregationInterval,
      label:
    ...
    {
      aggregateKey: "641287435601027145" + aggregatedTs + aggregationInterval,
    ...
    {
      aggregateKey: "16743225271705059729" + aggregatedTs + aggregationInterval,
      label:
    ...
    {
      aggregateKey: "6075815909800602827" + aggregatedTs + aggregationInterval,
      label:
    ...
    {
      aggregateKey: "5158086166870396309" + aggregatedTs + aggregationInterval,
      label:
    ...
    {
      aggregateKey: "13494397675172244644" + aggregatedTs + aggregationInterval,
    ...
    {
      aggregateKey: "101921598584277094" + aggregatedTs + aggregationInterval,
    ...
    {
      aggregateKey: "7880339715822034020" + aggregatedTs + aggregationInterval,
      label:
    ...
    {
      aggregateKey: "16819876564846676829" + aggregatedTs + aggregationInterval,
