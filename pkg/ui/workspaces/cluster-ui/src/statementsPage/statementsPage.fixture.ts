...
const statementsPagePropsFixture: StatementsPageProps = {
  ...
  statements: [
    {
      aggregateFingerprintID: "1253500548539870016",
      label:
        "SELECT IFNULL(a, b)\n" +
        "    FROM (\n" +
    ...
    {
      aggregateFingerprintID: "1985666523427702831",
    ...
    {
      aggregateFingerprintID: "13649565517143827225",
      label:
        "SELECT IFNULL(a, b)\n" +
        "    FROM (\n" +
    ...
    {
      aggregateFingerprintID: "1533636712988872414",
      label:
    ...
    {
      aggregateFingerprintID: "2461578209191418170",
    ...
    {
      aggregateFingerprintID: "4705782015019656142",
    ...
    {
      aggregateFingerprintID: "2298970482983227199",
      label:
    ...
    {
      aggregateFingerprintID: "4716433305747424413",
    ...
    {
      aggregateFingerprintID: "367828504526856403",
      label:
    ...
    {
      aggregateFingerprintID: "14972494059652918390",
    ...
    {
      aggregateFingerprintID: "15897033026745880862",
      label:
    ...
    {
      aggregateFingerprintID: '49958554803360403681',
    ...
    {
      aggregateFingerprintID: '9233296116064220812',
    ...
    {
      aggregateFingerprintID: '6117473345491440803',
      label:
    ...
    {
      aggregateFingerprintID: '1301242584620444873',
      label: "SHOW database",
    ...
    {
      aggregateFingerprintID: '11195381626529102926',
      label:
    ...
    {
      aggregateFingerprintID: '18127289707013477303',
    ...
    {
      aggregateFingerprintID: '2499764450427976233',
    ...
    {
      aggregateFingerprintID: '818321793552651414',
      label:
    ...
    {
      aggregateFingerprintID: '13217779306501326587',
      label:
    ...
    {
      aggregateFingerprintID: '6325213731862855938',
    ...
    {
      aggregateFingerprintID: '17372586739449521577',
    ...
    {
      aggregateFingerprintID: '17098541896015126122',
    ...
    {
      aggregateFingerprintID: '13350023170184726428',
      label:
    ...
    {
      aggregateFingerprintID: '2695725667586429780',
      label:
    ...
    {
      aggregateFingerprintID: '6754865160812330169',
      label:
    ...
    {
      aggregateFingerprintID: '6810471486115018510',
    ...
    {
      aggregateFingerprintID: '13265908854908549668',
    ...
    {
      aggregateFingerprintID: '18377382163116490400',
    ...
    {
      aggregateFingerprintID: '8695470234690735168',
      label:
    ...
    {
      aggregateFingerprintID: '9261848985398568228',
      label:
    ...
    {
      aggregateFingerprintID: '4176684928840388768',
    ...
    {
      aggregateFingerprintID: "15868120298061590648",
    ...
    {
      aggregateFingerprintID: "13070583869906258880",
      label:
    ...
    {
      aggregateFingerprintID: "641287435601027145",
    ...
    {
      aggregateFingerprintID: "16743225271705059729",
      label:
    ...
    {
      aggregateFingerprintID: "6075815909800602827",
      label:
    ...
    {
      aggregateFingerprintID: "5158086166870396309",
      label:
    ...
    {
      aggregateFingerprintID: "13494397675172244644",
    ...
    {
      aggregateFingerprintID: "101921598584277094",
    ...
    {
      aggregateFingerprintID: "7880339715822034020",
      label:
    ...
    {
      aggregateFingerprintID: "16819876564846676829",
