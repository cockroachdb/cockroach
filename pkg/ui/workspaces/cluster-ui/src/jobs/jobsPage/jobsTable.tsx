...
export function makeJobsColumns(): ColumnDescriptor<Job>[] {
  return [
    ...
    },
    {
      ...
      cell: job => <Timestamp time={TimestampToMoment(job?.created)} format={DATE_FORMAT_24_TZ} />,
    ...
    },
    {
      ...
      cell: job => <Timestamp time={TimestampToMoment(job?.modified)} format={DATE_FORMAT_24_TZ} />,
    ...
    },
    {
      ...
      cell: job => <Timestamp time={TimestampToMoment(job?.last_run)} format={DATE_FORMAT_24_TZ} />,
