...
export function JobDetailsV2<AppState = unknown>({
  ...
  const jobId = useMemo(() => long.fromString(getMatchParamByName(match, idAttr)), [match]);
            ...
            <>
              ...
              <Tabs
                ...
                items={[
                  ...
                  (!ccContext && hasAdminRole) && {
                    key: "profiler",
                    label: TabKeysEnum.PROFILER,
                    children: (
                      <JobProfilerViewV2
                        jobID={jobId}
                        onFetchExecutionDetailFiles={onFetchExecutionDetailFiles}
