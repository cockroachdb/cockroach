...
import {refreshSchemaInsightsSaga, requestSchemaInsightsSaga} from "./schemaInsights.sagas";
import {actions, reducer, SchemaInsightsState} from "./schemaInsights.reducer";
...
describe("SchemaInsights sagas", () => {
  ...
  const schemaInsightsAPIProvider: (EffectProviders | StaticProvider)[] = [
    [matchers.call.fn(getSchemaInsightEventState), schemaInsightsResponse],
  ];
  ...
  describe("requestSchemaInsightsSaga", () => {
    ...
    it("returns error on failed request", () => {
      ...
      return expectSaga(requestSchemaInsightsSaga, actions.request())
        .provide([[matchers.call.fn(getSchemaInsightEventState), throwError(error)]])
