...
export interface SearchCriteriaProps {
  ...
  onChangeBy: (by: SqlStatsSortOptions) => void;
  onApply: () => void;
}
        ...
        <PageConfigItem>
          <label>
            ...
            <Select
              ...
              value={requestSortOptions.filter(top => top.value == byValue)}
              onChange={event => onChangeBy(event.value as SqlStatsSortOptions)}
