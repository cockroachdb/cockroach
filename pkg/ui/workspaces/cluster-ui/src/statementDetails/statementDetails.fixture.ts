  ...
  statementDetails: {
    statement: {
      key_data: {
        ...
        distSQL: { true: new Long(2), false: new Long(1) },
        failed: { true: new Long(2), false: new Long(1) },
        implicit_txn: true,
        vec: { true: new Long(2), false: new Long(1) },
        full_scan: { true: new Long(2), false: new Long(1) },
        databases: ["defaultdb"],
