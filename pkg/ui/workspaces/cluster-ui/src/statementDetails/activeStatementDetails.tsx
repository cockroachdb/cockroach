...
import { commonStyles, SqlBox } from "src";
...
import { ExecutionStatusIcon } from "src/activeExecutions/ExecutionStatusIcon";
                ...
                <Row>
                  <Col>
                    ...
                    <div className={summaryCardStylesCx("summary--card__item")}>
                      <Text>Status</Text>
                      <Text>
                        <ExecutionStatusIcon status={statement.status} />
                        {statement.status}
                      </Text>
                    </div>
                  </Col>
