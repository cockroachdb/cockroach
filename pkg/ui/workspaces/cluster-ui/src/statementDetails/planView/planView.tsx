...
// standardizeKey converts strings separated by comma, whitespace and/or
// hypens to camel case. '(anti)' is also removed from the resulting string.
...
function NodeAttribute({
  ...
  const attributeValTooltip = getAttributeValueTooltip(
    standardizeKey(attribute.values.join(",")),
  );
