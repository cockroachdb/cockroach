...
import classNames from "classnames/bind";
import { getSubsetWarning } from "../../util/sqlActivityConstants";
import { StatisticTableColumnKeys } from "../../statsTableUtil/statsTableUtil";
        ...
        <InlineAlert
          ...
          title={
            <>
              ...
              the current time window, toggle the time window to see this
              request. Further attempts to activate a diagnostic for this
              statement will fail.
            </>
          }
