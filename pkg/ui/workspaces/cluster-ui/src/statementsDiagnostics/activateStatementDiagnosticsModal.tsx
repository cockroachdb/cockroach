  ...
  return (
    ...
    >
      <Text>
        ...
        according to the trace and latency thresholds set below. The request is
        cancelled when a single diagnostics bundle is captured.{" "}
