...
module.exports = {
  ...
  resolve: {
    ...
    // __dirname is an absolute path, meaning that only the exact directory is
    // checked. A relative path would follow the resolution behavior used by
    // node.js for "node_modules", which checks for a "node_modules" child
    // directory located in either the current directory *or in any parent directory*.
    //
