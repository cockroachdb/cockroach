...
export type StatisticType = 'statement' | 'transaction'
...
export const StatisticTableTitle: StatisticTableTitleType = {
  ...
  executionCount: (statType: StatisticType) => {
    var contentModifier = statType === 'statement' ? contentModifiers.transactions : contentModifiers.statements
      return (
          <Tooltip
          placement="bottom"
          style="tableTitle"
  ...
  time: (statType: StatisticType) => {
    var columnLabel = statType === 'statement' ? contentModifiers.transactionCapital : contentModifiers.statementCapital
    var contentModifier = statType === 'statement' ? contentModifiers.transactions : contentModifiers.statements
  ...
  maxMemUsage: (statType: StatisticType) => {
    var contentModifier = statType === 'statement' ? contentModifiers.transaction : contentModifiers.statement
      return (
          <Tooltip
          placement="bottom"
          style="tableTitle"
