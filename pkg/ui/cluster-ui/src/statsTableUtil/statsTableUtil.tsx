...
// StatisticTableTitle is a mapping between statistic table columns and functions.
...
// of data the statistics are based on (e.g. statements or transactions). The
...
export const statisticsTableTitles: StatisticTableTitleType = {
  ...
  executionCount: (statType: StatisticType) => {
    const contentModifier =
      statType === "statement"
        ? contentModifiers.transactions
        : contentModifiers.statements;
    return (
      <Tooltip
        placement="bottom"
        style="tableTitle"
  ...
  time: (statType: StatisticType) => {
    const columnLabel =
      statType === "statement"
        ? contentModifiers.transactionCapital
        : contentModifiers.statementCapital;
    const contentModifier =
      statType === "statement"
        ? contentModifiers.transactions
        : contentModifiers.statements;
  ...
  maxMemUsage: (statType: StatisticType) => {
    const contentModifier =
      statType === "statement"
        ? contentModifiers.transaction
        : contentModifiers.statement;
    return (
      <Tooltip
        placement="bottom"
        style="tableTitle"
