  ...
  executionCount: (statType: StatisticType) => {
    ...
    switch(statType) {
      ...
      case "transactionDetails":
        contentModifier = contentModifiers.statements;
        fingerprintModifier = " for this " + contentModifiers.transactionFingerprint
        break;
    }
        ...
        content={
          <>
            <p>
              ...
              {
                ` of statements with this fingerprint${fingerprintModifier} within the last hour or specified time interval.`
              }
            </p>
          </>
        }
