...
export const idleSession: SessionInfo = {
  session: {
    ...
    sched_ticks: Long.fromNumber(0),
    nanos: Long.fromNumber(0),
    large_bytes: Long.fromNumber(0),
    active_queries: [],
    toJSON: () => ({}),
  },
};
...
export const activeSession: SessionInfo = {
  session: {
    ...
    max_alloc_bytes: Long.fromNumber(10240),
    sched_ticks: Long.fromNumber(123),
    nanos: Long.fromNumber(123),
    large_bytes: Long.fromNumber(123),
    active_txn: {
