...
function makeCommonColumns(
  ...
  const columns: ColumnDescriptor<AggregateStatistics>[] = [
    {
      name: "executionCount",
      title: statisticsTableTitles.executionCount("statement"),
    ...
    {
      name: "database",
      title: statisticsTableTitles.database("statement"),
    ...
    {
      name: "rowsRead",
      title: statisticsTableTitles.rowsRead("statement"),
    ...
    {
      name: "bytesRead",
      title: statisticsTableTitles.bytesRead("statement"),
      cell: bytesReadBar,
      sort: (stmt: AggregateStatistics) =>
    ...
    {
      name: "statementTime",
      title: statisticsTableTitles.time("statement"),
    ...
    {
      name: "contention",
      title: statisticsTableTitles.contention("statement"),
      cell: contentionBar,
      sort: (stmt: AggregateStatistics) =>
    ...
    {
      name: "maxMemUsage",
      title: statisticsTableTitles.maxMemUsage("statement"),
      cell: maxMemUsageBar,
      sort: (stmt: AggregateStatistics) =>
    ...
    {
      name: "networkBytes",
      title: statisticsTableTitles.networkBytes("statement"),
    ...
    {
      name: "retries",
      title: statisticsTableTitles.retries("statement"),
    ...
    {
      name: "workloadPct",
      title: statisticsTableTitles.workloadPct("statement"),
    ...
    {
      name: "regionNodes",
      title: statisticsTableTitles.regionNodes("statement"),
...
export function makeStatementsColumns(
  ...
  const columns: ColumnDescriptor<AggregateStatistics>[] = [
    {
      name: "statements",
      title: statisticsTableTitles.statements("statement"),
  ...
  if (activateDiagnosticsRef) {
    const diagnosticsColumn: ColumnDescriptor<AggregateStatistics> = {
      name: "diagnostics",
      title: statisticsTableTitles.diagnostics("statement"),
