...
function makeCommonColumns(
  ...
  const columns: ColumnDescriptor<AggregateStatistics>[] = [
    {
      name: "executionCount",
      title: StatisticTableTitle.executionCount('statement'),
    ...
    {
      name: "database",
      title: StatisticTableTitle.database('statement'),
    ...
    {
      name: "rowsRead",
      title: StatisticTableTitle.rowsRead('statement'),
    ...
    {
      name: "bytesRead",
      title: StatisticTableTitle.bytesRead('statement'),
      cell: bytesReadBar,
      sort: (stmt: AggregateStatistics) =>
    ...
    {
      name: "statementTime",
      title: StatisticTableTitle.time('statement'),
    ...
    {
      name: "contention",
      title: StatisticTableTitle.contention('statement'),
      cell: contentionBar,
      sort: (stmt: AggregateStatistics) =>
    ...
    {
      name: "maxMemUsage",
      title: StatisticTableTitle.maxMemUsage('statement'),
      cell: maxMemUsageBar,
      sort: (stmt: AggregateStatistics) =>
    ...
    {
      name: "networkBytes",
      title: StatisticTableTitle.networkBytes('statement'),
    ...
    {
      name: "retries",
      title: StatisticTableTitle.retries('statement'),
    ...
    {
      name: "workloadPct",
      title: StatisticTableTitle.workloadPct('statement'),
    ...
    {
      name: "regionNodes",
      title: StatisticTableTitle.regionNodes('statement'),
...
export function makeStatementsColumns(
  ...
  const columns: ColumnDescriptor<AggregateStatistics>[] = [
    {
      name: "statements",
      title: StatisticTableTitle.statements('statement'),
  ...
  if (activateDiagnosticsRef) {
    const diagnosticsColumn: ColumnDescriptor<AggregateStatistics> = {
      name: "diagnostics",
      title: StatisticTableTitle.diagnostics('statement'),
