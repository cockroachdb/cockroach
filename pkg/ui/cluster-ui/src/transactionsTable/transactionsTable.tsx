...
export const TransactionsTable: React.FC<TransactionsTable> = props => {
  ...
  const columns = [
    ...
    },
    {
      ...
      title: StatisticTableTitle.executionCount(true),
      cell: countBar,
      sort: (item: TransactionInfo) =>
    ...
    {
      name: "rows read",
      title: StatisticTableTitle.rowsRead(true),
      cell: rowsReadBar,
    ...
    {
      name: "bytes read",
      title: StatisticTableTitle.bytesRead(true),
      cell: bytesReadBar,
    ...
    {
      name: "latency",
      title: StatisticTableTitle.time(true),
      cell: latencyBar,
    ...
    {
      name: "contention",
      title: StatisticTableTitle.contention(true),
      cell: contentionBar,
    ...
    {
      name: "max memory",
      title: StatisticTableTitle.maxMemUsage(true),
      cell: maxMemUsageBar,
    ...
    {
      name: "network",
      title: StatisticTableTitle.networkBytes(true),
    ...
    {
      name: "retries",
      title: StatisticTableTitle.retries(true),
      cell: retryBar,
      sort: (item: TransactionInfo) =>
    ...
    {
      name: "regionNodes",
      title: StatisticTableTitle.regionNodes(true),
