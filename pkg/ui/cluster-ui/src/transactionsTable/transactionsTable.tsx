...
import { StatisticTableTitle } from "../table/statsTableContent";
...
export const TransactionsTable: React.FC<TransactionsTable> = props => {
  ...
  const columns = [
    ...
    },
    {
      ...
      title: StatisticTableTitle.executionCount('transaction'),
      cell: countBar,
      sort: (item: TransactionInfo) =>
    ...
    {
      name: "rows read",
      title: StatisticTableTitle.rowsRead('transaction'),
      cell: rowsReadBar,
    ...
    {
      name: "bytes read",
      title: StatisticTableTitle.bytesRead('transaction'),
      cell: bytesReadBar,
    ...
    {
      name: "latency",
      title: StatisticTableTitle.time('transaction'),
      cell: latencyBar,
    ...
    {
      name: "contention",
      title: StatisticTableTitle.contention('transaction'),
      cell: contentionBar,
    ...
    {
      name: "max memory",
      title: StatisticTableTitle.maxMemUsage('transaction'),
      cell: maxMemUsageBar,
    ...
    {
      name: "network",
      title: StatisticTableTitle.networkBytes('transaction'),
    ...
    {
      name: "retries",
      title: StatisticTableTitle.retries('transaction'),
      cell: retryBar,
      sort: (item: TransactionInfo) =>
    ...
    {
      name: "regionNodes",
      title: StatisticTableTitle.regionNodes('transaction'),
