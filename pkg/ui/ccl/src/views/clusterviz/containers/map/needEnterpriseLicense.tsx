...
const TRIAL_LICENSE_URL = "https://www.cockroachlabs.com/docs/stable/enterprise-licensing.html#request-a-trial-or-an-enterprise-license-key";
        ...
        <div className="need-license-blurb">
          <div>
            ...
            <p className="need-license-blurb__text">
              ...
              To enable it for your cluster, all you need is an Enterprise trial
              license and some configuration.
            </p>
          </div>
          <a href={TRIAL_LICENSE_URL} className="need-license-blurb__trial_link">
            GET A FREE 30-DAY ENTERPRISE TRIAL
          </a>
        </div>
...
function Step(props: { num: number, text: string, img?: string }) {
  return (
    <div className="license-step">
      <div className="license-step__image">
        <img src={props.img} width="318" />
      </div>
