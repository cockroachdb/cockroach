...
import Selector, { SelectorOption, ArrowDirection } from "../components/dropdown";
...
// TimeScaleSelector is the dropdown that allows users to select the time range
// for graphs.
class TimeScaleSelector extends React.Component<TimeScaleSelectorProps, {}> {
  changeSettings = (newTimescaleKey: SelectorOption) => {
  ...
  render() {
    ...
    let className = "Select--side-arrows";
    ...
    if (currentScale.windowEnd) {
      ...
      className += " Select--no-right-arrow";
    }
