...
import { Bytes, ComputePrefixExponent, Duration } from "../util/format";
...
function ComputeByteAxisDomain(
  ...
  let prefixExponent = ComputePrefixExponent(max, 1024, byteLabels);
  let prefixFactor = Math.pow(1024, prefixExponent);
