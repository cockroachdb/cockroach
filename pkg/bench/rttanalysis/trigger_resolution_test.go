...
var triggerResolutionCases = []RoundTripBenchTestCase{
	{
...
func BenchmarkTriggerResolution(b *testing.B) {
	runCPUMemBenchmark(bShim{b}, triggerResolutionCases, defaultCC)
}

func TestBenchmarkExpectation_TriggerResolution(t *testing.T) {
	runExpectation(t, "TriggerResolution", triggerResolutionCases, defaultCC)
}
