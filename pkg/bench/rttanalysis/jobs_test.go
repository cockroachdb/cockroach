...
func init() {
	...
	setupQueries := []string{
		...
		// Job 3001 is a RUNNING job. It isn't really running
		// as we already marked it as claimed and with a
		// backoff configuration that likely prevents it form
		// actually being resumed.
