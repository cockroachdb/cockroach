...
var discardCases = []RoundTripBenchTestCase{
	{
...
func BenchmarkDiscard(b *testing.B) { runCPUMemBenchmark(bShim{b}, discardCases, defaultCC) }

func TestBenchmarkExpectation_Discard(t *testing.T) {
	runExpectation(t, "Discard", discardCases, defaultCC)
}
