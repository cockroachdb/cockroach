...
func runRoundTripBenchmark(b testingTB, tests []RoundTripBenchTestCase, cc ClusterConstructor) {
	for _, tc := range tests {
		b.Run(tc.Name, func(b testingTB) {
...
func executeRoundTripTest(b testingTB, tc RoundTripBenchTestCase, cc ClusterConstructor) {
	defer b.logScope()()
