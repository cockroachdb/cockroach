...
type RemoteClockMetrics struct {
	...
	ClockOffsetMedianAbsDev *metric.Gauge
...
var (
	...
	metaClockOffsetMedianAbsDev = metric.Metadata{
...
func newRemoteClockMonitor(
	...
	r.metrics = RemoteClockMetrics{
		...
		ClockOffsetMedianAbsDev: metric.NewGauge(metaClockOffsetMedianAbsDev),
...
func (r *RemoteClockMonitor) VerifyClockOffset(ctx context.Context) error {
	...
	r.metrics.ClockOffsetMedianAbsDev.Update(int64(medianAbsoluteDeviation))
...
func updateClockOffsetTracking(
	...
	remoteClocks.UpdateOffset(ctx, nodeID, offset, pingDuration)     // updates nodes offset info and exports latency metric info
	return pingDuration, offset, remoteClocks.VerifyClockOffset(ctx) // updates offset info that are exported in metrics
}
