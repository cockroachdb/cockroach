...
type NodeMetrics struct {
	...
	HeartbeatRoundTripLatency        *aggmetric.Histogram
	HeartbeatRoundTripAverageLatency ewma.MovingAverage
}
...
func (m *Metrics) loadNodeMetrics(nodeID roachpb.NodeID) NodeMetrics {
	...
	nm := NodeMetrics{
		...
		HeartbeatRoundTripLatency:        m.HeartbeatRoundTripLatency.AddChild(nodeID.String()),
		HeartbeatRoundTripAverageLatency: ewma.NewMovingAverage(),
	}
	m.mu.nm[nodeID] = nm
	return nm
}
