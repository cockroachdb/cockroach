...
func (*RemoteOffset) Descriptor() ([]byte, []int) {
	return fileDescriptor_heartbeat_30f4fba5d4a313f3, []int{0}
}
...
type PingRequest struct {
	...
	// client_cluster_version is the client's active cluster version. Used by the
	// server to verify that the client is compatible with its minimum accepted
	// version.
	//
	// The client is saying that it won't make requests with versions lower than
	// this (so, when preparing any request, at least this version will be
	// considered active). The client might create requests "with higher versions"
	// in the future (if the cluster version is bumped), but never lower.
	ClientClusterVersion roachpb.Version `protobuf:"bytes,6,opt,name=client_cluster_version,json=clientClusterVersion" json:"client_cluster_version"`
...
func (*PingRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_heartbeat_30f4fba5d4a313f3, []int{1}
}
...
type PingResponse struct {
	...
	// server_cluster_version is the server's active cluster version. Used by the
	// client to verify that the server is compatible with its minimum accepted
	// version.
	//
	// The server is saying that it won't make requests with versions lower than
	// this (so, when preparing any request, at least this version will be
	// considered active). The server might create requests "with higher versions"
	// in the future (if the cluster version is bumped), but never lower.
	ServerClusterVersion roachpb.Version `protobuf:"bytes,3,opt,name=server_cluster_version,json=serverClusterVersion" json:"server_cluster_version"`
}
...
func (*PingResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_heartbeat_30f4fba5d4a313f3, []int{2}
}
...
func (m *PingRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x32
	i++
	i = encodeVarintHeartbeat(dAtA, i, uint64(m.ClientClusterVersion.Size()))
	n3, err := m.ClientClusterVersion.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n3
...
func (m *PingResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x1a
	i++
	i = encodeVarintHeartbeat(dAtA, i, uint64(m.ServerClusterVersion.Size()))
	n4, err := m.ServerClusterVersion.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n4
...
func (m *PingRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ClientClusterVersion", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.ClientClusterVersion.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 7:
...
func (m *PingResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ServerClusterVersion", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.ServerClusterVersion.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func init() { proto.RegisterFile("rpc/heartbeat.proto", fileDescriptor_heartbeat_30f4fba5d4a313f3) }

var fileDescriptor_heartbeat_30f4fba5d4a313f3 = []byte{
	// 556 bytes of a gzipped FileDescriptorProto
	,
}
