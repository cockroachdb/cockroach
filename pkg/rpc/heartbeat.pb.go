...
func (*RemoteOffset) Descriptor() ([]byte, []int) {
	return fileDescriptor_heartbeat_d899da5f1f2c5028, []int{0}
}
...
func (*PingRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_heartbeat_d899da5f1f2c5028, []int{1}
}
...
type PingResponse struct {
	...
	DisablePeerNameVerification bool `protobuf:"varint,5,opt,name=disable_peer_name_verification,json=disablePeerNameVerification" json:"disable_peer_name_verification"`
}
...
func (*PingResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_heartbeat_d899da5f1f2c5028, []int{2}
}
...
func (m *PingResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x28
	i++
	if m.DisablePeerNameVerification {
		dAtA[i] = 1
	} else {
		dAtA[i] = 0
	}
...
func (m *PingResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DisablePeerNameVerification", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DisablePeerNameVerification = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipHeartbeat(dAtA[iNdEx:])
			if err != nil {
...
func init() { proto.RegisterFile("rpc/heartbeat.proto", fileDescriptor_heartbeat_d899da5f1f2c5028) }

var fileDescriptor_heartbeat_d899da5f1f2c5028 = []byte{
	// 595 bytes of a gzipped FileDescriptorProto
	,
}
