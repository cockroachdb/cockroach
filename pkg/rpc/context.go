...
func (a internalClientAdapter) MuxRangeFeed(
	...
	eventPipe := newRangeFeedPipe(ctx, receiveMuxRangeFeedEvent)
	...
	go func() {
		...
		// This call is blocking.
		err := a.serverStreamInterceptors.run(a.server, eventPipe, muxRangefeedStreamInfo, handler)
		if err == nil {
			err = io.EOF
		}
		eventPipe.errC <- err
...
func (a muxRangeFeedClientAdapter) SendMsg(m interface{}) error {
	return a.ClientStream.SendMsg(m)
}

func (a muxRangeFeedClientAdapter) RecvMsg(m interface{}) error {
	return a.ClientStream.RecvMsg(m)
}
...
func (a muxRangeFeedServerAdapter) SendMsg(m interface{}) error {
	return a.ServerStream.SendMsg(m)
}

func (a muxRangeFeedServerAdapter) RecvMsg(m interface{}) error {
