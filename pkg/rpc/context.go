...
func NewServerEx(
	...
	grpcOpts := []grpc.ServerOption{
		...
		grpc.InitialWindowSize(initialWindowSize(ctx)),
		grpc.InitialConnWindowSize(initialConnWindowSize(ctx)),
...
func (rpcCtx *Context) dialOptsCommon(
	...
	dialOpts = append(dialOpts, grpc.WithInitialConnWindowSize(initialConnWindowSize(ctx)))
	if class == RangefeedClass {
		dialOpts = append(dialOpts, grpc.WithInitialWindowSize(rangefeedInitialWindowSize(ctx)))
	} else {
		dialOpts = append(dialOpts, grpc.WithInitialWindowSize(initialWindowSize(ctx)))
	}
