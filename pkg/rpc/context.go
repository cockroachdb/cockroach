...
func (a muxRangeFeedClientAdapter) Recv() (*roachpb.MuxRangeFeedResponse, error) {
	e, err := a.recvHandler()
	if err != nil {
		return nil, err
	}
	return e.(*roachpb.MuxRangeFeedResponse), nil
}
...
func (a muxRangeFeedServerAdapter) Send(event *roachpb.MuxRangeFeedResponse) error {
