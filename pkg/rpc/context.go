...
type rangeFeedStreamClientAdapter struct {
	localStream
	sendHandler func(interface{}) error
	recvHandler func() (interface{}, error)
}

func (a rangeFeedStreamClientAdapter) Send(r *roachpb.RangeFeedRequest) error {
	return a.sendHandler(r)
}

func (a rangeFeedStreamClientAdapter) Recv() (*roachpb.RangeFeedStreamResponse, error) {
	e, err := a.recvHandler()
	if err != nil {
		return nil, err
	}
	return e.(*roachpb.RangeFeedStreamResponse), nil
}

var _ roachpb.Internal_RangeFeedStreamClient = rangeFeedStreamClientAdapter{}

type rangeFeedStreamServerAdapter struct {
	localStream
	sendHandler func(interface{}) error
	recvHandler func() (interface{}, error)
}

func (a rangeFeedStreamServerAdapter) Send(event *roachpb.RangeFeedStreamResponse) error {
	return a.sendHandler(event)
}

func (a rangeFeedStreamServerAdapter) Recv() (*roachpb.RangeFeedRequest, error) {
	e, err := a.recvHandler()
	if err != nil {
		return nil, err
	}
...
var _ roachpb.Internal_RangeFeedStreamServer = rangeFeedStreamServerAdapter{}

func (a internalClientAdapter) RangeFeedStream(
	ctx context.Context, opts ...grpc.CallOption,
) (roachpb.Internal_RangeFeedStreamClient, error) {
	ctx, cancel := context.WithCancel(ctx)
	...
	adapter := rangeFeedStreamClientAdapter{
		localStream: localStream{ctx: ctx},
		sendHandler: clientStream.sendInternal,
		recvHandler: serverStream.recvInternal,
	}
	// rfAdapter.client.Send() -> rfAdapter.server.respC
	return adapter, nil
}
