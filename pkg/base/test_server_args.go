...
var (
	...
	TestTenantProbabilisticOnly = DefaultTestTenantOptions{testBehavior: ttProbOnly}
	...
	TestTenantProbabilistic = DefaultTestTenantOptions{testBehavior: ttProb}
	...
	TestIsSpecificToStorageLayerAndNeedsASystemTenant = DefaultTestTenantOptions{testBehavior: ttDisabled}
	...
	// sentinel value.
	InternalNonDefaultDecision = DefaultTestTenantOptions{testBehavior: ttDisabled}
)
...
func TestDoesNotWorkWithSecondaryTenantsButWeDontKnowWhyYet(
	...
	return DefaultTestTenantOptions{testBehavior: ttDisabled, issueNum: issueNumber, label: "C-test-failure"}
}
...
func TestIsForStuffThatShouldWorkWithSecondaryTenantsButDoesntYet(
	...
	return DefaultTestTenantOptions{testBehavior: ttDisabled, issueNum: issueNumber, label: "C-bug"}
}
