...
target_file_size=2097152`
	...
	testCases := []struct {
		...
		// errors
		{"path=/mnt/hda1,size=0", "store size (0B) must be at least 640 MiB", StoreSpec{}},
		...
		// type
		{"type=mem,size=20GiB", "", StoreSpec{Size: storageconfig.BytesSize(21474836480), Type: storageconfig.InMemoryStore}},
		{"size=20GiB,type=mem", "", StoreSpec{Size: storageconfig.BytesSize(21474836480), Type: storageconfig.InMemoryStore}},
		{"size=20.5GiB,type=mem", "", StoreSpec{Size: storageconfig.BytesSize(22011707392), Type: storageconfig.InMemoryStore}},
		...
		{"type=mem,size=20", "store size (20B) must be at least 640 MiB", StoreSpec{}},
...
func TestStoreSpecListPreventedStartupMessage(t *testing.T) {
	...
	ssl := base.StoreSpecList{
		Specs: []base.StoreSpec{
			{Path: "foo", Type: storageconfig.InMemoryStore},
			{Path: okStoreDir},
			{Path: boomStoreDir},
		},
	}
