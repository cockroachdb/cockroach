...
var (
	...
	defaultRaftTickInterval = envutil.EnvOrDefaultDuration("COCKROACH_RAFT_TICK_INTERVAL",
	...
	defaultRaftHeartbeatIntervalTicks = envutil.EnvOrDefaultInt(
		"COCKROACH_RAFT_HEARTBEAT_INTERVAL_TICKS", 5)
	...
	defaultRangeLeaseRaftElectionTimeoutMultiplier = envutil.EnvOrDefaultFloat(
		"COCKROACH_RANGE_LEASE_RAFT_ELECTION_TIMEOUT_MULTIPLIER", 3.0)
	...
	defaultRangeLeaseRenewalFraction = envutil.EnvOrDefaultFloat(
	...
	livenessRenewalFraction = envutil.EnvOrDefaultFloat(
