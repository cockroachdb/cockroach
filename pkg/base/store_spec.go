...
func PopulateWithEncryptionOpts(
	...
	for _, es := range encryptionSpecs.Specs {
		...
		pathMatched, err := setExternalPathEncryption(&walFailoverConfig.Path, es)
		if err != nil {
			return err
		}
		prevPathMatched, err := setExternalPathEncryption(&walFailoverConfig.PrevPath, es)
		if err != nil {
			return err
		}
...
func setExternalPathEncryption(
