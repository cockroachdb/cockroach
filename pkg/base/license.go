...
// RegisterLicenseExpiryCallback is a function that's called on startup
// in order to connect the enterprise license setting update to the
// prometheus metric defined above.
var RegisterLicenseExpiryCallback = func(st *cluster.Settings, ts timeutil.TimeSource) {}
