...
func (*SystemConfigEntries) Descriptor() ([]byte, []int) {
	return fileDescriptor_system_97c2c510a15d21db, []int{0}
}
...
func init() { proto.RegisterFile("config/system.proto", fileDescriptor_system_97c2c510a15d21db) }

var fileDescriptor_system_97c2c510a15d21db = []byte{
