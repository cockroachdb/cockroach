...
type GCPolicy struct {
	...
	// For internal use only. Internal options not settable via yaml.
	Internal GCPolicy_Internal `protobuf:"bytes,2,opt,name=internal" json:"internal" yaml:"-"`
}
...
type GCPolicy_Internal struct {
	// On DROP and TRUNCATE, the drop deadline is set to a timestamp
	// after which the GC queue will invoke ClearRange on the data.
	// The GC queue is activated if this value is non-zero.
	DropDeadline cockroach_util_hlc.Timestamp `protobuf:"bytes,1,opt,name=drop_deadline,json=dropDeadline" json:"drop_deadline"`
}

func (m *GCPolicy_Internal) Reset()                    { *m = GCPolicy_Internal{} }
func (m *GCPolicy_Internal) String() string            { return proto.CompactTextString(m) }
func (*GCPolicy_Internal) ProtoMessage()               {}
func (*GCPolicy_Internal) Descriptor() ([]byte, []int) { return fileDescriptorZone, []int{0, 0} }
...
func init() {
	...
	proto.RegisterType((*GCPolicy_Internal)(nil), "cockroach.config.GCPolicy.Internal")
...
func (this *GCPolicy_Internal) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*GCPolicy_Internal)
	if !ok {
		that2, ok := that.(GCPolicy_Internal)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.DropDeadline.Equal(&that1.DropDeadline) {
		return false
	}
	return true
}
...
func (m *GCPolicy) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x12
	i++
	i = encodeVarintZone(dAtA, i, uint64(m.Internal.Size()))
...
func (m *GCPolicy_Internal) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *GCPolicy_Internal) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	dAtA[i] = 0xa
	i++
	i = encodeVarintZone(dAtA, i, uint64(m.DropDeadline.Size()))
	n2, err := m.DropDeadline.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n2
...
func (m *ZoneConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	n4, err := m.Constraints.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n4
...
func (m *GCPolicy_Internal) Size() (n int) {
	var l int
	_ = l
	l = m.DropDeadline.Size()
	n += 1 + l + sovZone(uint64(l))
	return n
}
...
func (m *GCPolicy_Internal) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DropDeadline", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.DropDeadline.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorZone = []byte{
	...
	,
}
