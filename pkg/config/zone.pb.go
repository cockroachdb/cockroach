...
func (Constraint_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_zone_307d7ba44b6664f2, []int{1, 0}
}
...
func (*GCPolicy) Descriptor() ([]byte, []int) {
	return fileDescriptor_zone_307d7ba44b6664f2, []int{0}
}
...
func (*Constraint) Descriptor() ([]byte, []int) {
	return fileDescriptor_zone_307d7ba44b6664f2, []int{1}
}
...
func (*Constraints) Descriptor() ([]byte, []int) {
	return fileDescriptor_zone_307d7ba44b6664f2, []int{2}
}
...
func (*LeasePreference) Descriptor() ([]byte, []int) {
	return fileDescriptor_zone_307d7ba44b6664f2, []int{3}
}
...
func (*ZoneConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_zone_307d7ba44b6664f2, []int{4}
}
...
func (*Subzone) Descriptor() ([]byte, []int) {
	return fileDescriptor_zone_307d7ba44b6664f2, []int{5}
}
...
func (*SubzoneSpan) Descriptor() ([]byte, []int) {
	return fileDescriptor_zone_307d7ba44b6664f2, []int{6}
}
...
func init() { proto.RegisterFile("config/zone.proto", fileDescriptor_zone_307d7ba44b6664f2) }

var fileDescriptor_zone_307d7ba44b6664f2 = []byte{
	// 847 bytes of a gzipped FileDescriptorProto
	,
}
