...
type ZoneConfig struct {
	...
	ExplicitlySetConstraints bool `protobuf:"varint,10,opt,name=explicitly_set_constraints,json=explicitlySetConstraints" json:"explicitly_set_constraints"`
	...
	// ExplicitlySetContraints specifies if value in the Constraints field was
	// pupulated by the user explicitly and not inherited from the zone's parent.
	ExplicitlySetLeasePreferences bool `protobuf:"varint,11,opt,name=explicitly_set_lease_preferences,json=explicitlySetLeasePreferences" json:"explicitly_set_lease_preferences"`
...
func (this *ZoneConfig) Equal(that interface{}) bool {
	...
	if this.ExplicitlySetConstraints != that1.ExplicitlySetConstraints {
		return false
	}
	...
	if this.ExplicitlySetLeasePreferences != that1.ExplicitlySetLeasePreferences {
		return false
	}
...
func (m *ZoneConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x58
	i++
	if m.ExplicitlySetLeasePreferences {
		dAtA[i] = 1
	} else {
		dAtA[i] = 0
	}
...
func NewPopulatedZoneConfig(r randyZone, easy bool) *ZoneConfig {
	...
	this.ExplicitlySetConstraints = bool(bool(r.Intn(2) == 0))
	this.ExplicitlySetLeasePreferences = bool(bool(r.Intn(2) == 0))
	if !easy && r.Intn(10) != 0 {
	}
	return this
}
...
func (m *ZoneConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExplicitlySetConstraints", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ExplicitlySetConstraints = bool(v != 0)
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExplicitlySetLeasePreferences", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ExplicitlySetLeasePreferences = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipZone(dAtA[iNdEx:])
			if err != nil {
...
var fileDescriptorZone = []byte{
	...
	,
}
