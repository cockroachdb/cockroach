...
type marshalableZoneConfig struct {
	...
	GC                           *GCPolicy         `json:"gc"`
	NonBlockingTxns              *bool             `json:"non_blocking_txns" yaml:"non_blocking_txns"`
...
func zoneConfigToMarshalable(c ZoneConfig) marshalableZoneConfig {
	...
	if c.NonBlockingTxns != nil {
		m.NonBlockingTxns = proto.Bool(*c.NonBlockingTxns)
	}
...
func zoneConfigFromMarshalable(m marshalableZoneConfig, c ZoneConfig) ZoneConfig {
	...
	if m.NonBlockingTxns != nil {
		c.NonBlockingTxns = proto.Bool(*m.NonBlockingTxns)
	}
