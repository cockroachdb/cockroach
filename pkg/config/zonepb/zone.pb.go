...
func (Constraint_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_zone_845007ab3f32b5c9, []int{1, 0}
}
...
func (*GCPolicy) Descriptor() ([]byte, []int) {
	return fileDescriptor_zone_845007ab3f32b5c9, []int{0}
}
...
func (*Constraint) Descriptor() ([]byte, []int) {
	return fileDescriptor_zone_845007ab3f32b5c9, []int{1}
}
...
func (*ConstraintsConjunction) Descriptor() ([]byte, []int) {
	return fileDescriptor_zone_845007ab3f32b5c9, []int{2}
}
...
func (*LeasePreference) Descriptor() ([]byte, []int) {
	return fileDescriptor_zone_845007ab3f32b5c9, []int{3}
}
...
type ZoneConfig struct {
	...
	// desired number of voting and non-voting replicas.
	...
	// configured and constrained separately, using the `num_voters` and
	// `voter_constraints` attributes. When false (default), `num_replicas`
	...
	NumVotersConfiguredSeparately bool `protobuf:"varint,15,opt,name=num_voters_configured_separately,json=numVotersConfiguredSeparately" json:"num_voters_configured_separately"`
	// NumVoters specifies the desired number of voter replicas.
	NumVoters *int32 `protobuf:"varint,12,opt,name=num_voters,json=numVoters" json:"num_voters,omitempty" yaml:"num_voters"`
	...
	// config statement with the number of replicas set to 0. If not, fix the
	// above comment.
	...
	// not necessarily a subset.
	VoterConstraints []ConstraintsConjunction `protobuf:"bytes,13,rep,name=voter_constraints,json=voterConstraints" json:"voter_constraints" yaml:"voter_constraints,flow"`
	...
	// user.
	InheritedVoterConstraints bool `protobuf:"varint,14,opt,name=inherited_voter_constraints,json=inheritedVoterConstraints" json:"inherited_voter_constraints"`
...
func (*ZoneConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_zone_845007ab3f32b5c9, []int{4}
}
...
func (*Subzone) Descriptor() ([]byte, []int) {
	return fileDescriptor_zone_845007ab3f32b5c9, []int{5}
}
...
func (*SubzoneSpan) Descriptor() ([]byte, []int) {
	return fileDescriptor_zone_845007ab3f32b5c9, []int{6}
}
...
func (this *ZoneConfig) Equal(that interface{}) bool {
	...
	if this.NumVotersConfiguredSeparately != that1.NumVotersConfiguredSeparately {
		return false
	}
...
func (m *ZoneConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x78
	i++
	if m.NumVotersConfiguredSeparately {
		dAtA[i] = 1
	} else {
		dAtA[i] = 0
	}
...
func NewPopulatedZoneConfig(r randyZone, easy bool) *ZoneConfig {
	...
	if r.Intn(10) != 0 {
		v17 := r.Intn(5)
		this.VoterConstraints = make([]ConstraintsConjunction, v17)
		for i := 0; i < v17; i++ {
			v18 := NewPopulatedConstraintsConjunction(r, easy)
			this.VoterConstraints[i] = *v18
		}
	}
	this.InheritedVoterConstraints = bool(bool(r.Intn(2) == 0))
	this.NumVotersConfiguredSeparately = bool(bool(r.Intn(2) == 0))
	if !easy && r.Intn(10) != 0 {
	}
	return this
}
...
func (m *ZoneConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 15:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field NumVotersConfiguredSeparately", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.NumVotersConfiguredSeparately = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipZone(dAtA[iNdEx:])
			if err != nil {
...
func init() { proto.RegisterFile("config/zonepb/zone.proto", fileDescriptor_zone_845007ab3f32b5c9) }

var fileDescriptor_zone_845007ab3f32b5c9 = []byte{
	// 968 bytes of a gzipped FileDescriptorProto
	,
}
