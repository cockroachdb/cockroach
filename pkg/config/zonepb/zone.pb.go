...
func (Constraint_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_zone_d3eaa18978737071, []int{1, 0}
}
...
func (*GCPolicy) Descriptor() ([]byte, []int) {
	return fileDescriptor_zone_d3eaa18978737071, []int{0}
}
...
func (*Constraint) Descriptor() ([]byte, []int) {
	return fileDescriptor_zone_d3eaa18978737071, []int{1}
}
...
func (*ConstraintsConjunction) Descriptor() ([]byte, []int) {
	return fileDescriptor_zone_d3eaa18978737071, []int{2}
}
...
func (*LeasePreference) Descriptor() ([]byte, []int) {
	return fileDescriptor_zone_d3eaa18978737071, []int{3}
}
...
func (*ZoneConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_zone_d3eaa18978737071, []int{4}
}
...
func (*Subzone) Descriptor() ([]byte, []int) {
	return fileDescriptor_zone_d3eaa18978737071, []int{5}
}
...
func (*SubzoneSpan) Descriptor() ([]byte, []int) {
	return fileDescriptor_zone_d3eaa18978737071, []int{6}
}
...
func init() { proto.RegisterFile("config/zonepb/zone.proto", fileDescriptor_zone_d3eaa18978737071) }

var fileDescriptor_zone_d3eaa18978737071 = []byte{
	...
	,
}
