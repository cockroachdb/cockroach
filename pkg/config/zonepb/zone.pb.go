...
type ZoneConfig struct {
	...
	// IsEphemeral specifies if the range(s) contain ephemeral data. Ephemeral
	// data is assumed to have a short GC.TTL, and is therefore not included in
	// operations that rely on reading revisions. egs: BACKUP
	IsEphemeral *bool `protobuf:"varint,16,opt,name=is_ephemeral,json=isEphemeral" json:"is_ephemeral,omitempty" yaml:"is_ephemeral"`
}
...
var fileDescriptor_450fc84cee6c50bb = []byte{
	...
	,
}
...
func (this *ZoneConfig) Equal(that interface{}) bool {
	...
	if this.IsEphemeral != nil && that1.IsEphemeral != nil {
		if *this.IsEphemeral != *that1.IsEphemeral {
			return false
		}
	} else if this.IsEphemeral != nil {
		return false
	} else if that1.IsEphemeral != nil {
		return false
	}
	return true
}
...
func NewPopulatedSubzone(r randyZone, easy bool) *Subzone {
	...
	v21 := NewPopulatedZoneConfig(r, easy)
	this.Config = *v21
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedSubzoneSpan(r randyZone, easy bool) *SubzoneSpan {
	...
	if r.Intn(5) != 0 {
		v22 := r.Intn(100)
		this.Key = make(github_com_cockroachdb_cockroach_pkg_roachpb.Key, v22)
		for i := 0; i < v22; i++ {
	...
	if r.Intn(5) != 0 {
		v23 := r.Intn(100)
		this.EndKey = make(github_com_cockroachdb_cockroach_pkg_roachpb.Key, v23)
		for i := 0; i < v23; i++ {
...
func randFieldZone(dAtA []byte, r randyZone, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateZone(dAtA, uint64(v25))
	case 1:
		dAtA = encodeVarintPopulateZone(dAtA, uint64(key))
...
func (m *ZoneConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 16:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IsEphemeral", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
