...
// ZonesPrefix returns key prefix for the primary index in the system.zones
// table.
func ZonesPrefix(codec keys.SQLCodec) roachpb.Key {
...
func MakeZoneKeyPrefix(codec keys.SQLCodec, id descpb.ID) roachpb.Key {
	return encoding.EncodeUvarintAscending(ZonesPrefix(codec), uint64(id))
}
