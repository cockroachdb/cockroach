...
func DefaultZoneConfig() ZoneConfig {
	...
	return ZoneConfig{
		NumReplicas:   proto.Int32(*defaultZoneConfig.NumReplicas),
		RangeMinBytes: proto.Int64(*defaultZoneConfig.RangeMinBytes),
...
func DefaultSystemZoneConfig() ZoneConfig {
	...
	defer testingLock.Unlock()
	return ZoneConfig{
		NumReplicas:   proto.Int32(*defaultSystemZoneConfig.NumReplicas),
		RangeMinBytes: proto.Int64(*defaultSystemZoneConfig.RangeMinBytes),
...
func (z *ZoneConfig) Validate() error {
	...
	switch {
	case z.NumReplicas != nil && *z.NumReplicas < 0:
