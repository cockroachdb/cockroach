...
func New(msg string) error {
	return WithDomain(errors.New(msg), packageDomainInternal(1))
}
...
func Handled(err error) error {
	return HandledInDomain(err, packageDomainInternal(1))
}
...
func PackageDomain() Domain {
	return packageDomainInternal(1)
}

func packageDomainInternal(depth int) Domain {
