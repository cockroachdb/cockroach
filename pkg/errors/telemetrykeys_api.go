...
import "github.com/cockroachdb/cockroach/pkg/errors/telemetrykeys"
...
var WithTelemetry func(err error, keys ...string) error = telemetrykeys.WithTelemetry
...
var GetTelemetryKeys func(err error) []string = telemetrykeys.GetTelemetryKeys
