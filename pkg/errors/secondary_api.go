...
import "github.com/cockroachdb/cockroach/pkg/errors/secondary"
...
var WithSecondaryError func(err error, additionalErr error) error = secondary.WithSecondaryError
