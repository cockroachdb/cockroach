...
type Request struct {
	...
	Addr *cockroach_util.UnresolvedAddr `protobuf:"bytes,2,opt,name=addr" json:"addr,omitempty"`
	...
	ClusterID *github_com_cockroachdb_cockroach_pkg_util_uuid.UUID `protobuf:"bytes,5,opt,name=cluster_id,json=clusterId,proto3,customtype=github.com/cockroachdb/cockroach/pkg/util/uuid.UUID" json:"cluster_id,omitempty"`
}
...
func (m *OutgoingConnStatus) MarshalTo(dAtA []byte) (int, error) {
	...
	n7, err := m.ConnStatus.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n7
	...
	n8, err := m.MetricSnap.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n8
...
func (m *InfoStatus) MarshalTo(dAtA []byte) (int, error) {
	...
	n13, err := m.Connectivity.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n13
...
func (m *Request) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.Addr == nil {
				m.Addr = &cockroach_util.UnresolvedAddr{}
			}
...
var fileDescriptorGossip = []byte{
	...
	,
}
