...
func TestConvergence(t *testing.T) {
	...
	network := simulation.NewNetwork(stopper, testConvergenceSize, true, config.DefaultZoneConfig())
...
func TestNetworkReachesEquilibrium(t *testing.T) {
	...
	network := simulation.NewNetwork(stopper, testReachesEquilibriumSize, true, config.DefaultZoneConfig())
