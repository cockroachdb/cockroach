...
// loopController structure contains fields to control registry jobs
type loopController struct {
	timer   *timeutil.Timer
	lastRun time.Time
	updated chan struct{}
	// getInterval returns value of the associated cluster setting
...
// updateTimer is called when the associated interval setting gets updated
func (lc *loopController) updateTimer() {
	lc.updateTimerWithBound(lc.getInterval())
}

// updateTimerWithBound sets the associated timer's reset value to the minimum
// of associated cluster setting and maxDur
func (lc *loopController) updateTimerWithBound(maxDur time.Duration) {
