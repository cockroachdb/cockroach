...
func (r *Registry) makeJobLeaseKey(jobID int64) roachpb.Key {
	const leaseFamilyID = 2
	prefix := r.codec.IndexPrefix(keys.JobsTableID, 1)
...
func (r *Registry) AcquireLease(ctx context.Context, jobID int64) (*leasemanager.Lease, error) {
	return r.lm.AcquireLease(ctx, r.makeJobLeaseKey(jobID))
}
