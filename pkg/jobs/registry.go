...
func (r *Registry) AddChangefeedIdentityHashToJobInfo(
	...
	changefeedHash, err := r.GenerateChangefeedIdentityHash(ctx, details)
	if err != nil {
		return err
	}
...
func (r *Registry) GenerateChangefeedIdentityHash(
...
func (r *Registry) FindDuplicateChangefeedJob(
	...
	changefeedHash, err := r.GenerateChangefeedIdentityHash(ctx, record.Details.(jobspb.ChangefeedDetails))
	if err != nil {
