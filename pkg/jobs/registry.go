...
type Registry struct {
	...
	// improving this API.
	sessionBoundInternalExecutorFactory sqlutil.InternalExecutorFactory
...
// SetInternalExecutorFactory sets the InternalExecutorFactory that will be
// used by the job registry executor. We expose this separately from the
// constructor to avoid a circular dependency.
