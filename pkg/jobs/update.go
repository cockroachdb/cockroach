...
// DeprecatedUpdater is deprecated. See job_info_storage.go for better alternatives.
...
// DeprecatedNoTxn is deprecated. See job_info_storage.go for better alternatives.
func (j *Job) DeprecatedNoTxn() DeprecatedUpdater {
	return DeprecatedUpdater{j: j}
}

// DeprecatedDebugNameNoTxn is deprecated. See job_info_storage.go for better alternatives.
...
// DeprecatedWithTxn is deprecated. See job_info_storage.go for better alternatives.
