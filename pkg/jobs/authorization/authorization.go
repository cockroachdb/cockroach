...
// Authorizer is a function which returns an error if authorization for the job
// denoted by jobID and payload fails.
...
func Authorize(
	...
	return pgerror.Newf(pgcode.InsufficientPrivilege,
		"user %s does not have %s authorization for job $d",
