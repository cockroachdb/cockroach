...
// NotifyToResumeJobs is used to notify the registry that it should attempt
...
func (r *Registry) NotifyToResumeJobs(ctx context.Context, jobs []jobspb.JobID) {
	m := newJobIDSet(jobs...)
...
// leaking memory.
func (r *Registry) installWaitingSet(ids ...jobspb.JobID) (done <-chan struct{}, cleanup func()) {
	ws := &waitingSet{
