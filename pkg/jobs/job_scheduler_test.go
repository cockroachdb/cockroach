...
func (n *recordScheduleExecutor) CreateString(_ *ScheduledJob) (string, error) {
	return "", nil
}
...
func (e *returnErrorExecutor) CreateString(_ *ScheduledJob) (string, error) {
	return "", nil
}
...
func (e *txnConflictExecutor) CreateString(_ *ScheduledJob) (string, error) {
	return "", nil
}
