...
var _ Details = DeleteTempObjectsDetails{}
...
var _ ProgressDetails = DeleteTempObjectsProgress{}
...
func WrapProgressDetails(details ProgressDetails) interface {
	...
	case DeleteTempObjectsProgress:
		return &Progress_DeleteTempObjects{DeleteTempObjects: &d}
	default:
...
func WrapPayloadDetails(details Details) interface {
	...
	case DeleteTempObjectsDetails:
		return &Payload_DeleteTempObjects{DeleteTempObjects: &d}
	default:
