...
// JobDetailsForEveryJobType is an array of Details where each entry corresponds
// to a distinct jobspb.Type except for jobspb.TypeUnspecified.
var JobDetailsForEveryJobType = map[Type]Details{
	...
	TypeAutoCreateStats: CreateStatsDetails{
		// Differentiate between jobspb.TypeCreateStats and jobspb.TypeAutoCreateStats
		Name: AutoStatsName,
	},
