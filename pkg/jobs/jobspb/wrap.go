...
var _ Details = WaitingForGCDetails{}
...
var _ ProgressDetails = WaitingForGCProgress{}
...
func WrapProgressDetails(details ProgressDetails) interface {
	...
	case WaitingForGCProgress:
		return &Progress_WaitingForGC{WaitingForGC: &d}
	default:
...
func WrapPayloadDetails(details Details) interface {
	...
	case WaitingForGCDetails:
		return &Payload_WaitingForGC{WaitingForGC: &d}
	default:
