...
var (
	...
	_ Details = ConsistencyCheckDetails{}
)
...
var (
	...
	_ ProgressDetails = ConsistencyCheckProgress{}
)
...
func DetailsType(d isPayload_Details) (Type, error) {
	...
	case *Payload_ConsistencyCheckDetails:
		return TypeConsistencyCheck, nil
	default:
...
var JobDetailsForEveryJobType = map[Type]Details{
	...
	TypeConsistencyCheck:             ConsistencyCheckDetails{},
}
...
func WrapProgressDetails(details ProgressDetails) interface {
	...
	case ConsistencyCheckProgress:
		return &Progress_ConsistencyCheck{ConsistencyCheck: &d}
	default:
...
func (p *Payload) UnwrapDetails() Details {
	...
	case *Payload_ConsistencyCheckDetails:
		return *d.ConsistencyCheckDetails
	default:
		return nil
	}
}
...
func (p *Progress) UnwrapDetails() ProgressDetails {
	...
	case *Progress_ConsistencyCheck:
		return d.ConsistencyCheck
	default:
		return nil
	}
}
...
func WrapPayloadDetails(details Details) interface {
	...
	case ConsistencyCheckDetails:
		return &Payload_ConsistencyCheckDetails{ConsistencyCheckDetails: &d}
	default:
