...
var (
	...
	_ Details = ResourceGroupReconciliationDetails{}
)
...
var (
	...
	_ ProgressDetails = ResourceGroupReconciliationProgress{}
)
...
func DetailsType(d isPayload_Details) (Type, error) {
	...
	case *Payload_ResourceGroupReconciliationDetails:
		return TypeResourceGroupReconciliation, nil
	default:
...
var JobDetailsForEveryJobType = map[Type]Details{
	...
	TypeResourceGroupReconciliation:  ResourceGroupReconciliationDetails{},
}
...
func WrapProgressDetails(details ProgressDetails) interface {
	...
	case ResourceGroupReconciliationProgress:
		return &Progress_ResourceGroupReconciliation{ResourceGroupReconciliation: &d}
	default:
...
func (p *Payload) UnwrapDetails() Details {
	...
	case *Payload_ResourceGroupReconciliationDetails:
		return *d.ResourceGroupReconciliationDetails
	default:
		return nil
	}
}
...
func (p *Progress) UnwrapDetails() ProgressDetails {
	...
	case *Progress_ResourceGroupReconciliation:
		return *d.ResourceGroupReconciliation
	default:
		return nil
	}
}
...
func WrapPayloadDetails(details Details) interface {
	...
	case ResourceGroupReconciliationDetails:
		return &Payload_ResourceGroupReconciliationDetails{ResourceGroupReconciliationDetails: &d}
	default:
