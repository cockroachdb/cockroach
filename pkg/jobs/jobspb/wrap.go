...
var _ Details = DeleteTempTablesDetails{}
...
var _ ProgressDetails = DeleteTempTablesProgress{}
...
func WrapProgressDetails(details ProgressDetails) interface {
	...
	case DeleteTempTablesProgress:
		return &Progress_DeleteTempTables{DeleteTempTables: &d}
	default:
...
func WrapPayloadDetails(details Details) interface {
	...
	case DeleteTempTablesDetails:
		return &Payload_DeleteTempTables{DeleteTempTables: &d}
	default:
