...
type StreamReplicationDetails struct {
	// Which tenant in the source cluster we stream replication from
	TenantID uint64 `protobuf:"varint,1,opt,name=tenant_id,json=tenantId,proto3" json:"tenant_id,omitempty"`
	// Key span we are replicating
	Span *roachpb.Span `protobuf:"bytes,2,opt,name=span,proto3" json:"span,omitempty"`
	// Timeout after which we clean up the job
	StreamTimeout time.Duration `protobuf:"varint,3,opt,name=stream_timeout,json=streamTimeout,proto3,casttype=time.Duration" json:"stream_timeout,omitempty"`
}
...
type StreamReplicationProgress struct {
	// Last active timestamp in micros
	LastActive int64 `protobuf:"varint,1,opt,name=last_active,json=lastActive,proto3" json:"last_active,omitempty"`
}
...
type Payload struct {
	...
	//	*Payload_StreamReplicationDetails
...
type Payload_StreamReplicationDetails struct {
	StreamReplicationDetails *StreamReplicationDetails `protobuf:"bytes,33,opt,name=streamReplicationDetails,proto3,oneof" json:"streamReplicationDetails,omitempty"`
}
...
func (*Payload_StreamReplicationDetails) isPayload_Details()     {}
...
func (m *Payload) GetStreamReplicationDetails() *StreamReplicationDetails {
	if x, ok := m.GetDetails().(*Payload_StreamReplicationDetails); ok {
		return x.StreamReplicationDetails
	}
	return nil
}
...
func (*Payload) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*Payload_StreamReplicationDetails)(nil),
	}
}
...
type Progress struct {
	...
	//	*Progress_StreamReplicationProgress
...
type Progress_StreamReplicationProgress struct {
	StreamReplicationProgress *StreamReplicationProgress `protobuf:"bytes,24,opt,name=streamReplicationProgress,proto3,oneof" json:"streamReplicationProgress,omitempty"`
}
...
func (*Progress_StreamReplicationProgress) isProgress_Details()    {}
...
func (m *Progress) GetStreamReplicationProgress() *StreamReplicationProgress {
	if x, ok := m.GetDetails().(*Progress_StreamReplicationProgress); ok {
		return x.StreamReplicationProgress
	}
	return nil
}
...
func (*Progress) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*Progress_StreamReplicationProgress)(nil),
	}
}
...
var fileDescriptor_6c315f3a2536c4ef = []byte{
	...
	,
}
...
func (m *StreamReplicationDetails) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.StreamTimeout != 0 {
		i = encodeVarintJobs(dAtA, i, uint64(m.StreamTimeout))
		i--
		dAtA[i] = 0x18
	}
	if m.Span != nil {
...
func (m *StreamReplicationProgress) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.LastActive != 0 {
		i = encodeVarintJobs(dAtA, i, uint64(m.LastActive))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *NewSchemaChangeProgress) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.States) > 0 {
		dAtA30 := make([]byte, len(m.States)*10)
		var j29 int
...
func (m *Payload_StreamReplicationDetails) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Payload_StreamReplicationDetails) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.StreamReplicationDetails != nil {
		{
			size, err := m.StreamReplicationDetails.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Progress_StreamReplicationProgress) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Progress_StreamReplicationProgress) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.StreamReplicationProgress != nil {
		{
			size, err := m.StreamReplicationProgress.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *StreamReplicationDetails) Size() (n int) {
	...
	if m.StreamTimeout != 0 {
		n += 1 + sovJobs(uint64(m.StreamTimeout))
	}
	return n
}
...
func (m *StreamReplicationProgress) Size() (n int) {
	...
	_ = l
	if m.LastActive != 0 {
		n += 1 + sovJobs(uint64(m.LastActive))
	}
	return n
}
...
func (m *Payload_StreamReplicationDetails) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.StreamReplicationDetails != nil {
		l = m.StreamReplicationDetails.Size()
		n += 2 + l + sovJobs(uint64(l))
	}
	return n
}
...
func (m *Progress_StreamReplicationProgress) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.StreamReplicationProgress != nil {
		l = m.StreamReplicationProgress.Size()
		n += 2 + l + sovJobs(uint64(l))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.StreamTimeout |= time.Duration(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *Payload) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 33:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field StreamReplicationDetails", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Details = &Payload_StreamReplicationDetails{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipJobs(dAtA[iNdEx:])
...
func (m *Progress) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 24:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field StreamReplicationProgress", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Details = &Progress_StreamReplicationProgress{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipJobs(dAtA[iNdEx:])
