...
type StreamIngestionProgress_EventType int32

const (
	StreamIngestionProgress_Generation    StreamIngestionProgress_EventType = 0
	StreamIngestionProgress_JobCompletion StreamIngestionProgress_EventType = 1
)

var StreamIngestionProgress_EventType_name = map[int32]string{
	0: "Generation",
	1: "JobCompletion",
}

var StreamIngestionProgress_EventType_value = map[string]int32{
	"Generation":    0,
	"JobCompletion": 1,
}

func (x StreamIngestionProgress_EventType) String() string {
	return proto.EnumName(StreamIngestionProgress_EventType_name, int32(x))
}

func (StreamIngestionProgress_EventType) EnumDescriptor() ([]byte, []int) {
...
type StreamIngestionProgress struct {
	...
	CutoverTriggeredBy StreamIngestionProgress_EventType `protobuf:"varint,2,opt,name=cutover_triggered_by,json=cutoverTriggeredBy,proto3,enum=cockroach.sql.jobs.jobspb.StreamIngestionProgress_EventType" json:"cutover_triggered_by,omitempty"`
}
...
func init() {
	...
	proto.RegisterEnum("cockroach.sql.jobs.jobspb.StreamIngestionProgress_EventType", StreamIngestionProgress_EventType_name, StreamIngestionProgress_EventType_value)
...
var fileDescriptor_6c315f3a2536c4ef = []byte{
	...
	,
}
...
func (m *StreamIngestionProgress) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.CutoverTriggeredBy != 0 {
		i = encodeVarintJobs(dAtA, i, uint64(m.CutoverTriggeredBy))
		i--
		dAtA[i] = 0x10
	}
	{
...
func (m *StreamIngestionProgress) Size() (n int) {
	...
	n += 1 + l + sovJobs(uint64(l))
	if m.CutoverTriggeredBy != 0 {
		n += 1 + sovJobs(uint64(m.CutoverTriggeredBy))
	}
	return n
}
...
func (m *StreamIngestionProgress) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CutoverTriggeredBy", wireType)
			}
			m.CutoverTriggeredBy = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowJobs
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CutoverTriggeredBy |= StreamIngestionProgress_EventType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
