...
type BackupDetails struct {
	...
	// is written by the backup job. While the job ought to clean up the record
	// when it enters a terminal state, there may be cases where it cannot or does
	// not run the code to do so. To deal with this there is a background
	...
	// ProtectedTimestampRecordFromPreviousBackup is the ID of the protected
	// timestamp record from the previous backup in the chain, that should be
	// released by the backup job on successful completion.
	//
	// Currently, this field is only set for scheduled incremental backups that
	// rely on the record written by the previous full or incremental backup in
	// the chain.
	ProtectedTimestampRecordFromPreviousBackup *github_com_cockroachdb_cockroach_pkg_util_uuid.UUID `protobuf:"bytes,10,opt,name=protected_timestamp_record_from_previous_backup,json=protectedTimestampRecordFromPreviousBackup,proto3,customtype=github.com/cockroachdb/cockroach/pkg/util/uuid.UUID" json:"protected_timestamp_record_from_previous_backup,omitempty"`
	// PersistProtectedTimestampRecordForNextBackup if set to true, prevents the
	// record created by the backup job from being released on successful
	// completion of the job.
	PersistProtectedTimestampRecordForNextBackup bool `protobuf:"varint,11,opt,name=persist_protected_timestamp_record_for_next_backup,json=persistProtectedTimestampRecordForNextBackup,proto3" json:"persist_protected_timestamp_record_for_next_backup,omitempty"`
...
var fileDescriptor_6c315f3a2536c4ef = []byte{
	...
	,
}
...
func (m *BackupDetails) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.PersistProtectedTimestampRecordForNextBackup {
		i--
		if m.PersistProtectedTimestampRecordForNextBackup {
			dAtA[i] = 1
		} else {
	...
	if m.ProtectedTimestampRecordFromPreviousBackup != nil {
		{
			size := m.ProtectedTimestampRecordFromPreviousBackup.Size()
			i -= size
			if _, err := m.ProtectedTimestampRecordFromPreviousBackup.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
			i = encodeVarintJobs(dAtA, i, uint64(size))
		}
...
func (m *BackupDetails) Size() (n int) {
	...
	if m.ProtectedTimestampRecordFromPreviousBackup != nil {
		l = m.ProtectedTimestampRecordFromPreviousBackup.Size()
		n += 1 + l + sovJobs(uint64(l))
	}
	if m.PersistProtectedTimestampRecordForNextBackup {
		n += 2
...
func (m *BackupDetails) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ProtectedTimestampRecordFromPreviousBackup", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			var v github_com_cockroachdb_cockroach_pkg_util_uuid.UUID
			m.ProtectedTimestampRecordFromPreviousBackup = &v
			if err := m.ProtectedTimestampRecordFromPreviousBackup.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PersistProtectedTimestampRecordForNextBackup", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PersistProtectedTimestampRecordForNextBackup = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipJobs(dAtA[iNdEx:])
			if err != nil {
