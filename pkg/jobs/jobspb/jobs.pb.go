...
const (
	// JobEventUnspecified is the zero value for EventType and should be used.
	JobEventUnspecified ExecutionEvent_EventType = 0
	// JobStartEvent indicates that this event was created at the beginning of
	// job execution.
	JobStartEvent ExecutionEvent_EventType = 1
	// JobEndEvent indicates that this event was created at the end of job
	// execution.
	JobEndEvent ExecutionEvent_EventType = 2
)

var ExecutionEvent_EventType_name = map[int32]string{
	0: "UNSPECIFIED",
	1: "START",
	2: "END",
}

var ExecutionEvent_EventType_value = map[string]int32{
	"UNSPECIFIED": 0,
	"START":       1,
	"END":         2,
}
...
func (x ExecutionEvent_EventType) String() string {
	return proto.EnumName(ExecutionEvent_EventType_name, int32(x))
}
...
// ExecutionEvent holds information about a job when it starts or
// ends an execution. It contains information about the event time,
// the node on which the job is executed, the status of the job,and
// any errors occurred during execution.
type ExecutionEvent struct {
	// Type of event, start or end of execution when this event is created.
	Type ExecutionEvent_EventType `protobuf:"varint,1,opt,name=type,proto3,enum=cockroach.sql.jobs.jobspb.ExecutionEvent_EventType" json:"type,omitempty"`
	// ID of the node on which the job is executed.
	InstanceId int32 `protobuf:"varint,2,opt,name=instance_id,json=instanceId,proto3" json:"instance_id,omitempty"`
	// Status of the job in this execution. It should be a jobs.Status.
	Status string `protobuf:"bytes,3,opt,name=status,proto3" json:"status,omitempty"`
	// Event timestamp when the event is created, represented as the number
	// of microseconds elapsed since UnixEpoch. See timeutil.ToUnixMicros
	// for more information about conversion to micros.
	EventTimeMicros int64 `protobuf:"varint,4,opt,name=event_time_micros,json=eventTimeMicros,proto3" json:"event_time_micros,omitempty"`
	// Errors during execution: it is empty for a JobStartEvent. For a JobEndEvent,
	// it consists of errors encountered during the current job execution.
	ExecutionError string `protobuf:"bytes,5,opt,name=execution_error,json=executionError,proto3" json:"execution_error,omitempty"`
}
...
func (m *ExecutionEvent) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ExecutionEvent.Merge(m, src)
}
...
type Payload struct {
	...
	// An ExecutionEvent is created whenever a job's Resumer starts and ends
	// an execution. At the beginning of the execution of a job's Resumer,
	// a EventType.START event is created and appended to executionLog in
	// job's payload. When the Resumer completes execution, which can be with
	// or without an error, an EventType.END event is created and appended to
	// job's executionLog. The sequence of events in this log show the lifecycle
	// of a job and the errors encountered during job execution.
	ExecutionLog []*ExecutionEvent `protobuf:"bytes,29,rep,name=executionLog,proto3" json:"executionLog,omitempty"`
}
...
func init() {
	...
	proto.RegisterEnum("cockroach.sql.jobs.jobspb.ExecutionEvent_EventType", ExecutionEvent_EventType_name, ExecutionEvent_EventType_value)
	...
	proto.RegisterType((*ExecutionEvent)(nil), "cockroach.sql.jobs.jobspb.ExecutionEvent")
...
var fileDescriptor_6c315f3a2536c4ef = []byte{
	...
	,
}
...
func (m *ImportProgress) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.WriteProgress) > 0 {
		for iNdEx := len(m.WriteProgress) - 1; iNdEx >= 0; iNdEx-- {
			f23 := math.Float32bits(float32(m.WriteProgress[iNdEx]))
			i -= 4
	...
	if len(m.ReadProgress) > 0 {
		for iNdEx := len(m.ReadProgress) - 1; iNdEx >= 0; iNdEx-- {
			f24 := math.Float32bits(float32(m.ReadProgress[iNdEx]))
			i -= 4
	...
	if len(m.SamplingProgress) > 0 {
		for iNdEx := len(m.SamplingProgress) - 1; iNdEx >= 0; iNdEx-- {
			f25 := math.Float32bits(float32(m.SamplingProgress[iNdEx]))
			i -= 4
...
func (m *NewSchemaChangeProgress) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.States) > 0 {
		dAtA27 := make([]byte, len(m.States)*10)
		var j26 int
...
func (m *SchemaChangeDetails) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.DroppedSchemas) > 0 {
		dAtA32 := make([]byte, len(m.DroppedSchemas)*10)
		var j31 int
	...
	if len(m.DroppedTypes) > 0 {
		dAtA34 := make([]byte, len(m.DroppedTypes)*10)
		var j33 int
...
func (m *CreateStatsDetails_ColStat) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ColumnIDs) > 0 {
		dAtA44 := make([]byte, len(m.ColumnIDs)*10)
		var j43 int
...
func (m *ExecutionEvent) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ExecutionEvent) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ExecutionEvent) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.ExecutionError) > 0 {
		...
		i = encodeVarintJobs(dAtA, i, uint64(len(m.ExecutionError)))
		i--
		dAtA[i] = 0x2a
	}
	if m.EventTimeMicros != 0 {
		i = encodeVarintJobs(dAtA, i, uint64(m.EventTimeMicros))
		i--
		dAtA[i] = 0x20
	}
	if len(m.Status) > 0 {
...
func (m *Payload) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ExecutionLog) > 0 {
		for iNdEx := len(m.ExecutionLog) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ExecutionLog[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.DescriptorIDs) > 0 {
		dAtA48 := make([]byte, len(m.DescriptorIDs)*10)
		var j47 int
		...
		i = encodeVarintJobs(dAtA, i, uint64(j47))
		i--
		dAtA[i] = 0x32
	}
...
func (m *ExecutionEvent) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.EventTimeMicros != 0 {
		n += 1 + sovJobs(uint64(m.EventTimeMicros))
	}
...
func (m *ExecutionEvent) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= ExecutionEvent_EventType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EventTimeMicros", wireType)
			}
			m.EventTimeMicros = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.EventTimeMicros |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *Payload) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 29:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExecutionLog", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ExecutionLog = append(m.ExecutionLog, &ExecutionEvent{})
			if err := m.ExecutionLog[len(m.ExecutionLog)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 30:
