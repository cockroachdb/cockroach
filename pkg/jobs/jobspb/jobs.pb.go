...
// TransitionLog records state transitions of jobs from Registry. A job passes through several
// states in its lifecycle, and its state transitions can happen due to failures. TransitionLog
// records information about the current execution of a job and the error, if any, happened during
// job's current execution.
type TransitionLog struct {
	// The node on which the job's Resumer is running.
	CoordinatorId int32 `protobuf:"varint,1,opt,name=coordinator_id,json=coordinatorId,proto3" json:"coordinator_id,omitempty"`
	// Job's state in which the resumer started.
	State string `protobuf:"bytes,2,opt,name=state,proto3" json:"state,omitempty"`
	// Time when the resumer started.
	ResumeStartMicros int64 `protobuf:"varint,3,opt,name=resume_start_micros,json=resumeStartMicros,proto3" json:"resume_start_micros,omitempty"`
	// Error message when the resumer finished execution.
	ResumeExitError *errorspb.EncodedError `protobuf:"bytes,4,opt,name=resume_exit_error,json=resumeExitError,proto3" json:"resume_exit_error,omitempty"`
}
...
func (*TransitionLog) Descriptor() ([]byte, []int) {
	return fileDescriptor_6c315f3a2536c4ef, []int{34}
}
func (m *TransitionLog) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TransitionLog) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *TransitionLog) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TransitionLog.Merge(m, src)
}
func (m *TransitionLog) XXX_Size() int {
	return m.Size()
}
func (m *TransitionLog) XXX_DiscardUnknown() {
	xxx_messageInfo_TransitionLog.DiscardUnknown(m)
}

var xxx_messageInfo_TransitionLog proto.InternalMessageInfo
...
type Payload struct {
	...
	// TransitionLogs record state transitions of a job and any errors that happened
	// during job's execution. A TransitionLog is created by Registry and appended
	// to transitionLogs before calling Resumer's Resume() or OnFailOrCancel() functions, i.e.,
	// when the job is executed in its running or reverting states.
	//
	// When the resumer completes its Resume()/OnFailOrCancel() with an error, Registry
	// populates resume_exit_error field of the TransitionLog that was appended for the
	// current attempt of the job.
	//
	// transition_logs column in crdb_internal.jobs shows these logs.
	TransitionLogs []*TransitionLog `protobuf:"bytes,29,rep,name=transitionLogs,proto3" json:"transitionLogs,omitempty"`
}
...
func init() {
	...
	proto.RegisterType((*TransitionLog)(nil), "cockroach.sql.jobs.jobspb.TransitionLog")
...
var fileDescriptor_6c315f3a2536c4ef = []byte{
	// 5596 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *TransitionLog) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TransitionLog) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TransitionLog) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.ResumeExitError != nil {
		{
			size, err := m.ResumeExitError.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.ResumeStartMicros != 0 {
		i = encodeVarintJobs(dAtA, i, uint64(m.ResumeStartMicros))
		i--
		dAtA[i] = 0x18
	}
	if len(m.State) > 0 {
		i -= len(m.State)
		copy(dAtA[i:], m.State)
		i = encodeVarintJobs(dAtA, i, uint64(len(m.State)))
		i--
		dAtA[i] = 0x12
	}
	if m.CoordinatorId != 0 {
		i = encodeVarintJobs(dAtA, i, uint64(m.CoordinatorId))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Payload) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.TransitionLogs) > 0 {
		for iNdEx := len(m.TransitionLogs) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.TransitionLogs[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *TransitionLog) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.CoordinatorId != 0 {
		n += 1 + sovJobs(uint64(m.CoordinatorId))
	}
	l = len(m.State)
	if l > 0 {
		n += 1 + l + sovJobs(uint64(l))
	...
	if m.ResumeStartMicros != 0 {
		n += 1 + sovJobs(uint64(m.ResumeStartMicros))
	}
	if m.ResumeExitError != nil {
		l = m.ResumeExitError.Size()
		n += 1 + l + sovJobs(uint64(l))
	}
	return n
}
...
func (m *Payload) Size() (n int) {
	...
	if len(m.TransitionLogs) > 0 {
		for _, e := range m.TransitionLogs {
			l = e.Size()
			n += 2 + l + sovJobs(uint64(l))
		}
	}
...
func (m *TransitionLog) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TransitionLog: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TransitionLog: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CoordinatorId |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ResumeStartMicros", wireType)
			}
			m.ResumeStartMicros = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowJobs
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ResumeStartMicros |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ResumeExitError", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ResumeExitError == nil {
				m.ResumeExitError = &errorspb.EncodedError{}
			}
			if err := m.ResumeExitError.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *Payload) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 29:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TransitionLogs", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TransitionLogs = append(m.TransitionLogs, &TransitionLog{})
			if err := m.TransitionLogs[len(m.TransitionLogs)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
