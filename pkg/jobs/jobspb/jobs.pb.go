...
type SchemaChangeDetails struct {
	...
	DropDatabaseID github_com_cockroachdb_cockroach_pkg_sql_sqlbase.ID `protobuf:"varint,4,opt,name=drop_database_id,json=dropDatabaseId,proto3,casttype=github.com/cockroachdb/cockroach/pkg/sql/sqlbase.ID" json:"drop_database_id,omitempty"`
}
...
func (m *SchemaChangeDetails) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DropDatabaseID != 0 {
		dAtA[i] = 0x20
		i++
		i = encodeVarintJobs(dAtA, i, uint64(m.DropDatabaseID))
	}
	return i, nil
}
...
func (m *SchemaChangeDetails) Size() (n int) {
	...
	if m.DropDatabaseID != 0 {
		n += 1 + sovJobs(uint64(m.DropDatabaseID))
	}
	return n
}
...
func (m *SchemaChangeDetails) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DropDatabaseID", wireType)
			}
			m.DropDatabaseID = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DropDatabaseID |= (github_com_cockroachdb_cockroach_pkg_sql_sqlbase.ID(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorJobs = []byte{
	...
	,
}
