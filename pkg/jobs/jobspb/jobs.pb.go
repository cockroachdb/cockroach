...
type SchemaChangeDetails struct {
	...
	RemainingDroppedTables []DroppedTableDetails `protobuf:"bytes,3,rep,name=remaining_dropped_tables,json=remainingDroppedTables" json:"remaining_dropped_tables"`
}
...
func (m *SchemaChangeDetails) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.RemainingDroppedTables) > 0 {
		for _, msg := range m.RemainingDroppedTables {
			dAtA[i] = 0x1a
			i++
			i = encodeVarintJobs(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *SchemaChangeDetails) Size() (n int) {
	...
	if len(m.RemainingDroppedTables) > 0 {
		for _, e := range m.RemainingDroppedTables {
			l = e.Size()
			n += 1 + l + sovJobs(uint64(l))
		}
	}
...
func (m *SchemaChangeDetails) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RemainingDroppedTables", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RemainingDroppedTables = append(m.RemainingDroppedTables, DroppedTableDetails{})
			if err := m.RemainingDroppedTables[len(m.RemainingDroppedTables)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorJobs = []byte{
	...
	,
}
