...
func (ScheduleDetails_WaitBehavior) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_schedule_8975b77326e15c3c, []int{0, 0}
}
...
func (ScheduleDetails_ErrorHandlingBehavior) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_schedule_8975b77326e15c3c, []int{0, 1}
}
...
func (*ScheduleDetails) Descriptor() ([]byte, []int) {
	return fileDescriptor_schedule_8975b77326e15c3c, []int{0}
}
...
func (*ExecutionArguments) Descriptor() ([]byte, []int) {
	return fileDescriptor_schedule_8975b77326e15c3c, []int{1}
}
...
func (*ScheduleChangeInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_schedule_8975b77326e15c3c, []int{2}
}
...
func (*ScheduleChangeInfo_Change) Descriptor() ([]byte, []int) {
	return fileDescriptor_schedule_8975b77326e15c3c, []int{2, 0}
}
...
func (*SqlStatementExecutionArg) Descriptor() ([]byte, []int) {
	return fileDescriptor_schedule_8975b77326e15c3c, []int{3}
}
...
func init() {
	proto.RegisterFile("jobs/jobspb/schedule.proto", fileDescriptor_schedule_8975b77326e15c3c)
}

var fileDescriptor_schedule_8975b77326e15c3c = []byte{
