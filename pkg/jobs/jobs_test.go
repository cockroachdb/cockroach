...
func TestJobLifecycle(t *testing.T) {
	...
	t.Run("valid job lifecycles succeed", func(t *testing.T) {
		...
		woodyPride, _ := username.MakeSQLUsernameFromUserInput("Woody Pride", username.UsernameValidation)
		...
		buzzL, _ := username.MakeSQLUsernameFromUserInput("Buzz Lightyear", username.UsernameValidation)
		...
		sidP, _ := username.MakeSQLUsernameFromUserInput("Sid Phillips", username.UsernameValidation)
...
func TestStartableJob(t *testing.T) {
	...
	woodyP, _ := username.MakeSQLUsernameFromUserInput("Woody Pride", username.UsernameValidation)
	rec := jobs.Record{
		Description:   "There's a snake in my boot!",
		Username:      woodyP,
		DescriptorIDs: []descpb.ID{1, 2, 3},
