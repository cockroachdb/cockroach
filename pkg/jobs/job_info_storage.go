...
var (
	...
	getJobProgressQuery = mustParseOne(
	...
	getJobStatusQuery = mustParseOne(
...
func (i ProgressStorage) Set(
	...
	// txn.ExecParsed(ctx, "write-job-progress-delete", txn.KV(), sessiondata.NodeUserSessionDataOverride, stmt, i)
