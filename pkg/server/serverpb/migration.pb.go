...
func (*ValidateTargetClusterVersionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_migration_c69e816c34ca9e47, []int{0}
}
...
func (*ValidateTargetClusterVersionResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_migration_c69e816c34ca9e47, []int{1}
}
...
func (*BumpClusterVersionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_migration_c69e816c34ca9e47, []int{2}
}
...
func (*BumpClusterVersionResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_migration_c69e816c34ca9e47, []int{3}
}
...
func init() {
	proto.RegisterFile("server/serverpb/migration.proto", fileDescriptor_migration_c69e816c34ca9e47)
}

var fileDescriptor_migration_c69e816c34ca9e47 = []byte{
