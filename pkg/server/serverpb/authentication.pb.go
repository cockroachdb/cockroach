...
func (*UserLoginRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_authentication_00f894dc6d516dac, []int{0}
}
...
func (*UserLoginResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_authentication_00f894dc6d516dac, []int{1}
}
...
func (*UserLogoutRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_authentication_00f894dc6d516dac, []int{2}
}
...
func (*UserLogoutResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_authentication_00f894dc6d516dac, []int{3}
}
...
func (*SessionCookie) Descriptor() ([]byte, []int) {
	return fileDescriptor_authentication_00f894dc6d516dac, []int{4}
}
...
type OIDCState struct {
	...
	MessageMAC []byte `protobuf:"bytes,4,opt,name=messageMAC,proto3" json:"messageMAC,omitempty"`
}
...
func (*OIDCState) Descriptor() ([]byte, []int) {
	return fileDescriptor_authentication_00f894dc6d516dac, []int{5}
}
...
func (m *OIDCState) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Message) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintAuthentication(dAtA, i, uint64(len(m.Message)))
		i += copy(dAtA[i:], m.Message)
	}
	if len(m.MessageMAC) > 0 {
		dAtA[i] = 0x22
		i++
		i = encodeVarintAuthentication(dAtA, i, uint64(len(m.MessageMAC)))
		i += copy(dAtA[i:], m.MessageMAC)
	}
	return i, nil
}
...
func (m *OIDCState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MessageMAC", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MessageMAC = append(m.MessageMAC[:0], dAtA[iNdEx:postIndex]...)
			if m.MessageMAC == nil {
				m.MessageMAC = []byte{}
			}
			iNdEx = postIndex
...
func init() {
	proto.RegisterFile("server/serverpb/authentication.proto", fileDescriptor_authentication_00f894dc6d516dac)
}

var fileDescriptor_authentication_00f894dc6d516dac = []byte{
	// 424 bytes of a gzipped FileDescriptorProto
	,
}
