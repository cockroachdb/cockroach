...
func (m *ReportFailure) Reset()                    { *m = ReportFailure{} }
func (m *ReportFailure) String() string            { return proto.CompactTextString(m) }
func (*ReportFailure) ProtoMessage()               {}
func (*ReportFailure) Descriptor() ([]byte, []int) { return fileDescriptorReport, []int{1} }
...
type ReportProblemRangesResponse struct {
	...
	NodeID                           github_com_cockroachdb_cockroach_pkg_roachpb.NodeID    `protobuf:"varint,1,opt,name=node_id,json=nodeId,proto3,casttype=github.com/cockroachdb/cockroach/pkg/roachpb.NodeID" json:"node_id,omitempty"`
	Failures                         []ReportFailure                                        `protobuf:"bytes,2,rep,name=failures" json:"failures"`
...
func (*ReportProblemRangesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptorReport, []int{2}
}

func init() {
	proto.RegisterType((*ReportProblemRangesRequest)(nil), "cockroach.server.serverpb.ReportProblemRangesRequest")
	proto.RegisterType((*ReportFailure)(nil), "cockroach.server.serverpb.ReportFailure")
...
func (m *ReportFailure) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ReportFailure) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ReportFailure) Size() (n int) {
	var l int
	_ = l
	if m.NodeID != 0 {
...
func (m *ReportFailure) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ReportFailure: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ReportFailure: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *ReportProblemRangesResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Failures = append(m.Failures, ReportFailure{})
...
var fileDescriptorReport = []byte{
	...
	,
}
