...
var (
	...
	pattern_Status_CancelStatementDiagnosticsReport_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"_status", "stmtdiagcancel"}, "", runtime.AssumeColonVerbOpt(true)))
