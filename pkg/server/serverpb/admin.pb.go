...
/*
	...
	It has these top-level messages:
		...
		LivenessRequest
		LivenessResponse
		PhysicalQueryPlanRequest
		PhysicalQueryPlanResponse
		DetailsRequest
		DetailsResponse
		NodesRequest
		NodesResponse
...
// PhysicalQueryPlanRequest requests a JSON physical query plan for a SQL string.
type PhysicalQueryPlanRequest struct {
	// query is the SQL query string.
	Query string `protobuf:"bytes,1,opt,name=query,proto3" json:"query,omitempty"`
}

func (m *PhysicalQueryPlanRequest) Reset()                    { *m = PhysicalQueryPlanRequest{} }
func (m *PhysicalQueryPlanRequest) String() string            { return proto.CompactTextString(m) }
func (*PhysicalQueryPlanRequest) ProtoMessage()               {}
func (*PhysicalQueryPlanRequest) Descriptor() ([]byte, []int) { return fileDescriptorAdmin, []int{26} }

// PhysicalQueryPlanResponse contains a JSON physical query plan.
type PhysicalQueryPlanResponse struct {
	PhysicalQueryPlan string `protobuf:"bytes,1,opt,name=physical_query_plan,json=physicalQueryPlan,proto3" json:"physical_query_plan,omitempty"`
}

func (m *PhysicalQueryPlanResponse) Reset()                    { *m = PhysicalQueryPlanResponse{} }
func (m *PhysicalQueryPlanResponse) String() string            { return proto.CompactTextString(m) }
func (*PhysicalQueryPlanResponse) ProtoMessage()               {}
func (*PhysicalQueryPlanResponse) Descriptor() ([]byte, []int) { return fileDescriptorAdmin, []int{27} }
...
func init() {
	...
	proto.RegisterType((*PhysicalQueryPlanRequest)(nil), "cockroach.server.serverpb.PhysicalQueryPlanRequest")
	proto.RegisterType((*PhysicalQueryPlanResponse)(nil), "cockroach.server.serverpb.PhysicalQueryPlanResponse")
...
type AdminClient interface {
	...
	// PhysicalQuery returns a JSON physical query plan for a SQL string.
	PhysicalQueryPlan(ctx context.Context, in *PhysicalQueryPlanRequest, opts ...grpc.CallOption) (*PhysicalQueryPlanResponse, error)
...
func (c *adminClient) PhysicalQueryPlan(ctx context.Context, in *PhysicalQueryPlanRequest, opts ...grpc.CallOption) (*PhysicalQueryPlanResponse, error) {
	out := new(PhysicalQueryPlanResponse)
	err := grpc.Invoke(ctx, "/cockroach.server.serverpb.Admin/PhysicalQueryPlan", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AdminServer interface {
	...
	// PhysicalQuery returns a JSON physical query plan for a SQL string.
	PhysicalQueryPlan(context.Context, *PhysicalQueryPlanRequest) (*PhysicalQueryPlanResponse, error)
	// Drain puts the node into the specified drain mode(s) and optionally
	// instructs the process to terminate.
...
func _Admin_PhysicalQueryPlan_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PhysicalQueryPlanRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdminServer).PhysicalQueryPlan(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cockroach.server.serverpb.Admin/PhysicalQueryPlan",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServer).PhysicalQueryPlan(ctx, req.(*PhysicalQueryPlanRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Admin_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PhysicalQueryPlan",
			Handler:    _Admin_PhysicalQueryPlan_Handler,
		},
	},
...
func (m *PhysicalQueryPlanRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *PhysicalQueryPlanRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *PhysicalQueryPlanResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *PhysicalQueryPlanResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.PhysicalQueryPlan) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintAdmin(dAtA, i, uint64(len(m.PhysicalQueryPlan)))
		i += copy(dAtA[i:], m.PhysicalQueryPlan)
	}
	return i, nil
}
...
func (m *PhysicalQueryPlanRequest) Size() (n int) {
	var l int
	_ = l
	l = len(m.Query)
	if l > 0 {
...
func (m *PhysicalQueryPlanResponse) Size() (n int) {
	var l int
	_ = l
	l = len(m.PhysicalQueryPlan)
	if l > 0 {
		n += 1 + l + sovAdmin(uint64(l))
	}
	return n
...
func (m *PhysicalQueryPlanRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PhysicalQueryPlanRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PhysicalQueryPlanRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *PhysicalQueryPlanResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PhysicalQueryPlanResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PhysicalQueryPlanResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PhysicalQueryPlan", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PhysicalQueryPlan = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipAdmin(dAtA[iNdEx:])
...
var fileDescriptorAdmin = []byte{
	...
	,
}
