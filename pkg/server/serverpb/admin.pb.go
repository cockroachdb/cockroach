...
type QueueRequest struct {
	...
	SkipShouldQueue bool `protobuf:"varint,3,opt,name=skip_should_queue,json=skipShouldQueue,proto3" json:"skip_should_queue,omitempty"`
}
...
func (*QueueRequest) Descriptor() ([]byte, []int) { return fileDescriptorAdmin, []int{41} }
...
func (*QueueResponse) Descriptor() ([]byte, []int) { return fileDescriptorAdmin, []int{42} }
...
type AdminClient interface {
	...
	// doing so.
	// URL: /_admin/v1/queue/split/range/1
	// URL: /_admin/v1/queue/split/range/1?skip_should_queue=true
	...
	QueueLocal(ctx context.Context, in *QueueRequest, opts ...grpc.CallOption) (*QueueResponse, error)
}
...
func (c *adminClient) QueueLocal(ctx context.Context, in *QueueRequest, opts ...grpc.CallOption) (*QueueResponse, error) {
	out := new(QueueResponse)
	err := grpc.Invoke(ctx, "/cockroach.server.serverpb.Admin/QueueLocal", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AdminServer interface {
	...
	// method, since we don't have a good way of finding a range's replicas and
	// leaseholder given just its ID.
	QueueLocal(context.Context, *QueueRequest) (*QueueResponse, error)
}
...
func _Admin_QueueLocal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueueRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdminServer).QueueLocal(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cockroach.server.serverpb.Admin/QueueLocal",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServer).QueueLocal(ctx, req.(*QueueRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Admin_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "QueueLocal",
			Handler:    _Admin_QueueLocal_Handler,
		},
	},
...
var fileDescriptorAdmin = []byte{
	...
	,
}
