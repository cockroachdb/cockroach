...
func (*AlertsRequest) Descriptor() ([]byte, []int) { return fileDescriptorAdmin, []int{45} }

type AlertsResponse struct {
	Alerts map[github_com_cockroachdb_cockroach_pkg_roachpb.NodeID]cockroach_server_status_statuspb.HealthCheckResult `protobuf:"bytes,1,rep,name=alerts,castkey=github.com/cockroachdb/cockroach/pkg/roachpb.NodeID" json:"alerts" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
}
...
func (*AlertsResponse) Descriptor() ([]byte, []int) { return fileDescriptorAdmin, []int{46} }
...
func init() {
	...
	proto.RegisterType((*AlertsRequest)(nil), "cockroach.server.serverpb.AlertsRequest")
	proto.RegisterType((*AlertsResponse)(nil), "cockroach.server.serverpb.AlertsResponse")
...
func (c *adminClient) Alerts(ctx context.Context, in *AlertsRequest, opts ...grpc.CallOption) (*AlertsResponse, error) {
	out := new(AlertsResponse)
	err := grpc.Invoke(ctx, "/cockroach.server.serverpb.Admin/Alerts", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Admin_Alerts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AlertsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdminServer).Alerts(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cockroach.server.serverpb.Admin/Alerts",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServer).Alerts(ctx, req.(*AlertsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func (m *EventsResponse_Event) MarshalTo(dAtA []byte) (int, error) {
	...
	n6, err := types.StdTimeMarshalTo(m.Timestamp, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n6
...
func (m *GetUIDataResponse_Value) MarshalTo(dAtA []byte) (int, error) {
	...
	n8, err := types.StdTimeMarshalTo(m.LastUpdated, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n8
...
func (m *JobsResponse_Job) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Created != nil {
		...
		n22, err := types.StdTimeMarshalTo(*m.Created, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n22
	...
	if m.Started != nil {
		...
		n23, err := types.StdTimeMarshalTo(*m.Started, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n23
	...
	if m.Finished != nil {
		...
		n24, err := types.StdTimeMarshalTo(*m.Finished, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n24
	...
	if m.Modified != nil {
		...
		n25, err := types.StdTimeMarshalTo(*m.Modified, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n25
	...
	if m.HighwaterTimestamp != nil {
		...
		n26, err := types.StdTimeMarshalTo(*m.HighwaterTimestamp, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n26
...
func (m *DataDistributionResponse_TableInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DroppedAt != nil {
		...
		n32, err := types.StdTimeMarshalTo(*m.DroppedAt, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n32
...
func (m *AlertsResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.Alerts) > 0 {
		keysForAlerts := make([]int32, 0, len(m.Alerts))
		for k := range m.Alerts {
			keysForAlerts = append(keysForAlerts, int32(k))
		}
		sortkeys.Int32s(keysForAlerts)
		for _, k := range keysForAlerts {
			dAtA[i] = 0xa
			i++
			v := m.Alerts[github_com_cockroachdb_cockroach_pkg_roachpb.NodeID(k)]
			msgSize := 0
			if (&v) != nil {
				msgSize = (&v).Size()
				msgSize += 1 + sovAdmin(uint64(msgSize))
...
func (m *AlertsResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Alerts == nil {
				m.Alerts = make(map[github_com_cockroachdb_cockroach_pkg_roachpb.NodeID]cockroach_server_status_statuspb.HealthCheckResult)
			}
			var mapkey int32
			mapvalue := &cockroach_server_status_statuspb.HealthCheckResult{}
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
			...
			m.Alerts[github_com_cockroachdb_cockroach_pkg_roachpb.NodeID(mapkey)] = *mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipAdmin(dAtA[iNdEx:])
...
var fileDescriptorAdmin = []byte{
	...
	,
}
