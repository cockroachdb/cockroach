...
type QueriesRequest_OrderByCol int32

const (
	QueriesRequest_SvcLatAvg QueriesRequest_OrderByCol = 0
	QueriesRequest_Count     QueriesRequest_OrderByCol = 1
)

var QueriesRequest_OrderByCol_name = map[int32]string{
	0: "SvcLatAvg",
	1: "Count",
}
var QueriesRequest_OrderByCol_value = map[string]int32{
	"SvcLatAvg": 0,
	"Count":     1,
}

func (x QueriesRequest_OrderByCol) String() string {
	return proto.EnumName(QueriesRequest_OrderByCol_name, int32(x))
}
func (QueriesRequest_OrderByCol) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorAdmin, []int{41, 0}
}

type QueriesRequest_OrderDir int32

const (
	QueriesRequest_DESC QueriesRequest_OrderDir = 0
	QueriesRequest_ASC  QueriesRequest_OrderDir = 1
)

var QueriesRequest_OrderDir_name = map[int32]string{
	0: "DESC",
	1: "ASC",
}
var QueriesRequest_OrderDir_value = map[string]int32{
	"DESC": 0,
	"ASC":  1,
}

func (x QueriesRequest_OrderDir) String() string {
	return proto.EnumName(QueriesRequest_OrderDir_name, int32(x))
}
func (QueriesRequest_OrderDir) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorAdmin, []int{41, 1}
}
...
type QueriesRequest struct {
	OrderByCol QueriesRequest_OrderByCol `protobuf:"varint,1,opt,name=order_by_col,json=orderByCol,proto3,enum=cockroach.server.serverpb.QueriesRequest_OrderByCol" json:"order_by_col,omitempty"`
	OrderDir   QueriesRequest_OrderDir   `protobuf:"varint,2,opt,name=order_dir,json=orderDir,proto3,enum=cockroach.server.serverpb.QueriesRequest_OrderDir" json:"order_dir,omitempty"`
}

func (m *QueriesRequest) Reset()                    { *m = QueriesRequest{} }
func (m *QueriesRequest) String() string            { return proto.CompactTextString(m) }
func (*QueriesRequest) ProtoMessage()               {}
func (*QueriesRequest) Descriptor() ([]byte, []int) { return fileDescriptorAdmin, []int{41} }

type QueriesResponse struct {
	Queries []QueriesResponse_Query `protobuf:"bytes,1,rep,name=queries" json:"queries"`
}

func (m *QueriesResponse) Reset()                    { *m = QueriesResponse{} }
func (m *QueriesResponse) String() string            { return proto.CompactTextString(m) }
func (*QueriesResponse) ProtoMessage()               {}
func (*QueriesResponse) Descriptor() ([]byte, []int) { return fileDescriptorAdmin, []int{42} }

type QueriesResponse_Query struct {
	...
	QueryAnonymized string  `protobuf:"bytes,3,opt,name=query_anonymized,json=queryAnonymized,proto3" json:"query_anonymized,omitempty"`
	Count           int64   `protobuf:"varint,4,opt,name=count,proto3" json:"count,omitempty"`
	RowsAvg         float32 `protobuf:"fixed32,5,opt,name=rows_avg,json=rowsAvg,proto3" json:"rows_avg,omitempty"`
	RowsVar         float32 `protobuf:"fixed32,6,opt,name=rows_var,json=rowsVar,proto3" json:"rows_var,omitempty"`
	ServiceLatAvg   float32 `protobuf:"fixed32,7,opt,name=service_lat_avg,json=serviceLatAvg,proto3" json:"service_lat_avg,omitempty"`
	ServiceLatVar   float32 `protobuf:"fixed32,8,opt,name=service_lat_var,json=serviceLatVar,proto3" json:"service_lat_var,omitempty"`
}

func (m *QueriesResponse_Query) Reset()                    { *m = QueriesResponse_Query{} }
func (m *QueriesResponse_Query) String() string            { return proto.CompactTextString(m) }
func (*QueriesResponse_Query) ProtoMessage()               {}
func (*QueriesResponse_Query) Descriptor() ([]byte, []int) { return fileDescriptorAdmin, []int{42, 0} }
...
func init() {
	...
	proto.RegisterType((*QueriesRequest)(nil), "cockroach.server.serverpb.QueriesRequest")
	proto.RegisterType((*QueriesResponse)(nil), "cockroach.server.serverpb.QueriesResponse")
	proto.RegisterType((*QueriesResponse_Query)(nil), "cockroach.server.serverpb.QueriesResponse.Query")
	...
	proto.RegisterEnum("cockroach.server.serverpb.QueriesRequest_OrderByCol", QueriesRequest_OrderByCol_name, QueriesRequest_OrderByCol_value)
	proto.RegisterEnum("cockroach.server.serverpb.QueriesRequest_OrderDir", QueriesRequest_OrderDir_name, QueriesRequest_OrderDir_value)
}
...
type AdminClient interface {
	...
	Queries(ctx context.Context, in *QueriesRequest, opts ...grpc.CallOption) (*QueriesResponse, error)
}
...
func (c *adminClient) Queries(ctx context.Context, in *QueriesRequest, opts ...grpc.CallOption) (*QueriesResponse, error) {
	out := new(QueriesResponse)
	err := grpc.Invoke(ctx, "/cockroach.server.serverpb.Admin/Queries", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AdminServer interface {
	...
	Queries(context.Context, *QueriesRequest) (*QueriesResponse, error)
}
...
func _Admin_Queries_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueriesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdminServer).Queries(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cockroach.server.serverpb.Admin/Queries",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServer).Queries(ctx, req.(*QueriesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Admin_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Queries",
			Handler:    _Admin_Queries_Handler,
		},
	},
...
func (m *QueriesRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *QueriesRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.OrderByCol != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintAdmin(dAtA, i, uint64(m.OrderByCol))
	}
	if m.OrderDir != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintAdmin(dAtA, i, uint64(m.OrderDir))
	}
	return i, nil
}

func (m *QueriesResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *QueriesResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *QueriesResponse_Query) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *QueriesResponse_Query) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if len(m.ApplicationName) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintAdmin(dAtA, i, uint64(len(m.ApplicationName)))
		i += copy(dAtA[i:], m.ApplicationName)
	}
	if len(m.QueryAnonymized) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintAdmin(dAtA, i, uint64(len(m.QueryAnonymized)))
		i += copy(dAtA[i:], m.QueryAnonymized)
	}
	if m.Count != 0 {
		dAtA[i] = 0x20
		i++
	...
	if m.RowsAvg != 0 {
		dAtA[i] = 0x2d
		i++
		binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.RowsAvg))))
		i += 4
	}
	if m.RowsVar != 0 {
		dAtA[i] = 0x35
		i++
		binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.RowsVar))))
		i += 4
	}
	if m.ServiceLatAvg != 0 {
		dAtA[i] = 0x3d
		i++
		binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.ServiceLatAvg))))
		i += 4
	}
	if m.ServiceLatVar != 0 {
		dAtA[i] = 0x45
		i++
		binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.ServiceLatVar))))
		i += 4
	}
	return i, nil
}
...
func (m *QueriesRequest) Size() (n int) {
	var l int
	_ = l
	if m.OrderByCol != 0 {
		n += 1 + sovAdmin(uint64(m.OrderByCol))
	}
	if m.OrderDir != 0 {
		n += 1 + sovAdmin(uint64(m.OrderDir))
	}
	return n
}

func (m *QueriesResponse) Size() (n int) {
	var l int
	_ = l
	if len(m.Queries) > 0 {
...
func (m *QueriesResponse_Query) Size() (n int) {
	var l int
	_ = l
	if m.NodeId != 0 {
		n += 1 + sovAdmin(uint64(m.NodeId))
...
func (m *QueriesRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueriesRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueriesRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field OrderByCol", wireType)
			}
			m.OrderByCol = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.OrderByCol |= (QueriesRequest_OrderByCol(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field OrderDir", wireType)
			}
			m.OrderDir = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.OrderDir |= (QueriesRequest_OrderDir(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *QueriesResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueriesResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueriesResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Queries = append(m.Queries, QueriesResponse_Query{})
...
func (m *QueriesResponse_Query) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field QueryAnonymized", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.QueryAnonymized = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 0 {
		...
		case 5:
			if wireType != 5 {
				return fmt.Errorf("proto: wrong wireType = %d for field RowsAvg", wireType)
			}
			var v uint32
			if (iNdEx + 4) > l {
				return io.ErrUnexpectedEOF
			...
			v = uint32(binary.LittleEndian.Uint32(dAtA[iNdEx:]))
			iNdEx += 4
			m.RowsAvg = float32(math.Float32frombits(v))
		case 6:
			if wireType != 5 {
				return fmt.Errorf("proto: wrong wireType = %d for field RowsVar", wireType)
			}
			var v uint32
			if (iNdEx + 4) > l {
				return io.ErrUnexpectedEOF
			...
			v = uint32(binary.LittleEndian.Uint32(dAtA[iNdEx:]))
			iNdEx += 4
			m.RowsVar = float32(math.Float32frombits(v))
		case 7:
			if wireType != 5 {
				return fmt.Errorf("proto: wrong wireType = %d for field ServiceLatAvg", wireType)
			}
			var v uint32
			if (iNdEx + 4) > l {
				return io.ErrUnexpectedEOF
			...
			v = uint32(binary.LittleEndian.Uint32(dAtA[iNdEx:]))
			iNdEx += 4
			m.ServiceLatAvg = float32(math.Float32frombits(v))
		case 8:
			if wireType != 5 {
				return fmt.Errorf("proto: wrong wireType = %d for field ServiceLatVar", wireType)
			}
			var v uint32
			if (iNdEx + 4) > l {
				return io.ErrUnexpectedEOF
			...
			v = uint32(binary.LittleEndian.Uint32(dAtA[iNdEx:]))
			iNdEx += 4
			m.ServiceLatVar = float32(math.Float32frombits(v))
		default:
			iNdEx = preIndex
			skippy, err := skipAdmin(dAtA[iNdEx:])
			if err != nil {
...
var fileDescriptorAdmin = []byte{
	...
	,
}
