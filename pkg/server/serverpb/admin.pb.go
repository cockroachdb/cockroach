...
type ReplicaMatrixResponse struct {
	// By database id.
	DatabaseInfo map[uint64]ReplicaMatrixResponse_DatabaseInfo `protobuf:"bytes,1,rep,name=database_info,json=databaseInfo" json:"database_info" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
	// By zone config id.
...
type ReplicaMatrixResponse_TableInfo struct {
	Name                 string                                                        `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	ReplicaCountByNodeId map[github_com_cockroachdb_cockroach_pkg_roachpb.NodeID]int64 `protobuf:"bytes,2,rep,name=replica_count_by_node_id,json=replicaCountByNodeId,castkey=github.com/cockroachdb/cockroach/pkg/roachpb.NodeID" json:"replica_count_by_node_id,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	ZoneConfigId         int64                                                         `protobuf:"varint,3,opt,name=zone_config_id,json=zoneConfigId,proto3" json:"zone_config_id,omitempty"`
}
...
type ReplicaMatrixResponse_DatabaseInfo struct {
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	// By table id.
	TableInfo map[uint64]ReplicaMatrixResponse_TableInfo `protobuf:"bytes,2,rep,name=table_info,json=tableInfo" json:"table_info" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
}
...
func (m *ReplicaMatrixResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.DatabaseInfo) > 0 {
		keysForDatabaseInfo := make([]uint64, 0, len(m.DatabaseInfo))
		for k := range m.DatabaseInfo {
			keysForDatabaseInfo = append(keysForDatabaseInfo, uint64(k))
		}
		sortkeys.Uint64s(keysForDatabaseInfo)
		for _, k := range keysForDatabaseInfo {
			dAtA[i] = 0xa
			i++
			v := m.DatabaseInfo[uint64(k)]
			msgSize := 0
			if (&v) != nil {
				msgSize = (&v).Size()
				msgSize += 1 + sovAdmin(uint64(msgSize))
...
func (m *ReplicaMatrixResponse_DatabaseInfo) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.TableInfo) > 0 {
		keysForTableInfo := make([]uint64, 0, len(m.TableInfo))
		for k := range m.TableInfo {
			keysForTableInfo = append(keysForTableInfo, uint64(k))
		}
		sortkeys.Uint64s(keysForTableInfo)
		for _, k := range keysForTableInfo {
			dAtA[i] = 0x12
			i++
			v := m.TableInfo[uint64(k)]
			msgSize := 0
			if (&v) != nil {
				msgSize = (&v).Size()
				msgSize += 1 + sovAdmin(uint64(msgSize))
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.DatabaseInfo == nil {
				m.DatabaseInfo = make(map[uint64]ReplicaMatrixResponse_DatabaseInfo)
			}
			var mapkey uint64
...
func (m *ReplicaMatrixResponse_DatabaseInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.TableInfo == nil {
				m.TableInfo = make(map[uint64]ReplicaMatrixResponse_TableInfo)
			}
			var mapkey uint64
...
var fileDescriptorAdmin = []byte{
	...
	,
}
