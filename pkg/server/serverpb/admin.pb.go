...
type MetricMetadataResponse struct {
	...
	UnitKey       map[int32]string                          `protobuf:"bytes,1,rep,name=unitKey" json:"unitKey" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (m *MetricMetadataResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.UnitKey) > 0 {
		keysForUnitKey := make([]int32, 0, len(m.UnitKey))
		for k := range m.UnitKey {
			keysForUnitKey = append(keysForUnitKey, int32(k))
		}
		sortkeys.Int32s(keysForUnitKey)
		for _, k := range keysForUnitKey {
			dAtA[i] = 0xa
			i++
			v := m.UnitKey[int32(k)]
...
func (m *MetricMetadataResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.UnitKey == nil {
				m.UnitKey = make(map[int32]string)
			}
			var mapkey int32
			var mapvalue string
			for iNdEx < postIndex {
...
var fileDescriptorAdmin = []byte{
	...
	,
}
