...
type MetricMetadataResponse struct {
	// displayUnitKey and metricTypeKey expose the string equivalent of their respective
	// enums, which makes this endpoint's data more useful for external services such as
	// the CockroachDB documentation.
...
func (m *MetricMetadataResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.DisplayUnitKey) > 0 {
		keysForDisplayUnitKey := make([]int32, 0, len(m.DisplayUnitKey))
		for k := range m.DisplayUnitKey {
			keysForDisplayUnitKey = append(keysForDisplayUnitKey, int32(k))
		}
		sortkeys.Int32s(keysForDisplayUnitKey)
		for _, k := range keysForDisplayUnitKey {
			dAtA[i] = 0xa
			i++
			v := m.DisplayUnitKey[int32(k)]
			mapSize := 1 + sovAdmin(uint64(k)) + 1 + len(v) + sovAdmin(uint64(len(v)))
			i = encodeVarintAdmin(dAtA, i, uint64(mapSize))
			dAtA[i] = 0x8
			i++
			i = encodeVarintAdmin(dAtA, i, uint64(k))
	...
	if len(m.MetricTypeKey) > 0 {
		keysForMetricTypeKey := make([]int32, 0, len(m.MetricTypeKey))
		for k := range m.MetricTypeKey {
			keysForMetricTypeKey = append(keysForMetricTypeKey, int32(k))
		}
		sortkeys.Int32s(keysForMetricTypeKey)
		for _, k := range keysForMetricTypeKey {
			dAtA[i] = 0x12
			i++
			v := m.MetricTypeKey[int32(k)]
			mapSize := 1 + sovAdmin(uint64(k)) + 1 + len(v) + sovAdmin(uint64(len(v)))
			i = encodeVarintAdmin(dAtA, i, uint64(mapSize))
			dAtA[i] = 0x8
			i++
...
func (m *MetricMetadataResponse) Size() (n int) {
	...
	_ = l
	if len(m.DisplayUnitKey) > 0 {
		for k, v := range m.DisplayUnitKey {
			_ = k
			_ = v
...
func (m *MetricMetadataResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DisplayUnitKey", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.DisplayUnitKey == nil {
				m.DisplayUnitKey = make(map[int32]string)
			}
			var mapkey int32
			var mapvalue string
			for iNdEx < postIndex {
			...
			m.DisplayUnitKey[mapkey] = mapvalue
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MetricTypeKey", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.MetricTypeKey == nil {
				m.MetricTypeKey = make(map[int32]string)
			}
			var mapkey int32
			var mapvalue string
			for iNdEx < postIndex {
			...
			m.MetricTypeKey[mapkey] = mapvalue
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
...
var fileDescriptorAdmin = []byte{
	...
	,
}
