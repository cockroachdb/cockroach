...
func (*LivenessRequest) Descriptor() ([]byte, []int) { return fileDescriptorAdmin, []int{22} }

// LivenessResponse contains a map of the liveness status of each node, keyed
// by Node ID.
type LivenessResponse struct {
	LivenessMap map[int32]cockroach_storage.Liveness `protobuf:"bytes,1,rep,name=liveness_map,json=livenessMap" json:"liveness_map" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
}
...
func (*LivenessResponse) Descriptor() ([]byte, []int) { return fileDescriptorAdmin, []int{23} }
...
func (*ClusterFreezeRequest) Descriptor() ([]byte, []int) { return fileDescriptorAdmin, []int{24} }
...
func (*ClusterFreezeResponse) Descriptor() ([]byte, []int) { return fileDescriptorAdmin, []int{25} }
...
func (m *LivenessResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.LivenessMap) > 0 {
		keysForLivenessMap := make([]int32, 0, len(m.LivenessMap))
		for k := range m.LivenessMap {
			keysForLivenessMap = append(keysForLivenessMap, int32(k))
		}
		github_com_gogo_protobuf_sortkeys.Int32s(keysForLivenessMap)
		for _, k := range keysForLivenessMap {
			dAtA[i] = 0xa
			i++
			v := m.LivenessMap[int32(k)]
			msgSize := 0
			if (&v) != nil {
				msgSize = (&v).Size()
				msgSize += 1 + sovAdmin(uint64(msgSize))
...
func (m *LivenessResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LivenessMap", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.LivenessMap == nil {
				m.LivenessMap = make(map[int32]cockroach_storage.Liveness)
			}
			if iNdEx < postIndex {
				var valuekey uint64
				for shift := uint(0); ; shift += 7 {
				...
				mapvalue := &cockroach_storage.Liveness{}
				if err := mapvalue.Unmarshal(dAtA[iNdEx:postmsgIndex]); err != nil {
					return err
				}
				iNdEx = postmsgIndex
				m.LivenessMap[mapkey] = *mapvalue
			} else {
				var mapvalue cockroach_storage.Liveness
				m.LivenessMap[mapkey] = mapvalue
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorAdmin = []byte{
	...
	,
}
