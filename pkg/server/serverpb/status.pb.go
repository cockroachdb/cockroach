...
func (m *LogSpyRequest) Reset()                    { *m = LogSpyRequest{} }
func (m *LogSpyRequest) String() string            { return proto.CompactTextString(m) }
func (*LogSpyRequest) ProtoMessage()               {}
func (*LogSpyRequest) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{28} }
...
func (*SpanStatsRequest) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{43} }
...
func (*SpanStatsResponse) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{44} }
...
func (*ProblemRangesRequest) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{45} }
...
func (*ProblemRangesResponse) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{46} }
...
func (*RangeRequest) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{47} }
...
func (*RangeResponse) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{48} }
...
func init() {
	...
	proto.RegisterType((*LogSpyRequest)(nil), "cockroach.server.serverpb.LogSpyRequest")
...
type StatusClient interface {
	...
	LogSpy(ctx context.Context, in *LogSpyRequest, opts ...grpc.CallOption) (Status_LogSpyClient, error)
...
func (c *statusClient) LogSpy(ctx context.Context, in *LogSpyRequest, opts ...grpc.CallOption) (Status_LogSpyClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Status_serviceDesc.Streams[0], c.cc, "/cockroach.server.serverpb.Status/LogSpy", opts...)
	if err != nil {
		return nil, err
	}
	x := &statusLogSpyClient{stream}
...
type Status_LogSpyClient interface {
	Recv() (*cockroach_util_log.Entry, error)
	grpc.ClientStream
}

type statusLogSpyClient struct {
	grpc.ClientStream
}

func (x *statusLogSpyClient) Recv() (*cockroach_util_log.Entry, error) {
	m := new(cockroach_util_log.Entry)
...
type StatusServer interface {
	...
	LogSpy(*LogSpyRequest, Status_LogSpyServer) error
...
func _Status_LogSpy_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(LogSpyRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(StatusServer).LogSpy(m, &statusLogSpyServer{stream})
}

type Status_LogSpyServer interface {
	Send(*cockroach_util_log.Entry) error
	grpc.ServerStream
}

type statusLogSpyServer struct {
	grpc.ServerStream
}

func (x *statusLogSpyServer) Send(m *cockroach_util_log.Entry) error {
...
var _Status_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "LogSpy",
			Handler:       _Status_LogSpy_Handler,
			ServerStreams: true,
		},
	},
...
func (m *LogSpyRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *LogSpyRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if len(m.Duration) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintStatus(dAtA, i, uint64(len(m.Duration)))
		i += copy(dAtA[i:], m.Duration)
	}
	if len(m.Grep) > 0 {
		dAtA[i] = 0x22
		i++
		i = encodeVarintStatus(dAtA, i, uint64(len(m.Grep)))
		i += copy(dAtA[i:], m.Grep)
	}
	return i, nil
}
...
func (m *LogSpyRequest) Size() (n int) {
	var l int
	_ = l
	l = len(m.NodeId)
	if l > 0 {
...
func (m *LogSpyRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LogSpyRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LogSpyRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorStatus = []byte{
	...
	,
}
