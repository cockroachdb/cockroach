...
const (
	ProfileType_HEAP ProfileType = 0
)
...
func (ProfileType) EnumDescriptor() ([]byte, []int) { return fileDescriptorStatus, []int{0} }
...
type ProfileListRequest struct {
	...
	Type ProfileType `protobuf:"varint,5,opt,name=type,proto3,enum=cockroach.server.serverpb.ProfileType" json:"type,omitempty"`
}
...
func (*ProfileListRequest) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{30} }
...
func (*ProfileListResponse) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{31} }
...
func (*ProfileResponse) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{33} }
...
func init() {
	...
	proto.RegisterType((*ProfileListRequest)(nil), "cockroach.server.serverpb.ProfileListRequest")
	proto.RegisterType((*ProfileListResponse)(nil), "cockroach.server.serverpb.ProfileListResponse")
	proto.RegisterType((*ProfileRequest)(nil), "cockroach.server.serverpb.ProfileRequest")
	proto.RegisterType((*ProfileResponse)(nil), "cockroach.server.serverpb.ProfileResponse")
	...
	proto.RegisterEnum("cockroach.server.serverpb.ProfileType", ProfileType_name, ProfileType_value)
...
type StatusClient interface {
	...
	ReadProfile(ctx context.Context, in *ProfileRequest, opts ...grpc.CallOption) (*ProfileResponse, error)
...
func (c *statusClient) ProfileList(ctx context.Context, in *ProfileListRequest, opts ...grpc.CallOption) (*ProfileListResponse, error) {
	out := new(ProfileListResponse)
	err := grpc.Invoke(ctx, "/cockroach.server.serverpb.Status/ProfileList", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *statusClient) ReadProfile(ctx context.Context, in *ProfileRequest, opts ...grpc.CallOption) (*ProfileResponse, error) {
	out := new(ProfileResponse)
	err := grpc.Invoke(ctx, "/cockroach.server.serverpb.Status/ReadProfile", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StatusServer interface {
	...
	ReadProfile(context.Context, *ProfileRequest) (*ProfileResponse, error)
...
func _Status_ProfileList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ProfileListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StatusServer).ProfileList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cockroach.server.serverpb.Status/ProfileList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StatusServer).ProfileList(ctx, req.(*ProfileListRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Status_ReadProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ProfileRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StatusServer).ReadProfile(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cockroach.server.serverpb.Status/ReadProfile",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StatusServer).ReadProfile(ctx, req.(*ProfileRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Status_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Status_ProfileList_Handler,
		},
		{
			MethodName: "ReadProfile",
			Handler:    _Status_ReadProfile_Handler,
		},
		{
...
func (m *ProfileListRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ProfileListRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ProfileRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Filename) > 0 {
		dAtA[i] = 0x32
		i++
		i = encodeVarintStatus(dAtA, i, uint64(len(m.Filename)))
...
func (m *ProfileListRequest) Size() (n int) {
	var l int
	_ = l
	l = len(m.NodeId)
	if l > 0 {
...
func (m *ProfileListRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ProfileListRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ProfileListRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 5:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= (ProfileType(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorStatus = []byte{
	...
	,
}
