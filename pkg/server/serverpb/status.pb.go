...
// CancelTransactionRequest requests transaction cancellation.
type CancelTransactionRequest struct {
	// transaction_id of the transaction to be cancelled.
	TransactionId string `protobuf:"bytes,1,opt,name=transaction_id,json=transactionId,proto3" json:"transaction_id,omitempty"`
	// node_id of the transaction to be cancelled.
...
func (*CancelTransactionRequest) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{42} }

// CancelTransactionResponse responds to a transaction cancellation request.
type CancelTransactionResponse struct {
	// cancelled indicates whether the transaction was cancelled.
	Cancelled bool `protobuf:"varint,1,opt,name=cancelled,proto3" json:"cancelled,omitempty"`
	// error message (accompanied with cancelled = false).
	Error string `protobuf:"bytes,2,opt,name=error,proto3" json:"error,omitempty"`
}
...
func (*CancelTransactionResponse) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{43} }
...
func (*SpanStatsRequest) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{44} }
...
func (*SpanStatsResponse) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{45} }
...
func (*ProblemRangesRequest) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{46} }
...
func (*ProblemRangesResponse) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{47} }
...
func (*RangeRequest) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{48} }
...
func (*RangeResponse) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{49} }
...
func (*RangeResponse_RangeLog) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{49, 1} }
...
func (*RangeResponse_RangeLog_PrettyInfo) Descriptor() ([]byte, []int) {
	return fileDescriptorStatus, []int{49, 1, 0}
}
...
func init() {
	...
	proto.RegisterType((*CancelTransactionRequest)(nil), "cockroach.server.serverpb.CancelTransactionRequest")
	proto.RegisterType((*CancelTransactionResponse)(nil), "cockroach.server.serverpb.CancelTransactionResponse")
...
func (c *statusClient) CancelTransaction(ctx context.Context, in *CancelTransactionRequest, opts ...grpc.CallOption) (*CancelTransactionResponse, error) {
	out := new(CancelTransactionResponse)
	err := grpc.Invoke(ctx, "/cockroach.server.serverpb.Status/CancelTransaction", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Status_CancelTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CancelTransactionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StatusServer).CancelTransaction(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cockroach.server.serverpb.Status/CancelTransaction",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StatusServer).CancelTransaction(ctx, req.(*CancelTransactionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Status_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Status_CancelTransaction_Handler,
		},
		{
...
func (m *AllocatorRangeResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DryRun != nil {
		...
		n15, err := m.DryRun.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n15
...
func (m *ActiveQuery) MarshalTo(dAtA []byte) (int, error) {
	...
	n22, err := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.Start, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n22
...
func (m *Session) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.KvTxnID != nil {
		...
		n24, err := m.KvTxnID.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n24
...
func (m *CancelTransactionRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *CancelTransactionRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.TransactionId) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintStatus(dAtA, i, uint64(len(m.TransactionId)))
...
func (m *CancelTransactionResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *CancelTransactionResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *SpanStatsResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	n25, err := m.TotalStats.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n25
...
func (m *ProblemRangesResponse_NodeProblems) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.UnavailableRangeIDs) > 0 {
		dAtA28 := make([]byte, len(m.UnavailableRangeIDs)*10)
		var j27 int
	...
	if len(m.RaftLeaderNotLeaseHolderRangeIDs) > 0 {
		dAtA30 := make([]byte, len(m.RaftLeaderNotLeaseHolderRangeIDs)*10)
		var j29 int
	...
	if len(m.NoRaftLeaderRangeIDs) > 0 {
		dAtA32 := make([]byte, len(m.NoRaftLeaderRangeIDs)*10)
		var j31 int
	...
	if len(m.NoLeaseRangeIDs) > 0 {
		dAtA34 := make([]byte, len(m.NoLeaseRangeIDs)*10)
		var j33 int
	...
	if len(m.UnderreplicatedRangeIDs) > 0 {
		dAtA36 := make([]byte, len(m.UnderreplicatedRangeIDs)*10)
		var j35 int
...
func (m *RangeResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	n38, err := m.RangeLog.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n38
...
func (m *CancelTransactionRequest) Size() (n int) {
	var l int
	_ = l
...
func (m *CancelTransactionResponse) Size() (n int) {
	var l int
	_ = l
	if m.Cancelled {
		n += 2
...
func (m *CancelTransactionRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CancelTransactionRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CancelTransactionRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *CancelTransactionResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CancelTransactionResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CancelTransactionResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
var fileDescriptorStatus = []byte{
	...
	,
}
