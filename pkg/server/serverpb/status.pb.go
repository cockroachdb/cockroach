...
type RangeProblems struct {
	...
	LogTooLarge            bool `protobuf:"varint,7,opt,name=log_too_large,json=logTooLarge,proto3" json:"log_too_large,omitempty"`
}
...
type ProblemRangesResponse_NodeProblems struct {
	...
	LogSizeTooLargeRangeIDs          []github_com_cockroachdb_cockroach_pkg_roachpb.RangeID `protobuf:"varint,8,rep,packed,name=log_size_too_large_range_ids,json=logSizeTooLargeRangeIds,casttype=github.com/cockroachdb/cockroach/pkg/roachpb.RangeID" json:"log_size_too_large_range_ids,omitempty"`
}
...
func (m *ProblemRangesResponse_NodeProblems) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.LogSizeTooLargeRangeIDs) > 0 {
		dAtA41 := make([]byte, len(m.LogSizeTooLargeRangeIDs)*10)
		var j40 int
		for _, num1 := range m.LogSizeTooLargeRangeIDs {
			num := uint64(num1)
			for num >= 1<<7 {
...
func (m *ProblemRangesResponse_NodeProblems) Size() (n int) {
	...
	if len(m.LogSizeTooLargeRangeIDs) > 0 {
		l = 0
		for _, e := range m.LogSizeTooLargeRangeIDs {
			l += sovStatus(uint64(e))
		}
		n += 1 + sovStatus(uint64(l)) + l
	}
...
func (m *RangeProblems) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LogTooLarge", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType == 0 {
				...
				m.LogSizeTooLargeRangeIDs = append(m.LogSizeTooLargeRangeIDs, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field LogSizeTooLargeRangeIDs", wireType)
			}
		default:
			iNdEx = preIndex
			skippy, err := skipStatus(dAtA[iNdEx:])
...
var fileDescriptorStatus = []byte{
	...
	,
}
