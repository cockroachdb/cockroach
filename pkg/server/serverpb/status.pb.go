...
type HeapFileResponse struct {
	Data []byte `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"`
}

func (m *HeapFileResponse) Reset()                    { *m = HeapFileResponse{} }
func (m *HeapFileResponse) String() string            { return proto.CompactTextString(m) }
func (*HeapFileResponse) ProtoMessage()               {}
func (*HeapFileResponse) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{29} }

type HeapFilesListRequest struct {
	// node_id is a string so that "local" can be used to specify that no
	// forwarding is necessary.
	NodeId string `protobuf:"bytes,1,opt,name=node_id,json=nodeId,proto3" json:"node_id,omitempty"`
}

func (m *HeapFilesListRequest) Reset()                    { *m = HeapFilesListRequest{} }
func (m *HeapFilesListRequest) String() string            { return proto.CompactTextString(m) }
func (*HeapFilesListRequest) ProtoMessage()               {}
func (*HeapFilesListRequest) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{30} }

type HeapFilesListResponse struct {
	Files []string `protobuf:"bytes,1,rep,name=files" json:"files,omitempty"`
}

func (m *HeapFilesListResponse) Reset()                    { *m = HeapFilesListResponse{} }
func (m *HeapFilesListResponse) String() string            { return proto.CompactTextString(m) }
func (*HeapFilesListResponse) ProtoMessage()               {}
func (*HeapFilesListResponse) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{31} }

type HeapFileRequest struct {
	// node_id is a string so that "local" can be used to specify that no
	// forwarding is necessary.
	NodeId string `protobuf:"bytes,1,opt,name=node_id,json=nodeId,proto3" json:"node_id,omitempty"`
	File   string `protobuf:"bytes,2,opt,name=file,proto3" json:"file,omitempty"`
...
func (m *HeapFileRequest) Reset()                    { *m = HeapFileRequest{} }
func (m *HeapFileRequest) String() string            { return proto.CompactTextString(m) }
func (*HeapFileRequest) ProtoMessage()               {}
func (*HeapFileRequest) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{32} }
...
func (*StacksRequest) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{33} }
...
func (*CommandQueueRequest) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{56} }
...
func (*CommandQueueResponse) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{57} }
...
func (*DiagnosticsRequest) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{58} }
...
func (*StoresRequest) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{59} }
...
func (*StoreDetails) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{60} }
...
func (*StoresResponse) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{61} }
...
func (*StatementsRequest) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{62} }
...
func (*StatementsResponse) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{63} }
...
func (*StatementsResponse_ExtendedStatementStatisticsKey) Descriptor() ([]byte, []int) {
	return fileDescriptorStatus, []int{63, 0}
}
...
func (*StatementsResponse_CollectedStatementStatistics) Descriptor() ([]byte, []int) {
	return fileDescriptorStatus, []int{63, 1}
}
...
func init() {
	...
	proto.RegisterType((*HeapFileResponse)(nil), "cockroach.server.serverpb.HeapFileResponse")
	proto.RegisterType((*HeapFilesListRequest)(nil), "cockroach.server.serverpb.HeapFilesListRequest")
	proto.RegisterType((*HeapFilesListResponse)(nil), "cockroach.server.serverpb.HeapFilesListResponse")
	proto.RegisterType((*HeapFileRequest)(nil), "cockroach.server.serverpb.HeapFileRequest")
...
type StatusClient interface {
	...
	HeapFilesList(ctx context.Context, in *HeapFilesListRequest, opts ...grpc.CallOption) (*HeapFilesListResponse, error)
	HeapFile(ctx context.Context, in *HeapFileRequest, opts ...grpc.CallOption) (*HeapFileResponse, error)
...
func (c *statusClient) HeapFilesList(ctx context.Context, in *HeapFilesListRequest, opts ...grpc.CallOption) (*HeapFilesListResponse, error) {
	out := new(HeapFilesListResponse)
	err := grpc.Invoke(ctx, "/cockroach.server.serverpb.Status/HeapFilesList", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *statusClient) HeapFile(ctx context.Context, in *HeapFileRequest, opts ...grpc.CallOption) (*HeapFileResponse, error) {
	out := new(HeapFileResponse)
	err := grpc.Invoke(ctx, "/cockroach.server.serverpb.Status/HeapFile", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StatusServer interface {
	...
	HeapFilesList(context.Context, *HeapFilesListRequest) (*HeapFilesListResponse, error)
	HeapFile(context.Context, *HeapFileRequest) (*HeapFileResponse, error)
...
func _Status_HeapFilesList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HeapFilesListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StatusServer).HeapFilesList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cockroach.server.serverpb.Status/HeapFilesList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StatusServer).HeapFilesList(ctx, req.(*HeapFilesListRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Status_HeapFile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HeapFileRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StatusServer).HeapFile(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cockroach.server.serverpb.Status/HeapFile",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StatusServer).HeapFile(ctx, req.(*HeapFileRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Status_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "HeapFilesList",
			Handler:    _Status_HeapFilesList_Handler,
		},
		{
			MethodName: "HeapFile",
			Handler:    _Status_HeapFile_Handler,
		},
		{
...
func (m *HeapFileResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *HeapFileResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *HeapFilesListRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *HeapFilesListRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *HeapFilesListResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *HeapFilesListResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *HeapFileRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *HeapFileRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *HeapFileResponse) Size() (n int) {
	var l int
	_ = l
	l = len(m.Data)
	if l > 0 {
...
func (m *HeapFilesListRequest) Size() (n int) {
	var l int
	_ = l
	l = len(m.NodeId)
	if l > 0 {
...
func (m *HeapFilesListResponse) Size() (n int) {
	var l int
	_ = l
	if len(m.Files) > 0 {
		for _, s := range m.Files {
...
func (m *HeapFileRequest) Size() (n int) {
	var l int
	_ = l
	l = len(m.NodeId)
	if l > 0 {
...
func (m *HeapFileResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: HeapFileResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: HeapFileResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *HeapFilesListRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: HeapFilesListRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: HeapFilesListRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *HeapFilesListResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: HeapFilesListResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: HeapFilesListResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *HeapFileRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: HeapFileRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: HeapFileRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorStatus = []byte{
	...
	,
}
