...
type DebugProblemRangesRequest struct {
	NodeID string `protobuf:"bytes,1,opt,name=node_id,json=nodeId,proto3" json:"node_id,omitempty"`
}

func (m *DebugProblemRangesRequest) Reset()                    { *m = DebugProblemRangesRequest{} }
func (m *DebugProblemRangesRequest) String() string            { return proto.CompactTextString(m) }
func (*DebugProblemRangesRequest) ProtoMessage()               {}
func (*DebugProblemRangesRequest) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{34} }
...
func (m *DebugFailure) Reset()                    { *m = DebugFailure{} }
func (m *DebugFailure) String() string            { return proto.CompactTextString(m) }
func (*DebugFailure) ProtoMessage()               {}
func (*DebugFailure) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{35} }

type DebugProblemRangesResponse struct {
	// If node_id is greater than 0, then this response is only representative of
	// a single node's knowledge.
	NodeID                           github_com_cockroachdb_cockroach_pkg_roachpb.NodeID    `protobuf:"varint,1,opt,name=node_id,json=nodeId,proto3,casttype=github.com/cockroachdb/cockroach/pkg/roachpb.NodeID" json:"node_id,omitempty"`
	Failures                         []DebugFailure                                         `protobuf:"bytes,2,rep,name=failures" json:"failures"`
...
func (m *DebugProblemRangesResponse) Reset()         { *m = DebugProblemRangesResponse{} }
func (m *DebugProblemRangesResponse) String() string { return proto.CompactTextString(m) }
func (*DebugProblemRangesResponse) ProtoMessage()    {}
func (*DebugProblemRangesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptorStatus, []int{36}
}
...
func (m *DebugCell) Reset()                    { *m = DebugCell{} }
func (m *DebugCell) String() string            { return proto.CompactTextString(m) }
func (*DebugCell) ProtoMessage()               {}
func (*DebugCell) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{37} }

type DebugRow struct {
	Classes []string    `protobuf:"bytes,1,rep,name=classes" json:"classes,omitempty"`
	Cells   []DebugCell `protobuf:"bytes,2,rep,name=cells" json:"cells"`
}

func (m *DebugRow) Reset()                    { *m = DebugRow{} }
func (m *DebugRow) String() string            { return proto.CompactTextString(m) }
func (*DebugRow) ProtoMessage()               {}
func (*DebugRow) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{38} }

type DebugNodesRequest struct {
	// This should be a comma separated list of node ids.
	NodeIDs string `protobuf:"bytes,1,opt,name=node_ids,json=nodeIds,proto3" json:"node_ids,omitempty"`
	// A regex used to filter nodes based on locality.
	Locality string `protobuf:"bytes,2,opt,name=locality,proto3" json:"locality,omitempty"`
}

func (m *DebugNodesRequest) Reset()                    { *m = DebugNodesRequest{} }
func (m *DebugNodesRequest) String() string            { return proto.CompactTextString(m) }
func (*DebugNodesRequest) ProtoMessage()               {}
func (*DebugNodesRequest) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{39} }

type DebugNodesResponse struct {
	Failures []DebugFailure `protobuf:"bytes,1,rep,name=failures" json:"failures"`
	Filters  []string       `protobuf:"bytes,2,rep,name=filters" json:"filters,omitempty"`
	Rows     []DebugRow     `protobuf:"bytes,3,rep,name=rows" json:"rows"`
}

func (m *DebugNodesResponse) Reset()                    { *m = DebugNodesResponse{} }
func (m *DebugNodesResponse) String() string            { return proto.CompactTextString(m) }
func (*DebugNodesResponse) ProtoMessage()               {}
func (*DebugNodesResponse) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{40} }
...
func (*PrettySpan) Descriptor() ([]byte, []int) { return fileDescriptorStatus, []int{41} }
...
func init() {
	...
	proto.RegisterType((*DebugProblemRangesRequest)(nil), "cockroach.server.serverpb.DebugProblemRangesRequest")
	proto.RegisterType((*DebugFailure)(nil), "cockroach.server.serverpb.DebugFailure")
	proto.RegisterType((*DebugProblemRangesResponse)(nil), "cockroach.server.serverpb.DebugProblemRangesResponse")
	proto.RegisterType((*DebugCell)(nil), "cockroach.server.serverpb.DebugCell")
	proto.RegisterType((*DebugRow)(nil), "cockroach.server.serverpb.DebugRow")
	proto.RegisterType((*DebugNodesRequest)(nil), "cockroach.server.serverpb.DebugNodesRequest")
	proto.RegisterType((*DebugNodesResponse)(nil), "cockroach.server.serverpb.DebugNodesResponse")
...
type StatusClient interface {
	...
	ProblemRanges(ctx context.Context, in *DebugProblemRangesRequest, opts ...grpc.CallOption) (*DebugProblemRangesResponse, error)
	DebugNodes(ctx context.Context, in *DebugNodesRequest, opts ...grpc.CallOption) (*DebugNodesResponse, error)
}
...
func (c *statusClient) ProblemRanges(ctx context.Context, in *DebugProblemRangesRequest, opts ...grpc.CallOption) (*DebugProblemRangesResponse, error) {
	out := new(DebugProblemRangesResponse)
...
func (c *statusClient) DebugNodes(ctx context.Context, in *DebugNodesRequest, opts ...grpc.CallOption) (*DebugNodesResponse, error) {
	out := new(DebugNodesResponse)
	err := grpc.Invoke(ctx, "/cockroach.server.serverpb.Status/DebugNodes", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StatusServer interface {
	...
	ProblemRanges(context.Context, *DebugProblemRangesRequest) (*DebugProblemRangesResponse, error)
	DebugNodes(context.Context, *DebugNodesRequest) (*DebugNodesResponse, error)
}
...
func _Status_ProblemRanges_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DebugProblemRangesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StatusServer).ProblemRanges(ctx, req.(*DebugProblemRangesRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Status_DebugNodes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DebugNodesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StatusServer).DebugNodes(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cockroach.server.serverpb.Status/DebugNodes",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StatusServer).DebugNodes(ctx, req.(*DebugNodesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Status_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DebugNodes",
			Handler:    _Status_DebugNodes_Handler,
		},
	},
...
func (m *DebugProblemRangesRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *DebugProblemRangesRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *DebugFailure) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *DebugFailure) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *DebugProblemRangesResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *DebugProblemRangesResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if len(m.UnavailableRangeIDs) > 0 {
		dAtA20 := make([]byte, len(m.UnavailableRangeIDs)*10)
		var j19 int
	...
	if len(m.RaftLeaderNotLeaseHolderRangeIDs) > 0 {
		dAtA22 := make([]byte, len(m.RaftLeaderNotLeaseHolderRangeIDs)*10)
		var j21 int
	...
	if len(m.NoRaftLeaderRangeIDs) > 0 {
		dAtA24 := make([]byte, len(m.NoRaftLeaderRangeIDs)*10)
		var j23 int
	...
	if len(m.NoLeaseRangeIDs) > 0 {
		dAtA26 := make([]byte, len(m.NoLeaseRangeIDs)*10)
		var j25 int
	...
	if len(m.UnderreplicatedRangeIDs) > 0 {
		dAtA28 := make([]byte, len(m.UnderreplicatedRangeIDs)*10)
		var j27 int
...
func (m *DebugCell) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *DebugCell) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if len(m.Title) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintStatus(dAtA, i, uint64(len(m.Title)))
...
func (m *DebugRow) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *DebugRow) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *DebugNodesRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *DebugNodesRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.NodeIDs) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintStatus(dAtA, i, uint64(len(m.NodeIDs)))
		i += copy(dAtA[i:], m.NodeIDs)
	}
	if len(m.Locality) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintStatus(dAtA, i, uint64(len(m.Locality)))
		i += copy(dAtA[i:], m.Locality)
	}
	return i, nil
}

func (m *DebugNodesResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *DebugNodesResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *DebugProblemRangesRequest) Size() (n int) {
	var l int
	_ = l
	l = len(m.NodeID)
	if l > 0 {
...
func (m *DebugFailure) Size() (n int) {
	var l int
	_ = l
	if m.NodeID != 0 {
		n += 1 + sovStatus(uint64(m.NodeID))
...
func (m *DebugProblemRangesResponse) Size() (n int) {
	var l int
	_ = l
	if m.NodeID != 0 {
		n += 1 + sovStatus(uint64(m.NodeID))
...
func (m *DebugNodesRequest) Size() (n int) {
	var l int
	_ = l
	l = len(m.NodeIDs)
	if l > 0 {
...
func (m *DebugNodesResponse) Size() (n int) {
	var l int
	_ = l
	if len(m.Failures) > 0 {
		for _, e := range m.Failures {
...
func (m *DebugProblemRangesRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DebugProblemRangesRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DebugProblemRangesRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *DebugFailure) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DebugFailure: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DebugFailure: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *DebugProblemRangesResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DebugProblemRangesResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DebugProblemRangesResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			...
			m.Failures = append(m.Failures, DebugFailure{})
...
func (m *DebugCell) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DebugCell: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DebugCell: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *DebugRow) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DebugRow: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DebugRow: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			m.Cells = append(m.Cells, DebugCell{})
...
func (m *DebugNodesRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DebugNodesRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DebugNodesRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.NodeIDs = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
...
func (m *DebugNodesResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DebugNodesResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DebugNodesResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorStatus = []byte{
	...
	,
}
