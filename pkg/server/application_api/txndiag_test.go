	...
	testCases := []testCase{
		{
			...
			createRequests: []*serverpb.CreateTransactionDiagnosticsReportRequest{
				{
					TransactionFingerprintId: []byte(sqlstatsutil.EncodeTxnFingerprintIDToString(appstatspb.TransactionFingerprintID(123))),
				},
			},
			cancelRequests:  nil,
			expectedReports: 1,
		...
		},
		{
			...
			createRequests: []*serverpb.CreateTransactionDiagnosticsReportRequest{
				{
					TransactionFingerprintId: []byte(sqlstatsutil.EncodeTxnFingerprintIDToString(appstatspb.TransactionFingerprintID(456))),
					StatementFingerprintIds: [][]byte{
						[]byte(sqlstatsutil.EncodeStmtFingerprintIDToString(appstatspb.StmtFingerprintID(789))),
						[]byte(sqlstatsutil.EncodeStmtFingerprintIDToString(appstatspb.StmtFingerprintID(101112))),
					},
		...
		},
		{
			...
			createRequests: []*serverpb.CreateTransactionDiagnosticsReportRequest{
				{
					TransactionFingerprintId: []byte(sqlstatsutil.EncodeTxnFingerprintIDToString(appstatspb.TransactionFingerprintID(111))),
				},
				{
					TransactionFingerprintId: []byte(sqlstatsutil.EncodeTxnFingerprintIDToString(appstatspb.TransactionFingerprintID(222))),
		...
		},
		{
			...
			createRequests: []*serverpb.CreateTransactionDiagnosticsReportRequest{
				{
					TransactionFingerprintId: []byte(sqlstatsutil.EncodeTxnFingerprintIDToString(appstatspb.TransactionFingerprintID(333))),
				},
				{
					TransactionFingerprintId: []byte(sqlstatsutil.EncodeTxnFingerprintIDToString(appstatspb.TransactionFingerprintID(444))),
				},
			},
		...
		},
		{
			...
			createRequests: []*serverpb.CreateTransactionDiagnosticsReportRequest{
				{
					TransactionFingerprintId: []byte(sqlstatsutil.EncodeTxnFingerprintIDToString(appstatspb.TransactionFingerprintID(555))),
					StatementFingerprintIds: [][]byte{
						[]byte(sqlstatsutil.EncodeStmtFingerprintIDToString(appstatspb.StmtFingerprintID(666))),
					},
				},
			},
			cancelRequests:  nil,
...
func TestAdminAPITransactionDiagnosticsBundle(t *testing.T) {
	...
	// Create a transaction diagnostic request using the API
	req := &serverpb.CreateTransactionDiagnosticsReportRequest{
		TransactionFingerprintId: []byte("5a808c2f3780b2c8"),
		StatementFingerprintIds: [][]byte{
			[]byte("2ca050d725bfd5f0"),
			[]byte("fece62580b006715"),
		},
	}
