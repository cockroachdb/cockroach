...
func TestStatusAPICombinedStatementsWithFullScans(t *testing.T) {
	...
	executeStatements := func(statements []TestCases) map[string]StatementData {
	...
	executeStatements(statementsBeforeIdx)
	...
	executeStatements(statementsAfterIdx)
