...
func TestStatusAPICombinedTransactions(t *testing.T) {
	...
	sqlstatstestutil.WaitForTransactionEntriesAtLeast(t, obsConn, 1, sqlstatstestutil.TransactionFilter{
...
func TestStatusAPITransactionStatementFingerprintIDsTruncation(t *testing.T) {
	...
	sqlstatstestutil.WaitForTransactionEntriesAtLeast(t, obsConn, 2, sqlstatstestutil.TransactionFilter{
		App: testingApp,
	})
...
func TestStatusAPIStatements(t *testing.T) {
	...
	sqlstatstestutil.WaitForTransactionEntriesAtLeast(t, obsConn, len(statements))
...
func TestStatusAPICombinedStatementsWithFullScans(t *testing.T) {
	...
	executeStatements := func(statements []TestCases) {
		...
		sqlstatstestutil.WaitForStatementEntriesAtLeast(t, obsConn, stmtCount,
...
func TestStatusAPICombinedStatements(t *testing.T) {
	...
	sqlstatstestutil.WaitForStatementEntriesAtLeast(t, obsConn, len(statements),
...
func TestStatusAPIStatementDetails(t *testing.T) {
	...
	sqlstatstestutil.WaitForStatementEntriesAtLeast(t, obsConn, 5,
...
func TestCombinedStatementUsesCorrectSourceTable(t *testing.T) {
	...
	sqlstatstestutil.WaitForStatementEntriesAtLeast(t, conn, 2)
