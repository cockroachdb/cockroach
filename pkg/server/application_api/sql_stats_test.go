...
// TestCombinedStatementsRequestsSourceTable tests that requests read from
...
func TestCombinedStatementsRequestsSourceTable(t *testing.T) {
	defer leaktest.AfterTest(t)()
	defer log.Scope(t).Close(t)
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			for _, r := range tc.reqs {
				...
				require.Equal(t, tc.expectedStmtsTable, resp.StmtsSourceTable, "%v", r)
				require.Equal(t, tc.expectedTxnsTable, resp.TxnsSourceTable, "%v", r)
			}
