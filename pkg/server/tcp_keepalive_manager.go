...
// Aliases for the cluster settings, for use by other packages that already
// reference these variables by their old names.
var (
	KeepAliveProbeCount     = tcpkeepalive.ProbeCount
	KeepAliveProbeFrequency = tcpkeepalive.ProbeInterval
	KeepAliveIdleTime       = tcpkeepalive.IdleTime
	TCPUserTimeout          = tcpkeepalive.UserTimeout
)
