...
func TestStatementsExcludeStats(t *testing.T) {
	...
	t.Run("exclude-statements", func(t *testing.T) {
		resp, err := client.Statements(ctx, &serverpb.StatementsRequest{NodeID: "local", ExcludeStatements: true})
		require.NoError(t, err)
		require.NotEmpty(t, resp.Transactions)
	...
	t.Run("exclude-transactions", func(t *testing.T) {
		resp, err := client.Statements(ctx, &serverpb.StatementsRequest{NodeID: "local", ExcludeTransactions: true})
		require.NoError(t, err)
