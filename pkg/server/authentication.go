...
// system.users table. Returns an error if the credentials cannot be verified.
// TODO(mrtracy): this does not currently distinguish "User not found" from
// any other type of SQL error.
