...
func (a *apiV2Server) registerRoutes(innerMux *mux.Router, authMux http.Handler) {
	...
	routeDefinitions := []struct{
		...
		{"hotranges/", a.hotRanges, true /* requiresAuth */ , adminRole, noOption},
		{"ranges/{range_id}/", a.rangeHandler, true /* requiresAuth */ , adminRole, noOption},
		{"nodes/", a.nodes, true /* requiresAuth */ , regularRole, noOption},
	}
