...
// newExecTraceMetadataFn returns a callback that embeds metadata into a Go
// execution trace via runtime/trace.Log. The metadata includes the current
// wall-clock time, node ID, build version, and the source of the trace capture.
// The returned function is safe to call from any goroutine.
func newExecTraceMetadataFn(
	idContainer *base.NodeIDContainer,
) func(ctx context.Context, source string) {
