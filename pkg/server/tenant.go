...
func newTenantServer(
	...
	if baseCfg.SplitListenSQL && !baseCfg.DisableSQLListener {
		if baseCfg.SQLAddrListener, err = ListenAndUpdateAddrs(
			ctx, &baseCfg.SQLAddr, &baseCfg.SQLAdvertiseAddr, "sql"); err != nil {
			return nil, err
		}
	}
	...
	if sqlCfg.DelayedSetTenantID != nil {
		if err = sqlCfg.DelayedSetTenantID(&sqlCfg.TenantID); err != nil {
			return nil, err
		}
	}
