...
var strFoo = settings.RegisterStringSetting(settings.TenantWritable, "str.foo", "desc", "")
var strBar = settings.RegisterStringSetting(settings.TenantWritable, "str.bar", "desc", "bar")
var i0 = settings.RegisterIntSetting(settings.TenantWritable, "i0", "desc", 0)
var i1 = settings.RegisterIntSetting(settings.TenantWritable, "i1", "desc", 1)
