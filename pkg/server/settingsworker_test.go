...
func TestSettingsZipkinBatchSize(t *testing.T) {
	...
	collectorHandlerFcn := func(rw http.ResponseWriter, req *http.Request) {
		...
		atomic.StoreInt64(&observedBatchSize, int64(batchSize))
	}
...
func TestSettingsTraceSamplingRate(t *testing.T) {
	...
	testutils.SucceedsSoon(t, func() error {
		...
		if currentTraces < 950 && currentTraces > 1050 {
			return fmt.Errorf(`could not trace all SQL 'INSERT INTO' statements. traced %d out of 1000`, currentTraces)
		}
		return nil
	})
	...
	testutils.SucceedsSoon(t, func() error {
		...
		if currentTraces < 450 && currentTraces > 550 {
			return fmt.Errorf(`could not trace 50 percent of SQL 'INSERT INTO' statements. traced %d out of 1000`, currentTraces)
		}
		return nil
	})
	...
	testutils.SucceedsSoon(t, func() error {
		currentTraces := atomic.LoadInt64(&nTraces)
		if currentTraces < 50 && currentTraces > 150 {
			return fmt.Errorf(`could not trace 10 percent of SQL 'INSERT INTO' statements. traced %d out of 1000`, currentTraces)
		}
		return nil
	})
}
