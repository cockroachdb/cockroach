...
var _ serverpb.InternalSpanStatsServer = &spanStatsServer{}
...
func (s *spanStatsServer) dialFn(ctx context.Context, nodeID roachpb.NodeID) (interface{}, error) {
	...
	return serverpb.NewInternalSpanStatsClient(conn), err
}

func (s *spanStatsServer) fanOut(
	ctx context.Context, req *roachpb.InternalSpanStatsRequest,
) (*roachpb.InternalSpanStatsResponse, error) {
	var res *roachpb.InternalSpanStatsResponse
	...
	nodeFn := func(ctx context.Context, client interface{}, nodeID roachpb.NodeID) (interface{}, error) {
		...
		if client == nil {
			return &roachpb.InternalSpanStatsResponse{}, nil
		}
		stats, err := client.(serverpb.InternalSpanStatsClient).GetSpanStatsInternal(ctx,
	...
	responseFn := func(nodeID roachpb.NodeID, resp interface{}) {
		nodeResponse := resp.(*roachpb.InternalSpanStatsResponse)
...
func (s *spanStatsServer) getLocalStats(
	...
	res := &roachpb.InternalSpanStatsResponse{}
...
func (s *spanStatsServer) GetSpanStatsInternal(
	ctx context.Context, req *roachpb.InternalSpanStatsRequest,
) (*roachpb.InternalSpanStatsResponse, error) {
	...
	return client.(serverpb.InternalSpanStatsClient).GetSpanStatsInternal(ctx, req)
}
