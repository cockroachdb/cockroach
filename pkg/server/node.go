...
func (n *Node) initStores(
	...
	if len(bootstraps) > 0 {
		if err := stopper.RunAsyncTask(ctx, "bootstrapStores", func(ctx context.Context) {
...
func (n *Node) writeSummaries(ctx context.Context) error {
	var err error
	if runErr := n.stopper.RunTask(ctx, "Node.writeSummaries", func(ctx context.Context) {
...
func (n *Node) batchInternal(
	...
	if err := n.stopper.RunTaskWithErr(ctx, "batchInternal", func(ctx context.Context) error {
