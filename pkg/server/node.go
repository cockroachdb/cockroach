...
func (n *Node) setupSpanForIncomingRPC(
	...
	if localRequest {
		...
		// We only expect a span in the context at this point for requests coming
		// from 21.2 clusters. If the cluster version is 22.1, the gRPC interceptor
		// that generally opens spans for other RPCs should have omitted doing that
		// for this particular RPC.
		if parentSpan == nil {
