...
type setRangeIDEventSink struct {
	...
	wrapped roachpb.Internal_RangeFeedStreamServer
}
...
func (s *setRangeIDEventSink) Send(event *roachpb.RangeFeedEvent) error {
	response := &roachpb.RangeFeedStreamResponse{
...
func (n *Node) asyncRangeFeed(
	args roachpb.RangeFeedRequest, stream roachpb.Internal_RangeFeedStreamServer,
...
// RangeFeedStream implements the roachpb.InternalServer interface.
func (n *Node) RangeFeedStream(stream roachpb.Internal_RangeFeedStreamServer) error {
