...
type Node struct {
	...
	testingErrHook func(context.Context, *roachpb.BatchRequest, error)
}
...
func NewNode(
	...
	n := &Node{
		...
		testingErrHook:        cfg.TestingKnobs.TestingServerResponseError,
	}
...
func (n *Node) Batch(
	...
	if buildutil.CrdbTestBuild && br.Error != nil && n.testingErrHook != nil {
		n.testingErrHook(ctx, args, errors.DecodeError(ctx, br.Error.EncodedError))
	}
	return br, nil
}
