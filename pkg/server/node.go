...
// block until nodes are fully bootstrapped.
func (n *Node) start(
	ctx context.Context,
	...
	if len(state.newEngines) > 0 {
		...
		// the KV layer to be available yet. See #39415.

		// Create bootstrapNewStoresDone channel and update waitForBootstrapNewStores function to block on it.
