...
func newAPIV2SystemServer(
	ctx context.Context,
	opts *apiV2ServerOpts,
	systemAdmin *systemAdminServer,
	systemStatus *systemStatusServer,
) *apiV2SystemServer {
	...
	systemA := &apiV2SystemServer{
		apiV2Server:  a,
		systemAdmin:  systemAdmin,
		systemStatus: systemStatus,
	}
	a.registerRoutes(innerMux, authMux, systemA)
	return systemA
}
...
func newAPIV2Server(ctx context.Context, opts *apiV2ServerOpts) *apiV2Server {
	...
	a.registerRoutes(innerMux, authMux, a)
	return a
}

// registerRoutes registers endpoints under the current API server.
func (a *apiV2Server) registerRoutes(
	innerMux *mux.Router, authMux http.Handler, systemRoutes ApiV2System,
) {
