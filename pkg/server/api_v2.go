...
func registerRoutes(
	...
	routeDefinitions := []struct {
		...
		{"metadata/databases/", a.DbsMetadata, true, authserver.RegularRole, true},
		{"metadata/database/{database_id}/tables/", a.DbTablesMetadata, true, authserver.RegularRole, true},
	}
