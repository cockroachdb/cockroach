...
func newSQLServer(ctx context.Context, cfg sqlServerArgs) (*SQLServer, error) {
	...
	*execCfg = sql.ExecutorConfig{
	...
	ieFactory := func(
		...
		ie := sql.MakeInternalExecutor(ctx, pgServer.SQLServer, internalMemMetrics, cfg.Settings, ieFactoryMonitor)
	...
	*cfg.circularInternalExecutor = sql.MakeInternalExecutor(ctx, pgServer.SQLServer, internalMemMetrics, cfg.Settings, nil /* monitor */)
...
func (s *SQLServer) preStart(
	...
	migrationsExecutor := sql.MakeInternalExecutor(ctx, s.pgServer.SQLServer, s.internalMemMetrics, s.execCfg.Settings, nil /* monitor */)
