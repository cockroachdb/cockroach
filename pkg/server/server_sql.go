...
func (s *SQLServer) setInstanceID(instanceID base.SQLInstanceID, sessionID sqlliveness.SessionID) {
...
func (s *SQLServer) preStart(
	...
	// If we have a nodeID, set our SQL instance ID to the node ID. Otherwise,
	// allow our SQL instance ID to be generated by SQL.
	...
	s.setInstanceID(instance.InstanceID, session.ID())
