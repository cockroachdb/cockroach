...
func newSQLServer(ctx context.Context, cfg sqlServerArgs) (*SQLServer, error) {
	...
	// Set up the sqlliveness subsystem
	var livenessTestKnobs sql.LivenessKnobs
	if livenessTestingKnobs := cfg.TestingKnobs.SQLLivenessKnobs; livenessTestingKnobs != nil {
		livenessTestKnobs = *livenessTestingKnobs.(*sql.LivenessKnobs)
	}
	cfg.sqlLivenessProvider = slprovider.New(
		cfg.stopper, cfg.clock, cfg.db, codec, cfg.Settings, livenessTestKnobs,
	)
