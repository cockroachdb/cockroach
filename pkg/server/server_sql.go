...
func (s *SQLServer) SQLInstanceID()
base.SQLInstanceID{
...
// testing.
func (s *SQLServer) StartDiagnostics(ctx
context.Context) {
...
func (s *SQLServer) AnnotateCtx(ctx
...
serveConn
func (ctx context.Context, conn net.Conn, preServeStatus pgwire.PreServeStatus) error,
pgL
net.Listener,
...
func prepareUnixSocket(
	ctx
context.Context, pgL
net.Listener, socketFileCfg * string,
) (socketFile
string, socketLock
lockfile.Lockfile, err
error) {
socketFile = ""
...
// for this server.
func (s *SQLServer) LogicalClusterID()
uuid.UUID{
