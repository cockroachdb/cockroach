...
// NOTE(andrei): I've commented out this test when removing
// VersionUnreplicatedRaftTruncatedState cluster version. I think the test needs
// to stay for this special migration, but I'm not sure how it needs to evolve.
//
