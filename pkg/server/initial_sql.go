...
// MaybeRunInitialSQL concerns itself with running "initial SQL" code when
...
func (s *Server) MaybeRunInitialSQL(
...
// MaybeRunInitialSQL implements cli.serverStartupInterface.
// For now, SQL-only servers do not run initial SQL.
func (s *SQLServerWrapper) MaybeRunInitialSQL(context.Context, bool, string, string) error {
	return nil
}
