...
type NodeStatus struct {
	...
	// num_cores is the number of logical cores on this machine.
...
func (m *NodeStatus) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.NumCores != 0 {
		dAtA[i] = 0x58
		i++
		i = encodeVarintStatus(dAtA, i, uint64(m.NumCores))
	}
	return i, nil
}
...
func (m *NodeStatus) Size() (n int) {
	...
	if m.NumCores != 0 {
		n += 1 + sovStatus(uint64(m.NumCores))
	}
	return n
}
...
var fileDescriptorStatus = []byte{
	...
	,
}
