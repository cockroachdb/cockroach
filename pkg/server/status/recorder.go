...
func (mr *MetricsRecorder) GetMetricsMetadata(
	...
	mr.getStoreMetricsMetadata(nodeMetrics)
...
func (mr *MetricsRecorder) GetRecordedMetricNames(
	...
	mr.getStoreMetricsMetadata(storeMetricsMap)
...
// getStoreMetricsMetadata Gets a store from mr.mu.storeRegistries and writes
// the metrics metadata to the provided map.
func (mr *MetricsRecorder) getStoreMetricsMetadata(metricsMetadata map[string]metric.Metadata) {
