...
type MetricsRecorder struct {
	*HealthChecker
	...
	// tenantName is the tenant name of the tenant this recorder is attached to.
	// It will be used to label metrics that are tenant-specific.
...
func (mr *MetricsRecorder) AddNode(
	...
	if mr.tenantName != "" {
		reg.AddLabel("tenant", string(mr.tenantName))
	}
}
