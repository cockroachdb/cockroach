...
func TestMetricsRecorderLabels(t *testing.T) {
	...
	err = recorder.PrintAsText(buf, expfmt.NewFormat(expfmt.TypeTextPlain), false)
	require.NoError(t, err)
	...
	err = recorderTenant.PrintAsText(bufTenant, expfmt.NewFormat(expfmt.TypeTextPlain), false)
	require.NoError(t, err)
...
func TestMetricsRecorder(t *testing.T) {
	...
	for i := 0; i < 100; i++ {
		...
		go func() {
			...
			_ = recorder.PrintAsText(io.Discard, expfmt.NewFormat(expfmt.TypeTextPlain), false)
