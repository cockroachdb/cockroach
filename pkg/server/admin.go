...
func getFullyQualifiedTableName(
	ctx context.Context, dbName string, tableName string,
) (string, error) {
...
func (s *adminServer) TableDetails(
	...
	escQualTable, err := getFullyQualifiedTableName(ctx, req.Database, req.Table)
	if err != nil {
		return nil, err
	}
