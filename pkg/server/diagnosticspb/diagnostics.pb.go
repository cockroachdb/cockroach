...
type DiagnosticReport struct {
	...
	AppStats            []cockroach_sql.CollectedApplicationStatistics `protobuf:"bytes,6,rep,name=app_stats,json=appStats" json:"app_stats"`
}
...
func (m *DiagnosticReport) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AppStats", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AppStats = append(m.AppStats, cockroach_sql.CollectedApplicationStatistics{})
			if err := m.AppStats[len(m.AppStats)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorDiagnostics = []byte{
	...
	,
}
