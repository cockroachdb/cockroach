...
// getCallCountInterceptor returns either a gRPC or dRPC interceptor based on the enableDRPC flag.
func getCallCountInterceptor(enableDRPC bool) interface{} {
	if enableDRPC {
		return getDRPCCallCountInterceptor()
	}
	return getGRPCCallCountInterceptor()
}
