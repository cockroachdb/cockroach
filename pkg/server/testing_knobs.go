...
type TestingKnobs struct {
	...
	// OverrideClusterVersion overrides the version of the cluster (assuming that
	...
	//
	// When OverrideClusterVersion is set, the cluster will be at this version
	...
	// OverrideClusterVersion; after all the servers in the test cluster have been
	// started, `SET CLUSTER SETTING version = OverrideClusterVersion` will be run
	// to step through the upgrades until the specified override.
	//
	// OverrideClusterVersion is also used when advertising this server's binary
