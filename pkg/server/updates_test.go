...
func TestReportUsage(t *testing.T) {
	...
	expectedFeatureUsage := map[string]int32{
		...
		"unimplemented.alter table rename constraint":     10,
		"unimplemented.simple_type const_interval":        10,
		"unimplemented.#9148":                             10,
		"internalerror.":                                  10,
		"othererror.builtins.go":                          10,
		"pgerror.blah":                                    10,
		"pgerror." + pgerror.CodeInternalError:            10,
		"pgerror." + pgerror.CodeSyntaxError:              10,
		"pgerror." + pgerror.CodeFeatureNotSupportedError: 10,
		"pgerror." + pgerror.CodeDivisionByZeroError:      10,
	}
