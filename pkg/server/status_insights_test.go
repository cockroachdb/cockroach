...
func TestStatusServer_StatementExecutionInsights(t *testing.T) {
	...
	var stmtInsight *serverpb.StatementExecutionInsightsResponse_StatementInsight
	...
	t.Run("request_with_filter", func(t *testing.T) {
		...
		testCases := []struct {
			...
			{
				name: "statement_id",
				tReq: serverpb.StatementExecutionInsightsRequest{StatementID: &stmtInsight.Statement.ID},
			...
			},
			{
				...
				tReq: serverpb.StatementExecutionInsightsRequest{StmtFingerprintID: stmtInsight.Statement.FingerprintID},
