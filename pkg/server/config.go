...
// value to set maxOpenFiles to for each store. See the appropriate os suffixed
// file for implementations.
//
...
//
// On Windows there is no need to change the file descriptor, known as file
// handles, limit. This limit cannot be changed is approximately 16,711,680. See
