...
func (s *statusServer) localUpdateTableMetadataCache() (*serverpb.UpdateTableMetadataCacheResponse, error) {
	select {
...
// GetUpdateTableMetadataCacheSignal sets the signal channel for the
