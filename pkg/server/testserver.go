...
// SQLServer is part of the TestTenantInterface interface.
func (t *TestTenant) SQLServer() interface{} {
	return t.pgServer.SQLServer
}

// ReportDiagnostics is part of the TestTenantInterface interface.
func (t *TestTenant) ReportDiagnostics(ctx context.Context) {
	t.diagnosticsReporter.ReportDiagnostics(ctx)
}
