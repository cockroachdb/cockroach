...
func StartTenant(
	...
	// Since SQLStatusServer requires a pointer to SQLServer, it is constructed after SQLServer is
	// constructed and retrospectively added to SQLServer's execCfg.
