...
func makeTestConfigFromParams(params base.TestServerArgs) Config {
	...
	if params.Tracer == nil {
		tr = tracing.NewTracerWithOpt(context.TODO(), tracing.WithClusterSettings(&st.SV), tracing.WithTracingDefault(params.TracingDefault))
	}
...
func (ts *TestServer) StartTenant(
	...
	if stopper == nil {
		...
		tr := tracing.NewTracerWithOpt(ctx, tracing.WithClusterSettings(&st.SV), tracing.WithTracingDefault(params.TracingDefault))
