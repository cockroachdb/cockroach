...
// SQLInstanceID is part of the serverutils.TestServerInterface XX.
func (ts *TestServer) SQLInstanceID() base.SQLInstanceID {
	return ts.sqlServer.sqlIDContainer.SQLInstanceID()
}

// StatusServer is part of the serverutils.TestServerInterface XX.
...
func (ts *TestServer) MigrationServer() interface{} {
	return ts.sqlServer.migrationServer
}
