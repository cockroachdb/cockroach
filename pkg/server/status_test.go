...
func TestLocalExecutionInsights(t *testing.T) {
	...
	t.Run("hasHighContentionCause", func(t *testing.T) {
		causes := []insights.Cause{insights.Cause_PlanRegression}
		require.False(t, hasHighContentionCause(causes))

		causes = []insights.Cause{insights.Cause_HighContention}
		require.True(t, hasHighContentionCause(causes))

		causes = []insights.Cause{insights.Cause_PlanRegression, insights.Cause_HighContention}
		require.True(t, hasHighContentionCause(causes))
	})
	...
	t.Run("validContentionInsights", func(t *testing.T) {
		...
		valid := validContentionInsights(registry, insights)
