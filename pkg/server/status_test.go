...
func TestHistoricalContentionEvents(t *testing.T) {
	defer leaktest.AfterTest(t)()
	defer log.Scope(t).Close(t)
...
`,
    ...
    SELECT count(*) > 0
    FROM crdb_internal.historical_contention_events
    WHERE
