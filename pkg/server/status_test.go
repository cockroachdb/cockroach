...
func TestStatusAPIStatementDetails(t *testing.T) {
	...
	// Test fix for #83608. The stmt being requested has a fingerprint id that is
	// 15 chars in hexadecimal. We should be able to find this stmt now that we
	// construct the filter using a bytes comparison instead of string.

	selectQuery := "select 1, 2, 3, 4"
	statements = []string{
