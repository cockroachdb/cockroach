...
func (s *Server) refreshSettings() {
	...
	s.stopper.RunWorker(ctx, func(ctx context.Context) {
		// The setting values are global and updating them is a global process.
		// If we have multiple testservers or testcluster at the same time, let
		// only one of them populate the values.
		select {
