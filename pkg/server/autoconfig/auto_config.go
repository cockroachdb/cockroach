...
func (r *autoConfigRunner) Resume(ctx context.Context, execCtx interface{}) error {
	...
	// TODO(knz): Remove this after the following issue has been
	// addressed: https://github.com/cockroachdb/cockroach/issues/99242
	ctx, cleanup := execCfg.RPCContext.Stopper.WithCancelOnQuiesce(ctx)
	defer cleanup()
