...
func (c *serverController) attemptLoginToAllTenants() http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if len(tenantNameToSetCookieSlice) > 0 {
			...
			http.SetCookie(w, authserver.CreateTenantCookie(tenantSelection, !c.disableTLSForHTTP /* forHTTPSOnly */))
...
func (c *serverController) attemptLogoutFromAllTenants() http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		http.SetCookie(w, authserver.CreateEmptyTenantCookieWithImmediateExpiry(!c.disableTLSForHTTP /* forHTTPSOnly */))
