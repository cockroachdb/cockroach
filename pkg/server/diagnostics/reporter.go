...
func (r *Reporter) buildReportingURL(
	...
	clusterInfo := ClusterInfo{
		...
		OrganizationID:   uuid.UUID(license.OrganizationId),
		LicenseExpiry:    license.ValidUntilUnixSec,         // requires a context, settings, time source
		LicenseID:        uuid.UUID(license.OrganizationId), // requires a context, settings, time source
