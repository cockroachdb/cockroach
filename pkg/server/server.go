...
func NewServer(cfg Config, stopper *stop.Stopper) (*Server, error) {
	...
	s.internalMemMetrics = sql.MakeInternalMemMetrics()
	...
	s.adminMemMetrics = sql.MakeAdminMemMetrics()
	...
	s.pgServer = pgwire.MakeServer(s.cfg.Config, s.sqlExecutor, s.cfg.SQLMemoryPoolSize)
