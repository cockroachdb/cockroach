...
func updateAlloyConfig(
	...
	err = pyroscopeCluster.Run(ctx, l, l.Stdout, l.Stderr, install.WithNodes(pyroscopeCluster.Nodes), "restart alloy",
		fmt.Sprintf("cd %s && sudo docker compose kill -HUP alloy", pyroscopeDir))
	return err
}
