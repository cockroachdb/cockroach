...
func Sync(l *logger.Logger, options vm.ListOptions) (*cloud.Cloud, error) {
	...
	if err := syncClustersCache(l, cld, deleteClusters); err != nil {
		return nil, err
	}
...
func getCluster(l *logger.Logger, clusterName string) (*cloud.Cluster, error) {
	...
	if !ok {
		if err != nil {
			return &cloud.Cluster{}, errors.Wrapf(err, "cluster not found")
		}
		return &cloud.Cluster{}, errors.New("cluster not found")
	}
