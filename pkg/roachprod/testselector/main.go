...
func main() {
	...
	selectFromSuccessPct := flag.Int("select-from-success-pct", 0,
		"percentage of tests to be selected for running from the successful test list")
	...
	if err := SelectTests(ctx, *forPastDays, *firstRunOn, *lastRunOn, *selectFromSuccessPct, *cloud, *suite); err != nil {
