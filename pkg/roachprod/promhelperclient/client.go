...
func (c *PromClient) UpdatePrometheusTargets(
	...
	return c.makeRequest(request, "UpdatePrometheusTargets")
}
...
func (c *PromClient) DeleteClusterConfig(
	...
	return c.makeRequest(request, "DeleteClusterConfig")
}
...
func (c *PromClient) makeRequest(request *http.Request, logPrefix string) error {
...
func WithIAPTokenSource(tokenSource roachprodutil.IAPTokenSourceIface) OptionFunc {
	return func(c *PromClient) {
		c.client = tokenSource.GetHTTPClient()
	}
}
