...
const (
	// None indicates that the node provider is not reachable.
	None Reachability = iota
	// Private indicates that the node provider is reachable via private network.
	Private
	// Public indicates that the node provider is reachable via public network.
	Public
)
