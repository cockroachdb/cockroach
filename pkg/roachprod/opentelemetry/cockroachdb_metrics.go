...
var cockroachdbMetrics = map[string]string{
	...
	"rpc_server_drpc_request_duration_nanos":                      "rpc.server.drpc.request.duration.nanos",
	"rpc_server_drpc_request_duration_nanos_bucket":               "rpc.server.drpc.request.duration.nanos.bucket",
	"rpc_server_drpc_request_duration_nanos_count":                "rpc.server.drpc.request.duration.nanos.count",
	"rpc_server_drpc_request_duration_nanos_sum":                  "rpc.server.drpc.request.duration.nanos.sum",
