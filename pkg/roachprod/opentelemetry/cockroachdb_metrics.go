...
var cockroachdbMetrics = map[string]string{
	...
	"server_grpc_request_duration_nanos":                          "server.grpc.request.duration.nanos",
	"server_grpc_request_duration_nanos_bucket":                   "server.grpc.request.duration.nanos.bucket",
	"server_grpc_request_duration_nanos_count":                    "server.grpc.request.duration.nanos.count",
	"server_grpc_request_duration_nanos_sum":                      "server.grpc.request.duration.nanos.sum",
