...
// cockroachdbMetrics is a mapping from Datagod integration metric names to
// CockroachDB metric names.
var cockroachdbMetrics = map[string]string{
	...
	"admission_admitted_elastic_cpu":                                  "admission.admitted.elastic-cpu",
	"admission_admitted_elastic_cpu_bulk_normal_pri":                  "admission.admitted.elastic-cpu.bulk-normal-pri",
	"admission_admitted_elastic_cpu_normal_pri":                       "admission.admitted.elastic-cpu.normal-pri",
	"admission_admitted_elastic_stores":                               "admission.admitted.elastic-stores",
	"admission_admitted_elastic_stores_bulk_low_pri":                  "admission.admitted.elastic-stores.bulk-low-pri",
	"admission_admitted_elastic_stores_bulk_normal_pri":               "admission.admitted.elastic-stores.bulk-normal-pri",
	"admission_admitted_kv":                                           "admission.admitted.kv",
	"admission_admitted_kv_high_pri":                                  "admission.admitted.kv.high-pri",
	"admission_admitted_kv_locking_normal_pri":                        "admission.admitted.kv.locking-normal-pri",
	"admission_admitted_kv_normal_pri":                                "admission.admitted.kv.normal-pri",
	"admission_admitted_kv_stores":                                    "admission.admitted.kv-stores",
	"admission_admitted_kv_stores_high_pri":                           "admission.admitted.kv-stores.high-pri",
	"admission_admitted_kv_stores_locking_normal_pri":                 "admission.admitted.kv-stores.locking-normal-pri",
	"admission_admitted_kv_stores_normal_pri":                         "admission.admitted.kv-stores.normal-pri",
	"admission_admitted_kv_stores_user_high_pri":                      "admission.admitted.kv-stores.user-high-pri",
	"admission_admitted_sql_kv_response":                              "admission.admitted.sql-kv-response",
	"admission_admitted_sql_kv_response_locking_normal_pri":           "admission.admitted.sql-kv-response.locking-normal-pri",
	"admission_admitted_sql_kv_response_normal_pri":                   "admission.admitted.sql-kv-response.normal-pri",
	"admission_admitted_sql_sql_response":                             "admission.admitted.sql-sql-response",
	"admission_admitted_sql_sql_response_locking_normal_pri":          "admission.admitted.sql-sql-response.locking-normal-pri",
	"admission_admitted_sql_sql_response_normal_pri":                  "admission.admitted.sql-sql-response.normal-pri",
	...
	"admission_errored_elastic_cpu":                                   "admission.errored.elastic-cpu",
	"admission_errored_elastic_cpu_bulk_normal_pri":                   "admission.errored.elastic-cpu.bulk-normal-pri",
	"admission_errored_elastic_cpu_normal_pri":                        "admission.errored.elastic-cpu.normal-pri",
	"admission_errored_elastic_stores":                                "admission.errored.elastic-stores",
	"admission_errored_elastic_stores_bulk_low_pri":                   "admission.errored.elastic-stores.bulk-low-pri",
	"admission_errored_elastic_stores_bulk_normal_pri":                "admission.errored.elastic-stores.bulk-normal-pri",
	"admission_errored_kv":                                            "admission.errored.kv",
	"admission_errored_kv_high_pri":                                   "admission.errored.kv.high-pri",
	"admission_errored_kv_locking_normal_pri":                         "admission.errored.kv.locking-normal-pri",
	"admission_errored_kv_normal_pri":                                 "admission.errored.kv.normal-pri",
	"admission_errored_kv_stores":                                     "admission.errored.kv-stores",
	"admission_errored_kv_stores_high_pri":                            "admission.errored.kv-stores.high-pri",
	"admission_errored_kv_stores_locking_normal_pri":                  "admission.errored.kv-stores.locking-normal-pri",
	"admission_errored_kv_stores_normal_pri":                          "admission.errored.kv-stores.normal-pri",
	"admission_errored_kv_stores_user_high_pri":                       "admission.errored.kv-stores.user-high-pri",
	"admission_errored_sql_kv_response":                               "admission.errored.sql-kv-response",
	"admission_errored_sql_kv_response_locking_normal_pri":            "admission.errored.sql-kv-response.locking-normal-pri",
	"admission_errored_sql_kv_response_normal_pri":                    "admission.errored.sql-kv-response.normal-pri",
	"admission_errored_sql_sql_response":                              "admission.errored.sql-sql-response",
	"admission_errored_sql_sql_response_locking_normal_pri":           "admission.errored.sql-sql-response.locking-normal-pri",
	"admission_errored_sql_sql_response_normal_pri":                   "admission.errored.sql-sql-response.normal-pri",
	...
	"admission_granter_io_tokens_exhausted_duration_kv":               "admission.granter.io_tokens_exhausted_duration.kv",
	...
	"admission_granter_total_slots_kv":                                "admission.granter.total_slots.kv",
	"admission_granter_used_slots_kv":                                 "admission.granter.used_slots.kv",
	...
	"admission_requested_elastic_cpu":                                 "admission.requested.elastic-cpu",
	"admission_requested_elastic_cpu_bulk_normal_pri":                 "admission.requested.elastic-cpu.bulk-normal-pri",
	"admission_requested_elastic_cpu_normal_pri":                      "admission.requested.elastic-cpu.normal-pri",
	"admission_requested_elastic_stores":                              "admission.requested.elastic-stores",
	"admission_requested_elastic_stores_bulk_low_pri":                 "admission.requested.elastic-stores.bulk-low-pri",
	"admission_requested_elastic_stores_bulk_normal_pri":              "admission.requested.elastic-stores.bulk-normal-pri",
	"admission_requested_kv":                                          "admission.requested.kv",
	"admission_requested_kv_high_pri":                                 "admission.requested.kv.high-pri",
	"admission_requested_kv_locking_normal_pri":                       "admission.requested.kv.locking-normal-pri",
	"admission_requested_kv_normal_pri":                               "admission.requested.kv.normal-pri",
	"admission_requested_kv_stores":                                   "admission.requested.kv-stores",
	"admission_requested_kv_stores_high_pri":                          "admission.requested.kv-stores.high-pri",
	"admission_requested_kv_stores_locking_normal_pri":                "admission.requested.kv-stores.locking-normal-pri",
	"admission_requested_kv_stores_normal_pri":                        "admission.requested.kv-stores.normal-pri",
	"admission_requested_kv_stores_user_high_pri":                     "admission.requested.kv-stores.user-high-pri",
	"admission_requested_sql_kv_response":                             "admission.requested.sql-kv-response",
	"admission_requested_sql_kv_response_locking_normal_pri":          "admission.requested.sql-kv-response.locking-normal-pri",
	"admission_requested_sql_kv_response_normal_pri":                  "admission.requested.sql-kv-response.normal-pri",
	"admission_requested_sql_sql_response":                            "admission.requested.sql-sql-response",
	"admission_requested_sql_sql_response_locking_normal_pri":         "admission.requested.sql-sql-response.locking-normal-pri",
	"admission_requested_sql_sql_response_normal_pri":                 "admission.requested.sql-sql-response.normal-pri",
	"admission_scheduler_latency_listener_p99_nanos":                  "admission.scheduler_latency_listener.p99_nanos",
	"admission_wait_durations_elastic_cpu":                            "admission.wait_durations.elastic-cpu",
	"admission_wait_durations_elastic_cpu_bulk_normal_pri":            "admission.wait_durations.elastic-cpu.bulk-normal-pri",
	"admission_wait_durations_elastic_cpu_normal_pri":                 "admission.wait_durations.elastic-cpu.normal-pri",
	"admission_wait_durations_elastic_stores":                         "admission.wait_durations.elastic-stores",
	"admission_wait_durations_elastic_stores_bulk_low_pri":            "admission.wait_durations.elastic-stores.bulk-low-pri",
	"admission_wait_durations_elastic_stores_bulk_normal_pri":         "admission.wait_durations.elastic-stores.bulk-normal-pri",
	"admission_wait_durations_kv":                                     "admission.wait_durations.kv",
	"admission_wait_durations_kv_high_pri":                            "admission.wait_durations.kv.high-pri",
	"admission_wait_durations_kv_locking_normal_pri":                  "admission.wait_durations.kv.locking-normal-pri",
	"admission_wait_durations_kv_normal_pri":                          "admission.wait_durations.kv.normal-pri",
	"admission_wait_durations_kv_stores":                              "admission.wait_durations.kv-stores",
	"admission_wait_durations_kv_stores_high_pri":                     "admission.wait_durations.kv-stores.high-pri",
	"admission_wait_durations_kv_stores_locking_normal_pri":           "admission.wait_durations.kv-stores.locking-normal-pri",
	"admission_wait_durations_kv_stores_normal_pri":                   "admission.wait_durations.kv-stores.normal-pri",
	"admission_wait_durations_kv_stores_user_high_pri":                "admission.wait_durations.kv-stores.user-high-pri",
	"admission_wait_durations_snapshot_ingest":                        "admission.wait_durations.snapshot_ingest",
	"admission_wait_durations_sql_kv_response":                        "admission.wait_durations.sql-kv-response",
	"admission_wait_durations_sql_kv_response_locking_normal_pri":     "admission.wait_durations.sql-kv-response.locking-normal-pri",
	"admission_wait_durations_sql_kv_response_normal_pri":             "admission.wait_durations.sql-kv-response.normal-pri",
	"admission_wait_durations_sql_sql_response":                       "admission.wait_durations.sql-sql-response",
	"admission_wait_durations_sql_sql_response_locking_normal_pri":    "admission.wait_durations.sql-sql-response.locking-normal-pri",
	"admission_wait_durations_sql_sql_response_normal_pri":            "admission.wait_durations.sql-sql-response.normal-pri",
	"admission_wait_queue_length_elastic_cpu":                         "admission.wait_queue_length.elastic-cpu",
	"admission_wait_queue_length_elastic_cpu_bulk_normal_pri":         "admission.wait_queue_length.elastic-cpu.bulk-normal-pri",
	"admission_wait_queue_length_elastic_cpu_normal_pri":              "admission.wait_queue_length.elastic-cpu.normal-pri",
	"admission_wait_queue_length_elastic_stores":                      "admission.wait_queue_length.elastic-stores",
	"admission_wait_queue_length_elastic_stores_bulk_low_pri":         "admission.wait_queue_length.elastic-stores.bulk-low-pri",
	"admission_wait_queue_length_elastic_stores_bulk_normal_pri":      "admission.wait_queue_length.elastic-stores.bulk-normal-pri",
	"admission_wait_queue_length_kv":                                  "admission.wait_queue_length.kv",
	"admission_wait_queue_length_kv_high_pri":                         "admission.wait_queue_length.kv.high-pri",
	"admission_wait_queue_length_kv_locking_normal_pri":               "admission.wait_queue_length.kv.locking-normal-pri",
	"admission_wait_queue_length_kv_normal_pri":                       "admission.wait_queue_length.kv.normal-pri",
	"admission_wait_queue_length_kv_stores":                           "admission.wait_queue_length.kv-stores",
	"admission_wait_queue_length_kv_stores_high_pri":                  "admission.wait_queue_length.kv-stores.high-pri",
	"admission_wait_queue_length_kv_stores_locking_normal_pri":        "admission.wait_queue_length.kv-stores.locking-normal-pri",
	"admission_wait_queue_length_kv_stores_normal_pri":                "admission.wait_queue_length.kv-stores.normal-pri",
	"admission_wait_queue_length_kv_stores_user_high_pri":             "admission.wait_queue_length.kv-stores.user-high-pri",
	"admission_wait_queue_length_sql_kv_response":                     "admission.wait_queue_length.sql-kv-response",
	"admission_wait_queue_length_sql_kv_response_locking_normal_pri":  "admission.wait_queue_length.sql-kv-response.locking-normal-pri",
	"admission_wait_queue_length_sql_kv_response_normal_pri":          "admission.wait_queue_length.sql-kv-response.normal-pri",
	"admission_wait_queue_length_sql_sql_response":                    "admission.wait_queue_length.sql-sql-response",
	"admission_wait_queue_length_sql_sql_response_locking_normal_pri": "admission.wait_queue_length.sql-sql-response.locking-normal-pri",
	"admission_wait_queue_length_sql_sql_response_normal_pri":         "admission.wait_queue_length.sql-sql-response.normal-pri",
	...
	"auth_ldap_conn_latency_internal":                                 "auth.ldap.conn.latency.internal",
	"auth_password_conn_latency":                                      "auth.password.conn.latency",
	"auth_scram_conn_latency":                                         "auth.scram.conn.latency",
	"backup_last_failed_time_kms_inaccessible":                        "backup.last-failed-time.kms-inaccessible",
	...
	"changefeed_admit_latency":                                        "changefeed.admit_latency",
	"changefeed_aggregator_progress":                                  "changefeed.aggregator_progress",
	"changefeed_backfill_count":                                       "changefeed.backfill_count",
	"changefeed_backfill_pending_ranges":                              "changefeed.backfill_pending_ranges",
	...
	"changefeed_buffer_pushback_nanos":                                "changefeed.buffer_pushback_nanos",
	...
	"changefeed_bytes_messages_pushback_nanos":                        "changefeed.bytes.messages_pushback_nanos",
	"changefeed_checkpoint_create_nanos":                              "changefeed.checkpoint.create_nanos",
	"changefeed_checkpoint_hist_nanos":                                "changefeed.checkpoint_hist_nanos",
	...
	"changefeed_commit_latency":                                       "changefeed.commit_latency",
	"changefeed_emitted_batch_sizes":                                  "changefeed.emitted_batch_sizes",
	"changefeed_emitted_bytes":                                        "changefeed.emitted_bytes",
	"changefeed_emitted_messages":                                     "changefeed.emitted_messages",
	"changefeed_error_retries":                                        "changefeed.error_retries",
	"changefeed_failures":                                             "changefeed.failures",
	"changefeed_filtered_messages":                                    "changefeed.filtered_messages",
	"changefeed_flush_hist_nanos":                                     "changefeed.flush_hist_nanos",
	"changefeed_flush_messages_pushback_nanos":                        "changefeed.flush.messages_pushback_nanos",
	...
	"changefeed_internal_retry_message_count":                         "changefeed.internal_retry_message_count",
	...
	"changefeed_max_behind_nanos":                                     "changefeed.max_behind_nanos",
	"changefeed_message_size_hist":                                    "changefeed.message_size_hist",
	"changefeed_messages_messages_pushback_nanos":                     "changefeed.messages.messages_pushback_nanos",
	"changefeed_network_bytes_in":                                     "changefeed.network.bytes_in",
	"changefeed_network_bytes_out":                                    "changefeed.network.bytes_out",
	"changefeed_nprocs_consume_event_nanos":                           "changefeed.nprocs_consume_event_nanos",
	"changefeed_nprocs_flush_nanos":                                   "changefeed.nprocs_flush_nanos",
	"changefeed_nprocs_in_flight_count":                               "changefeed.nprocs_in_flight_count",
	...
	"changefeed_parallel_io_queue_nanos":                              "changefeed.parallel_io_queue_nanos",
	...
	"changefeed_queue_time_nanos":                                     "changefeed.queue_time_nanos",
	"changefeed_running":                                              "changefeed.running",
	"changefeed_schema_registry_registrations":                        "changefeed.schema_registry.registrations",
	"changefeed_schema_registry_retry_count":                          "changefeed.schema_registry.retry_count",
	"changefeed_schemafeed_table_history_scans":                       "changefeed.schemafeed.table_history_scans",
	"changefeed_schemafeed_table_metadata_nanos":                      "changefeed.schemafeed.table_metadata_nanos",
	"changefeed_sink_backpressure_nanos":                              "changefeed.sink_backpressure_nanos",
	"changefeed_sink_batch_hist_nanos":                                "changefeed.sink_batch_hist_nanos",
	...
	"clock_offset_medianabsdevnanos":                                  "clock-offset.medianabsdevnanos",
	"clock_offset_mediannanos":                                        "clock-offset.mediannanos",
	...
	"cluster_preserve_downgrade_option_last_updated":                  "cluster.preserve-downgrade-option.last-updated",
	...
	"distsender_batches":                                              "distsender.batches",
	...
	"distsender_rpc_sent":                                             "distsender.rpc.sent",
	...
	"gossip_callbacks_pending_duration":                               "gossip.callbacks.pending_duration",
	"gossip_callbacks_processed":                                      "gossip.callbacks.processed",
	"gossip_callbacks_processing_duration":                            "gossip.callbacks.processing_duration",
	...
	"jobs_auto_create_stats_currently_running":                        "jobs.auto_create_stats.currently_running",
	...
	"jobs_auto_create_stats_resume_failed":                            "jobs.auto_create_stats.resume_failed",
	...
	"jobs_changefeed_resume_retry_error":                              "jobs.changefeed.resume_retry_error",
	...
	"jobs_create_stats_currently_running":                             "jobs.create_stats.currently_running",
	...
	"jobs_row_level_ttl_currently_running":                            "jobs.row_level_ttl.currently_running",
	...
	"jobs_row_level_ttl_resume_completed":                             "jobs.row_level_ttl.resume_completed",
	"jobs_row_level_ttl_resume_failed":                                "jobs.row_level_ttl.resume_failed",
	"jobs_row_level_ttl_resume_retry_error":                           "jobs.row_level_ttl.resume_retry_error",
	"jobs_row_level_ttl_rows_deleted":                                 "jobs.row_level_ttl.rows_deleted",
	"jobs_row_level_ttl_rows_selected":                                "jobs.row_level_ttl.rows_selected",
	...
	"jobs_update_table_metadata_cache_currently_idle":                 "jobs.update_table_metadata_cache.currently_idle",
	"jobs_update_table_metadata_cache_currently_paused":               "jobs.update_table_metadata_cache.currently_paused",
	"jobs_update_table_metadata_cache_currently_running":              "jobs.update_table_metadata_cache.currently_running",
	"jobs_update_table_metadata_cache_expired_pts_records":            "jobs.update_table_metadata_cache.expired_pts_records",
	"jobs_update_table_metadata_cache_fail_or_cancel_completed":       "jobs.update_table_metadata_cache.fail_or_cancel_completed",
	"jobs_update_table_metadata_cache_fail_or_cancel_retry_error":     "jobs.update_table_metadata_cache.fail_or_cancel_retry_error",
	"jobs_update_table_metadata_cache_protected_age_sec":              "jobs.update_table_metadata_cache.protected_age_sec",
	"jobs_update_table_metadata_cache_protected_record_count":         "jobs.update_table_metadata_cache.protected_record_count",
	"jobs_update_table_metadata_cache_resume_completed":               "jobs.update_table_metadata_cache.resume_completed",
	"jobs_update_table_metadata_cache_resume_failed":                  "jobs.update_table_metadata_cache.resume_failed",
	"jobs_update_table_metadata_cache_resume_retry_error":             "jobs.update_table_metadata_cache.resume_retry_error",
	"keybytes": "keybytes",
	"keycount": "keycount",
	...
	"leases_preferences_less_preferred":              "leases.preferences.less-preferred",
	...
	"logical_replication_batch_hist_nanos":           "logical_replication.batch_hist_nanos",
	"logical_replication_catchup_ranges":             "logical_replication.catchup_ranges",
	"logical_replication_catchup_ranges_by_label":    "logical_replication.catchup_ranges_by_label",
	"logical_replication_checkpoint_events_ingested": "logical_replication.checkpoint_events_ingested",
	"logical_replication_commit_latency":             "logical_replication.commit_latency",
	"logical_replication_events_dlqed":               "logical_replication.events_dlqed",
	"logical_replication_events_dlqed_age":           "logical_replication.events_dlqed_age",
	"logical_replication_events_dlqed_by_label":      "logical_replication.events_dlqed_by_label",
	"logical_replication_events_dlqed_errtype":       "logical_replication.events_dlqed_errtype",
	"logical_replication_events_dlqed_space":         "logical_replication.events_dlqed_space",
	"logical_replication_events_ingested":            "logical_replication.events_ingested",
	"logical_replication_events_ingested_by_label":   "logical_replication.events_ingested_by_label",
	"logical_replication_events_initial_failure":     "logical_replication.events_initial_failure",
	"logical_replication_events_initial_success":     "logical_replication.events_initial_success",
	"logical_replication_events_retry_failure":       "logical_replication.events_retry_failure",
	"logical_replication_events_retry_success":       "logical_replication.events_retry_success",
	"logical_replication_kv_update_too_old":          "logical_replication.kv.update_too_old",
	"logical_replication_kv_value_refreshes":         "logical_replication.kv.value_refreshes",
	"logical_replication_logical_bytes":              "logical_replication.logical_bytes",
	"logical_replication_replan_count":               "logical_replication.replan_count",
	"logical_replication_replicated_time_by_label":   "logical_replication.replicated_time_by_label",
	"logical_replication_replicated_time_seconds":    "logical_replication.replicated_time_seconds",
	"logical_replication_retry_queue_bytes":          "logical_replication.retry_queue_bytes",
	"logical_replication_retry_queue_events":         "logical_replication.retry_queue_events",
	"logical_replication_scanning_ranges":            "logical_replication.scanning_ranges",
	"logical_replication_scanning_ranges_by_label":   "logical_replication.scanning_ranges_by_label",
	"node_id":                                                             "node-id",
	...
	"raft_commands_reproposed_new_lai":                                    "raft.commands.reproposed.new-lai",
	...
	"raft_transport_flow_token_dispatches_dropped":                        "raft.transport.flow-token-dispatches-dropped",
	"raft_transport_rcvd":                                                 "raft.transport.rcvd",
	"raft_transport_reverse_rcvd":                                         "raft.transport.reverse-rcvd",
	"raft_transport_reverse_sent":                                         "raft.transport.reverse-sent",
	"raft_transport_send_queue_bytes":                                     "raft.transport.send-queue-bytes",
	"raft_transport_send_queue_size":                                      "raft.transport.send-queue-size",
	"raft_transport_sends_dropped":                                        "raft.transport.sends-dropped",
	...
	"range_snapshots_cross_region_rcvd_bytes":                             "range.snapshots.cross-region.rcvd-bytes",
	"range_snapshots_cross_region_sent_bytes":                             "range.snapshots.cross-region.sent-bytes",
	"range_snapshots_cross_zone_rcvd_bytes":                               "range.snapshots.cross-zone.rcvd-bytes",
	"range_snapshots_cross_zone_sent_bytes":                               "range.snapshots.cross-zone.sent-bytes",
	"range_snapshots_delegate_failures":                                   "range.snapshots.delegate.failures",
	"range_snapshots_delegate_in_progress":                                "range.snapshots.delegate.in-progress",
	"range_snapshots_delegate_sent_bytes":                                 "range.snapshots.delegate.sent-bytes",
	"range_snapshots_delegate_successes":                                  "range.snapshots.delegate.successes",
	"range_snapshots_generated":                                           "range.snapshots.generated",
	"range_snapshots_rcvd_bytes":                                          "range.snapshots.rcvd-bytes",
	"range_snapshots_rebalancing_rcvd_bytes":                              "range.snapshots.rebalancing.rcvd-bytes",
	"range_snapshots_rebalancing_sent_bytes":                              "range.snapshots.rebalancing.sent-bytes",
	"range_snapshots_recovery_rcvd_bytes":                                 "range.snapshots.recovery.rcvd-bytes",
	"range_snapshots_recovery_sent_bytes":                                 "range.snapshots.recovery.sent-bytes",
	"range_snapshots_recv_failed":                                         "range.snapshots.recv-failed",
	"range_snapshots_recv_in_progress":                                    "range.snapshots.recv-in-progress",
	"range_snapshots_recv_queue":                                          "range.snapshots.recv-queue",
	"range_snapshots_recv_queue_bytes":                                    "range.snapshots.recv-queue-bytes",
	"range_snapshots_recv_total_in_progress":                              "range.snapshots.recv-total-in-progress",
	"range_snapshots_recv_unusable":                                       "range.snapshots.recv-unusable",
	"range_snapshots_send_in_progress":                                    "range.snapshots.send-in-progress",
	"range_snapshots_send_queue":                                          "range.snapshots.send-queue",
	"range_snapshots_send_queue_bytes":                                    "range.snapshots.send-queue-bytes",
	"range_snapshots_send_total_in_progress":                              "range.snapshots.send-total-in-progress",
	"range_snapshots_sent_bytes":                                          "range.snapshots.sent-bytes",
	"range_snapshots_unknown_rcvd_bytes":                                  "range.snapshots.unknown.rcvd-bytes",
	"range_snapshots_unknown_sent_bytes":                                  "range.snapshots.unknown.sent-bytes",
	"range_snapshots_upreplication_rcvd_bytes":                            "range.snapshots.upreplication.rcvd-bytes",
	"range_snapshots_upreplication_sent_bytes":                            "range.snapshots.upreplication.sent-bytes",
	"range_splits":                                                        "range.splits",
	...
	"replicas_leaders_not_leaseholders":                                   "replicas.leaders_not_leaseholders",
	...
	"rocksdb_bloom_filter_prefix_checked":                                 "rocksdb.bloom.filter.prefix.checked",
	"rocksdb_bloom_filter_prefix_useful":                                  "rocksdb.bloom.filter.prefix.useful",
	"rocksdb_compacted_bytes_read":                                        "rocksdb.compacted-bytes-read",
	"rocksdb_compacted_bytes_written":                                     "rocksdb.compacted-bytes-written",
	"rocksdb_compactions":                                                 "rocksdb.compactions",
	...
	"round_trip_default_class_latency":                                    "round-trip-default-class-latency",
	"round_trip_latency":                                                  "round-trip-latency",
	"round_trip_raft_class_latency":                                       "round-trip-raft-class-latency",
	"round_trip_rangefeed_class_latency":                                  "round-trip-rangefeed-class-latency",
	"round_trip_system_class_latency":                                     "round-trip-system-class-latency",
	...
	"schedules_BACKUP_last_completed_time_by_virtual_cluster":             "schedules.BACKUP.last-completed-time-by-virtual_cluster",
	...
	"schedules_scheduled_schema_telemetry_executor_failed":                "schedules.scheduled-schema-telemetry-executor.failed",
	"schedules_scheduled_schema_telemetry_executor_started":               "schedules.scheduled-schema-telemetry-executor.started",
	"schedules_scheduled_schema_telemetry_executor_succeeded":             "schedules.scheduled-schema-telemetry-executor.succeeded",
	"schedules_scheduled_sql_stats_compaction_executor_failed":            "schedules.scheduled-sql-stats-compaction-executor.failed",
	"schedules_scheduled_sql_stats_compaction_executor_started":           "schedules.scheduled-sql-stats-compaction-executor.started",
	"schedules_scheduled_sql_stats_compaction_executor_succeeded":         "schedules.scheduled-sql-stats-compaction-executor.succeeded",
	...
	"sql_copy_count_internal":                                             "sql.copy.count.internal",
	"sql_copy_nonatomic_count":                                            "sql.copy.nonatomic.count",
	"sql_copy_nonatomic_count_internal":                                   "sql.copy.nonatomic.count.internal",
	"sql_copy_nonatomic_started_count":                                    "sql.copy.nonatomic.started.count",
	"sql_copy_nonatomic_started_count_internal":                           "sql.copy.nonatomic.started.count.internal",
	"sql_copy_started_count":                                              "sql.copy.started.count",
	"sql_copy_started_count_internal":                                     "sql.copy.started.count.internal",
	"sql_crud_query_count":                                                "sql.crud_query.count",
	"sql_crud_query_count_internal":                                       "sql.crud_query.count.internal",
	"sql_crud_query_started_count":                                        "sql.crud_query.started.count",
	"sql_crud_query_started_count_internal":                               "sql.crud_query.started.count.internal",
	...
	"sql_distsql_contended_queries_count":                                 "sql.distsql.contended_queries.count",
	...
	"sql_guardrails_full_scan_rejected_count_internal":                    "sql.guardrails.full_scan_rejected.count.internal",
	"sql_guardrails_max_row_size_err_count":                               "sql.guardrails.max_row_size_err.count",
	"sql_guardrails_max_row_size_err_count_internal":                      "sql.guardrails.max_row_size_err.count.internal",
	"sql_guardrails_max_row_size_log_count":                               "sql.guardrails.max_row_size_log.count",
	"sql_guardrails_max_row_size_log_count_internal":                      "sql.guardrails.max_row_size_log.count.internal",
	"sql_guardrails_transaction_rows_read_err_count":                      "sql.guardrails.transaction_rows_read_err.count",
	"sql_guardrails_transaction_rows_read_err_count_internal":             "sql.guardrails.transaction_rows_read_err.count.internal",
	"sql_guardrails_transaction_rows_read_log_count":                      "sql.guardrails.transaction_rows_read_log.count",
	"sql_guardrails_transaction_rows_read_log_count_internal":             "sql.guardrails.transaction_rows_read_log.count.internal",
	"sql_guardrails_transaction_rows_written_err_count":                   "sql.guardrails.transaction_rows_written_err.count",
	"sql_guardrails_transaction_rows_written_err_count_internal":          "sql.guardrails.transaction_rows_written_err.count.internal",
	"sql_guardrails_transaction_rows_written_log_count":                   "sql.guardrails.transaction_rows_written_log.count",
	"sql_guardrails_transaction_rows_written_log_count_internal":          "sql.guardrails.transaction_rows_written_log.count.internal",
	...
	"sql_insert_count_internal":                                           "sql.insert.count.internal",
	"sql_insert_started_count":                                            "sql.insert.started.count",
	"sql_insert_started_count_internal":                                   "sql.insert.started.count.internal",
	...
	"sql_restart_savepoint_count_internal":                                "sql.restart_savepoint.count.internal",
	"sql_restart_savepoint_release_count":                                 "sql.restart_savepoint.release.count",
	"sql_restart_savepoint_release_count_internal":                        "sql.restart_savepoint.release.count.internal",
	"sql_restart_savepoint_release_started_count":                         "sql.restart_savepoint.release.started.count",
	"sql_restart_savepoint_release_started_count_internal":                "sql.restart_savepoint.release.started.count.internal",
	"sql_restart_savepoint_rollback_count":                                "sql.restart_savepoint.rollback.count",
	"sql_restart_savepoint_rollback_count_internal":                       "sql.restart_savepoint.rollback.count.internal",
	"sql_restart_savepoint_rollback_started_count":                        "sql.restart_savepoint.rollback.started.count",
	"sql_restart_savepoint_rollback_started_count_internal":               "sql.restart_savepoint.rollback.started.count.internal",
	"sql_restart_savepoint_started_count":                                 "sql.restart_savepoint.started.count",
	"sql_restart_savepoint_started_count_internal":                        "sql.restart_savepoint.started.count.internal",
	...
	"storage_batch_commit_commit_wait_duration":                           "storage.batch-commit.commit-wait.duration",
	"storage_batch_commit_count":                                          "storage.batch-commit.count",
	"storage_batch_commit_duration":                                       "storage.batch-commit.duration",
	"storage_batch_commit_l0_stall_duration":                              "storage.batch-commit.l0-stall.duration",
	"storage_batch_commit_mem_stall_duration":                             "storage.batch-commit.mem-stall.duration",
	"storage_batch_commit_sem_wait_duration":                              "storage.batch-commit.sem-wait.duration",
	"storage_batch_commit_wal_queue_wait_duration":                        "storage.batch-commit.wal-queue-wait.duration",
	"storage_batch_commit_wal_rotation_duration":                          "storage.batch-commit.wal-rotation.duration",
	"storage_block_load_active":                                           "storage.block-load.active",
	"storage_block_load_queued":                                           "storage.block-load.queued",
	...
	"storage_disk_read_max_bytespersecond":                                "storage.disk.read-max.bytespersecond",
	"storage_disk_read_max_iops":                                          "storage.disk.read-max.iops",
	...
	"storage_disk_write_max_bytespersecond":                               "storage.disk.write-max.bytespersecond",
	"storage_disk_write_max_iops":                                         "storage.disk.write-max.iops",
	...
	"storage_iterator_block_load_bytes":                                   "storage.iterator.block-load.bytes",
	"storage_iterator_block_load_cached_bytes":                            "storage.iterator.block-load.cached-bytes",
	"storage_iterator_block_load_read_duration":                           "storage.iterator.block-load.read-duration",
	"storage_iterator_category_backup_block_load_bytes":                   "storage.iterator.category-backup.block-load.bytes",
	"storage_iterator_category_backup_block_load_cached_bytes":            "storage.iterator.category-backup.block-load.cached-bytes",
	"storage_iterator_category_backup_block_load_latency_sum":             "storage.iterator.category-backup.block-load.latency-sum",
	"storage_iterator_category_batch_eval_block_load_bytes":               "storage.iterator.category-batch-eval.block-load.bytes",
	"storage_iterator_category_batch_eval_block_load_cached_bytes":        "storage.iterator.category-batch-eval.block-load.cached-bytes",
	"storage_iterator_category_batch_eval_block_load_latency_sum":         "storage.iterator.category-batch-eval.block-load.latency-sum",
	"storage_iterator_category_crdb_unknown_block_load_bytes":             "storage.iterator.category-crdb-unknown.block-load.bytes",
	"storage_iterator_category_crdb_unknown_block_load_cached_bytes":      "storage.iterator.category-crdb-unknown.block-load.cached-bytes",
	"storage_iterator_category_crdb_unknown_block_load_latency_sum":       "storage.iterator.category-crdb-unknown.block-load.latency-sum",
	"storage_iterator_category_intent_resolution_block_load_bytes":        "storage.iterator.category-intent-resolution.block-load.bytes",
	"storage_iterator_category_intent_resolution_block_load_cached_bytes": "storage.iterator.category-intent-resolution.block-load.cached-bytes",
	"storage_iterator_category_intent_resolution_block_load_latency_sum":  "storage.iterator.category-intent-resolution.block-load.latency-sum",
	"storage_iterator_category_mvcc_gc_block_load_bytes":                  "storage.iterator.category-mvcc-gc.block-load.bytes",
	"storage_iterator_category_mvcc_gc_block_load_cached_bytes":           "storage.iterator.category-mvcc-gc.block-load.cached-bytes",
	"storage_iterator_category_mvcc_gc_block_load_latency_sum":            "storage.iterator.category-mvcc-gc.block-load.latency-sum",
	"storage_iterator_category_pebble_compaction_block_load_bytes":        "storage.iterator.category-pebble-compaction.block-load.bytes",
	"storage_iterator_category_pebble_compaction_block_load_cached_bytes": "storage.iterator.category-pebble-compaction.block-load.cached-bytes",
	"storage_iterator_category_pebble_compaction_block_load_latency_sum":  "storage.iterator.category-pebble-compaction.block-load.latency-sum",
	"storage_iterator_category_pebble_get_block_load_bytes":               "storage.iterator.category-pebble-get.block-load.bytes",
	"storage_iterator_category_pebble_get_block_load_cached_bytes":        "storage.iterator.category-pebble-get.block-load.cached-bytes",
	"storage_iterator_category_pebble_get_block_load_latency_sum":         "storage.iterator.category-pebble-get.block-load.latency-sum",
	"storage_iterator_category_pebble_ingest_block_load_bytes":            "storage.iterator.category-pebble-ingest.block-load.bytes",
	"storage_iterator_category_pebble_ingest_block_load_cached_bytes":     "storage.iterator.category-pebble-ingest.block-load.cached-bytes",
	"storage_iterator_category_pebble_ingest_block_load_latency_sum":      "storage.iterator.category-pebble-ingest.block-load.latency-sum",
	"storage_iterator_category_range_snap_block_load_bytes":               "storage.iterator.category-range-snap.block-load.bytes",
	"storage_iterator_category_range_snap_block_load_cached_bytes":        "storage.iterator.category-range-snap.block-load.cached-bytes",
	"storage_iterator_category_range_snap_block_load_latency_sum":         "storage.iterator.category-range-snap.block-load.latency-sum",
	"storage_iterator_category_rangefeed_block_load_bytes":                "storage.iterator.category-rangefeed.block-load.bytes",
	"storage_iterator_category_rangefeed_block_load_cached_bytes":         "storage.iterator.category-rangefeed.block-load.cached-bytes",
	"storage_iterator_category_rangefeed_block_load_latency_sum":          "storage.iterator.category-rangefeed.block-load.latency-sum",
	"storage_iterator_category_replication_block_load_bytes":              "storage.iterator.category-replication.block-load.bytes",
	"storage_iterator_category_replication_block_load_cached_bytes":       "storage.iterator.category-replication.block-load.cached-bytes",
	"storage_iterator_category_replication_block_load_latency_sum":        "storage.iterator.category-replication.block-load.latency-sum",
	"storage_iterator_category_scan_background_block_load_bytes":          "storage.iterator.category-scan-background.block-load.bytes",
	"storage_iterator_category_scan_background_block_load_cached_bytes":   "storage.iterator.category-scan-background.block-load.cached-bytes",
	"storage_iterator_category_scan_background_block_load_latency_sum":    "storage.iterator.category-scan-background.block-load.latency-sum",
	"storage_iterator_category_scan_regular_block_load_bytes":             "storage.iterator.category-scan-regular.block-load.bytes",
	"storage_iterator_category_scan_regular_block_load_cached_bytes":      "storage.iterator.category-scan-regular.block-load.cached-bytes",
	"storage_iterator_category_scan_regular_block_load_latency_sum":       "storage.iterator.category-scan-regular.block-load.latency-sum",
	"storage_iterator_category_unknown_block_load_bytes":                  "storage.iterator.category-unknown.block-load.bytes",
	"storage_iterator_category_unknown_block_load_cached_bytes":           "storage.iterator.category-unknown.block-load.cached-bytes",
	"storage_iterator_category_unknown_block_load_latency_sum":            "storage.iterator.category-unknown.block-load.latency-sum",
	...
	"storage_keys_range_key_set_count":                                    "storage.keys.range-key-set.count",
	"storage_keys_tombstone_count":                                        "storage.keys.tombstone.count",
	"storage_l0_bytes_flushed":                                            "storage.l0-bytes-flushed",
	"storage_l0_bytes_ingested":                                           "storage.l0-bytes-ingested",
	"storage_l0_level_score":                                              "storage.l0-level-score",
	"storage_l0_level_size":                                               "storage.l0-level-size",
	"storage_l0_num_files":                                                "storage.l0-num-files",
	"storage_l0_sublevels":                                                "storage.l0-sublevels",
	"storage_l1_bytes_ingested":                                           "storage.l1-bytes-ingested",
	"storage_l1_level_score":                                              "storage.l1-level-score",
	"storage_l1_level_size":                                               "storage.l1-level-size",
	"storage_l2_bytes_ingested":                                           "storage.l2-bytes-ingested",
	"storage_l2_level_score":                                              "storage.l2-level-score",
	"storage_l2_level_size":                                               "storage.l2-level-size",
	"storage_l3_bytes_ingested":                                           "storage.l3-bytes-ingested",
	"storage_l3_level_score":                                              "storage.l3-level-score",
	"storage_l3_level_size":                                               "storage.l3-level-size",
	"storage_l4_bytes_ingested":                                           "storage.l4-bytes-ingested",
	"storage_l4_level_score":                                              "storage.l4-level-score",
	"storage_l4_level_size":                                               "storage.l4-level-size",
	"storage_l5_bytes_ingested":                                           "storage.l5-bytes-ingested",
	"storage_l5_level_score":                                              "storage.l5-level-score",
	"storage_l5_level_size":                                               "storage.l5-level-size",
	"storage_l6_bytes_ingested":                                           "storage.l6-bytes-ingested",
	"storage_l6_level_score":                                              "storage.l6-level-score",
	"storage_l6_level_size":                                               "storage.l6-level-size",
	...
	"storage_secondary_cache_count":                                       "storage.secondary-cache.count",
	"storage_secondary_cache_evictions":                                   "storage.secondary-cache.evictions",
	"storage_secondary_cache_reads_full_hit":                              "storage.secondary-cache.reads-full-hit",
	"storage_secondary_cache_reads_multi_block":                           "storage.secondary-cache.reads-multi-block",
	"storage_secondary_cache_reads_multi_shard":                           "storage.secondary-cache.reads-multi-shard",
	"storage_secondary_cache_reads_no_hit":                                "storage.secondary-cache.reads-no-hit",
	"storage_secondary_cache_reads_partial_hit":                           "storage.secondary-cache.reads-partial-hit",
	"storage_secondary_cache_reads_total":                                 "storage.secondary-cache.reads-total",
	"storage_secondary_cache_size":                                        "storage.secondary-cache.size",
	"storage_secondary_cache_write_back_failures":                         "storage.secondary-cache.write-back-failures",
	"storage_shared_storage_read":                                         "storage.shared-storage.read",
	"storage_shared_storage_write":                                        "storage.shared-storage.write",
	"storage_single_delete_ineffectual":                                   "storage.single-delete.ineffectual",
	"storage_single_delete_invariant_violation":                           "storage.single-delete.invariant-violation",
	...
	"storage_write_amplification":                                         "storage.write-amplification",
	"storage_write_stall_nanos":                                           "storage.write-stall-nanos",
	...
	"storeliveness_transport_receive_queue_bytes":                         "storeliveness.transport.receive-queue-bytes",
	"storeliveness_transport_receive_queue_size":                          "storeliveness.transport.receive-queue-size",
	...
	"storeliveness_transport_send_queue_bytes":                            "storeliveness.transport.send-queue-bytes",
	"storeliveness_transport_send_queue_idle":                             "storeliveness.transport.send-queue-idle",
	"storeliveness_transport_send_queue_size":                             "storeliveness.transport.send-queue-size",
	...
	"sys_cpu_host_combined_percent_normalized":                            "sys.cpu.host.combined.percent-normalized",
	...
	"txnwaitqueue_deadlocks_total":                                        "txnwaitqueue.deadlocks_total",
