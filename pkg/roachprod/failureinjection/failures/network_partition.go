...
func MakeIPTablesPartitionFailure(
	...
	return &IPTablesPartitionFailure{c: c}, nil
}
...
func (f *IPTablesPartitionFailure) run(
...
func (f *IPTablesPartitionFailure) runWithDetails(
	ctx context.Context, l *logger.Logger, node install.Nodes, args ...string,
...
func (f *IPTablesPartitionFailure) Cleanup(_ context.Context, _ *logger.Logger, _ FailureArgs) error {
	return nil
}
...
func (f *IPTablesPartitionFailure) PacketsDropped(
