...
type FixtureMetadata struct {
	...
	// fixture at the time it was marked ready.
	// It an stringified integer that is computed from XOR'ing the results of
	// `SHOW EXPERIMENTAL_FINGERPRINTS` on each table in the fixture.
