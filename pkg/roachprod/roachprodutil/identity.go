...
// IAPTokenSourceIface is an interface that defines the methods
// for the IAPTokenSource.
type IAPTokenSourceIface interface {
	Token() (*oauth2.Token, error)
	GetHTTPClient() *http.Client
}

// IAPTokenSource is a struct that holds the token source and HTTP client
// authenticated with the Identity-Aware Proxy.
// This struct satisfies the oauth2.TokenSource interface.
type IAPTokenSource struct {
...
func NewIAPTokenSource(opts IAPTokenSourceOptions) (*IAPTokenSource, error) {
