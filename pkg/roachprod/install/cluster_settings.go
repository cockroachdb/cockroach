...
// Option is the interface satisfied by options to MakeClusterSettings.
...
// CertsDirOption is used to pass certs dir for secure connections.
type CertsDirOption string

func (o CertsDirOption) apply(settings *ClusterSettings) {
	settings.CertsDir = string(o)
}
...
func MakeClusterSettings(opts ...Option) ClusterSettings {
