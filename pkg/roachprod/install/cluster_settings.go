...
// compute sets the Secure flag based on the ComplexSecureOption value
// on the SyncedCluster struct.
func (o ComplexSecureOption) compute(c *SyncedCluster) error {
...
// compute sets the Secure flag based on the SimpleSecureOption value
// on the SyncedCluster struct.
func (o SimpleSecureOption) compute(c *SyncedCluster) error {
	c.Secure = bool(o)
	return nil
}
