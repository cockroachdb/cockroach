...
func (t *attachedTags) toAttachTagOptions(resourceCRN string) *globaltaggingv1.AttachTagOptions {
	return &globaltaggingv1.AttachTagOptions{
...
func newInstanceFromCRN(provider *Provider, crn string, query bool) (*instance, error) {
	...
	// Fill in the ID from the CRN.
	zone, instanceID := i.extractCRN()
...
// extractCRN extracts the zone and instance ID from the CRN.
func (i *instance) extractCRN() (*string, *string) {
	...
	parts := strings.Split(*i.instance.CRN, ":")
...
func (i *instance) isRoachprodAndValidStatus() (bool, string) {
	if i.instance == nil || i.instance.Status == nil {
...
func (i *instance) load() error {
	...
	if i.instance.ID == nil || i.instance.Zone == nil {
		if i.instance.CRN == nil {
			...
			// If we have a CRN, we can extract the ID and zone from it.
			zone, instanceID := i.extractCRN()
			i.instance.Zone = &vpcv1.ZoneReference{
				Name: zone,
			}
...
func (i *instance) toVM() vm.VM {
	...
	return vm.VM{
		...
		BootVolume:             i.bootVolume.toVmVolume(),
