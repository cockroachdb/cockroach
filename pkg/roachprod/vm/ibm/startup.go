...
# TODO(golgeek): this is required due to a regression in the IBM cloud-init
# on Ubuntu 22.04 that causes the default user to be locked. This should be
# removed once the issue is fixed (case CS4275852 is open with IBM) and a new
# Ubuntu 22.04 image has been generated (revision > 4).
usermod --password "$(openssl rand -base64 12)" {{ .SharedUser }}
