...
func (p *Provider) runInstance(
	...
	filename, err := writeStartupScript(name, extraMountOpts, providerOpts.UseMultipleDisks, opts.Arch == vm.ArchFIPS)
	if err != nil {
	...
	if useArmAMI && (opts.Arch != "" && opts.Arch != vm.ArchARM64) {
