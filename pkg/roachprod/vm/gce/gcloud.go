...
func (p *Provider) Create(
	...
	filename, err := writeStartupScript(extraMountOpts, opts.SSDOpts.FileSystem, providerOpts.UseMultipleDisks, opts.Arch == string(vm.ArchFIPS), !shouldEnableRSA(opts.UbuntuVersion, opts.Arch))
	if err != nil {
...
// TODO: In the future, when all tests are run on Ubuntu 22.04, we can remove this check and default true.
func shouldEnableRSA(version vm.UbuntuVersion, arch string) bool {
