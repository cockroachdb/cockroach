...
func (o *ProviderOpts) ConfigureCreateFlags(flags *pflag.FlagSet) {
	flags.DurationVar(&vm.Providers[ProviderName].(*Provider).OperationTimeout, ProviderName+"-timeout", vm.Providers[ProviderName].(*Provider).OperationTimeout,
		"The maximum amount of time for an Azure API operation to take")
	flags.BoolVar(&vm.Providers[ProviderName].(*Provider).SyncDelete, ProviderName+"-sync-delete", vm.Providers[ProviderName].(*Provider).SyncDelete,
