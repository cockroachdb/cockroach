...
func (p *Provider) getRoleFromName(
	ctx context.Context, identity azcore.TokenCredential,
	subID string, roleName string,
...
func (p *Provider) maybeAssignRoachprodRoleToVM(
	l *logger.Logger, ctx context.Context,
	subID string, vm compute.VirtualMachine,
) error {
