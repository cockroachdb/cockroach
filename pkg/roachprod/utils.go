...
// ClusterOpts has the options used by newCluster().
...
// DefaultClusterOpts returns ClusterOpts with default values.
...
func newCluster(opts ClusterOpts) (*install.SyncedCluster, error) {
	nodeNames := "all"
	{
