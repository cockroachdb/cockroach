...
func TestInterleavedTableMigration(t *testing.T) {
   ...
   CONSTRAINT fk_customer FOREIGN KEY (customer) REFERENCES customers
	...
	tdb.ExpectErr(t, "pq: verifying precondition for version 21.1-128: interleaved tables are no longer supported at this version, please drop or uninterleave them.",
