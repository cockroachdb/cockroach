...
// Package truncatedstate contains a migration for the raft truncated state.
package truncatedstate
...
func truncatedStateMigration(
	...
	if err := h.ForEveryNode(ctx, op, func(ctx context.Context, client serverpb.MigrationClient) error {
