...
// can legally keep tenants at cluster version N (binary version N+1) while
...
//
// We could even entertain letting tenants trail multiple releases in the
// future at the expense of a smaller `MinSupportedVersion` and more time
// spent on legacy behavior during development.
