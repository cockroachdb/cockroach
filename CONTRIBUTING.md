...
- The `make build` command builds a binary covered by the CockroachDB 
Community License. To build a pure open-source (APL2) version instead, use 
`make buildoss`. See this 
[blog post](https://www.cockroachlabs.com/blog/how-were-building-a-business-to-last/) for more details. 
