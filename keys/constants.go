...
var (
	...
	TableDataMin = roachpb.Key(encoding.EncodeVarint(nil, math.MinInt64, encoding.Ascending))
	// TableDataMin is the end of the range of table data keys.
	TableDataMax = roachpb.Key(encoding.EncodeVarint(nil, math.MaxInt64, encoding.Ascending))
