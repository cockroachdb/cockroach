...
CockroachDV key/value datastore. It is used to serve basic metrics generated by
CockroachDB.
...
to meet these challenges; these solutions are built on top of specialized
...
Another common use csae of time series queries is the aggregation of multiple series;
