...
inline void InitDefaults() {
  InitDefaultsDataKeysRegistry_StoreKeysEntry_DoNotUse();
  InitDefaultsDataKeysRegistry_DataKeysEntry_DoNotUse();
  InitDefaultsDataKeysRegistry();
  InitDefaultsKeyInfo();
  InitDefaultsSecretKey();
  InitDefaultsEncryptionSettings();
}
}  // namespace protobuf_ccl_2fstorageccl_2fengineccl_2fenginepbccl_2fkey_5fregistry_2eproto
namespace cockroach {
namespace ccl {
...
class DataKeysRegistry : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:cockroach.ccl.storageccl.engineccl.enginepbccl.DataKeysRegistry) */ {
 ...
 private:
  ...
  friend void ::protobuf_ccl_2fstorageccl_2fengineccl_2fenginepbccl_2fkey_5fregistry_2eproto::InitDefaultsDataKeysRegistryImpl();
};
// -------------------------------------------------------------------
...
class KeyInfo : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:cockroach.ccl.storageccl.engineccl.enginepbccl.KeyInfo) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_ccl_2fstorageccl_2fengineccl_2fenginepbccl_2fkey_5fregistry_2eproto::TableStruct;
  friend void ::protobuf_ccl_2fstorageccl_2fengineccl_2fenginepbccl_2fkey_5fregistry_2eproto::InitDefaultsKeyInfoImpl();
};
// -------------------------------------------------------------------
...
class SecretKey : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:cockroach.ccl.storageccl.engineccl.enginepbccl.SecretKey) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_ccl_2fstorageccl_2fengineccl_2fenginepbccl_2fkey_5fregistry_2eproto::TableStruct;
  friend void ::protobuf_ccl_2fstorageccl_2fengineccl_2fenginepbccl_2fkey_5fregistry_2eproto::InitDefaultsSecretKeyImpl();
};
// -------------------------------------------------------------------
...
class EncryptionSettings : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:cockroach.ccl.storageccl.engineccl.enginepbccl.EncryptionSettings) */ {
 public:
  ...
  inline EncryptionSettings* New() const PROTOBUF_FINAL { return New(NULL); }

  EncryptionSettings* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from)
    PROTOBUF_FINAL;
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_ccl_2fstorageccl_2fengineccl_2fenginepbccl_2fkey_5fregistry_2eproto::TableStruct;
  friend void ::protobuf_ccl_2fstorageccl_2fengineccl_2fenginepbccl_2fkey_5fregistry_2eproto::InitDefaultsEncryptionSettingsImpl();
};
// ===================================================================
