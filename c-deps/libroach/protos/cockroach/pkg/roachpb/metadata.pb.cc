...
Version::Version(const Version& from)
  : ::google::protobuf::MessageLite(),
      ...
      _cached_size_(0) {
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::memcpy(&majorval_, &from.majorval_,
    reinterpret_cast<char*>(&unstable_) -
    reinterpret_cast<char*>(&majorval_) + sizeof(unstable_));
  // @@protoc_insertion_point(copy_constructor:cockroach.roachpb.Version)
}

void Version::SharedCtor() {
  _cached_size_ = 0;
  ::memset(&majorval_, 0, reinterpret_cast<char*>(&unstable_) -
    reinterpret_cast<char*>(&majorval_) + sizeof(unstable_));
}
...
void Version::SerializeWithCachedSizes(
  ...
  cached_has_bits = _has_bits_[0];
  if (cached_has_bits & 0x00000001u) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(1, this->majorval(), output);
  }

  if (cached_has_bits & 0x00000002u) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(2, this->minorval(), output);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:cockroach.roachpb.Version)
  ...
  if (cached_has_bits & 15u) {
    if (cached_has_bits & 0x00000001u) {
      majorval_ = from.majorval_;
    }
    if (cached_has_bits & 0x00000002u) {
      minorval_ = from.minorval_;
    }
    if (cached_has_bits & 0x00000004u) {
      patch_ = from.patch_;
    }
...
void Version::InternalSwap(Version* other) {
  std::swap(majorval_, other->majorval_);
  std::swap(minorval_, other->minorval_);
...
bool Version::has_majorval() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
void Version::set_has_majorval() {
  _has_bits_[0] |= 0x00000001u;
}
void Version::clear_has_majorval() {
  _has_bits_[0] &= ~0x00000001u;
}
void Version::clear_majorval() {
  majorval_ = 0;
  clear_has_majorval();
}
::google::protobuf::int32 Version::majorval() const {
  // @@protoc_insertion_point(field_get:cockroach.roachpb.Version.majorval)
  return majorval_;
}
void Version::set_majorval(::google::protobuf::int32 value) {
  set_has_majorval();
  majorval_ = value;
  // @@protoc_insertion_point(field_set:cockroach.roachpb.Version.majorval)
}

bool Version::has_minorval() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
void Version::set_has_minorval() {
  _has_bits_[0] |= 0x00000002u;
}
void Version::clear_has_minorval() {
  _has_bits_[0] &= ~0x00000002u;
}
void Version::clear_minorval() {
  minorval_ = 0;
  clear_has_minorval();
}
::google::protobuf::int32 Version::minorval() const {
  // @@protoc_insertion_point(field_get:cockroach.roachpb.Version.minorval)
  return minorval_;
}
void Version::set_minorval(::google::protobuf::int32 value) {
  set_has_minorval();
  minorval_ = value;
