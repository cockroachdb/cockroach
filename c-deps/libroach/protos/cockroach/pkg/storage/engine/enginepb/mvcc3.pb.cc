...
namespace protobuf_cockroach_2fpkg_2fstorage_2fengine_2fenginepb_2fmvcc3_2eproto {
...
TxnMeta::TxnMeta()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_cockroach_2fpkg_2fstorage_2fengine_2fenginepb_2fmvcc3_2eproto::InitDefaults();
  }
  SharedCtor();
