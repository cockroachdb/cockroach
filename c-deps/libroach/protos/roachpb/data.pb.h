...
// int32 command_count = 3;
inline void LeafTxnFinalState::clear_command_count() {
  command_count_ = 0;
}
inline ::google::protobuf::int32 LeafTxnFinalState::command_count() const {
  // @@protoc_insertion_point(field_get:cockroach.roachpb.LeafTxnFinalState.command_count)
  return command_count_;
}
inline void LeafTxnFinalState::set_command_count(::google::protobuf::int32 value) {
  
  command_count_ = value;
  // @@protoc_insertion_point(field_set:cockroach.roachpb.LeafTxnFinalState.command_count)
}
...
inline int LeafTxnFinalState::refresh_writes_size() const {
  return refresh_writes_.size();
}
inline void LeafTxnFinalState::clear_refresh_writes() {
  refresh_writes_.Clear();
}
inline ::cockroach::roachpb::Span* LeafTxnFinalState::mutable_refresh_writes(int index) {
  // @@protoc_insertion_point(field_mutable:cockroach.roachpb.LeafTxnFinalState.refresh_writes)
  return refresh_writes_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::cockroach::roachpb::Span >*
LeafTxnFinalState::mutable_refresh_writes() {
  // @@protoc_insertion_point(field_mutable_list:cockroach.roachpb.LeafTxnFinalState.refresh_writes)
  return &refresh_writes_;
}
inline const ::cockroach::roachpb::Span& LeafTxnFinalState::refresh_writes(int index) const {
  // @@protoc_insertion_point(field_get:cockroach.roachpb.LeafTxnFinalState.refresh_writes)
  return refresh_writes_.Get(index);
}
inline ::cockroach::roachpb::Span* LeafTxnFinalState::add_refresh_writes() {
  // @@protoc_insertion_point(field_add:cockroach.roachpb.LeafTxnFinalState.refresh_writes)
  return refresh_writes_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::cockroach::roachpb::Span >&
LeafTxnFinalState::refresh_writes() const {
  // @@protoc_insertion_point(field_list:cockroach.roachpb.LeafTxnFinalState.refresh_writes)
  return refresh_writes_;
}
