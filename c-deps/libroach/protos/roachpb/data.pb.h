...
// bool sticky_bit = 1;
inline void StickyBitTrigger::clear_sticky_bit() {
  sticky_bit_ = false;
}
inline bool StickyBitTrigger::sticky_bit() const {
  // @@protoc_insertion_point(field_get:cockroach.roachpb.StickyBitTrigger.sticky_bit)
  return sticky_bit_;
}
inline void StickyBitTrigger::set_sticky_bit(bool value) {
  
  sticky_bit_ = value;
  // @@protoc_insertion_point(field_set:cockroach.roachpb.StickyBitTrigger.sticky_bit)
}
