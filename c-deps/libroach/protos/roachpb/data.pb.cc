...
namespace protobuf_kv_2fstorage_2fengine_2fenginepb_2fmvcc3_2eproto {
extern PROTOBUF_INTERNAL_EXPORT_protobuf_kv_2fstorage_2fengine_2fenginepb_2fmvcc3_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_IgnoredSeqNumRange;
extern PROTOBUF_INTERNAL_EXPORT_protobuf_kv_2fstorage_2fengine_2fenginepb_2fmvcc3_2eproto ::google::protobuf::internal::SCCInfo<1> scc_info_TxnMeta;
}  // namespace protobuf_kv_2fstorage_2fengine_2fenginepb_2fmvcc3_2eproto
namespace protobuf_kv_2fstorage_2fengine_2fenginepb_2fmvcc_2eproto {
extern PROTOBUF_INTERNAL_EXPORT_protobuf_kv_2fstorage_2fengine_2fenginepb_2fmvcc_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_MVCCStats;
}  // namespace protobuf_kv_2fstorage_2fengine_2fenginepb_2fmvcc_2eproto
...
::google::protobuf::internal::SCCInfo<3> scc_info_MergeTrigger =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 3, InitDefaultsMergeTrigger}, {
      &protobuf_roachpb_2fmetadata_2eproto::scc_info_RangeDescriptor.base,
      &protobuf_kv_2fstorage_2fengine_2fenginepb_2fmvcc_2eproto::scc_info_MVCCStats.base,
      &protobuf_util_2fhlc_2ftimestamp_2eproto::scc_info_Timestamp.base,}};
...
::google::protobuf::internal::SCCInfo<6> scc_info_Transaction =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 6, InitDefaultsTransaction}, {
      &protobuf_kv_2fstorage_2fengine_2fenginepb_2fmvcc3_2eproto::scc_info_TxnMeta.base,
      &protobuf_util_2fhlc_2ftimestamp_2eproto::scc_info_Timestamp.base,
      ...
      &protobuf_kv_2fstorage_2fengine_2fenginepb_2fmvcc3_2eproto::scc_info_IgnoredSeqNumRange.base,}};
...
void MergeTrigger::InitAsDefaultInstance() {
  ...
  ::cockroach::roachpb::_MergeTrigger_default_instance_._instance.get_mutable()->right_desc_ = const_cast< ::cockroach::roachpb::RangeDescriptor*>(
      ::cockroach::roachpb::RangeDescriptor::internal_default_instance());
  ::cockroach::roachpb::_MergeTrigger_default_instance_._instance.get_mutable()->right_mvcc_stats_ = const_cast< ::cockroach::kv::storage::engine::enginepb::MVCCStats*>(
      ::cockroach::kv::storage::engine::enginepb::MVCCStats::internal_default_instance());
...
MergeTrigger::MergeTrigger(const MergeTrigger& from)
  ...
  if (from.has_right_mvcc_stats()) {
    right_mvcc_stats_ = new ::cockroach::kv::storage::engine::enginepb::MVCCStats(*from.right_mvcc_stats_);
  } else {
    right_mvcc_stats_ = NULL;
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:cockroach.roachpb.MergeTrigger)
  ...
  if (from.has_right_mvcc_stats()) {
    mutable_right_mvcc_stats()->::cockroach::kv::storage::engine::enginepb::MVCCStats::MergeFrom(from.right_mvcc_stats());
  }
  if (from.has_freeze_start()) {
...
void Transaction::InitAsDefaultInstance() {
  ::cockroach::roachpb::_Transaction_default_instance_._instance.get_mutable()->meta_ = const_cast< ::cockroach::kv::storage::engine::enginepb::TxnMeta*>(
      ::cockroach::kv::storage::engine::enginepb::TxnMeta::internal_default_instance());
...
Transaction::Transaction(const Transaction& from)
  ...
  if (from.has_meta()) {
    meta_ = new ::cockroach::kv::storage::engine::enginepb::TxnMeta(*from.meta_);
  } else {
    meta_ = NULL;
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:cockroach.roachpb.Transaction)
  ...
  if (from.has_meta()) {
    mutable_meta()->::cockroach::kv::storage::engine::enginepb::TxnMeta::MergeFrom(from.meta());
  }
  if (from.has_last_heartbeat()) {
...
void TransactionRecord::InitAsDefaultInstance() {
  ::cockroach::roachpb::_TransactionRecord_default_instance_._instance.get_mutable()->meta_ = const_cast< ::cockroach::kv::storage::engine::enginepb::TxnMeta*>(
      ::cockroach::kv::storage::engine::enginepb::TxnMeta::internal_default_instance());
...
void Intent::InitAsDefaultInstance() {
  ...
  ::cockroach::roachpb::_Intent_default_instance_._instance.get_mutable()->txn_ = const_cast< ::cockroach::kv::storage::engine::enginepb::TxnMeta*>(
      ::cockroach::kv::storage::engine::enginepb::TxnMeta::internal_default_instance());
}
...
Intent::Intent(const Intent& from)
  ...
  if (from.has_txn()) {
    txn_ = new ::cockroach::kv::storage::engine::enginepb::TxnMeta(*from.txn_);
  } else {
    txn_ = NULL;
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:cockroach.roachpb.Intent)
  ...
  if (from.has_txn()) {
    mutable_txn()->::cockroach::kv::storage::engine::enginepb::TxnMeta::MergeFrom(from.txn());
  }
}
...
void LockUpdate::InitAsDefaultInstance() {
  ::cockroach::roachpb::_LockUpdate_default_instance_._instance.get_mutable()->span_ = const_cast< ::cockroach::roachpb::Span*>(
      ::cockroach::roachpb::Span::internal_default_instance());
  ::cockroach::roachpb::_LockUpdate_default_instance_._instance.get_mutable()->txn_ = const_cast< ::cockroach::kv::storage::engine::enginepb::TxnMeta*>(
      ::cockroach::kv::storage::engine::enginepb::TxnMeta::internal_default_instance());
}
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      // .cockroach.kv.storage.concurrency.lock.Durability durability = 5;
      case 5: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   int, ::google::protobuf::internal::WireFormatLite::TYPE_ENUM>(
                 input, &value)));
          set_durability(static_cast< ::cockroach::kv::storage::concurrency::lock::Durability >(value));
        } else {
          goto handle_unusual;
        }
        break;
