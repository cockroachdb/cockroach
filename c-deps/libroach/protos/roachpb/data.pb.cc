...
::google::protobuf::internal::SCCInfo<2> scc_info_TxnCoordMeta =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 2, InitDefaultsTxnCoordMeta}, {
