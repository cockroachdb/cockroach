...
#ifndef PROTOBUF_INCLUDED_util_2ftracing_2ftracingpb_2frecorded_5fspan_2eproto
#define PROTOBUF_INCLUDED_util_2ftracing_2ftracingpb_2frecorded_5fspan_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_util_2ftracing_2ftracingpb_2frecorded_5fspan_2eproto 
...
namespace google {
namespace protobuf {
template<> ::cockroach::util::tracing::tracingpb::LogRecord* Arena::CreateMaybeMessage<::cockroach::util::tracing::tracingpb::LogRecord>(Arena*);
template<> ::cockroach::util::tracing::tracingpb::LogRecord_Field* Arena::CreateMaybeMessage<::cockroach::util::tracing::tracingpb::LogRecord_Field>(Arena*);
template<> ::cockroach::util::tracing::tracingpb::NormalizedSpan* Arena::CreateMaybeMessage<::cockroach::util::tracing::tracingpb::NormalizedSpan>(Arena*);
template<> ::cockroach::util::tracing::tracingpb::NormalizedSpan_TagsEntry_DoNotUse* Arena::CreateMaybeMessage<::cockroach::util::tracing::tracingpb::NormalizedSpan_TagsEntry_DoNotUse>(Arena*);
template<> ::cockroach::util::tracing::tracingpb::RecordedSpan* Arena::CreateMaybeMessage<::cockroach::util::tracing::tracingpb::RecordedSpan>(Arena*);
template<> ::cockroach::util::tracing::tracingpb::RecordedSpan_BaggageEntry_DoNotUse* Arena::CreateMaybeMessage<::cockroach::util::tracing::tracingpb::RecordedSpan_BaggageEntry_DoNotUse>(Arena*);
template<> ::cockroach::util::tracing::tracingpb::RecordedSpan_TagsEntry_DoNotUse* Arena::CreateMaybeMessage<::cockroach::util::tracing::tracingpb::RecordedSpan_TagsEntry_DoNotUse>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace cockroach {
namespace util {
...
class LogRecord_Field : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:cockroach.util.tracing.tracingpb.LogRecord.Field) */ {
 public:
  LogRecord_Field();
  ...
  // @@protoc_insertion_point(class_scope:cockroach.util.tracing.tracingpb.LogRecord.Field)
 private:
  ...
  friend struct ::protobuf_util_2ftracing_2ftracingpb_2frecorded_5fspan_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class LogRecord : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:cockroach.util.tracing.tracingpb.LogRecord) */ {
 public:
  LogRecord();
  virtual ~LogRecord();
  ...
  ::cockroach::util::tracing::tracingpb::LogRecord_Field* mutable_fields(int index);
  ::google::protobuf::RepeatedPtrField< ::cockroach::util::tracing::tracingpb::LogRecord_Field >*
      mutable_fields();
  const ::cockroach::util::tracing::tracingpb::LogRecord_Field& fields(int index) const;
  ::cockroach::util::tracing::tracingpb::LogRecord_Field* add_fields();
  const ::google::protobuf::RepeatedPtrField< ::cockroach::util::tracing::tracingpb::LogRecord_Field >&
      fields() const;
  ...
  // @@protoc_insertion_point(class_scope:cockroach.util.tracing.tracingpb.LogRecord)
 private:

  ::google::protobuf::internal::InternalMetadataWithArenaLite _internal_metadata_;
  ::google::protobuf::RepeatedPtrField< ::cockroach::util::tracing::tracingpb::LogRecord_Field > fields_;
...
class RecordedSpan : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:cockroach.util.tracing.tracingpb.RecordedSpan) */ {
 public:
  RecordedSpan();
  ...
  ::cockroach::util::tracing::tracingpb::LogRecord* mutable_logs(int index);
  ::google::protobuf::RepeatedPtrField< ::cockroach::util::tracing::tracingpb::LogRecord >*
      mutable_logs();
  const ::cockroach::util::tracing::tracingpb::LogRecord& logs(int index) const;
  ::cockroach::util::tracing::tracingpb::LogRecord* add_logs();
  const ::google::protobuf::RepeatedPtrField< ::cockroach::util::tracing::tracingpb::LogRecord >&
      logs() const;
  ...
  // @@protoc_insertion_point(class_scope:cockroach.util.tracing.tracingpb.RecordedSpan)
 private:
  ...
  ::google::protobuf::internal::MapFieldLite<
      ...
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      0 > tags_;
  ::google::protobuf::RepeatedPtrField< ::cockroach::util::tracing::tracingpb::LogRecord > logs_;
...
class NormalizedSpan : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:cockroach.util.tracing.tracingpb.NormalizedSpan) */ {
 public:
  NormalizedSpan();
  ...
  ::cockroach::util::tracing::tracingpb::NormalizedSpan* mutable_children(int index);
  ::google::protobuf::RepeatedPtrField< ::cockroach::util::tracing::tracingpb::NormalizedSpan >*
      mutable_children();
  const ::cockroach::util::tracing::tracingpb::NormalizedSpan& children(int index) const;
  ::cockroach::util::tracing::tracingpb::NormalizedSpan* add_children();
  const ::google::protobuf::RepeatedPtrField< ::cockroach::util::tracing::tracingpb::NormalizedSpan >&
      children() const;
  ...
  // @@protoc_insertion_point(class_scope:cockroach.util.tracing.tracingpb.NormalizedSpan)
 private:
  ...
  ::google::protobuf::internal::MapFieldLite<
      ...
      0 > tags_;
  ::google::protobuf::RepeatedPtrField< ::cockroach::util::tracing::tracingpb::LogRecord > logs_;
  ::google::protobuf::RepeatedPtrField< ::cockroach::util::tracing::tracingpb::NormalizedSpan > children_;
  ::google::protobuf::internal::ArenaStringPtr operation_;
  ::google::protobuf::Timestamp* start_time_;
  ::google::protobuf::Duration* duration_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
...
inline const ::std::string& LogRecord_Field::key() const {
  // @@protoc_insertion_point(field_get:cockroach.util.tracing.tracingpb.LogRecord.Field.key)
  return key_.GetNoArena();
}
inline void LogRecord_Field::set_key(const ::std::string& value) {
  
  key_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:cockroach.util.tracing.tracingpb.LogRecord.Field.key)
}
#if LANG_CXX11
inline void LogRecord_Field::set_key(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:cockroach.util.tracing.tracingpb.LogRecord.Field.key)
}
#endif
inline void LogRecord_Field::set_key(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:cockroach.util.tracing.tracingpb.LogRecord.Field.key)
}
inline void LogRecord_Field::set_key(const char* value, size_t size) {
  
  key_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:cockroach.util.tracing.tracingpb.LogRecord.Field.key)
}
inline ::std::string* LogRecord_Field::mutable_key() {
  
  // @@protoc_insertion_point(field_mutable:cockroach.util.tracing.tracingpb.LogRecord.Field.key)
  return key_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* LogRecord_Field::release_key() {
  // @@protoc_insertion_point(field_release:cockroach.util.tracing.tracingpb.LogRecord.Field.key)
...
inline void LogRecord_Field::set_allocated_key(::std::string* key) {
  ...
  // @@protoc_insertion_point(field_set_allocated:cockroach.util.tracing.tracingpb.LogRecord.Field.key)
}
...
inline const ::std::string& LogRecord_Field::value() const {
  // @@protoc_insertion_point(field_get:cockroach.util.tracing.tracingpb.LogRecord.Field.value)
  return value_.GetNoArena();
}
inline void LogRecord_Field::set_value(const ::std::string& value) {
  
  value_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:cockroach.util.tracing.tracingpb.LogRecord.Field.value)
}
#if LANG_CXX11
inline void LogRecord_Field::set_value(::std::string&& value) {
  ...
  value_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:cockroach.util.tracing.tracingpb.LogRecord.Field.value)
}
#endif
inline void LogRecord_Field::set_value(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:cockroach.util.tracing.tracingpb.LogRecord.Field.value)
}
inline void LogRecord_Field::set_value(const char* value, size_t size) {
  
  value_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:cockroach.util.tracing.tracingpb.LogRecord.Field.value)
}
inline ::std::string* LogRecord_Field::mutable_value() {
  
  // @@protoc_insertion_point(field_mutable:cockroach.util.tracing.tracingpb.LogRecord.Field.value)
  return value_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* LogRecord_Field::release_value() {
  // @@protoc_insertion_point(field_release:cockroach.util.tracing.tracingpb.LogRecord.Field.value)
...
inline void LogRecord_Field::set_allocated_value(::std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:cockroach.util.tracing.tracingpb.LogRecord.Field.value)
}
...
inline const ::google::protobuf::Timestamp& LogRecord::time() const {
  ...
  // @@protoc_insertion_point(field_get:cockroach.util.tracing.tracingpb.LogRecord.time)
  return p != NULL ? *p : *reinterpret_cast<const ::google::protobuf::Timestamp*>(
      &::google::protobuf::_Timestamp_default_instance_);
}
inline ::google::protobuf::Timestamp* LogRecord::release_time() {
  // @@protoc_insertion_point(field_release:cockroach.util.tracing.tracingpb.LogRecord.time)
...
inline ::google::protobuf::Timestamp* LogRecord::mutable_time() {
  ...
  // @@protoc_insertion_point(field_mutable:cockroach.util.tracing.tracingpb.LogRecord.time)
  return time_;
}
inline void LogRecord::set_allocated_time(::google::protobuf::Timestamp* time) {
  ...
  time_ = time;
  // @@protoc_insertion_point(field_set_allocated:cockroach.util.tracing.tracingpb.LogRecord.time)
}
...
inline ::cockroach::util::tracing::tracingpb::LogRecord_Field* LogRecord::mutable_fields(int index) {
  // @@protoc_insertion_point(field_mutable:cockroach.util.tracing.tracingpb.LogRecord.fields)
  return fields_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::cockroach::util::tracing::tracingpb::LogRecord_Field >*
LogRecord::mutable_fields() {
  // @@protoc_insertion_point(field_mutable_list:cockroach.util.tracing.tracingpb.LogRecord.fields)
  return &fields_;
}
inline const ::cockroach::util::tracing::tracingpb::LogRecord_Field& LogRecord::fields(int index) const {
  // @@protoc_insertion_point(field_get:cockroach.util.tracing.tracingpb.LogRecord.fields)
  return fields_.Get(index);
}
inline ::cockroach::util::tracing::tracingpb::LogRecord_Field* LogRecord::add_fields() {
  // @@protoc_insertion_point(field_add:cockroach.util.tracing.tracingpb.LogRecord.fields)
  return fields_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::cockroach::util::tracing::tracingpb::LogRecord_Field >&
LogRecord::fields() const {
  // @@protoc_insertion_point(field_list:cockroach.util.tracing.tracingpb.LogRecord.fields)
  return fields_;
}
...
inline ::google::protobuf::uint64 RecordedSpan::trace_id() const {
  // @@protoc_insertion_point(field_get:cockroach.util.tracing.tracingpb.RecordedSpan.trace_id)
  return trace_id_;
}
inline void RecordedSpan::set_trace_id(::google::protobuf::uint64 value) {
  
  trace_id_ = value;
  // @@protoc_insertion_point(field_set:cockroach.util.tracing.tracingpb.RecordedSpan.trace_id)
}
...
inline ::google::protobuf::uint64 RecordedSpan::span_id() const {
  // @@protoc_insertion_point(field_get:cockroach.util.tracing.tracingpb.RecordedSpan.span_id)
  return span_id_;
}
inline void RecordedSpan::set_span_id(::google::protobuf::uint64 value) {
  
  span_id_ = value;
  // @@protoc_insertion_point(field_set:cockroach.util.tracing.tracingpb.RecordedSpan.span_id)
}
...
inline ::google::protobuf::uint64 RecordedSpan::parent_span_id() const {
  // @@protoc_insertion_point(field_get:cockroach.util.tracing.tracingpb.RecordedSpan.parent_span_id)
  return parent_span_id_;
}
inline void RecordedSpan::set_parent_span_id(::google::protobuf::uint64 value) {
  
  parent_span_id_ = value;
  // @@protoc_insertion_point(field_set:cockroach.util.tracing.tracingpb.RecordedSpan.parent_span_id)
}
...
inline const ::std::string& RecordedSpan::operation() const {
  // @@protoc_insertion_point(field_get:cockroach.util.tracing.tracingpb.RecordedSpan.operation)
...
inline void RecordedSpan::set_operation(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:cockroach.util.tracing.tracingpb.RecordedSpan.operation)
}
#if LANG_CXX11
inline void RecordedSpan::set_operation(::std::string&& value) {
  ...
  operation_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:cockroach.util.tracing.tracingpb.RecordedSpan.operation)
}
#endif
inline void RecordedSpan::set_operation(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:cockroach.util.tracing.tracingpb.RecordedSpan.operation)
}
inline void RecordedSpan::set_operation(const char* value, size_t size) {
  ...
  operation_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:cockroach.util.tracing.tracingpb.RecordedSpan.operation)
}
inline ::std::string* RecordedSpan::mutable_operation() {
  
  // @@protoc_insertion_point(field_mutable:cockroach.util.tracing.tracingpb.RecordedSpan.operation)
...
inline ::std::string* RecordedSpan::release_operation() {
  // @@protoc_insertion_point(field_release:cockroach.util.tracing.tracingpb.RecordedSpan.operation)
...
inline void RecordedSpan::set_allocated_operation(::std::string* operation) {
  ...
  // @@protoc_insertion_point(field_set_allocated:cockroach.util.tracing.tracingpb.RecordedSpan.operation)
}
...
RecordedSpan::baggage() const {
  // @@protoc_insertion_point(field_map:cockroach.util.tracing.tracingpb.RecordedSpan.baggage)
  return baggage_.GetMap();
}
inline ::google::protobuf::Map< ::std::string, ::std::string >*
RecordedSpan::mutable_baggage() {
  // @@protoc_insertion_point(field_mutable_map:cockroach.util.tracing.tracingpb.RecordedSpan.baggage)
...
RecordedSpan::tags() const {
  // @@protoc_insertion_point(field_map:cockroach.util.tracing.tracingpb.RecordedSpan.tags)
  return tags_.GetMap();
}
inline ::google::protobuf::Map< ::std::string, ::std::string >*
RecordedSpan::mutable_tags() {
  // @@protoc_insertion_point(field_mutable_map:cockroach.util.tracing.tracingpb.RecordedSpan.tags)
...
inline const ::google::protobuf::Timestamp& RecordedSpan::start_time() const {
  ...
  // @@protoc_insertion_point(field_get:cockroach.util.tracing.tracingpb.RecordedSpan.start_time)
  return p != NULL ? *p : *reinterpret_cast<const ::google::protobuf::Timestamp*>(
      &::google::protobuf::_Timestamp_default_instance_);
}
inline ::google::protobuf::Timestamp* RecordedSpan::release_start_time() {
  // @@protoc_insertion_point(field_release:cockroach.util.tracing.tracingpb.RecordedSpan.start_time)
...
inline ::google::protobuf::Timestamp* RecordedSpan::mutable_start_time() {
  ...
  // @@protoc_insertion_point(field_mutable:cockroach.util.tracing.tracingpb.RecordedSpan.start_time)
  return start_time_;
}
inline void RecordedSpan::set_allocated_start_time(::google::protobuf::Timestamp* start_time) {
  ...
  // @@protoc_insertion_point(field_set_allocated:cockroach.util.tracing.tracingpb.RecordedSpan.start_time)
}
...
inline const ::google::protobuf::Duration& RecordedSpan::duration() const {
  ...
  // @@protoc_insertion_point(field_get:cockroach.util.tracing.tracingpb.RecordedSpan.duration)
  return p != NULL ? *p : *reinterpret_cast<const ::google::protobuf::Duration*>(
      &::google::protobuf::_Duration_default_instance_);
}
inline ::google::protobuf::Duration* RecordedSpan::release_duration() {
  // @@protoc_insertion_point(field_release:cockroach.util.tracing.tracingpb.RecordedSpan.duration)
...
inline ::google::protobuf::Duration* RecordedSpan::mutable_duration() {
  ...
  // @@protoc_insertion_point(field_mutable:cockroach.util.tracing.tracingpb.RecordedSpan.duration)
  return duration_;
}
inline void RecordedSpan::set_allocated_duration(::google::protobuf::Duration* duration) {
  ...
  duration_ = duration;
  // @@protoc_insertion_point(field_set_allocated:cockroach.util.tracing.tracingpb.RecordedSpan.duration)
}
...
inline ::cockroach::util::tracing::tracingpb::LogRecord* RecordedSpan::mutable_logs(int index) {
  // @@protoc_insertion_point(field_mutable:cockroach.util.tracing.tracingpb.RecordedSpan.logs)
  return logs_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::cockroach::util::tracing::tracingpb::LogRecord >*
RecordedSpan::mutable_logs() {
  // @@protoc_insertion_point(field_mutable_list:cockroach.util.tracing.tracingpb.RecordedSpan.logs)
  return &logs_;
}
inline const ::cockroach::util::tracing::tracingpb::LogRecord& RecordedSpan::logs(int index) const {
  // @@protoc_insertion_point(field_get:cockroach.util.tracing.tracingpb.RecordedSpan.logs)
  return logs_.Get(index);
}
inline ::cockroach::util::tracing::tracingpb::LogRecord* RecordedSpan::add_logs() {
  // @@protoc_insertion_point(field_add:cockroach.util.tracing.tracingpb.RecordedSpan.logs)
  return logs_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::cockroach::util::tracing::tracingpb::LogRecord >&
RecordedSpan::logs() const {
  // @@protoc_insertion_point(field_list:cockroach.util.tracing.tracingpb.RecordedSpan.logs)
  return logs_;
}
...
inline const ::google::protobuf::Any& RecordedSpan::stats() const {
  ...
  // @@protoc_insertion_point(field_get:cockroach.util.tracing.tracingpb.RecordedSpan.stats)
  return p != NULL ? *p : *reinterpret_cast<const ::google::protobuf::Any*>(
      &::google::protobuf::_Any_default_instance_);
}
inline ::google::protobuf::Any* RecordedSpan::release_stats() {
  // @@protoc_insertion_point(field_release:cockroach.util.tracing.tracingpb.RecordedSpan.stats)
...
inline ::google::protobuf::Any* RecordedSpan::mutable_stats() {
  ...
  // @@protoc_insertion_point(field_mutable:cockroach.util.tracing.tracingpb.RecordedSpan.stats)
  return stats_;
}
inline void RecordedSpan::set_allocated_stats(::google::protobuf::Any* stats) {
  ...
  stats_ = stats;
  // @@protoc_insertion_point(field_set_allocated:cockroach.util.tracing.tracingpb.RecordedSpan.stats)
}
...
inline const ::std::string& NormalizedSpan::operation() const {
  // @@protoc_insertion_point(field_get:cockroach.util.tracing.tracingpb.NormalizedSpan.operation)
  return operation_.GetNoArena();
}
inline void NormalizedSpan::set_operation(const ::std::string& value) {
  
  operation_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:cockroach.util.tracing.tracingpb.NormalizedSpan.operation)
}
#if LANG_CXX11
inline void NormalizedSpan::set_operation(::std::string&& value) {
  ...
  operation_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:cockroach.util.tracing.tracingpb.NormalizedSpan.operation)
}
#endif
inline void NormalizedSpan::set_operation(const char* value) {
  ...
  operation_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:cockroach.util.tracing.tracingpb.NormalizedSpan.operation)
}
inline void NormalizedSpan::set_operation(const char* value, size_t size) {
  
  operation_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:cockroach.util.tracing.tracingpb.NormalizedSpan.operation)
}
inline ::std::string* NormalizedSpan::mutable_operation() {
  
  // @@protoc_insertion_point(field_mutable:cockroach.util.tracing.tracingpb.NormalizedSpan.operation)
  return operation_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* NormalizedSpan::release_operation() {
  // @@protoc_insertion_point(field_release:cockroach.util.tracing.tracingpb.NormalizedSpan.operation)
...
inline void NormalizedSpan::set_allocated_operation(::std::string* operation) {
  ...
  operation_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), operation);
  // @@protoc_insertion_point(field_set_allocated:cockroach.util.tracing.tracingpb.NormalizedSpan.operation)
}
...
NormalizedSpan::tags() const {
  // @@protoc_insertion_point(field_map:cockroach.util.tracing.tracingpb.NormalizedSpan.tags)
  return tags_.GetMap();
}
inline ::google::protobuf::Map< ::std::string, ::std::string >*
NormalizedSpan::mutable_tags() {
  // @@protoc_insertion_point(field_mutable_map:cockroach.util.tracing.tracingpb.NormalizedSpan.tags)
  return tags_.MutableMap();
}
...
inline const ::google::protobuf::Timestamp& NormalizedSpan::start_time() const {
  const ::google::protobuf::Timestamp* p = start_time_;
  // @@protoc_insertion_point(field_get:cockroach.util.tracing.tracingpb.NormalizedSpan.start_time)
  return p != NULL ? *p : *reinterpret_cast<const ::google::protobuf::Timestamp*>(
      &::google::protobuf::_Timestamp_default_instance_);
}
inline ::google::protobuf::Timestamp* NormalizedSpan::release_start_time() {
  // @@protoc_insertion_point(field_release:cockroach.util.tracing.tracingpb.NormalizedSpan.start_time)
...
inline ::google::protobuf::Timestamp* NormalizedSpan::mutable_start_time() {
  ...
  // @@protoc_insertion_point(field_mutable:cockroach.util.tracing.tracingpb.NormalizedSpan.start_time)
  return start_time_;
}
inline void NormalizedSpan::set_allocated_start_time(::google::protobuf::Timestamp* start_time) {
  ...
  start_time_ = start_time;
  // @@protoc_insertion_point(field_set_allocated:cockroach.util.tracing.tracingpb.NormalizedSpan.start_time)
}
...
inline const ::google::protobuf::Duration& NormalizedSpan::duration() const {
  const ::google::protobuf::Duration* p = duration_;
  // @@protoc_insertion_point(field_get:cockroach.util.tracing.tracingpb.NormalizedSpan.duration)
  return p != NULL ? *p : *reinterpret_cast<const ::google::protobuf::Duration*>(
      &::google::protobuf::_Duration_default_instance_);
}
inline ::google::protobuf::Duration* NormalizedSpan::release_duration() {
  // @@protoc_insertion_point(field_release:cockroach.util.tracing.tracingpb.NormalizedSpan.duration)
...
inline ::google::protobuf::Duration* NormalizedSpan::mutable_duration() {
  ...
  // @@protoc_insertion_point(field_mutable:cockroach.util.tracing.tracingpb.NormalizedSpan.duration)
  return duration_;
}
inline void NormalizedSpan::set_allocated_duration(::google::protobuf::Duration* duration) {
  ...
  duration_ = duration;
  // @@protoc_insertion_point(field_set_allocated:cockroach.util.tracing.tracingpb.NormalizedSpan.duration)
}
...
inline ::cockroach::util::tracing::tracingpb::LogRecord* NormalizedSpan::mutable_logs(int index) {
  // @@protoc_insertion_point(field_mutable:cockroach.util.tracing.tracingpb.NormalizedSpan.logs)
  return logs_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::cockroach::util::tracing::tracingpb::LogRecord >*
NormalizedSpan::mutable_logs() {
  // @@protoc_insertion_point(field_mutable_list:cockroach.util.tracing.tracingpb.NormalizedSpan.logs)
  return &logs_;
}
inline const ::cockroach::util::tracing::tracingpb::LogRecord& NormalizedSpan::logs(int index) const {
  // @@protoc_insertion_point(field_get:cockroach.util.tracing.tracingpb.NormalizedSpan.logs)
  return logs_.Get(index);
}
inline ::cockroach::util::tracing::tracingpb::LogRecord* NormalizedSpan::add_logs() {
  // @@protoc_insertion_point(field_add:cockroach.util.tracing.tracingpb.NormalizedSpan.logs)
  return logs_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::cockroach::util::tracing::tracingpb::LogRecord >&
NormalizedSpan::logs() const {
  // @@protoc_insertion_point(field_list:cockroach.util.tracing.tracingpb.NormalizedSpan.logs)
  return logs_;
}
...
inline ::cockroach::util::tracing::tracingpb::NormalizedSpan* NormalizedSpan::mutable_children(int index) {
  // @@protoc_insertion_point(field_mutable:cockroach.util.tracing.tracingpb.NormalizedSpan.children)
  return children_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::cockroach::util::tracing::tracingpb::NormalizedSpan >*
NormalizedSpan::mutable_children() {
  // @@protoc_insertion_point(field_mutable_list:cockroach.util.tracing.tracingpb.NormalizedSpan.children)
  return &children_;
}
inline const ::cockroach::util::tracing::tracingpb::NormalizedSpan& NormalizedSpan::children(int index) const {
  // @@protoc_insertion_point(field_get:cockroach.util.tracing.tracingpb.NormalizedSpan.children)
  return children_.Get(index);
}
inline ::cockroach::util::tracing::tracingpb::NormalizedSpan* NormalizedSpan::add_children() {
  // @@protoc_insertion_point(field_add:cockroach.util.tracing.tracingpb.NormalizedSpan.children)
  return children_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::cockroach::util::tracing::tracingpb::NormalizedSpan >&
NormalizedSpan::children() const {
  // @@protoc_insertion_point(field_list:cockroach.util.tracing.tracingpb.NormalizedSpan.children)
  return children_;
}
...
#endif  // PROTOBUF_INCLUDED_util_2ftracing_2ftracingpb_2frecorded_5fspan_2eproto
