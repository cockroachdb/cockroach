...
// source: kv/storage/engine/enginepb/file_registry.proto

#ifndef PROTOBUF_INCLUDED_kv_2fstorage_2fengine_2fenginepb_2ffile_5fregistry_2eproto
#define PROTOBUF_INCLUDED_kv_2fstorage_2fengine_2fenginepb_2ffile_5fregistry_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_kv_2fstorage_2fengine_2fenginepb_2ffile_5fregistry_2eproto 

namespace protobuf_kv_2fstorage_2fengine_2fenginepb_2ffile_5fregistry_2eproto {
...
namespace google {
namespace protobuf {
template<> ::cockroach::kv::storage::engine::enginepb::FileEntry* Arena::CreateMaybeMessage<::cockroach::kv::storage::engine::enginepb::FileEntry>(Arena*);
template<> ::cockroach::kv::storage::engine::enginepb::FileRegistry* Arena::CreateMaybeMessage<::cockroach::kv::storage::engine::enginepb::FileRegistry>(Arena*);
template<> ::cockroach::kv::storage::engine::enginepb::FileRegistry_FilesEntry_DoNotUse* Arena::CreateMaybeMessage<::cockroach::kv::storage::engine::enginepb::FileRegistry_FilesEntry_DoNotUse>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace cockroach {
namespace kv {
...
class FileRegistry_FilesEntry_DoNotUse : public ::google::protobuf::internal::MapEntryLite<FileRegistry_FilesEntry_DoNotUse, 
    ::std::string, ::cockroach::kv::storage::engine::enginepb::FileEntry,
...
class FileRegistry : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:cockroach.kv.storage.engine.enginepb.FileRegistry) */ {
 public:
  FileRegistry();
  ...
  // map<string, .cockroach.kv.storage.engine.enginepb.FileEntry> files = 2;
  int files_size() const;
  void clear_files();
  static const int kFilesFieldNumber = 2;
  const ::google::protobuf::Map< ::std::string, ::cockroach::kv::storage::engine::enginepb::FileEntry >&
      files() const;
  ::google::protobuf::Map< ::std::string, ::cockroach::kv::storage::engine::enginepb::FileEntry >*
      mutable_files();

  // .cockroach.kv.storage.engine.enginepb.RegistryVersion version = 1;
  void clear_version();
  static const int kVersionFieldNumber = 1;
  ::cockroach::kv::storage::engine::enginepb::RegistryVersion version() const;
  void set_version(::cockroach::kv::storage::engine::enginepb::RegistryVersion value);

  // @@protoc_insertion_point(class_scope:cockroach.kv.storage.engine.enginepb.FileRegistry)
 private:
  ...
  friend struct ::protobuf_kv_2fstorage_2fengine_2fenginepb_2ffile_5fregistry_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class FileEntry : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:cockroach.kv.storage.engine.enginepb.FileEntry) */ {
 public:
  FileEntry();
  virtual ~FileEntry();
  ...
  // .cockroach.kv.storage.engine.enginepb.EnvType env_type = 1;
  void clear_env_type();
  static const int kEnvTypeFieldNumber = 1;
  ::cockroach::kv::storage::engine::enginepb::EnvType env_type() const;
  void set_env_type(::cockroach::kv::storage::engine::enginepb::EnvType value);

  // @@protoc_insertion_point(class_scope:cockroach.kv.storage.engine.enginepb.FileEntry)
 private:
...
inline ::cockroach::kv::storage::engine::enginepb::RegistryVersion FileRegistry::version() const {
  // @@protoc_insertion_point(field_get:cockroach.kv.storage.engine.enginepb.FileRegistry.version)
  return static_cast< ::cockroach::kv::storage::engine::enginepb::RegistryVersion >(version_);
}
inline void FileRegistry::set_version(::cockroach::kv::storage::engine::enginepb::RegistryVersion value) {
  
  version_ = value;
  // @@protoc_insertion_point(field_set:cockroach.kv.storage.engine.enginepb.FileRegistry.version)
}
...
inline const ::google::protobuf::Map< ::std::string, ::cockroach::kv::storage::engine::enginepb::FileEntry >&
FileRegistry::files() const {
  // @@protoc_insertion_point(field_map:cockroach.kv.storage.engine.enginepb.FileRegistry.files)
  return files_.GetMap();
}
inline ::google::protobuf::Map< ::std::string, ::cockroach::kv::storage::engine::enginepb::FileEntry >*
FileRegistry::mutable_files() {
  // @@protoc_insertion_point(field_mutable_map:cockroach.kv.storage.engine.enginepb.FileRegistry.files)
...
inline ::cockroach::kv::storage::engine::enginepb::EnvType FileEntry::env_type() const {
  // @@protoc_insertion_point(field_get:cockroach.kv.storage.engine.enginepb.FileEntry.env_type)
  return static_cast< ::cockroach::kv::storage::engine::enginepb::EnvType >(env_type_);
}
inline void FileEntry::set_env_type(::cockroach::kv::storage::engine::enginepb::EnvType value) {
  
  env_type_ = value;
  // @@protoc_insertion_point(field_set:cockroach.kv.storage.engine.enginepb.FileEntry.env_type)
}
...
inline const ::std::string& FileEntry::encryption_settings() const {
  // @@protoc_insertion_point(field_get:cockroach.kv.storage.engine.enginepb.FileEntry.encryption_settings)
...
inline void FileEntry::set_encryption_settings(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:cockroach.kv.storage.engine.enginepb.FileEntry.encryption_settings)
}
#if LANG_CXX11
inline void FileEntry::set_encryption_settings(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:cockroach.kv.storage.engine.enginepb.FileEntry.encryption_settings)
}
#endif
inline void FileEntry::set_encryption_settings(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:cockroach.kv.storage.engine.enginepb.FileEntry.encryption_settings)
}
inline void FileEntry::set_encryption_settings(const void* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:cockroach.kv.storage.engine.enginepb.FileEntry.encryption_settings)
}
inline ::std::string* FileEntry::mutable_encryption_settings() {
  
  // @@protoc_insertion_point(field_mutable:cockroach.kv.storage.engine.enginepb.FileEntry.encryption_settings)
...
inline ::std::string* FileEntry::release_encryption_settings() {
  // @@protoc_insertion_point(field_release:cockroach.kv.storage.engine.enginepb.FileEntry.encryption_settings)
...
inline void FileEntry::set_allocated_encryption_settings(::std::string* encryption_settings) {
  ...
  // @@protoc_insertion_point(field_set_allocated:cockroach.kv.storage.engine.enginepb.FileEntry.encryption_settings)
}
...
template <> struct is_proto_enum< ::cockroach::kv::storage::engine::enginepb::RegistryVersion> : ::std::true_type {};
template <> struct is_proto_enum< ::cockroach::kv::storage::engine::enginepb::EnvType> : ::std::true_type {};
...
#endif  // PROTOBUF_INCLUDED_kv_2fstorage_2fengine_2fenginepb_2ffile_5fregistry_2eproto
