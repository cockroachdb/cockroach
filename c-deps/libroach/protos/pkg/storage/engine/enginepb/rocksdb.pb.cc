...
#include "pkg/storage/engine/enginepb/rocksdb.pb.h"
...
namespace protobuf_pkg_2fstorage_2fengine_2fenginepb_2frocksdb_2eproto {
...
SSTUserProperties::SSTUserProperties()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_pkg_2fstorage_2fengine_2fenginepb_2frocksdb_2eproto::InitDefaults();
  }
  SharedCtor();
