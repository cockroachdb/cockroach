...
#include "pkg/storage/engine/enginepb/mvcc.pb.h"
...
void TableStruct::InitDefaultsImpl() {
  ...
  ::cockroach::util::hlc::protobuf_pkg_2futil_2fhlc_2flegacy_5ftimestamp_2eproto::InitDefaults();
...
void AddDescriptorsImpl() {
  ...
  ::cockroach::util::hlc::protobuf_pkg_2futil_2fhlc_2flegacy_5ftimestamp_2eproto::AddDescriptors();
...
MVCCMetadata::MVCCMetadata()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_pkg_2fstorage_2fengine_2fenginepb_2fmvcc_2eproto::InitDefaults();
  }
  SharedCtor();
