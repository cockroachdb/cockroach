...
// source: pkg/util/unresolved_addr.proto
...
namespace protobuf_pkg_2futil_2funresolved_5faddr_2eproto {
...
void TableStruct::InitDefaultsImpl() {
  ...
  _UnresolvedAddr_default_instance_._instance.DefaultConstruct();
...
UnresolvedAddr::UnresolvedAddr()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_pkg_2futil_2funresolved_5faddr_2eproto::InitDefaults();
  }
  SharedCtor();
