...
template <> struct is_proto_enum< ::cockroach::storage::concurrency::lock::Strength> : ::std::true_type {};
template <> struct is_proto_enum< ::cockroach::storage::concurrency::lock::Durability> : ::std::true_type {};
