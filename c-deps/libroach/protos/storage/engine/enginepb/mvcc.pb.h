...
inline void InitDefaults() {
  InitDefaultsMVCCMetadata();
  InitDefaultsMVCCStats();
}
}  // namespace protobuf_storage_2fengine_2fenginepb_2fmvcc_2eproto
namespace cockroach {
namespace storage {
...
class MVCCMetadata : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:cockroach.storage.engine.enginepb.MVCCMetadata) */ {
 ...
 private:
  ...
  friend void ::protobuf_storage_2fengine_2fenginepb_2fmvcc_2eproto::InitDefaultsMVCCMetadataImpl();
};
// -------------------------------------------------------------------
...
class MVCCStats : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:cockroach.storage.engine.enginepb.MVCCStats) */ {
 ...
 private:
  ...
  friend struct ::protobuf_storage_2fengine_2fenginepb_2fmvcc_2eproto::TableStruct;
  friend void ::protobuf_storage_2fengine_2fenginepb_2fmvcc_2eproto::InitDefaultsMVCCStatsImpl();
};
// ===================================================================
