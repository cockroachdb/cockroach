...
#include "getter.h"
#include "iterator.h"
#include "protos/kv/storage/engine/enginepb/rocksdb.pb.h"
#include "status.h"
...
DBString DBEngine::GetUserProperties() {
  ...
  cockroach::kv::storage::engine::enginepb::SSTUserPropertiesCollection all;
  if (!status.ok()) {
  ...
  for (auto i = props.begin(); i != props.end(); i++) {
    cockroach::kv::storage::engine::enginepb::SSTUserProperties* sst = all.add_sst();
