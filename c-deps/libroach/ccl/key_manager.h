...
class FileKeyManager : public KeyManager {
 public:
  ...
  virtual EncryptionKey* CurrentKey() override { return active_key_.get(); }

  virtual EncryptionKey* GetKey(const KeyID id) override {
    if (id == "") {
      return nullptr;
    }
