...
1. Use a PostgreSQL-compatible driver or ORM to [build an app with CockroachDB](build-an-app-with-cockroachdb.html).

1. [Explore core features](https://www.cockroachlabs.com/docs/demo-data-replication.html), such as data replication, automatic rebalancing, and fault tolerance and recovery.
...
- [Troubleshooting documentation](https://www.cockroachlabs.com/docs/troubleshooting-overview.html) - Learn how to troubleshoot common errors, cluster and node setup, and SQL query behavior, and how to use debug and error logs.
