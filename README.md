...
[localhost:26257](http://localhost:26257); for OSX, things are a little more
complicated and you need to run `docker-machine ip default` to get the correct
address (but the port is the same).
