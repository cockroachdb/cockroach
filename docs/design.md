...
- ...
- `\x02<keyN>`: Range metadata for range ending `\x03<keyN>`.
- `\x03<key1>`: Range metadata for range ending `<key1>`.
- ...
...
In practice, key0 - keyN above are managed by the SQL subsystem, which employs
its own key anatomy.
