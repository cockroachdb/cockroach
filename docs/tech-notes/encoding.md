...
For more details, see [pkg/sql/sqlbase/sqlkv_structured.proto].
...
[pkg/sql/sqlbase/sqlkv_rowwriter.go]. For decoding, see
[pkg/sql/sqlbase/sqlkv_rowfetcher.go].
...
([pkg/sql/sqlbase/sqlkv_table.go]). See also `EncDatum`
([pkg/sql/sqlbase/r_encoded\_datum.go]).
...
[pkg/sql/sqlbase/sqlkv_table.go]). Unlike the `TUPLE` encoding, this encoding
...
([pkg/sql/sqlbase/sqlkv_structured.proto]).
...
`EncodeSecondaryIndex` in [pkg/sql/sqlbase/sqlkv_table.go]. Each row gives
...
Example dump:
  ...
  [pkg/sql/sqlbase/sqlkv_structured.proto]: https://github.com/cockroachdb/cockroach/blob/master/pkg/sql/sqlbase/sqlkv_structured.proto
  [pkg/sql/sqlbase/sqlkv_rowwriter.go]: https://github.com/cockroachdb/cockroach/blob/master/pkg/sql/sqlbase/sqlkv_rowwriter.go
  [pkg/sql/sqlbase/sqlkv_rowfetcher.go]: https://github.com/cockroachdb/cockroach/blob/master/pkg/sql/sqlbase/sqlkv_rowfetcher.go
  ...
  [pkg/sql/sqlbase/sqlkv_table.go]: https://github.com/cockroachdb/cockroach/blob/master/pkg/sql/sqlbase/sqlkv_table.go
  [pkg/sql/sqlbase/r_encoded\_datum.go]: https://github.com/cockroachdb/cockroach/blob/master/pkg/sql/sqlbase/r_encoded_datum.go
