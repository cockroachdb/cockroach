...
value component of an indexed column is placed in the k/v pair corresponding
to the column family of the indexed column. All of these fields are optional, so the
