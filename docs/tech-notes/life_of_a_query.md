...
but it is worth noting that, from this moment on, we have interfaced with the
...
[`Builder.buildSelectClause()`](https://github.com/cockroachdb/cockroach/blob/9969862335cf501c1aa67a4aaf018ad5dc8e85e8/pkg/sql/opt/optbuilder/select.go#L1003). 
Notice how different aspects of a `SELECT` statement are handled: a
`scanNode` is created (`Builder.buildSelectClause()`->...->
