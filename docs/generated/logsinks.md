...
- [Output to OpenTelemetry collectors.](#output-to-opentelemetry-collectors.)
...
<a name="output-to-opentelemetry-collectors.">

## Sink type: Output to OpenTelemetry collectors.
