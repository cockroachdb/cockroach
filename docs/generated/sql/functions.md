...
<tr><td><a name="crdb_internal.check_password_hash"></a><code>crdb_internal.check_password_hash(password: <a href="bytes.html">bytes</a>) &rarr; <a href="string.html">string</a></code></td><td><span class="funcdesc"><p>This function checks whether a string is a precomputed password hash. Returns the hash algorithm.</p>
</span></td></tr>
