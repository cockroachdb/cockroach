...
<pre><code>		Note this may not be an accurate time span since years and months are normalized from days, and years and months are out of context. Use the subtraction operator instead for day rounding which maintains this accuracy.</code></pre>
</span></td></tr>
...
<pre><code>		Note this may not be an accurate time span since years and months are normalized from days, and years and months are out of context. Use `timestamptz - now()` for day rounding which maintains this accuracy.</code></pre>
</span></td></tr>
