...
<tr><td><a name="crdb_internal.job_payload_user"></a><code>crdb_internal.job_payload_user(data: <a href="bytes.html">bytes</a>) &rarr; <a href="string.html">string</a></code></td><td><span class="funcdesc"><p>Reads the user from the jobspb.Payload protocol message.</p>
</span></td><td>Immutable</td></tr>
