...
<thead><tr><th>Function &rarr; Returns</th><th>Description</th></tr></thead>
<tbody>
<tr><td><a name="crdb_internal.init_stream"></a><code>crdb_internal.init_stream(tenant_id: <a href="int.html">int</a>) &rarr; <a href="int.html">int</a></code></td><td><span class="funcdesc"><p>This function can be used to start a stream replication job for the specified tenant on the producer side. The job will periodically check liveness of the stream replication and will kill the job if it has been inactive for a duration of time specified by the cluster setting ‘stream_replication.job_liveness_timeout’.</p>
</span></td></tr></tbody>
</table>
