...
<tr><td><a name="st_geohash"></a><code>st_geohash(geography: geography, precision: int4) &rarr; <a href="string.html">string</a></code></td><td><span class="funcdesc"><p>Accepts a geographic expression and returns a geoHash representation of the geometry.</p>
</span></td></tr>
