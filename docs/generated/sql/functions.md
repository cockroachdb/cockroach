...
<p>Note if geometries are the same, it will return the LineString with the maximum distance between the geometry’s vertexes. The function will return the first longest line if more than one is found.</p>
</span></td></tr>
