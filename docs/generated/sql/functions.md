...
<tr><td><a name="st_geohash"></a><code>st_geohash(geography: geography) &rarr; <a href="string.html">string</a></code></td><td><span class="funcdesc"><p>Accepts a geographic expression and returns a GeoHash representation of the geometry with full precision if a point is provided, or with variable precision based on the size of the feature</p>
</span></td></tr>
<tr><td><a name="st_geohash"></a><code>st_geohash(geography: geography, precision: int4) &rarr; <a href="string.html">string</a></code></td><td><span class="funcdesc"><p>Accepts a geographic expression and returns a GeoHash representation of the geometry with the supplied precision.</p>
</span></td></tr>
