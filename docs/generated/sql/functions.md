...
<tr><td><code>current_date() &rarr; <a href="date.html">date</a></code></td><td><span class="funcdesc"><p>Returns an approximation of the date of the current transaction.</p>
<p>The value is an estimate: it is greater than the logical time the
transaction started minus one microsecond, and smaller than the
logical time the transaction effectively commits. This estimate is
constant throughout the transaction.</p>
</span></td></tr>
<tr><td><code>current_timestamp() &rarr; <a href="timestamp.html">timestamp</a></code></td><td><span class="funcdesc"><p>Returns an approximate time of the current transaction.</p>
<p>The value is an estimate: it is greater than the logical time the
transaction started minus one microsecond, and smaller than the
logical time the transaction effectively commits. This estimate is
constant throughout the transaction.</p>
</span></td></tr>
<tr><td><code>current_timestamp() &rarr; <a href="timestamp.html">timestamptz</a></code></td><td><span class="funcdesc"><p>Returns an approximate time of the current transaction.</p>
<p>The value is an estimate: it is greater than the logical time the
transaction started minus one microsecond, and smaller than the
logical time the transaction effectively commits. This estimate is
constant throughout the transaction.</p>
...
<tr><td><code>now() &rarr; <a href="timestamp.html">timestamp</a></code></td><td><span class="funcdesc"><p>Returns an approximate time of the current transaction.</p>
<p>The value is an estimate: it is greater than the logical time the
transaction started minus one microsecond, and smaller than the
logical time the transaction effectively commits. This estimate is
constant throughout the transaction.</p>
</span></td></tr>
<tr><td><code>now() &rarr; <a href="timestamp.html">timestamptz</a></code></td><td><span class="funcdesc"><p>Returns an approximate time of the current transaction.</p>
<p>The value is an estimate: it is greater than the logical time the
transaction started minus one microsecond, and smaller than the
logical time the transaction effectively commits. This estimate is
constant throughout the transaction.</p>
...
<tr><td><code>transaction_timestamp() &rarr; <a href="timestamp.html">timestamp</a></code></td><td><span class="funcdesc"><p>Returns an approximate time of the current transaction.</p>
<p>The value is an estimate: it is greater than the logical time the
transaction started minus one microsecond, and smaller than the
logical time the transaction effectively commits. This estimate is
constant throughout the transaction.</p>
</span></td></tr>
<tr><td><code>transaction_timestamp() &rarr; <a href="timestamp.html">timestamptz</a></code></td><td><span class="funcdesc"><p>Returns an approximate time of the current transaction.</p>
<p>The value is an estimate: it is greater than the logical time the
transaction started minus one microsecond, and smaller than the
logical time the transaction effectively commits. This estimate is
constant throughout the transaction.</p>
...
<thead><tr><th>Function &rarr; Returns</th><th>Description</th></tr></thead>
<tbody>
<tr><td><code>current_time() &rarr; timetz</code></td><td><span class="funcdesc"><p>Returns an approximate time of the current transaction, with time zone.</p>
<p>The value is an estimate: it is greater than the logical time the
transaction started minus one microsecond, and smaller than the
logical time the transaction effectively commits. This estimate is
constant throughout the transaction.</p>
