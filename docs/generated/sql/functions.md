...
<tr><td><a name="crdb_internal.payloads_for_span_as_table"></a><code>crdb_internal.payloads_for_span_as_table(span_id: <a href="int.html">int</a>) &rarr; tuple{string AS payload_type, jsonb AS full_payload}</code></td><td><span class="funcdesc"><p>Returns the payload(s) of the span whose ID is passed in the argument.</p>
</span></td></tr>
