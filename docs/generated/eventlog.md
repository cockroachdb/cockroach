...
| `SkippedTransactions` | SkippedTransactions is the number of transactions that were not considered for sampling prior to this one. We only count skipped transactions when telemetry logging is enabled for the transaction type. | no |
