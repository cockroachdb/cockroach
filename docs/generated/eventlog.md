...
| `StatementFingerprintID` | Statement fingerprint ID of the query. | yes |
...
| `TransactionFingerprintID` | TransactionFingerprintID is the fingerprint ID of the transaction. This can be used to find the transaction in the console. | yes |
