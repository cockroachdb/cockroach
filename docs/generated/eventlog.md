...
### `unsafe_internals_access`

An event of type `unsafe_internals_access` is recorded when a query accesses unsafe internal
tables or functionality using the allow_unsafe_internals override.
