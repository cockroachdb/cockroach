...
| `JobType` | The type of the job that triggered the event. | yes |
...
| `Status` | The status of the job that triggered the event. This allows the job to indicate which phase execution it is in when the event is triggered. | yes |
