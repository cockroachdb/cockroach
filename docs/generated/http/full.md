...
| Field | Type | Label | Description | Support status |
| ----- | ---- | ----- | ----------- | -------------- |
| fingerprint_id | [uint64](#cockroach.server.serverpb.StatementDetailsRequest-uint64) |  | fingerprint_id is generated by ConstructStatementFingerprintID using: query, failed, implicitTxn and database. So we don't need to add them to the request. | [reserved](#support-status) |
| app_name | [string](#cockroach.server.serverpb.StatementDetailsRequest-string) |  |  | [reserved](#support-status) |
| full_scan | [string](#cockroach.server.serverpb.StatementDetailsRequest-string) |  |  | [reserved](#support-status) |
| distSQL | [string](#cockroach.server.serverpb.StatementDetailsRequest-string) |  |  | [reserved](#support-status) |
| vec | [string](#cockroach.server.serverpb.StatementDetailsRequest-string) |  |  | [reserved](#support-status) |
...
| Field | Type | Label | Description | Support status |
| ----- | ---- | ----- | ----------- | -------------- |
| statement | [StatementDetailsResponse.CollectedStatement](#cockroach.server.serverpb.StatementDetailsResponse-cockroach.server.serverpb.StatementDetailsResponse.CollectedStatement) |  | statement returns the total statistics for the statement, while the two list returns the same statement with its statistics separated by aggregated timestamp and plan hash. | [reserved](#support-status) |
| statements_per_aggregated_ts | [StatementDetailsResponse.CollectedStatementGrouped](#cockroach.server.serverpb.StatementDetailsResponse-cockroach.server.serverpb.StatementDetailsResponse.CollectedStatementGrouped) | repeated |  | [reserved](#support-status) |
| statements_per_plan_hash | [StatementDetailsResponse.CollectedStatementGrouped](#cockroach.server.serverpb.StatementDetailsResponse-cockroach.server.serverpb.StatementDetailsResponse.CollectedStatementGrouped) | repeated |  | [reserved](#support-status) |
...
<a name="cockroach.server.serverpb.StatementDetailsResponse-cockroach.server.serverpb.StatementDetailsResponse.CollectedStatement"></a>
#### StatementDetailsResponse.CollectedStatement
...
<a name="cockroach.server.serverpb.StatementDetailsResponse-cockroach.server.serverpb.StatementDetailsResponse.CollectedStatementGrouped"></a>
#### StatementDetailsResponse.CollectedStatementGrouped
