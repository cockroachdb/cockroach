...
## PersistedStatementStats

`GET /_status/persistedstmts`
...
| Field | Type | Label | Description | Support status |
| ----- | ---- | ----- | ----------- | -------------- |
| start | [int64](#cockroach.server.serverpb.PersistedStatementStatsRequest-int64) |  | Unix time range for aggregated statements. | [reserved](#support-status) |
| end | [int64](#cockroach.server.serverpb.PersistedStatementStatsRequest-int64) |  |  | [reserved](#support-status) |
