...
| is_unique | [bool](#cockroach.server.serverpb.TableIndexStatsResponse-bool) |  | is_unique indicates if the index is unique (include primary index). | [reserved](#support-status) |
