...
| errors | [string](#cockroach.server.serverpb.LogEntriesResponse-string) | repeated | errors contains list of errors that occurred during retrieving individual log entries that don't prevent to return at least partial response. | [reserved](#support-status) |
