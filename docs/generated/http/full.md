...
| data_non_live_percentage | [float](#cockroach.server.serverpb.TableDetailsResponse-float) |  | data_non_live_percentage is the percentage of non-live (MVCC) data on the table. | [reserved](#support-status) |
