...
## TransactionContentionEventsWithDetails

`GET /_status/transactioncontentioneventsextended`

TransactionContentionEventsWithDetails returns a list of un-aggregated contention
events sorted by the collection timestamp and include information about contended table object. .
...
| Field | Type | Label | Description | Support status |
| ----- | ---- | ----- | ----------- | -------------- |
| node_id | [string](#cockroach.server.serverpb.TransactionContentionEventsWithDetailsRequest-string) |  |  | [reserved](#support-status) |
...
| Field | Type | Label | Description | Support status |
| ----- | ---- | ----- | ----------- | -------------- |
| events | [ContentionEvent](#cockroach.server.serverpb.TransactionContentionEventsWithDetailsResponse-cockroach.server.serverpb.ContentionEvent) | repeated |  | [reserved](#support-status) |
| errors_by_node_id | [TransactionContentionEventsWithDetailsResponse.ErrorsByNodeIdEntry](#cockroach.server.serverpb.TransactionContentionEventsWithDetailsResponse-cockroach.server.serverpb.TransactionContentionEventsWithDetailsResponse.ErrorsByNodeIdEntry) | repeated | errors contains any errors that occurred during fan-out calls to other nodes. | [reserved](#support-status) |
...
<a name="cockroach.server.serverpb.TransactionContentionEventsWithDetailsResponse-cockroach.server.serverpb.ContentionEvent"></a>
#### ContentionEvent
...
| Field | Type | Label | Description | Support status |
| ----- | ---- | ----- | ----------- | -------------- |
| key | [bytes](#cockroach.server.serverpb.TransactionContentionEventsWithDetailsResponse-bytes) |  | Key is the key that this and the other transaction conflicted on. | [reserved](#support-status) |
| pretty_key | [string](#cockroach.server.serverpb.TransactionContentionEventsWithDetailsResponse-string) |  |  | [reserved](#support-status) |
| id | [bytes](#cockroach.server.serverpb.TransactionContentionEventsWithDetailsResponse-bytes) |  |  | [reserved](#support-status) |
| blocking_txn_fingerprint_id | [uint64](#cockroach.server.serverpb.TransactionContentionEventsWithDetailsResponse-uint64) |  |  | [reserved](#support-status) |
| duration | [google.protobuf.Duration](#cockroach.server.serverpb.TransactionContentionEventsWithDetailsResponse-google.protobuf.Duration) |  | Duration spent contending against the other transaction. | [reserved](#support-status) |
| waiting_txn_id | [bytes](#cockroach.server.serverpb.TransactionContentionEventsWithDetailsResponse-bytes) |  |  | [reserved](#support-status) |
| waiting_txn_fingerprint_id | [uint64](#cockroach.server.serverpb.TransactionContentionEventsWithDetailsResponse-uint64) |  |  | [reserved](#support-status) |
| collection_ts | [google.protobuf.Timestamp](#cockroach.server.serverpb.TransactionContentionEventsWithDetailsResponse-google.protobuf.Timestamp) |  |  | [reserved](#support-status) |
| waiting_stmt_fingerprint_id | [uint64](#cockroach.server.serverpb.TransactionContentionEventsWithDetailsResponse-uint64) |  |  | [reserved](#support-status) |
| waiting_stmt_id | [bytes](#cockroach.server.serverpb.TransactionContentionEventsWithDetailsResponse-bytes) |  |  | [reserved](#support-status) |
| database_name | [string](#cockroach.server.serverpb.TransactionContentionEventsWithDetailsResponse-string) |  |  | [reserved](#support-status) |
| schema_name | [string](#cockroach.server.serverpb.TransactionContentionEventsWithDetailsResponse-string) |  |  | [reserved](#support-status) |
| index_name | [string](#cockroach.server.serverpb.TransactionContentionEventsWithDetailsResponse-string) |  |  | [reserved](#support-status) |
| table_name | [string](#cockroach.server.serverpb.TransactionContentionEventsWithDetailsResponse-string) |  |  | [reserved](#support-status) |





<a name="cockroach.server.serverpb.TransactionContentionEventsWithDetailsResponse-cockroach.server.serverpb.TransactionContentionEventsWithDetailsResponse.ErrorsByNodeIdEntry"></a>
#### TransactionContentionEventsWithDetailsResponse.ErrorsByNodeIdEntry



| Field | Type | Label | Description | Support status |
| ----- | ---- | ----- | ----------- | -------------- |
| key | [int32](#cockroach.server.serverpb.TransactionContentionEventsWithDetailsResponse-int32) |  |  |  |
| value | [string](#cockroach.server.serverpb.TransactionContentionEventsWithDetailsResponse-string) |  |  |  |
