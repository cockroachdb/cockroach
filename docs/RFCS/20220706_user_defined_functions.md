...
[#70100](https://github.com/cockroachdb/cockroach/pull/70100)), or a reference
to the type of table's column (with the syntax `table_name.column_name%TYPE`).
...
initially support other statements including schema changes (see [DDL (Schema
Changes) in UDFs](#ddl-schema-changes-in-UDFs)), session settings, or creating
table statistics.**
