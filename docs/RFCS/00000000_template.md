...
- Explaining the feature largely in terms of examples. If applicable, stick to PM provided user stories
  and user flows.
...
- It covers where this feature may be surfaced in other areas of the product
   - What metrics should be measured? Should they be surfaced in the admin UI?
   - How will we debug issues? Do these metrics need to be surfaced anywhere?
   - Does the user interaction with this feature map to our existing design
     paradigms?
...
If drawbacks include potential impacts on other areas of the product, identify tests
to run before marking the feature as complete to make sure we don't introduce incomplete
features.
