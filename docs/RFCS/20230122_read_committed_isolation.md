...
blocking behavior using **a simpler approach** that has fewer auxiliary benefits
and shifts work from writers to readers but still achieves the sought-after
...
The design of Shared locks was explored in:
TODO(nvanbenschoten): link to Arul's RFC once it's on Github.
...
TODO(drew): merge in
https://docs.google.com/document/d/1qLzc7coISshNlaj620PJVIT2wFy_Hl2Z02LxH-MOwBE/edit#
https://docs.google.com/document/d/1f-jxoi6DLMAF1VgK_vO5Ocys6J8UxURefUKT8lBvoGk/edit#
