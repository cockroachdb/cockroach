...
- [Technical design](#technical-design)
    ...
    - [Alternatives](#alternatives)
        ...
        - [Target the query in the request, no the session](#target-the-query-in-the-request-no-the-session)
...
### Target the query in the request, no the session
...
5. execute the user input and print results
4. go back to step 1.
