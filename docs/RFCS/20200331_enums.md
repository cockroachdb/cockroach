...
this area. An example of these changes are in 
...
The type system itself will also have to be extended to have support for
resolved type references before type checking. The details involved in this
change can be found in [this PR](https://github.com/cockroachdb/cockroach/pull/47386).
