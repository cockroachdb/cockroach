...
_perfect_ generic plans that can be reused without re-optimization because the
...
will be fully optimized as a perfect generic query plan or imperfect generic
query plan.
