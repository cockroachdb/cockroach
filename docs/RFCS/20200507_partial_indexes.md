...
In this case, the constraint spans of the predicate and query filter are `[/101
- ]` and `[/201 - ]`, respectively. Because the constraints apply to the same
...
estimate the number of rows examined as the total number of rows in the table,
multiplied by the selectivity of `[/201 - ]` and the selectivity of `[/101 - ]`.
