...
created (or "interleaved") table. (The user can optionally specify fields with
the usual `(field1, field2)` syntax for extra explictness.)
...
However, adding the feature doesn't affect the speed of non-interleaved tables.
