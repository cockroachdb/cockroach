...
getting an ErrorResponse when trying to deserialize the session. The entire
transfer process must complete within 15 seconds, or a timeout handler will be
triggered to close the connection.
