...
type Streamer interface {
	...
	// responses will also reference the same key. This is useful, for example, r
	// "range-based lookup joins"
	// (https://github.com/cockroachdb/cockroach/pull/66002), where multiple spans
	// are read in the context of the same input-side row.
	//
...
single-range batch. Say that *B/P* = 1000 (i.e. the reorder window is a hundred
