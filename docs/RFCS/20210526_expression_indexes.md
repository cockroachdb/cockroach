...
This RFC proposes a design for supporting expression indexes. An expression
index allows a user to index an expression or multiple expressions. For example:
