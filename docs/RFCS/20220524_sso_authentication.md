...
| `sysid` | Payload  | string | The identity used to map to the user's SQL username.                          |
...
the customer wishes, but it is not a priority considering that the customer has presumably created these users already.
