...
2. **[new]** replace statements by logical nodes; this will
   ...
   4. expression reduction (currently called "normalization", see
   ...
   5. normalization (currently called "analysis" or "simplification",
   ...
   6. preparation of ancillary metadata for logical operation nodes:
