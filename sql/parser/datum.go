...
func (d *DBool) Format(buf *bytes.Buffer, f int) {
...
// Format implements the NodeFormatter interface.
func (d *DInt) Format(buf *bytes.Buffer, f int) {
...
// Format implements the NodeFormatter interface.
func (d *DFloat) Format(buf *bytes.Buffer, f int) {
	fl := float64(*d)
...
// Format implements the NodeFormatter interface.
func (d *DDecimal) Format(buf *bytes.Buffer, f int) {
...
// Format implements the NodeFormatter interface.
func (d *DString) Format(buf *bytes.Buffer, f int) {
...
// Format implements the NodeFormatter interface.
func (d *DBytes) Format(buf *bytes.Buffer, f int) {
...
// Format implements the NodeFormatter interface.
func (d *DDate) Format(buf *bytes.Buffer, f int) {
...
// Format implements the NodeFormatter interface.
func (d *DTimestamp) Format(buf *bytes.Buffer, f int) {
...
// Format implements the NodeFormatter interface.
func (d *DTimestampTZ) Format(buf *bytes.Buffer, f int) {
	buf.WriteString(d.UTC().Format(timestampWithOffsetZoneFormat))
}
...
// Format implements the NodeFormatter interface.
// Format implements the NodeFormatter interface.
func (d *DInterval) Format(buf *bytes.Buffer, f int) {
...
// Format implements the NodeFormatter interface.
func (d *DTuple) Format(buf *bytes.Buffer, f int) {
	buf.WriteByte('(')
	for i, v := range *d {
		if i > 0 {
			buf.WriteString(", ")
...
// Format implements the NodeFormatter interface.
func (dNull) Format(buf *bytes.Buffer, f int) {
...
// Format implements the NodeFormatter interface.
func (d *DValArg) Format(buf *bytes.Buffer, f int) {
	buf.WriteByte('$')
