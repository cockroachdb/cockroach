...
func (node *DropDatabase) Format(buf *bytes.Buffer, f int) {
...
// Format implements the NodeFormatter interface.
func (node *DropIndex) Format(buf *bytes.Buffer, f int) {
...
// Format implements the NodeFormatter interface.
func (node *DropTable) Format(buf *bytes.Buffer, f int) {
