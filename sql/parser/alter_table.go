...
func (node *AlterTable) Format(buf *bytes.Buffer, f int) {
...
// Format implements the NodeFormatter interface.
func (node AlterTableCmds) Format(buf *bytes.Buffer, f int) {
	var prefix string
	for _, n := range node {
...
// Format implements the NodeFormatter interface.
func (node *AlterTableAddColumn) Format(buf *bytes.Buffer, f int) {
	buf.WriteString("ADD ")
...
// Format implements the NodeFormatter interface.
func (node *AlterTableAddConstraint) Format(buf *bytes.Buffer, f int) {
	buf.WriteString("ADD ")
...
// Format implements the NodeFormatter interface.
func (node *AlterTableDropColumn) Format(buf *bytes.Buffer, f int) {
...
// Format implements the NodeFormatter interface.
func (node *AlterTableDropConstraint) Format(buf *bytes.Buffer, f int) {
...
// Format implements the NodeFormatter interface.
func (node *AlterTableSetDefault) Format(buf *bytes.Buffer, f int) {
...
// Format implements the NodeFormatter interface.
func (node *AlterTableDropNotNull) Format(buf *bytes.Buffer, f int) {
	buf.WriteString("ALTER ")
	if node.columnKeyword {
		buf.WriteString("COLUMN ")
	}
