...
CREATE TABLE a (b TINYINT)
CREATE TABLE a (b SMALLINT)
CREATE TABLE a (b MEDIUMINT)
CREATE TABLE a (b BIGINT)
CREATE TABLE a (b INTEGER)
CREATE TABLE a (b REAL)
CREATE TABLE a (b DOUBLE)
CREATE TABLE a (b FLOAT)
CREATE TABLE a (b DECIMAL)
CREATE TABLE a (b NUMERIC)
CREATE TABLE a (b DATE)
CREATE TABLE a (b TIME)
CREATE TABLE a (b DATETIME)
CREATE TABLE a (b TIMESTAMP)
CREATE TABLE a (b CHAR)
CREATE TABLE a (b VARCHAR)
CREATE TABLE a (b BINARY)
CREATE TABLE a (b VARBINARY)
CREATE TABLE a (b TEXT)
CREATE TABLE a (b TINYTEXT)
CREATE TABLE a (b MEDIUMTEXT)
CREATE TABLE a (b LONGTEXT)
CREATE TABLE a (b BLOB)
CREATE TABLE a (b TINYBLOB)
CREATE TABLE a (b MEDIUMBLOB)
CREATE TABLE a (b LONGBLOB)
CREATE TABLE a (b ENUM(`c`))#CREATE TABLE a (b ENUM)
CREATE TABLE a (b SET(`c`))#CREATE TABLE a (b SET)
