...
func (node *Select) Format(buf *bytes.Buffer, f int) {
...
// Format implements the NodeFormatter interface.
func (node *ParenSelect) Format(buf *bytes.Buffer, f int) {
	buf.WriteByte('(')
	FormatNode(buf, f, node.Select)
	buf.WriteByte(')')
}
...
// Format implements the NodeFormatter interface.
func (node *SelectClause) Format(buf *bytes.Buffer, f int) {
...
// Format implements the NodeFormatter interface.
func (node SelectExprs) Format(buf *bytes.Buffer, f int) {
	for i, n := range node {
		if i > 0 {
			buf.WriteString(", ")
		}
...
// Format implements the NodeFormatter interface.
func (node SelectExpr) Format(buf *bytes.Buffer, f int) {
...
// Format implements the NodeFormatter interface.
func (a AliasClause) Format(buf *bytes.Buffer, f int) {
...
// Format implements the NodeFormatter interface.
func (node TableExprs) Format(buf *bytes.Buffer, f int) {
	if len(node) != 0 {
...
// Format implements the NodeFormatter interface.
func (n *IndexHints) Format(buf *bytes.Buffer, f int) {
	if !n.NoIndexJoin {
		buf.WriteByte('@')
...
// Format implements the NodeFormatter interface.
func (node *AliasedTableExpr) Format(buf *bytes.Buffer, f int) {
	FormatNode(buf, f, node.Expr)
	if node.Hints != nil {
...
// Format implements the NodeFormatter interface.
func (node *ParenTableExpr) Format(buf *bytes.Buffer, f int) {
	buf.WriteByte('(')
	FormatNode(buf, f, node.Expr)
	buf.WriteByte(')')
}
...
// Format implements the NodeFormatter interface.
func (node *JoinTableExpr) Format(buf *bytes.Buffer, f int) {
...
// Format implements the NodeFormatter interface.
func (node *OnJoinCond) Format(buf *bytes.Buffer, f int) {
	buf.WriteString(" ON ")
	FormatNode(buf, f, node.Expr)
}
...
// Format implements the NodeFormatter interface.
func (node *UsingJoinCond) Format(buf *bytes.Buffer, f int) {
...
// Format implements the NodeFormatter interface.
func (node *Where) Format(buf *bytes.Buffer, f int) {
	if node != nil {
		buf.WriteByte(' ')
...
// Format implements the NodeFormatter interface.
func (node GroupBy) Format(buf *bytes.Buffer, f int) {
	prefix := " GROUP BY "
	for _, n := range node {
...
// Format implements the NodeFormatter interface.
func (node OrderBy) Format(buf *bytes.Buffer, f int) {
	prefix := " ORDER BY "
	for _, n := range node {
		buf.WriteString(prefix)
		FormatNode(buf, f, n)
...
// Format implements the NodeFormatter interface.
func (node *Order) Format(buf *bytes.Buffer, f int) {
	FormatNode(buf, f, node.Expr)
...
// Format implements the NodeFormatter interface.
func (node *Limit) Format(buf *bytes.Buffer, f int) {
	if node != nil {
		if node.Count != nil {
