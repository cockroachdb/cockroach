...
func exprFmtWithParen(buf *bytes.Buffer, f int, e Expr) {
...
func binExprFmtWithParen(buf *bytes.Buffer, f int, e1 Expr, op string, e2 Expr) {
...
func (node *AndExpr) Format(buf *bytes.Buffer, f int) {
...
// Format implements the NodeFormatter interface.
func (node *OrExpr) Format(buf *bytes.Buffer, f int) {
...
// Format implements the NodeFormatter interface.
func (node *NotExpr) Format(buf *bytes.Buffer, f int) {
	buf.WriteString("NOT ")
...
// Format implements the NodeFormatter interface.
func (node *ParenExpr) Format(buf *bytes.Buffer, f int) {
	buf.WriteByte('(')
...
// Format implements the NodeFormatter interface.
func (node *ComparisonExpr) Format(buf *bytes.Buffer, f int) {
...
// Format implements the NodeFormatter interface.
func (node *RangeCond) Format(buf *bytes.Buffer, f int) {
	notStr := " BETWEEN "
	if node.Not {
		notStr = " NOT BETWEEN "
	}
...
// Format implements the NodeFormatter interface.
func (node *IsOfTypeExpr) Format(buf *bytes.Buffer, f int) {
	FormatNode(buf, f, node.Expr)
	buf.WriteString(" IS")
	if node.Not {
		buf.WriteString(" NOT")
...
// Format implements the NodeFormatter interface.
func (node *ExistsExpr) Format(buf *bytes.Buffer, f int) {
...
// Format implements the NodeFormatter interface.
func (node *IfExpr) Format(buf *bytes.Buffer, f int) {
	buf.WriteString("IF(")
...
// Format implements the NodeFormatter interface.
func (node *NullIfExpr) Format(buf *bytes.Buffer, f int) {
...
// Format implements the NodeFormatter interface.
func (node *CoalesceExpr) Format(buf *bytes.Buffer, f int) {
...
// Format implements the NodeFormatter interface.
func (node DefaultVal) Format(buf *bytes.Buffer, f int) {
...
// Format implements the NodeFormatter interface.
func (node ValArg) Format(buf *bytes.Buffer, f int) {
	buf.WriteByte('$')
	buf.WriteString(node.name)
}
...
func (n *QualifiedName) setString() {
	...
	if n.Base == "" && len(n.Indirect) == 1 && n.Indirect[0] == unqualifiedStar {
		FormatNode(&buf, FmtSimple, n.Indirect[0])
	} else {
		FormatNode(&buf, FmtSimple, n.Base)
		FormatNode(&buf, FmtSimple, n.Indirect)
	}
	n.origString = buf.String()
}

// Format implements the NodeFormatter interface.
func (n *QualifiedName) Format(buf *bytes.Buffer, f int) {
	n.setString()
	buf.WriteString(n.origString)
}
...
// Format implements the NodeFormatter interface.
func (n QualifiedNames) Format(buf *bytes.Buffer, f int) {
	for i, e := range n {
		if i > 0 {
			buf.WriteString(", ")
		}
...
// Format implements the NodeFormatter interface.
func (n *TableNameWithIndex) Format(buf *bytes.Buffer, f int) {
...
// Format implements the NodeFormatter interface.
func (n TableNameWithIndexList) Format(buf *bytes.Buffer, f int) {
	for i, e := range n {
		if i > 0 {
			buf.WriteString(", ")
		}
...
// Format implements the NodeFormatter interface.
func (node *Tuple) Format(buf *bytes.Buffer, f int) {
	buf.WriteByte('(')
	FormatNode(buf, f, node.Exprs)
	buf.WriteByte(')')
}
...
// Format implements the NodeFormatter interface.
func (node *Row) Format(buf *bytes.Buffer, f int) {
	buf.WriteString("ROW(")
	FormatNode(buf, f, node.Exprs)
	buf.WriteByte(')')
}
...
// Format implements the NodeFormatter interface.
func (node *Array) Format(buf *bytes.Buffer, f int) {
...
// Format implements the NodeFormatter interface.
func (node Exprs) Format(buf *bytes.Buffer, f int) {
	for i, n := range node {
		if i > 0 {
			buf.WriteString(", ")
		}
...
// Format implements the NodeFormatter interface.
func (node *Subquery) Format(buf *bytes.Buffer, f int) {
...
// Format implements the NodeFormatter interface.
func (node *BinaryExpr) Format(buf *bytes.Buffer, f int) {
	binExprFmtWithParen(buf, f, node.Left, node.Operator.String(), node.Right)
}
...
// Format implements the NodeFormatter interface.
func (node *UnaryExpr) Format(buf *bytes.Buffer, f int) {
...
// Format implements the NodeFormatter interface.
func (node *FuncExpr) Format(buf *bytes.Buffer, f int) {
	var typ string
	if node.Type != 0 {
...
// Format implements the NodeFormatter interface.
func (node *OverlayExpr) Format(buf *bytes.Buffer, f int) {
	FormatNode(buf, f, node.Name)
	buf.WriteByte('(')
...
// Format implements the NodeFormatter interface.
func (node *CaseExpr) Format(buf *bytes.Buffer, f int) {
...
// Format implements the NodeFormatter interface.
func (node *When) Format(buf *bytes.Buffer, f int) {
...
// Format implements the NodeFormatter interface.
func (node *CastExpr) Format(buf *bytes.Buffer, f int) {
...
func (n *QualifiedName) String() string       { return AsString(n) }
