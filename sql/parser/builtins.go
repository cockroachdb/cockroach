...
var Aggregates = map[string][]Builtin{
	"avg": {
		Builtin{Types: ArgTypes{TypeInt}, ReturnType: TypeDecimal, Agg: newAvgAggregate},
		Builtin{Types: ArgTypes{TypeFloat}, ReturnType: TypeFloat, Agg: newAvgAggregate},
		Builtin{Types: ArgTypes{TypeDecimal}, ReturnType: TypeDecimal, Agg: newAvgAggregate},
	},

	"bool_and": {
		Builtin{Types: ArgTypes{TypeBool}, ReturnType: TypeBool, Agg: newBoolAndAggregate},
	},

	"bool_or": {
		Builtin{Types: ArgTypes{TypeBool}, ReturnType: TypeBool, Agg: newBoolOrAggregate},
	},

	"count": countImpls(),

	"max": AggregateFuncs(newMaxAggregate, TypeBool, TypeInt, TypeFloat, TypeDecimal, TypeString, TypeBytes, TypeDate, TypeTimestamp, TypeInterval),
	"min": AggregateFuncs(newMinAggregate, TypeBool, TypeInt, TypeFloat, TypeDecimal, TypeString, TypeBytes, TypeDate, TypeTimestamp, TypeInterval),

	"sum": {
		Builtin{Types: ArgTypes{TypeInt}, ReturnType: TypeDecimal, Agg: newSumAggregate},
		Builtin{Types: ArgTypes{TypeFloat}, ReturnType: TypeFloat, Agg: newSumAggregate},
		Builtin{Types: ArgTypes{TypeDecimal}, ReturnType: TypeDecimal, Agg: newSumAggregate},
	},

	"variance": {
		Builtin{Types: ArgTypes{TypeInt}, ReturnType: TypeDecimal, Agg: newVarianceAggregate},
		Builtin{Types: ArgTypes{TypeDecimal}, ReturnType: TypeDecimal, Agg: newVarianceAggregate},
		Builtin{Types: ArgTypes{TypeFloat}, ReturnType: TypeFloat, Agg: newVarianceAggregate},
	},

	"stddev": {
		Builtin{Types: ArgTypes{TypeInt}, ReturnType: TypeDecimal, Agg: newStddevAggregate},
		Builtin{Types: ArgTypes{TypeDecimal}, ReturnType: TypeDecimal, Agg: newStddevAggregate},
		Builtin{Types: ArgTypes{TypeFloat}, ReturnType: TypeFloat, Agg: newStddevAggregate},
	},
}
...
func AggregateFuncs(f func() AggregateFunc, types ...Datum) []Builtin {
	var r []Builtin
	for _, t := range types {
		r = append(r, Builtin{
