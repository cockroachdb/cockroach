...
var builtins = map[string][]builtin{
	...
	"acos": floatAndDecimalBuiltin1(func(x float64) (Datum, error) {
		return DFloat(math.Acos(x)), nil
	}),

	"asin": floatAndDecimalBuiltin1(func(x float64) (Datum, error) {
		return DFloat(math.Asin(x)), nil
	}),

	"atan": floatAndDecimalBuiltin1(func(x float64) (Datum, error) {
		return DFloat(math.Atan(x)), nil
	}),

	"atan2": floatAndDecimalBuiltin2(func(x, y float64) (Datum, error) {
		return DFloat(math.Atan2(x, y)), nil
	}),

	"cbrt": floatAndDecimalBuiltin1(func(x float64) (Datum, error) {
	...
	"cos": floatAndDecimalBuiltin1(func(x float64) (Datum, error) {
	...
	"div": {
		...
		decimalBuiltin2(func(x, y decimal.Decimal) (Datum, error) {
			...
			return DDecimal{Decimal: x.Div(y)}, nil
		}),
	},

	"exp": floatAndDecimalBuiltin1(func(x float64) (Datum, error) {
	...
	"ln": floatAndDecimalBuiltin1(func(x float64) (Datum, error) {
		return DFloat(math.Log(x)), nil
	}),

	"log": floatAndDecimalBuiltin1(func(x float64) (Datum, error) {
	...
	"mod": {
		...
		decimalBuiltin2(func(x, y decimal.Decimal) (Datum, error) {
			...
			quo := x.Div(y).Truncate(0)
			return DDecimal{Decimal: x.Sub(y.Mul(quo))}, nil
		}),
		builtin{
			returnType: typeInt,
	...
	"radians": floatAndDecimalBuiltin1(func(x float64) (Datum, error) {
	...
	"sin": floatAndDecimalBuiltin1(func(x float64) (Datum, error) {
	...
	"sqrt": floatAndDecimalBuiltin1(func(x float64) (Datum, error) {
		return DFloat(math.Sqrt(x)), nil
	}),

	"tan": floatAndDecimalBuiltin1(func(x float64) (Datum, error) {
...
var powImpl = floatAndDecimalBuiltin2(func(x, y float64) (Datum, error) {
...
func floatAndDecimalBuiltin1(f func(float64) (Datum, error)) []builtin {
	return []builtin{
		{
			types:      argTypes{floatType},
			returnType: typeFloat,
			...
			fn: func(_ EvalContext, args DTuple) (Datum, error) {
				...
				if math.IsNaN(rf) || math.IsInf(rf, 0) {
					...
					return DNull, fmt.Errorf("decimal does not support NaN")
				}
...
func floatAndDecimalBuiltin2(f func(float64, float64) (Datum, error)) []builtin {
	return []builtin{
		{
			types:      argTypes{floatType, floatType},
			returnType: typeFloat,
