...
// ArgTypes accepts a specific number of type of arguments.
...
// Builtin contains information for a builtin function.
type Builtin struct {
	Types      typeList
...
// Builtins map from function name to function data. Keep the list of
// functions sorted please.
