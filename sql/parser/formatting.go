...
var datetimeFormatSuffix = []*keySuffix {
	&keySuffix{"FM", 2, suffFillMode, suffTypePrefix},
	&keySuffix{"fm", 2, suffFillMode, suffTypePrefix},
//	{"TM", 2, dchSTM, suffTypePrefix},
//	{"tm", 2, dchSTM, suffTypePrefix},
	&keySuffix{"TH", 2, suffUpperOrdinalNumber, suffTypePostfix},
	&keySuffix{"th", 2, suffLowerOrdinalNumber, suffTypePostfix},
	&keySuffix{"SP", 2, suffSpellMode, suffTypePostfix},
}
...
var dateTimeFmtKeyword = []*keyWord {
	...
	&keyWord{"A.D.", 4, idxUpperAnnoDotDomin, false, fromCharDateNone},	/* A */
	&keyWord{"A.M.", 4, idxUpperAnnoDotMeridiem, false, fromCharDateNone},
	&keyWord{"AD", 2, idxUpperAnnoDomin, false, fromCharDateNone},
	&keyWord{"AM", 2, idxUpperAnnoMeridiem, false, fromCharDateNone},
	&keyWord{"B.C.", 4, idxUpperBeforeDotChrist, false, fromCharDateNone},	/* B */
	&keyWord{"BC", 2, idxUpperBeforeChrist, false, fromCharDateNone},
	&keyWord{"CC", 2, idxUpperCentury, true, fromCharDateNone},		/* C */
	&keyWord{"DAY", 3, idxUpperDay, false, fromCharDateNone},	/* D */
	&keyWord{"DDD", 3, idxUpperDayOfYear, true, fromCharDateGregorian},
	&keyWord{"DD", 2, idxUpperDayOfMonth, true, fromCharDateGregorian},
	&keyWord{"DY", 2, idxUpperAbbreviatedDayName, false, fromCharDateNone},
	&keyWord{"Day", 3, idxMixedCaseDay, false, fromCharDateNone},
	&keyWord{"Dy", 2, idxMixedCaseAbbreviatedDayName, false, fromCharDateNone},
	&keyWord{"D", 1, idxDayOfWeek, true, fromCharDateGregorian},
	&keyWord{"FX", 2, idxFixFormatGlobalOption, false, fromCharDateNone},		/* F */
	&keyWord{"HH24", 4, idxHourOfDay24, true, fromCharDateNone},	/* H */
	&keyWord{"HH12", 4, idxHourOfDay12, true, fromCharDateNone},
	&keyWord{"HH", 2, idxHourOfDay, true, fromCharDateNone},
	&keyWord{"IDDD", 4, idxUpperISODayOfYear, true, fromCharDateISOweek},		/* I */
	&keyWord{"ID", 2, idxUpperISODayOfWeek, true, fromCharDateISOweek},
	&keyWord{"IW", 2, idxISOWeekOfYear, true, fromCharDateISOweek},
	&keyWord{"IYYY", 4, idxISOYear, true, fromCharDateISOweek},
	&keyWord{"IYY", 3, idx3DigitsOfISOYear, true, fromCharDateISOweek},
	&keyWord{"IY", 2, idx2DigitsOfISOYear, true, fromCharDateISOweek},
	&keyWord{"I", 1, idxDigitsOfISOYear, true, fromCharDateISOweek},
	&keyWord{"J", 1, idxJulianDay, true, fromCharDateNone}, /* J */
	&keyWord{"MI", 2, idxMinute, true, fromCharDateNone},		/* M */
	&keyWord{"MM", 2, idxMonthNumber, true, fromCharDateGregorian},
	&keyWord{"MONTH", 5, idxUpperMonthName, false, fromCharDateGregorian},
	&keyWord{"MON", 3, idxAbbreviatedUpperMonthName, false, fromCharDateGregorian},
	&keyWord{"MS", 2, idxMillisecond, true, fromCharDateNone},
	&keyWord{"Month", 5, idxMixedCaseMonthName, false, fromCharDateGregorian},
	&keyWord{"Mon", 3, idxAbbreviatedMixedCaseMonthName, false, fromCharDateGregorian},
	&keyWord{"OF", 2, idxUpperOF, false, fromCharDateNone},		/* O */
	&keyWord{"P.M.", 4, idxUpperPostDotMeridiem, false, fromCharDateNone},	/* P */
	&keyWord{"PM", 2, idxUpperPostMeridiem, false, fromCharDateNone},
	&keyWord{"Q", 1, idxQuarter, true, fromCharDateNone}, /* Q */
	&keyWord{"RM", 2, idxUpperMonthInRomanNumerals, false, fromCharDateGregorian}, /* R */
	&keyWord{"SSSS", 4, idxUpperSecondPastMidnight, true, fromCharDateNone},	/* S */
	&keyWord{"SS", 2, idxUpperSecond, true, fromCharDateNone},
	&keyWord{"TZ", 2, idxUpperTimeZone, false, fromCharDateNone},		/* T */
	&keyWord{"US", 2, idxUpperMicrosecond, true, fromCharDateNone},		/* U */
	&keyWord{"WW", 2, idxUpperWeekOfYear, true, fromCharDateGregorian},	/* W */
	&keyWord{"W", 1, idxUpperWeekOfMonth, true, fromCharDateGregorian},
	&keyWord{"Y,YYY", 5, idxUpperYearWithComma, true, fromCharDateGregorian},	/* Y */
	&keyWord{"YYYY", 4, idxUpper4DigitsOfYear, true, fromCharDateGregorian},
	&keyWord{"YYY", 3, idxUpper3DigitsOfYear, true, fromCharDateGregorian},
	&keyWord{"YY", 2, idxUpper2DigitsOfYear, true, fromCharDateGregorian},
	&keyWord{"Y", 1, idxUpperLastDigitsOfYear, true, fromCharDateGregorian},
	&keyWord{"a.d.", 4, idxLowerAnnoDotDomin, false, fromCharDateNone},	/* a */
	&keyWord{"a.m.", 4, idxLowerAnnoDotMeridiem, false, fromCharDateNone},
	&keyWord{"ad", 2, idxLowerAnnoDomin, false, fromCharDateNone},
	&keyWord{"am", 2, idxLowerAnnoMeridiem, false, fromCharDateNone},
	&keyWord{"b.c.", 4, idxLowerBeforeDotChrist, false, fromCharDateNone},	/* b */
	&keyWord{"bc", 2, idxLowerBeforeChrist, false, fromCharDateNone},
	&keyWord{"cc", 2, idxLowerCentury, true, fromCharDateNone},		/* c */
	&keyWord{"day", 3, idxLowerDay, false, fromCharDateNone},	/* d */
	&keyWord{"ddd", 3, idxLowerDayOfYear, true, fromCharDateGregorian},
	&keyWord{"dd", 2, idxLowerDayOfMonth, true, fromCharDateGregorian},
	&keyWord{"dy", 2, idxLowerAbbreviatedDayName, false, fromCharDateNone},
	&keyWord{"d", 1, idxDayOfWeek, true, fromCharDateGregorian},
	&keyWord{"fx", 2, idxFixFormatGlobalOption, false, fromCharDateNone},		/* f */
	&keyWord{"hh24", 4, idxHourOfDay24, true, fromCharDateNone},	/* h */
	&keyWord{"hh12", 4, idxHourOfDay12, true, fromCharDateNone},
	...
	&keyWord{"mi", 2, idxMinute, true, fromCharDateNone},		/* m */
	&keyWord{"mm", 2, idxMonthNumber, true, fromCharDateGregorian},
	&keyWord{"month", 5, idxLowerMonthName, false, fromCharDateGregorian},
	&keyWord{"mon", 3, idxAbbreviatedLowerMonthName, false, fromCharDateGregorian},
	&keyWord{"ms", 2, idxMillisecond, true, fromCharDateNone},
	&keyWord{"p.m.", 4, idxLowerPostDotMeridiem, false, fromCharDateNone},	/* p */
	&keyWord{"pm", 2, idxLowerPostMeridiem, false, fromCharDateNone},
	&keyWord{"q", 1, idxQuarter, true, fromCharDateNone}, /* q */
	&keyWord{"rm", 2, idxLowerMonthInRomanNumerals, false, fromCharDateGregorian}, /* r */
	&keyWord{"ssss", 4, idxUpperSecondPastMidnight, true, fromCharDateNone},	/* s */
	&keyWord{"ss", 2, idxUpperSecond, true, fromCharDateNone},
	&keyWord{"tz", 2, idxLowerTimeZone, false, fromCharDateNone},		/* t */
	&keyWord{"us", 2, idxUpperMicrosecond, true, fromCharDateNone},		/* u */
	&keyWord{"ww", 2, idxUpperWeekOfYear, true, fromCharDateGregorian},	/* w */
	&keyWord{"w", 1, idxUpperWeekOfMonth, true, fromCharDateGregorian},
	&keyWord{"y,yyy", 5, idxUpperYearWithComma, true, fromCharDateGregorian},	/* y */
...
func DoToTimestamp(dateTxt string, fmtStr string) (*time.Time, error) {
	...
	log.Errorf("ts=%v", ts)
	res := time.Date(ts.year, time.Month(ts.mon), ts.mday, ts.hour, ts.min, ts.sec, 0, time.UTC)
	return &res, nil
}
