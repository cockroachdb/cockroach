...
// source: cockroach/sql/driver/session.proto
// DO NOT EDIT!
...
/*
	...
	It is generated from these files:
		cockroach/sql/driver/session.proto
...
type Session_Transaction struct {
	...
	Timestamp Datum_Timestamp `protobuf:"bytes,2,opt,name=timestamp" json:"timestamp"`
}
...
func (m *Session_Transaction) GetTimestamp() Datum_Timestamp {
	if m != nil {
		return m.Timestamp
	}
