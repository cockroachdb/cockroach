...
func (n *createTableNode) Start() error {
	...
	if n.n.As() {
		...
		// since CREATE TABLE is a DDL statement.
...
func MakeTableDescIfAs(p *parser.CreateTable, parentID sqlbase.ID,
	resultColumns []ResultColumn) (sqlbase.TableDescriptor, error) {
	desc := initTableDesc(parentID)
...
func initTableDesc(parentID sqlbase.ID) sqlbase.TableDescriptor {
