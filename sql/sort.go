...
func (n *sortNode) ExplainPlan() (name, description string, children []planNode) {
	...
	case *streamingSortStrategy:
		description = fmt.Sprintf("%s (streaming)", description)
...
func (ss *onDiskSortStrategy) Add(values parser.DTuple) {}

func (ss *onDiskSortStrategy) Finish() {}

func (ss *onDiskSortStrategy) Next() bool {
	return false
}

func (ss *onDiskSortStrategy) Values() parser.DTuple {
	return nil
}

func (ss *onDiskSortStrategy) DebugValues() debugValues {
	return debugValues{}
}
