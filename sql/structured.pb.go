...
const (
	...
	// value if specified. UPDATE ignores this descriptor. DELETE
...
// schema change will have a queue of DescriptorMutation for
// each column/index descriptor being added or dropped.
