...
type TableDescriptor struct {
	...
	// and instead, marks the up_version boolean to notify the schema
	...
	// single transaction.
	//
	// Multiple schema changes in the same transaction mark up_version.
	// The actual schema change execution that follows a schema change
	// command, sees the up_version boolean set and ups the version of
	// the table descriptor while maintaining the 2 version invariant.
	// The schema change execution must up the version before executing
	// future state changes, to ensure that the scheduled mutations
	// made by the original commands are visible on all leases. Multiple
	// schema change mutations can be grouped together on a particular
	// version increment.
	//
	...
	// See comment for up_version above.
