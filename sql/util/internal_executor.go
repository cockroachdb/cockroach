...
// InternalSQLExecutor is meant to be used by layers below SQL in the system
// that nevertheless want to execute SQL queries (against presumably system
// tables).
// It is extracted in this "sql/util" package to avoid circular references and
// is implemented by sql.InternalExecutor.
type InternalSQLExecutor interface {
