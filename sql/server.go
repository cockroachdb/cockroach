...
func MakeServer(ctx *base.Context, db client.DB, gossip *gossip.Gossip, leaseMgr *LeaseManager, metaRegistry metric.Registry) Server {
	return Server{
		context:  ctx,
		Executor: newExecutor(db, gossip, leaseMgr, metaRegistry),
	}
}
