...
// setTxn implements the Planner interface.
...
// resetTxn implements the Planner interface.
func (p *planner) resetTxn() {
	p.setTxn(nil)
}

// resetForBatch implements the Planner interface.
...
// exec implements the Planner interface.
...
// setTestingVerifyMetadata implements the Planner interface.
...
// blockConfigUpdatesMaybe implements the Planner interface.
...
// checkTestingVerifyMetadataInitialOrDie implements the Planner interface.
...
// checkTestingVerifyMetadataOrDie implements the Planner interface.
