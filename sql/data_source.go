...
// sourceAliases associates a column name (alias) to a set of columns
...
// name as source alias are considered. If the qname does not specify
// a table name, all columns in the data source are considered.
// If no column is found, invalidColIdx is returned with no error.
