...
// InternalExecutor is used by internal cockroach processes to execute SQL
// statements. InternalExecutor assumes that the caller has access to a
// cockroach KV client and can perform its own connection and transaction
// management.
