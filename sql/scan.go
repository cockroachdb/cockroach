...
func (n *scanNode) initTable(
	p *planner, tableName *parser.QualifiedName, indexHints *parser.IndexHints, allowHiddenCols bool,
) (string, error) {
	var err error
	...
	n.initDescDefaults(allowHiddenCols)
	return alias, nil
}
...
func (n *scanNode) initDescDefaults(allowHiddenCols bool) {
