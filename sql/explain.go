...
func (e *explainTypesNode) FinalizePlan() error {
	// TODO(knz) This will not need to call FinalizePlan() any more once all
	// the type checking occurs earlier.
	return e.plan.FinalizePlan()
}
...
func (e *explainPlanNode) FinalizePlan() error                     { return e.plan.FinalizePlan() }
...
func (n *explainDebugNode) FinalizePlan() error {
	if err := n.plan.FinalizePlan(); err != nil {
		return err
	}
