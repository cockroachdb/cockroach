...
func (e *explainTypesNode) BuildPlan() error {
	// TODO(knz) This will not need to call BuildPlan() any more once all
	// the type checking occurs earlier.
	return e.plan.BuildPlan()
}
...
func (e *explainPlanNode) BuildPlan() error                     { return e.plan.BuildPlan() }
...
func (n *explainDebugNode) BuildPlan() error {
