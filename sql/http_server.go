...
func MakeHTTPServer(ctx *base.Context, db client.DB, gossip *gossip.Gossip, leaseMgr *LeaseManager) HTTPServer {
	return HTTPServer{context: ctx, Executor: newExecutor(db, gossip, leaseMgr)}
}
