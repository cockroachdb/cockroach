...
type Session_Transaction struct {
	...
	Mutation  *Session_Transaction_TableMutation   `protobuf:"bytes,3,opt,name=mutation" json:"mutation,omitempty"`
}
...
type Session_Transaction_TableMutation struct {
	...
	// Mutation id.
	ID MutationID `protobuf:"varint,3,opt,name=id,casttype=MutationID" json:"id"`
}
...
func (m *Session_Transaction) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.Mutation == nil {
				m.Mutation = &Session_Transaction_TableMutation{}
			}
