...
type DescriptorMutation struct {
	...
	// A checkpoint key used when restarting the backfill for this mutation.
	// An unset value implies the beginning.
	CheckpointKey github_com_cockroachdb_cockroach_roachpb.Key `protobuf:"bytes,6,opt,name=checkpoint_key,json=checkpointKey,casttype=github.com/cockroachdb/cockroach/roachpb.Key" json:"checkpoint_key,omitempty"`
}
...
func (m *DescriptorMutation) MarshalTo(data []byte) (int, error) {
	...
	if m.CheckpointKey != nil {
		data[i] = 0x32
		i++
		i = encodeVarintStructured(data, i, uint64(len(m.CheckpointKey)))
...
func (m *DescriptorMutation) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			m.CheckpointKey = append(m.CheckpointKey[:0], data[iNdEx:postIndex]...)
			if m.CheckpointKey == nil {
				m.CheckpointKey = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
var fileDescriptorStructured = []byte{
	...
	,
}
