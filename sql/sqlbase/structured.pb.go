...
type TableDescriptor struct {
	...
	// replaced by State.
	OBSOLETE_Deleted bool                  `protobuf:"varint,18,opt,name=OBSOLETE_Deleted,json=oBSOLETEDeleted" json:"OBSOLETE_Deleted"`
	...
	// renamed multiple times in a row, there can be more than one element.
	// When this is detected in a schema change, the records for the old names is
	// are deleted and this field is cleared.
	RenameDetails []TableRenameDetails `protobuf:"bytes,20,rep,name=rename_details,json=renameDetails" json:"rename_details"`
}
...
func (m *TableDescriptor) GetOBSOLETE_Deleted() bool {
	if m != nil {
		return m.OBSOLETE_Deleted
	}
	return false
}
...
func (m *TableDescriptor) GetRenameDetails() []TableRenameDetails {
	if m != nil {
		return m.RenameDetails
	}
	return nil
}
...
type TableRenameDetails struct {
...
func (m *TableRenameDetails) Reset()                    { *m = TableRenameDetails{} }
func (m *TableRenameDetails) String() string            { return proto.CompactTextString(m) }
func (*TableRenameDetails) ProtoMessage()               {}
func (*TableRenameDetails) Descriptor() ([]byte, []int) { return fileDescriptorStructured, []int{5} }
...
func (*DatabaseDescriptor) Descriptor() ([]byte, []int) { return fileDescriptorStructured, []int{6} }
...
func (*Descriptor) Descriptor() ([]byte, []int) { return fileDescriptorStructured, []int{7} }
...
func init() {
	...
	proto.RegisterType((*TableRenameDetails)(nil), "cockroach.sql.sqlbase.TableRenameDetails")
...
func (m *TableDescriptor) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintStructured(data, i, uint64(m.State))
	if len(m.RenameDetails) > 0 {
		for _, msg := range m.RenameDetails {
			data[i] = 0xa2
			i++
			data[i] = 0x1
			i++
...
func (m *TableRenameDetails) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *TableRenameDetails) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *TableRenameDetails) Size() (n int) {
	var l int
	_ = l
...
func (m *TableDescriptor) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 18:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field OBSOLETE_Deleted", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 20:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RenameDetails", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RenameDetails = append(m.RenameDetails, TableRenameDetails{})
			if err := m.RenameDetails[len(m.RenameDetails)-1].Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *TableRenameDetails) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TableRenameDetails: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TableRenameDetails: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
var fileDescriptorStructured = []byte{
	...
	,
}
