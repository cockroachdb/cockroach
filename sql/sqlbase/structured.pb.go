...
type TableDescriptor struct {
	...
	CheckExpr        []string              `protobuf:"bytes,20,rep,name=check_expr,json=checkExpr" json:"check_expr,omitempty"`
}
...
func (m *TableDescriptor) GetCheckExpr() []string {
	if m != nil {
		return m.CheckExpr
	}
	return nil
...
func (m *TableDescriptor) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintStructured(data, i, uint64(m.State))
	if len(m.CheckExpr) > 0 {
		for _, s := range m.CheckExpr {
			data[i] = 0xa2
			i++
			data[i] = 0x1
			i++
...
func (m *TableDescriptor) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 20:
			...
			m.CheckExpr = append(m.CheckExpr, string(data[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipStructured(data[iNdEx:])
...
var fileDescriptorStructured = []byte{
	...
	,
}
