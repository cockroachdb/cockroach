...
const (
	...
	// Descriptor was renamed. When this state is detected in a schema change,
	// the record for the old name needs to be deleted.
	TableDescriptor_RENAME TableDescriptor_State = 3
)
...
type TableDescriptor struct {
	...
	// If state == RENAME, these old_* fields are set with the state of the
	// descriptor before the rename.
	OldParentId uint32 `protobuf:"varint,20,opt,name=old_parent_id,json=oldParentId" json:"old_parent_id"`
	OldName     string `protobuf:"bytes,21,opt,name=old_name,json=oldName" json:"old_name"`
}
...
func (m *TableDescriptor) GetOldParentId() uint32 {
	if m != nil {
...
func (m *TableDescriptor) GetOldName() string {
	if m != nil {
		return m.OldName
	}
	return ""
...
func (m *TableDescriptor) Size() (n int) {
	...
	n += 2 + sovStructured(uint64(m.OldParentId))
	l = len(m.OldName)
...
var fileDescriptorStructured = []byte{
	...
	,
}
