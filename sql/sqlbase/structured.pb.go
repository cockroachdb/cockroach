...
func (*IndexDescriptor) Descriptor() ([]byte, []int) { return fileDescriptorStructured, []int{4} }
...
func (*DescriptorMutation) Descriptor() ([]byte, []int) { return fileDescriptorStructured, []int{5} }
...
type InterleaveDescriptor struct {
	// IndexID is the index being interleaved.
	IndexID IndexID `protobuf:"varint,1,opt,name=index_id,json=indexId,casttype=IndexID" json:"index_id"`
	// Components contains the nesting of interleaves in the order they appear in
	// an encoded key. The last element is interleaved into the second to last,
	// and so on.
	Components []InterleaveDescriptor_Component `protobuf:"bytes,2,rep,name=components" json:"components"`
}
...
func (*InterleaveDescriptor) Descriptor() ([]byte, []int) { return fileDescriptorStructured, []int{6} }

type InterleaveDescriptor_Component struct {
	// ParentID the ID of the table being interleaved into.
	...
	// being interleaved, excluding the fields shared between parent and
	...
	// in the index being interleaved. Example:
	// Table 1 -> /a/b
	// Table 2 -> /a/b/c
	// Table 3 -> /a/b/c/d
...
func (m *InterleaveDescriptor_Component) Reset()         { *m = InterleaveDescriptor_Component{} }
func (m *InterleaveDescriptor_Component) String() string { return proto.CompactTextString(m) }
func (*InterleaveDescriptor_Component) ProtoMessage()    {}
func (*InterleaveDescriptor_Component) Descriptor() ([]byte, []int) {
...
type TableDescriptor struct {
	...
	Interleaves []InterleaveDescriptor `protobuf:"bytes,24,rep,name=interleaves" json:"interleaves"`
...
func (m *TableDescriptor) GetInterleaves() []InterleaveDescriptor {
	if m != nil {
		return m.Interleaves
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*InterleaveDescriptor_Component)(nil), "cockroach.sql.sqlbase.InterleaveDescriptor.Component")
...
func (m *DescriptorMutation) MarshalTo(data []byte) (int, error) {
	...
	if m.Descriptor_ != nil {
		nn3, err := m.Descriptor_.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += nn3
...
func (m *InterleaveDescriptor_Component) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *InterleaveDescriptor_Component) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *TableDescriptor) MarshalTo(data []byte) (int, error) {
	...
	n6, err := m.ModificationTime.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n6
	...
	n7, err := m.PrimaryIndex.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n7
	...
	if len(m.Interleaves) > 0 {
		for _, msg := range m.Interleaves {
			data[i] = 0xc2
			i++
			data[i] = 0x1
			i++
...
func (m *InterleaveDescriptor_Component) Size() (n int) {
	var l int
	_ = l
...
func (m *InterleaveDescriptor) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Components = append(m.Components, InterleaveDescriptor_Component{})
...
func (m *InterleaveDescriptor_Component) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *TableDescriptor) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 24:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Interleaves", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Interleaves = append(m.Interleaves, InterleaveDescriptor{})
			if err := m.Interleaves[len(m.Interleaves)-1].Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorStructured = []byte{
	...
	,
}
