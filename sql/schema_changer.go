...
// ErrExistingSchemaChangeLease is returned by AcquireLease() when someone else
// is holding the schema change lock.
var ErrExistingSchemaChangeLease = errors.New(
	"someone else is holding the schema change lock")
