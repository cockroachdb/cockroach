...
// that created the schema change. Occasionally the node dies while
// processing the schema change, and this manager acts as a backup
// execution mechanism  catching those cases.
