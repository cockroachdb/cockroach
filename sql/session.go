...
// Create instances using MakeSession().
type Session struct {
	Database string
	Syntax   int32
...
// SessionArgs contains arguments for creating a new Session with MakeSession().
type SessionArgs struct {
	Database string
	User     string
}

// MakeSession creates and initializes new Session object.
// remote can be nil.
func MakeSession(args SessionArgs, e *Executor, remote net.Addr) *Session {
	s := Session{}
