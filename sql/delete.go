...
type deleteNode struct {
	...
	autoCommit bool
	// The following fields are populated during the first call to
	// Next().
	rows                  planNode
...
func (d *deleteNode) initializePlan() *roachpb.Error {
...
func (d *deleteNode) Next() bool {
	...
	if d.rows == nil {
		// First call: prepare everything.
		if pErr := d.initializePlan(); pErr != nil {
			d.pErr = pErr
			return false
		}
	}
