...
type planner struct {
	...
	// List of schema changer, one for each outstanding
	// schema change, created by commands in the transaction.
	// The executor can execute these schema changers if it is
	// able to acquire the schema change lease for the table.
