...
// For now scanNode implements all the logic and selectNode just defers to it
...
func (n *selectNode) initFrom(p *planner, parsed *parser.Select) error {
	...
	case 1:
		...
		n.err = scan.initTableExpr(p, ate)
		if n.err != nil {
			return n.err
		}
	default:
	...
	n.from, n.err = p.initScanNode(scan, parsed)
	return n.err
}
