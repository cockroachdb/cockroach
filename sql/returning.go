...
func (p *planner) initReturning(r parser.ReturningExprs, alias string, tablecols []ColumnDescriptor) (*affectedNode, qvalMap, error) {
	result := &affectedNode{&valuesNode{}, 0}
	if r == nil {
...
func (p *planner) populateReturning(r parser.ReturningExprs, result *affectedNode, qvals qvalMap, rowVals parser.DTuple) error {
	if r == nil {
		return nil
	}
