...
func (p *planner) makeUpsertHelper(
	...
	helper := &upsertHelper{tableDesc: tableDesc, evalCtx: p.evalCtx, qvals: qvals, evalExprs: normExprs}
	return helper, nil
}
...
func (uh *upsertHelper) eval(
	...
	uh.qvals.populateQVals(uh.tableDesc.Name, existingRow)
	uh.qvals.populateQVals(upsertExcludedTable, insertRow)
