...
func (t *leaseTest) acquire(nodeID uint32, descID csql.ID, version csql.Version) (*csql.LeaseState, error) {
...
func (t *leaseTest) mustAcquire(nodeID uint32, descID csql.ID, version csql.Version) *csql.LeaseState {
