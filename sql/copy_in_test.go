...
// TestCopyInProgress verifies that only one COPY can run at once.
...
// TestCopyInCopy verifies that after a COPY has started another statement
// cannot run.
func TestCopyInCopy(t *testing.T) {
	defer leaktest.AfterTest(t)()
