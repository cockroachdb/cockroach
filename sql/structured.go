...
func (desc *TableDescriptor) makeMutationComplete(m DescriptorMutation) {
	...
	case DescriptorMutation_DROP:
		// Nothing to be done. All the work done to drop the column/index
		// is complete. The column/index has already been removed from the
		// set of column/index descriptors.
	}
}
