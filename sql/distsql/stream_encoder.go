...
// error.
//
// If the message is used (sent), NextMessage must be called. The returned
// message is only valid until that call.
...
// NextMessage resets the row data for the next message.
