...
type DistSQLClient interface {
	...
	// RunSimpleFlow instantiates a flow and returns the results of that flow as a
	// stream. The request must contain one flow, and that flow must have a single
	// mailbox of the special simple response type.
