...
func checkTableData(t *testing.T, kvDB *client.DB, sqlDB *sql.DB, descKey roachpb.Key, desc *csql.Descriptor, state csql.DescriptorMutation_State, e [][]string, revert bool) {
