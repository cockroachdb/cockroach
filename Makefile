...
pkg/roachprod/vm/aws/embedded.go: bin/.bootstrap pkg/roachprod/vm/aws/config.json pkg/roachprod/vm/aws/old.json
	(cd pkg/roachprod/vm/aws/embedded.go && $(GO) generate)
