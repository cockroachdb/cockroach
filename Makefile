...
$(BASE_CGO_FLAGS_FILES): Makefile build/defs.mk.sig | bin/.submodules-initialized
	...
	@echo '// #cgo LDFLAGS: $(addprefix -L,$(CRYPTOPP_DIR) $(PROTOBUF_DIR) $(JEMALLOC_DIR)/lib $(LIBEDIT_DIR)/src/.libs $(KRB_DIR) $(PROJ_DIR)/lib)' >> $@
	@echo 'import "C"' >> $@
...
.PHONY: protoc libcryptopp libjemalloc libprotobuf libgeos libproj libkrb5
protoc:      $(PROTOC)
