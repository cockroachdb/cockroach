...
install: override LDFLAGS += \
	-X "github.com/cockroachdb/cockroach/pkg/build.tag=$(shell build/buildinfo.sh tag)" \
	-X "github.com/cockroachdb/cockroach/pkg/build.utcTime=$(shell date -u '+%Y/%m/%d %H:%M:%S')" \
	-X "github.com/cockroachdb/cockroach/pkg/build.rev=$(shell build/buildinfo.sh rev)"
