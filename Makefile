...
# change.
# These should be synced with `pkg/cmd/import-tools`.
bin/.bootstrap: $(GITHOOKS) vendor | bin/.submodules-initialized
	@$(GO_INSTALL) -v \
...
override xgo := GOFLAGS='-mod=vendor' GOOS=$(XGOOS) GOARCH=$(XGOARCH) CC=$(XCC) CXX=$(XCXX) $(xgo)
endif
...
vendor: go.sum
	go install github.com/otan-cockroach/modvendor
	go mod vendor
	modvendor -copy="**/*.c **/*.h **/*.proto"  -inject 'github.com/grpc-ecosystem/grpc-gateway:github.com/grpc-ecosystem/grpc-gateway/third_party/googleapis/google/api,github.com/grpc-ecosystem/grpc-gateway:github.com/grpc-ecosystem/grpc-gateway/third_party/googleapis/google/rpc,github.com/prometheus/client_model:github.com/prometheus/client_model'
