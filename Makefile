...
pkg/ui/yarn.protobuf.installed: pkg/ui/src/js/package.json pkg/ui/src/js/yarn.lock pkg/ui/yarn.protobufjs-cli.lock | bin/.submodules-initialized
	...
	# reproducable builds.
	$(NODE_RUN) pkg/ui/src/js/bin/gen-protobuf-cli-deps.js > pkg/ui/src/js/node_modules/protobufjs/cli/package.json
	ln -sf ../../../../../yarn.protobufjs-cli.lock pkg/ui/src/js/node_modules/protobufjs/cli/yarn.lock
	$(NODE_RUN) -C pkg/ui/src/js/node_modules/protobufjs/cli yarn install --offline
	touch $@
...
pkg/ui/yarn.installed: pkg/ui/package.json pkg/ui/yarn.lock pkg/ui/yarn.cluster-ui.installed | bin/.submodules-initialized
	$(NODE_RUN) -C pkg/ui yarn install --offline || $(NODE_RUN) -C pkg/ui yarn install --offline
...
PBJS := $(NODE_RUN) pkg/ui/src/js/node_modules/.bin/pbjs
PBTS := $(NODE_RUN) pkg/ui/src/js/node_modules/.bin/pbts
