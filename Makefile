...
C_LIBS_COMMON = \
	...
	$(LIBPROTOBUF) $(LIBSNAPPY) $(LIBPROJ) $(LIBGEOS)
C_LIBS_SHORT = $(C_LIBS_COMMON) $(LIBCRYPTOPP)
C_LIBS_OSS = $(C_LIBS_COMMON) $(LIBROACH) $(LIBROCKSDB)
C_LIBS_CCL = $(C_LIBS_COMMON) $(LIBCRYPTOPP) $(LIBROACHCCL) $(LIBROCKSDB)
