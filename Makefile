...
$(COCKROACH) build go-install gotestdashi: $(C_LIBS_CCL)
...
$(COCKROACH) build buildoss go-install gotestdashi: $(CGO_FLAGS_FILES) $(BOOTSTRAP_TARGET) ui .buildinfo/tag .buildinfo/rev .buildinfo/basebranch
$(COCKROACH) build buildoss go-install gotestdashi: override LINKFLAGS += \
