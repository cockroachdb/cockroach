...
pkg/sql/plpgsql/parser/lexbase/tokens.go: pkg/sql/parser/gen/sql.go.tmp
	(echo "// Code generated by make. DO NOT EDIT."; \
	 echo "// GENERATED FILE DO NOT EDIT"; \
	 echo; \
	 echo "package lexbase"; \
...
pkg/sql/plpgsql/parser/plpgsql-gen.y: pkg/sql/plpgsql/parser/plpgsql.y
...
pkg/sql/plpgsql/parser/lexbase/keywords.go: pkg/sql/plpgsql/parser/gen/plpgsql-gen.y pkg/sql/lexbase/allkeywords/main.go | bin/.bootstrap
	$(GO) run -tags all-keywords pkg/sql/lexbase/allkeywords/main.go < $< > $@.tmp || rm $@.tmp
	mv -f $@.tmp $@
	gofmt -s -w $@
