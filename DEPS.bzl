...
def go_deps():
    ...
    go_repository(
        ...
        sum = "h1:iSWWcgAfvbEVlCWXx3NHvw4oPh3zshjqOwT9DHiuAXE=",
        version = "v0.0.0-20200924231108-71cdee7c3cc7",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:7Mr0IG3PMp/Z/iNN2vCCHdXS4RFzBwi9sr5Km6b2+N4=",
        version = "v0.0.0-20170921033129-f5072df9c550",
    )
    go_repository(
