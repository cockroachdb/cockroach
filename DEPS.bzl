...
def go_deps():
    ...
    go_repository(
        ...
        strip_prefix = "github.com/cockroachdb/pebble@v0.0.0-20241206160845-91e091aa3637",
        urls = [
    ...
    go_repository(
        ...
        sha256 = "26bb88408231046c3e1cc6eac6dad19cde6eecc895ccd97c56ca47306a25a93e",
        strip_prefix = "github.com/DataExMachina-dev/side-eye-go@v0.0.0-20241220191938-9388bafcd06e",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/DataExMachina-dev/side-eye-go/com_github_dataexmachina_dev_side_eye_go-v0.0.0-20241220191938-9388bafcd06e.zip",
        ],
    )
    go_repository(
