...
def go_deps():
    ...
    go_repository(
        ...
        sha256 = "9b52cfa958a352b796ed8a09803234d8f336e6dbb4b774b023389bb51b899594",
        strip_prefix = "github.com/cockroachdb/pebble@v0.0.0-20220311224846-910ce60578df",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/cockroachdb/pebble/com_github_cockroachdb_pebble-v0.0.0-20220311224846-910ce60578df.zip",
        ],
    )
    go_repository(
