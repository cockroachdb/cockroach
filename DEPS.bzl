...
def go_deps():
    ...
    go_repository(
        ...
        sum = "h1:7cjFsEgqTuNh+72+gtpnVTCqTiG0vT86ffETvTxyvUo=",
        version = "v1.0.7",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:SekUYENjk7gp38SJWM7kKuJjZ1EK7dNqE9UjKaCNJD8=",
        version = "v1.17.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:lzPl/30ZLkTveYsYZPKMcgXc8MbnE6RsTd4F9KgiLtk=",
        version = "v8.2.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:l4v5f5zMxqzCwPRRIlL5yCD/REWJ94PrId/ESmRPEDc=",
        version = "v0.4.1-0.20190115100425-713f2944833c",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:JDEmUDtyiLMyMlFwiaDOv2hxUp35497fkwePcLeV7j4=",
        version = "v0.0.0-20200819021114-67c6ae64274f",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:3O0dZNhZdJ7XurqvXJ4FxJ7K4uMIi15PgbvRSlFDRlo=",
        version = "v3.0.0-20201102185109-86185ba20fb7",
    )
    go_repository(
        name = "io_etcd_go_etcd_raft_v3",
        build_file_proto_mode = "disable",
        importpath = "go.etcd.io/etcd/raft/v3",
        sum = "h1:TvQmW4/U4n5WelvdficH3M+iAPlV1txtSw8BC0aMzdE=",
        version = "v3.0.0-20201102185109-86185ba20fb7",
    )
    ...
    go_repository(
        ...
        sum = "h1:Ecr6ZKQU8edcSK19d1HJKnQrQyzxCA4heauBJmygepc=",
        version = "v2.2.0-rc.1.0.20180830030426-1740ce8b3188+incompatible",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:WgqgiQvkiZWz7XLhphjt2GI2GcGCTIZs9jqXMWmH+oc=",
        version = "v0.0.0-20201022201747-fb209a7c41cd",
    )
    go_repository(
