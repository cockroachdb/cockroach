...
def go_deps():
    ...
    go_repository(
        ...
        sha256 = "da2747d1c254d8daacd246c303250640adbcc00d4a7e0c97de4e00dad5d8c1ca",
        strip_prefix = "github.com/cockroachdb/errors@v1.10.1",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/cockroachdb/errors/com_github_cockroachdb_errors-v1.10.1.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        sha256 = "358fa779d76f88f7b2b5efd16c1e0efff601cde6ce67412e8d4221c745823eee",
        strip_prefix = "github.com/cockroachdb/pebble@v0.0.0-20230824192853-9bb0864bdb98",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/cockroachdb/pebble/com_github_cockroachdb_pebble-v0.0.0-20230824192853-9bb0864bdb98.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        # TODO: mirror this repo (to fix, run `./dev generate bazel --mirror`)
        sum = "h1:c+fV23/HDO+M88dTYFg7TFRlxU0scgfdcFrQh/8s5Z8=",
        version = "v1.41.0",
    )
    go_repository(
