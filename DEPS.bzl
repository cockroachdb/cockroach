...
def go_deps():
    ...
    go_repository(
        ...
        sha256 = "979941e7e36765ac87b16a6801cc0982c94c34f2ab1acf194b590a819ccba630",
        strip_prefix = "github.com/cockroachdb/pebble@v0.0.0-20260303212728-d3f67f72ab35",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/cockroachdb/pebble/com_github_cockroachdb_pebble-v0.0.0-20260303212728-d3f67f72ab35.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        sha256 = "cf83c6631710dfac91d7e9d1d8c78775bd6899bedd257fefafe642f6dd1d936f",
        strip_prefix = "github.com/cockroachdb/drpc@v0.0.0-20260309150405-23c6b7f09fe5",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/cockroachdb/drpc/com_github_cockroachdb_drpc-v0.0.0-20260309150405-23c6b7f09fe5.zip",
        ],
    )
    go_repository(
        name = "org_bazil_fuse",
