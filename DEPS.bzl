...
def go_deps():
    ...
    go_repository(
        ...
        sha256 = "b4372973769aeaa78758efe46bc948ca3b8c54a8c998a5e5312fdfbab034f48a",
        strip_prefix = "github.com/cockroachdb/pebble@v0.0.0-20231222152533-1cce3d01f6d9",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/cockroachdb/pebble/com_github_cockroachdb_pebble-v0.0.0-20231222152533-1cce3d01f6d9.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        sha256 = "c9447cced46014bbdfac6c85f500bbff3ed3eed8917d41eee5dbc837bf150904",
        strip_prefix = "github.com/erikgrinaker/raft/v3@v3.0.0-20240105111133-226ef1c2a640",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/erikgrinaker/raft/v3/com_github_erikgrinaker_raft_v3-v3.0.0-20240105111133-226ef1c2a640.zip",
        ],
    )
    go_repository(
        name = "io_goji",
