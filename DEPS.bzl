...
def go_deps():
    ...
    go_repository(
        ...
        sha256 = "696d844e72342f054ca6203e174e69cc6f523ccd3f75e8a320b7884c47e07958",
        strip_prefix = "github.com/cockroachdb/pebble@v0.0.0-20240610203341-9b0824f2cdaa",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/cockroachdb/pebble/com_github_cockroachdb_pebble-v0.0.0-20240610203341-9b0824f2cdaa.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        sha256 = "5903ed6a13df94e1c3b3c15226ed23ebb1b6393c19c5e6ebe0c1123a9fa52db8",
        strip_prefix = "github.com/cockroachdb/swiss@v0.0.0-20240605133600-232b93a2b829",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/cockroachdb/swiss/com_github_cockroachdb_swiss-v0.0.0-20240605133600-232b93a2b829.zip",
        ],
    )
    go_repository(
