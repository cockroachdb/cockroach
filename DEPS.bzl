...
def go_deps():
    ...
    go_repository(
        ...
        sha256 = "0f7c6222243ec56fbf48a633fe8b3df6f6062a41b51fab63a6026e2946b18cc3",
        strip_prefix = "github.com/aws/aws-sdk-go-v2@v1.23.5",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/aws/aws-sdk-go-v2/com_github_aws_aws_sdk_go_v2-v1.23.5.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        sha256 = "79d6035b3cb01535e8092574f4eb4f2c4d0e8f2bb8b4b3af3dfe7fbbe9cfba1e",
        strip_prefix = "github.com/aws/smithy-go@v1.18.1",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/aws/smithy-go/com_github_aws_smithy_go-v1.18.1.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        strip_prefix = "github.com/cockroachdb/pebble@v0.0.0-20231218155426-48b54c29d8fe",
        urls = [
