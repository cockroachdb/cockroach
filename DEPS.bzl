...
def go_deps():
    ...
    go_repository(
        ...
        sum = "h1:yl6xBJcvtrrSedk+xPNUjCdNGq+hGgaJvlUvFHT2uDY=",
        version = "v0.43.3-0.20210705162921-1225dbd1c319",
    )
    ...
    go_repository(
        ...
        sum = "h1://Oxo1osUXF6NSKaA+6M3gO30xN9Anb4Bo0pc/XoZoA=",
        version = "v1.8.3-0.20210603172055-ac729f7067c3",
    )
