...
def go_deps():
    ...
    go_repository(
        ...
        sha256 = "2929dcac3918b9e8a846712a97a3b6cef720f750f9d866a7fc9a39cf03b4f3e7",
        strip_prefix = "github.com/charmbracelet/bubbletea@v0.22.0",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/charmbracelet/bubbletea/com_github_charmbracelet_bubbletea-v0.22.0.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        strip_prefix = "github.com/cockroachdb/pebble@v0.0.0-20220817213320-358f750befa5",
        urls = [
    ...
    go_repository(
        ...
        sha256 = "1bd2807c78460cb5114a65df6c1c03c0cd82546eb59983eb8f64413ff2d98372",
        strip_prefix = "github.com/knz/bubbline@v0.0.0-20220819153353-d28ec61129dc",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/knz/bubbline/com_github_knz_bubbline-v0.0.0-20220819153353-d28ec61129dc.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        strip_prefix = "github.com/rivo/uniseg@v0.3.4",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/rivo/uniseg/com_github_rivo_uniseg-v0.3.4.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        sha256 = "f63d73d483df7a501adb9a6d465cd71531f5bbe1113c909965ccf664570b238a",
        strip_prefix = "golang.org/x/sys@v0.0.0-20220818161305-2296e01440c6",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/golang.org/x/sys/org_golang_x_sys-v0.0.0-20220818161305-2296e01440c6.zip",
        ],
    )
    go_repository(
