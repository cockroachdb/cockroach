...
def go_deps():
    ...
    go_repository(
        ...
        sha256 = "c38bd2461780b85b5a54eb4a14c3c6f8ad67ba213d92677e918f984e29281736",
        strip_prefix = "go.etcd.io/etcd/raft/v3@v3.6.0-alpha.0.0.20220928120404-d379e6221e10",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/go.etcd.io/etcd/raft/v3/io_etcd_go_etcd_raft_v3-v3.6.0-alpha.0.0.20220928120404-d379e6221e10.zip",
        ],
    )
    go_repository(
        name = "io_goji",
