...
def go_deps():
    ...
    go_repository(
        ...
        sum = "h1:GcFgQl7MsBygmeeqXyV1ivrTEmsVz/rdFJaTcltG9ag=",
        version = "v1.8.1",
    )
    go_repository(
        ...
        sum = "h1:qrZINaORyr78syO1zfD4l7r4tZjy0Z1l0sy4jiysyOM=",
        version = "v1.6.1",
    )
    go_repository(
        ...
        sum = "h1:A13QPatmUl41SqUfnuT3V0E3XiNGL6qNTOINbE8cZL4=",
        version = "v1.3.3",
    )
    go_repository(
        ...
        sum = "h1:rc+fRGvlKbeSd9IFhFS1KWBs0XjTkq0CfK5xqyLgIp0=",
        version = "v1.4.1",
    )
    go_repository(
        ...
        sum = "h1:IkqRRUZTKaS16P2vpX+FNc2jq3JWa3c478gykQp4ow4=",
        version = "v1.2.1",
    )
    go_repository(
        ...
        sum = "h1:amBnPTRG9rrvfk1OEUJq3HpaB4wC+E0KWsZWIsvVvjM=",
        version = "v1.14.0",
    )
    go_repository(
        ...
        sum = "h1:BmBI3WE3zQYAKafyNhtgvOh7w2KT6pG2WXvGhV5J0IY=",
        version = "v1.8.1",
    )
    go_repository(
        ...
        sum = "h1:VxFCgxsqWe7OThOwJ5IpFX3xrObtuIH9Hg/NW7oot1Y=",
        version = "v1.2.3",
    )
    go_repository(
        ...
        sum = "h1:K2gCnGvAASpz+jqP9iyr+F/KNjmTYf8aWOtTQzhmZ5w=",
        version = "v1.3.3",
    )
    go_repository(
        ...
        sum = "h1:l504GWCoQi1Pk68vSUFGLmDIEMzRfVGNgLakDK+Uj58=",
        version = "v1.6.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:mdXu4r70lQky9rbOBtodOuYDDK/VKEGVK3FLdhTGkFc=",
        version = "v1.4.6",
    )
    ...
    go_repository(
        ...
        sum = "h1:LX55ObGRfG+53/1KRKTvCfqC1U2Htf7KgkPBpIVhuUM=",
        version = "v0.20.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:pFPUZsiIbZ20kLUcuCGeuQWG735fPMxW7wHF9BWlnQU=",
        version = "v0.20.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Yo2bneoGy68A7aNwmuETFnPhjyBEm7n3vzRacEVMjvI=",
        version = "v1.5.0",
    )
    go_repository(
        ...
        sum = "h1:WC4594Wp/LkEeML/OdQKEC1yqBmEYkRp6i7X5u0zDAs=",
        version = "v0.5.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:yJoyfZXo4Pk2p/M/viW+YLibBFiIbKoP79gu7kDAFP0=",
        version = "v0.9.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:q7hY+WNJTcSqJNGwJzXZYL++nWBaoKlKdgZOyY6jxz4=",
    ...
    go_repository(
        ...
        sum = "h1:mtX2D0ta3lWxCvv276VVIH6mMYzm4jhSfYP70ZJSOQU=",
        version = "v1.1.2-0.20180806203336-f20d4c4d746f",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:VqVU3dsTLGDa5pW74b+xG1lvKltt4EZIUrFPeKOqV2s=",
        version = "v0.0.0-20210514180818-737f94c0881e",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Ati8dO7+U7mxpkPSxBZQEvzHVUYB/MqCklCN8ig5w/o=",
        version = "v0.0.0-20210810183815-faf39c7919d5",
    )
    go_repository(
