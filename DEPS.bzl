...
def go_deps():
    ...
    go_repository(
        ...
        sha256 = "4ac5c6f2c23ebcf140bec1644425521f1db49008f7aa944379576690bbd13072",
        strip_prefix = "github.com/onsi/gomega@v1.31.1",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/onsi/gomega/com_github_onsi_gomega-v1.31.1.zip",
        ],
    )
    go_repository(
