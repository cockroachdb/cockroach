...
def go_deps():
    ...
    go_repository(
        ...
        strip_prefix = "github.com/cockroachdb/pebble@v0.0.0-20241125211801-f5057c948b65",
        urls = [
    ...
    go_repository(
        ...
        sha256 = "7a91982c93816b187308f345fe56f892a3f7069b69c6da3c5657576dbd8c16d3",
        strip_prefix = "github.com/grpc-ecosystem/grpc-gateway/v2@v2.11.3",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/grpc-ecosystem/grpc-gateway/v2/com_github_grpc_ecosystem_grpc_gateway_v2-v2.11.3.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        sha256 = "00eb74fb4c04d70162caec61973540ec292bff3b8875a3170af8b1ffdbee41f1",
        strip_prefix = "go.opentelemetry.io/proto/otlp@v0.19.0",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/go.opentelemetry.io/proto/otlp/io_opentelemetry_go_proto_otlp-v0.19.0.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        sha256 = "a7443fc1663da3cf828bacefb83f10b511100c225d2a4dfde1db4c31b6b8bb01",
        strip_prefix = "google.golang.org/genproto/googleapis/bytestream@v0.0.0-20241202173237-19429a94021a",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/google.golang.org/genproto/googleapis/bytestream/org_golang_google_genproto_googleapis_bytestream-v0.0.0-20241202173237-19429a94021a.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/golang.org/x/crypto/org_golang_x_crypto-v0.27.0.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        sha256 = "fec08ca53c4f3ddb0a81a0bfed2f7d36a6b2867d25380e4cc021c746fe4b722f",
        strip_prefix = "golang.org/x/net@v0.29.0",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/golang.org/x/net/org_golang_x_net-v0.29.0.zip",
        ],
    )
    go_repository(
        ...
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/golang.org/x/oauth2/org_golang_x_oauth2-v0.23.0.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        sha256 = "95e485046cac79d164d4d35a13e93b2a866a1ac2148184c37ca71514ddd94a52",
        strip_prefix = "golang.org/x/sys@v0.25.0",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/golang.org/x/sys/org_golang_x_sys-v0.25.0.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/golang.org/x/term/org_golang_x_term-v0.24.0.zip",
        ],
    )
    go_repository(
