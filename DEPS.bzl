...
def go_deps():
    ...
    go_repository(
        ...
        sha256 = "59cb40f465ac593ea2bed827484b507d1683a95f95d13f95ed9ffbebd2326167",
        strip_prefix = "github.com/charmbracelet/bubbles@v0.13.1-0.20220902203015-13f52d678d31",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/charmbracelet/bubbles/com_github_charmbracelet_bubbles-v0.13.1-0.20220902203015-13f52d678d31.zip",
        ],
    )
    go_repository(
        ...
        sha256 = "872dc65c441f2b139c5a46183370b15b431f9439522d6f49f3da0d5073d8cd06",
        strip_prefix = "github.com/charmbracelet/bubbletea@v0.22.2-0.20220830200705-989d49f3e69f",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/charmbracelet/bubbletea/com_github_charmbracelet_bubbletea-v0.22.2-0.20220830200705-989d49f3e69f.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        sha256 = "9f48bf9e3f9f73b5d6cc6788d87dc9e1448e34bbe5f1f0179f22ce93c3060602",
        strip_prefix = "github.com/charmbracelet/lipgloss@v0.5.0",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/charmbracelet/lipgloss/com_github_charmbracelet_lipgloss-v0.5.0.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        strip_prefix = "github.com/cockroachdb/pebble@v0.0.0-20220829152249-c2dc3de22e91",
        urls = [
    ...
    go_repository(
        ...
        sha256 = "258d8ad8ec7f456dbe7b68f5ee937b161871e7e638de15ecf5cb88ad0888c665",
        strip_prefix = "github.com/knz/bubbline@v0.0.0-20220905093408-09ca7aa84505",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/knz/bubbline/com_github_knz_bubbline-v0.0.0-20220905093408-09ca7aa84505.zip",
        ],
    )
    go_repository(
        ...
        sha256 = "58e9a746973f191f7a36aeaa70230a203b420451742b9d9c48a7dec05295442f",
        strip_prefix = "github.com/knz/catwalk@v0.1.0",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/knz/catwalk/com_github_knz_catwalk-v0.1.0.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        strip_prefix = "github.com/mattn/go-runewidth@v0.0.13",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/mattn/go-runewidth/com_github_mattn_go_runewidth-v0.0.13.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        sha256 = "a8552b4ba6fc57b5a905dbac412bd55fb2940595ef35115a83512e448f687a5f",
        strip_prefix = "github.com/muesli/termenv@v0.12.0",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/muesli/termenv/com_github_muesli_termenv-v0.12.0.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        sha256 = "4b124798027190646fbaafc10ae0a31c0bfc025352f30e6b92282bcee99c0e04",
        strip_prefix = "github.com/cockroachdb/uniseg@v0.3.4",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/cockroachdb/uniseg/com_github_cockroachdb_uniseg-v0.3.4.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        sha256 = "71d4baca5c8f5ba665560e1bd96e3f73187d73d7dbc8f4a26faa73e5865b0749",
        strip_prefix = "golang.org/x/sync@v0.0.0-20220513210516-0976fa681c29",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/golang.org/x/sync/org_golang_x_sync-v0.0.0-20220513210516-0976fa681c29.zip",
        ],
    )
    go_repository(
        ...
        sha256 = "fde041b0470174e874db66e5dce94ca6a9b0ac0b553982f21175826459b61efe",
        strip_prefix = "golang.org/x/sys@v0.0.0-20220825204002-c680a09ffe64",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/golang.org/x/sys/org_golang_x_sys-v0.0.0-20220825204002-c680a09ffe64.zip",
        ],
    )
    go_repository(
        ...
        sha256 = "56fa4c44da3c61a77a894a9d5fa5603e0d203ca1cc23ec1f42d4e9fcfbd4c53b",
        strip_prefix = "golang.org/x/term@v0.0.0-20220722155259-a9ba230a4035",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/golang.org/x/term/org_golang_x_term-v0.0.0-20220722155259-a9ba230a4035.zip",
        ],
    )
    go_repository(
