...
def go_deps():
    ...
    go_repository(
        ...
        sha256 = "6c739327d027b2e6573ae5fe3de501ad1e3691af6a9e7f34541944010f142f27",
        strip_prefix = "github.com/google/go-cmp@v0.5.7",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/google/go-cmp/com_github_google_go_cmp-v0.5.7.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        sha256 = "4d34bd7f9d9c402c2e13f75383f8c9984d64394df61c48f49449082880af4d66",
        strip_prefix = "github.com/googleapis/gax-go/v2@v2.3.0",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/googleapis/gax-go/v2/com_github_googleapis_gax_go_v2-v2.3.0.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        sha256 = "bf28558914c5083102facd3e1c602f14eb043cd10751c337c4413d3cf5c5dc86",
        strip_prefix = "github.com/jackc/pgx/v4@v4.16.0",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/jackc/pgx/v4/com_github_jackc_pgx_v4-v4.16.0.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        sha256 = "b888a22240f32a46b5c3ea464afd3fd8cda2653bb69d3096dd09cd9602b38fcd",
        strip_prefix = "cloud.google.com/go/compute@v1.6.0",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/cloud.google.com/go/compute/com_google_cloud_go_compute-v1.6.0.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        sha256 = "ff7ee199b1d7d3e4034d6ddce326d130ff77d9598ca4cf59669f97dc3d6b0f8c",
        strip_prefix = "google.golang.org/api@v0.75.0",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/google.golang.org/api/org_golang_google_api-v0.75.0.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        sha256 = "02bfaedd488f1347476a9d039ab410d3fd1515f4ccebe70e92eaad47f49efe2c",
        strip_prefix = "google.golang.org/genproto@v0.0.0-20220414192740-2d67ff6cf2b4",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/google.golang.org/genproto/org_golang_google_genproto-v0.0.0-20220414192740-2d67ff6cf2b4.zip",
        ],
    )
    go_repository(
        ...
        sha256 = "d00abfad4f0d71818f16e0323925dc093bdfc3417f22bc2f73916df7c3d9556e",
        strip_prefix = "google.golang.org/grpc@v1.45.0",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/google.golang.org/grpc/org_golang_google_grpc-v1.45.0.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        sha256 = "fd3b43831166c2b554d62e5217776a8de08ec35bad8f31169a8f98f9bca12e55",
        strip_prefix = "golang.org/x/net@v0.0.0-20220412020605-290c469a71a5",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/golang.org/x/net/org_golang_x_net-v0.0.0-20220412020605-290c469a71a5.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        sha256 = "ffb4b3488ab203e6a883355e57fd1c4a84983c41fb0880ef520587863d47219c",
        strip_prefix = "golang.org/x/sys@v0.0.0-20220412211240-33da011f77ad",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/golang.org/x/sys/org_golang_x_sys-v0.0.0-20220412211240-33da011f77ad.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        sha256 = "74da8691af0731e342692d53b91af7a0b8b1d7ce509eccc4fc6fddde4fecfcd1",
        strip_prefix = "golang.org/x/xerrors@v0.0.0-20220411194840-2f41105eb62f",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/golang.org/x/xerrors/org_golang_x_xerrors-v0.0.0-20220411194840-2f41105eb62f.zip",
        ],
    )
    go_repository(
