...
def go_deps():
    ...
    go_repository(
        ...
        sha256 = "96dc47ce22ee724cf1a213c957326f602e98e22d601704754a80b4f1ca8188e3",
        strip_prefix = "github.com/cockroachdb/pebble@v0.0.0-20230510135629-fe7ae7a62e0f",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/cockroachdb/pebble/com_github_cockroachdb_pebble-v0.0.0-20230510135629-fe7ae7a62e0f.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        sha256 = "4592f2cdf6a1abab5e6ce3aff5c1f05ba0c6f73fb2f9c20e097ece5c6cec036f",
        strip_prefix = "go.etcd.io/raft/v3@v3.0.0-20230518105827-4967cffe43c1",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/go.etcd.io/raft/v3/io_etcd_go_raft_v3-v3.0.0-20230518105827-4967cffe43c1.zip",
        ],
    )
    go_repository(
        name = "io_goji",
