...
def go_deps():
    ...
    go_repository(
        ...
        sum = "h1:uGzqGUGvaSJ3APz5BmLFw1LpSTnB9o+EzE5fI3rBbJI=",
        version = "v1.17.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:NBxB1XxiWpGqkPUiJ9PoBXkHV5A9+GohMOA+EmWoPbU=",
    ...
    go_repository(
        ...
        sum = "h1:Xj+JO91noE97IN6F/7WZxzC5QE6yENAQPrwIYhW3bsA=",
