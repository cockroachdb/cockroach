...
def go_deps():
    ...
    go_repository(
        ...
        sum = "h1:qA5V5+uQf6Mgr+tmFI8UT3D/ELyhIYkPwNGao/3Y+sQ=",
        version = "v0.77.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:1cKjpk2kD02zsadTfPyHzxHEjHdnvvZCttQVhEEXkOQ=",
        version = "v0.0.0-20210217184607-1b75f7144df2",
    )
    ...
    go_repository(
        ...
        sum = "h1:BaN3BAqnopnKjvl+15DYP6LLrbBHfbfmlFYzmFj/Q9Q=",
        version = "v0.0.0-20210113205817-d3ed898aa8a3",
    )
    go_repository(
