...
def go_deps():
    ...
    go_repository(
        ...
        sha256 = "d2849180bf5e269fb55dd05ac090536367c753676cf8d48a62a6dd0c3109de29",
        strip_prefix = "go.etcd.io/raft/v3@v3.0.0-20221216114228-91eb7518afb5",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/go.etcd.io/raft/v3/io_etcd_go_raft_v3-v3.0.0-20221216114228-91eb7518afb5.zip",
        ],
    )
    go_repository(
        name = "io_goji",
