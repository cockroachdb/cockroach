...
def go_deps():
    ...
    go_repository(
        ...
        sha256 = "a3d0518c9c3433d1bb1e57679cc9dda9a3d5dcad2b7bd4c282ca263337aba53c",
        strip_prefix = "github.com/cockroachdb/pebble@v0.0.0-20250327213305-cafb179340d9",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/cockroachdb/pebble/com_github_cockroachdb_pebble-v0.0.0-20250327213305-cafb179340d9.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        sha256 = "b3b0dc8e5f05cc9cfa06533f1f59db3cae918943d7e9881745705f3ac74ef2d2",
        strip_prefix = "golang.org/x/image@v0.25.0",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/golang.org/x/image/org_golang_x_image-v0.25.0.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        strip_prefix = "golang.org/x/net@v0.37.0",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/golang.org/x/net/org_golang_x_net-v0.37.0.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        sha256 = "6e1c27b6df84f711dcd0933e9082a2a1ef0be46147feb721bf9f74ef8df30c61",
        strip_prefix = "golang.org/x/perf@v0.0.0-20250305200902-02a15fd477ba",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/golang.org/x/perf/org_golang_x_perf-v0.0.0-20250305200902-02a15fd477ba.zip",
        ],
    )
    go_repository(
