...
def go_deps():
    ...
    go_repository(
        ...
        sha256 = "eb8a7668eab08f0a7845ba34c7de6b00e7caf83eb26b67dd79366c8302c38b50",
        strip_prefix = "github.com/nvanbenschoten/etcd/raft/v3@v3.0.0-20220826205122-68e4f4f51143",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/nvanbenschoten/etcd/raft/v3/com_github_nvanbenschoten_etcd_raft_v3-v3.0.0-20220826205122-68e4f4f51143.zip",
        ],
    )
    go_repository(
        name = "io_goji",
