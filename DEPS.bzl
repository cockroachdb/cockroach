...
def go_deps():
    ...
    go_repository(
        ...
        sha256 = "7613dfbcdba4563cc2c1715057aff403717083a2bae9129c87f92bcec2f56d3d",
        strip_prefix = "golang.org/x/net@v0.0.0-20221017152216-f25eb7ecb193",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/golang.org/x/net/org_golang_x_net-v0.0.0-20221017152216-f25eb7ecb193.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        sha256 = "90ea00ad812be6819bb4963bda5ea62beee71aee00f437e9320a33cc14bab768",
        strip_prefix = "golang.org/x/sys@v0.0.0-20221010170243-090e33056c14",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/golang.org/x/sys/org_golang_x_sys-v0.0.0-20221010170243-090e33056c14.zip",
        ],
    )
    go_repository(
