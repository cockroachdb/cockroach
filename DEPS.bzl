...
def go_deps():
    ...
    go_repository(
        ...
        sha256 = "fa3c2af06d47a151cbab65b166b6a890fdf5300c232117b717708b71aa842945",
        strip_prefix = "github.com/cockroachdb/errors@v1.8.7",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/cockroachdb/errors/com_github_cockroachdb_errors-v1.8.7.zip",
        ],
    )
    go_repository(
