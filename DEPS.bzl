...
def go_deps():
    ...
    go_repository(
        ...
        sum = "h1:91KsdC7buTs1uuZPv7hdIe1587xxe+MY6lxAbz/wmOQ=",
        version = "v0.0.0-20211012165517-0ee4290cea22",
    )
    ...
    go_repository(
        ...
        sum = "h1:kvwiyEkiUT/JaadXzVLI/R1wDO934A7r3Bs2wEe6wqA=",
        version = "v1.0.0-RC3",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:iRMkET+EmJUn5mW0hJzygBraXRmrUwzbOtNvTCh/oKs=",
        version = "v1.0.0-RC3",
    )
    go_repository(
        ...
        sum = "h1:9F0ayEvlxv8BmNmPbU005WK7hC+7KbOazCPZjNa1yME=",
        version = "v1.0.0-RC3",
    )
