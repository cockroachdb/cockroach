...
def go_deps():
    ...
    go_repository(
        ...
        strip_prefix = "github.com/cockroachdb/crlib@v0.0.0-20241015224233-894974b3ad94",
        urls = [
    ...
    go_repository(
        ...
        strip_prefix = "github.com/cockroachdb/pebble@v0.0.0-20241016162652-8b6d64f23a33",
        urls = [
