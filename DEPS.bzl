...
def go_deps():
    ...
    go_repository(
        ...
        sum = "h1:aGvdaR0v1t9XLgjtBYwxcBvBOTMqClzwE26CHOgjW1Y=",
        version = "v0.15.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:XtuXmOLIXLjiU2XduuWREDT0LOKtSgos/g7i7RYyoZQ=",
        version = "v0.3.0",
    )
    ...
    go_repository(
        ...
        sum = "h1:kETrAMYZq6WVGPa8IIixL0CaEcIUNi+1WX7grUoi3y8=",
