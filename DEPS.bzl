...
def go_deps():
    ...
    go_repository(
        ...
        sha256 = "aafd887ce53e6381cab1a65d36b57569711ee3b2a2e5be29b70260d1061c1aa6",
        strip_prefix = "github.com/cockroachdb/pebble@v0.0.0-20230712164403-3b12109b5013",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/cockroachdb/pebble/com_github_cockroachdb_pebble-v0.0.0-20230712164403-3b12109b5013.zip",
        ],
    )
    go_repository(
    ...
    go_repository(
        ...
        sha256 = "2f3aedf52b904dd9450076bd1edc75e398fe48412bbd9bc2b527da0bdae6b498",
        strip_prefix = "github.com/cockroachdb/etcd/raft/v3@v3.0.0-20230718104326-dbe02a550754",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/cockroachdb/etcd/raft/v3/com_github_cockroachdb_etcd_raft_v3-v3.0.0-20230718104326-dbe02a550754.zip",
        ],
    )
    go_repository(
        name = "io_goji",
