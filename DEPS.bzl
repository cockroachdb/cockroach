...
def go_deps():
    ...
    go_repository(
        ...
        sha256 = "600e75e50137c542ece0b3c432fb809b445959bc63e84c7b4ff59d8e920af307",
        strip_prefix = "github.com/cockroachdb/pebble@v0.0.0-20240611041800-00ad6bf02676",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/cockroachdb/pebble/com_github_cockroachdb_pebble-v0.0.0-20240611041800-00ad6bf02676.zip",
        ],
    )
    go_repository(
