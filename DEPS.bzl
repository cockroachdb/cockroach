...
def go_deps():
    ...
    go_repository(
        ...
        sha256 = "910f38c81b2924ffcee6585a4fd4491c9a54bdb0dfc10c100513db19f997572f",
        strip_prefix = "github.com/cockroachdb/drpc@v0.0.0-20250529054554-aef0a2a83a53",
        urls = [
            "https://storage.googleapis.com/cockroach-godeps/gomod/github.com/cockroachdb/drpc/com_github_cockroachdb_drpc-v0.0.0-20250529054554-aef0a2a83a53.zip",
        ],
    )
    go_repository(
