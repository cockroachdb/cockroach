...
func TestSequenceCachePutGetClearData(t *testing.T) {
	...
	const seq = 123
	if err := sc.PutSequence(e, testTxnID, testTxnEpoch, seq, testTxnKey, testTxnTimestamp, nil); err != nil {
	...
	if err := sc.PutSequence(e, testTxnID, testTxnEpoch, 2*seq, testTxnKey, testTxnTimestamp, nil); err != nil {
		t.Errorf("unexpected error putting response: %s", err)
	}
	tryHit(2*seq, testTxnEpoch)

	if err := sc.PutSequence(e, testTxnID, 2*testTxnEpoch, 2*seq, testTxnKey, testTxnTimestamp, nil); err != nil {
		t.Errorf("unexpected error putting response: %s", err)
	}

	tryHit(2*seq, 2*testTxnEpoch)

	if err := sc.PutSequence(e, testTxnID, testTxnEpoch-1, 2*seq, testTxnKey, testTxnTimestamp, nil); err != nil {
		t.Errorf("unexpected error putting response: %s", err)
	}
...
func TestSequenceCacheEmptyParams(t *testing.T) {
	...
	if err := sc.PutSequence(e, testTxnID, testTxnEpoch, 0, testTxnKey, testTxnTimestamp, nil); err != errEmptyID {
		t.Errorf("unexpected error putting response: %v", err)
	}
	if err := sc.PutSequence(e, nil, testTxnEpoch, 10, testTxnKey, testTxnTimestamp, nil); err != errEmptyID {
		t.Errorf("unexpected error putting response: %v", err)
	}
...
func TestSequenceCacheCopyInto(t *testing.T) {
	...
	if err := rc1.PutSequence(e, testTxnID, testTxnEpoch, seq, testTxnKey, testTxnTimestamp, nil); err != nil {
		t.Errorf("unexpected error putting response: %s", err)
	}
