...
// by Cockroach for the efficient accumulation of certain values. Due
// to the difficulty of making these operations transactional, merges
// are not currently exposed directly to clients. Merged values are
// explicitly not MVCC data.
