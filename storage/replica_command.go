...
func (r *Replica) splitTrigger(
	...
	batch.Defer(func() {
		...
		// Try to add both the original and new range to the replicate queue. We
		// try both ranges because the replicate queue only processes replicas that
		// do not require splits.
