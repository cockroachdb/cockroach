...
func (r *Replica) TruncateLog(
	...
	if _, _, err := engine.MVCCDeleteRange(ctx, batch, &diff, start, end, 0, /* max */
...
func (r *Replica) mergeTrigger(
	...
	if _, _, err := engine.MVCCDeleteRange(ctx, batch, nil, localRangeIDKeyPrefix, localRangeIDKeyPrefix.PrefixEnd(), 0, hlc.ZeroTimestamp, nil, false); err != nil {
