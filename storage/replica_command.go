...
// a replica is divided into three phases. The first phase, which occurs in
...
// raft.RawNode.ProposeConfChange). When this phase completes, the replica
// change has been enacted on the Raft group. If a new replica was added the
// raft leader will start sending it heartbeat messages and attempting to bring
// it up to date.
//
...
//
// TODO(peter): Why does a removed replica receive the EndTransaction
// containing the ChangeReplicasTrigger? Is this accidental or guaranteed by
// Raft?
//
...
// applied.
//
// TODO(peter): What happens if the replica is brought up to date via Raft log
// entries?
//
