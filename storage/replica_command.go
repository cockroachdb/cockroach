...
func (r *Replica) Scan(
	...
	if numKeys == maxKeys {
		...
		span.Key = args.EndKey
	}
	return roachpb.ScanResponse{Rows: rows}, span, numKeys, intentsToTrigger(intents, &args), err
}
...
func (r *Replica) ReverseScan(
	...
	if numKeys == maxKeys {
		...
		span.EndKey = args.Key
	}
	return roachpb.ReverseScanResponse{Rows: rows}, span, numKeys, intentsToTrigger(intents, &args), err
}
