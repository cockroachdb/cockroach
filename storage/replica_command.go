...
func (r *Replica) TransferLease(
	...
	return r.applyNewLeaseLocked(ctx, batch, ms, args.Lease, true /* isTransfer */)
}
...
//
// isTransfer should be set if the lease holder changes with this lease.
// If it doesn't, we don't need a PostCommitTrigger that synchronizes with
// reads.
//
