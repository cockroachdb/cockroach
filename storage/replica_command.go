...
// sibling. An interesting subtlety here: A will send a snapshot to B and C
// because when range 2 is initialized it starts at Raft log index 10. This
// causes Raft to believe that there is a discarded prefix to the log and will
// thus send a snapshot to followers instead of log entries (or worse,
// pretending that the range is empty and thus allow it to start processing
// requests).
//
