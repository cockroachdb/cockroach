...
func (r *Replica) beginCmds(ba *roachpb.BatchRequest) func(*roachpb.BatchResponse, *roachpb.Error) *roachpb.Error {
	...
	return func(br *roachpb.BatchResponse, pErr *roachpb.Error) *roachpb.Error {
		return r.endCmds(cmdKeys, ba, br, pErr)
	}
}
...
func (r *Replica) endCmds(cmdKeys []interface{}, ba *roachpb.BatchRequest, br *roachpb.BatchResponse, pErr *roachpb.Error) (rErr *roachpb.Error) {
	r.mu.Lock()
	if r.mu.frozen && pErr == nil {
		...
		defer func() {
			if err := frozenWaitTrigger(r, *br, r.mu.appliedIndex); err != nil {
