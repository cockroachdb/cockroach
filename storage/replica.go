...
func (r *Replica) executeWriteBatch(
	...
	if ba.Txn == nil || r.store.TestingKnobs().DisableOnePhaseCommits ||
		!ba.IsOnePhaseCommit() || ba.Txn.WriteTooOld ||
	...
	if pErr == nil && ba.Timestamp == br.Timestamp {
		...
		br.Responses = append(br.Responses, roachpb.ResponseUnion{EndTransaction: &roachpb.EndTransactionResponse{}})
