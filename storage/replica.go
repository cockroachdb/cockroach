...
// supplied function should return true for the unquiesce argument if the
// replica should be unquiesced. See handleRaftReady for an instance of where
// this value varies. The shouldCampaign argument indicates whether a new raft
// group should be campaigned upon creation and is used to eagerly campaign
// idle replicas.
func (r *Replica) withRaftGroupLocked(
	shouldCampaign bool, f func(r *raft.RawNode) (unquiesce bool, _ error)) error {
...
func (r *Replica) withRaftGroup(f func(r *raft.RawNode) (unquiesce bool, _ error)) error {
	r.mu.Lock()
	defer r.mu.Unlock()
...
// proposing a raft command, it wakes the leader by sending an empty message
// proposal. This acts a failsafe against bugs in which a follower is left
// unquiesced while the leader is quiesced.
//
