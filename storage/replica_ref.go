...
// ReplicaRef is a container that manages references to a *Replica. The
// Acquire() method must be called to receive a *Replica and returns a closure
// that releases it. Similarly, AcquireExclusive() returns a *Replica with
