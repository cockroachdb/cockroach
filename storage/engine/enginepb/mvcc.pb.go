...
type MVCCStats struct {
	...
	// when necessary.
	//
	// TODO(nvanbenschoten) When we adjust this stats object, we should set this
	// to true for all stats during a migration to force full recomputation on
	// splits, otherwise the previously computed stats calculations could be off,
	// which will never be corrected. See #5690.
...
var fileDescriptorMvcc = []byte{
	...
	,
}
