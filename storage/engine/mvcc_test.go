...
func TestMVCCDeleteRange(t *testing.T) {
	...
	deleted, resumeKey, num, err = MVCCDeleteRange(
		context.Background(), engine, nil, testKey4, keyMax, 0, makeTS(2, 0), nil, false,
	)
	if err != nil {
		t.Fatal(err)
	}
	...
	deleted, resumeKey, num, err = MVCCDeleteRange(
		context.Background(), engine, nil, keyMin, testKey2, 0, makeTS(2, 0), nil, false,
	)
	if err != nil {
		t.Fatal(err)
	}
...
func TestMVCCDeleteRangeReturnKeys(t *testing.T) {
	...
	deleted, resumeKey, num, err = MVCCDeleteRange(
		context.Background(), engine, nil, testKey4, keyMax, 0, makeTS(2, 0), nil, true,
	)
	if err != nil {
		t.Fatal(err)
	}
	...
	deleted, resumeKey, num, err = MVCCDeleteRange(
		context.Background(), engine, nil, keyMin, testKey2, 0, makeTS(2, 0), nil, true,
	)
	if err != nil {
		t.Fatal(err)
	}
...
func TestMVCCDeleteRangeFailed(t *testing.T) {
	...
	_, _, _, err = MVCCDeleteRange(context.Background(), engine, nil, testKey2, testKey4, 0, makeTS(1, 0), nil, false)
	if err == nil {
		t.Fatal("expected error on uncommitted write intent")
	}

	txn.Sequence++
	_, _, _, err = MVCCDeleteRange(context.Background(), engine, nil, testKey2, testKey4, 0, makeTS(1, 0), &txn, false)
	if err != nil {
		t.Fatal(err)
	}
}
...
func TestMVCCDeleteRangeConcurrentTxn(t *testing.T) {
	...
	_, _, _, err = MVCCDeleteRange(context.Background(), engine, nil, testKey2, testKey4, 0, makeTS(1, 0), txn1, false)
	if err == nil {
		t.Fatal("expected error on uncommitted write intent")
	}
}
