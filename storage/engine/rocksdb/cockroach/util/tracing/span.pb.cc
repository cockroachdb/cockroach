...
void protobuf_AssignDesc_cockroach_2futil_2ftracing_2fspan_2eproto() {
  ...
  static const int WireSpan_offsets_[2] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(WireSpan, attributes_),
  };
...
void protobuf_AddDesc_cockroach_2futil_2ftracing_2fspan_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "utes\030\002 \001(\014B\tZ\007tracingX\000b\006proto3", 151);
...
const int WireSpan::kAttributesFieldNumber;
...
// optional bytes attributes = 2;
void WireSpan::clear_attributes() {
  attributes_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
 const ::std::string& WireSpan::attributes() const {
 ...
 void WireSpan::set_attributes(const ::std::string& value) {
 ...
 void WireSpan::set_attributes(const char* value) {
 ...
 void WireSpan::set_attributes(const void* value, size_t size) {
 ...
 ::std::string* WireSpan::mutable_attributes() {
 ...
 ::std::string* WireSpan::release_attributes() {
  
  return attributes_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
 void WireSpan::set_allocated_attributes(::std::string* attributes) {
  if (attributes != NULL) {
