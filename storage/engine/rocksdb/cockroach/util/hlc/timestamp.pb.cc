...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_cockroach_2futil_2fhlc_2ftimestamp_2eproto);
}
...
void protobuf_AddDesc_cockroach_2futil_2fhlc_2ftimestamp_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\"cockroach/util/hlc/timestamp.proto\022\022co"
    "ckroach.util.hlc\032\024gogoproto/gogo.proto\"E"
    "\n\tTimestamp\022\027\n\twall_time\030\001 \001(\003B\004\310\336\037\000\022\025\n\007"
    "logical\030\002 \001(\005B\004\310\336\037\000:\010\230\240\037\000\270\240\037\001B\005Z\003hlcX\000", 158);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "cockroach/util/hlc/timestamp.proto", &protobuf_RegisterTypes);
...
::google::protobuf::uint8* Timestamp::SerializeWithCachedSizesToArray(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:cockroach.util.hlc.Timestamp)
  // optional int64 wall_time = 1;
  if (has_wall_time()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:cockroach.util.hlc.Timestamp)
  return target;
}
...
// @@protoc_insertion_point(generalized_merge_from_start:cockroach.util.hlc.Timestamp)
  if (GOOGLE_PREDICT_FALSE(&from == this)) MergeFromFail(__LINE__);
  const Timestamp* source = 
      ::google::protobuf::internal::DynamicCastToGenerated<const Timestamp>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:cockroach.util.hlc.Timestamp)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:cockroach.util.hlc.Timestamp)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:cockroach.util.hlc.Timestamp)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
