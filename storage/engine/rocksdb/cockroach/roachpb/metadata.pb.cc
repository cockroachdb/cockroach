...
void protobuf_ShutdownFile_cockroach_2froachpb_2fmetadata_2eproto() {
  ...
  delete ReplicaIdentifier::default_instance_;
...
void protobuf_AddDesc_cockroach_2froachpb_2fmetadata_2eproto() {
  ...
  ReplicaIdentifier::default_instance_ = new ReplicaIdentifier();
  ...
  ReplicaIdentifier::default_instance_->InitAsDefaultInstance();
...
static ::std::string* MutableUnknownFieldsForReplicaIdentifier(
    ReplicaIdentifier* ptr) {
  return ptr->mutable_unknown_fields();
}

#if !defined(_MSC_VER) || _MSC_VER >= 1900
const int ReplicaIdentifier::kRangeIdFieldNumber;
const int ReplicaIdentifier::kReplicaFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900

ReplicaIdentifier::ReplicaIdentifier()
  : ::google::protobuf::MessageLite(), _arena_ptr_(NULL) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:cockroach.roachpb.ReplicaIdentifier)
}

void ReplicaIdentifier::InitAsDefaultInstance() {
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
...
ReplicaIdentifier::ReplicaIdentifier(const ReplicaIdentifier& from)
  : ::google::protobuf::MessageLite(),
    _arena_ptr_(NULL) {
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:cockroach.roachpb.ReplicaIdentifier)
}

void ReplicaIdentifier::SharedCtor() {
  ::google::protobuf::internal::GetEmptyString();
  _cached_size_ = 0;
  _unknown_fields_.UnsafeSetDefault(
      &::google::protobuf::internal::GetEmptyStringAlreadyInited());
...
ReplicaIdentifier::~ReplicaIdentifier() {
  // @@protoc_insertion_point(destructor:cockroach.roachpb.ReplicaIdentifier)
  SharedDtor();
}

void ReplicaIdentifier::SharedDtor() {
  _unknown_fields_.DestroyNoArena(
      &::google::protobuf::internal::GetEmptyStringAlreadyInited());
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  if (this != &default_instance()) {
...
void ReplicaIdentifier::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const ReplicaIdentifier& ReplicaIdentifier::default_instance() {
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  protobuf_AddDesc_cockroach_2froachpb_2fmetadata_2eproto();
#else
  if (default_instance_ == NULL) protobuf_AddDesc_cockroach_2froachpb_2fmetadata_2eproto();
...
ReplicaIdentifier* ReplicaIdentifier::default_instance_ = NULL;

ReplicaIdentifier* ReplicaIdentifier::New(::google::protobuf::Arena* arena) const {
  ReplicaIdentifier* n = new ReplicaIdentifier;
  if (arena != NULL) {
    arena->Own(n);
  }
  return n;
...
void ReplicaIdentifier::Clear() {
// @@protoc_insertion_point(message_clear_start:cockroach.roachpb.ReplicaIdentifier)
...
bool ReplicaIdentifier::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  ::google::protobuf::io::LazyStringOutputStream unknown_fields_string(
      ::google::protobuf::internal::NewPermanentCallback(
          &MutableUnknownFieldsForReplicaIdentifier, this));
  ::google::protobuf::io::CodedOutputStream unknown_fields_stream(
      &unknown_fields_string, false);
  // @@protoc_insertion_point(parse_start:cockroach.roachpb.ReplicaIdentifier)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:cockroach.roachpb.ReplicaIdentifier)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:cockroach.roachpb.ReplicaIdentifier)
  return false;
#undef DO_
}

void ReplicaIdentifier::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:cockroach.roachpb.ReplicaIdentifier)
  // optional int64 range_id = 1;
  if (has_range_id()) {
  ...
  output->WriteRaw(unknown_fields().data(),
                   static_cast<int>(unknown_fields().size()));
  // @@protoc_insertion_point(serialize_end:cockroach.roachpb.ReplicaIdentifier)
}

int ReplicaIdentifier::ByteSize() const {
// @@protoc_insertion_point(message_byte_size_start:cockroach.roachpb.ReplicaIdentifier)
  int total_size = 0;
...
void ReplicaIdentifier::CheckTypeAndMergeFrom(
    const ::google::protobuf::MessageLite& from) {
  MergeFrom(*::google::protobuf::down_cast<const ReplicaIdentifier*>(&from));
}

void ReplicaIdentifier::MergeFrom(const ReplicaIdentifier& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:cockroach.roachpb.ReplicaIdentifier)
  if (GOOGLE_PREDICT_FALSE(&from == this)) MergeFromFail(__LINE__);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
...
void ReplicaIdentifier::CopyFrom(const ReplicaIdentifier& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:cockroach.roachpb.ReplicaIdentifier)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool ReplicaIdentifier::IsInitialized() const {

  return true;
}

void ReplicaIdentifier::Swap(ReplicaIdentifier* other) {
  if (other == this) return;
  InternalSwap(other);
}
void ReplicaIdentifier::InternalSwap(ReplicaIdentifier* other) {
...
::std::string ReplicaIdentifier::GetTypeName() const {
  return "cockroach.roachpb.ReplicaIdentifier";
}
...
// optional int64 range_id = 1;
bool ReplicaIdentifier::has_range_id() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
void ReplicaIdentifier::set_has_range_id() {
  _has_bits_[0] |= 0x00000001u;
}
void ReplicaIdentifier::clear_has_range_id() {
  _has_bits_[0] &= ~0x00000001u;
}
void ReplicaIdentifier::clear_range_id() {
  range_id_ = GOOGLE_LONGLONG(0);
  clear_has_range_id();
}
 ::google::protobuf::int64 ReplicaIdentifier::range_id() const {
  // @@protoc_insertion_point(field_get:cockroach.roachpb.ReplicaIdentifier.range_id)
  return range_id_;
}
 void ReplicaIdentifier::set_range_id(::google::protobuf::int64 value) {
  set_has_range_id();
  range_id_ = value;
  // @@protoc_insertion_point(field_set:cockroach.roachpb.ReplicaIdentifier.range_id)
}

// optional .cockroach.roachpb.ReplicaDescriptor replica = 2;
bool ReplicaIdentifier::has_replica() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
void ReplicaIdentifier::set_has_replica() {
  _has_bits_[0] |= 0x00000002u;
}
void ReplicaIdentifier::clear_has_replica() {
  _has_bits_[0] &= ~0x00000002u;
}
void ReplicaIdentifier::clear_replica() {
  if (replica_ != NULL) replica_->::cockroach::roachpb::ReplicaDescriptor::Clear();
  clear_has_replica();
}
const ::cockroach::roachpb::ReplicaDescriptor& ReplicaIdentifier::replica() const {
  // @@protoc_insertion_point(field_get:cockroach.roachpb.ReplicaIdentifier.replica)
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
...
::cockroach::roachpb::ReplicaDescriptor* ReplicaIdentifier::mutable_replica() {
  set_has_replica();
  if (replica_ == NULL) {
    replica_ = new ::cockroach::roachpb::ReplicaDescriptor;
  }
  // @@protoc_insertion_point(field_mutable:cockroach.roachpb.ReplicaIdentifier.replica)
  return replica_;
}
::cockroach::roachpb::ReplicaDescriptor* ReplicaIdentifier::release_replica() {
  // @@protoc_insertion_point(field_release:cockroach.roachpb.ReplicaIdentifier.replica)
  clear_has_replica();
  ::cockroach::roachpb::ReplicaDescriptor* temp = replica_;
  replica_ = NULL;
  return temp;
}
void ReplicaIdentifier::set_allocated_replica(::cockroach::roachpb::ReplicaDescriptor* replica) {
  delete replica_;
  replica_ = replica;
  if (replica) {
    set_has_replica();
  ...
  // @@protoc_insertion_point(field_set_allocated:cockroach.roachpb.ReplicaIdentifier.replica)
}
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      // repeated .cockroach.roachpb.ReplicaIdentifier replicas = 2;
      case 2: {
        if (tag == 18) {
         parse_replicas:
          DO_(input->IncrementRecursionDepth());
...
const ::cockroach::roachpb::ReplicaIdentifier& StoreDeadReplicas::replicas(int index) const {
  // @@protoc_insertion_point(field_get:cockroach.roachpb.StoreDeadReplicas.replicas)
  return replicas_.Get(index);
}
::cockroach::roachpb::ReplicaIdentifier* StoreDeadReplicas::mutable_replicas(int index) {
  // @@protoc_insertion_point(field_mutable:cockroach.roachpb.StoreDeadReplicas.replicas)
  return replicas_.Mutable(index);
}
::cockroach::roachpb::ReplicaIdentifier* StoreDeadReplicas::add_replicas() {
  // @@protoc_insertion_point(field_add:cockroach.roachpb.StoreDeadReplicas.replicas)
  return replicas_.Add();
}
::google::protobuf::RepeatedPtrField< ::cockroach::roachpb::ReplicaIdentifier >*
StoreDeadReplicas::mutable_replicas() {
  // @@protoc_insertion_point(field_mutable_list:cockroach.roachpb.StoreDeadReplicas.replicas)
  return &replicas_;
}
const ::google::protobuf::RepeatedPtrField< ::cockroach::roachpb::ReplicaIdentifier >&
