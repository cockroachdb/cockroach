...
void protobuf_AssignDesc_cockroach_2froachpb_2fdata_2eproto() {
  ...
  NodeList_reflection_ =
    ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
      ...
      -1);
  Meta_descriptor_ = file->message_type(11);
  static const int Meta_offsets_[4] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Meta, epoch_),
...
void protobuf_AddDesc_cockroach_2froachpb_2fdata_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "2\030.cockroach.roachpb.ValueB\004\310\336\037\000\"\214\001\n\nSto"
    "reIdent\022%\n\ncluster_id\030\001 \001(\tB\021\310\336\037\000\342\336\037\tClu"
    "sterID\022)\n\007node_id\030\002 \001(\005B\030\310\336\037\000\342\336\037\006NodeID\372"
    "\336\037\006NodeID\022,\n\010store_id\030\003 \001(\005B\032\310\336\037\000\342\336\037\007Sto"
    "reID\372\336\037\007StoreID\"\324\001\n\014SplitTrigger\022>\n\014upda"
    "ted_desc\030\001 \001(\0132\".cockroach.roachpb.Range"
    "DescriptorB\004\310\336\037\000\022:\n\010new_desc\030\002 \001(\0132\".coc"
    "kroach.roachpb.RangeDescriptorB\004\310\336\037\000\022H\n\027"
    "initial_leader_store_id\030\003 \001(\005B\'\310\336\037\000\342\336\037\024I"
    "nitialLeaderStoreID\372\336\037\007StoreID\"\215\001\n\014Merge"
    "Trigger\022>\n\014updated_desc\030\001 \001(\0132\".cockroac"
    "h.roachpb.RangeDescriptorB\004\310\336\037\000\022=\n\021subsu"
    "med_range_id\030\002 \001(\003B\"\310\336\037\000\342\336\037\017SubsumedRang"
    "eID\372\336\037\007RangeID\"\230\002\n\025ChangeReplicasTrigger"
    "\022\?\n\013change_type\030\001 \001(\0162$.cockroach.roachp"
    ...
    "odeID\"|\n\004Meta\022\022\n\002id\030\003 \001(\014B\006\342\336\037\002ID\022\024\n\003key"
    "\030\002 \001(\014B\007\372\336\037\003Key\022\023\n\005epoch\030\007 \001(\rB\004\310\336\037\000\0225\n\t"
    "timestamp\030\t \001(\0132\034.cockroach.roachpb.Time"
    "stampB\004\310\336\037\000\"\255\004\n\013Transaction\022/\n\004meta\030\001 \001("
    "\0132\027.cockroach.roachpb.MetaB\010\310\336\037\000\320\336\037\001\022\022\n\004"
    "name\030\002 \001(\tB\004\310\336\037\000\022\026\n\010priority\030\003 \001(\005B\004\310\336\037\000"
    "\0229\n\tisolation\030\004 \001(\0162 .cockroach.roachpb."
    "IsolationTypeB\004\310\336\037\000\022:\n\006status\030\005 \001(\0162$.co"
    "ckroach.roachpb.TransactionStatusB\004\310\336\037\000\022"
    "4\n\016last_heartbeat\030\006 \001(\0132\034.cockroach.roac"
    "hpb.Timestamp\022:\n\016orig_timestamp\030\007 \001(\0132\034."
    "cockroach.roachpb.TimestampB\004\310\336\037\000\0229\n\rmax"
    "_timestamp\030\010 \001(\0132\034.cockroach.roachpb.Tim"
    "estampB\004\310\336\037\000\0228\n\rcertain_nodes\030\t \001(\0132\033.co"
    "ckroach.roachpb.NodeListB\004\310\336\037\000\022\025\n\007Writin"
    "g\030\n \001(\010B\004\310\336\037\000\022\026\n\010Sequence\030\013 \001(\rB\004\310\336\037\000\022.\n"
    "\007Intents\030\014 \003(\0132\027.cockroach.roachpb.SpanB"
    "\004\310\336\037\000:\004\230\240\037\000\"\241\001\n\006Intent\022/\n\004span\030\001 \001(\0132\027.c"
    "ockroach.roachpb.SpanB\010\310\336\037\000\320\336\037\001\022*\n\003txn\030\002"
    " \001(\0132\027.cockroach.roachpb.MetaB\004\310\336\037\000\022:\n\006s"
    "tatus\030\003 \001(\0162$.cockroach.roachpb.Transact"
    "ionStatusB\004\310\336\037\000\"\265\001\n\005Lease\0221\n\005start\030\001 \001(\013"
    "2\034.cockroach.roachpb.TimestampB\004\310\336\037\000\0226\n\n"
    "expiration\030\002 \001(\0132\034.cockroach.roachpb.Tim"
    "estampB\004\310\336\037\000\022;\n\007replica\030\003 \001(\0132$.cockroac"
    "h.roachpb.ReplicaDescriptorB\004\310\336\037\000:\004\230\240\037\000\""
    "a\n\022SequenceCacheEntry\022\024\n\003key\030\001 \001(\014B\007\372\336\037\003"
    "Key\0225\n\ttimestamp\030\002 \001(\0132\034.cockroach.roach"
    "pb.TimestampB\004\310\336\037\000*^\n\tValueType\022\013\n\007UNKNO"
    ...
    "\020\001\022\013\n\007ABORTED\020\002\032\004\210\243\036\000B\tZ\007roachpbX\001", 2994);
...
const int Meta::kEpochFieldNumber;
...
Meta::Meta()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:cockroach.roachpb.Meta)
}
...
Meta::Meta(const Meta& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:cockroach.roachpb.Meta)
}
...
Meta::~Meta() {
  // @@protoc_insertion_point(destructor:cockroach.roachpb.Meta)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:cockroach.roachpb.Meta)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:cockroach.roachpb.Meta)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:cockroach.roachpb.Meta)
  return false;
#undef DO_
}
...
void Meta::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:cockroach.roachpb.Meta)
  // optional bytes key = 2;
  if (has_key()) {
    ::google::protobuf::internal::WireFormatLite::WriteBytesMaybeAliased(
      2, this->key(), output);
  ...
  // @@protoc_insertion_point(serialize_end:cockroach.roachpb.Meta)
}

::google::protobuf::uint8* Meta::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:cockroach.roachpb.Meta)
  // optional bytes key = 2;
  if (has_key()) {
    target =
      ::google::protobuf::internal::WireFormatLite::WriteBytesToArray(
  ...
  // @@protoc_insertion_point(serialize_to_array_end:cockroach.roachpb.Meta)
  return target;
}
...
// optional bytes id = 3;
bool Meta::has_id() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
void Meta::set_has_id() {
  _has_bits_[0] |= 0x00000001u;
}
void Meta::clear_has_id() {
  _has_bits_[0] &= ~0x00000001u;
}
void Meta::clear_id() {
  id_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
...
void Meta::clear_key() {
 ...
 void Meta::set_key(const void* value, size_t size) {
  set_has_key();
  key_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
...
// optional uint32 epoch = 7;
bool Meta::has_epoch() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
void Meta::set_has_epoch() {
  _has_bits_[0] |= 0x00000004u;
}
void Meta::clear_has_epoch() {
  _has_bits_[0] &= ~0x00000004u;
}
void Meta::clear_epoch() {
  epoch_ = 0u;
  clear_has_epoch();
}
 ::google::protobuf::uint32 Meta::epoch() const {
  // @@protoc_insertion_point(field_get:cockroach.roachpb.Meta.epoch)
  return epoch_;
}
 void Meta::set_epoch(::google::protobuf::uint32 value) {
  set_has_epoch();
  epoch_ = value;
...
const ::cockroach::roachpb::Timestamp& Meta::timestamp() const {
  // @@protoc_insertion_point(field_get:cockroach.roachpb.Meta.timestamp)
  return timestamp_ != NULL ? *timestamp_ : *default_instance_->timestamp_;
}
::cockroach::roachpb::Timestamp* Meta::mutable_timestamp() {
  set_has_timestamp();
  if (timestamp_ == NULL) {
    timestamp_ = new ::cockroach::roachpb::Timestamp;
  }
...
::cockroach::roachpb::Timestamp* Meta::release_timestamp() {
  clear_has_timestamp();
  ::cockroach::roachpb::Timestamp* temp = timestamp_;
  timestamp_ = NULL;
  return temp;
}
void Meta::set_allocated_timestamp(::cockroach::roachpb::Timestamp* timestamp) {
  delete timestamp_;
  timestamp_ = timestamp;
  if (timestamp) {
    set_has_timestamp();
...
void Transaction::InitAsDefaultInstance() {
  meta_ = const_cast< ::cockroach::roachpb::Meta*>(&::cockroach::roachpb::Meta::default_instance());
...
void Transaction::MergeFrom(const Transaction& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_meta()) {
      mutable_meta()->::cockroach::roachpb::Meta::MergeFrom(from.meta());
    }
    if (from.has_name()) {
      set_has_name();
...
::cockroach::roachpb::Meta* Transaction::release_meta() {
  clear_has_meta();
  ::cockroach::roachpb::Meta* temp = meta_;
  meta_ = NULL;
  return temp;
}
void Transaction::set_allocated_meta(::cockroach::roachpb::Meta* meta) {
  delete meta_;
  meta_ = meta;
  if (meta) {
    set_has_meta();
...
::cockroach::roachpb::Meta* Intent::release_txn() {
  clear_has_txn();
  ::cockroach::roachpb::Meta* temp = txn_;
  txn_ = NULL;
  return temp;
}
void Intent::set_allocated_txn(::cockroach::roachpb::Meta* txn) {
  delete txn_;
  txn_ = txn;
  if (txn) {
    set_has_txn();
