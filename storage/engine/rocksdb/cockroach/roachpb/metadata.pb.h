...
class ReplicaIdentifier : public ::google::protobuf::MessageLite {
 public:
  ReplicaIdentifier();
  virtual ~ReplicaIdentifier();

  ReplicaIdentifier(const ReplicaIdentifier& from);

  inline ReplicaIdentifier& operator=(const ReplicaIdentifier& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ReplicaIdentifier& default_instance();
  ...
  // for Protobuf internal code. Please use default_instance() declared
  // above instead.
  static inline const ReplicaIdentifier* internal_default_instance() {
    return default_instance_;
  }
  #endif

  void Swap(ReplicaIdentifier* other);

  // implements Message ----------------------------------------------

  inline ReplicaIdentifier* New() const { return New(NULL); }

  ReplicaIdentifier* New(::google::protobuf::Arena* arena) const;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from);
  void CopyFrom(const ReplicaIdentifier& from);
  void MergeFrom(const ReplicaIdentifier& from);
  void Clear();
  bool IsInitialized() const;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(ReplicaIdentifier* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _arena_ptr_;
  }
  ...
  // @@protoc_insertion_point(class_scope:cockroach.roachpb.ReplicaIdentifier)
 private:
  ...
  void InitAsDefaultInstance();
  static ReplicaIdentifier* default_instance_;
};
// -------------------------------------------------------------------
...
class StoreDeadReplicas : public ::google::protobuf::MessageLite {
 public:
  StoreDeadReplicas();
  ...
  const ::cockroach::roachpb::ReplicaIdentifier& replicas(int index) const;
  ::cockroach::roachpb::ReplicaIdentifier* mutable_replicas(int index);
  ::cockroach::roachpb::ReplicaIdentifier* add_replicas();
 ...
 private:
  ...
  ::google::protobuf::uint32 _has_bits_[1];
  mutable int _cached_size_;
  ::google::protobuf::RepeatedPtrField< ::cockroach::roachpb::ReplicaIdentifier > replicas_;
  ::google::protobuf::int32 store_id_;
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void  protobuf_AddDesc_cockroach_2froachpb_2fmetadata_2eproto_impl();
  #else
...
// optional int64 range_id = 1;
inline bool ReplicaIdentifier::has_range_id() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void ReplicaIdentifier::set_has_range_id() {
  _has_bits_[0] |= 0x00000001u;
}
inline void ReplicaIdentifier::clear_has_range_id() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void ReplicaIdentifier::clear_range_id() {
  range_id_ = GOOGLE_LONGLONG(0);
  clear_has_range_id();
}
inline ::google::protobuf::int64 ReplicaIdentifier::range_id() const {
  // @@protoc_insertion_point(field_get:cockroach.roachpb.ReplicaIdentifier.range_id)
  return range_id_;
}
inline void ReplicaIdentifier::set_range_id(::google::protobuf::int64 value) {
  set_has_range_id();
  range_id_ = value;
...
// optional .cockroach.roachpb.ReplicaDescriptor replica = 2;
inline bool ReplicaIdentifier::has_replica() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void ReplicaIdentifier::set_has_replica() {
  _has_bits_[0] |= 0x00000002u;
}
inline void ReplicaIdentifier::clear_has_replica() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void ReplicaIdentifier::clear_replica() {
  if (replica_ != NULL) replica_->::cockroach::roachpb::ReplicaDescriptor::Clear();
  clear_has_replica();
}
inline const ::cockroach::roachpb::ReplicaDescriptor& ReplicaIdentifier::replica() const {
...
inline ::cockroach::roachpb::ReplicaDescriptor* ReplicaIdentifier::mutable_replica() {
  set_has_replica();
  if (replica_ == NULL) {
...
inline ::cockroach::roachpb::ReplicaDescriptor* ReplicaIdentifier::release_replica() {
...
inline void ReplicaIdentifier::set_allocated_replica(::cockroach::roachpb::ReplicaDescriptor* replica) {
  delete replica_;
  replica_ = replica;
  if (replica) {
    set_has_replica();
...
inline const ::cockroach::roachpb::ReplicaIdentifier& StoreDeadReplicas::replicas(int index) const {
  // @@protoc_insertion_point(field_get:cockroach.roachpb.StoreDeadReplicas.replicas)
  return replicas_.Get(index);
}
inline ::cockroach::roachpb::ReplicaIdentifier* StoreDeadReplicas::mutable_replicas(int index) {
  // @@protoc_insertion_point(field_mutable:cockroach.roachpb.StoreDeadReplicas.replicas)
  return replicas_.Mutable(index);
}
inline ::cockroach::roachpb::ReplicaIdentifier* StoreDeadReplicas::add_replicas() {
  // @@protoc_insertion_point(field_add:cockroach.roachpb.StoreDeadReplicas.replicas)
  return replicas_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::cockroach::roachpb::ReplicaIdentifier >*
StoreDeadReplicas::mutable_replicas() {
  // @@protoc_insertion_point(field_mutable_list:cockroach.roachpb.StoreDeadReplicas.replicas)
  return &replicas_;
}
inline const ::google::protobuf::RepeatedPtrField< ::cockroach::roachpb::ReplicaIdentifier >&
