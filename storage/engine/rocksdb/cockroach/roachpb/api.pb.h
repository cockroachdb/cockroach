...
class RequestUnion : public ::google::protobuf::Message {
 public:
  ...
  bool has_collect_checksum() const;
  void clear_collect_checksum();
  static const int kCollectChecksumFieldNumber = 23;
  const ::cockroach::roachpb::VerifyChecksumRequest& collect_checksum() const;
  ::cockroach::roachpb::VerifyChecksumRequest* mutable_collect_checksum();
  ::cockroach::roachpb::VerifyChecksumRequest* release_collect_checksum();
  void set_allocated_collect_checksum(::cockroach::roachpb::VerifyChecksumRequest* collect_checksum);

  // optional .cockroach.roachpb.NoopRequest noop = 24;
  bool has_noop() const;
  void clear_noop();
  static const int kNoopFieldNumber = 24;
 ...
 private:
  ...
  inline void set_has_collect_checksum();
  inline void clear_has_collect_checksum();
  ...
  ::cockroach::roachpb::VerifyChecksumRequest* collect_checksum_;
...
class ResponseUnion : public ::google::protobuf::Message {
 public:
  ...
  void clear_collect_checksum();
  static const int kCollectChecksumFieldNumber = 23;
  const ::cockroach::roachpb::VerifyChecksumResponse& collect_checksum() const;
  ::cockroach::roachpb::VerifyChecksumResponse* mutable_collect_checksum();
  ::cockroach::roachpb::VerifyChecksumResponse* release_collect_checksum();
  void set_allocated_collect_checksum(::cockroach::roachpb::VerifyChecksumResponse* collect_checksum);
 ...
 private:
  ...
  ::cockroach::roachpb::VerifyChecksumResponse* collect_checksum_;
...
// optional .cockroach.roachpb.VerifyChecksumRequest collect_checksum = 23;
inline bool RequestUnion::has_collect_checksum() const {
  return (_has_bits_[0] & 0x00400000u) != 0;
}
inline void RequestUnion::set_has_collect_checksum() {
  _has_bits_[0] |= 0x00400000u;
}
inline void RequestUnion::clear_has_collect_checksum() {
  _has_bits_[0] &= ~0x00400000u;
}
inline void RequestUnion::clear_collect_checksum() {
  if (collect_checksum_ != NULL) collect_checksum_->::cockroach::roachpb::VerifyChecksumRequest::Clear();
  clear_has_collect_checksum();
}
inline const ::cockroach::roachpb::VerifyChecksumRequest& RequestUnion::collect_checksum() const {
...
inline ::cockroach::roachpb::VerifyChecksumRequest* RequestUnion::mutable_collect_checksum() {
...
inline ::cockroach::roachpb::VerifyChecksumRequest* RequestUnion::release_collect_checksum() {
  clear_has_collect_checksum();
  ::cockroach::roachpb::VerifyChecksumRequest* temp = collect_checksum_;
  collect_checksum_ = NULL;
  return temp;
}
inline void RequestUnion::set_allocated_collect_checksum(::cockroach::roachpb::VerifyChecksumRequest* collect_checksum) {
...
// optional .cockroach.roachpb.VerifyChecksumResponse collect_checksum = 23;
inline bool ResponseUnion::has_collect_checksum() const {
  return (_has_bits_[0] & 0x00400000u) != 0;
}
inline void ResponseUnion::set_has_collect_checksum() {
  _has_bits_[0] |= 0x00400000u;
}
inline void ResponseUnion::clear_has_collect_checksum() {
  _has_bits_[0] &= ~0x00400000u;
}
inline void ResponseUnion::clear_collect_checksum() {
  if (collect_checksum_ != NULL) collect_checksum_->::cockroach::roachpb::VerifyChecksumResponse::Clear();
  clear_has_collect_checksum();
}
inline const ::cockroach::roachpb::VerifyChecksumResponse& ResponseUnion::collect_checksum() const {
  // @@protoc_insertion_point(field_get:cockroach.roachpb.ResponseUnion.collect_checksum)
  return collect_checksum_ != NULL ? *collect_checksum_ : *default_instance_->collect_checksum_;
}
inline ::cockroach::roachpb::VerifyChecksumResponse* ResponseUnion::mutable_collect_checksum() {
  set_has_collect_checksum();
  if (collect_checksum_ == NULL) {
...
inline ::cockroach::roachpb::VerifyChecksumResponse* ResponseUnion::release_collect_checksum() {
  clear_has_collect_checksum();
  ::cockroach::roachpb::VerifyChecksumResponse* temp = collect_checksum_;
  collect_checksum_ = NULL;
  return temp;
}
inline void ResponseUnion::set_allocated_collect_checksum(::cockroach::roachpb::VerifyChecksumResponse* collect_checksum) {
  delete collect_checksum_;
  collect_checksum_ = collect_checksum;
  if (collect_checksum) {
    set_has_collect_checksum();
