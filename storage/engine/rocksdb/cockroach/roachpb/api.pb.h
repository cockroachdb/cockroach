...
const ChecksumStatus ChecksumStatus_MIN = CHECKSUM_SUCCESS;
const ChecksumStatus ChecksumStatus_MAX = CHECKSUM_GCED;
const int ChecksumStatus_ARRAYSIZE = ChecksumStatus_MAX + 1;

const ::google::protobuf::EnumDescriptor* ChecksumStatus_descriptor();
inline const ::std::string& ChecksumStatus_Name(ChecksumStatus value) {
  return ::google::protobuf::internal::NameOfEnum(
    ChecksumStatus_descriptor(), value);
}
inline bool ChecksumStatus_Parse(
    const ::std::string& name, ChecksumStatus* value) {
  return ::google::protobuf::internal::ParseNamedEnum<ChecksumStatus>(
    ChecksumStatus_descriptor(), name, value);
}
// ===================================================================
...
class ComputeChecksumResponse : public ::google::protobuf::Message {
 public:
  ...
  ::cockroach::roachpb::ChecksumStatus status() const;
  void set_status(::cockroach::roachpb::ChecksumStatus value);
...
class VerifyChecksumRequest : public ::google::protobuf::Message {
 public:
  ...
  bool has_can_panic() const;
  void clear_can_panic();
  static const int kCanPanicFieldNumber = 5;
  bool can_panic() const;
  void set_can_panic(bool value);
 ...
 private:
  ...
  inline void set_has_can_panic();
  inline void clear_has_can_panic();
...
// optional .cockroach.roachpb.ChecksumStatus status = 2;
inline bool ComputeChecksumResponse::has_status() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void ComputeChecksumResponse::set_has_status() {
  _has_bits_[0] |= 0x00000002u;
}
inline void ComputeChecksumResponse::clear_has_status() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void ComputeChecksumResponse::clear_status() {
  status_ = 0;
  clear_has_status();
}
inline ::cockroach::roachpb::ChecksumStatus ComputeChecksumResponse::status() const {
...
inline void ComputeChecksumResponse::set_status(::cockroach::roachpb::ChecksumStatus value) {
...
// optional bool can_panic = 5;
inline bool VerifyChecksumRequest::has_can_panic() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void VerifyChecksumRequest::set_has_can_panic() {
  _has_bits_[0] |= 0x00000010u;
}
inline void VerifyChecksumRequest::clear_has_can_panic() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void VerifyChecksumRequest::clear_can_panic() {
  can_panic_ = false;
  clear_has_can_panic();
}
inline bool VerifyChecksumRequest::can_panic() const {
  // @@protoc_insertion_point(field_get:cockroach.roachpb.VerifyChecksumRequest.can_panic)
  return can_panic_;
}
inline void VerifyChecksumRequest::set_can_panic(bool value) {
  set_has_can_panic();
  can_panic_ = value;
...
// optional .cockroach.roachpb.ChecksumStatus status = 2;
inline bool VerifyChecksumResponse::has_status() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void VerifyChecksumResponse::set_has_status() {
  _has_bits_[0] |= 0x00000002u;
}
inline void VerifyChecksumResponse::clear_has_status() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void VerifyChecksumResponse::clear_status() {
  status_ = 0;
  clear_has_status();
}
inline ::cockroach::roachpb::ChecksumStatus VerifyChecksumResponse::status() const {
  // @@protoc_insertion_point(field_get:cockroach.roachpb.VerifyChecksumResponse.status)
  return static_cast< ::cockroach::roachpb::ChecksumStatus >(status_);
}
inline void VerifyChecksumResponse::set_status(::cockroach::roachpb::ChecksumStatus value) {
  assert(::cockroach::roachpb::ChecksumStatus_IsValid(value));
  set_has_status();
  status_ = value;
...
template <> struct is_proto_enum< ::cockroach::roachpb::ChecksumStatus> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::cockroach::roachpb::ChecksumStatus>() {
  return ::cockroach::roachpb::ChecksumStatus_descriptor();
}
