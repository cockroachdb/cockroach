...
inline const ::cockroach::roachpb::RequestHeader& BatchRequest::header() const {
  // @@protoc_insertion_point(field_get:cockroach.roachpb.BatchRequest.header)
  return header_ != NULL ? *header_ : *default_instance_->header_;
}
inline ::cockroach::roachpb::RequestHeader* BatchRequest::mutable_header() {
  set_has_header();
  if (header_ == NULL) {
    header_ = new ::cockroach::roachpb::RequestHeader;
  }
...
inline ::cockroach::roachpb::RequestHeader* BatchRequest::release_header() {
  clear_has_header();
  ::cockroach::roachpb::RequestHeader* temp = header_;
  header_ = NULL;
  return temp;
}
inline void BatchRequest::set_allocated_header(::cockroach::roachpb::RequestHeader* header) {
  delete header_;
  header_ = header;
  if (header) {
    set_has_header();
...
inline const ::cockroach::roachpb::ResponseHeader& BatchResponse::header() const {
  // @@protoc_insertion_point(field_get:cockroach.roachpb.BatchResponse.header)
  return header_ != NULL ? *header_ : *default_instance_->header_;
}
inline ::cockroach::roachpb::ResponseHeader* BatchResponse::mutable_header() {
  set_has_header();
  if (header_ == NULL) {
    header_ = new ::cockroach::roachpb::ResponseHeader;
  }
...
inline ::cockroach::roachpb::ResponseHeader* BatchResponse::release_header() {
  clear_has_header();
  ::cockroach::roachpb::ResponseHeader* temp = header_;
  header_ = NULL;
  return temp;
}
inline void BatchResponse::set_allocated_header(::cockroach::roachpb::ResponseHeader* header) {
  delete header_;
  header_ = header;
  if (header) {
    set_has_header();
