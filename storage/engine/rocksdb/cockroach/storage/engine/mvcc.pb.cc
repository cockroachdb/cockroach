...
void protobuf_AddDesc_cockroach_2fstorage_2fengine_2fmvcc_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "pb/data.proto\032\024gogoproto/gogo.proto\"\376\001\n\014"
    "MVCCMetadata\022$\n\003txn\030\001 \001(\0132\027.cockroach.ro"
    "achpb.Meta\0225\n\ttimestamp\030\002 \001(\0132\034.cockroac"
    "h.roachpb.TimestampB\004\310\336\037\000\022\025\n\007deleted\030\003 \001"
    "(\010B\004\310\336\037\000\022\027\n\tkey_bytes\030\004 \001(\003B\004\310\336\037\000\022\027\n\tval"
    "_bytes\030\005 \001(\003B\004\310\336\037\000\022\021\n\traw_bytes\030\006 \001(\014\0225\n"
    "\017merge_timestamp\030\007 \001(\0132\034.cockroach.roach"
    "pb.Timestamp\"\362\002\n\tMVCCStats\022\037\n\021last_updat"
    "e_nanos\030\001 \001(\003B\004\310\336\037\000\022\030\n\nintent_age\030\002 \001(\003B"
    ...
    "e_count\030\005 \001(\003B\004\310\336\037\000\022\027\n\tkey_bytes\030\006 \001(\003B\004"
    "\310\336\037\000\022\027\n\tkey_count\030\007 \001(\003B\004\310\336\037\000\022\027\n\tval_byt"
    "es\030\010 \001(\003B\004\310\336\037\000\022\027\n\tval_count\030\t \001(\003B\004\310\336\037\000\022"
    "\032\n\014intent_bytes\030\n \001(\003B\004\310\336\037\000\022\032\n\014intent_co"
    "unt\030\013 \001(\003B\004\310\336\037\000\022\027\n\tsys_bytes\030\014 \001(\003B\004\310\336\037\000"
    "\022\027\n\tsys_count\030\r \001(\003B\004\310\336\037\000B\010Z\006engineX\001", 757);
...
void MVCCMetadata::InitAsDefaultInstance() {
  txn_ = const_cast< ::cockroach::roachpb::Meta*>(&::cockroach::roachpb::Meta::default_instance());
...
#define ZR_(first, last) do {\
  ...
  if (_has_bits_[0 / 32] & 127u) {
    ...
    if (has_txn()) {
      if (txn_ != NULL) txn_->::cockroach::roachpb::Meta::Clear();
    }
    if (has_timestamp()) {
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      // optional .cockroach.roachpb.Meta txn = 1;
      case 1: {
        if (tag == 10) {
...
void MVCCMetadata::MergeFrom(const MVCCMetadata& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_txn()) {
      mutable_txn()->::cockroach::roachpb::Meta::MergeFrom(from.txn());
    }
...
const ::cockroach::roachpb::Meta& MVCCMetadata::txn() const {
  // @@protoc_insertion_point(field_get:cockroach.storage.engine.MVCCMetadata.txn)
  return txn_ != NULL ? *txn_ : *default_instance_->txn_;
}
::cockroach::roachpb::Meta* MVCCMetadata::mutable_txn() {
  set_has_txn();
  if (txn_ == NULL) {
    txn_ = new ::cockroach::roachpb::Meta;
  }
  // @@protoc_insertion_point(field_mutable:cockroach.storage.engine.MVCCMetadata.txn)
  return txn_;
}
::cockroach::roachpb::Meta* MVCCMetadata::release_txn() {
  clear_has_txn();
  ::cockroach::roachpb::Meta* temp = txn_;
  txn_ = NULL;
  return temp;
}
void MVCCMetadata::set_allocated_txn(::cockroach::roachpb::Meta* txn) {
  delete txn_;
  txn_ = txn;
  if (txn) {
    set_has_txn();
