...
const ::google::protobuf::Descriptor* MVCCKeyValue_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection*
  MVCCKeyValue_reflection_ = NULL;
...
void protobuf_AssignDesc_cockroach_2fstorage_2fengine_2fmvcc_2eproto() {
  ...
  MVCCStats_reflection_ =
    ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
      ...
      -1);
  MVCCKeyValue_descriptor_ = file->message_type(3);
  static const int MVCCKeyValue_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MVCCKeyValue, key_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MVCCKeyValue, value_),
  };
  MVCCKeyValue_reflection_ =
    ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
      MVCCKeyValue_descriptor_,
      MVCCKeyValue::default_instance_,
      MVCCKeyValue_offsets_,
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MVCCKeyValue, _has_bits_[0]),
      -1,
      -1,
      sizeof(MVCCKeyValue),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MVCCKeyValue, _internal_metadata_),
      -1);
}
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
      MVCCKeyValue_descriptor_, &MVCCKeyValue::default_instance());
}
...
void protobuf_ShutdownFile_cockroach_2fstorage_2fengine_2fmvcc_2eproto() {
  ...
  delete MVCCKeyValue::default_instance_;
  delete MVCCKeyValue_reflection_;
}
...
void protobuf_AddDesc_cockroach_2fstorage_2fengine_2fmvcc_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\336\037\000\022\037\n\021last_update_nanos\030\036 \001(\003B\004\310\336\037\000\"7\n\014"
    "MVCCKeyValue\022\030\n\003key\030\001 \001(\014B\013\372\336\037\007MVCCKey\022\r"
    "\n\005value\030\002 \001(\014B\034Z\006engine\310\341\036\000\220\343\036\000\310\342\036\001\340\342\036\001\320"
    "\342\036\001", 883);
  ...
  MVCCKeyValue::default_instance_ = new MVCCKeyValue();
  ...
  MVCCKeyValue::default_instance_->InitAsDefaultInstance();
...
#ifndef _MSC_VER
const int MVCCKeyValue::kKeyFieldNumber;
const int MVCCKeyValue::kValueFieldNumber;
#endif  // !_MSC_VER

MVCCKeyValue::MVCCKeyValue()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:cockroach.storage.engine.MVCCKeyValue)
}

void MVCCKeyValue::InitAsDefaultInstance() {
}

MVCCKeyValue::MVCCKeyValue(const MVCCKeyValue& from)
  : ::google::protobuf::Message(),
    _internal_metadata_(NULL) {
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:cockroach.storage.engine.MVCCKeyValue)
}

void MVCCKeyValue::SharedCtor() {
...
MVCCKeyValue::~MVCCKeyValue() {
  // @@protoc_insertion_point(destructor:cockroach.storage.engine.MVCCKeyValue)
  SharedDtor();
}

void MVCCKeyValue::SharedDtor() {
...
void MVCCKeyValue::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const ::google::protobuf::Descriptor* MVCCKeyValue::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return MVCCKeyValue_descriptor_;
}

const MVCCKeyValue& MVCCKeyValue::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_cockroach_2fstorage_2fengine_2fmvcc_2eproto();
  return *default_instance_;
}

MVCCKeyValue* MVCCKeyValue::default_instance_ = NULL;

MVCCKeyValue* MVCCKeyValue::New(::google::protobuf::Arena* arena) const {
  MVCCKeyValue* n = new MVCCKeyValue;
  if (arena != NULL) {
    arena->Own(n);
  }
  return n;
...
bool MVCCKeyValue::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:cockroach.storage.engine.MVCCKeyValue)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:cockroach.storage.engine.MVCCKeyValue)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:cockroach.storage.engine.MVCCKeyValue)
  return false;
#undef DO_
}

void MVCCKeyValue::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:cockroach.storage.engine.MVCCKeyValue)
  // optional bytes key = 1;
  if (has_key()) {
  ...
  // @@protoc_insertion_point(serialize_end:cockroach.storage.engine.MVCCKeyValue)
}

::google::protobuf::uint8* MVCCKeyValue::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:cockroach.storage.engine.MVCCKeyValue)
  // optional bytes key = 1;
  if (has_key()) {
    target =
  ...
  // @@protoc_insertion_point(serialize_to_array_end:cockroach.storage.engine.MVCCKeyValue)
  return target;
}

int MVCCKeyValue::ByteSize() const {
  int total_size = 0;
...
void MVCCKeyValue::MergeFrom(const ::google::protobuf::Message& from) {
  if (GOOGLE_PREDICT_FALSE(&from == this)) MergeFromFail(__LINE__);
  const MVCCKeyValue* source = 
      ::google::protobuf::internal::DynamicCastToGenerated<const MVCCKeyValue>(
          &from);
  if (source == NULL) {
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
...
void MVCCKeyValue::MergeFrom(const MVCCKeyValue& from) {
  if (GOOGLE_PREDICT_FALSE(&from == this)) MergeFromFail(__LINE__);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_key()) {
      set_has_key();
...
void MVCCKeyValue::CopyFrom(const ::google::protobuf::Message& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void MVCCKeyValue::CopyFrom(const MVCCKeyValue& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool MVCCKeyValue::IsInitialized() const {

  return true;
}

void MVCCKeyValue::Swap(MVCCKeyValue* other) {
  if (other == this) return;
  InternalSwap(other);
}
void MVCCKeyValue::InternalSwap(MVCCKeyValue* other) {
...
::google::protobuf::Metadata MVCCKeyValue::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = MVCCKeyValue_descriptor_;
  metadata.reflection = MVCCKeyValue_reflection_;
  return metadata;
}
