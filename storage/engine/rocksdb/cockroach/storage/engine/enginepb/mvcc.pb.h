...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::cockroach::storage::engine::enginepb::IsolationType>() {
  return ::cockroach::storage::engine::enginepb::IsolationType_descriptor();
}
