...
class SplitTrigger : public ::google::protobuf::Message {
 public:
  ...
  const ::cockroach::proto::RangeDescriptor& updated_desc() const;
  ::cockroach::proto::RangeDescriptor* mutable_updated_desc();
  ...
  const ::cockroach::proto::RangeDescriptor& new_desc() const;
  ::cockroach::proto::RangeDescriptor* mutable_new_desc();
  ::cockroach::proto::RangeDescriptor* release_new_desc();
  void set_allocated_new_desc(::cockroach::proto::RangeDescriptor* new_desc);
...
class InternalCommitTrigger : public ::google::protobuf::Message {
 public:
  ...
  const ::cockroach::proto::SplitTrigger& split_trigger() const;
  ::cockroach::proto::SplitTrigger* mutable_split_trigger();
  ::cockroach::proto::SplitTrigger* release_split_trigger();
  void set_allocated_split_trigger(::cockroach::proto::SplitTrigger* split_trigger);
  ...
  const ::cockroach::proto::MergeTrigger& merge_trigger() const;
  ::cockroach::proto::MergeTrigger* mutable_merge_trigger();
  ::cockroach::proto::MergeTrigger* release_merge_trigger();
  void set_allocated_merge_trigger(::cockroach::proto::MergeTrigger* merge_trigger);
  ...
  const ::cockroach::proto::ChangeReplicasTrigger& change_replicas_trigger() const;
  ::cockroach::proto::ChangeReplicasTrigger* mutable_change_replicas_trigger();
...
class Transaction : public ::google::protobuf::Message {
 public:
  ...
  ::cockroach::proto::IsolationType isolation() const;
  void set_isolation(::cockroach::proto::IsolationType value);

  // optional .cockroach.proto.TransactionStatus status = 6;
  bool has_status() const;
  void clear_status();
  static const int kStatusFieldNumber = 6;
  ::cockroach::proto::TransactionStatus status() const;
  void set_status(::cockroach::proto::TransactionStatus value);
  ...
  const ::cockroach::proto::Timestamp& last_heartbeat() const;
  ::cockroach::proto::Timestamp* mutable_last_heartbeat();
  ::cockroach::proto::Timestamp* release_last_heartbeat();
  void set_allocated_last_heartbeat(::cockroach::proto::Timestamp* last_heartbeat);
  ...
  const ::cockroach::proto::Timestamp& orig_timestamp() const;
  ::cockroach::proto::Timestamp* mutable_orig_timestamp();
  ::cockroach::proto::Timestamp* release_orig_timestamp();
  void set_allocated_orig_timestamp(::cockroach::proto::Timestamp* orig_timestamp);
  ...
  const ::cockroach::proto::Timestamp& max_timestamp() const;
  ::cockroach::proto::Timestamp* mutable_max_timestamp();
  ::cockroach::proto::Timestamp* release_max_timestamp();
  void set_allocated_max_timestamp(::cockroach::proto::Timestamp* max_timestamp);
  ...
  const ::cockroach::proto::NodeList& certain_nodes() const;
  ::cockroach::proto::NodeList* mutable_certain_nodes();
...
class Lease : public ::google::protobuf::Message {
 public:
  ...
  const ::cockroach::proto::Timestamp& start() const;
  ::cockroach::proto::Timestamp* mutable_start();
  ::cockroach::proto::Timestamp* release_start();
  void set_allocated_start(::cockroach::proto::Timestamp* start);

  // optional .cockroach.proto.Timestamp expiration = 2;
  bool has_expiration() const;
  void clear_expiration();
  static const int kExpirationFieldNumber = 2;
  const ::cockroach::proto::Timestamp& expiration() const;
  ::cockroach::proto::Timestamp* mutable_expiration();
