...
// encodings for all fields. This is so that it can predict it's own impact
// on the system-local kv-pairs.
type MVCCStats struct {
	...
	// are documented in keys/constants.go under the localPrefix constant
	// using either the LocalRangeIDPrefix or the LocalRangePrefix.
