...
type MVCCMetadata struct {
	...
	// value that may have multiple versions. For inline values this
	// will always be set to zero. Inline values will have raw_bytes
	// set (e.g. on merged time series data).
