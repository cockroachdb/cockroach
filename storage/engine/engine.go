...
type Engine interface {
	...
	// calling Repr() on a batch. Using this method is equivalent to calling
	// Commit() on a batch, but can also be used when the representation has been
	// extracted and passed to a remote node.
