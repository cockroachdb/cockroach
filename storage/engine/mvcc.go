...
import (
	...
	"github.com/cockroachdb/cockroach/util/alloc"
...
func MVCCIterate(ctx context.Context,
	...
	var wiErr error
	var calloc alloc.ChunkAllocator
	...
	for {
		...
		calloc, metaKey.Key = calloc.AllocAndCopy(metaKey.Key, 1)
		...
		if value != nil {
			if valueSafety == unsafeValue {
				...
				calloc, value.RawBytes = calloc.AllocAndCopy(value.RawBytes, 0)
			}
