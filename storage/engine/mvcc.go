...
func updateStatsOnPut(key roachpb.Key, origMetaKeySize, origMetaValSize,
	...
	// Move the stats to the new meta's timestamp. If we had an old meta, this
	// creates the correct diff which cancels out the age contributions in the
	// time the old key was live.
