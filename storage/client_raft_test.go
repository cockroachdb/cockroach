...
func TestRaftRemoveRace(t *testing.T) {
	...
	for i := 0; i < 10; i++ {
		...
		// removing, though in practice it should be hard to trigger it in
		// practice. It is caused by the GC of the previous incarnation of
		// the Replica being in process when the new preemptive snapshot
		// is sent.
