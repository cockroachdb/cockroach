...
func sizeof(pb proto.Message) int {
	return pb.(sizer).Size()
}
...
func marshalTo(pb proto.Message, b []byte) (int, error) {
	return pb.(marshalerTo).MarshalTo(b)
}
...
var goldenProtos = map[reflect.Type]fixture{
	...
	reflect.TypeOf(&roachpb.Lease{}): {
		...
		emptySum:             3085288883727889585,
		populatedSum:         15667178284499273865,
	},
...
func TestBelowRaftProtos(t *testing.T) {
	...
	for typ, fix := range goldenProtos {
