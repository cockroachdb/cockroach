...
type RangeInfo struct {
	...
	// Deprecated with removal of the verify queue.
	LastVerificationDeprecated cockroach_util_hlc.Timestamp `protobuf:"bytes,4,opt,name=last_verification_deprecated,json=lastVerificationDeprecated" json:"last_verification_deprecated"`
}
...
func (m *RangeInfo) MarshalTo(data []byte) (int, error) {
	...
	data[i] = 0x22
	i++
	i = encodeVarintState(data, i, uint64(m.LastVerificationDeprecated.Size()))
	n7, err := m.LastVerificationDeprecated.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n7
...
func (m *RangeInfo) Size() (n int) {
	...
	l = m.LastVerificationDeprecated.Size()
	n += 1 + l + sovState(uint64(l))
	if m.NumDropped != 0 {
...
func (m *RangeInfo) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LastVerificationDeprecated", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.LastVerificationDeprecated.Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
...
var fileDescriptorState = []byte{
	...
	,
}
