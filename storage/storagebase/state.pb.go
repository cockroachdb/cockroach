...
type ReplicaState struct {
	...
	// txn_span_threshold is the (maximum) timestamp below which transaction
	...
	// transaction entry.
	TxnSpanThreshold cockroach_util_hlc.Timestamp `protobuf:"bytes,9,opt,name=txn_span_threshold,json=txnSpanThreshold" json:"txn_span_threshold"`
}
...
func (m *ReplicaState) MarshalTo(data []byte) (int, error) {
	...
	data[i] = 0x4a
	i++
	i = encodeVarintState(data, i, uint64(m.TxnSpanThreshold.Size()))
	n6, err := m.TxnSpanThreshold.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n6
...
var fileDescriptorState = []byte{
	...
	,
}
