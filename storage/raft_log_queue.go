...
// can be truncated and the oldest index that cannot be pruned. Entries are
// considered truncatable if there are more than 64MB of them, or can't be used
// to catch up a behind node.
