...
func getTruncatableIndexes(ref *ReplicaRef) (uint64, uint64, error) {
...
func (*raftLogQueue) shouldQueue(
	now hlc.Timestamp, ref *ReplicaRef, _ config.SystemConfig,
) (shouldQ bool, priority float64) {
	truncatableIndexes, _, err := getTruncatableIndexes(ref)
	if err != nil {
