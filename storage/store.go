...
// transaction. Should a transactional operation require a higher timestamp,
// the BatchResponse will have a transaction set which should be used to update
// the client transaction from.
