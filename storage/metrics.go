...
var (
	...
	metaGCQueueTime = metric.Metadata{Name: "queue.gc.processingnanos",
	...
	metaRaftLogQueueTime = metric.Metadata{Name: "queue.raftlog.processingnanos",
	...
	metaConsistencyQueueTime = metric.Metadata{Name: "queue.consistency.processingnanos",
	...
	metaReplicaGCQueueTime = metric.Metadata{Name: "queue.replicagc.processingnanos",
	...
	metaReplicateQueueTime = metric.Metadata{Name: "queue.replicate.processingnanos",
	...
	metaSplitQueueTime = metric.Metadata{Name: "queue.split.processingnanos",
