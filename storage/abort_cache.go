...
// protection for a transaction which doesn't yet know its aborted
// from reading spurious results from keys which it had already
// written, but whose intents have been aborted.
//
...
// Put writes an abort number for the specified transaction ID.
