...
var (
	...
	metaRaftEnqueuedMessages = metric.Metadata{
		Name: "raft.enqueued.total",
...
type StoreMetrics struct {
	...
	RaftEnqueuedMessages *metric.Counter
...
func newStoreMetrics() *StoreMetrics {
	...
	sm := &StoreMetrics{
		...
		RaftEnqueuedMessages:                   metric.NewCounter(metaRaftEnqueuedMessages),
