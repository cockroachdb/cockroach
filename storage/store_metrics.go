...
var (
	...
	metaRangeLeaseHolders = metric.Metadata{
		...
		Help: "Total number of Replicas on this store that are leaseholders.",
	}

	metaRangeLeaseHoldersWithoutRaftLeadership = metric.Metadata{
		Name: "range.leaseholders.without.leadership",
		Help: "Total number of Replicas on this store that are leaseholders but not Raft leaders.",
	}
