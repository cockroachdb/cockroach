...
func TestReplicaTSCacheLowWaterOnLease(t *testing.T) {
	...
	// test cases that do not test anything. NOTE(andrei): it's actually not 0,
	// but 900ms. Not sure why.
	...
	testCases := []struct {
		...
		{storeID: tc.store.StoreID(),
			...
			// We expect 50, not 60, because the new lease iw winded back to the end
