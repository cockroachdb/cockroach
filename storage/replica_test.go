...
func TestRangeLeaderLease(t *testing.T) {
	...
	pErr := tc.rng.redirectOnOrAcquireLeaderLease(tracing.DefaultSpan())
	...
	if _, ok := rng.redirectOnOrAcquireLeaderLease(tracing.DefaultSpan()).GetDetail().(*roachpb.NotLeaderError); !ok {
