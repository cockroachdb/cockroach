...
func TestRangeResolveIntentRange(t *testing.T) {
	...
	txn := &roachpb.Transaction{TxnMeta: roachpb.TxnMeta{ID: uuid.NewV4().Bytes(), Timestamp: tc.clock.Now()}, Sequence: 1}
...
func TestRangeLookupUseReverseScan(t *testing.T) {
	...
	txn2 := &roachpb.Transaction{TxnMeta: roachpb.TxnMeta{ID: uuid.NewV4().Bytes(), Timestamp: tc.clock.Now()}, Sequence: 1}
