...
func TestDiffRange(t *testing.T) {
	...
	leaderKeys := []string{"a", "abc", "abcd", "abcde", "abcdefg", "abcdefgh", "x", "y"}
	replicaKeys := []string{"ab", "abc", "abcde", "abcdef", "abcdefg", "abcdefgh", "z"}
	eDiff := []ReplicaSnapshotDiff{
		...
		{Leader: true, Key: []byte("abcdefg"), Timestamp: timestamp, Value: value},
