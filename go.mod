...
require (
	...
	// NB: see the replace directive for go.etcd.io/etcd/pkg/v3 below and make
	// sure the pinned version there does not diverge from the one here.
	go.etcd.io/etcd/raft/v3 v3.0.0-20201102185109-86185ba20fb7
...
replace go.etcd.io/etcd/pkg/v3 => go.etcd.io/etcd/pkg/v3 v3.0.0-20201102185109-86185ba20fb7
