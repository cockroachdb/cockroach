...
require (
	...
	github.com/cockroachdb/pebble v0.0.0-20210930163017-ff9a5bb54278
...
replace cloud.google.com/go => github.com/cockroachdb/google-cloud-go v0.45.2-0.20210623224357-4fefe580b8d5
