	...
	testCases := []struct {
		...
		},
		{
			...
			pErr: roachpb.NewErrorWithTxn(&roachpb.TransactionAbortedError{},
				&roachpb.Transaction{
					Meta: roachpb.Meta{Timestamp: origTS.Add(20, 10)}, Priority: 10,
				}),
			expPri: 10,
		},
		{
			...
			pErr: roachpb.NewError(&roachpb.TransactionPushError{
				PusheeTxn: roachpb.Transaction{
					Meta:     roachpb.Meta{Timestamp: origTS.Add(10, 10)},
					Priority: int32(10)},
			}),
			expEpoch:  1,
			expPri:    9,
		...
		},
		{
			...
			pErr: roachpb.NewErrorWithTxn(&roachpb.TransactionRetryError{},
				&roachpb.Transaction{
					Meta: roachpb.Meta{Timestamp: origTS.Add(10, 10)}, Priority: int32(10)}),
			expEpoch:  1,
			expPri:    10,
