...
func TestTxnDBLostUpdateAnomaly_Delete(t *testing.T) {
	...
	// TODO(tschottdorf): when fixed, should pass with bothIsolations as well.
	// SNAPSHOT currently shows more anomalies (likely similar to #6277).
...
func TestTxnDBLostUpdateAnomaly_DeleteRange(t *testing.T) {
	...
	t.Skip("TODO(tschottdorf): see #6277")
