...
func sendPing(opts Options, addrs []net.Addr, rpcContext *rpc.Context) (proto.Message, error) {
	return sendRPC(opts, addrs, rpcContext, "Heartbeat.Ping",
		&rpc.PingRequest{}, &rpc.PingResponse{})
}

func sendRPC(opts Options, addrs []net.Addr, rpcContext *rpc.Context, name string,
