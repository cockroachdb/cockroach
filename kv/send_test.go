...
func TestSendToOneClient(t *testing.T) {
	...
	roachpb.RegisterNodeServer(s, Node(0))
...
func TestUnretryableError(t *testing.T) {
	...
	sendOneFn = func(client batchClient, _ time.Duration, _ opentracing.Span, done chan batchCall) {
		done <- batchCall{
...
func TestClientNotReady(t *testing.T) {
	...
	roachpb.RegisterNodeServer(s, Node(50*time.Millisecond))
