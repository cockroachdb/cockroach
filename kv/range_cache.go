...
type rangeDescriptorCache struct {
	...
	// descriptors from the database. It allows mutliple rangeDescriptorCache
...
func (rdc *rangeDescriptorCache) performRangeLookup(key roachpb.RKey, considerIntents,
	...
	default:
		...
		if desc, pErr = rdc.LookupRangeDescriptor(metadataKey, considerIntents, useReverseScan); pErr != nil {
			return nil, pErr
		}
	}
