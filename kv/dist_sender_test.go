...
func TestSendRPCOrder(t *testing.T) {
	...
	makeVerifier := func(expOrder orderingPolicy,
		expAddrs []int32) func(Options, []net.Addr) error {
		return func(o Options, addrs []net.Addr) error {
	...
	var verifyCall func(Options, []net.Addr) error

	var testFn rpcSendFn = func(opts Options, method string,
		...
		return getArgs(addrs[0]).(*roachpb.BatchRequest).CreateReply(), nil
	}
...
func TestOwnNodeCertain(t *testing.T) {
	...
	var testFn rpcSendFn = func(_ Options, _ string, _ []net.Addr, getArgs func(addr net.Addr) proto.Message, _ func() proto.Message, _ *rpc.Context) (proto.Message, error) {
...
func TestRetryOnNotLeaderError(t *testing.T) {
	...
	var testFn rpcSendFn = func(_ Options, method string, addrs []net.Addr, getArgs func(addr net.Addr) proto.Message, getReply func() proto.Message, _ *rpc.Context) (proto.Message, error) {
		if first {
			reply := getReply()
...
func TestEvictCacheOnError(t *testing.T) {
	...
	for i, tc := range testCases {
		...
		var testFn rpcSendFn = func(_ Options, _ string, _ []net.Addr, getArgs func(addr net.Addr) proto.Message, getReply func() proto.Message, _ *rpc.Context) (proto.Message, error) {
			if !first {
				return getArgs(nil).(*roachpb.BatchRequest).CreateReply(), nil
			}
			first = false
...
func TestRangeLookupOptionOnReverseScan(t *testing.T) {
	...
	var testFn rpcSendFn = func(_ Options, method string, addrs []net.Addr, getArgs func(addr net.Addr) proto.Message, _ func() proto.Message, _ *rpc.Context) (proto.Message, error) {
		return getArgs(nil).(*roachpb.BatchRequest).CreateReply(), nil
	}
...
func TestMultiRangeSplitEndTransaction(t *testing.T) {
	...
	for _, test := range testCases {
		...
		var testFn rpcSendFn = func(_ Options, method string, addrs []net.Addr, ga func(addr net.Addr) proto.Message, _ func() proto.Message, _ *rpc.Context) (proto.Message, error) {
