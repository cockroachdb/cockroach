...
func TestGetFirstRangeDescriptor(t *testing.T) {
	n := simulation.NewNetwork(3, "unix", simulation.DefaultTestGossipInterval, simulation.DefaultTestGossipBootstrap)
...
func TestVerifyPermissions(t *testing.T) {
	n := simulation.NewNetwork(1, "unix", simulation.DefaultTestGossipInterval, simulation.DefaultTestGossipBootstrap)
	ds := NewDistSender(n.Nodes[0].Gossip)
