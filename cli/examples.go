...
The default is 'startrek', a database containing a table of episodes 
and a table of quotes from the eponymous TV show.
`,
...
-- 'cockroach gen demo' to a file, or pipe it as input to 'cockroach sql'.
`
