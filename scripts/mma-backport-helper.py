...
IGNORED_PRS: dict[int, str] = {
    ...
    164970: "removes unused spans, unrelated to MMA",
    164549: "adds a claude skill, doesn't need to be backported",
    165333: "fix for a long standing issue in SMA that needs to bake more",
    # Author-based matches not specific to MMA.
    157015: "author-based: kvserver load-based splits observability",
    159005: "author-based: kvserver slow latch threshold tweak",
    159046: "author-based: status node_id label fix",
    159047: "author-based: roachprod multi-store local cluster",
    159063: "author-based: gen-cockroach-metrics regexp tweak",
    159165: "author-based: revert decommission AllocatorCheckRange retry",
    159279: "author-based: allstacks buffer alloc sizing",
    159352: "author-based: server on-demand goroutine dumps",
    159376: "author-based: admission exhausted_duration help string",
    159403: "author-based: admission SnapshotQueue deadlock fix",
    159406: "author-based: admission SnapshotQueue cleanup",
    159436: "author-based: admission/kvserver snapshot disk write min-rate",
    159440: "author-based: admission elastic_cpu counter type fix",
    159518: "author-based: roachtest rapid-restart termination wait",
    159819: "author-based: cmd ghsearchdump and ghweeklysummary",
    159917: "author-based: admission ElasticCPUWorkHandle yielding",
    159925: "author-based: kvserver read request yielding without latches",
    160541: "author-based: kvserver split/replicate trace test simplification",
    160617: "author-based: ghweeklysummary PR fetch limit fix",
    160654: "author-based: roachtest kv_rangefeed node cpu increase",
    160655: "author-based: cmd/ghsearchdump search query update",
    160681: "author-based: roachprod-microbench markdown checklist",
    160702: "author-based: rangefeed benchmark allocation fix",
    160923: "author-based: cmd/ghsearchdump format update",
    160947: "author-based: kvcoord BenchmarkTxnWriteBuffer nil panic fix",
    161007: "author-based: admission disk bandwidth limiter naming",
    161013: "author-based: kvcoord skip test UnderDuress",
    161030: "author-based: admission disk bandwidth exhausted metric",
    161082: "author-based: admission bandwidth overload tick faster",
    161091: "author-based: admission metric help text typo",
    161111: "author-based: workload allow rows=0",
    161132: "author-based: admission error accounting refactor",
    161173: "author-based: kvserver/storage snapshot shared/external sst fix",
    161217: "author-based: admission disk bandwidth error smoothing",
    161266: "author-based: kvflowcontrol log verbosity increase",
    161285: "author-based: roachtest secondary store metrics bootstrap",
    161427: "author-based: admission wrap context errors",
    161457: "author-based: execinfra spelling fix",
    161511: "author-based: roachtest formatting nits",
    161517: "author-based: cmd/kv datadoggen",
    161652: "author-based: scripts gceworker.sh username length trim",
    161656: "author-based: tests index backfill disk bandwidth limiting",
    161684: "author-based: sniffarg flag parsing fix",
    161778: "author-based: .cursor remove main.mdc",
    161782: "author-based: CLAUDE.md update",
    161899: "author-based: schedulerlatency runtimeHistogram fix",
    161956: "author-based: schedulerlatency rename windowedCounts",
    161957: "author-based: CLAUDE.md improve comment principles",
    162076: "author-based: microbench-ci repro instructions",
    162136: "author-based: kvadmission RaftAdmissionMeta plumbing",
    162285: "author-based: kvserver remove kv.Sender from Store/Stores/Replica",
    163270: "author-based: roachprod prometheus target error handling",
    162086: "author-based: extend gce machine type for heterogeneous clusters",
    163493: "author-based: fix stuck merge-pending replicas in GC queue",
    163413: "author-based: improve diagnostic context in lease preference check",
    163272: "author-based: add diagnostic logging for stuck leadership transfers",
    163834: "author-based: add major and minor version labels to build.timestamp metric",
    164300: "author-based: split TestReplicateQueueSeesLearnerOrJointConfig into two",
    164428: "author-based: add collectInstantaneous to defaultCollector",
    164303: "author-based: increase timing threshold in TestPaceUpdateSignalling",
    164145: "author-based: reject lease transfers to replicas with send queues",
    164827: "author-based: promote key admission control metrics to Essential",
    164508: "author-based: skip TestLeaseTransferReplicatesLocks under duress",
    164510: "author-based: bump backup perturbation threshold from 5x to 15x",
    164312: "author-based: deflake TestLeaseTransferReplicatesLocks",
    164753: "author-based: delete accidentally committed executable",
    164730: "author-based: rewrite redactability rule for better triggering",
    164813: "author-based: add review-crdb skill",
    165415: "author-based: ci: add feedback footer to /investigate findings",
    165531: "author-based: go: bump go fork to pick up gcnoassist toggle",
    165703: "author-based: kvserverbase: always sync in WriteFileSyncing",
    # Intentionally ignored SQL CPU accounting PRs.
    165003: "SQL CPU: mmaintegration: add SQL-aware decomposition to physical CPU model",
    163592: "SQL CPU: load: extract cumulativeDelta helper from recordCPUUsage",
    161952: "SQL CPU: sql,admission: support cpu reporting and admission",
}
