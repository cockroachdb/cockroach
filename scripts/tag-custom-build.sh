...
The binaries will be available at:
  https://storage.googleapis.com/cockroach-builds-artifacts-prod/cockroach-$ID.linux-amd64.tgz
  https://storage.googleapis.com/cockroach-builds-artifacts-prod/cockroach-$ID.linux-arm64.tgz
  https://storage.googleapis.com/cockroach-builds-artifacts-prod/cockroach-$ID.darwin-10.9-amd64.tgz
  https://storage.googleapis.com/cockroach-builds-artifacts-prod/cockroach-$ID.windows-6.2-amd64.zip
