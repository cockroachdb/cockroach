...
syn keyword sqlFunc MIN MAX CORR COUNT SUM_INT AVG SUM STDDEV VARIANCE BOOL_AND BOOL_OR ARRAY_AGG BIT_AND BIT_OR STDDEV_POP VAR_POP COVAR_POP COVAR_SAMP REGR_INTERCEPT REGR_R2 REGR_SLOPE REGR_SXX REGR_SXY REGR_SYY
