...
func TestTransactionClone(t *testing.T) {
	...
	// Verify that the only equal pointer fields in Transactions are the ones whitelisted below. If
	// this test fails, please update both the whitelist below and Transaction.clonePtrFields().
	expFields := []string{
		"ID",
		"Intents.EndKey",
		"Intents.Key",
