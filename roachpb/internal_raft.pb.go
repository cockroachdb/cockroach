...
func (m *PartialRaftSnapshotData) Reset()         { *m = PartialRaftSnapshotData{} }
func (m *PartialRaftSnapshotData) String() string { return proto.CompactTextString(m) }
func (*PartialRaftSnapshotData) ProtoMessage()    {}
func (*PartialRaftSnapshotData) Descriptor() ([]byte, []int) {
	return fileDescriptorInternalRaft, []int{3}
}
...
func init() {
	...
	proto.RegisterType((*PartialRaftSnapshotData)(nil), "cockroach.roachpb.PartialRaftSnapshotData")
}
...
func (m *PartialRaftSnapshotData) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PartialRaftSnapshotData: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PartialRaftSnapshotData: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorInternalRaft = []byte{
	...
	,
}
