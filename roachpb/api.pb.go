...
type LeaseInfoResponse struct {
	ResponseHeader `protobuf:"bytes,1,opt,name=header,embedded=header" json:"header"`
	// The current lease. It can also be the tentative future lease, if a lease
...
func (*VerifyChecksumRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{58} }
...
func (*VerifyChecksumResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{59} }

type ExportKeysRequest struct {
	Span      `protobuf:"bytes,1,opt,name=header,embedded=header" json:"header"`
	Basepath  string                       `protobuf:"bytes,2,opt,name=basepath" json:"basepath"`
	StartTime cockroach_util_hlc.Timestamp `protobuf:"bytes,3,opt,name=start_time,json=startTime" json:"start_time"`
}

func (m *ExportKeysRequest) Reset()                    { *m = ExportKeysRequest{} }
func (m *ExportKeysRequest) String() string            { return proto.CompactTextString(m) }
func (*ExportKeysRequest) ProtoMessage()               {}
func (*ExportKeysRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{60} }

type ExportKeysBatch struct {
...
func (m *ExportKeysBatch) Reset()                    { *m = ExportKeysBatch{} }
func (m *ExportKeysBatch) String() string            { return proto.CompactTextString(m) }
func (*ExportKeysBatch) ProtoMessage()               {}
func (*ExportKeysBatch) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{61} }

type ExportKeysResponse struct {
	ResponseHeader `protobuf:"bytes,1,opt,name=header,embedded=header" json:"header"`
	Batches        []ExportKeysBatch `protobuf:"bytes,2,rep,name=batches" json:"batches"`
}

func (m *ExportKeysResponse) Reset()                    { *m = ExportKeysResponse{} }
func (m *ExportKeysResponse) String() string            { return proto.CompactTextString(m) }
func (*ExportKeysResponse) ProtoMessage()               {}
func (*ExportKeysResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{62} }
...
type RequestUnion struct {
	...
	ExportKeys         *ExportKeysRequest         `protobuf:"bytes,31,opt,name=export_keys,json=exportKeys" json:"export_keys,omitempty"`
}
...
type ResponseUnion struct {
	...
	ExportKeys         *ExportKeysResponse         `protobuf:"bytes,31,opt,name=export_keys,json=exportKeys" json:"export_keys,omitempty"`
}
...
func (*RaftCommand) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{68} }
...
func init() {
	...
	proto.RegisterType((*ExportKeysRequest)(nil), "cockroach.roachpb.ExportKeysRequest")
	proto.RegisterType((*ExportKeysBatch)(nil), "cockroach.roachpb.ExportKeysBatch")
	proto.RegisterType((*ExportKeysResponse)(nil), "cockroach.roachpb.ExportKeysResponse")
...
func (m *VerifyChecksumRequest) MarshalTo(data []byte) (int, error) {
	...
	if m.Snapshot != nil {
		...
		n82, err := m.Snapshot.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n82
...
func (m *ExportKeysRequest) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *ExportKeysRequest) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	data[i] = 0x12
	i++
	i = encodeVarintApi(data, i, uint64(len(m.Basepath)))
	i += copy(data[i:], m.Basepath)
	data[i] = 0x1a
	i++
	i = encodeVarintApi(data, i, uint64(m.StartTime.Size()))
	n85, err := m.StartTime.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n85
...
func (m *ExportKeysBatch) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *ExportKeysBatch) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ExportKeysResponse) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *ExportKeysResponse) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *RequestUnion) MarshalTo(data []byte) (int, error) {
	...
	if m.Get != nil {
		...
		n88, err := m.Get.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n88
	...
	if m.Put != nil {
		...
		n89, err := m.Put.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n89
	...
	if m.ConditionalPut != nil {
		...
		n90, err := m.ConditionalPut.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n90
	...
	if m.Increment != nil {
		...
		n91, err := m.Increment.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n91
	...
	if m.Delete != nil {
		...
		n92, err := m.Delete.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n92
	...
	if m.DeleteRange != nil {
		...
		n93, err := m.DeleteRange.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n93
	...
	if m.Scan != nil {
		...
		n94, err := m.Scan.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n94
	...
	if m.BeginTransaction != nil {
		...
		n95, err := m.BeginTransaction.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n95
	...
	if m.EndTransaction != nil {
		...
		n96, err := m.EndTransaction.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n96
	...
	if m.AdminSplit != nil {
		...
		n97, err := m.AdminSplit.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n97
	...
	if m.AdminMerge != nil {
		...
		n98, err := m.AdminMerge.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n98
	...
	if m.HeartbeatTxn != nil {
		...
		n99, err := m.HeartbeatTxn.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n99
	...
	if m.Gc != nil {
		...
		n100, err := m.Gc.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n100
	...
	if m.PushTxn != nil {
		...
		n101, err := m.PushTxn.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n101
	...
	if m.RangeLookup != nil {
		...
		n102, err := m.RangeLookup.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n102
	...
	if m.ResolveIntent != nil {
		...
		n103, err := m.ResolveIntent.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n103
	...
	if m.ResolveIntentRange != nil {
		...
		n104, err := m.ResolveIntentRange.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n104
	...
	if m.Merge != nil {
		...
		n105, err := m.Merge.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n105
	...
	if m.TruncateLog != nil {
		...
		n106, err := m.TruncateLog.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n106
	...
	if m.RequestLease != nil {
		...
		n107, err := m.RequestLease.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n107
	...
	if m.ReverseScan != nil {
		...
		n108, err := m.ReverseScan.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n108
	...
	if m.ComputeChecksum != nil {
		...
		n109, err := m.ComputeChecksum.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n109
	...
	if m.VerifyChecksum != nil {
		...
		n110, err := m.VerifyChecksum.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n110
	...
	if m.CheckConsistency != nil {
		...
		n111, err := m.CheckConsistency.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n111
	...
	if m.Noop != nil {
		...
		n112, err := m.Noop.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n112
	...
	if m.InitPut != nil {
		...
		n113, err := m.InitPut.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n113
	...
	if m.ChangeFrozen != nil {
		...
		n114, err := m.ChangeFrozen.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n114
	...
	if m.TransferLease != nil {
		...
		n115, err := m.TransferLease.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n115
	...
	if m.AdminTransferLease != nil {
		...
		n116, err := m.AdminTransferLease.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n116
	...
	if m.LeaseInfo != nil {
		...
		n117, err := m.LeaseInfo.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n117
	...
	if m.ExportKeys != nil {
		...
		data[i] = 0x1
		i++
		i = encodeVarintApi(data, i, uint64(m.ExportKeys.Size()))
		n118, err := m.ExportKeys.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n118
...
func (m *ResponseUnion) MarshalTo(data []byte) (int, error) {
	...
	if m.VerifyChecksum != nil {
		...
		i++
		i = encodeVarintApi(data, i, uint64(m.VerifyChecksum.Size()))
		n141, err := m.VerifyChecksum.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n141
	...
	if m.ChangeFrozen != nil {
		...
		i++
		i = encodeVarintApi(data, i, uint64(m.ChangeFrozen.Size()))
		n145, err := m.ChangeFrozen.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n145
	...
	if m.ExportKeys != nil {
		...
		i++
		i = encodeVarintApi(data, i, uint64(m.ExportKeys.Size()))
		n148, err := m.ExportKeys.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n148
...
func (m *Header) MarshalTo(data []byte) (int, error) {
	...
	if m.Trace != nil {
		...
		n152, err := m.Trace.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n152
...
func (m *RaftCommand) MarshalTo(data []byte) (int, error) {
	...
	n159, err := m.OriginReplica.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n159
	...
	n160, err := m.Cmd.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n160
...
func (m *ExportKeysRequest) Size() (n int) {
	var l int
	_ = l
	l = m.Span.Size()
	n += 1 + l + sovApi(uint64(l))
...
func (m *ExportKeysBatch) Size() (n int) {
	var l int
	_ = l
	l = m.Span.Size()
	n += 1 + l + sovApi(uint64(l))
...
func (m *ExportKeysResponse) Size() (n int) {
	var l int
	_ = l
	l = m.ResponseHeader.Size()
	n += 1 + l + sovApi(uint64(l))
...
func (m *ExportKeysRequest) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ExportKeysRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ExportKeysRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ExportKeysBatch) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ExportKeysBatch: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ExportKeysBatch: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ExportKeysResponse) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ExportKeysResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ExportKeysResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			m.Batches = append(m.Batches, ExportKeysBatch{})
...
func (m *RequestUnion) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 31:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExportKeys", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ExportKeys == nil {
				m.ExportKeys = &ExportKeysRequest{}
			}
			if err := m.ExportKeys.Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ResponseUnion) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 31:
			...
			if m.ExportKeys == nil {
				m.ExportKeys = &ExportKeysResponse{}
			}
			if err := m.ExportKeys.Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
...
var fileDescriptorApi = []byte{
	...
	,
}
