...
type Header struct {
	...
	// replica specifies the location where the request was sent to.
	// replica location cached by distsender may stale, this is checked
	// by locasender to ensure the replica was still hold by the given
	// store.
