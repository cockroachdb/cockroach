...
/*
	...
	It has these top-level messages:
		...
		AdminSetFrozenRequest
		AdminSetFrozenResponse
...
// AdminSetFrozenRequest .
type AdminSetFrozenRequest struct {
	Span   `protobuf:"bytes,1,opt,name=header,embedded=header" json:"header"`
	Frozen bool `protobuf:"varint,2,opt,name=frozen" json:"frozen"`
	// The request affects exactly those Ranges which have a start_key larger than
	// the (range-global) key specified below; it is a no-op on all others that may
	// receive it.
	// In practice, always set to the original start key of the request (prior to
	// distributing it).
	MinStartKey Key `protobuf:"bytes,3,opt,name=min_start_key,json=minStartKey,casttype=Key" json:"min_start_key,omitempty"`
}

func (m *AdminSetFrozenRequest) Reset()                    { *m = AdminSetFrozenRequest{} }
func (m *AdminSetFrozenRequest) String() string            { return proto.CompactTextString(m) }
func (*AdminSetFrozenRequest) ProtoMessage()               {}
func (*AdminSetFrozenRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{21} }

// AdminSetFrozenResponse .
type AdminSetFrozenResponse struct {
	ResponseHeader `protobuf:"bytes,1,opt,name=header,embedded=header" json:"header"`
	Affected       int32 `protobuf:"varint,2,opt,name=affected" json:"affected"`
}

func (m *AdminSetFrozenResponse) Reset()                    { *m = AdminSetFrozenResponse{} }
func (m *AdminSetFrozenResponse) String() string            { return proto.CompactTextString(m) }
func (*AdminSetFrozenResponse) ProtoMessage()               {}
func (*AdminSetFrozenResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{22} }
...
type RequestUnion struct {
	...
	AdminFreeze        *AdminSetFrozenRequest     `protobuf:"bytes,27,opt,name=admin_freeze,json=adminFreeze" json:"admin_freeze,omitempty"`
}
...
type ResponseUnion struct {
	...
	AdminFreeze        *AdminSetFrozenResponse     `protobuf:"bytes,27,opt,name=admin_freeze,json=adminFreeze" json:"admin_freeze,omitempty"`
}
...
func init() {
	...
	proto.RegisterType((*AdminSetFrozenRequest)(nil), "cockroach.roachpb.AdminSetFrozenRequest")
	proto.RegisterType((*AdminSetFrozenResponse)(nil), "cockroach.roachpb.AdminSetFrozenResponse")
...
func (m *AdminSetFrozenRequest) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *AdminSetFrozenRequest) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *AdminSetFrozenResponse) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *AdminSetFrozenResponse) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *RequestUnion) MarshalTo(data []byte) (int, error) {
	...
	if m.AdminFreeze != nil {
		data[i] = 0xda
		i++
		data[i] = 0x1
		i++
		i = encodeVarintApi(data, i, uint64(m.AdminFreeze.Size()))
		n101, err := m.AdminFreeze.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n101
...
func (m *ResponseUnion) MarshalTo(data []byte) (int, error) {
	...
	if m.AdminFreeze != nil {
		...
		i++
		i = encodeVarintApi(data, i, uint64(m.AdminFreeze.Size()))
		n128, err := m.AdminFreeze.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n128
...
func (m *AdminSetFrozenRequest) Size() (n int) {
	var l int
	_ = l
	l = m.Span.Size()
	n += 1 + l + sovApi(uint64(l))
...
func (m *AdminSetFrozenResponse) Size() (n int) {
	var l int
	_ = l
	l = m.ResponseHeader.Size()
	n += 1 + l + sovApi(uint64(l))
...
func (this *RequestUnion) GetValue() interface{} {
	...
	if this.AdminFreeze != nil {
		return this.AdminFreeze
	}
	return nil
}
...
func (m *AdminSetFrozenRequest) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AdminSetFrozenRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AdminSetFrozenRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *AdminSetFrozenResponse) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AdminSetFrozenResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AdminSetFrozenResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *RequestUnion) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 27:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AdminFreeze", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.AdminFreeze == nil {
				m.AdminFreeze = &AdminSetFrozenRequest{}
			}
			if err := m.AdminFreeze.Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ResponseUnion) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 27:
			...
			if m.AdminFreeze == nil {
				m.AdminFreeze = &AdminSetFrozenResponse{}
			}
			if err := m.AdminFreeze.Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
...
var fileDescriptorApi = []byte{
	...
	,
}
