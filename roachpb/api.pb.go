...
type VerifyChecksumRequest struct {
	...
	// checksum of cockroach internal consistent k:v pairs with values
	// containing floating points. Different architectures can do floating
	// point math in unpredictable ways. We separate these k:v pairs so as
	// to ignore differences in heterogenous systems.
	FPChecksum []byte `protobuf:"bytes,5,opt,name=fp_checksum,json=fpChecksum" json:"fp_checksum,omitempty"`
}
...
func (m *VerifyChecksumRequest) MarshalTo(data []byte) (int, error) {
	...
	if m.FPChecksum != nil {
		data[i] = 0x2a
		i++
		i = encodeVarintApi(data, i, uint64(len(m.FPChecksum)))
		i += copy(data[i:], m.FPChecksum)
	}
	return i, nil
}
...
func (m *BatchResponse_Header) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintApi(data, i, uint64(m.Now.Size()))
	n128, err := m.Now.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n128
...
func (m *VerifyChecksumRequest) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FPChecksum", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.FPChecksum = append(m.FPChecksum[:0], data[iNdEx:postIndex]...)
			if m.FPChecksum == nil {
				m.FPChecksum = []byte{}
			}
			iNdEx = postIndex
...
var fileDescriptorApi = []byte{
	...
	,
}
