...
// A PollFrozenRequest asks the addressed Store whether all of its Replicas are
// frozen.
...
// A PollFrozenResponse is the response returned from a PollFrozenRequest. If
// all of the Store's replicas are frozen, the contained boolean will be set.
type PollFrozenResponse struct {
	Frozen bool `protobuf:"varint,1,opt,name=frozen" json:"frozen"`
}
...
func (m *RaftCommand) MarshalTo(data []byte) (int, error) {
	...
	data[i] = 0x20
	i++
	i = encodeVarintApi(data, i, uint64(m.MustIndex))
	return i, nil
}
...
func (m *RaftCommand) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MustIndex", wireType)
			}
			m.MustIndex = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := data[iNdEx]
				iNdEx++
				m.MustIndex |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorApi = []byte{
	...
	,
}
