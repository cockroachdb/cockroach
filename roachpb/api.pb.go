...
// An error can be returned if the version is unsupported.
...
// 1. The version is unsupported.
// 2. There was an error while computing the checksum.
// 3. The local checksum doesn't match the checksum from the leader.
// 4. The checksum computed through ComputeChecksum has already been GCed.
