...
type VerifyChecksumRequest struct {
	Span       `protobuf:"bytes,1,opt,name=header,embedded=header" json:"header"`
	ChecksumID github_com_cockroachdb_cockroach_util_uuid.UUID `protobuf:"bytes,2,opt,name=checksum_id,customtype=github.com/cockroachdb/cockroach/util/uuid.UUID" json:"checksum_id"`
...
type RequestUnion struct {
	...
	CollectChecksum    *VerifyChecksumRequest     `protobuf:"bytes,23,opt,name=collect_checksum" json:"collect_checksum,omitempty"`
	Noop               *NoopRequest               `protobuf:"bytes,24,opt,name=noop" json:"noop,omitempty"`
}
...
type ResponseUnion struct {
	...
	CollectChecksum    *VerifyChecksumResponse     `protobuf:"bytes,23,opt,name=collect_checksum" json:"collect_checksum,omitempty"`
	Noop               *NoopResponse               `protobuf:"bytes,24,opt,name=noop" json:"noop,omitempty"`
}
...
func (m *RequestUnion) MarshalTo(data []byte) (int, error) {
	...
	if m.CollectChecksum != nil {
		data[i] = 0xba
		i++
		data[i] = 0x1
		i++
		i = encodeVarintApi(data, i, uint64(m.CollectChecksum.Size()))
		n91, err := m.CollectChecksum.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n91
	...
	if m.Noop != nil {
		...
		n92, err := m.Noop.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n92
...
func (m *ResponseUnion) MarshalTo(data []byte) (int, error) {
	...
	if m.LeaderLease != nil {
		...
		i++
		i = encodeVarintApi(data, i, uint64(m.LeaderLease.Size()))
		n112, err := m.LeaderLease.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n112
	...
	if m.CollectChecksum != nil {
		...
		i++
		i = encodeVarintApi(data, i, uint64(m.CollectChecksum.Size()))
		n115, err := m.CollectChecksum.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n115
...
func (m *Header) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintApi(data, i, uint64(m.Timestamp.Size()))
	n117, err := m.Timestamp.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n117
	...
	n118, err := m.Replica.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n118
	...
	if m.Txn != nil {
		...
		i++
		i = encodeVarintApi(data, i, uint64(m.Txn.Size()))
		n119, err := m.Txn.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n119
...
func (m *BatchResponse) MarshalTo(data []byte) (int, error) {
	...
	n121, err := m.BatchResponse_Header.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n121
...
func (m *BatchResponse_Header) MarshalTo(data []byte) (int, error) {
	...
	if m.Error != nil {
		...
		n122, err := m.Error.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n122
	...
	i++
	i = encodeVarintApi(data, i, uint64(m.Timestamp.Size()))
	n123, err := m.Timestamp.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n123
...
func (this *RequestUnion) GetValue() interface{} {
	...
	if this.CollectChecksum != nil {
		return this.CollectChecksum
	}
	if this.Noop != nil {
		return this.Noop
	}
...
func (m *RequestUnion) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 23:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CollectChecksum", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.CollectChecksum == nil {
				m.CollectChecksum = &VerifyChecksumRequest{}
			}
			if err := m.CollectChecksum.Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 24:
...
func (m *ResponseUnion) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 23:
			...
			if m.CollectChecksum == nil {
				m.CollectChecksum = &VerifyChecksumResponse{}
			}
			if err := m.CollectChecksum.Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
