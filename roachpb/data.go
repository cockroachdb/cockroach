...
func MakePriority(userPriority float64) int32 {
	...
	//
	// To convert to an integer, we scale things to accomodate a few (10) standard deviations
	// for the maximum priority. Note that the probability function falls exponentially.
	val := rand.ExpFloat64() * userPriority / (10 * MaxUserPriority) * math.MaxInt32
