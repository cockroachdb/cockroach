...
// ReplicaIdentifier uniquely identifies a specific replica on a range.
...
func (m *ReplicaIdentifier) Reset()                    { *m = ReplicaIdentifier{} }
func (m *ReplicaIdentifier) String() string            { return proto.CompactTextString(m) }
func (*ReplicaIdentifier) ProtoMessage()               {}
func (*ReplicaIdentifier) Descriptor() ([]byte, []int) { return fileDescriptorMetadata, []int{2} }
...
type StoreDeadReplicas struct {
	StoreID  StoreID             `protobuf:"varint,1,opt,name=store_id,json=storeId,casttype=StoreID" json:"store_id"`
	Replicas []ReplicaIdentifier `protobuf:"bytes,2,rep,name=replicas" json:"replicas"`
}
...
func init() {
	...
	proto.RegisterType((*ReplicaIdentifier)(nil), "cockroach.roachpb.ReplicaIdentifier")
...
func (m *ReplicaIdentifier) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *ReplicaIdentifier) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ReplicaIdentifier) Size() (n int) {
	var l int
	_ = l
...
func (m *ReplicaIdentifier) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ReplicaIdentifier: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ReplicaIdentifier: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *StoreDeadReplicas) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Replicas = append(m.Replicas, ReplicaIdentifier{})
			if err := m.Replicas[len(m.Replicas)-1].Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
var fileDescriptorMetadata = []byte{
	...
	,
}
