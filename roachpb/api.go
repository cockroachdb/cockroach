...
func (rh *ResponseHeader) combine(otherRH ResponseHeader) error {
	...
	if (rh.ResumeSpan == nil && otherRH.ResumeSpan != nil) ||
		(rh.ResumeSpan != nil && otherRH.ResumeSpan == nil) {
		return fmt.Errorf("one span is nil while the other is not: %s, %s", rh.ResumeSpan, otherRH.ResumeSpan)
	}
