...
type InternalTimeSeriesSample struct {
	...
	// Sum of all measurements. This is a fixed point value
	// with a scale of 3 represented as an int64.
	Sum int64 `protobuf:"varint,7,opt,name=sum" json:"sum"`
	// Maximum encountered measurement in this sample.
	Max *int64 `protobuf:"varint,8,opt,name=max" json:"max,omitempty"`
	// Minimum encountered measurement in this sample.
	Min *int64 `protobuf:"varint,9,opt,name=min" json:"min,omitempty"`
}
...
func (m *InternalTimeSeriesSample) MarshalTo(data []byte) (int, error) {
	...
	data[i] = 0x38
	i++
	i = encodeVarintInternal(data, i, uint64(m.Sum))
	if m.Max != nil {
		data[i] = 0x40
		i++
		i = encodeVarintInternal(data, i, uint64(*m.Max))
	}
	if m.Min != nil {
		data[i] = 0x48
		i++
		i = encodeVarintInternal(data, i, uint64(*m.Min))
	}
	return i, nil
}
...
func (m *InternalTimeSeriesSample) Size() (n int) {
	...
	n += 1 + sovInternal(uint64(m.Sum))
	if m.Max != nil {
		n += 1 + sovInternal(uint64(*m.Max))
	}
	if m.Min != nil {
		n += 1 + sovInternal(uint64(*m.Min))
	}
	return n
}
...
var fileDescriptorInternal = []byte{
	...
	,
}
