...
func NewPopulatedTransaction(r randyData, easy bool) *Transaction {
	...
	if r.Intn(10) != 0 {
		v8 := r.Intn(5)
		this.Intents = make([]Span, v8)
		for i := 0; i < v8; i++ {
			v9 := NewPopulatedSpan(r, easy)
			this.Intents[i] = *v9
		}
	}
...
func NewPopulatedLease(r randyData, easy bool) *Lease {
	...
	this.Expiration = *v11
	v12 := NewPopulatedReplicaDescriptor(r, easy)
	this.Replica = *v12
	v13 := cockroach_util_hlc.NewPopulatedTimestamp(r, easy)
	this.StartStasis = *v13
	if !easy && r.Intn(10) != 0 {
	}
	return this
}
...
var fileDescriptorData = []byte{
	...
	,
}
