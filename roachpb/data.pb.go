...
import fmt "fmt"
import math "math"
import cockroach_storage_enginepb "github.com/cockroachdb/cockroach/storage/engine/enginepb"
...
type Transaction struct {
	...
	cockroach_storage_enginepb.TxnMeta `protobuf:"bytes,1,opt,name=meta,embedded=meta" json:"meta"`
...
type Intent struct {
	...
	Txn    cockroach_storage_enginepb.TxnMeta `protobuf:"bytes,2,opt,name=txn" json:"txn"`
...
func NewPopulatedTransaction(r randyData, easy bool) *Transaction {
	this := &Transaction{}
	v3 := cockroach_storage_enginepb.NewPopulatedTxnMeta(r, easy)
	this.TxnMeta = *v3
...
var fileDescriptorData = []byte{
	...
	,
}
