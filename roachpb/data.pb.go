...
// AbortCacheEntry contains information about transactions which
// have been aborted. They're written to a range's abort cache if
// it contained keys with intents belonging to an aborted txn. In
// the event that the same transaction attempts to read keys it
// may have written previously, this entry contains the necessary
// informaiton to instruct the transaction to restart and at which
// priority.
...
var fileDescriptorData = []byte{
	...
	,
}
