...
type Transaction struct {
	...
	// The write_too_old bool is true if the transaction tried to write
	// a key for which a newer version already existed. If this is true,
	// the snapshot isolation transactions must retry. This bool is set
	// instead of immediately returning a txn retry error so that
	// intents can continue to be laid down, minimizing work required on
	// txn restart.
	WriteTooOld bool `protobuf:"varint,10,opt,name=write_too_old,json=writeTooOld" json:"write_too_old"`
...
var fileDescriptorData = []byte{
	...
	,
}
