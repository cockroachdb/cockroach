...
// Meta is the metadata of a Transaction record.
type Meta struct {
...
type Transaction struct {
	...
	Meta `protobuf:"bytes,1,opt,name=meta,embedded=meta" json:"meta"`
...
type Intent struct {
	...
	Txn    Meta              `protobuf:"bytes,2,opt,name=txn" json:"txn"`
...
func init() {
	...
	proto.RegisterType((*Meta)(nil), "cockroach.roachpb.Meta")
...
func (m *Transaction) MarshalTo(data []byte) (int, error) {
	...
	data[i] = 0xa
	i++
	i = encodeVarintData(data, i, uint64(m.Meta.Size()))
