...
type Transaction struct {
	...
	// Don't use an actual map to represent this because it
	// doesn't marshal predictably.
	ObservedTimestamps []Transaction_ObservedTimestamp `protobuf:"bytes,8,rep,name=observed_timestamps,json=observedTimestamps" json:"observed_timestamps"`
...
type Transaction_ObservedTimestamp struct {
	NodeID    NodeID    `protobuf:"varint,1,opt,name=NodeID,json=nodeID,casttype=NodeID" json:"NodeID"`
	Timestamp Timestamp `protobuf:"bytes,2,opt,name=timestamp" json:"timestamp"`
}
...
func (*Transaction_ObservedTimestamp) Descriptor() ([]byte, []int) {
...
var fileDescriptorData = []byte{
	...
	,
}
