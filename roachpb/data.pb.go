...
// what was originally both ranges and the now invalid range descriptor
// that used to cover the subsumed half of the merge. This information
// allows the final bookkeeping for the merge to be completed and put
// into operation.
type MergeTrigger struct {
	// The updated range descriptor that now encompasses what was originally
	// both ranges.
	UpdatedDesc RangeDescriptor `protobuf:"bytes,1,opt,name=updated_desc" json:"updated_desc"`
	// The now INVALID range descriptor that used to cover the subsumed half
	// of the merge.
