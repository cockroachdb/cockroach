...
func (*ErrorWithPGCode) Descriptor() ([]byte, []int) { return fileDescriptorErrors, []int{19} }
...
func (m *ErrorDetail) MarshalTo(data []byte) (int, error) {
	...
	if m.ExistingSchemeChangeLease != nil {
		...
		n30, err := m.ExistingSchemeChangeLease.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n30
	...
	if m.ErrorWithPgCode != nil {
		...
		n31, err := m.ErrorWithPgCode.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n31
...
var fileDescriptorErrors = []byte{
	...
	,
}
