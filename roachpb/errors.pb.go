...
// SQLErrorProto is the detail for errors carring sql error codes.
type SQLErrorProto struct {
	ErrorCode string `protobuf:"bytes,1,opt,name=error_code,json=errorCode" json:"error_code"`
	Message   string `protobuf:"bytes,2,opt,name=message" json:"message"`
}

func (m *SQLErrorProto) Reset()                    { *m = SQLErrorProto{} }
func (m *SQLErrorProto) String() string            { return proto.CompactTextString(m) }
func (*SQLErrorProto) ProtoMessage()               {}
func (*SQLErrorProto) Descriptor() ([]byte, []int) { return fileDescriptorErrors, []int{20} }
...
type ErrorDetail struct {
	...
	SqlError                  *SQLErrorProto                  `protobuf:"bytes,22,opt,name=sql_error,json=sqlError" json:"sql_error,omitempty"`
}
...
func init() {
	...
	proto.RegisterType((*SQLErrorProto)(nil), "cockroach.roachpb.SQLErrorProto")
...
func (m *SQLErrorProto) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *SQLErrorProto) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ErrorDetail) MarshalTo(data []byte) (int, error) {
	...
	if m.SqlError != nil {
		...
		data[i] = 0x1
		i++
		i = encodeVarintErrors(data, i, uint64(m.SqlError.Size()))
		n32, err := m.SqlError.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n32
...
func (m *SQLErrorProto) Size() (n int) {
	var l int
	_ = l
	l = len(m.ErrorCode)
	n += 1 + l + sovErrors(uint64(l))
...
func (m *SQLErrorProto) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SQLErrorProto: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SQLErrorProto: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ErrorDetail) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 22:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SqlError", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.SqlError == nil {
				m.SqlError = &SQLErrorProto{}
			}
			if err := m.SqlError.Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorErrors = []byte{
	...
	,
}
