...
type RangeKeyMismatchError struct {
	...
	//   range did not fully contain the requests key(s). If so, that specified
	...
	//   fully contained the request. If no range contained the request's
	//   start key, mismatched_range will be nil. If a range contained the
	//   requests start key but the request overlapped ranges, mismatched_range
	//   will be the descriptor of the range which contains the start_key of
	//   the request.
...
var fileDescriptorErrors = []byte{
	...
	,
}
