...
func test_certs_node_key() (*asset, error) {
	...
	info := bindata_file_info{name: "test_certs/node.key", size: 1675, mode: os.FileMode(420), modTime: time.Unix(1400000000, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
