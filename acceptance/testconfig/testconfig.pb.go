...
// source: cockroach/acceptance/testconfig/testconfig.proto
// DO NOT EDIT!

/*
	Package testconfig is a generated protocol buffer package.

	It is generated from these files:
		cockroach/acceptance/testconfig/testconfig.proto
...
type TestConfig struct {
	Nodes    []NodeConfig  `protobuf:"bytes,1,rep,name=nodes" json:"nodes"`
	Duration time.Duration `protobuf:"varint,2,opt,name=duration,casttype=time.Duration" json:"duration"`
	Stall    time.Duration `protobuf:"varint,3,opt,name=stall,casttype=time.Duration" json:"stall"`
...
func init() {
	proto.RegisterType((*StoreConfig)(nil), "cockroach.acceptance.testconfig.StoreConfig")
	proto.RegisterType((*NodeConfig)(nil), "cockroach.acceptance.testconfig.NodeConfig")
	proto.RegisterType((*TestConfig)(nil), "cockroach.acceptance.testconfig.TestConfig")
}
